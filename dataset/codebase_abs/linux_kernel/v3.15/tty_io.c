...
static void F_89 ( struct V_120 * time )
{
unsigned long V_121 = F_90 () & ~ 7 ;
if ( ( long ) ( V_121 - time -> V_122 ) > 0 )
time -> V_122 = V_121 ;
}
static T_2 F_91 ( struct V_7 * V_7 , char T_3 * V_15 , T_4 V_23 ,
T_5 * V_55 )
{
int V_123 ;
struct V_17 * V_17 = F_92 ( V_7 ) ;
...
void F_94 ( struct V_1 * V_3 )
__releases( &tty->atomic_write_lock
int F_95 ( struct V_1 * V_3 , int V_127 )
...
void F_100 ( struct V_1 * V_3 , char * V_138 )
{
if ( V_3 ) {
F_31 ( & V_3 -> V_139 ) ;
F_62 ( V_3 ) ;
...
V_45 = F_96 ( V_69 -> V_42 -> V_97 , V_3 , V_7 , V_15 , V_23 ) ;
F_49 ( V_69 ) ;
return V_45 ;
}
...
if ( V_22 ) {
T_2 V_36 ;
V_36 = F_102 ( V_22 , V_15 , V_23 , & V_22 -> V_143 ) ;
F_69 ( V_22 ) ;
return V_36 ;
}
...
static T_2 F_104 ( struct V_29 * V_24 , int V_31 , char * V_22 )
{
if ( V_24 -> V_44 & V_146 )
...
static struct V_1 * F_105 ( struct V_29 * V_24 ,
...
V_3 -> V_153 . V_155 = F_107 ( & V_3 -> V_153 ) ;
V_3 -> V_153 . V_156 = F_108 ( & V_3 -> V_153 ) ;
return 0 ;
}
int F_109 ( struct V_29 * V_24 , struct V_1 * V_3 )
{
int V_45 = F_106 ( V_3 ) ;
if ( V_45 )
return V_45 ;
...
static int F_110 ( struct V_29 * V_24 ,
struct V_1 * V_3 )
{
return V_24 -> V_42 -> V_157 ? V_24 -> V_42 -> V_157 ( V_24 , V_3 ) :
F_109 ( V_24 , V_3 ) ;
}
void F_111 ( struct V_29 * V_24 , struct V_1 * V_3 )
{
if ( V_24 -> V_42 -> remove )
...
static int F_112 ( struct V_1 * V_3 )
{
...
struct V_1 * F_114 ( struct V_29 * V_24 , int V_147 )
{
struct V_1 * V_3 ;
int V_160 ;
if ( ! F_115 ( V_24 -> V_161 ) )
...
F_117 ( V_3 , V_24 , V_147 ) ;
F_62 ( V_3 ) ;
V_160 = F_110 ( V_24 , V_3 ) ;
if ( V_160 < 0 )
goto V_164;
if ( ! V_3 -> V_165 )
...
static void F_126 ( struct V_1 * V_3 )
{
F_127 ( & V_3 -> V_171 ) ;
F_127 ( & V_3 -> V_107 ) ;
}
...
static void F_131 ( struct V_173 * V_173 )
{
struct V_1 * V_3 = F_71 ( V_173 , struct V_1 , V_173 ) ;
F_132 ( & V_3 -> V_107 , F_128 ) ;
F_74 ( & V_3 -> V_107 ) ;
}
void F_66 ( struct V_1 * V_3 )
{
if ( V_3 )
F_133 ( & V_3 -> V_173 , F_131 ) ;
}
static void F_123 ( struct V_1 * V_3 , int V_147 )
{
F_113 ( V_3 -> V_31 != V_147 ) ;
F_113 ( ! F_134 ( & V_41 ) ) ;
if ( V_3 -> V_42 -> V_174 )
V_3 -> V_42 -> V_174 ( V_3 ) ;
F_124 ( V_3 ) ;
...
F_135 ( & V_3 -> V_165 -> V_15 . V_106 ) ;
if ( V_3 -> V_28 )
F_66 ( V_3 -> V_28 ) ;
F_66 ( V_3 ) ;
}
static int F_136 ( struct V_1 * V_3 , struct V_1 * V_175 ,
int V_147 )
{
#ifdef F_18
...
int F_137 ( struct V_17 * V_17 , struct V_7 * V_56 )
{
...
V_3 -> V_24 -> V_26 == V_158 ) ;
V_175 = V_3 -> V_28 ;
if ( F_136 ( V_3 , V_175 , V_147 ) ) {
F_63 ( V_3 ) ;
return 0 ;
}
#ifdef F_73
F_19 ( V_108 L_28 , V_167 ,
...
if ( V_180 ) {
if ( F_139 ( & V_175 -> V_116 ) ) {
F_140 ( & V_175 -> V_116 , V_58 ) ;
V_181 ++ ;
}
if ( F_139 ( & V_175 -> V_72 ) ) {
F_140 ( & V_175 -> V_72 , V_59 ) ;
V_181 ++ ;
}
}
if ( ! V_181 )
...
F_126 ( V_175 ) ;
#ifdef F_73
F_19 ( V_108 L_33 , V_167 , F_16 ( V_3 , V_15 ) ) ;
#endif
F_31 ( & V_41 ) ;
F_123 ( V_3 , V_147 ) ;
F_32 ( & V_41 ) ;
...
static struct V_1 * F_144 ( T_1 V_30 , struct V_7 * V_56 )
{
struct V_1 * V_3 ;
...
static struct V_29 * F_145 ( T_1 V_30 , struct V_7 * V_56 ,
int * V_185 , int * V_31 )
{
struct V_29 * V_24 ;
switch ( V_30 ) {
...
static int F_148 ( struct V_17 * V_17 , struct V_7 * V_56 )
{
struct V_1 * V_3 ;
int V_185 , V_160 ;
...
V_24 = F_145 ( V_30 , V_56 , & V_185 , & V_31 ) ;
if ( F_150 ( V_24 ) ) {
V_160 = F_151 ( V_24 ) ;
goto V_193;
}
V_3 = F_105 ( V_24 , V_17 , V_31 ) ;
if ( F_150 ( V_3 ) ) {
V_160 = F_151 ( V_3 ) ;
goto V_193;
}
...
V_185 = 1 ;
#ifdef F_73
F_19 ( V_108 L_34 , V_167 , V_3 -> V_16 ) ;
#endif
if ( V_3 -> V_42 -> V_195 )
...
static unsigned int F_155 ( struct V_7 * V_56 , T_6 * V_57 )
{
struct V_1 * V_3 = F_6 ( V_56 ) ;
struct V_68 * V_69 ;
int V_45 = 0 ;
if ( F_17 ( V_3 , F_92 ( V_56 ) , L_36 ) )
return 0 ;
V_69 = F_93 ( V_3 ) ;
if ( V_69 -> V_42 -> V_200 )
...
unsigned long V_44 ;
int V_160 = 0 ;
if ( F_17 ( V_3 , F_92 ( V_56 ) , L_37 ) )
goto V_51;
V_160 = F_156 ( V_201 , V_56 , V_202 , & V_3 -> V_203 ) ;
if ( V_160 <= 0 )
goto V_51;
V_159 = F_48 ( V_3 ) ;
if ( V_159 ) {
...
F_58 ( V_76 ) ;
F_36 ( & V_3 -> V_47 , V_44 ) ;
V_160 = F_158 ( V_56 , V_76 , type , 0 ) ;
F_57 ( V_76 ) ;
}
V_51:
return V_160 ;
}
static int F_159 ( int V_201 , struct V_7 * V_56 , int V_202 )
{
struct V_1 * V_3 = F_6 ( V_56 ) ;
int V_160 ;
F_62 ( V_3 ) ;
...
static int F_160 ( struct V_1 * V_3 , char T_3 * V_22 )
{
char V_207 , V_208 = 0 ;
struct V_68 * V_69 ;
if ( ( V_46 -> signal -> V_3 != V_3 ) && ! F_152 ( V_197 ) )
return - V_209 ;
if ( F_161 ( V_207 , V_22 ) )
return - V_136 ;
F_162 ( V_3 , V_207 ) ;
...
static int F_163 ( struct V_1 * V_3 , struct V_211 T_3 * V_65 )
{
int V_212 ;
F_31 ( & V_3 -> V_213 ) ;
V_212 = F_164 ( V_65 , & V_3 -> V_211 , sizeof( * V_65 ) ) ;
F_32 ( & V_3 -> V_213 ) ;
return V_212 ? - V_136 : 0 ;
}
int F_165 ( struct V_1 * V_3 , struct V_211 * V_214 )
{
struct V_76 * V_48 ;
unsigned long V_44 ;
F_31 ( & V_3 -> V_213 ) ;
...
static int F_166 ( struct V_1 * V_3 , struct V_211 T_3 * V_65 )
{
struct V_211 V_217 ;
if ( F_97 ( & V_217 , V_65 , sizeof( * V_65 ) ) )
return - V_136 ;
if ( V_3 -> V_42 -> V_218 )
return V_3 -> V_42 -> V_218 ( V_3 , & V_217 ) ;
else
return F_165 ( V_3 , & V_217 ) ;
}
static int F_167 ( struct V_7 * V_7 )
{
if ( ! F_152 ( V_197 ) )
return - V_209 ;
...
static int F_168 ( struct V_7 * V_7 , int T_3 * V_22 )
{
int V_219 ;
if ( F_161 ( V_219 , V_22 ) )
return - V_136 ;
...
static int F_169 ( struct V_1 * V_3 , int V_65 )
{
int V_45 = 0 ;
if ( V_46 -> signal -> V_82 && ( F_85 ( V_46 ) == V_3 -> V_79 ) )
return V_45 ;
F_31 ( & V_41 ) ;
...
static int F_171 ( struct V_1 * V_3 , struct V_1 * V_222 , T_7 T_3 * V_22 )
{
struct V_76 * V_76 ;
int V_45 ;
...
return - V_67 ;
V_76 = F_83 ( V_222 ) ;
V_45 = F_172 ( F_173 ( V_76 ) , V_22 ) ;
F_57 ( V_76 ) ;
return V_45 ;
}
static int F_174 ( struct V_1 * V_3 , struct V_1 * V_222 , T_7 T_3 * V_22 )
{
struct V_76 * V_48 ;
T_7 V_223 ;
...
static int F_179 ( struct V_1 * V_3 , struct V_1 * V_222 , T_7 T_3 * V_22 )
{
if ( V_3 == V_222 && V_46 -> signal -> V_3 != V_222 )
return - V_67 ;
if ( ! V_222 -> V_79 )
return - V_67 ;
return F_172 ( F_173 ( V_222 -> V_79 ) , V_22 ) ;
}
static int F_180 ( struct V_1 * V_3 , int T_3 * V_22 )
{
int V_159 ;
int V_45 ;
if ( F_161 ( V_159 , V_22 ) )
return - V_136 ;
V_45 = F_181 ( V_3 , V_159 ) ;
return V_45 ;
}
static int F_182 ( struct V_1 * V_3 , unsigned int V_226 )
{
int V_160 ;
...
static int F_184 ( struct V_1 * V_3 , int T_3 * V_22 )
{
int V_160 = - V_224 ;
if ( V_3 -> V_42 -> V_230 ) {
V_160 = V_3 -> V_42 -> V_230 ( V_3 ) ;
if ( V_160 >= 0 )
V_160 = F_172 ( V_160 , V_22 ) ;
}
return V_160 ;
}
static int F_185 ( struct V_1 * V_3 , unsigned int V_64 ,
unsigned T_3 * V_22 )
{
int V_160 ;
...
static int F_186 ( struct V_1 * V_3 , void T_3 * V_65 )
{
int V_160 = - V_224 ;
struct V_243 V_244 ;
...
if ( V_160 != 0 )
return V_160 ;
if ( F_164 ( V_65 , & V_244 , sizeof( V_244 ) ) )
return - V_136 ;
return 0 ;
}
...
struct V_1 * F_188 ( struct V_1 * V_3 )
{
if ( V_3 -> V_24 -> type == V_25 &&
V_3 -> V_24 -> V_26 == V_158 )
return V_3 ;
...
long F_189 ( struct V_7 * V_7 , unsigned int V_64 , unsigned long V_65 )
{
struct V_1 * V_3 = F_6 ( V_7 ) ;
struct V_1 * V_222 ;
...
switch ( V_64 ) {
case V_251 :
return F_160 ( V_3 , V_22 ) ;
case V_252 :
return F_163 ( V_222 , V_22 ) ;
case V_253 :
return F_166 ( V_222 , V_22 ) ;
case V_254 :
return V_222 != V_3 ? - V_224 : F_167 ( V_7 ) ;
case V_255 :
return F_168 ( V_7 , V_22 ) ;
case V_256 :
F_64 ( V_196 , & V_3 -> V_44 ) ;
return 0 ;
case V_257 :
...
return F_172 ( V_259 , ( int T_3 * ) V_22 ) ;
}
case V_260 :
if ( V_46 -> signal -> V_3 != V_3 )
return - V_67 ;
...
return 0 ;
case V_261 :
return F_169 ( V_3 , V_65 ) ;
case V_262 :
return F_171 ( V_3 , V_222 , V_22 ) ;
case V_66 :
return F_174 ( V_3 , V_222 , V_22 ) ;
case V_263 :
return F_179 ( V_3 , V_222 , V_22 ) ;
case V_264 :
return F_172 ( V_3 -> V_159 -> V_42 -> V_35 , ( int T_3 * ) V_22 ) ;
case V_246 :
return F_180 ( V_3 , V_22 ) ;
case V_265 :
if ( ! F_152 ( V_197 ) )
return - V_209 ;
F_75 ( V_3 ) ;
...
case V_266 :
{
unsigned int V_45 = F_191 ( F_192 ( V_222 ) ) ;
return F_172 ( V_45 , ( unsigned int T_3 * ) V_22 ) ;
}
case V_247 :
if ( V_3 -> V_42 -> V_227 )
...
case V_249 :
if ( ! V_65 )
return F_182 ( V_3 , 250 ) ;
return 0 ;
case V_250 :
return F_182 ( V_3 , V_65 ? V_65 * 100 : 250 ) ;
case V_267 :
return F_184 ( V_3 , V_22 ) ;
case V_237 :
case V_236 :
case V_235 :
return F_185 ( V_3 , V_64 , V_22 ) ;
case V_268 :
V_160 = F_186 ( V_3 , V_22 ) ;
if ( V_160 != - V_224 )
return V_160 ;
break;
case V_269 :
...
static long F_194 ( struct V_7 * V_7 , unsigned int V_64 ,
unsigned long V_65 )
{
struct V_1 * V_3 = F_6 ( V_7 ) ;
struct V_68 * V_69 ;
...
V_160 = F_195 ( V_3 , V_7 , V_64 , V_65 ) ;
F_49 ( V_69 ) ;
return V_160 ;
}
static int F_196 ( const void * V_275 , struct V_7 * V_7 , unsigned V_201 )
{
if ( F_197 ( V_7 -> V_96 -> V_125 != F_91 ) )
return 0 ;
return F_6 ( V_7 ) != V_275 ? 0 : V_201 + 1 ;
}
void F_198 ( struct V_1 * V_3 )
{
#ifdef F_199
F_72 ( V_3 ) ;
#else
...
F_205 ( V_22 ) ;
V_123 = F_206 ( V_22 -> V_280 , 0 , F_196 , V_3 ) ;
if ( V_123 != 0 ) {
F_19 ( V_277 L_39
L_41 ,
F_202 ( V_22 ) , V_22 -> V_278 , V_123 - 1 ) ;
F_207 ( V_279 , V_22 ) ;
}
F_208 ( V_22 ) ;
} F_209 ( V_276 , V_22 ) ;
...
void F_211 ( struct V_1 * V_3 )
{
if ( ! V_3 )
return;
F_74 ( & V_3 -> V_171 ) ;
}
static int F_212 ( struct V_30 * V_4 , const void * V_281 )
{
const T_1 * V_282 = V_281 ;
return V_4 -> V_282 == * V_282 ;
}
static struct V_30 * F_213 ( struct V_1 * V_3 )
{
T_1 V_282 = F_192 ( V_3 ) ;
return F_214 ( V_283 , NULL , & V_282 , F_212 ) ;
}
...
F_220 ( & V_3 -> V_72 ) ;
F_220 ( & V_3 -> V_116 ) ;
F_132 ( & V_3 -> V_107 , F_70 ) ;
F_217 ( & V_3 -> V_139 ) ;
F_221 ( & V_3 -> V_47 ) ;
F_222 ( & V_3 -> V_14 ) ;
F_132 ( & V_3 -> V_171 , F_210 ) ;
V_3 -> V_24 = V_24 ;
V_3 -> V_42 = V_24 -> V_42 ;
V_3 -> V_31 = V_147 ;
F_104 ( V_24 , V_147 , V_3 -> V_16 ) ;
V_3 -> V_4 = F_213 ( V_3 ) ;
}
...
int F_224 ( struct V_1 * V_3 , unsigned char V_207 )
{
if ( V_3 -> V_42 -> V_288 )
return V_3 -> V_42 -> V_288 ( V_3 , V_207 ) ;
return V_3 -> V_42 -> V_97 ( V_3 , & V_207 , 1 ) ;
}
static int F_225 ( struct V_29 * V_24 , T_1 V_4 ,
unsigned int V_31 , unsigned int V_23 )
{
F_226 ( & V_24 -> V_289 [ V_31 ] , & V_199 ) ;
V_24 -> V_289 [ V_31 ] . V_161 = V_24 -> V_161 ;
return F_227 ( & V_24 -> V_289 [ V_31 ] , V_4 , V_23 ) ;
}
struct V_30 * F_228 ( struct V_29 * V_24 , unsigned V_31 ,
struct V_30 * V_30 )
{
return F_229 ( V_24 , V_31 , V_30 , NULL , NULL ) ;
}
static void F_230 ( struct V_30 * V_4 )
{
F_231 ( L_42 , F_232 ( V_4 ) , V_167 ) ;
F_5 ( V_4 ) ;
}
struct V_30 * F_229 ( struct V_29 * V_24 ,
...
F_4 ( V_4 ) ;
if ( V_293 )
F_236 ( & V_24 -> V_289 [ V_31 ] ) ;
return F_116 ( V_160 ) ;
}
void F_237 ( struct V_29 * V_24 , unsigned V_31 )
{
F_238 ( V_283 ,
...
struct V_29 * F_239 ( unsigned int V_299 , struct V_300 * V_161 ,
unsigned long V_44 )
{
struct V_29 * V_24 ;
...
V_24 -> V_44 = V_44 ;
if ( ! ( V_44 & V_176 ) ) {
V_24 -> V_149 = F_240 ( V_299 , sizeof( * V_24 -> V_149 ) ,
V_2 ) ;
V_24 -> V_153 = F_240 ( V_299 , sizeof( * V_24 -> V_153 ) ,
V_2 ) ;
...
if ( ! ( V_44 & V_294 ) ) {
V_24 -> V_166 = F_240 ( V_299 , sizeof( * V_24 -> V_166 ) ,
V_2 ) ;
if ( ! V_24 -> V_166 ) {
V_212 = - V_11 ;
goto V_302;
...
V_24 -> V_289 = F_240 ( V_289 , sizeof( * V_24 -> V_289 ) , V_2 ) ;
if ( ! V_24 -> V_289 ) {
V_212 = - V_11 ;
goto V_302;
}
...
static void F_241 ( struct V_173 * V_173 )
{
...
void F_129 ( struct V_29 * V_24 )
{
F_133 ( & V_24 -> V_173 , F_241 ) ;
}
void F_243 ( struct V_29 * V_24 ,
const struct V_305 * V_306 )
{
V_24 -> V_42 = V_306 ;
}
void F_244 ( struct V_29 * V_307 )
{
F_129 ( V_307 ) ;
}
...
error = F_249 ( V_4 , V_24 -> V_35 , V_24 -> V_16 ) ;
}
if ( error < 0 )
goto V_212;
if ( V_24 -> V_44 & V_294 ) {
error = F_225 ( V_24 , V_4 , 0 , V_24 -> V_35 ) ;
if ( error )
goto V_308;
}
F_31 ( & V_41 ) ;
...
int F_252 ( struct V_29 * V_24 )
{
#if 0
if (driver->refcount)
return -EBUSY;
#endif
F_251 ( F_27 ( V_24 -> V_33 , V_24 -> V_34 ) ,
V_24 -> V_35 ) ;
F_31 ( & V_41 ) ;
F_15 ( & V_24 -> V_309 ) ;
F_32 ( & V_41 ) ;
...
static void F_153 ( struct V_74 * V_111 , struct V_1 * V_3 )
{
if ( V_3 ) {
unsigned long V_44 ;
F_34 ( & V_3 -> V_47 , V_44 ) ;
...
V_111 -> signal -> V_3 = F_84 ( V_3 ) ;
V_111 -> signal -> V_86 = NULL ;
}
static void F_170 ( struct V_74 * V_111 , struct V_1 * V_3 )
{
...
V_23 += F_104 ( V_325 , V_31 , V_15 + V_23 ) ;
else
...
{
if ( V_326 )
F_265 ( & V_326 -> V_327 , NULL , L_47 ) ;
}
int T_8 F_266 ( void )
{
F_226 ( & V_328 , & V_199 ) ;
if ( F_227 ( & V_328 , F_27 ( V_182 , 0 ) , 1 ) ||
F_249 ( F_27 ( V_182 , 0 ) , 1 , L_48 ) < 0 )
F_267 ( L_49 ) ;
F_268 ( V_283 , NULL , F_27 ( V_182 , 0 ) , NULL , L_17 ) ;
F_226 ( & V_329 , & V_330 ) ;
if ( F_227 ( & V_329 , F_27 ( V_182 , 1 ) , 1 ) ||
F_249 ( F_27 ( V_182 , 1 ) , 1 , L_50 ) < 0 )
F_267 ( L_51 ) ;
V_326 = F_268 ( V_283 , NULL , F_27 ( V_182 , 1 ) , NULL ,
L_52 ) ;
if ( F_150 ( V_326 ) )
V_326 = NULL ;
else
F_113 ( F_269 ( V_326 , & V_331 ) < 0 ) ;
#ifdef F_146
F_270 ( & V_330 ) ;
#endif
return 0 ;
