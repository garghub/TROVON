...
int F_11 ( struct V_33 * V_34 , struct V_24 * V_25 ,
struct V_1 * V_2 ,
T_1 V_35 , T_1 V_36 )
{
int V_55 ;
F_12 ( ! F_13 ( V_58 , & V_34 -> V_59 ) &&
V_25 -> V_60 ) ;
F_14 ( & V_34 -> V_61 ) ;
V_25 -> V_44 = V_2 -> V_13 ;
V_55 = F_8 ( V_34 , V_25 , V_2 ,
V_35 , V_36 ,
V_62 , 0 ) ;
return V_55 ;
}
void F_15 ( struct V_33 * V_34 , struct V_24 * V_25 )
{
F_14 ( & V_34 -> V_61 ) ;
V_25 -> V_60 ++ ;
}
