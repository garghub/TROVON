...
#ifdef F_94
if ( V_2 -> V_333 ) {
F_95 ( V_2 -> V_333 , V_335 , & V_2 -> V_249 ) ;
F_95 ( V_2 -> V_333 , V_336 , & V_2 -> V_250 ) ;
}
#endif
if ( V_27 -> V_28 -> V_337 ) {
V_27 -> V_28 -> V_337 ( V_2 ) ;
...
if ( ! ( V_2 -> V_91 & V_340 ) && ! ( V_2 -> V_91 & V_344 ) ) {
...
V_2 -> V_71 = F_3 ( V_2 , V_345 ) ;
if ( V_2 -> V_71 == 0xffff )
V_2 -> V_71 = 0 ;
}
if ( ! ( V_2 -> V_91 & V_341 ) && ! ( V_2 -> V_91 & V_346 ) ) {
V_2 -> V_347 = F_3 ( V_2 , V_309 ) ;
if ( V_2 -> V_347 == 0xffff )
V_2 -> V_347 = 0 ;
if ( V_2 -> V_347 & 1 )
V_2 -> V_91 |= V_346 ;
}
if ( ! F_99 ( V_2 ) && ! F_100 ( V_2 ) ) {
...
V_349:
if ( F_99 ( V_2 ) )
V_2 -> V_334 = ( V_2 -> V_71 & V_364 ) >> V_365 ;
else
V_2 -> V_334 = ( V_2 -> V_347 & V_366 ) >> V_367 ;
if ( V_2 -> V_71 & 0x01c9 ) {
V_3 = F_3 ( V_2 , V_128 ) ;
V_3 |= V_2 -> V_71 & 0x01c0 ;
if ( ! V_27 -> V_273 )
...
if ( ( V_2 -> V_71 & V_278 ) && V_27 -> V_368 ) {
F_11 ( V_2 , V_233 , V_245 , V_369 ) ;
if ( ( F_3 ( V_2 , V_233 ) & V_245 ) == V_369 )
V_2 -> V_114 |= V_275 ;
F_11 ( V_2 , V_233 , V_245 , 0 ) ;
}
if ( V_2 -> V_71 & V_370 ) {
F_70 ( V_2 , V_276 , 0 , & V_2 -> V_256 [ V_371 ] ) ;
F_70 ( V_2 , V_372 , 0 , & V_2 -> V_256 [ V_373 ] ) ;
} else {
V_2 -> V_256 [ V_371 ] = V_274 ;
if ( V_2 -> V_114 & V_275 )
V_2 -> V_256 [ V_371 ] |= V_277 ;
...
if ( V_2 -> V_71 & V_374 ) {
F_70 ( V_2 , V_375 , 0 , & V_2 -> V_256 [ V_376 ] ) ;
} else {
V_2 -> V_256 [ V_376 ] = V_274 ;
}
if ( V_2 -> V_71 & V_156 ) {
F_70 ( V_2 , V_377 , V_276 , & V_2 -> V_256 [ V_378 ] ) ;
V_2 -> V_91 |= V_219 ;
}
if ( V_2 -> V_71 & V_154 ) {
...
if ( V_27 -> V_28 -> V_381 )
V_27 -> V_28 -> V_381 ( V_2 ) ;
F_72 ( V_2 , V_2 -> V_4 , V_64 , ! F_99 ( V_2 ) ) ;
F_72 ( NULL , V_2 -> V_4 , V_64 , ! F_99 ( V_2 ) ) ;
if ( ! V_2 -> V_246 )
V_2 -> V_246 = & V_382 ;
if ( F_99 ( V_2 ) ) {
char V_383 [ 16 ] ;
if ( V_174 -> V_384 [ 0 ] == '\0' ) {
strcpy ( V_174 -> V_384 , V_64 ) ;
} else {
if ( strlen ( V_174 -> V_384 ) + 1 + strlen ( V_64 ) + 1 <= sizeof( V_174 -> V_384 ) ) {
strcat ( V_174 -> V_384 , L_29 ) ;
strcat ( V_174 -> V_384 , V_64 ) ;
}
}
sprintf ( V_383 , L_30 , V_2 -> V_4 ) ;
if ( ( V_84 = F_101 ( V_174 , V_383 ) ) < 0 ) {
F_43 ( V_2 ) ;
return V_84 ;
}
if ( F_64 ( V_2 ) < 0 ) {
...
F_24 ( V_2 ) ;
F_102 ( V_2 ) ;
if ( ( V_84 = F_81 ( V_174 , V_385 , V_2 , & V_28 ) ) < 0 ) {
F_43 ( V_2 ) ;
return V_84 ;
}
* V_329 = V_2 ;
...
F_2 ( V_2 , V_128 , V_386 ) ;
if ( V_2 -> V_91 & V_92 )
V_386 = V_2 -> V_33 [ V_90 ] & ~ V_87 ;
else if ( ! ( V_2 -> V_91 & V_391 ) )
V_386 = V_2 -> V_33 [ V_90 ] | V_87 ;
V_386 |= V_392 ;
V_386 |= V_393 | V_394 ;
F_2 ( V_2 , V_90 , V_386 ) ;
...
int F_104 ( struct V_1 * V_2 , int V_3 , int V_399 )
{
int V_160 ;
if ( ! V_2 )
return 0 ;
...
if ( V_3 == V_130 )
V_3 = V_276 ;
for ( V_160 = 0 ; V_160 < V_400 ; V_160 ++ ) {
if ( V_401 [ V_160 ] . V_3 == V_3 ) {
if ( V_399 )
V_2 -> V_88 |= ( 1 << V_160 ) ;
else
V_2 -> V_88 &= ~ ( 1 << V_160 ) ;
...
V_164 = V_401 [ V_160 ] . V_37 ;
F_11 ( V_2 , V_401 [ V_160 ] . V_408 ,
V_401 [ V_160 ] . V_37 , V_164 ) ;
}
if ( ! V_88 ) {
if ( ! ( V_2 -> V_33 [ V_90 ] & V_395 ) ) {
F_11 ( V_2 , V_90 ,
...
V_410:
if ( V_2 -> V_27 -> V_28 -> V_381 )
V_2 -> V_27 -> V_28 -> V_381 ( V_2 ) ;
if ( V_2 -> V_246 -> V_411 )
V_2 -> V_246 -> V_411 ( V_2 ) ;
else {
F_109 ( V_2 ) ;
...
static void F_112 ( char * V_412 , const char * V_413 , const char * V_414 )
{
if ( V_414 )
sprintf ( V_412 , L_32 , V_413 , V_414 ) ;
else
strcpy ( V_412 , V_413 ) ;
}
static int F_113 ( struct V_1 * V_2 , const char * V_64 ,
const char * V_414 )
{
struct V_415 V_4 ;
memset ( & V_4 , 0 , sizeof( V_4 ) ) ;
F_112 ( V_4 . V_64 , V_64 , V_414 ) ;
V_4 . V_416 = V_417 ;
return F_114 ( V_2 -> V_27 -> V_174 , & V_4 ) ;
}
static struct V_50 * F_115 ( struct V_1 * V_2 , const char * V_64 , const char * V_414 )
{
struct V_415 V_418 ;
memset ( & V_418 , 0 , sizeof( V_418 ) ) ;
F_112 ( V_418 . V_64 , V_64 , V_414 ) ;
V_418 . V_416 = V_417 ;
return F_116 ( V_2 -> V_27 -> V_174 , & V_418 ) ;
}
static int F_117 ( struct V_1 * V_2 , const char * V_413 ,
const char * V_412 , const char * V_414 )
{
struct V_50 * V_89 = F_115 ( V_2 , V_413 , V_414 ) ;
if ( V_89 ) {
F_112 ( V_89 -> V_4 . V_64 , V_412 , V_414 ) ;
return 0 ;
}
return - V_419 ;
}
static void F_118 ( struct V_1 * V_2 , const char * V_413 ,
const char * V_412 )
{
F_117 ( V_2 , V_413 , V_412 , L_33 ) ;
F_117 ( V_2 , V_413 , V_412 , L_34 ) ;
}
static int F_119 ( struct V_1 * V_2 , const char * V_420 ,
const char * V_421 , const char * V_414 )
{
struct V_50 * V_422 , * V_423 ;
V_422 = F_115 ( V_2 , V_420 , V_414 ) ;
V_423 = F_115 ( V_2 , V_421 , V_414 ) ;
if ( V_422 && V_423 ) {
F_112 ( V_422 -> V_4 . V_64 , V_421 , V_414 ) ;
F_112 ( V_423 -> V_4 . V_64 , V_420 , V_414 ) ;
return 0 ;
}
return - V_419 ;
}
static int F_120 ( struct V_50 * V_51 , struct V_66 * V_67 )
{
int V_84 = F_22 ( V_51 , V_67 ) ;
if ( V_84 > 0 ) {
unsigned long V_424 = V_51 -> V_56 ;
...
{
struct V_50 * V_425 = F_115 ( V_2 , L_3 , NULL ) ;
struct V_50 * V_426 = F_115 ( V_2 , L_35 , NULL ) ;
if ( ! V_425 || ! V_426 )
return - V_419 ;
V_425 -> V_427 = F_120 ;
V_426 -> V_427 = F_120 ;
...
{
if ( F_119 ( V_2 , L_4 , L_5 , L_33 ) ||
F_119 ( V_2 , L_4 , L_5 , L_34 ) )
return - V_419 ;
return 0 ;
}
...
return F_59 ( V_2 -> V_27 -> V_174 , F_54 ( & V_430 , V_2 ) ) ;
}
static int F_126 ( struct V_1 * V_2 )
{
struct V_50 * V_89 = F_115 ( V_2 , L_40 , NULL ) ;
if ( ! V_89 )
return - V_419 ;
F_25 ( V_2 , V_89 ) ;
return 0 ;
}
static int F_127 ( struct V_50 * V_51 , struct V_66 * V_67 )
{
int V_84 = F_22 ( V_51 , V_67 ) ;
if ( V_84 > 0 ) {
struct V_1 * V_2 = F_16 ( V_51 ) ;
...
if ( type <= 0 )
return 0 ;
else if ( type >= F_50 ( V_431 ) )
return - V_36 ;
if ( V_431 [ type ] . V_432 )
return V_431 [ type ] . V_432 ( V_2 ) ;
return 0 ;
}
static int F_132 ( struct V_1 * V_2 , const char * V_433 )
{
int V_160 ;
struct V_434 * V_435 ;
for ( V_160 = 0 ; V_160 < F_50 ( V_431 ) ; V_160 ++ ) {
V_435 = & V_431 [ V_160 ] ;
if ( V_435 -> V_64 && ! strcmp ( V_433 , V_435 -> V_64 ) )
return F_131 ( V_2 , V_160 ) ;
}
if ( * V_433 >= '0' && * V_433 <= '9' )
return F_131 ( V_2 , ( int ) F_133 ( V_433 , NULL , 10 ) ) ;
return - V_36 ;
}
int F_134 ( struct V_1 * V_2 , struct V_436 * V_437 , const char * V_438 )
{
int V_271 ;
if ( V_438 && strcmp ( V_438 , L_41 ) && strcmp ( V_438 , L_42 ) ) {
V_271 = F_132 ( V_2 , V_438 ) ;
if ( V_271 < 0 )
F_86 ( V_2 , L_43 ,
V_438 , V_271 ) ;
return V_271 ;
...
if ( ! V_437 )
return - V_36 ;
for (; V_437 -> V_439 ; V_437 ++ ) {
if ( V_437 -> V_439 != V_2 -> V_249 )
continue;
if ( ( ! V_437 -> V_37 && V_437 -> V_440 == V_2 -> V_250 ) ||
V_437 -> V_440 == ( V_437 -> V_37 & V_2 -> V_250 ) ) {
if ( V_437 -> V_441 && V_437 -> V_441 != V_2 -> V_4 )
continue;
F_135 ( V_2 , L_44 ,
V_437 -> V_64 , V_2 -> V_249 ,
V_2 -> V_250 ) ;
V_271 = F_131 ( V_2 , V_437 -> type ) ;
if ( V_271 < 0 )
F_86 ( V_2 ,
L_45 ,
V_437 -> type , V_437 -> V_64 , V_271 ) ;
return V_271 ;
}
}
return 0 ;
