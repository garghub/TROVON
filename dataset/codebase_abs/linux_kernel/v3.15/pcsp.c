...
if ( V_38 != 0 )
return - V_41 ;
F_10 ( & V_23 . V_42 , V_10 , V_43 ) ;
V_23 . V_42 . V_44 = V_45 ;
V_7 = F_11 ( V_40 , V_46 , V_47 , V_48 , 0 , & V_2 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_1 ( V_2 ) ;
if ( V_7 < 0 ) {
...
static int F_19 ( struct V_55 * V_40 )
{
int V_7 ;
V_7 = F_20 ( & V_23 . V_56 , & V_40 -> V_40 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_16 ( & V_40 -> V_40 ) ;
if ( V_7 < 0 ) {
...
static int F_23 ( struct V_55 * V_40 )
{
struct V_53 * V_54 = F_24 ( V_40 ) ;
F_21 ( V_54 -> V_56 ) ;
F_18 ( V_54 ) ;
return 0 ;
}
...
{
struct V_53 * V_54 = F_29 ( V_40 ) ;
F_25 ( V_54 ) ;
F_30 ( V_54 -> V_57 ) ;
return 0 ;
}
static void F_31 ( struct V_55 * V_40 )
{
struct V_53 * V_54 = F_24 ( V_40 ) ;
F_25 ( V_54 ) ;
}
