...
{
struct V_18 * V_12 = & V_27 -> V_12 ;
struct V_28 * * V_14 ;
struct V_1 * V_1 ;
unsigned int V_29 ;
int V_15 ;
V_1 = F_20 ( V_12 , sizeof( * V_1 ) , V_30 ) ;
if ( ! V_1 )
return - V_13 ;
V_14 = F_20 ( V_12 , sizeof( * V_14 ) , V_30 ) ;
if ( ! V_14 )
return - V_13 ;
V_1 -> V_31 = F_21 ( V_12 , NULL ) ;
if ( F_22 ( V_1 -> V_31 ) ) {
F_23 ( V_12 , L_1 ) ;
...
V_1 -> V_3 . V_32 . V_12 = V_12 ;
V_1 -> V_3 . V_32 . V_19 = V_22 ;
V_1 -> V_3 . V_32 . V_14 = V_14 ;
V_1 -> V_3 . V_32 . V_36 = 1 ;
F_26 ( & V_1 -> V_3 . V_33 ) ;
V_1 -> V_3 . V_34 = & V_37 ;
