...
struct V_79 * V_80 ;
int V_47 ;
V_47 = F_28 ( & V_10 -> V_45 , - 1 , NULL , V_81 , 0 , & V_78 ) ;
if ( V_47 < 0 )
return V_47 ;
V_7 -> V_78 = V_78 ;
...
{
struct V_77 * V_78 = F_37 ( V_10 ) ;
if ( V_78 )
return F_35 ( V_78 ) ;
return 0 ;
}
static int F_38 ( struct V_1 * V_94 )
{
struct V_5 * V_7 = & V_94 -> V_7 ;
int V_47 ;
V_7 -> V_95 . V_96 = F_27 ;
V_7 -> V_95 . remove = F_36 ;
...
static void F_42 ( struct V_1 * V_94 )
{
struct V_5 * V_7 = & V_94 -> V_7 ;
F_41 ( & V_7 -> V_95 ) ;
F_43 ( & V_7 -> V_10 ) ;
...
static int T_3
F_48 ( struct V_100 * V_101 , struct V_2 * V_102 )
{
...
V_107 = F_51 ( V_102 , V_129 , V_130 , NULL ) ;
if ( V_107 )
goto V_47;
V_29 = & V_94 -> V_7 . V_49 ;
V_29 -> V_56 = V_125 . V_127 ;
V_29 -> V_55 = F_52 ( V_29 -> V_56 * V_57 , V_92 ) ;
if ( ! V_29 -> V_55 ) {
V_29 -> V_56 = 0 ;
F_11 ( & V_7 -> V_10 . V_45 ,
L_6 , V_32 , __LINE__ ) ;
...
return 0 ;
V_47:
F_53 ( V_94 -> V_7 . V_48 . V_55 ) ;
F_53 ( V_94 -> V_7 . V_49 . V_55 ) ;
F_54 ( V_102 ) ;
if ( V_94 -> V_123 )
...
static void
F_55 ( struct V_100 * V_101 , struct V_2 * V_102 )
{
struct V_1 * V_94 = F_1 ( V_102 ) ;
struct V_28 * V_29 ;
F_42 ( V_94 ) ;
...
static int
F_56 ( struct V_2 * V_102 , unsigned V_131 , unsigned V_132 )
{
...
static int
F_60 ( struct V_2 * V_102 , unsigned V_131 )
{
struct V_1 * V_94 = F_1 ( V_102 ) ;
struct V_5 * V_7 = & V_94 -> V_7 ;
if ( V_131 == V_94 -> V_110 )
...
static void
F_61 ( struct V_2 * V_102 )
{
struct V_1 * V_94 = F_1 ( V_102 ) ;
struct V_5 * V_7 = & V_94 -> V_7 ;
F_44 ( & V_7 -> V_48 , V_94 -> V_123 ) ;
V_94 -> V_119 = 0 ;
F_44 ( & V_7 -> V_49 , V_94 -> V_120 ) ;
V_94 -> V_115 = 0 ;
}
static int
F_62 ( struct V_2 * V_102 , const struct V_136 * V_137 )
{
struct V_15 * V_16 = V_102 -> V_133 -> V_104 -> V_16 ;
struct V_1 * V_94 = F_1 ( V_102 ) ;
struct V_5 * V_7 = & V_94 -> V_7 ;
T_4 V_138 = F_63 ( V_137 -> V_139 ) ;
T_4 V_140 = F_63 ( V_137 -> V_141 ) ;
T_4 V_142 = F_63 ( V_137 -> V_143 ) ;
...
V_150 . V_152 = V_72 ;
V_146 = F_64 ( unsigned , V_138 , sizeof V_150 ) ;
memcpy ( V_16 -> V_41 , & V_150 , V_146 ) ;
} else if ( V_145 == V_154 ) {
* ( T_5 * ) V_16 -> V_41 = 1 ;
V_146 = F_64 ( unsigned , V_138 , 1 ) ;
} else {
F_11 ( & V_7 -> V_10 . V_45 ,
L_8 ,
V_32 , __LINE__ , V_145 ) ;
...
static int
F_65 ( struct V_2 * V_102 , const struct V_136 * V_137 )
{
struct V_15 * V_16 = V_102 -> V_133 -> V_104 -> V_16 ;
struct V_1 * V_94 = F_1 ( V_102 ) ;
struct V_5 * V_7 = & V_94 -> V_7 ;
...
V_156 . V_159 = 0 ;
V_156 . V_160 = 1 ;
V_146 = F_64 ( unsigned , V_138 , sizeof V_156 ) ;
...
return F_62 ( V_102 , V_137 ) ;
else if ( V_137 -> V_161 == V_163 )
return F_65 ( V_102 , V_137 ) ;
else
return - V_147 ;
}
static int
...
{
int V_171 ;
V_172 = F_52 ( sizeof *V_172 , V_92 ) ;
if ( V_172 == NULL ) {
F_71 ( V_173 L_9 ) ;
return - V_174 ;
}
V_171 = F_72 ( V_101 -> V_104 , V_175 ) ;
if ( V_171 )
return V_171 ;
...
V_172 -> V_4 . V_201 = F_48 ;
V_172 -> V_4 . V_202 = F_55 ;
V_172 -> V_4 . V_203 = F_56 ;
V_172 -> V_4 . V_204 = F_60 ;
V_172 -> V_4 . V_205 = F_61 ;
V_172 -> V_4 . V_206 = F_69 ;
V_186 . V_207 = F_5 ( V_73 ) ;
V_186 . V_208 = F_73 ( V_73 ) ;
V_189 . V_207 = F_5 ( V_69 ) ;
V_189 . V_208 = F_73 ( V_69 ) ;
V_209 . V_207 = F_5 ( V_73 ) ;
V_209 . V_208 = F_73 ( V_73 ) ;
V_210 . V_207 = F_5 ( V_69 ) ;
V_210 . V_208 = F_73 ( V_69 ) ;
V_211 . V_212 = V_213 ;
V_211 . V_214 = V_213 * 8 ;
V_215 . V_212 = V_216 ;
V_215 . V_214 = V_216 * 8 ;
...
V_171 = F_74 ( V_101 , & V_172 -> V_4 ) ;
if ( V_171 < 0 )
F_53 ( V_172 ) ;
return V_171 ;
}
static void
F_75 ( struct V_100 * V_101 )
{
F_53 ( V_172 ) ;
V_172 = NULL ;
}
