...
if ( V_6 )
goto error;
V_2 -> V_51 = V_7 [ 3 ] * 50 * 1000 ;
exit:
if ( V_22 -> V_34 . V_35 )
V_22 -> V_34 . V_35 ( V_22 , 0 ) ;
return V_6 ;
error:
F_18 ( & V_2 -> V_15 -> V_16 , L_7 , V_30 , V_6 ) ;
goto exit;
}
static int F_20 ( struct V_21 * V_22 , T_2 * V_32 )
{
struct V_1 * V_2 = V_22 -> V_23 ;
* V_32 = V_2 -> V_51 ;
return 0 ;
...
struct V_21 * F_23 ( struct V_21 * V_22 ,
struct V_52 * V_15 , struct V_53 * V_12 )
{
struct V_1 * V_2 = NULL ;
int V_6 ;
T_1 V_4 ;
V_2 = F_24 ( sizeof( struct V_1 ) , V_54 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_12 = V_12 ;
V_2 -> V_15 = V_15 ;
...
V_22 -> V_34 . V_35 ( V_22 , 0 ) ;
if ( ! V_6 )
F_18 ( & V_2 -> V_15 -> V_16 , L_8 , V_30 , V_4 ) ;
if ( V_6 || V_4 != 0xc7 ) {
F_22 ( V_2 ) ;
return NULL ;
}
