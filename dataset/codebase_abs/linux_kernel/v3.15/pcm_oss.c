...
T_1 V_1 ;
V_1 = F_1 () ;
V_130 = F_101 ( V_49 , ( void V_142 V_192 * ) V_186 , V_60 ) ;
F_5 ( V_1 ) ;
} else {
V_130 = F_101 ( V_49 , ( void V_142 V_192 * ) V_186 , V_60 ) ;
}
...
T_8 F_102 ( struct V_20 * V_49 , char * V_186 , T_4 V_60 , int V_187 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
T_8 V_183 ;
int V_130 ;
...
T_1 V_1 ;
V_1 = F_1 () ;
V_130 = F_103 ( V_49 , ( void V_142 V_192 * ) V_186 , V_60 ) ;
F_5 ( V_1 ) ;
} else {
V_130 = F_103 ( V_49 , ( void V_142 V_192 * ) V_186 , V_60 ) ;
}
...
T_8 F_104 ( struct V_20 * V_49 , void * * V_200 , T_4 V_60 , int V_187 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
int V_130 ;
while ( 1 ) {
...
T_1 V_1 ;
V_1 = F_1 () ;
V_130 = F_105 ( V_49 , ( void V_192 * * ) V_200 , V_60 ) ;
F_5 ( V_1 ) ;
} else {
V_130 = F_105 ( V_49 , ( void V_192 * * ) V_200 , V_60 ) ;
}
...
T_8 F_106 ( struct V_20 * V_49 , void * * V_200 , T_4 V_60 , int V_187 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
int V_130 ;
while ( 1 ) {
...
T_1 V_1 ;
V_1 = F_1 () ;
V_130 = F_107 ( V_49 , ( void V_192 * * ) V_200 , V_60 ) ;
F_5 ( V_1 ) ;
} else {
V_130 = F_107 ( V_49 , ( void V_192 * * ) V_200 , V_60 ) ;
}
...
static T_7 F_108 ( struct V_20 * V_49 , const char * V_201 , T_6 V_62 , int V_187 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
T_8 V_60 , V_202 ;
#ifdef F_81
...
if ( ! V_187 ) {
if ( F_109 ( V_51 -> V_55 . V_168 , ( const char V_142 V_192 * ) V_201 , V_62 ) )
return - V_207 ;
V_201 = V_51 -> V_55 . V_168 ;
}
V_60 = V_62 / V_204 ;
V_202 = F_110 ( V_49 , ( char * ) V_201 , V_60 , & V_148 ) ;
if ( V_202 < 0 )
return V_202 ;
V_202 = F_111 ( V_49 , V_148 , V_202 ) ;
if ( V_202 <= 0 )
return V_202 ;
V_62 = V_202 * V_204 ;
} else
...
{
V_60 = F_59 ( V_51 , V_62 ) ;
V_202 = F_99 ( V_49 , V_201 , V_60 , V_187 ) ;
if ( V_202 <= 0 )
return V_202 ;
...
static T_7 F_112 ( struct V_20 * V_49 , const char V_192 * V_201 , T_6 V_62 )
{
T_6 V_208 = 0 ;
T_7 V_209 ;
struct V_50 * V_51 = V_49 -> V_51 ;
if ( F_69 ( & V_49 -> V_112 ) )
return - V_210 ;
if ( ( V_209 = F_97 ( V_49 ) ) < 0 )
return V_209 ;
F_113 ( & V_51 -> V_55 . V_139 ) ;
while ( V_62 > 0 ) {
...
if ( V_209 > 0 ) {
if ( F_109 ( V_51 -> V_55 . V_168 + V_51 -> V_55 . V_170 , V_201 , V_209 ) ) {
V_209 = - V_207 ;
goto V_22;
}
}
...
V_209 = F_108 ( V_49 , V_51 -> V_55 . V_168 + V_51 -> V_55 . V_182 ,
...
static T_7 F_114 ( struct V_20 * V_49 , char * V_201 , T_6 V_62 , int V_187 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
T_8 V_60 , V_202 ;
#ifdef F_81
...
V_201 = V_51 -> V_55 . V_168 ;
V_60 = V_62 / V_204 ;
V_202 = F_110 ( V_49 , V_201 , V_60 , & V_148 ) ;
if ( V_202 < 0 )
return V_202 ;
V_202 = F_115 ( V_49 , V_148 , V_202 ) ;
if ( V_202 <= 0 )
return V_202 ;
V_62 = V_202 * V_204 ;
if ( ! V_187 && F_116 ( V_214 , V_201 , V_62 ) )
return - V_207 ;
} else
#endif
{
V_60 = F_59 ( V_51 , V_62 ) ;
V_202 = F_102 ( V_49 , V_201 , V_60 , V_187 ) ;
if ( V_202 <= 0 )
return V_202 ;
V_62 = F_56 ( V_51 , V_202 ) ;
}
...
static T_7 F_117 ( struct V_20 * V_49 , char V_192 * V_201 , T_6 V_62 )
{
T_6 V_208 = 0 ;
T_7 V_209 ;
struct V_50 * V_51 = V_49 -> V_51 ;
...
V_209 = F_114 ( V_49 , V_51 -> V_55 . V_168 , V_51 -> V_55 . V_124 , 1 ) ;
if ( V_209 <= 0 )
goto V_22;
V_51 -> V_55 . V_62 += V_209 ;
V_51 -> V_55 . V_182 = V_209 ;
...
if ( F_116 ( V_201 , V_51 -> V_55 . V_168 + ( V_51 -> V_55 . V_182 - V_51 -> V_55 . V_170 ) , V_209 ) ) {
V_209 = - V_207 ;
goto V_22;
}
V_201 += V_209 ;
...
V_209 = F_114 ( V_49 , ( char V_142 * ) V_201 ,
V_51 -> V_55 . V_124 , 0 ) ;
if ( V_209 <= 0 )
goto V_22;
V_51 -> V_55 . V_62 += V_209 ;
...
if ( ( V_22 = F_97 ( V_49 ) ) < 0 )
return V_22 ;
F_85 ( V_49 , V_217 , NULL ) ;
}
return 0 ;
}
static int F_120 ( struct V_20 * V_49 , T_6 V_218 )
{
struct V_50 * V_51 ;
T_7 V_219 = 0 ;
T_9 V_189 ;
...
V_51 = V_49 -> V_51 ;
F_121 ( & V_221 , V_222 ) ;
F_122 ( & V_51 -> V_223 , & V_221 ) ;
#ifdef F_100
F_74 ( V_49 -> V_21 , L_19 , V_218 ) ;
#endif
while ( 1 ) {
V_219 = F_108 ( V_49 , V_51 -> V_55 . V_168 , V_218 , 1 ) ;
if ( V_219 > 0 ) {
V_51 -> V_55 . V_170 = 0 ;
V_219 = 0 ;
break;
...
F_129 ( & V_51 -> V_223 , & V_221 ) ;
return V_219 ;
}
static int F_130 ( struct V_173 * V_174 )
{
int V_22 = 0 ;
unsigned int V_229 ;
struct V_20 * V_49 ;
...
V_218 ) ;
V_22 = F_120 ( V_49 , V_51 -> V_55 . V_124 ) ;
if ( V_22 < 0 ) {
F_94 ( & V_51 -> V_55 . V_139 ) ;
return V_22 ;
}
...
static int F_131 ( struct V_173 * V_174 , int V_128 )
{
int V_176 ;
...
static int F_132 ( struct V_173 * V_174 )
{
struct V_20 * V_49 ;
int V_22 ;
...
static int F_133 ( struct V_173 * V_174 , unsigned int V_148 )
{
int V_176 ;
if ( V_148 < 1 )
V_148 = 1 ;
...
static int F_137 ( struct V_173 * V_174 , int V_67 )
{
int V_239 , V_176 ;
if ( V_67 != V_243 ) {
V_239 = F_136 ( V_174 ) ;
...
static int F_138 ( struct V_173 * V_174 )
{
struct V_20 * V_49 ;
int V_22 ;
if ( ( V_22 = F_95 ( V_174 , & V_49 ) ) < 0 )
...
static int F_139 ( struct V_20 * V_49 , int V_244 )
{
struct V_50 * V_51 ;
if ( V_49 == NULL )
return 0 ;
...
static int F_140 ( struct V_173 * V_174 , int V_244 )
{
int V_22 = - V_7 , V_176 ;
for ( V_176 = 1 ; V_176 >= 0 ; -- V_176 ) {
struct V_20 * V_49 = V_174 -> V_178 [ V_176 ] ;
if ( V_49 == NULL )
continue;
if ( ( V_22 = F_139 ( V_49 , V_244 ) ) < 0 )
return V_22 ;
}
return V_22 ;
}
static int F_141 ( struct V_20 * V_49 , unsigned int V_10 )
{
struct V_50 * V_51 ;
if ( V_49 == NULL )
return 0 ;
...
static int F_142 ( struct V_173 * V_174 , unsigned int V_10 )
{
int V_22 = - V_7 , V_176 ;
for ( V_176 = 1 ; V_176 >= 0 ; -- V_176 ) {
struct V_20 * V_49 = V_174 -> V_178 [ V_176 ] ;
if ( V_49 == NULL )
continue;
if ( ( V_22 = F_141 ( V_49 , V_10 ) ) < 0 )
return V_22 ;
}
return V_22 ;
}
static int F_143 ( struct V_245 * V_245 )
{
F_144 ( & V_245 -> V_246 ) ;
V_245 -> V_212 |= V_213 ;
F_145 ( & V_245 -> V_246 ) ;
...
static int F_146 ( struct V_20 * V_49 , int V_220 )
{
if ( V_49 == NULL ) {
V_220 &= ~ V_247 ;
return V_220 ;
...
static int F_149 ( struct V_173 * V_174 )
{
int V_219 , V_176 ;
V_219 = V_254 | V_255 | V_247 | V_250 ;
for ( V_176 = 0 ; V_176 < 2 ; V_176 ++ ) {
struct V_20 * V_49 = V_174 -> V_178 [ V_176 ] ;
V_219 = F_146 ( V_49 , V_219 ) ;
}
V_219 |= 0x0001 ;
return V_219 ;
}
static void F_150 ( struct V_20 * V_49 ,
T_4 V_256 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
T_4 V_233 ;
...
static int F_151 ( struct V_173 * V_174 , int V_155 )
{
struct V_50 * V_51 ;
struct V_20 * V_257 = NULL , * V_258 = NULL ;
int V_22 , V_259 ;
#ifdef F_100
F_74 ( V_49 -> V_21 , L_23 , V_155 ) ;
#endif
V_257 = V_174 -> V_178 [ V_152 ] ;
V_258 = V_174 -> V_178 [ V_158 ] ;
if ( V_257 ) {
if ( ( V_22 = F_97 ( V_257 ) ) < 0 )
return V_22 ;
}
if ( V_258 ) {
if ( ( V_22 = F_97 ( V_258 ) ) < 0 )
return V_22 ;
}
if ( V_257 ) {
V_51 = V_257 -> V_51 ;
...
static int F_152 ( struct V_173 * V_174 )
{
struct V_20 * V_257 = NULL , * V_258 = NULL ;
int V_219 = 0 ;
V_257 = V_174 -> V_178 [ V_152 ] ;
...
static int F_154 ( struct V_173 * V_174 , int V_151 , struct V_264 V_192 * V_265 )
{
struct V_20 * V_49 ;
struct V_50 * V_51 ;
T_8 V_183 ;
...
if ( F_116 ( V_265 , & V_251 , sizeof( V_251 ) ) )
return - V_207 ;
return 0 ;
}
if ( V_151 == V_152 ) {
...
static int F_155 ( struct V_173 * V_174 , int V_151 , struct V_269 V_192 * V_265 )
{
struct V_20 * V_49 ;
struct V_50 * V_51 ;
T_8 V_270 ;
...
static int F_156 ( struct V_173 * V_174 , int V_151 , struct V_274 V_192 * V_265 )
{
return - V_7 ;
}
static const char * F_157 ( const char * V_275 )
{
...
static void F_158 ( struct V_277 * V_21 , int V_151 ,
const char * V_278 ,
struct V_279 * V_280 )
{
struct V_279 * V_114 ;
F_113 ( & V_21 -> V_178 [ V_151 ] . V_55 . V_281 ) ;
do {
...
} while ( ( V_278 = F_157 ( V_278 ) ) != NULL );
V_283:
if ( V_114 )
* V_280 = * V_114 ;
F_94 ( & V_21 -> V_178 [ V_151 ] . V_55 . V_281 ) ;
}
static void F_159 ( struct V_20 * V_49 )
{
struct V_50 * V_51 ;
V_51 = V_49 -> V_51 ;
F_90 ( V_51 -> V_55 . V_168 ) ;
...
static int F_165 ( struct V_245 * V_245 ,
struct V_277 * V_21 ,
struct V_173 * * V_291 ,
int V_284 ,
struct V_279 * V_114 )
...
V_22 = F_167 ( V_21 , V_176 , V_245 , & V_49 ) ;
if ( V_22 < 0 ) {
F_163 ( V_174 ) ;
return V_22 ;
}
...
static int F_168 ( struct V_300 * V_301 , char * V_302 , T_6 V_218 )
{
unsigned int V_176 ;
...
static int F_169 ( struct V_304 * V_304 , struct V_245 * V_245 )
{
int V_22 ;
char V_278 [ 32 ] ;
struct V_277 * V_21 ;
...
int V_285 ;
T_10 V_221 ;
V_22 = F_170 ( V_304 , V_245 ) ;
if ( V_22 < 0 )
return V_22 ;
V_21 = F_171 ( F_172 ( V_304 ) ,
V_305 ) ;
if ( V_21 == NULL ) {
V_22 = - V_306 ;
goto V_307;
}
V_22 = F_173 ( V_21 -> V_308 , V_245 ) ;
if ( V_22 < 0 )
goto V_307;
if ( ! F_174 ( V_21 -> V_308 -> V_309 ) ) {
V_22 = - V_207 ;
goto V_310;
}
if ( F_168 ( V_222 , V_278 , sizeof( V_278 ) ) < 0 ) {
V_22 = - V_207 ;
goto V_311;
}
...
V_285 = V_312 ;
F_121 ( & V_221 , V_222 ) ;
F_122 ( & V_21 -> V_313 , & V_221 ) ;
F_113 ( & V_21 -> V_314 ) ;
while ( 1 ) {
V_22 = F_165 ( V_245 , V_21 , & V_174 ,
F_172 ( V_304 ) , V_114 ) ;
if ( V_22 >= 0 )
break;
if ( V_22 == - V_196 ) {
...
return V_22 ;
V_311:
F_177 ( V_21 -> V_308 -> V_309 ) ;
V_310:
F_178 ( V_21 -> V_308 , V_245 ) ;
V_307:
if ( V_21 )
F_176 ( V_21 -> V_308 ) ;
return V_22 ;
}
static int F_179 ( struct V_304 * V_304 , struct V_245 * V_245 )
{
struct V_277 * V_21 ;
struct V_20 * V_49 ;
struct V_173 * V_174 ;
...
static long F_181 ( struct V_245 * V_245 , unsigned int V_259 , unsigned long V_317 )
{
struct V_173 * V_174 ;
...
V_174 = V_245 -> V_299 ;
if ( V_259 == V_319 )
return F_182 ( V_320 , V_318 ) ;
if ( V_259 == V_321 )
return F_182 ( 1 , V_318 ) ;
#if F_148 ( V_322 ) || ( F_148 ( V_323 ) && F_148 ( V_324 ) )
if ( ( ( V_259 >> 8 ) & 0xff ) == 'M' ) {
struct V_20 * V_49 ;
int V_176 ;
for ( V_176 = 0 ; V_176 < 2 ; ++ V_176 ) {
...
if ( F_43 ( V_176 >= 2 ) )
return - V_210 ;
return F_183 ( V_49 -> V_21 -> V_308 , V_259 , V_317 ) ;
}
#endif
if ( ( ( V_259 >> 8 ) & 0xff ) != 'P' )
return - V_7 ;
...
return F_130 ( V_174 ) ;
case V_327 :
if ( F_185 ( V_220 , V_318 ) )
return - V_207 ;
if ( ( V_220 = F_131 ( V_174 , V_220 ) ) < 0 )
return V_220 ;
return F_182 ( V_220 , V_318 ) ;
case V_328 :
V_220 = F_132 ( V_174 ) ;
if ( V_220 < 0 )
return V_220 ;
...
static T_7 F_186 ( struct V_245 * V_245 , char V_192 * V_201 , T_6 V_355 , T_12 * V_356 )
{
struct V_173 * V_174 ;
struct V_20 * V_49 ;
V_174 = V_245 -> V_299 ;
...
#ifndef F_100
return F_117 ( V_49 , V_201 , V_355 ) ;
#else
{
T_7 V_220 = F_117 ( V_49 , V_201 , V_355 ) ;
F_74 ( V_49 -> V_21 ,
L_27 ,
...
static T_7 F_187 ( struct V_245 * V_245 , const char V_192 * V_201 , T_6 V_355 , T_12 * V_356 )
{
struct V_173 * V_174 ;
struct V_20 * V_49 ;
long V_219 ;
...
static unsigned int F_192 ( struct V_245 * V_245 , T_13 * V_221 )
{
struct V_173 * V_174 ;
unsigned int V_138 ;
struct V_20 * V_257 = NULL , * V_258 = NULL ;
...
static int F_194 ( struct V_245 * V_245 , struct V_363 * V_364 )
{
struct V_173 * V_174 ;
...
static void F_196 ( struct V_373 * V_374 ,
struct V_375 * V_168 )
{
struct V_376 * V_248 = V_374 -> V_299 ;
struct V_279 * V_114 = V_248 -> V_55 . V_282 ;
F_113 ( & V_248 -> V_55 . V_281 ) ;
while ( V_114 ) {
F_197 ( V_168 , L_31 ,
V_114 -> V_278 ,
V_114 -> V_121 ,
V_114 -> V_115 ,
V_114 -> V_298 ? L_32 : L_33 ,
V_114 -> V_134 ? L_34 : L_33 ,
V_114 -> V_286 ? L_35 : L_33 ,
V_114 -> V_285 ? L_36 : L_33 ,
V_114 -> V_211 ? L_37 : L_33 ,
V_114 -> V_164 ? L_38 : L_33 ) ;
V_114 = V_114 -> V_54 ;
}
F_94 ( & V_248 -> V_55 . V_281 ) ;
}
static void F_198 ( struct V_376 * V_248 )
{
...
static void F_199 ( struct V_373 * V_374 ,
struct V_375 * V_168 )
{
struct V_376 * V_248 = V_374 -> V_299 ;
...
V_186 = F_201 ( V_278 , line , sizeof( V_278 ) ) ;
if ( ! strcmp ( V_278 , L_39 ) || ! strcmp ( V_278 , L_40 ) ) {
F_198 ( V_248 ) ;
F_94 ( & V_248 -> V_55 . V_281 ) ;
continue;
}
...
V_186 = F_201 ( V_378 , V_186 , sizeof( V_378 ) ) ;
V_381 . V_121 = F_202 ( V_378 , NULL , 10 ) ;
V_186 = F_201 ( V_378 , V_186 , sizeof( V_378 ) ) ;
V_381 . V_115 = F_202 ( V_378 , NULL , 10 ) ;
...
static void F_204 ( struct V_277 * V_21 )
{
int V_151 ;
...
if ( V_248 -> V_249 == 0 )
continue;
if ( ( V_374 = F_205 ( V_21 -> V_308 , L_48 , V_248 -> V_382 ) ) != NULL ) {
V_374 -> V_383 = V_384 ;
V_374 -> V_385 = V_386 | V_387 | V_388 ;
V_374 -> V_28 . V_389 . V_390 = F_196 ;
V_374 -> V_28 . V_389 . V_391 = F_199 ;
V_374 -> V_299 = V_248 ;
if ( F_206 ( V_374 ) < 0 ) {
F_207 ( V_374 ) ;
V_374 = NULL ;
...
static void F_208 ( struct V_277 * V_21 )
{
int V_151 ;
for ( V_151 = 0 ; V_151 < 2 ; ++ V_151 ) {
struct V_376 * V_248 = & V_21 -> V_178 [ V_151 ] ;
F_207 ( V_248 -> V_55 . V_392 ) ;
V_248 -> V_55 . V_392 = NULL ;
F_198 ( V_248 ) ;
}
}
static void F_209 ( struct V_277 * V_21 , int V_393 )
{
if ( F_210 ( V_305 ,
...
static int F_211 ( struct V_277 * V_21 )
{
V_21 -> V_55 . V_397 = 0 ;
...
! ( V_21 -> V_295 & V_296 ) ) ;
sprintf ( V_302 , L_50 , V_21 -> V_302 , V_399 ? L_51 : L_33 ) ;
#ifdef F_212
F_213 ( F_212 ,
V_21 -> V_308 -> V_395 ,
V_302 ) ;
...
static int F_214 ( struct V_277 * V_21 )
{
if ( V_21 -> V_55 . V_397 ) {
...
static int F_217 ( struct V_277 * V_21 )
{
F_214 ( V_21 ) ;
F_208 ( V_21 ) ;
return 0 ;
...
if ( ( V_22 = F_220 ( & V_404 , 0 ) ) < 0 )
return V_22 ;
return 0 ;
}
static void T_15 F_221 ( void )
{
F_220 ( & V_404 , 1 ) ;
}
