...
F_12 ( V_10 , V_49 ,
V_143 , V_143 ) ;
F_6 ( V_10 , V_144 , 0x50 | ( 1 << 8 ) ) ;
F_6 ( V_10 , V_145 , 0x50 | ( 1 << 8 ) ) ;
return 0 ;
}
...
static int F_30 ( struct V_146 * V_147 ,
const struct V_148 * V_149 )
{
struct V_62 * V_63 ;
int V_14 ;
V_63 = F_31 ( & V_147 -> V_2 , sizeof( struct V_62 ) ,
V_150 ) ;
if ( V_63 == NULL )
return - V_151 ;
F_32 ( V_147 , V_63 ) ;
...
static int F_34 ( struct V_146 * V_154 )
{
F_35 ( & V_154 -> V_2 ) ;
return 0 ;
}
