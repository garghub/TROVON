...
V_192 -> V_19 . type = F_3 ( V_226 ) ;
V_192 -> V_19 . V_12 =
F_3 ( sizeof( struct V_227 ) ) ;
V_119 = F_20 (
V_2 -> V_8 -> V_111 ) ;
...
V_228 ) {
V_54 V_229 ;
V_229 = F_16 ( V_192 -> V_192 . V_140 ) ;
V_229 &= ~ V_230 ;
V_229 &= ~ V_231 ;
V_192 -> V_192 . V_140 = F_3 ( V_229 ) ;
}
V_78 += sizeof( struct V_191 ) ;
V_190 += sizeof( struct V_191 ) ;
V_194 = (struct V_193 * ) V_78 ;
memset ( V_194 , 0 , sizeof( struct V_193 ) ) ;
V_194 -> V_19 . type = F_3 ( V_232 ) ;
V_194 -> V_19 . V_12 =
F_3 ( sizeof( struct V_233 ) ) ;
V_194 -> V_234 . V_235 =
( T_1 ) V_2 -> V_99 . V_156 . V_157 ;
if ( V_8 -> V_221 ) {
V_194 -> V_234 . V_236 = V_8 -> V_221 ;
V_194 -> V_234 . V_236 |=
V_237 ;
}
V_194 -> V_234 . V_238 =
F_3 ( V_239 ) ;
V_194 -> V_234 . V_240 [ 0 ] = 0xff ;
...
V_2 -> V_81 = V_15 ;
V_58 -> V_79 = F_3 ( V_244 ) ;
V_242 -> V_156 . V_197 = V_198 ;
V_242 -> V_156 . V_85
= F_3 ( V_15 -> V_85 ) ;
memcpy ( & V_242 -> V_156 . V_245 ,
& V_15 -> V_83 , V_246 ) ;
memcpy ( & V_242 -> V_156 . V_89 ,
& V_15 -> V_89 . V_89 , V_15 -> V_89 . V_90 ) ;
memcpy ( & V_242 -> V_156 . V_94 ,
& V_15 -> V_94 ,
sizeof( union V_205 ) ) ;
memcpy ( & V_242 -> V_156 . V_206 ,
...
;
V_76 = V_30 ;
memset ( V_242 -> V_156 . V_101 , 0 ,
sizeof( V_242 -> V_156 . V_101 ) ) ;
memcpy ( V_242 -> V_156 . V_101 ,
V_15 -> V_42 , V_76 ) ;
V_2 -> V_99 . V_100 = V_76 ;
...
V_224 , & V_78 ) ;
V_58 -> V_130 = F_3
( ( V_54 ) ( sizeof( struct V_241 )
+ V_131 + V_190 ) ) ;
V_242 -> V_156 . V_86 = F_3 ( V_77 ) ;
return 0 ;
}
...
struct V_14 * V_15 ;
V_54 V_249 ;
V_248 = & V_135 -> V_61 . V_248 ;
V_15 = V_2 -> V_81 ;
V_249 = F_16 ( V_135 -> V_250 ) ;
if ( V_249 ) {
...
V_2 -> V_99 . V_158 ) ;
return F_42 ( V_2 , V_244 ,
V_220 , 0 , V_15 , true ) ;
}
static int F_55 ( struct V_1 * V_2 , T_1 * V_258 )
{
T_1 V_83 [ V_246 ] ;
int V_27 ;
if ( ! V_258 || F_56 ( V_258 ) )
...
memcpy ( V_83 , V_258 , V_246 ) ;
V_27 = F_42 ( V_2 , V_259 ,
V_220 , 0 , V_83 , true ) ;
return V_27 ;
}
int F_57 ( struct V_1 * V_2 , T_1 * V_258 )
{
int V_27 = 0 ;
if ( ! V_2 -> V_151 )
return 0 ;
...
struct V_1 * V_2 ;
int V_30 ;
for ( V_30 = 0 ; V_30 < V_8 -> V_264 ; V_30 ++ ) {
V_2 = V_8 -> V_2 [ V_30 ] ;
if ( V_2 )
F_57 ( V_2 , NULL ) ;
}
