...
int
F_79 ( struct V_10 * V_6 , int V_337 )
{
struct F_3 * V_9 ;
int V_256 , V_291 ;
V_9 = F_80 ( sizeof( * V_9 ) , V_338 ) ;
if ( ! V_9 )
return - V_339 ;
for ( V_291 = 0 ; V_291 < 256 ; V_291 ++ ) {
...
V_9 -> V_5 = V_337 ;
V_9 -> V_65 = V_271 ;
F_81 ( V_6 , & V_9 -> V_283 , & V_340 ) ;
F_82 ( & V_9 -> V_283 , & V_341 ) ;
F_83 ( & V_9 -> V_283 , 256 ) ;
