...
V_9 -> V_9 . V_34 = V_44 ;
V_9 -> V_9 . V_35 = V_35 ;
V_9 -> V_9 . V_36 = V_38 -> V_36 ;
V_9 -> V_9 . V_14 = V_45 ;
V_9 -> V_9 . V_37 = V_31 ;
V_9 -> V_38 = V_38 ;
V_19 = 0 ;
V_31 = 0 ;
F_16 (umem->sg_head.sgl, sg, umem->nmap, entry) {
void * V_40 ;
V_40 = F_17 ( F_18 ( V_51 ) ) ;
if ( ! V_40 ) {
V_10 = F_5 ( - V_52 ) ;
...
int F_19 ( struct V_4 * V_15 )
{
struct V_8 * V_9 = F_20 ( V_15 ) ;
int V_20 ;
F_21 ( & F_11 ( V_15 -> V_32 ) -> V_18 , V_15 -> V_26 ) ;
V_20 = V_9 -> V_9 . V_24 ;
while ( V_20 ) {
V_20 -- ;
F_9 ( V_9 -> V_9 . V_22 [ V_20 ] ) ;
...
struct V_2 * F_22 ( struct V_5 * V_6 , int V_45 ,
struct V_57 * V_58 )
{
struct V_1 * V_59 ;
int V_19 , V_20 = 0 ;
...
int F_23 ( struct V_2 * V_3 , T_1 * V_62 ,
int V_63 , T_1 V_34 )
{
...
struct V_1 * V_59 = F_1 ( V_3 ) ;
int V_20 ;
F_21 ( & F_11 ( V_3 -> V_32 ) -> V_18 , V_3 -> V_26 ) ;
V_20 = V_59 -> V_9 . V_24 ;
while ( V_20 )
F_9 ( V_59 -> V_9 . V_22 [ -- V_20 ] ) ;
F_9 ( V_59 ) ;
