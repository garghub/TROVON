...
static int F_38 ( struct V_122 * V_38 )
{
struct V_9 * V_9 = F_39 ( V_38 ) ;
struct V_5 * V_6 = F_40 ( V_38 ) ;
int V_10 ;
F_11 ( & V_6 -> V_16 -> V_17 , L_13 , V_27 ) ;
if ( ! V_9 -> V_47 [ V_38 -> V_123 ] . V_93 ) {
V_10 = - V_86 ;
goto V_56;
}
V_38 -> V_124 [ 0 ] = F_41 ( V_125 , & V_9 -> V_47 [ V_38 -> V_123 ] ,
& V_6 -> V_126 , & V_9 -> V_127 ) ;
if ( V_38 -> V_124 [ 0 ] == NULL ) {
V_10 = - V_86 ;
goto V_56;
}
V_38 -> V_124 [ 0 ] -> V_127 . V_128 = NULL ;
V_38 -> V_124 [ 0 ] -> V_129 = F_36 ;
return 0 ;
V_56:
F_11 ( & V_6 -> V_16 -> V_17 , L_4 , V_27 , V_10 ) ;
return V_10 ;
}
static int F_42 ( struct V_122 * V_38 )
{
struct V_9 * V_9 = F_39 ( V_38 ) ;
struct V_5 * V_6 = F_40 ( V_38 ) ;
int V_10 ;
...
T_2 V_131 ;
F_11 ( & V_6 -> V_16 -> V_17 , L_13 , V_27 ) ;
switch ( V_9 -> V_47 [ V_38 -> V_123 ] . V_93 ) {
case V_99 :
...
if ( V_10 < 0 )
goto V_56;
V_124 = F_41 ( V_132 , V_38 -> V_124 [ 0 ] ,
& V_6 -> V_126 , & V_133 ) ;
break;
case V_100 :
V_124 = F_41 ( V_134 , V_38 -> V_124 [ 0 ] ,
& V_6 -> V_126 , & V_135 ) ;
break;
case V_101 :
if ( V_38 -> V_123 == 0 ) {
...
V_124 = F_41 ( V_136 , V_38 -> V_124 [ 0 ] , & V_6 -> V_126 ,
V_131 , & V_137 [ V_38 -> V_123 ] ) ;
break;
case V_102 :
V_124 = F_41 ( V_138 , V_38 -> V_124 [ 0 ] ,
& V_6 -> V_126 , & V_139 ) ;
break;
case V_103 :
...
V_40 [ 0 ] . V_2 = 2 ;
V_40 [ 0 ] . V_1 = L_26 ;
V_10 = F_44 ( & V_6 -> V_126 , V_40 , 1 ) ;
if ( V_10 < 0 )
goto V_56;
}
F_30 ( 10000 , 50000 ) ;
V_124 = F_41 ( V_142 , V_38 -> V_124 [ 0 ] , & V_6 -> V_126 ,
& V_143 [ V_38 -> V_123 ] ) ;
break;
case V_95 :
case V_106 :
...
case V_108 :
case V_109 :
V_124 = F_41 ( V_144 , V_38 -> V_124 [ 0 ] , & V_6 -> V_126 ,
V_9 -> V_47 [ V_38 -> V_123 ] . V_48 ,
V_9 -> V_47 [ 0 ] . V_93 ) ;
break;
default:
V_124 = NULL ;
...
struct V_9 * V_9 = F_7 ( V_6 ) ;
int V_10 , V_3 ;
T_1 V_145 = ( V_6 -> V_16 -> V_146 == V_147 ? 5 : 87 ) * 188 / 4 ;
T_2 V_148 = ( V_6 -> V_16 -> V_146 == V_147 ? 64 : 512 ) / 4 ;
struct V_149 V_150 [] = {
{ 0x80f99d , 0x01 , 0x01 } ,
{ 0x80f9a4 , 0x01 , 0x01 } ,
{ 0x00dd11 , 0x00 , 0x20 } ,
...
F_11 ( & V_6 -> V_16 -> V_17 ,
L_27 ,
V_27 , V_6 -> V_16 -> V_146 , V_145 , V_148 ) ;
...
static int F_49 ( struct V_130 * V_124 , T_2 * V_164 ,
struct V_165 * V_166 )
{
struct V_5 * V_6 = F_50 ( V_124 ) ;
F_11 ( & V_6 -> V_16 -> V_17 , L_31 , V_27 , F_51 ( V_124 ) -> V_123 ) ;
if ( V_6 -> V_16 -> V_146 == V_147 )
V_166 -> V_167 . V_168 . V_169 = 5 * 188 ;
return 0 ;
}
static int F_52 ( struct V_122 * V_38 , int V_170 )
{
struct V_9 * V_9 = F_39 ( V_38 ) ;
return V_9 -> V_127 . V_171 ( V_38 -> V_124 [ 0 ] , V_170 ) ;
}
static int F_53 ( struct V_122 * V_38 , int V_172 , T_1 V_173 ,
int V_170 )
{
struct V_9 * V_9 = F_39 ( V_38 ) ;
return V_9 -> V_127 . V_174 ( V_38 -> V_124 [ 0 ] , V_172 , V_173 , V_170 ) ;
}
static int F_54 ( struct V_175 * V_176 ,
const struct V_177 * V_123 )
{
struct V_178 * V_16 = F_55 ( V_176 ) ;
char V_179 [ sizeof( L_32 ) ] ;
memset ( V_179 , 0 , sizeof( V_179 ) ) ;
F_56 ( V_16 , V_16 -> V_180 . V_181 ,
V_179 , sizeof( V_179 ) ) ;
if ( ( F_57 ( V_16 -> V_180 . V_182 ) == V_183 ) &&
( F_57 ( V_16 -> V_180 . V_184 ) == 0x0099 ) ) {
if ( ! strcmp ( L_32 , V_179 ) ) {
F_11 ( & V_16 -> V_17 , L_33 , V_27 ) ;
return - V_86 ;
}
}
return F_58 ( V_176 , V_123 ) ;
}
