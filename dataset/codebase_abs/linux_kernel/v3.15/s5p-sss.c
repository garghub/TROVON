...
if ( V_92 )
return - V_102 ;
V_98 = F_48 ( V_2 , sizeof( * V_98 ) , V_103 ) ;
if ( ! V_98 )
return - V_20 ;
V_101 = F_49 ( V_24 , V_104 , 0 ) ;
V_98 -> V_38 = F_50 ( & V_24 -> V_2 , V_101 ) ;
if ( F_51 ( V_98 -> V_38 ) )
return F_52 ( V_98 -> V_38 ) ;
V_98 -> V_105 = F_53 ( V_2 , L_2 ) ;
if ( F_51 ( V_98 -> V_105 ) ) {
F_54 ( V_2 , L_3 ) ;
return - V_106 ;
}
F_55 ( V_98 -> V_105 ) ;
F_56 ( & V_98 -> V_27 ) ;
V_98 -> V_107 = F_57 ( V_24 , L_4 ) ;
if ( V_98 -> V_107 < 0 ) {
V_9 = V_98 -> V_107 ;
F_58 ( V_2 , L_5 ) ;
goto V_108;
}
V_9 = F_59 ( V_2 , V_98 -> V_107 , F_18 ,
V_109 , V_24 -> V_110 , V_24 ) ;
if ( V_9 < 0 ) {
F_58 ( V_2 , L_5 ) ;
goto V_108;
}
V_98 -> V_28 = F_57 ( V_24 , L_6 ) ;
if ( V_98 -> V_28 < 0 ) {
V_9 = V_98 -> V_28 ;
F_58 ( V_2 , L_7 ) ;
goto V_108;
}
V_9 = F_59 ( V_2 , V_98 -> V_28 , F_18 ,
V_109 , V_24 -> V_110 , V_24 ) ;
if ( V_9 < 0 ) {
F_58 ( V_2 , L_7 ) ;
goto V_108;
...
F_60 ( V_24 , V_98 ) ;
V_92 = V_98 ;
F_61 ( & V_98 -> V_85 , F_27 , ( unsigned long ) V_98 ) ;
F_62 ( & V_98 -> V_81 , V_111 ) ;
for ( V_95 = 0 ; V_95 < F_63 ( V_112 ) ; V_95 ++ ) {
V_9 = F_64 ( & V_112 [ V_95 ] ) ;
if ( V_9 )
goto V_113;
}
...
return 0 ;
V_113:
F_54 ( V_2 , L_9 , V_112 [ V_95 ] . V_114 , V_9 ) ;
