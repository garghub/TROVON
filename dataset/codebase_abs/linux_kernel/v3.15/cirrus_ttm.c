...
int F_43 ( struct V_80 * V_66 , int V_15 , int V_98 ,
T_1 V_34 , struct V_27 * * V_99 )
{
struct V_1 * V_9 = V_66 -> V_100 ;
struct V_27 * V_49 ;
T_3 V_101 ;
int V_79 ;
...
return F_54 ( V_53 , V_112 ) ;
V_114 = V_53 -> V_116 ;
V_9 = V_114 -> V_117 -> V_66 -> V_100 ;
return F_55 ( V_53 , V_112 , & V_9 -> V_4 . V_5 ) ;
}
