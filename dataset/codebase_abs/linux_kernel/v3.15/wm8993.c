...
F_24 ( V_136 , V_84 ,
V_300 , 0 ) ;
F_24 ( V_136 , V_71 , V_301 , 0 ) ;
F_45 ( V_136 , V_140 -> V_197 . V_198 ,
V_140 -> V_197 . V_199 ,
V_140 -> V_197 . V_302 ,
V_140 -> V_197 . V_303 ,
V_140 -> V_197 . V_304 ,
...
F_6 ( V_312 ) ) ;
F_48 ( V_136 ) ;
F_49 ( V_188 , V_313 , F_6 ( V_313 ) ) ;
F_50 ( V_136 , V_140 -> V_197 . V_198 ,
V_140 -> V_197 . V_199 ) ;
...
static int F_54 ( struct V_141 * V_142 ,
const struct V_315 * V_316 )
{
struct V_139 * V_140 ;
unsigned int V_3 ;
int V_147 , V_123 ;
V_140 = F_55 ( & V_142 -> V_2 , sizeof( struct V_139 ) ,
V_317 ) ;
if ( V_140 == NULL )
return - V_318 ;
V_140 -> V_2 = & V_142 -> V_2 ;
F_56 ( & V_140 -> V_163 ) ;
V_140 -> V_192 = F_57 ( V_142 , & V_319 ) ;
if ( F_58 ( V_140 -> V_192 ) ) {
V_147 = F_59 ( V_140 -> V_192 ) ;
F_14 ( & V_142 -> V_2 , L_32 , V_147 ) ;
return V_147 ;
}
F_60 ( V_142 , V_140 ) ;
for ( V_123 = 0 ; V_123 < F_6 ( V_140 -> V_191 ) ; V_123 ++ )
V_140 -> V_191 [ V_123 ] . V_320 = V_321 [ V_123 ] ;
V_147 = F_61 ( & V_142 -> V_2 , F_6 ( V_140 -> V_191 ) ,
V_140 -> V_191 ) ;
if ( V_147 != 0 ) {
...
if ( V_147 != 0 )
goto V_322;
V_147 = F_62 ( V_140 -> V_192 , V_323 ,
F_6 ( V_323 ) ) ;
if ( V_147 != 0 )
F_18 ( V_140 -> V_2 , L_37 ,
V_147 ) ;
if ( V_142 -> V_162 ) {
V_147 = F_63 ( V_140 -> V_192 , V_26 ,
V_324 |
V_325 , 7 ) ;
if ( V_147 != 0 )
goto V_322;
V_147 = F_64 ( V_142 -> V_162 , NULL , F_39 ,
V_326 | V_327 ,
L_38 , V_140 ) ;
if ( V_147 != 0 )
goto V_322;
