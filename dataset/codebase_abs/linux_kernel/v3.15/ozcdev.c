...
V_14 = F_51 ( V_94 , NULL , V_23 . V_88 , NULL , L_7 ) ;
if ( F_49 ( V_14 ) ) {
F_7 ( V_9 , L_12 ) ;
V_86 = F_50 ( V_14 ) ;
goto V_95;
...
int F_60 ( struct V_2 * V_3 , int V_96 )
{
struct V_1 * V_4 ;
struct V_1 * V_97 ;
if ( V_96 ) {
...
V_4 = F_61 ( sizeof( struct V_1 ) , V_98 ) ;
if ( V_4 == NULL )
return - V_99 ;
F_62 ( & V_4 -> V_8 , 1 ) ;
V_4 -> V_53 = 1 ;
...
void F_64 ( struct V_2 * V_3 , int V_101 )
{
struct V_1 * V_4 ;
if ( V_101 ) {
F_7 ( V_9 , L_16 ) ;
