...
struct V_8 * V_9 = F_2 ( V_7 ) ;
bool V_41 = V_34 -> V_42 == V_43 ;
T_1 V_44 = V_9 -> V_10 / F_7 ( V_36 ) ;
...
V_47 = V_49 ;
V_12 = V_48 [ V_45 ] . V_50 ;
V_46 = V_9 -> V_31 ? V_51 : V_48 [ V_45 ] . V_52 ;
F_5 ( V_9 -> V_25 , V_53 ,
F_9 ( V_41 ) | V_47 ,
F_10 ( V_41 , V_46 ) | V_12 ) ;
return 0 ;
}
static int F_11 ( struct V_1 * V_37 , int V_54 )
{
...
static bool F_12 ( struct V_57 * V_23 , unsigned int V_58 )
{
switch ( V_58 ) {
case V_59 :
return true ;
...
static bool F_13 ( struct V_57 * V_23 , unsigned int V_58 )
{
switch ( V_58 ) {
case V_60 :
case V_59 :
...
F_18 ( V_9 -> V_25 , V_55 , V_56 ) ;
return 0 ;
}
int F_19 ( struct V_57 * V_23 , struct V_25 * V_25 )
{
const struct V_68 * V_69 = F_20 ( V_70 , V_23 ) ;
struct V_8 * V_9 ;
int V_71 , V_12 , V_45 ;
V_9 = F_21 ( V_23 , sizeof( * V_9 ) , V_72 ) ;
if ( V_9 == NULL )
return - V_73 ;
F_22 ( V_23 , V_9 ) ;
if ( V_69 )
