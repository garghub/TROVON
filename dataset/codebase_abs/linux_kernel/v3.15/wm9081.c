...
static int F_36 ( struct V_231 * V_232 ,
const struct V_233 * V_234 )
{
struct V_96 * V_97 ;
unsigned int V_3 ;
int V_101 ;
V_97 = F_37 ( & V_232 -> V_2 , sizeof( struct V_96 ) ,
V_235 ) ;
if ( V_97 == NULL )
return - V_236 ;
F_38 ( V_232 , V_97 ) ;
V_97 -> V_59 = F_39 ( V_232 , & V_237 ) ;
if ( F_40 ( V_97 -> V_59 ) ) {
V_101 = F_41 ( V_97 -> V_59 ) ;
F_18 ( & V_232 -> V_2 , L_22 , V_101 ) ;
return V_101 ;
}
V_101 = F_42 ( V_97 -> V_59 , V_4 , & V_3 ) ;
if ( V_101 != 0 ) {
F_18 ( & V_232 -> V_2 , L_23 , V_101 ) ;
return V_101 ;
}
if ( V_3 != 0x9081 ) {
F_18 ( & V_232 -> V_2 , L_24 , V_3 ) ;
return - V_72 ;
}
V_101 = F_3 ( V_97 -> V_59 ) ;
if ( V_101 < 0 ) {
...
if ( F_43 ( & V_232 -> V_2 ) )
memcpy ( & V_97 -> V_207 , F_43 ( & V_232 -> V_2 ) ,
sizeof( V_97 -> V_207 ) ) ;
V_3 = 0 ;
if ( V_97 -> V_207 . V_238 )
V_3 |= V_239 ;
...
V_239 | V_241 , V_3 ) ;
F_23 ( V_97 -> V_59 , true ) ;
V_101 = F_45 ( & V_232 -> V_2 ,
& V_242 , & V_243 , 1 ) ;
if ( V_101 < 0 )
return V_101 ;
return 0 ;
}
static int F_46 ( struct V_231 * V_244 )
{
F_47 ( & V_244 -> V_2 ) ;
return 0 ;
}
