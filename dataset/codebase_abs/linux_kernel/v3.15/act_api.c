...
V_4 -> V_57 . V_60 = V_59 ;
if ( V_51 ) {
int V_26 = F_33 ( & V_4 -> V_11 , & V_4 -> V_12 ,
& V_4 -> V_56 , V_51 ) ;
if ( V_26 ) {
F_34 ( V_4 ) ;
return V_26 ;
...
if ( V_26 < 0 )
goto V_90;
if ( F_78 ( & V_109 , & V_4 -> V_11 ) < 0 ||
F_79 ( & V_109 , & V_4 -> V_11 ,
& V_4 -> V_12 ) < 0 ||
F_80 ( & V_109 , & V_4 -> V_114 ) < 0 )
goto V_90;
if ( F_81 ( & V_109 ) < 0 )
goto V_90;
return 0 ;
...
static int
F_82 ( struct V_20 * V_21 , struct V_74 * V_75 , T_1 V_115 , T_1 V_116 ,
T_2 V_117 , int V_118 , int V_14 , int V_87 )
{
struct V_119 * V_120 ;
struct V_121 * V_122 ;
unsigned char * V_88 = F_60 ( V_21 ) ;
struct V_31 * V_32 ;
V_122 = F_83 ( V_21 , V_115 , V_116 , V_118 , sizeof( * V_120 ) , V_117 ) ;
if ( ! V_122 )
goto V_123;
V_120 = F_84 ( V_122 ) ;
V_120 -> V_124 = V_125 ;
V_120 -> V_126 = 0 ;
V_120 -> V_127 = 0 ;
V_32 = F_11 ( V_21 , V_128 ) ;
if ( V_32 == NULL )
goto V_123;
if ( F_62 ( V_21 , V_75 , V_14 , V_87 ) < 0 )
goto V_123;
F_14 ( V_21 , V_32 ) ;
V_122 -> V_129 = F_60 ( V_21 ) - V_88 ;
return V_21 -> V_130 ;
V_123:
F_13 ( V_21 , V_88 ) ;
return - 1 ;
...
static int
F_85 ( struct V_91 * V_91 , T_1 V_115 , struct V_121 * V_40 ,
struct V_74 * V_75 , int V_118 )
{
struct V_20 * V_21 ;
V_21 = F_86 ( V_131 , V_54 ) ;
if ( ! V_21 )
return - V_132 ;
if ( F_82 ( V_21 , V_75 , V_115 , V_40 -> V_133 , 0 , V_118 , 0 , 0 ) <= 0 ) {
F_87 ( V_21 ) ;
return - V_41 ;
}
return F_88 ( V_21 , V_91 , V_115 ) ;
}
...
static struct V_1 *
F_91 ( struct V_31 * V_92 , struct V_121 * V_40 , T_1 V_115 )
{
struct V_31 * V_98 [ V_99 + 1 ] ;
struct V_1 * V_2 ;
int V_27 ;
...
V_26 = - V_41 ;
if ( V_98 [ V_134 ] == NULL ||
F_92 ( V_98 [ V_134 ] ) < sizeof( V_27 ) )
goto V_100;
V_27 = F_93 ( V_98 [ V_134 ] ) ;
V_26 = - V_55 ;
V_2 = F_89 ( 0 ) ;
if ( V_2 == NULL )
goto V_100;
...
if ( V_2 . V_8 == NULL )
goto V_100;
V_122 = F_83 ( V_21 , V_115 , V_40 -> V_133 , V_47 , sizeof( * V_120 ) , 0 ) ;
if ( ! V_122 )
goto V_136;
V_120 = F_84 ( V_122 ) ;
V_120 -> V_124 = V_125 ;
...
if ( V_32 == NULL )
goto V_136;
V_26 = V_2 . V_8 -> V_68 ( V_21 , & V_135 , V_47 , & V_2 ) ;
if ( V_26 < 0 )
goto V_136;
if ( V_26 == 0 )
goto V_137;
...
V_122 -> V_138 |= V_139 ;
F_19 ( V_2 . V_8 -> V_45 ) ;
V_26 = F_96 ( V_21 , V_91 , V_115 , V_140 ,
V_40 -> V_138 & V_141 ) ;
if ( V_26 > 0 )
return 0 ;
return V_26 ;
...
static int
F_97 ( struct V_91 * V_91 , struct V_121 * V_40 , struct V_74 * V_75 ,
T_1 V_115 )
{
int V_15 ;
struct V_20 * V_21 ;
...
if ( ! V_21 )
return - V_132 ;
if ( F_82 ( V_21 , V_75 , V_115 , V_40 -> V_133 , 0 , V_47 ,
0 , 1 ) <= 0 ) {
F_87 ( V_21 ) ;
return - V_41 ;
}
...
V_15 = F_96 ( V_21 , V_91 , V_115 , V_140 ,
V_40 -> V_138 & V_141 ) ;
if ( V_15 > 0 )
return 0 ;
return V_15 ;
...
static int
F_98 ( struct V_91 * V_91 , struct V_31 * V_92 , struct V_121 * V_40 ,
T_1 V_115 , int V_118 )
{
int V_28 , V_15 ;
struct V_31 * V_98 [ V_38 + 1 ] ;
...
if ( V_15 < 0 )
return V_15 ;
if ( V_118 == V_47 && V_40 -> V_138 & V_139 ) {
if ( V_98 [ 1 ] != NULL )
return F_95 ( V_91 , V_98 [ 1 ] , V_40 , V_115 ) ;
else
return - V_41 ;
}
for ( V_28 = 1 ; V_28 <= V_38 && V_98 [ V_28 ] ; V_28 ++ ) {
V_63 = F_91 ( V_98 [ V_28 ] , V_40 , V_115 ) ;
if ( F_74 ( V_63 ) ) {
V_15 = F_75 ( V_63 ) ;
goto V_26;
}
...
if ( V_118 == V_48 )
V_15 = F_85 ( V_91 , V_115 , V_40 , & V_75 , V_118 ) ;
else {
V_15 = F_97 ( V_91 , V_40 , & V_75 , V_115 ) ;
if ( V_15 )
goto V_26;
return V_15 ;
}
...
static int
F_100 ( struct V_91 * V_91 , struct V_121 * V_40 , struct V_74 * V_75 ,
T_1 V_115 )
{
struct V_20 * V_21 ;
int V_26 = 0 ;
...
if ( ! V_21 )
return - V_132 ;
if ( F_82 ( V_21 , V_75 , V_115 , V_40 -> V_133 , V_40 -> V_138 ,
V_142 , 0 , 0 ) <= 0 ) {
F_87 ( V_21 ) ;
return - V_41 ;
}
...
static int
F_101 ( struct V_91 * V_91 , struct V_31 * V_92 , struct V_121 * V_40 ,
T_1 V_115 , int V_94 )
{
int V_15 = 0 ;
F_99 ( V_75 ) ;
...
if ( V_15 )
goto V_37;
V_15 = F_100 ( V_91 , V_40 , & V_75 , V_115 ) ;
F_94 ( & V_75 ) ;
V_37:
return V_15 ;
}
static int F_102 ( struct V_20 * V_21 , struct V_121 * V_40 )
{
struct V_91 * V_91 = F_103 ( V_21 -> V_143 ) ;
struct V_31 * V_144 [ V_99 + 1 ] ;
T_1 V_115 = V_21 ? F_104 ( V_21 ) . V_115 : 0 ;
int V_15 = 0 , V_94 = 0 ;
if ( ( V_40 -> V_145 != V_48 ) && ! F_105 ( V_21 , V_146 ) )
return - V_17 ;
V_15 = F_106 ( V_40 , sizeof( struct V_119 ) , V_144 , V_99 , NULL ) ;
if ( V_15 < 0 )
return V_15 ;
if ( V_144 [ V_128 ] == NULL ) {
F_107 ( L_5 ) ;
...
V_94 = 1 ;
V_148:
V_15 = F_101 ( V_91 , V_144 [ V_128 ] , V_40 , V_115 , V_94 ) ;
if ( V_15 == - V_102 )
goto V_148;
break;
case V_47 :
V_15 = F_98 ( V_91 , V_144 [ V_128 ] , V_40 ,
V_115 , V_47 ) ;
break;
case V_48 :
V_15 = F_98 ( V_91 , V_144 [ V_128 ] , V_40 ,
...
static struct V_31 *
F_109 ( const struct V_121 * V_40 )
{
struct V_31 * V_149 , * V_150 [ V_99 + 1 ] ;
struct V_31 * V_98 [ V_38 + 1 ] ;
struct V_31 * V_92 [ V_151 + 1 ] ;
struct V_31 * V_43 ;
if ( F_106 ( V_40 , sizeof( struct V_119 ) , V_92 , V_151 , NULL ) < 0 )
return NULL ;
V_149 = V_92 [ V_128 ] ;
if ( V_149 == NULL )
return NULL ;
if ( F_110 ( V_98 , V_38 , F_111 ( V_149 ) ,
F_112 ( F_92 ( V_149 ) ) , NULL ) < 0 )
return NULL ;
if ( V_98 [ 1 ] == NULL )
return NULL ;
if ( F_110 ( V_150 , V_99 , F_111 ( V_98 [ 1 ] ) ,
F_92 ( V_98 [ 1 ] ) , NULL ) < 0 )
return NULL ;
V_43 = V_150 [ V_101 ] ;
return V_43 ;
...
struct V_1 V_2 ;
int V_15 = 0 ;
struct V_119 * V_120 = (struct V_119 * ) F_84 ( V_23 -> V_122 ) ;
struct V_31 * V_43 = F_109 ( V_23 -> V_122 ) ;
if ( V_43 == NULL ) {
F_114 ( L_6 ) ;
return 0 ;
}
...
memset ( & V_2 , 0 , sizeof( struct V_1 ) ) ;
V_2 . V_8 = V_95 ;
V_122 = F_83 ( V_21 , F_104 ( V_23 -> V_21 ) . V_115 , V_23 -> V_122 -> V_133 ,
V_23 -> V_122 -> V_145 , sizeof( * V_120 ) , 0 ) ;
if ( ! V_122 )
goto V_136;
V_120 = F_84 ( V_122 ) ;
V_120 -> V_124 = V_125 ;
...
{
F_116 ( V_153 , V_142 , F_102 , NULL , NULL ) ;
F_116 ( V_153 , V_47 , F_102 , NULL , NULL ) ;
F_116 ( V_153 , V_48 , F_102 , F_113 ,
NULL ) ;
return 0 ;
}
