...
if ( V_42 > 0 ) {
V_26 -> V_65 = V_26 -> V_64 ;
V_35 = & V_26 -> V_67 [ V_26 -> V_64 ++ ] ;
V_35 -> V_68 = L_16 ;
V_35 -> V_69 = L_17 ;
V_35 -> V_70 = & V_26 ;
V_35 -> V_71 = sizeof( V_26 ) ;
}
if ( V_43 > 0 ) {
V_26 -> V_66 = V_26 -> V_64 ;
V_35 = & V_26 -> V_67 [ V_26 -> V_64 ++ ] ;
...
V_39 = F_40 ( & V_25 -> V_32 , V_25 -> V_72 , V_26 -> V_67 ,
V_26 -> V_64 , NULL , 0 , NULL ) ;
if ( V_39 < 0 )
goto V_54;
F_41 ( & V_25 -> V_32 , true ) ;
F_42 ( V_25 , V_26 ) ;
...
static int F_48 ( struct V_73 * V_32 )
{
struct V_1 * V_74 = F_49 ( V_32 ) ;
F_3 ( V_74 , V_12 , 0x00 ) ;
F_43 ( V_32 ) ;
return 0 ;
}
static int F_50 ( struct V_73 * V_32 )
{
struct V_1 * V_74 = F_49 ( V_32 ) ;
unsigned int V_75 , V_40 ;
F_36 ( V_32 ) ;
V_40 = V_58 | V_59 ;
if ( V_74 -> V_65 != - 1 )
V_40 |= V_61 | V_60 ;
