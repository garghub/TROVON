...
static int T_2 F_32 ( struct V_48 * V_49 )
{
static int V_50 = 0 ;
struct V_51 * V_52 ;
if ( ! V_53 ||
...
#endif
V_52 = F_39 ( V_49 , sizeof( struct V_37 ) ) ;
if ( V_52 == NULL ) {
F_40 ( V_82 ) ;
V_82 = 0 ;
return 0 ;
...
static int F_47 ( struct V_51 * V_93 )
{
if ( F_5 () )
F_48 ( V_6 , V_93 ) ;
if ( V_82 )
...
static int T_2 F_50 ( char * V_94 )
{
int V_95 [ 6 ] ;
F_51 ( V_94 , F_52 ( V_95 ) , V_95 ) ;
if ( V_95 [ 0 ] < 1 ) {
F_14 ( L_26 ) ;
return 0 ;
}
...
F_57 ( V_103 ,
F_58 ( F_59 ( V_104 ) ) ) ;
F_57 ( V_105 , V_106 | V_107 ) ;
F_60 ( 50 ) ;
F_57 ( V_105 , V_106 ) ;
F_59 ( V_108 ) ;
V_102 = V_109 + V_110 ;
while ( F_61 ( V_109 , V_102 ) )
F_62 () ;
F_14 ( L_29 ) ;
}
static const char * F_63 ( struct V_51 * V_49 )
{
static const char string [] = L_30 ;
return string ;
}
static unsigned long F_64 ( struct V_51 * V_52 ,
void * V_111 , unsigned long V_112 ,
int V_113 )
{
unsigned long V_10 = F_38 ( V_111 ) ;
F_15 ( L_31
...
static long F_68 ( struct V_51 * V_52 )
{
return V_24 ;
}
static int F_69 ( T_3 * V_97 )
{
...
static unsigned long F_70 ( unsigned long V_130 ,
T_3 * V_97 , int V_131 )
{
...
V_133 = ( V_82 && ! F_65 ( F_38 ( V_97 -> V_134 . V_135 ) ) ) ?
V_83 : 255 * 512 ;
if ( V_132 > V_133 )
V_132 = V_133 ;
if ( V_132 != V_130 )
