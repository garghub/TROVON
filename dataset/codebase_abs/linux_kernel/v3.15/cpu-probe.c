...
static inline void F_68 ( struct V_10 * V_11 , int V_24 )
{
F_49 ( V_11 ) ;
if ( ( V_11 -> V_14 & V_143 ) == V_320 ) {
V_11 -> V_50 = V_273 ;
V_146 [ V_24 ] = L_98 ;
return;
}
...
F_71 () , V_11 -> V_14 , F_77 () ) ;
if ( V_11 -> V_3 & V_4 )
F_57 ( V_182 L_106 , V_11 -> V_28 ) ;
if ( V_364 )
F_69 ( L_107 , V_11 -> V_35 ) ;
}
