...
V_156 = F_35 ( V_64 -> V_2 , F_17 ( V_117 -> V_177 ) ,
V_117 -> V_177 ) ;
if ( V_156 ) {
...
for ( V_115 = 0 ; V_115 < F_17 ( V_191 ) ; ++ V_115 )
F_6 ( V_64 , V_191 [ V_115 ] ,
0x100 , 0x100 ) ;
F_6 ( V_64 , V_58 , V_192 ,
V_192 ) ;
F_24 ( V_64 , V_173 ) ;
...
static int F_36 ( struct V_193 * V_194 )
{
struct V_116 * V_117 ;
int V_156 ;
V_117 = F_37 ( & V_194 -> V_2 , sizeof *V_117 , V_195 ) ;
if ( ! V_117 )
return - V_196 ;
F_38 ( V_194 , V_117 ) ;
V_117 -> V_178 = F_39 ( V_194 , & V_197 ) ;
if ( F_40 ( V_117 -> V_178 ) ) {
V_156 = F_41 ( V_117 -> V_178 ) ;
F_11 ( & V_194 -> V_2 , L_18 ,
V_156 ) ;
return V_156 ;
}
V_156 = F_42 ( & V_194 -> V_2 ,
& V_198 , & V_199 , 1 ) ;
return V_156 ;
}
static int F_43 ( struct V_193 * V_194 )
{
F_44 ( & V_194 -> V_2 ) ;
return 0 ;
}
static int F_45 ( struct V_200 * V_201 ,
const struct V_202 * V_203 )
{
struct V_116 * V_117 ;
int V_156 ;
V_117 = F_37 ( & V_201 -> V_2 , sizeof *V_117 , V_195 ) ;
if ( ! V_117 )
return - V_196 ;
F_46 ( V_201 , V_117 ) ;
V_117 -> V_178 = F_47 ( V_201 , & V_197 ) ;
if ( F_40 ( V_117 -> V_178 ) ) {
V_156 = F_41 ( V_117 -> V_178 ) ;
F_11 ( & V_201 -> V_2 , L_18 ,
V_156 ) ;
