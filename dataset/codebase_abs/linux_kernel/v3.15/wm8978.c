...
int V_21 ;
V_27 -> V_51 = V_52 ;
for ( V_21 = 0 ; V_21 < F_6 ( V_105 ) ; V_21 ++ )
F_10 ( V_6 , V_105 [ V_21 ] , 0x100 , 0x100 ) ;
F_20 ( V_6 , V_98 ) ;
return 0 ;
}
...
struct V_26 * V_27 ;
int V_44 ;
V_27 = F_29 ( & V_107 -> V_2 , sizeof( struct V_26 ) ,
V_110 ) ;
if ( V_27 == NULL )
return - V_111 ;
V_27 -> V_104 = F_30 ( V_107 , & V_112 ) ;
if ( F_31 ( V_27 -> V_104 ) ) {
V_44 = F_32 ( V_27 -> V_104 ) ;
F_33 ( & V_107 -> V_2 , L_14 , V_44 ) ;
return V_44 ;
}
F_34 ( V_107 , V_27 ) ;
V_44 = F_35 ( V_27 -> V_104 , V_4 , 0 ) ;
if ( V_44 != 0 ) {
F_33 ( & V_107 -> V_2 , L_15 , V_44 ) ;
return V_44 ;
}
V_44 = F_36 ( & V_107 -> V_2 ,
& V_113 , & V_114 , 1 ) ;
if ( V_44 != 0 ) {
F_33 ( & V_107 -> V_2 , L_16 , V_44 ) ;
return V_44 ;
}
return 0 ;
}
static int F_37 ( struct V_106 * V_115 )
{
F_38 ( & V_115 -> V_2 ) ;
return 0 ;
}
