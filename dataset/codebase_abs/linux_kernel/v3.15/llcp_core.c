...
V_4 = V_120 -> V_4 ;
V_22 = V_7 ( V_4 ) ;
if ( V_22 == NULL && F_81 ( V_120 ) == V_127 ) {
F_13 ( V_120 ) ;
F_93 ( V_13 -> V_26 ) ;
} else if ( V_22 && ! V_22 -> V_128 ) {
F_94 ( & V_13 -> V_17 , V_120 ) ;
F_93 ( V_13 -> V_26 ) ;
} else {
struct V_14 * V_129 = NULL ;
T_1 V_130 = F_81 ( V_120 ) ;
int V_100 ;
F_9 ( L_16 ) ;
F_95 ( V_131 , L_17 ,
V_132 , 16 , 1 ,
V_120 -> V_52 , V_120 -> V_133 , true ) ;
if ( V_130 == V_134 && V_4 != NULL &&
V_4 -> V_24 == V_135 ) {
F_5 ( & V_13 -> V_23 , V_4 ) ;
F_96 ( V_4 ) ;
F_39 ( V_4 ) ;
...
V_148 = F_111 ( NULL , V_149 -> V_70 , V_125 ) ;
if ( V_148 == NULL ) {
V_151 = V_154 ;
F_110 ( & V_3 -> V_4 ) ;
F_39 ( & V_3 -> V_4 ) ;
...
struct V_7 * V_22 ;
struct V_3 * V_4 ;
T_1 V_48 , V_47 , V_130 , V_161 , V_162 ;
V_130 = F_81 ( V_120 ) ;
V_48 = F_80 ( V_120 ) ;
V_47 = F_82 ( V_120 ) ;
V_161 = F_83 ( V_120 ) ;
...
V_48 = F_80 ( V_120 ) ;
V_47 = F_82 ( V_120 ) ;
F_9 ( L_43 , V_130 , V_48 , V_47 ) ;
if ( V_130 != V_180 )
F_95 ( V_131 , L_44 , V_132 ,
