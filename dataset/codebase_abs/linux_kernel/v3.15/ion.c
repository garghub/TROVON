...
char V_174 [ 64 ] ;
F_66 ( L_16 , V_17 , __LINE__ ) ;
snprintf ( V_174 , 64 , L_29 , F_47 ( V_56 -> V_57 ) ) ;
V_62 = F_85 ( V_8 , V_174 ) ;
if ( F_19 ( V_62 ) )
return F_132 ( V_62 ) ;
V_84 -> V_154 = V_62 ;
...
if ( V_19 -> V_187 . V_188 ) {
char V_174 [ 64 ] ;
snprintf ( V_174 , 64 , L_44 , V_19 -> V_82 ) ;
V_190 = F_95 (
...
V_195 -> V_97 = F_161 ( L_46 , NULL ) ;
if ( ! V_195 -> V_97 ) {
F_9 ( L_48 ) ;
goto V_200;
}
V_195 -> V_192 = F_161 ( L_49 , V_195 -> V_97 ) ;
if ( ! V_195 -> V_192 ) {
F_9 ( L_50 ) ;
goto V_200;
}
V_195 -> V_98 = F_161 ( L_51 ,
V_195 -> V_97 ) ;
if ( ! V_195 -> V_98 )
F_9 ( L_52 ) ;
V_200:
