...
if ( V_21 -> V_128 && V_146 ) {
while ( V_146 -> V_112 ) {
if ( ! strcmp ( V_21 -> V_128 , V_146 -> V_112 ) ) {
V_125 = V_146 -> V_125 ;
V_112 = V_146 -> V_112 ;
break;
}
...
if ( V_125 < 0 && V_148 ) {
V_150 = F_49 ( V_21 -> V_151 -> V_152 , V_148 ) ;
if ( V_150 ) {
V_125 = V_150 -> V_153 ;
#ifdef F_50
V_112 = V_150 -> V_112 ;
...
if ( V_125 < 0 && V_148 ) {
for ( V_150 = V_148 ; V_150 -> V_154 || V_150 -> V_155 ; V_150 ++ ) {
unsigned int V_156 =
V_150 -> V_155 | ( V_150 -> V_154 << 16 ) ;
unsigned int V_157 = 0xffff0000 | V_150 -> V_158 ;
if ( ( V_21 -> V_159 & V_157 ) == ( V_156 & V_157 ) ) {
V_125 = V_150 -> V_153 ;
#ifdef F_50
V_112 = V_150 -> V_112 ;
#endif
