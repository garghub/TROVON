...
static int F_80 ( struct V_74 * V_70 )
{
int V_55 ;
struct V_12 * V_13 ;
int V_19 = 0 ;
...
V_13 = F_81 ( V_6 , sizeof( struct V_12 ) , V_76 ) ;
if ( ! V_13 )
return - V_77 ;
switch ( V_53 ) {
default:
...
case 0xe5 :
V_52 = L_12 ;
V_13 -> V_78 = V_79 [ 0 ] ? 3 : 0 ;
V_13 -> V_80 = V_79 [ 1 ] ? 11 : 0 ;
V_13 -> V_81 = V_79 [ 2 ] ? 2 : 0 ;
break;
case 0xe9 :
V_52 = L_13 ;
V_13 -> V_78 = V_79 [ 0 ] ? 3 : 0 ;
V_13 -> V_80 = V_79 [ 1 ] ? 14 : 0 ;
V_13 -> V_81 = V_79 [ 2 ] ? 3 : 0 ;
break;
}
V_13 -> V_52 = V_52 ;
F_82 ( & V_13 -> V_82 ) ;
...
V_13 -> V_84 [ V_55 ] = V_79 [ V_55 ] ;
if ( V_13 -> V_84 [ V_55 ]
&& ! F_84 ( V_6 , V_79 [ V_55 ] , V_85 ,
V_86 . V_87 . V_52 ) ) {
F_85 ( V_6 ,
L_14 ,
V_79 [ V_55 ] , V_79 [ V_55 ] + V_85 - 1 ) ;
return - V_88 ;
}
}
if ( V_13 -> V_78 )
...
if ( V_13 -> V_80 ) {
V_55 = F_86 ( V_13 , V_30 , V_22 ,
V_89 ) ;
if ( V_13 -> V_81 ) {
V_55 &= F_86 ( V_13 , V_49 , V_22 ,
V_90 ) ;
}
...
if ( F_89 ( V_13 -> V_24 , V_55 ) )
V_13 -> V_16 [ V_55 ] = F_86 ( V_13 ,
V_21 , V_22 ,
F_23 ( V_55 ) ) ;
}
if ( V_92 > 0 ) {
if ( V_53 == 0xe9 && V_13 -> V_84 [ 1 ] )
V_75 = V_64 [ 2 ] & 0x40 ;
F_90 ( V_70 , V_75 ) ;
}
if ( V_13 -> V_80 ) {
V_19 = F_91 ( & V_6 -> V_68 , & V_73 ) ;
if ( V_19 )
goto error;
}
if ( V_13 -> V_80 == 14 ) {
V_19 = F_91 ( & V_6 -> V_68 , & V_72 ) ;
if ( V_19 )
goto error;
}
if ( V_13 -> V_81 ) {
for ( V_55 = 0 ; V_55 < V_13 -> V_81 ; V_55 ++ ) {
V_19 = F_91 ( & V_6 -> V_68 ,
& V_67 [ V_55 ] ) ;
if ( V_19 )
goto error;
...
if ( F_93 ( V_13 -> V_24 , V_55 ) ) {
V_19 = F_92 ( V_6 , & V_23 [ V_55 ] . V_71 ) ;
if ( V_19 )
goto error;
}
}
...
static int F_97 ( struct V_74 * V_70 )
{
struct V_12 * V_13 = F_98 ( V_70 ) ;
F_99 ( V_13 -> V_93 ) ;
F_76 ( & V_70 -> V_6 ) ;
return 0 ;
}
static int F_86 ( struct V_12 * V_13 , T_1 V_94 , T_1 V_95 ,
T_1 V_2 )
{
int V_96 ;
F_19 ( & ( V_13 -> V_82 ) ) ;
if ( V_95 != V_22 )
F_100 ( V_95 , V_13 -> V_84 [ V_94 ] + V_97 ) ;
V_96 = F_101 ( V_13 -> V_84 [ V_94 ] + V_2 ) ;
F_24 ( & ( V_13 -> V_82 ) ) ;
return V_96 ;
}
static void F_21 ( struct V_12 * V_13 , T_1 V_94 , T_1 V_95 ,
T_1 V_2 , T_1 V_98 )
{
F_19 ( & ( V_13 -> V_82 ) ) ;
if ( V_95 != V_22 )
F_100 ( V_95 , V_13 -> V_84 [ V_94 ] + V_97 ) ;
F_100 ( V_98 , V_13 -> V_84 [ V_94 ] + V_2 ) ;
F_24 ( & ( V_13 -> V_82 ) ) ;
}
static void F_90 ( struct V_74 * V_70 ,
int V_75 )
{
struct V_12 * V_13 = F_98 ( V_70 ) ;
int V_55 , V_33 ;
const T_1 V_99 [ 14 ] = { 2 , 2 , 2 , 2 , 2 , 2 , 2 , 1 , 1 , 3 , 1 , 2 , 2 , 2 } ;
const T_1 V_100 [ 3 ] = { 2 , 2 , 1 } ;
T_1 V_2 ;
if ( V_92 >= 2 && V_13 -> V_80 ) {
...
V_33 = V_13 -> V_80 < 11 ? V_13 -> V_80 : 11 ;
for ( V_55 = 0 ; V_55 < V_33 ; V_55 ++ ) {
V_2 = F_86 ( V_13 , V_30 , V_55 ,
V_102 ) ;
F_87 ( & V_70 -> V_6 , L_19 , V_55 , V_2 ) ;
if ( V_92 >= V_99 [ V_55 ] ) {
if ( ! ( V_2 & V_103 ) ) {
F_87 ( & V_70 -> V_6 , L_20 ,
V_55 ) ;
...
F_87 ( & V_70 -> V_6 , L_21 , V_75 ) ;
for ( V_55 = 11 ; V_55 < V_13 -> V_80 ; V_55 ++ ) {
V_2 = F_86 ( V_13 , V_30 , V_55 ,
V_104 ) ;
V_75 = V_75 || ( V_2 & V_103 ) ;
F_87 ( & V_70 -> V_6 , L_22 , V_55 - 7 , V_2 ) ;
}
F_87 ( & V_70 -> V_6 , L_23 , V_75 ) ;
V_55 = V_75 ? 2 : 0 ;
for (; V_55 < V_13 -> V_81 ; V_55 ++ ) {
V_2 = F_86 ( V_13 , V_49 , V_55 ,
V_104 ) ;
F_87 ( & V_70 -> V_6 , L_22 , V_55 + 1 , V_2 ) ;
if ( V_92 >= V_100 [ V_55 ] ) {
if ( ! ( V_2 & V_103 ) ) {
F_87 ( & V_70 -> V_6 ,
L_24 , V_55 + 1 ) ;
...
if ( V_13 -> V_81 ) {
V_2 = F_86 ( V_13 , V_49 , V_22 ,
V_90 ) ;
F_87 ( & V_70 -> V_6 , L_28 , V_2 ) ;
if ( V_2 & V_103 ) {
F_87 ( & V_70 -> V_6 ,
L_29 ) ;
F_21 ( V_13 , V_49 , V_22 ,
...
T_1 V_55 ;
F_19 ( & V_13 -> V_20 ) ;
if ( F_104 ( V_106 , V_13 -> V_107 + V_108 * 2 ) || ! V_13 -> V_109 ) {
F_87 ( V_6 , L_32 ) ;
for ( V_55 = 0 ; V_55 < V_13 -> V_78 ; V_55 ++ ) {
if ( F_89 ( V_13 -> V_24 , V_55 ) ) {
V_13 -> V_16 [ V_55 ] =
F_86 ( V_13 , V_21 ,
V_22 , F_23 ( V_55 ) ) ;
V_13 -> V_14 [ V_55 ] = F_86 ( V_13 , V_21 ,
V_22 , F_105 ( V_55 ) ) ;
V_13 -> V_17 [ V_55 ] = F_86 ( V_13 ,
V_21 , V_22 ,
F_22 ( V_55 ) ) ;
F_103 ( V_6 , V_55 ) ;
F_21 ( V_13 , V_21 , V_22 ,
...
if ( F_93 ( V_13 -> V_24 , V_55 ) )
V_13 -> V_23 [ V_55 ] = F_86 ( V_13 , V_21 ,
V_22 , F_29 ( V_55 ) ) ;
}
for ( V_55 = 0 ; V_55 < V_13 -> V_80 ; V_55 ++ ) {
V_13 -> V_29 [ V_55 ] = F_86 ( V_13 , V_30 , V_55 ,
V_102 ) ;
F_21 ( V_13 , V_30 , V_55 ,
V_102 ,
V_13 -> V_29 [ V_55 ] ) ;
if ( ( V_13 -> V_29 [ V_55 ] & V_110 ) == V_110 ) {
V_13 -> V_25 [ V_55 ] = F_86 ( V_13 , V_30 ,
V_55 , V_111 ) ;
}
if ( V_13 -> V_29 [ V_55 ] & V_103 ) {
V_13 -> V_27 [ V_55 ] = F_86 ( V_13 ,
V_30 , V_55 ,
V_31 ) ;
V_13 -> V_28 [ V_55 ] = F_86 ( V_13 ,
V_30 , V_55 ,
V_32 ) ;
if ( V_55 >= 11 )
V_13 -> V_39 [ V_55 - 11 ] =
...
if ( V_13 -> V_80 ) {
V_13 -> V_38 = F_86 ( V_13 , V_30 ,
V_22 , V_112 )
| ( ( F_86 ( V_13 , V_30 ,
V_22 , V_113 )
& 0x07 ) << 8 ) ;
V_13 -> V_36 = ( V_13 -> V_91 & 0xE0 ) ?
F_86 ( V_13 , V_30 ,
V_22 , V_114 ) : 0x1F ;
}
for ( V_55 = 0 ; V_55 < V_13 -> V_81 ; V_55 ++ ) {
V_13 -> V_48 [ V_55 ] = F_86 ( V_13 ,
V_49 , V_55 ,
V_104 ) ;
F_21 ( V_13 , V_49 , V_55 ,
V_104 ,
V_13 -> V_48 [ V_55 ] ) ;
if ( ( V_13 -> V_48 [ V_55 ] & V_110 ) == V_110 ) {
V_13 -> V_44 [ V_55 ] = F_86 ( V_13 ,
V_49 , V_55 ,
V_115 ) ;
}
if ( V_13 -> V_48 [ V_55 ] & V_103 ) {
V_13 -> V_45 [ V_55 ] = F_86 ( V_13 ,
V_49 , V_55 ,
V_40 ) ;
V_13 -> V_46 [ V_55 ] = F_86 ( V_13 ,
V_49 , V_55 ,
V_41 ) ;
V_13 -> V_47 [ V_55 ] = F_86 ( V_13 ,
V_49 , V_55 ,
V_42 ) ;
}
}
if ( V_13 -> V_81 ) {
V_13 -> V_50 = F_86 ( V_13 , V_49 ,
V_22 , V_116 )
& 0x3F ;
}
V_13 -> V_107 = V_106 ;
...
static int T_4 F_106 ( unsigned short V_84 )
{
struct V_117 V_96 [ 3 ] ;
int V_19 , V_55 , V_118 ;
V_70 = F_107 ( L_9 , V_84 ) ;
...
memset ( V_96 , 0 , 3 * sizeof( struct V_117 ) ) ;
V_118 = 0 ;
for ( V_55 = 0 ; V_55 < 3 ; V_55 ++ ) {
if ( ! V_79 [ V_55 ] )
continue;
V_96 [ V_118 ] . V_119 = V_79 [ V_55 ] ;
V_96 [ V_118 ] . V_120 = V_79 [ V_55 ] + V_85 - 1 ;
V_96 [ V_118 ] . V_52 = L_9 ,
V_96 [ V_118 ] . V_121 = V_122 ,
V_19 = F_109 ( & V_96 [ V_118 ] ) ;
if ( V_19 )
goto V_123;
V_118 ++ ;
}
V_19 = F_110 ( V_70 , V_96 , V_118 ) ;
if ( V_19 ) {
F_108 ( L_34 , V_19 ) ;
goto V_123;
}
