...
static int F_65 ( struct V_26 * V_12 , unsigned V_74 ,
...
V_31 = F_64 ( V_12 , V_77 , V_27 , V_66 ) ;
}
if ( V_31 ) {
for ( -- V_77 ; V_77 >= V_74 ; V_77 -- )
F_64 ( V_12 , V_77 , - 1 , V_66 ) ;
}
return V_31 ;
}
static void F_66 ( struct V_26 * V_12 , bool V_66 )
{
struct V_44 * V_45 = V_12 -> V_45 ;
int V_67 ;
F_65 ( V_12 , 0 , V_12 -> V_55 , NULL , V_66 ) ;
...
int V_31 ;
if ( V_12 -> V_56 == V_78 )
return F_65 ( V_12 , V_74 , V_75 ,
V_76 , V_66 ) ;
V_31 = F_58 ( V_12 , V_74 + V_75 , V_66 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_65 ( V_12 , V_74 , V_75 , V_76 , V_66 ) ;
if ( V_31 )
F_66 ( V_12 , V_66 ) ;
return V_31 ;
}
...
int F_73 ( struct V_26 * V_12 , T_8 V_9 ,
unsigned V_78 , unsigned V_74 , unsigned V_75 ,
void * V_13 )
{
int (* F_74)( struct V_26 * V_12 , unsigned V_78 ,
...
if ( ! F_74 )
return - V_82 ;
return F_74 ( V_12 , V_78 , V_74 , V_75 , V_9 , V_13 ) ;
}
