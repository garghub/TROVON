...
static int F_14 ( struct V_29 * V_29 ,
...
static struct V_42 * F_15 ( T_7 V_43 , struct V_44 * V_45 )
{
struct V_46 V_47 ;
F_16 ( V_45 -> V_48 , V_45 -> V_30 , V_49 ,
V_50 , V_43 , & V_47 ) ;
return V_47 . V_42 ;
}
static int
F_17 ( T_8 V_51 , T_7 V_43 , T_9 * V_52 ,
int V_53 , void * V_54 )
{
...
/ sizeof( T_7 ) ;
return F_19 ( V_51 , V_43 , & V_55 , V_52 ,
V_53 , V_54 ) ;
}
#ifndef F_20
if ( ! F_14 ( V_42 -> V_29 , V_45 -> V_30 , & V_32 ) ) {
memset ( & V_55 , 0 , sizeof( V_55 ) ) ;
if ( F_21 ( 0 , & V_55 , V_43 , 0 , V_42 -> V_29 -> V_22 ,
V_42 -> V_59 , V_42 -> V_2 ) )
return F_19 ( V_51 , V_43 , & V_55 , V_52 ,
V_53 , V_54 ) ;
}
...
static int F_27 ( struct V_44 * V_45 , T_7 V_71 ,
T_7 * V_37 )
{
struct V_46 V_47 ;
T_6 V_75 ;
...
V_50 , V_71 , & V_47 ) ;
if ( ! V_47 . V_42 ) {
F_18 ( L_7 , ( unsigned long ) V_71 ) ;
return - 1 ;
}
if ( ! V_47 . V_42 -> V_29 )
return - 1 ;
V_75 = F_28 ( V_47 . V_42 -> V_29 , V_47 . V_42 , V_45 -> V_30 ,
V_71 , ( T_1 * ) V_37 , sizeof( * V_37 ) ) ;
return ! ( V_75 == sizeof( * V_37 ) ) ;
}
static int F_29 ( T_8 T_11 V_51 ,
T_7 V_71 , T_7 * V_76 ,
int V_66 , void * V_54 )
{
struct V_44 * V_45 = V_54 ;
...
V_41 = F_30 ( & V_59 , & V_45 -> V_79 -> V_81 , V_83 ) ;
if ( V_41 )
return V_41 ;
V_2 = V_59 + V_78 -> V_75 ;
...
if ( V_86 < 0 )
return - V_12 ;
V_41 = F_30 ( & V_3 , & V_45 -> V_79 -> V_81 , V_86 ) ;
if ( V_41 ) {
F_23 ( L_14 , V_85 ) ;
return V_41 ;
}
* V_76 = ( T_7 ) V_3 ;
F_18 ( L_15 , V_85 , ( unsigned long ) * V_76 ) ;
return 0 ;
}
static void F_33 ( T_8 T_11 V_51 ,
T_9 * V_52 T_11 ,
void * V_54 T_11 )
{
F_18 ( L_16 ) ;
}
static int F_34 ( T_2 V_43 , struct V_48 * V_48 , struct V_30 * V_30 ,
T_16 V_87 , void * V_54 )
{
struct V_88 V_89 ;
struct V_46 V_47 ;
...
static int F_37 ( struct V_44 * V_45 , T_16 V_87 ,
void * V_54 , int V_95 )
{
T_8 V_96 ;
T_14 V_97 ;
...
V_41 = F_39 ( & V_97 , V_96 , V_45 ) ;
if ( V_41 )
F_36 ( V_41 ) ;
while ( ! V_41 && ( F_40 ( & V_97 ) > 0 ) && V_95 -- ) {
T_7 V_43 ;
F_41 ( & V_97 , V_100 , & V_43 ) ;
V_41 = V_43 ? F_34 ( V_43 , V_45 -> V_48 , V_45 -> V_30 , V_87 , V_54 ) : 0 ;
}
F_42 ( V_96 ) ;
return V_41 ;
}
int F_43 ( T_16 V_87 , void * V_54 ,
...
if ( ! V_37 -> V_81 . V_82 )
return - V_12 ;
V_41 = F_30 ( & V_43 , & V_37 -> V_81 , V_102 ) ;
if ( V_41 )
return V_41 ;
V_41 = F_34 ( V_43 , V_48 , V_30 , V_87 , V_54 ) ;
if ( V_41 )
return - V_99 ;
return -- V_95 > 0 ? F_37 ( & V_45 , V_87 , V_54 , V_95 ) : 0 ;
}
