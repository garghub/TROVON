...
static int F_56 ( struct V_59 * V_162 )
{
T_2 V_32 ;
...
static int F_57 ( struct V_14 * V_6 ,
struct V_161 * V_162 ,
struct V_35 * V_108 )
{
...
if ( V_162 -> V_173 % V_66 )
return - V_48 ;
if ( F_15 ( V_6 ) || F_58 ( V_6 ) )
V_170 = 255 ;
else
V_170 = 63 ;
if ( V_162 -> V_135 & V_170 || V_162 -> V_142 & V_170 )
return - V_48 ;
if ( F_49 ( V_6 ) && V_162 -> V_135 < 512 )
return - V_48 ;
...
static int F_59 ( struct V_14 * V_6 )
{
struct V_4 * V_5 = V_6 -> V_7 ;
T_2 V_151 ;
if ( F_54 ( V_6 ) -> V_154 <= 3 && ( F_15 ( V_6 ) || ! F_60 ( V_6 ) ) )
return - 1 ;
V_151 = F_20 ( V_152 ) ;
if ( ( V_151 & V_182 ) == 0 )
return - 1 ;
...
int F_61 ( struct V_14 * V_6 , void * V_183 ,
struct V_184 * V_185 )
{
...
V_60 = F_66 ( sizeof( * V_60 ) , V_191 ) ;
if ( ! V_60 )
return - V_119 ;
V_188 = F_67 ( V_6 , V_186 -> V_192 ,
V_193 ) ;
if ( ! V_188 ) {
V_18 = - V_194 ;
goto V_195;
}
V_40 = F_68 ( F_69 ( V_188 ) ) ;
V_108 = F_70 ( F_71 ( V_6 , V_185 ,
V_186 -> V_196 ) ) ;
if ( & V_108 -> V_38 == NULL ) {
V_18 = - V_194 ;
goto V_195;
...
static bool F_76 ( T_2 V_208 , T_2 V_209 )
{
int V_210 ;
...
int F_79 ( struct V_14 * V_6 , void * V_183 ,
struct V_184 * V_185 )
{
...
void F_92 ( struct V_14 * V_6 )
{
struct V_4 * V_5 = V_6 -> V_7 ;
if ( ! V_5 -> V_3 )
return;
F_9 ( V_5 -> V_3 -> V_21 ) ;
F_74 ( & V_5 -> V_3 -> V_9 -> V_38 ) ;
F_73 ( V_5 -> V_3 ) ;
}
static struct V_1 T_1 *
F_93 ( struct V_2 * V_3 )
...
if ( ! V_8 )
goto V_236;
F_98 ( & error -> V_8 , V_8 , sizeof( struct V_1 ) ) ;
F_95 ( V_3 , V_8 ) ;
return error ;
V_236:
F_73 ( error ) ;
...
F_100 ( V_238 , L_9 ,
error -> V_38 ) ;
#define F_101 ( T_3 ) i915_error_printf(m, " " #x ": 0x%08x\n", error->regs.x)
F_101 ( V_134 ) ;
F_101 ( V_239 ) ;
F_101 ( V_140 ) ;
F_101 ( V_141 ) ;
