...
F_3 ( F_4 , & V_17 ) ;
F_2 ( L_4 , V_17 ) ;
V_18 = F_7 ( V_17 + 4 , V_19 ) ;
if ( V_18 == NULL )
F_8 ( V_20 L_5 ) ;
}
static T_2 * F_9 ( struct V_1 * V_13 , T_2 * V_14 )
{
...
static inline int F_13 ( void * V_2 , int V_15 , void * V_23 , T_3 V_24 )
{
if ( ( V_23 + V_24 ) < V_2 )
return 0 ;
if ( V_23 > ( V_2 + V_15 ) )
...
static T_2 * F_14 ( struct V_1 * V_13 , T_2 * V_14 )
{
unsigned long V_21 ;
unsigned long V_22 ;
void * V_25 ;
...
V_22 = V_16 ;
V_2 = F_11 ( V_21 ) ;
if ( F_13 ( V_2 , V_22 , V_25 , 4096 ) ) {
F_2 ( L_6 , V_21 ) ;
goto V_28;
}
if ( F_13 ( V_2 , V_22 , V_18 , V_17 ) ) {
F_2 ( L_7 , V_21 ) ;
goto V_28;
}
V_26 = F_10 ( ~ 0 , V_2 , V_22 ) ;
if ( V_26 != * V_14 ) {
F_8 ( V_20 L_8
L_9 , V_21 , V_26 , * V_14 ) ;
F_2 ( L_10 ,
