...
int F_23 ( struct V_5 * V_5 , char * V_31 , unsigned long V_4 )
{
return F_24 ( V_5 , V_31 , V_4 , L_10 ) ;
}
int F_25 ( struct V_5 * V_5 ,
char * V_31 , unsigned long V_4 , char * V_32 )
{
return F_24 ( V_5 , V_31 , V_4 , V_32 ) ;
}
struct V_6 * F_26 ( struct V_5 * V_5 ,
struct V_6 * V_7 )
{
static int V_33 ;
if ( ! V_5 || ! V_5 -> V_10 )
...
unsigned long long F_27 ( const char * V_35 )
{
int V_36 ;
if ( isdigit ( V_35 [ 0 ] ) )
return F_17 ( V_35 , NULL , 0 ) ;
