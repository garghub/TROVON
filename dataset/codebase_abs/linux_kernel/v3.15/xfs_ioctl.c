...
case V_325 :
return F_121 ( V_5 -> V_326 , ( int V_14 * ) V_92 ) ;
case V_327 :
...
case V_330 :
return F_108 ( V_10 , V_92 ) ;
case V_331 :
return F_109 ( V_10 , V_58 , V_92 ) ;
case V_332 : {
struct V_93 V_333 ;
...
case V_334 :
case V_298 :
return F_111 ( V_10 , V_138 , V_1 , V_92 ) ;
case V_335 :
return F_114 ( V_10 , V_92 ) ;
case V_11 :
case V_336 :
case V_27 : {
T_1 V_2 ;
...
if ( ! F_21 ( V_60 ) )
return - V_61 ;
if ( F_127 ( V_347 , ( T_14 V_14 * ) V_92 ) )
return - F_22 ( V_37 ) ;
error = F_128 ( V_83 , V_347 ) ;
return - error ;
}
case V_354 : {
T_32 V_347 ;
