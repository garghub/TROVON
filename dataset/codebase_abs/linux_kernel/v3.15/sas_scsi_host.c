...
int F_90 ( struct V_186 * V_187 , int V_54 , void T_2 * V_188 )
{
struct V_47 * V_33 = F_91 ( V_187 ) ;
if ( F_27 ( V_33 ) )
return F_92 ( V_33 -> V_88 . V_89 , V_187 , V_54 , V_188 ) ;
return - V_189 ;
}
struct V_47 * F_93 ( struct V_190 * V_150 )
{
struct V_80 * V_109 = F_94 ( V_150 -> V_33 . V_191 ) ;
struct V_48 * V_35 = F_32 ( V_109 ) ;
struct V_47 * V_192 = NULL ;
int V_83 ;
unsigned long V_49 ;
F_11 ( & V_35 -> V_134 , V_49 ) ;
for ( V_83 = 0 ; V_83 < V_35 -> V_193 ; V_83 ++ ) {
struct V_106 * V_34 = V_35 -> V_194 [ V_83 ] ;
struct V_47 * V_33 ;
F_95 ( & V_34 -> V_195 ) ;
...
int F_98 ( struct V_197 * V_198 )
{
struct V_190 * V_150 = F_99 ( V_198 -> V_33 . V_191 ) ;
struct V_47 * V_192 = F_93 ( V_150 ) ;
if ( ! V_192 )
return - V_155 ;
F_76 ( & V_192 -> V_177 ) ;
V_198 -> V_199 = V_192 ;
...
int F_100 ( struct V_186 * V_200 )
{
struct V_47 * V_33 = F_91 ( V_200 ) ;
struct V_48 * V_72 ;
F_48 ( V_33 -> V_150 -> V_201 . V_202 != V_203 ) ;
if ( F_27 ( V_33 ) ) {
F_101 ( V_200 , V_33 -> V_88 . V_89 ) ;
return 0 ;
}
V_72 = V_33 -> V_34 -> V_35 ;
F_102 ( V_200 ) ;
...
int F_106 ( struct V_186 * V_187 , int V_208 , int V_209 )
{
struct V_47 * V_33 = F_91 ( V_187 ) ;
if ( F_27 ( V_33 ) )
return F_107 ( V_33 -> V_88 . V_89 , V_187 , V_208 ,
V_209 ) ;
switch ( V_209 ) {
case V_210 :
case V_211 :
...
int F_111 ( struct V_186 * V_200 , int V_214 )
{
struct V_47 * V_33 = F_91 ( V_200 ) ;
if ( F_27 ( V_33 ) )
return - V_189 ;
...
F_105 ( V_200 , 1 ) ;
F_103 ( V_200 , V_214 ) ;
F_104 ( V_200 , V_200 -> V_215 ) ;
return V_214 ;
}
int F_112 ( struct V_186 * V_200 ,
struct V_216 * V_217 ,
T_3 V_218 , int * V_219 )
{
V_219 [ 0 ] = 255 ;
...
! F_72 ( & V_74 -> V_78 ) &&
! F_12 ( V_51 , & V_72 -> V_52 ) ) {
V_221 = V_72 -> V_76 - V_74 -> V_77 ;
if ( V_221 >= 0 ) {
V_221 = V_74 -> V_77 ;
F_82 ( & V_74 -> V_78 , & V_220 ) ;
} else {
struct V_100 * V_222 , * V_103 ;
V_221 = V_72 -> V_76 ;
...
F_13 ( & V_74 -> V_75 , V_49 ) ;
{
struct V_3 * V_4 = F_73 ( V_220 . V_176 ,
struct V_3 ,
V_45 ) ;
F_8 ( & V_220 ) ;
V_85 = V_83 -> V_94 -> V_95 ( V_4 , V_221 ,
V_223 ) ;
if ( F_14 ( V_85 ) )
F_117 ( & V_220 , V_4 -> V_45 . V_224 , & V_4 -> V_45 ) ;
}
F_11 ( & V_74 -> V_75 , V_49 ) ;
if ( V_85 ) {
F_82 ( & V_220 , & V_74 -> V_78 ) ;
V_74 -> V_77 += V_221 ;
}
}
F_13 ( & V_74 -> V_75 , V_49 ) ;
...
static int F_118 ( void * V_225 )
{
struct V_48 * V_72 = V_225 ;
while ( 1 ) {
F_119 ( V_226 ) ;
F_54 () ;
F_114 ( V_72 ) ;
...
if ( ! V_229 )
return;
if ( ! F_130 ( & V_229 -> V_231 ) )
return;
V_229 -> V_231 . V_232 ( V_229 -> V_231 . V_233 ) ;
return;
}
if ( F_27 ( V_4 -> V_33 ) ) {
F_131 ( V_4 ) ;
} else {
struct V_234 * V_220 = V_2 -> V_62 -> V_234 ;
unsigned long V_49 ;
F_11 ( V_220 -> V_235 , V_49 ) ;
F_132 ( V_2 -> V_236 ) ;
F_13 ( V_220 -> V_235 , V_49 ) ;
}
}
void F_133 ( struct V_197 * V_198 )
{
struct V_47 * V_192 = V_198 -> V_199 ;
if ( ! V_192 )
return;
V_198 -> V_199 = NULL ;
F_79 ( V_192 ) ;
}
static void F_134 ( T_4 * V_127 , const char * V_237 )
{
int V_83 ;
for ( V_83 = 0 ; V_83 < V_238 ; V_83 ++ ) {
T_4 V_239 , V_240 ;
if ( ! * V_237 )
break;
V_239 = isdigit ( * V_237 ) ? * V_237 - '0' : toupper ( * V_237 ) - 'A' + 10 ;
V_237 ++ ;
V_240 = isdigit ( * V_237 ) ? * V_237 - '0' : toupper ( * V_237 ) - 'A' + 10 ;
V_237 ++ ;
V_127 [ V_83 ] = ( V_239 << 4 ) | V_240 ;
}
}
int F_135 ( struct V_80 * V_109 , T_4 * V_241 )
{
int V_85 ;
const struct V_242 * V_243 ;
V_85 = F_136 ( & V_243 , L_44 , & V_109 -> V_244 ) ;
if ( V_85 )
return V_85 ;
