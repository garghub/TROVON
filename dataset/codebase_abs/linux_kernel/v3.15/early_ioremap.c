...
void T_1 F_15 ( void T_4 * V_30 , unsigned long V_17 )
{
unsigned long V_31 ;
unsigned long V_18 ;
unsigned int V_20 ;
...
if ( F_8 ( V_31 < F_16 ( V_12 ) ) )
return;
V_18 = V_31 & ~ V_27 ;
V_20 = F_13 ( V_18 + V_17 ) >> V_28 ;
V_5 = V_12 - V_13 * V_21 ;
while ( V_20 > 0 ) {
if ( V_3 )
F_6 ( V_5 ) ;
...
void T_1 T_4 *
F_17 ( T_5 V_16 , unsigned long V_17 )
{
...
void T_1 F_19 ( void * V_30 , unsigned long V_17 )
{
F_15 ( ( V_34 void T_4 * ) V_30 , V_17 ) ;
}
