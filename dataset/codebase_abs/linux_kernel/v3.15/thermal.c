...
{
struct V_1 * V_2 = F_52 ( V_103 , struct V_1 ,
V_104 ) ;
F_16 ( V_2 ) ;
}
static int F_53 ( struct V_80 * V_9 )
{
int V_52 = 0 ;
struct V_1 * V_2 = NULL ;
if ( ! V_9 )
return - V_6 ;
V_2 = F_54 ( sizeof( struct V_1 ) , V_105 ) ;
if ( ! V_2 )
return - V_106 ;
V_2 -> V_9 = V_9 ;
strcpy ( V_2 -> V_40 , V_9 -> V_73 . V_107 ) ;
strcpy ( F_55 ( V_9 ) , V_108 ) ;
strcpy ( F_56 ( V_9 ) , V_109 ) ;
V_9 -> V_110 = V_2 ;
V_52 = F_49 ( V_2 ) ;
if ( V_52 )
goto V_111;
...
goto V_111;
F_57 ( & V_2 -> V_104 , F_51 ) ;
F_58 ( V_27 L_35 , F_55 ( V_9 ) ,
F_59 ( V_9 ) , F_60 ( V_2 -> V_8 ) ) ;
goto V_112;
V_111:
F_61 ( V_2 ) ;
V_112:
...
static int F_62 ( struct V_80 * V_9 )
{
struct V_1 * V_2 = NULL ;
if ( ! V_9 || ! F_47 ( V_9 ) )
return - V_6 ;
...
static int F_65 ( struct V_9 * V_75 )
{
struct V_1 * V_2 ;
...
F_68 ( V_113 , & V_2 -> V_104 ) ;
return V_4 ;
}
static int F_69 ( const struct V_118 * V_119 ) {
if ( V_42 == 0 ) {
F_70 ( V_27 L_36
L_37 , V_119 -> V_120 ) ;
V_42 = - 1 ;
...
static int F_73 ( const struct V_118 * V_119 ) {
if ( V_33 == 0 ) {
F_70 ( V_27 L_36
L_40 , V_119 -> V_120 ) ;
V_33 = - 1 ;
