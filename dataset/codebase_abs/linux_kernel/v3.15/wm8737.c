...
struct V_17 * V_18 ;
int V_61 , V_19 ;
V_18 = F_27 ( & V_82 -> V_2 , sizeof( struct V_17 ) ,
V_85 ) ;
if ( V_18 == NULL )
return - V_86 ;
for ( V_19 = 0 ; V_19 < F_6 ( V_18 -> V_69 ) ; V_19 ++ )
V_18 -> V_69 [ V_19 ] . V_87 = V_88 [ V_19 ] ;
V_61 = F_28 ( & V_82 -> V_2 , F_6 ( V_18 -> V_69 ) ,
V_18 -> V_69 ) ;
if ( V_61 != 0 ) {
F_11 ( & V_82 -> V_2 , L_5 , V_61 ) ;
return V_61 ;
}
V_18 -> V_70 = F_29 ( V_82 , & V_89 ) ;
if ( F_30 ( V_18 -> V_70 ) )
return F_31 ( V_18 -> V_70 ) ;
F_32 ( V_82 , V_18 ) ;
V_61 = F_33 ( & V_82 -> V_2 ,
& V_90 , & V_91 , 1 ) ;
return V_61 ;
}
static int F_34 ( struct V_81 * V_92 )
{
F_35 ( & V_92 -> V_2 ) ;
return 0 ;
}
static int F_36 ( struct V_93 * V_94 )
{
struct V_17 * V_18 ;
int V_61 , V_19 ;
V_18 = F_27 ( & V_94 -> V_2 , sizeof( struct V_17 ) ,
V_85 ) ;
if ( V_18 == NULL )
return - V_86 ;
for ( V_19 = 0 ; V_19 < F_6 ( V_18 -> V_69 ) ; V_19 ++ )
V_18 -> V_69 [ V_19 ] . V_87 = V_88 [ V_19 ] ;
V_61 = F_28 ( & V_94 -> V_2 , F_6 ( V_18 -> V_69 ) ,
V_18 -> V_69 ) ;
if ( V_61 != 0 ) {
F_11 ( & V_94 -> V_2 , L_5 , V_61 ) ;
return V_61 ;
}
V_18 -> V_70 = F_37 ( V_94 , & V_89 ) ;
if ( F_30 ( V_18 -> V_70 ) )
return F_31 ( V_18 -> V_70 ) ;
F_38 ( V_94 , V_18 ) ;
V_61 = F_33 ( & V_94 -> V_2 ,
