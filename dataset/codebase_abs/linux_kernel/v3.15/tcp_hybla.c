...
if ( V_4 -> V_10 == 0 )
F_1 ( V_2 ) ;
V_29 = V_4 -> V_5 - ( V_4 -> V_10 << 3 ) ;
if ( V_14 -> V_17 < V_14 -> V_31 ) {
V_30 = 1 ;
V_27 = ( ( 1 << F_12 ( V_4 -> V_10 , 16U ) ) *
F_7 ( V_29 ) ) - 128 ;
} else {
V_27 = V_4 -> V_11 / V_14 -> V_17 ;
if ( V_27 < 128 )
V_14 -> V_32 ++ ;
}
V_28 = V_27 % 128 ;
...
if ( V_27 == 0 && V_28 == 0 && V_14 -> V_32 >= V_14 -> V_17 ) {
V_14 -> V_17 ++ ;
V_14 -> V_32 = 0 ;
}
if ( V_30 )
V_14 -> V_17 = F_12 ( V_14 -> V_17 , V_14 -> V_31 ) ;
V_14 -> V_17 = F_13 ( V_6 , V_14 -> V_17 , V_14 -> V_18 ) ;
}
static int T_2 F_14 ( void )
{
F_15 ( sizeof( struct V_3 ) > V_33 ) ;
return F_16 ( & V_34 ) ;
}
