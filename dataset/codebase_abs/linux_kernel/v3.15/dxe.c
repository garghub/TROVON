...
static int F_12 ( struct V_4 * V_58 )
{
...
V_58 -> V_63 = F_13 ( NULL , V_62 , & V_58 -> V_64 ,
V_21 ) ;
if ( ! V_58 -> V_63 )
return - V_25 ;
...
void F_24 ( struct V_1 * V_2 , T_4 V_92 )
{
struct V_93 * V_94 ;
struct V_87 * V_88 ;
unsigned long V_95 ;
...
static void F_31 ( struct V_1 * V_2 , struct V_4 * V_5 )
{
...
do {
if ( V_15 -> V_88 ) {
F_32 ( NULL , V_15 -> V_65 -> V_72 ,
V_15 -> V_88 -> V_100 , V_101 ) ;
V_94 = F_28 ( V_15 -> V_88 ) ;
if ( ! ( V_94 -> V_95 & V_102 ) ) {
F_33 ( V_2 -> V_99 , V_15 -> V_88 ) ;
}
F_25 ( & V_15 -> V_103 , V_95 ) ;
if ( V_2 -> V_104 ) {
V_2 -> V_104 = false ;
F_30 ( V_2 -> V_99 ) ;
}
...
static T_5 F_34 ( int V_106 , void * V_107 )
{
struct V_1 * V_2 = (struct V_1 * ) V_107 ;
int V_108 , V_109 ;
F_16 ( V_2 , V_110 , & V_108 ) ;
if ( V_108 & V_111 ) {
F_16 ( V_2 ,
V_112 ,
& V_109 ) ;
...
{
int V_26 ;
V_26 = F_40 ( V_2 -> V_119 , F_34 ,
V_120 , L_7 , V_2 ) ;
if ( V_26 ) {
F_10 ( L_8 ) ;
goto V_53;
}
V_26 = F_40 ( V_2 -> V_118 , F_35 , V_120 ,
L_9 , V_2 ) ;
if ( V_26 ) {
F_10 ( L_10 ) ;
goto V_121;
...
V_63 = F_13 ( NULL , V_125 , & V_2 -> V_126 . V_81 ,
V_21 ) ;
if ( ! V_63 )
goto V_53;
V_2 -> V_126 . V_82 = V_63 ;
...
V_63 = F_13 ( NULL , V_125 , & V_2 -> V_128 . V_81 ,
V_21 ) ;
if ( ! V_63 )
goto V_53;
V_2 -> V_128 . V_82 = V_63 ;
...
{
if ( V_2 -> V_126 . V_82 )
F_47 ( NULL , V_2 -> V_126 . V_79 *
V_35 ,
V_2 -> V_126 . V_82 ,
V_2 -> V_126 . V_81 ) ;
if ( V_2 -> V_128 . V_82 ) {
F_47 ( NULL , V_2 -> V_128 . V_79 *
V_34 ,
V_2 -> V_128 . V_82 ,
V_2 -> V_128 . V_81 ) ;
}
