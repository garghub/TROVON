...
if ( V_106 && V_105 == V_70 ) {
switch ( V_2 -> V_107 . V_112 ) {
case V_113 :
V_2 -> V_107 . V_112 = V_114 ;
break;
case V_115 :
V_2 -> V_107 . V_112 = V_116 ;
break;
default:
break;
}
...
F_6 ( V_2 , V_117 , V_100 ) ;
F_6 ( V_2 , V_120 , V_101 ) ;
V_103 = ( V_2 -> V_107 . V_108 << 10 ) | V_126 ;
for ( V_56 = 0 ; V_56 < V_127 ; V_56 ++ ) {
if ( ( V_2 -> V_107 . V_123 & V_114 ) &&
V_2 -> V_107 . V_109 [ V_56 ] ) {
V_104 = ( V_2 -> V_107 . V_109 [ V_56 ] << 10 ) | V_128 ;
...
V_102 = V_2 -> V_107 . V_110 * 0x00010001 ;
for ( V_56 = 0 ; V_56 < ( V_127 / 2 ) ; V_56 ++ )
F_6 ( V_2 , F_23 ( V_56 ) , V_102 ) ;
F_6 ( V_2 , V_129 , V_2 -> V_107 . V_110 / 2 ) ;
V_8:
return V_31 ;
}
