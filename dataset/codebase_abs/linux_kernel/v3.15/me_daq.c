...
int V_19 ;
V_27 -> V_39 &= 0xFFFC ;
F_6 ( V_27 -> V_39 , V_27 -> V_24 + V_40 ) ;
V_27 -> V_21 &= ~ ( V_41 | V_42 ) ;
F_6 ( V_27 -> V_21 , V_27 -> V_24 + V_25 ) ;
F_6 ( 0x00 , V_27 -> V_24 + V_43 ) ;
V_27 -> V_21 |= ( V_41 | V_42 ) ;
F_6 ( V_27 -> V_21 , V_27 -> V_24 + V_25 ) ;
V_32 = V_16 & 0x0f ;
V_32 |= ( V_37 & 0x03 ) << 4 ;
V_32 |= ( V_37 & 0x04 ) << 4 ;
V_32 |= ( ( V_38 & V_44 ) ? 0x80 : 0 ) ;
F_6 ( V_32 & 0xff , V_27 -> V_24 + V_45 ) ;
V_27 -> V_39 |= V_46 ;
F_6 ( V_27 -> V_39 , V_27 -> V_24 + V_40 ) ;
F_9 ( V_27 -> V_24 + V_47 ) ;
...
unsigned int V_64 ;
unsigned int V_49 ;
F_18 ( 0x00 , V_27 -> V_65 + V_66 ) ;
V_63 = F_9 ( V_27 -> V_24 + V_67 ) ;
F_1 ( 1 ) ;
F_19 ( 0x00 , V_27 -> V_24 + 0x0 ) ;
F_1 ( 1 ) ;
if ( V_62 < 16 )
return - V_68 ;
...
F_19 ( ( V_12 [ 16 + V_49 ] & 0xff ) ,
V_27 -> V_24 + 0x0 ) ;
for ( V_49 = 0 ; V_49 < 5 ; V_49 ++ )
F_19 ( 0x00 , V_27 -> V_24 + 0x0 ) ;
V_63 = F_20 ( V_27 -> V_65 + V_66 ) ;
if ( V_63 & V_69 ) {
F_18 ( 0x00 , V_27 -> V_65 + V_66 ) ;
F_21 ( V_7 -> V_70 , L_1 ) ;
return - V_71 ;
...
V_7 -> V_81 = V_78 ;
V_7 -> V_82 = V_78 -> V_83 ;
V_27 = F_26 ( V_7 , sizeof( * V_27 ) ) ;
if ( ! V_27 )
return - V_84 ;
V_19 = F_27 ( V_7 ) ;
if ( V_19 )
return V_19 ;
V_27 -> V_65 = F_28 ( V_76 , 0 ) ;
if ( ! V_27 -> V_65 )
return - V_84 ;
V_27 -> V_24 = F_28 ( V_76 , 2 ) ;
if ( ! V_27 -> V_24 )
return - V_84 ;
if ( V_78 -> V_85 ) {
