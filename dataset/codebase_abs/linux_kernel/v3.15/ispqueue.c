...
if ( V_2 -> V_45 -> V_46 -> V_63 )
V_16 = V_2 -> V_45 -> V_46 -> V_63 ( V_2 ) ;
V_59:
if ( V_16 < 0 ) {
F_23 ( V_2 ) ;
return V_16 ;
...
{
if ( V_77 ) {
return ( V_2 -> V_68 != V_73 &&
V_2 -> V_68 != V_74 )
? 0 : - V_78 ;
}
return F_39 ( V_2 -> V_79 ,
V_2 -> V_68 != V_73 &&
V_2 -> V_68 != V_74 ) ;
}
static int F_40 ( struct V_80 * V_45 )
{
unsigned int V_31 ;
if ( V_45 -> V_81 )
return - V_82 ;
for ( V_31 = 0 ; V_31 < V_45 -> V_83 ; ++ V_31 ) {
if ( V_45 -> V_84 [ V_31 ] -> V_65 != 0 )
return - V_82 ;
}
for ( V_31 = 0 ; V_31 < V_45 -> V_83 ; ++ V_31 ) {
struct V_1 * V_2 = V_45 -> V_84 [ V_31 ] ;
F_23 ( V_2 ) ;
F_17 ( V_2 -> V_33 ) ;
V_2 -> V_33 = NULL ;
F_41 ( V_2 ) ;
...
static int F_43 ( struct V_80 * V_45 ,
unsigned int V_85 ,
unsigned int V_86 , enum V_87 V_17 )
{
struct V_1 * V_2 ;
unsigned int V_31 ;
void * V_88 ;
...
V_2 -> V_4 . V_5 . V_39 = V_31 * F_12 ( V_86 ) ;
V_2 -> V_33 = V_88 ;
}
V_2 -> V_4 . V_91 = V_31 ;
V_2 -> V_4 . V_9 = V_86 ;
...
int F_47 ( struct V_80 * V_45 )
{
return F_40 ( V_45 ) ;
}
int F_48 ( struct V_80 * V_45 ,
enum V_95 type ,
const struct V_96 * V_46 ,
struct V_97 * V_51 , unsigned int V_89 )
{
F_42 ( & V_45 -> V_45 ) ;
F_49 ( & V_45 -> V_11 ) ;
F_50 ( & V_45 -> V_98 ) ;
...
int F_51 ( struct V_80 * V_45 ,
struct V_99 * V_100 )
{
unsigned int V_85 = V_100 -> V_83 ;
unsigned int V_86 ;
int V_16 ;
if ( V_100 -> type != V_45 -> type )
return - V_21 ;
V_45 -> V_46 -> V_101 ( V_45 , & V_85 , & V_86 ) ;
if ( V_86 == 0 )
return - V_21 ;
V_85 = F_52 (unsigned int, nbuffers, ISP_VIDEO_MAX_BUFFERS) ;
F_53 ( & V_45 -> V_11 ) ;
V_16 = F_43 ( V_45 , V_85 , V_86 , V_100 -> V_17 ) ;
if ( V_16 < 0 )
goto V_59;
V_100 -> V_83 = V_16 ;
V_16 = 0 ;
...
return - V_21 ;
F_53 ( & V_45 -> V_11 ) ;
if ( V_4 -> V_91 >= V_45 -> V_83 ) {
V_16 = - V_21 ;
goto V_59;
}
V_2 = V_45 -> V_84 [ V_4 -> V_91 ] ;
F_37 ( V_2 , V_4 ) ;
V_59:
F_54 ( & V_45 -> V_11 ) ;
return V_16 ;
}
int F_56 ( struct V_80 * V_45 ,
struct V_64 * V_4 )
{
struct V_1 * V_2 ;
unsigned long V_66 ;
...
int F_60 ( struct V_80 * V_45 ,
struct V_64 * V_4 , int V_77 )
{
struct V_1 * V_2 ;
int V_16 ;
if ( V_4 -> type != V_45 -> type )
...
V_2 = F_62 ( & V_45 -> V_45 , struct V_1 , V_103 ) ;
V_16 = F_38 ( V_2 , V_77 ) ;
if ( V_16 < 0 )
goto V_59;
F_63 ( & V_2 -> V_103 ) ;
...
for ( V_31 = 0 ; V_31 < V_45 -> V_83 ; ++ V_31 ) {
V_2 = V_45 -> V_84 [ V_31 ] ;
if ( ( V_2 -> V_4 . V_5 . V_39 >> V_34 ) == V_13 -> V_106 )
break;
}
if ( V_31 == V_45 -> V_83 ) {
V_16 = - V_21 ;
...
V_86 = V_13 -> V_28 - V_13 -> V_107 ;
if ( V_2 -> V_4 . V_17 != V_18 ||
V_86 != F_12 ( V_2 -> V_4 . V_9 ) ) {
V_16 = - V_21 ;
goto V_59;
}
...
unsigned int F_73 ( struct V_80 * V_45 ,
struct V_110 * V_110 , T_3 * V_79 )
{
struct V_1 * V_2 ;
