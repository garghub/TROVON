...
{
struct V_172 * V_125 = F_74 ( V_17 ) ;
struct V_173 * V_16 = F_75 ( V_17 ) ;
...
static int F_81 ( struct V_109 * V_17 )
{
struct V_172 * V_125 = F_74 ( V_17 ) ;
struct V_173 * V_16 = F_75 ( V_17 ) ;
struct V_1 * V_2 = V_16 -> V_22 ;
...
F_89 ( V_183 , L_14 ,
F_5 ( V_2 , F_18 ( V_155 ) ) ) ;
F_89 ( V_183 , L_15 , V_26 ) ;
F_89 ( V_183 , L_16 ,
V_26 & V_9 ? L_17 : L_18 ,
V_26 & V_10 ? L_19 : L_18 ,
V_26 & V_11 ? L_20 : L_18 ,
( V_26 & ( V_9 | V_10 | V_11 ) ) == 0 ? L_21 : L_18 ) ;
}
static void F_90 ( struct V_1 * V_2 )
{
struct V_180 * V_181 ;
if ( ! F_91 ( V_2 -> V_16 , L_22 , & V_181 ) )
F_92 ( V_181 , V_2 , F_88 ) ;
}
static int F_93 ( struct V_184 * V_109 )
{
struct V_1 * V_2 = V_109 -> V_185 ;
return F_66 ( V_2 ) ;
}
static int F_94 ( struct V_173 * V_16 ,
struct V_172 * V_125 ,
unsigned long V_131 ,
struct V_1 * * V_186 )
{
...
struct V_190 * V_129 ;
* V_186 = NULL ;
if ( ( V_103 = F_83 ( V_125 ) ) < 0 )
return V_103 ;
V_2 = F_95 ( sizeof( * V_2 ) , V_192 ) ;
if ( V_2 == NULL ) {
F_71 ( V_125 ) ;
return - V_193 ;
}
...
V_2 -> V_125 = V_125 ;
V_2 -> V_63 = - 1 ;
if ( ( V_103 = F_97 ( V_125 , V_16 -> V_123 ) ) < 0 ) {
F_72 ( V_2 ) ;
F_71 ( V_125 ) ;
return V_103 ;
}
if ( V_131 == V_134 ) {
V_2 -> V_4 = F_98 ( V_125 , 0 , 0 ) ;
goto V_194;
}
if ( F_99 ( V_125 , 2 ) & V_195 )
V_2 -> V_6 = F_98 ( V_125 , 2 , 0 ) ;
else
V_2 -> V_6 = F_98 ( V_125 , 0 , 0 ) ;
if ( ! V_2 -> V_6 ) {
F_20 ( V_16 -> V_17 , L_23 ) ;
F_66 ( V_2 ) ;
return - V_12 ;
}
if ( F_99 ( V_125 , 3 ) & V_195 )
V_2 -> V_4 = F_98 ( V_125 , 3 , 0 ) ;
else
V_2 -> V_4 = F_98 ( V_125 , 1 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_20 ( V_16 -> V_17 , L_24 ) ;
F_66 ( V_2 ) ;
return - V_12 ;
...
V_194:
if ( F_86 ( V_125 -> V_63 , F_29 , V_177 ,
V_178 , V_2 ) ) {
F_20 ( V_16 -> V_17 , L_25 , V_125 -> V_63 ) ;
F_66 ( V_2 ) ;
return - V_18 ;
}
V_2 -> V_63 = V_125 -> V_63 ;
...
if ( V_131 == V_134 )
V_33 -> V_198 = ( V_33 -> V_37 - 0x40 ) / 0x10 ;
}
V_2 -> V_47 = ( V_131 == V_168 ) ? 0 : 1 ;
if ( F_101 ( V_124 , F_54 ( V_125 ) ,
V_2 -> V_69 * sizeof( T_2 ) * V_199 * 2 ,
& V_2 -> V_170 ) < 0 ) {
F_66 ( V_2 ) ;
return - V_193 ;
}
...
for ( V_59 = 0 ; V_59 < V_2 -> V_69 ; V_59 ++ ) {
V_33 = & V_2 -> V_70 [ V_59 ] ;
V_33 -> V_35 = ( ( T_2 * ) V_2 -> V_170 . V_171 ) + ( V_59 * V_199 * 2 ) ;
V_33 -> V_39 = V_2 -> V_170 . V_6 + ( V_59 * sizeof( T_2 ) * V_199 * 2 ) ;
V_187 |= V_33 -> V_68 ;
}
V_2 -> V_66 = V_200 ;
V_2 -> V_68 = V_187 ;
...
if ( ( V_103 = F_102 ( V_16 , V_201 , V_2 , & V_147 ) ) < 0 ) {
F_66 ( V_2 ) ;
return V_103 ;
}
* V_186 = V_2 ;
...
static int F_103 ( struct V_172 * V_125 ,
...
int V_103 ;
struct V_204 * V_114 ;
V_103 = F_104 ( & V_125 -> V_17 , V_205 , V_206 , V_207 , 0 , & V_16 ) ;
if ( V_103 < 0 )
return V_103 ;
strcpy ( V_16 -> V_208 , L_26 ) ;
strcpy ( V_16 -> V_123 , L_6 ) ;
for ( V_114 = V_209 ; V_114 -> V_206 ; V_114 ++ ) {
if ( V_125 -> V_109 == V_114 -> V_206 ) {
strcpy ( V_16 -> V_123 , V_114 -> V_210 ) ;
break;
}
}
strcat ( V_16 -> V_123 , L_27 ) ;
if ( ( V_103 = F_94 ( V_16 , V_125 , V_203 -> V_211 , & V_2 ) ) < 0 ) {
F_105 ( V_16 ) ;
return V_103 ;
}
V_16 -> V_22 = V_2 ;
...
F_90 ( V_2 ) ;
sprintf ( V_16 -> V_212 , L_28 ,
V_16 -> V_123 , V_2 -> V_63 ) ;
if ( ( V_103 = F_106 ( V_16 ) ) < 0 ) {
F_105 ( V_16 ) ;
return V_103 ;
}
F_107 ( V_125 , V_16 ) ;
...
static void F_108 ( struct V_172 * V_125 )
{
F_105 ( F_109 ( V_125 ) ) ;
}
