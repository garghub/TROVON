...
F_67 ( & V_75 -> V_118 ) ;
F_68 () ;
V_38 = F_69 ( V_101 , V_119 ) ;
if ( V_38 )
GOTO ( V_61 , V_38 ) ;
V_113 . V_120 = V_121 ;
V_113 . V_122 = 1 ;
V_113 . V_123 = 0 ;
V_38 = F_70 ( V_101 , V_55 -> V_117 , & V_113 ,
& V_75 -> V_124 ) ;
if ( V_38 )
GOTO ( V_125 , V_38 ) ;
V_38 = F_71 ( V_101 , V_55 -> V_117 , & V_112 ) ;
if ( V_38 )
GOTO ( V_125 , V_38 ) ;
V_115 = F_72 ( V_101 , V_55 -> V_117 , & V_112 ,
& V_75 -> V_124 -> V_126 -> V_127 ) ;
if ( F_43 ( F_39 ( V_115 ) ) )
GOTO ( V_128 , V_38 = F_40 ( V_115 ) ) ;
V_116 = F_73 ( V_101 , V_75 -> V_124 , V_115 ,
V_129 ,
V_130 | V_131 | V_132 | V_133 ) ;
F_74 ( V_101 , & V_115 -> V_134 ) ;
if ( F_39 ( V_116 ) )
...
V_138:
if ( V_38 ) {
F_76 ( V_101 , & V_75 -> V_109 -> V_134 ) ;
V_75 -> V_109 = NULL ;
}
V_128:
if ( V_38 < 0 ) {
F_77 ( V_101 , V_75 -> V_124 ) ;
V_75 -> V_124 = NULL ;
F_78 ( & V_75 -> V_118 ) ;
}
V_125:
...
static int F_85 ( const struct V_100 * V_101 , struct V_34 * V_35 )
{
struct V_103 * V_104 ;
V_104 = F_61 ( V_35 , V_140 ) ;
if ( V_104 )
...
static int F_86 ( struct V_34 * V_35 , enum V_142 V_143 )
{
int V_38 = 0 ;
switch ( V_143 ) {
case V_144 :
...
static int F_95 ( struct V_34 * V_35 , struct V_150 * V_53 )
{
struct V_151 V_152 ;
int V_38 ;
F_96 () ;
...
F_98 ( & V_152 ) ;
F_99 ( V_35 , V_152 . V_155 ) ;
F_100 ( V_35 ) ;
if ( F_101 ( & V_146 ) == 1 ) {
V_84 = 0 ;
F_102 ( & V_97 ) ;
V_38 = F_40 ( F_103 ( F_51 , NULL ,
L_33 ) ) ;
if ( F_104 ( V_38 ) ) {
F_2 ( L_34
L_35 ,
...
static int F_105 ( struct V_156 * V_157 , struct V_158 * V_159 ,
void * V_71 , int V_160 )
{
struct V_161 V_162 ;
...
static int F_110 ( struct V_170 * exp ,
struct V_171 * V_172 )
{
struct V_173 * V_174 ;
struct V_171 * V_175 , * V_176 ;
int V_38 ;
V_174 = F_111 ( F_112 ( exp ) ,
& V_177 , V_178 ,
V_179 ) ;
if ( ! V_174 )
return - V_39 ;
V_175 = F_113 ( & V_174 -> V_180 , & V_181 ) ;
if ( ! V_175 ) {
F_114 ( V_174 ) ;
return - V_39 ;
}
...
V_38 = F_116 ( V_174 ) ;
if ( ! V_38 ) {
V_176 = F_117 ( & V_174 -> V_180 , & V_181 ) ;
memcpy ( V_172 , V_176 , sizeof( * V_176 ) ) ;
}
F_114 ( V_174 ) ;
return V_38 ;
}
static int F_118 ( struct V_170 * exp , struct V_184 * V_185 ,
...
if ( V_174 == NULL )
return - V_39 ;
F_119 ( & V_174 -> V_180 , & V_205 , V_206 , 0 ) ;
F_115 ( V_174 ) ;
if ( V_17 -> V_32 . V_45 ) {
...
V_38 = F_120 ( exp , & V_174 , & V_195 , & V_17 -> V_50 , NULL , V_188 ,
NULL , 0 , V_208 , V_162 , 0 ) ;
F_114 ( V_174 ) ;
return V_38 ;
}
static int F_121 ( struct V_170 * exp , struct V_184 * V_209 ,
T_2 V_187 , struct V_161 * V_162 )
{
F_122 ( V_162 , V_187 ) ;
return 0 ;
}
static void F_123 ( struct V_34 * V_210 )
{
F_21 ( & V_21 ) ;
V_84 |= V_93 ;
F_15 ( & V_21 ) ;
...
static int F_124 ( struct V_170 * exp ,
struct V_211 * V_212 )
{
struct V_173 * V_174 ;
...
int F_125 ( const struct V_100 * V_101 , struct V_170 * exp ,
T_4 V_221 , void * V_222 , T_4 V_223 ,
void * V_224 , struct V_225 * V_226 )
{
int V_38 = - V_6 ;
if ( F_126 ( V_227 ) ) {
struct V_72 * V_73 = F_112 ( exp ) ;
int V_228 ;
if ( V_223 != sizeof( int ) )
return - V_6 ;
V_228 = * ( int * ) V_224 ;
...
static int F_132 ( const struct V_100 * V_101 , struct V_170 * exp ,
...
static int F_133 ( struct V_34 * V_35 ,
struct V_72 * V_73 ,
enum V_251 V_252 )
{
int V_38 = 0 ;
...
static int F_137 ( struct V_34 * V_265 ,
struct V_16 * V_17 ,
T_1 V_266 ,
...
F_12 ( F_35 ( V_55 ) ) ;
V_38 = F_138 ( V_55 -> V_281 , V_274 , NULL ,
V_279 ) ;
if ( V_38 ) {
F_19 ( V_274 , V_279 ) ;
return - V_6 ;
...
V_38 = F_143 ( V_35 -> V_74 . V_75 . V_76 ,
V_270 -> V_74 . V_297 [ 0 ] ,
(struct V_298 * ) V_287 ) ;
F_50 ( & V_35 -> V_74 . V_75 . V_82 ) ;
if ( V_38 < 0 ) {
F_2 ( L_71 ,
F_144 ( V_270 -> V_74 . V_297 [ 0 ] ) ) ;
break;
}
F_5 ( V_19 , L_72 ,
V_287 , F_144 ( V_270 -> V_74 . V_297 [ 0 ] ) ) ;
V_277 += strlen ( V_287 ) ;
V_277 += sprintf ( V_275 + V_277 , L_73 , V_270 -> V_299 ) ;
F_12 ( V_277 < V_276 ) ;
F_145 ( & V_272 , 1 , V_286 ) ;
V_38 = - V_39 ;
V_53 = F_146 ( V_300 , & V_272 ) ;
if ( V_53 == NULL ) {
F_2 ( L_74 ) ;
break;
}
...
V_308 [ V_311 ] = F_150 ( V_316 ) ;
if ( V_308 [ V_311 ] == NULL )
GOTO ( V_315 , V_38 = - V_39 ) ;
}
V_317:
F_12 ( F_151 ( V_17 ) ) ;
F_12 ( F_152 ( & V_17 -> V_42 ) ) ;
V_174 = F_153 ( F_112 ( V_17 -> V_26 ) ,
& V_318 ) ;
if ( V_174 == NULL )
GOTO ( V_315 , V_38 = - V_39 ) ;
V_38 = F_154 ( V_174 , V_178 , V_319 ) ;
if ( V_38 )
GOTO ( V_315 , V_38 ) ;
V_303 = F_113 ( & V_174 -> V_180 , & V_320 ) ;
F_12 ( V_303 != NULL ) ;
F_12 ( sizeof( V_303 -> V_321 ) > strlen ( V_17 -> V_20 ) ) ;
if ( F_155 ( V_303 -> V_321 , V_17 -> V_20 , sizeof( V_303 -> V_321 ) )
>= sizeof( V_303 -> V_321 ) )
...
V_303 -> V_324 = V_325 ;
V_303 -> V_326 = V_309 ;
V_159 = F_156 ( V_174 , V_309 , 1 , V_327 ,
V_328 ) ;
if ( V_159 == NULL )
GOTO ( V_315 , V_38 = - V_39 ) ;
for ( V_311 = 0 ; V_311 < V_309 ; V_311 ++ )
F_157 ( V_159 , V_308 [ V_311 ] , 0 , V_279 ) ;
F_115 ( V_174 ) ;
V_38 = F_116 ( V_174 ) ;
if ( V_38 )
GOTO ( V_315 , V_38 ) ;
V_305 = F_117 ( & V_174 -> V_180 , & V_329 ) ;
...
V_312 = F_158 ( V_174 , V_174 -> V_332 , 0 ) ;
if ( V_312 < 0 )
...
int V_336 ;
void * V_60 ;
V_60 = F_161 ( V_308 [ V_311 ] ) ;
V_336 = F_137 ( V_35 , V_17 , V_305 -> V_331 , V_60 ,
F_162 ( int , V_312 , V_279 ) ,
V_268 ) ;
F_163 ( V_308 [ V_311 ] ) ;
if ( V_336 < 0 ) {
F_164 ( L_80 ,
...
static int F_166 ( const struct V_100 * V_101 ,
struct V_34 * V_35 ,
struct V_103 * V_337 ,
...
V_38 = F_167 ( V_101 , V_35 , V_338 , V_338 , V_14 , V_339 ) ;
if ( V_38 < 0 && V_38 != - V_52 )
GOTO ( V_315 , V_38 ) ;
V_38 = F_167 ( V_101 , V_35 , V_337 , V_338 , V_14 , V_14 ) ;
if ( V_38 == - V_52 ) {
F_168 ( V_101 , V_338 , NULL , V_14 ) ;
} else if ( V_38 < 0 ) {
F_167 ( V_101 , V_35 , V_338 , V_338 , V_339 , V_14 ) ;
V_315:
F_2 ( L_82 ,
V_35 -> V_49 , V_14 , V_38 ) ;
}
F_168 ( V_101 , V_338 , NULL , V_339 ) ;
F_19 ( V_339 , strlen ( V_14 ) + 1 ) ;
return V_38 ;
}
static int F_169 ( struct V_34 * V_265 ,
...
if ( V_338 && V_55 && F_36 ( V_55 ) && ! F_170 ( V_55 ) &&
V_341 != NULL &&
F_171 ( V_341 -> V_134 . V_344 ) == V_55 -> V_117 ) {
if ( ! V_340 )
V_38 = F_166 ( V_101 , V_265 , V_104 , V_338 ,
V_17 -> V_20 ) ;
if ( V_340 || V_38 ) {
if ( F_172 ( V_101 , V_338 , V_17 -> V_20 ) ) {
F_173 ( 0x13a ,
L_83 ,
V_17 -> V_20 ) ;
...
V_38 = F_175 ( V_101 , V_104 , V_17 -> V_20 ,
& V_17 -> V_32 ) ;
V_345:
F_176 ( V_101 , V_104 ) ;
if ( V_338 )
...
V_348 = F_118 ( V_265 -> V_74 . V_75 . V_350 , NULL , V_351 , NULL ,
V_352 , & V_188 , NULL , NULL , NULL ,
V_17 , 0 , NULL , & V_162 ) ;
if ( V_348 == 0 ) {
F_8 ( V_17 ) ;
V_38 = F_180 ( & V_162 , ( void * ) V_17 ) ;
F_12 ( V_38 == 0 ) ;
} else {
F_5 ( V_11 , L_86 , V_348 ) ;
V_17 -> V_98 = 1 ;
...
V_38 = 0 ;
if ( V_348 == 0 )
V_38 = F_149 ( V_265 , V_17 ) ;
} else {
V_38 = F_169 ( V_265 , V_17 , V_348 != 0 ) ;
}
F_5 ( V_11 , L_87 ,
V_265 -> V_49 , V_17 -> V_20 , V_38 ? L_88 : L_89 , V_38 ) ;
F_44 ( & V_17 -> V_42 ) ;
if ( ! V_348 ) {
V_348 = F_121 ( V_265 -> V_74 . V_75 . V_350 , NULL ,
V_352 , & V_162 ) ;
if ( V_348 )
F_2 ( L_90 , V_348 ) ;
}
...
static int F_181 ( struct V_34 * V_35 , T_4 V_2 , void * V_275 )
{
...
sizeof( struct V_211 ) )
GOTO ( V_315 , V_38 = - V_6 ) ;
V_212 = (struct V_211 * ) F_183 ( V_53 , 1 ) ;
F_5 ( V_11 , L_91 ,
V_212 -> V_218 , V_212 -> V_238 ) ;
V_38 = F_124 ( V_35 -> V_74 . V_75 . V_350 , V_212 ) ;
break;
}
case V_355 :
F_2 ( L_92 ) ;
...
struct V_36 * V_37 ;
V_14 = F_185 ( V_53 , 1 ) ;
V_28 = (struct V_27 * ) F_183 ( V_53 , 2 ) ;
V_37 = * (struct V_36 * * ) F_183 ( V_53 , 3 ) ;
F_5 ( V_11 , L_93 , V_14 ,
V_28 -> V_43 ) ;
