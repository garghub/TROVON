...
V_32 -> V_139 = 1 ;
#if F_53 ( V_62 )
if ( V_8 -> V_2 -> V_63 == V_64 && ! V_8 -> V_65 )
error = F_91 ( V_8 -> V_2 , V_32 , NULL ) ;
else
#endif
error = F_92 ( V_8 -> V_2 , V_32 , V_135 ) ;
if ( error >= 0 ) {
F_39 ( & V_8 -> V_40 . V_140 ) ;
...
static void F_93 ( struct V_2 * V_3 , struct V_31 * V_32 ,
int V_143 )
{
struct V_144 * V_145 = F_94 ( V_3 ) ;
struct V_56 * V_57 = F_50 ( V_32 ) ;
if ( ! F_95 ( V_32 ) || ! F_95 ( V_32 ) -> V_146 ||
! ( F_95 ( V_32 ) -> V_146 -> V_147 & V_148 ) ) {
T_3 V_73 = F_96 ( V_32 , 0 , V_143 , 0 ) ;
V_32 -> V_68 = V_74 ;
V_57 -> V_66 = F_55 ( & V_145 -> V_70 , & V_3 -> V_149 , V_143 ,
V_72 , V_73 ) ;
if ( V_57 -> V_66 == 0 )
V_57 -> V_66 = V_150 ;
} else {
V_32 -> V_68 = V_151 ;
V_32 -> V_152 = F_97 ( V_32 ) - V_32 -> V_153 ;
V_32 -> V_154 = F_98 ( struct V_56 , V_66 ) ;
V_57 -> V_66 = ~ F_55 ( & V_145 -> V_70 , & V_3 -> V_149 ,
V_143 , V_72 , 0 ) ;
}
}
int F_99 ( struct V_15 * V_20 , struct V_31 * V_32 , int V_155 )
{
int V_136 = V_32 -> V_59 ;
struct V_1 * V_8 = V_20 -> V_8 ;
...
int V_143 ;
int V_157 = V_158 ;
V_156 = V_159 + sizeof( struct V_160 ) +
V_137 + V_155 ;
if ( F_100 ( V_32 , V_156 ) ) {
F_45 ( V_32 ) ;
return V_161 ;
}
V_20 -> V_162 ( V_20 , F_83 ( V_32 , V_155 ) ) ;
memset ( & ( F_101 ( V_32 ) -> V_163 ) , 0 , sizeof( F_101 ( V_32 ) -> V_163 ) ) ;
F_101 ( V_32 ) -> V_126 &= ~ ( V_164 | V_165 |
V_166 ) ;
F_102 ( V_32 ) ;
F_103 ( V_3 ) ;
if ( F_104 ( V_3 ) ) {
...
F_105 ( V_32 ) ;
F_106 ( V_32 , F_107 ( F_108 ( V_3 , 0 ) ) ) ;
V_76 = F_58 ( V_3 ) ;
V_135 = & V_76 -> V_168 . V_135 ;
switch ( V_8 -> V_129 ) {
case V_130 :
F_83 ( V_32 , sizeof( * V_57 ) ) ;
F_109 ( V_32 ) ;
V_57 = F_50 ( V_32 ) ;
V_57 -> V_169 = V_76 -> V_170 ;
V_57 -> V_171 = V_76 -> V_172 ;
V_143 = V_137 + V_155 + V_136 ;
V_57 -> V_59 = F_86 ( V_143 ) ;
V_57 -> V_66 = 0 ;
#if F_53 ( V_62 )
...
if ( V_3 -> V_61 == V_173 )
V_32 -> V_68 = V_174 ;
else if ( ( F_95 ( V_32 ) && F_95 ( V_32 ) -> V_146 ) &&
( ! ( F_95 ( V_32 ) -> V_146 -> V_147 & V_175 ) ) ) {
V_32 -> V_68 = V_69 ;
V_73 = F_96 ( V_32 , 0 , V_143 , 0 ) ;
V_57 -> V_66 = F_110 ( V_76 -> V_77 ,
V_76 -> V_78 ,
V_143 , V_72 , V_73 ) ;
if ( V_57 -> V_66 == 0 )
V_57 -> V_66 = V_150 ;
...
if ( V_8 == NULL )
goto V_177;
F_69 ( V_8 , V_178 , L_28 , V_8 -> V_39 ) ;
switch ( V_8 -> V_129 ) {
case V_130 :
( F_113 ( V_3 ) ) -> V_179 = 0 ;
( F_113 ( V_3 ) ) -> V_180 = NULL ;
( F_113 ( V_3 ) ) -> V_181 = NULL ;
break;
case V_176 :
break;
}
...
V_20 = F_120 ( V_188 , struct V_15 , V_190 ) ;
F_69 ( V_20 , V_178 ,
L_30 , V_20 -> V_39 ) ;
F_121 ( & V_20 -> V_190 ) ;
if ( V_20 -> V_91 != NULL )
...
F_2 ( F_125 ( & V_8 -> V_9 ) != 0 ) ;
F_2 ( V_8 -> V_2 != NULL ) ;
F_69 ( V_8 , V_178 , L_31 , V_8 -> V_39 ) ;
F_126 ( V_8 , V_192 ) ;
}
static void F_127 ( struct V_193 * V_194 )
{
struct V_1 * V_8 = NULL ;
struct V_11 * V_2 = NULL ;
struct V_2 * V_3 = NULL ;
V_8 = F_128 ( V_194 , struct V_1 , V_195 ) ;
V_3 = F_9 ( V_8 ) ;
if ( ! V_3 )
return;
V_2 = V_3 -> V_14 ;
...
V_10 = F_133 ( V_211 , V_212 , 0 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_134 ( V_2 -> V_3 , V_6 ) ;
V_206 . V_213 = V_211 ;
memcpy ( & V_206 . V_214 , V_198 -> V_209 ,
sizeof( V_206 . V_214 ) ) ;
V_206 . V_215 = F_86 ( V_198 -> V_216 ) ;
V_10 = F_135 ( V_2 , (struct V_217 * ) & V_206 ,
sizeof( V_206 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_206 . V_213 = V_211 ;
memcpy ( & V_206 . V_214 , V_198 -> V_210 ,
sizeof( V_206 . V_214 ) ) ;
V_206 . V_215 = F_86 ( V_198 -> V_218 ) ;
V_10 = F_136 ( V_2 ,
(struct V_217 * ) & V_206 ,
sizeof( V_206 ) , 0 ) ;
if ( V_10 < 0 )
...
#endif
{
V_10 = F_133 ( V_219 , V_212 , 0 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_134 ( V_2 -> V_3 , V_6 ) ;
V_202 . V_220 = V_219 ;
V_202 . V_221 = V_198 -> V_222 ;
V_202 . V_223 = F_86 ( V_198 -> V_216 ) ;
V_10 = F_135 ( V_2 , (struct V_217 * ) & V_202 ,
sizeof( V_202 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_202 . V_220 = V_219 ;
V_202 . V_221 = V_198 -> V_224 ;
V_202 . V_223 = F_86 ( V_198 -> V_218 ) ;
V_10 = F_136 ( V_2 ,
(struct V_217 * ) & V_202 ,
sizeof( V_202 ) , 0 ) ;
if ( V_10 < 0 )
...
#if F_53 ( V_62 )
if ( V_198 -> V_209 && V_198 -> V_210 ) {
V_10 = F_133 ( V_211 , V_212 ,
V_226 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_134 ( V_2 -> V_3 , V_6 ) ;
V_208 . V_227 = V_211 ;
memcpy ( & V_208 . V_228 , V_198 -> V_209 ,
sizeof( V_208 . V_228 ) ) ;
V_208 . V_229 = V_30 ;
V_10 = F_135 ( V_2 , (struct V_217 * ) & V_208 ,
sizeof( V_208 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_208 . V_227 = V_211 ;
memcpy ( & V_208 . V_228 , V_198 -> V_210 ,
sizeof( V_208 . V_228 ) ) ;
V_208 . V_229 = V_127 ;
V_10 = F_136 ( V_2 ,
(struct V_217 * ) & V_208 ,
...
#endif
{
V_10 = F_133 ( V_219 , V_212 ,
V_226 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_134 ( V_2 -> V_3 , V_6 ) ;
V_204 . V_227 = V_219 ;
V_204 . V_228 = V_198 -> V_222 ;
V_204 . V_229 = V_30 ;
V_10 = F_135 ( V_2 , (struct V_217 * ) & V_204 ,
sizeof( V_204 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_204 . V_227 = V_219 ;
V_204 . V_228 = V_198 -> V_224 ;
V_204 . V_229 = V_127 ;
V_10 = F_136 ( V_2 , (struct V_217 * ) & V_204 ,
sizeof( V_204 ) , 0 ) ;
if ( V_10 < 0 )
goto V_12;
}
...
int F_137 ( struct V_6 * V_6 , int V_13 , int V_96 , T_1 V_30 , T_1 V_127 , struct V_197 * V_198 , struct V_1 * * V_230 )
{
struct V_1 * V_8 = NULL ;
int V_10 ;
struct V_11 * V_2 = NULL ;
struct V_2 * V_3 = NULL ;
struct V_5 * V_17 ;
enum V_231 V_129 = V_130 ;
if ( V_13 < 0 ) {
V_10 = F_132 ( V_6 , V_30 , V_127 ,
V_198 , & V_2 ) ;
if ( V_10 < 0 )
goto V_10;
} else {
...
V_8 = F_141 ( sizeof( struct V_1 ) , V_236 ) ;
if ( V_8 == NULL ) {
V_10 = - V_237 ;
goto V_10;
}
...
V_8 -> V_65 = true ;
V_76 -> V_77 = V_145 -> V_70 . V_240 [ 3 ] ;
V_76 -> V_241 = V_3 -> V_242 . V_240 [ 3 ] ;
V_76 -> V_78 = V_3 -> V_149 . V_240 [ 3 ] ;
} else {
V_8 -> V_65 = false ;
}
}
...
V_8 -> V_129 = V_129 ;
if ( V_129 == V_130 ) {
F_113 ( V_3 ) -> V_179 = V_243 ;
F_113 ( V_3 ) -> V_180 = F_84 ;
F_113 ( V_3 ) -> V_181 = F_124 ;
#if F_53 ( V_62 )
if ( V_3 -> V_63 == V_64 && ! V_8 -> V_65 )
F_144 () ;
else
...
V_8 -> V_2 = V_3 ;
V_8 -> V_13 = V_13 ;
F_146 ( & V_3 -> V_244 . V_245 , & V_246 , L_36 ) ;
V_3 -> V_247 = V_248 ;
F_147 ( & V_8 -> V_195 , F_127 ) ;
F_148 ( & V_8 -> V_185 ) ;
F_5 ( & V_186 ) ;
F_149 ( V_8 ) ;
F_34 ( & V_17 -> V_184 ) ;
F_150 ( & V_8 -> V_185 , & V_17 -> V_249 ) ;
F_41 ( & V_17 -> V_184 ) ;
V_10 = 0 ;
V_10:
if ( V_230 )
...
int F_151 ( struct V_1 * V_8 )
{
F_116 ( V_8 ) ;
return ( false == F_152 ( V_251 , & V_8 -> V_195 ) ) ;
}
void F_153 ( struct V_15 * V_20 )
{
struct V_1 * V_8 = V_20 -> V_8 ;
F_2 ( F_125 ( & V_20 -> V_9 ) != 0 ) ;
if ( V_8 ) {
F_2 ( V_8 -> V_110 != V_239 ) ;
if ( V_20 -> V_16 != 0 )
F_115 ( & V_252 ) ;
...
V_20 -> V_155 = 4 + V_20 -> V_132 + V_20 -> V_104 + V_20 -> V_90 ;
if ( V_20 -> V_8 -> V_129 == V_130 )
V_20 -> V_155 += 4 ;
}
}
struct V_15 * F_158 ( int V_255 , struct V_1 * V_8 , T_1 V_16 , T_1 V_128 , struct V_256 * V_198 )
{
struct V_15 * V_20 ;
V_20 = F_141 ( sizeof( struct V_15 ) + V_255 , V_236 ) ;
if ( V_20 != NULL ) {
V_20 -> V_110 = V_111 ;
V_20 -> V_8 = V_8 ;
V_20 -> V_16 = V_16 ;
...
if ( V_198 ) {
V_20 -> V_257 = V_198 -> V_258 ;
V_20 -> V_114 = V_198 -> V_114 ;
V_20 -> V_259 = V_198 -> V_259 ;
V_20 -> V_260 = V_198 -> V_260 ;
V_20 -> V_106 = V_198 -> V_106 ;
V_20 -> V_107 = V_198 -> V_107 ;
V_20 -> V_105 = V_198 -> V_105 ;
V_20 -> V_82 = V_198 -> V_82 ;
V_20 -> V_90 = V_198 -> V_90 ;
V_20 -> V_100 = V_198 -> V_100 ;
V_20 -> V_104 = V_198 -> V_104 ;
V_20 -> V_132 = V_198 -> V_132 ;
memcpy ( & V_20 -> V_133 [ 0 ] , & V_198 -> V_133 [ 0 ] , V_198 -> V_132 ) ;
V_20 -> V_92 = V_198 -> V_92 ;
memcpy ( & V_20 -> V_93 [ 0 ] , & V_198 -> V_93 [ 0 ] , V_198 -> V_92 ) ;
}
if ( V_8 -> V_96 == V_97 )
V_20 -> V_162 = F_85 ;
else
...
static T_5 int F_163 ( struct V_6 * V_6 )
{
...
F_164 ( & V_17 -> V_184 ) ;
for ( V_25 = 0 ; V_25 < V_29 ; V_25 ++ )
F_165 ( & V_17 -> V_261 [ V_25 ] ) ;
F_164 ( & V_17 -> V_253 ) ;
return 0 ;
}
static T_6 void F_166 ( struct V_6 * V_6 )
{
struct V_5 * V_17 = F_1 ( V_6 ) ;
struct V_1 * V_8 = NULL ;
F_18 () ;
