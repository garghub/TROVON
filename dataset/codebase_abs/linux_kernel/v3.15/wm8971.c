...
F_24 ( V_12 , V_73 , 0x0100 , 0x0100 ) ;
F_24 ( V_12 , V_74 , 0x0100 , 0x0100 ) ;
F_24 ( V_12 , V_75 , 0x0100 , 0x0100 ) ;
F_24 ( V_12 , V_76 , 0x0100 , 0x0100 ) ;
return V_67 ;
}
...
struct V_81 * V_81 ;
int V_67 ;
V_14 = F_28 ( & V_78 -> V_82 , sizeof( struct V_13 ) ,
V_83 ) ;
if ( V_14 == NULL )
return - V_68 ;
V_81 = F_29 ( V_78 , & V_84 ) ;
...
static int F_34 ( struct V_77 * V_87 )
{
F_35 ( & V_87 -> V_82 ) ;
return 0 ;
}
