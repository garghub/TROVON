...
static int F_41 ( struct V_39 * V_40 , struct V_22 * V_22 , struct V_41 * V_42
)
{
F_42 ( V_22 -> V_43 , V_42 ) ;
V_42 -> V_44 = V_45 . V_44 + F_43 () ;
return 0 ;
}
static struct V_22 * F_44 ( struct V_46 * V_47 , struct V_22 * V_22 , unsigned int V_21 )
{
if ( ! F_45 ( V_47 , V_22 , V_21 ) )
return NULL ;
return F_46 ( V_47 , V_22 , V_21 ) ;
}
static int F_47 ( struct V_48 * V_48 , struct V_49 * V_50 )
{
if ( V_50 -> V_51 < V_52 ) {
int error = F_48 ( V_48 , V_50 ) ;
if ( F_49 ( error <= 0 ) )
return error ;
V_50 -> V_51 = V_52 ;
}
return F_50 ( V_48 , V_50 ) ;
}
