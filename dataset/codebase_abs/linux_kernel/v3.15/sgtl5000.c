...
static int F_54 ( struct V_27 * V_7 )
{
int V_116 ;
int V_251 ;
int V_252 = 0 ;
struct V_44 * V_45 = F_14 ( V_7 ) ;
struct V_253 * V_218 ;
for ( V_251 = 0 ; V_251 < F_40 ( V_45 -> V_170 ) ; V_251 ++ )
V_45 -> V_170 [ V_251 ] . V_249 = V_254 [ V_251 ] ;
if ( V_45 -> V_255 < 0x11 ) {
V_218 = F_55 ( V_7 -> V_86 , L_13 ) ;
if ( F_34 ( V_218 ) ) {
if ( F_35 ( V_218 ) == - V_256 )
return - V_256 ;
} else {
...
V_116 = F_57 ( V_7 -> V_86 , F_40 ( V_45 -> V_170 ) ,
V_45 -> V_170 ) ;
if ( V_116 )
goto V_257;
...
static int F_59 ( struct V_27 * V_7 )
{
int V_116 ;
struct V_44 * V_45 = F_14 ( V_7 ) ;
V_116 = F_54 ( V_7 ) ;
...
{
int V_251 , V_116 , V_268 , V_269 ;
for ( V_251 = 0 ; V_251 < F_40 ( V_270 ) ; V_251 ++ ) {
V_268 = V_270 [ V_251 ] . V_271 ;
V_269 = V_270 [ V_251 ] . V_28 ;
V_116 = F_62 ( V_45 -> V_171 , V_269 , V_268 ) ;
if ( V_116 )
return V_116 ;
}
return 0 ;
}
static int F_63 ( struct V_272 * V_273 ,
const struct V_274 * V_275 )
{
struct V_44 * V_45 ;
int V_116 , V_28 , V_276 ;
V_45 = F_64 ( & V_273 -> V_86 , sizeof( struct V_44 ) ,
V_151 ) ;
if ( ! V_45 )
return - V_152 ;
V_45 -> V_171 = F_65 ( V_273 , & V_277 ) ;
if ( F_34 ( V_45 -> V_171 ) ) {
V_116 = F_35 ( V_45 -> V_171 ) ;
F_17 ( & V_273 -> V_86 , L_14 , V_116 ) ;
return V_116 ;
}
V_45 -> V_278 = F_66 ( & V_273 -> V_86 , NULL ) ;
if ( F_34 ( V_45 -> V_278 ) ) {
V_116 = F_35 ( V_45 -> V_278 ) ;
F_17 ( & V_273 -> V_86 , L_15 , V_116 ) ;
if ( V_116 == - V_279 )
return - V_256 ;
return V_116 ;
}
V_116 = F_67 ( V_45 -> V_278 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_68 ( V_45 -> V_171 , V_173 , & V_28 ) ;
if ( V_116 )
goto V_280;
if ( ( ( V_28 & V_281 ) >> V_282 ) !=
V_283 ) {
...
V_276 = ( V_28 & V_285 ) >> V_286 ;
F_53 ( & V_273 -> V_86 , L_17 , V_276 ) ;
V_45 -> V_255 = V_276 ;
F_69 ( V_273 , V_45 ) ;
V_116 = F_61 ( V_45 ) ;
if ( V_116 )
goto V_280;
V_116 = F_70 ( & V_273 -> V_86 ,
& V_287 , & V_288 , 1 ) ;
if ( V_116 )
goto V_280;
return 0 ;
...
static int F_72 ( struct V_272 * V_273 )
{
struct V_44 * V_45 = F_73 ( V_273 ) ;
F_74 ( & V_273 -> V_86 ) ;
F_71 ( V_45 -> V_278 ) ;
return 0 ;
}
