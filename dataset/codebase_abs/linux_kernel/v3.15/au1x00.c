...
V_66 = F_55 () ;
V_2 -> V_14 [ V_44 ] -> V_34 = F_56 ( V_2 -> V_75 [ 0 ] ,
L_5 , F_24 , 0 ,
V_2 -> V_14 [ V_44 ] ) ;
...
V_2 -> V_14 [ V_49 ] -> V_34 = F_56 ( V_2 -> V_75 [ 1 ] ,
L_6 , F_24 , 0 ,
V_2 -> V_14 [ V_49 ] ) ;
...
F_59 ( V_2 -> V_14 [ V_44 ] -> V_34 ) & ~ V_77 ) ;
F_58 ( V_2 -> V_14 [ V_49 ] -> V_34 ,
F_59 ( V_2 -> V_14 [ V_49 ] -> V_34 ) & ~ V_77 ) ;
F_57 ( V_66 ) ;
V_2 -> V_42 = V_42 ;
return 0 ;
}
static unsigned short
F_60 ( struct V_78 * V_56 , unsigned short V_79 )
{
...
V_80 = V_2 -> V_6 -> V_60 & 0xffff ;
F_3 ( & V_2 -> V_5 ) ;
return V_80 ;
}
static void
F_61 ( struct V_78 * V_56 , unsigned short V_79 , unsigned short V_85 )
{
struct V_1 * V_2 = V_56 -> V_43 ;
T_1 V_60 ;
int V_28 ;
...
static void F_62 ( struct V_87 * V_67 )
{
struct V_1 * V_2 = V_67 -> V_43 ;
if ( V_2 -> V_14 [ V_44 ] ) {
if ( V_2 -> V_14 [ V_44 ] -> V_34 >= 0 )
F_63 ( V_2 -> V_14 [ V_44 ] -> V_34 ) ;
F_6 ( V_2 -> V_14 [ V_44 ] ) ;
}
if ( V_2 -> V_14 [ V_49 ] ) {
if ( V_2 -> V_14 [ V_49 ] -> V_34 >= 0 )
F_63 ( V_2 -> V_14 [ V_49 ] -> V_34 ) ;
F_6 ( V_2 -> V_14 [ V_49 ] ) ;
}
if ( V_2 -> V_88 ) {
if ( V_2 -> V_6 ) {
...
struct V_96 * V_97 ;
struct V_98 V_56 ;
V_52 = F_67 ( & V_92 -> V_99 , - 1 , L_9 , V_100 ,
...
F_54 ( & V_2 -> V_5 ) ;
V_67 -> V_101 = F_62 ;
V_95 = F_68 ( V_92 , V_102 , 0 ) ;
if ( ! V_95 ) {
V_52 = - V_103 ;
F_69 ( V_104 L_10 ) ;
goto V_105;
}
V_2 -> V_75 [ 0 ] = V_95 -> V_32 ;
V_95 = F_68 ( V_92 , V_102 , 1 ) ;
if ( ! V_95 ) {
V_52 = - V_103 ;
F_69 ( V_104 L_11 ) ;
goto V_105;
}
V_2 -> V_75 [ 1 ] = V_95 -> V_32 ;
V_2 -> V_14 [ V_44 ] = F_9 ( sizeof( struct V_13 ) ,
V_30 ) ;
if ( ! V_2 -> V_14 [ V_44 ] )
goto V_105;
V_2 -> V_14 [ V_44 ] -> V_34 = - 1 ;
V_2 -> V_14 [ V_49 ] = F_9 ( sizeof( struct V_13 ) ,
V_30 ) ;
if ( ! V_2 -> V_14 [ V_49 ] )
goto V_105;
V_2 -> V_14 [ V_49 ] -> V_34 = - 1 ;
V_95 = F_68 ( V_92 , V_106 , 0 ) ;
if ( ! V_95 )
goto V_105;
V_52 = - V_76 ;
V_2 -> V_88 = F_70 ( V_95 -> V_32 ,
V_95 -> V_107 - V_95 -> V_32 + 1 , V_92 -> V_74 ) ;
if ( ! V_2 -> V_88 ) {
F_69 ( V_40 L_12 ) ;
goto V_105;
}
V_93 = F_71 ( V_95 -> V_32 , V_95 -> V_107 - V_95 -> V_32 + 1 ) ;
if ( ! V_93 )
goto V_105;
V_2 -> V_6 = (struct V_108 * ) V_93 ;
F_72 ( F_73 ( V_109 ) & ~ 0x02 , V_109 ) ;
V_2 -> V_6 -> V_89 = V_90 | V_110 ;
F_74 ( 10 ) ;
V_2 -> V_6 -> V_89 = V_110 ;
F_74 ( 10 ) ;
V_2 -> V_6 -> V_7 = V_111 ;
...
V_2 -> V_6 -> V_7 = 0x0 ;
F_75 ( 5 ) ;
V_52 = V_96 ( V_2 -> V_67 , 0 , & V_112 , V_2 , & V_97 ) ;
if ( V_52 < 0 )
goto V_105;
memset ( & V_56 , 0 , sizeof( V_56 ) ) ;
V_56 . V_43 = V_2 ;
V_52 = F_76 ( V_97 , & V_56 , & V_2 -> V_56 ) ;
if ( V_52 < 0 )
goto V_105;
V_52 = F_49 ( V_2 ) ;
if ( V_52 < 0 )
goto V_105;
strcpy ( V_67 -> V_113 , L_13 ) ;
strcpy ( V_67 -> V_114 , L_14 ) ;
sprintf ( V_67 -> V_115 , L_15 ) ;
V_52 = F_77 ( V_67 ) ;
if ( V_52 < 0 )
goto V_105;
F_28 ( V_104 L_16 ) ;
