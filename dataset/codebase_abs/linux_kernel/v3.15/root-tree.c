...
int F_51 ( struct V_32 * V_33 , struct V_13 * V_14 ,
struct V_15 * V_34 )
{
struct V_17 * V_18 ;
int V_23 ;
...
if ( V_23 == 0 ) {
V_40 = V_18 -> V_27 [ 0 ] ;
V_59 = F_53 ( V_40 , V_18 -> V_26 [ 0 ] ,
struct V_58 ) ;
F_54 ( F_55 ( V_40 , V_59 ) != V_54 ) ;
F_54 ( F_56 ( V_40 , V_59 ) != V_57 ) ;
V_35 = ( unsigned long ) ( V_59 + 1 ) ;
F_54 ( F_57 ( V_40 , V_56 , V_35 , V_57 ) ) ;
* V_55 = F_58 ( V_40 , V_59 ) ;
...
V_40 = V_18 -> V_27 [ 0 ] ;
V_59 = F_53 ( V_40 , V_18 -> V_26 [ 0 ] , struct V_58 ) ;
F_60 ( V_40 , V_59 , V_54 ) ;
F_61 ( V_40 , V_59 , V_55 ) ;
F_62 ( V_40 , V_59 , V_57 ) ;
V_35 = ( unsigned long ) ( V_59 + 1 ) ;
F_30 ( V_40 , V_56 , V_35 , V_57 ) ;
F_31 ( V_40 ) ;
if ( V_34 . type == V_60 ) {
F_15 ( V_18 ) ;
V_34 . V_28 = V_53 ;
...
F_69 ( & V_14 -> V_69 ) ;
F_70 ( V_5 , V_33 -> V_70 ) ;
F_71 ( & V_5 -> ctime , V_67 . V_71 ) ;
F_72 ( & V_5 -> ctime , V_67 . V_72 ) ;
F_73 ( & V_14 -> V_69 ) ;
}
