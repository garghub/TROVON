...
T_3 V_13 , V_11 ;
T_2 V_19 ;
F_19 (i, NUMA_NO_NODE, &start, &end, NULL)
V_18 += F_16 ( V_13 , V_11 ) ;
#ifdef F_20
{
T_3 V_2 ;
...
static inline void T_1 F_23 ( T_4 * V_20 )
{
struct V_21 * V_22 ;
if ( V_23 )
return;
...
void T_1 F_27 ( T_4 * V_20 , unsigned long V_29 ,
unsigned long V_2 )
{
F_7 ( F_8 ( V_29 ) , V_2 ) ;
F_28 ( V_29 , V_2 ) ;
}
void T_1 F_29 ( unsigned long V_7 , unsigned long V_2 )
{
F_7 ( F_8 ( V_7 ) , V_2 ) ;
F_28 ( V_7 , V_2 ) ;
}
static void * T_1 F_30 ( unsigned long V_2 ,
unsigned long V_3 ,
unsigned long V_4 ,
unsigned long V_5 )
{
...
return F_30 ( V_2 , V_3 , V_4 , V_5 ) ;
}
static void * T_1 F_35 ( unsigned long V_2 , unsigned long V_3 ,
unsigned long V_4 , unsigned long V_5 )
{
void * V_33 = F_30 ( V_2 , V_3 , V_4 , V_5 ) ;
if ( V_33 )
return V_33 ;
F_36 ( V_34 L_1 , V_2 ) ;
F_37 ( L_2 ) ;
...
{
if ( F_31 ( F_32 () ) )
return F_41 ( V_2 , V_30 , V_20 -> V_36 ) ;
return F_39 ( V_20 , V_2 , V_3 , V_4 , 0 ) ;
}
static void * T_1 F_42 ( T_4 * V_20 , unsigned long V_2 ,
unsigned long V_3 , unsigned long V_4 ,
unsigned long V_5 )
{
void * V_6 ;
V_6 = F_39 ( V_20 , V_2 , V_3 , V_4 , V_5 ) ;
if ( V_6 )
return V_6 ;
F_36 ( V_34 L_1 , V_2 ) ;
F_37 ( L_2 ) ;
...
void * T_1 F_43 ( T_4 * V_20 , unsigned long V_2 ,
unsigned long V_3 , unsigned long V_4 )
{
if ( F_31 ( F_32 () ) )
return F_41 ( V_2 , V_30 , V_20 -> V_36 ) ;
return F_42 ( V_20 , V_2 , V_3 , V_4 , 0 ) ;
}
...
void * T_1 F_45 ( unsigned long V_2 , unsigned long V_3 ,
unsigned long V_4 )
{
return F_35 ( V_2 , V_3 , V_4 , V_37 ) ;
}
void * T_1 F_46 ( unsigned long V_2 ,
unsigned long V_3 ,
unsigned long V_4 )
{
...
void * T_1 F_47 ( T_4 * V_20 , unsigned long V_2 ,
unsigned long V_3 , unsigned long V_4 )
{
if ( F_31 ( F_32 () ) )
return F_41 ( V_2 , V_30 , V_20 -> V_36 ) ;
return F_42 ( V_20 , V_2 , V_3 , V_4 ,
V_37 ) ;
}
