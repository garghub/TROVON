...
if ( V_79 -> V_10 & V_72 )
return - V_73 ;
if ( ! V_79 -> V_5 || V_79 -> V_5 & V_72 )
return - V_73 ;
F_47 ( V_72 & V_66 ) ;
if ( V_57 && V_57 < V_79 -> V_10 )
return - V_73 ;
if ( V_34 + V_79 -> V_5 && V_34 + V_79 -> V_5 < V_34 )
return - V_73 ;
F_50 ( & V_3 -> V_67 ) ;
if ( F_1 ( V_3 , V_79 -> V_10 , V_79 -> V_5 ) ) {
F_52 ( & V_3 -> V_67 ) ;
return - V_84 ;
}
...
V_9 -> V_32 = V_32 ;
F_3 ( V_3 , V_9 ) ;
for ( V_10 = V_79 -> V_10 ; V_10 < V_57 ; V_10 += V_5 , V_34 += V_5 ) {
...
V_37 = F_57 ( V_3 , V_10 , V_27 , V_24 , V_32 ) ;
if ( V_37 ) {
