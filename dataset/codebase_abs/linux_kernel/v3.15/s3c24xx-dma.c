...
static int F_50 ( struct V_39 * V_40 , enum V_102 V_103 ,
unsigned long V_104 )
{
...
static enum V_108 F_55 ( struct V_39 * V_40 ,
T_3 V_109 , struct V_110 * V_111 )
{
struct V_7 * V_8 = F_14 ( V_40 ) ;
struct V_42 * V_43 ;
struct V_63 * V_64 ;
...
static struct V_55 * F_60 (
struct V_39 * V_40 , T_5 V_114 , T_5 V_115 ,
...
switch ( V_68 % 4 ) {
case 0 :
V_43 -> V_47 = ( V_116 == 0 && V_117 == 0 ) ? 4 : 1 ;
break;
case 2 :
V_43 -> V_47 = ( ( V_116 == 2 || V_116 == 0 ) &&
( V_117 == 2 || V_117 == 0 ) ) ? 2 : 1 ;
break;
default:
V_43 -> V_47 = 1 ;
...
V_43 -> V_79 = V_119 | V_120 ;
V_43 -> V_83 = V_121 | V_122 ;
V_43 -> V_60 |= V_123 | V_124 |
V_125 ;
return F_62 ( & V_8 -> V_41 , & V_43 -> V_57 , V_25 ) ;
}
static struct V_55 * F_63 (
struct V_39 * V_40 , struct V_126 * V_127 ,
unsigned int V_128 , enum V_129 V_130 ,
unsigned long V_25 , void * V_131 )
{
struct V_7 * V_8 = F_14 ( V_40 ) ;
struct V_9 * V_10 = V_8 -> V_11 ;
const struct V_12 * V_13 = V_10 -> V_13 ;
...
F_61 ( & V_64 -> V_66 , & V_43 -> V_59 ) ;
V_64 -> V_68 = F_64 ( V_132 ) ;
if ( V_130 == V_145 ) {
V_64 -> V_77 = F_66 ( V_132 ) ;
V_64 -> V_81 = V_133 ;
} else {
V_64 -> V_77 = V_133 ;
V_64 -> V_81 = F_66 ( V_132 ) ;
}
break;
}
return F_62 ( & V_8 -> V_41 , & V_43 -> V_57 , V_25 ) ;
...
V_40 = F_70 ( V_148 -> V_34 , sizeof( * V_40 ) , V_149 ) ;
if ( ! V_40 ) {
F_9 ( V_148 -> V_34 ,
L_13 , V_150 ) ;
return - V_151 ;
...
if ( V_19 ) {
V_40 -> V_19 = true ;
V_40 -> V_91 = F_71 ( V_149 , L_14 , V_26 ) ;
if ( ! V_40 -> V_91 )
return - V_151 ;
} else {
V_40 -> V_91 = F_71 ( V_149 , L_15 , V_26 ) ;
if ( ! V_40 -> V_91 )
return - V_151 ;
}
F_38 ( V_148 -> V_34 ,
...
F_72 ( & V_40 -> V_41 , V_148 ) ;
}
F_73 ( V_148 -> V_34 , L_17 ,
V_26 , V_19 ? L_18 : L_19 ) ;
return V_26 ;
}
...
static struct V_154 * F_75 ( struct V_155 * V_33 )
{
return (struct V_154 * )
F_76 ( V_33 ) -> V_156 ;
}
static int F_77 ( struct V_155 * V_33 )
{
const struct V_12 * V_13 = F_78 ( & V_33 -> V_34 ) ;
struct V_9 * V_10 ;
struct V_154 * V_20 ;
struct V_157 * V_158 ;
int V_27 ;
...
if ( ! V_20 )
return - V_50 ;
V_10 = F_70 ( & V_33 -> V_34 , sizeof( * V_10 ) , V_149 ) ;
if ( ! V_10 )
return - V_151 ;
V_10 -> V_33 = V_33 ;
V_10 -> V_13 = V_13 ;
V_10 -> V_20 = V_20 ;
V_158 = F_79 ( V_33 , V_161 , 0 ) ;
V_10 -> V_4 = F_80 ( & V_33 -> V_34 , V_158 ) ;
if ( F_81 ( V_10 -> V_4 ) )
return F_82 ( V_10 -> V_4 ) ;
V_10 -> V_29 = F_70 ( & V_33 -> V_34 ,
sizeof( struct V_1 ) *
V_13 -> V_28 ,
V_149 ) ;
if ( ! V_10 -> V_29 )
...
V_2 -> V_11 = V_10 ;
V_2 -> V_99 = F_83 ( V_33 , V_26 ) ;
if ( V_2 -> V_99 < 0 ) {
F_9 ( & V_33 -> V_34 , L_22 ,
V_26 , V_2 -> V_99 ) ;
continue;
}
V_27 = F_84 ( & V_33 -> V_34 , V_2 -> V_99 , F_46 ,
0 , V_33 -> V_91 , V_2 ) ;
if ( V_27 ) {
F_9 ( & V_33 -> V_34 , L_23 ,
V_26 , V_27 ) ;
...
V_2 -> V_36 = F_85 ( & V_33 -> V_34 , V_162 ) ;
if ( F_81 ( V_2 -> V_36 ) && V_20 -> V_35 ) {
F_9 ( & V_33 -> V_34 , L_25 ,
V_26 , F_82 ( V_2 -> V_36 ) ) ;
continue;
}
...
F_88 ( V_164 , V_10 -> memcpy . V_165 ) ;
F_88 ( V_166 , V_10 -> memcpy . V_165 ) ;
V_10 -> memcpy . V_34 = & V_33 -> V_34 ;
V_10 -> memcpy . V_167 =
F_51 ;
V_10 -> memcpy . V_168 =
F_52 ;
V_10 -> memcpy . V_169 = F_60 ;
V_10 -> memcpy . V_170 = F_55 ;
V_10 -> memcpy . V_171 = F_67 ;
V_10 -> memcpy . V_172 = F_50 ;
F_88 ( V_173 , V_10 -> V_19 . V_165 ) ;
F_88 ( V_166 , V_10 -> V_19 . V_165 ) ;
V_10 -> V_19 . V_34 = & V_33 -> V_34 ;
V_10 -> V_19 . V_167 =
F_51 ;
V_10 -> V_19 . V_168 =
F_52 ;
V_10 -> V_19 . V_170 = F_55 ;
V_10 -> V_19 . V_171 = F_67 ;
V_10 -> V_19 . V_174 = F_63 ;
V_10 -> V_19 . V_172 = F_50 ;
V_27 = F_69 ( V_10 , & V_10 -> memcpy ,
V_13 -> V_28 , false ) ;
if ( V_27 <= 0 ) {
F_7 ( & V_33 -> V_34 ,
L_30 ,
...
static int F_93 ( struct V_155 * V_33 )
{
const struct V_12 * V_13 = F_78 ( & V_33 -> V_34 ) ;
struct V_9 * V_10 = F_94 ( V_33 ) ;
struct V_154 * V_20 = F_75 ( V_33 ) ;
int V_26 ;
F_91 ( & V_10 -> V_19 ) ;
F_91 ( & V_10 -> memcpy ) ;
F_74 ( & V_10 -> V_19 ) ;
...
bool F_95 ( struct V_39 * V_40 , void * V_180 )
{
struct V_7 * V_8 ;
if ( V_40 -> V_181 -> V_34 -> V_182 != & V_183 . V_182 )
return false ;
V_8 = F_14 ( V_40 ) ;
return V_8 -> V_17 == ( int ) V_180 ;
}
