...
int V_39 ;
if ( ! V_7 ) {
V_7 = F_13 ( sizeof( struct V_11 ) , V_41 ) ;
if ( ! V_7 ) {
F_14 ( & V_6 -> V_37 , L_2 ) ;
return - V_42 ;
}
...
static inline unsigned int F_19 ( struct V_1 * V_13 , int V_47 )
{
return V_13 -> V_48 ? V_13 -> V_48 [ V_47 ] : 0 ;
}
static inline T_2 F_20 ( unsigned int V_49 )
{
return 1 << ( V_49 - V_50 ) ;
}
...
* V_70 = F_20 ( V_13 -> V_49 ) ;
F_25 ( & V_54 -> V_74 , V_54 -> V_76 ) ;
}
F_26 ( V_13 -> V_49 , true ) ;
V_13 -> V_69 = V_15 ;
V_13 -> V_77 = 1 ;
}
static int F_27 ( void * V_78 , int V_79 )
{
...
static inline void F_28 ( struct V_1 * V_86 ) { }
static inline void F_21 ( struct V_1 * V_86 ) { }
static inline bool F_30 ( struct V_1 * V_86 ) { return false ; }
static inline bool F_31 ( struct V_1 * V_86 ) { return false ; }
...
F_33 ( & V_13 -> V_89 ) ;
V_13 -> V_77 = 0 ;
if ( F_30 ( V_13 ) && V_27 -> V_66 >= 3 )
F_21 ( V_13 ) ;
F_6 ( F_19 ( V_13 , 0 ) , V_13 -> V_22 + V_90 ) ;
F_34 ( & V_13 -> V_89 ) ;
return V_13 -> V_47 ;
}
static T_3 F_35 ( int V_49 , void * V_37 )
{
struct V_1 * V_13 = V_37 ;
unsigned int V_91 = F_36 ( V_13 -> V_22 + V_92 ) ;
...
V_13 -> V_47 ++ ;
if ( V_13 -> V_57 )
V_13 -> V_57 [ V_47 ] = F_36 ( V_13 -> V_22 + V_96 ) ;
V_47 ++ ;
if ( V_47 < V_13 -> V_66 )
F_6 ( F_19 ( V_13 , V_47 ) , V_13 -> V_22 + V_90 ) ;
else
F_37 ( & V_13 -> V_89 ) ;
} else {
V_13 -> V_47 = V_13 -> V_66 ;
V_13 -> V_77 = 0 ;
if ( V_13 -> V_57 )
V_13 -> V_57 [ V_13 -> V_66 - 1 ] = F_36 ( V_13 -> V_22 + V_96 ) ;
F_37 ( & V_13 -> V_89 ) ;
}
V_94:
return V_97 ;
...
struct V_104 * V_105 ;
int V_106 = 0 ;
V_4 = F_42 ( & V_102 -> V_37 , sizeof( struct V_1 ) ) ;
if ( V_4 == NULL ) {
F_14 ( & V_102 -> V_37 , L_5 ) ;
return - V_42 ;
}
...
V_13 -> V_4 = V_4 ;
V_13 -> V_19 = V_19 = F_43 ( & V_102 -> V_37 ) ;
...
V_13 -> V_43 . V_46 = F_5 ;
V_13 -> V_43 . V_115 = F_32 ;
V_13 -> V_4 -> V_116 = F_12 ;
V_13 -> V_4 -> V_117 = F_17 ;
F_10 ( V_13 -> V_37 , L_7 , & V_13 -> V_43 ) ;
V_105 = F_46 ( V_102 , V_118 , 0 ) ;
V_13 -> V_22 = F_47 ( & V_102 -> V_37 , V_105 ) ;
if ( F_48 ( V_13 -> V_22 ) ) {
V_106 = F_49 ( V_13 -> V_22 ) ;
goto V_108;
}
V_13 -> V_49 = F_50 ( V_102 , 0 ) ;
if ( V_13 -> V_49 < 0 ) {
F_14 ( & V_102 -> V_37 , L_8 ) ;
V_106 = - V_107 ;
goto V_108;
}
V_106 = F_51 ( & V_102 -> V_37 , V_13 -> V_49 , F_35 , 0 ,
V_102 -> V_83 , V_13 ) ;
if ( V_106 ) {
F_14 ( & V_102 -> V_37 , L_9 ) ;
goto V_108;
}
V_13 -> V_29 = F_52 ( & V_102 -> V_37 , L_10 ) ;
if ( F_48 ( V_13 -> V_29 ) ) {
F_14 ( & V_102 -> V_37 , L_11 ) ;
V_106 = F_49 ( V_13 -> V_29 ) ;
goto V_108;
}
if ( ! V_19 -> V_18 ) {
if ( V_19 -> V_9 < 0 ) {
F_14 ( & V_102 -> V_37 , L_12 ) ;
V_106 = - V_119 ;
goto V_120;
}
V_106 = F_53 ( & V_102 -> V_37 , V_19 -> V_9 ,
F_29 ( & V_102 -> V_37 ) ) ;
if ( V_106 ) {
F_14 ( & V_102 -> V_37 , L_13 ) ;
goto V_120;
}
V_13 -> V_18 = F_3 ;
F_40 ( V_19 -> V_9 , 1 ) ;
...
V_13 -> V_18 = V_19 -> V_18 ;
F_38 ( V_13 ) ;
V_106 = F_54 ( & V_13 -> V_43 ) ;
if ( V_106 ) {
F_14 ( & V_102 -> V_37 , L_14 ) ;
goto V_120;
}
return 0 ;
V_120:
...
static int F_57 ( struct V_101 * V_37 )
{
struct V_1 * V_13 = F_58 ( V_37 ) ;
F_59 ( & V_13 -> V_43 ) ;
F_55 ( V_13 -> V_29 ) ;
F_56 ( V_13 -> V_4 ) ;
return 0 ;
