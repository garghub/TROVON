...
static int F_10 ( struct V_4 * V_5 , struct V_27 * V_28 )
{
return 1 ;
}
static int F_11 ( struct V_29 * V_12 )
{
struct V_30 * V_31 = F_12 ( & V_12 -> V_13 ) ;
struct V_1 * V_2 ;
struct V_4 * V_5 ;
struct V_32 V_8 ;
int V_19 = 0 ;
...
memset ( & V_8 , 0 , sizeof( struct V_32 ) ) ;
V_8 . type = V_39 ;
V_5 = F_14 ( & V_12 -> V_13 , L_5 ,
& V_12 -> V_13 , V_2 , & V_40 ,
& V_8 ) ;
if ( F_15 ( V_5 ) ) {
F_8 ( & V_12 -> V_13 ,
...
static int F_18 ( struct V_29 * V_12 )
{
