...
static inline struct V_27 * F_25 ( struct V_54 * V_55 )
{
return F_2 ( F_26 ( V_55 ) , struct V_27 ,
V_30 . V_56 ) ;
}
static void F_27 ( struct V_57 * V_3 )
{
struct V_27 * V_58 ;
...
static struct V_57 * F_32 ( void )
{
struct V_27 * V_58 ;
V_58 = F_33 ( sizeof( * V_58 ) , V_59 ) ;
if ( ! V_58 )
return F_34 ( - V_60 ) ;
F_35 ( & V_58 -> V_32 ) ;
V_58 -> V_30 . V_61 = F_27 ;
...
static void F_40 ( struct V_20 * V_21 , struct V_2 * V_3 )
{
V_34 [ 0 ] . V_37 = 0 ;
F_24 ( V_3 ) ;
}
