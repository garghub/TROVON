...
static unsigned long long F_24 (
struct V_2 * V_3 ,
struct V_15 * V_16 ,
struct V_13 * V_14 )
{
unsigned long long V_60 = ( F_25 ( F_26 ( V_16 -> V_61 ) ,
F_15 ( V_16 ) ) - 1 ) ;
T_1 V_62 = F_15 ( V_16 ) ;
...
static void F_31 ( struct V_73 * V_73 , int V_74 )
{
struct V_63 * V_64 = V_73 -> V_75 ;
struct V_65 * V_66 = V_64 -> V_67 ;
if ( ! F_32 ( V_76 , & V_73 -> V_77 ) && ! V_74 )
V_74 = - V_78 ;
if ( V_74 != 0 ) {
F_8 ( L_18
L_19 , V_73 , V_74 ) ;
...
static struct V_73 *
F_36 ( struct V_63 * V_64 , T_4 V_79 , T_1 V_80 )
{
struct V_1 * V_11 = F_1 ( V_64 -> V_81 ) ;
struct V_73 * V_73 ;
if ( V_80 > V_82 )
V_80 = V_82 ;
V_73 = F_37 ( V_83 , V_80 , V_11 -> V_25 ) ;
if ( ! V_73 ) {
F_8 ( L_20 ) ;
return NULL ;
}
...
static void F_38 ( struct V_88 * V_89 , int V_90 )
{
struct V_91 V_92 ;
struct V_73 * V_73 ;
F_39 ( & V_92 ) ;
while ( ( V_73 = F_40 ( V_89 ) ) )
F_41 ( V_90 , V_73 ) ;
F_42 ( & V_92 ) ;
}
static void F_43 ( struct V_73 * V_73 , int V_74 )
{
struct V_63 * V_64 = V_73 -> V_75 ;
if ( V_74 )
F_8 ( L_21 , V_74 ) ;
...
static T_5
F_46 ( struct V_63 * V_64 , void * V_67 ,
T_4 V_79 , T_4 V_96 )
{
struct V_15 * V_97 = V_67 ;
int V_20 ;
V_20 = F_47 ( V_97 , V_79 , V_96 , V_12 , 0 ) ;
if ( V_20 < 0 ) {
F_8 ( L_22 , V_20 ) ;
return V_98 ;
}
...
F_55 ( & V_66 -> V_69 , 1 ) ;
while ( V_104 ) {
while ( F_56 ( V_73 , F_57 ( V_102 ) , V_102 -> V_107 , V_102 -> V_111 )
!= V_102 -> V_107 ) {
V_73 = F_36 ( V_64 , V_103 , 1 ) ;
if ( ! V_73 )
goto V_112;
...
int V_20 = 0 , V_122 ;
unsigned long V_123 ;
V_120 = F_59 ( V_115 , V_12 ) ;
if ( ! V_120 )
return - V_21 ;
V_117 = V_120 ;
while ( ( V_118 = F_60 ( & V_120 , L_25 ) ) != NULL ) {
if ( ! * V_118 )
continue;
V_122 = F_61 ( V_118 , V_124 , args ) ;
switch ( V_122 ) {
case V_125 :
if ( V_11 -> V_34 ) {
F_8 ( L_26
...
static T_6 F_65 ( struct V_2 * V_3 , char * V_130 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
...
F_67 ( V_16 -> V_134 ) , F_68 ( V_16 -> V_134 ) , ( ! V_16 -> V_135 ) ?
...
static int
F_69 ( struct V_63 * V_64 , struct V_73 * V_73 )
{
...
V_138 = F_70 ( V_73 , V_83 , V_64 -> V_142 ) ;
if ( ! V_138 ) {
F_8 ( L_42 ) ;
return - V_21 ;
}
...
V_140 = F_72 ( V_73 , F_57 ( V_102 ) , V_102 -> V_107 ,
V_102 -> V_111 ) ;
...
F_4 ( L_45 ,
F_57 ( V_102 ) , V_102 -> V_107 , V_102 -> V_111 ) ;
}
return 0 ;
}
static T_5
F_73 ( struct V_63 * V_64 , struct V_101 * V_147 , T_1 V_148 ,
enum V_149 V_150 )
{
struct V_2 * V_3 = V_64 -> V_81 ;
struct V_65 * V_66 ;
...
static T_5
F_84 ( struct V_63 * V_64 )
{
return F_85 ( V_64 , & V_164 ) ;
}
