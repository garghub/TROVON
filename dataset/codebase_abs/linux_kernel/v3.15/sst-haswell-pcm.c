...
V_44 -> V_81 , V_27 -> V_60 -> V_61 ) ;
if ( V_58 < 0 )
return V_58 ;
F_39 ( V_20 , V_16 -> V_23 ,
V_82 ) ;
if ( V_44 -> V_81 % V_36 )
V_32 = ( V_44 -> V_81 / V_36 ) + 1 ;
else
V_32 = V_44 -> V_81 / V_36 ;
V_58 = F_40 ( V_20 , V_16 -> V_23 ,
V_14 -> V_31 [ V_27 -> V_60 -> V_61 ] [ V_25 -> V_23 ] . V_83 ,
V_32 , V_44 -> V_81 , 0 ,
F_20 ( V_31 , 0 ) >> V_37 ) ;
if ( V_58 < 0 ) {
...
static int F_50 ( struct V_24 * V_25 , int V_86 )
{
struct V_26 * V_27 = V_25 -> V_42 ;
struct V_13 * V_14 =
F_6 ( V_27 -> V_9 ) ;
...
static T_1 V_62 ( struct V_93 * V_23 , void * V_94 )
{
struct V_15 * V_16 = V_94 ;
struct V_24 * V_25 = V_16 -> V_25 ;
struct V_43 * V_44 = V_25 -> V_44 ;
struct V_26 * V_27 = V_25 -> V_42 ;
T_1 V_95 ;
V_95 = F_52 ( V_44 ,
( V_44 -> V_96 -> V_97 % V_44 -> V_98 ) ) ;
F_19 ( V_27 -> V_33 , L_18 , V_95 ) ;
F_53 ( V_25 ) ;
return V_95 ;
}
...
T_4 V_85 ;
T_5 V_99 ;
T_1 V_100 = F_55 ( V_20 , V_16 -> V_23 ) ;
V_85 = F_56 ( V_44 , V_100 ) ;
V_99 = F_57 ( V_20 , V_16 -> V_23 ) ;
F_19 ( V_27 -> V_33 , L_19 ,
V_100 , V_99 ) ;
return V_85 ;
}
...
static void F_62 ( struct V_103 * V_17 )
{
F_63 ( V_17 ) ;
}
static int F_64 ( struct V_26 * V_27 )
{
struct V_103 * V_17 = V_27 -> V_17 ;
struct V_8 * V_9 = V_27 -> V_9 ;
struct V_104 * V_14 = F_65 ( V_9 -> V_33 ) ;
struct V_105 * V_33 = V_14 -> V_106 ;
int V_58 = 0 ;
if ( V_17 -> V_107 [ V_64 ] . V_25 ||
V_17 -> V_107 [ V_108 ] . V_25 ) {
V_58 = F_66 ( V_17 ,
V_109 ,
V_33 ,
V_101 . V_110 ,
...
return - V_112 ;
V_106 = V_14 -> V_106 ;
V_111 = F_68 ( V_9 -> V_33 , sizeof( * V_111 ) , V_113 ) ;
V_111 -> V_20 = V_14 -> V_48 ;
F_69 ( V_9 , V_111 ) ;
for ( V_3 = 0 ; V_3 < F_2 ( V_114 ) ; V_3 ++ ) {
F_70 ( & V_111 -> V_17 [ V_3 ] . V_22 ) ;
if ( V_114 [ V_3 ] . V_115 . V_116 ) {
V_58 = F_71 ( V_117 , V_106 ,
V_36 , & V_111 -> V_31 [ V_3 ] [ 0 ] ) ;
if ( V_58 < 0 )
goto V_118;
}
if ( V_114 [ V_3 ] . V_119 . V_116 ) {
V_58 = F_71 ( V_117 , V_106 ,
V_36 , & V_111 -> V_31 [ V_3 ] [ 1 ] ) ;
if ( V_58 < 0 )
goto V_118;
}
}
...
for (; V_3 >= 0 ; V_3 -- ) {
if ( V_114 [ V_3 ] . V_115 . V_116 )
F_72 ( & V_111 -> V_31 [ V_3 ] [ 0 ] ) ;
if ( V_114 [ V_3 ] . V_119 . V_116 )
F_72 ( & V_111 -> V_31 [ V_3 ] [ 1 ] ) ;
}
return V_58 ;
}
...
{
struct V_104 * V_104 = F_65 ( & V_121 -> V_33 ) ;
int V_58 ;
V_58 = F_75 ( & V_121 -> V_33 , V_104 ) ;
if ( V_58 < 0 )
return - V_112 ;
V_58 = F_76 ( & V_121 -> V_33 , & V_122 ) ;
if ( V_58 < 0 )
goto V_123;
V_58 = F_77 ( & V_121 -> V_33 , & V_124 ,
V_114 , F_2 ( V_114 ) ) ;
if ( V_58 < 0 )
goto V_125;
return 0 ;
