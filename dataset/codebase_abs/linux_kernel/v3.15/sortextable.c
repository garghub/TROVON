...
break;
case V_58 :
if ( V_36 ( & V_32 -> V_59 ) != sizeof( T_7 )
|| V_36 ( & V_32 -> V_60 ) != sizeof( V_61 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
break;
case V_62 : {
T_8 * const V_63 = ( T_8 * ) V_32 ;
if ( V_36 ( & V_63 -> V_59 ) != sizeof( T_8 )
|| V_36 ( & V_63 -> V_60 ) != sizeof( V_64 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
for ( V_17 = 1 ; V_17 < V_65 ; V_17 ++ ) {
char * V_68 = V_66 [ V_17 ] ;
int const V_69 = setjmp ( V_70 ) ;
switch ( V_69 ) {
default:
fprintf ( V_10 , L_9 , V_68 ) ;
exit ( 1 ) ;
break;
case V_71 :
V_5 = - 1 ;
