...
V_87 -> type = V_89 ;
V_87 -> V_90 = 1 ;
V_87 -> V_91 . V_92 . V_93 = 2 ;
if ( V_87 -> V_91 . V_92 . V_94 >= V_87 -> V_91 . V_92 . V_93 ) {
V_87 -> V_91 . V_92 . V_94 =
V_87 -> V_91 . V_92 . V_93 - 1 ;
}
strcpy ( V_87 -> V_91 . V_92 . V_73 ,
V_88 [ V_87 -> V_91 . V_92 . V_94 ] ) ;
return 0 ;
}
...
* V_96 )
{
struct V_3 * V_4 = F_76 ( V_85 ) ;
if ( F_77 ( & V_4 -> V_6 ) )
V_96 -> V_91 . V_92 . V_94 [ 0 ] = V_97 ;
else
V_96 -> V_91 . V_92 . V_94 [ 0 ] = V_98 ;
return 0 ;
}
...
int V_100 =
F_77 ( & V_4 -> V_6 ) ;
if ( ( ( V_96 -> V_91 . integer . V_91 [ 0 ] == V_97 )
&& ! V_100 )
|| ( ( V_96 -> V_91 . integer . V_91 [ 0 ] == V_98 )
&& V_100 ) ) {
F_79 ( & V_4 -> V_6 , ! V_100 ) ;
V_99 = 1 ;
}
