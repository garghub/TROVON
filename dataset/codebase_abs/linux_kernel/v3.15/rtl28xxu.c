...
V_171 = V_16 [ 0 ] << 8 | V_16 [ 2 ] ;
} else {
V_171 = V_16 [ 0 ] << 16 |
V_16 [ 1 ] << 8 | V_16 [ 2 ] ;
}
} else {
V_171 = V_16 [ 0 ] << 24 | V_16 [ 1 ] << 16 |
V_16 [ 2 ] << 8 | V_16 [ 3 ] ;
}
F_56 ( V_10 -> V_176 , V_171 , 0 ) ;
V_13 = F_12 ( V_10 , V_177 , 1 ) ;
if ( V_13 )
goto V_20;
V_13 = F_12 ( V_10 , V_177 , 1 ) ;
if ( V_13 )
...
if ( ! V_47 -> V_174 ) {
static const struct V_188 V_193 [] = {
{ V_168 , 0x00 , 0x04 } ,
{ V_168 , 0x00 , 0x08 } ,
{ V_194 , 0x20 , 0x20 } ,
{ V_68 , 0x00 , 0x08 } ,
...
for ( V_170 = 0 ; V_170 < F_55 ( V_193 ) ; V_170 ++ ) {
V_13 = F_14 ( V_10 , V_193 [ V_170 ] . V_31 ,
V_193 [ V_170 ] . V_32 , V_193 [ V_170 ] . V_40 ) ;
if ( V_13 )
goto V_20;
}
V_47 -> V_174 = true ;
}
V_13 = F_13 ( V_10 , V_190 , & V_16 [ 0 ] ) ;
if ( V_13 )
goto V_20;
if ( V_16 [ 0 ] != 0x83 )
goto exit;
V_13 = F_13 ( V_10 , V_204 , & V_16 [ 0 ] ) ;
if ( V_13 )
goto V_20;
V_33 = V_16 [ 0 ] ;
V_13 = F_11 ( V_10 , V_205 , V_16 , V_33 ) ;
if ( V_13 )
goto V_20;
for ( V_170 = 0 ; V_170 < F_55 ( V_189 ) ; V_170 ++ ) {
V_13 = F_14 ( V_10 , V_189 [ V_170 ] . V_31 ,
V_189 [ V_170 ] . V_32 , V_189 [ V_170 ] . V_40 ) ;
if ( V_13 )
goto V_20;
}
F_59 ( & V_187 ) ;
for ( V_170 = 0 ; V_170 < V_33 ; V_170 ++ ) {
V_187 . V_206 = V_16 [ V_170 ] >> 7 ;
V_187 . V_207 = 50800 * ( V_16 [ V_170 ] & 0x7f ) ;
F_60 ( V_10 -> V_176 , & V_187 ) ;
}
F_61 ( V_10 -> V_176 , true ) ;
F_62 ( V_10 -> V_176 ) ;
exit:
return V_13 ;
V_20:
