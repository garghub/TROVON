...
V_35 = F_42 ( & V_13 -> V_36 -> V_80 , V_13 -> V_81 , V_13 -> V_47 ,
V_82 , 0 , & V_46 ) ;
if ( V_35 < 0 ) {
ERROR ( V_13 , L_12 ) ;
goto V_83;
...
F_44 ( V_46 , L_14 ) ;
V_35 = F_45 ( V_46 , V_46 -> V_87 , 0 ,
V_13 -> V_90 , V_13 -> V_91 , & V_69 ) ;
if ( V_35 < 0 ) {
ERROR ( V_13 , L_15 , V_35 ) ;
goto V_83;
}
V_13 -> V_69 = V_69 ;
strcpy ( V_69 -> V_31 , V_46 -> V_88 ) ;
V_69 -> V_92 = V_93 |
V_94 |
V_95 ;
V_69 -> V_70 = V_13 ;
...
static int T_3
F_48 ( struct V_43 * V_44 , struct V_2 * V_3 )
{
struct V_100 * * V_101 ;
...
V_114 . V_115 [ 0 ] = V_25 ;
V_25 = - V_116 ;
V_13 -> V_27 = F_51 ( V_23 -> V_36 , & V_117 ) ;
if ( ! V_13 -> V_27 )
goto V_83;
V_13 -> V_27 -> V_14 = V_23 ;
V_13 -> V_26 = F_51 ( V_23 -> V_36 , & V_118 ) ;
if ( ! V_13 -> V_26 )
goto V_83;
V_13 -> V_26 -> V_14 = V_23 ;
V_101 = F_52 ( ( V_65 * 4 ) + 9 , sizeof( * V_101 ) ,
V_119 ) ;
if ( ! V_101 ) {
V_25 = - V_41 ;
goto V_83;
...
+ ( V_13 -> V_91 + V_13 -> V_90 ) *
( V_121 + F_53 ( 1 ) ) ;
V_122 . V_123 = F_54 ( V_108 ) ;
V_101 [ V_19 ++ ] = (struct V_100 * ) & V_122 ;
for ( V_108 = 0 ; V_108 < V_13 -> V_91 ; V_108 ++ ) {
...
V_145 . V_126 = F_55 ( V_13 -> V_91 ) ;
V_145 . V_146 = V_13 -> V_91 ;
V_141 . V_126 = F_55 ( V_13 -> V_90 ) ;
V_141 . V_146 = V_13 -> V_90 ;
V_101 [ V_19 ++ ] = (struct V_100 * ) & V_118 ;
V_101 [ V_19 ++ ] = (struct V_100 * ) & V_145 ;
V_101 [ V_19 ++ ] = (struct V_100 * ) & V_117 ;
V_101 [ V_19 ++ ] = (struct V_100 * ) & V_141 ;
V_101 [ V_19 ++ ] = NULL ;
V_3 -> V_147 = F_56 ( V_101 ) ;
if ( ! V_3 -> V_147 )
goto V_148;
if ( F_57 ( V_44 -> V_23 -> V_36 ) ) {
V_117 . V_149 = F_54 ( 512 ) ;
V_118 . V_149 = F_54 ( 512 ) ;
V_3 -> V_150 = F_56 ( V_101 ) ;
if ( ! V_3 -> V_150 )
goto V_148;
}
F_6 ( V_101 ) ;
...
struct V_1 * V_13 ;
int V_25 , V_19 ;
if ( V_91 > V_65 || V_90 > V_65 )
return - V_72 ;
V_13 = F_60 ( sizeof *V_13 , V_119 ) ;
if ( ! V_13 ) {
V_25 = - V_41 ;
goto V_83;
}
for ( V_19 = 0 ; V_19 < V_91 ; V_19 ++ ) {
struct V_54 * V_55 = F_60 ( sizeof( * V_55 ) , V_119 ) ;
if ( ! V_55 ) {
V_25 = - V_41 ;
goto V_151;
}
...
F_61 ( & V_13 -> V_75 , F_31 , ( unsigned long ) V_13 ) ;
V_13 -> V_91 = V_91 ;
V_13 -> V_90 = V_90 ;
V_25 = F_41 ( V_13 ) ;
if ( V_25 < 0 )
...
V_13 -> V_4 . V_156 = F_22 ;
V_13 -> V_4 . V_157 = F_23 ;
V_13 -> V_47 = F_62 ( V_47 , V_119 ) ;
V_13 -> V_81 = V_81 ;
V_13 -> V_40 = V_40 ;
V_13 -> V_39 = V_39 ;
V_25 = F_63 ( V_44 , & V_13 -> V_4 ) ;
if ( V_25 )
goto V_151;
return 0 ;
V_151:
