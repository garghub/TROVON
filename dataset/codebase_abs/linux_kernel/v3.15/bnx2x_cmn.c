...
V_62 = F_22 ( F_29 ( V_62 ) ) ;
if ( V_54 -> V_73 & V_74 ) {
V_59 = & V_49 -> V_70 [ V_62 ] . V_75 ;
V_66 = F_30 ( V_59 ) ;
-- V_65 ;
V_62 = F_22 ( F_29 ( V_62 ) ) ;
}
F_31 ( & V_2 -> V_76 -> V_4 , F_32 ( V_57 ) ,
F_30 ( V_57 ) + V_66 ,
V_77 ) ;
while ( V_65 > 0 ) {
V_59 = & V_49 -> V_70 [ V_62 ] . V_75 ;
F_33 ( & V_2 -> V_76 -> V_4 , F_32 ( V_59 ) ,
F_30 ( V_59 ) , V_77 ) ;
if ( -- V_65 )
V_62 = F_22 ( F_29 ( V_62 ) ) ;
}
...
{
struct V_79 * V_80 ;
T_3 V_81 , V_82 , V_83 = V_49 -> V_84 ;
unsigned int V_51 = 0 , V_52 = 0 ;
#ifdef F_26
if ( F_38 ( V_2 -> V_85 ) )
return - 1 ;
#endif
V_80 = F_39 ( V_2 -> V_4 , V_49 -> V_69 ) ;
V_81 = F_25 ( * V_49 -> V_86 ) ;
V_82 = V_49 -> V_87 ;
while ( V_82 != V_81 ) {
T_3 V_88 ;
...
F_24 ( V_68 ,
L_6 ,
V_49 -> V_69 , V_81 , V_82 , V_88 ) ;
V_83 = F_21 ( V_2 , V_49 , V_88 ,
& V_51 , & V_52 ) ;
V_82 ++ ;
}
F_40 ( V_80 , V_51 , V_52 ) ;
...
V_92 = F_52 ( V_15 -> V_93 ) ;
V_97 = V_92 >> V_103 ;
V_98 = F_52 ( V_15 -> V_104 ) >> V_103 ;
if ( V_97 + 1 != V_98 )
V_97 ++ ;
for ( V_3 = V_98 ; V_3 != V_97 ; V_3 = F_53 ( V_3 ) ) {
if ( F_35 ( V_15 -> V_99 [ V_3 ] ) )
break;
V_15 -> V_99 [ V_3 ] = V_105 ;
V_46 += V_106 ;
}
...
static void F_57 ( struct V_13 * V_15 , T_3 V_123 ,
T_3 V_124 , T_3 V_125 ,
struct V_107 * V_96 )
{
struct V_1 * V_2 = V_15 -> V_2 ;
struct V_126 * V_127 = & V_15 -> V_128 [ V_124 ] ;
struct V_126 * V_129 = & V_15 -> V_128 [ V_125 ] ;
struct V_130 * V_131 = & V_15 -> V_132 [ V_125 ] ;
T_5 V_133 ;
struct V_29 * V_31 = & V_15 -> V_31 [ V_123 ] ;
struct V_126 * V_134 = & V_31 -> V_134 ;
if ( V_31 -> V_135 != V_136 )
F_27 ( L_9 , V_123 ) ;
...
* V_134 = * V_127 ;
V_31 -> V_144 =
F_25 ( V_96 -> V_145 . V_73 ) ;
V_31 -> V_146 = F_25 ( V_96 -> V_146 ) ;
V_31 -> V_135 = V_147 ;
V_31 -> V_148 = F_25 ( V_96 -> V_148 ) ;
V_31 -> V_149 = V_96 -> V_149 ;
V_31 -> V_150 = F_55 ( V_2 , V_96 , & V_31 -> V_109 ) ;
if ( V_15 -> V_151 == V_152 ) {
T_3 V_153 = F_25 ( V_96 -> V_154 ) ;
V_31 -> V_155 = V_156 / V_153 * V_153 ;
V_31 -> V_153 = V_153 ;
}
#ifdef F_26
V_15 -> V_157 |= ( 1 << V_123 ) ;
