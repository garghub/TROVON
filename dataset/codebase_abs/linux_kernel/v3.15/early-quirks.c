...
static T_5 F_39 ( int V_1 , int V_2 , int V_3 )
{
T_4 V_38 ;
V_38 = F_21 ( V_1 , V_2 , V_3 , V_59 ) ;
V_38 >>= V_62 ;
...
static void T_1 F_40 ( int V_1 , int V_2 , int V_3 )
{
T_5 V_64 ;
int V_65 ;
T_2 V_66 ;
...
for ( V_65 = 0 ; V_65 < F_41 ( V_71 ) ; V_65 ++ ) {
...
static void T_1 F_44 ( int V_1 , int V_2 , int V_3 )
{
#ifdef F_45
V_79 = 1 ;
F_46 ( L_18 ) ;
...
static int T_1 F_47 ( int V_1 , int V_2 , int V_3 )
{
T_4 V_80 ;
T_4 V_81 ;
T_4 V_21 ;
