...
T_4 * V_38 = & V_18 -> V_6 . V_44 [ F_15 ( V_64 ) ] ;
T_4 * V_36 ;
if ( ! ( * V_38 & F_16 ( V_64 ) ) )
continue;
* V_38 &= ~ F_16 ( V_64 ) ;
...
static struct V_1 * F_26 ( struct V_50 * V_114 ,
T_2 V_115 )
{
int V_51 = 0 ;
struct V_1 * V_18 ;
...
V_51 = - V_24 ;
V_11 -> V_33 = F_24 ( V_114 -> V_119 [ V_3 ] ) ;
if ( V_11 -> V_33 == V_66 )
goto V_120;
...
struct V_127 * V_127 ;
F_28 () ;
V_127 = F_29 ( V_11 -> V_49 ) ;
if ( ! V_127 ) {
F_30 () ;
V_51 = - V_128 ;
goto V_120;
}
V_11 -> V_49 = F_31 ( V_127 ) ;
F_30 () ;
}
V_51 = F_25 ( V_18 , V_11 ) ;
if ( V_51 )
...
case V_72 :
case V_74 :
V_11 -> V_122 = F_32 ( F_33 () , V_11 -> V_49 ) ;
if ( ! F_34 ( V_11 -> V_122 ) )
goto V_120;
break;
case V_75 :
...
case V_78 :
case V_79 :
V_11 -> V_124 = F_35 ( F_33 () , V_11 -> V_49 ) ;
if ( ! F_36 ( V_11 -> V_124 ) )
goto V_120;
break;
case V_108 :
...
V_51 = F_37 ( V_11 -> type , V_11 -> V_33 , V_23 ,
( void * * ) & V_11 -> V_13 ) ;
if ( V_51 == - V_24 ) {
F_38 ( L_2 ,
V_23 ) ;
...
goto V_120;
V_18 -> V_6 . V_129 += V_11 -> V_49 ;
V_51 = F_39 ( & V_18 -> V_6 , V_23 , V_11 -> V_49 , V_11 -> V_33 ) ;
if ( V_51 ) {
F_3 ( V_23 ) ;
goto V_120;
}
...
goto V_120;
V_18 -> V_6 . V_129 += V_11 -> V_49 ;
V_51 = F_40 ( & V_18 -> V_6 , V_23 , V_11 -> V_33 ) ;
F_3 ( V_23 ) ;
if ( V_51 )
goto V_120;
break;
...
static inline T_2 F_42 ( void * * V_20 , const char * V_23 )
{
...
static struct V_50 * F_43 ( struct V_4 * V_28 )
{
struct V_50 * V_114 ;
void * V_20 ;
int V_3 ;
V_114 = F_12 ( sizeof( * V_114 ) + V_28 -> V_129 , V_19 ) ;
if ( F_9 ( ! V_114 ) )
return NULL ;
...
static int F_46 ( struct V_4 * V_131 , struct V_4 * V_132 )
{
int V_3 ;
...
break;
case V_104 :
if ( strcmp ( F_44 ( V_131 -> V_7 ) ,
F_44 ( V_132 -> V_7 ) ) )
return 1 ;
break;
case V_105 :
if ( strcmp ( F_45 ( V_131 -> V_32 ) ,
F_45 ( V_132 -> V_32 ) ) )
return 1 ;
break;
case V_106 :
...
case V_73 :
case V_74 :
if ( ! F_47 ( V_131 -> V_8 [ V_3 ] . V_122 , V_132 -> V_8 [ V_3 ] . V_122 ) )
return 1 ;
break;
case V_75 :
case V_76 :
...
case V_78 :
case V_79 :
if ( ! F_48 ( V_131 -> V_8 [ V_3 ] . V_124 , V_132 -> V_8 [ V_3 ] . V_124 ) )
return 1 ;
break;
default:
...
static inline int F_49 ( struct V_10 * V_133 ,
struct V_10 * V_134 )
{
int V_135 = 0 ;
char * V_12 ;
V_12 = F_50 ( V_134 -> V_12 , V_19 ) ;
if ( F_9 ( ! V_12 ) )
return - V_27 ;
V_133 -> V_12 = V_12 ;
V_135 = F_37 ( V_133 -> type , V_133 -> V_33 , V_133 -> V_12 ,
( void * * ) & V_133 -> V_13 ) ;
if ( V_135 == - V_24 ) {
F_38 ( L_2 ,
V_133 -> V_12 ) ;
...
struct V_1 * F_51 ( struct V_4 * V_136 )
{
T_1 V_137 = V_136 -> V_9 ;
struct V_1 * V_18 ;
struct V_4 * V_138 ;
...
case V_102 :
case V_103 :
V_51 = F_49 ( & V_138 -> V_8 [ V_3 ] ,
& V_136 -> V_8 [ V_3 ] ) ;
break;
case V_106 :
V_139 = F_50 ( V_136 -> V_14 , V_19 ) ;
if ( F_9 ( ! V_139 ) )
V_51 = - V_27 ;
else
V_138 -> V_14 = V_139 ;
...
static struct V_1 * F_53 ( struct V_1 * V_18 ,
struct V_141 * * V_38 )
{
...
static inline int F_56 ( struct V_1 * V_18 )
{
struct V_1 * V_2 ;
...
static inline int F_65 ( struct V_1 * V_18 )
{
struct V_1 * V_2 ;
struct V_148 * V_7 = V_18 -> V_6 . V_7 ;
struct V_149 * V_32 = V_18 -> V_6 . V_32 ;
...
static void F_71 ( T_4 V_159 , int V_160 , struct V_161 * V_162 )
{
struct V_163 * V_164 ;
struct V_4 * V_165 ;
int V_3 ;
for ( V_3 = 0 ; V_3 < V_166 ; V_3 ++ ) {
F_55 (r, &audit_rules_list[i], list) {
struct V_50 * V_114 ;
V_114 = F_43 ( V_165 ) ;
if ( F_9 ( ! V_114 ) )
break;
V_164 = F_72 ( V_159 , V_160 , V_167 ,
0 , 1 , V_114 ,
...
V_164 = F_72 ( V_159 , V_160 , V_167 , 1 , 1 , NULL , 0 ) ;
if ( V_164 )
F_73 ( V_162 , V_164 ) ;
}
static void F_74 ( char * V_56 , struct V_4 * V_6 , int V_168 )
{
struct V_169 * V_170 ;
T_5 V_171 = F_75 ( & V_172 , F_76 ( V_173 ) ) ;
unsigned int V_174 = F_77 ( V_173 ) ;
if ( ! V_175 )
return;
V_170 = F_78 ( NULL , V_19 , V_176 ) ;
if ( ! V_170 )
return;
F_79 ( V_170 , L_3 , V_171 , V_174 ) ;
F_80 ( V_170 ) ;
F_79 ( V_170 , L_4 ) ;
F_81 ( V_170 , V_56 ) ;
F_82 ( V_170 , V_6 -> V_14 ) ;
F_79 ( V_170 , L_5 , V_6 -> V_29 , V_168 ) ;
F_83 ( V_170 ) ;
}
int F_84 ( int type , T_4 V_159 , int V_160 , void * V_114 ,
T_2 V_115 )
{
int V_51 = 0 ;
struct V_1 * V_18 ;
switch ( type ) {
case V_177 :
V_18 = F_26 ( V_114 , V_115 ) ;
if ( F_27 ( V_18 ) )
return F_85 ( V_18 ) ;
V_51 = F_56 ( V_18 ) ;
F_74 ( L_6 , & V_18 -> V_6 , ! V_51 ) ;
if ( V_51 )
F_1 ( V_18 ) ;
break;
case V_178 :
...
int F_86 ( struct V_163 * V_179 , int V_160 )
{
T_1 V_159 = F_87 ( V_179 ) . V_159 ;
struct V_180 * V_180 = F_88 ( F_87 ( V_179 ) . V_181 ) ;
struct V_182 * V_183 ;
struct V_184 * V_185 ;
int V_51 = 0 ;
V_185 = F_12 ( sizeof( struct V_184 ) , V_19 ) ;
if ( ! V_185 )
return - V_27 ;
V_185 -> V_180 = F_89 ( V_180 ) ;
V_185 -> V_159 = V_159 ;
F_90 ( & V_185 -> V_162 ) ;
F_57 ( & V_151 ) ;
F_71 ( V_159 , V_160 , & V_185 -> V_162 ) ;
F_58 ( & V_151 ) ;
V_183 = F_91 ( V_186 , V_185 , L_8 ) ;
if ( F_27 ( V_183 ) ) {
F_92 ( & V_185 -> V_162 ) ;
F_3 ( V_185 ) ;
V_51 = F_85 ( V_183 ) ;
...
int F_93 ( T_1 V_187 , T_1 V_33 , T_1 V_188 )
{
switch ( V_33 ) {
case V_34 :
return ( V_187 == V_188 ) ;
...
int F_95 ( T_6 V_187 , T_1 V_33 , T_6 V_188 )
{
switch ( V_33 ) {
case V_34 :
return F_47 ( V_187 , V_188 ) ;
case V_35 :
return ! F_47 ( V_187 , V_188 ) ;
case V_189 :
return F_96 ( V_187 , V_188 ) ;
case V_190 :
...
int F_100 ( T_7 V_187 , T_1 V_33 , T_7 V_188 )
{
switch ( V_33 ) {
case V_34 :
...
int F_106 ( const char * V_195 , const char * V_193 , int V_196 )
{
int V_197 , V_198 ;
const char * V_38 ;
V_197 = strlen ( V_195 ) ;
...
if ( V_198 < V_197 )
return 1 ;
V_196 = V_196 == V_199 ? F_105 ( V_193 ) : V_196 ;
if ( V_198 - V_196 != V_197 )
return 1 ;
V_38 = V_193 + V_196 ;
return strncmp ( V_38 , V_195 , V_197 ) ;
}
static int F_107 ( struct V_4 * V_6 , int type ,
enum V_200 * V_201 )
{
int V_3 ;
...
case V_80 :
V_127 = F_108 ( V_173 ) ;
V_202 = F_93 ( V_127 , V_11 -> V_33 , V_11 -> V_49 ) ;
break;
case V_69 :
V_202 = F_95 ( F_109 () , V_11 -> V_33 , V_11 -> V_122 ) ;
break;
case V_75 :
V_202 = F_100 ( F_110 () , V_11 -> V_33 , V_11 -> V_124 ) ;
break;
case V_73 :
V_202 = F_95 ( F_76 ( V_173 ) ,
V_11 -> V_33 , V_11 -> V_122 ) ;
break;
case V_107 :
V_202 = F_93 ( F_111 ( V_173 ) ,
V_11 -> V_33 , V_11 -> V_49 ) ;
break;
case V_68 :
V_202 = F_93 ( type , V_11 -> V_33 , V_11 -> V_49 ) ;
break;
case V_94 :
case V_95 :
case V_96 :
...
V_206 = F_107 ( & V_2 -> V_6 , type , & V_201 ) ;
if ( V_206 ) {
...
static int F_118 ( struct V_4 * V_165 )
{
...
F_121 ( & V_165 -> V_209 , & V_208 -> V_6 . V_209 ) ;
F_122 ( & V_18 -> V_37 , & V_208 -> V_37 ) ;
F_123 ( & V_165 -> V_37 , & V_208 -> V_6 . V_37 ) ;
}
F_70 ( & V_18 -> V_17 , F_5 ) ;
return V_51 ;
}
...
F_57 ( & V_151 ) ;
for ( V_3 = 0 ; V_3 < V_166 ; V_3 ++ ) {
F_125 (r, n, &audit_rules_list[i], list) {
int V_168 = F_118 ( V_165 ) ;
if ( ! V_51 )
V_51 = V_168 ;
}
}
