...
if ( V_8 -> V_23 & ( V_36 | V_37 ) ) {
V_34 = F_15 ( V_32 * sizeof( * V_34 ) , V_35 ) ;
if ( ! V_34 ) {
V_33 = - V_38 ;
goto V_39;
}
...
V_34 = F_17 ( V_32 * sizeof( * V_34 ) , V_35 ) ;
if ( ! V_34 ) {
V_33 = - V_38 ;
goto V_39;
}
...
{
union V_82 V_83 ;
args -> V_84 = F_55 ( args -> V_84 , args -> V_18 , args -> V_85 ) ;
...
V_23 |= V_36 ;
F_113 ( F_6 ( V_23 ) ,
& V_83 . V_149 . V_18 , & V_83 . V_149 . V_11 ) ;
V_12 = F_114 ( F_6 ( V_23 ) ,
V_83 . V_149 . V_18 , V_83 . V_149 . V_11 ) ;
} else {
V_12 = F_56 ( V_83 . V_86 ) ;
}
V_8 = F_17 ( sizeof( * V_8 ) , V_35 ) ;
if ( ! V_8 )
goto V_67;
F_115 ( & V_8 -> V_147 , & V_97 -> V_150 ) ;
V_2 = & V_8 -> V_109 ;
...
V_8 -> V_23 = V_23 ;
if ( V_23 & V_24 ) {
V_8 -> V_18 = V_83 . V_149 . V_18 ;
V_8 -> V_11 = V_83 . V_149 . V_11 ;
}
V_33 = 0 ;
if ( V_23 & ( V_55 | V_148 ) )
F_117 ( V_20 , V_2 , V_12 ) ;
else
V_33 = F_118 ( V_20 , V_2 , V_12 ) ;
if ( V_33 )
goto V_67;
return V_2 ;
V_67:
...
int V_19 , V_155 ;
if ( ! F_120 () ) {
F_121 ( V_20 -> V_20 , L_25 ) ;
return;
}
V_10 = F_122 ( 3 , sizeof( * V_10 ) , V_35 ) ;
if ( ! V_10 )
return;
for ( V_19 = 0 ; V_19 < F_42 ( V_151 ) ; V_19 ++ ) {
T_6 V_45 = 1 , V_44 = V_13 >> V_19 ;
F_113 ( V_151 [ V_19 ] , & V_44 , & V_45 ) ;
V_10 [ V_19 ] . V_11 = V_45 ;
V_10 [ V_19 ] . V_61 = F_123 ( V_45 ) ;
V_10 [ V_19 ] . V_65 = F_73 ( V_151 [ V_19 ] , 0 ) >> V_16 ;
V_10 [ V_19 ] . V_62 = F_123 ( ( V_13 / V_45 ) >> V_19 ) ;
for ( V_155 = 0 ; V_155 < V_25 ; V_155 ++ ) {
struct V_5 * V_6 = & V_10 [ V_19 ] . V_6 [ V_155 ] ;
struct V_101 * V_64 =
F_64 ( V_151 [ V_19 ] , V_44 , V_45 ,
V_13 ) ;
if ( F_12 ( V_64 ) ) {
F_13 ( V_20 -> V_20 ,
L_26 ,
V_19 , V_155 , F_14 ( V_64 ) ) ;
return;
}
V_6 -> V_56 = F_67 ( V_64 ) ;
V_6 -> V_64 = V_64 ;
F_47 ( L_27 , V_19 , V_155 , V_44 , V_45 ,
V_6 -> V_56 ,
V_10 [ V_19 ] . V_65 << V_16 ) ;
}
}
