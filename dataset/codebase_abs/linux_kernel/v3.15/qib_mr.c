...
V_5 -> V_5 . V_40 = V_47 ;
V_5 -> V_5 . V_44 = V_44 ;
V_5 -> V_5 . V_60 = V_52 -> V_60 ;
V_5 -> V_5 . V_29 = V_48 ;
V_5 -> V_52 = V_52 ;
if ( F_19 ( V_52 -> V_61 ) )
V_5 -> V_5 . V_62 = F_20 ( V_52 -> V_61 ) ;
V_9 = 0 ;
V_38 = 0 ;
...
int F_34 ( struct V_2 * V_3 , T_1 * V_73 ,
int V_79 , T_1 V_40 )
{
...
struct V_80 * V_81 ;
unsigned long V_82 ;
F_40 (fmr, fmr_list, ibfmr.list) {
V_81 = & F_36 ( V_77 -> V_3 . V_84 ) -> V_85 ;
F_37 ( & V_81 -> V_86 , V_82 ) ;
V_77 -> V_5 . V_39 = 0 ;
V_77 -> V_5 . V_40 = 0 ;
V_77 -> V_5 . V_44 = 0 ;
