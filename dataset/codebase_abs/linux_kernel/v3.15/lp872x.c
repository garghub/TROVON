...
int V_70 ;
T_1 V_120 ;
V_66 = F_34 ( V_8 , sizeof( * V_66 ) , V_121 ) ;
if ( ! V_66 )
goto V_122;
F_35 ( V_113 , L_6 , & V_66 -> V_96 ) ;
if ( F_36 ( V_113 , L_7 , NULL ) )
V_66 -> V_94 = true ;
V_66 -> V_65 = F_34 ( V_8 , sizeof( struct V_64 ) , V_121 ) ;
if ( ! V_66 -> V_65 )
goto V_122;
V_66 -> V_65 -> V_44 = F_37 ( V_113 , L_8 , 0 ) ;
F_35 ( V_113 , L_9 , ( T_1 * ) & V_66 -> V_65 -> V_67 ) ;
F_35 ( V_113 , L_10 , & V_120 ) ;
V_66 -> V_65 -> V_91 = V_120 ? V_48 : V_49 ;
if ( F_38 ( V_113 ) == 0 )
goto V_122;
switch ( V_111 ) {
case V_18 :
...
V_119 = V_115 ( V_8 , V_113 , V_116 , V_118 ) ;
if ( V_119 <= 0 )
goto V_122;
for ( V_70 = 0 ; V_70 < V_118 ; V_70 ++ ) {
V_66 -> V_100 [ V_70 ] . V_98 =
(enum V_28 ) V_116 [ V_70 ] . V_108 ;
V_66 -> V_100 [ V_70 ] . V_101 = V_116 [ V_70 ] . V_101 ;
if ( strncmp ( V_116 [ V_70 ] . V_125 , L_11 , 4 ) )
continue;
V_117 = V_66 -> V_100 [ V_70 ] . V_101 ;
V_117 -> V_126 . V_127 |= V_128 ;
V_117 -> V_126 . V_129 |= V_130 ;
}
V_122:
return V_66 ;
}
...
static int F_39 ( struct V_131 * V_132 , const struct V_133 * V_98 )
{
struct V_1 * V_2 ;
int V_5 , V_15 , V_99 ;
const int V_134 [] = {
...
if ( V_132 -> V_8 . V_114 )
V_132 -> V_8 . V_137 = F_33 ( & V_132 -> V_8 ,
(enum V_10 ) V_98 -> V_108 ) ;
V_2 = F_34 ( & V_132 -> V_8 , sizeof( struct V_1 ) , V_121 ) ;
if ( ! V_2 )
goto V_138;
V_99 = V_134 [ V_98 -> V_108 ] ;
V_15 = sizeof( struct V_26 * ) * V_99 ;
V_2 -> V_109 = F_34 ( & V_132 -> V_8 , V_15 , V_121 ) ;
if ( ! V_2 -> V_109 )
goto V_138;
V_2 -> V_7 = F_40 ( V_132 , & V_139 ) ;
if ( F_31 ( V_2 -> V_7 ) ) {
V_5 = F_32 ( V_2 -> V_7 ) ;
F_3 ( & V_132 -> V_8 , L_12 , V_5 ) ;
goto V_140;
}
V_2 -> V_8 = & V_132 -> V_8 ;
V_2 -> V_66 = F_41 ( & V_132 -> V_8 ) ;
V_2 -> V_12 = V_98 -> V_108 ;
V_2 -> V_99 = V_99 ;
F_42 ( V_132 , V_2 ) ;
V_5 = F_27 ( V_2 ) ;
