...
if ( V_17 -> V_100 & V_101 &&
V_93 -> V_30 == V_102 ) {
V_95 = F_80 ( V_17 , ( unsigned long ) V_24 ,
V_24 -> V_98 ) ;
if ( V_95 ) {
F_81 ( & V_24 -> V_4 ) ;
F_79 ( & V_24 -> V_4 ) ;
...
void F_84 ( struct V_2 * V_24 )
{
struct V_15 * V_4 = & V_24 -> V_4 ;
struct V_1 * V_17 = F_2 ( V_4 -> V_5 ) ;
if ( V_17 -> V_100 & V_101 &&
V_24 -> V_30 == V_102 )
F_85 ( V_17 , ( unsigned long ) V_24 ) ;
F_86 ( V_4 ) ;
F_81 ( V_4 ) ;
F_79 ( V_4 ) ;
F_60 ( V_4 ) ;
}
static int F_87 ( struct V_15 * V_4 , void * V_103 )
{
if ( F_62 ( V_4 ) )
F_84 ( F_59 ( V_4 ) ) ;
return 0 ;
}
void F_88 ( struct V_1 * V_17 )
{
F_89 ( & V_17 -> V_61 , NULL , F_87 ) ;
}
void F_90 ( struct V_2 * V_24 )
{
F_41 ( & V_24 -> V_53 ) ;
if ( V_24 -> V_43 == V_39 )
F_36 ( V_24 ) ;
...
static int F_92 ( struct V_1 * V_17 , T_3 V_104 , T_3 V_105 ,
int V_106 )
{
struct V_32 * V_26 = F_13 ( V_17 -> V_33 ) ;
return V_26 -> V_34 -> V_107 ( V_17 , V_104 , V_105 , V_106 ) ;
}
static int F_93 ( struct V_1 * V_17 , T_3 V_104 , int V_106 )
{
struct V_32 * V_26 = F_13 ( V_17 -> V_33 ) ;
return V_26 -> V_34 -> V_108 ( V_17 , V_104 , V_106 ) ;
}
struct V_109 *
F_94 ( struct V_110 * V_111 )
{
int V_31 ;
struct V_32 * V_26 ;
...
F_96 ( V_31 > F_11 ( V_26 -> V_116 ) ) ;
F_95 ( & V_26 -> V_90 ) ;
V_26 -> V_34 = V_111 ;
return & V_26 -> V_91 ;
}
void F_97 ( struct V_109 * V_91 )
{
