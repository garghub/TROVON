...
if ( F_101 ( V_117 , V_11 -> V_82 . V_190 , false ) < 0 ) {
F_102 ( L_78 , strerror ( V_138 ) ) ;
F_103 ( V_117 ) ;
goto V_133;
}
V_129 = 0 ;
...
V_11 -> V_99 = V_191 ;
V_11 -> V_109 = F_105 ( & V_194 , false , & V_11 -> V_99 ) ;
if ( ! V_11 -> V_109 ) {
F_8 ( L_79 ) ;
return - V_156 ;
}
if ( ! F_106 ( V_11 -> V_109 , L_80 ) )
return - V_156 ;
V_24 = F_69 ( V_11 ) ;
if ( V_24 < 0 )
return V_24 ;
return F_107 ( V_11 -> V_109 , & V_11 -> V_99 ) ;
}
static int F_108 ( struct V_10 * V_11 )
{
if ( V_11 -> V_199 ) {
V_11 -> V_102 = F_109 ( V_11 -> V_199 ) ;
if ( V_11 -> V_102 == NULL ) {
F_8 ( L_81 ) ;
return - V_156 ;
}
...
static int
F_112 ( struct V_10 * V_11 , int V_200 , const char * * V_201 )
{
...
V_203 [ V_13 ] = F_113 ( V_204 [ V_13 ] ) ;
for ( V_36 = 0 ; V_36 < F_71 ( V_205 ) ; V_36 ++ ) {
V_203 [ V_13 ++ ] = L_88 ;
V_203 [ V_13 ++ ] = F_113 ( V_205 [ V_36 ] ) ;
}
V_203 [ V_13 ++ ] = F_113 ( L_89 ) ;
V_203 [ V_13 ++ ] = F_113 ( V_11 -> V_196 ) ;
for ( V_36 = 1 ; V_36 < ( unsigned int ) V_200 ; V_36 ++ , V_13 ++ )
V_203 [ V_13 ] = V_201 [ V_36 ] ;
return F_114 ( V_13 , V_203 , NULL ) ;
}
static int
F_115 ( struct V_10 * V_11 , int V_200 , const char * * V_201 )
{
const struct V_206 V_207 [] = {
F_116 ( 0 , L_90 , & V_11 -> V_25 , L_91 ,
L_92 ) ,
F_117 ( 0 , L_93 , & V_11 -> V_56 ,
L_94 ) ,
F_116 ( 'k' , L_95 , & V_11 -> V_67 , L_96 ,
L_97
L_98 ) ,
F_116 ( 'p' , L_99 , & V_11 -> V_199 , L_99 ,
L_100 ) ,
F_118 ()
} ;
...
static struct V_172 * F_122 ( void )
{
struct V_172 * V_117 ;
char * V_209 , * V_8 , * V_210 ;
unsigned int V_36 ;
int V_107 = - 1 ;
V_117 = F_123 () ;
if ( V_117 == NULL )
...
char V_211 [ V_212 ] ;
int V_107 ;
const struct V_206 V_213 [] = {
F_116 ( 'p' , L_99 , & V_11 -> V_82 . V_83 . V_60 , L_99 ,
L_104 ) ,
F_128 ( 'm' , L_105 , & V_11 -> V_82 . V_190 , L_106 ,
L_107 ,
V_214 ) ,
F_129 ( 'v' , L_108 , & V_215 ,
L_109 ) ,
F_130 ( 'a' , L_110 , & V_11 -> V_82 . V_83 . V_84 ,
L_111 ) ,
F_131 ( 'd' , L_112 , & V_11 -> V_135 ,
L_113 ) ,
F_116 ( 0 , L_90 , & V_11 -> V_25 , L_91 ,
L_92 ) ,
F_117 ( 0 , L_93 , & V_11 -> V_56 ,
...
L_97
L_98 ) ,
F_132 ( 0 , L_114 , & V_11 -> V_57 ,
L_115 ) ,
F_118 ()
} ;
const char * const V_216 [] = {
L_116 ,
NULL
} ;
struct V_193 V_194 = {
...
V_11 -> V_99 . exit = V_218 ;
V_11 -> V_99 . V_219 = V_220 ;
V_11 -> V_99 . V_221 = F_64 ;
V_11 -> V_99 . V_123 = true ;
F_133 ( & V_11 -> V_99 ) ;
V_11 -> V_135 = 1 ;
V_11 -> V_82 . V_222 = 1 ;
V_11 -> V_82 . V_190 = 512 ;
V_11 -> V_82 . V_83 . V_223 = false ;
V_11 -> V_82 . V_83 . V_224 = NULL ;
V_11 -> V_82 . V_83 . V_225 = V_226 ;
F_119 () ;
F_134 () ;
V_227 = 0 ;
F_135 ( false ) ;
if ( V_200 ) {
V_200 = F_120 ( V_200 , V_201 , V_213 ,
V_216 , 0 ) ;
if ( V_200 )
F_121 ( V_216 , V_213 ) ;
}
V_11 -> V_57 *= V_228 ;
V_107 = F_136 ( & V_11 -> V_82 . V_83 ) ;
if ( V_107 ) {
F_137 ( & V_11 -> V_82 . V_83 , V_107 , V_211 , V_212 ) ;
F_138 ( L_6 , V_211 ) ;
}
if ( F_139 ( & V_11 -> V_82 . V_83 ) )
...
V_229 . V_230 = V_11 -> V_117 -> V_231 ;
if ( F_140 ( V_11 -> V_117 , & V_11 -> V_82 . V_83 ) < 0 )
F_121 ( V_216 , V_213 ) ;
V_11 -> V_109 = F_105 ( & V_194 , false , & V_11 -> V_99 ) ;
if ( V_11 -> V_109 == NULL ) {
V_107 = - V_167 ;
...
F_141 ( V_11 -> V_109 ) ;
F_142 ( & V_11 -> V_109 -> V_232 . V_233 , & V_11 -> V_82 . V_83 ,
V_11 -> V_117 -> V_234 , false ) ;
V_107 = F_95 ( V_11 ) ;
if ( V_107 )
goto V_133;
V_107 = F_90 ( V_11 ) ;
...
static int F_146 ( const char * V_196 , int V_200 , const char * * V_201 )
{
struct V_10 V_11 = {
. V_196 = V_196 ,
. V_56 = - 1 ,
...
return F_112 ( & V_11 , V_200 - 1 , V_201 + 1 ) ;
if ( ! strncmp ( V_201 [ 1 ] , L_126 , 3 ) )
return F_115 ( & V_11 , V_200 - 1 , V_201 + 1 ) ;
#ifdef F_147
if ( ! strncmp ( V_201 [ 1 ] , L_127 , 4 ) )
return F_127 ( & V_11 , V_200 - 1 , V_201 + 1 ) ;
#endif
V_236:
return F_148 ( V_200 , V_201 , NULL ) ;
}
static int F_149 ( const char * V_196 , int V_200 , const char * * V_201 )
{
int V_202 , V_13 = 0 , V_36 ;
const char * * V_203 ;
V_202 = V_200 + 2 ;
V_203 = calloc ( V_202 + 1 , sizeof( char * ) ) ;
V_203 [ V_13 ++ ] = F_124 ( L_82 ) ;
V_203 [ V_13 ++ ] = F_124 ( L_89 ) ;
V_203 [ V_13 ++ ] = F_124 ( V_196 ) ;
for ( V_36 = 1 ; V_36 < V_200 ; V_36 ++ , V_13 ++ )
V_203 [ V_13 ] = V_201 [ V_36 ] ;
F_30 ( V_13 != V_202 ) ;
return F_114 ( V_13 , V_203 , NULL ) ;
}
static int F_150 ( const char * V_196 , int V_200 , const char * * V_201 )
{
int V_202 , V_13 = 0 , V_36 ;
const char * * V_203 ;
V_202 = V_200 + 2 ;
V_203 = calloc ( V_202 + 1 , sizeof( char * ) ) ;
V_203 [ V_13 ++ ] = F_124 ( L_128 ) ;
V_203 [ V_13 ++ ] = F_124 ( L_129 ) ;
V_203 [ V_13 ++ ] = F_124 ( V_196 ) ;
for ( V_36 = 1 ; V_36 < V_200 ; V_36 ++ , V_13 ++ )
V_203 [ V_13 ] = V_201 [ V_36 ] ;
F_30 ( V_13 != V_202 ) ;
...
static int
F_152 ( const char * V_196 , int V_200 , const char * * V_201 )
{
int V_202 , V_13 = 0 , V_36 ;
const char * * V_203 ;
V_202 = V_200 + 2 ;
V_203 = calloc ( V_202 + 1 , sizeof( char * ) ) ;
V_203 [ V_13 ++ ] = F_124 ( L_130 ) ;
V_203 [ V_13 ++ ] = F_124 ( L_129 ) ;
V_203 [ V_13 ++ ] = F_124 ( V_196 ) ;
for ( V_36 = 1 ; V_36 < V_200 ; V_36 ++ , V_13 ++ )
V_203 [ V_13 ] = V_201 [ V_36 ] ;
...
const struct V_206 V_237 [] = {
F_116 ( 'i' , L_131 , & V_196 , L_132 ,
L_133 ) ,
F_116 ( 'o' , L_134 , & V_196 , L_132 ,
L_135 ) ,
F_130 ( 0 , L_136 , & V_238 ,
L_137 ) ,
F_130 ( 0 , L_138 , & V_239 ,
L_139 ) ,
F_116 ( 0 , L_140 , & V_229 . V_240 , L_141 ,
L_142
L_143 ) ,
F_116 ( 0 , L_144 , & V_229 . V_241 ,
L_132 , L_145 ) ,
F_116 ( 0 , L_146 , & V_229 . V_242 ,
L_132 , L_147 ) ,
F_116 ( 0 , L_148 , & V_229 . V_243 ,
L_132 , L_149 ) ,
F_129 ( 'v' , L_108 , & V_215 ,
L_109 ) ,
F_118 ()
} ;
const char * const V_244 [] = { L_150 , L_82 , L_128 , L_151 ,
L_130 , L_152 , NULL } ;
const char * V_245 [] = { NULL , NULL } ;
V_239 = 0 ;
V_238 = 1 ;
V_200 = F_155 ( V_200 , V_201 , V_237 , V_244 , V_245 ,
V_246 ) ;
if ( ! V_200 )
F_121 ( V_245 , V_237 ) ;
if ( ! V_239 )
...
return F_149 ( V_196 , V_200 , V_201 ) ;
else if ( ! strncmp ( V_201 [ 0 ] , L_126 , 3 ) )
return F_150 ( V_196 , V_200 , V_201 ) ;
else if ( ! strncmp ( V_201 [ 0 ] , L_151 , 4 ) )
return F_157 ( V_200 , V_201 , NULL ) ;
else if ( ! strncmp ( V_201 [ 0 ] , L_150 , 3 ) )
return F_158 ( V_200 , V_201 , NULL ) ;
else if ( ! strncmp ( V_201 [ 0 ] , L_130 , 12 ) )
return F_152 ( V_196 , V_200 , V_201 ) ;
#if F_159 ( V_247 ) || F_159 ( V_248 )
else if ( ! strncmp ( V_201 [ 0 ] , L_152 , 4 ) )
return F_146 ( V_196 , V_200 , V_201 ) ;
#endif
else
F_121 ( V_245 , V_237 ) ;
return 0 ;
