...
V_117 ;
V_6 -> V_37 . V_38 = V_118 ;
V_6 -> V_37 . V_119 . V_120 ++ ;
} else {
V_85 -> V_45 [ 1 ] = V_121 |
V_122 ;
V_6 -> V_37 . V_38 = V_123 ;
V_6 -> V_37 . V_119 . V_124 ++ ;
}
} else {
V_85 -> V_95 |= V_125 ;
V_85 -> V_45 [ 2 ] = V_126 ;
...
static T_4 F_37 ( int V_148 , void * V_149 )
{
...
if ( V_156 )
return V_156 ;
V_156 = F_40 ( V_4 -> V_148 , & F_37 , V_6 -> V_157 ,
V_4 -> V_158 , V_4 ) ;
if ( V_156 ) {
F_41 ( V_4 ) ;
return - V_159 ;
...
struct V_3 * F_45 ( int V_160 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
V_4 = F_46 ( sizeof( struct V_5 ) + V_160 ,
V_161 ) ;
if ( ! V_4 )
return NULL ;
V_6 = F_3 ( V_4 ) ;
V_6 -> V_4 = V_4 ;
V_6 -> V_37 . V_162 = & V_163 ;
V_6 -> V_37 . V_164 = F_18 ;
V_6 -> V_37 . V_165 = F_16 ;
V_6 -> V_37 . V_166 = V_71 ;
memcpy ( V_6 -> V_8 , V_167 , sizeof( V_167 ) ) ;
if ( V_160 )
...
V_4 -> V_168 = & V_169 ;
V_4 -> V_170 |= V_171 ;
if ( ! V_172 && V_6 -> V_12 & V_13 ) {
V_6 -> V_37 . V_173 = F_19 ;
V_6 -> V_12 = V_174 | V_13 | V_175 ;
F_6 ( V_4 , L_16 ) ;
} else {
V_6 -> V_12 = V_174 | V_175 ;
F_6 ( V_4 , L_17 ) ;
}
F_12 ( V_6 ) ;
F_9 ( V_4 ) ;
