...
{
struct V_9 * V_10 = V_4 -> V_11 ;
if ( ! F_14 ( V_10 ) && ! F_15 ( V_10 ) && ! F_16 ( V_10 ) &&
! F_17 ( V_10 ) )
goto V_23;
if ( ! V_10 -> V_7 )
goto V_23;
...
goto V_32;
F_21 ( & V_10 -> V_12 ) ;
V_10 -> V_31 = F_19 ( V_4 -> V_33 , V_26 ) ;
if ( ! V_10 -> V_31 ) {
F_20 ( V_30 , V_4 , 0x00f8 ,
L_13 ) ;
goto V_23;
}
F_22 ( & V_28 ) ;
V_32:
V_10 -> V_34 = F_23 ( L_14 , V_35 , V_10 -> V_31 , V_4 ,
& V_36 ) ;
if ( ! V_10 -> V_34 ) {
F_20 ( V_30 , V_4 , 0x00f9 ,
L_15 ) ;
goto V_23;
}
V_23:
