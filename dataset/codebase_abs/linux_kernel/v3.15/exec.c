...
void F_136 ( struct V_137 * V_138 , const char * V_179 )
{
F_93 ( V_138 ) ;
F_137 ( V_138 , V_179 ) ;
...
! V_14 -> V_215 &&
F_178 ( V_10 -> V_200 -> V_226 , V_221 -> V_227 ) &&
F_179 ( V_10 -> V_200 -> V_226 , V_221 -> V_228 ) ) {
if ( V_222 & V_229 ) {
V_10 -> V_190 |= V_230 ;
...
int F_184 ( struct V_9 * V_10 )
{
bool V_236 = F_185 ( V_237 ) ;
struct V_1 * V_2 ;
int V_181 ;
if ( V_10 -> V_238 > 5 )
return - V_239 ;
...
if ( F_189 ( V_10 -> V_179 [ 0 ] ) && F_189 ( V_10 -> V_179 [ 1 ] ) &&
F_189 ( V_10 -> V_179 [ 2 ] ) && F_189 ( V_10 -> V_179 [ 3 ] ) )
return V_181 ;
if ( F_190 ( L_1 , * ( V_243 * ) ( V_10 -> V_179 + 2 ) ) < 0 )
return V_181 ;
V_236 = false ;
goto V_241;
}
...
V_244 = V_14 -> V_164 ;
F_174 () ;
V_245 = F_192 ( V_14 , F_193 ( V_14 -> V_175 ) ) ;
F_176 () ;
V_21 = F_184 ( V_10 ) ;
if ( V_21 >= 0 ) {
F_194 ( V_10 ) ;
F_195 ( V_14 , V_244 , V_10 ) ;
F_196 ( V_246 , V_245 ) ;
F_197 ( V_14 ) ;
}
return V_21 ;
}
static int F_198 ( struct V_110 * V_110 ,
struct V_55 V_56 ,
struct V_55 V_247 )
{
struct V_9 * V_10 ;
...
return F_198 ( V_110 , V_56 , V_247 ) ;
}
static int F_210 ( struct V_110 * V_110 ,
const T_2 T_1 * V_75 ,
const T_2 T_1 * V_260 )
{
struct V_55 V_56 = {
...
} while ( F_213 ( & V_13 -> V_183 , V_264 , V_261 ) != V_264 );
}
