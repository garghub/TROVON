...
struct V_3 * V_3 ;
int V_45 ;
V_45 = F_41 ( & V_34 -> V_68 , - 16 , NULL , V_74 ,
sizeof( * V_3 ) , & V_14 ) ;
if ( V_45 < 0 )
return V_45 ;
V_3 = V_14 -> V_5 ;
V_3 -> V_14 = V_14 ;
V_3 -> V_34 = V_34 ;
F_42 ( & V_3 -> V_12 , F_12 , ( unsigned long ) V_3 ) ;
F_43 ( & V_3 -> V_27 ) ;
V_3 -> V_11 = true ;
V_3 -> V_30 = F_44 ( V_29 , V_75 ) ;
if ( ! V_3 -> V_30 ) {
V_45 = - V_76 ;
goto V_77;
}
...
static void F_51 ( struct V_70 * V_34 )
{
struct V_3 * V_3 = F_52 ( & V_34 -> V_68 ) ;
int V_26 ;
T_3 V_16 ;
V_16 = F_34 ( ( ( V_67 ) V_33 << 56 ) |
V_3 -> V_62 . V_61 ) ;
...
static void F_53 ( struct V_70 * V_34 )
{
struct V_3 * V_3 = F_52 ( & V_34 -> V_68 ) ;
F_54 ( V_3 -> V_14 ) ;
F_4 ( V_3 -> V_10 ) = NULL ;
