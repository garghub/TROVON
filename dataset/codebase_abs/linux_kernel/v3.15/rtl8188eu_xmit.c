...
V_162 = V_163 -> V_182 ;
while ( ! F_44 ( V_163 , V_162 ) ) {
V_69 = F_45 ( V_162 , struct V_68 , V_183 ) ;
V_162 = V_162 -> V_182 ;
V_69 -> V_106 = 0 ;
V_69 -> V_91 = 0 ;
V_149 = F_34 ( V_69 ) + V_13 + ( V_69 -> V_91 * V_89 ) ;
if ( F_41 ( V_164 + V_149 ) > V_184 ) {
V_69 -> V_106 = 1 ;
V_69 -> V_91 = 1 ;
break;
}
...
static T_1 F_49 ( struct V_1 * V_2 , struct V_68 * V_69 )
{
T_1 V_190 = V_8 ;
V_190 = F_39 ( V_2 , V_69 -> V_173 , V_69 ) ;
if ( V_190 == V_8 )
F_25 ( V_2 , V_69 ) ;
else
F_21 ( L_7 , V_191 ) ;
...
if ( F_51 ( V_2 , V_41 ) > 0 )
goto V_195;
if ( F_52 ( V_193 , V_196 | V_197 ) == true )
goto V_195;
V_132 = F_36 ( V_4 ) ;
if ( V_132 == NULL )
goto V_195;
...
T_1 F_54 ( struct V_1 * V_2 , struct V_68 * V_201 )
{
return F_25 ( V_2 , V_201 ) ;
}
T_1 F_55 ( struct V_1 * V_2 , struct V_68 * V_69 )
{
return F_50 ( V_2 , V_69 ) ;
}
