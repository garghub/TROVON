...
{
int V_44 , V_45 ;
V_44 = F_6 ( V_16 -> V_32 . V_34 , false ) ;
V_45 = F_6 ( V_16 -> V_32 . V_36 ,
V_16 -> V_32 . V_38 ) ;
if ( V_45 < 0 || V_44 < 0 )
return - V_14 ;
return 3 + V_44 + V_45 + V_16 -> V_32 . V_39 ;
}
static int
...
if ( ! F_13 ( V_27 , 3 ) )
return - V_14 ;
memcpy ( V_16 , V_27 -> V_46 , 3 ) ;
V_30 = F_10 ( V_16 ) ;
if ( V_30 < 0 || ! F_13 ( V_27 , V_30 ) )
return - V_14 ;
V_5 += F_11 ( V_27 -> V_46 + V_5 , V_16 ) ;
if ( V_16 -> V_32 . V_39 ) {
int V_47 = V_5 + F_8 ( V_27 -> V_46 [ V_5 ] ) ;
if ( ! F_13 ( V_27 , V_47 ) )
return - V_14 ;
V_5 += F_7 ( V_27 -> V_46 + V_5 , & V_16 -> V_41 ) ;
}
F_14 ( V_27 , V_5 ) ;
return V_5 ;
}
