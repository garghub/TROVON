...
F_61 ( V_59 -> V_10 ) ) ;
F_6 ( V_59 ) ;
return F_48 ( V_10 ? F_61 ( V_10 ) : - V_43 ) ;
}
F_62 ( V_59 -> V_10 , F_7 , NULL ) ;
F_63 ( & V_59 -> V_71 ) ;
F_22 ( & V_59 -> V_91 ) ;
return V_59 ;
}
...
int F_66 ( struct V_58 * V_59 , struct V_11 * V_12 )
{
struct V_92 * V_93 ;
int V_74 ;
...
return - V_43 ;
V_93 -> V_12 = V_12 ;
V_74 = F_67 ( V_59 -> V_10 , V_12 ) ;
if ( V_74 )
goto V_95;
if ( ! F_68 ( V_59 -> V_10 , V_96 ) ) {
F_8 ( L_13 ,
F_9 ( V_12 ) ) ;
V_74 = - V_78 ;
goto V_97;
...
void F_70 ( struct V_58 * V_59 , struct V_11 * V_12 )
{
struct V_92 * V_93 ;
int V_99 = 0 ;
F_38 ( & V_59 -> V_71 ) ;
...
V_59 -> V_98 -- ;
F_41 ( & V_59 -> V_71 ) ;
return F_69 ( V_59 -> V_10 , V_12 ) ;
}
struct V_11 * * F_71 ( struct V_58 * V_59 )
{
struct V_92 * V_93 ;
struct V_11 * * V_91 ;
int V_26 = 0 ;
F_38 ( & V_59 -> V_71 ) ;
V_91 = F_72 ( V_59 -> V_98 + 1 , sizeof( * V_91 ) , V_94 ) ;
if ( ! V_91 ) {
V_91 = F_48 ( - V_43 ) ;
goto V_49;
}
