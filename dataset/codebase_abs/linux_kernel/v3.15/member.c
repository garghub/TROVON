...
V_32 = V_48 + V_47 ;
V_31 = F_15 ( V_32 * sizeof( struct V_19 ) , V_50 ) ;
if ( ! V_31 )
return - V_51 ;
V_49 = 0 ;
F_13 (memb, &ls->ls_nodes, list) {
...
struct V_9 * V_10 ;
int error ;
V_10 = F_15 ( sizeof( struct V_9 ) , V_50 ) ;
if ( ! V_10 )
return - V_51 ;
error = F_22 ( V_64 -> V_25 ) ;
if ( error < 0 ) {
F_16 ( V_10 ) ;
return error ;
}
...
static struct V_9 * F_23 ( struct V_55 * V_59 , int V_25 )
{
struct V_9 * V_10 ;
F_13 (memb, head, list) {
if ( V_10 -> V_25 == V_25 )
...
{
if ( F_23 ( & V_6 -> V_60 , V_25 ) )
return 1 ;
return 0 ;
}
int F_25 ( struct V_5 * V_6 , int V_25 )
{
if ( F_23 ( & V_6 -> V_68 , V_25 ) )
return 1 ;
return 0 ;
}
static void F_26 ( struct V_55 * V_59 )
{
struct V_9 * V_10 ;
while ( ! F_27 ( V_59 ) ) {
...
V_6 -> V_74 = V_71 ;
V_31 = F_32 ( sizeof( int ) * V_71 , V_50 ) ;
if ( ! V_31 )
return;
F_13 (memb, &ls->ls_nodes, list) {
if ( ! V_72 && ! V_10 -> V_65 )
...
return;
V_49 = V_6 -> V_67 ;
V_81 = F_15 ( V_49 * sizeof( struct V_19 ) , V_83 ) ;
if ( ! V_81 )
return;
V_22 = 0 ;
F_13 (memb, &ls->ls_nodes, list) {
...
static struct V_63 * F_41 ( struct V_85 * V_86 ,
int V_25 )
{
int V_22 ;
...
int F_42 ( struct V_5 * V_6 , struct V_85 * V_86 , int * V_89 )
{
...
V_91 ++ ;
F_44 ( & V_10 -> V_58 , & V_6 -> V_68 ) ;
V_6 -> V_67 -- ;
F_38 ( V_6 , V_10 ) ;
}
for ( V_22 = 0 ; V_22 < V_86 -> V_87 ; V_22 ++ ) {
V_64 = & V_86 -> V_88 [ V_22 ] ;
if ( F_24 ( V_6 , V_64 -> V_25 ) )
continue;
F_21 ( V_6 , V_64 ) ;
...
F_48 ( & V_6 -> V_98 ) ;
F_49 ( V_99 , & V_6 -> V_100 ) ;
V_54 = F_50 ( V_101 , & V_6 -> V_100 ) ;
V_6 -> V_102 ++ ;
F_51 ( & V_6 -> V_98 ) ;
F_52 ( & V_6 -> V_97 ) ;
if ( V_54 ) {
F_49 ( V_103 , & V_6 -> V_100 ) ;
F_53 ( V_6 -> V_104 ) ;
F_54 ( V_6 -> V_105 ,
F_55 ( V_106 , & V_6 -> V_100 ) ) ;
}
F_56 ( V_6 ) ;
F_48 ( & V_6 -> V_98 ) ;
F_16 ( V_6 -> V_24 ) ;
...
{
struct V_85 * V_86 = NULL , * V_111 ;
struct V_63 * V_88 ;
int error , V_112 ;
V_86 = F_15 ( sizeof( struct V_85 ) , V_50 ) ;
if ( ! V_86 )
return - V_51 ;
error = F_59 ( V_6 -> V_113 , & V_88 , & V_112 ) ;
if ( error < 0 )
goto V_114;
F_48 ( & V_6 -> V_98 ) ;
if ( ! F_60 ( V_6 ) ) {
