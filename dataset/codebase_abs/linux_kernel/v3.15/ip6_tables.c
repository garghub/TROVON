...
static int
F_97 ( struct V_79 * V_79 , const void T_4 * V_124 , unsigned int V_107 )
{
int V_14 ;
struct V_155 V_181 ;
struct V_74 * V_117 ;
...
static int
F_99 ( struct V_79 * V_79 , const void T_4 * V_124 , unsigned int V_107 ,
int V_178 )
{
...
static int
F_101 ( struct V_44 * V_49 , void T_4 * * V_204 ,
...
F_32 (ematch, e) {
V_14 = F_102 ( V_101 , V_204 , V_126 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_63 = V_49 -> V_63 - ( V_206 - * V_126 ) ;
V_56 = F_17 ( V_49 ) ;
V_14 = F_103 ( V_56 , V_204 , V_126 ) ;
if ( V_14 )
return V_14 ;
V_129 = V_49 -> V_129 - ( V_206 - * V_126 ) ;
if ( F_104 ( V_63 , & V_205 -> V_63 ) != 0 ||
F_104 ( V_129 , & V_205 -> V_129 ) != 0 )
return - V_171 ;
return 0 ;
}
static int
F_105 ( struct V_100 * V_131 ,
const char * V_60 ,
...
static void F_106 ( struct V_176 * V_49 )
{
struct V_48 * V_56 ;
struct V_100 * V_101 ;
F_32 (ematch, e)
...
static int
F_109 ( struct V_176 * V_49 , void * * V_204 ,
...
* V_126 += sizeof( struct V_44 ) - sizeof( struct V_176 ) ;
F_32 (ematch, e) {
V_14 = F_110 ( V_101 , V_204 , V_126 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_210 -> V_63 = V_49 -> V_63 - ( V_206 - * V_126 ) ;
V_56 = F_107 ( V_49 ) ;
F_111 ( V_56 , V_204 , V_126 ) ;
...
static int
F_114 ( struct V_79 * V_79 , void T_4 * V_124 , unsigned int V_107 )
{
int V_14 ;
struct V_218 V_181 ;
struct V_74 * V_117 ;
...
V_14 = F_113 ( V_79 , V_181 . V_60 , V_181 . V_99 ,
...
static int
F_117 ( struct V_219 * V_220 , int V_221 , void T_4 * V_124 ,
unsigned int V_107 )
{
int V_14 ;
if ( ! F_118 ( F_119 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_225 :
V_14 = F_114 ( F_119 ( V_220 ) , V_124 , V_107 ) ;
break;
case V_226 :
V_14 = F_99 ( F_119 ( V_220 ) , V_124 , V_107 , 1 ) ;
break;
default:
F_11 ( L_52 , V_221 ) ;
V_14 = - V_135 ;
...
static int
F_120 ( unsigned int V_166 , struct V_1 * V_86 ,
void T_4 * V_167 )
{
struct V_153 * V_106 ;
const struct V_74 * V_75 = V_86 -> V_75 ;
...
static int
F_121 ( struct V_79 * V_79 , struct V_227 T_4 * V_184 ,
int * V_107 )
{
int V_14 ;
struct V_227 V_185 ;
...
switch ( V_221 ) {
case V_228 :
V_14 = F_82 ( F_119 ( V_220 ) , V_124 , V_107 , 1 ) ;
break;
case V_229 :
V_14 = F_121 ( F_119 ( V_220 ) , V_124 , V_107 ) ;
break;
default:
V_14 = F_123 ( V_220 , V_221 , V_124 , V_107 ) ;
}
return V_14 ;
}
static int
F_124 ( struct V_219 * V_220 , int V_221 , void T_4 * V_124 , unsigned int V_107 )
{
int V_14 ;
if ( ! F_118 ( F_119 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_225 :
V_14 = F_97 ( F_119 ( V_220 ) , V_124 , V_107 ) ;
break;
case V_226 :
V_14 = F_99 ( F_119 ( V_220 ) , V_124 , V_107 , 0 ) ;
break;
default:
F_11 ( L_52 , V_221 ) ;
V_14 = - V_135 ;
...
static int
F_123 ( struct V_219 * V_220 , int V_221 , void T_4 * V_124 , int * V_107 )
{
int V_14 ;
if ( ! F_118 ( F_119 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_228 :
V_14 = F_82 ( F_119 ( V_220 ) , V_124 , V_107 , 0 ) ;
break;
case V_229 :
V_14 = F_92 ( F_119 ( V_220 ) , V_124 , V_107 ) ;
break;
case V_230 :
case V_231 : {
struct V_232 V_233 ;
...
if ( V_14 != 0 )
goto V_236;
V_235 = F_127 ( V_79 , V_86 , & V_234 , V_117 ) ;
if ( F_49 ( V_235 ) ) {
V_14 = F_50 ( V_235 ) ;
goto V_236;
}
...
void F_128 ( struct V_79 * V_79 , struct V_1 * V_86 )
{
struct V_74 * V_75 ;
void * V_170 ;
...
static inline bool
F_130 ( T_7 V_239 , T_7 V_240 , T_7 V_241 ,
T_7 type , T_7 V_242 ,
bool V_243 )
{
...
if ( V_41 -> V_12 != 0 )
return false ;
V_245 = F_132 ( V_6 , V_41 -> V_102 , sizeof( V_246 ) , & V_246 ) ;
if ( V_245 == NULL ) {
F_11 ( L_58 ) ;
V_41 -> V_13 = true ;
return false ;
}
return F_130 ( V_248 -> type ,
V_248 -> V_242 [ 0 ] ,
V_248 -> V_242 [ 1 ] ,
V_245 -> V_249 , V_245 -> V_250 ,
! ! ( V_248 -> V_28 & V_251 ) ) ;
}
static int F_133 ( const struct V_137 * V_41 )
{
const struct V_247 * V_248 = V_41 -> V_105 ;
...
if ( V_14 < 0 )
goto V_253;
V_14 = F_140 ( V_254 , F_141 ( V_254 ) ) ;
if ( V_14 < 0 )
goto V_255;
V_14 = F_142 ( V_256 , F_141 ( V_256 ) ) ;
if ( V_14 < 0 )
goto V_257;
V_14 = F_143 ( & V_258 ) ;
if ( V_14 < 0 )
...
return 0 ;
V_259:
F_145 ( V_256 , F_141 ( V_256 ) ) ;
V_257:
F_146 ( V_254 , F_141 ( V_254 ) ) ;
V_255:
F_147 ( & V_252 ) ;
V_253:
return V_14 ;
