...
V_9 -> V_10 = 8191 ;
F_10 ( V_9 ) ;
F_46 ( ( unsigned long ) V_9 -> V_80 . V_81 ) ;
V_40 = F_17 ( V_9 -> V_33 + V_50 ) ;
V_40 &= ~ V_64 -> V_94 ;
V_40 |= V_64 -> V_95 ;
V_40 &= ~ V_96 ;
...
int T_5 F_55 ( const struct V_100 * V_65 , T_2 V_101 , T_2 V_102 )
{
struct V_8 * V_9 = V_65 -> V_22 ;
if ( V_9 && V_9 -> V_85 )
return V_9 -> V_85 ( V_65 , V_101 , V_102 ) ;
return - 1 ;
}
int F_56 ( struct V_100 * V_65 )
{
return 0 ;
}
