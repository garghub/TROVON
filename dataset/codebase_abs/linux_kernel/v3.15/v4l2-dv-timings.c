...
V_73 = ( V_73 + V_98 / 2 ) & ~ ( V_98 - 1 ) ;
if ( V_93 )
V_89 = ( ( V_73 * V_99 * V_65 ) -
( V_73 * V_100 * 1000 ) +
( V_65 * ( 100 - V_99 ) + V_100 * 1000 ) / 2 ) /
( V_65 * ( 100 - V_99 ) + V_100 * 1000 ) ;
else
V_89 = ( ( V_73 * V_101 * V_65 ) -
( V_73 * V_102 * 1000 ) +
( V_65 * ( 100 - V_101 ) + V_102 * 1000 ) / 2 ) /
( V_65 * ( 100 - V_101 ) + V_102 * 1000 ) ;
V_89 = V_89 - V_89 % ( 2 * V_98 ) ;
V_71 = V_73 + V_89 ;
V_75 = ( V_73 + V_89 ) * V_65 ;
