...
V_80 &= ~ V_85 ;
F_2 ( V_80 , F_3 ( V_2 ) ) ;
F_48 ( V_74 -> V_82 -> V_9 , V_77 , V_51 , V_70 ) ;
return V_24 ;
}
...
static void F_52 ( struct V_1 * V_2 , int V_93 , int V_92 )
{
int V_55 , V_94 ;
unsigned long * V_68 = ( unsigned long * ) & V_2 -> V_62 [ V_92 ] ;
V_94 = ( V_93 + 3 ) / 4 ;
if ( V_2 -> V_16 && V_93 >= 32 &&
F_40 ( V_2 , V_68 , V_93 , V_37 ) > 0 )
goto V_95;
...
V_95:
for ( V_55 = 0 ; V_55 < V_94 ; V_55 ++ )
V_68 [ V_55 ] = F_53 ( V_68 [ V_55 ] ) ;
}
static enum V_52 F_54
...
V_99 [ V_55 ] = F_30 ( F_55 ( V_2 ) ) ;
V_99 [ V_55 ] = F_53 ( V_99 [ V_55 ] ) ;
}
}
return V_98 ;
}
static void F_56 ( struct V_1 * V_2 , int V_93 ,
unsigned int V_92 )
{
int V_55 , V_94 ;
unsigned long * V_68 = ( unsigned long * ) & V_2 -> V_62 [ V_92 ] ;
...
for ( V_55 = 0 ; V_55 < V_94 ; V_55 ++ ) {
F_32 ( V_2 ) ;
F_2 ( F_57 ( V_68 [ V_55 ] ) , F_22 ( V_2 ) ) ;
}
}
static void F_58 ( struct V_1 * V_2 , int V_93 ,
unsigned int V_92 )
{
int V_55 , V_94 ;
unsigned long * V_68 = ( unsigned long * ) & V_2 -> V_62 [ V_92 ] ;
V_94 = ( V_93 + 3 ) / 4 ;
for ( V_55 = 0 ; V_55 < V_94 ; V_55 ++ )
V_68 [ V_55 ] = F_57 ( V_68 [ V_55 ] ) ;
if ( V_2 -> V_17 && V_93 >= 32 &&
F_40 ( V_2 , V_68 , V_93 , V_32 ) > 0 )
return;
for ( V_55 = 0 ; V_55 < V_94 ; V_55 ++ ) {
F_39 ( V_2 ) ;
F_2 ( V_68 [ V_55 ] , F_55 ( V_2 ) ) ;
}
}
static void F_59 ( struct V_38 * V_39 , T_1 V_100 , T_1 V_101 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
...
static int F_64 ( struct V_38 * V_39 , struct V_125 * V_43 ,
...
static void F_65 ( struct V_38 * V_39 , int V_41 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
int V_97 , V_133 ;
enum V_52 V_134 ;
...
static void F_67 ( struct V_38 * V_39 , int V_41 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
...
( V_118 << 8 ) | V_117 ) ;
F_1 ( V_2 ) ;
F_2 ( F_30 ( F_60 ( V_2 ) ) | V_136 , F_60 ( V_2 ) ) ;
F_2 ( F_30 ( F_61 ( V_2 ) ) | V_133 , F_61 ( V_2 ) ) ;
F_2 ( V_41 << 2 , F_28 ( V_2 ) ) ;
F_4 ( V_2 ) ;
for ( V_97 = 0 ; V_97 < V_133 ; V_97 ++ ) {
F_56 ( V_2 , 512 , 512 * V_97 ) ;
F_58 ( V_2 , 16 , V_39 -> V_129 + 16 * V_97 ) ;
}
F_9 ( V_2 ) ;
F_2 ( F_30 ( F_60 ( V_2 ) ) & ~ V_136 , F_60 ( V_2 ) ) ;
}
...
static void F_70 ( struct V_38 * V_39 , unsigned int V_142 ,
int V_40 , int V_41 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
T_1 V_143 = 0 ;
...
if ( V_2 -> V_46 )
F_59 ( V_39 , V_142 , ( V_135 << 8 )
| V_142 ) ;
else
F_59 ( V_39 , V_142 , V_142 ) ;
F_25 ( V_39 , 0 , V_41 ) ;
...
F_25 ( V_39 , V_40 , 0 ) ;
V_2 -> V_144 = 8 ;
F_2 ( V_2 -> V_144 , F_31 ( V_2 ) ) ;
F_1 ( V_2 ) ;
F_4 ( V_2 ) ;
F_52 ( V_2 , V_2 -> V_144 , 0 ) ;
F_9 ( V_2 ) ;
break;
case V_110 :
V_2 -> V_149 = V_41 ;
...
F_59 ( V_39 , V_142 , ( V_142 << 8 ) | V_117 ) ;
F_25 ( V_39 , V_2 -> V_151 , V_2 -> V_141 ) ;
...
static void F_74 ( struct V_38 * V_39 , int V_155 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
int V_24 ;
switch ( V_155 ) {
...
static void F_79 ( struct V_38 * V_39 , const T_4 * V_68 , int V_51 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
memcpy ( & V_2 -> V_62 [ V_2 -> V_65 ] , V_68 , V_51 ) ;
V_2 -> V_65 += V_51 ;
}
static T_4 F_80 ( struct V_38 * V_39 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
T_4 V_58 ;
...
static T_6 F_81 ( struct V_38 * V_39 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
...
static void F_82 ( struct V_38 * V_39 , T_4 * V_68 , int V_51 )
{
struct V_1 * V_2 = F_26 ( V_39 ) ;
...
V_43 -> V_166 . V_173 = 10 ;
V_43 -> V_166 . V_174 = 4 ;
V_43 -> V_166 . V_175 = F_63 ;
V_43 -> V_166 . V_176 = F_64 ;
...
static T_7 F_84 ( int V_181 , void * V_182 )
{
...
static struct V_22 * F_85 ( struct V_82 * V_9 )
{
...
int V_181 ;
struct V_198 V_199 = {} ;
V_2 = F_87 ( & V_8 -> V_9 , sizeof( struct V_1 ) , V_192 ) ;
if ( ! V_2 )
return - V_200 ;
V_98 = F_90 ( V_8 , V_201 , 0 ) ;
V_2 -> V_80 = F_91 ( & V_8 -> V_9 , V_98 ) ;
if ( F_92 ( V_2 -> V_80 ) )
return F_93 ( V_2 -> V_80 ) ;
V_181 = F_94 ( V_8 , 0 ) ;
if ( V_181 < 0 ) {
F_8 ( & V_8 -> V_9 , L_14 ) ;
return - V_202 ;
}
V_24 = F_95 ( & V_8 -> V_9 , V_181 , F_84 , V_203 ,
L_15 , V_2 ) ;
if ( V_24 ) {
F_8 ( & V_8 -> V_9 , L_16 ) ;
return V_24 ;
...
V_2 -> V_3 = V_2 -> V_146 ? ( V_205 | V_206 ) : V_205 ;
V_197 -> V_207 = 20 ;
V_197 -> V_208 = F_80 ;
V_197 -> V_132 = F_79 ;
V_197 -> V_128 = F_82 ;
...
if ( V_24 )
goto V_212;
V_199 . V_190 = V_8 -> V_9 . V_190 ;
V_24 = F_101 ( V_196 , NULL , & V_199 , V_23 -> V_213 ,
V_23 -> V_214 ) ;
return 0 ;
V_212:
F_14 ( V_2 ) ;
...
static int F_103 ( struct V_21 * V_8 )
{
struct V_1 * V_2 = F_104 ( V_8 ) ;
F_14 ( V_2 ) ;
F_105 ( & V_2 -> V_39 ) ;
F_102 ( & V_8 -> V_9 ) ;
return 0 ;
