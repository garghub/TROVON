...
F_63 ( & V_92 -> V_90 , F_55 , NULL , NULL ) ;
V_92 -> V_15 = V_15 ;
F_64 ( V_15 -> V_101 , & V_92 -> V_90 ) ;
}
static void F_65 ( struct V_14 * V_15 , int V_102 )
{
struct V_20 * V_59 ;
struct V_96 * V_97 = V_15 -> V_97 ;
unsigned long V_18 ;
...
V_51 -> V_58 ) ;
for ( V_103 = 0 ; V_103 < V_51 -> V_63 ; ++ V_103 ) {
F_66 ( V_107 L_6 ,
V_51 -> V_61 [ V_103 ] -> V_106 ) ;
}
if ( V_59 -> V_84 == V_51 )
F_66 ( V_107 L_7 ,
V_59 -> V_85 - V_51 -> V_5 ) ;
...
V_13 -> V_73 [ V_9 ] -> V_5 ,
V_13 -> V_73 [ V_9 ] -> V_54 ) ;
for ( V_103 = 0 ; V_103 < V_13 -> V_73 [ V_9 ] -> V_63 ; ++ V_103 ) {
F_66 ( V_107 L_6 ,
V_13 -> V_73 [ V_9 ] -> V_61 [ V_103 ] -> V_106 ) ;
}
}
F_66 ( V_107 L_8 ) ;
...
V_11 = F_8 ( V_108 ) ;
F_54 ( V_108 ) ;
if ( F_16 ( V_36 , V_5 , & V_109 , V_7 , V_11 ) ) {
F_20 ( V_36 ) ;
return F_68 ( - V_111 ) ;
}
F_28 ( V_2 -> V_15 ) ;
