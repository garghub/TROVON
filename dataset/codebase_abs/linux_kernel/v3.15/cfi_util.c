...
void F_16 ( struct V_25 * V_26 , struct F_16 * V_27 )
{
struct V_1 * V_2 = V_26 -> V_28 ;
struct V_4 * V_5 = V_2 -> V_18 ;
struct F_16 * V_29 ;
for ( V_29 = V_27 ; V_29 -> V_30 ; V_29 ++ ) {
if ( ( ( V_29 -> V_11 == V_31 ) || ( V_29 -> V_11 == V_5 -> V_11 ) ) &&
( ( V_29 -> V_13 == V_32 ) || ( V_29 -> V_13 == V_5 -> V_13 ) ) ) {
V_29 -> V_30 ( V_26 ) ;
}
}
}
int F_17 ( struct V_25 * V_26 , T_6 V_33 ,
T_7 V_34 , T_8 V_35 , void * V_36 )
{
struct V_1 * V_2 = V_26 -> V_28 ;
struct V_4 * V_5 = V_2 -> V_18 ;
unsigned long V_15 ;
...
V_20 = 0 ;
while ( V_20 < V_26 -> V_43 && V_34 >= V_41 [ V_20 ] . V_44 )
V_20 ++ ;
V_20 -- ;
if ( V_34 & ( V_41 [ V_20 ] . V_45 - 1 ) )
return - V_46 ;
V_39 = V_20 ;
while ( V_20 < V_26 -> V_43 && ( V_34 + V_35 ) >= V_41 [ V_20 ] . V_44 )
V_20 ++ ;
V_20 -- ;
if ( ( V_34 + V_35 ) & ( V_41 [ V_20 ] . V_45 - 1 ) )
return - V_46 ;
V_37 = V_34 >> V_5 -> V_47 ;
V_15 = V_34 - ( V_37 << V_5 -> V_47 ) ;
V_20 = V_39 ;
while( V_35 ) {
int V_16 = V_41 [ V_20 ] . V_45 ;
V_38 = (* V_33)( V_2 , & V_5 -> V_48 [ V_37 ] , V_15 , V_16 , V_36 ) ;
if ( V_38 )
return V_38 ;
V_15 += V_16 ;
V_34 += V_16 ;
V_35 -= V_16 ;
if ( V_34 == V_41 [ V_20 ] . V_44 + V_16 * V_41 [ V_20 ] . V_49 )
V_20 ++ ;
if ( V_15 >> V_5 -> V_47 ) {
V_15 = 0 ;
V_37 ++ ;
