...
{
struct V_8 * V_17 = V_2 -> V_9 ;
F_10 ( V_17 , V_3 , V_4 ) ;
F_7 ( V_2 , V_14 , V_15 , ( L_3 , V_3 , V_4 ) ) ;
}
void F_11 ( struct V_1 * V_2 , T_1 V_3 , T_1 V_18 , T_1 V_4 )
{
struct V_8 * V_8 = V_2 -> V_9 ;
F_12 ( V_8 , V_3 , V_18 , V_4 ) ;
F_4 ( 1 ) ;
F_7 ( V_2 , V_14 , V_15 ,
( L_4 ,
V_3 , V_4 ) ) ;
...
( L_5 ,
V_3 , V_18 , V_4 ) ) ;
F_14 ( V_2 -> V_9 , V_3 , V_18 , V_4 ) ;
}
}
void F_15 ( struct V_1 * V_2 , T_1 V_3 , T_1 V_18 , T_1 V_4 )
{
struct V_8 * V_8 = V_2 -> V_9 ;
if ( V_3 == 0xfe ) {
F_2 ( 50 ) ;
