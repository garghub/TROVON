...
int V_3 ;
T_1 V_34 [ 3 ] = { 0 , } ;
V_2 = F_51 ( & V_16 -> V_33 , sizeof( struct V_1 ) , V_54 ) ;
if ( ! V_2 ) {
F_39 ( & V_16 -> V_33 , L_6 ) ;
return - V_55 ;
}
...
V_2 -> V_32 = F_54 ( V_2 -> V_33 , L_8 , V_2 -> V_33 , V_2 ,
& V_57 ) ;
if ( F_55 ( V_2 -> V_32 ) ) {
F_39 ( V_2 -> V_33 , L_9 ) ;
return F_56 ( V_2 -> V_32 ) ;
}
V_2 -> V_20 = F_57 ( V_2 -> V_33 , L_10 ,
V_2 -> V_33 , V_2 , & V_58 , NULL ) ;
if ( F_55 ( V_2 -> V_20 ) ) {
F_39 ( V_2 -> V_33 , L_11 ) ;
return F_56 ( V_2 -> V_20 ) ;
}
...
static int F_60 ( struct V_51 * V_16 )
{
struct V_1 * V_2 = F_48 ( & V_16 -> V_33 ) ;
F_24 ( V_2 ) ;
F_5 ( V_2 -> V_6 -> V_59 ) ;
...
static int F_61 ( struct V_51 * V_16 )
{
struct V_1 * V_2 = F_48 ( & V_16 -> V_33 ) ;
F_25 ( V_2 ) ;
F_5 ( V_2 -> V_6 -> V_11 ) ;
