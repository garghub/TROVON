...
V_4 = F_29 ( sizeof( struct V_1 ) + V_14 -> V_58 -> V_148 ,
V_30 ) ;
if ( ! V_4 )
return - V_31 ;
V_4 -> V_3 = V_6 ;
V_4 -> V_14 = V_14 ;
F_92 ( & V_4 -> V_112 ) ;
V_4 -> V_13 . V_149 = V_6 -> V_149 ;
V_29 = F_135 ( V_6 , V_3 -> V_149 ) ;
if ( V_29 ) {
F_104 ( V_3 , L_16 , V_29 ) ;
goto V_150;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_49 -> V_159 . V_162 = V_4 -> V_16 . V_15 ;
return 0 ;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_4 -> V_16 . V_15 = V_49 -> V_159 . V_162 ;
F_12 ( V_4 ) ;
F_165 ( V_4 -> V_14 ) ;
return 0 ;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_49 -> V_159 . V_162 = V_4 -> V_16 . V_17 ;
return 0 ;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_4 -> V_16 . V_17 = V_49 -> V_159 . V_162 ;
F_12 ( V_4 ) ;
F_165 ( V_4 -> V_14 ) ;
return 0 ;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
T_3 V_120 = V_49 -> V_159 . V_161 ;
if ( V_4 -> V_111 == V_120 )
return 0 ;
if ( V_120 >= V_14 -> V_3 -> V_164 )
return - V_62 ;
...
void * V_167 )
{
F_173 ( & V_166 -> V_168 , & V_169 ) ;
}
static void F_174 ( struct V_2 * V_3 )
{
F_173 ( & V_3 -> V_170 , & V_171 ) ;
...
F_76 ( V_14 ) ;
F_82 ( V_14 ) ;
V_29 = F_33 ( V_14 , V_177 , F_181 ( V_177 ) ) ;
if ( V_29 )
goto V_178;
F_182 ( V_3 ) ;
F_174 ( V_3 ) ;
...
V_179 = F_95 ( V_14 , V_68 ) ;
if ( ! V_179 )
V_179 = V_14 -> V_73 . V_74 ( V_14 , V_68 ) ;
if ( V_179 ) {
struct V_96 * V_97 ;
V_97 = F_87 ( V_14 -> V_97 ) ;
F_88 ( & V_97 -> V_98 ) ;
...
F_90 ( V_14 -> V_97 -> V_182 ) ;
}
return V_183 ;
}
static T_3 F_190 ( struct V_2 * V_3 , struct V_67 * V_68 ,
void * V_184 , T_7 V_185 )
{
T_3 V_166 = F_191 ( V_68 ) ? F_192 ( V_68 ) : 0 ;
F_193 ( V_68 ) -> V_186 = V_68 -> V_114 ;
if ( F_194 ( V_166 >= V_3 -> V_164 ) ) {
do {
V_166 -= V_3 -> V_164 ;
} while ( V_166 >= V_3 -> V_164 );
}
return V_166 ;
}
static void F_195 ( struct V_2 * V_3 , int V_187 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_188 ;
...
if ( V_187 & V_189 ) {
V_188 = V_3 -> V_129 & V_189 ? 1 : - 1 ;
F_197 ( V_4 -> V_3 , V_188 ) ;
}
if ( V_187 & V_190 ) {
V_188 = V_3 -> V_129 & V_190 ? 1 : - 1 ;
F_198 ( V_4 -> V_3 , V_188 ) ;
}
}
F_199 () ;
...
static int F_203 ( struct V_2 * V_3 , void * V_191 )
{
struct V_8 * V_9 = V_191 ;
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
if ( V_3 -> type == V_192 && ! F_204 ( V_9 -> V_10 ) )
return - V_193 ;
memcpy ( V_3 -> V_7 , V_9 -> V_10 , V_3 -> V_11 ) ;
F_196 () ;
F_96 (port, &team->port_list, list)
if ( V_14 -> V_73 . V_194 )
V_14 -> V_73 . V_194 ( V_14 , V_4 ) ;
F_199 () ;
return 0 ;
}
static int F_205 ( struct V_2 * V_3 , int V_195 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_29 ;
...
F_135 ( V_4 -> V_3 , V_3 -> V_149 ) ;
V_14 -> V_196 = false ;
F_122 ( & V_14 -> V_134 ) ;
return V_29 ;
}
static struct V_198 *
F_207 ( struct V_2 * V_3 , struct V_198 * V_199 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_96 * V_191 ;
T_8 V_99 , V_100 , V_104 , V_180 , V_181 ;
T_4 V_105 = 0 , V_182 = 0 ;
unsigned int V_200 ;
int V_28 ;
F_208 (i) {
V_191 = F_209 ( V_14 -> V_97 , V_28 ) ;
do {
V_200 = F_210 ( & V_191 -> V_98 ) ;
V_99 = V_191 -> V_99 ;
V_100 = V_191 -> V_100 ;
V_104 = V_191 -> V_104 ;
V_180 = V_191 -> V_180 ;
V_181 = V_191 -> V_181 ;
} while ( F_211 ( & V_191 -> V_98 , V_200 ) );
V_199 -> V_99 += V_99 ;
V_199 -> V_100 += V_100 ;
V_199 -> V_201 += V_104 ;
V_199 -> V_180 += V_180 ;
...
static int F_212 ( struct V_2 * V_3 , T_9 V_202 , T_3 V_203 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_29 ;
F_121 ( & V_14 -> V_134 ) ;
F_14 (port, &team->port_list, list) {
V_29 = F_213 ( V_4 -> V_3 , V_202 , V_203 ) ;
if ( V_29 )
goto V_197;
}
F_122 ( & V_14 -> V_134 ) ;
...
V_197:
F_206 (port, &team->port_list, list)
F_214 ( V_4 -> V_3 , V_202 , V_203 ) ;
F_122 ( & V_14 -> V_134 ) ;
return V_29 ;
}
static int F_215 ( struct V_2 * V_3 , T_9 V_202 , T_3 V_203 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
F_196 () ;
...
struct V_241 * V_242 [] , struct V_241 * V_159 [] )
{
int V_29 ;
if ( V_242 [ V_243 ] == NULL )
F_235 ( V_3 ) ;
...
static int F_237 ( struct V_241 * V_242 [] , struct V_241 * V_159 [] )
{
if ( V_242 [ V_243 ] ) {
...
goto V_264;
if ( F_258 ( V_68 , V_270 , V_49 . V_159 . V_161 ) )
goto V_264;
break;
case V_271 :
...
goto V_264;
if ( F_260 ( V_68 , V_270 , V_49 . V_159 . V_275 . V_101 ,
V_49 . V_159 . V_275 . V_276 ) )
goto V_264;
break;
case V_277 :
...
goto V_264;
if ( F_262 ( V_68 , V_270 , V_49 . V_159 . V_163 ) )
goto V_264;
break;
default:
F_263 () ;
...
if ( V_29 )
return V_29 ;
V_249 = F_244 ( V_68 , V_260 , V_285 , & V_253 , V_129 | V_292 ,
V_293 ) ;
if ( ! V_249 )
return - V_255 ;
...
goto V_291;
V_297:
V_288 = F_271 ( V_68 , V_260 , V_285 , V_298 , 0 , V_129 | V_292 ) ;
if ( ! V_288 ) {
V_29 = F_266 ( & V_68 , V_14 , V_260 , V_283 ) ;
if ( V_29 )
goto V_296;
...
V_49 . V_159 . V_160 = F_239 ( V_306 ) ;
break;
case V_273 :
V_49 . V_159 . V_275 . V_101 = F_238 ( V_306 ) ;
V_49 . V_159 . V_275 . V_276 = F_239 ( V_306 ) ;
break;
case V_277 :
V_49 . V_159 . V_162 = V_306 ? true : false ;
break;
case V_279 :
V_49 . V_159 . V_163 = F_280 ( V_306 ) ;
break;
default:
F_263 () ;
}
...
static int F_300 ( struct V_336 * V_167 ,
