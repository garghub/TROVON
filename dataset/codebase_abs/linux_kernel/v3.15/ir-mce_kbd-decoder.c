...
if ( ! F_10 ( V_36 . V_43 , V_44 , V_44 / 2 ) )
goto V_45;
V_46:
F_2 ( 2 , L_7 ,
V_1 -> V_41 , F_11 ( V_36 . V_43 ) , F_12 ( V_36 . V_47 ) ) ;
if ( ! F_10 ( V_36 . V_43 , V_44 , V_44 / 2 ) )
return 0 ;
switch ( V_1 -> V_41 ) {
case V_42 :
...
switch ( V_1 -> V_56 ) {
case V_57 :
V_18 = V_1 -> V_59 & 0xffff ;
F_2 ( 1 , L_9 , V_1 -> V_59 ) ;
if ( V_34 -> V_63 )
V_38 = F_16 ( V_34 -> V_63 / 1000 ) ;
else
V_38 = F_17 ( 100 ) ;
F_18 ( & V_1 -> V_64 , V_65 + V_38 ) ;
F_4 ( V_1 -> V_8 , V_18 ) ;
break;
case V_58 :
V_18 = V_1 -> V_59 & 0x1fffff ;
F_2 ( 1 , L_10 , V_18 ) ;
F_5 ( V_1 -> V_8 , V_18 ) ;
break;
default:
...
if ( ! V_8 )
return - V_68 ;
snprintf ( V_3 -> V_69 , sizeof( V_3 -> V_69 ) ,
L_12 , V_34 -> V_70 ) ;
F_22 ( V_3 -> V_71 , L_13 , sizeof( V_3 -> V_71 ) ) ;
V_8 -> V_69 = V_3 -> V_69 ;
V_8 -> V_71 = V_3 -> V_71 ;
F_23 ( V_72 , V_8 -> V_73 ) ;
F_23 ( V_74 , V_8 -> V_73 ) ;
for ( V_4 = 0 ; V_4 < sizeof( V_6 ) ; V_4 ++ )
F_23 ( V_6 [ V_4 ] , V_8 -> V_75 ) ;
F_23 ( V_76 , V_8 -> V_73 ) ;
F_23 ( V_29 , V_8 -> V_77 ) ;
F_23 ( V_30 , V_8 -> V_77 ) ;
F_23 ( V_31 , V_8 -> V_75 ) ;
