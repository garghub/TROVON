...
struct V_93 * V_9 = F_21 ( V_5 -> V_9 ) ;
T_1 V_94 ;
int V_26 ;
V_94 = V_58 ( V_5 -> V_9 ) -> V_95 ;
if ( F_44 ( V_9 ) ) {
if ( V_5 -> V_96 . V_97 == V_98 ||
! F_45 ( V_71 -> V_99 , F_46 ( V_94 ) ) )
V_94 = 32 ;
V_26 = F_47 ( V_71 -> V_99 , F_46 ( V_94 ) ) ;
if ( V_26 )
return V_26 ;
V_26 = F_48 ( V_71 -> V_99 ,
F_46 ( V_94 ) ) ;
...
V_5 -> V_103 . V_104 = V_7 ( V_5 -> V_9 ) -> V_17 -> V_82 ;
V_5 -> V_103 . V_104 -= F_51 ( V_5 -> V_9 ) -> V_105 ;
V_26 = F_52 ( & V_5 -> V_74 . V_6 , V_106 ,
V_5 -> V_103 . V_104 >> V_32 ) ;
if ( V_26 ) {
F_50 ( V_5 , L_7 , V_26 ) ;
return V_26 ;
}
V_5 -> V_74 . V_107 = F_53 ( F_54 ( V_9 , 1 ) ,
F_55 ( V_9 , 1 ) ) ;
if ( V_5 -> V_96 . V_97 != V_98 ) {
V_5 -> V_103 . V_108 = V_58 ( V_5 -> V_9 ) -> V_109 ;
} else {
V_5 -> V_103 . V_108 = V_5 -> V_96 . V_82 ;
}
V_26 = F_52 ( & V_5 -> V_74 . V_6 , V_110 ,
...
{
F_10 ( & V_5 -> V_71 -> V_111 ) ;
F_58 ( & V_5 -> V_74 . V_6 , V_106 ) ;
F_58 ( & V_5 -> V_74 . V_6 , V_110 ) ;
F_14 ( & V_5 -> V_71 -> V_111 ) ;
F_59 ( & V_5 -> V_74 . V_6 ) ;
F_42 ( V_5 ) ;
F_60 ( V_5 -> V_74 . V_107 ) ;
