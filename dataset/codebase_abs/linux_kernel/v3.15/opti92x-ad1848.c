...
static int F_53 ( struct V_105 * V_74 , struct V_46 * * V_106 )
{
struct V_46 * V_47 ;
int V_52 ;
V_52 = F_54 ( V_74 , V_57 , V_78 , V_107 ,
...
static int F_55 ( struct V_105 * V_109 ,
unsigned int V_110 )
{
#ifdef F_4
if ( V_111 )
...
static int F_56 ( struct V_105 * V_109 ,
unsigned int V_110 )
{
struct V_46 * V_47 ;
int error ;
...
static int F_62 ( struct V_105 * V_109 ,
unsigned int V_110 )
{
F_60 ( F_63 ( V_109 ) ) ;
return 0 ;
...
static int F_67 ( struct V_105 * V_110 , unsigned int V_123 ,
T_2 V_124 )
{
return F_64 ( F_63 ( V_110 ) ) ;
}
static int F_68 ( struct V_105 * V_110 , unsigned int V_123 )
{
return F_66 ( F_63 ( V_110 ) ) ;
}
static int F_69 ( struct V_70 * V_125 ,
const struct V_71 * V_72 )
{
struct V_46 * V_47 ;
int error , V_126 ;
...
if ( ! V_9 )
return - V_23 ;
error = F_53 ( & V_125 -> V_47 -> V_110 , & V_47 ) ;
if ( error < 0 )
return error ;
V_2 = V_47 -> V_81 ;
...
static void F_71 ( struct V_70 * V_125 )
{
F_60 ( F_72 ( V_125 ) ) ;
F_70 ( V_125 , NULL ) ;
V_111 = 0 ;
}
static int F_73 ( struct V_70 * V_125 ,
T_2 V_124 )
{
return F_64 ( F_72 ( V_125 ) ) ;
}
static int F_74 ( struct V_70 * V_125 )
{
return F_66 ( F_72 ( V_125 ) ) ;
}
