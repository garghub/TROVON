...
int V_11 = 0 ;
V_141 = F_96 ( F_97 ( V_142 ) , V_44 ) ;
if ( ! V_141 ) {
F_29 ( V_44 , L_21 ) ;
V_11 = - V_84 ;
goto V_11;
}
V_11 = F_98 ( V_138 , 0 , V_136 ) ;
if ( V_11 < 0 ) {
F_29 ( V_44 , L_22 ) ;
V_11 = - V_84 ;
goto V_11;
...
T_1 V_152 ;
V_2 = F_102 ( V_44 , sizeof( struct V_1 ) , V_153 ) ;
if ( V_2 == NULL ) {
F_29 ( V_44 , L_26 ) ;
goto V_154;
}
...
F_103 ( V_144 , V_2 ) ;
F_104 ( & V_2 -> V_108 ) ;
F_105 ( & V_2 -> V_109 , V_155 ) ;
V_11 = ( V_44 -> V_139 ) ? F_95 ( V_2 , V_44 , & V_136 ) :
F_99 ( V_2 , V_144 , & V_136 ) ;
if ( V_11 )
goto V_156;
V_2 -> V_4 = F_106 ( V_44 , & V_136 ) ;
if ( F_107 ( V_2 -> V_4 ) ) {
V_11 = F_108 ( V_2 -> V_4 ) ;
goto V_156;
}
...
static int F_124 ( struct V_143 * V_144 )
{
struct V_1 * V_2 = F_125 ( V_144 ) ;
int V_13 , V_151 ;
if ( ! V_2 )
return - V_118 ;
F_117 ( & V_37 ) ;
...
static int F_128 ( struct V_134 * V_44 )
{
F_88 ( V_44 ) ;
return 0 ;
}
