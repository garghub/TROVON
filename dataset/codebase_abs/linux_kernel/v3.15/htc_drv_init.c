...
V_12 -> V_178 = 4 ;
V_12 -> V_179 = 1 ;
V_12 -> V_180 = sizeof( struct V_181 ) ;
V_12 -> V_182 = sizeof( struct V_183 ) ;
V_12 -> V_184 = sizeof( struct V_185 ) +
sizeof( struct V_186 ) + 4 ;
if ( V_2 -> V_10 -> V_187 . V_188 & V_189 )
V_12 -> V_13 -> V_190 [ V_191 ] =
& V_55 -> V_192 [ V_191 ] ;
if ( V_2 -> V_10 -> V_187 . V_188 & V_193 )
V_12 -> V_13 -> V_190 [ V_194 ] =
& V_55 -> V_192 [ V_194 ] ;
F_73 ( V_10 ) ;
V_153 = F_74 ( V_2 ) ;
if ( V_153 ) {
V_12 -> V_13 -> V_195 = V_153 -> V_196 ;
V_12 -> V_13 -> V_197 = V_153 -> V_198 ;
}
F_75 ( V_12 , V_55 -> V_199 ) ;
}
...
if ( V_26 )
return - V_98 ;
V_2 -> V_203 = F_78 ( V_201 . V_204 ) ;
V_2 -> V_205 = F_78 ( V_201 . V_206 ) ;
snprintf ( V_12 -> V_13 -> V_207 , sizeof( V_12 -> V_13 -> V_207 ) , L_15 ,
V_2 -> V_203 ,
V_2 -> V_205 ) ;
F_22 ( V_2 -> V_8 , L_16 ,
V_2 -> V_203 ,
...
if ( error != 0 )
goto V_213;
error = F_80 ( & V_55 -> V_214 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_215;
V_57 = & V_55 -> V_214 ;
...
goto V_222;
if ( ! F_87 ( V_57 ) ) {
error = F_88 ( V_12 -> V_13 , V_57 -> V_223 ) ;
if ( error )
goto V_224;
}
error = F_89 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_90 ( V_2 -> V_10 , V_211 , sizeof( V_211 ) ) ;
F_91 ( V_12 -> V_13 , L_20 , V_211 ) ;
F_92 ( V_2 ) ;
F_93 ( V_2 ) ;
return 0 ;
V_224:
...
int F_94 ( struct V_226 * V_227 , struct V_228 * V_8 ,
T_1 V_24 , char * V_106 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_95 ( sizeof( struct V_1 ) , & V_229 ) ;
if ( ! V_12 )
return - V_108 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_100 ( struct V_226 * V_227 , bool V_232 )
{
if ( V_227 -> V_230 ) {
if ( V_232 )
V_227 -> V_230 -> V_10 -> V_111 |= V_233 ;
F_9 ( V_227 -> V_230 ) ;
F_98 ( V_227 -> V_230 ) ;
F_99 ( V_227 -> V_230 -> V_12 ) ;
}
}
void F_101 ( struct V_226 * V_227 )
{
F_102 ( V_227 -> V_230 , V_234 ) ;
}
int F_103 ( struct V_226 * V_227 )
{
struct V_1 * V_2 = V_227 -> V_230 ;
int V_26 ;
V_26 = F_1 ( V_2 ) ;
if ( V_26 )
return V_26 ;
