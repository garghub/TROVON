...
if ( F_38 ( V_20 ) && V_6 -> V_59 )
V_6 -> V_59 ( V_6 ) ;
return V_20 ;
}
static int F_39 ( struct V_42 * V_6 )
{
T_1 V_61 , V_62 ;
int V_20 ;
do {
V_61 = F_40 ( & V_6 -> V_47 . V_63 ) ;
V_20 = F_41 ( V_6 -> V_47 . V_15 , & V_62 ) ;
if ( V_20 ) {
if ( V_20 != 3 )
break;
V_62 = 0 ;
}
} while ( F_42 ( & V_6 -> V_47 . V_63 , V_61 , V_62 ) != V_61 );
return V_20 ;
}
static int F_43 ( struct V_42 * V_6 )
{
T_1 V_61 , V_62 , V_64 ;
int V_20 ;
do {
...
V_64 = ( V_61 <= V_62 ) ? V_62 - V_61
: ( - 1ULL - V_61 ) + V_62 + 1 ;
F_44 ( V_64 , & V_6 -> V_66 ) ;
V_65:
return V_20 ;
}
static void F_45 ( struct V_42 * V_6 )
{
if ( V_6 -> V_47 . V_1 & V_67 )
return;
F_43 ( V_6 ) ;
}
static void F_46 ( struct V_42 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
struct V_12 * V_13 = & V_6 -> V_47 ;
if ( F_47 ( ! ( V_13 -> V_1 & V_67 ) ) )
return;
if ( F_47 ( V_13 -> V_15 == - 1 ) )
return;
if ( V_28 & V_68 )
...
static void F_48 ( struct V_42 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
struct V_12 * V_13 = & V_6 -> V_47 ;
if ( ! ( V_13 -> V_1 & V_67 ) ) {
...
if ( ( V_28 & V_70 ) && ! ( V_13 -> V_1 & V_69 ) ) {
F_43 ( V_6 ) ;
V_6 -> V_47 . V_1 |= V_69 ;
}
}
static int F_49 ( struct V_42 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
if ( ! ( V_19 -> V_28 & V_71 ) )
if ( F_10 ( & V_6 -> V_47 ) )
...
V_6 -> V_47 . V_1 = V_69 | V_67 ;
if ( V_28 & V_72 )
F_46 ( V_6 , V_68 ) ;
F_50 ( V_6 ) ;
return 0 ;
}
static void F_51 ( struct V_42 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
F_48 ( V_6 , V_70 ) ;
...
static int F_58 ( struct V_74 * V_75 , unsigned long V_76 ,
void * V_77 )
{
unsigned int V_78 = ( long ) V_77 ;
int V_28 ;
switch ( V_76 & ~ V_79 ) {
case V_80 :
V_28 = V_39 ;
F_59 ( V_78 , F_20 , & V_28 , 1 ) ;
break;
case V_81 :
V_28 = V_40 ;
F_59 ( V_78 , F_20 , & V_28 , 1 ) ;
