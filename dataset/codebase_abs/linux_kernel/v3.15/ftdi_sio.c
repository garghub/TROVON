...
if ( V_75 > 99 )
V_75 = 99 ;
F_9 ( & V_73 -> V_13 , L_27 , V_18 , V_75 ) ;
F_33 ( & V_73 -> V_13 , L_28 , V_75 ) ;
...
{
struct V_72 * V_73 = V_23 -> V_13 ;
if ( ( V_73 -> V_153 && ! strcmp ( V_73 -> V_153 , L_30 ) ) ||
( V_73 -> V_154 && ! strcmp ( V_73 -> V_154 , L_31 ) ) )
return F_56 ( V_23 ) ;
return 0 ;
}
...
goto V_238;
if ( ( V_220 -> V_224 & ( V_233 | V_239 | V_240 | V_241 | V_242 ) ) ==
( V_222 -> V_224 & ( V_233 | V_239 | V_240 | V_241 | V_242 ) ) )
goto V_243;
V_235:
V_14 = 0 ;
...
F_9 ( V_221 , L_48 ,
V_18 , V_225 ) ;
V_228 = V_222 -> V_255 [ V_256 ] ;
V_227 = V_222 -> V_255 [ V_257 ] ;
V_14 = ( V_227 << 8 ) | ( V_228 ) ;
if ( F_10 ( V_13 ,
F_11 ( V_13 , 0 ) ,
V_163 ,
...
case V_272 :
return F_24 ( V_7 ,
(struct V_84 T_3 * ) V_271 ) ;
case V_273 :
return F_26 ( V_30 , V_7 ,
(struct V_84 T_3 * ) V_271 ) ;
case V_274 :
return F_31 ( V_7 , (struct V_84 T_3 * ) V_271 ) ;
break;
default:
break;
}
