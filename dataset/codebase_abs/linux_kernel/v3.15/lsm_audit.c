...
return;
case V_58 :
F_14 ( V_46 , L_5 , V_52 -> V_10 . V_59 ) ;
break;
case V_60 :
F_14 ( V_46 , L_6 , V_52 -> V_10 . V_61 ) ;
break;
case V_62 : {
struct V_63 * V_63 ;
F_20 ( V_46 , L_7 , & V_52 -> V_10 . V_64 ) ;
V_63 = V_52 -> V_10 . V_64 . V_65 -> V_66 ;
if ( V_63 ) {
F_14 ( V_46 , L_8 ) ;
F_19 ( V_46 , V_63 -> V_67 -> V_68 ) ;
F_14 ( V_46 , L_9 , V_63 -> V_69 ) ;
}
break;
}
case V_70 : {
struct V_63 * V_63 ;
F_14 ( V_46 , L_10 ) ;
F_19 ( V_46 , V_52 -> V_10 . V_65 -> V_71 . V_72 ) ;
V_63 = V_52 -> V_10 . V_65 -> V_66 ;
if ( V_63 ) {
F_14 ( V_46 , L_8 ) ;
F_19 ( V_46 , V_63 -> V_67 -> V_68 ) ;
F_14 ( V_46 , L_9 , V_63 -> V_69 ) ;
...
V_10 = F_25 ( V_77 ) ;
if ( V_10 -> V_64 . V_65 ) {
F_20 ( V_46 , L_7 , & V_10 -> V_64 ) ;
break;
}
if ( ! V_10 -> V_48 )
break;
V_80 = V_10 -> V_48 -> V_80 - sizeof( short ) ;
V_81 = & V_10 -> V_48 -> V_72 -> V_95 [ 0 ] ;
F_14 ( V_46 , L_7 ) ;
if ( * V_81 )
F_19 ( V_46 , V_81 ) ;
else
...
struct V_98 * V_99 ;
V_99 = F_27 ( & V_100 , V_52 -> V_10 . V_11 -> V_97 ) ;
if ( V_99 ) {
F_14 ( V_46 , L_19 , V_99 -> V_72 ) ;
F_28 ( V_99 ) ;
}
}
break;
...
F_14 ( V_46 , L_21 ) ;
F_19 ( V_46 , V_52 -> V_10 . V_102 . V_104 ) ;
}
break;
#endif
case V_105 :
F_14 ( V_46 , L_22 ) ;
F_19 ( V_46 , V_52 -> V_10 . V_106 ) ;
break;
}
}
void F_30 ( struct V_3 * V_52 ,
void (* F_31)( struct V_45 * , void * ) ,
void (* F_32)( struct V_45 * , void * ) )
{
struct V_45 * V_46 ;
if ( V_52 == NULL )
return;
V_46 = F_33 ( V_55 -> V_107 , V_108 | V_109 ,
V_110 ) ;
if ( V_46 == NULL )
return;
if ( F_31 )
