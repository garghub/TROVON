...
{
struct V_77 * V_78 = & V_21 -> V_79 ;
if ( V_78 -> V_88 > 3000000 )
V_94 -> V_95 = 2000 ;
else
V_94 -> V_95 = 3000 ;
V_94 -> V_96 = V_78 -> V_88 / 16000 ;
V_94 -> V_97 = V_78 -> V_88 / 2000 ;
return 0 ;
}
static int F_28 ( struct V_20 * V_21 , int V_98 )
{
struct V_1 * V_2 = V_21 -> V_22 ;
if ( V_98 )
F_1 ( V_2 , 0x81 , 0x84 ) ;
...
struct V_20 * F_32 ( const struct V_99 * V_10 ,
struct V_100 * V_14 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_33 ( sizeof( struct V_1 ) , V_101 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_14 = V_14 ;
