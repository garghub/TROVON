...
args . V_29 = V_29 ;
args . V_81 = V_29 ;
args . V_82 = F_7 ( V_29 , V_31 | V_32 ) ;
args . V_83 = F_22 ( V_78 -> V_84 ) ;
args . V_85 = F_30 (
args . V_13 -> V_34 , V_29 ) ;
V_72 = F_31 ( & args ) ;
if ( V_72 )
...
unsigned char * V_82 )
{
struct V_92 * V_93 = (struct V_92 * ) V_7 -> V_93 ;
T_14 * V_94 ;
int V_95 ;
ASSERT ( ! ( V_7 -> V_26 & V_96 ) ) ;
ASSERT ( V_7 -> V_16 >= 0 ) ;
ASSERT ( V_7 -> V_16 < ( V_97 / 8 ) ) ;
ASSERT ( V_7 -> V_98 >= sizeof( * V_93 ) ) ;
ASSERT ( V_7 -> V_98 <= V_7 -> V_22 ) ;
if ( ( ( V_7 -> V_26 & V_99 ) == 0 ) !=
( ( V_26 & V_100 ) == 0 ) )
return 0 ;
if ( ( ( V_7 -> V_26 & V_101 ) == 0 ) !=
...
V_94 = ( T_14 * ) & V_7 -> V_93 [ V_7 -> V_98 ] ;
V_94 -> V_105 = V_29 ;
memcpy ( V_94 -> V_106 , V_36 , V_28 ) ;
V_94 -> V_106 [ V_28 ] = 0 ;
V_93 -> V_103 [ V_7 -> V_16 ++ ] = V_7 -> V_98 ;
V_93 -> V_107 = V_7 -> V_16 ;
F_45 ( V_7 ) ;
return 0 ;
}
...
V_7 . V_98 = V_7 . V_22 ;
V_7 . V_25 = F_42 ;
V_93 = (struct V_92 * ) V_7 . V_93 ;
V_93 -> V_107 = 0 ;
V_93 -> V_104 = 0 ;
V_93 -> V_103 [ 0 ] = V_7 . V_22 ;
error = F_35 ( & V_7 ) ;
ASSERT ( error >= 0 ) ;
return error ;
}
