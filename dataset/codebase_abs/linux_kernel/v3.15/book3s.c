...
V_145 = F_68 ( V_143 -> V_146 , F_69 ( V_2 , V_123 ) ) ;
break;
case V_155 :
V_145 = F_68 ( V_143 -> V_146 , V_2 -> V_7 . V_156 . V_157 ) ;
break;
#ifdef F_70
case V_158 ... V_159 :
if ( ! F_71 ( V_160 ) ) {
...
V_145 . V_162 = V_2 -> V_7 . V_163 . V_163 [ V_143 -> V_146 - V_158 ] ;
break;
case V_164 :
if ( ! F_71 ( V_160 ) ) {
V_92 = - V_161 ;
...
V_145 = F_68 ( V_143 -> V_146 , V_2 -> V_7 . V_163 . V_165 . V_166 [ 3 ] ) ;
break;
case V_167 :
...
case V_169 ... V_170 :
if ( F_71 ( V_171 ) ) {
long int V_123 = V_143 -> V_146 - V_169 ;
V_145 . V_172 [ 0 ] = V_2 -> V_7 . V_156 . V_173 [ V_123 ] [ 0 ] ;
V_145 . V_172 [ 1 ] = V_2 -> V_7 . V_156 . V_173 [ V_123 ] [ 1 ] ;
} else {
V_92 = - V_161 ;
}
break;
...
case V_174 : {
T_6 V_175 = V_176 ;
V_92 = F_73 ( ( T_6 V_115 * ) ( long ) V_143 -> V_177 ,
& V_175 , sizeof( T_6 ) ) ;
break;
}
#ifdef F_74
...
V_145 = F_68 ( V_143 -> V_146 , F_75 ( V_2 ) ) ;
break;
#endif
default:
V_92 = - V_147 ;
...
if ( V_92 )
return V_92 ;
if ( F_73 ( ( char V_115 * ) ( unsigned long ) V_143 -> V_177 , & V_145 , V_104 ) )
V_92 = - V_180 ;
return V_92 ;
}
int F_76 ( struct V_1 * V_2 , struct V_142 * V_143 )
{
int V_92 ;
union V_144 V_145 ;
int V_104 ;
...
if ( V_104 > sizeof( V_145 ) )
return - V_147 ;
if ( F_45 ( & V_145 , ( char V_115 * ) ( unsigned long ) V_143 -> V_177 , V_104 ) )
return - V_180 ;
V_92 = V_2 -> V_3 -> V_7 . V_118 -> V_181 ( V_2 , V_143 -> V_146 , & V_145 ) ;
if ( V_92 == - V_147 ) {
V_92 = 0 ;
switch ( V_143 -> V_146 ) {
case V_149 :
V_2 -> V_7 . V_8 -> V_150 = F_77 ( V_143 -> V_146 , V_145 ) ;
break;
case V_151 :
V_2 -> V_7 . V_8 -> V_152 = F_77 ( V_143 -> V_146 , V_145 ) ;
break;
case V_153 ... V_154 :
V_123 = V_143 -> V_146 - V_153 ;
F_69 ( V_2 , V_123 ) = F_77 ( V_143 -> V_146 , V_145 ) ;
break;
case V_155 :
V_2 -> V_7 . V_156 . V_157 = F_77 ( V_143 -> V_146 , V_145 ) ;
break;
#ifdef F_70
case V_158 ... V_159 :
if ( ! F_71 ( V_160 ) ) {
...
V_2 -> V_7 . V_163 . V_163 [ V_143 -> V_146 - V_158 ] = V_145 . V_162 ;
break;
case V_164 :
if ( ! F_71 ( V_160 ) ) {
V_92 = - V_161 ;
...
V_2 -> V_7 . V_163 . V_165 . V_166 [ 3 ] = F_77 ( V_143 -> V_146 , V_145 ) ;
break;
case V_167 :
if ( ! F_71 ( V_160 ) ) {
V_92 = - V_161 ;
...
V_2 -> V_7 . V_168 = F_77 ( V_143 -> V_146 , V_145 ) ;
break;
#endif
#ifdef F_72
case V_169 ... V_170 :
if ( F_71 ( V_171 ) ) {
long int V_123 = V_143 -> V_146 - V_169 ;
V_2 -> V_7 . V_156 . V_173 [ V_123 ] [ 0 ] = V_145 . V_172 [ 0 ] ;
V_2 -> V_7 . V_156 . V_173 [ V_123 ] [ 1 ] = V_145 . V_172 [ 1 ] ;
} else {
V_92 = - V_161 ;
}
break;
...
void F_79 ( struct V_1 * V_2 , int V_182 )
{
V_2 -> V_3 -> V_7 . V_118 -> V_183 ( V_2 , V_182 ) ;
}
void F_80 ( struct V_1 * V_2 )
{
V_2 -> V_3 -> V_7 . V_118 -> V_184 ( V_2 ) ;
}
void F_62 ( struct V_1 * V_2 , T_2 V_14 )
{
V_2 -> V_3 -> V_7 . V_118 -> V_185 ( V_2 , V_14 ) ;
}
int F_81 ( struct V_186 * V_186 , struct V_1 * V_2 )
{
return V_2 -> V_3 -> V_7 . V_118 -> V_187 ( V_186 , V_2 ) ;
}
...
void F_84 ( unsigned long V_85 )
{
struct V_1 * V_2 = (struct V_1 * ) V_85 ;
F_20 ( V_2 ) ;
F_85 ( V_2 ) ;
}
struct V_1 * F_86 ( struct V_3 * V_3 , unsigned int V_146 )
{
return V_3 -> V_7 . V_118 -> V_192 ( V_3 , V_146 ) ;
}
void F_87 ( struct V_1 * V_2 )
{
V_2 -> V_3 -> V_7 . V_118 -> V_193 ( V_2 ) ;
}
int F_88 ( struct V_1 * V_2 )
{
return V_2 -> V_3 -> V_7 . V_118 -> V_194 ( V_2 ) ;
}
int F_89 ( struct V_3 * V_3 , struct V_195 * log )
{
return V_3 -> V_7 . V_118 -> V_196 ( V_3 , log ) ;
}
void F_90 ( struct V_3 * V_3 , struct V_197 * free ,
struct V_197 * V_198 )
{
V_3 -> V_7 . V_118 -> V_199 ( free , V_198 ) ;
}
int F_91 ( struct V_3 * V_3 , struct V_197 * V_200 ,
unsigned long V_201 )
{
return V_3 -> V_7 . V_118 -> V_202 ( V_200 , V_201 ) ;
}
void F_92 ( struct V_3 * V_3 , struct V_197 * V_203 )
{
V_3 -> V_7 . V_118 -> V_204 ( V_3 , V_203 ) ;
}
int F_93 ( struct V_3 * V_3 ,
struct V_197 * V_203 ,
struct V_205 * V_206 )
{
return V_3 -> V_7 . V_118 -> V_207 ( V_3 , V_203 , V_206 ) ;
}
void F_94 ( struct V_3 * V_3 ,
struct V_205 * V_206 ,
const struct V_197 * V_208 )
{
V_3 -> V_7 . V_118 -> V_209 ( V_3 , V_206 , V_208 ) ;
}
int F_95 ( struct V_3 * V_3 , unsigned long V_111 )
{
return V_3 -> V_7 . V_118 -> V_210 ( V_3 , V_111 ) ;
}
int F_96 ( struct V_3 * V_3 , unsigned long V_211 , unsigned long V_212 )
{
return V_3 -> V_7 . V_118 -> V_213 ( V_3 , V_211 , V_212 ) ;
}
int F_97 ( struct V_3 * V_3 , unsigned long V_111 )
{
return V_3 -> V_7 . V_118 -> V_214 ( V_3 , V_111 ) ;
}
int F_98 ( struct V_3 * V_3 , unsigned long V_111 )
{
return V_3 -> V_7 . V_118 -> V_215 ( V_3 , V_111 ) ;
}
void F_99 ( struct V_3 * V_3 , unsigned long V_111 , T_7 V_88 )
{
V_3 -> V_7 . V_118 -> V_216 ( V_3 , V_111 , V_88 ) ;
}
void F_100 ( struct V_1 * V_2 )
{
V_2 -> V_3 -> V_7 . V_118 -> V_217 ( V_2 ) ;
}
...
F_103 ( & V_3 -> V_7 . V_219 ) ;
#endif
return V_3 -> V_7 . V_118 -> V_220 ( V_3 ) ;
}
void F_104 ( struct V_3 * V_3 )
{
V_3 -> V_7 . V_118 -> V_221 ( V_3 ) ;
#ifdef F_102
F_105 ( V_3 ) ;
F_106 ( ! F_107 ( & V_3 -> V_7 . V_218 ) ) ;
#endif
}
int F_108 ( void )
{
...
{
int V_92 ;
V_92 = F_110 ( NULL , sizeof( struct V_1 ) , 0 , V_222 ) ;
if ( V_92 )
return V_92 ;
#ifdef F_111
V_92 = F_112 () ;
