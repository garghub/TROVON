...
void F_44 ( struct V_8 * V_9 , T_1 V_141 )
{
F_2 ( V_9 , V_141 ) ;
}
...
switch ( V_2 -> V_119 ) {
case V_131 :
F_42 ( V_9 -> V_30 , & V_2 -> V_142 . V_143 , 1 ,
V_144 ) ;
F_42 ( V_9 -> V_30 , & V_2 -> V_142 . V_83 , 1 ,
V_145 ) ;
break;
case V_133 :
case V_134 :
...
{
T_1 V_30 ;
for ( V_30 = 0 ; V_30 < V_147 ; V_30 ++ ) {
if ( V_9 -> V_148 [ V_30 ] . V_114 == V_149 ) {
V_9 -> V_148 [ V_30 ] . V_43 = V_30 ;
return & V_9 -> V_148 [ V_30 ] ;
}
}
if ( V_30 == V_147 ) {
F_47 ( V_9 ,
...
V_101 -> V_156 = & V_46 ;
if ( V_153 && F_51 ( V_153 -> V_114 ) ) {
int V_42 ;
struct V_157 * V_48 ;
for ( V_42 = 0 ; V_42 < V_153 -> V_158 . V_159 ;
V_42 ++ ) {
V_48 = & V_153 -> V_158 . V_157 [ V_42 ] ;
if ( F_52 ( V_48 -> V_160 )
== F_52 ( V_30 -> V_161 ) ) {
V_101 -> V_162 = V_42 ;
break;
...
if ( V_42 == V_153 -> V_158 . V_159 ) {
F_47 ( V_9 ,
F_12 ( L_9
L_10 , F_52 ( V_30 -> V_161 ) ,
F_52 ( V_153 -> V_161 ) ) ) ;
V_152 = - 1 ;
}
} else {
...
{
if ( ! F_56 ( & V_2 -> V_169 -> V_170 ) )
return;
F_57 ( & V_2 -> V_169 -> V_46 ) ;
}
static void F_58 ( unsigned long V_171 )
{
...
return - V_128 ;
V_2 -> V_30 = V_30 ;
V_2 -> V_119 = V_30 -> V_178 ;
memcpy ( & V_2 -> V_179 , V_173 , V_174 ) ;
V_2 -> V_116 = F_55 ;
V_2 -> V_169 -> V_170 . V_171 = ( unsigned long ) V_2 ;
V_2 -> V_169 -> V_170 . V_180 = F_58 ;
V_2 -> V_169 -> V_170 . V_181 = V_182 + V_183 * V_82 ;
F_61 ( & V_2 -> V_169 -> V_170 ) ;
V_152 = F_33 ( V_2 , 1 , V_177 , 1 , V_93 ) ;
if ( V_152 ) {
F_56 ( & V_2 -> V_169 -> V_170 ) ;
F_47 ( V_9 ,
F_12 ( L_12
L_13 ) ) ;
goto V_184;
...
V_184:
F_64 ( V_175 == 3 && V_2 != NULL ) ;
F_63 ( V_2 ) ;
return V_152 ;
}
static int
F_65 ( struct V_8 * V_9 ,
struct V_101 * V_102 , struct V_29 * V_30 , T_1 V_154 ,
T_1 V_196 )
{
int V_152 , V_175 ;
T_1 V_7 ;
...
return F_59 ( V_30 , & V_179 , sizeof( V_179 ) ,
V_93 ) ;
}
void F_69 (
struct V_8 * V_9 ,
