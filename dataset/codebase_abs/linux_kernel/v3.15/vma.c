...
unsigned V_44 )
{
struct V_45 * V_46 = V_47 -> V_46 ;
unsigned long V_32 ;
int V_48 ;
if ( ! V_49 )
return 0 ;
F_14 ( & V_46 -> V_50 ) ;
V_32 = F_9 ( V_46 -> V_51 , V_44 ) ;
V_32 = F_15 ( NULL , V_32 , V_44 , 0 , 0 ) ;
if ( F_16 ( V_32 ) ) {
V_48 = V_32 ;
goto V_52;
}
V_47 -> V_46 -> V_53 . V_1 = ( void * ) V_32 ;
V_48 = F_17 ( V_46 , V_32 , V_44 ,
V_54 | V_55 |
V_56 | V_57 | V_58 ,
V_43 ) ;
if ( V_48 ) {
V_47 -> V_46 -> V_53 . V_1 = NULL ;
goto V_52;
}
V_52:
F_18 ( & V_46 -> V_50 ) ;
...
int F_19 ( struct V_39 * V_40 , int V_41 )
{
return F_13 ( V_40 , V_41 , V_26 ,
V_24 ) ;
}
int F_20 ( struct V_39 * V_40 , int V_41 )
{
return F_13 ( V_40 , V_41 , V_30 ,
V_29 ) ;
}
static T_1 int F_21 ( char * V_59 )
{
V_49 = F_22 ( V_59 , NULL , 0 ) ;
return 0 ;
}
