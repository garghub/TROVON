...
return V_8 ;
V_55 -> V_82 = F_24 ( V_78 ) ;
V_8 = F_6 ( V_2 , V_55 -> V_82 ) ;
if ( V_8 )
return V_8 ;
return 0 ;
}
int F_25 ( struct V_52 * V_53 , unsigned int * V_83 )
{
struct V_54 * V_55 ;
if ( V_53 == NULL || V_83 == NULL )
return - V_22 ;
V_55 = F_9 ( V_53 ) ;
switch ( V_55 -> V_9 ) {
case V_72 :
...
V_55 = F_27 ( sizeof( struct V_54 ) , V_90 ) ;
if ( V_55 == NULL ) {
F_4 ( V_53 -> V_6 , L_20 ) ;
return - V_91 ;
}
