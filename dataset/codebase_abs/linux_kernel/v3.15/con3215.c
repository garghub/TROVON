...
static int F_83 ( struct V_97 * V_112 , struct V_51 * V_52 )
{
struct V_8 * V_9 ;
V_9 = V_89 [ V_52 -> V_98 ] ;
if ( V_9 == NULL )
return - V_94 ;
V_52 -> V_113 = V_9 ;
return F_84 ( & V_9 -> V_43 , V_112 , V_52 ) ;
}
static int F_85 ( struct V_51 * V_52 , struct V_114 * V_115 )
{
...
static void F_87 ( struct V_51 * V_52 , struct V_114 * V_115 )
{
struct V_8 * V_9 ;
...
static int F_91 ( struct V_51 * V_52 , unsigned char V_72 )
{
struct V_8 * V_9 ;
if ( ! V_52 )
return 0 ;
...
V_112 -> V_129 . V_134 = V_135 | V_136 ;
V_112 -> V_129 . V_137 = V_138 ;
V_112 -> V_3 = V_139 ;
F_103 ( V_112 , & V_140 ) ;
V_120 = F_104 ( V_112 ) ;
if ( V_120 ) {
