...
int V_92 ;
int V_93 = 0 ;
for ( V_147 = 0 ; V_147 < V_172 ; V_147 ++ ) {
if ( ( V_8 -> V_12 & V_173 ) &&
! ( V_8 -> V_12 & V_174 ) ) {
V_8 -> V_84 . V_85 [ V_147 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_147 ] . V_175 = 0 ;
break;
} else if ( V_8 -> V_84 . V_85 [ V_147 ] . V_86 < 0 ) {
break;
} else if ( V_147 >= V_2 -> V_176 ) {
V_8 -> V_84 . V_85 [ V_147 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_147 ] . V_175 = 0 ;
break;
}
V_91 += V_8 -> V_84 . V_85 [ V_147 ] . V_175 ;
}
V_168 = V_147 - 1 ;
if ( V_91 < 0 )
V_91 = 0 ;
F_41 () ;
V_90 = V_6 -> V_2 . V_177 -> V_178 [ V_8 -> V_179 ] ;
V_150 = V_22 -> V_33 ;
F_64 (local, hdr->addr1, sta, tmp) {
if ( ! F_65 ( V_22 -> V_180 , V_20 -> V_28 -> V_27 . V_48 ) )
continue;
...
F_13 ( V_22 ) ,
V_20 , true , V_130 ) ;
if ( ( V_6 -> V_2 . V_12 & V_183 ) &&
( F_58 ( V_22 -> V_33 ) ) &&
( V_168 != - 1 ) )
V_20 -> V_184 = V_8 -> V_84 . V_85 [ V_168 ] ;
if ( ( V_8 -> V_12 & V_185 ) &&
( F_12 ( V_150 ) ) ) {
T_2 V_36 , V_81 ;
T_1 * V_59 ;
...
if ( ! V_130 && F_71 ( V_150 ) ) {
T_2 V_36 , V_25 ;
V_171 = (struct V_170 * ) V_4 -> V_23 ;
V_25 = F_70 ( V_171 -> V_25 ) ;
if ( ! ( V_25 & V_188 ) ) {
T_2 V_81 = F_70 ( V_171 -> V_189 ) ;
V_36 = ( V_25 &
V_190 ) >>
V_191 ;
F_29 ( V_20 , V_36 , V_81 ) ;
...
F_40 ( V_6 , V_4 , false ) ;
F_81 ( V_4 ) ;
V_169 = ! ! ( V_8 -> V_12 & V_195 ) ||
! ( F_58 ( V_150 ) ) ;
if ( ! V_6 -> V_211 && ( ! V_169 || ! V_6 -> V_212 ) ) {
F_82 ( V_4 ) ;
return;
}
V_92 = F_30 ( V_8 ) ;
...
void F_90 ( struct V_222 * V_223 , T_5 V_224 )
{
struct V_19 * V_20 = F_91 ( V_223 , struct V_19 , V_20 ) ;
