...
return;
F_91 ( & V_153 -> V_165 . V_166 , V_37 ) ;
if ( F_53 ( ! F_92 ( V_153 -> V_165 ) ) )
F_93 ( V_153 ) ;
F_94 ( & V_153 -> V_165 . V_166 , V_37 ) ;
F_95 ( V_153 ) ;
F_96 ( F_97 ( V_153 -> V_165 ) ,
V_167 ) ;
}
void F_98 ( void )
{
...
void F_102 ( struct V_152 * V_153 )
{
T_4 V_141 = F_97 ( V_153 -> V_165 ) ;
int V_46 = F_86 () ;
if ( F_103 ( & V_153 -> V_175 ) == 1 ) {
F_104 ( F_77 ( V_153 ) , F_64 ( V_46 ) ) ;
goto V_176;
}
F_62 ( & V_177 ,
V_141 , 0 , 0 ,
...
static void F_105 ( void * V_150 )
{
struct V_178 * V_42 = V_150 ;
F_106 ( V_42 -> V_141 , V_42 -> V_116 , V_42 -> V_179 ) ;
}
void F_107 ( struct V_152 * V_153 , unsigned long V_116 , unsigned long * V_179 )
{
T_4 V_141 = F_97 ( V_153 -> V_165 ) ;
struct V_178 V_150 ;
int V_46 = F_86 () ;
...
V_150 . V_116 = V_116 ;
V_150 . V_179 = V_179 ;
if ( V_153 == V_14 -> V_153 && F_103 ( & V_153 -> V_175 ) == 1 )
F_104 ( F_77 ( V_153 ) , F_64 ( V_46 ) ) ;
else
F_76 ( F_77 ( V_153 ) , F_105 ,
& V_150 , 1 ) ;
F_106 ( V_141 , V_116 , V_179 ) ;
F_87 () ;
}
void F_108 ( struct V_152 * V_153 , unsigned long V_74 )
{
unsigned long V_165 = F_97 ( V_153 -> V_165 ) ;
int V_46 = F_86 () ;
if ( V_153 == V_14 -> V_153 && F_103 ( & V_153 -> V_175 ) == 1 )
F_104 ( F_77 ( V_153 ) , F_64 ( V_46 ) ) ;
else
...
void F_110 ( unsigned long V_181 , unsigned long V_182 )
{
V_181 &= V_183 ;
V_182 = F_111 ( V_182 ) ;
if ( V_181 != V_182 ) {
...
void T_5 F_120 ( int V_147 , struct V_148 * V_149 )
{
F_68 ( 1 << V_147 ) ;
F_19 () ;
...
int F_122 ( unsigned int V_190 )
{
return - V_191 ;
}
void T_6 F_123 ( unsigned int V_192 )
{
}
void F_124 ( void )
{
...
if ( F_5 ( V_3 ) . V_195 ==
F_5 ( V_193 ) . V_195 )
F_129 ( V_193 , & V_194 [ V_3 ] ) ;
}
}
F_127 (i) {
unsigned int V_193 ;
F_128 ( & F_130 ( V_196 , V_3 ) ) ;
if ( F_5 ( V_3 ) . V_197 == - 1 ) {
F_129 ( V_3 , & F_130 ( V_196 , V_3 ) ) ;
continue;
}
F_127 (j) {
if ( F_5 ( V_3 ) . V_197 ==
F_5 ( V_193 ) . V_197 )
F_129 ( V_193 , & F_130 ( V_196 , V_3 ) ) ;
}
}
}
int F_131 ( unsigned int V_46 , struct V_77 * V_198 )
{
...
F_136 ( V_46 , & V_194 [ V_3 ] ) ;
F_128 ( & V_194 [ V_46 ] ) ;
F_59 (i, &per_cpu(cpu_sibling_map, cpu))
F_136 ( V_46 , & F_130 ( V_196 , V_3 ) ) ;
F_128 ( & F_130 ( V_196 , V_46 ) ) ;
V_207 = & F_5 ( V_46 ) ;
V_207 -> V_195 = 0 ;
V_207 -> V_197 = - 1 ;
F_140 () ;
...
void T_6 F_149 ( unsigned int V_192 )
{
F_150 () ;
}
void F_151 ( int V_46 )
...
void T_5 F_155 ( int V_147 , struct V_148 * V_149 )
{
F_68 ( 1 << V_147 ) ;
F_156 () ;
}
...
static void * T_6 F_158 ( unsigned int V_46 , T_8 V_211 ,
T_8 V_212 )
{
const unsigned long V_213 = F_40 ( V_214 ) ;
#ifdef F_159
int V_215 = F_160 ( V_46 ) ;
void * V_216 ;
if ( ! F_161 ( V_215 ) || ! F_162 ( V_215 ) ) {
V_216 = F_163 ( V_211 , V_212 , V_213 ) ;
F_164 ( L_33 ,
V_46 , V_215 ) ;
F_165 ( L_34 ,
V_46 , V_211 , F_40 ( V_216 ) ) ;
} else {
V_216 = F_166 ( F_162 ( V_215 ) ,
V_211 , V_212 , V_213 ) ;
F_165 ( L_35
L_36 , V_46 , V_211 , V_215 , F_40 ( V_216 ) ) ;
}
return V_216 ;
#else
return F_163 ( V_211 , V_212 , V_213 ) ;
#endif
}
static void T_6 F_167 ( void * V_216 , T_8 V_211 )
{
F_168 ( F_40 ( V_216 ) , V_211 ) ;
}
static int T_6 F_169 ( unsigned int V_217 , unsigned int V_218 )
{
if ( F_160 ( V_217 ) == F_160 ( V_218 ) )
return V_219 ;
else
return V_220 ;
}
static void T_6 F_170 ( unsigned long V_221 )
{
T_9 * V_155 = F_171 ( V_221 ) ;
T_10 * V_222 ;
T_11 * V_223 ;
V_222 = F_172 ( V_155 , V_221 ) ;
if ( F_173 ( * V_222 ) ) {
T_11 * V_224 ;
V_224 = F_163 ( V_225 , V_225 , V_225 ) ;
F_174 ( & V_12 , V_222 , V_224 ) ;
}
V_223 = F_175 ( V_222 , V_221 ) ;
if ( ! F_176 ( * V_223 ) ) {
T_12 * V_224 ;
V_224 = F_163 ( V_225 , V_225 , V_225 ) ;
F_177 ( & V_12 , V_223 , V_224 ) ;
}
}
void T_6 F_178 ( void )
{
