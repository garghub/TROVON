...
int V_271 = 0 ;
T_2 V_280 ;
if ( ! F_232 ( V_37 -> V_38 . V_190 . V_222 ) )
return 0 ;
F_233 (vcpu, (u64)gfn << PAGE_SHIFT, iterator) {
if ( V_219 . V_44 == V_44 ) {
...
F_106 ( V_37 , V_219 . V_14 ) ;
if ( ! F_23 ( * V_219 . V_14 ) ) {
T_1 V_283 = V_219 . V_220 ;
V_283 &= F_234 ( V_219 . V_44 ) ;
V_280 = V_283 >> V_19 ;
...
static void F_235 ( unsigned long V_284 , struct V_285 * V_286 )
{
T_10 V_287 ;
V_287 . V_288 = V_289 ;
V_287 . V_290 = 0 ;
...
V_287 . V_295 = V_19 ;
F_236 ( V_289 , & V_287 , V_286 ) ;
}
static int F_237 ( struct V_36 * V_37 , T_2 V_15 , T_3 V_21 )
{
if ( V_21 == V_296 )
return 1 ;
if ( V_21 == V_297 ) {
F_235 ( F_238 ( V_37 -> V_11 , V_15 ) , V_298 ) ;
return 0 ;
}
return - V_299 ;
}
static void F_239 ( struct V_36 * V_37 ,
T_2 * V_300 , T_3 * V_301 , int * V_302 )
{
T_3 V_21 = * V_301 ;
T_2 V_15 = * V_300 ;
int V_44 = * V_302 ;
if ( ! F_240 ( V_21 ) && ! F_49 ( V_21 ) &&
V_44 == V_45 &&
F_241 ( F_51 ( V_21 ) ) &&
...
static bool F_245 ( struct V_36 * V_37 , T_7 V_175 , T_2 V_15 ,
T_3 V_21 , unsigned V_16 , int * V_303 )
{
bool V_68 = true ;
if ( F_14 ( F_246 ( V_21 ) ) ) {
* V_303 = F_237 ( V_37 , V_15 , V_21 ) ;
goto exit;
}
if ( F_14 ( F_15 ( V_21 ) ) )
F_247 ( V_37 , V_175 , V_15 , V_16 ) ;
V_68 = false ;
exit:
return V_68 ;
}
static bool F_248 ( T_4 V_304 )
{
if ( F_14 ( V_304 & V_305 ) )
return false ;
if ( ! ( V_304 & V_306 ) ||
...
static bool
F_249 ( struct V_36 * V_37 , T_1 * V_14 , T_1 V_10 )
{
struct V_51 * V_52 = F_37 ( F_38 ( V_14 ) ) ;
T_2 V_15 ;
F_3 ( ! V_52 -> V_94 . V_95 ) ;
V_15 = F_75 ( V_52 , V_14 - V_52 -> V_131 ) ;
if ( F_250 ( V_14 , V_10 , V_10 | V_139 ) == V_10 )
F_221 ( V_37 -> V_11 , V_15 ) ;
return true ;
}
static bool F_251 ( struct V_36 * V_37 , T_7 V_175 , int V_44 ,
T_4 V_304 )
{
struct V_218 V_219 ;
bool V_68 = false ;
...
if ( ! F_41 ( V_10 ) )
goto exit;
V_68 = F_249 ( V_37 , V_219 . V_14 , V_10 ) ;
exit:
F_253 ( V_37 , V_175 , V_304 , V_219 . V_14 ,
V_10 , V_68 ) ;
F_57 ( V_37 ) ;
return V_68 ;
}
static int F_254 ( struct V_36 * V_37 , T_7 V_276 , T_4 V_304 ,
T_2 V_15 , bool V_279 )
{
int V_84 ;
int V_44 ;
...
V_44 = V_45 ;
if ( F_251 ( V_37 , V_276 , V_44 , V_304 ) )
return 0 ;
V_309 = V_37 -> V_11 -> V_310 ;
F_40 () ;
if ( F_255 ( V_37 , V_279 , V_15 , V_276 , & V_21 , V_277 , & V_278 ) )
return 0 ;
if ( F_245 ( V_37 , V_276 , V_15 , V_21 , V_281 , & V_84 ) )
return V_84 ;
F_210 ( & V_37 -> V_11 -> V_200 ) ;
if ( F_256 ( V_37 -> V_11 , V_309 ) )
goto V_311;
F_257 ( V_37 ) ;
if ( F_18 ( ! V_308 ) )
F_239 ( V_37 , & V_15 , & V_21 , & V_44 ) ;
...
static void F_258 ( struct V_36 * V_37 )
{
int V_105 ;
struct V_51 * V_52 ;
F_166 ( V_187 ) ;
...
return V_84 ;
ASSERT ( V_37 ) ;
ASSERT ( F_232 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
V_15 = V_175 >> V_19 ;
return F_254 ( V_37 , V_175 & V_20 ,
V_304 , V_15 , V_279 ) ;
}
...
return F_281 ( V_37 , V_175 , F_238 ( V_37 -> V_11 , V_15 ) , & V_38 ) ;
}
...
static bool F_255 ( struct V_36 * V_37 , bool V_279 , T_2 V_15 ,
...
V_44 = V_45 ;
if ( F_251 ( V_37 , V_344 , V_44 , V_304 ) )
return 0 ;
V_309 = V_37 -> V_11 -> V_310 ;
F_40 () ;
if ( F_255 ( V_37 , V_279 , V_15 , V_344 , & V_21 , V_277 , & V_278 ) )
return 0 ;
if ( F_245 ( V_37 , 0 , V_15 , V_21 , V_281 , & V_84 ) )
return V_84 ;
F_210 ( & V_37 -> V_11 -> V_200 ) ;
if ( F_256 ( V_37 -> V_11 , V_309 ) )
goto V_311;
...
void F_301 ( struct V_36 * V_37 ,
struct V_345 * V_190 , bool V_365 )
{
unsigned V_366 , V_367 , V_368 ;
T_8 V_369 ;
bool V_354 , V_370 , V_371 , V_372 , V_373 , V_374 , V_375 , V_376 , V_377 , V_378 , V_379 = 0 ;
V_378 = F_302 ( V_37 , V_380 ) ;
V_377 = F_302 ( V_37 , V_381 ) ;
for ( V_367 = 0 ; V_367 < F_60 ( V_190 -> V_382 ) ; ++ V_367 ) {
V_368 = V_367 << 1 ;
V_369 = 0 ;
V_373 = V_368 & V_307 ;
V_374 = V_368 & V_383 ;
...
{
struct V_345 * V_346 = V_37 -> V_38 . V_397 ;
V_346 -> V_208 . V_214 = 0 ;
V_346 -> V_347 = F_290 ;
V_346 -> V_191 = F_151 ;
V_346 -> V_349 = F_152 ;
V_346 -> V_350 = F_153 ;
V_346 -> V_223 = V_118 -> V_398 () ;
V_346 -> V_222 = V_313 ;
V_346 -> V_209 = true ;
V_346 -> V_399 = V_118 -> V_400 ;
V_346 -> V_318 = V_318 ;
V_346 -> V_321 = V_401 ;
V_346 -> F_294 = V_402 ;
if ( ! F_310 ( V_37 ) ) {
...
F_307 ( V_37 , V_346 ) ;
V_37 -> V_38 . V_190 . V_208 . V_404 = F_22 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_189 = ! ! F_162 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_405 = F_303 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_406
= V_403 && ! F_303 ( V_37 ) ;
}
...
{
F_312 ( V_37 , V_37 -> V_38 . V_397 ) ;
V_37 -> V_38 . V_397 -> V_399 = V_118 -> V_399 ;
V_37 -> V_38 . V_397 -> V_318 = V_318 ;
V_37 -> V_38 . V_397 -> V_321 = V_401 ;
V_37 -> V_38 . V_397 -> F_294 = V_402 ;
}
static void F_315 ( struct V_36 * V_37 )
{
struct V_345 * V_412 = & V_37 -> V_38 . V_328 ;
V_412 -> V_318 = V_318 ;
V_412 -> V_321 = V_401 ;
V_412 -> F_294 = V_402 ;
if ( ! F_310 ( V_37 ) ) {
...
if ( V_84 )
goto V_88;
V_37 -> V_38 . V_190 . V_399 ( V_37 , V_37 -> V_38 . V_190 . V_222 ) ;
V_88:
return V_84 ;
}
...
{
F_258 ( V_37 ) ;
F_3 ( F_232 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
}
...
{
if ( V_52 -> V_94 . V_44 != V_45 ) {
++ V_37 -> V_11 -> V_135 . V_416 ;
return;
}
++ V_37 -> V_11 -> V_135 . V_417 ;
V_37 -> V_38 . V_190 . V_350 ( V_37 , V_52 , V_10 , V_415 ) ;
}
static bool F_322 ( T_1 V_418 , T_1 V_415 )
{
if ( ! F_23 ( V_418 ) )
return false ;
if ( ! F_23 ( V_415 ) )
...
static void F_323 ( struct V_36 * V_37 , bool V_420 ,
...
T_1 V_424 ;
int V_84 ;
if ( F_162 ( V_37 ) && * V_423 == 4 ) {
* V_344 &= ~ ( T_9 ) 7 ;
* V_423 = 8 ;
V_84 = F_325 ( V_37 -> V_11 , * V_344 , & V_424 , 8 ) ;
if ( V_84 )
V_424 = 0 ;
...
F_213 ( L_25 ,
V_344 , V_423 , V_52 -> V_94 . V_214 ) ;
V_425 = F_328 ( V_344 ) ;
V_426 = V_52 -> V_94 . V_189 ? 8 : 4 ;
...
static T_1 * F_329 ( struct V_51 * V_52 , T_9 V_344 , int * V_428 )
{
...
V_10 = & V_52 -> V_131 [ V_429 / sizeof( * V_10 ) ] ;
return V_10 ;
}
...
F_213 ( L_26 , V_162 , V_344 , V_423 ) ;
V_424 = F_324 ( V_37 , & V_344 , V_415 , & V_423 ) ;
F_69 ( V_37 ) ;
F_210 ( & V_37 -> V_11 -> V_200 ) ;
++ V_37 -> V_11 -> V_135 . V_432 ;
F_168 ( V_37 , V_433 ) ;
V_4 . V_405 = V_4 . V_189 = V_4 . V_404 = 1 ;
F_172 (vcpu->kvm, sp, gfn) {
if ( F_327 ( V_52 , V_344 , V_423 ) ||
F_326 ( V_52 ) ) {
V_420 |= ! ! F_163 ( V_37 -> V_11 , V_52 ,
& V_187 ) ;
++ V_37 -> V_11 -> V_135 . V_434 ;
continue;
}
V_10 = F_329 ( V_52 , V_344 , & V_431 ) ;
if ( ! V_10 )
continue;
V_422 = true ;
while ( V_431 -- ) {
...
& V_4 . V_214 ) && F_99 ( V_37 ) )
F_321 ( V_37 , V_52 , V_10 , & V_424 ) ;
if ( F_322 ( V_430 , * V_10 ) )
V_421 = true ;
++ V_10 ;
}
}
F_323 ( V_37 , V_420 , V_421 , V_422 ) ;
F_167 ( V_37 -> V_11 , & V_187 ) ;
F_168 ( V_37 , V_435 ) ;
F_211 ( & V_37 -> V_11 -> V_200 ) ;
}
...
{
F_166 ( V_187 ) ;
if ( F_18 ( F_333 ( V_37 -> V_11 ) >= V_436 ) )
return;
while ( F_333 ( V_37 -> V_11 ) < V_437 ) {
if ( ! F_207 ( V_37 -> V_11 , & V_187 ) )
break;
++ V_37 -> V_11 -> V_135 . V_438 ;
}
F_167 ( V_37 -> V_11 , & V_187 ) ;
}
...
int F_335 ( struct V_36 * V_37 , T_7 V_439 , T_4 V_304 ,
void * V_440 , int V_441 )
{
int V_84 , V_442 = V_443 ;
enum V_444 V_445 ;
V_84 = V_37 -> V_38 . V_190 . V_347 ( V_37 , V_439 , V_304 , false ) ;
if ( V_84 < 0 )
goto V_88;
if ( ! V_84 ) {
V_84 = 1 ;
...
if ( F_334 ( V_37 , V_439 ) )
V_442 = 0 ;
V_445 = F_336 ( V_37 , V_439 , V_442 , V_440 , V_441 ) ;
switch ( V_445 ) {
case V_446 :
return 1 ;
case V_447 :
...
{
ASSERT ( V_37 ) ;
V_37 -> V_38 . V_397 = & V_37 -> V_38 . V_190 ;
V_37 -> V_38 . V_190 . V_222 = V_313 ;
V_37 -> V_38 . V_190 . V_329 = V_329 ;
V_37 -> V_38 . V_328 . V_329 = V_451 ;
return F_341 ( V_37 ) ;
}
...
T_2 V_452 ;
int V_105 ;
V_150 = F_347 ( V_11 -> V_453 , V_100 ) ;
V_452 = V_150 -> V_102 + V_150 -> V_156 - 1 ;
F_210 ( & V_11 -> V_200 ) ;
for ( V_105 = V_45 ;
V_105 < V_45 + V_107 ; ++ V_105 ) {
unsigned long * V_130 ;
unsigned long V_454 , V_93 ;
V_130 = V_150 -> V_38 . V_129 [ V_105 - V_45 ] ;
V_454 = F_78 ( V_452 , V_150 -> V_102 , V_105 ) ;
for ( V_93 = 0 ; V_93 <= V_454 ; ++ V_93 , ++ V_130 ) {
if ( * V_130 )
F_109 ( V_11 , V_130 , false ) ;
...
{
return F_14 ( ! F_355 ( & V_11 -> V_38 . V_459 ) ) ;
}
...
F_358 ( struct V_461 * V_462 , struct V_463 * V_464 )
{
struct V_11 * V_11 ;
int V_465 = V_464 -> V_465 ;
...
V_469:
F_211 ( & V_11 -> V_200 ) ;
F_361 ( & V_11 -> V_468 , V_101 ) ;
F_362 ( & V_11 -> V_470 , & V_470 ) ;
break;
}
F_211 ( & V_467 ) ;
return V_466 ;
...
static unsigned long
F_363 ( struct V_461 * V_462 , struct V_463 * V_464 )
{
return F_364 ( & V_165 ) ;
}
