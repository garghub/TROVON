...
V_13 = F_56 ( V_66 [ 0 ] , V_66 [ 1 ] ) ;
V_14 = F_57 ( V_66 [ 0 ] , V_66 [ 1 ] ) ;
if ( V_13 < 98000000 )
V_13 = 101000000 ;
V_13 = ( V_13 * ( * V_67 ) ) / 2000 ;
V_14 = ( V_14 * ( * V_67 ) ) / 2000 ;
...
static int F_58 ( struct V_52 * V_60 )
{
struct V_52 * V_61 ;
