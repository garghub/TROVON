...
static struct V_96 * F_52 ( struct V_90
* V_104 )
{
...
static enum V_111 F_55 ( struct V_90
* V_104 , bool V_112 )
{
return V_113 ;
}
static void F_56 ( struct V_90 * V_104 )
{
F_57 ( V_104 ) ;
F_29 ( V_104 ) ;
}
static struct V_90 * F_58 ( struct V_4 * V_5 )
{
struct V_90 * V_104 ;
struct V_114 * V_114 ;
V_114 = F_31 ( sizeof( struct V_114 ) , V_91 ) ;
if ( ! V_114 )
return NULL ;
V_104 = & V_114 -> V_92 ;
F_59 ( V_5 , V_104 ,
...
F_62 ( V_7 -> V_5 ) ;
V_7 -> V_50 . V_118 = true ;
V_7 -> V_5 -> V_119 . V_120 = V_121 ;
V_7 -> V_5 -> V_119 . V_122 = V_123 ;
V_7 -> V_5 -> V_119 . V_124 = V_7 -> V_125 . V_126 ;
V_7 -> V_5 -> V_119 . V_127 = 24 ;
V_7 -> V_5 -> V_119 . V_128 = 0 ;
F_30 ( V_7 -> V_5 ) ;
V_97 = F_45 ( V_7 -> V_5 ) ;
if ( ! V_97 ) {
F_19 ( L_2 ) ;
