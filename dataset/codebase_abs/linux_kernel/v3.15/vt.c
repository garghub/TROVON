...
{
int V_79 ;
for ( V_79 = 0 ; V_79 <= V_5 -> V_181 ; V_79 ++ )
switch ( V_5 -> V_182 [ V_79 ] ) {
case 0 :
F_87 ( V_5 ) ;
break;
case 1 :
...
break;
default:
if ( V_5 -> V_182 [ V_79 ] >= 30 && V_5 -> V_182 [ V_79 ] <= 37 )
V_5 -> V_59 = V_190 [ V_5 -> V_182 [ V_79 ] - 30 ]
| ( V_5 -> V_59 & 0xf0 ) ;
else if ( V_5 -> V_182 [ V_79 ] >= 40 && V_5 -> V_182 [ V_79 ] <= 47 )
V_5 -> V_59 = ( V_190 [ V_5 -> V_182 [ V_79 ] - 40 ] << 4 )
| ( V_5 -> V_59 & 0x0f ) ;
break;
}
F_26 ( V_5 ) ;
}
static void F_90 ( const char * V_14 , struct V_191 * V_127 )
{
while ( * V_14 ) {
F_91 ( V_127 , * V_14 , 0 ) ;
V_14 ++ ;
...
{
char V_192 [ 40 ] ;
sprintf ( V_192 , L_2 , V_5 -> V_82 + ( V_5 -> V_177 ? V_5 -> V_158 + 1 : 1 ) , V_5 -> V_77 + 1 ) ;
F_90 ( V_192 , V_138 -> V_127 ) ;
}
static inline void F_94 ( struct V_137 * V_138 )
{
F_90 ( L_3 , V_138 -> V_127 ) ;
}
static inline void F_95 ( struct V_137 * V_138 )
{
F_90 ( V_193 , V_138 -> V_127 ) ;
}
...
break;
case 9 :
V_207 = ( ( V_5 -> V_182 [ 1 ] < 60 ) ? V_5 -> V_182 [ 1 ] : 60 ) * 60 ;
F_102 () ;
break;
case 10 :
if ( V_5 -> V_181 >= 1 )
V_5 -> V_208 = V_5 -> V_182 [ 1 ] ;
else
V_5 -> V_208 = V_209 ;
break;
case 11 :
if ( V_5 -> V_181 >= 1 )
V_5 -> V_210 = ( V_5 -> V_182 [ 1 ] < 2000 ) ?
V_5 -> V_182 [ 1 ] * V_211 / 1000 : 0 ;
else
V_5 -> V_210 = V_212 ;
break;
case 12 :
if ( V_5 -> V_182 [ 1 ] >= 1 && F_46 ( V_5 -> V_182 [ 1 ] - 1 ) )
F_103 ( V_5 -> V_182 [ 1 ] - 1 ) ;
break;
case 13 :
F_102 () ;
break;
case 14 :
V_213 = ( ( V_5 -> V_182 [ 1 ] < 60 ) ? V_5 -> V_182 [ 1 ] : 60 ) * 60 * V_211 ;
break;
case 15 :
F_103 ( V_214 ) ;
break;
...
V_5 -> V_185 = V_5 -> V_224 ;
V_5 -> V_186 = V_5 -> V_225 ;
V_5 -> V_183 = F_89 ( V_5 -> V_184 ? V_5 -> V_186 : V_5 -> V_185 , V_5 ) ;
F_26 ( V_5 ) ;
V_5 -> V_78 = 0 ;
}
...
{
if ( V_5 -> V_227 == V_236 && V_9 >= 8 && V_9 <= 13 )
return;
switch ( V_9 ) {
case 0 :
return;
...
case 14 :
V_5 -> V_184 = 1 ;
V_5 -> V_183 = F_89 ( V_5 -> V_186 , V_5 ) ;
V_5 -> V_187 = 1 ;
return;
case 15 :
V_5 -> V_184 = 0 ;
V_5 -> V_183 = F_89 ( V_5 -> V_185 , V_5 ) ;
V_5 -> V_187 = 0 ;
return;
case 24 : case 26 :
V_5 -> V_227 = V_228 ;
...
case V_239 :
if ( V_9 == 'P' ) {
for ( V_5 -> V_181 = 0 ; V_5 -> V_181 < V_245 ; V_5 -> V_181 ++ )
V_5 -> V_182 [ V_5 -> V_181 ] = 0 ;
V_5 -> V_181 = 0 ;
V_5 -> V_227 = V_246 ;
return;
} else if ( V_9 == 'R' ) {
...
case V_246 :
if ( isxdigit ( V_9 ) ) {
V_5 -> V_182 [ V_5 -> V_181 ++ ] = F_115 ( V_9 ) ;
if ( V_5 -> V_181 == 7 ) {
int V_79 = V_5 -> V_182 [ 0 ] * 3 , V_247 = 1 ;
V_5 -> V_248 [ V_79 ] = 16 * V_5 -> V_182 [ V_247 ++ ] ;
V_5 -> V_248 [ V_79 ++ ] += V_5 -> V_182 [ V_247 ++ ] ;
V_5 -> V_248 [ V_79 ] = 16 * V_5 -> V_182 [ V_247 ++ ] ;
V_5 -> V_248 [ V_79 ++ ] += V_5 -> V_182 [ V_247 ++ ] ;
V_5 -> V_248 [ V_79 ] = 16 * V_5 -> V_182 [ V_247 ++ ] ;
V_5 -> V_248 [ V_79 ] += V_5 -> V_182 [ V_247 ] ;
...
return;
case V_249 :
if ( V_9 == ';' && V_5 -> V_181 < V_245 - 1 ) {
V_5 -> V_181 ++ ;
return;
} else if ( V_9 >= '0' && V_9 <= '9' ) {
V_5 -> V_182 [ V_5 -> V_181 ] *= 10 ;
V_5 -> V_182 [ V_5 -> V_181 ] += V_9 - '0' ;
return;
}
V_5 -> V_227 = V_228 ;
switch( V_9 ) {
...
if ( V_5 -> V_199 ) {
if ( V_5 -> V_182 [ 0 ] )
V_5 -> V_80 = V_5 -> V_182 [ 0 ] | ( V_5 -> V_182 [ 1 ] << 8 ) | ( V_5 -> V_182 [ 2 ] << 16 ) ;
else
V_5 -> V_80 = V_234 ;
return;
}
...
F_35 () ;
if ( V_5 -> V_182 [ 0 ] )
V_5 -> V_75 = V_5 -> V_182 [ 0 ] << 8 | V_5 -> V_182 [ 1 ] ;
else
V_5 -> V_75 = V_5 -> V_119 ;
return;
}
...
if ( V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] -- ;
F_64 ( V_5 , V_5 -> V_182 [ 0 ] , V_5 -> V_82 ) ;
return;
case 'A' :
if ( ! V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] ++ ;
F_64 ( V_5 , V_5 -> V_77 , V_5 -> V_82 - V_5 -> V_182 [ 0 ] ) ;
return;
case 'B' : case 'e' :
if ( ! V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] ++ ;
...
if ( ! V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] ++ ;
F_64 ( V_5 , V_5 -> V_77 + V_5 -> V_182 [ 0 ] , V_5 -> V_82 ) ;
return;
case 'D' :
if ( ! V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] ++ ;
...
if ( ! V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] ++ ;
F_64 ( V_5 , 0 , V_5 -> V_82 + V_5 -> V_182 [ 0 ] ) ;
return;
case 'F' :
if ( ! V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] ++ ;
...
if ( V_5 -> V_182 [ 1 ] )
V_5 -> V_182 [ 1 ] -- ;
F_76 ( V_5 , V_5 -> V_182 [ 1 ] , V_5 -> V_182 [ 0 ] ) ;
return;
case 'J' :
F_84 ( V_5 , V_5 -> V_182 [ 0 ] ) ;
return;
case 'K' :
F_85 ( V_5 , V_5 -> V_182 [ 0 ] ) ;
return;
case 'L' :
F_105 ( V_5 , V_5 -> V_182 [ 0 ] ) ;
return;
case 'M' :
F_107 ( V_5 , V_5 -> V_182 [ 0 ] ) ;
return;
case 'P' :
F_106 ( V_5 , V_5 -> V_182 [ 0 ] ) ;
return;
case 'c' :
if ( ! V_5 -> V_182 [ 0 ] )
F_95 ( V_138 ) ;
...
if ( V_5 -> V_182 [ 0 ] < 4 )
F_116 ( V_5 -> V_102 ,
( V_5 -> V_182 [ 0 ] < 3 ) ? V_5 -> V_182 [ 0 ] : 4 ) ;
return;
case 'r' :
if ( ! V_5 -> V_182 [ 0 ] )
V_5 -> V_182 [ 0 ] ++ ;
if ( ! V_5 -> V_182 [ 1 ] )
V_5 -> V_182 [ 1 ] = V_5 -> V_27 ;
if ( V_5 -> V_182 [ 0 ] < V_5 -> V_182 [ 1 ] &&
V_5 -> V_182 [ 1 ] <= V_5 -> V_27 ) {
V_5 -> V_158 = V_5 -> V_182 [ 0 ] - 1 ;
V_5 -> V_159 = V_5 -> V_182 [ 1 ] ;
F_76 ( V_5 , 0 , 0 ) ;
}
return;
case 's' :
...
return;
case 'X' :
F_86 ( V_5 , V_5 -> V_182 [ 0 ] ) ;
return;
case '@' :
F_104 ( V_5 , V_5 -> V_182 [ 0 ] ) ;
return;
case ']' :
F_101 ( V_5 ) ;
return;
...
if ( ( ! ( V_5 -> V_231 && ! V_5 -> V_187 ) || V_9 < 128 ) && ! ( V_9 & ~ V_269 ) ) {
V_260 = V_9 ;
} else {
...
V_5 -> V_76 = V_5 -> V_15 ;
F_166 ( V_5 ) ;
for ( V_247 = V_335 = 0 ; V_247 < 16 ; V_247 ++ ) {
V_5 -> V_248 [ V_335 ++ ] = V_336 [ V_247 ] ;
V_5 -> V_248 [ V_335 ++ ] = V_337 [ V_247 ] ;
V_5 -> V_248 [ V_335 ++ ] = V_338 [ V_247 ] ;
}
V_5 -> V_180 = V_339 ;
V_5 -> V_56 = V_340 ;
V_5 -> V_55 = V_341 ;
...
if ( V_207 ) {
V_351 = V_352 ;
F_168 ( & V_353 , V_354 + ( V_207 * V_211 ) ) ;
}
for ( V_120 = 0 ; V_120 < V_355 ; V_120 ++ ) {
V_99 [ V_120 ] . V_25 = V_5 = F_53 ( sizeof( struct V_4 ) , V_356 ) ;
F_55 ( & V_99 [ V_120 ] . V_128 , V_129 ) ;
F_54 ( & V_5 -> V_127 ) ;
F_47 ( V_5 , V_120 , 1 ) ;
V_5 -> V_92 = F_53 ( V_5 -> V_72 , V_356 ) ;
...
static T_9 F_172 ( struct V_358 * V_359 ,
struct V_360 * V_361 , char * V_192 )
{
return sprintf ( V_192 , L_10 , V_100 + 1 ) ;
}
int T_8 F_173 ( const struct V_362 * V_363 )
{
F_174 ( & V_364 , V_363 ) ;
if ( F_175 ( & V_364 , F_176 ( V_365 , 0 ) , 1 ) ||
F_177 ( F_176 ( V_365 , 0 ) , 1 , L_11 ) < 0 )
F_178 ( L_12 ) ;
V_103 = F_179 ( V_366 , NULL , F_176 ( V_365 , 0 ) , NULL , L_13 ) ;
if ( F_180 ( V_103 ) )
V_103 = NULL ;
else
F_181 ( F_182 ( V_103 , & V_367 ) < 0 ) ;
F_183 () ;
V_301 = F_184 ( V_108 ) ;
if ( ! V_301 )
F_178 ( L_14 ) ;
...
V_301 -> V_373 = V_374 ;
if ( V_232 )
V_301 -> V_373 . V_331 |= V_332 ;
V_301 -> V_375 = V_376 | V_377 ;
F_185 ( V_301 , & V_378 ) ;
if ( F_186 ( V_301 ) )
F_178 ( L_16 ) ;
F_187 () ;
...
static int F_191 ( const struct V_379 * V_380 , int V_257 , int V_258 ,
int V_381 )
{
struct V_382 * V_111 = V_380 -> V_111 ;
const char * V_348 = NULL ;
struct V_345 * V_345 ;
int V_79 , V_247 = - 1 , V_335 = - 1 , V_323 = - V_383 ;
if ( ! F_192 ( V_111 ) )
return - V_383 ;
F_21 () ;
for ( V_79 = 0 ; V_79 < V_344 ; V_79 ++ ) {
V_345 = & V_346 [ V_79 ] ;
if ( V_345 -> V_347 == V_380 ) {
V_348 = V_345 -> V_348 ;
V_323 = 0 ;
break;
}
...
V_257 = V_255 ( V_257 , V_345 -> V_257 ) ;
V_258 = F_63 ( V_258 , V_345 -> V_258 ) ;
...
static int F_193 ( const struct V_379 * V_380 , int V_257 , int V_258 )
{
int V_79 , V_323 = 0 ;
for ( V_79 = V_257 ; V_79 <= V_258 ; V_79 ++ ) {
struct V_4 * V_5 = V_99 [ V_79 ] . V_25 ;
...
int F_194 ( const struct V_379 * V_380 , int V_257 , int V_258 , int V_381 )
{
struct V_382 * V_111 = V_380 -> V_111 ;
const struct V_379 * V_384 = NULL ;
struct V_345 * V_345 = NULL , * V_385 = NULL ;
int V_79 , V_323 = - V_383 ;
if ( ! F_192 ( V_111 ) )
return - V_383 ;
F_21 () ;
for ( V_79 = 0 ; V_79 < V_344 ; V_79 ++ ) {
...
if ( ! F_195 ( V_384 ) ) {
const struct V_379 * V_387 = V_112 ;
V_384 -> V_343 () ;
V_385 -> V_349 |= V_350 ;
V_112 = V_387 ;
}
if ( ! F_195 ( V_380 ) )
V_345 -> V_349 &= ~ V_350 ;
F_191 ( V_384 , V_257 , V_258 , V_381 ) ;
V_135:
F_48 ( V_111 ) ;
return V_323 ;
}
static int F_196 ( struct V_345 * V_347 )
{
const struct V_379 * V_384 = NULL , * V_380 = NULL ;
int V_79 , V_388 = 1 , V_257 = - 1 , V_258 = - 1 , V_381 = 0 ;
if ( ! V_347 -> V_347 || ! ( V_347 -> V_349 & V_386 ) ||
F_193 ( V_347 -> V_347 , V_347 -> V_257 , V_347 -> V_258 ) )
goto V_135;
V_380 = V_347 -> V_347 ;
for ( V_79 = 0 ; V_79 < V_344 ; V_79 ++ ) {
...
while ( V_388 ) {
V_388 = 0 ;
for ( V_79 = V_347 -> V_257 ; V_79 <= V_347 -> V_258 ; V_79 ++ ) {
if ( V_113 [ V_79 ] == V_384 ) {
if ( V_257 == - 1 )
V_257 = V_79 ;
V_258 = V_79 ;
...
static int F_197 ( struct V_345 * V_347 )
{
...
static inline int F_196 ( struct V_345 * V_347 )
{
return 0 ;
}
static inline int F_197 ( struct V_345 * V_347 )
{
return 0 ;
}
static T_9 F_198 ( struct V_358 * V_359 , struct V_360 * V_361 ,
const char * V_192 , T_10 V_36 )
{
struct V_345 * V_347 = F_199 ( V_359 ) ;
int V_389 = F_200 ( V_192 , NULL , 0 ) ;
if ( V_389 )
F_196 ( V_347 ) ;
else
F_197 ( V_347 ) ;
...
static T_9 F_201 ( struct V_358 * V_359 , struct V_360 * V_361 ,
char * V_192 )
{
struct V_345 * V_347 = F_199 ( V_359 ) ;
int V_389 = F_195 ( V_347 -> V_347 ) ;
return snprintf ( V_192 , V_390 , L_21 , V_389 ) ;
}
static T_9 F_202 ( struct V_358 * V_359 , struct V_360 * V_361 ,
char * V_192 )
{
struct V_345 * V_347 = F_199 ( V_359 ) ;
return snprintf ( V_192 , V_390 , L_22 ,
( V_347 -> V_349 & V_386 ) ? L_23 : L_24 ,
V_347 -> V_348 ) ;
}
static int F_203 ( struct V_345 * V_347 )
{
int V_79 ;
int error = 0 ;
V_347 -> V_349 |= V_391 ;
F_204 ( V_347 -> V_359 , V_347 ) ;
for ( V_79 = 0 ; V_79 < F_119 ( V_392 ) ; V_79 ++ ) {
error = F_182 ( V_347 -> V_359 , & V_392 [ V_79 ] ) ;
if ( error )
break;
}
if ( error ) {
while ( -- V_79 >= 0 )
F_205 ( V_347 -> V_359 , & V_392 [ V_79 ] ) ;
V_347 -> V_349 &= ~ V_391 ;
}
return error ;
}
static void F_206 ( struct V_345 * V_347 )
{
int V_79 ;
if ( V_347 -> V_349 & V_391 ) {
for ( V_79 = 0 ; V_79 < F_119 ( V_392 ) ; V_79 ++ )
F_205 ( V_347 -> V_359 , & V_392 [ V_79 ] ) ;
V_347 -> V_349 &= ~ V_391 ;
}
}
int F_195 ( const struct V_379 * V_380 )
{
int V_79 , V_393 = 0 ;
for ( V_79 = 0 ; V_79 < V_108 ; V_79 ++ ) {
if ( V_113 [ V_79 ] == V_380 ) {
...
if ( F_209 ( V_401 [ 0 ] , & V_399 ) ) {
snprintf ( V_400 , 4 , L_27 , V_5 -> V_27 ) ;
F_210 ( 2 , V_401 ) ;
}
}
if ( V_5 -> V_31 < 999 ) {
...
V_282 = V_396 ;
V_86 = V_398 ;
V_99 [ V_100 ] . V_25 -> V_87 = V_397 ;
V_5 = V_99 [ V_100 ] . V_25 ;
if ( V_5 -> V_16 -> F_211 )
V_169 = V_5 -> V_16 -> F_211 ( V_5 ) ;
return V_169 ;
}
static int F_212 ( const struct V_379 * V_380 , int V_257 , int V_258 )
{
struct V_382 * V_111 = V_380 -> V_111 ;
struct V_345 * V_345 ;
const char * V_348 ;
...
if ( V_323 )
goto V_135;
V_345 -> V_359 = F_179 ( V_405 , NULL ,
F_176 ( 0 , V_345 -> V_404 ) ,
NULL , L_29 ,
V_345 -> V_404 ) ;
if ( F_180 ( V_345 -> V_359 ) ) {
F_124 ( V_406 L_30
L_31 , V_345 -> V_348 ,
F_213 ( V_345 -> V_359 ) ) ;
V_345 -> V_359 = NULL ;
...
int F_214 ( const struct V_379 * V_380 )
{
int V_79 , V_323 = - V_383 ;
if ( F_195 ( V_380 ) )
goto V_135;
...
int F_216 ( const struct V_379 * V_380 , int V_257 , int V_258 , int V_381 )
{
int V_135 ;
V_135 = F_212 ( V_380 , V_257 , V_258 ) ;
if ( V_135 == - V_403 )
V_135 = 0 ;
if ( ! V_135 )
F_191 ( V_380 , V_257 , V_258 , V_381 ) ;
...
void F_217 ( const struct V_379 * V_380 )
{
F_71 () ;
F_214 ( V_380 ) ;
F_72 () ;
...
for ( V_79 = 0 ; V_79 < V_344 ; V_79 ++ ) {
struct V_345 * V_347 = & V_346 [ V_79 ] ;
if ( V_347 -> V_347 && ! V_347 -> V_359 ) {
V_347 -> V_359 = F_179 ( V_405 , NULL ,
F_176 ( 0 , V_347 -> V_404 ) ,
NULL , L_29 ,
V_347 -> V_404 ) ;
if ( F_180 ( V_347 -> V_359 ) ) {
F_124 ( V_406 L_34
L_35 ,
V_347 -> V_348 , F_213 ( V_347 -> V_359 ) ) ;
V_347 -> V_359 = NULL ;
} else {
F_203 ( V_347 ) ;
}
...
return - V_306 ;
V_408 = ( V_289 < 4 ) ? V_289 : 0 ;
return 0 ;
}
void F_130 ( int V_409 )
{
struct V_4 * V_5 = V_99 [ V_100 ] . V_25 ;
int V_79 ;
F_21 () ;
...
V_286 = 0 ;
F_38 ( V_5 ) ;
V_79 = V_5 -> V_16 -> V_412 ( V_5 , V_213 ? 1 : ( V_408 + 1 ) , 0 ) ;
V_86 = V_100 + 1 ;
if ( V_79 )
F_37 ( V_5 ) ;
if ( V_413 && V_413 ( 1 ) )
...
if ( V_213 && V_408 ) {
V_351 = V_410 ;
F_168 ( & V_353 , V_354 + V_213 ) ;
}
F_68 ( V_414 , V_5 -> V_102 , V_5 -> V_102 ) ;
}
void F_221 ( int V_415 )
{
struct V_4 * V_5 ;
if ( ! V_416 )
F_123 () ;
...
V_86 = 0 ;
if ( V_5 -> V_16 -> V_412 ( V_5 , 0 , V_415 ) || F_43 ( V_5 ) )
F_67 ( V_5 ) ;
if ( V_413 )
V_413 ( 0 ) ;
F_42 ( V_5 ) ;
F_24 ( V_5 ) ;
F_68 ( V_417 , V_5 -> V_102 , V_5 -> V_102 ) ;
}
void F_143 ( void )
{
F_221 ( 0 ) ;
}
static void F_223 ( unsigned long V_418 )
{
if ( F_224 ( ! F_225 () ) ) {
F_168 ( & V_353 , V_354 + ( V_207 * V_211 ) ) ;
return;
...
F_21 () ;
if ( V_5 -> V_87 != V_88 )
V_5 -> V_16 -> V_419 ( V_5 , V_190 ) ;
}
int F_227 ( unsigned char T_7 * V_302 )
{
int V_79 , V_247 , V_335 ;
unsigned char V_420 [ 3 * 16 ] ;
if ( F_228 ( V_420 , V_302 , sizeof( V_420 ) ) )
return - V_306 ;
F_71 () ;
for ( V_79 = V_335 = 0 ; V_79 < 16 ; V_79 ++ ) {
V_336 [ V_79 ] = V_420 [ V_335 ++ ] ;
V_337 [ V_79 ] = V_420 [ V_335 ++ ] ;
V_338 [ V_79 ] = V_420 [ V_335 ++ ] ;
}
for ( V_79 = 0 ; V_79 < V_108 ; V_79 ++ ) {
if ( ! F_46 ( V_79 ) )
continue;
for ( V_247 = V_335 = 0 ; V_247 < 16 ; V_247 ++ ) {
V_99 [ V_79 ] . V_25 -> V_248 [ V_335 ++ ] = V_336 [ V_247 ] ;
V_99 [ V_79 ] . V_25 -> V_248 [ V_335 ++ ] = V_337 [ V_247 ] ;
V_99 [ V_79 ] . V_25 -> V_248 [ V_335 ++ ] = V_338 [ V_247 ] ;
}
F_42 ( V_99 [ V_79 ] . V_25 ) ;
}
F_72 () ;
...
F_71 () ;
for ( V_79 = V_335 = 0 ; V_79 < 16 ; V_79 ++ ) {
V_420 [ V_335 ++ ] = V_336 [ V_79 ] ;
V_420 [ V_335 ++ ] = V_337 [ V_79 ] ;
V_420 [ V_335 ++ ] = V_338 [ V_79 ] ;
}
F_72 () ;
if ( F_230 ( V_302 , V_420 , sizeof( V_420 ) ) )
return - V_306 ;
return 0 ;
}
...
static int F_231 ( struct V_4 * V_5 , struct V_421 * V_422 )
{
struct V_423 V_424 ;
int V_425 = - V_156 ;
int V_9 ;
if ( V_422 -> V_303 ) {
V_424 . V_303 = F_57 ( V_426 , V_125 ) ;
if ( ! V_424 . V_303 )
return - V_126 ;
} else
V_424 . V_303 = NULL ;
...
V_425 = V_5 -> V_16 -> F_231 ( V_5 , & V_424 ) ;
else
V_425 = - V_427 ;
F_72 () ;
if ( V_425 )
goto V_428;
V_9 = ( V_424 . V_132 + 7 ) / 8 * 32 * V_424 . V_429 ;
if ( V_422 -> V_303 && V_424 . V_429 > V_422 -> V_429 )
V_425 = - V_430 ;
if ( ! ( V_422 -> V_375 & V_431 ) ) {
if ( V_424 . V_132 > V_422 -> V_132 || V_424 . V_133 > V_422 -> V_133 )
V_425 = - V_430 ;
} else {
if ( V_424 . V_132 != 8 )
V_425 = - V_432 ;
else if ( ( V_422 -> V_133 && V_424 . V_133 > V_422 -> V_133 ) ||
V_424 . V_133 > 32 )
V_425 = - V_430 ;
}
if ( V_425 )
goto V_428;
V_422 -> V_133 = V_424 . V_133 ;
V_422 -> V_132 = V_424 . V_132 ;
V_422 -> V_429 = V_424 . V_429 ;
if ( V_422 -> V_303 && F_230 ( V_422 -> V_303 , V_424 . V_303 , V_9 ) )
V_425 = - V_306 ;
V_428:
F_58 ( V_424 . V_303 ) ;
return V_425 ;
}
static int F_232 ( struct V_4 * V_5 , struct V_421 * V_422 )
{
struct V_423 V_424 ;
int V_425 = - V_156 ;
int V_433 ;
...
if ( ! V_422 -> V_133 ) {
int V_434 , V_79 ;
T_2 T_7 * V_435 = V_422 -> V_303 ;
T_2 V_436 ;
if ( ! ( V_422 -> V_375 & V_431 ) )
return - V_156 ;
for ( V_434 = 32 ; V_434 > 0 ; V_434 -- )
for ( V_79 = 0 ; V_79 < V_422 -> V_429 ; V_79 ++ ) {
if ( F_140 ( V_436 , & V_435 [ 32 * V_79 + V_434 - 1 ] ) )
return - V_306 ;
if ( V_436 )
goto V_437;
}
...
if ( V_422 -> V_132 <= 0 || V_422 -> V_132 > 32 || V_422 -> V_133 > 32 )
return - V_156 ;
V_433 = ( V_422 -> V_132 + 7 ) / 8 * 32 * V_422 -> V_429 ;
if ( V_433 > V_426 )
return - V_430 ;
V_424 . V_429 = V_422 -> V_429 ;
V_424 . V_133 = V_422 -> V_133 ;
V_424 . V_132 = V_422 -> V_132 ;
V_424 . V_303 = F_233 ( V_422 -> V_303 , V_433 ) ;
if ( F_180 ( V_424 . V_303 ) )
return F_213 ( V_424 . V_303 ) ;
F_71 () ;
if ( V_5 -> V_87 != V_284 )
V_425 = - V_156 ;
else if ( V_5 -> V_16 -> F_232 )
V_425 = V_5 -> V_16 -> F_232 ( V_5 , & V_424 , V_422 -> V_375 ) ;
else
V_425 = - V_427 ;
F_72 () ;
F_58 ( V_424 . V_303 ) ;
...
static int F_234 ( struct V_4 * V_5 , struct V_421 * V_422 )
{
struct V_423 V_424 = { . V_132 = V_422 -> V_132 , . V_133 = V_422 -> V_133 } ;
char V_368 [ V_438 ] ;
char * V_26 = V_368 ;
int V_425 ;
if ( ! V_422 -> V_303 )
V_26 = NULL ;
else if ( F_235 ( V_368 , V_422 -> V_303 , V_438 - 1 ) < 0 )
return - V_306 ;
else
V_368 [ V_438 - 1 ] = 0 ;
F_71 () ;
...
if ( V_5 -> V_16 -> F_234 )
V_425 = V_5 -> V_16 -> F_234 ( V_5 , & V_424 , V_26 ) ;
else
V_425 = - V_427 ;
F_72 () ;
if ( ! V_425 ) {
...
static int F_236 ( struct V_4 * V_5 , struct V_421 * V_422 )
{
int V_347 = V_422 -> V_133 ;
int V_425 ;
F_71 () ;
if ( V_5 -> V_87 != V_284 )
V_425 = - V_156 ;
...
V_425 = V_5 -> V_16 -> F_236 ( V_5 , V_347 ) ;
F_72 () ;
return V_425 ;
}
int F_237 ( struct V_4 * V_5 , struct V_421 * V_422 )
{
switch ( V_422 -> V_422 ) {
case V_440 :
return F_232 ( V_5 , V_422 ) ;
case V_441 :
return F_231 ( V_5 , V_422 ) ;
case V_442 :
return F_234 ( V_5 , V_422 ) ;
case V_443 :
return F_236 ( V_5 , V_422 ) ;
}
return - V_427 ;
}
T_1 F_238 ( struct V_4 * V_5 , int V_12 )
{
T_1 V_444 = F_19 ( F_8 ( V_5 , V_12 , 1 ) ) ;
T_1 V_9 = V_444 & 0xff ;
if ( V_444 & V_5 -> V_57 )
V_9 |= 0x100 ;
return V_9 ;
}
unsigned short * F_239 ( struct V_4 * V_5 , int V_445 , int V_13 )
{
return F_8 ( V_5 , 2 * V_445 , V_13 ) ;
}
...
T_1 F_242 ( struct V_4 * V_5 , const T_1 * V_446 )
{
if ( ( unsigned long ) V_446 == V_5 -> V_76 && V_81 != - 1 )
return V_81 ;
return F_19 ( V_446 ) ;
}
void F_243 ( struct V_4 * V_5 , T_1 V_447 , T_1 * V_446 )
{
F_28 ( V_447 , V_446 ) ;
if ( ( unsigned long ) V_446 == V_5 -> V_76 ) {
V_81 = - 1 ;
F_33 ( V_5 ) ;
}
}
