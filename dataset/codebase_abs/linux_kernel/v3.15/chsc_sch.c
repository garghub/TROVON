...
{
V_32 = F_28 ( L_5 , 8 , 1 , 4 * sizeof( long ) ) ;
if ( ! V_32 )
goto V_33;
F_29 ( V_32 , & V_34 ) ;
F_30 ( V_32 , 2 ) ;
...
V_78 = F_12 ( sizeof( * V_78 ) , V_23 ) ;
if ( ! V_78 ) {
V_20 = - V_24 ;
goto V_77;
}
V_76 = ( void * ) F_50 ( V_70 | V_23 ) ;
if ( ! V_76 ) {
V_20 = - V_24 ;
goto V_79;
}
if ( F_52 ( V_76 , V_66 , V_72 ) ) {
V_20 = - V_73 ;
goto V_80;
}
V_20 = 0 ;
...
static int F_62 ( void T_2 * V_66 )
{
struct V_82 * V_42 ;
int V_20 , V_83 ;
V_42 = ( void * ) F_50 ( V_23 | V_70 ) ;
if ( ! V_42 )
return - V_24 ;
if ( F_52 ( V_42 , V_66 , V_72 ) ) {
V_20 = - V_73 ;
...
V_98 = ( void * ) F_50 ( V_23 | V_70 ) ;
if ( ! V_98 )
return - V_24 ;
V_88 = F_12 ( sizeof( * V_88 ) , V_23 ) ;
if ( ! V_88 ) {
V_20 = - V_24 ;
goto V_71;
}
if ( F_52 ( V_88 , V_86 , sizeof( * V_88 ) ) ) {
V_20 = - V_73 ;
goto V_71;
}
...
V_71:
F_15 ( V_88 ) ;
F_57 ( ( unsigned long ) V_106 ) ;
return V_20 ;
}
static int F_65 ( void T_2 * V_109 )
{
struct V_110 * V_111 ;
int V_20 , V_83 ;
struct {
...
V_114 = ( void * ) F_50 ( V_23 | V_70 ) ;
if ( ! V_114 )
return - V_24 ;
V_111 = F_12 ( sizeof( * V_111 ) , V_23 ) ;
if ( ! V_111 ) {
V_20 = - V_24 ;
goto V_71;
}
if ( F_52 ( V_111 , V_109 , sizeof( * V_111 ) ) ) {
V_20 = - V_73 ;
goto V_71;
}
...
if ( F_56 ( V_109 , V_111 , sizeof( * V_111 ) ) )
V_20 = - V_73 ;
else
V_20 = 0 ;
V_71:
F_15 ( V_111 ) ;
F_57 ( ( unsigned long ) V_114 ) ;
return V_20 ;
}
static int F_66 ( void T_2 * V_116 )
{
struct V_117 * V_118 ;
int V_20 , V_83 ;
struct {
...
V_120 = ( void * ) F_50 ( V_23 | V_70 ) ;
if ( ! V_120 )
return - V_24 ;
V_118 = F_12 ( sizeof( * V_118 ) , V_23 ) ;
if ( ! V_118 ) {
V_20 = - V_24 ;
goto V_71;
}
if ( F_52 ( V_118 , V_116 , sizeof( * V_118 ) ) ) {
V_20 = - V_73 ;
goto V_71;
}
...
if ( F_56 ( V_116 , V_118 , sizeof( * V_118 ) ) )
V_20 = - V_73 ;
else
V_20 = 0 ;
V_71:
F_15 ( V_118 ) ;
F_57 ( ( unsigned long ) V_120 ) ;
return V_20 ;
}
static int F_67 ( void T_2 * V_122 )
{
struct V_123 * V_124 ;
int V_20 , V_83 ;
struct {
...
V_127 = ( void * ) F_50 ( V_23 | V_70 ) ;
if ( ! V_127 )
return - V_24 ;
V_124 = F_12 ( sizeof( * V_124 ) , V_23 ) ;
if ( ! V_124 ) {
V_20 = - V_24 ;
goto V_71;
}
if ( F_52 ( V_124 , V_122 , sizeof( * V_124 ) ) ) {
V_20 = - V_73 ;
goto V_71;
}
...
if ( F_56 ( V_122 , V_124 , sizeof( * V_124 ) ) )
V_20 = - V_73 ;
else
V_20 = 0 ;
V_71:
F_15 ( V_124 ) ;
F_57 ( ( unsigned long ) V_127 ) ;
return V_20 ;
}
static int F_68 ( void T_2 * V_141 )
{
struct V_142 * V_143 ;
struct V_144 * V_145 ;
int V_20 ;
V_145 = F_12 ( sizeof( * V_145 ) , V_23 ) ;
V_143 = ( void * ) F_50 ( V_23 | V_70 ) ;
if ( ! V_143 || ! V_145 ) {
V_20 = - V_24 ;
goto V_71;
}
if ( F_52 ( V_145 , V_141 , sizeof( * V_145 ) ) ) {
V_20 = - V_73 ;
goto V_71;
}
V_20 = F_69 ( V_145 -> V_100 , V_145 -> V_99 ,
V_145 -> V_146 , V_145 -> V_147 , V_145 -> V_90 ,
V_143 ) ;
if ( V_20 )
goto V_71;
memcpy ( & V_145 -> V_148 , & V_143 -> V_95 , V_143 -> V_95 . V_3 ) ;
if ( F_56 ( V_141 , V_145 , sizeof( * V_145 ) ) )
V_20 = - V_73 ;
V_71:
F_15 ( V_145 ) ;
F_57 ( ( unsigned long ) V_143 ) ;
return V_20 ;
}
static int F_70 ( void T_2 * V_149 )
{
struct V_150 * V_151 ;
int V_20 , V_83 ;
struct {
...
V_155 = ( void * ) F_50 ( V_23 | V_70 ) ;
if ( ! V_155 )
return - V_24 ;
V_151 = F_12 ( sizeof( * V_151 ) , V_23 ) ;
if ( ! V_151 ) {
V_20 = - V_24 ;
goto V_71;
}
if ( F_52 ( V_151 , V_149 , sizeof( * V_151 ) ) ) {
V_20 = - V_73 ;
goto V_71;
}
...
V_155 -> V_95 . V_3 ) ;
if ( F_56 ( V_149 , V_151 , sizeof( * V_151 ) ) )
V_20 = - V_73 ;
else
V_20 = 0 ;
V_71:
F_15 ( V_151 ) ;
F_57 ( ( unsigned long ) V_155 ) ;
return V_20 ;
}
static long F_71 ( struct V_157 * V_158 , unsigned int V_51 ,
unsigned long V_159 )
{
void T_2 * V_160 ;
F_7 ( 2 , L_20 , V_51 ) ;
...
static int F_74 ( struct V_173 * V_173 , struct V_157 * V_157 )
{
if ( ! F_75 ( & V_174 ) ) {
F_76 ( & V_174 ) ;
return - V_49 ;
}
return F_77 ( V_173 , V_157 ) ;
}
static int F_78 ( struct V_173 * V_173 , struct V_157 * V_158 )
{
char V_44 [ 13 ] ;
int V_20 ;
F_59 ( & V_75 ) ;
