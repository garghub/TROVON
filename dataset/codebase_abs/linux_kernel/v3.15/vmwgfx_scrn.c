...
V_2 -> V_11 = false ;
V_2 -> V_3 . V_74 = ( V_32 == 0 ) ;
V_2 -> V_3 . V_75 = V_17 -> V_76 ;
V_2 -> V_3 . V_77 = V_17 -> V_78 ;
V_2 -> V_3 . V_79 = NULL ;
V_2 -> V_3 . V_16 = true ;
F_32 ( V_68 , V_62 , & V_80 ,
V_81 ) ;
V_62 -> V_82 = F_33 ( V_62 , true ) ;
F_34 ( V_68 , V_64 , & V_83 ,
V_84 ) ;
F_35 ( V_62 , V_64 ) ;
V_64 -> V_85 = ( 1 << V_32 ) ;
...
V_48 = - V_28 ;
V_17 -> V_10 = F_42 ( sizeof( * V_17 -> V_10 ) , V_56 ) ;
if ( F_11 ( ! V_17 -> V_10 ) )
goto V_94;
V_17 -> V_10 -> V_12 = 0 ;
V_17 -> V_10 -> V_13 = NULL ;
...
void F_48 ( struct V_6 * V_17 ,
struct V_4 * V_5 )
{
struct V_1 * V_2 = F_5 ( V_5 ) ;
F_8 ( ! V_2 -> V_3 . V_16 ) ;
V_17 -> V_10 -> V_13 =
F_25 ( V_2 -> V_3 . V_5 . V_71 -> V_66 ) ;
}
