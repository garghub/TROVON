...
{
int V_2 , V_54 ;
V_1 -> V_5 . V_84 = F_40 ( V_1 -> V_8 -> V_85 ,
L_55 , 0 ) ;
if ( V_1 -> V_5 . V_84 < 0 )
V_1 -> V_5 . V_84 = 0 ;
V_1 -> V_5 . V_86 = F_40 ( V_1 -> V_8 -> V_85 ,
L_56 , 0 ) ;
if ( V_1 -> V_5 . V_86 < 0 )
V_1 -> V_5 . V_86 = 0 ;
V_2 = F_41 ( V_1 -> V_8 -> V_85 ,
L_57 ,
V_1 -> V_5 . V_87 ,
F_42 ( V_1 -> V_5 . V_87 ) ) ;
if ( V_2 >= 0 ) {
for ( V_54 = 0 ; V_54 < F_42 ( V_1 -> V_5 . V_87 ) ; V_54 ++ ) {
if ( V_1 -> V_5 . V_87 [ V_54 ] > 0xffff )
V_1 -> V_5 . V_87 [ V_54 ] = 0 ;
else if ( V_1 -> V_5 . V_87 [ V_54 ] == 0 )
V_1 -> V_5 . V_87 [ V_54 ] = 0x10000 ;
}
} else {
F_10 ( V_1 -> V_8 , L_58 ,
V_2 ) ;
...
int (* F_44)( struct V_1 * ) = NULL ;
int V_2 , V_54 ;
F_45 ( V_1 -> V_8 , V_1 ) ;
F_46 ( & V_1 -> V_3 ) ;
if ( F_47 ( V_1 -> V_8 ) )
memcpy ( & V_1 -> V_5 , F_47 ( V_1 -> V_8 ) ,
sizeof( V_1 -> V_5 ) ) ;
else
F_39 ( V_1 ) ;
F_25 ( V_1 -> V_10 , true ) ;
...
case V_89 :
case V_90 :
for ( V_54 = 0 ; V_54 < F_42 ( V_91 ) ; V_54 ++ )
V_1 -> V_92 [ V_54 ] . V_93
= V_91 [ V_54 ] ;
V_1 -> V_94 = F_42 ( V_91 ) ;
break;
...
V_2 = F_48 ( V_1 -> V_8 , - 1 , V_96 ,
F_42 ( V_96 ) , NULL , 0 , NULL ) ;
if ( V_2 != 0 ) {
F_10 ( V_8 , L_60 , V_2 ) ;
return V_2 ;
}
V_2 = F_49 ( V_8 , V_1 -> V_94 ,
V_1 -> V_92 ) ;
if ( V_2 != 0 ) {
F_10 ( V_8 , L_61 ,
V_2 ) ;
...
F_59 ( V_8 , L_81 , V_88 , V_1 -> V_104 + 'A' ) ;
if ( F_44 ) {
V_2 = F_44 ( V_1 ) ;
if ( V_2 != 0 ) {
F_10 ( V_1 -> V_8 , L_46 ,
...
for ( V_54 = 0 ; V_54 < F_42 ( V_1 -> V_5 . V_87 ) ; V_54 ++ ) {
if ( ! V_1 -> V_5 . V_87 [ V_54 ] )
continue;
F_18 ( V_1 -> V_10 , V_108 + V_54 ,
V_1 -> V_5 . V_87 [ V_54 ] ) ;
}
if ( V_1 -> V_5 . V_109 &&
V_1 -> V_5 . V_109 -> V_110 == 0 )
V_1 -> V_78 = true ;
F_60 ( V_1 -> V_8 , 100 ) ;
F_61 ( V_1 -> V_8 ) ;
F_62 ( V_1 -> V_8 ) ;
...
if ( ! V_1 -> V_5 . V_115 [ V_54 ] . V_116 &&
! V_1 -> V_5 . V_115 [ V_54 ] . V_117 )
continue;
if ( ! V_1 -> V_5 . V_115 [ V_54 ] . V_116 )
V_1 -> V_5 . V_115 [ V_54 ] . V_116 = 2800 ;
V_16 = ( V_1 -> V_5 . V_115 [ V_54 ] . V_116 - 1500 ) / 100 ;
V_16 <<= V_118 ;
if ( V_1 -> V_5 . V_115 [ V_54 ] . V_119 )
V_16 |= V_120 ;
if ( V_1 -> V_5 . V_115 [ V_54 ] . V_121 )
V_16 |= V_122 ;
if ( V_1 -> V_5 . V_115 [ V_54 ] . V_123 )
V_16 |= V_124 ;
if ( V_1 -> V_5 . V_115 [ V_54 ] . V_117 )
V_16 |= V_125 ;
F_4 ( V_1 -> V_10 ,
V_126 + V_54 ,
V_127 |
...
V_16 = V_1 -> V_5 . V_129 [ V_54 ]
<< V_130 ;
V_16 |= V_1 -> V_5 . V_131 [ V_54 ] << V_132 ;
F_4 ( V_1 -> V_10 ,
V_133 + ( V_54 * 8 ) ,
V_134 |
V_135 , V_16 ) ;
...
for ( V_54 = 0 ; V_54 < V_140 ; V_54 ++ ) {
if ( V_1 -> V_5 . V_141 [ V_54 ] )
F_4 ( V_1 -> V_10 ,
V_142 + ( V_54 * 2 ) ,
V_143 |
V_144 ,
V_1 -> V_5 . V_141 [ V_54 ] ) ;
if ( V_1 -> V_5 . V_145 [ V_54 ] )
F_4 ( V_1 -> V_10 ,
V_146 + ( V_54 * 2 ) ,
V_147 ,
V_1 -> V_5 . V_145 [ V_54 ] ) ;
...
switch ( V_1 -> type ) {
case V_77 :
V_2 = F_48 ( V_1 -> V_8 , - 1 , V_151 ,
F_42 ( V_151 ) , NULL , 0 , NULL ) ;
break;
case V_89 :
V_2 = F_48 ( V_1 -> V_8 , - 1 , V_152 ,
F_42 ( V_152 ) , NULL , 0 , NULL ) ;
break;
case V_90 :
V_2 = F_48 ( V_1 -> V_8 , - 1 , V_153 ,
F_42 ( V_153 ) , NULL , 0 , NULL ) ;
break;
}
if ( V_2 != 0 ) {
