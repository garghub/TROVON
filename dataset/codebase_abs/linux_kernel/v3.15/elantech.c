...
bool V_90 ;
if ( V_10 -> V_88 )
V_90 = ( ( V_26 [ 3 ] & 0x08 ) == 0x00 ) ;
else
V_90 = ( ( V_26 [ 0 ] & 0x0c ) == 0x04 &&
( V_26 [ 3 ] & 0x1c ) == 0x10 ) ;
if ( ! V_90 )
return V_81 ;
switch ( V_63 ) {
...
struct V_9 * V_10 = V_1 -> V_11 ;
int V_63 ;
if ( V_1 -> V_91 < V_1 -> V_25 )
return V_92 ;
if ( V_10 -> V_93 > 1 )
F_11 ( V_1 ) ;
switch ( V_10 -> V_18 ) {
case 1 :
if ( V_10 -> V_94 && ! F_30 ( V_1 ) )
return V_95 ;
F_14 ( V_1 ) ;
break;
case 2 :
...
V_10 -> V_98 = 0x16 ;
V_10 -> V_99 = 0x8f ;
if ( F_10 ( V_1 , 0x10 , V_10 -> V_98 ) ||
F_10 ( V_1 , 0x11 , V_10 -> V_99 ) ) {
V_12 = - 1 ;
}
break;
case 2 :
...
unsigned int * V_108 , unsigned int * V_36 ,
unsigned int * V_57 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
unsigned char V_3 [ 3 ] ;
...
if ( V_10 -> V_118 ( V_1 , V_119 , V_3 ) )
return - 1 ;
V_117 = V_3 [ 1 ] & 0x10 ;
if ( ( ( V_10 -> V_30 >> 16 ) == 0x14 ) && V_117 ) {
if ( V_10 -> V_118 ( V_1 , V_120 , V_3 ) )
return - 1 ;
* V_108 = ( V_10 -> V_42 [ 1 ] - V_23 ) * V_3 [ 1 ] / 2 ;
...
{
unsigned char V_3 [ 3 ] ;
if ( F_5 ( V_1 , V_123 , V_3 ) )
return - 1 ;
* V_121 = F_38 ( V_3 [ 1 ] & 0x0f ) ;
* V_122 = F_38 ( ( V_3 [ 1 ] & 0xf0 ) >> 4 ) ;
return 0 ;
}
...
F_41 ( V_124 , V_28 -> V_125 ) ;
F_42 ( V_41 , V_28 -> V_126 ) ;
}
}
...
struct V_27 * V_28 = V_1 -> V_28 ;
struct V_9 * V_10 = V_1 -> V_11 ;
unsigned int V_106 = 0 , V_107 = 0 , V_108 = 0 , V_36 = 0 , V_57 = 0 ;
unsigned int V_121 = 0 , V_122 = 0 ;
if ( F_37 ( V_1 , & V_106 , & V_107 , & V_108 , & V_36 , & V_57 ) )
return - 1 ;
F_41 ( V_127 , V_28 -> V_125 ) ;
F_41 ( V_128 , V_28 -> V_129 ) ;
F_41 ( V_130 , V_28 -> V_129 ) ;
F_42 ( V_131 , V_28 -> V_129 ) ;
F_41 ( V_40 , V_28 -> V_126 ) ;
F_41 ( V_41 , V_28 -> V_126 ) ;
F_41 ( V_33 , V_28 -> V_126 ) ;
F_41 ( V_37 , V_28 -> V_126 ) ;
F_41 ( V_38 , V_28 -> V_126 ) ;
F_41 ( V_39 , V_28 -> V_126 ) ;
switch ( V_10 -> V_18 ) {
case 1 :
if ( V_10 -> V_30 < 0x020000 &&
( V_10 -> V_42 [ 0 ] & V_43 ) ) {
F_41 ( V_44 , V_28 -> V_126 ) ;
F_41 ( V_45 , V_28 -> V_126 ) ;
}
F_44 ( V_28 , V_34 , V_106 , V_108 , 0 , 0 ) ;
F_44 ( V_28 , V_35 , V_107 , V_36 , 0 , 0 ) ;
break;
case 2 :
F_41 ( V_59 , V_28 -> V_126 ) ;
F_41 ( V_132 , V_28 -> V_125 ) ;
case 3 :
if ( V_10 -> V_18 == 3 )
F_40 ( V_1 ) ;
F_44 ( V_28 , V_34 , V_106 , V_108 , 0 , 0 ) ;
F_44 ( V_28 , V_35 , V_107 , V_36 , 0 , 0 ) ;
if ( V_10 -> V_60 ) {
F_44 ( V_28 , V_61 , V_133 ,
V_134 , 0 , 0 ) ;
F_44 ( V_28 , V_62 , V_135 ,
V_136 , 0 , 0 ) ;
}
F_45 ( V_28 , 2 , 0 ) ;
F_44 ( V_28 , V_51 , V_106 , V_108 , 0 , 0 ) ;
F_44 ( V_28 , V_52 , V_107 , V_36 , 0 , 0 ) ;
break;
case 4 :
if ( F_39 ( V_1 , & V_121 , & V_122 ) ) {
F_46 ( V_1 , L_16 ) ;
}
F_40 ( V_1 ) ;
F_41 ( V_59 , V_28 -> V_126 ) ;
F_44 ( V_28 , V_34 , V_106 , V_108 , 0 , 0 ) ;
F_44 ( V_28 , V_35 , V_107 , V_36 , 0 , 0 ) ;
F_47 ( V_28 , V_34 , V_121 ) ;
F_47 ( V_28 , V_35 , V_122 ) ;
F_44 ( V_28 , V_61 , V_133 ,
V_134 , 0 , 0 ) ;
F_44 ( V_28 , V_62 , V_135 ,
V_136 , 0 , 0 ) ;
...
F_44 ( V_28 , V_51 , V_106 , V_108 , 0 , 0 ) ;
F_44 ( V_28 , V_52 , V_107 , V_36 , 0 , 0 ) ;
F_47 ( V_28 , V_51 , V_121 ) ;
F_47 ( V_28 , V_52 , V_122 ) ;
F_44 ( V_28 , V_69 , V_133 ,
V_134 , 0 , 0 ) ;
F_44 ( V_28 , V_70 , 0 ,
V_136 * V_57 , 0 , 0 ) ;
break;
...
static T_3 F_48 ( struct V_1 * V_1 , void * V_137 ,
char * V_138 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_139 * V_140 = V_137 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_140 -> V_141 ;
int V_12 = 0 ;
if ( V_140 -> V_16 )
V_12 = F_9 ( V_1 , V_140 -> V_16 , V_16 ) ;
return sprintf ( V_138 , L_17 , ( V_140 -> V_16 && V_12 ) ? - 1 : * V_16 ) ;
}
static T_3 F_49 ( struct V_1 * V_1 ,
void * V_137 , const char * V_138 , T_4 V_142 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_139 * V_140 = V_137 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_140 -> V_141 ;
unsigned char V_143 ;
int V_144 ;
V_144 = F_50 ( V_138 , 16 , & V_143 ) ;
if ( V_144 )
return V_144 ;
if ( V_10 -> V_18 == 1 ) {
if ( V_140 -> V_16 == 0x10 )
V_143 |= V_105 ;
else if ( V_140 -> V_16 == 0x11 )
V_143 |= V_145 ;
}
if ( ! V_140 -> V_16 || F_10 ( V_1 , V_140 -> V_16 , V_143 ) == 0 )
* V_16 = V_143 ;
return V_142 ;
}
static bool F_51 ( const unsigned char * V_3 )
{
static const unsigned char V_146 [] = { 200 , 100 , 80 , 60 , 40 , 20 , 10 } ;
int V_23 ;
if ( V_3 [ 0 ] == 0 )
return false ;
if ( V_3 [ 1 ] == 0 )
return true ;
for ( V_23 = 0 ; V_23 < F_52 ( V_146 ) ; V_23 ++ )
if ( V_3 [ 2 ] == V_146 [ V_23 ] )
return false ;
return true ;
}
int F_53 ( struct V_1 * V_1 , bool V_147 )
{
struct V_4 * V_4 = & V_1 -> V_4 ;
unsigned char V_3 [ 3 ] ;
F_3 ( & V_1 -> V_4 , NULL , V_148 ) ;
if ( F_3 ( V_4 , NULL , V_149 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , V_3 , V_5 ) ) {
...
{
int V_156 = ( V_10 -> V_30 & 0x0f0000 ) >> 16 ;
...
V_10 -> V_88 = ( ( V_10 -> V_30 & 0x4000 ) == 0x4000 ) ;
V_10 -> V_101 = ! F_61 ( V_157 ) ;
return 0 ;
}
...
int V_23 , error ;
unsigned char V_3 [ 3 ] ;
V_1 -> V_11 = V_10 = F_63 ( sizeof( struct V_9 ) , V_158 ) ;
if ( ! V_10 )
return - V_159 ;
F_59 ( V_1 ) ;
V_10 -> V_85 [ 0 ] = 1 ;
...
error = F_65 ( & V_1 -> V_4 . V_153 -> V_28 . V_154 ,
& V_155 ) ;
if ( error ) {
F_4 ( V_1 ,
L_32 ,
