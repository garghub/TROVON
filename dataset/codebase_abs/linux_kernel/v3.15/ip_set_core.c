...
continue;
V_55 += F_45 ( V_54 + V_55 , V_49 [ V_47 ] . V_61 ) ;
V_53 -> V_55 [ V_47 ] = V_55 ;
...
F_56 ( struct V_2 * V_2 , T_5 V_80 )
{
struct V_52 * V_53 ;
struct V_1 * V_81 = F_1 ( V_2 ) ;
F_17 () ;
V_53 = F_57 ( V_81 -> V_82 ) [ V_80 ] ;
F_19 () ;
return V_53 ;
}
int
F_58 ( T_5 V_80 , const struct V_83 * V_84 ,
const struct V_85 * V_86 , struct V_87 * V_88 )
{
struct V_52 * V_53 = F_56 (
F_59 ( V_86 -> V_89 ? V_86 -> V_89 : V_86 -> V_90 ) , V_80 ) ;
int V_22 = 0 ;
F_55 ( V_53 == NULL ) ;
...
int
F_63 ( T_5 V_80 , const struct V_83 * V_84 ,
const struct V_85 * V_86 , struct V_87 * V_88 )
{
struct V_52 * V_53 = F_56 (
F_59 ( V_86 -> V_89 ? V_86 -> V_89 : V_86 -> V_90 ) , V_80 ) ;
...
{
const struct V_52 * V_53 = F_56 ( V_2 , V_80 ) ;
F_55 ( V_53 == NULL ) ;
F_55 ( V_53 -> V_79 == 0 ) ;
return V_53 -> V_6 ;
}
...
static inline bool
F_70 ( const struct V_33 * const V_38 [] )
{
return ! V_38 [ V_111 ] ||
F_71 ( V_38 [ V_111 ] ) != V_24 ;
}
static inline T_4
F_72 ( const struct V_112 * V_113 )
{
return V_113 -> V_114 & V_115 ? 0 : V_116 ;
}
static struct V_112 *
F_73 ( struct V_83 * V_84 , T_4 V_117 , T_4 V_118 , unsigned int V_48 ,
enum V_119 V_120 )
{
struct V_112 * V_113 ;
struct V_121 * V_122 ;
V_113 = F_74 ( V_84 , V_117 , V_118 , V_120 | ( V_12 << 8 ) ,
sizeof( * V_122 ) , V_48 ) ;
if ( V_113 == NULL )
return NULL ;
V_122 = F_75 ( V_113 ) ;
...
static struct V_52 *
F_76 ( struct V_1 * V_81 , const char * V_6 , T_5 * V_47 )
{
...
static inline struct V_52 *
F_77 ( struct V_1 * V_81 , const char * V_6 )
{
T_5 V_47 ;
return F_76 ( V_81 , V_6 , & V_47 ) ;
}
static int
F_78 ( struct V_1 * V_81 , const char * V_6 , T_5 * V_80 ,
struct V_52 * * V_53 )
{
struct V_52 * V_108 ;
T_5 V_106 ;
...
static int
F_80 ( struct V_130 * V_131 , struct V_83 * V_84 ,
const struct V_112 * V_113 ,
const struct V_33 * const V_132 [] )
{
struct V_2 * V_2 = F_81 ( V_131 ) ;
struct V_1 * V_81 = F_1 ( V_2 ) ;
...
! F_34 ( V_132 [ V_141 ] ) ) ) )
return - V_40 ;
V_6 = F_41 ( V_132 [ V_137 ] ) ;
V_136 = F_41 ( V_132 [ V_138 ] ) ;
V_7 = F_71 ( V_132 [ V_140 ] ) ;
V_8 = F_71 ( V_132 [ V_139 ] ) ;
F_12 ( L_18 ,
...
return - V_142 ;
F_82 ( & V_53 -> V_93 ) ;
F_83 ( V_53 -> V_6 , V_6 , V_143 ) ;
V_53 -> V_7 = V_7 ;
V_53 -> V_8 = V_8 ;
V_22 = F_84 ( V_136 , V_7 , V_8 , & ( V_53 -> type ) ) ;
if ( V_22 )
goto V_90;
if ( V_132 [ V_141 ] &&
F_37 ( V_38 , V_135 , V_132 [ V_141 ] ,
V_53 -> type -> V_144 ) ) {
V_22 = - V_40 ;
goto V_145;
}
...
if ( V_22 != 0 )
goto V_145;
V_22 = F_78 ( V_81 , V_53 -> V_6 , & V_80 , & V_134 ) ;
if ( V_22 == - V_128 ) {
if ( ( V_48 & V_116 ) &&
...
const struct V_33 * const V_132 [] )
{
struct V_1 * V_81 = F_1 ( F_81 ( V_131 ) ) ;
struct V_52 * V_108 ;
T_5 V_106 ;
int V_22 = 0 ;
if ( F_36 ( F_70 ( V_132 ) ) )
...
V_108 = F_76 ( V_81 , F_41 ( V_132 [ V_137 ] ) ,
& V_106 ) ;
if ( V_108 == NULL ) {
V_22 = - V_153 ;
goto V_90;
...
V_108 = F_77 ( V_81 , F_41 ( V_132 [ V_137 ] ) ) ;
if ( V_108 == NULL )
return - V_153 ;
F_91 ( V_108 ) ;
}
...
V_132 [ V_156 ] == NULL ) )
return - V_40 ;
V_53 = F_77 ( V_81 , F_41 ( V_132 [ V_137 ] ) ) ;
if ( V_53 == NULL )
return - V_153 ;
F_60 ( & V_78 ) ;
if ( V_53 -> V_79 != 0 ) {
...
V_132 [ V_156 ] == NULL ) )
return - V_40 ;
V_159 = F_76 ( V_81 , F_41 ( V_132 [ V_137 ] ) ,
& V_161 ) ;
if ( V_159 == NULL )
return - V_153 ;
V_160 = F_76 ( V_81 , F_41 ( V_132 [ V_156 ] ) ,
& V_162 ) ;
if ( V_160 == NULL )
return - V_158 ;
...
if ( V_172 [ V_137 ] ) {
struct V_52 * V_53 ;
V_53 = F_76 ( V_81 , F_41 ( V_172 [ V_137 ] ) ,
& V_80 ) ;
if ( V_53 == NULL )
return - V_153 ;
V_174 = V_177 ;
...
struct V_1 * V_81 = F_1 ( F_81 ( V_84 -> V_183 ) ) ;
T_4 V_174 , V_184 ;
int V_22 = 0 ;
if ( ! V_165 -> args [ V_181 ] ) {
...
V_113 = F_73 ( V_84 , F_104 ( V_165 -> V_84 ) . V_117 ,
...
if ( V_53 == NULL )
return - V_153 ;
if ( F_37 ( V_38 , V_224 , V_132 [ V_141 ] ,
V_53 -> type -> V_226 ) )
return - V_40 ;
F_60 ( & V_53 -> V_93 ) ;
...
if ( V_212 == NULL )
return - V_142 ;
V_228 = F_73 ( V_212 , F_104 ( V_84 ) . V_117 , V_113 -> V_188 , 0 ,
V_230 ) ;
if ( ! V_228 )
goto V_231;
...
F_33 ( F_133 ( V_81 -> V_82 , 1 ) ) ;
}
static int T_9
F_134 ( void )
{
int V_22 = F_135 ( & V_259 ) ;
if ( V_22 != 0 ) {
F_136 ( L_30 ) ;
return V_22 ;
}
