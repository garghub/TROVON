...
int V_50 = 0 ;
if ( V_46 . V_41 )
V_50 = F_18 ( V_55 -> V_59 , V_57 -> V_60 , & V_42 ,
& V_29 , & V_30 ) ;
else
V_50 = F_21 ( V_57 -> V_60 , & V_42 ,
& V_29 , & V_30 ) ;
if ( V_50 )
return V_50 ;
V_23 = V_42 / V_29 / V_30 ;
...
return - V_51 ;
if ( V_46 . V_41 ) {
V_48 = F_12 ( V_58 -> V_60 , & V_26 ) ;
if ( ! V_48 )
return - V_51 ;
V_42 = V_26 . V_33 . V_34 ;
} else {
V_48 = F_15 ( V_58 -> V_60 , & V_26 ) ;
if ( ! V_48 )
return - V_51 ;
V_42 = V_26 . V_42 ;
}
...
int T_2 F_77 ( struct V_1 * V_88 , struct V_102 * V_103 )
{
struct V_102 * V_104 ;
T_3 V_105 ;
int V_50 ;
V_104 = F_78 ( V_103 , NULL ) ;
if ( ! V_104 )
return 0 ;
V_50 = F_79 ( V_104 , L_11 , & V_105 ) ;
if ( V_50 ) {
F_31 ( L_12 ) ;
goto V_106;
}
