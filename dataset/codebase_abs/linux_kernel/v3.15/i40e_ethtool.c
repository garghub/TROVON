...
struct V_304 * V_305 ;
int V_306 = 0 ;
V_281 -> V_90 = V_8 -> V_12 . V_307 +
V_8 -> V_308 ;
F_85 (rule, node2,
&pf->fdir_filter_list, fdir_node) {
if ( V_306 == V_281 -> V_309 )
return - V_310 ;
V_301 [ V_306 ] = V_303 -> V_311 ;
V_306 ++ ;
}
V_281 -> V_309 = V_306 ;
return 0 ;
...
F_85 (rule, node2,
&pf->fdir_filter_list, fdir_node) {
if ( V_313 -> V_315 <= V_303 -> V_311 )
break;
}
if ( ! V_303 || V_313 -> V_315 != V_303 -> V_311 )
return - V_115 ;
V_313 -> V_282 = V_303 -> V_282 ;
V_313 -> V_316 . V_317 . V_318 = V_303 -> V_319 ;
V_313 -> V_316 . V_317 . V_320 = V_303 -> V_321 ;
V_313 -> V_316 . V_317 . V_322 = V_303 -> V_323 [ 0 ] ;
V_313 -> V_316 . V_317 . V_324 = V_303 -> V_325 [ 0 ] ;
V_313 -> V_326 = V_303 -> V_327 ;
return 0 ;
}
static int F_87 ( struct V_1 * V_2 , struct V_280 * V_281 ,
T_1 * V_301 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_133 * V_9 = V_6 -> V_9 ;
...
break;
case V_330 :
V_281 -> V_309 = V_8 -> V_331 ;
V_248 = 0 ;
break;
case V_332 :
V_248 = F_86 ( V_8 , V_281 ) ;
break;
case V_333 :
V_248 = F_84 ( V_8 , V_281 , V_301 ) ;
break;
default:
break;
}
...
static int F_88 ( struct V_7 * V_8 , struct V_280 * V_334 )
{
struct V_11 * V_12 = & V_8 -> V_12 ;
T_4 V_335 = ( T_4 ) F_10 ( V_12 , F_89 ( 0 ) ) |
( ( T_4 ) F_10 ( V_12 , F_89 ( 1 ) ) << 32 ) ;
if ( V_334 -> V_90 & ~ ( V_292 | V_293 |
V_285 | V_286 ) )
return - V_115 ;
if ( ! ( V_334 -> V_90 & V_292 ) ||
! ( V_334 -> V_90 & V_293 ) )
...
F_62 ( V_12 , F_89 ( 0 ) , ( T_1 ) V_335 ) ;
F_62 ( V_12 , F_89 ( 1 ) , ( T_1 ) ( V_335 >> 32 ) ) ;
F_82 ( V_12 ) ;
return 0 ;
}
static bool F_90 ( struct V_302 * V_303 ,
struct V_302 * V_346 )
{
if ( ( V_303 -> V_325 [ 0 ] != V_346 -> V_325 [ 0 ] ) ||
( V_303 -> V_323 [ 0 ] != V_346 -> V_323 [ 0 ] ) ||
( V_303 -> V_321 != V_346 -> V_321 ) ||
( V_303 -> V_319 != V_346 -> V_319 ) )
return false ;
return true ;
}
...
F_85 (rule, node2,
&pf->fdir_filter_list, fdir_node) {
if ( V_303 -> V_311 >= V_347 )
break;
V_348 = V_303 ;
}
if ( V_303 && ( V_303 -> V_311 == V_347 ) ) {
if ( V_346 && ! F_90 ( V_303 , V_346 ) )
V_157 = F_92 ( V_9 , V_303 , false ) ;
else if ( ! V_346 )
V_157 = F_92 ( V_9 , V_303 , false ) ;
F_93 ( & V_303 -> V_349 ) ;
F_18 ( V_303 ) ;
...
struct V_7 * V_8 = V_9 -> V_10 ;
int V_248 = 0 ;
V_248 = F_91 ( V_9 , NULL , V_313 -> V_315 , V_281 ) ;
F_98 ( V_8 ) ;
return V_248 ;
}
...
if ( V_8 -> V_352 & V_351 )
return - V_353 ;
V_313 = (struct V_312 * ) & V_281 -> V_314 ;
if ( V_313 -> V_315 >= ( V_8 -> V_12 . V_354 . V_355 +
V_8 -> V_12 . V_354 . V_356 ) ) {
return - V_115 ;
}
if ( V_313 -> V_326 >= V_9 -> V_162 )
return - V_115 ;
V_346 = F_13 ( sizeof( * V_346 ) , V_118 ) ;
if ( ! V_346 )
return - V_119 ;
V_346 -> V_311 = V_313 -> V_315 ;
if ( V_313 -> V_326 == V_357 )
V_346 -> V_358 = V_359 ;
else
V_346 -> V_358 =
V_360 ;
V_346 -> V_327 = V_313 -> V_326 ;
V_346 -> V_361 = 0 ;
V_346 -> V_362 = 0 ;
V_346 -> V_363 = V_9 -> V_364 ;
V_346 -> V_365 = V_366 ;
V_346 -> V_367 = 0 ;
V_346 -> V_282 = V_313 -> V_282 ;
V_346 -> V_368 = V_313 -> V_316 . V_369 . V_370 ;
V_346 -> V_319 = V_313 -> V_316 . V_317 . V_318 ;
V_346 -> V_321 = V_313 -> V_316 . V_317 . V_320 ;
V_346 -> V_323 [ 0 ] = V_313 -> V_316 . V_317 . V_322 ;
V_346 -> V_325 [ 0 ] = V_313 -> V_316 . V_317 . V_324 ;
V_248 = F_92 ( V_9 , V_346 , true ) ;
if ( V_248 )
F_18 ( V_346 ) ;
else
F_91 ( V_9 , V_346 , V_313 -> V_315 , NULL ) ;
return V_248 ;
}
static int F_100 ( struct V_1 * V_2 , struct V_280 * V_281 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_133 * V_9 = V_6 -> V_9 ;
struct V_7 * V_8 = V_9 -> V_10 ;
...
switch ( V_281 -> V_281 ) {
case V_371 :
V_248 = F_88 ( V_8 , V_281 ) ;
break;
case V_372 :
V_248 = F_99 ( V_9 , V_281 ) ;
break;
case V_373 :
V_248 = F_97 ( V_9 , V_281 ) ;
break;
default:
break;
}
...
struct V_133 * V_9 = V_6 -> V_9 ;
struct V_7 * V_8 = V_9 -> V_10 ;
V_375 -> V_376 = F_101 ( V_9 ) ;
V_375 -> V_377 = ( V_8 -> V_230 & V_351 ) ? 1 : 0 ;
V_375 -> V_378 = V_375 -> V_377 ;
V_375 -> V_379 = V_9 -> V_162 ;
}
static int F_103 ( struct V_1 * V_122 ,
struct V_374 * V_375 )
{
struct V_5 * V_6 = F_2 ( V_122 ) ;
unsigned int V_149 = V_375 -> V_379 ;
struct V_133 * V_9 = V_6 -> V_9 ;
struct V_7 * V_8 = V_9 -> V_10 ;
int V_380 ;
if ( V_9 -> type != V_381 )
return - V_115 ;
if ( ! V_149 || V_375 -> V_382 || V_375 -> V_383 )
return - V_115 ;
if ( V_375 -> V_377 != ( ( V_8 -> V_230 & V_351 ) ? 1 : 0 ) )
return - V_115 ;
if ( V_149 > F_101 ( V_9 ) )
return - V_115 ;
if ( V_149 > V_8 -> V_384 )
V_149 = V_8 -> V_384 ;
V_380 = F_104 ( V_8 , V_149 ) ;
if ( V_380 > 0 )
return 0 ;
else
return - V_115 ;
