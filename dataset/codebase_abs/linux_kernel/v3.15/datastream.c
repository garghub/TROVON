...
T_8 * V_29 = F_3 ( V_3 ) ;
F_2 ( V_3 , L_12 , V_10 ) ;
V_27 = V_4 -> V_30 >> V_29 -> V_11 ;
if ( V_4 -> V_30 & ( V_29 -> V_24 - 1 ) )
V_27 += 1 ;
V_28 = 1 ;
if ( V_4 -> V_30 > V_4 -> V_16 )
V_28 += V_4 -> V_31 . V_21 ;
if ( V_4 -> V_30 > V_4 -> V_17 && V_4 -> V_17 != 0 ) {
T_3 V_32 ;
T_3 V_33 ;
T_3 V_34 ;
V_32 =
...
F_2 ( V_3 , L_14 , V_10 , ( unsigned long ) V_37 ) ;
if ( V_37 > V_42 ) {
F_5 ( V_3 , L_15 ,
V_10 ) ;
return V_19 ;
}
for ( V_38 = 0 , V_41 = 0 ; V_38 < V_43 ;
V_41 += V_39 [ V_38 ] . V_21 , V_38 ++ ) {
if ( V_37 >= V_41 && V_37 < V_41 + ( V_39 [ V_38 ] . V_21 ) ) {
int V_44 = V_37 - V_41 ;
V_8 -> V_45 = V_39 [ V_38 ] . V_45 ;
V_8 -> V_46 = V_39 [ V_38 ] . V_46 + V_44 ;
V_8 -> V_21 = V_39 [ V_38 ] . V_21 - V_44 ;
F_2 ( V_3 , L_16
L_17 , V_10 ,
...
T_9 * V_39 ;
T_4 V_31 = V_13 -> V_31 ;
T_5 V_51 = F_14 ( V_3 , & V_31 ) ;
int V_52 = F_13 ( V_3 ) ;
F_2 ( V_3 , L_14 , V_10 , ( unsigned long ) V_37 ) ;
V_48 = V_13 -> V_16 >> F_3 ( V_3 ) -> V_11 ;
V_49 = V_37 - V_48 ;
for ( V_38 = 0 ; V_38 < V_31 . V_21 ; V_38 ++ ) {
V_50 = F_15 ( V_3 , V_51 + V_38 ) ;
if ( V_50 == NULL ) {
F_2 ( V_3 , L_19
L_20 ,
V_10 , ( unsigned long ) V_51 + V_38 ) ;
return V_19 ;
}
V_39 = ( T_9 * ) V_50 -> V_25 ;
for ( V_47 = 0 ; V_47 < V_52 ; ++ V_47 ) {
int V_21 = F_16 ( V_3 , V_39 [ V_47 ] . V_21 ) ;
if ( V_49 >= V_41 && V_49 < V_41 + V_21 ) {
int V_44 = V_49 - V_41 ;
V_8 -> V_45 =
F_17 ( V_3 , V_39 [ V_47 ] . V_45 ) ;
V_8 -> V_46 =
F_16 ( V_3 , V_39 [ V_47 ] . V_46 ) + V_44 ;
V_8 -> V_21 =
F_16 ( V_3 , V_39 [ V_47 ] . V_21 ) - V_44 ;
F_11 ( V_50 ) ;
F_2 ( V_3 ,
L_21
L_22 , V_10 ,
...
* V_35 ;
F_2 ( V_3 , L_25 , V_10 , ( unsigned long ) V_37 ) ;
V_53 = V_65 / V_67 ;
V_59 = V_65 % V_67 ;
V_54 = V_59 / V_67 ;
V_55 = V_53 / F_13 ( V_3 ) ;
if ( V_55 > V_13 -> V_36 . V_21 ) {
F_5 ( V_3 , L_26
L_27
L_28 , V_10 ,
V_53 ) ;
