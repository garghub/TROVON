...
V_136 , V_1 -> V_5 -> V_33 , V_1 ) ;
if ( V_53 < 0 ) {
F_6 ( 0 , L_14 ,
V_1 -> V_5 -> V_33 , V_1 -> V_47 -> V_38 ) ;
return V_53 ;
}
F_79 ( V_47 , V_137 , & V_134 ) ;
F_6 ( 1 , L_15
L_16 , V_5 -> V_33 , V_138 ,
F_80 ( V_47 ) , V_47 -> V_139 , V_47 -> V_38 ,
...
static int F_83 ( struct V_131 * V_47 ,
...
V_53 = F_84 ( & V_47 -> V_48 , V_145 [ V_138 ] , V_127 [ V_138 ] , V_146 ,
sizeof( T_1 ) , & V_93 ) ;
if ( V_53 < 0 )
return V_53 ;
V_93 -> V_147 = F_70 ;
...
if ( V_53 < 0 )
goto error;
V_53 = F_85 ( V_93 , F_86 ( & V_148 , V_1 ) ) ;
if ( V_53 < 0 )
goto error;
V_53 = F_85 ( V_93 , F_86 ( & V_149 , V_1 ) ) ;
if ( V_53 < 0 )
goto error;
V_53 = F_85 ( V_93 , F_86 ( & V_150 , V_1 ) ) ;
if ( V_53 < 0 )
goto error;
if ( V_5 -> V_118 )
F_85 ( V_93 , F_86 ( & V_151 , V_1 ) ) ;
strcpy ( V_93 -> V_152 , L_18 ) ;
sprintf ( V_93 -> V_153 , L_19 , V_47 -> V_90 ) ;
sprintf ( V_93 -> V_154 , L_20 ,
V_93 -> V_153 , ( unsigned long long ) F_81 ( V_47 , 0 ) ) ;
strcpy ( V_93 -> V_155 , L_21 ) ;
F_6 ( 0 , L_22 ,
V_93 -> V_152 , V_138 ) ;
V_53 = F_87 ( V_93 ) ;
if ( V_53 < 0 )
...
static void F_90 ( struct V_131 * V_47 )
{
struct V_130 * V_93 = F_91 ( V_47 ) ;
F_89 ( V_93 ) ;
V_138 -- ;
}
