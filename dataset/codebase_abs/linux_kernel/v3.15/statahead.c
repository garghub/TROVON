...
static void F_99 ( struct V_147 * V_65 , const char * V_149 ,
int V_150 )
{
...
struct V_21 * V_154 ;
struct V_155 * V_156 = F_82 ( V_88 ) ;
struct V_8 * V_9 = F_61 ( V_153 -> V_79 ) ;
struct V_157 * V_158 = & V_9 -> V_69 ;
struct V_159 V_160 = { 0 } ;
F_27 ( V_38 , L_14 ,
F_103 () , V_65 -> V_161 . V_33 , V_65 -> V_161 . V_32 ) ;
F_32 ( & V_156 -> V_162 ) ;
F_7 ( & V_153 -> V_67 ) ;
V_9 -> V_17 = 1 ;
F_104 ( V_158 , V_163 ) ;
...
V_167 = F_107 ( F_102 , V_65 ,
L_17 , V_153 -> V_80 ) ;
if ( F_92 ( V_167 ) ) {
F_108 ( L_18 , F_93 ( V_167 ) ) ;
F_104 ( V_158 , V_165 ) ;
return;
}
F_105 ( V_158 -> V_70 ,
F_85 ( V_158 ) || F_64 ( V_158 ) ,
& V_160 ) ;
}
...
void F_120 ( struct V_15 * V_88 , void * V_195 )
{
struct V_21 * V_34 = F_30 ( V_88 ) ;
if ( F_25 ( V_195 == NULL ) )
return;
F_7 ( & V_34 -> V_44 ) ;
if ( V_34 -> V_78 != V_195 || V_34 -> V_80 == 0 ) {
F_9 ( & V_34 -> V_44 ) ;
return;
}
V_34 -> V_78 = NULL ;
...
if ( V_197 && V_196 -> V_32 [ 0 ] != '.' ) {
F_27 ( V_38 , L_29 ,
V_196 -> V_33 , V_196 -> V_32 ,
V_180 , V_32 ) ;
continue;
}
if ( V_196 -> V_33 != V_180 ||
memcmp ( V_196 -> V_32 , V_32 , V_180 ) != 0 )
V_85 = V_198 ;
else if ( ! V_197 )
V_85 = V_199 ;
else
...
{
struct V_157 * V_158 = & V_9 -> V_76 ;
struct V_155 * V_156 = F_82 ( V_9 -> V_43 ) ;
int V_201 ;
...
( * V_204 ) -> V_161 . V_33 , ( * V_204 ) -> V_161 . V_32 ,
F_65 ( & V_34 -> V_84 ) , F_65 ( & V_212 -> V_84 ) ) ;
F_101 ( V_65 ) ;
F_39 ( V_9 -> V_43 ) ;
GOTO ( V_96 , V_85 = - V_102 ) ;
}
