...
struct V_11 * F_280 ( struct V_1 * V_2 )
{
struct V_11 * V_12 ;
V_12 = F_266 ( V_2 ) ;
if ( V_12 )
...
bool F_281 ( struct V_11 * V_186 , int error , unsigned int V_285 )
{
int V_286 ;
if ( ! V_186 -> V_28 )
return false ;
F_282 ( V_186 -> V_2 , V_186 , V_285 ) ;
if ( V_186 -> V_44 == V_213 )
V_186 -> V_216 = 0 ;
...
unsigned V_294 = F_283 ( V_28 -> V_36 . V_37 , V_285 ) ;
...
if ( F_21 ( V_186 ) < F_284 ( V_186 ) ) {
F_16 ( V_186 , L_30 ) ;
V_186 -> V_195 = F_284 ( V_186 ) ;
}
F_247 ( V_186 ) ;
return true ;
}
static bool F_285 ( struct V_11 * V_12 , int error ,
unsigned int V_285 ,
unsigned int V_295 )
{
if ( F_281 ( V_12 , error , V_285 ) )
return true ;
if ( F_12 ( F_278 ( V_12 ) ) &&
F_281 ( V_12 -> V_282 , error , V_295 ) )
return true ;
if ( F_286 ( V_12 -> V_2 ) )
F_287 ( V_12 -> V_42 ) ;
return false ;
}
void F_288 ( struct V_11 * V_186 )
{
struct V_1 * V_2 = V_186 -> V_2 ;
V_186 -> V_33 &= ~ V_277 ;
if ( V_2 -> V_132 )
...
static void F_289 ( struct V_11 * V_186 , int error )
{
if ( F_161 ( V_186 ) )
...
static bool F_291 ( struct V_11 * V_12 , int error ,
unsigned int V_285 , unsigned int V_295 )
{
struct V_1 * V_2 = V_12 -> V_2 ;
unsigned long V_63 ;
if ( F_285 ( V_12 , error , V_285 , V_295 ) )
return true ;
F_48 ( V_2 -> V_51 , V_63 ) ;
F_289 ( V_12 , error ) ;
F_49 ( V_2 -> V_51 , V_63 ) ;
...
bool F_293 ( struct V_11 * V_12 , int error , unsigned int V_285 )
{
return F_291 ( V_12 , error , V_285 , 0 ) ;
}
void F_294 ( struct V_11 * V_12 , int error )
{
bool V_297 ;
unsigned int V_295 = 0 ;
if ( F_12 ( F_278 ( V_12 ) ) )
V_295 = F_21 ( V_12 -> V_282 ) ;
V_297 = F_291 ( V_12 , error , F_21 ( V_12 ) , V_295 ) ;
F_146 ( V_297 ) ;
}
bool F_295 ( struct V_11 * V_12 , int error )
{
return F_293 ( V_12 , error , F_284 ( V_12 ) ) ;
}
bool F_296 ( struct V_11 * V_12 , int error )
{
F_33 ( error >= 0 ) ;
return F_293 ( V_12 , error , F_250 ( V_12 ) ) ;
}
bool F_297 ( struct V_11 * V_12 , int error , unsigned int V_285 )
{
...
{
return F_297 ( V_12 , error , F_284 ( V_12 ) ) ;
}
bool F_299 ( struct V_11 * V_12 , int error )
{
F_33 ( error >= 0 ) ;
return F_297 ( V_12 , error , F_250 ( V_12 ) ) ;
}
...
static void F_307 ( struct V_11 * V_305 , struct V_11 * V_306 )
{
...
int F_308 ( struct V_11 * V_12 , struct V_11 * V_310 ,
struct V_311 * V_312 , T_2 V_86 ,
int (* F_309)( struct V_28 * , struct V_28 * , void * ) ,
void * V_313 )
{
...
V_312 = V_315 ;
F_4 ( NULL , V_12 ) ;
F_310 (bio_src, rq_src) {
V_28 = F_311 ( V_314 , V_86 , V_312 ) ;
if ( ! V_28 )
goto V_316;
if ( F_309 && F_309 ( V_28 , V_314 , V_313 ) )
goto V_316;
if ( V_12 -> V_28 ) {
...
int F_312 ( struct V_1 * V_2 , struct V_48 * V_49 )
{
return F_313 ( V_53 , V_49 ) ;
}
...
static int F_316 ( void * V_324 , struct V_206 * V_325 , struct V_206 * V_232 )
{
...
static void F_317 ( struct V_1 * V_2 , unsigned int V_328 ,
bool V_329 )
__releases( V_2 -> V_51 )
{
...
static void F_320 ( struct V_204 * V_205 , bool V_329 )
{
F_321 ( V_330 ) ;
while ( ! F_56 ( & V_205 -> V_323 ) ) {
F_322 ( & V_205 -> V_323 , & V_330 ) ;
while ( ! F_56 ( & V_330 ) ) {
struct V_331 * V_332 = F_323 ( & V_330 ,
struct V_331 ,
V_209 ) ;
F_324 ( & V_332 -> V_209 ) ;
...
struct V_331 * F_325 ( T_6 V_334 , void * V_313 ,
int V_335 )
{
...
if ( F_56 ( & V_205 -> V_209 ) )
return;
F_322 ( & V_205 -> V_209 , & V_209 ) ;
F_329 ( NULL , & V_209 , F_316 ) ;
V_2 = NULL ;
V_328 = 0 ;
F_330 ( V_63 ) ;
while ( ! F_56 ( & V_209 ) ) {
V_12 = F_331 ( V_209 . V_336 ) ;
F_274 ( & V_12 -> V_13 ) ;
F_146 ( ! V_12 -> V_2 ) ;
if ( V_12 -> V_2 != V_2 ) {
if ( V_2 )
F_317 ( V_2 , V_328 , V_329 ) ;
V_2 = V_12 -> V_2 ;
V_328 = 0 ;
F_332 ( V_2 -> V_51 ) ;
}
...
void F_334 ( struct V_204 * V_205 )
{
F_207 ( V_205 , false ) ;
if ( V_205 == V_151 -> V_205 )
V_151 -> V_205 = NULL ;
}
void F_335 ( struct V_1 * V_2 , struct V_338 * V_168 )
{
V_2 -> V_168 = V_168 ;
V_2 -> V_268 = V_270 ;
F_336 ( V_2 -> V_168 , - 1 ) ;
...
void F_339 ( struct V_1 * V_2 , int V_100 )
{
F_24 ( V_2 -> V_51 ) ;
if ( ! V_100 ) {
V_2 -> V_268 = V_269 ;
...
void F_341 ( struct V_1 * V_2 , int V_100 )
{
F_24 ( V_2 -> V_51 ) ;
if ( ! V_100 ) {
V_2 -> V_268 = V_270 ;
