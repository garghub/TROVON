...
V_7 = & ( F_6 ( V_3 ) . V_4 ) ;
V_7 -> V_89 = 0 ;
if ( V_7 -> V_85 && F_66 ( V_7 ) )
V_163 = F_65 ( V_163 , V_7 ) ;
}
if ( V_163 &&
F_17 ( V_163 -> V_79 ) == V_14 ) {
if ( V_167 && V_167 -> V_79 &&
V_167 -> V_79 -> V_125 &&
( F_8 ( V_167 ) ||
( ! F_8 ( V_167 ) &&
...
V_163 -> V_3 ? V_163 -> V_3 -> V_13 -> V_137 : L_18 ) ;
F_42 (bond, slave, iter) {
V_7 = & ( F_6 ( V_3 ) . V_4 ) ;
F_25 ( L_19 ,
V_7 -> V_154 , V_7 -> V_85 ,
...
F_19 ( V_5 ) . system . V_190 = * ( (struct V_193 * ) V_5 -> V_13 -> V_191 ) ;
V_37 = V_189 ;
F_74 ( V_5 ,
V_194 *
V_37 ) ;
...
V_4 = & ( F_6 ( V_3 ) . V_4 ) ;
F_70 ( V_4 ) ;
V_4 -> V_169 = * ( (struct V_193 * ) V_5 -> V_13 -> V_191 ) ;
...
if ( ! V_2 -> V_3 ) {
F_78 ( L_26 ,
V_3 -> V_5 -> V_13 -> V_137 , V_3 -> V_13 -> V_137 ) ;
return;
}
F_25 ( L_27 ,
V_4 -> V_154 ) ;
...
static int F_89 ( struct V_45 * V_45 , struct V_3 * V_3 ,
T_2 V_93 )
{
struct V_2 * V_2 ;
int V_211 = V_212 ;
...
if ( ! V_2 -> V_3 ) {
F_62 ( L_34 ,
V_3 -> V_13 -> V_137 , V_3 -> V_5 -> V_13 -> V_137 ) ;
return V_211 ;
}
switch ( V_45 -> V_172 ) {
case V_213 :
...
if ( V_167 ) {
if ( V_167 -> V_85 < V_5 -> V_15 . V_219 ) {
if ( F_68 ( V_5 -> V_13 ) ) {
F_93 ( V_5 -> V_13 ) ;
goto V_218;
}
} else if ( ! F_68 ( V_5 -> V_13 ) ) {
F_94 ( V_5 -> V_13 ) ;
goto V_218;
}
} else if ( F_68 ( V_5 -> V_13 ) ) {
...
int F_97 ( struct V_90 * V_91 , struct V_223 * V_13 )
{
struct V_1 * V_5 = F_98 ( V_13 ) ;
...
V_227 = V_220 . V_221 ;
if ( V_225 == 0 ) {
F_25 ( L_48 , V_13 -> V_137 ) ;
goto V_228;
}
V_226 = F_99 ( V_5 , V_91 , V_225 ) ;
V_224 = NULL ;
F_42 (bond, slave, iter) {
V_7 = F_6 ( V_3 ) . V_2 . V_4 ;
...
int F_103 ( const struct V_90 * V_91 , struct V_1 * V_5 ,
struct V_3 * V_3 )
{
int V_211 = V_212 ;
...
if ( V_91 -> V_98 != V_99 )
return V_211 ;
V_45 = F_104 ( V_91 , 0 , sizeof( V_230 ) , & V_230 ) ;
if ( ! V_45 )
return V_211 ;
F_82 ( & V_5 -> V_205 ) ;
V_211 = F_89 ( V_45 , V_3 , V_91 -> V_231 ) ;
F_84 ( & V_5 -> V_205 ) ;
return V_211 ;
}
