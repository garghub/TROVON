...
V_1514 [ V_26 ] . V_1519 = V_26 ;
}
V_1517 = F_539 ( V_1235 , V_1514 , 1 , V_1517 ) ;
if ( V_1517 < 0 ) {
V_4 -> V_87 &= ~ V_1520 ;
return;
}
...
const T_3 * V_1523 ;
int V_26 ;
V_1523 = F_542 ( V_1522 -> V_11 . V_1524 , L_181 , NULL ) ;
if ( ! V_1523 )
return - V_8 ;
for ( V_26 = 0 ; V_26 < V_1522 -> V_1525 . V_1517 ; V_26 ++ ) {
V_1512 [ V_26 ] = V_1523 [ V_26 ] ;
V_4 -> V_29 [ V_26 ] . V_783 = V_1522 -> V_1525 . V_1526 [ V_26 ] ;
}
V_4 -> V_28 = V_1522 -> V_1525 . V_1517 ;
return 0 ;
#else
return - V_21 ;
#endif
...
V_1529 = 0 ;
V_10 = F_498 ( V_4 , V_25 , V_1512 [ V_1529 ] ,
F_545 ( V_30 ) ) ;
if ( V_10 )
return V_10 ;
V_1529 ++ ;
...
V_1527 = 0 ;
for ( V_26 = 0 ; V_26 < V_30 ; V_26 ++ )
V_1527 += V_25 -> V_811 [ V_26 ] ;
V_1528 = V_25 -> V_811 [ V_30 ] ;
for ( V_26 = V_1527 ; V_26 < ( V_1527 + V_1528 ) ; V_26 ++ ) {
V_10 = F_498 ( V_4 , V_25 ,
V_1512 [ V_1529 ] ,
F_233 ( V_26 ) ) ;
...
V_1532 = F_549 ( V_4 -> V_1235 ) ;
V_1421 = F_542 ( V_1532 , L_142 , & V_1411 ) ;
if ( ! V_1421 ) {
F_10 ( V_11 , L_182 ,
V_1532 -> V_1534 ) ;
return - V_21 ;
...
F_10 ( V_11 , L_184 ,
V_1532 -> V_1534 , V_4 -> V_1226 . V_1421 ) ;
return - V_21 ;
}
V_1533 = F_542 ( V_1532 , L_140 , & V_1411 ) ;
if ( ! V_1533 ) {
F_10 ( V_11 , L_185 ,
V_1532 -> V_1534 ) ;
return - V_21 ;
}
if ( V_1411 != V_11 -> V_1535 ) {
F_10 ( V_11 , L_186 ,
V_1532 -> V_1534 , V_1411 ) ;
}
memcpy ( V_11 -> V_1105 , V_1533 , V_11 -> V_1535 ) ;
if ( ! F_429 ( & V_11 -> V_1105 [ 0 ] ) ) {
F_10 ( V_11 , L_187 ,
V_1532 -> V_1534 ) ;
F_10 ( V_11 , L_188 , V_1532 -> V_1534 , V_11 -> V_1105 ) ;
return - V_21 ;
}
V_1414 = F_542 ( V_1532 , L_137 , & V_1411 ) ;
if ( V_1414 )
strcpy ( V_4 -> V_1226 . V_1414 , V_1414 ) ;
if ( F_550 ( V_1532 , L_189 , & V_1411 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
}
return 0 ;
...
{
struct V_1521 * V_1542 = F_553 ( V_11 ) ;
struct V_24 * V_498 = F_554 ( & V_1542 -> V_11 ) ;
...
return sprintf ( V_1541 , L_201 , V_1544 ) ;
}
...
T_5 * V_1547 ;
int V_26 ;
V_1547 = ( V_1546 ? V_498 -> V_810 : V_498 -> V_811 ) ;
for ( V_26 = 0 ; V_26 < V_498 -> V_481 ; V_26 ++ ) {
V_1541 += sprintf ( V_1541 ,
( V_26 == 0 ) ? L_202 : L_203 ,
V_1547 [ V_26 ] ) ;
...
struct V_1539 * V_1540 , char * V_1541 )
{
return F_556 ( V_11 , V_1540 , V_1541 , 1 ) ;
}
...
union V_1548 * V_1465 , T_5 V_543 )
{
struct V_1521 * V_1542 ;
struct V_24 * V_498 ;
int V_26 ;
V_1542 = F_561 ( L_205 , V_1549 ,
NULL , 0 ) ;
if ( F_562 ( V_1542 ) )
return NULL ;
for ( V_26 = 0 ; V_1550 [ V_26 ] . V_1540 . V_1118 ; V_26 ++ ) {
...
goto V_1551;
V_498 -> V_375 = V_1549 ++ ;
V_1542 -> V_11 . V_1552 = V_498 ;
V_498 -> V_1542 = V_1542 ;
memcpy ( & V_498 -> V_1465 , V_1465 , sizeof( * V_1465 ) ) ;
V_498 -> V_339 = V_543 ;
F_565 ( & V_498 -> V_1553 ) ;
F_566 ( & V_498 -> V_1554 , 0 ) ;
F_567 ( & V_498 -> V_1553 , & V_1555 ) ;
F_568 ( & V_498 -> V_155 ) ;
V_498 -> V_903 = 7500 ;
V_498 -> V_441 = V_1556 ;
...
V_10 = F_573 ( & V_498 -> V_1542 -> V_11 . V_1562 ,
& V_4 -> V_508 -> V_1562 ,
V_1561 ) ;
if ( ! V_10 ) {
...
sprintf ( V_1561 , L_206 , V_30 ) ;
F_571 ( & V_1560 ) ;
F_577 ( & V_498 -> V_1542 -> V_11 . V_1562 , V_1561 ) ;
V_498 -> V_1428 [ V_30 ] = NULL ;
V_4 -> V_25 = NULL ;
if ( F_578 ( & V_498 -> V_1554 ) ) {
F_579 ( & V_498 -> V_1553 ) ;
F_569 ( V_498 -> V_1542 ) ;
}
F_575 ( & V_1560 ) ;
...
T_14 V_1565 ;
void * V_861 ;
V_861 = F_581 ( V_11 , V_487 , & V_1565 , V_1564 ) ;
if ( V_861 )
* V_1563 = V_1565 ;
return V_861 ;
}
...
static T_1 F_588 ( struct V_508 * V_11 , void * V_1566 ,
T_13 V_487 ,
enum V_1567 V_1568 )
{
return F_589 ( V_11 , V_1566 , V_487 , V_1568 ) ;
}
static void F_590 ( struct V_508 * V_11 , T_1 V_1569 ,
T_13 V_487 ,
enum V_1567 V_1568 )
{
F_591 ( V_11 , V_1569 , V_487 , V_1568 ) ;
}
...
static struct V_308 * F_593 ( struct V_508 * V_1571 ,
...
if ( ! ( F_602 ( V_1235 , 0 ) & V_1587 ) ||
! ( F_602 ( V_1235 , 2 ) & V_1587 ) ) {
...
V_1585 . V_1592 . V_1593 = F_606 ( V_1235 -> V_1594 ) ;
V_1585 . V_1592 . V_1594 = V_1235 -> V_1594 -> V_1595 ;
V_1585 . V_1592 . V_508 = F_607 ( V_1235 -> V_1591 ) ;
V_4 -> V_25 = F_570 ( V_4 , & V_1585 ,
V_1545 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
goto V_1596;
...
V_1603 ) ;
V_1586 = F_609 ( 44 ) ;
V_10 = F_610 ( V_1235 , V_1586 ) ;
if ( ! V_10 ) {
V_11 -> V_552 |= V_1604 ;
V_10 = F_611 ( V_1235 , V_1586 ) ;
if ( V_10 ) {
...
{
unsigned long V_1610 = F_631 ( V_487 ) ;
unsigned long V_485 = F_632 ( V_1564 , V_1610 ) ;
if ( V_485 == 0UL )
return NULL ;
...
{
unsigned long V_1610 = F_631 ( V_487 ) ;
F_635 ( ( unsigned long ) V_1566 , V_1610 ) ;
}
...
static int F_641 ( struct V_1521 * V_1522 )
{
union V_1548 V_1585 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
int V_10 ;
F_592 () ;
V_1 = F_542 ( V_1522 -> V_11 . V_1524 , L_226 , NULL ) ;
if ( ! V_1 ) {
F_226 ( & V_1522 -> V_11 , L_227 ,
V_1522 -> V_11 . V_1524 -> V_1534 ) ;
return - V_8 ;
}
V_11 = F_593 ( & V_1522 -> V_11 , NULL , V_1522 ,
& V_1611 , V_1 [ 0 ] & 0x1 ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1612;
...
V_4 = F_400 ( V_11 ) ;
memset ( & V_1585 , 0 , sizeof( V_1585 ) ) ;
V_1585 . V_1613 = F_642 ( V_1522 -> V_11 . V_1524 ) ;
V_4 -> V_25 = F_570 ( V_4 , & V_1585 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_599 ( V_11 ) ;
V_4 -> V_1504 = F_643 ( & V_1522 -> V_1614 [ 1 ] , 0 ,
F_644 ( & V_1522 -> V_1614 [ 1 ] ) ,
L_228 ) ;
if ( ! V_4 -> V_1504 ) {
F_226 ( & V_1522 -> V_11 , L_223 ) ;
V_10 = - V_506 ;
goto V_1605;
}
V_4 -> V_1615 = F_643 ( & V_1522 -> V_1614 [ 2 ] , 0 ,
F_644 ( & V_1522 -> V_1614 [ 2 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1615 ) {
F_226 ( & V_1522 -> V_11 , L_230 ) ;
V_10 = - V_506 ;
goto V_1608;
}
V_4 -> V_1616 = F_643 ( & V_1522 -> V_1614 [ 3 ] , 0 ,
F_644 ( & V_1522 -> V_1614 [ 3 ] ) ,
L_231 ) ;
if ( ! V_4 -> V_1616 ) {
F_226 ( & V_1522 -> V_11 , L_232 ) ;
V_10 = - V_506 ;
goto V_1608;
}
F_597 ( V_11 ) ;
...
if ( V_10 ) {
if ( V_10 != - V_8 )
F_226 ( & V_1522 -> V_11 , L_224 ) ;
goto V_1608;
}
V_10 = F_615 ( V_11 ) ;
if ( V_10 ) {
F_226 ( & V_1522 -> V_11 , L_225 ) ;
goto V_1608;
}
F_645 ( V_1522 , V_11 ) ;
F_598 ( V_4 ) ;
...
V_1608:
if ( V_4 -> V_1615 ) {
F_646 ( & V_1522 -> V_1614 [ 2 ] , V_4 -> V_1615 ,
F_644 ( & V_1522 -> V_1614 [ 2 ] ) ) ;
V_4 -> V_1615 = NULL ;
}
if ( V_4 -> V_1616 ) {
F_646 ( & V_1522 -> V_1614 [ 3 ] , V_4 -> V_1616 ,
F_644 ( & V_1522 -> V_1614 [ 3 ] ) ) ;
V_4 -> V_1616 = NULL ;
}
if ( V_4 -> V_1504 ) {
F_646 ( & V_1522 -> V_1614 [ 1 ] , V_4 -> V_1504 ,
F_644 ( & V_1522 -> V_1614 [ 1 ] ) ) ;
V_4 -> V_1504 = NULL ;
}
V_1605:
...
static int F_647 ( struct V_1521 * V_1522 )
{
struct V_308 * V_11 = F_648 ( V_1522 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_400 ( V_11 ) ;
F_623 ( V_11 ) ;
if ( V_4 -> V_1615 ) {
