...
static void F_36 ( struct V_17 * V_21 , struct V_25 * V_26 ,
T_3 V_1 )
{
...
int V_29 ;
if ( V_1 >= V_8 )
return F_37 ( V_21 , V_26 , - V_33 ) ;
V_32:
V_44 = F_38 ( V_45 , V_48 ) ;
if ( ! V_44 )
return F_37 ( V_45 , V_26 , - V_49 ) ;
V_44 -> V_27 = V_45 -> V_27 ;
V_21 = V_44 ;
F_1 ( V_1 ) ;
...
static void F_43 ( struct V_17 * V_21 )
{
struct V_25 * V_26 = F_40 ( V_21 ) ;
int V_53 ;
if ( V_26 -> F_28 < V_54 ||
V_21 -> V_52 < V_26 -> F_28 )
return;
...
V_30 = F_45 ( V_26 ) ;
F_42 ( V_21 , V_53 ) ;
F_36 ( V_21 , V_26 , V_30 -> V_65 ) ;
} else {
F_46 ( V_21 , & F_26 ) ;
}
}
static void F_47 ( int V_15 )
{
const struct V_4 * V_10 ;
int type = V_66 [ V_15 ] ;
F_29 () ;
...
static int T_7 F_48 ( struct V_14 * V_14 )
{
struct V_67 * V_16 ;
struct V_68 V_69 = {
. V_70 = V_71 ,
...
static void T_8 F_50 ( struct V_76 * V_77 )
{
struct V_14 * V_14 ;
F_51 (net, net_exit_list, exit_list)
F_52 ( V_14 -> V_16 , NULL ) ;
F_53 () ;
F_51 (net, net_exit_list, exit_list)
F_54 ( V_14 -> V_75 ) ;
