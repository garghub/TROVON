...
static int F_25 ( struct V_70 * V_8 , int V_1 ,
struct V_35 * * V_71 )
{
struct V_35 * V_4 ;
T_1 * V_2 ;
int V_9 ;
V_9 = F_26 ( V_8 , V_72 [ V_1 ] , V_6 [ V_1 ] , V_73 ,
sizeof( T_1 ) , & V_4 ) ;
if ( V_9 < 0 )
return V_9 ;
V_2 = V_4 -> V_58 ;
...
V_9 = F_31 ( V_79 , 0 , NULL ) ;
if ( V_9 < 0 )
return V_9 ;
V_9 = F_32 ( V_79 , 0 , NULL ) ;
if ( V_9 < 0 )
return V_9 ;
...
static int F_40 ( struct V_70 * V_8 ,
unsigned int V_1 )
{
if ( ! V_95 [ V_1 ] )
return 0 ;
...
static int F_42 ( struct V_70 * V_8 ,
unsigned int V_1 )
{
struct V_35 * V_4 ;
int V_9 ;
V_9 = F_25 ( V_8 , V_1 , & V_4 ) ;
if ( V_9 < 0 )
return V_9 ;
...
static int F_45 ( struct V_70 * V_97 ,
unsigned int V_1 )
{
F_43 ( F_46 ( V_97 ) ) ;
return 0 ;
}
static int F_47 ( struct V_3 * V_98 ,
...
if ( V_1 >= V_101 )
return - V_102 ;
V_100 = F_25 ( & V_98 -> V_4 -> V_1 , V_1 , & V_4 ) ;
if ( V_100 < 0 )
return V_100 ;
...
static void F_49 ( struct V_3 * V_98 )
{
F_43 ( F_50 ( V_98 ) ) ;
F_48 ( V_98 , NULL ) ;
}
