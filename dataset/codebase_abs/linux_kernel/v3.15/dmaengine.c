...
T_3
F_115 ( struct V_1 * V_6 , struct V_128 * V_129 ,
unsigned int V_130 , struct V_128 * V_131 , unsigned int V_132 ,
T_7 V_114 )
{
...
T_3 V_37 ;
unsigned long V_127 ;
V_110 = F_112 ( V_3 -> V_3 , 2 , V_135 ) ;
if ( ! V_110 )
return - V_51 ;
V_110 -> V_112 = 1 ;
V_110 -> V_116 = 1 ;
V_110 -> V_113 [ 0 ] = F_116 ( V_3 -> V_3 , V_131 , V_132 , V_114 ,
V_115 ) ;
V_110 -> V_113 [ 1 ] = F_116 ( V_3 -> V_3 , V_129 , V_130 , V_114 ,
V_117 ) ;
V_110 -> V_114 = V_114 ;
V_127 = V_136 ;
V_134 = V_3 -> V_83 ( V_6 , V_110 -> V_113 [ 1 ] , V_110 -> V_113 [ 0 ] ,
V_114 , V_127 ) ;
if ( ! V_134 ) {
F_103 ( V_110 ) ;
return - V_51 ;
...
T_3
F_122 ( struct V_1 * V_6 , void * V_138 ,
void * V_139 , T_7 V_114 )
{
return F_115 ( V_6 , F_123 ( V_138 ) ,
( unsigned long ) V_138 & ~ V_140 ,
F_123 ( V_139 ) ,
( unsigned long ) V_139 & ~ V_140 , V_114 ) ;
}
T_3
F_124 ( struct V_1 * V_6 , struct V_128 * V_128 ,
unsigned int V_141 , void * V_142 , T_7 V_114 )
{
return F_115 ( V_6 , V_128 , V_141 ,
F_123 ( V_142 ) ,
( unsigned long ) V_142 & ~ V_140 , V_114 ) ;
}
void F_125 ( struct V_133 * V_134 ,
struct V_1 * V_6 )
{
V_134 -> V_6 = V_6 ;
#ifdef F_126
...
enum V_36
F_128 ( struct V_133 * V_134 )
{
unsigned long V_39 = V_40 + F_27 ( 5000 ) ;
if ( ! V_134 )
return V_144 ;
while ( V_134 -> V_37 == - V_64 ) {
if ( F_30 ( V_40 , V_39 ) ) {
F_31 ( L_16 ,
V_41 ) ;
return V_42 ;
...
return F_26 ( V_134 -> V_6 , V_134 -> V_37 ) ;
}
void F_129 ( struct V_133 * V_134 )
{
struct V_133 * V_145 = F_130 ( V_134 ) ;
struct V_133 * V_146 ;
struct V_1 * V_6 ;
if ( ! V_145 )
return;
