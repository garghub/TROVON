...
static int F_49 ( struct V_191 * V_192 ,
const struct V_193 * V_194 )
{
struct V_61 * V_62 ;
int V_157 ;
V_62 = F_50 ( & V_192 -> V_9 , sizeof( struct V_61 ) ,
V_195 ) ;
if ( NULL == V_62 )
return - V_196 ;
F_51 ( V_192 , V_62 ) ;
V_62 -> V_180 = F_52 ( V_192 , & V_197 ) ;
if ( F_53 ( V_62 -> V_180 ) )
return F_54 ( V_62 -> V_180 ) ;
V_157 = F_55 ( & V_192 -> V_9 , & V_198 ,
V_199 , F_31 ( V_199 ) ) ;
return V_157 ;
}
static int F_56 ( struct V_191 * V_200 )
{
F_57 ( & V_200 -> V_9 ) ;
return 0 ;
}
