...
return 0 ;
V_152 = V_151 + V_157 ;
V_149 = F_68 ( V_152 * sizeof( T_5 ) , V_154 ) ;
V_150 = F_68 ( V_152 * sizeof( T_5 ) , V_154 ) ;
if ( ! V_149 || ! V_150 ) {
F_69 ( V_149 ) ;
F_69 ( V_150 ) ;
return - V_155 ;
...
static void F_72 ( void * V_27 , struct V_146 * V_156 )
{
struct V_88 * V_89 = V_27 ;
struct V_80 * V_81 = & V_89 -> V_82 ;
...
static void F_73 ( void * V_27 , struct V_146 * V_147 , int V_148 ,
int V_159 , T_5 V_160 )
{
struct V_88 * V_89 = V_27 ;
struct V_80 * V_81 = & V_89 -> V_82 ;
...
F_74 ( V_163 , & V_89 -> V_113 , 0 ) ;
F_30 ( V_143 , & V_81 -> V_122 ) ;
F_75 () ;
F_76 ( & V_81 -> V_122 , V_143 ) ;
F_52 ( & V_81 -> V_120 ) ;
}
static void F_77 ( struct V_88 * V_89 , unsigned int V_158 ,
unsigned int V_150 )
{
struct V_80 * V_81 = & V_89 -> V_82 ;
...
if ( ! F_4 ( V_162 , & V_81 -> V_122 ) )
F_74 ( V_163 , & V_89 -> V_113 ,
V_150 == V_165 ? V_166 : 0 ) ;
F_52 ( & V_81 -> V_120 ) ;
}
static int F_78 ( struct V_88 * V_89 , const char * V_167 )
{
struct V_80 * V_81 = & V_89 -> V_82 ;
char V_168 [ V_169 ] ;
const char * V_170 ;
...
V_170 ++ ;
V_79 = V_173 | V_174 ;
error = F_81 ( V_170 , V_168 , V_79 , V_35 ,
& V_175 , V_89 , & V_171 ,
& V_81 -> V_87 ) ;
if ( error ) {
...
static void F_83 ( struct V_88 * V_89 )
{
struct V_80 * V_81 = & V_89 -> V_82 ;
int error ;
if ( F_4 ( V_164 , & V_81 -> V_122 ) )
