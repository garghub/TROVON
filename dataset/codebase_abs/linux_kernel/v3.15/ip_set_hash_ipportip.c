...
if ( V_38 [ V_58 ] ) {
V_47 = F_24 ( V_38 [ V_58 ] , & V_43 ) ;
if ( V_47 )
return V_47 ;
if ( V_5 > V_43 )
F_25 ( V_5 , V_43 ) ;
} else if ( V_38 [ V_59 ] ) {
T_3 V_60 = F_20 ( V_38 [ V_59 ] ) ;
if ( ! V_60 || V_60 > 32 )
return - V_61 ;
F_26 ( V_5 , V_43 , V_60 ) ;
}
...
& V_28 . V_6 , & V_28 . V_7 ) )
return - V_33 ;
F_39 ( V_9 , V_25 -> V_31 & V_34 , & V_28 . V_5 . V_63 ) ;
F_39 ( V_9 , V_25 -> V_31 & V_35 , & V_28 . V_3 . V_63 ) ;
return V_26 ( V_19 , & V_28 , & V_30 , & V_25 -> V_30 , V_25 -> V_36 ) ;
}
static int
