...
T_1 V_46 , V_47 ;
T_1 V_48 ;
V_41 = V_10 -> V_35 . V_37 [ V_10 -> V_49 ] . V_50 ;
if ( V_41 & V_51 ) {
V_42 = 0x19 ;
V_44 = 0x1a ;
V_46 = 0x1b ;
...
static void F_17 ( struct V_10 * V_10 , T_3 * V_55 , int V_28 )
{
struct V_16 * V_16 = (struct V_16 * ) V_10 ;
struct V_56 * V_57 = ( void * ) V_55 ;
T_1 * V_3 = V_55 + sizeof( * V_57 ) ;
int V_58 = V_28 - sizeof( * V_57 ) ;
T_1 V_59 = V_16 -> V_36 | 1 ;
T_1 V_60 = V_16 -> V_36 | 2 ;
T_1 V_61 = V_16 -> V_36 | 5 ;
if ( V_28 < 12 )
return;
if ( V_57 -> V_25 [ 0 ] != 'R' || V_57 -> V_25 [ 1 ] != 'B' ) {
F_10 ( L_14 ,
V_16 -> V_36 , V_57 -> V_25 [ 0 ] , V_57 -> V_25 [ 1 ] ) ;
return;
}
if ( V_57 -> V_62 == V_59 )
F_18 ( V_10 , V_63 , V_3 , V_58 ) ;
else if ( V_57 -> V_62 == V_60 )
F_18 ( V_10 , V_64 , V_3 , V_58 ) ;
else if ( V_57 -> V_62 == V_61 )
F_18 ( V_10 , V_65 , V_3 , V_58 ) ;
else
F_10 ( L_15 ) ;
}
static int F_19 ( struct V_66 * V_67 , const struct V_33 * V_34 )
{
return F_20 ( V_67 , V_34 , & V_68 , sizeof( struct V_16 ) ,
V_69 ) ;
}
