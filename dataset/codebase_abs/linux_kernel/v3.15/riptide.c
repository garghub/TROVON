...
if ( ! V_103 )
return;
F_142 ( V_259 , L_48 , V_103 -> V_134 -> V_260 ) ;
F_142 ( V_259 , L_49 ,
V_103 -> V_245 , V_103 -> V_239 , V_103 -> V_238 ) ;
for ( V_12 = 0 ; V_12 < 64 ; V_12 += 4 )
F_142 ( V_259 , L_50 ,
( V_12 % 16 ) ? ' ' : '\n' , V_12 , F_143 ( V_103 -> V_68 + V_12 ) ) ;
if ( ( V_8 = V_103 -> V_8 ) ) {
F_142 ( V_259 ,
L_51 ,
...
F_142 ( V_259 , L_53 , V_12 , V_81 , V_82 ) ;
}
F_142 ( V_259 ,
L_54 ,
V_8 -> V_75 , V_8 -> V_59 ,
...
while ( V_12 >= 2 ) {
V_12 -= 2 ;
F_142 ( V_259 , L_59 , V_13 [ V_12 ] , V_13 [ V_12 + 1 ] ) ;
}
F_142 ( V_259 , L_60 ) ;
}
...
{
struct V_256 * V_257 ;
if ( ! F_145 ( V_103 -> V_134 , L_61 , & V_257 ) )
F_146 ( V_257 , V_103 , F_141 ) ;
}
...
if ( ( V_21 = F_148 ( V_262 , & V_138 , & V_103 -> V_138 ) ) < 0 )
return V_21 ;
return V_21 ;
}
static int
F_149 ( struct V_131 * V_132 , const struct V_270 * V_91 )
{
static int V_130 ;
struct V_271 * V_271 ;
if ( V_130 >= V_272 )
...
static void F_154 ( struct V_131 * V_132 )
{
struct V_271 * V_271 = F_155 ( V_132 ) ;
if ( V_271 ) {
F_156 ( V_271 -> V_278 , 8 ) ;
F_157 ( V_271 ) ;
}
...
static int
F_158 ( struct V_131 * V_132 , const struct V_270 * V_279 )
{
static int V_130 ;
struct V_133 * V_134 ;
struct V_102 * V_103 ;
...
V_21 = F_159 ( & V_132 -> V_130 , V_280 [ V_130 ] , V_91 [ V_130 ] , V_281 ,
0 , & V_134 ) ;
if ( V_21 < 0 )
return V_21 ;
...
F_161 ( V_103 -> V_132 , V_289 , V_20 ) ;
if ( V_286 [ V_130 ] ) {
V_20 = V_286 [ V_130 ] ;
F_161 ( V_103 -> V_132 , V_290 , V_20 ) ;
V_21 = F_162 ( V_134 , 0 , V_291 ,
V_20 , V_292 , - 1 ,
& V_103 -> V_241 ) ;
if ( V_21 < 0 )
F_17 ( V_277
...
if ( V_283 [ V_130 ] ) {
V_20 = V_283 [ V_130 ] ;
F_161 ( V_103 -> V_132 , V_294 , V_20 ) ;
V_21 = F_163 ( V_134 , V_20 , V_20 + 2 ,
V_295 , 0 , & V_103 -> V_296 ) ;
if ( V_21 < 0 )
F_17 ( V_277
L_65 ,
...
V_103 -> V_297 = V_20 ;
V_21 = F_164 ( V_103 -> V_296 , 0 , 1 , NULL ) ;
if ( V_21 < 0 )
F_17 ( V_277
L_66 ) ;
}
