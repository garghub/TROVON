...
char * V_42 )
{
struct V_43 * V_44 = F_15 ( V_41 ) ;
const int V_26 = F_11 ( V_2 , V_44 -> V_45 ) ;
return snprintf ( V_42 , V_46 , L_1 , V_26 ) ;
}
...
{
struct V_43 * V_44 = F_15 ( V_41 ) ;
const unsigned int V_35 = F_13 ( V_2 , V_44 -> V_45 ) ;
return snprintf ( V_42 , V_46 , L_2 , V_35 ) ;
}
...
struct V_43 * V_44 = F_15 ( V_41 ) ;
const unsigned int V_35 = F_13 ( V_2 , V_44 -> V_45 ) ;
const int V_47 = F_11 ( V_2 , V_44 -> V_45 + 1 ) ;
const unsigned int V_48 = abs ( V_47 * V_35 ) ;
return snprintf ( V_42 , V_46 , L_2 , V_48 ) ;
}
static T_4 F_18 ( struct V_1 * V_2 ,
struct V_40 * V_41 ,
char * V_42 )
{
struct V_49 * V_44 = F_19 ( V_41 ) ;
struct V_3 * V_4 = F_6 ( V_2 ) ;
const T_1 V_24 = V_4 -> V_19 [ V_44 -> V_45 ] ;
const T_3 V_50 = V_44 -> V_51 ;
return snprintf ( V_42 , V_46 , L_2 , ( V_24 & V_50 ) ? 1 : 0 ) ;
}
...
if ( V_21 < 0 )
return V_21 ;
return snprintf ( V_42 , V_46 , L_2 , V_21 * 10 ) ;
}
...
{
struct V_55 * V_56 = F_23 ( & V_6 -> V_2 ) ;
struct V_57 * V_58 = V_6 -> V_2 . V_59 ;
if ( V_56 )
return V_56 -> V_11 ;
if ( F_24 ( V_58 , L_3 , NULL ) )
return true ;
return false ;
}
...
if ( ! F_26 ( V_63 , V_65 ) )
return - V_66 ;
V_4 = F_27 ( & V_6 -> V_2 , sizeof( * V_4 ) , V_67 ) ;
if ( ! V_4 )
return - V_68 ;
V_4 -> V_6 = V_6 ;
F_28 ( & V_4 -> V_22 ) ;
