...
V_16 = F_5 ( V_13 -> V_21 , V_5 , V_7 , sizeof( * V_15 ) , V_9 ) ;
if ( V_16 )
return V_16 ;
V_16 = V_22 ;
} else {
...
struct V_119 V_120 ;
if ( F_47 ( V_29 , V_20 , sizeof( V_113 ) , & V_113 ) )
goto V_121;
V_120 . V_122 = F_48 ( V_103 - V_15 -> V_101 . V_122 ) ;
V_120 . V_102 = F_48 ( V_103 - V_15 -> V_101 . V_102 ) ;
V_120 . V_123 = F_48 ( V_15 -> V_101 . V_123 ) ;
if ( F_47 ( V_29 , V_124 , sizeof( V_120 ) , & V_120 ) )
goto V_121;
return V_29 -> V_62 ;
V_121:
F_49 ( V_29 , V_112 ) ;
