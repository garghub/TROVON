...
static int F_162 ( struct V_302 * V_42 , struct V_26 * V_27 )
{
struct V_41 * V_4 = F_87 ( V_42 ,
struct V_41 ,
V_205 ) ;
...
const struct V_26 * V_322 )
{
int V_14 ;
struct V_26 V_323 ;
struct V_26 V_303 ;
V_14 = F_162 ( V_42 , & V_323 ) ;
if ( V_14 != 0 )
return V_14 ;
V_303 = F_165 ( * V_322 , V_323 ) ;
...
if ( V_2 -> type -> V_331 )
V_2 -> type -> V_331 ( V_2 , true , true ) ;
}
void F_170 ( struct V_1 * V_2 )
{
if ( V_2 -> type -> V_331 )
V_2 -> type -> V_331 ( V_2 , false , true ) ;
F_83 ( V_2 ) ;
}
