...
static int F_69 ( struct V_71 * V_72 , unsigned long V_37 )
{
struct V_73 * V_74 ;
T_5 V_75 ;
struct V_40 * V_41 ;
...
{
struct V_40 * V_41 ;
V_41 = F_93 ( sizeof( struct V_40 ) , V_48 ) ;
if ( ! V_41 ) {
F_41 ( L_5 , type ) ;
return;
}
