...
int V_22 ;
int V_23 ;
for ( V_23 = 0 ; V_23 < F_6 ( V_2 -> V_16 ) ; V_23 ++ ) {
V_18 = F_7 ( V_2 -> V_16 , V_23 ) ;
if ( ! V_18 )
continue;
V_3 = F_8 ( V_18 ) ;
...
F_10 ( V_8 , F_4 ( V_6 -> V_11 ) , V_25 | V_24 ) ;
return 0 ;
}
...
V_6 -> V_2 . V_35 = & V_35 ;
V_6 -> V_8 = V_8 ;
V_16 = F_17 ( NULL , & V_6 -> V_2 ) ;
if ( F_18 ( V_16 ) )
F_19 ( V_6 ) ;
return V_16 ;
}
static void T_3
F_20 ( struct V_44 * V_45 , struct V_7 * V_8 ,
const struct V_9 * V_10 )
{
int V_46 ;
T_1 V_11 ;
...
const char * V_31 ;
struct V_44 * V_48 ;
V_33 = F_21 ( V_45 , L_1 , L_2 ) ;
if ( V_33 <= 0 || V_33 > V_47 )
return;
for ( V_23 = 0 ; V_23 < V_33 ; ++ V_23 ) {
V_32 [ V_23 ] = F_22 ( V_45 , V_23 ) ;
if ( ! V_32 [ V_23 ] )
return;
}
V_46 = F_23 ( V_45 ) ;
...
return;
F_24 (np, progclknp) {
if ( F_25 ( V_48 , L_3 , & V_11 ) )
continue;
if ( F_26 ( V_45 , L_4 , & V_31 ) )
V_31 = V_48 -> V_31 ;
V_16 = F_14 ( V_8 , V_31 ,
V_32 , V_33 ,
V_11 , V_10 ) ;
...
void T_3 F_28 ( struct V_44 * V_45 ,
struct V_7 * V_8 )
{
F_20 ( V_45 , V_8 , & V_50 ) ;
}
