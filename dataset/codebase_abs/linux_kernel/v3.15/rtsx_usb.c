...
if ( V_17 )
goto V_175;
V_17 = F_52 ( & V_158 -> V_5 , V_162 -> V_165 , V_176 ,
F_53 ( V_176 ) , NULL , 0 , NULL ) ;
if ( V_17 )
goto V_175;
F_54 ( & V_3 -> V_20 ) ;
F_55 ( & V_3 -> V_20 , F_1 , ( unsigned long ) V_3 ) ;
#ifdef F_56
V_158 -> V_177 = 1 ;
F_57 ( V_162 ) ;
#endif
return 0 ;
V_175:
F_58 ( V_3 -> V_18 , V_36 , V_3 -> V_168 ,
V_3 -> V_169 ) ;
return V_17 ;
}
static void F_59 ( struct V_157 * V_158 )
{
struct V_2 * V_3 = (struct V_2 * ) F_60 ( V_158 ) ;
...
static int F_62 ( struct V_157 * V_158 , T_3 V_178 )
{
struct V_2 * V_3 =
(struct V_2 * ) F_60 ( V_158 ) ;
F_2 ( & V_158 -> V_5 , L_13 ,
V_6 , V_178 . V_179 ) ;
F_63 ( & V_3 -> V_174 ) ;
F_64 ( V_3 ) ;
