...
static int F_22 ( struct V_81 * V_81 ,
...
V_47 = F_26 ( V_84 , V_86 , & V_9 ) ;
if ( V_47 < 0 ) {
F_10 ( & V_81 -> V_30 , L_6 ) ;
goto error;
}
if ( ( V_9 != F_27 ( V_87 , V_88 ) ) &&
( V_9 != F_27 ( V_87 , V_89 ) ) ) {
F_10 ( & V_81 -> V_30 , L_7 , V_9 ) ;
V_47 = - V_90 ;
goto error;
}
F_28 ( & V_81 -> V_30 , L_8 ,
V_9 & 7 ) ;
V_24 = F_29 ( & V_81 -> V_30 , sizeof( struct V_23 ) ,
V_91 ) ;
if ( ! V_24 )
return - V_92 ;
F_30 ( V_81 , V_24 ) ;
...
static int F_32 ( struct V_81 * V_95 )
{
F_33 ( & V_95 -> V_30 ) ;
return 0 ;
}
