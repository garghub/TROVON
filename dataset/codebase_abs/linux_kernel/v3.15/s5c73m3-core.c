...
V_17 = F_77 ( V_30 -> clock , V_30 -> V_187 ) ;
if ( V_17 < 0 )
goto V_186;
V_17 = F_78 ( V_30 -> clock ) ;
if ( V_17 < 0 )
goto V_186;
F_8 ( 1 , V_18 , & V_30 -> V_188 , L_31 ,
F_79 ( V_30 -> clock ) ) ;
F_74 ( V_30 , V_189 ) ;
F_15 ( 100 , 200 ) ;
F_74 ( V_30 , V_190 ) ;
...
V_17 = F_80 ( V_30 -> V_184 [ V_99 ] . V_185 ) ;
if ( V_17 )
goto V_191;
}
return 0 ;
...
int V_192 = F_76 ( V_30 -> V_184 [ V_99 ] . V_185 ) ;
if ( V_192 < 0 )
F_9 ( & V_30 -> V_188 , L_32 ,
V_30 -> V_184 [ V_99 ] . V_193 , V_192 ) ;
}
F_78 ( V_30 -> clock ) ;
return V_17 ;
}
...
struct V_29 * V_30 = F_32 ( V_60 ) ;
int V_17 ;
V_17 = F_85 ( V_60 -> V_194 , & V_30 -> V_45 ) ;
if ( V_17 ) {
F_9 ( V_60 -> V_194 , L_35 ,
V_30 -> V_188 . V_175 ) ;
return V_17 ;
}
V_17 = F_86 ( & V_30 -> V_45 . V_195 ,
V_138 , & V_30 -> V_188 . V_195 , V_130 ,
V_196 | V_197 ) ;
V_17 = F_86 ( & V_30 -> V_45 . V_195 ,
V_154 , & V_30 -> V_188 . V_195 , V_133 ,
V_196 | V_197 ) ;
return V_17 ;
}
...
{
static const char * const V_198 [] = {
L_36 , L_37
} ;
struct V_12 * V_199 = V_30 -> V_12 ;
struct V_200 * V_201 = V_30 -> V_181 ;
int V_17 , V_99 ;
for ( V_99 = 0 ; V_99 < V_202 ; ++ V_99 ) {
unsigned int V_25 = V_203 ;
if ( V_201 [ V_99 ] . V_182 )
V_25 |= V_204 ;
V_17 = F_90 ( & V_199 -> V_65 , V_201 [ V_99 ] . V_181 , V_25 ,
V_198 [ V_99 ] ) ;
if ( V_17 ) {
F_9 ( V_199 , L_38 ,
V_198 [ V_99 ] ) ;
...
struct V_206 * V_65 = & V_30 -> V_12 -> V_65 ;
struct V_207 * V_208 = V_65 -> V_209 ;
int V_17 , V_99 ;
for ( V_99 = 0 ; V_99 < V_202 ; ++ V_99 ) {
enum V_210 V_211 ;
V_17 = F_92 ( V_208 , V_205 [ V_99 ] ,
0 , & V_211 ) ;
if ( V_17 < 0 ) {
F_93 ( V_65 , L_41 ,
V_205 [ V_99 ] ) ;
...
V_30 -> V_181 [ V_99 ] . V_181 = V_17 ;
V_30 -> V_181 [ V_99 ] . V_182 = ! ( V_211 & V_212 ) ;
}
return 0 ;
}
...
{
struct V_206 * V_65 = & V_30 -> V_12 -> V_65 ;
const struct V_213 * V_214 = V_65 -> V_215 ;
struct V_207 * V_208 = V_65 -> V_209 ;
struct V_207 * V_216 ;
struct V_217 V_218 ;
int V_17 ;
...
V_30 -> V_187 = V_214 -> V_187 ;
V_30 -> V_181 [ V_189 ] = V_214 -> V_219 ;
V_30 -> V_181 [ V_190 ] = V_214 -> V_220 ;
return 0 ;
}
V_30 -> clock = F_95 ( V_65 , V_221 ) ;
if ( F_96 ( V_30 -> clock ) )
...
if ( V_218 . V_226 . V_227 . V_228 != V_229 )
F_99 ( V_65 , L_47 ) ;
return 0 ;
}
static int F_104 ( struct V_12 * V_13 ,
const struct V_230 * V_180 )
{
struct V_206 * V_65 = & V_13 -> V_65 ;
struct V_59 * V_60 ;
struct V_59 * V_188 ;
struct V_29 * V_30 ;
int V_17 , V_99 ;
V_30 = F_105 ( V_65 , sizeof( * V_30 ) , V_231 ) ;
if ( ! V_30 )
return - V_232 ;
V_30 -> V_12 = V_13 ;
V_17 = F_94 ( V_30 ) ;
...
V_188 = & V_30 -> V_188 ;
F_107 ( V_60 , & V_233 ) ;
V_60 -> V_234 = V_13 -> V_65 . V_235 -> V_234 ;
F_108 ( V_60 , V_30 ) ;
F_109 ( V_60 -> V_175 , L_48 , sizeof( V_60 -> V_175 ) ) ;
V_60 -> V_236 = & V_237 ;
V_60 -> V_25 |= V_238 ;
V_30 -> V_239 [ V_154 ] . V_25 = V_240 ;
V_30 -> V_239 [ V_138 ] . V_25 = V_240 ;
V_60 -> V_195 . type = V_241 ;
V_17 = F_110 ( & V_60 -> V_195 , V_167 ,
V_30 -> V_239 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
F_111 ( V_188 , V_13 , & V_242 ) ;
strcpy ( V_188 -> V_175 , L_49 ) ;
V_188 -> V_236 = & V_243 ;
V_188 -> V_25 |= V_238 ;
V_30 -> V_244 [ V_130 ] . V_25 = V_245 ;
V_30 -> V_244 [ V_133 ] . V_25 = V_245 ;
V_30 -> V_244 [ V_134 ] . V_25 = V_240 ;
V_188 -> V_195 . type = V_241 ;
V_17 = F_110 ( & V_188 -> V_195 , V_246 ,
V_30 -> V_244 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
V_17 = F_89 ( V_30 ) ;
...
goto V_247;
for ( V_99 = 0 ; V_99 < V_183 ; V_99 ++ )
V_30 -> V_184 [ V_99 ] . V_193 = V_248 [ V_99 ] ;
V_17 = F_112 ( V_65 , V_183 ,
V_30 -> V_184 ) ;
if ( V_17 ) {
F_93 ( V_65 , L_50 ) ;
goto V_247;
...
{
struct V_59 * V_188 = F_119 ( V_13 ) ;
struct V_29 * V_30 = F_32 ( V_188 ) ;
