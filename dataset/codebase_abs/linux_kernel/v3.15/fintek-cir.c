...
V_95 -> V_131 = V_132 ;
V_95 -> V_133 = L_35 ;
V_95 -> V_134 . V_135 = V_136 ;
V_95 -> V_134 . V_32 = V_48 ;
V_95 -> V_134 . V_137 = V_2 -> V_26 ;
V_95 -> V_134 . V_138 = V_2 -> V_27 ;
V_95 -> V_114 . V_139 = & V_117 -> V_114 ;
V_95 -> V_140 = V_16 ;
V_95 -> V_141 = V_142 ;
V_95 -> V_143 = F_28 ( 1000 ) ;
V_95 -> V_144 = F_28 ( V_100 ) ;
V_2 -> V_95 = V_95 ;
V_34 = - V_145 ;
if ( ! F_52 ( V_2 -> V_14 ,
V_2 -> V_57 , V_16 ) )
goto V_122;
if ( F_53 ( V_2 -> V_56 , F_33 , V_146 ,
V_16 , ( void * ) V_2 ) )
goto V_147;
V_34 = F_54 ( V_95 ) ;
if ( V_34 )
goto V_148;
F_55 ( & V_117 -> V_114 , true ) ;
F_16 ( V_149 , L_36 ) ;
if ( V_110 )
F_13 ( V_2 ) ;
return 0 ;
...
F_56 ( V_2 -> V_56 , V_2 ) ;
V_147:
F_57 ( V_2 -> V_14 , V_2 -> V_57 ) ;
V_122:
F_58 ( V_95 ) ;
F_59 ( V_2 ) ;
return V_34 ;
}
static void F_60 ( struct V_116 * V_117 )
{
struct V_1 * V_2 = F_61 ( V_117 ) ;
unsigned long V_25 ;
F_17 ( & V_2 -> V_50 , V_25 ) ;
F_37 ( V_2 ) ;
F_11 ( V_2 , V_59 , V_20 ) ;
...
static int F_63 ( struct V_116 * V_117 , T_4 V_150 )
{
struct V_1 * V_2 = F_61 ( V_117 ) ;
unsigned long V_25 ;
F_2 ( L_37 , V_5 ) ;
