...
goto V_90;
V_89 = F_29 ( & V_59 , L_9 ) ;
if ( ! strlen ( V_89 ) || strcmp ( V_89 , L_11 ) != 0 )
goto V_53;
if ( ! V_59 )
goto V_53;
...
struct V_1 * V_2 )
{
return F_46 ( L_14 , V_19 , ( void * ) V_2 -> V_60 ,
V_2 -> V_59 ) ;
}
static struct V_61 *
...
struct V_1 * V_2 )
{
return F_46 ( L_15 , V_19 , ( void * ) V_2 -> V_60 ,
V_2 -> V_59 ) ;
}
static struct V_61 *
...
F_24 ( V_19 , L_6 , V_2 -> V_60 ) ;
if ( V_2 -> V_59 )
F_24 ( V_19 , L_7 , V_2 -> V_59 ) ;
else
F_21 ( V_19 , L_8 ) ;
return 0 ;
}
...
if ( ! V_79 )
return - V_43 ;
system = F_29 ( & V_79 , L_10 ) ;
if ( ! V_79 )
return - V_43 ;
V_115 = F_29 ( & V_79 , L_10 ) ;
V_35 = - V_43 ;
