...
V_171 = ( ( F_46 ( V_10 , 0x51 ) << 1 ) + ( F_46 ( V_10 , 0x52 ) >> 7 ) ) * 1000000 ;
V_171 += ( ( F_46 ( V_10 , 0x52 ) & 0x7f ) * 7813 ) ;
if ( F_83 ( V_10 ) ) {
V_171 = V_171 * 8 / ( ( ( F_46 ( V_10 , 0x0b ) & 0xc0 ) >> 6 ) * 2 + 8 ) ;
}
V_6 -> V_108 = V_171 ;
...
F_46 ( V_10 , 0x33 ) ) / 2 ;
V_6 -> V_173 = ( ( F_46 ( V_10 , 0x05 ) & 0x10 ) ? V_161 : 0 ) |
( ( F_46 ( V_10 , 0x05 ) & 0x20 ) ? V_159 : 0 ) ;
if ( V_6 -> V_164 == V_169 ) {
V_6 -> V_96 += ( F_46 ( V_10 , 0x0b ) & 0x0f ) * 256 +
F_46 ( V_10 , 0x0c ) ;
V_6 -> V_174 = ( ( F_46 ( V_10 , 0x2c ) & 0x1f ) * 256 +
F_46 ( V_10 , 0x2d ) ) / 2 ;
V_6 -> V_175 = ( ( F_46 ( V_10 , 0x30 ) & 0x1f ) * 256 +
F_46 ( V_10 , 0x31 ) ) / 2 ;
...
{
F_34 ( V_10 , 0xe0 , 0xbf , V_180 -> V_181 ? 0x00 : 0x40 ) ;
if ( ! V_180 -> V_181 )
return;
F_34 ( V_10 , 0xe0 , 0x7f , V_180 -> V_182 == 2 ? 0x80 : 0x00 ) ;
F_34 ( V_10 , 0xe0 , 0xe0 , V_180 -> V_183 >> 8 ) ;
F_33 ( V_10 , 0xe1 , V_180 -> V_183 ) ;
F_34 ( V_10 , 0xe2 , 0xe0 , V_180 -> V_184 >> 8 ) ;
F_33 ( V_10 , 0xe3 , V_180 -> V_184 ) ;
F_34 ( V_10 , 0xe4 , 0xe0 , V_180 -> V_185 >> 8 ) ;
F_33 ( V_10 , 0xe5 , V_180 -> V_185 ) ;
F_34 ( V_10 , 0xe6 , 0x80 , V_180 -> V_186 >> 8 ) ;
F_33 ( V_10 , 0xe7 , V_180 -> V_186 ) ;
F_34 ( V_10 , 0xe8 , 0xe0 , V_180 -> V_187 >> 8 ) ;
F_33 ( V_10 , 0xe9 , V_180 -> V_187 ) ;
F_34 ( V_10 , 0xea , 0xe0 , V_180 -> V_188 >> 8 ) ;
F_33 ( V_10 , 0xeb , V_180 -> V_188 ) ;
F_34 ( V_10 , 0xec , 0xe0 , V_180 -> V_189 >> 8 ) ;
F_33 ( V_10 , 0xed , V_180 -> V_189 ) ;
F_34 ( V_10 , 0xee , 0x80 , V_180 -> V_190 >> 8 ) ;
F_33 ( V_10 , 0xef , V_180 -> V_190 ) ;
F_34 ( V_10 , 0xf0 , 0xe0 , V_180 -> V_191 >> 8 ) ;
F_33 ( V_10 , 0xf1 , V_180 -> V_191 ) ;
F_34 ( V_10 , 0xf2 , 0xe0 , V_180 -> V_192 >> 8 ) ;
F_33 ( V_10 , 0xf3 , V_180 -> V_192 ) ;
F_34 ( V_10 , 0xf4 , 0xe0 , V_180 -> V_193 >> 8 ) ;
F_33 ( V_10 , 0xf5 , V_180 -> V_193 ) ;
F_34 ( V_10 , 0xf6 , 0x80 , V_180 -> V_194 >> 8 ) ;
F_33 ( V_10 , 0xf7 , V_180 -> V_194 ) ;
}
...
T_3 V_199 , T_3 V_200 , T_3 V_201 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_55 ( 2 , V_52 , V_10 , L_53 , V_53 , V_199 ) ;
switch ( V_199 ) {
case V_202 :
V_40 -> V_54 = V_57 ;
V_40 -> V_196 = V_203 ;
...
F_100 ( V_10 ) ;
F_103 ( V_10 , V_40 -> V_196 ) ;
F_99 ( V_10 ) ;
F_105 ( V_10 , V_211 , NULL ) ;
return 0 ;
}
static int F_106 ( struct V_9 * V_10 , unsigned int V_212 ,
enum V_213 * V_214 )
{
if ( V_212 )
return - V_75 ;
...
static void F_108 ( struct V_9 * V_10 , bool V_225 )
{
if ( V_225 ) {
F_23 ( V_10 , 0x46 , 0x9c ) ;
F_23 ( V_10 , 0x5a , 0x10 ) ;
...
static int F_109 ( struct V_9 * V_10 , T_3 V_146 , bool * V_226 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 V_227 , V_228 , V_229 ;
T_2 V_230 [ 6 ] ;
F_108 ( V_10 , false ) ;
V_230 [ 0 ] = F_21 ( V_10 , 0x43 ) ;
V_230 [ 1 ] = F_21 ( V_10 , 0x57 ) ;
V_230 [ 2 ] = F_21 ( V_10 , 0x70 ) ;
V_230 [ 3 ] = F_21 ( V_10 , 0x75 ) ;
V_230 [ 4 ] = F_21 ( V_10 , 0x9d ) ;
V_230 [ 5 ] = F_21 ( V_10 , 0x66 ) ;
if ( V_230 [ 0 ] )
F_23 ( V_10 , 0x44 , V_230 [ 0 ] ) ;
if ( V_230 [ 1 ] )
F_23 ( V_10 , 0x58 , V_230 [ 1 ] ) ;
if ( V_230 [ 2 ] )
F_23 ( V_10 , 0x71 , V_230 [ 2 ] ) ;
if ( V_230 [ 3 ] )
F_23 ( V_10 , 0x76 , V_230 [ 3 ] ) ;
if ( V_230 [ 4 ] )
F_23 ( V_10 , 0x9e , V_230 [ 4 ] ) ;
if ( V_230 [ 5 ] )
F_23 ( V_10 , 0x67 , V_230 [ 5 ] ) ;
F_108 ( V_10 , true ) ;
F_55 ( 1 , V_52 , V_10 , L_54 , V_53 ,
V_230 [ 0 ] , V_230 [ 1 ] , V_230 [ 2 ] ,
V_230 [ 3 ] , V_230 [ 4 ] , V_230 [ 5 ] ) ;
V_227 = V_230 [ 0 ] & 0x9c ;
if ( V_40 -> V_54 == V_148 )
V_229 = ( V_230 [ 1 ] & 0x30 ) | ( V_230 [ 4 ] & 0x09 ) ;
else
V_229 = 0 ;
if ( F_58 ( V_10 ) )
V_228 = V_230 [ 3 ] & 0x03 ;
...
static int F_110 ( struct V_9 * V_10 , struct V_231 * V_71 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 * V_20 = NULL ;
if ( V_71 -> V_232 > V_233 )
...
case V_68 :
case V_69 :
if ( V_40 -> V_67 . V_66 & ( 0x04 << V_71 -> V_232 ) )
V_20 = V_40 -> V_67 . V_71 ;
break;
case V_233 :
if ( V_40 -> V_70 . V_66 )
...
static int F_111 ( struct V_9 * V_10 , struct V_231 * V_236 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
int V_30 = 0 ;
if ( V_236 -> V_232 > V_233 )
return - V_75 ;
if ( V_236 -> V_235 != 0 )
return - V_75 ;
if ( V_236 -> V_234 > 2 )
...
if ( V_236 -> V_234 )
V_40 -> V_67 . V_66 |= 0x04 << V_236 -> V_232 ;
else
V_40 -> V_67 . V_66 &= ~ ( 0x04 << V_236 -> V_232 ) ;
memcpy ( & V_40 -> V_67 . V_71 , V_236 -> V_71 , 128 * V_236 -> V_234 ) ;
V_30 = F_65 ( V_10 , V_236 -> V_232 ) ;
break;
default:
return - V_75 ;
}
if ( V_30 < 0 )
F_76 ( V_10 , L_60 , V_30 , V_236 -> V_232 ) ;
return V_30 ;
}
...
F_96 ( V_10 -> V_178 , L_150 ,
& V_89 , true ) ;
F_96 ( V_10 -> V_178 , L_151 ,
& V_40 -> V_89 , true ) ;
if ( F_82 ( V_10 ) )
return 0 ;
F_67 ( V_10 , L_152 ) ;
...
static int F_121 ( struct V_9 * V_10 , T_7 * V_220 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_55 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_54 != V_148 )
...
F_143 ( & V_40 -> V_65 ,
F_60 ) ;
V_40 -> V_232 . V_23 = V_377 ;
V_30 = F_144 ( & V_10 -> V_378 , 1 , & V_40 -> V_232 , 0 ) ;
if ( V_30 )
goto V_379;
V_30 = F_122 ( V_10 ) ;
if ( V_30 )
goto V_380;
F_67 ( V_10 , L_203 , V_16 -> V_178 ,
V_16 -> V_22 << 1 , V_16 -> V_21 -> V_178 ) ;
return 0 ;
V_380:
F_145 ( & V_10 -> V_378 ) ;
V_379:
