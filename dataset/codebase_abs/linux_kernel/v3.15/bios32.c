...
T_6 F_50 ( void * V_109 , const struct V_16 * V_79 ,
T_6 V_110 , T_6 V_111 )
{
...
if ( V_61 -> V_97 )
return V_61 -> V_97 ( V_6 , V_79 , V_18 , V_110 , V_111 ) ;
return V_18 ;
}
int F_51 ( struct V_5 * V_6 , int V_112 )
{
if ( F_44 ( V_107 ) )
return 0 ;
return F_52 ( V_6 , V_112 ) ;
}
int F_53 ( struct V_5 * V_6 , struct V_113 * V_114 ,
enum V_115 V_116 , int V_117 )
{
struct V_60 * V_118 = V_6 -> V_62 ;
unsigned long V_119 ;
if ( V_116 == V_120 ) {
return - V_121 ;
} else {
V_119 = V_114 -> V_122 + ( V_118 -> V_78 >> V_123 ) ;
}
V_114 -> V_124 = F_54 ( V_114 -> V_124 ) ;
if ( F_55 ( V_114 , V_114 -> V_125 , V_119 ,
V_114 -> V_126 - V_114 -> V_125 ,
V_114 -> V_124 ) )
return - V_127 ;
return 0 ;
}
void T_5 F_56 ( unsigned long V_128 )
{
struct V_129 V_130 = {
. V_131 = V_132 ,
. type = V_133 ,
