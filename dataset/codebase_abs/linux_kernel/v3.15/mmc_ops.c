...
T_2 * V_102 ;
int V_31 , V_5 ;
static T_2 V_103 [ 8 ] = { 0x55 , 0xaa , 0 , 0 , 0 , 0 , 0 , 0 } ;
static T_2 V_104 [ 4 ] = { 0x5a , 0 , 0 , 0 } ;
V_51 = F_18 ( V_44 , V_53 ) ;
if ( ! V_51 )
return - V_54 ;
if ( V_44 == 8 )
...
int F_38 ( struct V_1 * V_2 , T_2 V_109 )
{
int V_5 , V_110 ;
if ( V_109 == V_111 )
V_110 = 8 ;
...
return - V_68 ;
F_37 ( V_2 , V_2 -> V_8 , V_105 , V_110 ) ;
V_5 = F_37 ( V_2 , V_2 -> V_8 , V_106 , V_110 ) ;
return V_5 ;
}
