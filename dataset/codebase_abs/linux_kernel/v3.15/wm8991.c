...
static int F_26 ( struct V_132 * V_133 ,
const struct V_134 * V_135 )
{
struct V_108 * V_109 ;
unsigned int V_13 ;
int V_12 ;
V_109 = F_27 ( & V_133 -> V_2 , sizeof( * V_109 ) , V_136 ) ;
if ( ! V_109 )
return - V_137 ;
V_109 -> V_118 = F_28 ( V_133 , & V_138 ) ;
if ( F_29 ( V_109 -> V_118 ) )
return F_30 ( V_109 -> V_118 ) ;
F_31 ( V_133 , V_109 ) ;
V_12 = F_32 ( V_109 -> V_118 , V_4 , & V_13 ) ;
if ( V_12 != 0 ) {
F_33 ( & V_133 -> V_2 , L_6 , V_12 ) ;
return V_12 ;
}
if ( V_13 != 0x8991 ) {
F_33 ( & V_133 -> V_2 , L_7 , V_13 ) ;
return - V_67 ;
}
V_12 = F_34 ( V_109 -> V_118 , V_4 , 0 ) ;
if ( V_12 < 0 ) {
F_33 ( & V_133 -> V_2 , L_8 , V_12 ) ;
return V_12 ;
}
F_35 ( V_109 -> V_118 , V_139 ,
V_140 , V_140 ) ;
F_35 ( V_109 -> V_118 , V_141 ,
V_142 , 1 ) ;
F_35 ( V_109 -> V_118 , V_112 ,
V_143 | V_113 ,
V_143 | V_113 ) ;
F_35 ( V_109 -> V_118 , V_48 ,
V_144 , V_144 ) ;
F_34 ( V_109 -> V_118 , V_104 , 0 ) ;
F_34 ( V_109 -> V_118 , V_145 ,
0x50 | ( 1 << 8 ) ) ;
F_34 ( V_109 -> V_118 , V_146 ,
0x50 | ( 1 << 8 ) ) ;
V_12 = F_36 ( & V_133 -> V_2 ,
& V_147 , & V_148 , 1 ) ;
return V_12 ;
}
static int F_37 ( struct V_132 * V_149 )
{
F_38 ( & V_149 -> V_2 ) ;
return 0 ;
}
