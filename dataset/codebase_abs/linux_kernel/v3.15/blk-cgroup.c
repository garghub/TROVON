...
static const char * F_56 ( struct V_7 * V_8 )
{
if ( V_8 -> V_2 -> V_59 . V_60 )
return F_57 ( V_8 -> V_2 -> V_59 . V_60 ) ;
return NULL ;
}
void F_58 ( struct V_61 * V_62 , struct V_13 * V_13 ,
T_2 (* F_59)( struct V_61 * ,
struct V_20 * , int ) ,
...
T_2 V_65 = 0 ;
F_60 () ;
F_61 (blkg, &blkcg->blkg_list, blkcg_node) {
F_47 ( V_8 -> V_2 -> V_26 ) ;
if ( F_1 ( V_8 -> V_2 , V_4 ) )
V_65 += F_59 ( V_62 , V_8 -> V_11 [ V_4 -> V_5 ] , V_63 ) ;
F_48 ( V_8 -> V_2 -> V_26 ) ;
}
F_62 () ;
if ( V_64 )
F_63 ( V_62 , L_1 , ( unsigned long long ) V_65 ) ;
}
T_2 F_64 ( struct V_61 * V_62 , struct V_20 * V_11 , T_2 V_66 )
{
const char * V_67 = F_56 ( V_11 -> V_8 ) ;
if ( ! V_67 )
return 0 ;
F_63 ( V_62 , L_2 , V_67 , ( unsigned long long ) V_66 ) ;
return V_66 ;
}
T_2 F_65 ( struct V_61 * V_62 , struct V_20 * V_11 ,
...
F_63 ( V_62 , L_7 , V_67 , V_70 [ V_9 ] ,
( unsigned long long ) V_69 -> V_76 [ V_9 ] ) ;
V_66 = V_69 -> V_76 [ V_71 ] + V_69 -> V_76 [ V_72 ] ;
F_63 ( V_62 , L_8 , V_67 , ( unsigned long long ) V_66 ) ;
return V_66 ;
}
T_2 F_66 ( struct V_61 * V_62 , struct V_20 * V_11 , int V_77 )
{
return F_64 ( V_62 , V_11 , F_67 ( ( void * ) V_11 + V_77 ) ) ;
}
T_2 F_68 ( struct V_61 * V_62 , struct V_20 * V_11 ,
int V_77 )
{
struct V_68 V_69 = F_69 ( ( void * ) V_11 + V_77 ) ;
return F_65 ( V_62 , V_11 , & V_69 ) ;
}
T_2 F_70 ( struct V_20 * V_11 , int V_77 )
{
...
F_60 () ;
F_71 (pos_blkg, pos_css, pd_to_blkg(pd)) {
struct V_20 * V_81 = F_72 ( V_78 , V_4 ) ;
...
struct V_68 F_73 ( struct V_20 * V_11 ,
int V_77 )
{
struct V_3 * V_4 = V_3 [ V_11 -> V_5 ] ;
struct V_7 * V_78 ;
...
int F_74 ( struct V_13 * V_13 , const struct V_3 * V_4 ,
