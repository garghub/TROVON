...
V_9 -> V_150 = (struct V_151 * )
F_72 ( V_131 ) -> V_160 ;
V_9 -> V_117 = V_158 -> V_161 ;
V_9 -> V_128 = V_158 -> V_162 ;
V_9 -> V_75 = V_158 -> V_163 ;
V_9 -> V_76 = V_9 -> V_150 -> V_76 ;
...
static int F_73 ( struct V_164 * V_39 )
{
struct V_8 * V_9 = F_74 ( V_39 ) ;
F_23 ( V_9 , V_59 , V_57 ) ;
return 0 ;
}
static void F_75 ( struct V_164 * V_39 )
{
struct V_8 * V_9 = F_74 ( V_39 ) ;
F_23 ( V_9 , V_58 , V_57 ) ;
}
static int F_76 ( struct V_8 * V_9 , T_2 V_142 )
{
T_2 V_24 = 0 , V_165 ;
int V_10 = 0 ;
if ( V_9 -> V_70 == V_71 )
...
V_24 = V_167 ;
V_165 = F_61 ( V_168 * V_142 / 1000 , 1 ) ;
while ( V_165 >> ++ V_10 )
;
if ( abs ( V_165 - ( 1 << V_10 ) ) < abs ( V_165 - ( 1 << ( V_10 - 1 ) ) ) )
V_165 = V_10 ;
else
V_165 = V_10 - 1 ;
if ( V_9 -> V_150 -> V_169 ) {
V_24 |= F_77 ( V_9 -> V_150 -> V_170 )
& V_171 ;
V_24 |= F_78 ( V_165 ) & V_172 ;
V_24 |= V_173 ;
V_24 |= V_174 ;
V_24 |= 0x03 << 8 ;
F_23 ( V_9 , V_175 , V_24 ) ;
...
F_23 ( V_9 , V_176 , V_9 -> V_150 -> V_177
& V_178 ) ;
V_9 -> V_63 = F_61 ( ( V_179 *
V_142 / 1000 ) - 1 , 1 ) ;
return 0 ;
...
V_180 -> V_99 = V_181 ;
V_180 -> V_100 . V_182 = V_183 ;
V_180 -> V_39 . V_112 = & V_131 -> V_39 ;
V_180 -> V_184 = F_73 ;
V_180 -> V_185 = F_75 ;
F_81 ( V_186 , V_180 -> V_187 ) ;
F_81 ( V_188 , V_180 -> V_187 ) ;
F_81 ( V_47 , V_180 -> V_189 ) ;
F_82 ( V_180 , V_44 , 0 , ( 1 << V_38 ) - 1 , 0 , 0 ) ;
F_82 ( V_180 , V_45 , 0 , ( 1 << V_38 ) - 1 , 0 , 0 ) ;
F_82 ( V_180 , V_46 , 0 , 0xffffff , 0 , 0 ) ;
V_9 -> V_43 = V_180 ;
F_83 ( V_180 , V_9 ) ;
V_111 = F_84 ( V_180 ) ;
if ( V_111 )
...
static int F_88 ( struct V_130 * V_131 )
{
unsigned int V_190 , V_191 , V_145 , V_192 , V_142 , V_193 ;
int V_111 ;
struct V_5 * V_6 ;
struct V_8 * V_9 ;
struct V_194 * V_35 ;
T_2 V_24 ;
V_6 = F_89 ( & V_131 -> V_39 , sizeof( struct V_8 ) ) ;
if ( ! V_6 )
return - V_78 ;
V_9 = F_2 ( V_6 ) ;
if ( V_131 -> V_39 . V_134 )
...
V_6 -> V_99 = F_91 ( & V_131 -> V_39 ) ;
V_6 -> V_195 = V_196 ;
V_6 -> V_197 = & V_198 ;
V_9 -> V_1 = F_92 ( V_131 , 0 ) ;
if ( V_9 -> V_1 < 0 ) {
F_17 ( & V_131 -> V_39 , L_41 ) ;
return - V_139 ;
}
V_35 = F_93 ( V_131 , V_199 , 0 ) ;
V_9 -> V_200 = F_94 ( & V_131 -> V_39 , V_35 ) ;
if ( F_95 ( V_9 -> V_200 ) ) {
return F_96 ( V_9 -> V_200 ) ;
}
F_23 ( V_9 , V_124 , V_201 ) ;
F_23 ( V_9 , V_58 , 0xFFFFFFFF ) ;
V_111 = F_97 ( V_9 -> V_1 ,
F_22 ,
0 ,
V_131 -> V_39 . V_202 -> V_99 ,
V_6 ) ;
if ( V_111 ) {
F_17 ( & V_131 -> V_39 , L_42 ) ;
return V_111 ;
}
V_9 -> V_203 = F_98 ( & V_131 -> V_39 , L_43 ) ;
if ( F_95 ( V_9 -> V_203 ) ) {
F_17 ( & V_131 -> V_39 , L_44 ) ;
V_111 = F_96 ( V_9 -> V_203 ) ;
goto V_204;
}
V_111 = F_99 ( V_9 -> V_203 ) ;
if ( V_111 ) {
F_17 ( & V_131 -> V_39 ,
L_45 ) ;
goto V_204;
}
V_9 -> V_192 = F_98 ( & V_131 -> V_39 , L_46 ) ;
if ( F_95 ( V_9 -> V_192 ) ) {
F_17 ( & V_131 -> V_39 , L_47 ) ;
V_111 = F_96 ( V_9 -> V_192 ) ;
goto V_205;
}
V_111 = F_99 ( V_9 -> V_192 ) ;
if ( V_111 ) {
F_17 ( & V_131 -> V_39 ,
L_48 ) ;
goto V_205;
}
V_191 = F_100 ( V_9 -> V_203 ) ;
V_192 = F_100 ( V_9 -> V_192 ) ;
V_142 = V_192 / 1000 ;
F_18 ( & V_131 -> V_39 , L_49 ,
V_191 , V_192 ) ;
V_190 = ( V_191 / ( 2 * V_192 ) ) - 1 ;
if ( ! V_9 -> V_141 ) {
F_17 ( & V_131 -> V_39 , L_50 ) ;
V_111 = - V_106 ;
goto V_206;
}
V_145 = (* V_9 -> V_150 -> V_207 )( V_9 -> V_141 , V_142 ) ;
if ( V_9 -> V_155 > 0 )
V_193 = F_61 ( ( V_9 -> V_155 * V_142 / 1000 )
- 1 , 1 ) ;
else
V_193 = 0 ;
V_24 = F_101 ( V_190 ) & V_9 -> V_50 -> V_208 ;
V_24 |= F_102 ( V_145 ) & V_9 -> V_50 -> V_209 ;
if ( V_9 -> V_140 )
V_24 |= V_210 ;
if ( V_9 -> V_154 )
V_24 |= V_211 ;
V_24 |= F_103 ( V_193 ) & V_212 ;
F_23 ( V_9 , V_213 , V_24 ) ;
V_111 = F_25 ( V_6 ) ;
if ( V_111 < 0 ) {
...
static int F_109 ( struct V_130 * V_131 )
{
struct V_5 * V_6 = F_110 ( V_131 ) ;
struct V_8 * V_9 = F_2 ( V_6 ) ;
F_111 ( V_6 ) ;
if ( ! V_9 -> V_70 ) {
F_44 ( V_6 ) ;
