...
static int F_61 ( struct V_1 * V_2 , const void * V_111 )
{
struct V_4 * V_112 ;
const unsigned short * V_113 = V_111 ;
V_112 = F_3 ( V_2 ) ;
return V_112 -> V_30 == * V_113 ;
}
struct V_4 * F_62 ( unsigned short V_113 )
{
struct V_1 * V_114 ;
struct V_4 * V_5 = NULL ;
V_114 = F_63 ( & V_100 , NULL , & V_113 ,
F_61 ) ;
if ( V_114 ) {
V_5 = F_64 ( F_3 ( V_114 ) ) ;
F_2 ( V_114 ) ;
...
{
return V_2 -> type == & V_98 ;
}
int F_70 ( struct V_4 * V_5 , struct V_115 * V_116 )
{
if ( F_71 ( ! V_5 -> V_47 ) ) {
F_22 ( V_18
L_14
