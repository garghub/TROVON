...
static int F_194 ( struct V_150 * V_49 , struct V_283 * V_232 )
{
struct V_233 * V_284 = & V_232 -> V_233 ;
struct V_21 * V_285 = F_195 ( V_232 ) ;
struct V_42 * V_43 ;
struct V_286 V_287 ;
int V_288 , V_289 ;
int V_46 ;
V_43 = F_196 ( sizeof( * V_43 ) , V_183 ) ;
if ( ! V_43 )
return - V_48 ;
F_165 ( V_43 , V_270 ) ;
F_197 ( V_284 , V_43 ) ;
...
F_198 () ;
V_43 -> V_46 = V_46 ;
F_199 ( & V_287 , V_232 -> V_292 ) ;
while ( F_200 ( & V_287 , & V_288 , & V_289 ) ) {
...
V_43 -> V_2 = NULL ;
F_15 ( & V_43 -> V_272 ) ;
F_202 ( & V_43 -> V_90 , F_193 ) ;
F_203 ( & V_43 -> V_278 , F_191 ) ;
V_43 -> V_49 = V_49 ;
F_204 ( & V_43 -> V_297 , & V_49 -> V_298 ) ;
...
static void F_206 ( struct V_42 * V_43 )
{
struct V_1 * V_2 ;
F_2 ( & V_43 -> V_6 ) ;
F_165 ( V_43 , V_303 ) ;
...
static int F_209 ( struct V_283 * V_232 )
{
struct V_21 * V_285 = F_195 ( V_232 ) ;
...
V_304 = F_217 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_312 ,
...
if ( V_301 ) {
struct V_233 * V_314 ;
V_314 = F_217 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_275 ,
...
if ( ! F_219 ( V_315 ) ) {
V_49 -> V_316 = F_220 ( F_141 ( & V_232 -> V_233 ) ,
V_315 ) ;
if ( ! F_219 ( V_49 -> V_316 ) ) {
F_221 ( L_57 , 0444 , V_49 -> V_316 ,
V_49 , & V_317 ) ;
F_221 ( L_58 , 0444 , V_49 -> V_316 ,
V_49 , & V_318 ) ;
}
}
F_204 ( & V_49 -> V_297 , & V_319 ) ;
F_222 ( & V_232 , L_59 ,
F_141 ( V_35 -> V_233 ) , ( unsigned long long ) V_35 -> V_234 ) ;
V_84 = F_194 ( V_49 , V_232 ) ;
if ( ! V_84 )
return 0 ;
...
F_185 ( V_312 , V_49 -> V_155 [ V_14 ] -> V_145 ) ;
...
static int F_224 ( struct V_283 * V_232 ,
const struct V_320 * V_276 )
{
struct V_150 * V_49 ;
int V_84 ;
F_71 ( & V_321 ) ;
V_49 = F_187 ( F_195 ( V_232 ) -> V_35 ) ;
if ( ! V_49 )
V_84 = F_209 ( V_232 ) ;
else
V_84 = F_194 ( V_49 , V_232 ) ;
...
static void F_225 ( struct V_283 * V_232 )
{
struct V_42 * V_43 = F_226 ( & V_232 -> V_233 ) ;
...
static void F_228 ( struct V_283 * V_232 )
{
struct V_21 * V_285 = F_195 ( V_232 ) ;
struct V_42 * V_43 = F_226 ( & V_232 -> V_233 ) ;
int V_46 ;
...
static int F_231 ( struct V_42 * V_43 ,
struct V_241 * V_242 ,
unsigned long long V_45 ,
T_1 V_37 )
{
...
switch ( V_44 ) {
case V_121 :
V_23 = F_231 ( V_43 , V_242 , V_45 , V_37 ) ;
break;
default:
V_23 = V_124 ;
}
...
V_315 = F_220 ( V_331 , NULL ) ;
if ( V_264 + V_330 > V_332 )
V_264 = V_332 - V_330 ;
V_154 = V_264 + V_330 ;
V_312 = F_236 ( V_146 , V_333
| V_334 ) ;
if ( F_205 ( V_312 ) ) {
V_84 = F_218 ( V_312 ) ;
return V_84 ;
