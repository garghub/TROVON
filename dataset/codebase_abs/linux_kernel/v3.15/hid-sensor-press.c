...
static int F_14 ( struct V_41 * V_27 ,
unsigned V_42 ,
void * V_43 )
{
...
static int F_16 ( struct V_41 * V_27 ,
unsigned V_42 ,
T_1 V_46 , char * V_47 ,
void * V_43 )
{
...
F_1 ( V_2 , V_23 ,
V_50 -> V_24 . V_4 ) ;
F_12 ( & V_49 -> V_40 , L_3 , V_50 -> V_24 . V_52 ,
V_50 -> V_24 . V_17 ) ;
if ( V_50 -> V_26 . V_53 . V_52 < 0 ) {
F_18 ( V_27 ,
V_54 , V_42 ,
V_55 |
V_56 ,
...
struct V_10 * V_11 ;
struct V_16 * V_16 ;
struct V_41 * V_27 = V_49 -> V_40 . V_58 ;
struct V_1 * V_2 ;
V_11 = F_20 ( & V_49 -> V_40 ,
sizeof( struct V_16 ) ) ;
if ( ! V_11 )
...
V_2 = F_24 ( V_60 , sizeof( V_60 ) , V_61 ) ;
if ( ! V_2 ) {
F_23 ( & V_49 -> V_40 , L_7 ) ;
return - V_59 ;
}
V_19 = F_17 ( V_49 , V_27 , V_2 ,
V_28 , V_16 ) ;
if ( V_19 ) {
F_23 ( & V_49 -> V_40 , L_8 ) ;
goto V_62;
