...
int F_32 ( struct V_13 * V_14 , int V_43 )
{
struct V_50 V_51 ;
int V_18 ;
V_51 . V_43 = V_43 ;
V_18 = F_31 ( V_52 , & V_51 ) ;
if ( V_18 )
F_27 ( V_14 , V_18 , L_25 , V_43 ) ;
return V_18 ;
}
int F_33 ( struct V_13 * V_14 , int V_53 , void * * V_54 )
{
return V_55 -> V_56 ( V_14 , V_53 , V_54 ) ;
}
...
if ( ! V_19 )
return - V_24 ;
V_18 = F_44 ( 1 , & V_19 -> V_77 , false ) ;
if ( V_18 )
goto V_78;
V_76 = F_45 ( F_46 ( V_19 -> V_77 ) ) ;
V_18 = F_47 ( V_14 , V_53 , & V_19 -> V_72 , V_76 ) ;
if ( V_18 )
goto V_79;
F_40 ( & V_73 ) ;
F_41 ( & V_19 -> V_74 , & V_75 ) ;
...
int F_47 ( struct V_13 * V_14 , int V_53 ,
T_3 * V_72 , void * V_54 )
{
struct V_57 V_58 ;
F_49 ( & V_58 , ( unsigned long ) V_54 , V_60 , V_53 ,
V_14 -> V_42 ) ;
F_38 ( & V_58 , 1 ) ;
if ( V_58 . V_70 != V_71 ) {
F_6 ( V_14 , V_58 . V_70 ,
...
int F_50 ( struct V_13 * V_14 , void * V_54 )
{
return V_55 -> V_80 ( V_14 , V_54 ) ;
}
static int F_51 ( struct V_13 * V_14 , void * V_54 )
{
struct V_63 * V_19 ;
struct V_81 V_58 = {
. V_68 = ( unsigned long ) V_54 ,
} ;
unsigned int V_82 ;
F_40 ( & V_73 ) ;
F_52 (node, &xenbus_valloc_pages, next) {
if ( V_19 -> V_65 -> V_76 == V_54 ) {
F_53 ( & V_19 -> V_74 ) ;
goto V_83;
}
}
...
V_58 . V_72 = V_19 -> V_72 ;
V_58 . V_68 = F_37 (
F_54 ( ( unsigned long ) V_54 , & V_82 ) ) . V_69 ;
if ( F_55 ( V_86 , & V_58 , 1 ) )
F_56 () ;
if ( V_58 . V_70 == V_71 )
F_39 ( V_19 -> V_65 ) ;
...
static int F_57 ( struct V_13 * V_14 , void * V_54 )
{
int V_87 ;
struct V_63 * V_19 ;
void * V_76 ;
...
{
struct V_81 V_58 ;
F_60 ( & V_58 , ( unsigned long ) V_54 , V_60 , V_72 ) ;
if ( F_55 ( V_86 , & V_58 , 1 ) )
F_56 () ;
if ( V_58 . V_70 != V_71 )
F_27 ( V_14 , V_58 . V_70 ,
...
{
enum V_1 V_88 ;
int V_18 = F_62 ( V_40 , V_15 , L_14 , L_15 , & V_88 , NULL ) ;
if ( V_18 )
V_88 = V_4 ;
return V_88 ;
}
