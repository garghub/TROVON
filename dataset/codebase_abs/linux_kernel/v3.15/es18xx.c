...
if ( ( V_2 -> V_150 = F_80 ( V_2 -> V_78 , 8 , L_23 ) ) == NULL ) {
...
F_82 ( L_27 , V_2 -> V_6 , V_2 -> V_109 ) ;
if ( V_2 -> V_68 == V_2 -> V_55 )
V_2 -> V_30 &= ~ ( V_38 | V_151 ) ;
return F_77 ( V_2 , V_139 , V_140 ) ;
}
static int F_83 ( struct V_73 * V_74 , int V_155 ,
struct V_156 * * V_157 )
{
struct V_1 * V_2 = V_74 -> V_75 ;
struct V_156 * V_158 ;
...
if ( V_2 -> V_30 & V_38 )
V_43 = F_84 ( V_74 , V_159 , V_155 , 2 , 1 , & V_158 ) ;
else
V_43 = F_84 ( V_74 , V_159 , V_155 , 1 , 1 , & V_158 ) ;
if ( V_43 < 0 )
return V_43 ;
F_85 ( V_158 , V_160 , & V_161 ) ;
F_85 ( V_158 , V_162 , & V_163 ) ;
V_158 -> V_75 = V_2 ;
V_158 -> V_164 = 0 ;
if ( V_2 -> V_30 & V_151 )
V_158 -> V_164 |= V_165 ;
...
static int F_88 ( struct V_73 * V_74 , T_3 V_168 )
{
struct V_1 * V_2 = V_74 -> V_75 ;
F_89 ( V_74 , V_169 ) ;
F_90 ( V_2 -> V_158 ) ;
...
static int F_97 ( struct V_177 * V_155 )
{
return F_92 ( V_155 -> V_74 ) ;
}
...
V_2 -> V_63 = 0x00 ;
V_2 -> V_62 = 0 ;
V_2 -> V_175 = F_80 ( V_6 , 16 , L_30 ) ;
if ( V_2 -> V_175 == NULL ) {
F_92 ( V_74 ) ;
F_4 (KERN_ERR PFX L_31 , port, port + 16 - 1 ) ;
return - V_48 ;
}
if ( F_100 ( V_71 , F_44 , 0 , L_30 ,
( void * ) V_74 ) ) {
F_92 ( V_74 ) ;
...
V_2 -> V_68 = V_68 ;
if ( V_55 != V_68 && F_101 ( V_55 , L_35 ) ) {
F_92 ( V_74 ) ;
F_4 (KERN_ERR PFX L_36 , dma2) ;
return - V_48 ;
}
V_2 -> V_55 = V_55 ;
if ( F_81 ( V_2 , V_139 , V_140 ) < 0 ) {
F_92 ( V_74 ) ;
return - V_9 ;
}
V_43 = F_102 ( V_74 , V_181 , V_2 , & V_179 ) ;
if ( V_43 < 0 ) {
F_92 ( V_74 ) ;
return V_43 ;
}
...
for ( V_182 = 0 ; V_182 < F_104 ( V_184 ) ; V_182 ++ ) {
struct V_102 * V_185 ;
V_185 = F_105 ( & V_184 [ V_182 ] , V_2 ) ;
if ( V_2 -> V_30 & V_86 ) {
switch ( V_182 ) {
case 0 :
V_2 -> V_92 = V_185 ;
...
if ( ( V_43 = F_106 ( V_74 , V_185 ) ) < 0 )
return V_43 ;
}
if ( V_2 -> V_30 & V_38 ) {
for ( V_182 = 0 ; V_182 < F_104 ( V_187 ) ; V_182 ++ ) {
if ( ( V_43 = F_106 ( V_74 , F_105 ( & V_187 [ V_182 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
} else {
for ( V_182 = 0 ; V_182 < F_104 ( V_188 ) ; V_182 ++ ) {
if ( ( V_43 = F_106 ( V_74 , F_105 ( & V_188 [ V_182 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
}
if ( V_2 -> V_30 & V_147 ) {
for ( V_182 = 0 ; V_182 < F_104 ( V_189 ) ; V_182 ++ ) {
if ( ( V_43 = F_106 ( V_74 , F_105 ( & V_189 [ V_182 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
}
switch ( V_2 -> V_109 ) {
default:
if ( ( V_43 = F_106 ( V_74 , F_105 ( & V_190 , V_2 ) ) ) < 0 )
return V_43 ;
break;
case 0x1869 :
case 0x1879 :
if ( ( V_43 = F_106 ( V_74 , F_105 ( & V_191 , V_2 ) ) ) < 0 )
return V_43 ;
break;
}
if ( V_2 -> V_30 & V_145 ) {
for ( V_182 = 0 ; V_182 < F_104 ( V_192 ) ; V_182 ++ ) {
if ( ( V_43 = F_106 ( V_74 , F_105 ( & V_192 [ V_182 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
}
if ( V_2 -> V_30 & V_86 ) {
for ( V_182 = 0 ; V_182 < F_104 ( V_193 ) ; V_182 ++ ) {
struct V_102 * V_185 ;
V_185 = F_105 ( & V_193 [ V_182 ] , V_2 ) ;
if ( V_182 == 0 )
V_2 -> V_90 = V_185 ;
else
V_2 -> V_88 = V_185 ;
...
if ( V_2 -> V_109 != 0x1868 ) {
V_43 = F_106 ( V_74 , F_105 ( & V_194 ,
V_2 ) ) ;
if ( V_43 < 0 )
return V_43 ;
}
if ( V_2 -> V_109 == 0x1869 ) {
for ( V_182 = 0 ; V_182 < F_104 ( V_195 ) ; V_182 ++ ) {
V_43 = F_106 ( V_74 ,
F_105 ( & V_195 [ V_182 ] ,
V_2 ) ) ;
if ( V_43 < 0 )
...
V_43 = F_106 ( V_74 , F_105 ( & V_196 ,
V_2 ) ) ;
if ( V_43 < 0 )
return V_43 ;
} else if ( V_2 -> V_109 == 0x1879 ) {
for ( V_182 = 0 ; V_182 < F_104 ( V_197 ) ; V_182 ++ ) {
V_43 = F_106 ( V_74 ,
F_105 ( & V_197 [ V_182 ] ,
V_2 ) ) ;
if ( V_43 < 0 )
...
static int F_107 ( int V_198 , struct V_199 * V_200 )
{
if ( F_108 ( V_200 ) < 0 ) {
...
if ( F_109 ( V_200 ) ) {
F_110 ( F_111 ( V_200 ) , F_112 ( V_200 ) ) ;
F_113 ( 0x27 , F_114 ( V_200 , 0 ) ) ;
if ( V_139 [ V_198 ] != V_141 )
F_113 ( 0x28 , F_114 ( V_200 , 0 ) ) ;
F_113 ( 0x72 , F_114 ( V_200 , 0 ) ) ;
F_115 () ;
}
V_6 [ V_198 ] = F_116 ( V_200 , 0 ) ;
V_140 [ V_198 ] = F_116 ( V_200 , 1 ) ;
V_139 [ V_198 ] = F_116 ( V_200 , 2 ) ;
V_68 [ V_198 ] = F_117 ( V_200 , 0 ) ;
V_55 [ V_198 ] = F_117 ( V_200 , 1 ) ;
V_71 [ V_198 ] = F_114 ( V_200 , 0 ) ;
F_118 ( L_38 , V_6 [ V_198 ] , V_140 [ V_198 ] , V_139 [ V_198 ] ) ;
F_118 ( L_39 , V_68 [ V_198 ] , V_55 [ V_198 ] , V_71 [ V_198 ] ) ;
return 0 ;
}
...
{
V_2 -> V_198 = V_200 ;
if ( F_107 ( V_198 , V_2 -> V_198 ) < 0 )
return - V_48 ;
return 0 ;
}
static int F_120 ( int V_198 , struct V_1 * V_2 ,
struct V_201 * V_74 ,
const struct V_202 * V_89 )
{
V_2 -> V_198 = F_121 ( V_74 , V_89 -> V_203 [ 0 ] . V_89 , NULL ) ;
if ( V_2 -> V_198 == NULL )
return - V_48 ;
V_2 -> V_204 = F_121 ( V_74 , V_89 -> V_203 [ 1 ] . V_89 , NULL ) ;
if ( V_2 -> V_204 == NULL )
return - V_48 ;
if ( F_108 ( V_2 -> V_204 ) < 0 ) {
F_4 (KERN_ERR PFX L_40 ) ;
return - V_95 ;
}
F_118 ( L_41 ,
( unsigned long long ) F_116 ( V_2 -> V_204 , 0 ) ) ;
if ( F_107 ( V_198 , V_2 -> V_198 ) < 0 )
return - V_48 ;
return 0 ;
}
static int F_122 ( struct V_155 * V_200 , int V_198 ,
struct V_73 * * V_205 )
{
return F_123 ( V_200 , V_206 [ V_198 ] , V_89 [ V_198 ] , V_207 ,
sizeof( struct V_1 ) , V_205 ) ;
}
static int F_124 ( struct V_73 * V_74 , int V_198 )
{
struct V_1 * V_2 = V_74 -> V_75 ;
struct V_208 * V_209 ;
int V_43 ;
...
if ( F_125 ( V_74 , V_140 [ V_198 ] , V_140 [ V_198 ] + 2 ,
V_213 , 0 , & V_209 ) < 0 ) {
F_4 (KERN_WARNING PFX
L_44 ,
fm_port[dev]) ;
} else {
V_43 = F_126 ( V_209 , 0 , 1 , NULL ) ;
if ( V_43 < 0 )
return V_43 ;
}
}
if ( V_139 [ V_198 ] > 0 && V_139 [ V_198 ] != V_141 ) {
V_43 = F_127 ( V_74 , 0 , V_214 ,
V_139 [ V_198 ] , V_215 ,
- 1 , & V_2 -> V_83 ) ;
if ( V_43 < 0 )
return V_43 ;
...
static int F_129 ( struct V_155 * V_200 , unsigned int V_198 )
{
return V_216 [ V_198 ] && ! F_130 ( V_198 ) ;
}
static int F_131 ( int V_198 , struct V_155 * V_217 )
{
struct V_73 * V_74 ;
int V_43 ;
V_43 = F_122 ( V_217 , V_198 , & V_74 ) ;
if ( V_43 < 0 )
return V_43 ;
if ( ( V_43 = F_124 ( V_74 , V_198 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_43 ;
}
F_133 ( V_217 , V_74 ) ;
...
if ( V_6 [ V_198 ] != V_141 ) {
return F_131 ( V_198 , V_200 ) ;
} else {
static unsigned long V_222 [] = { 0x220 , 0x240 , 0x260 , 0x280 } ;
int V_4 ;
for ( V_4 = 0 ; V_4 < F_104 ( V_222 ) ; V_4 ++ ) {
V_6 [ V_198 ] = V_222 [ V_4 ] ;
V_43 = F_131 ( V_198 , V_200 ) ;
if ( ! V_43 )
return 0 ;
}
return V_43 ;
...
if ( V_198 >= V_226 )
return - V_9 ;
V_43 = F_122 ( & V_200 -> V_198 , V_198 , & V_74 ) ;
if ( V_43 < 0 )
return V_43 ;
if ( ( V_43 = F_119 ( V_198 , V_74 -> V_75 , V_200 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_43 ;
}
if ( ( V_43 = F_124 ( V_74 , V_198 ) ) < 0 ) {
...
{
return F_88 ( F_144 ( V_200 ) , V_168 ) ;
}
static int F_146 ( struct V_199 * V_200 )
{
return F_91 ( F_144 ( V_200 ) ) ;
}
...
if ( V_198 >= V_226 )
return - V_9 ;
V_230 = F_122 ( & V_228 -> V_74 -> V_198 , V_198 , & V_74 ) ;
if ( V_230 < 0 )
return V_230 ;
if ( ( V_230 = F_120 ( V_198 , V_74 -> V_75 , V_228 , V_229 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_230 ;
}
if ( ( V_230 = F_124 ( V_74 , V_198 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_230 ;
}
F_148 ( V_228 , V_74 ) ;
...
{
return F_88 ( F_150 ( V_228 ) , V_168 ) ;
}
static int F_152 ( struct V_201 * V_228 )
{
return F_91 ( F_150 ( V_228 ) ) ;
}
