...
static int F_31 ( struct V_1 * V_2 , const struct V_5 * V_6 ,
struct V_87 * V_88 )
{
...
if ( F_35 ( V_2 ) <= V_41 -> V_67 ) {
if ( ! V_41 -> V_70 ) {
F_34 ( & V_41 -> V_57 ) ;
return V_41 -> V_74 ;
}
V_89 = F_26 ( F_27 () ) ;
V_90 = F_36 ( V_79 , V_89 - V_41 -> V_84 ,
V_41 -> V_75 ) ;
if ( V_41 -> V_71 ) {
V_91 = V_90 + V_41 -> V_80 ;
if ( V_91 > V_41 -> V_78 )
...
if ( V_90 > V_41 -> V_75 )
V_90 = V_41 -> V_75 ;
V_90 -= ( V_79 ) F_25 ( & V_41 -> V_58 , F_35 ( V_2 ) ) ;
if ( ( V_90 | V_91 ) >= 0 ) {
V_41 -> V_84 = V_89 ;
V_41 -> V_77 = V_90 ;
V_41 -> V_80 = V_91 ;
...
static int
F_37 ( struct V_1 * V_2 , struct V_5 * V_6 , int V_33 , int V_97 )
{
unsigned char * V_98 = F_38 ( V_2 ) ;
struct V_40 * V_41 = V_6 -> V_24 ;
struct V_38 V_99 = {
. V_15 = V_41 -> V_85 ,
. V_82 = V_41 -> V_81 ,
...
if ( V_41 -> V_70 )
F_40 ( & V_99 . V_58 , & V_41 -> V_58 ) ;
if ( V_41 -> V_71 )
F_40 ( & V_99 . V_61 , & V_41 -> V_72 ) ;
if ( F_41 ( V_2 , V_48 , sizeof( V_99 ) , & V_99 ) )
goto V_26;
if ( V_41 -> V_74 &&
F_42 ( V_2 , V_73 , V_41 -> V_74 ) )
goto V_26;
if ( V_41 -> V_83 &&
F_42 ( V_2 , V_66 , V_41 -> V_83 ) )
goto V_26;
return V_2 -> V_102 ;
V_26:
F_43 ( V_2 , V_98 ) ;
