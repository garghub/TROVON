...
case 0x22 :
V_36 -> V_43 = V_23 & 0xff ;
V_36 -> V_44 = ( V_23 & 0xff00 ) >> 8 ;
break;
case 0x24 :
V_36 -> V_40 ++ ;
if ( V_36 -> V_41 > V_45 )
V_36 -> V_41 = V_45 ;
V_38 = & V_36 -> V_46 [ V_36 -> V_40 - 1 ] ;
V_38 -> V_27 = V_23 & 0xf ;
V_38 -> V_26 = ( V_23 & 0xff0 ) >> 4 ;
V_38 -> V_47 = V_39 [ ( V_23 & 0xf000 ) >> 12 ] ;
break;
case 0x25 :
V_38 = & V_36 -> V_46 [ V_36 -> V_40 - 1 ] ;
V_38 -> V_47 = V_23 ;
...
if ( V_36 -> V_41 > V_51 )
V_36 -> V_41 = V_51 ;
V_36 -> V_52 = F_4 ( V_2 , V_20 + 1 ) ;
V_36 -> V_53 = F_4 ( V_2 , V_20 + 2 ) ;
break;
}
}
if ( F_8 ( V_2 ) -> V_54 >= V_55 &&
V_36 -> V_41 == V_42 ) {
V_36 -> V_41 = V_51 ;
}
return 0 ;
