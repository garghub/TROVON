...
static char * F_134 ( struct V_8 * V_8 , char * V_170 , int V_171 )
{
return F_135 ( V_8 , V_170 , V_171 , L_69 ,
V_8 -> V_172 -> V_173 ) ;
}
static struct V_125 *
F_136 ( T_1 * V_27 )
...
V_158 -> V_183 = F_139 () ;
V_158 -> V_184 = F_140 () ;
V_174 . V_8 = F_141 ( V_124 -> V_185 , & V_176 ) ;
if ( ! V_174 . V_8 ) {
F_142 ( V_158 ) ;
return F_138 ( - V_179 ) ;
}
V_174 . V_186 = F_143 ( V_124 ) ;
F_144 ( V_174 . V_8 , V_158 ) ;
V_125 = F_145 ( & V_174 , V_187 , & V_188 ) ;
if ( F_98 ( V_125 ) ) {
F_146 ( & V_174 ) ;
return V_125 ;
}
...
static int
F_147 ( struct V_190 * V_191 , unsigned long V_85 , unsigned long V_42 , unsigned long V_40 )
{
F_40 ( ( L_72 , F_87 () , V_85 , V_42 , V_40 ) ) ;
while ( V_40 > 0 ) {
unsigned long V_192 = F_148 ( V_85 ) >> V_193 ;
if ( F_149 ( V_191 , V_42 , V_192 , V_43 , V_194 ) )
return - V_179 ;
V_42 += V_43 ;
V_85 += V_43 ;
V_40 -= V_43 ;
...
static int
F_150 ( struct V_1 * V_2 , struct V_125 * V_126 , T_1 * V_27 , unsigned long V_195 , void * * V_196 )
{
...
F_153 ( & V_191 -> V_202 ) ;
V_191 -> V_203 = V_121 ;
V_191 -> V_204 = F_154 ( V_126 ) ;
V_191 -> V_205 = V_206 | V_207 | V_208 | V_209 ;
V_191 -> V_210 = V_194 ;
V_27 -> V_164 = V_198 ;
V_27 -> V_157 = V_40 ;
F_155 ( & V_2 -> V_121 -> V_211 ) ;
V_191 -> V_212 = F_156 ( NULL , 0 , V_40 , 0 , V_213 | V_214 ) ;
if ( F_157 ( V_191 -> V_212 ) ) {
F_40 ( ( L_77 , V_40 ) ) ;
...
if ( F_147 ( V_191 , ( unsigned long ) V_198 , V_191 -> V_212 , V_40 ) ) {
F_40 ( ( L_79 ) ) ;
F_158 ( & V_2 -> V_121 -> V_211 ) ;
goto error;
}
F_159 ( V_121 , V_191 ) ;
F_160 ( V_191 -> V_203 , V_191 -> V_205 , V_191 -> V_204 ,
F_161 ( V_191 ) ) ;
F_158 ( & V_2 -> V_121 -> V_211 ) ;
...
F_168 ( & V_221 , V_219 ) ,
F_169 ( & V_221 , V_220 ) ,
F_168 ( & V_221 , V_218 -> V_222 ) ,
F_168 ( & V_221 , V_218 -> V_223 ) ,
F_168 ( & V_221 , V_218 -> V_219 ) ,
F_169 ( & V_221 , V_218 -> V_224 ) ,
F_169 ( & V_221 , V_218 -> V_225 ) ) ) ;
V_88 = ( ( ! F_170 ( V_219 , V_218 -> V_222 ) )
|| ( ! F_170 ( V_219 , V_218 -> V_223 ) )
|| ( ! F_170 ( V_219 , V_218 -> V_219 ) )
|| ( ! F_171 ( V_220 , V_218 -> V_224 ) )
|| ( ! F_171 ( V_220 , V_218 -> V_225 ) )
|| ( ! F_171 ( V_220 , V_218 -> V_220 ) ) ) && ! F_172 ( V_226 ) ;
F_173 () ;
return V_88 ;
}
static int
F_174 ( struct V_1 * V_2 , T_15 * V_227 )
{
int V_44 ;
V_44 = V_227 -> V_44 ;
if ( V_44 & V_51 ) {
...
if ( V_84 -> V_231 ) V_229 = F_176 ( V_91 ) ;
...
if ( V_88 ) goto error;
if ( V_40 ) {
V_88 = F_150 ( V_3 , V_126 , V_27 , V_40 , & V_228 ) ;
if ( V_88 ) goto error;
V_91 -> V_156 = V_228 ;
}
...
static int
F_185 ( T_1 * V_27 , T_16 V_242 , struct V_1 * * V_2 )
{
...
F_187 ( & V_244 ) ;
V_243 = F_188 ( V_242 ) ;
if ( V_243 ) F_189 ( V_243 ) ;
F_190 ( & V_244 ) ;
if ( V_243 == NULL ) return - V_245 ;
}
V_88 = F_182 ( V_27 , V_243 ) ;
if ( V_88 == 0 ) {
* V_2 = V_243 ;
} else if ( V_243 != V_3 ) {
F_1 ( V_243 ) ;
...
static int
F_191 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
T_15 * V_237 = ( T_15 * ) V_91 ;
struct V_125 * V_126 ;
struct V_174 V_174 ;
...
V_88 = F_175 ( V_3 , V_126 , V_27 , V_44 , 0 , V_237 ) ;
if ( V_88 )
goto V_248;
}
F_40 ( ( L_92 ,
...
static void
F_197 ( T_1 * V_27 , unsigned long * V_261 , int V_252 )
{
...
V_27 -> V_28 [ V_24 ] . V_20 = V_20 = F_196 ( V_27 -> V_28 + V_24 , V_252 ) ;
...
if ( V_27 -> V_46 == V_68 ) {
F_197 ( V_27 , V_261 , V_252 ) ;
return;
}
V_59 >>= V_63 ;
for( V_24 = V_63 ; V_59 ; V_24 ++ , V_59 >>= 1 ) {
if ( ( V_59 & 0x1UL ) == 0UL ) continue;
V_20 = F_196 ( V_27 -> V_28 + V_24 , V_252 ) ;
V_262 |= V_27 -> V_28 [ V_24 ] . V_263 [ 0 ] ;
F_59 ( ( L_93 , V_252 ? L_94 : L_95 , V_24 , V_20 ) ) ;
F_37 ( V_27 , V_24 , V_20 ) ;
}
...
static int
F_199 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
...
if ( V_273 && V_264 != F_180 ( V_267 ) && V_66 ^ V_265 ) {
F_40 ( ( L_100 ,
V_267 ,
V_265 ,
V_66 ) ) ;
...
F_203 ( V_27 , V_29 -> V_283 [ V_267 ] . V_295 [ 0 ] ) ;
if ( V_273 ) F_204 ( V_27 , 1UL << V_267 ) ;
...
return 0 ;
error:
F_202 ( V_237 -> V_268 , V_297 ) ;
return V_88 ;
}
static int
F_205 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
T_18 * V_237 = ( T_18 * ) V_91 ;
...
F_203 ( V_27 , F_208 ( V_267 ) ) ;
F_203 ( V_27 , F_209 ( V_267 ) ) ;
if ( V_274 && V_155 == V_68 ) {
...
static int
F_211 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
...
V_267 = V_237 -> V_278 ;
V_268 = V_237 -> V_268 ;
if ( F_206 ( ! F_207 ( V_267 ) ) ) goto error;
if ( F_206 ( ! F_212 ( V_27 , V_267 ) ) ) goto error;
...
int
F_213 ( struct V_1 * V_2 , void * V_237 , unsigned int V_311 , struct V_86 * V_87 )
{
T_1 * V_27 ;
...
return F_199 ( V_27 , V_237 , V_311 , V_87 ) ;
}
int
...
if ( V_27 == NULL ) return - V_106 ;
if ( V_2 != V_3 && V_27 -> V_50 == 0 ) return - V_108 ;
return F_211 ( V_27 , V_237 , V_311 , V_87 ) ;
}
int
...
static int
F_217 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
T_4 * V_84 ;
T_5 V_317 ;
...
static int
F_222 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
...
static int
F_223 ( int V_330 , T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
...
F_202 ( V_237 -> V_346 , V_297 ) ;
return V_88 ;
}
static int
F_226 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
return F_223 ( V_337 , V_27 , V_91 , V_246 , V_87 ) ;
}
static int
F_227 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
return F_223 ( V_339 , V_27 , V_91 , V_246 , V_87 ) ;
}
int
F_228 ( struct V_1 * V_2 , void * V_237 , unsigned int V_311 , struct V_86 * V_87 )
{
T_1 * V_27 ;
if ( V_237 == NULL ) return - V_106 ;
V_27 = F_121 () ;
if ( V_27 == NULL ) return - V_106 ;
if ( V_2 != V_3 && V_27 -> V_50 == 0 ) return - V_108 ;
return F_226 ( V_27 , V_237 , V_311 , V_87 ) ;
}
int
...
static int
F_230 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
...
static int
F_234 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_86 * V_349 ;
int V_155 , V_66 ;
V_155 = V_27 -> V_46 ;
...
static int
F_236 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
T_18 * V_237 = ( T_18 * ) V_91 ;
unsigned int V_267 ;
int V_24 ;
...
for ( V_24 = 0 ; V_24 < V_246 ; V_24 ++ , V_237 ++ ) {
V_267 = V_237 -> V_278 ;
if ( ! F_179 ( V_267 ) ) goto V_299;
V_237 -> V_279 = F_180 ( V_267 ) ;
F_202 ( V_237 -> V_268 , 0 ) ;
...
static int
F_240 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
struct V_331 * V_312 ;
struct T_1 * V_355 ;
...
V_88 = F_185 ( V_27 , V_237 -> V_361 , & V_2 ) ;
if ( V_88 ) {
...
V_312 -> V_313 , V_27 ) ) ;
V_88 = - V_108 ;
V_355 = F_241 ( V_362 , & V_312 -> V_313 , NULL , V_27 , sizeof( T_1 * ) ) ;
if ( V_355 != NULL ) {
...
F_53 ( V_27 , - 1 ) ;
V_27 -> V_352 = 0UL ;
F_233 ( V_87 ) -> V_351 = F_233 ( V_87 ) -> V_350 = 0 ;
}
V_88 = 0 ;
V_363:
...
F_249 ( F_120 () ) ;
F_249 ( F_233 ( V_87 ) -> V_351 ) ;
F_249 ( F_233 ( V_87 ) -> V_350 ) ;
}
if ( V_370 ) F_55 ( V_27 ) ;
}
static int
...
T_27 long
F_252 ( int V_144 , int V_143 , void T_8 * V_91 , int V_246 )
{
...
int (* F_253)( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 );
int (* F_254)( void * V_91 , T_9 * V_236 );
#define F_255 4096
if ( F_206 ( V_29 == NULL ) ) return - V_381 ;
if ( F_206 ( V_143 < 0 || V_143 >= V_382 ) ) {
F_40 ( ( L_159 , V_143 ) ) ;
return - V_106 ;
}
F_253 = V_383 [ V_143 ] . V_384 ;
V_377 = V_383 [ V_143 ] . V_385 ;
V_375 = V_383 [ V_143 ] . V_386 ;
F_254 = V_383 [ V_143 ] . V_387 ;
...
V_375 ,
V_246 ) ) ;
if ( F_206 ( ( V_377 == V_388 && V_246 <= 0 ) || ( V_377 > 0 && V_377 != V_246 ) ) )
return - V_106 ;
V_389:
V_236 = V_376 + V_375 * V_246 ;
if ( F_206 ( V_236 > F_255 ) ) {
F_63 ( V_67 L_161 , F_60 ( V_3 ) , V_236 ) ;
return - V_390 ;
}
if ( F_201 ( V_246 && V_374 == NULL ) ) {
V_374 = F_257 ( F_255 , V_45 ) ;
if ( V_374 == NULL ) return - V_179 ;
}
V_88 = - V_138 ;
if ( V_236 && F_258 ( V_374 , V_91 , V_236 ) ) {
F_40 ( ( L_162 , V_236 , V_91 ) ) ;
goto V_391;
}
if ( V_378 == 0 && F_254 ) {
V_88 = (* F_254)( V_374 , & V_376 ) ;
if ( V_88 ) goto V_391;
V_378 = 1 ;
F_40 ( ( L_163 , V_236 , V_376 ) ) ;
if ( F_201 ( V_376 ) ) goto V_389;
}
if ( F_206 ( ( V_380 & V_392 ) == 0 ) ) goto V_393;
V_88 = - V_147 ;
V_7 = F_259 ( V_144 ) ;
...
V_393:
V_88 = (* F_253)( V_27 , V_374 , V_246 , F_119 ( V_3 ) ) ;
V_379 = 1 ;
V_136:
if ( F_201 ( V_27 ) ) {
F_40 ( ( L_167 ) ) ;
...
if ( V_379 && F_260 ( V_143 ) && F_110 ( V_91 , V_374 , V_375 * V_246 ) ) V_88 = - V_138 ;
V_391:
if ( V_7 . V_125 )
F_261 ( V_7 ) ;
F_56 ( V_374 ) ;
F_40 ( ( L_168 , F_256 ( V_143 ) , V_88 ) ) ;
return V_88 ;
}
static void
F_262 ( T_1 * V_27 , unsigned long V_261 , struct V_86 * V_87 )
{
T_4 * V_84 = V_27 -> V_166 ;
T_5 V_317 ;
int V_155 ;
...
F_269 ( & V_27 -> V_146 , V_399 , V_400 ) ;
return 0 ;
}
static int
F_270 ( T_1 * V_27 , unsigned long V_401 )
{
T_2 * V_37 = NULL ;
if ( V_27 -> V_52 == 0 ) {
V_37 = F_39 ( V_27 ) ;
...
int V_417 = 0 ;
if ( F_206 ( V_27 -> V_46 == V_163 ) ) goto V_418;
if ( F_206 ( ( V_409 & 0x1 ) == 0 ) ) goto V_419;
V_414 = F_272 () ;
V_59 = V_409 >> V_63 ;
V_30 = V_29 -> V_30 ;
V_416 = F_218 ( V_27 ) ;
...
if ( F_201 ( V_411 > V_412 ) ) {
V_401 |= 1UL << V_24 ;
if ( F_210 ( V_27 , V_24 ) ) V_413 |= 1UL << V_24 ;
}
F_59 ( ( L_188 ,
V_24 ,
V_412 ,
...
static void *
F_283 ( struct V_455 * V_325 , T_10 * V_100 )
{
if ( * V_100 == 0 ) {
return V_456 ;
}
...
static void *
F_285 ( struct V_455 * V_325 , void * V_301 , T_10 * V_100 )
{
++ * V_100 ;
return F_283 ( V_325 , V_100 ) ;
}
static void
...
static int
F_289 ( struct V_455 * V_325 , void * V_301 )
{
unsigned long V_65 ;
unsigned int V_24 ;
int V_90 ;
...
V_90 , F_290 ( V_463 , V_90 ) & V_364 ? 1 : 0 ,
V_90 , F_290 ( V_463 , V_90 ) & V_69 ? 1 : 0 ,
V_90 , F_290 ( V_463 , V_90 ) & V_365 ? 1 : 0 ,
V_90 , F_290 ( V_464 , V_90 ) ? F_290 ( V_464 , V_90 ) -> V_242 : - 1 ,
V_90 , F_290 ( V_465 , V_90 ) ,
V_90 , F_290 ( V_466 , V_90 ) ) ;
if ( F_291 () == 1 && V_277 . V_326 > 0 ) {
V_65 = F_21 () ;
F_27 () ;
F_288 ( V_325 ,
L_224
...
{
return F_294 ( V_125 , & V_467 ) ;
}
void
F_295 ( struct V_1 * V_2 , unsigned long V_148 , int V_468 )
{
struct V_86 * V_87 ;
unsigned long V_469 ;
unsigned long V_470 ;
...
V_87 = F_119 ( V_2 ) ;
F_233 ( V_87 ) -> V_350 = V_468 ? V_470 : 0 ;
return;
}
if ( V_470 ) {
V_469 = F_22 ( V_70 ) ;
...
F_249 ( F_120 () ) ;
if ( F_206 ( ( V_2 -> V_312 . V_11 & V_366 ) == 0 ) ) return;
V_11 = F_8 ( V_27 ) ;
V_65 = F_21 () ;
...
V_499 = F_313 ( L_243 , V_182 , NULL , & V_500 ) ;
if ( V_499 == NULL ) {
F_63 ( V_67 L_244 ) ;
V_29 = NULL ;
return - 1 ;
...
V_148 = F_64 () ;
V_469 = F_22 ( V_70 ) ;
if ( V_148 == 0 && F_233 ( V_87 ) -> V_350 == 0 && ( V_469 & V_71 ) == 0 ) {
F_124 ( V_11 ) ;
return;
}
F_63 ( L_245 ,
...
for ( V_24 = 1 ; F_178 ( V_24 ) == 0 ; V_24 ++ ) {
if ( F_179 ( V_24 ) == 0 ) continue;
F_63 ( L_248 , V_426 , V_24 , F_275 ( V_24 ) , V_24 , V_27 -> V_64 [ V_24 ] ) ;
}
...
T_27 long
F_252 ( int V_144 , int V_143 , void * V_91 , int V_246 )
{
return - V_381 ;
}
