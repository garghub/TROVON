...
void F_35 ( struct V_4 * V_5 , T_1 V_93 )
{
struct V_94 V_95 = {
. V_96 = V_97 ,
. V_98 = { sizeof( T_1 ) , } ,
...
if ( V_103 < V_59 -> V_101 [ V_88 ] . V_103 )
break;
V_101 = V_59 -> V_101 [ V_88 ] . V_93 ;
}
if ( V_101 != 0 )
V_104 = true ;
if ( V_66 -> V_101 != V_101 )
...
L_15 ) ;
V_66 -> V_117 = true ;
} else if ( V_66 -> V_117 && ! V_66 -> V_78 && V_66 -> V_101 == 0 &&
V_103 <= V_59 -> V_114 ) {
F_40 ( V_5 ,
L_16 ) ;
V_66 -> V_117 = false ;
...
void F_41 ( struct V_4 * V_5 , T_1 V_100 )
{
struct V_65 * V_66 = & V_5 -> V_58 ;
F_24 ( V_5 , L_17 ) ;
if ( V_5 -> V_118 -> V_119 )
