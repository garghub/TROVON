...
F_44 ( V_34 ) ;
if ( V_85 [ V_96 ] )
V_34 -> V_72 = F_43 ( V_85 [ V_96 ] ) ;
V_3 -> V_71 = V_89 ;
V_3 -> V_68 = V_90 ;
if ( V_85 [ V_97 ] )
V_3 -> V_29 = F_43 ( V_85 [ V_97 ] ) ;
if ( V_85 [ V_98 ] ) {
T_1 V_99 = F_43 ( V_85 [ V_98 ] ) ;
V_3 -> V_44 = F_45 ( V_99 ) ;
}
if ( V_85 [ V_100 ] )
V_3 -> V_53 = F_43 ( V_85 [ V_100 ] ) ;
if ( V_85 [ V_101 ] ) {
T_1 V_99 = F_43 ( V_85 [ V_101 ] ) ;
V_3 -> V_25 = F_45 ( V_99 ) ;
}
V_60 = V_34 -> V_3 . V_60 ;
...
if ( V_106 == NULL )
goto V_108;
if ( F_53 ( V_5 , V_96 , V_34 -> V_72 ) ||
F_53 ( V_5 , V_93 , V_3 -> V_71 ) ||
...
F_53 ( V_5 , V_101 ,
F_54 ( V_3 -> V_25 ) ) ||
F_53 ( V_5 , V_94 , V_3 -> V_68 ) )
goto V_108;
return F_55 ( V_5 , V_106 ) ;
V_108:
return - 1 ;
}
static int F_56 ( struct V_33 * V_34 , struct V_109 * V_110 )
{
struct V_2 * V_3 = F_18 ( V_34 ) ;
struct V_111 V_112 = {
. V_74 = V_3 -> V_74 ,
...
return F_57 ( V_110 , & V_112 , sizeof( V_112 ) ) ;
}
