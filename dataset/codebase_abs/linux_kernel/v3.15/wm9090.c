...
static int F_23 ( struct V_112 * V_113 ,
const struct V_114 * V_115 )
{
struct V_68 * V_69 ;
unsigned int V_3 ;
int V_116 ;
V_69 = F_24 ( & V_113 -> V_2 , sizeof( * V_69 ) , V_117 ) ;
if ( V_69 == NULL ) {
F_7 ( & V_113 -> V_2 , L_4 ) ;
return - V_118 ;
}
V_69 -> V_99 = F_25 ( V_113 , & V_119 ) ;
if ( F_26 ( V_69 -> V_99 ) ) {
V_116 = F_27 ( V_69 -> V_99 ) ;
F_7 ( & V_113 -> V_2 , L_5 , V_116 ) ;
return V_116 ;
}
V_116 = F_28 ( V_69 -> V_99 , V_4 , & V_3 ) ;
if ( V_116 < 0 )
return V_116 ;
if ( V_3 != 0x9093 ) {
F_7 ( & V_113 -> V_2 , L_6 , V_3 ) ;
return - V_120 ;
}
V_116 = F_29 ( V_69 -> V_99 , V_4 , 0 ) ;
if ( V_116 < 0 )
return V_116 ;
if ( V_113 -> V_2 . V_121 )
...
sizeof( V_69 -> V_76 ) ) ;
F_30 ( V_113 , V_69 ) ;
V_116 = F_31 ( & V_113 -> V_2 ,
& V_122 , NULL , 0 ) ;
if ( V_116 != 0 ) {
F_7 ( & V_113 -> V_2 , L_7 , V_116 ) ;
return V_116 ;
}
return 0 ;
}
