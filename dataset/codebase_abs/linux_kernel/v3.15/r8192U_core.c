...
V_36 -> V_1085 = V_1086 ;
#endif
V_36 -> V_1087 = (struct V_1088 * ) & V_1089 ;
#endif
V_36 -> type = V_1090 ;
V_36 -> V_1091 = V_51 * 3 ;
if ( F_286 ( V_36 , V_1092 ) < 0 ) {
F_9 ( V_95 , L_143 ) ;
V_1092 = L_144 ;
F_286 ( V_36 , V_1092 ) ;
}
...
void F_306 ( struct V_35 * V_36 , int V_1097 )
{
unsigned long V_160 ;
short V_1098 ;
struct V_6 * V_7 = (struct V_6 * ) F_18 ( V_36 ) ;
F_96 ( & V_7 -> V_196 , V_160 ) ;
V_1098 = F_52 ( V_36 , V_1097 ) ;
F_99 ( & V_7 -> V_196 , V_160 ) ;
if ( V_1098 )
F_307 ( V_7 -> V_12 ) ;
}
...
V_11 -> V_1101 = 1 ;
if ( ( V_11 -> V_267 -> V_1102 & V_1103 ) || ! V_1104 ) {
V_11 -> V_1101 = 0 ;
V_713 &= ~ V_750 ;
}
F_9 ( V_823 , L_162 , V_28 ,
V_11 -> V_1101 , V_11 -> V_254 , V_713 ) ;
F_24 ( V_36 , V_752 , V_713 ) ;
}
void F_205 ( struct V_35 * V_36 , T_1 V_1105 , T_1 V_1106 , T_3 V_1107 ,
T_1 * V_820 , T_1 V_1108 , T_2 * V_1109 )
{
T_2 V_1110 = 0 ;
T_2 V_1111 = 0 ;
T_3 V_1112 = 0 ;
...
if ( V_1105 >= V_1113 )
F_9 ( V_27 , L_163 ) ;
F_9 ( V_823 , L_164 , V_36 , V_1105 , V_1106 , V_1107 , V_820 ) ;
if ( V_1108 )
V_1112 |= V_1114 | ( V_1107 << 2 ) ;
else
V_1112 |= V_1114 | ( V_1107 << 2 ) | V_1106 ;
for ( V_1 = 0 ; V_1 < V_843 ; V_1 ++ ) {
V_1110 = V_1 + V_843 * V_1105 ;
V_1110 |= V_38 | V_44 ;
if ( V_1 == 0 ) {
V_1111 = ( T_2 ) ( * ( V_820 + 0 ) ) << 16 |
( T_2 ) ( * ( V_820 + 1 ) ) << 24 |
( T_2 ) V_1112 ;
F_13 ( V_36 , V_43 , V_1111 ) ;
F_13 ( V_36 , V_40 , V_1110 ) ;
} else if ( V_1 == 1 ) {
V_1111 = ( T_2 ) ( * ( V_820 + 2 ) ) |
( T_2 ) ( * ( V_820 + 3 ) ) << 8 |
( T_2 ) ( * ( V_820 + 4 ) ) << 16 |
...
if ( V_1109 != NULL ) {
F_13 ( V_36 , V_43 , ( T_2 ) ( * ( V_1109 + V_1 - 2 ) ) ) ;
F_13 ( V_36 , V_40 , V_1110 ) ;
}
}
}
