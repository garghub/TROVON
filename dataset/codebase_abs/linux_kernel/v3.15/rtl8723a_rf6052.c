...
F_9 ( V_2 , ( T_2 ) ( V_83 + V_50 ) , ( T_1 ) V_59 ) ;
}
}
}
}
...
int V_91 = V_92 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
static char V_93 [] = V_94 ;
static char V_95 [] = V_96 ;
char * V_97 , * V_98 ;
V_97 = V_93 ;
V_98 = V_95 ;
for ( V_88 = 0 ; V_88 < V_6 -> V_99 ; V_88 ++ ) {
V_90 = & V_6 -> V_100 [ V_88 ] ;
switch ( V_88 ) {
case V_9 :
V_87 = F_12 ( V_2 , V_90 -> V_101 , V_102 ) ;
break;
case V_31 :
V_87 = F_12 ( V_2 , V_90 -> V_101 , V_102 << 16 ) ;
break;
}
F_5 ( V_2 , V_90 -> V_103 , V_102 << 16 , 0x1 ) ;
F_13 ( 1 ) ;
F_5 ( V_2 , V_90 -> V_104 , V_102 , 0x1 ) ;
F_13 ( 1 ) ;
F_5 ( V_2 , V_90 -> V_105 , V_106 , 0x0 ) ;
F_13 ( 1 ) ;
F_5 ( V_2 , V_90 -> V_105 , V_107 , 0x0 ) ;
F_13 ( 1 ) ;
switch ( V_88 ) {
case V_9 :
if ( V_108 == F_14 ( & V_6 -> V_109 , (enum V_110 ) V_88 , (enum V_110 ) V_88 ) )
V_91 = V_111 ;
break;
case V_31 :
if ( V_108 == F_14 ( & V_6 -> V_109 , (enum V_110 ) V_88 , (enum V_110 ) V_88 ) )
...
switch ( V_88 ) {
case V_9 :
F_5 ( V_2 , V_90 -> V_101 , V_102 , V_87 ) ;
break;
case V_31 :
F_5 ( V_2 , V_90 -> V_101 , V_102 << 16 , V_87 ) ;
break;
}
if ( V_91 != V_92 ) {
goto V_112;
