...
T_1 * V_50 ;
unsigned V_51 ;
struct V_52 V_53 = F_24 ( V_40 , V_5 -> V_54 ) ;
V_50 = F_25 ( V_53 . V_55 ) ;
V_51 = V_53 . V_56 ;
if ( F_17 ( V_51 >= V_45 ) )
V_51 = V_45 ;
V_28 = F_18 ( V_30 , V_50 + V_53 . V_57 , V_51 ) ;
F_26 ( V_50 ) ;
if ( V_28 < 0 ) {
F_16 ( L_2 , V_28 ) ;
return V_28 ;
}
F_27 ( V_40 , & V_5 -> V_54 , V_51 ) ;
V_45 -= V_51 ;
} while ( V_45 );
if ( ! V_3 -> V_24 ) {
V_28 = F_18 ( V_30 , V_3 -> V_36 , V_3 -> V_37 ) ;
...
V_5 -> V_44 = V_40 -> V_83 . V_87 >> V_3 -> V_49 ;
V_40 -> V_58 = F_32 ;
V_40 -> V_60 = V_5 ;
V_5 -> V_54 = V_40 -> V_83 ;
F_40 ( V_3 , V_5 ) ;
...
unsigned V_89 , char * V_31 , unsigned V_90 )
{
struct V_2 * V_3 = V_15 -> V_79 ;
unsigned V_91 = 0 ;
unsigned V_92 ;
...
( unsigned long long ) V_3 -> V_97 ,
V_3 -> V_98
) ;
for ( V_92 = 0 ; V_92 < V_3 -> V_7 ; V_92 ++ )
F_49 ( L_10 , V_3 -> V_48 [ V_92 ] ) ;
F_49 ( L_11 ) ;
if ( ! V_3 -> V_37 )
F_49 ( L_12 ) ;
else
for ( V_92 = 0 ; V_92 < V_3 -> V_37 ; V_92 ++ )
F_49 ( L_10 , V_3 -> V_36 [ V_92 ] ) ;
break;
}
}
static int F_50 ( struct V_78 * V_15 , unsigned V_99 ,
unsigned long V_100 )
{
struct V_2 * V_3 = V_15 -> V_79 ;
int V_28 = 0 ;
if ( V_3 -> V_14 ||
V_15 -> V_51 != F_51 ( V_3 -> V_81 -> V_82 -> V_101 ) >> V_84 )
V_28 = F_52 ( NULL , V_99 ) ;
return V_28 ? : F_53 ( V_3 -> V_81 -> V_82 , V_3 -> V_81 -> V_102 ,
V_99 , V_100 ) ;
}
static int F_54 ( struct V_78 * V_15 , struct V_103 * V_104 ,
struct V_52 * V_105 , int V_106 )
{
struct V_2 * V_3 = V_15 -> V_79 ;
...
{
struct V_2 * V_3 = V_15 -> V_79 ;
return V_110 ( V_15 , V_3 -> V_81 , V_3 -> V_14 , V_15 -> V_51 , V_27 ) ;
}
...
V_28 = F_69 ( V_15 , V_117 [ 2 ] , V_125 , & V_3 -> V_96 ) ;
if ( V_28 ) {
V_15 -> error = L_18 ;
goto V_127;
}
...
V_3 -> V_85 = V_119 ;
if ( V_15 -> V_51 > ( V_3 -> V_85 << ( V_3 -> V_49 - V_84 ) ) ) {
V_15 -> error = L_23 ;
V_28 = - V_126 ;
goto V_127;
}
...
V_3 -> V_97 = V_119 ;
V_3 -> V_98 = F_71 ( V_117 [ 7 ] , V_122 ) ;
if ( ! V_3 -> V_98 ) {
V_15 -> error = L_25 ;
V_28 = - V_123 ;
goto V_127;
}
V_3 -> V_33 = F_72 ( V_3 -> V_98 , 0 , 0 ) ;
if ( F_13 ( V_3 -> V_33 ) ) {
V_15 -> error = L_26 ;
V_28 = F_14 ( V_3 -> V_33 ) ;
V_3 -> V_33 = NULL ;
