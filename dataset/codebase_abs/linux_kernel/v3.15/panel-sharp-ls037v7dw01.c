...
struct V_1 * V_2 ;
int V_6 ;
V_4 = F_20 ( & V_28 -> V_31 , sizeof( * V_4 ) , V_38 ) ;
if ( V_4 == NULL )
return - V_39 ;
F_21 ( V_28 , V_4 ) ;
if ( F_16 ( & V_28 -> V_31 ) ) {
...
if ( F_8 ( V_4 -> V_35 ) ) {
V_6 = F_22 ( & V_28 -> V_31 , V_4 -> V_35 ,
V_40 , L_2 ) ;
if ( V_6 )
goto V_41;
}
if ( F_8 ( V_4 -> V_36 ) ) {
V_6 = F_22 ( & V_28 -> V_31 , V_4 -> V_36 ,
V_42 , L_3 ) ;
if ( V_6 )
goto V_41;
}
if ( F_8 ( V_4 -> V_37 ) ) {
V_6 = F_22 ( & V_28 -> V_31 , V_4 -> V_37 ,
V_42 , L_4 ) ;
if ( V_6 )
goto V_41;
}
if ( F_8 ( V_4 -> V_17 ) ) {
V_6 = F_22 ( & V_28 -> V_31 , V_4 -> V_17 ,
V_40 , L_5 ) ;
if ( V_6 )
goto V_41;
}
if ( F_8 ( V_4 -> V_18 ) ) {
V_6 = F_22 ( & V_28 -> V_31 , V_4 -> V_18 ,
V_40 , L_6 ) ;
if ( V_6 )
goto V_41;
}
...
static int T_1 F_25 ( struct V_27 * V_28 )
{
struct V_3 * V_4 = F_15 ( V_28 ) ;
