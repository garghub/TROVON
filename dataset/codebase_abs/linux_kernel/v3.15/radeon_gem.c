...
return - V_84 ;
V_4 = F_2 ( V_2 ) ;
V_18 = F_51 ( V_4 , args -> V_96 , args -> V_97 ) ;
F_40 ( V_2 ) ;
return V_18 ;
}
int F_52 ( struct V_57 * V_54 , void * V_58 ,
struct V_41 * V_59 )
{
struct V_98 * args = V_58 ;
struct V_1 * V_2 ;
struct V_3 * V_43 ;
int V_18 = 0 ;
F_50 ( L_9 ) ;
...
if ( F_53 ( V_18 != 0 ) )
goto V_99;
F_54 ( V_43 , & args -> V_96 , & args -> V_97 ) ;
F_24 ( V_43 ) ;
V_99:
F_40 ( V_2 ) ;
return V_18 ;
}
int F_55 ( struct V_57 * V_54 , void * V_58 ,
struct V_41 * V_59 )
{
...
V_101 = V_112 | V_113 ;
if ( ( args -> V_114 & V_101 ) ) {
F_26 ( & V_54 -> V_111 -> V_54 , L_11 ,
args -> V_114 , V_101 ) ;
args -> V_104 = V_105 ;
return - V_108 ;
}
if ( ! ( args -> V_114 & V_115 ) ) {
F_26 ( & V_54 -> V_111 -> V_54 , L_12 ) ;
args -> V_104 = V_105 ;
return - V_108 ;
}
switch ( args -> V_104 ) {
...
if ( V_50 -> V_118 ) {
args -> V_104 = V_119 ;
args -> V_109 = V_50 -> V_118 ;
goto V_99;
}
V_18 = F_56 ( V_10 , V_50 , args -> V_109 , args -> V_114 ) ;
break;
case V_117 :
V_18 = F_56 ( V_10 , V_50 , 0 , 0 ) ;
break;
default:
break;
}
...
int F_57 ( struct V_57 * V_54 , void * V_58 ,
struct V_41 * V_59 )
{
struct V_121 * args = V_58 ;
struct V_1 * V_2 ;
struct V_3 * V_4 ;
int V_18 ;
V_2 = F_42 ( V_54 , V_59 , args -> V_81 ) ;
...
T_1 V_81 ;
int V_18 ;
args -> V_97 = F_59 ( V_10 , args -> V_127 , args -> V_128 , 0 ) * ( ( args -> V_128 + 1 ) / 8 ) ;
args -> V_11 = args -> V_97 * args -> V_129 ;
args -> V_11 = F_60 ( args -> V_11 , V_19 ) ;
...
static int F_61 ( struct V_131 * V_132 , void * V_58 )
{
struct V_133 * V_134 = (struct V_133 * ) V_132 -> V_135 ;
struct V_57 * V_54 = V_134 -> V_136 -> V_54 ;
struct V_9 * V_10 = V_54 -> V_60 ;
struct V_3 * V_43 ;
unsigned V_64 = 0 ;
F_11 ( & V_10 -> V_32 . V_33 ) ;
...
unsigned V_38 ;
const char * V_137 ;
V_38 = F_47 ( V_43 -> V_7 . V_138 . V_139 ) ;
switch ( V_38 ) {
case V_28 :
V_137 = L_14 ;
break;
