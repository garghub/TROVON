...
static int F_68 ( struct V_46 * V_47 , struct V_60 * V_85 )
{
struct V_62 * V_63 ;
int error = 0 ;
F_12 (lkb, head, lkb_statequeue) {
error = F_69 ( V_47 , V_63 ) ;
if ( error )
break;
V_47 -> V_52 ++ ;
}
...
error = F_68 ( V_47 , & V_47 -> V_68 ) ;
if ( error )
goto V_20;
error = F_68 ( V_47 , & V_47 -> V_70 ) ;
if ( error )
goto V_20;
...
for ( V_112 = F_82 ( & V_2 -> V_117 [ V_113 ] . V_119 ) ; V_112 ; V_112 = F_83 ( V_112 ) ) {
V_47 = F_84 ( V_112 , struct V_46 , V_120 ) ;
F_85 ( & V_47 -> V_121 , & V_2 -> V_114 ) ;
F_28 ( V_47 ) ;
}
if ( ! F_86 ( & V_2 -> V_117 [ V_113 ] . V_122 ) )
F_34 ( V_2 , L_11 ) ;
...
for ( V_113 = 0 ; V_113 < V_2 -> V_116 ; V_113 ++ ) {
F_7 ( & V_2 -> V_117 [ V_113 ] . V_118 ) ;
for ( V_112 = F_82 ( & V_2 -> V_117 [ V_113 ] . V_122 ) ; V_112 ; V_112 = V_124 ) {
V_124 = F_83 ( V_112 ) ;
V_47 = F_84 ( V_112 , struct V_46 , V_120 ) ;
F_90 ( V_112 , & V_2 -> V_117 [ V_113 ] . V_122 ) ;
F_91 ( V_47 ) ;
V_74 ++ ;
}
F_8 ( & V_2 -> V_117 [ V_113 ] . V_118 ) ;
