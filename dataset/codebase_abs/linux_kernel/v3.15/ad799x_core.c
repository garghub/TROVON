...
static T_3 F_22 ( struct V_51 * V_8 ,
struct V_52 * V_53 ,
char * V_54 )
{
...
static T_3 F_24 ( struct V_51 * V_8 ,
struct V_52 * V_53 ,
const char * V_54 ,
T_4 V_58 )
{
...
goto V_61;
V_60 &= ~ V_56 ;
for ( V_59 = 0 ; V_59 < F_26 ( V_57 ) ; V_59 ++ )
if ( V_37 == V_57 [ V_59 ] )
break;
if ( V_59 == F_26 ( V_57 ) ) {
V_7 = - V_34 ;
...
static unsigned int F_28 ( const struct V_35 * V_36 ,
enum V_63 V_64 ,
enum V_65 V_66 )
{
switch ( V_66 ) {
...
struct V_1 * V_2 = F_11 ( V_10 ) ;
F_17 ( & V_10 -> V_41 ) ;
V_7 = F_6 ( V_2 , F_28 ( V_36 , V_64 , V_66 ) ,
V_37 ) ;
F_19 ( & V_10 -> V_41 ) ;
return V_7 ;
}
...
T_2 V_71 ;
F_17 ( & V_10 -> V_41 ) ;
V_7 = F_1 ( V_2 , F_28 ( V_36 , V_64 , V_66 ) ,
& V_71 ) ;
F_19 ( & V_10 -> V_41 ) ;
if ( V_7 < 0 )
return V_7 ;
...
static T_5 F_34 ( int V_72 , void * V_73 )
{
...
struct V_1 * V_2 ;
struct V_9 * V_10 ;
V_10 = F_39 ( & V_6 -> V_8 , sizeof( * V_2 ) ) ;
if ( V_10 == NULL )
return - V_15 ;
V_2 = F_11 ( V_10 ) ;
F_40 ( V_6 , V_10 ) ;
V_2 -> V_18 = V_18 -> V_83 ;
V_2 -> V_84 = & V_85 [ V_2 -> V_18 ] ;
V_2 -> V_22 = V_2 -> V_84 -> V_86 ;
V_2 -> V_3 = F_41 ( & V_6 -> V_8 , L_4 ) ;
if ( F_42 ( V_2 -> V_3 ) )
return F_43 ( V_2 -> V_3 ) ;
V_7 = F_44 ( V_2 -> V_3 ) ;
if ( V_7 )
return V_7 ;
V_2 -> V_49 = F_41 ( & V_6 -> V_8 , L_5 ) ;
if ( F_42 ( V_2 -> V_49 ) ) {
V_7 = F_43 ( V_2 -> V_49 ) ;
goto V_87;
}
...
goto V_87;
V_2 -> V_6 = V_6 ;
V_10 -> V_8 . V_88 = & V_6 -> V_8 ;
V_10 -> V_89 = V_18 -> V_89 ;
V_10 -> V_66 = V_2 -> V_84 -> V_66 ;
V_10 -> V_90 = V_91 ;
V_10 -> V_92 = V_2 -> V_84 -> V_69 ;
V_10 -> V_93 = V_2 -> V_84 -> V_93 ;
V_7 = F_45 ( V_10 ) ;
if ( V_7 )
goto V_87;
if ( V_6 -> V_72 > 0 ) {
