...
unsigned int F_144 ( struct V_245 * V_245 , struct V_111 * V_8 ,
T_5 * V_45 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
unsigned int V_246 = 0 ;
F_145 ( V_245 , F_105 ( V_9 ) , V_45 ) ;
if ( V_9 -> V_13 == V_19 )
return F_143 ( V_9 ) ;
...
F_147 ( V_256 , & V_9 -> V_96 -> V_29 ) ;
return V_246 ;
}
static int F_148 ( struct V_111 * V_8 , int V_257 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_6 * V_7 = F_10 ( V_9 ) ;
struct V_26 V_198 ;
...
static int F_151 ( struct V_111 * V_8 , int V_260 , int V_261 ,
...
static int F_153 ( struct V_111 * V_8 , int V_260 , int V_261 ,
...
static void F_161 ( struct V_99 * V_37 , T_2 V_271 [ 16 ] )
{
...
goto V_280;
V_279:
V_277 = F_165 ( sizeof( struct V_235 ) , V_84 | V_128 ) ;
if ( ! V_277 )
goto V_280;
V_277 -> V_37 = V_37 ;
V_277 -> V_27 = * V_27 ;
...
if ( V_27 -> V_224 == F_122 ( V_283 ) -> V_224 ) {
V_281 = V_283 ;
break;
}
V_283 = V_283 -> V_284 ;
...
static void F_169 ( struct V_99 * V_37 , T_2 V_271 [ 16 ] )
{
struct V_8 * V_9 = V_37 -> V_276 ;
if ( V_9 -> V_13 == V_20 )
return;
...
struct V_290 * V_291 , struct V_150 * V_292 )
{
struct V_8 * V_9 ;
struct V_6 * V_7 ;
struct V_51 * V_285 ;
...
F_179 ( V_50 , V_56 ) ;
V_285 = (struct V_51 * ) V_50 -> V_193 ;
F_157 ( V_285 -> V_67 , sizeof( V_285 -> V_67 ) ) ;
F_157 ( V_285 -> V_65 , sizeof( V_285 -> V_65 ) ) ;
F_157 ( V_285 -> V_71 , sizeof( V_285 -> V_71 ) ) ;
F_157 ( V_285 -> V_69 , sizeof( V_285 -> V_69 ) ) ;
...
case ( V_258 ) :
case 0 :
F_122 ( V_50 ) -> V_214 = V_285 -> V_73 . V_214 ;
V_10 = F_178 ( V_9 , V_50 ) ;
break;
default:
;
...
{
struct V_150 * V_306 = F_185 ( V_305 ) ;
struct V_8 * V_9 ;
struct V_6 * V_7 ;
switch ( V_304 ) {
case V_307 :
...
if ( V_10 )
goto V_315;
V_316 = F_165 ( sizeof( struct V_3 ) , V_138 ) ;
if ( ! V_316 ) {
V_10 = - V_85 ;
goto V_317;
}
...
V_316 -> V_225 = ( void ( * ) ( struct V_3 * ) ) F_134 ;
V_316 -> V_319 = & V_313 ;
V_10 = F_189 ( V_316 ) ;
if ( V_10 )
goto V_317;
