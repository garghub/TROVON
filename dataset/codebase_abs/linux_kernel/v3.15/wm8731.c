...
struct V_7 * V_8 ;
int V_23 ;
V_8 = F_40 ( & V_100 -> V_2 , sizeof( struct V_7 ) ,
V_101 ) ;
if ( V_8 == NULL )
return - V_102 ;
V_8 -> V_86 = F_41 ( V_100 , & V_103 ) ;
if ( F_42 ( V_8 -> V_86 ) ) {
V_23 = F_43 ( V_8 -> V_86 ) ;
F_35 ( & V_100 -> V_2 , L_5 ,
V_23 ) ;
...
struct V_7 * V_8 ;
int V_23 ;
V_8 = F_40 ( & V_107 -> V_2 , sizeof( struct V_7 ) ,
V_101 ) ;
if ( V_8 == NULL )
return - V_102 ;
V_8 -> V_86 = F_49 ( V_107 , & V_103 ) ;
if ( F_42 ( V_8 -> V_86 ) ) {
V_23 = F_43 ( V_8 -> V_86 ) ;
F_35 ( & V_107 -> V_2 , L_5 ,
V_23 ) ;
...
& V_104 , & V_105 , 1 ) ;
if ( V_23 != 0 ) {
F_35 ( & V_107 -> V_2 , L_6 , V_23 ) ;
return V_23 ;
}
return 0 ;
}
static int F_51 ( struct V_106 * V_110 )
{
F_47 ( & V_110 -> V_2 ) ;
return 0 ;
}
