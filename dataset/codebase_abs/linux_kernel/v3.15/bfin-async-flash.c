...
{
int V_24 ;
struct V_25 * V_26 = F_18 ( & V_23 -> V_27 ) ;
struct V_28 * V_29 = F_19 ( V_23 , V_30 , 0 ) ;
struct V_28 * V_31 = F_19 ( V_23 , V_30 , 1 ) ;
struct V_1 * V_2 ;
V_2 = F_20 ( sizeof( * V_2 ) , V_32 ) ;
if ( ! V_2 )
return - V_33 ;
V_2 -> V_10 . V_34 = V_35 ;
V_2 -> V_10 . V_36 = F_11 ;
...
V_2 -> V_10 . V_38 = F_14 ;
V_2 -> V_10 . V_39 = F_16 ;
V_2 -> V_10 . V_40 = V_26 -> V_41 ;
V_2 -> V_10 . V_42 = F_21 ( V_29 ) ;
V_2 -> V_10 . V_15 = ( void V_43 * ) V_29 -> V_44 ;
V_2 -> V_10 . V_45 = V_29 -> V_44 ;
V_2 -> V_10 . V_12 = ( unsigned long ) V_2 ;
V_2 -> V_4 = F_22 ( V_23 , 0 ) ;
V_2 -> V_7 = V_31 -> V_44 ;
V_2 -> V_8 = V_31 -> V_46 ;
if ( F_23 ( V_2 -> V_4 , V_35 ) ) {
...
V_2 -> V_48 = F_27 ( V_29 -> V_34 , & V_2 -> V_10 ) ;
if ( ! V_2 -> V_48 ) {
F_28 ( V_2 -> V_4 ) ;
F_25 ( V_2 ) ;
return - V_49 ;
}
F_29 ( V_2 -> V_48 , V_50 , NULL ,
V_26 -> V_51 , V_26 -> V_52 ) ;
F_30 ( V_23 , V_2 ) ;
return 0 ;
}
