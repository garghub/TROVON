...
V_19 -> V_216 . V_323 = & F_143 ;
V_45 = F_195 ( & V_19 -> V_216 ) ;
if ( V_45 ) {
F_34 ( L_28 ) ;
goto V_322;
}
...
static void F_200 ( struct V_156 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
F_201 ( & V_19 -> V_216 ) ;
F_156 ( & V_19 -> V_250 ) ;
...
static int F_203 ( struct V_156 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
int V_100 ;
F_201 ( & V_19 -> V_216 ) ;
...
static int F_206 ( struct V_156 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
int V_45 , V_100 ;
V_45 = F_180 ( V_19 ) ;
