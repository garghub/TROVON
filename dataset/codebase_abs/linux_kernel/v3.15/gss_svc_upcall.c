...
F_73:
V_102 = F_73 ( & V_54 , & V_46 -> V_24 , & V_142 ) ;
switch ( V_102 ) {
case - V_143 : {
int V_144 ;
if ( V_135 ) {
V_135 = 0 ;
F_87 ( & V_54 . V_88 ) ;
V_144 = F_88 ( V_145 , & V_46 -> V_24 . V_52 ) ;
if ( V_144 == 0 )
F_89 ( V_146 ) ;
F_90 ( & V_54 . V_88 ) ;
if ( V_144 == 0 )
...
V_123 -> V_151 = 1 ;
V_123 -> V_152 = F_94 ( V_46 -> V_20 . V_9 ) ;
...
V_128 = V_120 -> V_153 ;
F_19 ( V_128 -> V_154 -> V_155 == 3 ) ;
F_19 ( V_128 -> V_154 -> V_156 [ 0 ] >=
sizeof( * V_134 ) + V_46 -> V_19 . V_9 ) ;
F_19 ( V_128 -> V_154 -> V_156 [ 2 ] >= V_46 -> V_20 . V_9 ) ;
V_134 = F_96 ( V_128 -> V_154 , 0 , 0 ) ;
V_134 -> V_157 = V_158 ;
V_134 -> V_159 = 0 ;
V_134 -> V_160 = V_161 ;
V_134 -> V_162 = V_46 -> V_33 ;
V_134 -> V_163 = V_46 -> V_34 ;
V_134 -> V_164 = V_165 ;
V_134 -> V_166 . V_9 = V_46 -> V_19 . V_9 ;
memcpy ( V_134 -> V_166 . V_15 , V_46 -> V_19 . V_15 ,
V_46 -> V_19 . V_9 ) ;
memcpy ( F_96 ( V_128 -> V_154 , 2 , 0 ) , V_46 -> V_20 . V_15 ,
V_46 -> V_20 . V_9 ) ;
V_128 -> V_167 = F_97 ( V_128 -> V_154 , 2 ,
V_46 -> V_20 . V_9 , 0 ) ;
V_102 = V_168 ;
V_50:
#if 0
