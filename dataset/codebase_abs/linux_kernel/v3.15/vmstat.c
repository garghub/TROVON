...
#endif
#ifdef F_127
F_128 ( L_36 , V_142 , NULL , & V_143 ) ;
F_128 ( L_37 , V_142 , NULL , & V_144 ) ;
F_128 ( L_38 , V_142 , NULL , & V_145 ) ;
F_128 ( L_39 , V_142 , NULL , & V_146 ) ;
#endif
return 0 ;
}
static int F_129 ( unsigned int V_61 ,
struct V_59 * V_60 )
{
if ( V_60 -> V_62 == 0 )
return 1000 ;
...
for ( V_61 = 0 ; V_61 < V_65 ; ++ V_61 ) {
F_58 ( V_10 , V_61 , & V_60 ) ;
V_147 = F_129 ( V_61 , & V_60 ) ;
F_73 ( V_71 , L_40 , V_147 / 1000 , V_147 % 1000 ) ;
}
F_74 ( V_71 , '\n' ) ;
}
static int F_131 ( struct V_70 * V_71 , void * V_73 )
{
T_1 * V_21 = ( T_1 * ) V_73 ;
if ( ! F_87 ( V_21 -> V_76 , V_90 ) )
return 0 ;
F_67 ( V_71 , V_21 , F_130 ) ;
return 0 ;
}
static int F_132 ( struct V_92 * V_92 , struct V_93 * V_93 )
{
return F_89 ( V_93 , & V_148 ) ;
}
static void F_133 ( struct V_70 * V_71 ,
T_1 * V_21 , struct V_10 * V_10 )
{
unsigned int V_61 ;
int V_147 ;
...
static int F_134 ( struct V_70 * V_71 , void * V_73 )
{
T_1 * V_21 = ( T_1 * ) V_73 ;
F_67 ( V_71 , V_21 , F_133 ) ;
return 0 ;
}
static int F_135 ( struct V_92 * V_92 , struct V_93 * V_93 )
{
