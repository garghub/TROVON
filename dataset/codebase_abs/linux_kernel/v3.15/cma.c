...
static void F_93 ( struct V_83 * V_18 , struct V_83 * V_153 ,
struct V_11 * V_12 )
{
...
V_162 -> V_149 = V_12 -> V_62 ;
}
static void F_94 ( struct V_83 * V_18 , struct V_83 * V_153 ,
struct V_11 * V_12 )
{
...
static int F_95 ( struct V_83 * V_18 , struct V_83 * V_153 ,
struct V_167 * V_168 )
{
struct V_11 * V_12 ;
...
F_19 ( & V_7 ) ;
F_20 ( & V_2 -> V_25 ) ;
while ( ! F_100 ( & V_2 -> V_95 ) ) {
V_179 = F_101 ( V_2 -> V_95 . V_180 ,
struct V_1 , V_95 ) ;
F_102 ( & V_179 -> V_25 ) ;
F_20 ( & V_179 -> V_95 ) ;
F_21 ( & V_7 ) ;
...
{
struct V_28 * V_29 ;
while ( ! F_100 ( & V_2 -> V_96 ) ) {
V_29 = F_16 ( V_2 -> V_96 . V_180 ,
struct V_28 , V_25 ) ;
F_20 ( & V_29 -> V_25 ) ;
...
V_169 -> V_171 . V_196 . V_117 = V_195 -> V_117 ;
V_169 -> V_171 . V_196 . V_116 = V_195 -> V_201 ;
}
...
static struct V_1 * F_122 ( struct V_83 * V_153 ,
struct V_167 * V_168 )
{
struct V_1 * V_2 ;
struct V_83 * V_18 ;
...
if ( F_83 ( F_22 ( V_2 ) ) ) {
V_231 -> V_21 . V_22 . V_51 = V_52 ;
F_30 ( & V_231 -> V_21 . V_22 , & V_231 -> V_190 [ 0 ] . V_73 ) ;
F_31 ( & V_231 -> V_21 . V_22 , F_124 ( V_231 -> V_190 [ 0 ] . V_75 ) ) ;
} else {
V_6 = F_33 ( F_22 ( V_2 ) , & V_231 -> V_21 . V_22 ) ;
if ( V_6 )
goto V_115;
}
F_125 ( & V_231 -> V_21 . V_22 , & V_231 -> V_190 [ 0 ] . V_74 ) ;
V_2 -> V_8 = V_204 ;
return V_2 ;
V_115:
F_103 ( V_18 ) ;
...
static struct V_1 * F_126 ( struct V_83 * V_153 ,
struct V_167 * V_168 )
{
struct V_1 * V_2 ;
struct V_83 * V_18 ;
...
V_169 -> V_171 . V_196 . V_117 = V_235 -> V_117 ;
V_169 -> V_171 . V_196 . V_116 = V_235 -> V_201 ;
}
static int F_128 ( struct V_83 * V_18 , struct V_167 * V_168 )
{
...
T_6 F_132 ( struct V_83 * V_18 , struct V_33 * V_21 )
{
if ( V_21 -> V_56 == V_57 )
return ( (struct V_48 * ) V_21 ) -> V_151 ;
return F_92 ( ( ( V_251 ) V_18 -> V_41 << 16 ) + F_124 ( F_87 ( V_21 ) ) ) ;
}
static void F_133 ( enum V_86 V_41 , struct V_33 * V_21 ,
struct V_252 * V_253 )
{
...
V_6 = F_139 ( V_240 -> V_18 . V_19 , & V_278 ) ;
if ( V_6 ) {
F_21 ( & V_240 -> V_82 ) ;
F_103 ( V_276 ) ;
goto V_70;
...
T_6 V_282 ;
int V_6 ;
V_18 = F_141 ( V_2 -> V_18 . V_19 , F_129 , V_2 ) ;
if ( F_62 ( V_18 ) )
return F_63 ( V_18 ) ;
V_2 -> V_135 . V_32 = V_18 ;
V_21 = F_22 ( V_2 ) ;
V_282 = F_132 ( & V_2 -> V_18 , V_21 ) ;
if ( F_83 ( V_21 ) && ! V_2 -> V_283 )
V_6 = F_142 ( V_2 -> V_135 . V_32 , V_282 , 0 , NULL ) ;
else {
F_133 ( V_2 -> V_18 . V_41 , V_21 , & V_281 ) ;
V_6 = F_142 ( V_2 -> V_135 . V_32 , V_282 , 0 , & V_281 ) ;
}
if ( V_6 ) {
F_113 ( V_2 -> V_135 . V_32 ) ;
V_2 -> V_135 . V_32 = NULL ;
...
static int F_143 ( struct V_1 * V_2 , int V_284 )
{
int V_6 ;
struct V_261 * V_18 ;
V_18 = F_144 ( V_2 -> V_18 . V_19 ,
F_138 ,
V_2 ) ;
if ( F_62 ( V_18 ) )
return F_63 ( V_18 ) ;
...
F_136 ( F_22 ( V_2 ) ) ) ;
V_6 = F_145 ( V_2 -> V_135 . V_138 , V_284 ) ;
if ( V_6 ) {
F_114 ( V_2 -> V_135 . V_138 ) ;
V_2 -> V_135 . V_138 = NULL ;
}
...
static int F_146 ( struct V_83 * V_18 ,
struct V_193 * V_169 )
{
...
return;
V_18 = F_46 ( F_146 , V_2 , V_2 -> V_18 . V_41 ,
V_2 -> V_18 . V_88 ) ;
if ( F_62 ( V_18 ) )
return;
...
F_136 ( F_22 ( V_2 ) ) ) ;
F_8 ( V_179 , V_16 ) ;
F_11 ( & V_179 -> V_95 , & V_2 -> V_95 ) ;
F_9 ( & V_2 -> V_17 ) ;
V_179 -> V_189 = 1 ;
V_179 -> V_283 = V_2 -> V_283 ;
V_6 = F_148 ( V_18 , V_2 -> V_284 ) ;
if ( V_6 )
F_121 ( V_286 L_2
...
void F_150 ( struct V_83 * V_18 , int V_289 )
{
struct V_1 * V_2 ;
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
V_2 -> V_289 = ( T_1 ) V_289 ;
}
static void F_151 ( int V_209 , struct V_154 * V_190 ,
void * V_85 )
{
...
V_291 -> V_169 . V_209 = V_209 ;
}
F_152 ( V_296 , & V_291 -> V_291 ) ;
}
static int F_153 ( struct V_1 * V_2 , int V_297 ,
struct V_290 * V_291 )
{
struct V_50 * V_22 = & V_2 -> V_18 . V_20 . V_21 . V_22 ;
struct V_154 V_190 ;
...
F_154 ( V_22 , & V_190 . V_73 ) ;
F_155 ( V_22 , & V_190 . V_74 ) ;
V_190 . V_75 = F_156 ( F_72 ( V_22 ) ) ;
V_190 . V_300 = 1 ;
V_190 . V_301 = 1 ;
V_190 . V_302 = F_132 ( & V_2 -> V_18 , F_23 ( V_2 ) ) ;
V_298 = V_303 | V_304 |
V_305 | V_306 |
V_307 | V_308 ;
switch ( F_24 ( V_2 ) ) {
case V_140 :
V_190 . V_309 = F_156 ( ( T_3 ) V_2 -> V_289 ) ;
V_298 |= V_310 ;
break;
case V_144 :
V_299 = (struct V_145 * ) F_22 ( V_2 ) ;
V_190 . V_311 = ( T_1 ) ( F_28 ( V_299 -> V_312 ) >> 20 ) ;
V_298 |= V_313 ;
break;
case V_57 :
V_49 = (struct V_48 * ) F_22 ( V_2 ) ;
V_190 . V_311 = ( T_1 ) ( F_28 ( V_49 -> V_158 ) >> 20 ) ;
V_298 |= V_313 ;
break;
}
V_2 -> V_178 = F_157 ( & V_314 , V_2 -> V_18 . V_19 ,
V_2 -> V_18 . V_47 , & V_190 ,
V_298 , V_297 ,
V_89 , F_151 ,
V_291 , & V_2 -> V_177 ) ;
...
static void F_158 ( struct V_315 * V_316 )
{
...
static int F_160 ( struct V_1 * V_2 , int V_297 )
{
...
return - V_90 ;
V_291 -> V_18 = V_2 ;
F_161 ( & V_291 -> V_291 , F_158 ) ;
V_291 -> V_292 = V_182 ;
V_291 -> V_293 = V_320 ;
V_291 -> V_169 . V_169 = V_321 ;
V_20 -> V_190 = F_123 ( sizeof * V_20 -> V_190 , V_89 ) ;
if ( ! V_20 -> V_190 ) {
V_6 = - V_90 ;
goto V_245;
}
V_6 = F_153 ( V_2 , V_297 , V_291 ) ;
if ( V_6 )
goto V_247;
return 0 ;
V_247:
...
V_320 ) )
return - V_40 ;
V_18 -> V_20 . V_190 = F_163 ( V_190 , sizeof *V_190 * V_232 ,
V_89 ) ;
if ( ! V_18 -> V_20 . V_190 ) {
V_6 = - V_90 ;
goto V_115;
...
static int F_164 ( struct V_1 * V_2 , int V_297 )
{
struct V_290 * V_291 ;
V_291 = F_47 ( sizeof *V_291 , V_89 ) ;
if ( ! V_291 )
...
static int F_165 ( struct V_322 * V_323 , int V_289 )
{
int V_324 ;
struct V_322 * V_325 ;
V_324 = F_166 ( V_289 ) ;
...
F_167 ( V_323 ) : V_323 ;
if ( V_325 -> V_328 )
return F_168 ( V_325 , V_324 ) ;
#if F_169 ( V_329 )
if ( V_323 -> V_326 & V_327 )
return ( F_170 ( V_323 , V_324 ) &
V_330 ) >> V_331 ;
#endif
return 0 ;
}
...
V_291 -> V_18 = V_2 ;
F_161 ( & V_291 -> V_291 , F_158 ) ;
V_20 -> V_190 = F_47 ( sizeof * V_20 -> V_190 , V_89 ) ;
if ( ! V_20 -> V_190 ) {
V_6 = - V_90 ;
goto V_245;
}
V_20 -> V_232 = 1 ;
if ( V_21 -> V_22 . V_333 )
V_323 = F_172 ( & V_334 , V_21 -> V_22 . V_333 ) ;
if ( ! V_323 ) {
V_6 = - V_61 ;
goto V_247;
}
V_20 -> V_190 -> V_335 = F_173 ( V_323 ) ;
memcpy ( V_20 -> V_190 -> V_336 , V_21 -> V_22 . V_337 , V_338 ) ;
memcpy ( V_20 -> V_190 -> V_123 , V_323 -> V_22 , V_323 -> V_339 ) ;
F_36 ( (struct V_33 * ) & V_2 -> V_18 . V_20 . V_21 . V_34 ,
& V_20 -> V_190 -> V_73 ) ;
...
V_20 -> V_190 -> V_340 = 1 ;
V_20 -> V_190 -> V_301 = 1 ;
V_20 -> V_190 -> V_75 = F_156 ( 0xffff ) ;
V_20 -> V_190 -> V_341 = V_342 ;
V_20 -> V_190 -> V_343 = F_165 ( V_323 , V_2 -> V_289 ) ;
V_20 -> V_190 -> V_344 = F_174 ( V_323 -> V_344 ) ;
V_20 -> V_190 -> V_345 = V_342 ;
V_20 -> V_190 -> V_346 = F_175 ( V_323 ) ;
F_176 ( V_323 ) ;
V_20 -> V_190 -> V_347 = V_342 ;
V_20 -> V_190 -> V_348 = V_349 ;
if ( ! V_20 -> V_190 -> V_344 ) {
V_6 = - V_40 ;
goto V_247;
}
...
int F_177 ( struct V_83 * V_18 , int V_297 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
if ( ! F_4 ( V_2 , V_294 , V_182 ) )
return - V_40 ;
F_9 ( & V_2 -> V_17 ) ;
...
switch ( V_21 -> V_56 ) {
case V_140 :
( (struct V_141 * ) V_21 ) -> V_142 . V_143 = F_134 ( V_350 ) ;
break;
case V_144 :
...
if ( V_6 )
goto V_70;
V_6 = F_183 ( V_16 -> V_19 , V_77 , 0 , & V_75 ) ;
if ( V_6 )
goto V_70;
...
static void F_184 ( int V_209 , struct V_33 * V_34 ,
...
F_154 ( & V_2 -> V_18 . V_20 . V_21 . V_22 , & V_59 ) ;
F_125 ( & V_2 -> V_18 . V_20 . V_21 . V_22 , & V_59 ) ;
V_291 -> V_18 = V_2 ;
F_161 ( & V_291 -> V_291 , F_158 ) ;
V_291 -> V_292 = V_181 ;
V_291 -> V_293 = V_294 ;
...
F_125 ( & V_2 -> V_18 . V_20 . V_21 . V_22 , (union V_53 * )
...
static int F_187 ( struct V_83 * V_18 , struct V_33 * V_34 ,
struct V_33 * V_35 )
{
if ( ! V_34 || ! V_34 -> V_56 ) {
...
return F_188 ( V_18 , V_34 ) ;
}
int F_189 ( struct V_83 * V_18 , struct V_33 * V_34 ,
...
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
if ( V_2 -> V_8 == V_93 ) {
V_6 = F_187 ( V_18 , V_34 , V_35 ) ;
if ( V_6 )
return V_6 ;
}
if ( F_24 ( V_2 ) != V_35 -> V_56 )
return - V_40 ;
if ( ! F_4 ( V_2 , V_285 , V_181 ) )
return - V_40 ;
F_9 ( & V_2 -> V_17 ) ;
...
int F_191 ( struct V_83 * V_18 , int V_360 )
{
struct V_1 * V_2 ;
unsigned long V_5 ;
int V_6 ;
...
int F_192 ( struct V_83 * V_18 , int V_283 )
{
struct V_1 * V_2 ;
unsigned long V_5 ;
int V_6 ;
...
V_2 -> V_185 = V_185 ;
F_194 ( & V_2 -> V_186 , & V_185 -> V_187 ) ;
}
static int F_195 ( struct V_365 * V_41 , struct V_1 * V_2 ,
unsigned short V_366 )
{
struct V_184 * V_185 ;
int V_6 ;
V_185 = F_47 ( sizeof *V_185 , V_89 ) ;
if ( ! V_185 )
return - V_90 ;
V_6 = F_196 ( V_41 , V_185 , V_366 , V_366 + 1 , V_89 ) ;
if ( V_6 < 0 )
goto V_115;
V_185 -> V_41 = V_41 ;
V_185 -> V_62 = ( unsigned short ) V_6 ;
F_193 ( V_185 , V_2 ) ;
return 0 ;
V_115:
F_17 ( V_185 ) ;
...
unsigned int V_373 ;
F_198 ( & V_334 , & V_370 , & V_371 ) ;
V_372 = ( V_371 - V_370 ) + 1 ;
V_373 = F_199 () % V_372 + V_370 ;
V_374:
if ( V_369 != V_373 &&
! F_200 ( V_41 , ( unsigned short ) V_373 ) ) {
int V_6 = F_195 ( V_41 , V_2 , V_373 ) ;
if ( ! V_6 )
V_369 = V_373 ;
if ( V_6 != - V_368 )
return V_6 ;
...
V_21 = F_22 ( V_2 ) ;
F_202 (cur_id, &bind_list->owners, node) {
if ( V_2 == V_375 )
continue;
if ( ( V_375 -> V_8 != V_183 ) && V_361 &&
V_375 -> V_361 )
continue;
V_376 = F_22 ( V_375 ) ;
...
static int F_203 ( struct V_365 * V_41 , struct V_1 * V_2 )
{
struct V_184 * V_185 ;
unsigned short V_366 ;
int V_6 ;
V_366 = F_32 ( F_87 ( F_22 ( V_2 ) ) ) ;
if ( V_366 < V_378 && ! F_204 ( V_379 ) )
return - V_380 ;
V_185 = F_200 ( V_41 , V_366 ) ;
if ( ! V_185 ) {
V_6 = F_195 ( V_41 , V_2 , V_366 ) ;
} else {
V_6 = F_201 ( V_185 , V_2 , V_2 -> V_361 ) ;
if ( ! V_6 )
F_193 ( V_185 , V_2 ) ;
}
return V_6 ;
...
int V_6 = 0 ;
F_19 ( & V_7 ) ;
if ( V_185 -> V_187 . V_381 -> V_180 )
V_6 = F_201 ( V_185 , V_2 , 0 ) ;
F_21 ( & V_7 ) ;
return V_6 ;
}
static struct V_365 * F_206 ( struct V_1 * V_2 )
{
switch ( V_2 -> V_18 . V_41 ) {
case V_279 :
return & V_382 ;
...
static struct V_365 * F_207 ( struct V_1 * V_2 )
{
...
static int F_209 ( struct V_50 * V_22 ,
struct V_33 * V_21 )
{
#if F_169 ( V_392 )
struct V_145 * V_299 ;
...
int F_148 ( struct V_83 * V_18 , int V_284 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
...
V_6 = F_188 ( V_18 , F_22 ( V_2 ) ) ;
if ( V_6 )
return V_6 ;
}
if ( ! F_4 ( V_2 , V_285 , V_183 ) )
return - V_40 ;
if ( V_2 -> V_361 ) {
V_6 = F_205 ( V_2 ) ;
if ( V_6 )
...
int F_188 ( struct V_83 * V_18 , struct V_33 * V_21 )
{
struct V_1 * V_2 ;
int V_6 ;
...
return - V_40 ;
V_6 = F_209 ( & V_18 -> V_20 . V_21 . V_22 , V_21 ) ;
if ( V_6 )
goto V_245;
...
F_7 ( V_11 , 4 ) ;
V_11 -> V_34 . V_162 . V_21 = V_398 -> V_142 . V_143 ;
V_11 -> V_35 . V_162 . V_21 = V_399 -> V_142 . V_143 ;
...
V_169 . V_171 . V_243 . V_197 = V_407 ;
if ( V_403 -> V_209 != V_408 ) {
V_169 . V_169 = V_208 ;
V_169 . V_209 = V_168 -> V_171 . V_404 . V_209 ;
break;
}
...
V_236 = F_96 ( V_2 ) ;
V_411 . V_197 = V_236 + V_119 -> V_197 ;
if ( V_411 . V_197 < V_119 -> V_197 )
return - V_40 ;
if ( V_411 . V_197 ) {
V_174 = F_47 ( V_411 . V_197 , V_412 ) ;
if ( ! V_174 )
return - V_90 ;
} else {
V_174 = NULL ;
}
if ( V_119 -> V_174 && V_119 -> V_197 )
memcpy ( V_174 + V_236 , V_119 -> V_174 ,
V_119 -> V_197 ) ;
if ( V_174 ) {
V_6 = F_211 ( V_174 , V_2 ) ;
if ( V_6 )
...
V_18 = F_141 ( V_2 -> V_18 . V_19 , F_212 ,
V_2 ) ;
if ( F_62 ( V_18 ) ) {
V_6 = F_63 ( V_18 ) ;
goto V_70;
...
V_2 -> V_135 . V_32 = V_18 ;
V_411 . V_155 = V_2 -> V_18 . V_20 . V_190 ;
V_411 . V_302 = F_132 ( & V_2 -> V_18 , F_23 ( V_2 ) ) ;
V_411 . V_297 = 1 << ( V_413 - 8 ) ;
V_411 . V_414 = V_415 ;
V_6 = F_215 ( V_2 -> V_135 . V_32 , & V_411 ) ;
if ( V_6 ) {
F_113 ( V_2 -> V_135 . V_32 ) ;
V_2 -> V_135 . V_32 = NULL ;
}
...
memcpy ( V_174 + V_236 , V_119 -> V_174 ,
V_119 -> V_197 ) ;
V_18 = F_141 ( V_2 -> V_18 . V_19 , F_120 , V_2 ) ;
if ( F_62 ( V_18 ) ) {
V_6 = F_63 ( V_18 ) ;
goto V_70;
}
...
V_411 . V_173 = & V_20 -> V_190 [ 0 ] ;
if ( V_20 -> V_232 == 2 )
V_411 . V_233 = & V_20 -> V_190 [ 1 ] ;
V_411 . V_302 = F_132 ( & V_2 -> V_18 , F_23 ( V_2 ) ) ;
...
V_411 . V_199 = V_119 -> V_199 ;
V_411 . V_238 = F_217 ( T_1 , 7 , V_119 -> V_238 ) ;
V_411 . V_200 = F_217 ( T_1 , 7 , V_119 -> V_200 ) ;
V_411 . V_418 = V_413 ;
V_411 . V_419 = V_413 ;
V_411 . V_414 = V_415 ;
V_411 . V_117 = V_2 -> V_117 ? 1 : 0 ;
V_6 = F_218 ( V_2 -> V_135 . V_32 , & V_411 ) ;
V_70:
if ( V_6 && ! F_62 ( V_18 ) ) {
F_113 ( V_18 ) ;
V_2 -> V_135 . V_32 = NULL ;
...
int V_6 ;
struct V_420 V_421 ;
V_135 = F_144 ( V_2 -> V_18 . V_19 , F_135 , V_2 ) ;
if ( F_62 ( V_135 ) )
return F_63 ( V_135 ) ;
...
int F_221 ( struct V_83 * V_18 , struct V_118 * V_119 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
if ( ! F_4 ( V_2 , V_320 , V_204 ) )
return - V_40 ;
if ( ! V_18 -> V_99 ) {
...
V_403 . V_174 = V_119 -> V_174 ;
V_403 . V_197 = V_119 -> V_197 ;
V_403 . V_125 = V_119 -> V_125 ;
V_403 . V_127 = V_119 -> V_127 ;
V_403 . V_423 = 0 ;
V_403 . V_199 = V_119 -> V_199 ;
V_403 . V_200 = F_217 ( T_1 , 7 , V_119 -> V_200 ) ;
V_403 . V_117 = V_2 -> V_117 ? 1 : 0 ;
V_6 = F_223 ( V_2 -> V_135 . V_32 , & V_403 ) ;
V_70:
return V_6 ;
}
...
return F_225 ( V_2 -> V_135 . V_138 , & V_421 ) ;
}
static int F_226 ( struct V_1 * V_2 ,
enum V_424 V_209 , T_2 V_37 ,
...
V_403 . V_174 = V_174 ;
V_403 . V_197 = V_197 ;
return F_227 ( V_2 -> V_135 . V_32 , & V_403 ) ;
}
int F_228 ( struct V_83 * V_18 , struct V_118 * V_119 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
...
int F_230 ( struct V_83 * V_18 , enum V_426 V_169 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
...
int F_229 ( struct V_83 * V_18 , const void * V_174 ,
T_1 V_197 )
{
struct V_1 * V_2 ;
int V_6 ;
...
static int F_237 ( int V_209 , struct V_429 * V_31 )
{
struct V_1 * V_2 ;
...
F_19 ( & V_2 -> V_94 ) ;
if ( ! V_209 && V_2 -> V_18 . V_99 )
V_209 = F_238 ( V_2 -> V_18 . V_99 , & V_31 -> V_39 . V_46 ,
F_124 ( V_31 -> V_39 . V_430 ) ) ;
F_21 ( & V_2 -> V_94 ) ;
memset ( & V_169 , 0 , sizeof V_169 ) ;
V_169 . V_209 = V_209 ;
V_169 . V_171 . V_243 . V_174 = V_29 -> V_85 ;
if ( ! V_209 ) {
V_169 . V_169 = V_431 ;
F_239 ( V_2 -> V_18 . V_19 ,
...
F_241 ( & V_299 -> V_146 , V_22 -> V_436 , V_433 ) ;
if ( V_2 -> V_18 . V_41 == V_42 )
V_433 [ 7 ] = 0x01 ;
* V_46 = * (union V_53 * ) ( V_433 + 4 ) ;
} else {
F_242 ( sin -> V_142 . V_143 , V_22 -> V_436 , V_433 ) ;
if ( V_2 -> V_18 . V_41 == V_42 )
V_433 [ 7 ] = 0x01 ;
* V_46 = * (union V_53 * ) ( V_433 + 4 ) ;
}
...
F_154 ( V_22 , & V_39 . V_437 ) ;
V_39 . V_75 = F_156 ( F_72 ( V_22 ) ) ;
V_39 . V_438 = 1 ;
V_298 = V_439 | V_440 |
V_441 | V_442 |
V_443 | V_444 |
...
V_450 |
V_451 ;
V_29 -> V_31 . V_32 = F_245 ( & V_314 , V_2 -> V_18 . V_19 ,
V_2 -> V_18 . V_47 , & V_39 ,
V_298 , V_89 ,
F_237 , V_29 ) ;
return F_246 ( V_29 -> V_31 . V_32 ) ;
}
static void F_247 ( struct V_315 * V_291 )
{
...
static void F_248 ( struct V_33 * V_21 , union V_53 * V_46 )
{
struct V_141 * sin = (struct V_141 * ) V_21 ;
struct V_145 * V_299 = (struct V_145 * ) V_21 ;
if ( F_83 ( V_21 ) ) {
...
V_29 -> V_31 . V_32 -> V_39 . V_75 = F_156 ( 0xffff ) ;
if ( V_2 -> V_18 . V_41 == V_42 )
V_29 -> V_31 . V_32 -> V_39 . V_37 = F_244 ( V_44 ) ;
if ( V_22 -> V_333 )
V_323 = F_172 ( & V_334 , V_22 -> V_333 ) ;
if ( ! V_323 ) {
V_115 = - V_61 ;
goto V_457;
}
V_29 -> V_31 . V_32 -> V_39 . V_346 = F_175 ( V_323 ) ;
V_29 -> V_31 . V_32 -> V_39 . V_340 = 1 ;
V_29 -> V_31 . V_32 -> V_39 . V_344 = F_174 ( V_323 -> V_344 ) ;
F_176 ( V_323 ) ;
...
int F_251 ( struct V_83 * V_18 , struct V_33 * V_21 ,
void * V_85 )
{
struct V_1 * V_2 ;
struct V_28 * V_29 ;
...
void F_258 ( struct V_83 * V_18 , struct V_33 * V_21 )
{
struct V_1 * V_2 ;
struct V_28 * V_29 ;
V_2 = F_16 ( V_18 , struct V_1 , V_18 ) ;
...
F_124 ( V_29 -> V_31 . V_32 -> V_39 . V_430 ) ) ;
...
static int F_260 ( struct V_322 * V_323 , struct V_1 * V_2 )
{
struct V_50 * V_22 ;
struct V_318 * V_291 ;
...
static int F_261 ( struct V_461 * V_462 , unsigned long V_169 ,
void * V_463 )
{
struct V_322 * V_323 = F_262 ( V_463 ) ;
struct V_15 * V_16 ;
struct V_1 * V_2 ;
int V_6 = V_464 ;
if ( F_263 ( V_323 ) != & V_334 )
return V_464 ;
if ( V_169 != V_465 )
return V_464 ;
...
static void F_264 ( struct V_468 * V_19 )
{
struct V_15 * V_16 ;
struct V_1 * V_2 ;
V_16 = F_123 ( sizeof *V_16 , V_89 ) ;
if ( ! V_16 )
return;
V_16 -> V_19 = V_19 ;
F_52 ( & V_16 -> V_4 ) ;
...
static void F_268 ( struct V_468 * V_19 )
{
struct V_15 * V_16 ;
V_16 = F_269 ( V_19 , & V_469 ) ;
if ( ! V_16 )
return;
F_19 ( & V_7 ) ;
F_20 ( & V_16 -> V_25 ) ;
...
static int F_270 ( struct V_472 * V_473 , struct V_474 * V_475 )
{
struct V_476 * V_477 ;
struct V_478 * V_479 ;
struct V_1 * V_2 ;
...
V_479 = F_271 ( V_473 , & V_477 , V_475 -> V_477 -> V_482 ,
sizeof *V_479 , V_483 ,
V_484 ) ;
if ( ! V_479 )
goto V_70;
...
V_486 ) )
goto V_70;
V_479 -> V_487 = V_2 -> V_91 ;
V_479 -> V_488 = V_18 -> V_41 ;
V_479 -> V_489 = V_2 -> V_8 ;
