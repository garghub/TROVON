...
bool V_83 = false ;
#ifdef F_19
if ( F_20 ( V_84 , V_11 -> V_2 ) ) {
if ( F_21 ( V_11 -> V_2 -> V_85 ,
L_3 , NULL ) )
V_83 = true ;
if ( F_21 ( V_11 -> V_2 -> V_85 ,
L_4 , NULL ) )
...
struct V_12 * V_13 ;
V_13 = F_28 ( V_2 , sizeof( * V_13 ) , V_90 ) ;
if ( ! V_13 )
return - V_91 ;
if ( F_20 ( V_84 , V_2 ) )
V_13 -> V_86 =
...
struct V_12 * V_13 ;
int V_17 ;
V_17 = F_27 ( & V_93 -> V_2 , & V_13 ) ;
if ( V_17 < 0 )
return V_17 ;
F_32 ( V_93 , V_13 ) ;
V_13 -> V_27 = F_33 ( V_93 , & V_94 ) ;
if ( F_34 ( V_13 -> V_27 ) )
return F_35 ( V_13 -> V_27 ) ;
return F_36 ( & V_93 -> V_2 , & V_95 ,
& V_96 , 1 ) ;
}
