...
int V_28 ;
if ( ( V_120 -> V_199 != V_200 ) && ! F_127 ( V_97 , V_35 ) )
return - V_36 ;
V_28 = F_128 ( V_120 , sizeof( * V_197 ) , V_161 , V_198 , NULL ) ;
if ( V_28 < 0 )
return V_28 ;
V_49 = F_129 ( V_147 , V_197 -> V_201 ) ;
if ( ! V_49 )
return - V_202 ;
V_149 = V_197 -> V_203 ;
if ( V_149 ) {
...
struct V_196 * V_197 ;
struct V_148 * V_216 ;
unsigned char * V_217 = F_134 ( V_97 ) ;
struct V_218 V_219 ;
struct V_78 * V_82 ;
F_90 () ;
V_216 = F_135 ( V_97 , V_213 , V_214 , V_215 , sizeof( * V_197 ) , V_40 ) ;
if ( ! V_216 )
goto V_220;
V_197 = F_126 ( V_216 ) ;
V_197 -> V_221 = V_222 ;
...
goto V_100;
if ( F_138 ( V_97 , V_228 , V_229 , V_230 ,
F_117 ( V_3 ) , & V_219 ) < 0 )
goto V_100;
if ( V_3 -> V_34 -> V_231 && V_3 -> V_34 -> V_231 ( V_3 , & V_219 ) < 0 )
goto V_100;
if ( F_139 ( & V_219 , & V_3 -> V_178 ) < 0 ||
F_140 ( & V_219 , & V_3 -> V_178 , & V_3 -> V_179 ) < 0 ||
F_141 ( & V_219 , & V_3 -> V_146 ) < 0 )
goto V_100;
if ( F_142 ( & V_219 ) < 0 )
goto V_100;
V_216 -> V_232 = F_134 ( V_97 ) - V_217 ;
return V_97 -> V_31 ;
V_220:
V_100:
F_143 ( V_97 , V_217 ) ;
...
{
struct V_96 * V_97 ;
T_2 V_213 = V_233 ? F_145 ( V_233 ) . V_213 : 0 ;
V_97 = F_146 ( V_234 , V_74 ) ;
if ( ! V_97 )
return - V_235 ;
if ( V_150 && ! F_144 ( V_150 ) ) {
if ( F_133 ( V_97 , V_150 , V_149 , V_213 , V_120 -> V_236 ,
0 , V_205 ) < 0 )
goto V_166;
}
if ( V_151 && ! F_144 ( V_151 ) ) {
if ( F_133 ( V_97 , V_151 , V_149 , V_213 , V_120 -> V_236 ,
V_150 ? V_208 : 0 , V_237 ) < 0 )
goto V_166;
}
if ( V_97 -> V_31 )
return F_147 ( V_97 , V_147 , V_213 , V_238 ,
V_120 -> V_207 & V_239 ) ;
V_166:
F_148 ( V_97 ) ;
return - V_27 ;
...
if ( ! F_144 ( V_3 ) &&
F_133 ( V_97 , V_3 , V_3 -> V_42 , F_145 ( V_241 -> V_97 ) . V_213 ,
...
static int F_150 ( struct V_96 * V_97 , struct V_240 * V_241 )
{
struct V_147 * V_147 = F_125 ( V_97 -> V_195 ) ;
int V_248 , V_245 ;
int V_249 , V_243 ;
...
V_243 = 0 ;
V_245 = 0 ;
if ( F_149 ( V_49 -> V_45 , V_97 , V_241 , & V_245 , V_243 ) < 0 )
goto V_247;
V_158 = F_24 ( V_49 ) ;
if ( V_158 &&
F_149 ( V_158 -> V_50 , V_97 , V_241 ,
& V_245 , V_243 ) < 0 )
goto V_247;
V_250:
V_248 ++ ;
...
T_2 V_252 ;
int V_28 ;
if ( ( V_120 -> V_199 != V_253 ) && ! F_127 ( V_97 , V_35 ) )
return - V_36 ;
V_28 = F_128 ( V_120 , sizeof( * V_197 ) , V_161 , V_198 , NULL ) ;
if ( V_28 < 0 )
return V_28 ;
...
return F_155 ( V_259 -> V_97 , V_3 , V_53 , F_145 ( V_259 -> V_241 -> V_97 ) . V_213 ,
...
F_1 ( & V_295 ) ;
F_1 ( & V_296 ) ;
F_186 ( V_297 , V_237 , F_130 , NULL , NULL ) ;
F_186 ( V_297 , V_205 , F_124 , NULL , NULL ) ;
F_186 ( V_297 , V_200 , F_124 , F_150 , NULL ) ;
