...
V_36 = F_120 ( V_84 -> V_185 , V_98 , V_84 , V_162 . V_15 , V_162 . V_16 ,
...
static int F_143 ( struct V_234 * V_235 [] , struct V_234 * V_96 [] )
{
T_6 V_147 ;
if ( ! V_96 || ! V_96 [ V_236 ] )
return 0 ;
V_147 = F_144 ( V_96 [ V_236 ] ) ;
if ( V_147 != V_116 &&
V_147 != V_143 &&
V_147 != 0 )
return - V_75 ;
...
static void F_145 ( struct V_234 * V_96 [] ,
struct V_22 * V_13 )
{
...
return;
if ( V_96 [ V_237 ] )
V_13 -> V_17 = F_146 ( V_96 [ V_237 ] ) ;
if ( V_96 [ V_238 ] )
V_13 -> V_14 . V_15 = F_147 ( V_96 [ V_238 ] ) ;
if ( V_96 [ V_239 ] )
V_13 -> V_14 . V_16 = F_147 ( V_96 [ V_239 ] ) ;
if ( V_96 [ V_240 ] ) {
V_13 -> V_14 . V_117 = F_144 ( V_96 [ V_240 ] ) ;
if ( V_13 -> V_14 . V_117 )
V_13 -> V_14 . V_157 = F_81 ( V_209 ) ;
}
if ( V_96 [ V_241 ] )
V_13 -> V_14 . V_138 = F_144 ( V_96 [ V_241 ] ) ;
if ( ! V_96 [ V_242 ] || F_144 ( V_96 [ V_242 ] ) )
V_13 -> V_14 . V_157 = F_81 ( V_209 ) ;
if ( V_96 [ V_243 ] )
V_13 -> V_40 = F_148 ( V_96 [ V_243 ] ) ;
if ( V_96 [ V_236 ] )
V_13 -> V_14 . V_131 = F_144 ( V_96 [ V_236 ] ) ;
}
static bool F_149 ( struct V_234 * V_96 [] ,
struct V_195 * V_30 )
{
bool V_64 = false ;
...
static int F_152 ( struct V_2 * V_248 , struct V_3 * V_4 ,
struct V_234 * V_235 [] , struct V_234 * V_96 [] )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_1 * V_48 ;
#ifdef F_13
...
static int F_153 ( struct V_3 * V_4 , struct V_234 * V_235 [] ,
struct V_234 * V_96 [] )
{
struct V_1 * V_9 = F_14 ( V_4 ) ;
struct V_22 V_74 ;
...
{
struct V_1 * V_95 = F_14 ( V_4 ) ;
struct V_22 * V_249 = & V_95 -> V_13 ;
if ( F_157 ( V_84 , V_237 , V_249 -> V_17 ) ||
F_158 ( V_84 , V_238 , V_249 -> V_14 . V_15 ) ||
F_158 ( V_84 , V_239 , V_249 -> V_14 . V_16 ) ||
F_159 ( V_84 , V_240 , V_249 -> V_14 . V_117 ) ||
F_159 ( V_84 , V_241 , V_249 -> V_14 . V_138 ) ||
F_159 ( V_84 , V_242 ,
! ! ( V_249 -> V_14 . V_157 & F_81 ( V_209 ) ) ) ||
F_159 ( V_84 , V_236 , V_249 -> V_14 . V_131 ) ||
F_160 ( V_84 , V_243 , V_249 -> V_40 ) )
goto V_250;
#ifdef F_13
if ( F_161 ( V_84 , V_244 , sizeof( struct V_91 ) ,
& V_95 -> V_30 . V_31 ) ||
F_158 ( V_84 , V_245 ,
V_95 -> V_30 . V_32 ) ||
F_162 ( V_84 , V_246 ,
...
static void F_163 ( struct V_3 * V_4 , struct V_252 * V_80 )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
if ( V_4 != V_11 -> V_29 )
...
V_11 -> V_25 [ 1 ] = V_11 -> V_255 ;
V_11 -> V_25 [ 2 ] = V_11 -> V_256 ;
V_11 -> V_25 [ 3 ] = V_11 -> V_257 ;
...
if ( V_36 < 0 )
return V_36 ;
V_36 = F_182 ( & V_263 , V_264 ) ;
if ( V_36 < 0 ) {
F_180 ( L_8 , V_268 ) ;
goto V_269;
}
V_36 = F_182 ( & V_265 , V_266 ) ;
if ( V_36 < 0 ) {
F_180 ( L_9 , V_268 ) ;
goto V_270;
}
