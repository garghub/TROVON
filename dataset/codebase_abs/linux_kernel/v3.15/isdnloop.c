...
L_45 , ( int ) ( V_116 + 1 ) ,
V_132 , V_60 , V_53 -> V_24 . V_37 . V_41 ,
...
static int
F_50 ( const T_3 T_6 * V_79 , int V_10 , int V_149 , int V_2 )
{
T_1 * V_1 = F_48 ( V_149 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_28 & V_110 ) )
...
static int
F_51 ( T_3 T_6 * V_79 , int V_10 , int V_149 , int V_2 )
{
T_1 * V_1 = F_48 ( V_149 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_28 & V_110 ) )
...
static int
F_52 ( int V_149 , int V_2 , int V_11 , struct V_12 * V_13 )
{
T_1 * V_1 = F_48 ( V_149 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_28 & V_110 ) )
...
T_1 * V_1 ;
int V_93 ;
if ( ! ( V_1 = F_54 ( sizeof( T_1 ) , V_150 ) ) ) {
F_5 ( V_21
L_69 , V_149 ) ;
return ( T_1 * ) 0 ;
}
V_1 -> V_19 . V_151 = V_152 ;
V_1 -> V_19 . V_153 = V_131 ;
V_1 -> V_19 . V_154 = 1 ;
V_1 -> V_19 . V_155 = 4000 ;
V_1 -> V_19 . V_22 = F_49 ;
V_1 -> V_19 . V_156 = F_52 ;
...
V_164 ;
V_1 -> V_66 = V_127 ;
F_12 ( V_1 -> V_19 . V_149 , V_149 , sizeof( V_1 -> V_19 . V_149 ) ) ;
V_1 -> V_54 = V_1 -> V_57 ;
V_1 -> V_55 = V_1 -> V_57 ;
V_1 -> V_56 = & V_1 -> V_57 [ sizeof( V_1 -> V_57 ) - 1 ] ;
for ( V_93 = 0 ; V_93 < V_131 ; V_93 ++ ) {
V_1 -> V_134 [ V_93 ] = V_135 ;
F_55 ( & V_1 -> V_5 [ V_93 ] ) ;
}
F_55 ( & V_1 -> V_61 ) ;
F_56 ( & V_1 -> V_31 ) ;
