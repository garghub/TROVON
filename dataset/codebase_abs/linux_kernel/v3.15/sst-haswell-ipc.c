...
goto V_266;
F_124 ( & V_33 -> V_78 ) ;
V_33 -> V_267 = F_125 ( V_268 ,
& V_33 -> V_78 ,
F_126 ( V_33 -> V_50 ) ) ;
if ( F_127 ( V_33 -> V_267 ) ) {
V_70 = F_128 ( V_33 -> V_267 ) ;
F_13 ( V_33 -> V_50 , L_71 ) ;
goto V_266;
}
...
F_131 ( V_33 -> V_41 ) ;
V_264 = F_132 ( V_33 -> V_41 , V_102 -> V_272 , V_33 ) ;
if ( V_264 == NULL ) {
V_70 = - V_271 ;
F_13 ( V_50 , L_72 ) ;
goto V_273;
...
F_60 ( V_33 , & V_161 ) ;
F_134 ( V_33 -> V_50 , L_74 ,
V_161 . type , V_161 . V_276 , V_161 . V_277 , V_161 . V_278 ) ;
V_70 = F_102 ( V_33 ) ;
if ( V_70 < 0 ) {
F_13 ( V_33 -> V_50 , L_75 ) ;
goto V_275;
...
void F_137 ( struct V_261 * V_50 , struct V_262 * V_102 )
{
