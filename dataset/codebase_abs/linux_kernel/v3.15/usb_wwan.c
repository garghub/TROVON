...
for ( V_59 = 0 ; V_59 < V_90 ; V_59 ++ ) {
F_60 ( V_5 -> V_91 [ V_59 ] ) ;
F_62 ( ( unsigned long ) V_5 -> V_104 [ V_59 ] ) ;
}
F_61 ( V_5 ) ;
return - V_102 ;
}
...
struct V_1 * V_2 ;
struct V_4 * V_5 ;
for ( V_59 = 0 ; V_59 < V_8 -> V_114 ; ++ V_59 ) {
V_2 = V_8 -> V_2 [ V_59 ] ;
V_5 = F_2 ( V_2 ) ;
if ( ! V_5 )
continue;
for ( V_113 = 0 ; V_113 < V_90 ; V_113 ++ )
F_47 ( V_5 -> V_91 [ V_113 ] ) ;
for ( V_113 = 0 ; V_113 < V_66 ; V_113 ++ )
F_47 ( V_5 -> V_68 [ V_113 ] ) ;
}
}
int F_65 ( struct V_89 * V_8 , T_3 V_115 )
{
