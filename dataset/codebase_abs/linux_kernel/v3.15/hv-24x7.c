...
static T_4 F_34 ( struct V_76 * V_77 )
{
unsigned long V_28 ;
T_4 V_80 ;
...
T_4 V_97 ;
V_97 = F_34 ( V_77 ) ;
V_96 = F_36 ( & V_77 -> V_98 . V_99 , V_97 ) ;
F_37 ( V_97 - V_96 , & V_77 -> V_26 ) ;
}
static void F_38 ( struct V_76 * V_77 , int V_100 )
{
if ( V_100 & V_101 )
F_39 ( & V_77 -> V_98 . V_99 , F_34 ( V_77 ) ) ;
}
static void F_40 ( struct V_76 * V_77 , int V_100 )
{
F_35 ( V_77 ) ;
}
static int F_41 ( struct V_76 * V_77 , int V_100 )
{
if ( V_100 & V_102 )
F_38 ( V_77 , V_100 ) ;
return 0 ;
...
V_34 = F_46 ( L_14 , 4096 , 4096 , 0 , NULL ) ;
if ( ! V_34 )
return - V_38 ;
V_103 = F_47 ( & V_106 , V_106 . V_107 , - 1 ) ;
if ( V_103 )
return V_103 ;
return 0 ;
}
