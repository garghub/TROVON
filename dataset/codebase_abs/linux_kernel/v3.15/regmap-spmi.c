...
{
return F_9 ( & V_13 -> V_16 , & V_17 , V_13 , V_15 ) ;
}
struct V_11 * F_10 ( struct V_12 * V_13 ,
const struct V_14 * V_15 )
{
return F_11 ( & V_13 -> V_16 , & V_17 , V_13 , V_15 ) ;
}
...
V_6 = * ( T_3 * ) V_2 ;
while ( V_6 <= 0xFF && V_5 ) {
V_18 = F_13 ( T_1 , V_5 , 16 ) ;
V_7 = F_14 ( V_1 , V_6 , V_4 , V_18 ) ;
if ( V_7 )
goto V_9;
V_6 += V_18 ;
V_4 += V_18 ;
...
const struct V_14 * V_15 )
{
return F_9 ( & V_13 -> V_16 , & V_19 , V_13 , V_15 ) ;
}
struct V_11 * F_21 ( struct V_12 * V_13 ,
const struct V_14 * V_15 )
{
return F_11 ( & V_13 -> V_16 , & V_19 , V_13 , V_15 ) ;
}
