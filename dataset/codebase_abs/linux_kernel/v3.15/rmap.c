...
static int F_165 ( unsigned long V_122 , unsigned int * V_76 ,
...
static bool F_176 ( struct V_10 * V_11 , void * V_67 )
{
return F_175 ( V_11 ) ;
}
...
int F_178 ( struct V_38 * V_38 , enum V_103 V_98 )
{
int V_81 ;
struct V_83 V_84 = {
. V_85 = F_144 ,
...
F_115 ( ! F_112 ( V_38 ) || F_180 ( V_38 ) , V_38 ) ;
V_81 = F_98 ( V_38 , & V_84 ) ;
return V_81 ;
}
...
static struct V_1 * F_181 ( struct V_38 * V_38 ,
struct V_83 * V_84 )
{
struct V_1 * V_1 ;
if ( V_84 -> V_86 )
...
static int F_182 ( struct V_38 * V_38 , struct V_83 * V_84 )
{
struct V_1 * V_1 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
struct V_7 * V_12 ;
...
if ( ! V_1 )
return V_81 ;
F_183 (avc, &anon_vma->rb_root, pgoff, pgoff) {
...
static int F_184 ( struct V_38 * V_38 , struct V_83 * V_84 )
{
struct V_91 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << F_185 ( V_38 ) ;
struct V_10 * V_11 ;
int V_81 = V_72 ;
F_5 ( ! F_112 ( V_38 ) ) ;
if ( ! V_40 )
return V_81 ;
F_186 ( & V_40 -> V_141 ) ;
F_187 (vma, &mapping->i_mmap, pgoff, pgoff) {
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
if ( V_84 -> V_87 && V_84 -> V_87 ( V_11 , V_84 -> V_67 ) )
continue;
V_81 = V_84 -> V_85 ( V_38 , V_11 , V_51 , V_84 -> V_67 ) ;
...
{
if ( F_18 ( F_96 ( V_38 ) ) )
return F_189 ( V_38 , V_84 ) ;
else if ( F_63 ( V_38 ) )
return F_182 ( V_38 , V_84 ) ;
else
return F_184 ( V_38 , V_84 ) ;
}
static void F_190 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 , int V_92 )
{
struct V_1 * V_1 = V_11 -> V_1 ;
F_111 ( ! V_1 ) ;
...
if ( V_93 )
F_190 ( V_38 , V_11 , V_51 , 0 ) ;
}
void F_192 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 )
{
F_111 ( V_51 < V_11 -> V_49 || V_51 >= V_11 -> V_52 ) ;
F_3 ( & V_38 -> V_94 , 0 ) ;
F_190 ( V_38 , V_11 , V_51 , 1 ) ;
}
