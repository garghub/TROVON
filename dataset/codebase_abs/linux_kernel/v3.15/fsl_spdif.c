...
F_54 ( V_128 , & V_184 -> V_185 ,
& V_184 -> V_186 ) ;
F_55 ( V_128 , V_187 , F_56 ( V_187 ) ) ;
return 0 ;
}
static bool F_57 ( struct V_188 * V_9 , unsigned int V_20 )
{
switch ( V_20 ) {
case V_54 :
case V_181 :
...
static bool F_58 ( struct V_188 * V_9 , unsigned int V_20 )
{
switch ( V_20 ) {
case V_54 :
case V_181 :
...
struct V_81 * V_81 , T_4 V_193 ,
enum V_194 V_195 )
{
const T_1 V_80 [] = { 32000 , 44100 , 48000 } ;
T_4 V_196 , V_197 , V_198 ;
T_1 div , V_199 ;
for ( div = 1 ; div <= 128 ; div ++ ) {
V_196 = V_80 [ V_195 ] * ( div + 1 ) * 64 ;
V_197 = F_60 ( V_81 , V_196 ) ;
V_199 = V_197 / 64 ;
V_199 /= div ;
if ( V_199 == V_80 [ V_195 ] ) {
V_193 = 0 ;
V_2 -> V_91 [ V_195 ] = div ;
break;
} else if ( V_199 / V_80 [ V_195 ] == 1 ) {
V_198 = ( V_199 - V_80 [ V_195 ] ) * 100000 ;
F_48 ( V_198 , V_80 [ V_195 ] ) ;
if ( V_198 < V_193 ) {
V_193 = V_198 ;
V_2 -> V_91 [ V_195 ] = div ;
}
} else if ( V_80 [ V_195 ] / V_199 == 1 ) {
V_198 = ( V_80 [ V_195 ] - V_199 ) * 100000 ;
F_48 ( V_198 , V_80 [ V_195 ] ) ;
if ( V_198 < V_193 ) {
V_193 = V_198 ;
V_2 -> V_91 [ V_195 ] = div ;
...
const T_1 V_80 [] = { 32000 , 44100 , 48000 } ;
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_188 * V_9 = & V_5 -> V_9 ;
T_4 V_193 = 100000 , V_82 ;
struct V_81 * V_81 ;
char V_200 [ 16 ] ;
int V_101 ;
for ( V_101 = 0 ; V_101 < V_90 ; V_101 ++ ) {
sprintf ( V_200 , L_35 , V_101 ) ;
V_81 = F_62 ( & V_5 -> V_9 , V_200 ) ;
if ( F_63 ( V_81 ) ) {
F_7 ( V_9 , L_36 , V_101 ) ;
return F_64 ( V_81 ) ;
}
if ( ! F_24 ( V_81 ) )
continue;
V_82 = F_59 ( V_2 , V_81 , V_193 , V_195 ) ;
if ( V_193 == V_82 )
continue;
V_193 = V_82 ;
V_2 -> V_92 [ V_195 ] = V_81 ;
V_2 -> V_89 [ V_195 ] = V_101 ;
if ( V_193 < 100 )
break;
}
F_3 ( & V_5 -> V_9 , L_37 ,
V_2 -> V_89 [ V_195 ] , V_80 [ V_195 ] ) ;
F_3 ( & V_5 -> V_9 , L_38 ,
V_2 -> V_91 [ V_195 ] , V_80 [ V_195 ] ) ;
return 0 ;
}
static int F_65 ( struct V_4 * V_5 )
{
struct V_201 * V_202 = V_5 -> V_9 . V_203 ;
struct V_1 * V_2 ;
struct V_14 * V_15 ;
struct V_204 * V_205 ;
void T_5 * V_206 ;
...
return - V_207 ;
V_2 = F_66 ( & V_5 -> V_9 ,
sizeof( struct V_1 ) + strlen ( V_202 -> V_13 ) + 1 ,
V_208 ) ;
if ( ! V_2 )
return - V_209 ;
strcpy ( V_2 -> V_13 , V_202 -> V_13 ) ;
V_2 -> V_5 = V_5 ;
memcpy ( & V_2 -> V_210 , & V_211 , sizeof( V_211 ) ) ;
V_2 -> V_210 . V_13 = V_2 -> V_13 ;
if ( F_67 ( V_202 , L_39 ) )
V_212 . V_213 = V_214 ;
V_205 = F_68 ( V_5 , V_215 , 0 ) ;
V_206 = F_69 ( & V_5 -> V_9 , V_205 ) ;
if ( F_63 ( V_206 ) )
return F_64 ( V_206 ) ;
V_2 -> V_3 = F_70 ( & V_5 -> V_9 ,
L_40 , V_206 , & V_212 ) ;
if ( F_63 ( V_2 -> V_3 ) ) {
F_7 ( & V_5 -> V_9 , L_41 ) ;
return F_64 ( V_2 -> V_3 ) ;
...
V_32 = F_71 ( V_5 , 0 ) ;
if ( V_32 < 0 ) {
F_7 ( & V_5 -> V_9 , L_42 , V_202 -> V_216 ) ;
return V_32 ;
}
V_82 = F_72 ( & V_5 -> V_9 , V_32 , F_13 , 0 ,
V_2 -> V_13 , V_2 ) ;
if ( V_82 ) {
F_7 ( & V_5 -> V_9 , L_43 , V_32 ) ;
return V_82 ;
}
V_2 -> V_122 = F_62 ( & V_5 -> V_9 , L_44 ) ;
if ( F_63 ( V_2 -> V_122 ) ) {
F_7 ( & V_5 -> V_9 , L_45 ) ;
return F_64 ( V_2 -> V_122 ) ;
}
V_2 -> V_65 = V_217 ;
for ( V_101 = 0 ; V_101 < V_115 ; V_101 ++ ) {
V_82 = F_61 ( V_2 , V_101 ) ;
...
V_86 | V_131 ;
V_2 -> V_10 = false ;
V_2 -> V_185 . V_221 = V_222 ;
V_2 -> V_186 . V_221 = V_223 ;
V_2 -> V_185 . V_224 = V_205 -> V_225 + V_191 ;
V_2 -> V_186 . V_224 = V_205 -> V_225 + V_189 ;
F_74 ( & V_5 -> V_9 , V_2 ) ;
V_82 = F_75 ( & V_5 -> V_9 , & V_226 ,
& V_2 -> V_210 , 1 ) ;
if ( V_82 ) {
