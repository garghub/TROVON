...
for ( V_6 = 0 ; V_6 < V_5 -> V_217 ; V_6 ++ ) {
if ( ! F_118 ( F_119 ( V_2 , V_6 ) ) )
continue;
F_15 ( V_5 , L_48 ,
V_6 , V_5 -> V_218 [ V_6 ] -> V_71 , V_5 -> V_218 [ V_6 ] -> V_219 ,
V_5 -> V_218 [ V_6 ] -> V_220 , V_5 -> V_218 [ V_6 ] -> V_221 ) ;
}
V_5 -> V_222 . V_223 ++ ;
F_48 ( V_138 , V_5 , L_49 ) ;
F_37 ( V_82 -> V_114 , & V_5 -> V_224 ) ;
}
static struct V_225 * F_120 ( struct V_1 * V_2 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_36 ( & V_5 -> V_226 ) ;
memcpy ( & V_5 -> V_227 , & V_5 -> V_228 , sizeof( V_5 -> V_228 ) ) ;
F_38 ( & V_5 -> V_226 ) ;
return & V_5 -> V_227 ;
}
...
V_5 -> V_235 = V_236 ;
F_48 ( V_237 , V_5 , L_50 ,
V_5 -> V_2 -> V_238 , V_5 -> V_229 , V_5 -> V_231 ) ;
for ( V_6 = 0 ; V_6 < V_5 -> V_215 ; V_6 ++ ) {
V_14 = V_5 -> V_216 [ V_6 ] ;
V_14 -> V_239 = V_5 -> V_229 ;
V_14 -> V_240 = V_5 -> V_231 ;
V_5 -> V_241 [ V_6 ] = V_242 ;
V_5 -> V_243 [ V_6 ] = 0 ;
V_5 -> V_244 [ V_6 ] = 0 ;
}
for ( V_6 = 0 ; V_6 < V_5 -> V_217 ; V_6 ++ ) {
V_14 = V_5 -> V_245 [ V_6 ] ;
V_14 -> V_239 = V_5 -> V_233 ;
V_14 -> V_240 = V_5 -> V_235 ;
}
V_5 -> V_246 = V_247 ;
V_5 -> V_248 = V_249 ;
V_5 -> V_250 = V_251 ;
...
int V_240 ;
int V_17 , V_113 ;
if ( ! V_5 -> V_256 || V_259 < V_5 -> V_254 * V_267 )
return;
for ( V_17 = 0 ; V_17 < V_5 -> V_215 ; V_17 ++ ) {
F_36 ( & V_5 -> V_226 ) ;
V_264 = V_5 -> V_16 [ V_17 ] -> V_261 ;
V_265 = V_5 -> V_16 [ V_17 ] -> V_268 ;
F_38 ( & V_5 -> V_226 ) ;
V_266 = ( ( unsigned long ) ( V_264 -
V_5 -> V_243 [ V_17 ] ) ) ;
V_261 = V_266 ;
V_262 = V_261 * V_267 / V_259 ;
V_263 = V_261 ? ( ( unsigned long ) ( V_265 -
V_5 -> V_244 [ V_17 ] ) ) / V_261 : 0 ;
if ( V_262 > ( V_269 / V_5 -> V_215 ) &&
V_263 > V_270 ) {
if ( V_262 < V_5 -> V_246 )
V_240 = V_5 -> V_248 ;
...
if ( V_240 != V_5 -> V_241 [ V_17 ] ) {
V_5 -> V_241 [ V_17 ] = V_240 ;
V_14 = V_5 -> V_216 [ V_17 ] ;
V_14 -> V_240 = V_240 ;
V_14 -> V_239 = V_5 -> V_229 ;
...
{
struct V_271 * V_272 = F_125 ( V_32 ) ;
struct V_4 * V_5 = F_6 ( V_272 , struct V_4 ,
V_273 ) ;
struct V_121 * V_82 = V_5 -> V_82 ;
int V_113 ;
F_50 ( & V_82 -> V_125 ) ;
...
F_127 ( V_82 -> V_114 , & V_5 -> V_273 , V_274 ) ;
}
if ( V_82 -> V_275 [ V_276 + 1 - V_5 -> V_64 ] ) {
F_81 ( V_5 ) ;
V_82 -> V_275 [ V_276 + 1 - V_5 -> V_64 ] = 0 ;
}
F_53 ( & V_82 -> V_125 ) ;
}
...
F_50 ( & V_82 -> V_125 ) ;
if ( V_82 -> V_126 ) {
if ( V_82 -> V_2 -> V_134 . V_278 & V_279 )
F_129 ( V_82 ) ;
F_127 ( V_82 -> V_114 , & V_5 -> V_277 ,
V_280 ) ;
}
F_53 ( & V_82 -> V_125 ) ;
}
...
F_59 ( & V_5 -> V_203 ) ;
F_59 ( & V_5 -> V_288 ) ;
memset ( & V_5 -> V_289 [ 0 ] , 0 ,
sizeof( struct V_290 ) * V_291 ) ;
V_2 -> V_238 = F_134 ( V_2 -> V_238 , V_5 -> V_292 ) ;
F_135 ( V_2 ) ;
F_48 ( V_138 , V_5 , L_55 , V_5 -> V_293 ) ;
V_113 = F_136 ( V_5 ) ;
if ( V_113 ) {
F_18 ( V_5 , L_56 ) ;
return V_113 ;
...
for ( V_287 = 0 ; V_287 < V_14 -> V_295 ; V_287 ++ )
V_14 -> V_296 [ V_287 ] . V_297 = V_298 ;
V_113 = F_123 ( V_5 , V_14 ) ;
if ( V_113 ) {
F_18 ( V_5 , L_58 ) ;
F_139 ( V_5 , V_14 ) ;
...
F_140 ( V_5 , V_14 ) ;
V_5 -> V_16 [ V_6 ] -> V_219 = V_14 -> V_299 . V_219 ;
++ V_285 ;
}
...
V_14 -> V_296 -> V_303 = F_143 ( 0xffff ) ;
V_218 = V_5 -> V_218 [ V_6 ] ;
V_113 = F_144 ( V_5 , V_218 , V_14 -> V_299 . V_219 ,
V_6 / V_5 -> V_10 ) ;
if ( V_113 ) {
F_18 ( V_5 , L_64 ) ;
F_139 ( V_5 , V_14 ) ;
...
V_218 -> V_304 = F_119 ( V_2 , V_6 ) ;
F_140 ( V_5 , V_14 ) ;
for ( V_287 = 0 ; V_287 < V_218 -> V_305 ; V_287 += V_306 )
* ( ( T_3 * ) ( V_218 -> V_296 + V_287 ) ) = 0xffffffff ;
++ V_286 ;
}
...
V_113 = F_146 ( V_82 -> V_2 , V_5 -> V_64 , V_313 , 1 ) ;
if ( V_113 ) {
F_18 ( V_5 , L_67 ,
V_113 ) ;
goto V_302;
...
F_149 ( V_82 -> V_2 , & V_5 -> V_315 ) ;
#ifdef F_150
if ( V_5 -> V_82 -> V_2 -> V_134 . V_278 & V_316 )
F_151 ( V_2 ) ;
#endif
V_5 -> V_19 = true ;
F_152 ( V_2 ) ;
...
V_302:
while ( V_286 -- ) {
F_154 ( V_5 , V_5 -> V_218 [ V_286 ] ) ;
F_139 ( V_5 , V_5 -> V_245 [ V_286 ] ) ;
}
F_155 ( V_5 ) ;
V_301:
F_156 ( V_5 ) ;
...
F_155 ( V_5 ) ;
for ( V_6 = 0 ; V_6 < V_5 -> V_217 ; V_6 ++ ) {
F_154 ( V_5 , V_5 -> V_218 [ V_6 ] ) ;
F_139 ( V_5 , V_5 -> V_245 [ V_6 ] ) ;
}
F_166 ( 10 ) ;
for ( V_6 = 0 ; V_6 < V_5 -> V_217 ; V_6 ++ )
F_167 ( V_2 , V_5 -> V_218 [ V_6 ] ) ;
F_156 ( V_5 ) ;
F_73 ( V_5 ) ;
if ( ! ( V_82 -> V_2 -> V_134 . V_278 & V_320 ) )
V_82 -> V_275 [ V_5 -> V_64 ] = 1 ;
for ( V_6 = 0 ; V_6 < V_5 -> V_215 ; V_6 ++ ) {
...
F_48 ( V_123 , V_5 , L_75 ) ;
memset ( & V_5 -> V_228 , 0 , sizeof( V_5 -> V_228 ) ) ;
memset ( & V_5 -> V_323 , 0 , sizeof( V_5 -> V_323 ) ) ;
memset ( & V_5 -> V_324 , 0 , sizeof( V_5 -> V_324 ) ) ;
memset ( & V_5 -> V_222 , 0 , sizeof( V_5 -> V_222 ) ) ;
for ( V_6 = 0 ; V_6 < V_5 -> V_217 ; V_6 ++ ) {
V_5 -> V_218 [ V_6 ] -> V_268 = 0 ;
V_5 -> V_218 [ V_6 ] -> V_261 = 0 ;
V_5 -> V_218 [ V_6 ] -> V_325 = 0 ;
}
for ( V_6 = 0 ; V_6 < V_5 -> V_215 ; V_6 ++ ) {
V_5 -> V_16 [ V_6 ] -> V_268 = 0 ;
...
#endif
for ( V_6 = 0 ; V_6 < V_5 -> V_217 ; V_6 ++ ) {
if ( V_5 -> V_218 && V_5 -> V_218 [ V_6 ] )
F_181 ( V_5 , & V_5 -> V_218 [ V_6 ] ) ;
if ( V_5 -> V_245 && V_5 -> V_245 [ V_6 ] )
F_182 ( V_5 , & V_5 -> V_245 [ V_6 ] ) ;
}
for ( V_6 = 0 ; V_6 < V_5 -> V_215 ; V_6 ++ ) {
if ( V_5 -> V_16 [ V_6 ] )
F_183 ( V_5 , & V_5 -> V_16 [ V_6 ] ,
V_5 -> V_308 -> V_331 , V_5 -> V_332 ) ;
if ( V_5 -> V_216 [ V_6 ] )
F_182 ( V_5 , & V_5 -> V_216 [ V_6 ] ) ;
}
if ( V_5 -> V_333 ) {
F_71 ( V_5 -> V_82 -> V_2 , V_5 -> V_333 , V_5 -> V_217 ) ;
V_5 -> V_333 = 0 ;
}
}
int F_184 ( struct V_4 * V_5 )
{
struct V_334 * V_308 = V_5 -> V_308 ;
int V_6 ;
int V_113 ;
int V_335 ;
V_113 = F_68 ( V_5 -> V_82 -> V_2 , V_5 -> V_217 , 256 , & V_5 -> V_333 ) ;
if ( V_113 ) {
F_18 ( V_5 , L_79 ) ;
return V_113 ;
}
...
if ( F_187 ( V_5 , & V_5 -> V_245 [ V_6 ] ,
V_308 -> V_336 , V_6 , V_337 , V_335 ) )
goto V_113;
if ( F_188 ( V_5 , & V_5 -> V_218 [ V_6 ] ,
V_5 -> V_333 + V_6 ,
V_308 -> V_336 , V_338 ,
V_335 , V_6 ) )
goto V_113;
...
V_308 -> V_331 , V_6 , V_339 , V_335 ) )
goto V_113;
if ( F_189 ( V_5 , & V_5 -> V_16 [ V_6 ] ,
V_308 -> V_331 , V_5 -> V_332 ,
V_335 ) )
goto V_113;
}
#ifdef F_179
...
F_48 ( V_138 , V_5 , L_82 ,
V_2 -> V_238 , V_346 ) ;
if ( ( V_346 < V_347 ) || ( V_346 > V_5 -> V_292 ) ) {
F_18 ( V_5 , L_83 , V_346 ) ;
return - V_348 ;
}
V_2 -> V_238 = V_346 ;
...
static void F_219 ( struct V_31 * V_32 )
{
int V_96 ;
struct V_4 * V_5 = F_6 ( V_32 , struct V_4 ,
V_398 ) ;
V_96 = F_220 ( V_5 -> V_82 -> V_2 , V_5 -> V_399 ) ;
if ( V_96 )
goto V_111;
V_96 = F_146 ( V_5 -> V_82 -> V_2 , V_5 -> V_64 ,
V_313 , 1 ) ;
V_111:
if ( V_96 )
F_18 ( V_5 , L_86 , V_96 ) ;
}
static void F_221 ( struct V_31 * V_32 )
{
int V_96 ;
struct V_4 * V_5 = F_6 ( V_32 , struct V_4 ,
V_400 ) ;
...
if ( V_402 && V_402 != V_64 ) {
F_15 ( V_5 , L_87 ,
F_223 ( V_402 ) , F_223 ( V_64 ) ) ;
return;
}
V_5 -> V_399 = V_64 ;
F_37 ( V_5 -> V_82 -> V_114 , & V_5 -> V_398 ) ;
}
...
V_402 = V_5 -> V_399 ;
if ( V_402 != V_64 ) {
F_48 ( V_138 , V_5 , L_88 , F_223 ( V_64 ) ) ;
return;
}
F_37 ( V_5 -> V_82 -> V_114 , & V_5 -> V_400 ) ;
}
int F_225 ( struct V_121 * V_82 , int V_64 ,
struct V_334 * V_308 )
{
struct V_1 * V_2 ;
struct V_4 * V_5 ;
...
int V_113 ;
T_5 V_386 ;
V_2 = F_226 ( sizeof( struct V_4 ) ,
V_404 , V_405 ) ;
if ( V_2 == NULL )
return - V_112 ;
F_227 ( V_2 , V_308 -> V_217 ) ;
F_228 ( V_2 , V_308 -> V_215 ) ;
F_229 ( V_2 , & V_82 -> V_2 -> V_406 -> V_2 ) ;
V_2 -> V_407 = V_64 - 1 ;
V_5 = F_2 ( V_2 ) ;
memset ( V_5 , 0 , sizeof( struct V_4 ) ) ;
V_5 -> V_2 = V_2 ;
V_5 -> V_82 = V_82 ;
V_5 -> V_408 = & V_82 -> V_406 -> V_2 ;
V_5 -> V_308 = V_308 ;
V_5 -> V_64 = V_64 ;
V_5 -> V_19 = false ;
V_5 -> V_166 = V_308 -> V_166 ;
V_5 -> V_382 = F_206 ( V_409 |
V_410 ) ;
V_5 -> V_10 = V_82 -> V_411 . V_10 ;
V_5 -> V_217 = V_308 -> V_217 ;
V_5 -> V_218 = F_24 ( sizeof( struct V_284 * ) * V_404 ,
V_157 ) ;
if ( ! V_5 -> V_218 ) {
V_113 = - V_112 ;
goto V_111;
}
V_5 -> V_245 = F_24 ( sizeof( struct V_13 * ) * V_404 ,
V_157 ) ;
if ( ! V_5 -> V_245 ) {
V_113 = - V_112 ;
goto V_111;
}
V_5 -> V_215 = V_308 -> V_215 ;
V_5 -> V_412 = ( V_82 -> V_2 -> V_134 . V_413 == 64 ) ? 1 : 0 ;
V_5 -> V_414 = - 1 ;
V_5 -> V_415 = V_416 ;
F_230 ( & V_5 -> V_226 ) ;
F_25 ( & V_5 -> V_191 , F_110 ) ;
F_25 ( & V_5 -> V_224 , F_174 ) ;
F_25 ( & V_5 -> V_281 , F_130 ) ;
F_231 ( & V_5 -> V_273 , F_124 ) ;
F_231 ( & V_5 -> V_277 , F_128 ) ;
#ifdef F_150
F_25 ( & V_5 -> V_398 , F_219 ) ;
F_25 ( & V_5 -> V_400 , F_221 ) ;
#endif
#ifdef F_232
if ( ! F_233 ( V_5 -> V_82 -> V_2 ) ) {
if ( V_82 -> V_2 -> V_134 . V_166 & V_417 ) {
V_2 -> V_418 = & V_419 ;
} else {
F_131 ( V_5 , L_89 ) ;
V_2 -> V_418 = & V_420 ;
...
for ( V_6 = 0 ; V_6 < V_164 ; ++ V_6 )
F_234 ( & V_5 -> V_160 [ V_6 ] ) ;
V_5 -> V_292 = V_82 -> V_2 -> V_134 . V_421 [ V_5 -> V_64 ] ;
V_2 -> V_422 = V_78 ;
F_57 ( V_2 -> V_77 , V_82 -> V_2 -> V_134 . V_423 [ V_5 -> V_64 ] ) ;
if ( ! F_83 ( V_2 -> V_77 ) ) {
if ( F_233 ( V_5 -> V_82 -> V_2 ) ) {
F_235 ( V_2 ) ;
F_15 ( V_5 , L_90 , V_2 -> V_77 ) ;
V_386 = F_65 ( V_2 -> V_77 ) ;
V_82 -> V_2 -> V_134 . V_423 [ V_5 -> V_64 ] = V_386 ;
} else {
F_18 ( V_5 , L_91 ,
V_5 -> V_64 , V_2 -> V_77 ) ;
V_113 = - V_9 ;
...
V_5 -> V_332 = F_236 ( sizeof( struct V_424 ) +
V_425 * V_426 ) ;
V_113 = F_184 ( V_5 ) ;
if ( V_113 )
goto V_111;
...
V_113 = F_237 ( V_82 -> V_2 , & V_5 -> V_343 ,
V_344 , V_344 ) ;
if ( V_113 ) {
F_18 ( V_5 , L_92 ) ;
goto V_111;
...
F_228 ( V_2 , V_5 -> V_215 ) ;
F_239 ( V_2 , & V_432 ) ;
V_2 -> V_433 = V_434 | V_435 | V_436 ;
if ( V_82 -> V_437 )
V_2 -> V_433 |= V_438 | V_439 ;
V_2 -> V_440 = V_2 -> V_433 ;
V_2 -> V_433 |= V_441 | V_442 ;
V_2 -> V_380 = V_2 -> V_433 | V_443 |
V_444 | V_445 |
V_446 ;
V_2 -> V_433 |= V_381 ;
if ( V_82 -> V_2 -> V_134 . V_141 ==
...
V_5 -> V_341 = 1 ;
F_15 ( V_5 , L_94 , V_308 -> V_217 ) ;
F_15 ( V_5 , L_95 , V_308 -> V_215 ) ;
F_207 ( V_5 -> V_2 , V_5 -> V_2 -> V_380 ) ;
F_135 ( V_2 ) ;
V_113 = F_145 ( V_82 -> V_2 , V_5 -> V_64 ,
V_5 -> V_293 + V_307 ,
V_308 -> V_309 , V_308 -> V_310 ,
V_308 -> V_311 , V_308 -> V_312 ) ;
if ( V_113 ) {
F_18 ( V_5 , L_96
L_97 , V_5 -> V_64 , V_113 ) ;
goto V_111;
