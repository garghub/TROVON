...
{
struct V_59 * V_60 = F_28 ( & V_56 -> V_47 ) ;
int V_31 ;
F_29 ( & V_28 -> V_33 ) ;
V_28 -> V_2 = V_60 -> V_2 ;
V_28 -> V_29 . V_61 = V_58 -> V_61 ;
...
V_28 -> V_23 = V_60 -> V_23 ;
V_28 -> V_24 = V_60 -> V_24 ;
V_31 = F_30 ( & V_56 -> V_47 , & V_28 -> V_29 ) ;
if ( V_31 < 0 )
return V_31 ;
if ( V_28 -> V_30 [ V_41 ] != V_32 ) {
V_31 = F_31 ( V_28 -> V_29 . V_47 , & V_54 ) ;
if ( V_31 )
F_26 ( & V_28 -> V_29 ) ;
}
return V_31 ;
...
return - V_14 ;
V_67 = F_33 ( & V_56 -> V_47 ,
sizeof( struct V_27 ) * V_60 -> V_68 , V_69 ) ;
if ( ! V_67 )
return - V_70 ;
V_31 = F_8 ( V_60 -> V_2 ) ;
if ( V_31 < 0 )
return V_31 ;
for ( V_13 = 0 ; V_13 < V_60 -> V_68 ; V_13 ++ ) {
V_31 = F_27 ( V_56 , & V_67 [ V_13 ] , & V_60 -> V_71 [ V_13 ] ) ;
if ( V_31 < 0 )
goto V_72;
}
F_34 ( V_56 , V_67 ) ;
