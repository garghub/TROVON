...
static int F_36 ( struct V_9 * V_9 , struct V_62 * V_63 ,
T_1 V_59 )
{
struct V_10 * V_64 = F_2 ( F_37 ( V_9 ) ) ;
struct V_4 * V_5 ;
unsigned int V_13 ;
if ( ! V_64 )
return - V_8 ;
...
static int F_40 ( struct V_9 * V_9 , struct V_62 * V_63 )
{
return F_36 ( V_9 , V_63 , F_28 ) ;
}
...
int F_42 ( struct V_24 * V_24 , int V_71 )
{
int V_72 = F_43 ( V_24 , V_71 ) ;
if ( V_72 == 0 )
return 0 ;
if ( F_44 ( V_73 ) == F_45 ( V_24 ) )
V_72 = 0 ;
return V_72 ;
}
static int
...
static int F_48 ( struct V_9 * V_9 , struct V_62 * V_63 )
{
return F_36 ( V_9 , V_63 ,
F_46 ) ;
}
