...
F_60 ( args -> V_53 , V_91 ) ;
if ( ! error && ( args -> V_98 > 0 ) && ! ( args -> V_17 & V_103 ) ) {
error = F_74 ( args ) ;
}
return error ;
}
...
V_104 -> args = args ;
V_104 -> V_33 = V_33 ;
V_104 -> V_107 = V_104 -> V_33 -> V_36 . V_37 ;
V_104 -> V_108 = V_104 -> V_33 -> V_109 ;
error = F_77 ( V_104 , & V_86 ) ;
if ( error )
goto V_73;
V_105 = & V_104 -> V_110 . V_105 [ V_104 -> V_110 . V_111 - 1 ] ;
ASSERT ( V_105 -> V_112 == V_113 ) ;
if ( ( args -> V_17 & V_87 ) && ( V_86 == V_18 ) ) {
goto V_73;
} else if ( V_86 == V_26 ) {
if ( args -> V_17 & V_88 )
...
V_86 = F_62 ( V_105 -> V_91 , V_104 -> args ) ;
if ( V_86 == V_68 ) {
if ( V_104 -> V_110 . V_111 == 1 ) {
F_79 ( V_104 ) ;
V_104 = NULL ;
F_36 ( args -> V_40 , args -> V_39 ) ;
error = F_63 ( args ) ;
...
V_105 = & V_104 -> V_110 . V_105 [ V_104 -> V_110 . V_111 - 1 ] ;
ASSERT ( V_105 -> V_112 == V_113 ) ;
error = F_67 ( V_105 -> V_91 , args ) ;
F_81 ( V_104 , & V_104 -> V_110 ) ;
if ( V_86 && ( V_104 -> V_110 . V_111 > 1 ) ) {
F_36 ( args -> V_40 , args -> V_39 ) ;
error = F_82 ( V_104 ) ;
if ( ! error ) {
error = F_38 ( & args -> V_53 ,
...
if ( F_7 ( V_22 , V_24 ) ) {
ASSERT ( V_104 -> V_110 . V_111 == 1 ) ;
ASSERT ( V_104 -> V_110 . V_105 [ 0 ] . V_91 ) ;
V_104 -> V_110 . V_105 [ 0 ] . V_91 = NULL ;
...
F_87 ( V_104 -> args ) ;
V_110 = & V_104 -> V_110 ;
ASSERT ( ( V_110 -> V_111 >= 0 ) && ( V_110 -> V_111 < V_117 ) ) ;
for ( V_105 = V_110 -> V_105 , V_116 = 0 ; V_116 < V_110 -> V_111 ; V_105 ++ , V_116 ++ ) {
if ( V_105 -> V_91 ) {
V_105 -> V_118 = F_88 ( V_105 -> V_91 ) ;
V_105 -> V_91 = NULL ;
} else {
V_105 -> V_118 = 0 ;
}
...
for ( V_105 = V_110 -> V_105 , V_116 = 0 ; V_116 < V_110 -> V_111 ; V_105 ++ , V_116 ++ ) {
if ( V_105 -> V_118 ) {
error = F_90 ( V_104 -> args -> V_53 ,
V_104 -> args -> V_22 ,
V_105 -> V_92 , V_105 -> V_118 ,
& V_105 -> V_91 , V_24 ) ;
if ( error )
return ( error ) ;
} else {
...
ASSERT ( V_105 -> V_91 != NULL ) ;
ASSERT ( V_105 -> V_112 == V_113 ) ;
V_86 = F_73 ( V_105 -> V_91 , args ) ;
if ( ! V_86 && ( args -> V_98 > 0 )
&& ! ( args -> V_17 & V_103 ) ) {
V_86 = F_74 ( args ) ;
}
}
for ( V_120 = 0 ; V_120 < V_104 -> V_110 . V_111 ; V_120 ++ ) {
F_60 ( args -> V_53 , V_104 -> V_110 . V_105 [ V_120 ] . V_91 ) ;
V_104 -> V_110 . V_105 [ V_120 ] . V_91 = NULL ;
}
F_79 ( V_104 ) ;
return ( V_86 ) ;
}
