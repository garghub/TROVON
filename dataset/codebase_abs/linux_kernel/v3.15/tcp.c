...
static int F_180 ( struct V_165 * V_114 )
{
int V_49 , V_269 ;
struct V_243 sin ;
struct V_165 * V_270 = NULL ;
struct V_75 * V_7 = NULL ;
struct V_75 * V_271 = NULL ;
struct V_16 * V_17 = NULL ;
struct V_43 * V_46 ;
F_24 ( V_114 == NULL ) ;
V_49 = F_181 ( V_114 -> V_115 -> V_272 , V_114 -> V_115 -> V_273 ,
V_114 -> V_115 -> V_274 , & V_270 ) ;
if ( V_49 )
goto V_63;
V_270 -> type = V_114 -> type ;
V_270 -> V_181 = V_114 -> V_181 ;
V_49 = V_114 -> V_181 -> V_275 ( V_114 , V_270 , V_262 ) ;
if ( V_49 < 0 )
goto V_63;
V_270 -> V_115 -> V_251 = V_52 ;
V_49 = F_155 ( V_270 ) ;
if ( V_49 ) {
F_44 ( V_177 , L_65 , V_49 ) ;
goto V_63;
...
V_269 = sizeof( sin ) ;
V_49 = V_270 -> V_181 -> V_276 ( V_270 , (struct V_259 * ) & sin ,
& V_269 , 1 ) ;
if ( V_49 < 0 )
goto V_63;
...
static int F_186 ( T_12 V_282 , T_13 V_283 )
{
struct V_165 * V_114 = NULL ;
int V_49 ;
struct V_243 sin = {
...
V_279 = V_114 ;
F_67 ( & V_281 , F_185 ) ;
V_114 -> V_115 -> V_285 = V_286 ;
V_49 = V_114 -> V_181 -> V_258 ( V_114 , (struct V_259 * ) & sin , sizeof( sin ) ) ;
if ( V_49 < 0 ) {
F_85 ( V_284 L_80
L_81 , V_49 , & V_282 , F_183 ( V_283 ) ) ;
goto V_63;
}
V_49 = V_114 -> V_181 -> V_287 ( V_114 , 64 ) ;
if ( V_49 < 0 )
F_85 ( V_284 L_82 ,
V_49 , & V_282 , F_183 ( V_283 ) ) ;
V_63:
if ( V_49 ) {
V_279 = NULL ;
if ( V_114 )
...
if ( F_193 () )
return - V_154 ;
V_236 = F_62 ( sizeof( struct V_215 ) , V_290 ) ;
V_240 = F_62 ( sizeof( struct V_185 ) , V_290 ) ;
V_208 = F_62 ( sizeof( struct V_185 ) , V_290 ) ;
