...
static int F_103 ( struct V_52 * V_53 , int V_242 )
{
struct V_34 * V_35 = F_97 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_239 , L_116 ,
...
F_99 ( & V_35 -> V_224 ) ;
if ( V_35 -> V_241 )
V_112 = F_105 ( V_35 , V_243 ) ;
F_101 ( & V_35 -> V_224 ) ;
return V_112 ;
}
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 )
return F_106 ( V_43 , V_242 ) ;
}
F_16 ( V_239 , L_117
L_115 ) ;
return - V_68 ;
...
static int F_109 ( char * V_50 , struct V_244 * V_245 )
{
if ( V_246 == V_247 )
...
static int F_110 ( const char * V_248 , struct V_244 * V_245 )
{
if ( strncasecmp ( V_248 , L_120 , strlen ( L_120 ) ) == 0 )
V_248 += strlen ( L_120 ) ;
if ( strcasecmp ( V_248 , L_121 ) == 0 )
V_246 = V_247 ;
else if ( strcasecmp ( V_248 , L_122 ) == 0 )
V_246 = V_249 ;
else
return - V_68 ;
return 0 ;
