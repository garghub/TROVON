...
F_68 ( V_66 -> V_72 > V_138 ) ;
V_63 -> V_81 . V_139 = F_37 ( sizeof( struct V_68 ) +
V_66 -> V_72 ) ;
...
break;
case V_108 :
V_63 -> V_81 . V_139 += sizeof( struct V_23 ) ;
break;
default:
goto error;
}
...
{
if ( F_74 ( & V_142 , V_124 ) < 0 ) {
F_69 ( L_6 , V_143 ) ;
return - V_144 ;
}
if ( F_75 ( & V_145 , V_86 ) < 0 ) {
F_69 ( L_7 , V_143 ) ;
F_76 ( & V_142 , V_124 ) ;
return - V_144 ;
}
...
{
if ( F_78 ( & V_145 , V_86 ) < 0 )
F_69 ( L_8 , V_143 ) ;
if ( F_76 ( & V_142 , V_124 ) < 0 )
F_69 ( L_9 , V_143 ) ;
}
