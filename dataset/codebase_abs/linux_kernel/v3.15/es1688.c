...
struct V_5 * V_6 ;
int error ;
error = F_19 ( V_2 , V_35 [ V_3 ] , V_36 [ V_3 ] , V_37 ,
...
struct V_43 * V_44 ;
int error ;
V_44 = F_25 ( V_40 , V_42 -> V_45 [ 0 ] . V_36 , NULL ) ;
if ( V_44 == NULL )
return - V_46 ;
error = F_26 ( V_44 ) ;
if ( error < 0 ) {
...
V_19 [ V_3 ] = F_28 ( V_44 , 0 ) ;
V_17 [ V_3 ] = F_29 ( V_44 , 0 ) ;
V_14 [ V_3 ] = F_30 ( V_44 , 0 ) ;
...
if ( V_2 == V_49 )
return - V_46 ;
error = F_19 ( & V_40 -> V_6 -> V_2 ,
V_35 [ V_2 ] , V_36 [ V_2 ] , V_37 ,
sizeof( struct V_7 ) , & V_6 ) ;
if ( error < 0 )
return error ;
V_8 = V_6 -> V_9 ;
error = F_24 ( V_6 , V_2 , V_40 , V_42 ) ;
if ( error < 0 ) {
F_21 ( V_6 ) ;
return error ;
}
