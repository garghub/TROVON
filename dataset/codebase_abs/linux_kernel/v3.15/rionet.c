...
static int F_70 ( struct V_71 * V_72 , struct V_73 * V_74 )
{
int V_67 = - V_100 ;
T_2 V_101 , V_102 ;
struct V_57 * V_58 ;
...
if ( V_75 >= V_104 )
return V_67 ;
V_103 = F_71 ( V_75 , V_105 ) ;
if ( ! V_103 ) {
F_72 ( V_23 -> V_76 -> V_77 , V_106 ,
& V_101 ) ;
F_72 ( V_23 -> V_76 -> V_77 , V_107 ,
& V_102 ) ;
if ( ! F_73 ( V_101 , V_102 ) ) {
F_14 ( V_44
L_12 ,
...
F_75 ( & V_41 [ V_75 ] . V_108 ) ;
V_41 [ V_75 ] . V_43 = 0 ;
} else if ( V_41 [ V_75 ] . V_2 == NULL )
goto V_69;
if ( F_55 ( V_23 ) ) {
if ( ! ( V_58 = F_76 ( sizeof( struct V_57 ) , V_89 ) ) ) {
V_67 = - V_90 ;
goto V_69;
}
V_58 -> V_23 = V_23 ;
F_77 ( & V_58 -> V_78 , & V_41 [ V_75 ] . V_108 ) ;
}
return 0 ;
V_69:
return V_67 ;
...
F_82 ( ( unsigned long ) V_41 [ V_3 ] . V_49 ,
F_64 ( sizeof( void * ) *
F_21 ( V_5 -> V_9 -> V_48 ) ) ) ;
V_41 [ V_3 ] . V_49 = NULL ;
F_83 ( V_2 ) ;
