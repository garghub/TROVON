...
V_137 = F_81 () ;
snprintf ( V_153 , 16 , L_15 , V_8 -> V_97 -> V_98 ) ;
...
F_114 ( & V_61 -> V_113 -> V_164 , L_23 , V_61 ) ;
F_115 ( V_61 -> V_113 ) ;
V_61 -> V_113 = NULL ;
}
if ( V_61 -> V_54 != NULL )
...
V_4 -> V_17 = V_149 ;
F_108 ( V_149 ) ;
F_128 ( & V_149 -> V_164 , & V_4 -> V_173 , L_25 , V_4 ) ;
F_29 ( & V_4 -> V_59 ) ;
return 0 ;
}
...
#ifdef F_191
struct V_249 V_250 ;
F_192 ( V_221 , V_248 , & V_250 ) ;
return ( T_5 ) V_250 . V_251 ;
#else
return 0 ;
#endif
}
int F_193 ( const struct V_9 * V_61 , struct V_252 * V_253 )
{
T_6 V_221 ;
memset ( & V_221 , 0 , sizeof( V_221 ) ) ;
F_170 ( V_61 -> V_26 , & V_221 , 1 ) ;
return F_194 ( V_253 , L_31 ,
V_221 . V_225 ,
V_221 . V_226 ,
V_221 . V_228 ,
F_195 ( V_61 -> V_26 ) ,
...
int F_196 ( struct V_254 * V_255 )
{
int V_47 ;
struct V_254 * V_256 = V_255 ;
for ( V_47 = 0 ; V_256 -> V_257 != NULL ; ++ V_256 ) {
* V_256 -> V_257 = F_197 ( V_256 -> V_258 ,
V_256 -> V_259 ,
0 , 0 , NULL ) ;
if ( * V_256 -> V_257 == NULL ) {
V_47 = - V_50 ;
...
void F_198 ( struct V_254 * V_255 )
{
for (; V_255 -> V_257 != NULL ; ++ V_255 ) {
if ( * V_255 -> V_257 != NULL ) {
F_199 ( * V_255 -> V_257 ) ;
* V_255 -> V_257 = NULL ;
}
...
struct V_14 * V_260 = & V_4 -> V_16 -> V_27 ;
struct V_5 * V_6 ;
struct V_3 * V_115 ;
T_3 V_101 ;
struct V_34 * V_114 ;
...
void F_203 ( struct V_261 * V_262 )
{
F_4 ( V_262 ) ;
if ( V_262 -> V_263 ) {
F_4 ( V_262 -> V_264 > 0 ) ;
F_204 ( V_262 -> V_263 , V_262 -> V_264 ) ;
V_262 -> V_263 = NULL ;
V_262 -> V_264 = 0 ;
}
}
void F_205 ( struct V_261 * V_262 , int V_265 )
{
F_4 ( V_262 ) ;
F_4 ( V_262 -> V_263 == NULL ) ;
F_4 ( V_262 -> V_264 == 0 ) ;
F_206 ( V_262 -> V_263 , V_265 ) ;
if ( F_56 ( V_262 -> V_263 ) )
V_262 -> V_264 = V_265 ;
}
void F_207 ( struct V_261 * V_262 , int V_265 )
{
F_203 ( V_262 ) ;
F_205 ( V_262 , V_265 ) ;
}
struct V_261 * F_208 ( struct V_261 * V_262 , int V_266 )
{
if ( V_262 -> V_263 == NULL && V_262 -> V_264 == 0 )
F_205 ( V_262 , V_266 ) ;
if ( ( V_266 > V_262 -> V_264 ) && ( V_262 -> V_263 != NULL ) )
F_207 ( V_262 , V_266 ) ;
return V_262 ;
}
int F_209 ( struct V_261 * V_262 , int V_266 )
{
char * V_267 ;
if ( V_266 <= V_262 -> V_264 )
return 0 ;
F_206 ( V_267 , V_266 ) ;
if ( V_267 == NULL )
return - V_50 ;
if ( V_262 -> V_263 != NULL ) {
memcpy ( V_267 , V_262 -> V_263 , V_262 -> V_264 ) ;
F_204 ( V_262 -> V_263 , V_262 -> V_264 ) ;
}
V_262 -> V_263 = V_267 ;
V_262 -> V_264 = V_266 ;
