...
F_2 ( V_67 -> V_155 == NULL ) ;
V_67 -> V_156 = 0 ;
V_77 = F_100 ( V_67 -> V_154 , V_67 -> V_157 ) ;
switch ( V_77 ) {
case 1 :
F_101 ( V_67 , V_158 ) ;
case 0 :
...
! V_67 -> V_263 ) {
F_106 ( V_281 , V_67 , L_70 ) ;
V_277 = V_278 ;
}
break;
case V_285 :
default:
F_106 ( V_281 , V_67 , L_71 , V_67 -> V_279 ) ;
V_277 = V_278 ;
}
return V_277 ;
}
...
int F_166 ( struct V_162 * V_234 , int V_319 )
{
struct V_320 * V_321 ;
V_321 = F_136 ( V_234 , V_319 , 0 ) ;
V_321 -> V_322 = F_30 ( & V_58 , F_31 () ) ;
V_321 -> V_323 = F_32 ( & V_58 , F_33 () ) ;
V_321 -> V_324 = F_30 ( & V_58 , F_167 () ) ;
V_321 -> V_325 = F_32 ( & V_58 , F_168 () ) ;
V_321 -> V_326 = F_169 () ;
V_321 -> V_327 = ( V_234 -> V_241 [ V_319 ] - sizeof( * V_321 ) ) / 4 ;
F_170 ( V_328 ) ;
if ( V_321 -> V_327 > V_317 )
V_321 -> V_327 = V_317 ;
memcpy ( V_321 -> V_329 , F_171 () -> V_330 -> V_331 [ 0 ] ,
V_321 -> V_327 * sizeof( T_2 ) ) ;
F_172 ( V_328 ) ;
return 0 ;
}
int F_173 ( struct V_162 * V_234 , int V_319 , int V_332 )
{
struct V_320 * V_321 ;
int V_333 ;
V_321 = F_136 ( V_234 , V_319 , sizeof( * V_321 ) ) ;
if ( ! V_321 )
return - V_9 ;
if ( V_332 ) {
F_174 ( & V_321 -> V_322 ) ;
...
if ( F_175 ( V_47 ) )
return L_78 ;
return F_127 ( & V_47 -> V_334 -> V_197 -> V_220 . V_221 . V_226 ) ;
}
