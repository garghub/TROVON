...
V_28 = F_77 ( sizeof( struct V_84 ) , L_28 , F_75 ) ;
if ( ! V_28 )
return - V_13 ;
V_84 = F_43 ( V_28 ) ;
sprintf ( V_28 -> V_125 , L_29 , V_73 ) ;
F_78 ( & V_84 -> V_70 ) ;
V_84 -> V_73 = V_73 ;
error = F_79 ( V_28 ) ;
if ( error ) {
...
case V_132 :
F_2 ( L_31 ) ;
F_1 ( V_133 , F_43 ( V_28 ) -> V_73 , 0 ) ;
break;
case V_134 :
F_2 ( L_32 ) ;
F_1 ( V_135 , F_43 ( V_28 ) -> V_73 , 0 ) ;
break;
case V_136 :
case V_137 :
F_2 ( L_33 ) ;
F_1 ( V_138 , F_43 ( V_28 ) -> V_73 , 0 ) ;
break;
}
return V_130 ;
}
...
break;
case V_158 :
V_155 = F_65 ( V_40 , V_154 ) ;
break;
case V_159 :
V_155 = F_69 ( V_40 , ( V_166 T_1 ) V_154 ) ;
break;
case V_160 :
V_155 = F_52 ( V_40 , V_154 ) ;
break;
}
return V_155 ;
}
...
static void F_101 ( struct V_167 * V_168 , struct V_33 * V_34 ,
...
V_181 = ( ( V_18 == V_184 ) ||
( F_6 ( V_18 -> V_40 ) -> V_185 == V_186 ) ) ;
V_182 = ( ( V_18 == V_184 ) || V_18 -> V_53 ) ;
if ( V_18 == V_184 )
exp = V_20 -> V_21 -> V_25 ;
else
exp = V_18 -> V_38 ;
exp = ( V_26 - exp ) / V_49 ;
F_99 ( V_168 , L_38 ,
V_28 -> V_125 , V_181 ? L_39 : L_40 , V_182 ? L_41 : L_42 , exp ) ;
V_183 = F_102 ( V_180 , sizeof( V_180 ) - 1 , L_43 , V_34 -> V_71 ) ;
while ( V_183 < 16 )
V_180 [ V_183 ++ ] = ' ' ;
V_180 [ V_183 ] = '\0' ;
...
F_99 ( V_168 , L_46 ,
V_18 -> V_40 -> V_28 -> V_73 ,
V_18 -> V_40 -> V_187 , V_18 -> V_40 -> V_188 ) ;
} else {
F_98 ( V_168 , & V_18 -> V_40 -> V_189 ) ;
F_100 ( V_168 , '\n' ) ;
}
}
static struct V_18 * F_103 ( struct V_19 * V_190 ,
struct V_18 * V_191 )
{
if ( ! V_191 ) {
V_191 = V_190 -> V_24 ;
...
struct V_19 * V_190 , T_3 * V_193 )
{
struct V_18 * V_40 = V_164 -> V_40 ;
V_40 = F_103 ( V_190 , V_40 ) ;
if ( V_40 && V_193 != NULL ) {
while ( * V_193 ) {
V_40 = F_103 ( V_190 , V_40 ) ;
if ( ! V_40 )
...
F_101 ( V_168 , V_34 , F_16 ( V_34 ) , V_40 ) ;
}
return 0 ;
}
