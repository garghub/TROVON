...
case V_131 :
if ( V_16 -> V_126 & V_132 )
V_121 . V_133 = F_94 ( 0x0008 ) ;
else
V_121 . V_133 = F_94 ( 0x000D ) ;
V_121 . V_134 = 0x02 ;
break;
case V_135 :
V_121 . V_133 = F_94 ( 0xffff ) ;
V_121 . V_134 = 0xff ;
break;
}
F_93 ( V_15 , V_136 ,
...
static int F_96 ( struct V_116 * V_117 , struct V_70 * V_2 ,
...
F_59 ( V_3 ) ;
return F_98 ( V_117 , V_2 , V_41 , V_42 , V_68 ) ;
}
static int F_99 ( struct V_70 * V_2 , int V_140 , int V_141 , char T_5 * V_142 , unsigned int V_143 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_42 , V_22 = 0 ;
struct V_144 V_145 ;
...
if ( F_100 ( V_146 , ( T_6 T_5 * ) V_142 ) ) {
V_22 = - V_49 ;
break;
}
if ( V_146 )
F_101 ( V_139 , & F_61 ( V_3 ) -> V_68 ) ;
else
...
V_42 = F_103 (unsigned int, sizeof(voice), optlen) ;
if ( F_104 ( ( char * ) & V_145 , V_142 , V_42 ) ) {
V_22 = - V_49 ;
break;
}
if ( V_145 . V_31 != V_32 &&
...
static int F_105 ( struct V_70 * V_2 , int V_141 , char T_5 * V_142 , int T_5 * V_143 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_150 V_151 ;
struct V_152 V_153 ;
...
F_2 ( L_18 , V_151 . V_21 ) ;
V_42 = F_103 (unsigned int, len, sizeof(opts)) ;
if ( F_106 ( V_142 , ( char * ) & V_151 , V_42 ) )
V_22 = - V_49 ;
break;
case V_155 :
if ( V_3 -> V_4 != V_37 &&
...
V_42 = F_103 (unsigned int, len, sizeof(cinfo)) ;
if ( F_106 ( V_142 , ( char * ) & V_153 , V_42 ) )
V_22 = - V_49 ;
break;
default:
V_22 = - V_149 ;
...
static int F_107 ( struct V_70 * V_2 , int V_140 , int V_141 , char T_5 * V_142 , int T_5 * V_143 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_42 , V_22 = 0 ;
struct V_144 V_145 ;
F_2 ( L_7 , V_3 ) ;
if ( V_140 == V_159 )
return F_105 ( V_2 , V_141 , V_142 , V_143 ) ;
if ( F_100 ( V_42 , V_143 ) )
return - V_49 ;
F_58 ( V_3 ) ;
switch ( V_141 ) {
...
if ( F_108 ( F_97 ( V_139 , & F_61 ( V_3 ) -> V_68 ) ,
( T_6 T_5 * ) V_142 ) )
V_22 = - V_49 ;
break;
case V_148 :
V_145 . V_31 = F_23 ( V_3 ) -> V_31 ;
V_42 = F_103 (unsigned int, len, sizeof(voice)) ;
if ( F_106 ( V_142 , ( char * ) & V_145 , V_42 ) )
V_22 = - V_49 ;
break;
default:
V_22 = - V_149 ;
...
static int F_109 ( struct V_70 * V_2 , int V_160 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_22 = 0 ;
F_2 ( L_16 , V_2 , V_3 ) ;
...
static int F_110 ( struct V_70 * V_2 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_22 = 0 ;
F_2 ( L_16 , V_2 , V_3 ) ;
...
int F_116 ( struct V_14 * V_15 , T_1 * V_122 , T_7 * V_68 )
{
struct V_2 * V_3 ;
int V_167 = 0 ;
...
void F_117 ( struct V_12 * V_13 , T_7 V_171 )
{
...
F_17 ( V_13 , F_118 ( V_171 ) ) ;
}
void F_119 ( struct V_12 * V_13 , T_7 V_172 )
{
F_2 ( L_22 , V_13 , V_172 ) ;
F_17 ( V_13 , F_118 ( V_172 ) ) ;
}
int F_120 ( struct V_12 * V_13 , struct V_43 * V_44 )
{
struct V_11 * V_16 = V_13 -> V_17 ;
if ( ! V_16 )
goto V_50;
...
static int F_121 ( struct V_173 * V_174 , void * V_175 )
{
struct V_2 * V_3 ;
F_47 ( & V_54 . V_19 ) ;
F_44 (sk, &sco_sk_list.head) {
F_122 ( V_174 , L_24 , & F_23 ( V_3 ) -> V_25 ,
& F_23 ( V_3 ) -> V_26 , V_3 -> V_4 ) ;
}
F_48 ( & V_54 . V_19 ) ;
return 0 ;
}
static int F_123 ( struct V_176 * V_176 , struct V_177 * V_177 )
{
return F_124 ( V_177 , F_121 , V_176 -> V_178 ) ;
}
int T_8 F_125 ( void )
{
int V_22 ;
...
if ( V_22 < 0 )
return V_22 ;
V_22 = F_127 ( V_165 , & V_179 ) ;
if ( V_22 < 0 ) {
F_128 ( L_25 ) ;
goto error;
}
V_22 = F_129 ( & V_180 , L_26 , & V_54 , NULL ) ;
if ( V_22 < 0 ) {
F_128 ( L_27 ) ;
F_130 ( V_165 ) ;
goto error;
