...
{
struct V_13 * V_269 = F_25 ( V_7 ) ;
struct V_1 * V_2 = F_26 ( V_269 ) ;
if ( ! V_2 )
return 0 ;
if ( V_2 -> type && V_2 -> type -> V_270 )
V_2 -> type -> V_270 ( V_2 ) ;
F_98 ( V_269 ) ;
F_11 ( V_269 , 16 * 4 , & V_2 -> V_271 [ 0 ] ) ;
F_11 ( V_269 , 17 * 4 , & V_2 -> V_271 [ 1 ] ) ;
F_71 ( V_269 ) ;
return 0 ;
}
...
if ( ! V_2 )
return 0 ;
F_17 ( V_269 , 16 * 4 , V_2 -> V_271 [ 0 ] ) ;
F_17 ( V_269 , 17 * 4 , V_2 -> V_271 [ 1 ] ) ;
V_239 = F_88 ( V_269 ) ;
if ( V_239 )
return V_239 ;
F_100 ( V_269 ) ;
