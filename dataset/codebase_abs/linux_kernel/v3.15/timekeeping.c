...
void __weak F_66 ( struct V_8 * V_9 )
{
V_9 -> V_10 = 0 ;
V_9 -> V_11 = 0 ;
}
void __weak F_67 ( struct V_8 * V_9 )
{
V_9 -> V_10 = 0 ;
V_9 -> V_11 = 0 ;
}
...
F_4 ( V_2 ,
F_48 ( V_2 -> V_14 , V_9 ) ) ;
F_54 ( V_2 , V_2 -> V_18 - V_111 ) ;
V_110 = V_52 ;
}
}
return V_110 ;
}
static T_1 F_97 ( struct V_1 * V_2 , T_1 V_98 ,
T_2 V_6 ,
unsigned int * V_110 )
{
...
* V_110 |= F_95 ( V_2 ) ;
V_112 = ( V_4 ) V_2 -> V_33 << V_6 ;
V_112 += V_2 -> V_55 . V_11 ;
if ( V_112 >= V_5 ) {
V_4 V_113 = V_112 ;
V_112 = F_12 ( V_113 , V_5 ) ;
V_2 -> V_55 . V_10 += V_113 ;
}
V_2 -> V_55 . V_11 = V_112 ;
V_2 -> V_35 += F_92 () << V_6 ;
...
{
T_3 V_114 ;
V_114 = V_2 -> V_3 & ( ( 1ULL << V_2 -> V_6 ) - 1 ) ;
V_2 -> V_3 -= V_114 ;
V_2 -> V_3 += 1ULL << V_2 -> V_6 ;
V_2 -> V_35 += V_114 << V_2 -> V_36 ;
V_2 -> V_35 -= ( 1ULL << V_2 -> V_6 ) << V_2 -> V_36 ;
}
void F_99 ( void )
{
struct V_22 * clock ;
struct V_1 * V_115 = & V_1 ;
struct V_1 * V_2 = & V_54 ;
T_1 V_98 ;
int V_6 = 0 , V_116 ;
unsigned int V_110 = 0 ;
...
if ( V_98 < V_115 -> V_30 )
goto V_117;
V_6 = F_101 ( V_98 ) - F_101 ( V_2 -> V_30 ) ;
V_6 = V_90 ( 0 , V_6 ) ;
V_116 = ( 64 - ( F_101 ( F_92 () ) + 1 ) ) - 1 ;
V_6 = F_102 ( V_6 , V_116 ) ;
while ( V_98 >= V_2 -> V_30 ) {
V_98 = F_97 ( V_2 , V_98 , V_6 ,
& V_110 ) ;
...
F_5 ( V_9 , - V_118 . V_10 , - V_118 . V_11 ) ;
}
void F_105 ( struct V_8 * V_9 )
{
struct V_1 * V_2 = & V_1 ;
struct V_8 V_62 , V_119 ;
T_3 V_41 ;
unsigned int V_56 ;
F_36 ( V_59 ) ;
do {
...
V_9 -> V_10 += V_62 . V_10 + V_119 . V_10 ;
V_9 -> V_11 = 0 ;
F_30 ( V_9 , V_41 + V_62 . V_11 + V_119 . V_11 ) ;
}
T_4 F_106 ( void )
{
struct V_8 V_9 ;
...
F_5 ( & V_69 , V_69 . V_10 + V_120 . V_10 ,
V_69 . V_11 + V_120 . V_11 ) ;
return V_69 ;
}
void F_112 ( unsigned long V_121 )
{
V_122 += V_121 ;
F_113 ( V_121 ) ;
}
void F_114 ( struct V_8 * V_123 ,
struct V_8 * V_124 , struct V_8 * V_119 )
{
struct V_1 * V_2 = & V_1 ;
unsigned long V_56 ;
do {
...
struct V_8 V_84 ;
V_84 . V_10 = V_126 -> time . V_10 ;
V_84 . V_11 = V_126 -> time . V_70 ;
if ( ! ( V_126 -> V_129 & V_131 ) )
V_84 . V_11 *= 1000 ;
V_48 = F_51 ( & V_84 ) ;
if ( V_48 )
return V_48 ;
...
F_21 ( & V_49 , V_47 ) ;
F_46 ( & V_58 ) ;
V_127 = V_128 = V_2 -> V_18 ;
V_48 = F_120 ( V_126 , & V_9 , & V_128 ) ;
if ( V_128 != V_127 ) {
F_54 ( V_2 , V_128 ) ;
F_26 ( V_2 , V_53 | V_52 ) ;
}
...
void F_122 ( const struct V_8 * V_132 , const struct V_8 * V_133 )
{
unsigned long V_47 ;
F_21 ( & V_49 , V_47 ) ;
F_46 ( & V_58 ) ;
...
void F_124 ( unsigned long V_121 )
{
F_125 ( & V_134 ) ;
F_112 ( V_121 ) ;
F_126 ( & V_134 ) ;
