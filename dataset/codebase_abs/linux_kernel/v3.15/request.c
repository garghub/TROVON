...
{
struct V_19 * V_20 = F_11 ( V_18 , struct V_19 , V_18 ) ;
F_56 ( V_20 -> V_3 , V_20 -> V_54 , V_20 -> V_56 ) ;
F_57 ( & V_20 -> V_26 ) ;
F_58 ( V_20 -> V_3 ) ;
V_32 ( V_18 ) ;
}
...
{
if ( V_114 -> V_133 ) {
int V_134 , V_135 = F_107 ( V_114 -> V_133 ) ;
unsigned long V_136 = V_105 - V_114 -> V_137 ;
V_134 = F_108 () ;
F_109 ( V_134 , & V_114 -> V_12 -> V_84 -> V_138 ) ;
F_110 ( V_134 , & V_114 -> V_12 -> V_84 -> V_138 , V_139 [ V_135 ] , V_136 ) ;
F_111 () ;
F_112 ( V_114 -> V_12 , V_114 -> V_133 ) ;
F_113 ( V_114 -> V_133 , V_114 -> V_115 . error ) ;
V_114 -> V_133 = NULL ;
}
}
...
{
struct V_113 * V_114 ;
V_114 = F_122 ( V_12 -> V_25 -> V_113 , V_67 ) ;
...
V_114 -> V_12 = V_12 ;
V_114 -> V_132 = 1 ;
V_114 -> V_142 = ( V_3 -> V_57 & V_70 ) != 0 ;
V_114 -> V_127 = 0 ;
V_114 -> V_137 = V_105 ;
V_114 -> V_115 . V_25 = V_12 -> V_25 ;
V_114 -> V_115 . V_3 = NULL ;
V_114 -> V_115 . V_47 = V_12 -> V_143 ;
V_114 -> V_115 . V_64 = F_124 ( ( unsigned long ) V_87 , 16 ) ;
V_114 -> V_115 . V_65 = 0 ;
V_114 -> V_115 . error = 0 ;
V_114 -> V_115 . V_90 = 0 ;
...
struct V_1 * V_2 = F_11 ( V_114 -> V_12 , struct V_1 , V_84 ) ;
if ( V_114 -> V_115 . V_3 ) {
F_135 ( V_114 -> V_115 . V_3 ) ;
V_114 -> V_115 . V_3 -> V_41 . V_42 = V_114 -> V_124 -> V_41 . V_42 ;
V_114 -> V_115 . V_3 -> V_144 = V_114 -> V_124 -> V_144 ;
V_114 -> V_115 . V_3 -> V_41 . V_46 = V_114 -> V_145 << 9 ;
F_136 ( V_114 -> V_115 . V_3 , NULL ) ;
F_137 ( V_114 -> V_124 , V_114 -> V_115 . V_3 ) ;
F_28 ( V_114 -> V_124 ) ;
V_114 -> V_124 = NULL ;
}
if ( F_3 ( V_2 , & V_114 -> V_3 . V_3 ) && V_114 -> V_132 && ! V_114 -> V_127 )
F_138 ( V_2 , V_114 -> V_133 ) ;
F_106 ( V_114 ) ;
if ( V_114 -> V_115 . V_3 &&
! F_70 ( V_146 , & V_114 -> V_115 . V_25 -> V_90 ) ) {
F_53 ( ! V_114 -> V_115 . V_23 ) ;
F_139 ( & V_114 -> V_115 . V_18 , F_55 , NULL , V_18 ) ;
}
F_15 ( V_18 , F_127 , NULL ) ;
}
...
struct V_113 * V_114 = F_11 ( V_18 , struct V_113 , V_18 ) ;
struct V_1 * V_2 = F_11 ( V_114 -> V_12 , struct V_1 , V_84 ) ;
F_141 ( V_114 -> V_115 . V_25 , V_114 -> V_12 ,
! V_114 -> V_124 , V_114 -> V_115 . V_56 ) ;
F_142 ( V_114 -> V_133 , ! V_114 -> V_124 , V_114 -> V_115 . V_56 ) ;
if ( V_114 -> V_115 . error )
F_143 ( V_18 , F_131 , V_131 ) ;
else if ( V_114 -> V_115 . V_3 || F_3 ( V_2 , & V_114 -> V_3 . V_3 ) )
F_143 ( V_18 , F_134 , V_131 ) ;
else
F_143 ( V_18 , F_125 , NULL ) ;
}
static int F_144 ( struct V_120 * V_112 , struct V_113 * V_114 ,
...
V_148 = F_43 ( V_3 , V_43 , V_67 , V_114 -> V_12 -> V_63 ) ;
V_24 = V_148 == V_3 ? V_128 : V_122 ;
goto V_150;
}
if ( ! ( V_3 -> V_57 & V_151 ) &&
! ( V_3 -> V_57 & V_152 ) &&
V_114 -> V_115 . V_25 -> V_91 . V_92 < V_153 )
V_147 = F_95 ( V_154 , V_2 -> V_155 >> 9 ,
F_145 ( V_3 -> V_144 ) - F_76 ( V_3 ) ) ;
V_114 -> V_145 = F_25 ( V_43 , F_24 ( V_3 ) + V_147 ) ;
V_114 -> V_115 . V_22 = F_27 ( V_114 -> V_115 . V_47 ,
V_3 -> V_41 . V_42 + V_114 -> V_145 ,
V_114 -> V_145 ) ;
V_24 = F_146 ( V_112 , & V_114 -> V_20 , & V_114 -> V_115 . V_22 ) ;
if ( V_24 )
return V_24 ;
V_114 -> V_115 . V_23 = true ;
V_148 = F_43 ( V_3 , V_43 , V_67 , V_114 -> V_12 -> V_63 ) ;
V_24 = V_148 == V_3 ? V_128 : - V_118 ;
V_149 = F_147 ( V_156 ,
F_148 ( V_114 -> V_145 , V_157 ) ,
V_2 -> V_84 . V_63 ) ;
if ( ! V_149 )
goto V_150;
V_149 -> V_41 . V_42 = V_148 -> V_41 . V_42 ;
V_149 -> V_144 = V_148 -> V_144 ;
V_149 -> V_41 . V_46 = V_114 -> V_145 << 9 ;
V_149 -> V_68 = F_104 ;
V_149 -> V_53 = & V_114 -> V_18 ;
F_136 ( V_149 , NULL ) ;
if ( F_149 ( V_149 , V_158 | V_67 ) )
goto V_159;
if ( V_147 )
F_150 ( V_114 -> V_115 . V_25 , V_114 -> V_12 ) ;
V_114 -> V_124 = V_148 ;
V_114 -> V_115 . V_3 = V_149 ;
F_58 ( V_149 ) ;
F_133 ( V_149 , & V_114 -> V_18 , V_114 -> V_12 ) ;
return V_24 ;
V_159:
F_28 ( V_149 ) ;
V_150:
V_148 -> V_68 = F_104 ;
V_148 -> V_53 = & V_114 -> V_18 ;
F_133 ( V_148 , & V_114 -> V_18 , V_114 -> V_12 ) ;
return V_24 ;
}
static void F_151 ( struct V_1 * V_2 , struct V_113 * V_114 )
{
struct V_17 * V_18 = & V_114 -> V_18 ;
F_139 ( & V_114 -> V_115 . V_18 , F_101 , NULL , V_18 ) ;
...
static void F_154 ( struct V_1 * V_2 , struct V_113 * V_114 )
{
struct V_17 * V_18 = & V_114 -> V_18 ;
struct V_3 * V_3 = & V_114 -> V_3 . V_3 ;
struct V_5 V_161 = F_27 ( V_2 -> V_84 . V_143 , V_3 -> V_41 . V_42 , 0 ) ;
struct V_5 V_162 = F_27 ( V_2 -> V_84 . V_143 , F_76 ( V_3 ) , 0 ) ;
F_155 ( & V_114 -> V_115 . V_25 -> V_163 , & V_161 , & V_162 ) ;
F_156 ( & V_2 -> V_160 ) ;
...
V_114 -> V_115 . V_3 = V_3 ;
if ( V_3 -> V_57 & V_58 ) {
struct V_3 * V_166 = F_147 ( V_67 , 0 ,
V_2 -> V_84 . V_63 ) ;
V_166 -> V_57 = V_167 ;
V_166 -> V_144 = V_3 -> V_144 ;
V_166 -> V_68 = F_104 ;
V_166 -> V_53 = V_18 ;
F_133 ( V_166 , V_18 , V_114 -> V_12 ) ;
}
} else {
V_114 -> V_115 . V_3 = F_161 ( V_3 , V_67 , V_2 -> V_84 . V_63 ) ;
F_133 ( V_3 , V_18 , V_114 -> V_12 ) ;
}
F_139 ( & V_114 -> V_115 . V_18 , F_55 , NULL , V_18 ) ;
...
struct V_3 * V_3 = & V_114 -> V_3 . V_3 ;
if ( V_114 -> V_115 . V_27 )
F_163 ( V_114 -> V_115 . V_25 , V_18 ) ;
F_133 ( V_3 , V_18 , V_114 -> V_12 ) ;
F_15 ( V_18 , F_125 , NULL ) ;
}
static void F_164 ( struct V_168 * V_169 , struct V_3 * V_3 )
{
struct V_113 * V_114 ;
struct V_141 * V_12 = V_3 -> V_144 -> V_170 -> V_171 ;
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_84 ) ;
int V_134 , V_135 = F_107 ( V_3 ) ;
V_134 = F_108 () ;
F_165 ( V_134 , & V_12 -> V_84 -> V_138 , V_172 [ V_135 ] ) ;
F_110 ( V_134 , & V_12 -> V_84 -> V_138 , V_43 [ V_135 ] , F_24 ( V_3 ) ) ;
F_111 () ;
V_3 -> V_144 = V_2 -> V_165 ;
V_3 -> V_41 . V_42 += V_2 -> V_4 . V_173 ;
if ( F_166 ( V_2 ) ) {
V_114 = F_121 ( V_3 , V_12 ) ;
F_167 ( V_114 -> V_12 , V_3 ) ;
if ( ! V_3 -> V_41 . V_46 ) {
F_143 ( & V_114 -> V_18 ,
F_162 ,
V_131 ) ;
...
F_168 ( V_3 , & V_12 -> V_174 ) ;
}
}
static int F_169 ( struct V_141 * V_12 , T_4 V_85 ,
unsigned int V_175 , unsigned long V_176 )
{
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_84 ) ;
return F_170 ( V_2 -> V_165 , V_85 , V_175 , V_176 ) ;
}
static int F_171 ( void * V_177 , int V_178 )
{
struct V_141 * V_12 = V_177 ;
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_84 ) ;
struct V_168 * V_169 = F_159 ( V_2 -> V_165 ) ;
int V_24 = 0 ;
if ( F_172 ( & V_169 -> V_179 , V_178 ) )
return 1 ;
if ( F_166 ( V_2 ) ) {
unsigned V_60 ;
struct V_180 * V_181 ;
F_173 (ca, d->c, i) {
V_169 = F_159 ( V_181 -> V_165 ) ;
V_24 |= F_172 ( & V_169 -> V_179 , V_178 ) ;
}
F_126 ( V_2 ) ;
}
return V_24 ;
...
{
struct V_182 * V_183 = V_2 -> V_84 . V_84 ;
V_183 -> V_184 -> V_185 = F_164 ;
V_183 -> V_184 -> V_179 . V_186 = F_171 ;
V_2 -> V_84 . V_124 = F_144 ;
V_2 -> V_84 . V_187 = F_169 ;
}
static int F_175 ( struct V_120 * V_112 , struct V_113 * V_114 ,
struct V_3 * V_3 , unsigned V_43 )
{
unsigned V_188 = F_25 ( V_43 , F_24 ( V_3 ) ) << 9 ;
F_176 ( V_3 -> V_41 . V_46 , V_188 ) ;
F_177 ( V_3 ) ;
F_176 ( V_3 -> V_41 . V_46 , V_188 ) ;
F_178 ( V_3 , V_188 ) ;
if ( ! V_3 -> V_41 . V_46 )
...
static void F_180 ( struct V_168 * V_169 , struct V_3 * V_3 )
{
struct V_113 * V_114 ;
struct V_17 * V_18 ;
struct V_141 * V_12 = V_3 -> V_144 -> V_170 -> V_171 ;
...
F_155 ( & V_114 -> V_115 . V_25 -> V_163 ,
& F_27 ( V_12 -> V_143 , V_3 -> V_41 . V_42 , 0 ) ,
& F_27 ( V_12 -> V_143 , F_76 ( V_3 ) , 0 ) ) ;
...
static int F_181 ( struct V_141 * V_12 , T_4 V_85 ,
unsigned int V_175 , unsigned long V_176 )
{
return - V_189 ;
}
static int F_182 ( void * V_177 , int V_178 )
{
struct V_141 * V_12 = V_177 ;
struct V_168 * V_169 ;
struct V_180 * V_181 ;
...
void F_183 ( struct V_141 * V_12 )
{
struct V_182 * V_183 = V_12 -> V_84 ;
V_183 -> V_184 -> V_185 = F_180 ;
V_183 -> V_184 -> V_179 . V_186 = F_182 ;
V_12 -> V_124 = F_175 ;
V_12 -> V_187 = F_181 ;
}
void F_184 ( void )
