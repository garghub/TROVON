...
case V_109 ... V_110 :
F_66 ( V_111 , & V_2 -> V_50 ) ;
V_2 -> V_35 . V_112 = V_2 -> V_95 . args [ 1 ] ;
V_2 -> V_35 . V_113 = V_2 -> V_95 . args [ 2 ] ;
F_15 ( L_25 ,
V_2 -> V_35 . V_112 , V_2 -> V_35 . V_113 ) ;
break;
case V_114 :
F_67 ( V_115 , & V_2 -> V_50 ) ;
F_66 ( V_116 , & V_2 -> V_50 ) ;
...
F_35 ( V_27 -> V_29 -> V_156 , V_2 , F_59 ( 2 ) ) ;
...
static int F_112 ( struct V_64 * V_9 )
{
struct V_1 * V_2 = F_114 ( V_9 ) ;
F_16 ( V_2 ) ;
return 0 ;
}
static int F_115 ( struct V_64 * V_9 )
{
return 0 ;
}
static int F_116 ( struct V_64 * V_9 )
{
struct V_1 * V_2 = F_114 ( V_9 ) ;
...
static int F_117 ( struct V_181 * V_8 )
{
struct V_64 * V_9 = & V_8 -> V_9 ;
struct V_1 * V_2 = F_114 ( V_9 ) ;
F_118 ( V_9 ) ;
