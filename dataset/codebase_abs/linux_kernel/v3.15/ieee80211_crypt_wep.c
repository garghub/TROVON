...
struct V_25 V_26 = { . V_27 = V_16 -> V_7 } ;
T_1 V_28 ;
T_2 * V_29 ;
struct V_30 V_31 ;
...
if ( ! V_22 -> V_34 )
{
V_28 = ~ F_14 ( ~ 0 , V_21 , V_18 ) ;
V_29 = F_15 ( V_14 , 4 ) ;
V_29 [ 0 ] = V_28 ;
V_29 [ 1 ] = V_28 >> 8 ;
V_29 [ 2 ] = V_28 >> 16 ;
V_29 [ 3 ] = V_28 >> 24 ;
F_16 ( V_16 -> V_7 , V_19 , V_17 ) ;
F_17 ( & V_31 , V_21 , V_18 + 4 ) ;
return F_18 ( & V_26 , & V_31 , & V_31 , V_18 + 4 ) ;
}
return 0 ;
}
...
T_2 V_1 , * V_21 ;
T_3 * V_22 = ( T_3 * ) ( V_14 -> V_23 + V_24 ) ;
struct V_25 V_26 = { . V_27 = V_16 -> V_10 } ;
T_1 V_28 ;
T_2 V_29 [ 4 ] ;
struct V_30 V_31 ;
if ( V_14 -> V_18 < V_15 + 8 )
...
if ( ! V_22 -> V_34 )
{
F_16 ( V_16 -> V_10 , V_19 , V_17 ) ;
F_17 ( & V_31 , V_21 , V_35 + 4 ) ;
if ( F_20 ( & V_26 , & V_31 , & V_31 , V_35 + 4 ) )
return - 7 ;
V_28 = ~ F_14 ( ~ 0 , V_21 , V_35 ) ;
V_29 [ 0 ] = V_28 ;
V_29 [ 1 ] = V_28 >> 8 ;
V_29 [ 2 ] = V_28 >> 16 ;
V_29 [ 3 ] = V_28 >> 24 ;
...
static int F_24 ( void * V_19 , int V_18 , T_2 * V_37 , void * V_3 )
{
struct V_2 * V_16 = V_3 ;
if ( V_18 < V_16 -> V_32 )
return - 1 ;
...
static char * F_25 ( char * V_38 , void * V_3 )
{
struct V_2 * V_16 = V_3 ;
V_38 += sprintf ( V_38 , L_4 ,
V_16 -> V_6 , V_16 -> V_32 ) ;
return V_38 ;
}
int T_4 F_26 ( void )
