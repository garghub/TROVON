...
return 0 ;
if ( V_38 -> V_193 & V_195 ) {
if ( ( V_38 -> V_193 & V_196 ) && F_71 ( V_197 ) )
goto V_192;
if ( ! ( V_38 -> V_193 & V_196 ) && F_71 ( V_198 ) )
goto V_192;
return 0 ;
}
if ( V_38 -> V_193 & V_199 )
return 0 ;
if ( V_38 -> V_193 & V_196 ) {
if ( F_72 ( V_38 -> V_200 ) -> V_201 == 0 ?
F_71 ( V_202 ) : F_71 ( V_203 ) )
goto V_192;
return 0 ;
}
if ( V_38 -> V_204 && F_71 ( V_205 ) )
goto V_192;
if ( V_38 -> V_200 == NULL )
return 0 ;
if ( F_71 ( V_206 ) )
...
V_229 += F_78 ( strlen ( V_228 -> V_231 ) + 1 , 4 ) ;
V_229 += F_78 ( V_228 -> V_232 , 4 ) ;
return V_229 ;
}
static int F_79 ( struct V_227 * V_233 , struct V_234 * V_235 )
{
struct V_230 V_228 ;
V_228 . V_236 = strlen ( V_233 -> V_231 ) + 1 ;
V_228 . V_237 = V_233 -> V_232 ;
V_228 . V_238 = V_233 -> type ;
return F_80 ( V_235 , & V_228 , sizeof( V_228 ) ) &&
F_80 ( V_235 , V_233 -> V_231 , V_228 . V_236 ) && F_81 ( V_235 , 4 ) &&
F_80 ( V_235 , V_233 -> V_239 , V_233 -> V_232 ) && F_81 ( V_235 , 4 ) ;
}
static void F_82 ( struct V_15 * V_240 , int V_241 ,
T_8 V_242 , T_6 V_137 )
{
memset ( V_240 , 0 , sizeof( * V_240 ) ) ;
memcpy ( V_240 -> V_162 , V_163 , V_164 ) ;
V_240 -> V_162 [ V_243 ] = V_244 ;
V_240 -> V_162 [ V_245 ] = V_246 ;
V_240 -> V_162 [ V_247 ] = V_248 ;
V_240 -> V_162 [ V_249 ] = V_250 ;
V_240 -> V_109 = V_251 ;
V_240 -> V_252 = V_242 ;
V_240 -> V_253 = V_248 ;
...
static void F_83 ( struct V_50 * V_256 , int V_229 , T_9 V_257 )
{
V_256 -> V_98 = V_258 ;
V_256 -> V_92 = V_257 ;
V_256 -> V_90 = 0 ;
...
static void F_84 ( struct V_227 * V_261 , const char * V_231 , int type ,
unsigned int V_229 , void * V_239 )
{
V_261 -> V_231 = V_231 ;
V_261 -> type = type ;
V_261 -> V_232 = V_229 ;
...
static void F_102 ( struct V_227 * V_261 , struct V_291 * V_5 )
{
...
static void F_103 ( struct V_227 * V_261 , T_11 * V_307 ,
const T_12 * V_308 )
{
T_7 V_309 = F_73 () ;
F_75 ( V_310 ) ;
...
static int F_105 ( struct V_227 * V_261 )
{
struct V_37 * V_38 ;
...
struct V_346 * V_347 ,
const T_12 * V_308 , struct V_155 * V_156 )
{
...
do {
int V_95 ;
if ( ! F_79 ( & V_333 -> V_339 [ 0 ] , V_235 ) )
return 0 ;
if ( V_360 && ! F_79 ( & V_347 -> V_290 , V_235 ) )
return 0 ;
if ( V_360 && ! F_79 ( & V_347 -> V_358 , V_235 ) )
return 0 ;
if ( V_360 && ! F_79 ( & V_347 -> V_304 , V_235 ) )
return 0 ;
if ( V_360 && V_347 -> V_359 . V_239 &&
! F_79 ( & V_347 -> V_359 , V_235 ) )
return 0 ;
for ( V_95 = 1 ; V_95 < V_347 -> V_353 ; ++ V_95 )
if ( V_333 -> V_339 [ V_95 ] . V_239 &&
! F_79 ( & V_333 -> V_339 [ V_95 ] , V_235 ) )
return 0 ;
V_360 = 0 ;
V_333 = V_333 -> V_356 ;
} while ( V_333 );
...
F_131 ( & V_347 -> V_368 ) ;
V_347 -> V_339 = F_34 ( 8 * sizeof( struct V_227 ) , V_116 ) ;
if ( ! V_347 -> V_339 )
return 0 ;
...
V_347 -> V_263 -> V_364 = F_127 ( V_4 , V_156 ,
V_347 -> V_365 ) ;
...
V_241 ++ ;
V_241 ++ ;
V_52 = V_241 > V_396 ? V_396 : V_241 ;
if ( ! F_117 ( V_240 , V_52 , & V_347 , V_235 -> V_308 , V_235 -> V_156 ) )
goto V_397;
V_393 = 1 ;
V_213 = F_73 () ;
F_75 ( V_310 ) ;
...
{
T_2 V_229 = F_122 ( & V_347 ) ;
V_229 += F_144 () ;
V_395 = F_34 ( sizeof( * V_395 ) , V_116 ) ;
if ( ! V_395 )
goto V_398;
F_83 ( V_395 , V_229 , V_257 ) ;
V_257 += V_229 ;
}
V_394 = V_257 = F_78 ( V_257 , V_44 ) ;
V_257 += F_141 ( V_379 , V_235 -> V_191 ) ;
V_257 += F_145 () ;
V_383 = V_257 ;
if ( V_52 == V_396 ) {
...
V_257 = V_394 ;
if ( ! F_80 ( V_235 , V_240 , sizeof( * V_240 ) ) )
goto V_398;
if ( ! F_80 ( V_235 , V_395 , sizeof( * V_395 ) ) )
goto V_398;
for ( V_38 = F_138 ( V_4 , V_379 ) ; V_38 != NULL ;
V_38 = F_139 ( V_38 , V_379 ) ) {
struct V_50 V_256 ;
V_256 . V_98 = V_99 ;
V_256 . V_92 = V_257 ;
V_256 . V_90 = V_38 -> V_211 ;
V_256 . V_259 = 0 ;
V_256 . V_89 = F_70 ( V_38 , V_235 -> V_191 ) ;
V_256 . V_100 = V_38 -> V_226 - V_38 -> V_211 ;
V_257 += V_256 . V_89 ;
V_256 . V_125 = V_38 -> V_193 & V_209 ? V_126 : 0 ;
if ( V_38 -> V_193 & V_399 )
V_256 . V_125 |= V_128 ;
if ( V_38 -> V_193 & V_400 )
V_256 . V_125 |= V_130 ;
V_256 . V_260 = V_44 ;
if ( ! F_80 ( V_235 , & V_256 , sizeof( V_256 ) ) )
goto V_398;
}
if ( ! F_146 ( V_235 , V_257 ) )
goto V_398;
if ( ! F_123 ( & V_347 , V_235 ) )
goto V_398;
if ( F_147 ( V_235 ) )
goto V_398;
if ( ! F_148 ( V_235 , V_394 - V_235 -> V_401 ) )
goto V_398;
for ( V_38 = F_138 ( V_4 , V_379 ) ; V_38 != NULL ;
V_38 = F_139 ( V_38 , V_379 ) ) {
unsigned long V_3 ;
unsigned long V_2 ;
V_2 = V_38 -> V_211 + F_70 ( V_38 , V_235 -> V_191 ) ;
for ( V_3 = V_38 -> V_211 ; V_3 < V_2 ; V_3 += V_187 ) {
struct V_402 * V_402 ;
int V_403 ;
V_402 = F_149 ( V_3 ) ;
if ( V_402 ) {
void * V_404 = F_150 ( V_402 ) ;
V_403 = ! F_80 ( V_235 , V_404 , V_187 ) ;
F_151 ( V_402 ) ;
F_152 ( V_402 ) ;
} else
V_403 = ! F_148 ( V_235 , V_187 ) ;
if ( V_403 )
goto V_398;
}
}
...
goto V_398;
if ( V_52 == V_396 ) {
if ( ! F_80 ( V_235 , V_382 , sizeof( * V_382 ) ) )
goto V_398;
}
V_398:
F_75 ( V_213 ) ;
