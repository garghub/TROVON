...
if ( V_65 )
goto V_158;
F_86 ( V_151 , V_151 -> V_159 ,
V_157 ,
0 ,
NULL ,
F_87 ( V_160 , V_161 ) ) ;
V_151 -> V_159 -> V_162 = V_139 ;
V_65 = F_88 ( V_151 -> V_159 ) ;
if ( V_65 ) {
F_10 ( L_19 , V_22 ) ;
goto V_163;
}
F_77 ( V_151 -> V_159 -> V_127 ) ;
V_2 . V_98 = V_99 ;
if ( F_68 () ) {
V_65 = - V_130 ;
goto V_164;
}
V_65 = F_89 ( & V_151 -> V_165 , V_166 , V_167 , V_168 ,
0 , & V_2 . V_9 ) ;
if ( V_65 < 0 )
goto V_169;
strcpy ( V_2 . V_9 -> V_170 , L_20 ) ;
strcpy ( V_2 . V_9 -> V_171 , L_20 ) ;
strcpy ( V_2 . V_9 -> V_172 , L_21 ) ;
for ( V_66 = 0 ; V_66 < F_90 ( V_173 ) ; V_66 ++ ) {
V_65 = F_91 ( V_2 . V_9 ,
F_92 ( & V_173 [ V_66 ] , & V_2 ) ) ;
if ( V_65 < 0 )
goto V_174;
...
goto V_174;
V_2 . V_94 -> V_175 = & V_2 ;
strcpy ( V_2 . V_94 -> V_176 , L_22 ) ;
F_94 ( V_2 . V_94 , V_177 ,
& V_178 ) ;
V_2 . V_94 -> V_179 = V_180 ;
V_65 = F_95 ( V_2 . V_94 ,
V_181 ,
& V_151 -> V_165 ,
V_182 ,
...
goto V_187;
F_10 ( L_26 ,
V_2 . V_9 -> V_172 , V_2 . V_98 ) ;
return 0 ;
V_187:
F_98 ( & V_2 . V_125 -> V_165 ,
V_161 ,
V_2 . V_183 ,
V_2 . V_53 ) ;
V_186:
...
static int F_103 ( struct V_150 * V_151 )
{
int V_65 ;
F_10 ( L_27 , V_22 , V_151 -> V_154 ) ;
