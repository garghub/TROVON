...
static int
F_71 ( struct V_291 * V_322 , int V_6 , int V_228 )
{
if ( ( V_228 != 1 ) && ( V_228 != V_323 ) )
return - V_210 ;
if ( V_6 > V_322 -> V_61 - 1 )
return - V_210 ;
return 0 ;
...
static int
F_72 ( char * V_229 , int V_7 , struct V_291 * V_324 ,
T_1 V_6 )
{
int V_225 , V_325 ;
T_1 * V_326 ;
...
return 0 ;
V_325 = V_324 -> V_302 ;
V_7 += snprintf ( V_229 + V_7 , V_327 - V_7 ,
L_96 , V_6 ) ;
V_225 = 0 ;
V_326 = V_324 -> V_328 [ V_6 ] . V_329 ;
while ( V_325 > 0 ) {
V_7 += snprintf ( V_229 + V_7 , V_327 - V_7 ,
L_56 , * V_326 ) ;
V_326 ++ ;
V_225 += sizeof( T_1 ) ;
V_325 -= sizeof( T_1 ) ;
if ( V_325 > 0 && ! ( V_225 % ( 4 * sizeof( T_1 ) ) ) )
V_7 += snprintf ( V_229 + V_7 ,
V_327 - V_7 , L_41 ) ;
}
V_7 += snprintf ( V_229 + V_7 , V_327 - V_7 , L_41 ) ;
return V_7 ;
}
static T_2
...
struct V_151 * V_152 = V_149 -> V_157 ;
T_1 V_330 , V_6 , V_228 ;
struct V_291 * V_324 = NULL ;
char * V_229 ;
int V_7 = 0 ;
V_152 -> V_214 = V_236 ;
if ( ! V_152 -> V_12 )
V_152 -> V_12 = F_2 ( V_327 , V_14 ) ;
if ( ! V_152 -> V_12 )
return 0 ;
V_229 = V_152 -> V_12 ;
if ( * V_171 )
return 0 ;
if ( V_216 . V_217 . V_211 == V_331 ) {
V_6 = V_216 . V_217 . V_213 [ V_332 ] ;
V_228 = V_216 . V_217 . V_213 [ V_333 ] ;
V_324 = (struct V_291 * ) V_216 . V_334 ;
} else
return 0 ;
if ( V_228 == V_323 )
goto V_335;
V_7 = F_72 ( V_229 , V_7 , V_324 , V_6 ) ;
return F_39 ( V_3 , V_170 , V_171 , V_229 , V_7 ) ;
V_335:
V_330 = V_216 . V_225 . V_246 ;
V_6 = V_330 ;
while ( V_7 < V_336 - V_324 -> V_302 ) {
V_7 = F_72 ( V_229 , V_7 , V_324 , V_6 ) ;
V_6 ++ ;
if ( V_6 > V_324 -> V_61 - 1 )
break;
...
struct V_151 * V_152 = V_149 -> V_157 ;
struct V_26 * V_27 = (struct V_26 * ) V_152 -> V_150 ;
T_1 V_337 , V_338 , V_339 , V_6 , V_228 , V_225 , V_247 ;
T_1 * V_326 ;
struct V_291 * V_324 ;
int V_153 ;
V_152 -> V_214 = V_215 ;
...
V_339 = V_216 . V_217 . V_213 [ V_341 ] ;
V_6 = V_216 . V_217 . V_213 [ V_332 ] ;
V_228 = V_216 . V_217 . V_213 [ V_333 ] ;
V_225 = V_216 . V_217 . V_213 [ V_342 ] ;
V_247 = V_216 . V_217 . V_213 [ V_343 ] ;
...
if ( V_228 != 1 )
goto V_249;
} else if ( V_216 . V_217 . V_211 == V_331 ) {
if ( V_153 != V_345 )
goto V_249;
} else
goto V_249;
...
case V_346 :
if ( V_27 -> V_265 . V_294 ) {
for ( V_337 = 0 ; V_337 < V_27 -> V_295 ;
V_337 ++ ) {
if ( V_27 -> V_265 . V_294 [ V_337 ] &&
V_27 -> V_265 . V_294 [ V_337 ] -> V_301 ==
V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_294 [ V_337 ] ,
V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 =
...
case V_348 :
if ( V_27 -> V_265 . V_311 &&
V_27 -> V_265 . V_311 -> V_301 == V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_311 , V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 = V_27 -> V_265 . V_311 ;
goto V_347;
}
if ( V_27 -> V_265 . V_313 &&
V_27 -> V_265 . V_313 -> V_301 == V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_313 , V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 = V_27 -> V_265 . V_313 ;
goto V_347;
}
if ( V_27 -> V_265 . V_307 ) {
V_337 = 0 ;
do {
if ( V_27 -> V_265 . V_307 [ V_337 ] &&
V_27 -> V_265 . V_307 [ V_337 ] -> V_301 ==
V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_307 [ V_337 ] ,
V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 =
...
} while ( ++ V_337 < V_27 -> V_295 );
}
goto V_249;
break;
case V_349 :
if ( V_27 -> V_265 . V_312 &&
V_27 -> V_265 . V_312 -> V_301 == V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_312 , V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 = V_27 -> V_265 . V_312 ;
goto V_347;
}
goto V_249;
break;
case V_350 :
if ( V_27 -> V_265 . V_314 &&
V_27 -> V_265 . V_314 -> V_301 == V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_314 , V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 = V_27 -> V_265 . V_314 ;
goto V_347;
}
if ( V_27 -> V_265 . V_310 ) {
for ( V_337 = 0 ; V_337 < V_27 -> V_295 ;
V_337 ++ ) {
if ( ! V_27 -> V_265 . V_310 [ V_337 ] )
continue;
if ( V_27 -> V_265 . V_310 [ V_337 ] -> V_301 ==
V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_310 [ V_337 ] ,
V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 =
...
case V_351 :
if ( V_27 -> V_265 . V_315 &&
V_27 -> V_265 . V_315 -> V_301 == V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_315 , V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 = V_27 -> V_265 . V_315 ;
goto V_347;
}
if ( V_27 -> V_265 . V_316 &&
V_27 -> V_265 . V_316 -> V_301 == V_339 ) {
V_153 = F_71 (
V_27 -> V_265 . V_316 , V_6 , V_228 ) ;
if ( V_153 )
goto V_249;
V_216 . V_334 = V_27 -> V_265 . V_316 ;
goto V_347;
}
goto V_249;
break;
...
V_216 . V_217 . V_211 == V_223 ) {
V_324 = (struct V_291 * ) V_216 . V_334 ;
if ( V_225 > V_324 -> V_302 / sizeof( T_1 ) - 1 )
goto V_249;
V_326 = V_324 -> V_328 [ V_6 ] . V_329 ;
V_326 += V_225 ;
if ( V_216 . V_217 . V_211 == V_221 )
...
switch ( V_352 ) {
case V_353 :
V_7 += snprintf ( V_229 + V_7 , V_354 - V_7 ,
L_97 ,
F_17 ( V_27 -> V_265 . V_355 ) ) ;
break;
case V_356 :
V_7 += snprintf ( V_229 + V_7 , V_354 - V_7 ,
L_98 ,
F_17 ( V_27 -> V_265 . V_357 ) ) ;
break;
case V_358 :
V_7 += snprintf ( V_229 + V_7 , V_354 - V_7 ,
L_99 ,
F_17 ( V_27 -> V_265 . V_359 ) ) ;
break;
case V_360 :
V_7 += snprintf ( V_229 + V_7 , V_354 - V_7 ,
L_100 ,
F_17 ( V_27 -> V_265 . V_361 ) ) ;
break;
default:
break;
}
...
V_152 -> V_214 = V_236 ;
if ( ! V_152 -> V_12 )
V_152 -> V_12 = F_2 ( V_354 , V_14 ) ;
if ( ! V_152 -> V_12 )
return 0 ;
V_229 = V_152 -> V_12 ;
if ( * V_171 )
return 0 ;
if ( V_216 . V_217 . V_211 == V_363 )
V_362 = V_216 . V_217 . V_213 [ V_364 ] ;
else
return 0 ;
if ( V_362 == V_365 )
for ( V_5 = 1 ; V_5 <= V_366 ; V_5 ++ )
V_7 = F_75 ( V_27 ,
V_229 , V_7 , V_5 ) ;
else
V_7 = F_75 ( V_27 ,
...
return V_153 ;
V_362 = V_216 . V_217 . V_213 [ V_364 ] ;
V_247 = V_216 . V_217 . V_213 [ V_369 ] ;
if ( V_216 . V_217 . V_211 == V_370 ||
V_216 . V_217 . V_211 == V_371 ||
V_216 . V_217 . V_211 == V_372 ) {
if ( V_153 != V_373 )
goto V_249;
if ( V_362 > V_366 )
goto V_249;
} else if ( V_216 . V_217 . V_211 == V_363 ) {
if ( V_153 != V_374 )
goto V_249;
if ( ( V_362 > V_366 ) &&
( V_362 != V_365 ) )
...
switch ( V_362 ) {
case V_353 :
V_368 = V_27 -> V_265 . V_355 ;
break;
case V_356 :
V_368 = V_27 -> V_265 . V_357 ;
break;
case V_358 :
V_368 = V_27 -> V_265 . V_359 ;
break;
case V_360 :
V_368 = V_27 -> V_265 . V_361 ;
break;
default:
goto V_249;
}
...
switch ( V_375 ) {
case V_376 :
V_7 += snprintf ( V_229 + V_7 , V_377 - V_7 ,
L_101 ,
...
V_152 -> V_214 = V_236 ;
if ( ! V_152 -> V_12 )
V_152 -> V_12 = F_2 ( V_377 , V_14 ) ;
if ( ! V_152 -> V_12 )
return 0 ;
V_229 = V_152 -> V_12 ;
if ( * V_171 )
return 0 ;
if ( V_216 . V_217 . V_211 == V_390 )
V_389 = V_216 . V_217 . V_213 [ V_391 ] ;
else
return 0 ;
if ( V_389 == V_392 )
for ( V_5 = 1 ; V_5 <= V_393 ; V_5 ++ )
V_7 = F_78 ( V_27 ,
V_229 , V_7 , V_5 ) ;
else
V_7 = F_78 ( V_27 ,
...
return V_153 ;
V_389 = V_216 . V_217 . V_213 [ V_391 ] ;
V_247 = V_216 . V_217 . V_213 [ V_395 ] ;
if ( V_216 . V_217 . V_211 == V_396 ||
V_216 . V_217 . V_211 == V_397 ||
V_216 . V_217 . V_211 == V_398 ) {
if ( V_153 != V_399 )
goto V_249;
if ( V_389 > V_393 )
goto V_249;
} else if ( V_216 . V_217 . V_211 == V_390 ) {
if ( V_153 != V_400 )
goto V_249;
if ( ( V_389 > V_393 ) &&
( V_389 != V_392 ) )
...
{
T_1 V_401 , V_402 , V_403 , V_404 ;
int V_7 = 0 ;
V_404 = V_216 . V_217 . V_213 [ V_405 ] ;
V_401 = V_216 . V_217 . V_213 [ V_406 ] ;
V_402 = V_216 . V_217 . V_213 [ V_407 ] ;
V_403 = V_216 . V_217 . V_213 [ V_408 ] ;
V_7 += snprintf ( V_229 + V_7 , V_409 - V_7 ,
L_107 , V_401 ) ;
V_7 += snprintf ( V_229 + V_7 , V_409 - V_7 ,
L_108 , V_402 ) ;
V_7 += snprintf ( V_229 + V_7 , V_409 - V_7 ,
...
( V_401 != V_413 ) )
goto V_249;
if ( V_403 > sizeof( V_92 ) )
goto V_249;
} else if ( V_216 . V_217 . V_211 == V_411 ) {
if ( ! ( V_401 & V_414 ) )
goto V_249;
if ( ( V_401 & ~ V_414 ) &&
( V_401 != V_413 ) )
...
{
T_6 V_418 , V_419 ;
V_7 += snprintf ( V_229 + V_7 , V_420 - V_7 ,
L_111 ) ;
V_7 += snprintf ( V_229 + V_7 , V_420 - V_7 ,
L_112 ) ;
F_85 ( V_27 , V_421 ,
...
if ( V_153 < 0 )
return V_153 ;
V_430 = V_216 . V_217 . V_213 [ V_431 ] ;
if ( V_216 . V_217 . V_211 != V_432 )
goto V_249;
if ( V_153 != V_433 )
goto V_249;
if ( ! ( V_430 & V_434 ) )
...
void
F_91 ( struct V_26 * V_27 , enum V_438 V_439 ,
enum V_440 V_441 , enum V_442 V_443 ,
enum V_444 V_445 ,
struct V_45 * V_446 , T_1 V_447 )
{
#ifdef F_21
T_1 * V_404 , * V_401 , * V_402 , * V_403 ;
char V_448 [ V_449 ] ;
int V_7 = 0 ;
T_1 V_450 = 0 ;
T_1 * V_451 ;
T_1 V_5 ;
if ( V_216 . V_217 . V_211 != V_411 )
return;
V_404 = & V_216 . V_217 . V_213 [ V_405 ] ;
V_401 = & V_216 . V_217 . V_213 [ V_406 ] ;
V_402 = & V_216 . V_217 . V_213 [ V_407 ] ;
...
if ( V_450 ) {
V_451 = ( T_1 * ) V_446 -> V_74 ;
for ( V_5 = 0 ; V_5 < * V_403 ; V_5 ++ ) {
if ( ! ( V_5 % 8 ) ) {
if ( V_5 != 0 )
F_31 ( V_162 L_136 , V_448 ) ;
V_7 = 0 ;
V_7 += snprintf ( V_448 + V_7 ,
V_449 - V_7 ,
L_137 , V_5 ) ;
}
V_7 += snprintf ( V_448 + V_7 , V_449 - V_7 ,
L_56 , ( T_1 ) * V_451 ) ;
V_451 ++ ;
}
if ( ( V_5 - 1 ) % 8 )
...
void
F_92 ( struct V_26 * V_27 , V_92 * V_460 )
{
#ifdef F_21
T_1 * V_401 , * V_402 , * V_403 , * V_404 ;
char V_448 [ V_449 ] ;
...
if ( ! V_21 )
V_21 = V_147 ;
snprintf ( V_115 , sizeof( V_115 ) , L_144 , V_27 -> V_425 ) ;
if ( ! V_27 -> V_471 ) {
V_467 = true ;
V_27 -> V_471 =
F_94 ( V_115 , V_468 ) ;
...
snprintf ( V_115 , sizeof( V_115 ) , L_183 , V_2 -> V_491 ) ;
if ( ! V_2 -> V_492 ) {
V_2 -> V_492 =
F_94 ( V_115 , V_27 -> V_471 ) ;
if ( ! V_2 -> V_492 ) {
F_96 ( V_2 , V_162 , V_198 ,
L_184 ) ;
goto V_470;
...
if ( ! V_27 -> V_502 ) {
V_27 -> V_502 =
F_98 ( V_115 , V_474 | V_475 ,
V_27 -> V_497 , V_27 , & V_503 ) ;
if ( ! V_27 -> V_502 ) {
F_96 ( V_2 , V_162 , V_198 ,
L_200 ) ;
goto V_470;
...
F_104 ( V_27 ) ;
F_105 ( V_27 ) ;
for ( V_515 = 0 ; V_515 < V_27 -> V_295 ; V_515 ++ )
F_106 ( V_27 , V_515 ) ;
F_107 ( V_27 ) ;
F_108 ( V_27 ) ;
F_109 ( V_27 ) ;
