...
V_210 -> V_270 . V_123 &= ~ V_273 ;
V_210 -> V_270 . V_123 |=
V_209 -> V_270 . V_123 & V_273 ;
F_155 ( V_209 , V_265 ) ;
if ( V_262 -> V_67 == V_68 )
F_131 ( V_210 , 0 , V_263 ) ;
F_155 ( V_210 , V_265 ) ;
...
{
unsigned int V_275 ;
struct V_208 * V_276 , * V_277 ;
struct V_54 * V_25 = V_106 ;
struct V_9 * V_262 ;
unsigned long V_263 = 0 ;
F_144 ( & V_25 -> V_196 ) ;
V_262 = F_145 ( V_25 -> V_76 ) ;
V_276 = F_146 ( V_262 -> V_24 . V_75 ) ;
V_277 = F_147 ( V_262 -> V_24 . V_75 ) ;
V_275 = F_161 ( V_25 -> V_30 ) ;
if ( V_275 ) {
switch ( V_275 & 0x1f ) {
case 0x1 :
V_25 -> V_278 = V_279 ;
...
struct V_289 * V_290 ;
int V_60 ;
if ( ! V_286 -> V_245 . V_291 )
return - V_292 ;
V_25 = F_165 ( & V_286 -> V_245 , sizeof( struct V_54 ) , V_61 ) ;
if ( ! V_25 )
return - V_62 ;
V_25 -> V_26 = F_166 ( V_286 ) ;
F_167 ( & V_25 -> V_63 ) ;
F_168 ( & V_25 -> V_196 ) ;
V_25 -> V_245 = & V_286 -> V_245 ;
V_288 = F_169 ( V_286 , V_293 , 0 ) ;
V_25 -> V_30 = F_170 ( & V_286 -> V_245 , V_288 ) ;
if ( F_37 ( V_25 -> V_30 ) )
return F_38 ( V_25 -> V_30 ) ;
V_25 -> V_260 = V_60 = F_171 ( V_286 , 0 ) ;
if ( V_60 < 0 ) {
F_172 ( & V_286 -> V_245 , L_6 ) ;
return V_60 ;
}
V_60 = F_173 ( & V_286 -> V_245 , V_25 -> V_260 , V_25 -> V_26 -> V_294 ,
0 , F_174 ( & V_286 -> V_245 ) , V_25 ) ;
if ( V_60 ) {
F_172 ( & V_286 -> V_245 , L_7 , V_25 -> V_260 ) ;
return V_60 ;
}
V_25 -> V_295 = F_175 ( & V_286 -> V_245 , L_8 ) ;
if ( F_37 ( V_25 -> V_295 ) ) {
F_172 ( & V_286 -> V_245 , L_9 ) ;
V_60 = F_38 ( V_25 -> V_295 ) ;
return V_60 ;
}
F_176 ( & V_286 -> V_245 , L_10 , V_25 -> V_295 ) ;
V_60 = F_177 ( & V_286 -> V_245 , & V_25 -> V_174 ) ;
if ( V_60 ) {
F_172 ( & V_286 -> V_245 , L_11 ) ;
goto V_296;
}
...
V_290 = & V_298 ;
V_25 -> V_76 = F_178 ( V_290 ) ;
if ( F_37 ( V_25 -> V_76 ) ) {
F_65 ( & V_25 -> V_174 , L_12 ) ;
V_60 = F_38 ( V_25 -> V_76 ) ;
goto V_299;
}
V_25 -> V_241 = F_179 ( & V_286 -> V_245 ) ;
if ( F_37 ( V_25 -> V_241 ) ) {
...
snprintf ( V_25 -> V_313 -> V_126 , sizeof( V_25 -> V_313 -> V_126 ) ,
L_18 , V_110 ) ;
V_25 -> V_313 -> V_302 = & V_303 ;
V_25 -> V_313 -> V_304 = & V_305 ;
V_25 -> V_313 -> V_306 = - 1 ;
V_25 -> V_313 -> V_307 = V_308 ;
V_25 -> V_313 -> V_63 = & V_25 -> V_63 ;
V_25 -> V_313 -> V_174 = & V_25 -> V_174 ;
V_25 -> V_313 -> V_309 = V_310 ;
V_60 = F_181 ( V_25 -> V_313 , V_311 , - 1 ) ;
if ( V_60 ) {
F_65 ( & V_25 -> V_174 , L_16 ) ;
goto V_315;
}
F_182 ( V_25 -> V_313 , V_25 ) ;
F_183 ( & V_25 -> V_174 ,
L_19 ,
V_25 -> V_313 -> V_122 ) ;
F_184 ( V_286 , V_25 ) ;
...
static int F_191 ( struct V_285 * V_286 )
{
struct V_54 * V_25 = F_192 ( V_286 ) ;
F_193 ( V_25 -> V_245 ) ;
F_186 ( V_25 -> V_313 ) ;
V_308 ( V_25 -> V_313 ) ;
F_186 ( V_25 -> V_66 ) ;
...
F_188 ( V_25 -> V_76 ) ;
F_189 ( & V_25 -> V_174 ) ;
if ( ! F_194 ( & V_286 -> V_245 ) )
F_195 ( V_25 -> V_295 ) ;
F_190 ( V_25 -> V_295 ) ;
return 0 ;
}
static int F_196 ( struct V_316 * V_245 )
{
struct V_54 * V_25 = F_197 ( V_245 ) ;
F_195 ( V_25 -> V_295 ) ;
return 0 ;
}
static int F_198 ( struct V_316 * V_245 )
{
struct V_54 * V_25 = F_197 ( V_245 ) ;
unsigned long V_123 ;
int V_60 ;
V_60 = F_199 ( V_25 -> V_295 ) ;
if ( V_60 < 0 )
return V_60 ;
F_76 ( & V_25 -> V_196 , V_123 ) ;
if ( V_25 -> V_26 -> V_27 == V_28 ) {
...
static int F_200 ( struct V_316 * V_245 )
{
if ( F_201 ( V_245 ) )
return 0 ;
return F_196 ( V_245 ) ;
}
static int F_202 ( struct V_316 * V_245 )
{
if ( F_201 ( V_245 ) )
return 0 ;
return F_198 ( V_245 ) ;
}
static void * F_166 ( struct V_285 * V_286 )
{
struct V_317 * V_318 = NULL ;
const struct V_319 * V_320 ;
V_320 = F_203 ( F_204 ( V_321 ) ,
V_286 -> V_245 . V_291 ) ;
if ( V_320 )
V_318 = (struct V_317 * ) V_320 -> V_85 ;
return V_318 ;
}
