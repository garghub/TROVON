...
if ( ! V_10 )
return - V_26 ;
V_11 = F_14 ( & V_10 -> V_27 -> V_21 ) ;
if ( V_11 < 0 ) {
F_15 ( & V_10 -> V_27 -> V_21 , L_7 ) ;
return V_11 ;
}
return V_22 ;
}
...
F_17 (priv, tmp, listhead, list) {
F_18 ( & V_31 -> V_33 ) ;
return V_31 ;
}
return NULL ;
}
static struct V_28 * F_19 ( struct V_34 * V_35 )
{
unsigned long V_36 ;
struct V_28 * V_31 ;
F_20 ( & V_35 -> V_37 , V_36 ) ;
...
struct V_28 * V_31 ;
struct V_42 * V_42 ;
F_23 ( & V_35 -> V_27 -> V_21 , L_8 , V_35 ) ;
while ( ( V_31 = F_19 ( V_35 ) ) ) {
V_42 = V_31 -> V_42 ;
F_23 ( & V_35 -> V_27 -> V_21 , L_9 , V_42 ) ;
F_24 ( V_42 ) ;
F_25 ( V_43 , V_31 ) ;
F_26 ( V_42 -> V_44 ) ;
F_26 ( V_42 -> V_45 ) ;
