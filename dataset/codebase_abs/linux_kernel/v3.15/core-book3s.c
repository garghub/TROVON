...
F_54 ( V_178 , & V_6 -> V_179 . V_184 ) ;
}
static int F_55 ( int V_185 )
{
...
static void F_59 ( struct V_9 * V_10 , unsigned long V_7 )
{
...
F_57 ( V_10 , V_187 , V_188 ) ;
if ( V_7 & ( V_192 | V_128 ) )
F_33 ( V_127 , V_7 ) ;
}
static void F_60 ( struct V_193 * V_193 )
{
struct V_9 * V_10 ;
...
static void F_63 ( struct V_193 * V_193 )
{
struct V_5 * V_6 ;
struct V_9 * V_10 ;
unsigned long V_14 ;
...
static int F_65 ( struct V_5 * V_210 , int V_211 ,
...
F_67 (event, &group->sibling_list, group_entry) {
if ( ! F_66 ( V_6 ) &&
V_6 -> V_180 != V_213 ) {
if ( V_170 >= V_211 )
return - 1 ;
...
static int F_68 ( struct V_5 * V_6 , int V_214 )
{
struct V_9 * V_10 ;
unsigned long V_14 ;
int V_215 ;
...
static void F_74 ( struct V_5 * V_6 , int V_214 )
{
unsigned long V_14 ;
if ( ! V_6 -> V_179 . V_130 || ! V_6 -> V_179 . V_99 )
return;
...
void F_76 ( struct V_193 * V_193 )
{
struct V_9 * V_10 = & F_24 ( V_9 ) ;
V_10 -> V_218 &= ~ V_219 ;
F_71 ( V_193 ) ;
}
int F_77 ( struct V_193 * V_193 )
{
struct V_9 * V_10 ;
long V_135 , V_170 ;
if ( ! V_13 )
...
static int F_78 ( struct V_5 * V_6 , T_1 V_226 ,
unsigned int V_14 )
{
int V_170 ;
T_1 V_227 [ V_228 ] ;
...
static T_1 F_79 ( T_1 V_226 , unsigned long V_14 )
{
T_1 V_227 [ V_228 ] ;
int V_170 ;
V_14 &= ~ ( V_172 | V_157 ) ;
...
static int F_86 ( T_1 V_87 , T_1 * V_231 )
{
...
case V_241 :
V_226 = V_6 -> V_86 . V_87 ;
if ( V_226 >= V_13 -> V_242 || V_13 -> V_243 [ V_226 ] == 0 )
return - V_237 ;
V_226 = V_13 -> V_243 [ V_226 ] ;
break;
case V_244 :
V_238 = F_86 ( V_6 -> V_86 . V_87 , & V_226 ) ;
if ( V_238 )
return V_238 ;
break;
case V_245 :
...
V_14 |= V_248 ;
if ( V_13 -> V_14 & V_186 ) {
if ( F_78 ( V_6 , V_226 , V_14 ) ) {
V_14 |= V_172 ;
} else if ( V_13 -> V_158 ( V_226 ) ) {
V_226 = F_79 ( V_226 , V_14 ) ;
if ( ! V_226 )
return - V_91 ;
}
}
...
V_170 = 0 ;
if ( V_6 -> V_90 != V_6 ) {
V_170 = F_65 ( V_6 -> V_90 , V_13 -> V_136 - 1 ,
V_164 , V_205 , V_143 ) ;
if ( V_170 < 0 )
return - V_91 ;
}
...
V_6 -> V_179 . V_249 = V_6 -> V_179 . V_99 ;
F_49 ( & V_6 -> V_179 . V_184 , V_6 -> V_179 . V_249 ) ;
if ( F_7 ( V_6 ) )
...
T_5 F_96 ( struct V_253 * V_254 ,
struct V_255 * V_86 , char * V_256 )
{
struct V_257 * V_258 ;
V_258 = F_97 ( V_86 , struct V_257 , V_86 ) ;
return sprintf ( V_256 , L_11 , V_258 -> V_259 ) ;
}
static void F_98 ( struct V_5 * V_6 , unsigned long V_71 ,
struct V_1 * V_2 )
{
T_1 V_260 = V_6 -> V_179 . V_99 ;
...
if ( V_261 ) {
struct V_262 V_263 ;
F_99 ( & V_263 , ~ 0ULL , V_6 -> V_179 . V_249 ) ;
if ( V_6 -> V_86 . V_98 & V_264 )
F_2 ( V_2 , & V_263 . V_65 ) ;
if ( V_6 -> V_86 . V_98 & V_265 ) {
struct V_9 * V_10 ;
V_10 = & F_24 ( V_9 ) ;
F_15 ( V_10 ) ;
V_263 . V_266 = & V_10 -> V_83 ;
}
if ( F_100 ( V_6 , & V_263 , V_2 ) )
F_74 ( V_6 , 0 ) ;
}
}
unsigned long F_101 ( struct V_1 * V_2 )
{
T_2 V_14 = F_3 ( V_2 ) ;
if ( V_14 )
return V_14 ;
return F_102 ( V_2 ) ? V_41 :
V_46 ;
}
...
static bool F_105 ( unsigned long V_71 )
{
if ( ( int ) V_71 < 0 )
return true ;
return false ;
}
static void V_250 ( struct V_1 * V_2 )
{
int V_135 , V_152 ;
struct V_9 * V_10 = & F_24 ( V_9 ) ;
struct V_5 * V_6 ;
...
if ( ! V_268 && F_108 ( V_271 ) ) {
for ( V_135 = 0 ; V_135 < V_10 -> V_202 ; ++ V_135 ) {
V_6 = V_10 -> V_6 [ V_135 ] ;
if ( ! V_6 -> V_179 . V_130 || F_55 ( V_6 -> V_179 . V_130 ) )
continue;
if ( F_104 ( V_71 [ V_6 -> V_179 . V_130 - 1 ] ) ) {
V_268 = 1 ;
F_98 ( V_6 ,
...
if ( ! V_268 && ! V_270 && F_109 () )
F_38 ( V_272 L_12 ) ;
F_59 ( V_10 , V_10 -> V_197 [ 0 ] ) ;
if ( V_270 )
F_110 () ;
else
F_111 () ;
}
static void F_112 ( int V_273 )
{
struct V_9 * V_10 = & F_113 ( V_9 , V_273 ) ;
if ( ! V_13 )
return;
...
static int
F_114 ( struct V_274 * V_275 , unsigned long V_276 , void * V_277 )
{
unsigned int V_273 = ( long ) V_277 ;
switch ( V_276 & ~ V_278 ) {
case V_279 :
F_112 ( V_273 ) ;
break;
...
F_42 ( L_13 ,
V_193 -> V_137 ) ;
V_281 . V_282 = V_13 -> V_282 ;
#ifdef V_42
if ( F_116 () & V_42 )
V_43 = V_44 ;
#endif
F_117 ( & V_281 , L_14 , V_245 ) ;
F_118 ( F_114 ) ;
return 0 ;
}
