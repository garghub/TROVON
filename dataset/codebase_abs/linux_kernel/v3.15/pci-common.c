...
static void F_93 ( struct V_4 * V_17 ,
struct V_146 * V_147 )
{
unsigned long V_44 ;
struct V_40 * V_93 ;
...
V_93 -> V_55 = V_93 -> V_53 + V_148 ;
V_93 -> V_52 = V_49 ;
}
F_94 ( V_147 , V_93 ,
( V_149 T_1 ) ( V_17 -> V_22 - V_25 ) ) ;
F_34 ( L_57 ,
( unsigned long long ) V_93 -> V_53 ,
( unsigned long long ) V_93 -> V_55 ,
...
struct V_5 * F_95 ( struct V_26 * V_27 )
{
struct V_4 * V_17 = V_27 -> V_150 ;
return F_96 ( V_17 -> V_14 ) ;
}
static void F_97 ( struct V_4 * V_17 )
{
F_98 ( V_147 ) ;
struct V_26 * V_27 ;
...
F_34 ( L_63 , F_99 ( V_28 ) ) ;
F_93 ( V_17 , & V_147 ) ;
V_27 = F_100 ( V_17 -> V_30 , V_17 -> V_151 ,
V_17 -> V_152 , V_17 , & V_147 ) ;
if ( V_27 == NULL ) {
F_58 ( L_64 ,
V_17 -> V_10 ) ;
F_101 ( & V_147 ) ;
...
V_27 -> V_153 . V_53 = V_17 -> V_151 ;
V_17 -> V_27 = V_27 ;
V_17 -> V_154 = V_27 -> V_153 . V_55 ;
}
...
static struct V_4 * F_103 ( int V_27 )
{
struct V_4 * V_17 , * V_29 ;
F_19 (hose, tmp, &hose_list, list_node)
if ( V_27 >= V_17 -> V_151 && V_27 <= V_17 -> V_154 )
return V_17 ;
return NULL ;
}
long F_104 ( long V_157 , unsigned long V_27 , unsigned long V_158 )
{
struct V_4 * V_17 ;
long V_159 = - V_160 ;
V_17 = F_103 ( V_27 ) ;
...
static int
F_105 ( struct V_26 * V_27 , unsigned int V_158 , int V_41 ,
int V_167 , T_7 * V_73 )
{
return V_168 ;
}
static int
F_106 ( struct V_26 * V_27 , unsigned int V_158 , int V_41 ,
int V_167 , T_7 V_73 )
{
return V_168 ;
}
static struct V_26 *
F_107 ( struct V_4 * V_17 , int V_169 )
{
...
V_27 . V_78 = V_169 ;
V_27 . V_150 = V_17 ;
V_27 . V_152 = V_17 ? V_17 -> V_152 : & V_170 ;
return & V_27 ;
}
int F_108 ( struct V_4 * V_17 , int V_27 , int V_158 ,
int V_171 )
{
return F_109 ( F_107 ( V_17 , V_27 ) , V_158 , V_171 ) ;
}
