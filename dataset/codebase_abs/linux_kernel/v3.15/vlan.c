...
V_39 = F_35 ( sizeof( struct V_17 ) , V_27 , V_53 ) ;
if ( V_39 == NULL )
return - V_13 ;
F_36 ( V_39 , V_40 ) ;
V_39 -> V_54 = V_19 -> V_54 ;
V_39 -> V_55 |= ( V_19 -> V_55 & V_56 ) ;
V_18 = V_17 ( V_39 ) ;
V_18 -> V_3 = F_34 ( V_47 ) ;
V_18 -> V_4 = V_4 ;
V_18 -> V_19 = V_19 ;
...
V_62 -> V_66 = V_14 -> V_66 + V_67 ;
#if F_45 ( V_68 )
V_62 -> V_69 = V_14 -> V_69 ;
#endif
F_46 ( V_62 ) ;
}
static void F_47 ( struct V_5 * V_14 , unsigned long V_70 )
{
switch ( V_70 ) {
case V_71 :
F_48 ( V_14 ) ;
...
static int F_60 ( struct V_40 * V_40 , void T_3 * V_100 )
{
int V_32 ;
struct V_101 args ;
struct V_5 * V_14 = NULL ;
if ( F_61 ( & args , V_100 , sizeof( struct V_101 ) ) )
return - V_102 ;
args . V_103 [ 23 ] = 0 ;
...
case V_113 :
V_32 = - V_114 ;
V_14 = F_63 ( V_40 , args . V_103 ) ;
if ( ! V_14 )
goto V_83;
V_32 = - V_115 ;
if ( args . V_106 != V_110 && ! V_37 ( V_14 ) )
goto V_83;
}
switch ( args . V_106 ) {
case V_107 :
V_32 = - V_116 ;
if ( ! F_64 ( V_40 -> V_117 , V_118 ) )
break;
F_65 ( V_14 ,
args . V_104 . V_119 ,
args . V_120 ) ;
...
if ( ! F_64 ( V_40 -> V_117 , V_118 ) )
break;
if ( ( args . V_104 . V_48 >= 0 ) &&
( args . V_104 . V_48 < V_123 ) ) {
struct V_41 * V_42 ;
V_42 = F_33 ( V_40 , V_43 ) ;
V_42 -> V_48 = args . V_104 . V_48 ;
V_32 = 0 ;
} else {
V_32 = - V_115 ;
}
...
if ( ! F_64 ( V_40 -> V_117 , V_118 ) )
break;
V_32 = F_31 ( V_14 , args . V_104 . V_124 ) ;
break;
case V_111 :
V_32 = - V_116 ;
if ( ! F_64 ( V_40 -> V_117 , V_118 ) )
