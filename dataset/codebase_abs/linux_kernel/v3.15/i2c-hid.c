...
V_123 = F_12 ( V_42 -> V_125 ) ;
if ( V_123 < 4 || V_123 > sizeof( struct V_103 ) ) {
F_13 ( & V_2 -> V_45 , L_29 ,
V_123 ) ;
return - V_124 ;
}
...
T_6 V_138 ;
int V_14 ;
V_14 = F_63 ( V_45 -> V_139 , L_35 , & V_138 ) ;
if ( V_14 ) {
F_13 ( & V_2 -> V_45 , L_36 ) ;
return - V_124 ;
}
...
V_68 -> V_149 = V_150 ;
V_68 -> V_151 = F_12 ( V_11 -> V_42 . V_126 ) ;
V_68 -> V_152 = F_12 ( V_11 -> V_42 . V_153 ) ;
V_68 -> V_154 = F_12 ( V_11 -> V_42 . V_155 ) ;
snprintf ( V_68 -> V_122 , sizeof( V_68 -> V_122 ) , L_40 ,
