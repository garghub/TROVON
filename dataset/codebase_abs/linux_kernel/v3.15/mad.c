...
V_208 [ 0 ] . V_188 ,
V_211 ) ;
if ( F_84 ( F_85 ( V_104 -> V_3 , V_208 [ 0 ] . V_210 ) ) )
return - V_63 ;
...
V_208 [ 1 ] . V_188 ,
V_211 ) ;
if ( F_84 ( F_85 ( V_104 -> V_3 , V_208 [ 1 ] . V_210 ) ) ) {
F_86 ( V_104 -> V_3 ,
V_134 -> V_212 ,
V_208 [ 0 ] . V_188 , V_211 ) ;
return - V_63 ;
...
V_40 = F_87 ( V_104 -> V_60 , & V_134 -> V_144 ,
& V_206 ) ;
...
struct V_34 * F_93 ( struct V_117 * V_60 ,
T_1 V_35 ,
T_2 V_36 ,
T_3 V_37 ,
void * V_38 )
...
{
int V_23 ;
F_95 (i, mad_reg_req->method_mask, IB_MGMT_MAX_METHODS) {
if ( ( * V_22 ) -> V_64 [ V_23 ] ) {
...
V_18 = V_48 -> V_18 [ V_8 ] ;
if ( V_18 ) {
V_243 = F_100 ( V_18 , V_239 -> V_44 -> V_16 ) ;
if ( V_243 < 0 )
goto V_99;
...
static int F_104 ( struct V_26 * V_27 , T_8 V_248 )
{
int V_249 = 0 ;
...
static inline int F_107 ( struct V_133 * V_147 ,
struct V_115 * V_252 )
{
return ( (struct V_26 * ) ( V_147 -> V_112 . V_27 ) ) -> V_28 . V_8 ==
V_252 -> V_234 . V_27 -> V_28 . V_8 ;
}
static inline int F_108 ( struct V_42 * V_43 ,
struct V_133 * V_147 ,
struct V_115 * V_252 )
{
struct V_253 V_254 ;
...
if ( V_255 == V_256 )
return 0 ;
if ( F_109 ( V_147 -> V_112 . V_220 , & V_254 ) )
return 0 ;
...
static inline int F_112 ( T_1 V_46 )
{
return ( V_46 == V_9 ) ;
}
struct V_133 *
...
F_107 ( V_147 , V_122 ) &&
( F_112 ( V_122 -> V_234 . V_27 -> V_28 . V_8 ) ||
F_108 ( V_43 , V_147 , V_122 ) ) )
return ( V_147 -> V_123 == V_124 ) ? V_147 : NULL ;
}
F_2 (wr, &mad_agent_priv->send_list, agent_list) {
if ( F_105 ( V_43 , V_147 -> V_112 . V_27 ) &&
...
static void F_116 ( struct V_42 * V_43 ,
struct V_115 * V_116 )
{
struct V_133 * V_134 ;
struct V_113 V_114 ;
unsigned long V_6 ;
F_22 ( & V_116 -> V_74 ) ;
F_117 ( & V_116 -> V_234 . V_109 , & V_116 -> V_74 ) ;
if ( V_43 -> V_64 . V_35 ) {
V_116 = F_118 ( V_43 ,
V_116 ) ;
if ( ! V_116 ) {
...
static bool F_120 ( struct V_139 * V_271 ,
struct V_139 * V_272 )
{
...
static void F_122 ( struct V_1 * V_39 ,
struct V_121 * V_122 )
{
struct V_91 * V_59 ;
struct V_230 * V_231 ;
...
if ( ! F_104 ( & V_271 -> V_27 . V_27 , V_59 -> V_60 -> V_248 ) )
goto V_99;
...
V_9 ) {
enum V_281 V_282 ;
if ( F_124 ( & V_271 -> V_27 . V_136 ,
V_39 -> V_3 -> V_145 ,
V_4 ,
V_39 -> V_3 -> V_283 ) ==
V_152 )
goto V_99;
V_282 = F_125 ( & V_271 -> V_27 . V_136 ) ;
if ( V_282 == V_284 )
goto V_138;
if ( V_282 == V_285 ) {
...
V_272 -> V_236 . V_235 . V_234 . V_27 = & V_272 -> V_27 . V_27 ;
V_272 -> V_236 . V_235 . V_234 . V_265 = & V_272 -> V_265 ;
F_126 ( & V_272 -> V_27 . V_27 ,
& V_272 -> V_265 , V_122 ,
V_39 -> V_3 ,
F_127 ( & V_271 -> V_27 . V_136 ) ,
V_59 -> V_60 -> V_248 ) ;
goto V_99;
}
}
...
if ( V_104 ) {
F_116 ( V_104 , & V_271 -> V_236 . V_235 ) ;
V_271 = NULL ;
} else if ( ( V_40 & V_155 ) &&
F_120 ( V_271 , V_272 ) ) {
F_126 ( & V_272 -> V_27 . V_27 , & V_271 -> V_265 , V_122 ,
...
if ( ( long ) V_286 <= 0 )
V_286 = 1 ;
F_133 ( V_43 -> V_59 -> V_39 -> V_103 ,
& V_43 -> V_75 , V_286 ) ;
}
}
}
static void F_134 ( struct V_133 * V_134 )
{
struct V_42 * V_43 ;
struct V_133 * V_288 ;
struct V_205 * V_289 ;
...
V_134 -> V_222 += V_287 ;
if ( V_286 ) {
F_135 (list_item, &mad_agent_priv->wait_list) {
V_288 = F_131 ( V_289 ,
struct V_133 ,
V_87 ) ;
if ( F_132 ( V_134 -> V_222 ,
V_288 -> V_222 ) )
break;
}
}
...
V_289 = & V_43 -> V_72 ;
F_117 ( & V_134 -> V_87 , V_289 ) ;
if ( V_43 -> V_72 . V_180 == & V_134 -> V_87 )
F_133 ( V_43 -> V_59 -> V_39 -> V_103 ,
& V_43 -> V_75 , V_286 ) ;
}
void F_136 ( struct V_133 * V_134 ,
int V_218 )
{
V_134 -> V_222 = F_89 ( V_218 ) ;
F_134 ( V_134 ) ;
}
void F_119 ( struct V_133 * V_134 ,
struct V_113 * V_114 )
{
struct V_42 * V_43 ;
unsigned long V_6 ;
...
F_119 ( V_134 , & V_114 ) ;
if ( V_293 ) {
V_40 = F_87 ( V_59 -> V_60 , & V_293 -> V_144 ,
& V_206 ) ;
if ( V_40 ) {
...
static void F_140 ( struct V_91 * V_59 )
{
struct V_133 * V_134 ;
struct V_105 * V_106 ;
unsigned long V_6 ;
...
static void F_141 ( struct V_1 * V_39 ,
struct V_121 * V_122 )
{
struct V_105 * V_106 ;
struct V_91 * V_59 ;
...
struct V_143 * V_206 ;
V_134 -> V_294 = 0 ;
V_40 = F_87 ( V_59 -> V_60 , & V_134 -> V_144 ,
& V_206 ) ;
if ( V_40 )
F_139 ( V_39 , V_122 ) ;
} else
...
F_144 ( V_39 -> V_307 , V_308 ) ;
while ( F_145 ( V_39 -> V_307 , 1 , & V_122 ) == 1 ) {
...
agent_list) {
if ( F_105 ( V_43 , V_134 -> V_112 . V_27 ) &&
& V_134 -> V_112 == V_112 )
return V_134 ;
}
return NULL ;
}
int F_147 ( struct V_34 * V_104 ,
...
F_4 ( & V_43 -> V_70 , V_6 ) ;
while ( ! F_130 ( & V_43 -> V_77 ) ) {
V_138 = F_131 ( V_43 -> V_77 . V_180 ,
struct V_137 ,
V_158 ) ;
F_46 ( & V_138 -> V_158 ) ;
F_5 ( & V_43 -> V_70 , V_6 ) ;
...
F_117 ( & V_138 -> V_140 -> V_236 . V_235 . V_234 . V_109 ,
...
static int F_149 ( struct V_133 * V_134 )
{
int V_40 ;
if ( ! V_134 -> V_225 )
return - V_314 ;
V_134 -> V_225 -- ;
V_134 -> V_112 . V_224 ++ ;
V_134 -> V_222 = F_89 ( V_134 -> V_112 . V_218 ) ;
...
V_114 . V_270 = 0 ;
F_4 ( & V_43 -> V_70 , V_6 ) ;
while ( ! F_130 ( & V_43 -> V_72 ) ) {
V_134 = F_131 ( V_43 -> V_72 . V_180 ,
struct V_133 ,
V_87 ) ;
if ( F_132 ( V_134 -> V_222 , V_287 ) ) {
V_286 = V_134 -> V_222 - V_287 ;
if ( ( long ) V_286 <= 0 )
V_286 = 1 ;
F_151 ( V_43 -> V_59 ->
...
static void F_152 ( struct V_317 * V_307 , void * V_318 )
{
...
static int F_128 ( struct V_91 * V_59 ,
struct V_139 * V_27 )
{
unsigned long V_6 ;
int V_321 , V_40 ;
...
F_5 ( & V_296 -> V_70 , V_6 ) ;
V_40 = F_153 ( V_59 -> V_60 , & V_323 , & V_324 ) ;
if ( V_40 ) {
F_4 ( & V_296 -> V_70 , V_6 ) ;
...
static void F_154 ( struct V_91 * V_59 )
{
struct V_230 * V_231 ;
struct V_139 * V_271 ;
struct V_105 * V_106 ;
if ( ! V_59 -> V_60 )
return;
while ( ! F_130 ( & V_59 -> V_296 . V_109 ) ) {
V_106 = F_131 ( V_59 -> V_296 . V_109 . V_180 ,
struct V_105 , V_109 ) ;
V_231 = F_53 ( V_106 ,
struct V_230 ,
V_106 ) ;
...
static int F_155 ( struct V_1 * V_39 )
{
int V_40 , V_23 ;
struct V_298 * V_254 ;
struct V_117 * V_60 ;
...
V_254 -> V_299 = V_300 ;
V_254 -> V_333 = V_334 ;
V_40 = F_142 ( V_60 , V_254 , V_303 | V_335 ) ;
if ( V_40 ) {
F_62 (KERN_ERR PFX L_27
L_30 , i, ret) ;
goto V_99;
...
continue;
V_40 = F_128 ( & V_39 -> V_59 [ V_23 ] , NULL ) ;
if ( V_40 ) {
...
static void F_157 ( struct V_336 * V_337 , void * V_338 )
{
...
{
V_59 -> V_39 = V_39 ;
F_158 ( V_59 , & V_59 -> V_209 ) ;
F_158 ( V_59 , & V_59 -> V_296 ) ;
F_22 ( & V_59 -> V_215 ) ;
F_21 ( & V_59 -> V_95 ) ;
V_59 -> V_97 = NULL ;
V_59 -> V_96 = 0 ;
...
static int F_160 ( struct V_91 * V_59 ,
enum V_10 V_11 )
{
struct V_339 V_340 ;
int V_40 ;
...
V_340 . V_338 = V_59 ;
V_340 . V_354 = F_157 ;
V_59 -> V_60 = F_161 ( V_59 -> V_39 -> V_66 , & V_340 ) ;
if ( F_19 ( V_59 -> V_60 ) ) {
F_62 (KERN_ERR PFX L_35 ,
get_spl_qp_index(qp_type)) ;
V_40 = F_162 ( V_59 -> V_60 ) ;
goto error;
}
...
static void F_163 ( struct V_91 * V_59 )
{
if ( ! V_59 -> V_60 )
return;
F_164 ( V_59 -> V_60 ) ;
...
F_21 ( & V_39 -> V_82 ) ;
F_22 ( & V_39 -> V_87 ) ;
F_159 ( V_39 , & V_39 -> V_59 [ 0 ] ) ;
F_159 ( V_39 , & V_39 -> V_59 [ 1 ] ) ;
V_355 = V_347 + V_349 ;
V_357 = F_166 ( V_3 , V_4 ) == V_358 ;
if ( V_357 )
V_355 *= 2 ;
V_39 -> V_307 = F_167 ( V_39 -> V_3 ,
F_152 ,
NULL , V_39 , V_355 , 0 ) ;
if ( F_19 ( V_39 -> V_307 ) ) {
F_62 (KERN_ERR PFX L_37 ) ;
V_40 = F_162 ( V_39 -> V_307 ) ;
goto V_69;
}
V_39 -> V_66 = F_168 ( V_3 ) ;
if ( F_19 ( V_39 -> V_66 ) ) {
F_62 (KERN_ERR PFX L_38 ) ;
V_40 = F_162 ( V_39 -> V_66 ) ;
goto V_86;
}
V_39 -> V_65 = F_18 ( V_39 -> V_66 , V_67 ) ;
if ( F_19 ( V_39 -> V_65 ) ) {
F_62 (KERN_ERR PFX L_39 ) ;
V_40 = F_162 ( V_39 -> V_65 ) ;
goto V_359;
}
if ( V_357 ) {
V_40 = F_160 ( & V_39 -> V_59 [ 0 ] , V_12 ) ;
if ( V_40 )
goto V_360;
}
V_40 = F_160 ( & V_39 -> V_59 [ 1 ] , V_13 ) ;
if ( V_40 )
goto V_361;
snprintf ( V_356 , sizeof V_356 , L_40 , V_4 ) ;
V_39 -> V_103 = F_169 ( V_356 ) ;
if ( ! V_39 -> V_103 ) {
V_40 = - V_63 ;
goto V_362;
}
F_24 ( & V_39 -> V_306 , F_143 ) ;
F_4 ( & V_7 , V_6 ) ;
...
static int F_174 ( struct V_2 * V_3 , int V_4 )
{
struct V_1 * V_39 ;
unsigned long V_6 ;
F_4 ( & V_7 , V_6 ) ;
...
{
int V_40 ;
V_349 = F_181 ( V_349 , V_371 ) ;
V_349 = F_182 ( V_349 , V_372 ) ;
V_347 = F_181 ( V_347 , V_371 ) ;
V_347 = F_182 ( V_347 , V_372 ) ;
V_153 = F_183 ( L_48 ,
sizeof( struct V_139 ) ,
0 ,
V_373 ,
