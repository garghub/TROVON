...
static void F_36 ( int V_13 , struct V_11 * V_12 )
{
unsigned long V_29 ;
F_17 ( & V_12 -> V_34 , V_29 ) ;
F_19 ( V_12 , V_73 , 0x00 ) ;
...
static int F_42 ( int V_13 , struct V_9 * V_10 ,
struct V_96 * V_16 ,
...
static int F_51 ( struct V_108 * V_100 , int V_13 ,
struct V_15 * * V_109 )
{
struct V_15 * V_16 ;
struct V_9 * V_10 ;
int V_18 ;
V_18 = F_52 ( V_100 , V_95 [ V_13 ] , V_98 [ V_13 ] , V_110 ,
...
static int F_53 ( struct V_15 * V_16 , int V_13 )
{
...
return V_18 ;
V_10 -> V_44 = V_12 -> V_21 . V_121 ;
V_10 -> V_45 = V_12 -> V_21 . V_5 + 0x10c + 2 ;
F_36 ( V_13 , V_12 ) ;
F_29 ( V_12 ) ;
if ( ( V_18 = F_55 ( V_12 ) ) < 0 )
return V_18 ;
if ( F_56 ( V_112 , F_21 , 0 ,
L_25 , V_10 ) ) {
...
V_10 -> V_39 = V_112 ;
V_18 = F_57 ( V_16 ,
V_12 -> V_21 . V_5 + 0x10c , - 1 , V_112 ,
V_114 < 0 ? V_113 : V_114 , V_113 ,
V_122 ,
V_123 |
V_124 |
V_125 ,
...
if ( V_18 < 0 )
return V_18 ;
V_18 = F_58 ( V_46 , 0 , & V_117 ) ;
if ( V_18 < 0 )
return V_18 ;
sprintf ( V_117 -> V_17 + strlen ( V_117 -> V_17 ) , L_27 , V_12 -> V_38 + 'A' ) ;
strcat ( V_117 -> V_17 , L_28 ) ;
...
if ( ( V_18 = F_41 ( V_16 , & V_86 , & V_87 ) ) < 0 )
return V_18 ;
if ( ( V_18 = F_62 ( V_16 , V_115 , 0 , 1 ) ) < 0 )
return V_18 ;
}
#endif
V_12 -> V_126 = V_127 [ V_13 ] ;
...
V_118 = L_32 ;
#endif
strcpy ( V_16 -> V_128 , V_118 ) ;
strcpy ( V_16 -> V_37 , V_118 ) ;
sprintf ( V_16 -> V_129 , L_33 ,
V_118 ,
V_12 -> V_21 . V_5 ,
V_112 ,
V_113 ) ;
if ( V_114 >= 0 )
sprintf ( V_16 -> V_129 + strlen ( V_16 -> V_129 ) , L_34 , V_114 ) ;
V_18 = F_64 ( V_16 ) ;
if ( V_18 < 0 )
return V_18 ;
V_10 -> V_46 = V_46 ;
...
static int F_65 ( int V_13 , struct V_108 * V_130 )
{
struct V_15 * V_16 ;
int V_18 ;
V_18 = F_51 ( V_130 , V_13 , & V_16 ) ;
if ( V_18 < 0 )
return V_18 ;
...
static int F_68 ( struct V_108 * V_100 ,
unsigned int V_13 )
{
if ( ! V_131 [ V_13 ] )
return 0 ;
...
static int F_70 ( struct V_108 * V_100 ,
unsigned int V_13 )
{
int V_18 ;
...
if ( V_39 [ V_13 ] == V_135 ) {
if ( ( V_39 [ V_13 ] = F_71 ( V_133 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_35 ) ;
return - V_102 ;
}
}
if ( V_105 [ V_13 ] == V_136 ) {
if ( ( V_105 [ V_13 ] = F_72 ( V_134 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_36 ) ;
return - V_102 ;
}
}
if ( V_106 [ V_13 ] == V_136 ) {
if ( ( V_106 [ V_13 ] = F_72 ( V_134 ) ) < 0 ) {
...
static int F_73 ( struct V_108 * V_130 , unsigned int V_13 )
{
F_66 ( F_74 ( V_130 ) ) ;
return 0 ;
}
static int F_75 ( struct V_96 * V_138 ,
...
if ( V_13 >= V_140 )
return - V_24 ;
V_7 = F_51 ( & V_138 -> V_16 -> V_13 , V_13 , & V_16 ) ;
if ( V_7 < 0 )
return V_7 ;
...
static void F_77 ( struct V_96 * V_138 )
{
F_66 ( F_78 ( V_138 ) ) ;
F_76 ( V_138 , NULL ) ;
}
