...
V_232 |
V_233 , V_206 ) ;
V_33 -> V_169 = V_189 -> V_234 ;
}
return 0 ;
}
static int F_27 ( struct V_235 * V_236 ,
const struct V_237 * V_238 )
{
struct V_32 * V_33 ;
struct V_188 * V_189 = F_28 ( & V_236 -> V_31 ) ;
int V_57 ;
V_33 = F_29 ( & V_236 -> V_31 , sizeof( struct V_32 ) ,
V_239 ) ;
if ( ! V_33 )
return - V_240 ;
if ( V_189 )
V_33 -> V_189 = V_189 ;
F_30 ( V_236 , V_33 ) ;
V_33 -> V_241 = F_31 ( V_236 , & V_242 ) ;
if ( F_32 ( V_33 -> V_241 ) ) {
V_57 = F_33 ( V_33 -> V_241 ) ;
F_22 ( & V_236 -> V_31 , L_5 , V_57 ) ;
return V_57 ;
}
V_57 = F_34 ( & V_236 -> V_31 ,
& V_243 , & V_244 , 1 ) ;
if ( V_57 < 0 ) {
F_22 ( & V_236 -> V_31 , L_6 ,
V_57 ) ;
...
static int F_35 ( struct V_235 * V_245 )
{
F_36 ( & V_245 -> V_31 ) ;
return 0 ;
}
