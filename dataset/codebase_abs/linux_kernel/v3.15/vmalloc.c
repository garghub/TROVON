...
static int F_234 ( struct V_194 * V_194 , struct V_195 * V_195 )
{
unsigned int * V_196 = NULL ;
int V_27 ;
if ( F_227 ( V_188 ) ) {
V_196 = F_235 ( V_191 * sizeof( unsigned int ) , V_112 ) ;
if ( V_196 == NULL )
return - V_23 ;
}
V_27 = F_236 ( V_195 , & V_197 ) ;
if ( ! V_27 ) {
...
{
F_238 ( L_17 , V_199 , NULL , & V_200 ) ;
return 0 ;
}
void F_239 ( struct V_201 * V_202 )
{
struct V_34 * V_38 ;
unsigned long V_203 ;
unsigned long V_204 ;
