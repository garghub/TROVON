...
if ( V_84 . V_97 == 0 )
V_84 . V_97 = V_80 ;
V_79 = V_3 -> V_98 ( V_87 , V_84 . V_97 , & V_81 ) ;
if ( ! V_79 ) {
V_17 = - V_99 ;
goto V_67;
}
V_3 -> V_100 ( V_3 -> V_94 , F_33 ( V_81 ) ) ;
V_3 -> V_101 ( V_3 , V_81 , 1 , V_102 , NULL ) ;
F_19 ( V_84 . V_97 , V_79 ) ;
if ( V_3 -> V_64 & V_103 ) {
F_34 () ;
F_35 ( V_79 + 2 , V_85 , V_80 - 1 ) ;
F_34 () ;
F_36 ( V_85 [ V_80 - 1 ] , V_79 + V_80 + 1 ) ;
} else
F_35 ( V_79 + 2 , V_85 , V_80 ) ;
if ( V_3 -> V_64 & V_104 ) {
T_1 V_105 = ( V_81 >= V_3 -> V_51 ) ? 2047 : 1023 ;
F_34 () ;
F_36 ( 0xaebecede , V_79 + V_105 ) ;
}
F_34 () ;
F_37 ( V_3 , V_81 ) ;
V_3 -> V_101 ( V_3 , V_81 , 1 , V_106 , NULL ) ;
V_17 = sizeof( V_84 ) ;
V_67:
F_38 ( V_85 ) ;
return V_17 ;
