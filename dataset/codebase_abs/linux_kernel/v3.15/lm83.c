...
F_23 ( V_23 , V_9 ) ;
F_24 ( & V_9 -> V_18 ) ;
V_17 = F_25 ( & V_23 -> V_2 . V_44 , & V_45 ) ;
if ( V_17 )
return V_17 ;
if ( V_41 -> V_46 == V_47 ) {
V_17 = F_25 ( & V_23 -> V_2 . V_44 ,
& V_48 ) ;
if ( V_17 )
goto V_49;
}
V_9 -> V_50 = F_26 ( & V_23 -> V_2 ) ;
if ( F_27 ( V_9 -> V_50 ) ) {
V_17 = F_28 ( V_9 -> V_50 ) ;
goto V_49;
}
return 0 ;
V_49:
F_29 ( & V_23 -> V_2 . V_44 , & V_45 ) ;
F_29 ( & V_23 -> V_2 . V_44 , & V_48 ) ;
return V_17 ;
}
...
struct V_8 * V_9 = F_7 ( V_14 ) ;
F_31 ( V_9 -> V_50 ) ;
F_29 ( & V_14 -> V_2 . V_44 , & V_45 ) ;
F_29 ( & V_14 -> V_2 . V_44 , & V_48 ) ;
return 0 ;
}
...
struct V_8 * V_9 = F_7 ( V_14 ) ;
F_9 ( & V_9 -> V_18 ) ;
if ( F_32 ( V_51 , V_9 -> V_52 + V_53 * 2 ) || ! V_9 -> V_54 ) {
int V_16 ;
F_18 ( & V_14 -> V_2 , L_6 ) ;
