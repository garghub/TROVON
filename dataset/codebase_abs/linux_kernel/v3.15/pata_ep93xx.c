...
V_48 = V_144 -> V_48 ;
V_34 = V_48 -> V_51 -> V_52 ;
for ( V_24 = 0 ; ( V_48 -> V_102 -> V_178 ( V_48 ) & V_179 )
&& V_24 < 65536 ; V_24 += 2 )
F_12 ( V_34 , V_100 ) ;
if ( V_24 )
F_65 ( V_48 , L_8 , V_24 ) ;
...
V_183 = F_71 ( V_122 , V_186 , 0 ) ;
V_36 = F_72 ( & V_122 -> V_139 , V_183 ) ;
if ( F_73 ( V_36 ) ) {
V_177 = F_74 ( V_36 ) ;
goto V_185;
}
V_34 = F_75 ( & V_122 -> V_139 , sizeof( * V_34 ) , V_187 ) ;
if ( ! V_34 ) {
V_177 = - V_184 ;
goto V_185;
}
...
V_34 -> V_122 = V_122 ;
V_34 -> V_36 = V_36 ;
V_34 -> V_136 = V_183 -> V_26 + V_15 ;
V_34 -> V_141 = V_183 -> V_26 + V_14 ;
F_46 ( V_34 ) ;
V_51 = F_77 ( & V_122 -> V_139 , 1 ) ;
if ( ! V_51 ) {
V_177 = - V_184 ;
goto V_188;
}
...
F_6 ( V_36 , 0 ) ;
F_79 ( & V_122 -> V_139 , L_9 V_200 L_10 ) ;
V_177 = F_80 ( V_51 , V_181 , V_201 , 0 ,
& V_202 ) ;
if ( V_177 == 0 )
return 0 ;
V_188:
