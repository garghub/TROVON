...
if ( V_37 -> V_96 == V_192 ) {
V_139 = F_87 ( V_134 ) ;
F_88 ( V_46 , F_89 ( V_105 ) ,
V_139 ) ;
}
F_92 ( V_105 , & V_131 -> V_181 ) ;
if ( ! F_80 ( V_131 ) )
...
void F_107 ( struct V_129 * V_73 )
{
struct V_1 * V_2 = F_70 ( V_73 ) ;
int V_204 = V_73 -> V_205 + V_124 + V_206 + V_207 ;
int V_88 = 0 ;
int V_30 = 0 ;
while ( V_88 < V_204 ) {
V_2 -> V_6 [ V_30 ] . V_16 =
( V_204 > V_88 + V_208 [ V_30 ] ) ?
V_208 [ V_30 ] : V_204 - V_88 ;
V_2 -> V_6 [ V_30 ] . V_109 = V_88 ;
if ( ! V_30 ) {
V_2 -> V_6 [ V_30 ] . V_22 = V_116 ;
V_2 -> V_6 [ V_30 ] . V_24 =
F_108 ( V_208 [ V_30 ] + V_116 , V_209 ) ;
} else {
V_2 -> V_6 [ V_30 ] . V_22 = 0 ;
V_2 -> V_6 [ V_30 ] . V_24 =
F_108 ( V_208 [ V_30 ] , V_209 ) ;
}
...
V_2 -> V_31 = V_30 ;
V_2 -> V_210 = V_204 ;
V_2 -> V_52 = F_109 ( V_30 * sizeof( struct V_3 ) ) ;
F_14 ( V_39 , V_2 , L_17
L_18 , V_204 , V_2 -> V_31 ) ;
for ( V_30 = 0 ; V_30 < V_2 -> V_31 ; V_30 ++ ) {
F_22 ( V_2 ,
...
static int F_110 ( struct V_1 * V_2 , int V_211 ,
struct V_36 * V_37 ,
enum V_212 * V_213 ,
struct V_214 * V_215 )
{
...
struct V_216 * V_217 ;
int V_85 = 0 ;
V_217 = F_111 ( sizeof( * V_217 ) , V_38 ) ;
if ( ! V_217 )
return - V_17 ;
V_85 = F_112 ( V_46 -> V_73 , V_211 , V_215 ) ;
if ( V_85 ) {
F_22 ( V_2 , L_20 , V_211 ) ;
goto V_32;
}
...
F_113 ( V_2 , V_37 -> V_64 , V_37 -> V_42 , 0 , 0 ,
V_211 , V_37 -> V_99 , - 1 , V_217 ) ;
V_217 -> V_220 = F_9 ( V_37 -> V_53 . V_54 . V_10 ) ;
if ( V_46 -> V_73 -> V_74 . V_153 & V_221 ) {
V_217 -> V_222 |= F_17 ( 1 << 29 ) ;
V_37 -> V_167 = V_223 ;
} else
V_37 -> V_167 = 0 ;
V_85 = F_114 ( V_46 -> V_73 , & V_37 -> V_53 . V_224 , V_217 , V_215 , V_213 ) ;
if ( V_85 ) {
F_115 ( V_46 -> V_73 , V_215 ) ;
F_116 ( V_46 -> V_73 , V_215 ) ;
}
F_19 ( V_37 ) ;
V_32:
F_44 ( V_217 ) ;
...
int V_85 ;
T_3 V_211 ;
V_85 = F_118 ( V_2 -> V_46 -> V_73 , 1 , 1 , & V_211 ) ;
if ( V_85 ) {
F_22 ( V_2 , L_21 ) ;
return V_85 ;
}
V_85 = F_112 ( V_2 -> V_46 -> V_73 , V_211 , & V_2 -> V_225 ) ;
if ( V_85 ) {
F_22 ( V_2 , L_22 ) ;
F_119 ( V_2 -> V_46 -> V_73 , V_211 , 1 ) ;
return V_85 ;
}
return 0 ;
}
...
{
T_3 V_211 ;
V_211 = V_2 -> V_225 . V_211 ;
F_115 ( V_2 -> V_46 -> V_73 , & V_2 -> V_225 ) ;
F_116 ( V_2 -> V_46 -> V_73 , & V_2 -> V_225 ) ;
F_119 ( V_2 -> V_46 -> V_73 , V_211 , 1 ) ;
}
...
int V_230 ;
void * V_231 ;
T_6 V_232 = ( V_233 | V_234 | V_235 |
V_236 ) ;
int V_30 , V_211 ;
int V_85 = 0 ;
int V_237 = 0 ;
static const T_3 V_238 [ 10 ] = { 0xD181C62C , 0xF7F4DB5B , 0x1983A2FC ,
0x943E1ADB , 0xD9389E6B , 0xD1039C2C , 0xA74499AD ,
0x593D56D9 , 0xF3253C06 , 0x2ADC1FFC } ;
F_14 ( V_39 , V_2 , L_23 ) ;
V_85 = F_118 ( V_46 -> V_73 , V_2 -> V_62 ,
V_2 -> V_62 ,
& V_227 -> V_239 ) ;
if ( V_85 ) {
...
V_211 = V_227 -> V_239 + V_30 ;
V_85 = F_110 ( V_2 , V_211 , V_2 -> V_63 [ V_30 ] ,
& V_227 -> V_213 [ V_30 ] ,
& V_227 -> V_240 [ V_30 ] ) ;
if ( V_85 )
goto V_241;
...
V_85 = F_112 ( V_46 -> V_73 , V_2 -> V_239 , & V_227 -> V_242 ) ;
if ( V_85 ) {
F_22 ( V_2 , L_25 ) ;
goto V_241;
}
V_227 -> V_242 . V_218 = V_219 ;
F_113 ( V_2 , 0 , 0 , 0 , 1 , V_2 -> V_239 ,
V_2 -> V_63 [ 0 ] -> V_99 , - 1 , & V_217 ) ;
if ( ! V_2 -> V_60 -> V_230 || V_2 -> V_60 -> V_230 > V_2 -> V_62 )
V_230 = V_2 -> V_62 ;
else
V_230 = V_2 -> V_60 -> V_230 ;
V_231 = ( ( void * ) & V_217 ) + F_122 ( struct V_216 , V_243 )
+ V_244 ;
V_229 = V_231 ;
V_229 -> V_239 = F_17 ( F_123 ( V_230 ) << 24 |
( V_227 -> V_239 ) ) ;
V_229 -> V_245 = F_17 ( V_227 -> V_239 ) ;
if ( V_2 -> V_46 -> V_81 . V_246 ) {
V_232 |= V_247 | V_248 ;
V_229 -> V_249 = V_229 -> V_245 ;
}
if ( V_46 -> V_73 -> V_74 . V_250 == V_251 ) {
F_124 ( V_2 , L_26 ) ;
V_232 |= V_252 ;
}
V_229 -> V_153 = V_232 ;
...
V_229 -> V_255 [ V_30 ] = F_17 ( V_238 [ V_30 ] ) ;
V_85 = F_114 ( V_46 -> V_73 , & V_2 -> V_256 . V_224 , & V_217 ,
& V_227 -> V_242 , & V_227 -> V_257 ) ;
if ( V_85 )
goto V_258;
return 0 ;
V_258:
F_125 ( V_46 -> V_73 , NULL , V_227 -> V_257 ,
V_259 , NULL , 0 , 0 , & V_227 -> V_242 ) ;
F_115 ( V_46 -> V_73 , & V_227 -> V_242 ) ;
F_116 ( V_46 -> V_73 , & V_227 -> V_242 ) ;
V_241:
for ( V_30 = 0 ; V_30 < V_237 ; V_30 ++ ) {
F_125 ( V_46 -> V_73 , NULL , V_227 -> V_213 [ V_30 ] ,
V_259 , NULL , 0 , 0 , & V_227 -> V_240 [ V_30 ] ) ;
F_115 ( V_46 -> V_73 , & V_227 -> V_240 [ V_30 ] ) ;
F_116 ( V_46 -> V_73 , & V_227 -> V_240 [ V_30 ] ) ;
}
F_119 ( V_46 -> V_73 , V_227 -> V_239 , V_2 -> V_62 ) ;
return V_85 ;
}
