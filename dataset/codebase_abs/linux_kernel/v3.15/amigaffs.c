...
bool
F_42 ( const struct V_28 * V_28 )
{
struct V_1 * V_1 = V_28 -> V_31 ;
return F_29 ( V_1 -> V_7 ) -> V_92 & V_95 ;
}
int
F_43 ( const unsigned char * V_13 , int V_96 , bool V_97 )
{
int V_98 ;
if ( V_96 > 30 ) {
if ( V_97 )
...
{
int V_96 = F_45 ( V_28 -> V_102 . V_96 , 30u ) ;
* V_101 ++ = V_96 ;
memcpy ( V_101 , V_28 -> V_102 . V_13 , V_96 ) ;
return V_96 ;
}
