...
int V_80 , int * V_79 )
{
return F_27 ( V_14 , V_69 , ( V_14 -> V_5 << 8 ) | V_80 , V_79 ) ;
}
...
static int F_33 ( struct V_13 * V_14 , int V_49 , int V_79 )
{
...
V_56 = F_31 ( V_14 , V_85 , ( V_14 -> V_5 << 8 ) | V_80 ,
V_79 ) ;
if ( V_56 < 0 )
return V_56 ;
V_14 -> V_81 |= 1 << V_80 ;
...
static int F_38 ( unsigned char * V_99 , int V_100 , int V_101 , int V_102 )
{
...
struct V_112 * V_24 ;
if ( V_110 -> V_11 )
return F_9 ( V_3 , V_110 -> V_11 , V_11 , V_35 ) ;
if ( V_110 -> type >> 16 ) {
if ( V_111 )
return 0 ;
...
static int F_43 ( struct V_2 * V_3 , int V_8 , struct V_109 * V_118 )
{
int V_56 ;
void * V_119 ;
...
if ( F_27 ( V_14 , V_75 , ( V_14 -> V_5 << 8 ) | V_147 , & V_14 -> V_47 ) < 0 ) {
V_14 -> V_47 = 1 ;
} else {
int V_151 = V_14 -> V_47 ;
while ( V_14 -> V_47 > 1 ) {
if ( F_31 ( V_14 , V_152 ,
( V_14 -> V_5 << 8 ) | V_147 , V_14 -> V_47 / 2 ) < 0 )
break;
V_14 -> V_47 /= 2 ;
}
if ( F_27 ( V_14 , V_75 , ( V_14 -> V_5 << 8 ) | V_147 , & V_14 -> V_47 ) < 0 )
...
static int F_59 ( struct V_91 * V_92 , struct V_156 * V_157 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
if ( V_14 -> V_40 == V_41 ||
V_14 -> V_40 == V_42 )
...
static int F_61 ( struct V_91 * V_92 , struct V_165 * V_166 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
...
static int F_62 ( struct V_91 * V_92 , struct V_165 * V_166 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
...
case V_191 :
if ( ! V_36 ) {
V_36 = F_42 ( V_3 , V_110 , V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) , 1 ) ;
if ( ! V_36 )
V_36 = F_42 ( V_3 , & V_3 -> V_192 , V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) , 1 ) ;
if ( ! V_36 )
V_36 = snprintf ( V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) ,
L_35 , V_4 ) ;
}
if ( ! V_181 )
...
F_22 ( V_3 -> V_37 , L_44 ,
V_14 -> V_8 , V_104 -> V_8 . V_11 , V_14 -> V_123 , V_14 -> V_16 , V_14 -> V_18 , V_14 -> V_47 ) ;
F_39 ( V_3 -> V_52 , V_104 ) ;
}
static int F_71 ( struct V_2 * V_3 , int V_4 , void * V_194 )
{
...
unsigned int V_204 = F_21 ( V_199 + V_198 * ( V_195 + 1 ) , V_198 ) ;
if ( V_204 & ( 1 << V_149 ) )
V_203 |= ( 1 << V_195 ) ;
}
if ( V_203 & 1 )
F_66 ( V_3 , V_194 , V_203 , V_149 , & V_110 , V_4 , 0 ) ;
if ( V_196 & ( 1 << V_149 ) )
F_66 ( V_3 , V_194 , 0 , V_149 , & V_110 , V_4 , 0 ) ;
}
} else {
...
if ( V_203 & 1 )
F_66 ( V_3 , V_194 , V_203 , V_149 , & V_110 , V_4 , V_205 ) ;
if ( F_75 ( V_196 , V_149 ) )
...
if ( F_38 ( F_78 ( V_180 , V_3 -> V_52 -> V_77 ) , V_207 , V_149 , V_102 ) ) {
V_14 -> V_148 |= ( 1 << V_149 ) ;
V_14 -> V_123 ++ ;
}
}
...
V_36 = F_2 ( V_7 , V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) ) ;
if ( ! V_36 )
V_36 = F_42 ( V_3 , V_110 , V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) , 0 ) ;
if ( ! V_36 )
...
static int F_80 ( struct V_2 * V_3 , int V_4 , void * V_177 )
{
struct V_133 * V_180 = V_177 ;
struct V_109 V_110 ;
int V_208 , V_209 , V_102 ;
int V_210 , V_100 , V_56 ;
if ( V_180 -> V_30 < 11 || ! ( V_208 = V_180 -> V_141 ) || ! ( V_102 = F_46 ( V_180 ) ) ) {
F_26 ( V_3 -> V_37 , L_51 , V_4 ) ;
return - V_64 ;
}
if ( V_180 -> V_30 <= 10 + V_208 ) {
F_22 ( V_3 -> V_37 , L_52 , V_4 ) ;
return 0 ;
}
V_209 = 0 ;
V_100 = 0 ;
...
if ( F_38 ( F_78 ( V_180 , V_3 -> V_52 -> V_77 ) ,
V_100 , V_101 , V_102 ) ) {
V_211 = 1 ;
break;
}
...
static int F_81 ( struct V_91 * V_92 , struct V_165 * V_166 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
int V_56 , V_39 ;
...
static int F_82 ( struct V_91 * V_92 , struct V_165 * V_166 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
int V_39 , V_169 , V_56 ;
...
static int F_83 ( struct V_2 * V_3 , int V_4 , void * V_177 , struct V_212 * V_213 , char * V_11 )
{
...
V_36 = 0 ;
if ( V_182 )
V_36 = F_9 ( V_3 , V_182 , V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) ) ;
if ( ! V_36 )
...
static int F_87 ( struct V_2 * V_3 , int V_4 , void * V_177 )
{
return F_83 ( V_3 , V_4 , V_177 , V_229 , L_57 ) ;
}
static int F_88 ( struct V_2 * V_3 , int V_4 , void * V_177 )
{
return F_83 ( V_3 , V_4 , V_177 , V_230 , L_58 ) ;
}
static int F_89 ( struct V_91 * V_92 , struct V_156 * V_157 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
...
static int F_92 ( struct V_91 * V_92 , struct V_165 * V_166 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
int V_39 , V_56 ;
V_56 = F_28 ( V_14 , V_14 -> V_5 << 8 , & V_39 ) ;
...
static int F_93 ( struct V_91 * V_92 , struct V_165 * V_166 )
{
struct V_13 * V_14 = V_92 -> V_95 ;
int V_39 , V_169 , V_56 ;
V_56 = F_28 ( V_14 , V_14 -> V_5 << 8 , & V_169 ) ;
...
static int F_95 ( struct V_2 * V_3 , int V_4 , void * V_177 )
{
...
if ( ! V_36 )
sprintf ( V_235 [ V_149 ] , L_61 , V_149 ) ;
}
...
F_9 ( V_3 , V_182 , V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) ) ;
else {
V_36 = F_42 ( V_3 , & V_3 -> V_192 ,
V_104 -> V_8 . V_11 , sizeof( V_104 -> V_8 . V_11 ) , 0 ) ;
if ( ! V_36 )
F_3 ( V_104 -> V_8 . V_11 , L_62 , sizeof( V_104 -> V_8 . V_11 ) ) ;
if ( V_180 -> V_31 == V_134 )
F_63 ( V_104 , L_63 ) ;
...
V_6 = NULL ;
while ( ( V_6 = F_103 ( V_52 -> V_247 -> V_248 , V_52 -> V_247 -> V_249 ,
V_6 , V_251 ) ) != NULL ) {
if ( V_52 -> V_77 == V_78 ) {
...
V_52 -> V_83 ) ;
F_107 ( V_28 , L_81 , V_37 -> V_105 -> V_260 ) ;
...
V_268:
if ( V_266 != - V_283 && V_266 != - V_284 && V_266 != - V_285 ) {
