...
static int F_153 ( struct V_91 * V_47 , int type , int V_247 , int V_248 )
{
return sizeof( struct V_249 ) + 16 * F_123 ( V_47 , type , V_247 , V_248 ) ;
}
static struct V_169 * F_154 ( struct V_169 * V_170 , struct V_91 * V_47 ,
...
F_156 ( V_170 ) < F_153 ( V_47 , type , V_193 , V_194 ) ) {
if ( V_170 )
F_138 ( V_170 ) ;
...
if ( V_261 ) {
V_170 = F_154 ( V_170 , V_47 , type , & V_251 ) ;
V_261 = 0 ;
}
if ( ! V_170 )
return NULL ;
...
if ( V_170 && F_156 ( V_170 ) < sizeof( struct V_249 ) ) {
F_138 ( V_170 ) ;
V_170 = NULL ;
}
V_170 = F_154 ( V_170 , V_47 , type , & V_251 ) ;
...
static void F_157 ( struct V_1 * V_2 , struct V_91 * V_47 )
{
...
type = V_195 ;
V_170 = F_155 ( V_170 , V_47 , type , 0 , 0 , 0 ) ;
F_57 ( & V_47 -> V_97 ) ;
}
} else {
F_54 ( & V_47 -> V_97 ) ;
...
static void F_158 ( struct V_108 * * V_266 )
{
...
type = V_200 ;
V_268 = V_200 ;
V_170 = F_155 ( V_170 , V_47 , type , 1 , 0 , 0 ) ;
V_170 = F_155 ( V_170 , V_47 , V_268 , 1 , 1 , 0 ) ;
}
if ( V_47 -> V_103 ) {
if ( V_47 -> V_107 == V_30 ) {
type = V_197 ;
...
V_170 = F_155 ( V_170 , V_47 , type , 0 , 0 , 0 ) ;
V_170 = F_155 ( V_170 , V_47 , V_268 , 0 , 1 , 0 ) ;
if ( V_47 -> V_103 ) {
if ( V_47 -> V_107 == V_30 )
type = V_198 ;
else
...
static void F_160 ( struct V_10 * V_11 , struct V_12 * V_13 , int type )
{
struct V_18 * V_18 = F_95 ( V_13 ) ;
struct V_7 * V_8 = V_18 -> V_148 . V_209 ;
struct V_1 * V_2 ;
...
type = V_197 ;
V_170 = F_155 ( V_170 , V_47 , type , 0 , 0 , 1 ) ;
F_57 ( & V_47 -> V_97 ) ;
}
F_31 ( & V_2 -> V_40 ) ;
if ( V_170 )
...
static void F_164 ( unsigned long V_226 )
{
...
static int F_165 ( struct V_91 * V_47 , int V_29 ,
...
int V_53 = F_165 ( V_47 , V_29 , & V_276 [ V_51 ] ) ;
V_281 |= V_53 > 0 ;
if ( ! V_19 && V_53 < 0 )
V_19 = V_53 ;
}
...
V_109 -> V_113 = 0 ;
F_59 ( V_47 -> V_2 ) ;
} else if ( F_167 ( V_47 ) || V_281 )
F_59 ( V_47 -> V_2 ) ;
F_57 ( & V_47 -> V_97 ) ;
F_31 ( & V_2 -> V_40 ) ;
return V_19 ;
}
static int F_168 ( struct V_91 * V_47 , int V_29 ,
const struct V_10 * V_276 )
{
struct V_108 * V_109 , * V_258 ;
V_258 = NULL ;
...
static void F_166 ( struct V_91 * V_47 )
{
struct V_108 * V_109 ;
...
static int F_167 ( struct V_91 * V_47 )
{
...
V_19 = 0 ;
for ( V_51 = 0 ; V_51 < V_279 ; V_51 ++ ) {
V_19 = F_168 ( V_47 , V_29 , & V_276 [ V_51 ] ) ;
if ( V_19 )
break;
}
if ( V_19 ) {
...
if ( V_127 -> V_98 & V_102 )
return;
F_160 ( & V_127 -> V_95 , V_127 -> V_2 -> V_13 , V_289 ) ;
...
if ( F_2 ( V_127 -> V_2 ) ) {
if ( V_127 -> V_98 & V_192 )
F_160 ( & V_127 -> V_95 , V_127 -> V_2 -> V_13 ,
V_271 ) ;
} else {
...
static void F_170 ( unsigned long V_226 )
{
struct V_1 * V_2 = (struct V_1 * ) V_226 ;
V_2 -> V_134 = 0 ;
F_157 ( V_2 , NULL ) ;
...
static void F_171 ( unsigned long V_226 )
{
struct V_1 * V_2 = (struct V_1 * ) V_226 ;
F_159 ( V_2 ) ;
if ( V_2 -> V_138 ) {
...
F_68 ( & V_2 -> V_114 ) ;
V_2 -> V_134 = 0 ;
F_75 ( & V_2 -> V_135 , F_170 ,
( unsigned long ) V_2 ) ;
V_2 -> V_115 = NULL ;
V_2 -> V_138 = 0 ;
F_75 ( & V_2 -> V_137 , F_171 ,
( unsigned long ) V_2 ) ;
F_75 ( & V_2 -> V_139 , F_164 ,
( unsigned long ) V_2 ) ;
V_2 -> V_104 = V_158 ;
V_2 -> V_153 = V_291 ;
V_2 -> V_154 = V_292 ;
...
static inline struct V_91 * F_178 ( struct V_295 * V_296 )
{
struct V_91 * V_106 = NULL ;
struct V_297 * V_298 = F_179 ( V_296 ) ;
struct V_18 * V_18 = F_180 ( V_296 ) ;
V_298 -> V_2 = NULL ;
F_181 (net, state->dev) {
struct V_1 * V_2 ;
V_2 = F_24 ( V_298 -> V_13 ) ;
...
static struct V_91 * F_182 ( struct V_295 * V_296 , struct V_91 * V_106 )
{
struct V_297 * V_298 = F_179 ( V_296 ) ;
V_106 = V_106 -> V_24 ;
while ( ! V_106 ) {
if ( F_183 ( V_298 -> V_2 != NULL ) )
F_31 ( & V_298 -> V_2 -> V_40 ) ;
V_298 -> V_13 = F_184 ( V_298 -> V_13 ) ;
if ( ! V_298 -> V_13 ) {
V_298 -> V_2 = NULL ;
break;
}
...
static struct V_91 * F_185 ( struct V_295 * V_296 , T_4 V_299 )
{
struct V_91 * V_106 = F_178 ( V_296 ) ;
if ( V_106 )
while ( V_299 && ( V_106 = F_182 ( V_296 , V_106 ) ) != NULL )
-- V_299 ;
return V_299 ? NULL : V_106 ;
}
static void * F_186 ( struct V_295 * V_296 , T_4 * V_299 )
__acquires( T_5 )
{
F_7 () ;
return F_185 ( V_296 , * V_299 ) ;
}
static void * F_187 ( struct V_295 * V_296 , void * V_300 , T_4 * V_299 )
{
struct V_91 * V_106 = F_182 ( V_296 , V_300 ) ;
++ * V_299 ;
return V_106 ;
}
static void F_188 ( struct V_295 * V_296 , void * V_300 )
__releases( T_5 )
{
struct V_297 * V_298 = F_179 ( V_296 ) ;
if ( F_183 ( V_298 -> V_2 != NULL ) ) {
...
static int F_189 ( struct V_295 * V_296 , void * V_300 )
{
...
( V_106 -> V_98 & V_142 ) ?
F_191 ( V_106 -> V_105 . V_141 - V_125 ) : 0 ) ;
return 0 ;
}
static int F_192 ( struct V_302 * V_302 , struct V_303 * V_303 )
{
return F_193 ( V_302 , V_303 , & V_304 ,
sizeof( struct V_297 ) ) ;
}
static inline struct V_108 * F_194 ( struct V_295 * V_296 )
{
struct V_108 * V_109 = NULL ;
struct V_91 * V_106 = NULL ;
struct V_305 * V_298 = F_195 ( V_296 ) ;
struct V_18 * V_18 = F_180 ( V_296 ) ;
V_298 -> V_2 = NULL ;
V_298 -> V_106 = NULL ;
F_181 (net, state->dev) {
...
static struct V_108 * F_196 ( struct V_295 * V_296 , struct V_108 * V_109 )
{
struct V_305 * V_298 = F_195 ( V_296 ) ;
V_109 = V_109 -> V_112 ;
while ( ! V_109 ) {
...
static struct V_108 * F_197 ( struct V_295 * V_296 , T_4 V_299 )
{
struct V_108 * V_109 = F_194 ( V_296 ) ;
if ( V_109 )
while ( V_299 && ( V_109 = F_196 ( V_296 , V_109 ) ) != NULL )
-- V_299 ;
return V_299 ? NULL : V_109 ;
}
static void * F_198 ( struct V_295 * V_296 , T_4 * V_299 )
__acquires( T_5 )
{
F_7 () ;
return * V_299 ? F_197 ( V_296 , * V_299 - 1 ) : V_306 ;
}
static void * F_199 ( struct V_295 * V_296 , void * V_300 , T_4 * V_299 )
{
struct V_108 * V_109 ;
if ( V_300 == V_306 )
V_109 = F_194 ( V_296 ) ;
else
V_109 = F_196 ( V_296 , V_300 ) ;
++ * V_299 ;
return V_109 ;
}
static void F_200 ( struct V_295 * V_296 , void * V_300 )
__releases( T_5 )
{
struct V_305 * V_298 = F_195 ( V_296 ) ;
if ( F_183 ( V_298 -> V_106 != NULL ) ) {
F_57 ( & V_298 -> V_106 -> V_97 ) ;
V_298 -> V_106 = NULL ;
}
if ( F_183 ( V_298 -> V_2 != NULL ) ) {
...
static int F_201 ( struct V_295 * V_296 , void * V_300 )
{
...
static int F_202 ( struct V_302 * V_302 , struct V_303 * V_303 )
{
return F_193 ( V_302 , V_303 , & V_307 ,
sizeof( struct V_305 ) ) ;
}
static int T_6 F_203 ( struct V_18 * V_18 )
{
int V_19 ;
V_19 = - V_23 ;
if ( ! F_204 ( L_12 , V_308 , V_18 -> V_309 , & V_310 ) )
goto V_243;
if ( ! F_204 ( L_13 , V_308 , V_18 -> V_309 ,
& V_311 ) )
goto V_312;
V_19 = 0 ;
V_243:
return V_19 ;
V_312:
F_205 ( L_12 , V_18 -> V_309 ) ;
goto V_243;
}
static void T_7 F_206 ( struct V_18 * V_18 )
{
F_205 ( L_13 , V_18 -> V_309 ) ;
F_205 ( L_12 , V_18 -> V_309 ) ;
}
static inline int F_203 ( struct V_18 * V_18 )
{
return 0 ;
}
static inline void F_206 ( struct V_18 * V_18 )
{
}
static int T_6 F_207 ( struct V_18 * V_18 )
{
int V_19 ;
V_19 = F_208 ( & V_18 -> V_148 . V_209 , V_313 ,
V_314 , V_217 , V_18 ) ;
if ( V_19 < 0 ) {
F_209 ( L_14 ,
V_19 ) ;
...
return V_19 ;
V_315:
F_210 ( V_18 -> V_148 . V_209 ) ;
goto V_243;
}
static void T_7 F_211 ( struct V_18 * V_18 )
{
F_210 ( V_18 -> V_148 . V_209 ) ;
F_206 ( V_18 ) ;
}
