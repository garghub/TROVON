...
int F_241 ( struct V_1 * V_2 , struct V_291 * V_264 ,
int V_67 , int V_6 )
{
return F_238 ( V_2 , V_264 , V_67 , V_6 ) ;
}
int F_242 ( struct V_1 * V_2 , struct V_291 * V_264 , int V_67 , int V_6 )
{
int V_293 = F_238 ( V_2 , V_264 , V_67 , V_6 ) ;
F_243 ( & V_264 [ V_293 - 1 ] ) ;
return V_293 ;
}
int F_244 ( struct V_1 * V_2 , int V_294 , struct V_1 * * V_295 )
{
int V_296 ;
int V_292 ;
struct V_1 * V_218 , * * V_297 ;
if ( ( F_124 ( V_2 ) || F_23 ( V_2 ) -> V_85 ) &&
F_143 ( V_2 , F_245 ( V_2 ) - F_117 ( V_2 ) ) == NULL )
return - V_137 ;
if ( ! F_59 ( V_2 ) ) {
if ( F_130 ( V_2 ) < V_294 &&
...
{
struct V_179 * V_129 = V_2 -> V_129 ;
F_248 ( V_2 -> V_27 , & V_129 -> V_298 ) ;
}
int F_249 ( struct V_179 * V_129 , struct V_1 * V_2 )
{
...
if ( ! F_252 ( V_129 , V_301 ) )
V_129 -> V_302 ( V_129 ) ;
return 0 ;
}
void F_253 ( struct V_1 * V_303 ,
struct V_304 * V_305 )
{
...
V_157 = F_249 ( V_129 , V_2 ) ;
if ( V_157 )
F_76 ( V_2 ) ;
}
void F_257 ( struct V_1 * V_2 , bool V_313 )
{
struct V_179 * V_129 = V_2 -> V_129 ;
struct V_306 * V_307 ;
int V_157 ;
...
bool F_258 ( struct V_1 * V_2 , T_12 V_171 , T_12 V_76 )
{
...
static int F_259 ( struct V_1 * V_2 , unsigned int V_6 ,
unsigned int V_317 )
{
if ( F_117 ( V_2 ) >= V_6 )
return 0 ;
...
static int F_260 ( struct V_1 * V_2 , bool V_319 )
{
unsigned int V_76 ;
bool V_320 ;
V_213 * V_114 ;
...
if ( V_157 < 0 )
goto V_23;
if ( F_261 ( V_2 ) -> V_323 & F_262 ( V_324 | V_325 ) )
V_320 = true ;
V_76 = F_263 ( V_2 ) ;
V_157 = - V_318 ;
if ( V_320 )
goto V_23;
V_114 = F_264 ( V_2 , F_261 ( V_2 ) -> V_121 , V_76 ) ;
if ( F_265 ( V_114 ) )
return F_266 ( V_114 ) ;
if ( V_319 )
* V_114 = ~ F_267 ( F_261 ( V_2 ) -> V_326 ,
F_261 ( V_2 ) -> V_327 ,
V_2 -> V_6 - V_76 ,
F_261 ( V_2 ) -> V_121 , 0 ) ;
V_157 = 0 ;
...
static int F_268 ( struct V_1 * V_2 , bool V_319 )
{
int V_157 ;
T_3 V_328 ;
unsigned int V_76 ;
...
V_320 = false ;
V_163 = false ;
V_76 = sizeof( struct V_329 ) ;
V_157 = F_259 ( V_2 , V_76 , V_330 ) ;
if ( V_157 < 0 )
goto V_23;
V_328 = F_269 ( V_2 ) -> V_328 ;
V_6 = sizeof( struct V_329 ) + F_270 ( F_269 ( V_2 ) -> V_331 ) ;
...
if ( V_157 < 0 )
goto V_23;
V_336 = F_271 ( struct V_335 , V_2 , V_76 ) ;
V_328 = V_336 -> V_328 ;
V_76 += F_272 ( V_336 ) ;
break;
}
...
if ( V_157 < 0 )
goto V_23;
V_336 = F_271 ( struct V_338 , V_2 , V_76 ) ;
V_328 = V_336 -> V_328 ;
V_76 += F_273 ( V_336 ) ;
break;
}
...
if ( V_157 < 0 )
goto V_23;
V_336 = F_271 ( struct V_340 , V_2 , V_76 ) ;
if ( V_336 -> V_323 & F_262 ( V_341 | V_342 ) )
V_320 = true ;
V_328 = V_336 -> V_328 ;
V_76 += sizeof( struct V_340 ) ;
break;
}
default:
V_163 = true ;
...
if ( ! V_163 || V_320 )
goto V_23;
V_114 = F_264 ( V_2 , V_328 , V_76 ) ;
if ( F_265 ( V_114 ) )
return F_266 ( V_114 ) ;
if ( V_319 )
* V_114 = ~ F_274 ( & F_269 ( V_2 ) -> V_326 ,
& F_269 ( V_2 ) -> V_327 ,
V_2 -> V_6 - V_76 , V_328 , 0 ) ;
V_157 = 0 ;
V_23:
return V_157 ;
}
int F_275 ( struct V_1 * V_2 , bool V_319 )
{
int V_157 ;
switch ( V_2 -> V_121 ) {
case F_262 ( V_343 ) :
V_157 = F_260 ( V_2 , V_319 ) ;
break;
case F_262 ( V_344 ) :
V_157 = F_268 ( V_2 , V_319 ) ;
break;
default:
V_157 = - V_318 ;
break;
...
void F_276 ( const struct V_1 * V_2 )
{
F_223 ( L_7 ,
V_2 -> V_11 -> V_12 ) ;
}
void F_277 ( struct V_1 * V_2 , bool V_345 )
{
if ( V_345 ) {
F_62 ( V_2 ) ;
F_26 ( V_25 , V_2 ) ;
...
bool F_278 ( struct V_1 * V_170 , struct V_1 * V_199 ,
bool * V_346 , int * V_279 )
{
...
void F_280 ( struct V_1 * V_2 , bool V_347 )
{
if ( V_347 )
F_250 ( V_2 ) ;
V_2 -> V_104 . V_348 = 0 ;
...
unsigned int F_284 ( const struct V_1 * V_2 )
{
const struct V_32 * V_33 = F_23 ( V_2 ) ;
if ( F_34 ( V_33 -> V_143 & ( V_350 | V_351 ) ) )
return F_285 ( V_2 ) + V_33 -> V_141 ;
return V_33 -> V_141 ;
}
