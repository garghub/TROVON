...
int V_3 ;
T_2 V_104 ;
V_6 = F_44 ( & V_2 -> V_20 , sizeof( struct V_5 ) ,
V_105 ) ;
if ( V_6 == NULL ) {
F_14 ( & V_2 -> V_20 , L_29 ) ;
return - V_106 ;
...
V_6 -> V_24 [ V_63 ] . V_109 = V_110 [ V_63 ] ;
V_10 = F_50 ( & V_2 -> V_20 , V_23 ,
V_6 -> V_24 ) ;
if ( V_10 != 0 ) {
...
V_104 |= V_3 & 0xff ;
if ( V_104 != 0x2000 ) {
F_14 ( & V_2 -> V_20 , L_32 , V_104 ) ;
V_10 = - V_111 ;
goto V_112;
}
V_3 = F_4 ( V_2 , V_93 ) ;
F_51 ( & V_2 -> V_20 , L_33 , V_3 + 'A' ) ;
V_6 -> V_25 = F_52 ( & V_2 -> V_20 , L_34 ) ;
if ( F_48 ( V_6 -> V_25 ) ) {
V_10 = F_49 ( V_6 -> V_25 ) ;
...
V_100 = F_53 ( & V_2 -> V_20 ) ;
if ( V_100 ) {
V_6 -> V_44 = ! V_100 -> V_113 ;
if ( V_100 -> V_114 )
V_101 = V_100 -> V_114 ;
}
V_10 = F_54 ( & V_103 , V_101 , & V_2 -> V_20 ) ;
if ( V_10 != 0 ) {
F_14 ( & V_2 -> V_20 , L_37 , V_10 ) ;
goto V_112;
}
V_6 -> V_35 = V_103 -> V_115 + 2 ;
V_6 -> V_36 = F_44 ( & V_2 -> V_20 ,
V_6 -> V_35 ,
V_105 ) ;
if ( V_6 -> V_36 == NULL ) {
F_14 ( & V_2 -> V_20 , L_38 ) ;
...
V_6 -> V_36 [ 0 ] = 0x80 ;
V_6 -> V_36 [ 1 ] = 0x00 ;
memcpy ( V_6 -> V_36 + 2 , V_103 -> V_116 , V_103 -> V_115 ) ;
V_6 -> V_69 = 1 ;
V_6 -> V_71 = 1 ;
V_6 -> V_70 = 1 ;
V_6 -> V_2 = V_2 ;
F_6 ( V_6 ) ;
V_10 = F_55 ( & V_2 -> V_20 , & V_117 , NULL , 0 ) ;
V_112:
F_16 ( V_23 , V_6 -> V_24 ) ;
V_108:
F_56 ( V_103 ) ;
