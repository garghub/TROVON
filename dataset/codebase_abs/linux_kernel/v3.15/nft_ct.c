...
static int F_26 ( const struct V_86 * V_87 ,
const struct V_1 * V_2 ,
const struct V_79 * const V_80 [] )
{
struct V_8 * V_9 = F_2 ( V_2 ) ;
int V_29 ;
V_9 -> V_25 = F_27 ( F_28 ( V_80 [ V_88 ] ) ) ;
if ( V_80 [ V_89 ] ) {
V_29 = F_23 ( V_2 , V_80 ) ;
if ( V_29 < 0 )
return V_29 ;
V_9 -> V_11 = F_27 ( F_28 ( V_80 [ V_89 ] ) ) ;
V_29 = F_29 ( V_9 -> V_11 ) ;
if ( V_29 < 0 )
return V_29 ;
V_29 = F_30 ( V_87 , V_9 -> V_11 , NULL ,
V_90 ) ;
if ( V_29 < 0 )
return V_29 ;
} else {
...
if ( V_29 < 0 )
return V_29 ;
V_9 -> V_72 = F_27 ( F_28 ( V_80 [ V_91 ] ) ) ;
V_29 = F_31 ( V_9 -> V_72 ) ;
if ( V_29 < 0 )
return V_29 ;
}
V_29 = F_19 ( V_87 -> V_92 -> V_74 ) ;
if ( V_29 < 0 )
return V_29 ;
return 0 ;
}
static void F_32 ( const struct V_86 * V_87 ,
const struct V_1 * V_2 )
{
F_22 ( V_87 -> V_92 -> V_74 ) ;
}
static int F_33 ( struct V_70 * V_24 , const struct V_1 * V_2 )
{
const struct V_8 * V_9 = F_2 ( V_2 ) ;
if ( F_34 ( V_24 , V_89 , F_35 ( V_9 -> V_11 ) ) )
goto V_93;
if ( F_34 ( V_24 , V_88 , F_35 ( V_9 -> V_25 ) ) )
goto V_93;
switch ( V_9 -> V_25 ) {
case V_61 :
case V_54 :
...
static int F_37 ( struct V_70 * V_24 , const struct V_1 * V_2 )
{
const struct V_8 * V_9 = F_2 ( V_2 ) ;
if ( F_34 ( V_24 , V_91 , F_35 ( V_9 -> V_72 ) ) )
goto V_93;
if ( F_34 ( V_24 , V_88 , F_35 ( V_9 -> V_25 ) ) )
goto V_93;
return 0 ;
...
F_38 ( const struct V_86 * V_87 ,
const struct V_79 * const V_80 [] )
{
if ( V_80 [ V_88 ] == NULL )
return F_39 ( - V_84 ) ;
if ( V_80 [ V_89 ] && V_80 [ V_91 ] )
return F_39 ( - V_84 ) ;
if ( V_80 [ V_89 ] )
return & V_95 ;
if ( V_80 [ V_91 ] )
