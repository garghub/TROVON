...
return - V_114 ;
V_110 = F_74 ( V_109 ) ;
V_2 -> V_4 = F_75 ( & V_105 -> V_56 , V_109 ) ;
if ( F_76 ( V_2 -> V_4 ) )
return F_77 ( V_2 -> V_4 ) ;
F_78 ( & V_2 -> V_8 ) ;
V_2 -> V_30 = V_110 < V_115 ;
if ( V_2 -> V_30 ) {
V_2 -> V_116 = F_5 ;
V_2 -> V_117 = F_9 ;
} else {
...
return V_111 ;
V_2 -> V_87 = V_87 ;
V_2 -> V_58 = V_6 ? V_6 -> V_58 : - V_122 ;
if ( F_31 ( V_2 -> V_58 ) ) {
char * V_123 = F_81 ( & V_105 -> V_56 , 16 , V_124 ) ;
if ( ! V_123 )
return - V_83 ;
snprintf ( V_123 , 16 , L_7 , V_107 ) ;
V_2 -> V_125 = F_82 ( V_2 -> V_58 ) ;
if ( F_83 ( V_2 -> V_125 , F_55 ,
V_126 | V_127 ,
V_123 , V_2 -> V_24 ) < 0 )
V_2 -> V_58 = - V_122 ;
}
F_84 ( V_24 , L_8 , ( V_128 ) V_109 -> V_129 , V_87 ) ;
return 0 ;
}
...
static int F_96 ( struct V_141 * V_56 )
{
struct V_104 * V_105 = F_97 ( V_56 ) ;
struct V_23 * V_24 = F_70 ( V_105 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
if ( F_56 ( V_24 ) ) {
F_59 ( V_24 ) ;
...
static int F_99 ( struct V_141 * V_56 )
{
struct V_104 * V_105 = F_97 ( V_56 ) ;
struct V_23 * V_24 = F_70 ( V_105 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
