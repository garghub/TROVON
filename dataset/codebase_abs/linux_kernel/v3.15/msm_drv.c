...
static void F_68 ( struct V_1 * V_2 , struct V_73 * V_74 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
static void F_93 ( struct V_105 * V_103 )
{
F_94 ( V_106 ,
F_5 ( V_106 ) , V_103 ) ;
}
int F_95 ( struct V_1 * V_2 , V_63 V_108 ,
struct V_109 * V_110 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_53 ;
...
if ( ! V_110 ) {
V_53 = F_97 ( V_2 , V_108 ) ? 0 : - V_112 ;
} else {
unsigned long V_113 = F_98 ( V_110 ) ;
...
void F_101 ( struct V_1 * V_2 , V_63 V_108 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
F_28 ( & V_2 -> V_38 ) ;
V_4 -> V_117 = F_102 ( V_108 , V_4 -> V_117 ) ;
while ( ! F_103 ( & V_4 -> V_57 ) ) {
struct V_120 * V_121 ;
V_121 = F_104 ( & V_4 -> V_57 ,
struct V_120 , V_122 . V_123 ) ;
if ( V_121 -> V_108 > V_4 -> V_117 )
break;
F_105 ( & V_121 -> V_122 . V_123 ) ;
F_106 ( V_4 -> V_35 , & V_121 -> V_122 ) ;
}
F_29 ( & V_2 -> V_38 ) ;
F_107 ( & V_4 -> V_55 ) ;
}
void F_108 ( struct V_124 * V_122 )
{
struct V_120 * V_121 = F_109 ( V_122 , struct V_120 , V_122 ) ;
V_121 -> V_125 ( V_121 ) ;
}
...
static int F_111 ( struct V_1 * V_2 , void * V_27 ,
struct V_73 * V_74 )
{
...
return F_112 ( V_2 , V_74 , args -> V_19 ,
args -> V_51 , & args -> V_134 ) ;
}
...
int V_53 ;
if ( args -> V_138 & ~ V_139 ) {
F_96 ( L_28 , args -> V_138 ) ;
return - V_12 ;
}
V_137 = F_114 ( V_2 , V_74 , args -> V_134 ) ;
if ( ! V_137 )
return - V_140 ;
V_53 = F_115 ( V_137 , args -> V_138 , & F_116 ( args -> V_110 ) ) ;
F_117 ( V_137 ) ;
return V_53 ;
}
...
if ( ! V_137 )
return - V_140 ;
args -> V_144 = F_121 ( V_137 ) ;
F_117 ( V_137 ) ;
return V_53 ;
}
static int F_122 ( struct V_1 * V_2 , void * V_27 ,
struct V_73 * V_74 )
{
struct V_145 * args = V_27 ;
if ( args -> V_143 ) {
F_96 ( L_29 , args -> V_143 ) ;
return - V_12 ;
}
return F_95 ( V_2 , args -> V_108 ,
& F_116 ( args -> V_110 ) ) ;
}
static int F_123 ( struct V_48 * V_2 )
{
struct V_1 * V_146 = F_124 ( V_2 ) ;
F_125 ( V_146 ) ;
return 0 ;
}
static int F_126 ( struct V_48 * V_2 )
{
struct V_1 * V_146 = F_124 ( V_2 ) ;
F_127 ( V_146 ) ;
return 0 ;
}
static int F_128 ( struct V_48 * V_2 , void * V_27 )
{
return V_2 -> V_50 == V_27 ;
}
static int F_129 ( struct V_48 * V_147 , struct V_147 * V_91 )
{
struct V_148 * V_149 = V_147 -> V_50 ;
unsigned V_150 ;
int V_53 ;
for ( V_150 = 0 ; ; V_150 ++ ) {
struct V_148 * V_101 ;
V_101 = F_130 ( V_149 , L_30 , V_150 ) ;
if ( ! V_101 )
break;
V_53 = F_131 ( V_91 , F_128 , V_101 ) ;
F_132 ( V_101 ) ;
if ( V_53 )
return V_53 ;
}
...
int V_150 ;
F_46 ( L_33 ) ;
for ( V_150 = 0 ; V_150 < F_5 ( V_151 ) ; V_150 ++ ) {
struct V_48 * V_2 ;
int V_53 ;
V_2 = F_134 ( & V_58 ,
NULL , V_151 [ V_150 ] ) ;
if ( ! V_2 ) {
F_50 ( V_147 , L_34 , V_151 [ V_150 ] ) ;
return - V_152 ;
}
V_53 = F_131 ( V_91 , F_133 , V_2 ) ;
if ( V_53 ) {
F_46 ( L_35 , V_53 ) ;
return V_53 ;
}
...
static int F_135 ( struct V_48 * V_2 )
{
return F_136 ( & V_153 , F_137 ( V_2 ) ) ;
}
static void F_138 ( struct V_48 * V_2 )
{
F_139 ( F_140 ( F_137 ( V_2 ) ) ) ;
}
static int F_141 ( struct V_13 * V_14 )
{
V_14 -> V_2 . V_154 = F_142 ( 32 ) ;
return F_143 ( & V_14 -> V_2 , & V_155 ) ;
}
static int F_144 ( struct V_13 * V_14 )
{
F_145 ( & V_14 -> V_2 , & V_155 ) ;
return 0 ;
}
