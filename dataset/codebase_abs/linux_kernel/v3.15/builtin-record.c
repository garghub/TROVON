...
{
static const char * V_122 [ V_146 ] = { L_38 , L_39 , L_40 } ;
F_71 ( L_41 , V_122 [ V_58 -> V_141 ] ) ;
if ( V_58 -> V_141 == V_144 )
F_71 ( L_42 ,
V_58 -> V_145 ) ;
}
...
static int F_74 ( const char * V_149 , const char * V_125 , void * V_150 )
{
struct V_11 * V_12 = V_150 ;
if ( ! strcmp ( V_149 , L_44 ) )
return F_68 ( V_125 , & V_12 -> V_58 ) ;
return F_75 ( V_149 , V_125 , V_150 ) ;
}
int F_76 ( int V_93 , const char * * V_94 , const char * T_9 V_23 )
{
int V_76 = - V_5 ;
...
return - V_5 ;
F_78 ( F_74 , V_12 ) ;
V_93 = F_79 ( V_93 , V_94 , V_153 , V_154 ,
V_155 ) ;
if ( ! V_93 && F_55 ( & V_12 -> V_58 . V_64 ) )
F_80 ( V_154 , V_153 ) ;
if ( V_156 && ! V_12 -> V_58 . V_64 . V_157 ) {
F_24 ( L_45
L_46 ) ;
F_80 ( V_154 , V_153 ) ;
}
...
L_52
L_53 ) ;
if ( V_12 -> V_160 || V_12 -> V_75 )
F_83 () ;
if ( V_12 -> V_45 -> V_161 == 0 &&
F_84 ( V_12 -> V_45 ) < 0 ) {
F_4 ( L_54 ) ;
goto V_162;
}
if ( V_12 -> V_58 . V_64 . V_163 && ! V_12 -> V_58 . V_164 )
V_12 -> V_58 . V_165 = true ;
V_76 = F_85 ( & V_12 -> V_58 . V_64 ) ;
if ( V_76 ) {
F_86 ( & V_12 -> V_58 . V_64 , V_76 , V_151 , V_152 ) ;
F_22 ( L_55 , V_151 ) ;
}
...
V_76 = - V_5 ;
if ( F_88 ( V_12 -> V_45 , & V_12 -> V_58 . V_64 ) < 0 )
F_80 ( V_154 , V_153 ) ;
if ( F_89 ( & V_12 -> V_58 ) ) {
V_76 = - V_167 ;
goto V_162;
