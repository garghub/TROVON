...
static T_6 F_71 ( struct V_85 * V_21 , struct V_120 * V_121 ,
char * V_7 )
{
...
static T_6 F_73 ( struct V_85 * V_21 , struct V_120 * V_121 ,
const char * V_7 , T_1 V_122 )
{
struct V_3 * V_4 = F_72 ( V_21 ) ;
unsigned long V_123 ;
int V_11 ;
V_11 = F_74 ( V_7 , 0 , & V_123 ) ;
if ( V_11 ) {
F_21 ( V_4 -> V_21 , L_31 ) ;
return V_11 ;
}
...
static int F_77 ( struct V_114 * V_114 , struct V_115 * V_125 )
{
...
static int F_80 ( struct V_114 * V_114 , struct V_115 * V_125 )
{
...
static T_6 F_82 ( struct V_115 * V_125 , char T_7 * V_130 , T_1 V_122 ,
T_8 * V_131 )
{
struct V_128 * V_129 = V_125 -> V_126 ;
struct V_3 * V_4 = V_129 -> V_4 ;
...
V_122 = F_84 ( V_122 , V_134 ) ;
if ( F_85 ( V_130 , V_65 , V_122 ) )
return - V_141 ;
V_134 -= V_122 ;
if ( V_134 > 0 ) {
V_129 -> V_139 += V_122 ;
...
static unsigned int F_86 ( struct V_115 * V_125 , struct V_142 * V_143 )
{
struct V_128 * V_129 = V_125 -> V_126 ;
struct V_3 * V_4 = V_129 -> V_4 ;
...
static int F_88 ( struct V_115 * V_125 , struct V_147 * V_148 )
{
struct V_128 * V_129 = V_125 -> V_126 ;
struct V_3 * V_4 = V_129 -> V_4 ;
...
V_4 -> V_156 = F_100 ( & V_166 ) ;
V_4 -> V_51 = F_101 ( V_163 , 0 ) ;
if ( ! V_4 -> V_51 ) {
...
F_103 ( V_177 , V_144 ) ;
F_103 ( V_178 , V_144 ) ;
V_4 -> V_76 = F_104 ( V_144 , F_91 , NULL ) ;
if ( ! V_4 -> V_76 ) {
F_21 ( & V_161 -> V_21 , L_41 ) ;
V_11 = - V_172 ;
goto V_179;
}
V_4 -> V_91 = F_105 ( V_163 , 0 ) ;
if ( V_4 -> V_91 == V_180 ) {
...
F_96 ( V_164 , V_4 ) ;
V_11 = F_107 ( & V_164 -> V_185 , & V_186 ) ;
if ( V_11 ) {
F_21 ( & V_161 -> V_21 , L_45 ) ;
goto V_187;
}
F_108 ( & V_161 -> V_21 , L_46 ) ;
return 0 ;
V_187:
F_69 ( V_4 ) ;
V_184:
...
static int F_113 ( struct V_160 * V_161 )
{
struct V_3 * V_4 = F_114 ( V_161 ) ;
struct V_85 * V_164 = V_4 -> V_127 . V_164 ;
F_115 ( & V_164 -> V_185 , & V_186 ) ;
F_69 ( V_4 ) ;
F_56 ( V_4 ) ;
F_109 ( & V_4 -> V_127 ) ;
F_110 ( V_4 -> V_91 ) ;
