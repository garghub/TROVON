...
static int F_188 ( struct V_205 * V_206 , struct V_98 * V_99 )
{
unsigned long V_298 ;
...
{
struct V_40 * V_41 ;
if ( ! V_99 -> V_324 || V_152 < 0 || V_152 >= V_99 -> V_324 -> V_158 )
return 0 ;
V_41 = V_99 -> V_324 -> V_325 [ V_152 ] ;
if ( ! V_41 -> type -> V_326 )
return 0 ;
return V_41 -> type -> V_326 ( V_41 , V_99 , V_4 ) ;
}
static inline int
...
( V_41 -> V_45 . V_327 == V_223 -> V_45 . V_327 || ! V_223 -> V_45 . V_327 ) &&
( V_41 -> V_44 . V_328 == V_223 -> V_328 || ! V_223 -> V_328 ) &&
V_41 -> V_44 . V_224 == V_223 -> V_224 &&
( V_223 -> V_329 || ( V_223 -> V_330 & ( 1 << V_41 -> V_44 . V_331 ) ) ||
! ( F_200 ( V_223 -> V_45 . V_20 , V_332 ) ) ) &&
! ( V_41 -> V_44 . V_224 != V_271 &&
F_199 ( V_223 , V_41 , V_28 ) ) ;
}
static inline int
F_201 ( const struct V_216 * V_223 , const struct V_333 * V_324 , int V_334 ,
unsigned short V_28 )
{
int V_152 = V_334 ;
if ( V_223 -> V_233 ) {
...
V_334 = - 1 ;
for (; V_152 < V_324 -> V_158 ; V_152 ++ ) {
if ( F_197 ( V_223 , V_324 -> V_325 [ V_152 ] , V_28 ) )
return ++ V_152 ;
if ( V_324 -> V_325 [ V_152 ] -> V_44 . V_224 != V_271 ) {
if ( V_334 == - 1 )
V_334 = - 2 - V_152 ;
break;
}
...
unsigned int V_28 , int V_335 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
int V_179 ;
if ( F_9 ( V_32 == NULL ) )
return - V_38 ;
V_32 -> V_336 ( V_99 , V_4 , V_335 ) ;
V_179 = F_203 ( V_99 , & V_4 -> V_197 ) ;
F_13 ( V_32 ) ;
return V_179 ;
}
static inline int F_204 ( const struct V_333 * V_324 , int V_337 , int * V_338 )
{
for (; V_337 < V_324 -> V_158 ; V_337 ++ ) {
if ( V_324 -> V_325 [ V_337 ] -> V_44 . V_224 != V_271 ) {
* V_338 = V_337 ;
return 1 ;
}
}
...
V_60 &= V_342 ;
V_340 = F_129 ( V_60 ) ;
if ( F_202 ( V_99 , & V_4 , V_28 , V_335 ) < 0 ) {
F_175 ( V_35 , V_343 ) ;
return 0 ;
}
F_207 ( V_99 , & V_4 , V_28 ) ;
if ( V_99 -> V_324 ) {
int V_123 ;
for ( V_123 = V_99 -> V_324 -> V_158 - 1 ; V_123 >= 0 ; V_123 -- ) {
struct V_40 * V_41 = V_99 -> V_324 -> V_325 [ V_123 ] ;
...
if ( ! V_81 ) {
struct V_79 * V_80 ;
V_80 = F_195 ( V_35 , & V_4 , V_28 , V_340 ,
F_126 , NULL ) ;
if ( F_127 ( V_80 ) )
V_81 = F_128 ( V_80 ) ;
else
...
if ( ! V_81 ) {
if ( V_99 -> V_324 && F_204 ( V_99 -> V_324 , 0 , & V_341 ) ) {
F_196 ( V_341 , V_99 , & V_4 ) ;
F_175 ( V_35 , V_346 ) ;
return 0 ;
}
return 1 ;
...
if ( V_81 -> V_213 == V_289 ) {
struct V_333 * V_324 ;
static struct V_333 V_347 ;
struct V_216 * V_236 [ V_237 ] ;
struct V_216 * V_348 [ V_237 ] ;
struct V_216 * * V_238 = V_236 ;
int V_349 = 0 ;
int V_123 , V_337 ;
if ( ( V_324 = V_99 -> V_324 ) == NULL )
V_324 = & V_347 ;
for ( V_339 = 0 ; V_339 < V_235 ; V_339 ++ ) {
if ( V_234 [ V_339 ] != V_81 &&
V_234 [ V_339 ] -> V_213 != V_289 ) {
F_175 ( V_35 , V_350 ) ;
goto V_326;
}
if ( V_349 + V_234 [ V_339 ] -> V_214 >= V_237 ) {
F_175 ( V_35 , V_351 ) ;
goto V_352;
}
for ( V_123 = 0 ; V_123 < V_234 [ V_339 ] -> V_214 ; V_123 ++ )
V_238 [ V_349 ++ ] = & V_234 [ V_339 ] -> V_215 [ V_123 ] ;
}
V_214 = V_349 ;
if ( V_235 > 1 ) {
F_208 ( V_348 , V_238 , V_214 , V_28 , V_35 ) ;
V_238 = V_348 ;
}
for ( V_123 = V_214 - 1 , V_337 = 0 ; V_123 >= 0 ; V_123 -- ) {
V_337 = F_201 ( V_238 [ V_123 ] , V_324 , V_337 , V_28 ) ;
if ( V_337 < 0 ) {
if ( V_337 < - 1 )
V_341 = - ( 2 + V_337 ) ;
F_175 ( V_35 , V_353 ) ;
...
static struct V_34 * F_210 ( struct V_34 * V_37 , T_3 V_356 )
{
...
struct V_242 * V_243 = (struct V_242 * ) V_37 ;
T_3 V_358 , V_359 ;
V_358 = F_221 ( V_37 -> V_269 ) ;
V_243 -> V_360 = V_358 ;
V_358 = F_222 ( V_37 -> V_101 , V_358 ) ;
V_359 = F_221 ( V_243 -> V_244 ) ;
V_243 -> V_359 = V_359 ;
if ( V_358 > V_359 )
V_358 = V_359 ;
F_223 ( V_37 , V_361 , V_358 ) ;
} while ( ( V_37 = V_37 -> V_57 ) );
}
static int F_211 ( struct V_242 * V_362 )
{
struct V_34 * V_37 = & V_362 -> V_7 . V_37 ;
struct V_242 * V_363 ;
T_3 V_364 ;
if ( ! F_224 ( V_37 -> V_254 , ( (struct V_242 * ) V_37 ) -> V_365 ) ||
( V_37 -> V_258 && ! F_225 ( V_37 -> V_258 ) ) )
return 0 ;
if ( V_37 -> V_46 & V_246 )
return 1 ;
V_363 = NULL ;
...
return 0 ;
V_364 = F_221 ( V_37 -> V_269 ) ;
if ( V_243 -> V_360 != V_364 ) {
V_363 = V_243 ;
V_243 -> V_360 = V_364 ;
}
if ( ! F_224 ( V_243 -> V_244 , V_243 -> V_366 ) )
return 0 ;
V_364 = F_221 ( V_243 -> V_244 ) ;
if ( V_243 -> V_359 != V_364 ) {
V_363 = V_243 ;
V_243 -> V_359 = V_364 ;
}
V_37 = V_37 -> V_269 ;
...
for (; ; ) {
V_37 = & V_363 -> V_7 . V_37 ;
V_364 = F_222 ( V_37 -> V_101 , V_364 ) ;
if ( V_364 > V_363 -> V_359 )
V_364 = V_363 -> V_359 ;
F_223 ( V_37 , V_361 , V_364 ) ;
if ( V_363 == V_362 )
break;
V_363 = (struct V_242 * ) V_363 -> V_7 . V_37 . V_57 ;
V_363 -> V_360 = V_364 ;
}
return 1 ;
}
...
{
return F_227 ( V_37 -> V_254 ) ;
}
static unsigned int F_228 ( const struct V_34 * V_37 )
{
unsigned int V_364 = F_229 ( V_37 , V_361 ) ;
return V_364 ? : F_221 ( V_37 -> V_254 ) ;
}
static struct V_367 * F_230 ( const struct V_34 * V_37 ,
struct V_98 * V_99 ,
const void * V_9 )
{
return V_37 -> V_254 -> V_93 -> V_368 ( V_37 , V_99 , V_9 ) ;
}
...
if ( F_156 ( V_247 -> V_370 == NULL ) )
V_247 -> V_370 = V_371 ;
if ( F_156 ( V_247 -> V_372 == NULL ) )
V_247 -> V_372 = F_210 ;
if ( F_156 ( V_247 -> V_373 == NULL ) )
V_247 -> V_373 = F_226 ;
if ( F_156 ( V_247 -> V_364 == NULL ) )
V_247 -> V_364 = F_228 ;
if ( F_156 ( V_247 -> V_374 == NULL ) )
V_247 -> V_374 = F_216 ;
if ( F_156 ( V_247 -> V_375 == NULL ) )
V_247 -> V_375 = F_215 ;
if ( F_156 ( V_247 -> V_368 == NULL ) )
V_247 -> V_368 = F_230 ;
if ( F_156 ( V_32 -> V_376 == NULL ) )
V_32 -> V_376 = F_219 ;
...
switch ( V_32 -> V_28 ) {
case V_29 :
V_377 = & V_35 -> V_101 . V_248 ;
break;
#if F_154 ( V_249 )
case V_30 :
V_377 = & V_35 -> V_101 . V_250 ;
break;
#endif
default:
F_46 () ;
...
static int F_240 ( struct V_378 * V_379 , unsigned long V_380 , void * V_381 )
{
struct V_257 * V_258 = F_241 ( V_381 ) ;
switch ( V_380 ) {
case V_382 :
F_217 ( F_206 ( V_258 ) ) ;
}
...
{
int V_384 ;
if ( F_243 ( ( void V_385 * * ) V_35 -> V_386 . V_387 ,
sizeof( struct V_388 ) ,
F_244 ( struct V_388 ) ) < 0 )
return - V_218 ;
V_384 = F_245 ( V_35 ) ;
if ( V_384 < 0 )
F_246 ( ( void V_385 * * ) V_35 -> V_386 . V_387 ) ;
return V_384 ;
}
...
if ( V_384 < 0 )
goto V_64;
F_261 ( & V_35 -> V_101 . V_403 ) ;
F_39 ( & V_35 -> V_101 . V_124 ) ;
F_262 ( & V_35 -> V_101 . V_404 ) ;
return 0 ;
V_64:
F_263 ( V_35 ) ;
V_402:
...
if ( V_177 )
F_271 ( V_407 , L_2 ,
V_177 -> V_408 , V_177 -> V_409 , V_177 -> V_410 ) ;
switch ( V_2 -> V_28 ) {
case V_29 :
F_271 ( V_407 , L_3 , & V_2 -> V_12 . V_10 ) ;
if ( V_2 -> V_13 != 32 )
F_271 ( V_407 , L_4 ,
V_2 -> V_13 ) ;
F_271 ( V_407 , L_5 , & V_2 -> V_9 . V_10 ) ;
if ( V_2 -> V_11 != 32 )
F_271 ( V_407 , L_6 ,
V_2 -> V_11 ) ;
break;
case V_30 :
F_271 ( V_407 , L_7 , V_2 -> V_12 . V_411 ) ;
if ( V_2 -> V_13 != 128 )
F_271 ( V_407 , L_4 ,
V_2 -> V_13 ) ;
F_271 ( V_407 , L_8 , V_2 -> V_9 . V_411 ) ;
if ( V_2 -> V_11 != 128 )
F_271 ( V_407 , L_6 ,
V_2 -> V_11 ) ;
break;
...
void F_272 ( struct V_54 * V_55 , int V_412 ,
T_9 V_413 , unsigned int V_185 , T_3 V_186 )
{
struct V_406 * V_407 ;
V_407 = F_273 ( L_9 ) ;
if ( V_407 == NULL )
return;
F_274 ( V_413 , V_185 , V_186 , V_407 ) ;
F_271 ( V_407 , L_10 , V_412 ) ;
F_270 ( V_55 , V_407 ) ;
F_275 ( V_407 ) ;
}
void F_105 ( struct V_54 * V_55 , int V_412 ,
T_9 V_413 , unsigned int V_185 , T_3 V_186 )
{
struct V_406 * V_407 ;
V_407 = F_273 ( L_11 ) ;
...
static bool F_276 ( const struct V_1 * V_414 ,
const struct V_1 * V_415 )
{
if ( V_414 -> V_20 == V_416 ) {
if ( V_415 -> V_28 == V_414 -> V_28 &&
F_277 ( & V_415 -> V_9 , & V_414 -> V_9 ,
V_414 -> V_28 ) &&
F_277 ( & V_415 -> V_12 , & V_414 -> V_12 ,
V_414 -> V_28 ) &&
V_415 -> V_11 == V_414 -> V_11 &&
V_415 -> V_13 == V_414 -> V_13 ) {
return true ;
}
} else {
if ( memcmp ( V_415 , V_414 , sizeof( * V_415 ) ) == 0 ) {
return true ;
}
}
return false ;
...
static int F_279 ( const struct V_417 * V_167 , const struct V_216 * V_418 )
{
int V_195 = 0 ;
if ( V_418 -> V_224 == V_167 -> V_224 && V_418 -> V_45 . V_20 == V_167 -> V_20 &&
( V_167 -> V_328 == 0 || V_418 -> V_328 == V_167 -> V_328 ) ) {
switch ( V_418 -> V_224 ) {
case V_225 :
case V_226 :
if ( F_277 ( & V_418 -> V_45 . V_9 , & V_167 -> V_419 ,
V_167 -> V_420 ) &&
F_277 ( & V_418 -> V_12 , & V_167 -> V_421 ,
V_167 -> V_420 ) ) {
V_195 = 1 ;
}
break;
...
struct V_417 * V_167 , int V_422 )
{
struct V_417 * V_423 ;
int V_123 , V_424 , V_425 = 0 ;
F_70 ( & V_81 -> V_61 ) ;
if ( F_9 ( V_81 -> V_62 . V_63 ) ) {
F_71 ( & V_81 -> V_61 ) ;
return - V_181 ;
...
for ( V_424 = 0 , V_423 = V_167 ; V_424 < V_422 ; V_424 ++ , V_423 ++ ) {
if ( ! F_279 ( V_423 , & V_81 -> V_215 [ V_123 ] ) )
continue;
V_425 ++ ;
if ( V_81 -> V_215 [ V_123 ] . V_224 != V_225 &&
V_81 -> V_215 [ V_123 ] . V_224 != V_226 )
continue;
memcpy ( & V_81 -> V_215 [ V_123 ] . V_45 . V_9 , & V_423 -> V_426 ,
sizeof( V_81 -> V_215 [ V_123 ] . V_45 . V_9 ) ) ;
memcpy ( & V_81 -> V_215 [ V_123 ] . V_12 , & V_423 -> V_427 ,
sizeof( V_81 -> V_215 [ V_123 ] . V_12 ) ) ;
V_81 -> V_215 [ V_123 ] . V_227 = V_423 -> V_428 ;
F_53 ( & V_81 -> V_100 ) ;
}
}
F_71 ( & V_81 -> V_61 ) ;
...
static int F_281 ( const struct V_417 * V_167 , int V_422 )
{
int V_123 , V_424 ;
if ( V_422 < 1 || V_422 > V_237 )
return - V_193 ;
for ( V_123 = 0 ; V_123 < V_422 ; V_123 ++ ) {
if ( F_277 ( & V_167 [ V_123 ] . V_419 , & V_167 [ V_123 ] . V_426 ,
V_167 [ V_123 ] . V_420 ) &&
F_277 ( & V_167 [ V_123 ] . V_421 , & V_167 [ V_123 ] . V_427 ,
V_167 [ V_123 ] . V_420 ) )
return - V_193 ;
if ( F_141 ( & V_167 [ V_123 ] . V_426 , V_167 [ V_123 ] . V_428 ) ||
F_141 ( & V_167 [ V_123 ] . V_427 , V_167 [ V_123 ] . V_428 ) )
return - V_193 ;
for ( V_424 = V_123 + 1 ; V_424 < V_422 ; V_424 ++ ) {
if ( ! memcmp ( & V_167 [ V_123 ] . V_419 , & V_167 [ V_424 ] . V_419 ,
sizeof( V_167 [ V_123 ] . V_419 ) ) &&
! memcmp ( & V_167 [ V_123 ] . V_421 , & V_167 [ V_424 ] . V_421 ,
sizeof( V_167 [ V_123 ] . V_421 ) ) &&
V_167 [ V_123 ] . V_20 == V_167 [ V_424 ] . V_20 &&
V_167 [ V_123 ] . V_224 == V_167 [ V_424 ] . V_224 &&
V_167 [ V_123 ] . V_328 == V_167 [ V_424 ] . V_328 &&
V_167 [ V_123 ] . V_420 == V_167 [ V_424 ] . V_420 )
return - V_193 ;
}
}
return 0 ;
}
int V_417 ( const struct V_1 * V_2 , T_4 V_60 , T_4 type ,
struct V_417 * V_167 , int V_422 ,
struct V_430 * V_337 , struct V_35 * V_35 )
{
int V_123 , V_179 , V_431 = 0 , V_432 = 0 ;
struct V_54 * V_81 = NULL ;
struct V_40 * V_41 , * V_433 ;
struct V_40 * V_434 [ V_237 ] ;
struct V_40 * V_435 [ V_237 ] ;
struct V_417 * V_423 ;
if ( ( V_179 = F_281 ( V_167 , V_422 ) ) < 0 )
goto V_64;
if ( ( V_81 = F_278 ( V_2 , V_60 , type , V_35 ) ) == NULL ) {
V_179 = - V_181 ;
goto V_64;
}
for ( V_123 = 0 , V_423 = V_167 ; V_123 < V_422 ; V_123 ++ , V_423 ++ ) {
if ( ( V_41 = F_282 ( V_423 , V_35 ) ) ) {
V_434 [ V_431 ] = V_41 ;
V_431 ++ ;
if ( ( V_433 = F_283 ( V_41 , V_423 ) ) ) {
V_435 [ V_432 ] = V_433 ;
V_432 ++ ;
} else {
V_179 = - V_429 ;
...
if ( ( V_179 = F_280 ( V_81 , V_167 , V_422 ) ) < 0 )
goto V_436;
if ( V_431 ) {
F_284 ( V_434 , V_431 ) ;
F_285 ( V_434 , V_431 ) ;
}
F_286 ( V_2 , V_60 , type , V_167 , V_422 , V_337 ) ;
F_28 ( V_81 ) ;
return 0 ;
V_64:
return V_179 ;
