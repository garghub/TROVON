...
T_4 type = V_154 -> type ;
T_4 V_204 = V_154 -> V_204 ;
if ( V_154 -> type == V_111 &&
V_154 -> V_204 == V_205 ) {
struct V_16 * V_17 = V_13 -> V_17 ;
T_7 V_206 = F_25 ( V_154 -> V_202 . V_207 . V_206 ) ;
T_1 V_160 = V_156 -> V_160 ;
if ( F_107 ( V_15 , V_129 + sizeof( V_153 ) ) == NULL )
goto V_208;
...
if ( F_107 ( V_15 , V_198 ) == NULL )
goto V_208;
F_108 ( V_15 ) ;
F_28 ( 12 , L_38 ,
& F_61 ( V_15 ) -> V_67 , & F_61 ( V_15 ) -> V_71 ,
type , V_204 , F_111 ( V_201 ) ) ;
F_48 ( V_15 , type , V_204 , V_201 ) ;
F_14 ( V_13 , V_15 ) ;
V_208:
F_112 ( V_15 ) ;
V_147 = V_157 ;
