...
if ( V_36 )
F_32 ( V_21 -> V_12 -> V_85 , V_36 ) ;
} else {
if ( V_38 && V_38 -> V_115 . V_116 &&
( ! F_33 ( & V_21 -> V_117 . V_118 .
V_115 , & V_38 -> V_115 ) ) ) {
V_23 = 0 ;
goto V_95;
}
...
static int F_37 ( struct V_20 * V_21 , T_1 V_120 ,
...
break;
case V_134 :
V_123 -> V_127 = F_38 ( V_12 -> V_123 . V_127 ) ;
...
int F_40 ( struct V_20 * V_21 , int V_121 )
{
struct V_122 V_135 ;
V_135 . V_127 = V_128 ;
V_135 . V_126 = true ;
return F_37 ( V_21 , V_33 ,
V_121 , & V_135 ) ;
}
...
char V_255 [ 32 ] ;
V_254 . V_252 = V_12 -> V_256 ;
sprintf ( V_255 , L_37 , V_254 . V_253 [ 2 ] , V_254 . V_253 [ 1 ] , V_254 . V_253 [ 0 ] , V_254 . V_253 [ 3 ] ) ;
snprintf ( V_250 , V_251 , V_257 , V_255 ) ;
F_8 ( V_12 -> V_4 , L_38 , V_250 ) ;
return 0 ;
}
...
V_280 . V_106 =
F_63 ( V_277 -> V_284 ) ;
V_280 . V_278 = F_39 ( V_278 ) ;
}
if ( F_9 ( V_21 , V_285 ,
V_120 , 0 , & V_280 , true ) ) {
F_5 ( V_21 -> V_12 -> V_4 , L_39 ) ;
return - 1 ;
}
return V_280 . V_15 ;
}
...
{
struct V_292 V_293 ;
V_293 . type = F_39 ( V_305 ) ;
V_293 . V_308 = F_39 ( V_306 ) ;
V_293 . V_309 = F_39 ( V_307 ) ;
