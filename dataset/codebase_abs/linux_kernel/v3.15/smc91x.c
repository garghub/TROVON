...
F_144 ( V_11 ) ;
V_11 -> V_266 = F_145 ( V_267 ) ;
V_11 -> V_268 = & V_269 ;
V_11 -> V_270 = & V_271 ;
F_146 ( & V_13 -> V_79 , F_38 , ( unsigned long ) V_11 ) ;
F_147 ( & V_13 -> V_139 , F_80 ) ;
V_13 -> V_11 = V_11 ;
...
V_257 = F_148 ( V_11 -> V_182 , F_89 , V_256 , V_11 -> V_277 , V_11 ) ;
if ( V_257 )
goto V_261;
#ifdef F_149
# ifdef F_150
...
int V_279 = F_151 ( V_11 -> V_277 , V_280 ,
V_281 , NULL ) ;
if ( V_279 >= 0 )
V_11 -> V_279 = V_279 ;
}
...
{
struct V_10 * V_284 = F_156 ( V_283 ) ;
struct V_12 * V_13 = F_5 ( V_284 ) ;
unsigned long V_28 ;
unsigned char V_285 , V_286 ;
void T_2 * V_205 ;
struct V_287 * V_288 ;
V_288 = F_157 ( V_283 , V_289 , L_62 ) ;
if ( ! V_288 )
return 0 ;
V_205 = F_158 ( V_288 -> V_290 , V_291 ) ;
if ( ! V_205 )
return - V_292 ;
F_159 ( V_28 ) ;
V_285 = F_160 ( V_205 + ( V_293 << V_262 ) ) & ~ V_294 ;
F_161 ( V_285 | V_294 , V_205 + ( V_293 << V_262 ) ) ;
F_160 ( V_205 + ( V_293 << V_262 ) ) ;
F_14 ( 100 ) ;
F_161 ( V_285 , V_205 + ( V_293 << V_262 ) ) ;
F_161 ( V_285 | V_295 , V_205 + ( V_293 << V_262 ) ) ;
V_286 = F_160 ( V_205 + ( V_296 << V_262 ) ) & ~ V_297 ;
if ( ! F_162 ( V_13 ) )
V_286 |= V_297 ;
F_161 ( V_286 , V_205 + ( V_296 << V_262 ) ) ;
F_163 ( V_28 ) ;
F_164 ( V_205 ) ;
F_74 ( 1 ) ;
return 0 ;
}
static int F_165 ( struct V_282 * V_283 ,
struct V_10 * V_284 )
{
struct V_287 * V_288 = F_157 ( V_283 , V_289 , L_62 ) ;
struct V_12 * V_13 V_298 = F_5 ( V_284 ) ;
if ( ! V_288 )
return 0 ;
if ( ! F_166 ( V_288 -> V_290 , V_291 , V_48 ) )
return - V_299 ;
return 0 ;
}
static void F_167 ( struct V_282 * V_283 ,
struct V_10 * V_284 )
{
struct V_287 * V_288 = F_157 ( V_283 , V_289 , L_62 ) ;
struct V_12 * V_13 V_298 = F_5 ( V_284 ) ;
if ( V_288 )
F_168 ( V_288 -> V_290 , V_291 ) ;
}
static inline void F_169 ( struct V_282 * V_283 , struct V_10 * V_284 )
{
if ( V_300 ) {
struct V_287 * V_288 = F_157 ( V_283 , V_289 , L_63 ) ;
struct V_12 * V_13 = F_5 ( V_284 ) ;
if ( ! V_288 )
return;
if( ! F_166 ( V_288 -> V_290 , V_301 , V_48 ) ) {
F_63 ( V_284 , L_64 ,
V_48 ) ;
return;
}
V_13 -> V_302 = F_158 ( V_288 -> V_290 , V_301 ) ;
}
}
static void F_170 ( struct V_282 * V_283 , struct V_10 * V_284 )
{
if ( V_300 ) {
struct V_12 * V_13 = F_5 ( V_284 ) ;
struct V_287 * V_288 = F_157 ( V_283 , V_289 , L_63 ) ;
...
V_13 -> V_302 = NULL ;
if ( V_288 )
F_168 ( V_288 -> V_290 , V_301 ) ;
}
}
static int F_171 ( struct V_282 * V_283 )
{
struct V_303 * V_304 = F_172 ( & V_283 -> V_11 ) ;
...
int V_216 ;
V_284 = F_173 ( sizeof( struct V_12 ) ) ;
if ( ! V_284 ) {
V_216 = - V_292 ;
goto V_309;
}
F_174 ( V_284 , & V_283 -> V_11 ) ;
V_13 = F_5 ( V_284 ) ;
V_13 -> V_17 . V_28 = 0 ;
if ( V_304 ) {
memcpy ( & V_13 -> V_17 , V_304 , sizeof( V_13 -> V_17 ) ) ;
V_13 -> V_310 = F_175 ( V_13 -> V_17 . V_28 ) ;
}
#if F_176 ( V_311 )
V_306 = F_177 ( F_178 ( V_312 ) , & V_283 -> V_11 ) ;
if ( V_306 ) {
struct V_313 * V_314 = V_283 -> V_11 . V_315 ;
T_4 V_108 ;
if ( ! F_179 ( V_314 , L_65 , & V_108 ) ) {
if ( V_108 & 1 )
...
V_288 = F_157 ( V_283 , V_289 , L_66 ) ;
if ( ! V_288 )
V_288 = F_180 ( V_283 , V_289 , 0 ) ;
if ( ! V_288 ) {
V_216 = - V_260 ;
goto V_325;
}
if ( ! F_166 ( V_288 -> V_290 , V_326 , V_48 ) ) {
V_216 = - V_299 ;
goto V_325;
}
V_307 = F_180 ( V_283 , V_327 , 0 ) ;
if ( ! V_307 ) {
V_216 = - V_260 ;
goto V_328;
}
...
F_167 ( V_283 , V_284 ) ;
V_328:
F_168 ( V_288 -> V_290 , V_326 ) ;
V_325:
F_184 ( V_284 ) ;
V_309:
F_185 ( L_67 , V_48 , V_216 ) ;
return V_216 ;
}
static int F_186 ( struct V_282 * V_283 )
{
struct V_10 * V_284 = F_156 ( V_283 ) ;
struct V_12 * V_13 = F_5 ( V_284 ) ;
struct V_287 * V_288 ;
F_187 ( V_284 ) ;
F_188 ( V_284 -> V_182 , V_284 ) ;
#ifdef F_149
...
static int F_189 ( struct V_333 * V_11 )
{
struct V_282 * V_283 = F_190 ( V_11 ) ;
struct V_10 * V_284 = F_156 ( V_283 ) ;
if ( V_284 ) {
if ( F_191 ( V_284 ) ) {
F_192 ( V_284 ) ;
...
static int F_193 ( struct V_333 * V_11 )
{
struct V_282 * V_283 = F_190 ( V_11 ) ;
struct V_10 * V_284 = F_156 ( V_283 ) ;
if ( V_284 ) {
