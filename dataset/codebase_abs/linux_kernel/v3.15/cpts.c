...
V_78 = ( V_2 -> V_5 >> V_102 ) & V_103 ;
if ( V_96 == F_3 ( V_2 ) &&
F_39 ( V_74 , V_97 , V_78 , V_98 ) ) {
...
int F_52 ( struct V_110 * V_111 , struct V_8 * V_8 ,
T_1 V_44 , T_1 V_112 )
{
#ifdef F_53
int V_113 , V_18 ;
unsigned long V_46 ;
V_8 -> V_47 = V_114 ;
V_8 -> clock = F_54 ( & V_8 -> V_47 , V_111 ) ;
if ( F_34 ( V_8 -> clock ) ) {
V_113 = F_55 ( V_8 -> clock ) ;
V_8 -> clock = NULL ;
return V_113 ;
}
F_56 ( & V_8 -> V_49 ) ;
V_8 -> V_32 . V_115 = F_13 ;
V_8 -> V_32 . V_116 = F_57 ( 32 ) ;
V_8 -> V_48 = V_44 ;
V_8 -> V_32 . V_44 = V_44 ;
V_8 -> V_32 . V_112 = V_112 ;
F_58 ( & V_8 -> V_27 ) ;
F_58 ( & V_8 -> V_22 ) ;
for ( V_18 = 0 ; V_18 < V_117 ; V_18 ++ )
F_17 ( & V_8 -> V_118 [ V_18 ] . V_23 , & V_8 -> V_22 ) ;
F_32 ( V_8 ) ;
F_6 ( V_8 , V_66 , V_67 ) ;
F_6 ( V_8 , V_68 , V_69 ) ;
F_20 ( & V_8 -> V_49 , V_46 ) ;
