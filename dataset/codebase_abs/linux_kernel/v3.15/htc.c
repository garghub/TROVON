...
if ( V_4 -> V_89 < sizeof( V_86 -> V_28 ) + sizeof( V_86 -> V_126 ) ) {
F_46 ( L_37 ,
V_4 -> V_89 ) ;
return - V_42 ;
}
...
V_122 = F_34 ( V_86 -> V_126 . V_122 ) ;
V_123 = F_34 ( V_86 -> V_126 . V_123 ) ;
if ( V_87 != V_127 ) {
F_46 ( L_38 , V_87 ) ;
return - V_42 ;
}
...
V_61 = sizeof( V_86 -> V_28 ) + sizeof( V_86 -> V_142 ) ;
F_48 ( V_9 , V_61 ) ;
memset ( V_9 -> V_13 , 0 , V_61 ) ;
V_86 = (struct V_85 * ) V_9 -> V_13 ;
V_86 -> V_28 . V_87 =
F_19 ( V_143 ) ;
V_29 |= F_49 ( V_138 , V_144 ) ;
if ( V_119 -> V_108 != V_99 ) {
V_29 |= V_145 ;
V_137 = true ;
}
...
L_46 ,
F_40 ( V_108 ) ,
V_134 -> V_63 , V_134 -> V_22 ) ;
V_121 -> V_149 = V_134 -> V_63 ;
if ( V_134 -> V_63 != V_150 ) {
F_46 ( L_47 ,
F_40 ( V_108 ) ,
V_134 -> V_63 ) ;
...
V_135 = (enum V_33 ) V_134 -> V_22 ;
V_136 = F_34 ( V_134 -> V_136 ) ;
V_139:
if ( V_135 >= V_43 )
return - V_83 ;
if ( V_136 == 0 )
...
return - V_83 ;
V_121 -> V_22 = V_135 ;
V_121 -> V_151 = F_34 ( V_134 -> V_136 ) ;
V_2 -> V_108 = V_119 -> V_108 ;
V_2 -> V_111 = V_119 -> V_128 ;
V_2 -> V_110 = F_34 ( V_134 -> V_136 ) ;
V_2 -> V_26 = V_138 ;
V_2 -> V_152 = V_4 -> V_47 ;
V_2 -> V_27 = V_2 -> V_110 /
V_4 -> V_47 ;
...
F_11 ( V_140 ,
L_49 ,
V_2 -> V_22 , V_2 -> V_78 , V_2 -> V_154 ) ;
if ( V_137 && V_2 -> V_25 ) {
V_2 -> V_25 = false ;
F_11 ( V_140 ,
L_50 ,
F_40 ( V_2 -> V_108 ) , V_135 ) ;
}
return V_63 ;
}
struct V_8 * F_52 ( int V_155 )
{
struct V_8 * V_9 ;
...
if ( ! V_9 )
return - V_141 ;
F_48 ( V_9 , sizeof( V_86 -> V_28 ) + sizeof( V_86 -> V_156 ) ) ;
