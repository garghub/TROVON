...
static inline void F_133 ( struct V_22 * V_23 , int V_167 )
{
unsigned long V_65 , V_174 ;
#ifdef F_134
...
F_135 ( V_192 , & V_23 -> V_83 ) ;
F_31 ( V_23 , 0 ) ;
F_115 ( V_23 , V_23 -> V_165 & 0xff ) ;
#ifdef F_113
F_114 ( V_23 , 0 ) ;
F_136 ( V_23 , V_23 -> V_165 & 0xff ) ;
#endif
}
} else {
F_31 ( V_23 , V_37 ) ;
F_138 ( V_23 , ( ( V_23 -> V_193 << 13 ) & 0xe000 )
| ( V_23 -> V_165 & 0x1fff ) ) ;
#ifdef F_113
F_114 ( V_23 , V_37 ) ;
F_136 ( V_23 , ( ( V_23 -> V_193 << 13 ) & 0xe000 )
| ( V_23 -> V_165 & 0x1fff ) ) ;
F_137 ( V_23 , F_34 ( V_23 ) ) ;
F_114 ( V_23 , 0 ) ;
#else
...
if ( V_23 -> V_157 ) {
unsigned long V_134 = F_139 ( V_23 -> V_118 ) ;
int V_103 = 0 ;
F_23 ( L_64 ) ;
while ( ! ( F_131 ( V_23 ) & V_189 ) ) {
V_103 ++ ;
F_122 ( 10 ) ;
if ( V_103 > 1000 ) break;
}
F_23 ( L_65 , F_131 ( V_23 ) ) ;
F_23 ( L_66 , V_103 ) ;
F_138 ( V_23 , ( V_134 >> 16 ) & 0xffff ) ;
V_103 = 0 ;
while ( ! ( F_131 ( V_23 ) & V_189 ) ) {
V_103 ++ ;
if ( V_103 > 1000 ) break;
...
F_23 ( L_66 , V_103 ) ;
F_138 ( V_23 , V_134 & 0xffff ) ;
V_174 = F_118 () ;
F_140 ( V_23 -> V_16 , V_194 ) ;
F_141 ( V_23 -> V_16 ) ;
F_121 ( V_174 ) ;
} else {
V_174 = F_118 () ;
F_119 ( V_23 -> V_16 ) ;
F_120 ( V_23 -> V_16 ) ;
F_140 ( V_23 -> V_16 , V_195 ) ;
F_142 ( V_23 -> V_16 , F_139 ( V_23 -> V_118 ) ) ;
F_143 ( V_23 -> V_16 , V_23 -> V_165 ) ;
F_141 ( V_23 -> V_16 ) ;
F_121 ( V_174 ) ;
}
...
static inline void F_144 ( struct V_22 * V_23 , int V_167 )
{
unsigned long V_65 ;
#ifdef F_134
F_23 ( L_67 , V_23 -> V_13 ) ;
...
F_119 ( V_23 -> V_16 ) ;
F_120 ( V_23 -> V_16 ) ;
F_140 ( V_23 -> V_16 , V_201 ) ;
if ( F_123 ( V_23 -> V_199 , V_23 -> V_200 , V_23 -> V_98 & 0x1fff ) ) {
F_142 ( V_23 -> V_16 , F_139 ( V_23 -> V_200 ) ) ;
} else {
...
static inline void F_146 ( struct V_22 * V_23 , int V_167 )
{
unsigned long V_65 , V_174 ;
F_46 ( & V_23 -> V_31 , V_65 ) ;
V_174 = F_118 () ;
...
F_135 ( V_23 -> V_199 -> V_13 , & V_23 -> V_164 ) ;
} else {
F_44 ( L_71 , V_23 -> V_13 ) ;
}
V_10:
...
static void F_147 ( struct V_22 * V_23 , int V_167 )
{
char * V_175 ;
switch ( V_167 & V_205 ) {
case V_207 :
