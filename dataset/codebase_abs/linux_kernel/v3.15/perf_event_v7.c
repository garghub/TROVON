...
static void F_60 ( int V_89 , T_1 V_1 )
{
switch ( V_89 ) {
case 0 :
...
static void F_63 ( T_1 * V_90 , T_1 * V_91 )
{
T_1 V_92 ;
T_1 V_93 ;
F_64 ( F_65 () ) ;
* V_90 = F_66 () ;
V_92 = * V_90 | F_67 ( 10 ) | F_67 ( 11 ) ;
F_68 ( V_92 ) ;
* V_91 = F_69 ( V_94 ) ;
V_93 = * V_91 | V_95 ;
F_70 ( V_94 , V_93 ) ;
}
static void F_71 ( T_1 V_90 , T_1 V_91 )
{
F_64 ( F_65 () ) ;
F_70 ( V_94 , V_91 ) ;
F_3 () ;
...
static T_1 F_72 ( unsigned int V_96 )
{
...
static void F_73 ( int V_7 , T_1 V_28 )
{
T_1 V_1 ;
T_1 V_101 ;
T_1 V_102 , V_103 ;
...
static T_1 F_74 ( T_1 V_1 , int V_104 )
{
T_1 V_101 ;
int V_106 ;
V_106 = V_104 * 8 ;
...
static int F_79 ( struct V_10 * V_11 , unsigned int V_96 ,
unsigned int V_104 )
{
int V_112 ;
struct V_13 * V_14 = & V_11 -> V_15 ;
...
return - V_115 ;
V_112 = F_79 ( V_11 , V_96 , V_104 ) ;
if ( F_38 ( V_112 , V_33 -> V_45 ) )
return - V_46 ;
}
V_7 = F_37 ( V_33 , V_11 ) ;
if ( V_7 < 0 && V_114 )
F_81 ( V_112 , V_33 -> V_45 ) ;
return V_7 ;
}
static void F_82 ( struct V_23 * V_33 ,
struct V_10 * V_11 )
{
int V_112 ;
struct V_13 * V_14 = & V_11 -> V_15 ;
...
static inline int F_83 ( struct V_5 * V_6 )
{
return - V_120 ;
}
