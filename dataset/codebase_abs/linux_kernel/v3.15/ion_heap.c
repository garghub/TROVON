...
F_45 ( & V_2 -> V_43 ) ;
F_46 ( & V_2 -> V_47 ) ;
V_2 -> V_56 = F_47 ( F_41 , V_2 ,
L_1 , V_2 -> V_57 ) ;
if ( F_48 ( V_2 -> V_56 ) ) {
F_49 ( L_2 ,
V_58 ) ;
return F_50 ( V_2 -> V_56 ) ;
}
F_51 ( V_2 -> V_56 , V_59 , & V_54 ) ;
return 0 ;
}
static unsigned long F_52 ( struct V_60 * V_60 ,
struct V_61 * V_62 )
{
struct V_1 * V_2 = F_53 ( V_60 , struct V_1 ,
V_60 ) ;
int V_63 = 0 ;
V_63 = F_33 ( V_2 ) / V_15 ;
if ( V_2 -> V_64 -> V_65 )
...
static unsigned long F_54 ( struct V_60 * V_60 ,
struct V_61 * V_62 )
{
struct V_1 * V_2 = F_53 ( V_60 , struct V_1 ,
V_60 ) ;
...
struct V_1 * F_57 ( struct V_76 * V_77 )
{
struct V_1 * V_2 = NULL ;
switch ( V_77 -> type ) {
case V_78 :
