...
static int F_72 ( struct V_117 * V_117 , const char * V_30 ,
...
static int F_73 ( struct V_117 * V_117 , const void T_1 * V_184 ,
unsigned int V_98 )
{
struct V_134 V_200 ;
...
return - V_128 ;
return F_72 ( V_117 , V_200 . V_30 , V_200 . V_89 ,
V_200 . V_177 , V_184 , V_98 ) ;
}
static inline int F_74 ( const struct V_19 * V_20 ,
const char * V_81 , char T_1 * V_201 )
{
char T_1 * V_200 = V_201 + ( ( char * ) V_20 - V_81 ) ;
char V_30 [ V_114 ] = {} ;
F_75 ( V_30 , V_20 -> V_15 . V_21 -> V_30 , sizeof( V_30 ) ) ;
if ( F_4 ( V_200 , V_30 , V_114 ) )
return - V_7 ;
return 0 ;
}
static inline int F_76 ( const struct V_8 * V_9 ,
const char * V_81 , char T_1 * V_201 )
{
char T_1 * V_200 = V_201 + ( ( char * ) V_9 - V_81 ) ;
char V_30 [ V_114 ] = {} ;
F_75 ( V_30 , V_9 -> V_15 . V_16 -> V_30 , sizeof( V_30 ) ) ;
if ( F_4 ( V_200 , V_30 , V_114 ) )
return - V_7 ;
return 0 ;
}
static inline int
F_77 ( struct V_31 * V_32 , const char * V_81 , char T_1 * V_201 )
{
int V_126 ;
char T_1 * V_200 ;
const struct V_74 * V_75 ;
...
V_75 = (struct V_74 * ) ( ( ( char * ) V_32 ) + V_32 -> V_99 ) ;
V_126 = F_19 ( V_32 , F_74 , V_81 , V_201 ) ;
if ( V_126 != 0 )
return V_126 ;
V_126 = F_21 ( V_32 , F_76 , V_81 , V_201 ) ;
if ( V_126 != 0 )
return V_126 ;
F_75 ( V_30 , V_75 -> V_15 . V_14 -> V_30 , sizeof( V_30 ) ) ;
if ( F_4 ( V_200 , V_30 , V_114 ) )
return - V_7 ;
return 0 ;
}
static int F_78 ( struct V_67 * V_75 ,
...
static int F_79 ( struct V_67 * V_75 , void T_1 * V_184 ,
...
V_126 = F_78 ( V_75 , V_174 , V_186 . V_89 ,
V_186 . V_177 , V_69 ) ;
if ( V_126 )
return V_126 ;
...
F_77 , V_93 , V_186 . V_93 ) ;
}
static int F_80 ( struct V_204 * V_205 ,
int V_202 , void T_1 * V_184 , unsigned int V_98 )
{
int V_126 ;
struct V_117 * V_117 = F_81 ( V_205 ) ;
if ( ! F_82 ( V_117 -> V_206 , V_207 ) )
return - V_208 ;
switch ( V_202 ) {
case V_209 :
...
static int F_83 ( struct V_204 * V_205 , int V_202 , void T_1 * V_184 , int * V_98 )
{
int V_126 ;
struct V_134 V_186 ;
struct V_67 * V_75 ;
...
case V_203 :
case V_213 :
V_126 = F_79 ( V_75 , V_184 , V_98 , V_202 ) ;
F_28 ( & V_180 ) ;
break;
default:
F_28 ( & V_180 ) ;
...
{
F_85 ( F_86 ( sizeof( struct V_19 ) ) <
F_87 ( sizeof( struct V_214 ) ) ) ;
return ( int ) F_86 ( sizeof( struct V_19 ) ) -
F_87 ( sizeof( struct V_214 ) ) ;
}
static int F_88 ( const struct V_123 * V_21 ,
unsigned int V_215 )
{
if ( F_89 ( V_21 -> V_216 == - 1 ) )
return F_86 ( V_215 ) - F_87 ( V_215 ) ;
return F_90 ( V_21 ) ;
}
static int F_91 ( struct V_19 * V_20 , void T_1 * * V_217 ,
unsigned int * V_178 )
{
const struct V_123 * V_21 = V_20 -> V_15 . V_21 ;
struct V_214 T_1 * V_218 = * V_217 ;
int V_219 = F_88 ( V_21 , V_20 -> V_127 ) ;
T_4 V_220 = V_20 -> V_127 - V_219 ;
F_92 ( V_219 >= V_20 -> V_127 ) ;
if ( F_4 ( V_218 -> V_15 . V_30 , V_21 -> V_30 ,
strlen ( V_21 -> V_30 ) + 1 ) || F_93 ( V_220 , & V_218 -> V_127 ) )
return - V_7 ;
if ( V_21 -> V_221 ) {
...
F_92 ( V_219 >= V_75 -> V_163 ) ;
if ( F_4 ( V_218 -> V_15 . V_30 , V_14 -> V_30 ,
strlen ( V_14 -> V_30 ) + 1 ) || F_93 ( V_222 , & V_218 -> V_127 ) )
return - V_7 ;
if ( V_14 -> V_221 ) {
...
unsigned int * V_178 )
{
return F_94 ( (struct V_74 * ) V_9 ,
V_217 , V_178 ) ;
}
static int F_97 ( struct V_31 * V_32 , void T_1 * * V_217 ,
unsigned int * V_178 )
{
struct V_74 * V_75 ;
...
V_224 = * V_178 ;
* V_217 += sizeof( * V_223 ) ;
V_126 = F_19 ( V_32 , F_91 , V_217 , V_178 ) ;
if ( V_126 )
return V_126 ;
V_125 = V_32 -> V_125 - ( V_224 - * V_178 ) ;
V_126 = F_21 ( V_32 , F_96 , V_217 , V_178 ) ;
if ( V_126 )
return V_126 ;
V_99 = V_32 -> V_99 - ( V_224 - * V_178 ) ;
V_75 = (struct V_74 * ) ( ( char * ) V_32 + V_32 -> V_99 ) ;
V_126 = F_94 ( V_75 , V_217 , V_178 ) ;
if ( V_126 )
return V_126 ;
V_143 = V_32 -> V_143 - ( V_224 - * V_178 ) ;
if ( F_93 ( V_125 , & V_223 -> V_125 ) ||
F_93 ( V_99 , & V_223 -> V_99 ) ||
F_93 ( V_143 , & V_223 -> V_143 ) )
return - V_7 ;
* V_178 -= sizeof( * V_223 ) ;
return 0 ;
}
static int F_98 ( struct V_19 * V_20 , int * V_219 )
{
* V_219 += F_88 ( V_20 -> V_15 . V_21 , V_20 -> V_127 ) ;
* V_219 += F_84 () ;
return 0 ;
}
static int F_99 ( struct V_8 * V_9 , int * V_219 )
{
* V_219 += F_95 ( V_9 -> V_15 . V_16 ) ;
* V_219 += F_84 () ;
return 0 ;
}
static int F_100 ( const struct V_31 * V_32 ,
...
F_19 ( V_32 , F_98 , & V_219 ) ;
F_21 ( V_32 , F_99 , & V_219 ) ;
V_75 = ( const struct V_74 * ) ( ( char * ) V_32 + V_32 -> V_99 ) ;
V_219 += F_95 ( V_75 -> V_15 . V_14 ) ;
V_219 += F_84 () ;
V_136 -> V_138 -= V_219 ;
V_126 = F_101 ( V_5 , V_227 , V_219 ) ;
if ( V_126 )
return V_126 ;
for ( V_28 = 0 ; V_28 < V_141 ; V_28 ++ ) {
...
static int F_103 ( const struct V_82 * V_225 ,
struct V_226 * V_136 )
{
unsigned int V_178 = V_225 -> V_138 ;
const void * V_93 = V_225 -> V_93 ;
V_136 -> V_138 = V_178 ;
F_104 ( V_5 , V_225 -> V_69 ) ;
return F_50 ( V_93 , V_178 , F_100 , V_225 ,
V_93 , V_136 ) ;
}
static int F_105 ( struct V_67 * V_75 ,
...
if ( V_202 == V_203 )
V_126 = F_103 ( V_75 -> V_83 , & V_135 ) ;
else
V_126 = F_103 ( & V_229 , & V_135 ) ;
if ( V_126 )
return V_126 ;
...
V_126 = F_78 ( V_75 , V_174 , F_107 ( V_186 . V_89 ) ,
V_186 . V_177 , V_229 . V_69 ) ;
if ( V_126 )
return V_126 ;
V_167 = F_107 ( V_186 . V_93 ) ;
return F_50 ( V_229 . V_93 , V_229 . V_138 ,
F_97 , & V_167 , & V_186 . V_138 ) ;
}
...
static int F_109 ( struct V_230 * V_231 ,
void * V_18 , unsigned int V_232 )
{
if ( V_231 -> V_234 == NULL )
goto V_235;
F_92 ( V_231 -> V_233 + V_232 > V_231 -> V_236 ) ;
memcpy ( V_231 -> V_234 + V_231 -> V_233 , V_18 , V_232 ) ;
V_235:
V_231 -> V_237 += V_232 ;
return F_108 ( V_231 , V_232 ) ;
}
static int F_110 ( struct V_230 * V_231 , unsigned int V_232 )
{
char * V_238 = V_231 -> V_234 ;
F_92 ( V_238 && V_231 -> V_233 > V_231 -> V_236 ) ;
if ( V_238 != NULL && V_232 > 0 )
memset ( V_238 + V_231 -> V_233 , 0 , V_232 ) ;
return F_108 ( V_231 , V_232 ) ;
}
static int F_111 ( struct V_214 * V_239 ,
enum V_240 V_240 ,
struct V_230 * V_231 ,
...
F_75 ( V_30 , V_239 -> V_15 . V_30 , sizeof( V_30 ) ) ;
if ( V_231 -> V_234 )
...
V_231 -> V_237 += V_127 ;
V_242 = F_86 ( V_243 ) - V_243 ;
if ( V_242 > 0 && V_1 ) {
F_92 ( V_231 -> V_236 <= V_242 ) ;
F_92 ( V_231 -> V_233 - ( V_127 + V_219 ) + V_243 > V_231 -> V_236 - V_242 ) ;
memset ( V_1 + V_243 , 0 , V_242 ) ;
}
return V_219 + V_127 ;
}
static int F_112 ( struct V_214 * V_249 ,
...
V_126 = F_109 ( V_231 , V_252 , sizeof( * V_249 ) ) ;
if ( V_126 < 0 )
return V_126 ;
V_250 -= sizeof( * V_249 ) ;
V_126 = F_110 ( V_231 , F_84 () ) ;
if ( V_126 < 0 )
return V_126 ;
if ( V_249 -> V_127 > V_250 )
return - V_128 ;
V_250 -= V_249 -> V_127 ;
V_126 = F_111 ( V_249 , type , V_231 , V_81 ) ;
if ( V_126 < 0 )
return V_126 ;
F_92 ( V_126 < V_249 -> V_127 ) ;
...
if ( V_253 )
V_253 -> V_127 = V_126 ;
F_113 ( type == V_247 && V_250 ) ;
V_249 = (struct V_214 * ) V_252 ;
}
return V_251 ;
}
static int F_114 ( struct V_31 * V_25 , const unsigned char * V_81 ,
unsigned int * V_254 ,
struct V_230 * V_231 )
{
...
return F_109 ( V_231 , V_25 , sizeof( struct V_79 ) ) ;
}
if ( * V_254 < sizeof( * V_25 ) || V_25 -> V_143 < sizeof( * V_25 ) )
return - V_128 ;
V_255 = V_231 -> V_237 ;
V_126 = F_109 ( V_231 , V_25 ,
F_115 ( struct V_31 , V_125 ) ) ;
if ( V_126 < 0 )
return V_126 ;
...
V_126 = F_112 ( V_249 , V_178 , V_28 , V_231 , V_81 ) ;
if ( V_126 < 0 )
return V_126 ;
V_256 += V_126 ;
if ( V_258 && V_256 ) {
...
static int F_116 ( unsigned char * V_18 , unsigned int V_260 ,
struct V_230 * V_231 )
{
unsigned int V_261 = V_260 ;
int V_126 ;
V_126 = F_50 ( V_18 , V_260 , F_114 , V_18 ,
& V_261 , V_231 ) ;
if ( V_126 < 0 )
return V_126 ;
F_113 ( V_261 ) ;
...
if ( V_186 . V_177 >= V_187 / sizeof( struct V_71 ) )
return - V_173 ;
memcpy ( V_135 , & V_186 , F_115 ( struct V_134 , V_91 ) ) ;
for ( V_28 = 0 ; V_28 < V_141 ; V_28 ++ )
V_135 -> V_91 [ V_28 ] = F_107 ( V_186 . V_91 [ V_28 ] ) ;
V_135 -> V_177 = V_186 . V_177 ;
V_135 -> V_89 = F_107 ( V_186 . V_89 ) ;
V_135 -> V_93 = F_107 ( V_186 . V_93 ) ;
return 0 ;
}
static int F_118 ( struct V_117 * V_117 , void T_1 * V_184 ,
unsigned int V_98 )
{
...
V_263 = V_136 -> V_93 ;
F_119 ( V_5 ) ;
F_104 ( V_5 , V_186 . V_69 ) ;
V_126 = F_116 ( V_263 , V_186 . V_138 , & V_231 ) ;
if ( V_126 < 0 )
goto V_264;
F_102 ( L_49 ,
...
static int F_122 ( struct V_117 * V_117 , void T_1 * V_184 ,
unsigned int V_98 )
{
struct V_226 V_200 ;
if ( F_61 ( & V_200 , V_184 , sizeof( V_200 ) ) )
return - V_7 ;
if ( V_98 != sizeof( V_200 ) + V_200 . V_177 * sizeof( struct V_71 ) )
return F_73 ( V_117 , V_184 , V_98 ) ;
return F_72 ( V_117 , V_200 . V_30 , F_107 ( V_200 . V_89 ) ,
V_200 . V_177 , V_184 , V_98 ) ;
}
...
switch ( V_202 ) {
case V_209 :
V_126 = F_118 ( V_117 , V_184 , V_98 ) ;
break;
case V_210 :
V_126 = F_122 ( V_117 , V_184 , V_98 ) ;
break;
default:
V_126 = - V_128 ;
}
...
static int F_124 ( struct V_204 * V_205 , int V_202 ,
...
return F_83 ( V_205 , V_202 , V_184 , V_98 ) ;
if ( F_61 ( & V_186 , V_184 , sizeof( V_186 ) ) )
return - V_7 ;
V_75 = F_31 ( V_117 , V_186 . V_30 , & V_126 , & V_180 ) ;
if ( ! V_75 )
...
case V_203 :
case V_213 :
if ( F_79 ( V_75 , V_184 , V_98 , V_202 ) == 0 )
V_126 = 0 ;
else
V_126 = F_105 ( V_75 , V_184 , V_98 , V_202 ) ;
break;
default:
V_126 = - V_128 ;
}
