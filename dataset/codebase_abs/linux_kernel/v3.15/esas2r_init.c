...
F_84 ( V_2 ) ;
if ( ( V_2 -> V_11 -> V_180 == V_181 )
&& ( V_2 -> V_11 -> V_182 & V_183 ) )
V_2 -> V_45 |= V_184 ;
if ( F_50 ( V_184 , & V_2 -> V_45 ) )
V_2 -> V_45 |= V_185 ;
if ( V_2 -> V_11 -> V_182 == V_186 )
V_2 -> V_45 |= V_187 ;
V_171 = ( V_18 * ) * V_170 ;
for ( V_38 = 0 , V_173 = V_2 -> V_126 ; V_38 < V_158 ; V_38 ++ , V_173 ++ ) {
V_173 -> V_7 = V_160 ;
F_40 ( & V_173 -> V_25 , & V_2 -> V_83 ) ;
if ( ! F_1 ( V_2 , V_173 , V_188 ) ) {
if ( V_38 < V_189 )
return false ;
break;
}
}
V_2 -> V_190 = V_86 + V_162 ;
V_2 -> V_123 . V_7 = V_2 -> V_190 *
sizeof( struct
V_163 ) ;
if ( ! F_1 ( V_2 , & V_2 -> V_123 , V_191 ) ) {
F_11 ( L_70 ) ;
return false ;
}
V_2 -> V_124 . V_7 = V_2 -> V_190 *
sizeof( struct V_164 ) ;
...
V_2 -> V_192 = (struct V_156 * ) V_171 ;
V_171 += sizeof( struct V_156 ) ;
V_2 -> V_193 = V_171 ;
V_171 += V_157 ;
V_171 = F_4 ( V_171 , 8 ) ;
V_2 -> V_194 = ( T_1 volatile * ) V_171 ;
V_171 += sizeof( T_1 ) ;
if ( ! F_50 ( V_195 , & V_2 -> V_47 ) )
F_88 ( V_2 ) ;
* V_170 = ( void * ) V_171 ;
...
V_123 .
V_8 ;
for ( V_38 = 0 ; V_38 < V_2 -> V_190 ; V_38 ++ ) {
V_172 -> V_196 = 0 ;
V_172 -> V_197 = 0 ;
V_172 -> V_198 = F_90 ( V_199
| ( sizeof( union
V_22 )
/
sizeof( T_1 ) ) ) ;
...
T_2 V_204 ;
T_1 V_205 ;
if ( F_50 ( V_206 , & V_2 -> V_47 ) )
goto V_207;
F_92 ( V_2 , V_208 , V_209 ) ;
F_93 ( V_2 , V_208 ) ;
V_202 = F_94 ( V_210 ) ;
while ( true ) {
F_95 ( V_2 ) ;
V_203 = F_96 ( V_2 , V_211 ) ;
if ( V_203 == 0xFFFFFFFF ) {
if ( ( F_94 ( V_210 ) - V_202 ) > 2000 )
return F_83 ( V_2 ,
L_71 ) ;
} else if ( V_203 & V_212 ) {
T_1 V_213 = ( V_203 & V_214 ) ;
F_92 ( V_2 , V_211 ,
V_203 ) ;
if ( V_213 == V_215 ) {
F_23 ( V_93 , & V_2 -> V_47 ) ;
...
F_97 ( F_98 ( 50 ) ) ;
if ( ( F_94 ( V_210 ) - V_202 ) > 3000 ) {
F_11 ( L_75 ) ;
break;
}
}
V_207:
V_205 = F_96 ( V_2 , V_220 ) ;
V_205 &= ~ V_221 ;
F_92 ( V_2 , V_220 , V_205 ) ;
V_205 = F_96 ( V_2 , V_222 ) ;
V_205 &= ~ V_223 ;
F_92 ( V_2 , V_222 , V_205 ) ;
V_204 = V_2 -> V_123 . V_9 ;
F_92 ( V_2 , V_224 ,
F_44 ( V_204 ) ) ;
F_92 ( V_2 , V_225 ,
...
* V_2 -> V_194 =
V_2 -> V_230 =
V_2 -> V_231 = V_2 -> V_190 - 1 ;
F_23 ( V_232 , & V_2 -> V_47 ) ;
F_92 ( V_2 , V_233 , V_234 |
V_2 -> V_230 ) ;
F_92 ( V_2 , V_235 , V_236 |
V_2 -> V_230 ) ;
F_92 ( V_2 , V_237 , V_238 |
V_2 -> V_230 ) ;
F_92 ( V_2 , V_239 ,
V_240 | V_2 -> V_230 ) ;
V_205 = F_96 ( V_2 , V_241 ) ;
V_205 &= ~ ( V_242 | V_243 ) ;
F_92 ( V_2 , V_241 ,
( V_205 | V_244 | V_245 ) ) ;
V_205 = F_96 ( V_2 , V_246 ) ;
V_205 &= ~ ( V_247 | V_248 ) ;
F_92 ( V_2 , V_246 ,
( V_205 | V_249 |
V_250 ) ) ;
...
V_205 = F_96 ( V_2 , V_222 ) ;
V_205 &= ~ ( V_256 | V_257 ) ;
V_205 |= V_258 | ( V_2 -> V_190 << V_259 ) ;
F_92 ( V_2 , V_222 , V_205 ) ;
F_92 ( V_2 , V_218 , V_260 ) ;
V_202 = F_94 ( V_210 ) ;
while ( true ) {
V_203 = F_96 ( V_2 , V_211 ) ;
if ( V_203 & V_260 ) {
...
V_203 = F_96 ( V_2 , V_261 ) ;
if ( V_203 & V_262 )
F_23 ( V_263 , & V_2 -> V_45 ) ;
else
F_60 ( V_263 , & V_2 -> V_45 ) ;
F_92 ( V_2 , V_264 , V_265 ) ;
F_92 ( V_2 , V_266 , V_267 ) ;
return true ;
}
...
0 ,
NULL ) ;
V_270 = (struct V_269 * ) & V_20 -> V_28 -> V_275 . V_276 . V_277 ;
V_270 -> V_160 = F_90 ( V_160 ) ;
V_270 -> V_278 = F_90 ( V_273 . V_279 ) ;
V_20 -> V_47 |= V_280 ;
V_2 -> V_94 = V_281 ;
break;
}
...
V_286 = F_103 (
V_20 -> V_288 . V_289 . V_286 ) ;
V_284 = F_104 ( V_286 ) ;
V_285 = F_105 ( V_286 ) ;
V_2 -> V_287 += ( V_284 << 16 ) + ( V_285 << 24 ) ;
} else {
F_11 ( L_78 ) ;
}
if ( ( F_50 ( V_184 , & V_2 -> V_45 ) )
|| ( F_106 ( V_2 -> V_287 ) > 0x00524702 ) ) {
F_11 ( L_79 ) ;
F_102 ( V_2 ,
V_20 ,
V_292 ,
sizeof( struct V_269 ) ,
NULL ) ;
V_20 -> V_28 -> V_275 . V_293 = F_107 (
struct V_294 ,
V_276 . V_295 ) ;
V_20 -> V_28 -> V_275 . V_276 . V_296 . V_297 =
F_90 ( sizeof( struct V_269 ) ) ;
V_20 -> V_28 -> V_275 . V_276 . V_296 . V_196 = F_108 (
V_20 -> V_27 -> V_9 +
sizeof( union V_22 ) ) ;
V_20 -> V_47 |= V_280 ;
V_2 -> V_94 = V_298 ;
...
bool F_49 ( struct V_1 * V_2 , bool V_306 )
{
bool V_307 = false ;
struct V_19 * V_20 ;
T_1 V_38 ;
...
sprintf ( V_2 -> V_310 , L_83 ,
( int ) F_104 ( F_118 ( V_2 -> V_287 ) ) ,
( int ) F_105 ( F_118 ( V_2 -> V_287 ) ) ) ;
F_11 ( L_84 , V_2 -> V_310 ) ;
if ( F_50 ( V_206 , & V_2 -> V_47 )
&& ( F_50 ( V_92 , & V_2 -> V_47 ) ) ) {
F_51 ( V_2 ) ;
...
bool F_82 ( struct V_1 * V_2 , bool V_306 )
{
bool V_334 ;
F_60 ( V_332 , & V_2 -> V_47 ) ;
F_84 ( V_2 ) ;
...
{
if ( F_50 ( V_335 , & V_2 -> V_47 ) )
return false ;
if ( F_96 ( V_2 , V_211 ) == 0xFFFFFFFF ) {
F_23 ( V_335 , & V_2 -> V_47 ) ;
return false ;
}
return true ;
