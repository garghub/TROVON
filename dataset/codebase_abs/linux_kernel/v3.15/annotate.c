...
V_104 *= V_87 -> V_100 ;
printf ( L_58 ,
V_104 , V_104 , L_59 , V_165 , V_166 ) ;
V_171 = V_104 + V_169 + V_170 ;
printf ( L_60 ,
V_171 , V_171 , V_172 ) ;
if ( V_173 )
F_94 ( V_36 , V_87 ) ;
F_98 (pos, &notes->src->source, node) {
if ( V_164 && V_91 == NULL ) {
V_91 = V_76 ;
V_167 = 0 ;
}
...
break;
if ( V_167 == V_164 )
V_91 = F_63 ( V_91 -> V_75 . V_99 , F_99 ( * V_91 ) , V_75 ) ;
else
++ V_167 ;
break;
}
...
void F_102 ( struct V_73 * V_74 )
{
struct V_65 * V_76 , * V_174 ;
F_103 (pos, n, head, node) {
F_64 ( & V_76 -> V_75 ) ;
F_45 ( V_76 ) ;
}
}
static T_1 F_104 ( struct V_65 * V_66 , T_4 * V_175 )
{
T_1 V_27 ;
if ( V_66 -> V_17 == - 1 )
return fprintf ( V_175 , L_20 , V_66 -> line ) ;
V_27 = fprintf ( V_175 , L_11 V_14 L_15 , V_66 -> V_17 , V_66 -> V_5 ) ;
if ( V_66 -> V_2 . V_4 [ 0 ] != '\0' ) {
V_27 += fprintf ( V_175 , L_61 , 6 - ( int ) V_27 , L_22 ,
V_66 -> V_2 . V_4 ) ;
}
return V_27 + fprintf ( V_175 , L_10 ) ;
}
T_1 F_105 ( struct V_73 * V_74 , T_4 * V_175 )
{
struct V_65 * V_76 ;
T_1 V_27 = 0 ;
F_98 (pos, head, node)
V_27 += F_104 ( V_76 , V_175 ) ;
return V_27 ;
}
int F_106 ( struct V_35 * V_36 , struct V_34 * V_34 ,
struct V_86 * V_87 , bool V_176 ,
