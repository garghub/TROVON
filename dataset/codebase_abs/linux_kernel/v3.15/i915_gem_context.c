...
if ( F_58 ( & V_7 -> V_65 ) )
return 0 ;
F_40 ( ! V_7 -> V_57 [ V_61 ] . V_59 ) ;
F_59 (ring, dev_priv, i) {
V_23 = F_60 ( V_57 , V_57 -> V_59 ) ;
if ( V_23 )
return V_23 ;
}
return 0 ;
}
static int F_61 ( int V_45 , void * V_66 , void * V_67 )
{
...
F_65 ( & V_4 -> V_49 ) ;
V_38 -> V_71 =
F_39 ( V_4 , V_38 , F_66 ( V_4 ) ) ;
F_67 ( & V_4 -> V_49 ) ;
if ( F_42 ( V_38 -> V_71 ) ) {
F_68 ( & V_38 -> V_43 ) ;
return F_46 ( V_38 -> V_71 ) ;
}
return 0 ;
}
...
{
int V_23 ;
if ( F_12 ( V_57 -> V_4 ) && V_57 -> V_75 ) {
V_23 = V_57 -> V_76 ( V_57 , V_77 , 0 ) ;
if ( V_23 )
return V_23 ;
}
V_23 = F_74 ( V_57 , 6 ) ;
...
struct V_31 * V_87 = V_57 -> V_60 ;
struct V_1 * V_2 = F_23 ( V_86 ) ;
T_2 V_74 = 0 ;
int V_23 , V_54 ;
if ( V_87 != NULL && V_57 == & V_7 -> V_57 [ V_61 ] ) {
F_40 ( V_87 -> V_33 == NULL ) ;
F_40 ( ! F_80 ( V_87 -> V_33 ) ) ;
}
if ( V_87 == V_86 && V_87 -> V_88 == V_57 && ! V_86 -> V_46 )
return 0 ;
...
V_23 = F_81 ( V_86 -> V_33 , false ) ;
if ( V_23 )
goto V_90;
if ( ! V_86 -> V_33 -> V_92 ) {
struct V_16 * V_17 = F_82 ( V_86 -> V_33 ,
& V_7 -> V_53 . V_5 ) ;
V_17 -> V_93 ( V_17 , V_86 -> V_33 -> V_94 , V_95 ) ;
}
if ( ! V_86 -> V_96 || F_62 ( V_86 ) )
V_74 |= V_97 ;
V_23 = F_73 ( V_57 , V_86 , V_74 ) ;
if ( V_23 )
goto V_90;
...
if ( V_87 != NULL ) {
V_87 -> V_33 -> V_5 . V_99 = V_100 ;
F_84 ( F_85 ( V_87 -> V_33 ) , V_57 ) ;
V_87 -> V_33 -> V_101 = 1 ;
F_40 ( V_87 -> V_33 -> V_57 != V_57 ) ;
F_48 ( V_87 -> V_33 ) ;
F_38 ( V_87 ) ;
}
V_86 -> V_96 = true ;
...
int F_60 ( struct V_56 * V_57 ,
struct V_31 * V_86 )
{
struct V_6 * V_7 = V_57 -> V_4 -> V_8 ;
F_4 ( ! F_41 ( & V_7 -> V_4 -> V_49 ) ) ;
if ( V_86 -> V_33 == NULL ) {
if ( V_86 != V_57 -> V_60 ) {
F_50 ( V_86 ) ;
if ( V_57 -> V_60 )
...
return F_79 ( V_57 , V_86 ) ;
}
static bool F_86 ( struct V_3 * V_4 )
{
return F_87 ( V_4 ) -> V_40 ;
}
int F_88 ( struct V_3 * V_4 , void * V_67 ,
struct V_68 * V_69 )
{
struct V_102 * args = V_67 ;
struct V_37 * V_38 = V_69 -> V_70 ;
struct V_31 * V_32 ;
int V_23 ;
if ( ! F_86 ( V_4 ) )
...
if ( V_23 )
return V_23 ;
V_32 = F_39 ( V_4 , V_38 , F_66 ( V_4 ) ) ;
F_67 ( & V_4 -> V_49 ) ;
if ( F_42 ( V_32 ) )
return F_46 ( V_32 ) ;
args -> V_104 = V_32 -> V_45 ;
F_44 ( L_9 , args -> V_104 ) ;
return 0 ;
}
int F_90 ( struct V_3 * V_4 , void * V_67 ,
struct V_68 * V_69 )
{
struct V_105 * args = V_67 ;
struct V_37 * V_38 = V_69 -> V_70 ;
struct V_31 * V_32 ;
int V_23 ;
if ( args -> V_104 == V_44 )
...
if ( V_23 )
return V_23 ;
V_32 = F_71 ( V_38 , args -> V_104 ) ;
if ( F_42 ( V_32 ) ) {
F_67 ( & V_4 -> V_49 ) ;
return F_46 ( V_32 ) ;
}
F_91 ( & V_32 -> V_38 -> V_43 , V_32 -> V_45 ) ;
F_38 ( V_32 ) ;
F_67 ( & V_4 -> V_49 ) ;
F_44 ( L_10 , args -> V_104 ) ;
return 0 ;
}
