...
static T_3 F_10 ( struct V_50 * V_51 , struct V_19 * V_20 ,
char * V_5 )
{
struct V_6 * V_52 ;
V_52 = F_5 ( V_20 ) ;
...
static T_3 F_11 ( struct V_50 * V_51 , struct V_19 * V_20 ,
const char * V_5 , T_4 V_53 )
{
struct V_6 * V_52 ;
int V_9 ;
V_52 = F_5 ( V_20 ) ;
...
static T_3 F_15 ( struct V_50 * V_51 ,
...
static T_3 F_17 ( struct V_50 * V_51 ,
struct V_19 * V_20 ,
const char * V_5 , T_4 V_53 )
{
...
static T_3 F_28 ( struct V_50 * V_51 , struct V_19 * V_20 ,
char * V_5 )
{
T_2 V_26 ;
struct V_28 V_29 ;
union V_82 * V_83 ;
T_5 V_84 = 0 ;
struct V_28 V_85 = { V_86 , NULL } ;
struct V_87 V_88 = {
. V_89 = 0 ,
} ;
V_29 . V_41 = ( V_42 ) sizeof( V_88 ) ;
V_29 . V_43 = & V_88 ;
V_26 = F_7 ( V_39 , 1 ,
V_90 , & V_29 , & V_85 ) ;
if ( F_29 ( V_26 ) ) {
V_83 = (union V_82 * ) V_85 . V_43 ;
if ( V_83 && V_83 -> type == V_91 )
V_84 = ( T_5 ) V_83 -> integer . V_92 ;
if ( V_84 == 1 )
...
static T_3 F_30 ( struct V_50 * V_51 , struct V_19 * V_20 ,
const char * V_5 , T_4 V_53 )
{
struct V_28 V_29 ;
T_2 V_26 ;
struct V_87 args ;
if ( strcmp ( V_5 , L_21 ) == 0 )
args . V_89 = 1 ;
else if ( strcmp ( V_5 , L_22 ) == 0 )
args . V_89 = 2 ;
else
args . V_89 = 3 ;
F_4 ( L_23 , args . V_89 , V_5 ) ;
V_29 . V_41 = ( V_42 ) sizeof( args ) ;
V_29 . V_43 = & args ;
V_26 = F_7 ( V_39 , 1 ,
V_93 , & V_29 , NULL ) ;
...
static void F_31 ( struct V_65 * V_50 )
{
F_32 ( & V_50 -> V_51 , & V_94 ) ;
}
