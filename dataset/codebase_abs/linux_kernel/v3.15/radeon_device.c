...
static bool F_87 ( struct V_136 * V_15 )
{
if ( V_15 -> V_67 == V_68 &&
V_15 -> V_137 == 0x00e2 ) {
F_88 ( V_138 L_22 ) ;
...
static void F_89 ( struct V_136 * V_15 , enum V_139 V_127 )
{
struct V_1 * V_2 = F_90 ( V_15 ) ;
if ( F_1 ( V_2 ) && V_127 == V_140 )
return;
if ( V_127 == V_141 ) {
unsigned V_142 = V_2 -> V_15 -> V_142 ;
F_88 ( V_138 L_23 ) ;
V_2 -> V_143 = V_144 ;
if ( V_142 < 20 && F_87 ( V_15 ) )
V_2 -> V_15 -> V_142 = 20 ;
F_91 ( V_2 , true , true ) ;
V_2 -> V_15 -> V_142 = V_142 ;
V_2 -> V_143 = V_145 ;
F_92 ( V_2 ) ;
} else {
F_88 ( V_138 L_24 ) ;
...
static bool F_95 ( struct V_136 * V_15 )
{
struct V_1 * V_2 = F_90 ( V_15 ) ;
bool V_147 ;
F_96 ( & V_2 -> V_148 ) ;
...
V_15 -> V_67 , V_15 -> V_137 ) ;
F_76 ( & V_4 -> V_163 ) ;
F_76 ( & V_4 -> V_164 ) ;
F_99 ( & V_4 -> V_165 . V_166 , 0 ) ;
F_76 ( & V_4 -> V_167 . V_125 ) ;
F_76 ( & V_4 -> V_89 . V_125 ) ;
F_76 ( & V_4 -> V_168 ) ;
F_76 ( & V_4 -> V_169 ) ;
F_100 ( & V_4 -> V_89 . V_170 ) ;
F_100 ( & V_4 -> V_171 ) ;
F_101 ( & V_4 -> V_172 . V_173 ) ;
V_41 = F_102 ( V_4 ) ;
if ( V_41 )
return V_41 ;
V_4 -> V_174 . V_175 = 1 << 20 ;
V_41 = F_103 ( V_4 ) ;
if ( V_41 )
return V_41 ;
F_86 ( V_4 ) ;
...
V_41 = F_105 ( V_4 -> V_15 , F_106 ( V_150 ) ) ;
if ( V_41 ) {
V_4 -> V_179 = true ;
V_150 = 32 ;
F_88 ( V_182 L_26 ) ;
}
V_41 = F_107 ( V_4 -> V_15 , F_106 ( V_150 ) ) ;
if ( V_41 ) {
F_107 ( V_4 -> V_15 , F_106 ( 32 ) ) ;
F_88 ( V_182 L_27 ) ;
}
F_108 ( & V_4 -> V_183 ) ;
F_108 ( & V_4 -> V_184 ) ;
...
F_18 ( L_28 , ( T_2 ) V_4 -> V_196 ) ;
F_18 ( L_29 , ( unsigned ) V_4 -> V_197 ) ;
if ( V_4 -> V_17 >= V_195 )
F_13 ( V_4 ) ;
for ( V_14 = 0 ; V_14 < V_199 ; V_14 ++ ) {
if ( F_109 ( V_4 -> V_15 , V_14 ) & V_200 ) {
V_4 -> V_201 = F_15 ( V_4 -> V_15 , V_14 ) ;
V_4 -> V_118 = F_110 ( V_4 -> V_15 , V_14 , V_4 -> V_201 ) ;
break;
}
}
if ( V_4 -> V_118 == NULL )
F_73 ( L_30 ) ;
F_111 ( V_4 -> V_15 , V_4 , NULL , F_83 ) ;
if ( V_4 -> V_6 & V_7 )
V_151 = true ;
F_112 ( V_4 -> V_15 , & V_202 , V_151 ) ;
if ( V_151 )
F_113 ( V_4 -> V_2 , & V_4 -> V_203 ) ;
V_41 = F_114 ( V_4 ) ;
if ( V_41 )
return V_41 ;
V_41 = F_115 ( V_4 ) ;
...
F_118 ( V_4 ) ;
F_124 ( V_4 -> V_15 ) ;
F_111 ( V_4 -> V_15 , NULL , NULL , NULL ) ;
if ( V_4 -> V_118 )
F_125 ( V_4 -> V_15 , V_4 -> V_118 ) ;
V_4 -> V_118 = NULL ;
F_20 ( V_4 -> V_198 ) ;
V_4 -> V_198 = NULL ;
if ( V_4 -> V_17 >= V_195 )
...
struct V_215 * V_216 = F_129 ( V_209 -> V_217 -> V_218 ) ;
struct V_219 * V_220 ;
if ( V_216 == NULL || V_216 -> V_221 == NULL ) {
continue;
}
V_220 = F_130 ( V_216 -> V_221 ) ;
if ( ! F_131 ( V_4 , V_220 ) ) {
...
V_4 -> V_235 = false ;
F_134 ( V_4 ) ;
V_234 = F_161 ( & V_4 -> V_236 . V_237 ) ;
F_162 ( V_4 ) ;
F_135 ( V_4 ) ;
for ( V_14 = 0 ; V_14 < V_157 ; ++ V_14 ) {
V_231 [ V_14 ] = F_163 ( V_4 , & V_4 -> V_158 [ V_14 ] ,
& V_232 [ V_14 ] ) ;
if ( V_231 [ V_14 ] ) {
V_233 = true ;
F_39 ( V_4 -> V_2 , L_38
L_39 , V_231 [ V_14 ] , V_14 ) ;
}
}
V_238:
V_41 = F_117 ( V_4 ) ;
...
int F_170 ( struct V_249 * V_250 )
{
return 0 ;
}
void F_171 ( struct V_249 * V_250 )
{
}
