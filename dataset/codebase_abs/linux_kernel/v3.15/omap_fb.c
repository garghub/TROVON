...
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
V_79 = F_27 ( V_22 -> V_18 , & V_22 -> V_39 , true ) ;
if ( V_79 )
goto V_80;
F_28 ( V_22 -> V_18 , V_81 ) ;
}
...
F_36 ( L_4 , V_33 , V_34 , V_61 , V_62 , V_11 ) ;
while ( ( V_90 = F_32 ( V_11 , V_90 ) ) ) {
if ( V_90 -> V_93 && V_90 -> V_93 -> V_95 ) {
struct V_94 * V_95 = V_90 -> V_93 -> V_95 ;
int V_97 = F_37 ( 0 , V_33 - V_95 -> V_33 ) ;
int V_98 = F_37 ( 0 , V_34 - V_95 -> V_34 ) ;
int V_99 = V_61 + ( V_33 - V_95 -> V_33 ) - V_97 ;
int V_100 = V_62 + ( V_34 - V_95 -> V_34 ) - V_98 ;
F_38 ( V_90 , V_97 , V_98 , V_99 , V_100 ) ;
}
}
}
void F_39 ( struct V_10 * V_11 , struct V_101 * V_102 )
{
struct V_15 * V_16 = F_4 ( V_11 ) ;
int V_6 , V_19 = F_7 ( V_11 -> V_9 ) ;
F_40 ( V_102 , L_5 , V_11 -> V_54 , V_11 -> V_56 ,
( char * ) & V_11 -> V_9 ) ;
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
F_40 ( V_102 , L_6 ,
V_6 , V_22 -> V_35 , V_22 -> V_37 ) ;
F_41 ( V_22 -> V_18 , V_102 ) ;
}
}
struct V_10 * F_42 ( struct V_86 * V_28 ,
struct V_12 * V_103 , struct V_104 * V_105 )
{
struct V_82 * V_106 [ 4 ] ;
struct V_10 * V_11 ;
int V_79 ;
V_79 = F_43 ( V_28 , V_103 , V_105 -> V_9 ,
V_106 , V_105 -> V_107 ) ;
if ( V_79 )
return F_44 ( V_79 ) ;
V_11 = F_45 ( V_28 , V_105 , V_106 ) ;
if ( F_46 ( V_11 ) ) {
int V_6 , V_19 = F_7 ( V_105 -> V_9 ) ;
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ )
F_10 ( V_106 [ V_6 ] ) ;
return V_11 ;
}
...
struct V_10 * F_45 ( struct V_86 * V_28 ,
struct V_104 * V_105 , struct V_82 * * V_106 )
{
struct V_15 * V_16 ;
struct V_10 * V_11 = NULL ;
const struct V_32 * V_32 = NULL ;
int V_79 , V_6 , V_19 = F_7 ( V_105 -> V_9 ) ;
F_8 ( L_7 ,
V_28 , V_105 , V_105 -> V_54 , V_105 -> V_56 ,
( char * ) & V_105 -> V_9 ) ;
for ( V_6 = 0 ; V_6 < F_2 ( V_7 ) ; V_6 ++ ) {
if ( V_7 [ V_6 ] . V_9 == V_105 -> V_9 ) {
V_32 = & V_7 [ V_6 ] ;
break;
}
}
...
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
int V_111 , V_37 = V_105 -> V_112 [ V_6 ] ;
if ( V_37 < ( V_105 -> V_54 * V_32 -> V_17 [ V_6 ] . V_36 ) ) {
F_19 ( V_28 -> V_28 , L_9 ,
V_37 , V_105 -> V_54 * V_32 -> V_17 [ V_6 ] . V_36 ) ;
V_79 = - V_108 ;
goto V_80;
}
V_111 = V_37 * V_105 -> V_56 / V_32 -> V_17 [ V_6 ] . V_38 ;
if ( V_111 > ( F_48 ( V_106 [ V_6 ] ) - V_105 -> V_113 [ V_6 ] ) ) {
F_19 ( V_28 -> V_28 , L_10 ,
V_106 [ V_6 ] -> V_111 - V_105 -> V_113 [ V_6 ] , V_111 ) ;
V_79 = - V_108 ;
goto V_80;
}
V_22 -> V_18 = V_106 [ V_6 ] ;
V_22 -> V_35 = V_105 -> V_113 [ V_6 ] ;
V_22 -> V_37 = V_37 ;
V_22 -> V_39 = 0 ;
}
F_49 ( V_11 , V_105 ) ;
V_79 = F_50 ( V_28 , V_11 , & V_114 ) ;
if ( V_79 ) {
F_19 ( V_28 -> V_28 , L_11 , V_79 ) ;
goto V_80;
}
