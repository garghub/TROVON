...
static int F_129 ( struct V_265 * V_371 )
{
...
static void F_131 ( struct V_327 * V_205 )
{
struct V_1 * V_2 = F_132 ( V_205 ) ;
F_133 ( V_205 ) ;
if ( V_205 == V_2 -> V_205 )
V_2 -> V_205 = NULL ;
...
static struct V_327 * F_134 ( struct V_1 * V_2 ,
const struct V_327 * V_389 ,
const char * V_390 )
{
struct V_327 * V_391 ;
V_391 = F_135 () ;
...
V_391 -> V_9 = & V_2 -> V_9 ;
V_391 -> V_392 = V_393 ;
V_391 -> V_376 = & V_2 -> V_376 ;
F_136 ( V_394 , & V_391 -> V_212 ) ;
if ( V_2 -> V_4 . V_5 )
V_391 -> V_297 = 0 ;
snprintf ( V_391 -> V_291 , sizeof( V_391 -> V_291 ) , L_55 ,
V_2 -> V_291 , V_390 ) ;
F_137 ( V_391 , V_2 ) ;
return V_391 ;
}
...
V_396 . V_400 = V_401 ;
if ( V_2 -> V_4 . V_402 . type ) {
V_396 . type = V_2 -> V_4 . V_402 . type ;
V_396 . V_320 = V_2 -> V_4 . V_403 ;
F_3 ( & V_2 -> V_9 , 0 , V_210 , V_404 , & V_396 ) ;
}
if ( ( V_2 -> V_343 != V_344 ) && ( V_2 -> V_343 ) ) {
V_396 . type = V_2 -> V_343 ;
V_396 . V_320 = V_2 -> V_405 ;
F_3 ( & V_2 -> V_9 , 0 , V_210 , V_404 , & V_396 ) ;
}
if ( V_2 -> V_406 ) {
struct V_407 V_408 ;
V_408 . V_210 = V_409 ;
V_408 . V_247 = & V_2 -> V_406 ;
F_3 ( & V_2 -> V_9 , 0 , V_210 , V_410 , & V_408 ) ;
}
if ( V_2 -> V_343 == V_411 ) {
struct V_407 V_412 ;
struct V_413 V_414 ;
...
V_412 . V_210 = V_411 ;
V_412 . V_247 = & V_414 ;
F_3 ( & V_2 -> V_9 , 0 , V_210 , V_410 , & V_412 ) ;
}
V_197 . V_210 = 0 ;
V_197 . type = V_209 ;
V_197 . V_202 = 9076 ;
...
F_118 ( L_56 ) ;
F_119 ( & V_2 -> V_376 ) ;
V_36 = F_141 ( & V_2 -> V_99 -> V_2 , & V_2 -> V_9 ) ;
if ( V_36 < 0 ) {
F_19 ( L_57 ) ;
goto V_417;
}
...
V_419 ;
if ( V_2 -> V_4 . V_238 )
F_143 ( & V_2 -> V_9 , & V_2 -> V_420 [ V_2 -> V_421 ] ,
L_58 , 0 , V_422 ) ;
if ( V_2 -> V_4 . V_423 == V_424 )
F_143 ( & V_2 -> V_9 , & V_2 -> V_420 [ V_2 -> V_421 ] ,
L_59 , 0 , V_425 ) ;
if ( V_2 -> V_4 . V_423 == V_426 )
F_143 ( & V_2 -> V_9 , & V_2 -> V_420 [ V_2 -> V_421 ] ,
L_60 , 0 , V_427 ) ;
if ( V_2 -> V_4 . V_243 == V_428 )
F_143 ( & V_2 -> V_9 , & V_2 -> V_420 [ V_2 -> V_421 ] ,
L_61 , V_2 -> V_4 . V_429 , NULL ) ;
if ( V_2 -> V_4 . V_343 != V_344 ) {
int V_430 = ( V_2 -> V_406 & V_431 ) ;
if ( V_2 -> V_4 . V_402 . type )
F_143 ( & V_2 -> V_9 , & V_2 -> V_420 [ V_2 -> V_421 ] ,
L_62 , V_2 -> V_4 . V_403 , NULL ) ;
if ( V_430 )
F_143 ( & V_2 -> V_9 ,
& V_2 -> V_420 [ V_2 -> V_421 ] , L_62 ,
0 , F_144 ( V_432 ) ) ;
if ( V_2 -> V_405 == 0 ) {
enum V_433 type =
V_430 ? V_434 : V_435 ;
...
if ( V_2 -> V_340 . V_441 != V_442 ) {
F_148 ( V_416 , & V_443 ,
V_249 , 0 , 1 , 1 , 1 ) ;
F_148 ( V_416 , & V_443 ,
V_252 , 0 , 0x1f , 1 , 0x1f ) ;
} else {
F_149 ( F_150 ( V_416 , V_249 ) ,
F_61 , V_2 ) ;
F_149 ( F_150 ( V_416 , V_252 ) ,
F_61 , V_2 ) ;
}
F_2 ( V_2 ) ;
F_151 ( & V_2 -> V_148 . V_139 ) ;
F_151 ( & V_2 -> V_150 . V_139 ) ;
if ( V_2 -> V_4 . V_238 ) {
V_36 = F_6 ( V_2 , V_444 , 0xf7 ) ;
if ( V_36 < 0 ) {
F_19 ( L_64 ,
V_194 , V_36 ) ;
goto V_440;
...
V_2 -> V_250 = 1 ;
V_2 -> V_253 = 0x1f ;
V_251 = ( T_1 ) F_94 ( V_2 , V_447 ) ;
F_6 ( V_2 , V_447 ,
( V_448 | V_251 ) ) ;
F_7 ( V_2 ) ;
F_153 ( V_2 ) ;
if ( NULL == F_150 ( & V_2 -> V_255 , V_256 ) )
F_148 ( & V_2 -> V_255 , & V_443 ,
V_256 ,
0 , 0x1f , 1 , V_18 ) ;
if ( NULL == F_150 ( & V_2 -> V_255 , V_257 ) )
F_148 ( & V_2 -> V_255 , & V_443 ,
V_257 ,
- 0x80 , 0x7f , 1 , V_20 ) ;
if ( NULL == F_150 ( & V_2 -> V_255 , V_258 ) )
F_148 ( & V_2 -> V_255 , & V_443 ,
V_258 ,
0 , 0x1f , 1 , V_22 ) ;
if ( NULL == F_150 ( & V_2 -> V_255 , V_259 ) )
F_148 ( & V_2 -> V_255 , & V_443 ,
V_259 ,
- 0x30 , 0x30 , 1 , V_24 ) ;
if ( NULL == F_150 ( & V_2 -> V_255 , V_260 ) )
F_148 ( & V_2 -> V_255 , & V_443 ,
V_260 ,
- 0x30 , 0x30 , 1 , V_26 ) ;
if ( NULL == F_150 ( & V_2 -> V_255 , V_261 ) )
F_148 ( & V_2 -> V_255 , & V_443 ,
V_261 ,
0 , 0x0f , 1 , V_28 ) ;
F_5 ( V_2 ) ;
...
if ( V_36 )
goto V_440;
V_2 -> V_205 = F_134 ( V_2 , & V_449 , L_66 ) ;
if ( ! V_2 -> V_205 ) {
F_19 ( L_67 ) ;
V_36 = - V_450 ;
goto V_440;
}
V_2 -> V_205 -> V_451 = & V_2 -> V_216 ;
V_2 -> V_205 -> V_451 -> V_376 = & V_2 -> V_452 ;
if ( V_2 -> V_4 . V_5 ) {
F_155 ( V_2 -> V_205 , V_453 ) ;
F_155 ( V_2 -> V_205 , V_454 ) ;
F_155 ( V_2 -> V_205 , V_455 ) ;
} else {
F_155 ( V_2 -> V_205 , V_456 ) ;
}
if ( V_2 -> V_343 == V_344 ) {
F_155 ( V_2 -> V_205 , V_457 ) ;
F_155 ( V_2 -> V_205 , V_458 ) ;
F_155 ( V_2 -> V_205 , V_459 ) ;
F_155 ( V_2 -> V_205 , V_460 ) ;
}
if ( ! V_2 -> V_340 . V_341 ) {
F_155 ( V_2 -> V_205 , V_461 ) ;
F_155 ( V_2 -> V_205 , V_462 ) ;
}
V_36 = F_156 ( V_2 -> V_205 , V_333 ,
V_463 [ V_2 -> V_464 ] ) ;
if ( V_36 ) {
F_19 ( L_68 ,
V_36 ) ;
...
if ( F_1 ( V_2 ) == 1 ) {
V_2 -> V_347 = F_134 ( V_2 , & V_449 ,
L_69 ) ;
V_2 -> V_347 -> V_451 = & V_2 -> V_230 ;
V_2 -> V_347 -> V_451 -> V_376 = & V_2 -> V_465 ;
F_155 ( V_2 -> V_205 , V_456 ) ;
if ( V_2 -> V_343 == V_344 ) {
F_155 ( V_2 -> V_347 , V_457 ) ;
F_155 ( V_2 -> V_347 , V_458 ) ;
F_155 ( V_2 -> V_347 , V_459 ) ;
F_155 ( V_2 -> V_347 , V_460 ) ;
}
if ( ! V_2 -> V_340 . V_341 ) {
F_155 ( V_2 -> V_347 , V_461 ) ;
F_155 ( V_2 -> V_347 , V_462 ) ;
}
V_36 = F_156 ( V_2 -> V_347 , V_373 ,
V_466 [ V_2 -> V_464 ] ) ;
if ( V_36 < 0 ) {
F_19 ( L_70 ) ;
goto V_440;
...
if ( V_330 [ V_2 -> V_331 ] . V_402 . type == V_467 ) {
V_2 -> V_348 = F_134 ( V_2 , & V_468 ,
L_71 ) ;
if ( ! V_2 -> V_348 ) {
F_19 ( L_67 ) ;
V_36 = - V_450 ;
