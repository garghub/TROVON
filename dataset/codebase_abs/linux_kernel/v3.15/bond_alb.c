...
static int F_87 ( struct V_21 * V_21 , T_1 V_70 [] )
{
...
static void F_89 ( struct V_21 * V_130 , struct V_21 * V_131 )
{
T_1 V_132 [ V_133 ] ;
F_33 ( V_132 , V_130 -> V_74 -> V_84 ) ;
F_87 ( V_130 , V_131 -> V_74 -> V_84 ) ;
F_87 ( V_131 , V_132 ) ;
}
static void F_90 ( struct V_8 * V_9 , struct V_21 * V_130 ,
struct V_21 * V_131 )
{
int V_134 = ( F_24 ( V_130 ) != F_24 ( V_131 ) ) ;
struct V_21 * V_135 = NULL ;
F_91 () ;
if ( F_24 ( V_130 ) ) {
F_45 ( V_130 , V_130 -> V_74 -> V_84 , false ) ;
if ( V_9 -> V_72 . V_136 ) {
F_55 ( V_9 , V_130 ) ;
}
} else {
...
static void F_92 ( struct V_8 * V_9 , struct V_21 * V_21 )
{
int V_137 ;
int V_138 ;
struct V_21 * V_139 ;
...
static int F_94 ( struct V_8 * V_9 , struct V_21 * V_21 )
{
struct V_21 * V_141 = V_9 -> V_71 ;
struct V_21 * V_142 , * V_143 = NULL ;
struct V_37 * V_38 ;
if ( ! F_95 ( V_9 ) ) {
return 0 ;
}
if ( ! F_32 ( V_21 -> V_140 , V_9 -> V_74 -> V_84 ) ) {
if ( ! F_93 ( V_9 , V_21 -> V_74 -> V_84 ) )
return 0 ;
F_87 ( V_21 , V_9 -> V_74 -> V_84 ) ;
}
F_41 (bond, tmp_slave1, iter) {
if ( ! F_93 ( V_9 , V_142 -> V_140 ) ) {
V_143 = V_142 ;
break;
}
if ( ! V_141 ) {
...
static int F_97 ( struct V_8 * V_9 , void * V_70 )
{
...
return 0 ;
F_41 (bond, slave, iter) {
F_33 ( V_147 , V_21 -> V_74 -> V_84 ) ;
V_148 = F_88 ( V_21 -> V_74 , V_70 ) ;
F_33 ( V_21 -> V_74 -> V_84 , V_147 ) ;
if ( V_148 )
goto V_149;
}
return 0 ;
V_149:
memcpy ( V_146 . V_127 , V_9 -> V_74 -> V_84 , V_9 -> V_74 -> V_126 ) ;
V_146 . V_128 = V_9 -> V_74 -> type ;
F_41 (bond, rollback_slave, iter) {
if ( V_145 == V_21 )
break;
F_33 ( V_147 , V_145 -> V_74 -> V_84 ) ;
F_88 ( V_145 -> V_74 , & V_146 ) ;
F_33 ( V_145 -> V_74 -> V_84 , V_147 ) ;
}
return V_148 ;
}
int F_98 ( struct V_8 * V_9 , int V_136 )
{
int V_148 ;
V_148 = F_17 ( V_9 ) ;
if ( V_148 )
...
int F_100 ( struct V_2 * V_3 , struct V_119 * V_150 )
{
struct V_8 * V_9 = F_101 ( V_150 ) ;
struct V_151 * V_152 ;
struct V_28 * V_29 = & ( F_5 ( V_9 ) ) ;
struct V_21 * V_17 = NULL ;
static const T_3 V_153 = F_102 ( 0xffffffff ) ;
int V_5 = 0 ;
int V_154 = 1 ;
T_2 V_42 = 0 ;
const T_1 * V_4 = NULL ;
...
F_77 ( V_3 ) ;
V_152 = F_103 ( V_3 ) ;
switch ( F_104 ( V_3 -> V_61 ) ) {
case V_157 : {
const struct V_158 * V_159 = F_105 ( V_3 ) ;
...
V_156 = F_106 ( V_3 ) ;
if ( F_107 ( & V_156 -> V_165 ) ) {
V_154 = 0 ;
break;
}
V_4 = ( char * ) & ( F_106 ( V_3 ) -> V_161 ) ;
V_5 = sizeof( F_106 ( V_3 ) -> V_161 ) ;
break;
case V_166 :
if ( F_108 ( V_3 ) -> V_167 != V_168 ) {
V_154 = 0 ;
break;
}
if ( F_108 ( V_3 ) -> V_169 != V_170 ) {
V_154 = 0 ;
break;
}
...
void F_111 ( struct V_175 * V_176 )
{
struct V_8 * V_9 = F_112 ( V_176 , struct V_8 ,
V_177 . V_176 ) ;
struct V_28 * V_29 = & ( F_5 ( V_9 ) ) ;
struct V_37 * V_38 ;
struct V_21 * V_21 ;
...
F_86 () ;
V_180:
F_118 ( V_9 -> V_183 , & V_9 -> V_177 , V_184 ) ;
}
int F_119 ( struct V_8 * V_9 , struct V_21 * V_21 )
{
int V_148 ;
V_148 = F_87 ( V_21 , V_21 -> V_140 ) ;
if ( V_148 )
return V_148 ;
V_148 = F_94 ( V_9 , V_21 ) ;
if ( V_148 )
return V_148 ;
F_13 ( V_21 ) ;
V_9 -> V_72 . V_178 = V_181 ;
if ( V_9 -> V_72 . V_136 )
V_9 -> V_72 . F_64 = 1 ;
return 0 ;
}
void F_120 ( struct V_8 * V_9 , struct V_21 * V_21 )
{
if ( F_95 ( V_9 ) )
F_92 ( V_9 , V_21 ) ;
F_16 ( V_9 , V_21 , 0 ) ;
...
void F_121 ( struct V_8 * V_9 , struct V_21 * V_21 , char V_185 )
{
struct V_28 * V_29 = & ( F_5 ( V_9 ) ) ;
if ( V_185 == V_186 ) {
F_16 ( V_9 , V_21 , 0 ) ;
...
void F_122 ( struct V_8 * V_9 , struct V_21 * V_188 )
__releases( &bond->curr_slave_lock
int F_123 ( struct V_119 * V_150 , void * V_70 )
__acquires( &bond->lock
void F_124 ( struct V_8 * V_9 , unsigned short V_87 )
{
if ( V_9 -> V_72 . V_136 )
F_73 ( V_9 , V_87 ) ;
}
