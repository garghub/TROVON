...
static bool F_64 ( struct V_27 * V_35 , const struct V_13 * V_5 )
{
struct V_29 * V_30 = F_24 ( V_35 , struct V_29 , V_28 ) ;
char V_22 [ 80 ] ;
if ( ! F_12 ( V_5 ) )
...
static bool F_65 ( struct V_29 * V_30 , const struct V_13 * V_5 ,
unsigned V_26 )
{
...
static bool F_66 ( struct V_27 * V_35 , const struct V_13 * V_5 )
{
struct V_29 * V_30 = F_24 ( V_35 , struct V_29 , V_28 ) ;
struct V_16 * V_36 ;
unsigned V_4 , V_59 ;
...
static T_3 F_68 ( struct V_13 * V_9 , struct V_13 * V_10 )
{
return ( V_9 -> V_26 [ F_6 ( V_9 ) ] + V_10 -> V_26 [ F_6 ( V_10 ) ] ) &
~ ( ( T_3 ) 1 << 63 ) ;
}
static bool F_69 ( struct V_27 * V_35 , struct V_13 * V_9 , struct V_13 * V_10 )
{
struct V_29 * V_30 = F_24 ( V_35 , struct V_29 , V_28 ) ;
unsigned V_4 ;
if ( F_70 ( V_30 -> V_11 ) )
...
if ( V_9 -> V_26 [ V_4 ] + F_71 ( 0 , F_12 ( V_9 ) , 0 ) != V_10 -> V_26 [ V_4 ] ||
...
if ( F_22 ( V_9 ) ) {
if ( F_22 ( V_10 ) )
V_9 -> V_26 [ F_6 ( V_9 ) ] = F_68 ( V_9 , V_10 ) ;
else
F_72 ( V_9 , 0 ) ;
}
