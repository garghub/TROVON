...
struct V_1 * V_2 ;
V_25 = F_14 ( & V_22 -> V_29 ) ;
V_27 = F_15 ( V_22 , V_30 , 0 ) ;
V_28 = F_15 ( V_22 , V_31 , 0 ) ;
if ( ! V_27 || ! V_28 || ! V_28 -> V_32 )
return - V_33 ;
V_23 = sizeof( int ) * V_28 -> V_32 ;
V_2 = F_16 ( sizeof( * V_2 ) + V_23 , V_34 ) ;
if ( ! V_2 )
return - V_35 ;
V_2 -> V_9 = V_28 -> V_32 ;
V_2 -> V_8 = ( void * ) ( unsigned long ) V_28 -> V_36 ;
V_2 -> V_7 = ( void * ) ( V_2 + 1 ) ;
V_2 -> V_6 = F_17 ( V_27 ) ;
...
V_2 -> V_11 . V_41 = F_9 ;
V_2 -> V_11 . V_42 = F_11 ;
V_2 -> V_11 . V_43 = V_25 -> V_44 ;
V_2 -> V_11 . V_45 = V_2 -> V_6 * ( 1 << V_2 -> V_9 ) ;
V_2 -> V_11 . V_14 = F_18 ( V_27 -> V_36 , V_2 -> V_11 . V_45 ) ;
V_2 -> V_11 . V_46 = V_47 ;
V_2 -> V_11 . V_48 = ( unsigned long ) V_2 ;
F_19 ( V_22 , V_2 ) ;
V_4 = 0 ;
do {
if ( F_20 ( V_2 -> V_8 [ V_4 ] , V_38 ) ) {
F_21 (KERN_ERR PFX L_1 ,
state->gpio_addrs[i]) ;
while ( V_4 -- )
F_22 ( V_2 -> V_8 [ V_4 ] ) ;
F_23 ( V_2 ) ;
...
F_21 (KERN_NOTICE PFX L_2 ,
state->map.bankwidth * 8 ) ;
V_2 -> V_50 = F_25 ( V_27 -> V_37 , & V_2 -> V_11 ) ;
if ( ! V_2 -> V_50 ) {
