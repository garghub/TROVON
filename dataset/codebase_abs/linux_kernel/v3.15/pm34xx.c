...
struct V_60 * V_61 ;
int V_62 , V_3 = 0 ;
F_55 (pwrst, &pwrst_list, node)
V_61 -> V_63 = F_15 ( V_61 -> V_64 ) ;
F_55 (pwrst, &pwrst_list, node) {
if ( F_56 ( V_61 -> V_64 , V_61 -> V_65 ) )
goto V_66;
if ( F_57 ( V_61 -> V_64 ) )
goto V_66;
}
...
F_56 ( V_61 -> V_64 , V_61 -> V_65 ) ;
}
}
int F_72 ( struct V_133 * V_64 )
{
struct V_60 * V_61 ;
F_55 (pwrst, &pwrst_list, node) {
if ( V_61 -> V_64 == V_64 )
...
int F_73 ( struct V_133 * V_64 , int V_62 )
{
struct V_60 * V_61 ;
F_55 (pwrst, &pwrst_list, node) {
if ( V_61 -> V_64 == V_64 ) {
...
static int T_6 F_74 ( struct V_133 * V_64 , void * V_32 )
{
struct V_60 * V_61 ;
if ( ! V_64 -> V_135 )
return 0 ;
V_61 = F_75 ( sizeof( struct V_60 ) , V_136 ) ;
if ( ! V_61 )
return - V_137 ;
V_61 -> V_64 = V_64 ;
V_61 -> V_65 = V_49 ;
F_76 ( & V_61 -> V_138 , & V_139 ) ;
if ( F_77 ( V_64 ) )
F_78 ( V_64 ) ;
return F_56 ( V_61 -> V_64 , V_61 -> V_65 ) ;
}
void F_79 ( void )
{
V_140 = F_80 ( V_141 , V_142 ) ;
if ( F_16 () != V_6 )
F_18 = F_80 ( V_143 ,
V_144 ) ;
}
...
return V_3 ;
V_159:
F_101 (pwrst, tmp, &pwrst_list, node) {
F_102 ( & V_61 -> V_138 ) ;
F_103 ( V_61 ) ;
}
F_104 ( F_88 ( L_11 ) , F_84 ) ;
V_158:
F_104 ( F_88 ( L_8 ) , NULL ) ;
V_156:
return V_3 ;
