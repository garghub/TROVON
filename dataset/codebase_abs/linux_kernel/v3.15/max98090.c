...
if ( ( V_76 >= V_244 ) && ( V_76 <= V_244 + 0x0f ) ) {
V_75 -> V_112 = V_245 ;
F_24 ( V_80 -> V_2 , L_33 , V_76 ) ;
} else if ( ( V_76 >= V_246 ) && ( V_76 <= V_246 + 0x0f ) ) {
V_75 -> V_112 = V_113 ;
F_24 ( V_80 -> V_2 , L_34 , V_76 ) ;
} else {
V_75 -> V_112 = V_245 ;
F_5 ( V_80 -> V_2 , L_35 , V_76 ) ;
}
V_75 -> V_178 = V_216 ;
F_49 ( & V_75 -> V_214 , F_37 ) ;
F_22 ( V_80 , V_57 ,
V_247 | V_248 ) ;
F_21 ( V_80 -> V_2 , L_36 , V_75 -> V_224 ) ;
V_76 = F_50 ( V_75 -> V_224 , NULL ,
F_41 , V_249 | V_250 ,
L_37 , V_80 ) ;
if ( V_76 < 0 ) {
F_5 ( V_80 -> V_2 , L_38 ,
...
static int F_51 ( struct V_85 * V_80 )
{
struct V_74 * V_75 = F_9 ( V_80 ) ;
F_52 ( & V_75 -> V_214 ) ;
return 0 ;
}
static int F_53 ( struct V_258 * V_259 ,
const struct V_260 * V_261 )
{
struct V_74 * V_75 ;
int V_76 ;
F_54 ( L_39 ) ;
V_75 = F_55 ( & V_259 -> V_2 , sizeof( struct V_74 ) ,
V_262 ) ;
if ( V_75 == NULL )
return - V_263 ;
V_75 -> V_112 = V_261 -> V_264 ;
F_56 ( V_259 , V_75 ) ;
V_75 -> V_240 = V_259 -> V_2 . V_265 ;
V_75 -> V_224 = V_259 -> V_224 ;
V_75 -> V_77 = F_57 ( V_259 , & V_266 ) ;
if ( F_58 ( V_75 -> V_77 ) ) {
V_76 = F_59 ( V_75 -> V_77 ) ;
F_5 ( & V_259 -> V_2 , L_40 , V_76 ) ;
goto V_267;
}
V_76 = F_60 ( & V_259 -> V_2 ,
& V_268 , V_269 ,
...
static int F_61 ( struct V_258 * V_270 )
{
F_62 ( & V_270 -> V_2 ) ;
return 0 ;
}
