...
F_62 ( V_38 -> V_43 > V_110 ) ;
if ( V_35 -> V_54 . V_55 & V_63 )
V_35 -> V_54 . V_111 = F_29 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
else
V_35 -> V_54 . V_111 = F_30 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
if ( V_35 -> V_54 . V_80 == V_81 )
V_35 -> V_54 . V_111 += sizeof( struct V_13 ) ;
V_35 -> V_33 = V_38 ;
return 0 ;
error:
if ( V_38 ) {
...
{
if ( F_68 ( & V_112 , V_96 ) < 0 ) {
F_63 ( L_2 , V_108 ) ;
return - V_113 ;
}
if ( F_69 ( & V_114 , V_60 ) < 0 ) {
F_63 ( L_3 , V_108 ) ;
F_70 ( & V_112 , V_96 ) ;
return - V_113 ;
}
...
{
if ( F_72 ( & V_114 , V_60 ) < 0 )
F_63 ( L_4 , V_108 ) ;
if ( F_70 ( & V_112 , V_96 ) < 0 )
F_63 ( L_5 , V_108 ) ;
}
