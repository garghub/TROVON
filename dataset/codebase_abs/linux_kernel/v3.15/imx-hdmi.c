...
if ( ! V_2 -> V_374 )
return 0 ;
V_373 = F_63 ( V_370 , V_2 -> V_374 ) ;
if ( V_373 ) {
F_15 ( V_2 -> V_34 , L_11 ,
V_373 -> V_375 , V_373 -> V_376 ) ;
F_64 ( V_370 , V_373 ) ;
V_193 = F_65 ( V_370 , V_373 ) ;
F_66 ( V_373 ) ;
} else {
F_15 ( V_2 -> V_34 , L_12 ) ;
}
...
static struct V_377 * F_67 ( struct V_369
* V_370 )
{
struct V_1 * V_2 = F_61 ( V_370 , struct V_1 ,
V_370 ) ;
...
struct V_257 * V_379 )
{
struct V_1 * V_2 = F_61 ( V_378 , struct V_1 , V_378 ) ;
F_54 ( V_2 , V_258 ) ;
memcpy ( & V_2 -> V_367 , V_258 , sizeof( V_2 -> V_367 ) ) ;
}
static bool F_69 ( struct V_377 * V_378 ,
const struct V_257 * V_258 ,
struct V_257 * V_379 )
{
return true ;
}
static void F_70 ( struct V_377 * V_378 )
{
}
static void F_71 ( struct V_377 * V_378 , int V_258 )
{
struct V_1 * V_2 = F_61 ( V_378 , struct V_1 , V_378 ) ;
if ( V_258 )
F_59 ( V_2 ) ;
...
static void F_72 ( struct V_377 * V_378 )
{
struct V_1 * V_2 = F_61 ( V_378 , struct V_1 , V_378 ) ;
F_59 ( V_2 ) ;
F_73 ( V_378 , V_380 ) ;
}
static void F_74 ( struct V_377 * V_378 )
{
struct V_1 * V_2 = F_61 ( V_378 , struct V_1 , V_378 ) ;
int V_381 = F_75 ( V_2 -> V_34 -> V_382 , V_378 ) ;
F_1 ( V_2 , V_381 ) ;
F_58 ( V_2 ) ;
}
static T_3 F_76 ( int V_383 , void * V_384 )
{
struct V_1 * V_2 = V_384 ;
T_1 V_385 ;
V_385 = F_5 ( V_2 , V_342 ) ;
if ( V_385 )
F_3 ( V_2 , ~ 0 , V_361 ) ;
...
static T_3 F_77 ( int V_383 , void * V_384 )
{
struct V_1 * V_2 = V_384 ;
T_1 V_385 ;
T_1 V_388 ;
...
static int F_79 ( struct V_393 * V_394 , struct V_1 * V_2 )
{
int V_193 ;
V_193 = F_80 ( V_394 , & V_2 -> V_378 ,
V_2 -> V_34 -> V_382 ) ;
if ( V_193 )
return V_193 ;
V_2 -> V_370 . V_395 = V_396 ;
F_81 ( & V_2 -> V_378 , & V_397 ) ;
F_82 ( V_394 , & V_2 -> V_378 , & V_398 ,
V_399 ) ;
F_83 ( & V_2 -> V_370 ,
& V_400 ) ;
F_84 ( V_394 , & V_2 -> V_370 , & V_401 ,
V_402 ) ;
V_2 -> V_370 . V_378 = & V_2 -> V_378 ;
F_85 ( & V_2 -> V_370 , & V_2 -> V_378 ) ;
return 0 ;
}
static int F_86 ( struct V_403 * V_34 , struct V_403 * V_404 , void * V_11 )
{
struct V_405 * V_406 = F_87 ( V_34 ) ;
const struct V_407 * V_408 =
F_88 ( V_409 , V_34 ) ;
struct V_393 * V_394 = V_11 ;
struct V_410 * V_411 = V_34 -> V_382 ;
struct V_410 * V_412 ;
struct V_1 * V_2 ;
struct V_413 * V_414 ;
int V_193 , V_383 ;
V_2 = F_89 ( V_34 , sizeof( * V_2 ) , V_415 ) ;
if ( ! V_2 )
return - V_416 ;
V_2 -> V_34 = V_34 ;
V_2 -> V_372 = V_391 ;
...
V_2 -> V_28 = 100 ;
if ( V_408 ) {
const struct V_417 * V_418 = V_408 -> V_11 ;
V_2 -> V_327 = V_418 -> V_419 ;
}
V_412 = F_90 ( V_411 , L_15 , 0 ) ;
if ( V_412 ) {
V_2 -> V_374 = F_91 ( V_412 ) ;
if ( ! V_2 -> V_374 )
F_15 ( V_2 -> V_34 , L_16 ) ;
F_92 ( V_412 ) ;
} else {
...
if ( V_383 < 0 )
return - V_171 ;
V_193 = F_94 ( V_34 , V_383 , F_76 ,
F_77 , V_420 ,
F_95 ( V_34 ) , V_2 ) ;
if ( V_193 )
return V_193 ;
V_414 = F_96 ( V_406 , V_421 , 0 ) ;
V_2 -> V_10 = F_97 ( V_34 , V_414 ) ;
if ( F_98 ( V_2 -> V_10 ) )
return F_99 ( V_2 -> V_10 ) ;
V_2 -> V_4 = F_100 ( V_411 , L_18 ) ;
if ( F_98 ( V_2 -> V_4 ) )
return F_99 ( V_2 -> V_4 ) ;
V_2 -> V_422 = F_101 ( V_2 -> V_34 , L_19 ) ;
if ( F_98 ( V_2 -> V_422 ) ) {
...
V_2 -> V_423 = F_101 ( V_2 -> V_34 , L_22 ) ;
if ( F_98 ( V_2 -> V_423 ) ) {
V_193 = F_99 ( V_2 -> V_423 ) ;
F_43 ( V_2 -> V_34 ,
L_23 , V_193 ) ;
goto V_424;
}
V_193 = F_102 ( V_2 -> V_423 ) ;
if ( V_193 ) {
F_43 ( V_2 -> V_34 ,
L_24 , V_193 ) ;
goto V_424;
...
static void F_106 ( struct V_403 * V_34 , struct V_403 * V_404 ,
void * V_11 )
{
struct V_1 * V_2 = F_107 ( V_34 ) ;
F_3 ( V_2 , ~ 0 , V_361 ) ;
V_2 -> V_370 . V_430 -> V_431 ( & V_2 -> V_370 ) ;
V_2 -> V_378 . V_430 -> V_431 ( & V_2 -> V_378 ) ;
F_105 ( V_2 -> V_423 ) ;
F_105 ( V_2 -> V_422 ) ;
F_108 ( V_2 -> V_374 ) ;
}
static int F_109 ( struct V_405 * V_406 )
{
return F_110 ( & V_406 -> V_34 , & V_432 ) ;
}
static int F_111 ( struct V_405 * V_406 )
{
F_112 ( & V_406 -> V_34 , & V_432 ) ;
return 0 ;
}
