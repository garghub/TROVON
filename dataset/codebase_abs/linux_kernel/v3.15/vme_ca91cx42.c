...
static int F_76 ( struct V_46 * V_47 , const struct V_292 * V_293 )
{
int V_116 , V_6 ;
T_1 V_294 ;
...
struct V_239 * V_299 ;
struct V_261 * V_262 ;
V_16 = F_77 ( sizeof( struct V_15 ) , V_206 ) ;
if ( V_16 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_296 = F_77 ( sizeof( struct V_1 ) , V_206 ) ;
if ( V_296 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_116 = F_79 ( V_47 , V_53 ) ;
if ( V_116 ) {
F_8 ( & V_47 -> V_48 , L_43 ) ;
goto V_131;
}
V_296 -> V_19 = F_37 ( F_80 ( V_47 , 0 ) ,
4096 ) ;
if ( ! V_296 -> V_19 ) {
F_8 ( & V_47 -> V_48 , L_44 ) ;
V_116 = - V_303 ;
