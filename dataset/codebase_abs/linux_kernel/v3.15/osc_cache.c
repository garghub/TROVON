...
L_5 , * V_82 , V_92 , V_84 -> V_98 ) ;
F_69 ( ( V_90 - V_67 -> V_40 ) < V_91 , V_64 , F_41 ( V_67 ) ) ;
V_99:
F_51 ( V_19 ) ;
...
F_71 ( V_2 -> V_153 != NULL , V_2 ) ;
F_18 ( V_66 , V_2 , L_12 ) ;
F_16 (oap, &ext->oe_pages, oap_pending_item) {
++ V_25 ;
if ( V_151 == NULL || V_151 -> V_116 < V_24 -> V_116 )
V_151 = V_24 ;
...
V_159 = F_6 ( V_2 ) ;
if ( V_159 != NULL && V_159 -> V_40 <= V_161 )
GOTO ( V_27 , V_26 = - V_162 ) ;
V_2 -> V_39 = V_161 ;
V_2 -> V_37 += V_92 ;
* V_82 -= V_92 ;
F_7 ( * V_82 >= 0 ) ;
...
if ( V_144 -> V_190 != NULL )
F_121 ( V_59 , V_144 ) ;
F_7 ( V_144 -> V_190 == NULL ) ;
V_184 = V_168 == V_179 ? V_191 : V_172 ;
V_170 -> V_189 = 0 ;
F_104 ( & V_19 -> V_192 ) ;
F_7 ( V_170 -> V_193 != NULL ) ;
F_7 ( ! F_3 ( & V_170 -> V_194 ) ) ;
F_48 ( & V_170 -> V_194 ) ;
V_170 -> V_193 = NULL ;
F_105 ( & V_19 -> V_192 ) ;
...
{
int V_251 = 0 ;
if ( ( V_84 -> V_106 == NULL || V_84 -> V_106 -> V_252 ) )
V_251 = 1 ;
if ( V_168 & V_65 ) {
...
static int F_160 ( struct V_18 * V_19 , struct V_13 * V_276 )
{
struct V_83 * V_84 = F_54 ( V_19 ) ;
struct V_1 * V_2 ;
int V_25 = 0 ;
...
F_7 ( F_14 ( V_19 ) ) ;
while ( ! F_3 ( & V_19 -> V_249 ) ) {
V_2 = F_143 ( V_19 -> V_249 . V_159 , struct V_1 ,
V_57 ) ;
F_7 ( V_2 -> V_28 == V_36 ) ;
...
static int
F_161 ( const struct V_58 * V_59 , struct V_83 * V_84 ,
struct V_18 * V_165 , T_4 V_279 )
{
F_162 ( V_276 ) ;
struct V_1 * V_2 ;
struct V_1 * V_52 ;
...
if ( ! F_3 ( & V_276 ) ) {
F_7 ( V_25 > 0 ) ;
V_26 = F_164 ( V_59 , V_84 , & V_276 , V_65 , V_279 ) ;
F_7 ( F_3 ( & V_276 ) ) ;
}
F_51 ( V_165 ) ;
return V_26 ;
...
static int
F_165 ( const struct V_58 * V_59 , struct V_83 * V_84 ,
struct V_18 * V_165 , T_4 V_279 )
{
struct V_1 * V_2 ;
struct V_1 * V_159 ;
...
F_52 ( V_165 ) ;
F_7 ( V_25 > 0 ) ;
V_26 = F_164 ( V_59 , V_84 , & V_276 , V_179 , V_279 ) ;
F_7 ( F_3 ( & V_276 ) ) ;
F_51 ( V_165 ) ;
}
return V_26 ;
}
static struct V_18 * F_166 ( struct V_83 * V_84 )
{
if ( ! F_3 ( & V_84 -> V_262 ) )
return F_167 ( & V_84 -> V_262 , V_281 ) ;
if ( ! F_3 ( & V_84 -> V_261 ) )
return F_167 ( & V_84 -> V_261 , V_282 ) ;
if ( ! F_3 ( & V_84 -> V_244 ) &&
! F_3 ( & V_84 -> V_264 ) )
return F_167 ( & V_84 -> V_264 , V_283 ) ;
if ( V_84 -> V_106 == NULL || V_84 -> V_106 -> V_252 ) {
if ( ! F_3 ( & V_84 -> V_264 ) )
return F_167 ( & V_84 -> V_264 , V_283 ) ;
if ( ! F_3 ( & V_84 -> V_266 ) )
return F_167 ( & V_84 -> V_266 , V_284 ) ;
}
return NULL ;
}
static void F_168 ( const struct V_58 * V_59 , struct V_83 * V_84 ,
T_4 V_279 )
{
struct V_18 * V_165 ;
int V_26 = 0 ;
while ( ( V_165 = F_166 ( V_84 ) ) != NULL ) {
struct V_174 * V_19 = F_67 ( V_165 ) ;
struct V_285 V_286 ;
F_149 ( V_165 , L_35 , F_146 ( V_84 ) ) ;
if ( F_145 ( V_84 , V_165 ) ) {
F_152 ( V_84 , V_165 ) ;
break;
}
F_169 ( V_19 ) ;
F_133 ( & V_84 -> V_209 ) ;
F_170 ( & V_19 -> V_199 , & V_286 , L_36 ,
V_146 ) ;
F_51 ( V_165 ) ;
if ( F_147 ( V_84 , V_165 , V_65 ) ) {
V_26 = F_161 ( V_59 , V_84 , V_165 , V_279 ) ;
if ( V_26 < 0 ) {
F_158 ( L_37 , V_26 ) ;
}
}
if ( F_147 ( V_84 , V_165 , V_179 ) ) {
V_26 = F_165 ( V_59 , V_84 , V_165 , V_279 ) ;
if ( V_26 < 0 )
F_158 ( L_38 , V_26 ) ;
}
F_52 ( V_165 ) ;
F_153 ( V_84 , V_165 ) ;
F_171 ( & V_19 -> V_199 , & V_286 , L_36 ,
V_146 ) ;
F_172 ( V_59 , V_19 ) ;
F_131 ( & V_84 -> V_209 ) ;
}
}
static int F_173 ( const struct V_58 * V_59 , struct V_83 * V_84 ,
struct V_18 * V_165 , T_4 V_279 , int V_287 )
{
int V_26 = 0 ;
if ( V_165 != NULL && F_153 ( V_84 , V_165 ) == 0 )
return 0 ;
if ( ! V_287 ) {
F_31 ( & V_84 -> V_288 ) ;
F_131 ( & V_84 -> V_209 ) ;
F_168 ( V_59 , V_84 , V_279 ) ;
F_133 ( & V_84 -> V_209 ) ;
F_36 ( & V_84 -> V_288 ) ;
} else {
F_109 ( V_66 , L_39 , V_84 ) ;
F_7 ( V_84 -> V_289 != NULL ) ;
V_26 = F_174 ( V_84 -> V_289 ) ;
}
return V_26 ;
}
...
{
return F_173 ( V_59 , V_84 , V_165 , V_290 , 1 ) ;
}
void F_175 ( const struct V_58 * V_59 , struct V_83 * V_84 ,
struct V_18 * V_165 , T_4 V_279 )
{
( void ) F_173 ( V_59 , V_84 , V_165 , V_279 , 0 ) ;
}
int F_176 ( struct V_18 * V_165 , struct V_169 * V_291 ,
struct V_144 * V_144 , T_2 V_119 )
{
struct V_292 * exp = F_84 ( V_165 ) ;
struct V_23 * V_24 = & V_291 -> V_293 ;
if ( ! V_144 )
return F_177 ( sizeof( * V_24 ) ) ;
V_24 -> V_294 = V_295 ;
V_24 -> V_296 = & exp -> V_129 -> V_297 . V_84 ;
V_24 -> V_232 = V_165 ;
V_24 -> V_298 = V_144 ;
V_24 -> V_116 = V_119 ;
F_7 ( ! ( V_119 & ~ V_121 ) ) ;
if ( ! F_178 ( exp ) && F_179 ( V_299 ) )
V_24 -> V_195 = V_186 ;
F_26 ( & V_24 -> V_115 ) ;
F_26 ( & V_24 -> V_114 ) ;
F_180 ( & V_24 -> V_156 ) ;
F_109 ( V_300 , L_40 V_301 L_41 ,
V_24 , V_144 , V_24 -> V_116 ) ;
return 0 ;
}
int F_181 ( const struct V_58 * V_59 , struct V_135 * V_136 ,
struct V_169 * V_291 )
{
struct V_302 * V_303 = F_182 ( V_59 ) ;
struct V_1 * V_2 = NULL ;
struct V_23 * V_24 = & V_291 -> V_293 ;
struct V_83 * V_84 = V_24 -> V_296 ;
struct V_18 * V_165 = V_24 -> V_232 ;
T_1 V_49 ;
int V_82 = 0 ;
int V_304 = V_305 ;
...
V_19 = F_89 ( & V_165 -> V_311 ) ;
V_176 = & F_88 ( V_59 ) -> V_177 ;
F_114 ( V_19 ) ;
V_26 = F_115 ( V_59 , V_19 , V_176 ) ;
F_116 ( V_19 ) ;
V_309 [ V_312 ] = V_176 -> V_313 ;
V_309 [ V_314 ] = V_176 -> V_315 ;
if ( V_26 == 0 && F_183 ( V_84 , V_309 ) == V_316 )
V_26 = - V_218 ;
if ( V_26 )
return V_26 ;
}
V_24 -> V_275 = V_168 ;
V_24 -> V_120 = V_291 -> V_317 ;
V_24 -> V_117 = V_291 -> V_318 - V_291 -> V_317 ;
V_24 -> V_154 = 0 ;
V_24 -> V_195 = V_304 ;
F_149 ( V_165 , L_42 ,
V_24 , V_24 -> V_298 , V_24 -> V_275 & V_319 ) ;
V_49 = F_17 ( V_24 ) -> V_50 ;
V_2 = V_303 -> V_320 ;
...
struct V_18 * V_19 , struct V_169 * V_291 )
{
struct V_23 * V_24 = & V_291 -> V_293 ;
struct V_1 * V_2 = NULL ;
int V_26 = 0 ;
F_7 ( V_24 -> V_294 == V_295 ) ;
F_109 ( V_300 , L_45 ,
V_24 , V_291 , F_17 ( V_24 ) -> V_50 ) ;
F_51 ( V_19 ) ;
if ( ! F_3 ( & V_24 -> V_114 ) ) {
...
int F_186 ( const struct V_58 * V_59 , struct V_135 * V_136 ,
struct V_169 * V_291 )
{
struct V_1 * V_2 = NULL ;
struct V_18 * V_19 = F_119 ( V_291 -> V_180 . V_181 ) ;
struct V_142 * V_321 = V_291 -> V_180 . V_322 ;
T_1 V_49 = V_321 -> V_50 ;
struct V_23 * V_24 = & V_291 -> V_293 ;
bool V_323 = false ;
int V_26 = 0 ;
...
V_26 = F_188 ( V_59 , V_136 , F_91 ( V_321 ) , V_172 ) ;
if ( V_26 )
GOTO ( V_27 , V_26 ) ;
F_104 ( & V_24 -> V_156 ) ;
V_24 -> V_154 |= V_155 | V_324 ;
F_105 ( & V_24 -> V_156 ) ;
if ( F_189 () )
V_2 -> V_10 = 1 ;
V_2 -> V_9 = 1 ;
...
int F_190 ( const struct V_58 * V_59 , struct V_169 * V_291 )
{
struct V_23 * V_24 = & V_291 -> V_293 ;
...
struct V_13 * V_14 , int V_168 , int V_304 )
{
struct V_83 * V_84 = F_54 ( V_19 ) ;
struct V_1 * V_2 ;
...
F_52 ( V_19 ) ;
F_175 ( V_59 , V_84 , V_19 , V_290 ) ;
return 0 ;
}
int F_194 ( const struct V_58 * V_59 , struct V_302 * V_303 ,
...
int V_171 = 0 ;
bool V_132 ;
V_49 = F_195 ( F_67 ( V_19 ) , V_330 ) ;
V_132 = V_330 > F_117 ( F_67 ( V_19 ) , V_49 ) ;
V_332:
F_51 ( V_19 ) ;
V_2 = F_37 ( V_19 , V_49 ) ;
if ( V_2 == NULL )
...
F_18 ( V_66 , V_2 , L_52 V_301 L_53 , V_330 ) ;
F_30 ( V_2 ) ;
if ( V_2 -> V_28 == V_35 ) {
F_7 ( ! V_2 -> V_11 ) ;
V_2 -> V_11 = 1 ;
...
while ( ! F_3 ( & V_14 ) ) {
int V_26 ;
V_2 = F_143 ( V_14 . V_159 , struct V_1 , V_57 ) ;
F_48 ( & V_2 -> V_57 ) ;
if ( V_2 -> V_28 != V_78 )
F_74 ( V_59 , V_2 , V_78 ) ;
...
F_18 ( V_66 , V_2 ,
L_56 V_301 L_41 , V_330 ) ;
}
F_32 ( V_59 , V_2 ) ;
}
if ( V_331 != NULL ) {
int V_26 ;
V_26 = F_74 ( V_59 , V_331 , V_32 ) ;
if ( V_26 < 0 )
F_18 ( V_66 , V_331 , L_57 , V_26 ) ;
F_32 ( V_59 , V_331 ) ;
V_331 = NULL ;
goto V_332;
}
...
void F_196 ( const struct V_58 * V_59 , struct V_302 * V_303 ,
struct V_18 * V_19 )
{
...
T_1 V_328 , T_1 V_123 , int V_334 , int V_335 )
{
struct V_1 * V_2 ;
F_162 ( V_336 ) ;
bool V_323 = false ;
...
if ( V_323 )
F_175 ( V_59 , F_54 ( V_19 ) , V_19 , V_290 ) ;
if ( V_334 || V_335 ) {
int V_26 ;
V_26 = F_197 ( V_59 , V_19 , V_328 , V_123 ) ;
if ( V_171 >= 0 && V_26 < 0 )
V_171 = V_26 ;
}
F_149 ( V_19 , L_61 ) ;
