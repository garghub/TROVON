...
static int T_1 F_36 ( unsigned long V_40 ,
const char * V_41 , int V_42 ,
void * V_43 )
{
char * type = F_15 ( V_40 , L_4 , NULL ) ;
...
static unsigned long T_1 F_37 ( void )
{
...
V_92 <<= 1 ;
V_14 = V_21 [ V_82 ] . V_19 ;
V_93 = F_39 ( V_92 >> ( V_14 + 1 ) , 1UL << 11 ) ;
return V_93 << 7 ;
}
int F_40 ( unsigned long V_94 , unsigned long V_95 )
{
return F_2 ( V_94 , V_95 , F_41 ( V_94 ) ,
F_42 ( V_96 ) , V_81 ,
V_97 ) ;
}
int F_43 ( unsigned long V_94 , unsigned long V_95 )
{
return F_12 ( V_94 , V_95 , V_81 ,
V_97 ) ;
}
...
V_111 = V_122 ;
V_109 = F_52 ( V_116 , V_116 , V_111 ) ;
F_3 ( L_26 , V_109 ,
V_116 ) ;
V_118 = F_53 ( V_109 ) ;
V_119 = V_109 + F_38 ( V_93 ) - 11 ;
...
#endif
F_55 (memory, reg) {
V_110 = ( unsigned long ) F_53 ( V_113 -> V_110 ) ;
V_45 = V_113 -> V_45 ;
F_3 ( L_27 ,
V_110 , V_45 , V_13 ) ;
#ifdef F_56
...
if ( V_110 != V_125 )
F_10 ( F_2 ( V_110 , V_125 ,
F_41 ( V_110 ) , V_13 ,
V_81 ,
V_97 ) ) ;
if ( ( V_110 + V_45 ) > V_126 )
F_10 ( F_2 ( V_125 + 16 * V_127 ,
V_110 + V_45 ,
F_41 ( V_126 ) ,
V_13 ,
V_81 ,
...
#endif
F_10 ( F_2 ( V_110 , V_110 + V_45 , F_41 ( V_110 ) ,
V_13 , V_81 , V_97 ) ) ;
}
F_57 ( V_122 ) ;
if ( V_128 ) {
V_128 = ( unsigned long ) F_53 ( V_128 ) ;
V_129 = ( unsigned long ) F_53 ( V_129 ) ;
if ( V_110 + V_45 >= V_128 )
V_128 = V_110 + V_45 + 1 ;
F_10 ( F_2 ( V_128 , V_129 ,
F_41 ( V_128 ) , V_13 ,
V_81 , V_97 ) ) ;
}
F_44 () ;
...
void T_1 F_58 ( void )
{
F_59 () -> V_130 = F_41 ( ( V_131 ) & V_132 ) ;
F_59 () -> V_133 = ( V_131 ) & V_132 ;
F_48 () ;
if ( F_30 ( V_134 ) )
F_60 () ;
else
...
unsigned int F_63 ( unsigned int V_135 , T_4 V_136 , int V_137 )
{
struct V_138 * V_138 ;
if ( ! F_64 ( F_65 ( V_136 ) ) )
return V_135 ;
V_138 = F_66 ( V_136 ) ;
if ( ! F_67 ( V_139 , & V_138 -> V_140 ) && ! F_68 ( V_138 ) ) {
if ( V_137 == 0x400 ) {
F_69 ( V_138 ) ;
F_70 ( V_139 , & V_138 -> V_140 ) ;
} else
V_135 |= V_4 ;
}
return V_135 ;
}
unsigned int F_71 ( unsigned long V_141 )
{
V_131 V_142 ;
unsigned char * V_143 ;
unsigned long V_144 , V_145 ;
if ( V_141 < V_146 ) {
V_142 = F_59 () -> V_147 . V_148 ;
V_144 = F_72 ( V_141 ) ;
return ( V_142 >> ( V_144 * 4 ) ) & 0xF ;
}
V_143 = F_59 () -> V_147 . V_149 ;
V_144 = F_73 ( V_141 ) ;
V_145 = V_144 & 0x1 ;
...
unsigned int F_71 ( unsigned long V_141 )
{
return F_59 () -> V_147 . V_150 ;
}
void F_74 ( struct V_151 * V_152 , unsigned long V_141 )
{
if ( F_75 ( V_152 , V_141 ) == V_51 )
return;
F_76 ( V_152 , V_141 , 1 , V_51 ) ;
#ifdef F_77
F_78 ( V_152 ) ;
#endif
if ( F_71 ( V_141 ) != V_51 ) {
F_59 () -> V_147 = V_152 -> V_147 ;
F_79 () ;
}
}
static int F_80 ( struct V_151 * V_152 , unsigned long V_153 )
{
...
static inline int F_80 ( struct V_151 * V_152 , unsigned long V_153 )
{
return 0 ;
}
void F_81 ( unsigned long V_153 , unsigned long V_166 ,
...
int F_83 ( unsigned long V_153 , unsigned long V_166 , unsigned long V_137 )
{
enum V_170 V_171 = F_84 () ;
T_6 * V_172 ;
unsigned long V_24 ;
struct V_151 * V_152 ;
T_4 * V_173 ;
...
V_14 = F_75 ( V_152 , V_153 ) ;
V_15 = F_87 ( V_153 ) ;
V_24 = F_88 ( V_152 -> V_147 . V_181 , V_153 , V_15 ) ;
break;
case V_182 :
V_152 = & V_183 ;
V_24 = F_4 ( V_153 , V_97 ) ;
...
F_85 ( L_34 , V_152 , V_152 -> V_185 , V_24 ) ;
if ( ! V_24 ) {
F_85 ( L_35 ) ;
V_77 = 1 ;
goto V_180;
...
V_176 = F_89 ( F_90 () ) ;
if ( V_177 && F_91 ( F_92 ( V_152 ) , V_176 ) )
V_178 = 1 ;
#ifndef F_31
if ( V_14 != V_51 )
V_153 &= ~ ( ( 1ul << V_21 [ V_14 ] . V_19 ) - 1 ) ;
#endif
V_173 = F_93 ( V_172 , V_153 , & V_174 ) ;
if ( V_173 == NULL || ! F_94 ( * V_173 ) ) {
F_85 ( L_36 ) ;
V_77 = 1 ;
goto V_180;
}
...
if ( V_174 ) {
if ( F_96 ( * ( V_187 * ) V_173 ) )
V_77 = F_97 ( V_153 , V_166 , V_24 , ( V_187 * ) V_173 ,
V_137 , V_178 , V_15 , V_14 ) ;
#ifdef F_35
else
V_77 = F_98 ( V_153 , V_166 , V_24 , V_173 , V_137 ,
...
#ifndef F_31
F_85 ( L_38 , F_95 ( * V_173 ) ) ;
#else
F_85 ( L_39 , F_95 ( * V_173 ) ,
F_95 ( * ( V_173 + V_188 ) ) ) ;
#endif
#ifdef F_31
if ( ( F_95 ( * V_173 ) & V_189 ) && V_14 == V_52 ) {
F_74 ( V_152 , V_153 ) ;
V_14 = V_51 ;
}
if ( V_87 && V_14 == V_52 &&
...
#endif
{
int V_156 = F_80 ( V_152 , V_153 ) ;
if ( V_166 & V_156 )
V_77 = - 2 ;
else
V_77 = F_102 ( V_153 , V_166 , V_24 , V_173 , V_137 ,
V_178 , V_15 , V_156 ) ;
}
if ( V_77 == - 1 )
F_81 ( V_153 , V_166 , V_24 , V_137 , V_15 , V_14 ,
V_14 , F_95 ( * V_173 ) ) ;
#ifndef F_31
F_85 ( L_43 , F_95 ( * V_173 ) ) ;
#else
F_85 ( L_44 , F_95 ( * V_173 ) ,
F_95 ( * ( V_173 + V_188 ) ) ) ;
#endif
F_85 ( L_45 , V_77 ) ;
V_180:
...
void F_104 ( struct V_151 * V_152 , unsigned long V_153 ,
...
F_10 ( F_86 ( V_153 ) != V_179 ) ;
#ifdef F_105
if ( F_106 ( F_75 ( V_152 , V_153 ) != V_152 -> V_147 . V_150 ) )
return;
#endif
F_85 ( L_46
...
return;
F_107 ( V_140 ) ;
V_173 = F_93 ( V_172 , V_153 , & V_193 ) ;
if ( ! V_173 )
goto V_194;
F_99 ( V_193 ) ;
#ifdef F_31
if ( F_95 ( * V_173 ) & ( V_189 | V_190 ) )
goto V_194;
#endif
if ( F_91 ( F_92 ( V_152 ) , F_89 ( F_90 () ) ) )
V_178 = 1 ;
#ifdef F_45
...
#endif
V_77 = F_102 ( V_153 , V_166 , V_24 , V_173 , V_137 , V_178 , V_15 ,
F_80 ( V_152 , V_153 ) ) ;
if ( V_77 == - 1 )
F_81 ( V_153 , V_166 , V_24 , V_137 , V_15 ,
V_152 -> V_147 . V_150 ,
V_152 -> V_147 . V_150 ,
F_95 ( * V_173 ) ) ;
V_194:
...
void F_109 ( unsigned long V_25 , T_7 V_136 , int V_14 , int V_15 ,
int V_178 )
{
unsigned long V_22 , V_144 , V_19 , V_195 , V_196 ;
F_85 ( L_48 , V_25 ) ;
F_110 (pte, psize, vpn, index, shift) {
V_22 = F_9 ( V_25 , V_19 , V_15 ) ;
V_195 = F_111 ( V_136 , V_144 ) ;
if ( V_195 & V_197 )
V_22 = ~ V_22 ;
V_196 = ( V_22 & V_29 ) * V_30 ;
V_196 += V_195 & V_198 ;
F_85 ( L_49 , V_144 , V_196 , V_195 ) ;
V_31 . V_199 ( V_196 , V_25 , V_14 , V_14 , V_15 , V_178 ) ;
} F_112 () ;
#ifdef F_113
if ( V_178 && F_114 ( V_200 ) &&
V_168 -> V_201 . V_202 &&
F_115 ( V_168 -> V_201 . V_202 -> V_203 ) ) {
F_116 () ;
F_117 ( V_204 ) ;
}
#endif
}
void F_118 ( unsigned long V_205 , int V_178 )
{
if ( V_31 . F_118 )
V_31 . F_118 ( V_205 , V_178 ) ;
else {
int V_206 ;
struct V_207 * V_208 =
& F_119 ( V_207 ) ;
for ( V_206 = 0 ; V_206 < V_205 ; V_206 ++ )
F_109 ( V_208 -> V_25 [ V_206 ] , V_208 -> V_136 [ V_206 ] ,
V_208 -> V_14 , V_208 -> V_15 , V_178 ) ;
}
}
void F_120 ( struct V_209 * V_202 , unsigned long V_210 , int V_77 )
{
enum V_170 V_171 = F_84 () ;
if ( F_121 ( V_202 ) ) {
#ifdef F_122
if ( V_77 == - 2 )
F_123 ( V_211 , V_202 , V_212 , V_210 ) ;
else
#endif
F_123 ( V_213 , V_202 , V_214 , V_210 ) ;
} else
F_124 ( V_202 , V_210 , V_213 ) ;
F_103 ( V_171 ) ;
}
long F_125 ( unsigned long V_22 , unsigned long V_25 ,
...
static void F_127 ( unsigned long V_16 , unsigned long V_220 )
{
unsigned long V_22 ;
...
long V_20 ;
V_22 = F_9 ( V_25 , V_34 , V_97 ) ;
if ( ! V_24 )
return;
V_20 = F_125 ( V_22 , V_25 , F_41 ( V_16 ) , V_221 ,
V_33 ,
V_81 , V_97 ) ;
F_10 ( V_20 < 0 ) ;
F_128 ( & V_222 ) ;
F_10 ( V_36 [ V_220 ] & 0x80 ) ;
V_36 [ V_220 ] = V_20 | 0x80 ;
F_129 ( & V_222 ) ;
}
static void F_130 ( unsigned long V_16 , unsigned long V_220 )
{
...
void F_131 ( struct V_138 * V_138 , int V_223 , int V_224 )
{
unsigned long V_140 , V_16 , V_220 ;
int V_206 ;
F_107 ( V_140 ) ;
for ( V_206 = 0 ; V_206 < V_223 ; V_206 ++ , V_138 ++ ) {
V_16 = ( unsigned long ) F_132 ( V_138 ) ;
V_220 = F_41 ( V_16 ) >> V_34 ;
if ( V_220 >= V_35 )
continue;
if ( V_224 )
F_127 ( V_16 , V_220 ) ;
...
void F_133 ( T_8 V_225 ,
T_8 V_226 )
{
F_10 ( V_225 != 0 ) ;
V_124 = F_134 ( V_131 , V_226 , 0x40000000 ) ;
F_57 ( V_124 ) ;
}
