...
static void F_16 ( struct V_12 * V_13 , T_1 type , void * V_37 ,
int V_16 )
{
struct V_38 * V_38 = F_17 ( V_13 ) ;
T_2 * V_2 = ( T_2 * ) V_37 ;
T_1 V_39 = ( V_2 [ 0 ] << 8 ) | V_2 [ 1 ] ;
T_1 V_40 = ( V_2 [ 2 ] << 8 ) | V_2 [ 3 ] ;
F_6 ( V_13 , L_17 , V_39 , V_40 ) ;
F_18 ( V_38 , V_37 , V_16 ) ;
}
...
static inline struct V_50 * F_32 ( void )
{
return F_33 ( sizeof( struct V_50 ) , V_55 ) ;
}
static inline void F_29 ( struct V_50 * V_51 )
{
F_34 ( V_51 ) ;
}
static struct V_50 * F_35 ( void )
{
struct V_50 * V_51 ;
if ( F_36 ( & V_41 . V_46 ) )
V_51 = F_32 () ;
else {
V_51 = F_37 ( V_41 . V_46 . V_56 , struct V_50 , V_54 ) ;
F_28 ( & V_51 -> V_54 ) ;
}
return V_51 ;
}
...
struct V_50 * V_51 ;
F_26 ( & V_41 . V_49 , V_53 ) ;
while ( ! F_36 ( & V_41 . V_45 ) ) {
V_51 = F_37 ( V_41 . V_45 . V_56 , struct V_50 , V_54 ) ;
F_30 ( & V_41 . V_49 , V_53 ) ;
sscanf ( V_51 -> V_13 -> V_3 , L_19 , & V_59 ) ;
F_41 ( V_41 . V_43 , V_59 , 0 , V_51 -> V_60 , V_51 -> V_61 ) ;
F_26 ( & V_41 . V_49 , V_53 ) ;
F_28 ( & V_51 -> V_54 ) ;
F_38 ( V_51 ) ;
}
...
static int F_42 ( struct V_12 * V_13 , char * V_2 , int V_61 )
{
struct V_50 * V_51 ;
unsigned long V_53 ;
T_1 V_39 = ( ( T_2 ) V_2 [ 0 ] << 8 ) | ( T_2 ) V_2 [ 1 ] ;
T_1 V_40 = ( ( T_2 ) V_2 [ 2 ] << 8 ) | ( T_2 ) V_2 [ 3 ] ;
F_6 ( V_13 , L_20 , V_39 , V_40 ) ;
F_26 ( & V_41 . V_49 , V_53 ) ;
V_51 = F_35 () ;
if ( ! V_51 ) {
F_43 ( V_13 , L_21 , V_62 ) ;
...
V_51 -> V_13 = V_13 ;
V_51 -> V_61 = V_61 ;
memcpy ( V_51 -> V_60 , V_2 , V_61 ) ;
F_40 ( & V_51 -> V_54 , & V_41 . V_45 ) ;
F_30 ( & V_41 . V_49 , V_53 ) ;
F_44 ( & V_41 . V_47 ) ;
return 0 ;
}
static void F_45 ( void * V_63 )
{
struct V_38 * V_38 = V_63 ;
if ( F_46 ( V_38 -> V_64 ) )
F_47 ( V_38 -> V_64 ) ;
}
...
int V_32 = 0 ;
struct V_38 * V_38 = F_17 ( V_13 ) ;
V_32 = F_49 ( V_38 , V_31 -> V_15 , V_31 -> V_16 , F_45 ,
V_38 ) ;
if ( V_32 == - V_65 ) {
F_50 ( V_13 ) ;
V_32 = 0 ;
...
int V_32 = 0 ;
struct V_38 * V_38 = F_17 ( V_13 ) ;
struct V_69 * V_70 = (struct V_69 * ) V_38 -> V_71 [ V_72 ] . V_2 ;
...
{
int V_61 ;
V_61 = V_95 -> V_61 < V_96 -> V_61 ? V_95 -> V_61 : V_96 -> V_61 ;
V_95 -> V_61 = V_61 ;
if ( V_96 -> V_61 ) {
if ( ! V_95 -> V_2 )
return - V_97 ;
if ( F_68 ( ( void V_98 * ) V_95 -> V_2 , V_96 -> V_2 , V_61 ) )
return - V_99 ;
}
return 0 ;
}
...
if ( ! V_96 -> V_2 )
return - V_97 ;
if ( ! ( V_95 -> V_2 && V_95 -> V_61 == V_96 -> V_61 ) ) {
F_66 ( & V_95 -> V_2 ) ;
V_95 -> V_2 = F_33 ( V_96 -> V_61 , V_100 ) ;
if ( V_95 -> V_2 == NULL )
return - V_34 ;
}
if ( F_70 ( V_95 -> V_2 , ( void V_98 * ) V_96 -> V_2 , V_96 -> V_61 ) ) {
F_66 ( & V_95 -> V_2 ) ;
return - V_99 ;
}
V_95 -> V_61 = V_96 -> V_61 ;
...
F_66 ( & V_38 -> V_71 [ V_101 ] . V_2 ) ;
}
static void F_72 ( struct V_12 * V_13 , struct V_69 * V_103 )
{
struct V_38 * V_38 = F_17 ( V_13 ) ;
struct V_69 * V_104 =
(struct V_69 * ) V_38 -> V_71 [ V_72 ] . V_2 ;
if ( ! V_104 )
return;
...
V_32 = F_67 ( & V_110 -> V_15 ,
& V_38 -> V_71 [ V_110 -> V_115 ] ) ;
if ( V_32 < 0 )
return V_32 ;
...
V_32 = F_69 (
& V_38 -> V_71 [ V_110 -> V_115 ] , & V_110 -> V_15 ) ;
if ( V_32 < 0 )
return V_32 ;
}
break;
default:
F_43 ( V_13 , L_26 , V_62 , V_108 ) ;
return - V_112 ;
}
return 0 ;
}
...
static void F_105 ( void * V_63 , void * V_15 , int V_16 )
{
struct V_38 * V_38 = V_63 ;
F_103 ( V_38 -> V_64 , V_15 , V_16 ) ;
F_106 ( V_38 , F_105 , V_38 ) ;
}
static void F_107 ( void * V_63 , void * V_15 , int V_16 )
{
struct V_38 * V_38 = V_63 ;
int V_32 ;
V_32 = F_91 ( V_38 -> V_64 , V_15 , V_16 ) ;
if ( V_32 == 1 )
F_106 ( V_38 , F_105 , V_38 ) ;
else {
if ( V_32 < 0 )
F_43 ( V_38 -> V_64 ,
L_36 , V_32 ) ;
F_106 ( V_38 , F_107 , V_38 ) ;
#if 0
gdm_wimax_prepare_device(nic->netdev);
#endif
}
}
static void F_108 ( struct V_38 * V_38 )
{
F_106 ( V_38 , F_107 , V_38 ) ;
}
...
struct V_12 * V_13 ;
int V_32 ;
V_13 = F_110 ( sizeof( * V_38 ) , L_19 , V_148 ) ;
if ( V_13 == NULL ) {
F_24 ( L_37 ) ;
return - V_34 ;
}
...
{
struct V_38 * V_38 = F_17 ( V_145 -> V_64 ) ;
struct V_69 * V_70 = (struct V_69 * ) V_38 -> V_71 [ V_72 ] . V_2 ;
if ( V_70 )
V_70 -> V_74 = V_93 ;
F_116 ( V_38 -> V_64 ) ;
