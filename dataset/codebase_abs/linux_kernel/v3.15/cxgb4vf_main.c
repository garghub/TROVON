...
static void F_224 ( struct V_367 * V_104 )
{
struct V_1 * V_1 = F_225 ( V_104 ) ;
if ( V_1 ) {
int V_2 ;
F_13 (adapter, pidx)
if ( F_216 ( V_2 , & V_1 -> V_393 ) )
