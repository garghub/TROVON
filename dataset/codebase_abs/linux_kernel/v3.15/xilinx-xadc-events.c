...
void F_6 ( struct V_2 * V_3 , unsigned long V_17 )
{
unsigned int V_18 ;
F_7 (i, &events, 8 )
F_2 ( V_3 , V_18 ) ;
}
static unsigned F_8 ( const struct V_1 * V_10 ,
enum V_19 V_20 )
{
unsigned int V_11 ;
if ( V_10 -> type == V_12 ) {
...
const struct V_1 * V_10 , enum V_29 type ,
enum V_19 V_20 , enum V_43 V_44 ,
int * V_45 , int * V_46 )
{
unsigned int V_11 = F_8 ( V_10 , V_20 ) ;
struct V_30 * V_30 = F_11 ( V_3 ) ;
switch ( V_44 ) {
case V_47 :
* V_45 = V_30 -> V_48 [ V_11 ] ;
...
if ( V_10 -> type == V_12 ) {
V_45 |= 0x3 ;
if ( V_30 -> V_48 [ V_11 ] < V_30 -> V_50 )
V_30 -> V_48 [ V_11 + 4 ] = 0 ;
else
V_30 -> V_48 [ V_11 + 4 ] = V_30 -> V_48 [ V_11 ] -
V_30 -> V_50 ;
V_36 = F_15 ( V_30 , F_19 ( V_11 + 4 ) ,
V_30 -> V_48 [ V_11 + 4 ] ) ;
if ( V_36 )
goto V_54;
}
if ( V_44 == V_47 )
V_36 = F_15 ( V_30 , F_19 ( V_11 ) , V_45 ) ;
V_54:
F_16 ( & V_30 -> V_37 ) ;
return V_36 ;
}
