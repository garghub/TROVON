...
int V_135 ( struct V_1 * V_2 , int V_242 , struct V_243 * * V_244 )
{
struct V_243 * V_215 ;
int V_56 ;
if ( V_244 )
* V_244 = NULL ;
if ( ( V_56 = F_106 ( V_2 -> V_16 , L_18 , V_242 , V_245 , 1 , & V_215 ) ) < 0 )
return V_56 ;
V_215 -> V_32 = V_2 ;
F_107 ( V_215 , V_246 , & V_175 ) ;
F_107 ( V_215 , V_247 , & V_194 ) ;
V_215 -> V_248 = 0 ;
strcpy ( V_215 -> V_249 , L_18 ) ;
V_2 -> V_215 = V_215 ;
F_108 ( V_215 , V_231 ,
...
if ( V_244 )
* V_244 = NULL ;
if ( ( V_56 = F_106 ( V_2 -> V_16 , L_19 , V_242 , V_245 , 0 , & V_215 ) ) < 0 )
return V_56 ;
V_215 -> V_32 = V_2 ;
F_107 ( V_215 , V_246 , & V_177 ) ;
V_215 -> V_248 = 0 ;
strcpy ( V_215 -> V_249 , L_19 ) ;
V_2 -> V_250 = V_215 ;
F_108 ( V_215 , V_231 ,
F_93 ( V_2 -> V_64 ) , 64 * 1024 , 256 * 1024 ) ;
if ( V_244 )
...
if ( V_244 )
* V_244 = NULL ;
if ( ( V_56 = F_106 ( V_2 -> V_16 , L_20 , V_242 , V_245 , 0 , & V_215 ) ) < 0 )
return V_56 ;
V_215 -> V_32 = V_2 ;
F_107 ( V_215 , V_246 , & V_179 ) ;
V_215 -> V_248 = 0 ;
strcpy ( V_215 -> V_249 , L_20 ) ;
V_2 -> V_251 = V_215 ;
F_108 ( V_215 , V_231 ,
F_93 ( V_2 -> V_64 ) , 64 * 1024 , 256 * 1024 ) ;
if ( V_244 )
...
return V_56 ;
V_215 -> V_32 = V_2 ;
F_107 ( V_215 , V_246 , & V_181 ) ;
V_215 -> V_248 = 0 ;
strcpy ( V_215 -> V_249 , L_21 ) ;
V_2 -> V_250 = V_215 ;
F_108 ( V_215 , V_231 ,
F_93 ( V_2 -> V_64 ) , 64 * 1024 , 256 * 1024 ) ;
if ( V_244 )
...
int F_169 ( struct V_1 * V_2 , int V_242 , struct V_334 * * V_335 )
{
struct V_334 * V_217 ;
int V_56 ;
if ( V_335 )
...
return V_56 ;
strcpy ( V_217 -> V_249 , L_31 ) ;
F_171 ( V_217 , V_336 , & V_337 ) ;
F_171 ( V_217 , V_338 , & V_339 ) ;
V_217 -> V_248 |= V_340 | V_341 | V_342 ;
V_217 -> V_32 = V_2 ;
V_2 -> V_217 = V_217 ;
if ( V_335 )
* V_335 = NULL ;
...
static void F_172 ( struct V_343 * V_343 )
{
struct V_1 * V_2 = F_173 ( V_343 ) ;
if ( F_2 ( ! V_2 ) )
return;
F_5 ( V_2 , V_344 , 0xFF ) ;
}
static unsigned char F_174 ( struct V_343 * V_343 )
{
struct V_1 * V_2 = F_173 ( V_343 ) ;
if ( F_2 ( ! V_2 ) )
return 0 ;
return F_3 ( V_2 , V_344 ) ;
}
static int F_175 ( struct V_343 * V_343 , int * V_345 , int * V_346 )
{
struct V_1 * V_2 = F_173 ( V_343 ) ;
unsigned V_347 , V_348 , V_349 ;
if ( F_2 ( ! V_2 ) )
return 0 ;
V_347 = F_3 ( V_2 , V_350 ) ;
V_348 = F_3 ( V_2 , V_351 ) ;
V_349 = F_3 ( V_2 , V_344 ) ;
* V_346 = ( ~ V_349 >> 4 ) & 0x0F ;
V_345 [ 0 ] = ( ( V_347 & V_352 ) >> V_353 ) & 0xFFFF ;
V_345 [ 1 ] = ( ( V_347 & V_354 ) >> V_355 ) & 0xFFFF ;
V_345 [ 2 ] = ( ( V_348 & V_356 ) >> V_357 ) & 0xFFFF ;
V_345 [ 3 ] = ( ( V_348 & V_358 ) >> V_359 ) & 0xFFFF ;
for( V_349 = 0 ; V_349 < 4 ; ++ V_349 )
if( V_345 [ V_349 ] == 0xFFFF ) V_345 [ V_349 ] = - 1 ;
return 0 ;
}
static int F_176 ( struct V_343 * V_343 , int V_360 )
{
switch ( V_360 ) {
case V_361 :
return 0 ;
...
F_179 ( V_363 , L_33 ) ;
F_180 ( V_363 , L_34 , F_181 ( V_2 -> V_64 ) ) ;
F_182 ( V_363 , & V_2 -> V_64 -> V_17 ) ;
F_183 ( V_363 , V_2 ) ;
V_363 -> V_364 = F_176 ;
V_363 -> V_315 = F_174 ;
V_363 -> V_365 = F_172 ;
...
int F_177 ( struct V_1 * V_2 ) { return - V_370 ; }
static inline void F_185 ( struct V_1 * V_2 ) { }
static T_7 F_187 ( struct V_371 * V_71 ,
void * V_372 ,
struct V_373 * V_373 , char T_8 * V_374 ,
T_4 V_5 , T_9 V_375 )
{
struct V_376 * V_40 = V_71 -> V_32 ;
if ( F_188 ( V_374 , V_40 -> V_42 + V_375 , V_5 ) )
return - V_377 ;
return V_5 ;
}
...
struct V_376 * V_40 = & V_2 -> V_40 . V_41 [ V_41 ] ;
if ( ! F_190 ( V_16 , V_40 -> V_249 , & V_71 ) ) {
V_71 -> V_378 = V_379 ;
V_71 -> V_32 = V_2 ;
V_71 -> V_218 . V_174 = & V_380 ;
V_71 -> V_65 = V_40 -> V_65 ;
V_71 -> V_360 = V_381 | V_382 ;
}
}
#ifdef F_50
F_191 ( V_16 , V_2 ) ;
...
F_185 ( V_2 ) ;
if ( V_2 -> V_303 )
V_2 -> V_303 ( V_2 , - V_2 -> V_384 ) ;
F_192 ( V_2 ) ;
if ( V_2 -> V_40 . V_41 [ 0 ] . V_385 )
F_194 ( V_2 ) ;
if ( V_2 -> V_196 >= 0 )
F_196 ( V_2 -> V_196 , V_2 ) ;
if ( V_2 -> V_11 )
V_2 -> V_11 ( V_2 , - V_2 -> V_384 ) ;
for ( V_41 = 0 ; V_41 < 5 ; V_41 ++ ) {
struct V_376 * V_40 = & V_2 -> V_40 . V_41 [ V_41 ] ;
if ( V_40 -> V_42 )
F_197 ( V_40 -> V_42 ) ;
...
static int F_203 ( struct V_389 * V_242 )
{
struct V_1 * V_2 = V_242 -> V_390 ;
return F_195 ( V_2 ) ;
}
...
F_5 ( V_2 , V_392 , 0 ) ;
#ifdef F_50
F_5 ( V_2 , V_393 , V_394 | V_395 |
V_396 ) ;
#else
F_5 ( V_2 , V_393 , V_394 | V_397 ) ;
#endif
F_5 ( V_2 , V_14 , 0 ) ;
#ifdef F_50
F_5 ( V_2 , V_398 , 0 ) ;
...
#ifdef F_50
F_5 ( V_2 , V_398 , V_18 | V_22 ) ;
#endif
F_32 ( 10 ) ;
F_5 ( V_2 , V_392 , V_399 ) ;
F_5 ( V_2 , V_400 , V_401 | V_402 ) ;
F_5 ( V_2 , V_403 , 0x3a ) ;
F_5 ( V_2 , V_404 , V_405 ) ;
F_5 ( V_2 , V_96 , V_406 ) ;
F_6 ( 100 ) ;
F_5 ( V_2 , V_96 , V_406 | V_97 ) ;
F_5 ( V_2 , V_407 , V_408 ) ;
F_33 ( V_2 ) ;
F_5 ( V_2 , V_409 , V_410 | V_411 ) ;
F_5 ( V_2 , V_412 , V_413 | V_411 ) ;
F_5 ( V_2 , V_392 , V_399 | V_414 ) ;
#ifdef F_50
F_5 ( V_2 , V_415 , V_416 ) ;
F_5 ( V_2 , V_417 , 0 ) ;
F_5 ( V_2 , V_418 , 0 ) ;
...
#ifdef F_50
F_5 ( V_2 , V_398 , V_15 | V_18 | V_22 ) ;
#endif
V_391 = 150 ;
while ( V_391 -- > 0 ) {
if ( ( F_3 ( V_2 , V_424 ) & ( V_425 | V_426 ) ) == ( V_425 | V_426 ) )
goto V_29;
F_6 ( 10 ) ;
}
#ifndef F_50
...
F_29 ( V_2 ) ;
#ifdef F_50
for ( V_51 = 0 ; V_51 < V_386 ; V_51 ++ ) {
V_56 = F_19 ( V_2 , & V_2 -> V_387 [ V_51 ] , V_430 [ V_51 ] ) ;
if ( V_56 < 0 ) {
F_8 ( V_2 -> V_16 -> V_17 , L_43 ,
V_430 [ V_51 ] ) ;
return V_56 ;
}
V_56 = F_207 ( V_2 , V_2 -> V_387 [ V_51 ] ) ;
if ( V_56 < 0 ) {
...
{
T_1 V_41 , V_433 , V_7 , V_95 = 0 ;
T_10 V_434 , V_435 , V_436 ;
...
F_5 ( V_2 , V_283 ,
V_444 | V_282 ) ;
} else if ( V_267 && ! V_2 -> V_384 ) {
F_34 ( V_2 -> V_16 -> V_17 , L_50 ) ;
F_5 ( V_2 , V_280 , V_279 & ~ V_443 ) ;
F_5 ( V_2 , V_283 , V_282 & ~ V_444 ) ;
}
}
...
if ( V_2 -> V_445 )
return;
for ( V_41 = 0 ; V_41 < F_155 ( V_446 ) ; V_41 ++ ) {
struct V_256 * V_318 ;
V_318 = F_156 ( & V_446 [ V_41 ] , V_2 ) ;
if ( ( V_56 = F_157 ( V_16 , V_318 ) ) < 0 ) {
F_8 ( V_16 -> V_17 ,
L_53 ,
V_56 ) ;
...
return;
V_2 -> V_384 += V_268 ;
V_448 = V_447 = F_217 ( V_2 -> V_449 + 0x10 ) ;
if ( ! V_2 -> V_384 )
V_448 |= 0x2000 ;
else
V_448 &= ~ 0x2000 ;
if ( V_448 != V_447 )
F_218 ( V_448 , V_2 -> V_449 + 0x10 ) ;
}
...
if ( V_451 == NULL )
return;
F_221 ( V_451 , 0x41 , & V_452 ) ;
V_2 -> V_449 = V_452 << 8 ;
F_222 ( V_451 ) ;
}
static int F_223 ( struct V_242 * V_17 )
{
struct V_450 * V_64 = F_224 ( V_17 ) ;
struct V_309 * V_16 = F_225 ( V_17 ) ;
...
F_228 ( V_2 -> V_31 [ V_9 ] ) ;
F_228 ( V_2 -> V_31 [ V_10 ] ) ;
for ( V_51 = 0 ; V_51 < F_155 ( V_388 ) ; V_51 ++ )
V_2 -> V_388 [ V_51 ] = F_3 ( V_2 , V_388 [ V_51 ] ) ;
V_455 = V_2 -> V_384 ;
V_2 -> V_303 ( V_2 , - V_2 -> V_384 ) ;
F_194 ( V_2 ) ;
V_2 -> V_11 ( V_2 , - V_2 -> V_384 ) ;
...
static int F_231 ( struct V_242 * V_17 )
{
struct V_450 * V_64 = F_224 ( V_17 ) ;
struct V_309 * V_16 = F_225 ( V_17 ) ;
struct V_1 * V_2 = V_16 -> V_32 ;
...
F_236 ( V_2 ) ;
for ( V_51 = 0 ; V_51 < F_155 ( V_388 ) ; V_51 ++ )
F_5 ( V_2 , V_388 [ V_51 ] , V_2 -> V_388 [ V_51 ] ) ;
#else
F_28 ( V_2 ) ;
#endif
#if 0
...
V_2 -> V_64 = V_64 ;
V_2 -> V_196 = - 1 ;
V_2 -> V_469 = F_241 ( V_64 , 0 ) ;
V_2 -> V_470 = F_241 ( V_64 , 1 ) ;
if ( V_2 -> V_469 == 0 || V_2 -> V_469 == ( unsigned long ) ~ 0 ||
V_2 -> V_470 == 0 || V_2 -> V_470 == ( unsigned long ) ~ 0 ) {
F_8 ( V_2 -> V_16 -> V_17 ,
L_55 ,
V_2 -> V_469 , V_2 -> V_470 ) ;
F_195 ( V_2 ) ;
...
V_40 = & V_2 -> V_40 . V_249 . V_471 ;
strcpy ( V_40 -> V_249 , L_56 ) ;
V_40 -> V_472 = V_2 -> V_469 ;
V_40 -> V_65 = V_473 ;
V_40 = & V_2 -> V_40 . V_249 . V_474 ;
strcpy ( V_40 -> V_249 , L_57 ) ;
V_40 -> V_472 = V_2 -> V_470 + V_475 ;
V_40 -> V_65 = V_476 ;
V_40 = & V_2 -> V_40 . V_249 . V_477 ;
strcpy ( V_40 -> V_249 , L_58 ) ;
V_40 -> V_472 = V_2 -> V_470 + V_478 ;
V_40 -> V_65 = V_479 ;
V_40 = & V_2 -> V_40 . V_249 . V_480 ;
strcpy ( V_40 -> V_249 , L_59 ) ;
V_40 -> V_472 = V_2 -> V_470 + V_481 ;
V_40 -> V_65 = V_482 ;
V_40 = & V_2 -> V_40 . V_249 . V_3 ;
strcpy ( V_40 -> V_249 , L_60 ) ;
V_40 -> V_472 = V_2 -> V_470 + V_483 ;
V_40 -> V_65 = V_484 ;
F_242 ( V_64 , V_485 , & V_466 ) ;
F_242 ( V_64 , V_486 , & V_465 ) ;
for ( V_464 = & V_487 [ 0 ] ; V_464 -> V_249 ; V_464 ++ ) {
if ( V_464 -> V_488 == V_466 && V_464 -> V_311 == V_465 ) {
F_34 ( V_2 -> V_16 -> V_17 , L_61 ,
V_464 -> V_249 ) ;
V_2 -> V_303 = V_464 -> V_489 ;
V_2 -> V_11 = V_464 -> V_211 ;
V_2 -> V_324 = V_464 -> V_324 ;
if ( V_464 -> V_490 )
V_464 -> V_490 ( V_2 ) ;
break;
}
...
if ( ( V_40 -> V_385 = F_244 ( V_40 -> V_472 , V_40 -> V_65 ,
V_40 -> V_249 ) ) == NULL ) {
F_8 ( V_2 -> V_16 -> V_17 ,
L_64 ,
V_40 -> V_472 , V_40 -> V_472 + V_40 -> V_65 - 1 ) ;
F_195 ( V_2 ) ;
return - V_491 ;
}
V_40 -> V_42 = F_245 ( V_40 -> V_472 , V_40 -> V_65 ) ;
if ( V_40 -> V_42 == NULL ) {
F_8 ( V_2 -> V_16 -> V_17 ,
L_65 , V_40 -> V_249 ) ;
F_195 ( V_2 ) ;
...
if ( F_246 ( V_64 -> V_196 , F_86 , V_492 ,
V_493 , V_2 ) ) {
F_8 ( V_2 -> V_16 -> V_17 , L_66 , V_64 -> V_196 ) ;
F_195 ( V_2 ) ;
return - V_491 ;
}
...
if ( ( V_56 = F_248 ( V_16 , V_494 , V_2 , & V_174 ) ) < 0 ) {
F_195 ( V_2 ) ;
return V_56 ;
}
F_189 ( V_16 , V_2 ) ;
#ifdef F_201
V_2 -> V_388 = F_24 ( sizeof( * V_2 -> V_388 ) *
F_155 ( V_388 ) , V_67 ) ;
if ( ! V_2 -> V_388 ) {
F_195 ( V_2 ) ;
return - V_66 ;
