...
static int F_22 ( struct V_4 * V_50 ,
struct V_1 * V_1 , struct V_13 * V_14 , const void * V_51 )
{
const struct V_6 * V_7 = V_51 ;
struct V_4 * V_4 ;
struct V_16 * V_17 ;
V_4 = F_23 ( V_50 -> V_41 , V_14 ) ;
if ( ! V_4 )
goto V_45;
V_17 = F_2 ( V_4 ) ;
V_4 -> V_33 = V_52 | V_53 ;
...
static int F_26 ( struct V_56 * V_56 , struct V_57 * V_58 )
{
struct V_13 * V_14 = F_13 ( F_27 ( V_56 ) ) ;
const struct V_6 * * V_59 , * * V_60 ;
if ( ! V_14 )
return - V_21 ;
if ( ! F_28 ( V_56 , V_58 ) )
goto V_45;
if ( V_58 -> V_61 >= 2 + F_29 ( V_62 ) )
goto V_45;
V_59 = V_62 + ( V_58 -> V_61 - 2 ) ;
V_60 = & V_62 [ F_29 ( V_62 ) - 1 ] ;
while ( V_59 <= V_60 ) {
const struct V_6 * V_63 = * V_59 ;
if ( ! F_30 ( V_56 , V_58 , V_63 -> V_9 , strlen ( V_63 -> V_9 ) ,
F_22 , V_14 , V_63 ) )
break;
V_58 -> V_61 ++ ;
V_59 ++ ;
...
static struct V_1 * F_31 ( struct V_4 * V_50 ,
struct V_1 * V_1 , unsigned int V_64 )
{
int error ;
struct V_13 * V_14 = F_13 ( V_50 ) ;
const struct V_6 * * V_59 , * * V_60 ;
unsigned int V_65 = V_1 -> V_66 . V_65 ;
error = - V_21 ;
if ( ! V_14 )
goto V_67;
V_60 = & V_62 [ F_29 ( V_62 ) ] ;
for ( V_59 = V_62 ; V_59 < V_60 ; V_59 ++ ) {
if ( strlen ( ( * V_59 ) -> V_9 ) != V_65 )
continue;
if ( ! memcmp ( V_1 -> V_66 . V_9 , ( * V_59 ) -> V_9 , V_65 ) )
break;
}
if ( V_59 == V_60 )
goto V_45;
error = F_22 ( V_50 , V_1 , V_14 , * V_59 ) ;
V_45:
F_19 ( V_14 ) ;
V_67:
return F_5 ( error ) ;
}
struct V_56 * F_32 ( int V_68 )
{
struct V_56 * V_56 ;
V_56 = F_33 ( V_68 ) ;
if ( ! V_56 )
