...
T_3 V_147 [ 2 ] = { V_102 -> V_107 , V_143 } ;
struct V_31 * V_32 ;
if ( V_144 ) {
F_76 ( & V_37 -> V_118 ) ;
V_32 = & V_37 -> V_32 ;
} else if ( F_111 ( & V_37 -> V_118 ) )
V_32 = & V_37 -> V_55 ;
else
return - V_148 ;
if ( V_37 -> V_121 )
goto V_141;
V_44 = F_80 ( V_32 , V_37 -> V_34 , V_147 , & V_30 ) ;
if ( ! V_44 )
V_146 = F_8 ( V_30 ) ;
V_141:
F_77 ( & V_37 -> V_118 ) ;
...
& V_150 ) ;
V_43 -> V_143 = V_149 ;
V_43 -> V_151 = F_109 ( V_102 , V_150 ) ;
}
return V_44 ;
}
static int F_112 ( struct V_101 * V_102 , T_3 V_143 ,
T_3 V_152 )
{
int V_44 , V_153 ;
T_5 V_30 ;
...
F_63 ( & V_30 ) ;
V_44 = F_113 ( & V_37 -> V_32 , V_37 -> V_34 , V_147 , & V_30 ,
& V_37 -> V_34 , & V_153 ) ;
if ( V_44 )
return V_44 ;
V_102 -> V_106 = 1 ;
...
int F_114 ( struct V_101 * V_102 , T_3 V_143 ,
T_3 V_152 )
{
int V_44 = - V_91 ;
F_86 ( & V_102 -> V_37 -> V_118 ) ;
if ( ! V_102 -> V_37 -> V_121 )
V_44 = F_112 ( V_102 , V_143 , V_152 ) ;
F_87 ( & V_102 -> V_37 -> V_118 ) ;
return V_44 ;
}
static int F_115 ( struct V_101 * V_102 , T_3 V_143 )
{
int V_44 ;
struct V_36 * V_37 = V_102 -> V_37 ;
T_3 V_147 [ 2 ] = { V_102 -> V_107 , V_143 } ;
V_44 = F_84 ( & V_37 -> V_32 , V_37 -> V_34 , V_147 , & V_37 -> V_34 ) ;
if ( V_44 )
return V_44 ;
V_102 -> V_108 -- ;
V_102 -> V_106 = 1 ;
...
int F_116 ( struct V_101 * V_102 , T_3 V_143 )
{
int V_44 = - V_91 ;
F_86 ( & V_102 -> V_37 -> V_118 ) ;
if ( ! V_102 -> V_37 -> V_121 )
V_44 = F_115 ( V_102 , V_143 ) ;
F_87 ( & V_102 -> V_37 -> V_118 ) ;
return V_44 ;
}
int F_117 ( struct V_36 * V_37 , T_3 V_4 , bool * V_43 )
{
int V_44 ;
T_4 V_154 ;
F_76 ( & V_37 -> V_118 ) ;
V_44 = F_118 ( V_37 -> V_50 , V_4 , & V_154 ) ;
if ( ! V_44 )
* V_43 = ( V_154 != 0 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
bool F_119 ( struct V_101 * V_102 )
{
int V_44 ;
...
static void F_125 ( struct V_36 * V_37 )
{
struct V_101 * V_102 ;
...
int F_127 ( struct V_36 * V_37 , T_3 * V_43 )
{
int V_44 = - V_91 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_128 ( V_37 -> V_50 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
...
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_131 ( V_37 -> V_62 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_132 ( struct V_36 * V_37 , T_6 * V_43 )
{
F_76 ( & V_37 -> V_118 ) ;
* V_43 = V_37 -> V_83 ;
F_77 ( & V_37 -> V_118 ) ;
...
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_131 ( V_37 -> V_50 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_134 ( struct V_101 * V_102 , T_3 * V_43 )
{
int V_44 = - V_91 ;
struct V_36 * V_37 = V_102 -> V_37 ;
F_76 ( & V_37 -> V_118 ) ;
...
static int F_135 ( struct V_101 * V_102 , T_3 * V_43 )
{
int V_44 ;
T_5 V_20 ;
T_3 V_155 ;
...
return V_44 ;
V_155 = F_8 ( V_20 ) ;
return F_136 ( & V_37 -> V_58 , V_155 , V_43 ) ;
}
int F_137 ( struct V_101 * V_102 ,
T_3 * V_43 )
{
int V_44 = - V_91 ;
struct V_36 * V_37 = V_102 -> V_37 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_135 ( V_102 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
static int F_138 ( struct V_21 * V_22 , T_3 V_156 )
{
int V_44 ;
T_3 V_157 ;
V_44 = F_131 ( V_22 , & V_157 ) ;
if ( V_44 )
return V_44 ;
if ( V_156 == V_157 )
return 0 ;
...
return F_139 ( V_22 , V_156 - V_157 ) ;
}
int F_140 ( struct V_36 * V_37 , T_3 V_156 )
{
int V_44 = - V_91 ;
F_86 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_138 ( V_37 -> V_50 , V_156 ) ;
F_87 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_141 ( struct V_36 * V_37 , T_3 V_156 )
{
int V_44 = - V_91 ;
F_86 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_138 ( V_37 -> V_62 , V_156 ) ;
F_87 ( & V_37 -> V_118 ) ;
return V_44 ;
}
void F_142 ( struct V_36 * V_37 )
{
F_86 ( & V_37 -> V_118 ) ;
V_37 -> V_120 = true ;
F_143 ( V_37 -> V_39 ) ;
...
int V_44 ;
F_86 ( & V_37 -> V_118 ) ;
V_44 = F_147 ( V_37 -> V_62 , V_158 , V_159 , V_19 ) ;
F_87 ( & V_37 -> V_118 ) ;
return V_44 ;
}
...
bool F_149 ( struct V_36 * V_37 )
{
bool V_161 ;
F_76 ( & V_37 -> V_118 ) ;
V_161 = V_37 -> V_10 & V_160 ;
F_77 ( & V_37 -> V_118 ) ;
return V_161 ;
}
