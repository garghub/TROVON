...
static void F_43 ( struct V_81 * V_82 , T_1 V_83 )
{
struct V_4 * V_4 =
F_2 ( V_82 , struct V_4 , V_63 ) ;
F_44 ( L_18 , V_4 -> V_30 , V_83 ) ;
}
struct V_11 * F_45 ( struct V_6 * V_7 ,
int V_31 , bool V_84 )
{
struct V_41 * V_42 = V_7 -> V_43 ;
...
V_4 = F_46 ( sizeof( * V_4 ) , V_86 ) ;
if ( ! V_4 )
goto V_87;
V_16 = F_47 ( & V_4 -> V_5 , 16 ,
L_20 , F_1 ) ;
if ( V_16 ) {
F_13 ( V_7 -> V_7 , L_21 ) ;
goto V_87;
...
V_4 -> V_18 . V_90 = F_14 ;
V_4 -> V_18 . V_91 = F_21 ;
V_4 -> V_63 . V_92 = V_93 [ V_31 ] ;
V_4 -> V_63 . V_82 = F_43 ;
F_50 ( V_7 , & V_4 -> V_63 ) ;
F_51 ( V_7 , V_12 , ( 1 << V_42 -> V_94 ) - 1 , & V_95 ,
