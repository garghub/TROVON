...
V_16 = F_30 ( V_3 , V_100 , V_71 ) ;
if ( V_16 )
return V_16 ;
V_69 -> V_101 = ( 1 << V_70 ) ;
V_16 = F_39 ( V_3 -> V_102 , V_69 , 1 ) ;
if ( V_16 )
return V_16 ;
V_3 -> V_103 = 0 ;
return 0 ;
...
V_107 = & V_3 -> V_72 [ V_3 -> V_73 ] ;
F_16 ( & V_3 -> V_104 ) ;
V_16 = V_107 -> V_108 ( V_3 , V_107 -> V_55 ) ;
if ( V_16 )
F_40 ( V_3 ) ;
}
...
if ( V_3 -> V_103 >= V_109 )
return;
V_107 = & V_3 -> V_72 [ V_3 -> V_103 ++ ] ;
V_107 -> V_55 = V_55 ;
V_107 -> V_108 = V_108 ;
}
static int F_43 ( struct V_102 * V_102 , T_6 V_110 ,
T_6 V_111 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
T_7 V_112 , V_113 ;
F_37 ( L_9 , V_110 ,
V_111 , V_3 -> V_114 ) ;
V_112 = V_3 -> V_114 & V_110 ;
V_113 = V_3 -> V_114 & V_111 ;
if ( ! V_112 && ! V_113 ) {
F_24 ( L_10 ) ;
return - V_94 ;
}
...
static void F_45 ( struct V_102 * V_102 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
F_14 ( & V_3 -> V_104 ) ;
if ( ! V_3 -> V_103 ) {
...
static int F_47 ( struct V_102 * V_102 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
F_10 ( V_3 , 1 ) ;
return 0 ;
}
static int F_48 ( struct V_102 * V_102 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
F_10 ( V_3 , 0 ) ;
return 0 ;
}
static int F_49 ( struct V_102 * V_102 ,
struct V_68 * V_69 ,
T_8 V_129 , T_8 * V_130 , T_9 V_131 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
int V_16 ;
V_16 = F_50 ( V_3 , V_69 , V_129 , V_130 , V_131 ) ;
if ( ! V_16 )
V_3 -> V_116 = V_86 ;
return V_16 ;
}
static int F_51 ( struct V_102 * V_102 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
V_3 -> V_116 = 0 ;
return 0 ;
}
static int F_52 ( struct V_102 * V_102 ,
...
static void F_53 ( struct V_102 * V_102 ,
struct V_68 * V_69 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
if ( ! V_3 -> V_116 ) {
...
static int F_54 ( struct V_102 * V_132 , struct V_1 * V_5 )
{
struct V_2 * V_3 = F_44 ( V_132 ) ;
return F_55 ( V_3 , V_5 ) ;
}
static void F_56 ( struct V_2 * V_3 , void * V_36 ,
struct V_1 * V_30 )
{
struct V_133 * V_134 = V_36 ;
int V_16 ;
if ( F_18 ( V_30 ) ) {
V_16 = F_57 ( V_30 ) ;
V_30 = NULL ;
...
V_134 -> V_136 ( V_134 -> V_33 , V_30 , V_16 ) ;
F_20 ( V_134 ) ;
}
static int F_60 ( struct V_102 * V_102 , struct V_68 * V_69 ,
struct V_1 * V_5 , T_10 V_136 ,
void * V_33 )
{
struct V_2 * V_3 = F_44 ( V_102 ) ;
struct V_133 * V_134 ;
int V_16 ;
V_134 = F_27 ( sizeof( struct V_133 ) , V_8 ) ;
if ( ! V_134 ) {
F_24 ( L_17 ) ;
return - V_51 ;
}
...
struct V_2 * F_64 ( struct V_137 * V_19 ,
T_6 V_101 ,
T_6 V_138 ,
int V_6 , int V_7 )
{
...
V_3 -> V_6 = V_6 + V_144 ;
V_3 -> V_7 = V_7 + V_145 ;
V_3 -> V_102 = F_67 ( & V_146 , V_3 -> V_114 ,
V_3 -> V_6 ,
V_3 -> V_7 ) ;
if ( ! V_3 -> V_102 ) {
F_24 ( L_18 ) ;
