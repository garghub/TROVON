...
F_63 ( V_16 ) ;
* ( ( T_1 * ) F_64 ( V_16 , 4 ) ) = 0 ;
V_73 = F_65 ( F_64 ( V_16 , V_31 ) , V_88 -> V_105 , V_31 ) ;
if ( V_73 < 0 ) {
F_27 ( V_16 ) ;
goto error;
}
...
F_74 ( V_16 , & V_90 -> V_118 ) ;
V_119:
V_73 = F_75 ( V_3 , V_16 , & V_9 -> V_106 . V_107 ) ;
F_76 () ;
error:
if ( V_73 >= 0 )
V_73 = V_31 ;
...
T_3 V_123 = 0 ;
int V_124 = - V_125 ;
F_59 ( struct V_126 * , sin , V_88 -> V_95 ) ;
struct V_15 * V_16 ;
if ( V_75 & V_127 )
goto V_65;
V_16 = F_78 ( V_3 , V_75 , V_122 , & V_124 ) ;
if ( ! V_16 )
goto V_65;
V_123 = V_16 -> V_31 ;
if ( V_31 < V_123 ) {
...
V_124 = F_79 ( V_16 , 0 , V_88 -> V_105 , V_123 ) ;
if ( V_124 )
goto V_130;
F_80 ( V_88 , V_3 , V_16 ) ;
if ( sin ) {
sin -> V_131 = V_57 ;
sin -> V_132 . V_60 = F_81 ( V_16 ) -> V_133 ;
sin -> V_134 = 0 ;
