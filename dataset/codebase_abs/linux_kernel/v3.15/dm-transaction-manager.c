...
if ( V_4 < 0 )
return V_4 ;
return F_20 ( V_2 -> V_20 ) ;
}
int F_21 ( struct V_1 * V_2 , struct V_28 * V_29 )
{
if ( V_2 -> V_25 )
return - V_27 ;
F_9 ( V_2 ) ;
...
if ( V_2 -> V_25 )
return - V_27 ;
V_4 = F_24 ( V_2 -> V_22 , & V_33 ) ;
if ( V_4 < 0 )
return V_4 ;
V_4 = F_25 ( V_2 -> V_20 , V_33 , V_31 , V_32 ) ;
if ( V_4 < 0 ) {
F_26 ( V_2 -> V_22 , V_33 ) ;
return V_4 ;
}
...
T_1 V_35 ;
struct V_28 * V_36 ;
V_4 = F_24 ( V_2 -> V_22 , & V_35 ) ;
if ( V_4 < 0 )
return V_4 ;
V_4 = F_26 ( V_2 -> V_22 , V_34 ) ;
if ( V_4 < 0 )
return V_4 ;
V_4 = F_28 ( V_2 -> V_20 , V_34 , V_31 , & V_36 ) ;
if ( V_4 < 0 )
return V_4 ;
V_4 = F_25 ( V_2 -> V_20 , V_35 , V_31 , V_32 ) ;
if ( V_4 ) {
F_22 ( V_36 ) ;
return V_4 ;
}
...
return F_28 ( V_2 -> V_20 , V_3 , V_31 , V_38 ) ;
}
