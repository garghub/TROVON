...
int F_48 ( struct V_34 * V_65 )
{
struct V_1 * V_2 = V_65 -> V_2 ;
struct V_62 * V_63 = F_45 ( V_2 ) ;
int V_66 ;
F_46 ( & V_63 -> V_64 ) ;
V_66 = F_37 ( V_65 -> V_42 -> V_46 ,
V_65 -> V_42 -> V_48 ,
V_65 -> V_42 -> V_47 - 1 ) ;
F_47 ( & V_63 -> V_64 ) ;
return V_66 ;
...
struct V_43 * V_44 = F_50 ( V_70 , V_48 ) ;
V_44 -> V_8 = F_40 ( V_37 ) ;
V_44 -> V_38 = 0 ;
V_68 -> V_36 [ V_48 ] =
V_67 ;
...
struct V_43 * V_70 = V_68 -> V_55 ;
struct V_43 * V_44 = F_50 ( V_70 , V_47 ) ;
struct V_43 V_45 ;
T_2 V_38 ;
V_45 = * V_44 ;
V_38 = F_52 ( V_45 . V_38 ) ;
...
* V_73 = F_53 ( V_45 . V_8 ) ;
* V_74 = V_38 ;
* V_75 = F_54 ( F_52 ( V_45 . V_40 ) , V_57 ) ;
if ( F_52 ( V_45 . V_40 ) & V_61 )
* V_76 = V_77 ;
else
* V_76 = 0 ;
if ( V_72 )
...
void F_60 ( struct V_1 * V_2 , unsigned int V_81 )
{
struct V_62 * V_63 = F_45 ( V_2 ) ;
...
static struct V_34 * F_80 ( struct V_1 * V_2 ,
unsigned int V_81 ,
const struct V_90 * V_91 )
{
struct V_62 * V_63 = F_45 ( V_2 ) ;
...
struct V_34 * F_81 ( struct V_1 * V_2 ,
unsigned int V_81 ,
const struct V_90 * V_91 )
{
struct V_34 * V_35 ;
...
if ( V_51 )
return NULL ;
V_35 = F_80 ( V_2 , V_81 , V_91 ) ;
if ( ! V_35 ) {
F_83 ( L_4 , V_81 ) ;
goto V_69;
}
if ( V_91 -> V_93 ) {
V_51 = F_68 ( V_2 , V_81 , V_35 , V_91 ) ;
if ( V_51 ) {
F_83 ( L_5 ,
V_81 , V_51 ) ;
F_84 ( V_35 ) ;
