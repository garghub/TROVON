...
F_58 ( V_119 , & V_122 ) ;
V_11 -> V_70 = V_122 . V_125 . V_126 - V_127 ;
if ( V_11 -> V_70 < 0 || V_11 -> V_70 >= V_128 )
return - V_129 ;
F_56 ( V_119 , L_20 ,
& V_11 -> V_35 ) ;
V_11 -> V_39 = F_59 ( V_119 ,
L_21 ) ;
V_11 -> V_22 = V_122 . V_130 . V_131 . V_132 ;
F_60 ( V_119 ) ;
return 0 ;
}
...
int V_46 = - V_139 ;
int V_8 ;
V_11 = F_62 ( V_44 , sizeof( * V_11 ) , V_140 ) ;
if ( ! V_11 )
return - V_139 ;
F_63 ( & V_11 -> V_62 ) ;
F_64 ( & V_11 -> V_55 ) ;
V_11 -> V_45 = V_45 ;
if ( V_44 -> V_120 ) {
V_134 = F_65 ( V_141 , V_44 -> V_120 ) ;
if ( F_66 ( V_134 == NULL ) )
return - V_42 ;
V_136 = V_134 -> V_85 ;
V_11 -> V_15 = V_136 -> V_15 ;
V_46 = F_55 ( V_45 , V_11 ) ;
} else {
V_46 = F_53 ( V_45 , V_11 ) ;
}
...
V_11 -> V_142 = F_67 ( V_44 , L_23 ) ;
if ( F_16 ( V_11 -> V_142 ) )
return F_22 ( V_11 -> V_142 ) ;
V_138 = F_68 ( V_45 , V_143 , 0 ) ;
V_11 -> V_104 = F_69 ( V_44 , V_138 ) ;
if ( F_16 ( V_11 -> V_104 ) )
...
V_11 -> V_145 [ V_8 ] . V_146 = V_147 [ V_8 ] ;
V_46 = F_71 ( V_44 , V_144 ,
V_11 -> V_145 ) ;
if ( V_46 )
return V_46 ;
V_46 = F_20 ( V_11 ) ;
...
return V_46 ;
if ( V_11 -> V_111 )
V_46 = F_72 ( V_11 -> clock [ V_148 ] ,
V_11 -> V_111 ) ;
else
F_73 ( V_44 , L_25 ) ;
if ( V_46 < 0 )
goto V_149;
V_46 = F_74 ( V_11 -> clock [ V_148 ] ) ;
if ( V_46 < 0 )
goto V_149;
...
V_11 -> V_23 . V_25 = V_90 ;
V_11 -> V_23 . V_26 = V_91 ;
V_11 -> V_156 [ V_157 ] . V_54 = V_158 ;
V_11 -> V_156 [ V_80 ] . V_54 = V_159 ;
V_46 = F_78 ( & V_11 -> V_4 . V_160 ,
V_161 , V_11 -> V_156 , 0 ) ;
if ( V_46 < 0 )
goto V_150;
F_79 ( & V_11 -> V_4 , V_45 ) ;
F_80 ( V_45 , & V_11 -> V_4 ) ;
memcpy ( V_11 -> V_57 , V_162 , sizeof( V_11 -> V_57 ) ) ;
F_81 ( V_44 ) ;
if ( ! F_82 ( V_44 ) ) {
V_46 = F_83 ( V_44 , true ) ;
if ( V_46 < 0 )
...
F_85 ( & V_11 -> V_4 . V_160 ) ;
V_150:
F_86 ( V_11 -> clock [ V_148 ] ) ;
V_149:
F_15 ( V_11 ) ;
return V_46 ;
}
static int F_87 ( struct V_43 * V_44 , bool V_164 )
{
struct V_107 * V_45 = F_88 ( V_44 ) ;
struct V_2 * V_4 = F_89 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
int V_46 = 0 ;
...
static int F_83 ( struct V_43 * V_44 , bool V_164 )
{
struct V_107 * V_45 = F_88 ( V_44 ) ;
struct V_2 * V_4 = F_89 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
...
{
return F_87 ( V_44 , false ) ;
}
static int F_95 ( struct V_43 * V_44 )
{
return F_83 ( V_44 , false ) ;
}
static int F_96 ( struct V_43 * V_44 )
{
return F_87 ( V_44 , true ) ;
}
static int F_97 ( struct V_43 * V_44 )
{
return F_83 ( V_44 , true ) ;
}
static int F_98 ( struct V_107 * V_45 )
{
struct V_2 * V_4 = F_89 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
F_99 ( & V_45 -> V_44 ) ;
