...
struct V_20 * V_21 = V_37 -> V_38 ;
enum V_153 V_154 ;
char * type , * V_155 , V_113 [ 256 ] ;
bool V_156 = F_4 ( V_152 -> V_157 , 0 , 0 ) ;
bool V_158 = F_4 ( V_152 -> V_159 , 62 , 62 ) ;
bool V_160 = F_4 ( V_152 -> V_159 , 61 , 61 ) ;
bool V_161 ;
T_1 V_162 = F_4 ( V_152 -> V_159 , 38 , 52 ) ;
T_1 V_163 = F_4 ( V_152 -> V_159 , 16 , 31 ) ;
T_1 V_164 = F_4 ( V_152 -> V_159 , 0 , 15 ) ;
T_1 V_75 = F_4 ( V_152 -> V_159 , 0 , 3 ) ;
T_1 V_165 = F_4 ( V_152 -> V_159 , 4 , 6 ) ;
long V_110 , V_166 ;
T_2 V_111 , V_109 ;
int V_147 , V_40 ;
char * V_112 = NULL ;
if ( V_21 -> V_59 . type == V_167 )
V_161 = true ;
else
V_161 = F_4 ( V_152 -> V_159 , 56 , 56 ) ;
if ( V_160 ) {
if ( V_156 ) {
type = L_69 ;
V_154 = V_168 ;
...
if ( ! F_4 ( V_152 -> V_159 , 58 , 58 ) )
return;
V_147 = F_65 ( V_37 , V_152 -> V_108 , & V_109 ,
...
V_111 ) ;
F_7 ( 0 , L_83 , V_113 ) ;
F_82 ( V_154 , V_37 , V_162 ,
V_152 -> V_108 >> V_172 , V_152 -> V_108 & ~ V_173 , 0 ,
V_75 , V_40 , - 1 ,
V_155 , V_113 ) ;
return;
V_171:
F_82 ( V_154 , V_37 , V_162 , 0 , 0 , 0 ,
- 1 , - 1 , - 1 ,
V_113 , L_40 ) ;
}
...
struct V_151 * V_152 ;
F_84 () ;
V_174 = ( V_21 -> V_175 + V_176 - V_21 -> V_177 )
% V_176 ;
if ( ! V_174 )
return;
V_152 = V_21 -> V_178 ;
if ( V_21 -> V_177 + V_174 > V_176 ) {
unsigned V_179 = V_176 - V_21 -> V_177 ;
memcpy ( V_152 , & V_21 -> V_180 [ V_21 -> V_177 ] , sizeof( * V_152 ) * V_179 ) ;
F_85 () ;
V_21 -> V_177 = 0 ;
V_174 -= V_179 ;
V_152 += V_179 ;
}
memcpy ( V_152 , & V_21 -> V_180 [ V_21 -> V_177 ] , sizeof( * V_152 ) * V_174 ) ;
F_85 () ;
V_21 -> V_177 += V_174 ;
F_84 () ;
if ( V_21 -> V_181 ) {
...
F_80 ( V_37 , & V_21 -> V_178 [ V_30 ] ) ;
}
static int F_86 ( struct V_182 * V_183 , unsigned long V_184 ,
void * V_185 )
{
struct V_151 * V_151 = (struct V_151 * ) V_185 ;
struct V_36 * V_37 ;
struct V_20 * V_21 ;
char * type ;
if ( F_87 () == V_186 )
return V_187 ;
V_37 = F_64 ( V_151 -> V_188 ) ;
if ( ! V_37 )
return V_189 ;
V_21 = V_37 -> V_38 ;
if ( ( V_151 -> V_159 & 0xefff ) >> 7 != 1 )
return V_187 ;
if ( V_151 -> V_157 & V_190 )
type = L_85 ;
else
type = L_86 ;
F_88 ( V_37 , V_140 , L_87 ) ;
F_88 ( V_37 , V_140 , L_88
L_89 , V_151 -> V_191 , type ,
V_151 -> V_157 , V_151 -> V_192 , V_151 -> V_159 ) ;
F_88 ( V_37 , V_140 , L_90 , V_151 -> V_193 ) ;
F_88 ( V_37 , V_140 , L_91 , V_151 -> V_108 ) ;
F_88 ( V_37 , V_140 , L_92 , V_151 -> V_194 ) ;
F_88 ( V_37 , V_140 , L_93
L_94 , V_151 -> V_195 , V_151 -> V_196 ,
V_151 -> time , V_151 -> V_188 , V_151 -> V_197 ) ;
if ( F_89 ( V_151 -> V_198 ) . V_199 != V_21 -> V_12 -> V_54 )
return V_187 ;
F_84 () ;
if ( ( V_21 -> V_175 + 1 ) % V_176 == V_21 -> V_177 ) {
F_85 () ;
V_21 -> V_181 ++ ;
return V_187 ;
}
memcpy ( & V_21 -> V_180 [ V_21 -> V_175 ] , V_151 , sizeof( * V_151 ) ) ;
F_85 () ;
V_21 -> V_175 = ( V_21 -> V_175 + 1 ) % V_176 ;
if ( V_151 -> V_157 & 1 )
F_83 ( V_37 ) ;
return V_200 ;
}
...
V_37 -> V_212 = L_99 ;
V_37 -> V_213 = V_214 ;
V_37 -> V_215 = F_95 ( V_16 ) ;
V_37 -> V_216 = NULL ;
V_37 -> V_217 = F_83 ;
V_21 -> V_59 . type = type ;
if ( type == V_167 ) {
V_21 -> V_59 . V_65 = V_218 ;
V_21 -> V_59 . V_94 = F_25 ;
V_21 -> V_59 . V_96 = F_26 ;
V_21 -> V_59 . V_99 = V_219 ;
V_21 -> V_59 . V_97 = F_42 ( V_219 ) ;
V_21 -> V_59 . V_100 = V_220 ;
V_21 -> V_59 . V_123 = F_42 ( V_220 ) ;
V_21 -> V_59 . V_2 = V_221 ;
V_37 -> V_201 = F_96 ( V_15 , L_100 , V_37 -> V_222 ) ;
V_147 = F_78 ( V_37 , V_12 ) ;
if ( F_73 ( V_147 < 0 ) )
goto V_223;
} else {
V_21 -> V_59 . V_65 = V_224 ;
V_21 -> V_59 . V_94 = F_20 ;
V_21 -> V_59 . V_96 = F_23 ;
V_21 -> V_59 . V_99 = V_225 ;
V_21 -> V_59 . V_97 = F_42 ( V_225 ) ;
V_21 -> V_59 . V_100 = V_226 ;
V_21 -> V_59 . V_123 = F_42 ( V_226 ) ;
V_21 -> V_59 . V_2 = V_227 ;
V_37 -> V_201 = F_96 ( V_15 , L_101 , V_37 -> V_222 ) ;
V_147 = F_77 ( V_37 , V_12 ) ;
if ( F_73 ( V_147 < 0 ) )
goto V_223;
}
F_35 ( V_37 ) ;
...
static int F_98 ( struct V_27 * V_16 , const struct V_228 * V_229 )
{
int V_147 ;
T_2 V_54 , V_135 = 0 ;
struct V_12 * V_12 ;
...
V_231 ++ ;
if ( V_16 -> V_232 == V_233 ) {
V_147 = F_76 ( & V_135 , V_234 ) ;
type = V_167 ;
} else {
V_147 = F_76 ( & V_135 , V_235 ) ;
type = V_130 ;
}
if ( F_73 ( V_147 < 0 ) )
goto V_223;
