...
int V_14 ;
for ( V_14 = 0 ; V_43 [ V_14 ] . V_44 ; V_14 ++ )
if ( F_6 ( V_1 , V_43 [ V_14 ] . V_44 ) ) {
V_22 -> V_45 = V_43 [ V_14 ] . V_45 ;
V_22 -> V_46 = V_43 [ V_14 ] . V_46 ;
V_22 -> V_47 = V_43 [ V_14 ] . V_47 ;
V_22 -> V_48 = V_43 [ V_14 ] . V_48 ;
return 0 ;
}
if ( F_22 ( V_22 -> V_37 ) < 4 )
return 0 ;
if ( F_8 ( V_1 , V_49 , V_42 ) == 0 ) {
...
V_22 -> V_46 = ( V_42 [ 0 ] << 5 ) | ( ( V_42 [ 1 ] & 0x0f ) << 1 ) ;
V_22 -> V_48 = ( V_42 [ 2 ] << 5 ) | ( ( V_42 [ 1 ] & 0xf0 ) >> 3 ) ;
}
}
if ( F_16 ( V_22 -> V_34 ) >= 7 &&
F_24 ( V_22 -> V_36 ) ) {
...
V_22 -> V_45 = ( V_42 [ 0 ] << 5 ) | ( ( V_42 [ 1 ] & 0x0f ) << 1 ) ;
V_22 -> V_47 = ( V_42 [ 2 ] << 5 ) | ( ( V_42 [ 1 ] & 0xf0 ) >> 3 ) ;
}
}
return 0 ;
}
...
int V_148 )
{
int V_45 = V_22 -> V_45 ? : V_149 ;
int V_46 = V_22 -> V_46 ? : V_150 ;
int V_47 = V_22 -> V_47 ? : V_19 ;
int V_48 = V_22 -> V_48 ? : V_18 ;
int V_151 = F_85 ( V_22 -> V_36 ) ?
V_152 : 0 ;
F_86 ( V_105 , V_147 , V_45 , V_46 , V_151 , 0 ) ;
F_86 ( V_105 , V_148 , V_47 , V_48 , V_151 , 0 ) ;
F_87 ( V_105 , V_147 , V_22 -> V_50 ) ;
F_87 ( V_105 , V_148 , V_22 -> V_51 ) ;
}
