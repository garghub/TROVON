...
if ( V_48 > V_25 ) {
V_62 . V_61 . V_7 = V_58 ;
V_62 . V_61 . V_32 = F_29 ( V_7 ) &
V_33 ;
V_3 = F_30 ( & V_62 . V_61 , V_56 , V_48 ,
V_19 -> V_43 . V_44 . V_56 ) ;
if ( V_3 ) {
F_31 ( V_7 , V_64 ) ;
return - V_65 ;
...
V_19 -> V_43 . V_44 . V_55 [ V_63 ] = V_19 -> V_43 . V_44 . V_56 [ V_63 ] ^ 0x36 ;
V_19 -> V_43 . V_44 . V_47 [ V_63 ] = V_19 -> V_43 . V_44 . V_56 [ V_63 ] ^ 0x5c ;
}
...
static int F_32 ( struct V_66 * V_7 )
{
struct V_22 * V_19 = F_25 ( V_7 ) ;
struct V_6 * V_67 = F_33 ( V_7 ) ;
V_19 -> V_68 = F_1 ;
V_19 -> V_43 . V_44 . V_48 = 0 ;
F_34 ( V_67 , sizeof( struct V_8 ) ) ;
return 0 ;
}
static void F_35 ( struct V_66 * V_7 )
{
}
static int F_36 ( struct V_66 * V_7 )
{
struct V_22 * V_19 = F_25 ( V_7 ) ;
struct V_53 * V_54 = V_53 ( V_7 ) ;
struct V_57 * V_59 ;
V_59 = F_37 ( V_54 -> V_69 , 0 , 0 ) ;
if ( F_38 ( V_59 ) ) {
F_39 ( L_1 ,
V_54 -> V_69 ) ;
return F_40 ( V_59 ) ;
...
static void F_41 ( struct V_66 * V_7 )
{
struct V_22 * V_19 = F_25 ( V_7 ) ;
...
struct V_79 * V_31 ;
int V_3 ;
V_75 = F_44 ( sizeof( * V_75 ) , V_34 ) ;
if ( ! V_75 )
return - V_80 ;
* V_75 = * V_74 ;
F_17 ( & V_75 -> V_40 ) ;
strncpy ( V_75 -> V_69 , V_73 -> V_81 , V_82 ) ;
V_54 = & V_75 -> V_54 ;
V_54 -> V_83 = F_24 ;
V_78 = & V_54 -> V_78 ;
V_31 = & V_78 -> V_31 ;
snprintf ( V_31 -> V_84 , V_82 , L_2 , V_73 -> V_81 ) ;
snprintf ( V_31 -> V_85 , V_82 , L_3 ,
V_73 -> V_86 ) ;
V_31 -> V_87 = F_36 ;
V_31 -> V_88 = F_41 ;
V_3 = F_45 ( V_54 ) ;
...
V_78 -> V_93 = V_73 -> V_10 ;
V_31 = & V_78 -> V_31 ;
snprintf ( V_31 -> V_84 , V_82 , L_5 , V_73 -> V_81 ) ;
snprintf ( V_31 -> V_85 , V_82 , L_5 ,
V_73 -> V_86 ) ;
V_31 -> V_94 = V_95 | V_96 |
V_97 |
V_98 ;
V_31 -> V_99 = V_73 -> V_25 ;
V_31 -> V_100 = sizeof( struct V_22 ) ;
V_31 -> V_101 = V_102 ;
V_31 -> V_103 = & V_104 ;
V_31 -> V_87 = F_32 ;
V_31 -> V_88 = F_35 ;
...
F_48 ( & V_75 -> V_40 , V_71 ) ;
V_3 = F_43 ( V_71 , V_73 , V_75 ) ;
return V_3 ;
}
int F_50 ( struct V_70 * V_71 )
{
int V_63 , V_3 ;
for ( V_63 = 0 ; V_63 < F_51 ( V_107 ) ; V_63 ++ ) {
V_3 = F_49 ( V_71 , & V_107 [ V_63 ] ) ;
if ( V_3 )
return V_3 ;
}
return 0 ;
