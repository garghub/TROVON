...
V_69 = F_19 ( ( ( T_1 ) V_150 ) << V_29 ,
V_53 ) ;
V_70 = 0 ;
}
V_31 += ( V_30 - V_31 ) >> V_8 ;
}
void F_47 ( const struct V_91 * V_152 , const struct V_91 * V_153 )
{
struct V_138 V_154 , V_145 ;
V_154 = F_38 ( * V_152 ) ;
V_2 &= ~ ( V_16 | V_17 | V_18 ) ;
V_2 |= V_4 ;
V_15 = V_155 ;
...
static int T_4 F_49 ( char * V_156 )
{
V_49 = F_50 ( V_156 , NULL , 0 ) ;
V_49 <<= V_29 ;
return 1 ;
}
void T_4 F_51 ( void )
