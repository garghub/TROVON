...
( V_10 -> V_51 ) ] = V_3 ;
V_10 -> V_239 = 0 ;
V_237 . V_240 = F_75 ( V_13 -> V_241 . V_242 ,
sizeof( struct V_243 ) ,
& V_237 . V_244 ) ;
if ( V_237 . V_240 == NULL ) {
F_3 ( V_13 , V_20 , V_24 ,
...
V_237 . V_245 = sizeof( struct V_243 ) ;
memset ( V_237 . V_240 , 0 , V_237 . V_245 ) ;
V_131 = F_76 ( V_13 , V_118 , V_10 , & V_237 ) ;
if ( V_131 <= 0 ) {
F_3 ( V_13 , V_20 , V_24 ,
L_59 ,
V_10 -> V_51 ) ;
F_77 ( V_13 -> V_241 . V_242 , V_237 . V_245 ,
V_237 . V_240 , V_237 . V_244 ) ;
F_72 ( V_10 ) ;
return - V_246 ;
}
...
V_235 = (struct V_234 * ) V_237 . V_240 ;
V_10 = V_3 -> V_21 ;
V_10 -> V_247 = V_235 -> V_248 ;
V_10 -> V_239 = 1 ;
F_3 ( V_13 , V_25 , V_24 ,
L_61 ) ;
F_77 ( V_13 -> V_241 . V_242 , V_237 . V_245 ,
...
struct V_2 *
F_78 ( struct V_7 * V_8 , struct V_231 * V_118 ,
int V_233 )
{
struct V_12 * V_13 ;
struct V_9 * V_10 ;
...
int F_83 ( struct V_2 * V_3 , int V_253 )
{
struct V_9 * V_10 = V_3 -> V_21 ;
...
static int F_84 ( struct V_9 * V_10 , int V_254 )
{
int V_71 = 0 ;
unsigned int V_131 ;
struct V_12 * V_13 = V_10 -> V_13 ;
V_131 = F_85 ( V_13 , V_10 -> V_51 , V_254 ) ;
if ( ! V_131 ) {
F_3 ( V_13 , V_25 , V_24 ,
L_67 ,
V_10 -> V_51 ) ;
