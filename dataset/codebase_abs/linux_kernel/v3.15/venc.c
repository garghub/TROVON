...
static void T_2 F_57 ( struct V_126 * V_90 )
{
struct V_99 * V_112 = & V_3 . V_103 ;
F_58 ( V_112 ) ;
}
...
static int F_65 ( struct V_126 * V_90 )
{
T_3 V_148 ;
struct V_149 * V_150 ;
int V_89 ;
...
F_66 ( & V_3 . V_113 ) ;
V_3 . V_30 = 0 ;
V_150 = F_67 ( V_3 . V_90 , V_151 , 0 ) ;
if ( ! V_150 ) {
F_8 ( L_22 ) ;
return - V_115 ;
}
V_3 . V_4 = F_68 ( & V_90 -> V_91 , V_150 -> V_152 ,
F_69 ( V_150 ) ) ;
if ( ! V_3 . V_4 ) {
F_8 ( L_23 ) ;
return - V_153 ;
...
if ( V_89 )
goto V_154;
V_148 = ( T_3 ) ( F_3 ( V_155 ) & 0xff ) ;
F_71 ( & V_90 -> V_91 , L_24 , V_148 ) ;
F_14 () ;
if ( V_90 -> V_91 . V_121 ) {
V_89 = F_59 ( V_90 ) ;
if ( V_89 ) {
...
static int T_2 F_74 ( struct V_126 * V_90 )
{
F_57 ( V_90 ) ;
F_73 ( & V_90 -> V_91 ) ;
return 0 ;
}
static int F_75 ( struct V_157 * V_91 )
{
if ( V_3 . V_129 )
F_76 ( V_3 . V_129 ) ;
F_77 () ;
...
static int F_78 ( struct V_157 * V_91 )
{
int V_89 ;
V_89 = F_79 () ;
if ( V_89 < 0 )
