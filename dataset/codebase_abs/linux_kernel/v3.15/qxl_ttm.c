...
F_62 ( L_13 ,
( unsigned ) V_6 -> V_143 / ( 1024 * 1024 ) ) ;
F_62 ( L_14 ,
( ( unsigned ) V_134 * V_141 ) / ( 1024 * 1024 ) ) ;
F_62 ( L_15 ,
( unsigned ) V_6 -> V_142 / ( 1024 * 1024 ) ) ;
V_11 = F_63 ( V_6 ) ;
if ( V_11 ) {
F_9 ( L_16 ) ;
return V_11 ;
...
static int F_67 ( struct V_144 * V_145 , void * V_146 )
{
struct V_147 * V_148 = (struct V_147 * ) V_145 -> V_149 ;
struct V_150 * V_151 = (struct V_150 * ) V_148 -> V_152 -> V_146 ;
struct V_153 * V_45 = V_148 -> V_44 -> V_45 ;
struct V_1 * V_154 = V_45 -> V_46 ;
int V_121 ;
struct V_23 * V_155 = V_154 -> V_5 . V_3 . V_155 ;
F_68 ( & V_155 -> V_156 ) ;
V_121 = F_69 ( V_145 , V_151 ) ;
F_70 ( & V_155 -> V_156 ) ;
return V_121 ;
}
...
{
#if F_71 ( V_157 )
static struct V_158 V_159 [ V_160 ] ;
static char V_161 [ V_160 ] [ 32 ] ;
unsigned V_162 ;
for ( V_162 = 0 ; V_162 < V_160 ; V_162 ++ ) {
if ( V_162 == 0 )
sprintf ( V_161 [ V_162 ] , L_18 ) ;
else
sprintf ( V_161 [ V_162 ] , L_19 ) ;
V_159 [ V_162 ] . V_163 = V_161 [ V_162 ] ;
V_159 [ V_162 ] . V_164 = & F_67 ;
V_159 [ V_162 ] . V_165 = 0 ;
if ( V_162 == 0 )
V_159 [ V_162 ] . V_146 = V_6 -> V_5 . V_3 . V_52 [ V_59 ] . V_166 ;
else
V_159 [ V_162 ] . V_146 = V_6 -> V_5 . V_3 . V_52 [ V_60 ] . V_166 ;
}
return F_72 ( V_6 , V_159 , V_162 ) ;
#else
return 0 ;
#endif
}
