...
static int F_36 ( T_2 * V_73 , char * V_74 )
{
int V_75 , V_15 ;
V_75 = strlen ( V_74 ) ;
V_15 = F_37 ( V_73 , V_74 , V_75 ) ;
return ( V_15 ) ;
}
T_2 * F_38 ( T_5 * V_76 )
{
T_2 * V_15 = NULL , * V_77 = NULL , * V_10 = NULL ;
if ( ( V_77 = F_39 ( F_40 () ) ) == NULL )
return ( NULL ) ;
if ( ( V_10 = F_41 ( V_76 ) ) == NULL )
goto V_78;
if ( ( V_15 = F_23 ( V_77 , V_10 ) ) == NULL )
goto V_78;
return ( V_15 ) ;
V_78:
if ( V_77 != NULL ) F_42 ( V_77 ) ;
...
if ( ( V_79 = F_39 ( F_43 () ) ) == NULL )
return ( NULL ) ;
if ( ( V_10 = F_44 ( V_76 , 1 ) ) == NULL )
goto V_78;
if ( ( V_15 = F_23 ( V_10 , V_79 ) ) == NULL )
goto V_78;
return ( V_15 ) ;
V_78:
if ( V_79 != NULL ) F_42 ( V_79 ) ;
if ( V_15 != NULL ) F_42 ( V_15 ) ;
return ( NULL ) ;
}
T_2 * F_44 ( T_5 * V_76 , int V_80 )
{
T_2 * V_15 ;
T_4 * V_10 ;
if ( ( V_15 = F_39 ( F_1 () ) ) == NULL )
return ( NULL ) ;
if ( ( V_10 = F_45 ( V_76 ) ) == NULL )
{
F_42 ( V_15 ) ;
return ( NULL ) ;
}
...
return ( 0 ) ;
F_49 ( ( ( T_3 * ) V_82 -> V_7 ) -> V_10 , ( ( T_3 * ) V_83 -> V_7 ) -> V_10 ) ;
return ( 1 ) ;
}
void F_50 ( T_2 * V_12 )
{
