...
V_9 = F_5 () ;
V_9 -> V_18 = F_6 ( NULL ) ;
while( ( V_8 = F_7 ( V_5 , NULL , NULL ) ) )
F_8 ( V_9 -> V_18 , ( char * ) V_8 ) ;
if( ! F_9 ( V_9 -> V_18 ) )
{
F_3 ( V_13 , L_14 , V_3 ) ;
F_10 ( V_13 ) ;
...
if ( ! ( V_9 = F_12 ( V_5 , NULL , NULL ) ) ) {
F_3 ( V_13 , L_15 , V_3 ) ;
F_10 ( V_13 ) ;
goto V_16;
}
for( V_10 = 0 ; V_10 < F_9 ( V_9 -> V_18 ) ; V_10 ++ ) {
V_8 = ( T_2 * ) F_13 ( V_9 -> V_18 , V_10 ) ;
F_14 ( V_6 , V_8 ) ;
F_15 ( V_6 , V_8 ) ;
}
V_11 = 0 ;
...
static int F_14 ( T_1 * V_6 , T_2 * V_19 )
{
char V_20 [ 256 ] ;
F_18 ( F_19 ( V_19 ) , V_20 , 256 ) ;
F_20 ( V_6 , L_16 ) ;
F_20 ( V_6 , V_20 ) ;
F_18 ( F_21 ( V_19 ) , V_20 , 256 ) ;
F_20 ( V_6 , L_17 ) ;
F_20 ( V_6 , V_20 ) ;
F_20 ( V_6 , L_18 ) ;
return 0 ;
