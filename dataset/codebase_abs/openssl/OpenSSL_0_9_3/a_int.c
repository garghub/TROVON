...
{
if ( V_32 == 0 ) break;
V_31 [ V_6 ] = ( int ) V_32 & 0xff ;
V_32 >>= 8 ;
}
V_29 = 0 ;
for ( V_30 = V_6 - 1 ; V_30 >= 0 ; V_30 -- )
V_1 -> V_11 [ V_29 ++ ] = V_31 [ V_30 ] ;
V_1 -> V_12 = V_29 ;
return ( 1 ) ;
}
long F_11 ( T_1 * V_1 )
...
if( V_35 -> V_34 ) V_4 -> type = V_14 ;
else V_4 -> type = V_13 ;
V_29 = F_13 ( V_35 ) ;
V_18 = ( ( V_29 == 0 ) ? 0 : ( ( V_29 / 8 ) + 1 ) ) ;
V_4 -> V_11 = ( unsigned char * ) Malloc ( V_18 + 4 ) ;
V_4 -> V_12 = F_14 ( V_35 , V_4 -> V_11 ) ;
return ( V_4 ) ;
V_23:
if ( V_4 != V_36 ) F_8 ( V_4 ) ;
return ( NULL ) ;
}
T_2 * F_15 ( T_1 * V_36 , T_2 * V_35 )
{
T_2 * V_4 ;
if ( ( V_4 = F_16 ( V_36 -> V_11 , V_36 -> V_12 , V_35 ) ) == NULL )
F_7 ( V_39 , V_40 ) ;
if( V_36 -> type == V_14 ) V_35 -> V_34 = 1 ;
return ( V_4 ) ;
}
