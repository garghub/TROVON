...
F_9 ( V_4 -> V_10 . V_14 , V_6 ) ;
V_4 -> V_14 = 1 ;
if ( ! V_15 -> V_23 && ! ( V_15 -> V_23 = F_10 ( NULL ) ) ) {
F_3 ( V_19 , V_8 ) ;
return 0 ;
}
F_11 ( V_15 -> V_23 , ( char * ) V_4 ) ;
return 1 ;
}
...
T_4 * F_19 ( T_7 * V_38 , int V_39 )
{
T_2 * V_4 ;
int V_40 ;
if ( ! V_38 ) return NULL ;
for ( V_40 = 0 ; V_40 < F_20 ( V_38 ) ; V_40 ++ ) {
V_4 = ( T_2 * ) F_21 ( V_38 , V_40 ) ;
if ( F_22 ( V_4 -> V_12 ) == V_39 ) {
if ( F_23 ( V_4 -> V_10 . V_14 ) )
return F_24 ( V_4 -> V_10 . V_14 , 0 ) ;
else return NULL ;
}
}
return NULL ;
...
{
T_4 * V_41 ;
if ( ! ( V_41 = F_26 ( V_1 , V_35 ) ) ) return NULL ;
if ( V_41 -> type != V_31 ) return NULL ;
return F_27 ( V_41 -> V_10 . V_34 -> V_32 ,
V_41 -> V_10 . V_34 -> V_33 ) ;
}
