...
V_16 = V_15 ;
V_18 = ( T_1 * ) Malloc ( F_4 ( V_8 ) * sizeof( T_1 ) ) ;
for ( V_14 = 0 ; V_14 < F_4 ( V_8 ) ; V_14 ++ )
{
V_18 [ V_14 ] . V_6 = V_15 ;
F_3 ( F_5 ( V_8 , V_14 ) , & V_15 ) ;
...
T_2 * F_8 ( T_2 * * V_8 , unsigned char * * V_9 , long V_20 ,
char * (* F_3)() , void (* F_9)() , int V_10 , int V_11 )
{
T_3 V_21 ;
T_2 * V_13 = NULL ;
if ( ( V_8 == NULL ) || ( ( * V_8 ) == NULL ) )
{ if ( ( V_13 = F_10 ( NULL ) ) == NULL ) goto V_22; }
else
V_13 = ( * V_8 ) ;
V_21 . V_15 = * V_9 ;
V_21 . V_23 = ( V_20 == 0 ) ? 0 : ( V_21 . V_15 + V_20 ) ;
V_21 . V_24 = F_11 ( & V_21 . V_15 , & V_21 . V_25 , & V_21 . V_26 , & V_21 . V_27 , V_21 . V_23 - V_21 . V_15 ) ;
...
{
F_12 ( V_28 , V_34 ) ;
F_14 ( * V_9 , ( int ) ( V_21 . V_35 - * V_9 ) ) ;
goto V_22;
}
if ( ! F_15 ( V_13 , V_33 ) ) goto V_22;
}
