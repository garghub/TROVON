...
long F_16 ( T_1 * V_28 , int V_48 , long V_49 , char * V_52 )
{
long V_2 ;
long (* F_11)();
...
T_1 * F_18 ( T_1 * V_28 , T_1 * V_5 )
{
T_1 * V_56 ;
if ( V_28 == NULL ) return ( V_5 ) ;
V_56 = V_28 ;
while ( V_56 -> V_15 != NULL )
V_56 = V_56 -> V_15 ;
V_56 -> V_15 = V_5 ;
if ( V_5 != NULL )
V_5 -> V_14 = V_56 ;
F_16 ( V_28 , V_57 , 0 , NULL ) ;
return ( V_28 ) ;
}
T_1 * F_19 ( T_1 * V_28 )
{
...
V_28 -> V_15 = NULL ;
V_28 -> V_14 = NULL ;
F_16 ( V_28 , V_58 , 0 , NULL ) ;
return ( V_2 ) ;
}
T_1 * F_20 ( T_1 * V_5 , int * V_59 )
{
T_1 * V_28 , * V_60 ;
V_28 = V_60 = V_5 ;
for (; ; )
...
T_1 * F_25 ( T_1 * V_37 )
{
T_1 * V_2 = NULL , * V_64 = NULL , * V_5 , * V_65 ;
for ( V_5 = V_37 ; V_5 != NULL ; V_5 = V_5 -> V_15 )
{
if ( ( V_65 = F_1 ( V_5 -> V_1 ) ) == NULL ) goto V_66;
V_65 -> V_6 = V_5 -> V_6 ;
V_65 -> V_7 = V_5 -> V_7 ;
V_65 -> V_8 = V_5 -> V_8 ;
V_65 -> V_9 = V_5 -> V_9 ;
V_65 -> V_10 = V_5 -> V_10 ;
V_65 -> V_12 = V_5 -> V_12 ;
if ( ! F_26 ( V_5 , ( char * ) V_65 ) )
{
F_5 ( V_65 ) ;
goto V_66;
}
if ( ! F_27 ( V_19 , & V_65 -> V_20 , & V_5 -> V_20 ) )
goto V_66;
if ( V_2 == NULL )
{
V_64 = V_65 ;
...
void F_28 ( T_1 * V_28 )
{
F_29 ( V_28 , F_30 ( V_28 -> V_15 ) ) ;
V_28 -> V_11 = V_28 -> V_15 -> V_11 ;
}
int F_31 ( long V_67 , char * V_68 , int (* F_32)() ,
int (* F_33)() , void (* F_34)() )
{
V_69 ++ ;
return ( F_35 ( V_69 - 1 , & V_19 ,
V_67 , V_68 , F_32 , F_33 , F_34 ) ) ;
}
int F_36 ( T_1 * V_5 , int V_70 , char * V_71 )
{
return ( F_37 ( & ( V_5 -> V_20 ) , V_70 , V_71 ) ) ;
}
char * F_38 ( T_1 * V_5 , int V_70 )
{
return ( F_39 ( & ( V_5 -> V_20 ) , V_70 ) ) ;
}
