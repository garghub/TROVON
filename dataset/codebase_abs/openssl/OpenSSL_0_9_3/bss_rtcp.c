...
V_12 -> V_16 = 0 ;
V_12 -> V_17 = 0 ;
V_12 -> V_18 = Malloc ( sizeof( struct V_13 ) ) ;
V_14 = (struct V_13 * ) V_12 -> V_18 ;
V_14 -> V_19 = 0 ;
V_14 -> V_20 = 0 ;
return ( 1 ) ;
}
static int F_6 ( T_3 * V_21 )
{
if ( V_21 == NULL ) return ( 0 ) ;
if ( V_21 -> V_18 ) Free ( V_21 -> V_18 ) ;
V_21 -> V_18 = NULL ;
return ( 1 ) ;
}
static int F_7 ( T_3 * V_22 , char * V_23 , int V_24 )
{
int V_6 , V_5 ;
struct V_13 * V_14 ;
...
static int F_8 ( T_3 * V_22 , char * V_30 , int V_31 )
{
...
static long F_9 ( T_3 * V_22 , int V_34 , long V_16 , char * V_18 )
{
long V_35 = 1 ;
switch ( V_34 )
{
...
static int F_10 ( T_3 * V_47 , char * V_48 , int V_49 )
{
return ( 0 ) ;
}
static int F_11 ( T_3 * V_47 , char * V_50 )
{
int V_5 ;
if ( V_50 == NULL ) return ( 0 ) ;
V_5 = strlen ( V_50 ) ;
if ( V_5 == 0 ) return ( 0 ) ;
return F_8 ( V_47 , V_50 , V_5 ) ;
}
