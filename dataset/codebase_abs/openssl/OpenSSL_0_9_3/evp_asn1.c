...
F_8 ( V_16 ) = V_15 ;
V_9 = F_7 ( V_16 ) ;
F_16 ( & V_9 , 1 , V_14 , V_20 , V_21 ) ;
F_11 ( & V_17 , & V_9 ) ;
F_12 ( & V_4 , & V_9 ) ;
F_4 ( V_1 , V_20 , V_16 ) ;
return ( 1 ) ;
}
int F_17 ( T_1 * V_1 , long * V_8 , unsigned char * V_2 ,
int V_6 )
{
int V_7 = - 1 , V_14 ;
T_4 * V_22 = NULL ;
...
F_18 () ;
V_23 . V_28 = V_23 . V_9 ;
if ( ( V_22 = F_19 ( NULL , & V_23 . V_9 , V_23 . V_29 ) ) == NULL ) goto V_25;
V_23 . V_29 -= ( V_23 . V_9 - V_23 . V_28 ) ;
V_23 . V_28 = V_23 . V_9 ;
if ( ( V_4 = F_20 ( NULL , & V_23 . V_9 , V_23 . V_29 ) ) == NULL ) goto V_25;
V_23 . V_29 -= ( V_23 . V_9 - V_23 . V_28 ) ;
if ( ! F_21 () ) goto V_25;
if ( V_8 != NULL )
* V_8 = F_22 ( V_22 ) ;
