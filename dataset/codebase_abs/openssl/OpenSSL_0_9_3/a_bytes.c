...
if ( V_7 != 0 )
{
V_6 = ( unsigned char * ) Malloc ( ( int ) V_7 + 1 ) ;
if ( V_6 == NULL )
{
V_11 = V_17 ;
goto V_12;
...
V_6 = NULL ;
if ( V_4 -> V_18 != NULL ) Free ( ( char * ) V_4 -> V_18 ) ;
V_4 -> V_3 = ( int ) V_7 ;
V_4 -> V_18 = V_6 ;
V_4 -> type = V_9 ;
if ( V_1 != NULL ) ( * V_1 ) = V_4 ;
...
int F_7 ( T_1 * V_1 , unsigned char * * V_2 , int V_9 , int V_10 )
{
int V_4 , V_20 , V_21 ;
unsigned char * V_5 ;
...
V_21 = 0 ;
F_10 ( & V_5 , V_21 , V_4 , V_9 , V_10 ) ;
memcpy ( V_5 , V_1 -> V_18 , V_1 -> V_3 ) ;
V_5 += V_1 -> V_3 ;
* V_2 = V_5 ;
return ( V_20 ) ;
}
T_1 * F_11 ( T_1 * * V_1 , unsigned char * * V_2 , long V_3 ,
int V_24 , int V_25 )
{
T_1 * V_4 = NULL ;
unsigned char * V_5 , * V_6 ;
...
{
if ( V_4 -> V_18 != NULL ) Free ( ( char * ) V_4 -> V_18 ) ;
V_6 = ( unsigned char * ) Malloc ( ( int ) V_7 ) ;
if ( V_6 == NULL )
{
V_11 = V_17 ;
goto V_12;
...
static int F_12 ( T_1 * V_1 , T_2 * V_29 )
{
T_1 * V_33 = NULL ;
T_3 V_34 ;
int V_35 ;
...
V_29 -> V_38 = V_29 -> V_5 ;
if ( F_11 ( & V_33 , & V_29 -> V_5 , V_29 -> V_31 - V_29 -> V_5 , V_29 -> V_9 , V_29 -> V_10 )
== NULL )
{
V_29 -> error = V_39 ;
goto V_12;
}
if ( ! F_14 ( & V_34 , V_35 + V_33 -> V_3 ) )
{
V_29 -> error = V_40 ;
goto V_12;
}
...
if ( ! F_15 ( V_29 ) ) goto V_12;
V_1 -> V_3 = V_35 ;
if ( V_1 -> V_18 != NULL ) Free ( V_1 -> V_18 ) ;
V_1 -> V_18 = ( unsigned char * ) V_34 . V_18 ;
if ( V_33 != NULL ) F_6 ( V_33 ) ;
return ( 1 ) ;
V_12:
F_5 ( V_41 , V_29 -> error ) ;
if ( V_33 != NULL ) F_6 ( V_33 ) ;
if ( V_34 . V_18 != NULL ) Free ( V_34 . V_18 ) ;
return ( 0 ) ;
}
