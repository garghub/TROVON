...
void F_11 ( T_1 * V_1 , void (* F_10)() , char * V_23 )
{
int V_2 ;
T_2 * V_24 , * V_3 ;
...
static T_2 * * F_4 ( T_1 * V_1 , char * V_8 , unsigned long * V_38 )
{
T_2 * * V_11 , * V_25 ;
