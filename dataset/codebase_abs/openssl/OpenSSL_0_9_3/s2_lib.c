...
{
T_4 * V_6 ;
if ( ( V_6 = ( T_4 * ) Malloc ( sizeof( T_4 ) ) ) == NULL ) goto V_8;
memset ( V_6 , 0 , sizeof( T_4 ) ) ;
if ( ( V_6 -> V_9 = ( unsigned char * ) Malloc (
V_10 + 2 ) ) == NULL ) goto V_8;
if ( ( V_6 -> V_11 = ( unsigned char * ) Malloc (
V_10 + 2 ) ) == NULL ) goto V_8;
V_5 -> V_6 = V_6 ;
F_7 ( V_5 ) ;
return ( 1 ) ;
...
long F_10 ( T_5 * V_23 , int V_17 , long V_18 , char * V_19 )
{
return ( 0 ) ;
}
T_2 * F_11 ( const unsigned char * V_24 )
{
static int V_25 = 1 ;
static T_2 * V_26 [ V_2 ] ;
...
int F_15 ( const T_2 * V_27 , unsigned char * V_24 )
{
long V_35 ;
if ( V_24 != NULL )
{
...
{
F_17 ( & V_23 ) ;
F_18 ( & V_23 , V_5 -> V_40 -> V_41 , V_5 -> V_40 -> V_42 ) ;
F_18 ( & V_23 , ( unsigned char * ) & V_27 , 1 ) ;
V_27 ++ ;
F_18 ( & V_23 , V_5 -> V_6 -> V_43 , V_5 -> V_6 -> V_44 ) ;
F_18 ( & V_23 , V_5 -> V_6 -> V_45 , V_5 -> V_6 -> V_46 ) ;
F_19 ( V_36 , & V_23 ) ;
V_36 += V_39 ;
}
}
void F_20 ( T_3 * V_5 , int V_8 )
{
if ( ! V_5 -> error )
{
V_5 -> error = 3 ;
...
error = V_5 -> error ;
V_5 -> error = 0 ;
V_31 = F_22 ( V_5 , & ( V_48 [ 3 - error ] ) , error ) ;
if ( V_31 < 0 )
V_5 -> error = error ;
