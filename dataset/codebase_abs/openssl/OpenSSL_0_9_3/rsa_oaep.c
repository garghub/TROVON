...
20 ) ;
#endif
F_6 ( V_11 , V_8 - V_13 , V_10 , V_13 ) ;
for ( V_7 = 0 ; V_7 < V_8 - V_13 ; V_7 ++ )
V_9 [ V_7 ] ^= V_11 [ V_7 ] ;
F_6 ( V_12 , V_13 , V_9 , V_8 - V_13 ) ;
for ( V_7 = 0 ; V_7 < V_13 ; V_7 ++ )
V_10 [ V_7 ] ^= V_12 [ V_7 ] ;
Free ( V_11 ) ;
return ( 1 ) ;
}
int F_7 ( unsigned char * V_1 , int V_2 ,
...
int F_6 ( unsigned char * V_27 , long V_28 , unsigned char * V_10 , long V_29 )
{
long V_7 , V_30 = 0 ;
