...
{
V_47 = ( T_1 * ) F_23 ( V_46 , V_45 ) ;
F_4 ( V_47 ) ;
F_2 ( V_47 ) ;
}
F_24 ( V_46 ) ;
F_25 ( V_48 , ( char * ) V_44 , & V_44 -> V_40 ) ;
F_26 ( V_44 -> V_35 , F_18 ) ;
F_27 ( V_44 -> V_35 ) ;
Free ( V_44 ) ;
}
T_1 * F_28 ( T_6 * V_49 , T_2 * V_50 )
{
int V_45 ;
T_7 * V_46 ;
T_1 * V_47 ;
...
int F_30 ( T_8 * V_51 , int type , T_3 * V_14 ,
T_4 * V_2 )
{
T_6 * V_8 = V_51 -> V_8 ;
T_1 * V_47 ;
T_4 V_52 , * V_53 ;
int V_45 , V_54 ;
V_53 = F_31 ( V_8 -> V_35 , type , V_14 ) ;
if ( V_53 == NULL )
{
for ( V_45 = V_51 -> V_55 ; V_45 < F_22 ( V_8 -> V_37 ) ; V_45 ++ )
{
V_47 = ( T_1 * ) F_23 ( V_8 -> V_37 , V_45 ) ;
...
{
case V_26 :
F_33 ( & V_24 -> V_27 . V_28 -> V_42 , 1 , V_57 ) ;
break;
case V_31 :
F_33 ( & V_24 -> V_27 . V_32 -> V_42 , 1 , V_58 ) ;
break;
}
}
void F_34 ( T_4 * V_24 )
