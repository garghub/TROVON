...
int F_6 ( T_1 * V_12 )
{
static int V_13 [ 9 ] = { 0 , 0 , 1 , 1 , 0 , 0 , 0 , 0 , 0 } ;
static int V_14 [ 9 ] = { 99 , 99 , 12 , 31 , 23 , 59 , 59 , 12 , 59 } ;
char * V_1 ;
...
V_1 = ( char * ) V_12 -> V_19 ;
V_18 = 0 ;
if ( V_17 < 13 ) goto V_11;
for ( V_16 = 0 ; V_16 < 7 ; V_16 ++ )
{
if ( ( V_16 == 6 ) && ( ( V_1 [ V_18 ] == 'Z' ) ||
( V_1 [ V_18 ] == '+' ) || ( V_1 [ V_18 ] == '-' ) ) )
{ V_16 ++ ; break; }
...
sprintf ( V_23 , L_1 , V_25 -> V_28 + 1900 ,
V_25 -> V_29 + 1 , V_25 -> V_30 , V_25 -> V_31 , V_25 -> V_32 , V_25 -> V_33 ) ;
