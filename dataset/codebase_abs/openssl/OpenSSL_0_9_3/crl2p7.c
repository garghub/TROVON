...
if ( ( V_17 = F_7 ( NULL ) ) == NULL ) goto V_28;
V_14 -> V_15 = V_17 ;
if ( V_15 != NULL )
{
F_8 ( V_17 , ( char * ) V_15 ) ;
...
if ( ( V_19 = F_19 ( NULL ) ) == NULL ) goto V_28;
V_14 -> V_37 = V_19 ;
if( V_16 ) for( V_3 = 0 ; V_3 < F_20 ( V_16 ) ; V_3 ++ ) {
V_12 = F_21 ( V_16 , V_3 ) ;
if ( F_22 ( V_19 , V_12 ) < 0 )
{
F_9 ( V_22 , L_19 ) ;
...
if ( V_6 != NULL ) F_27 ( V_6 ) ;
if ( V_13 != NULL ) F_28 ( V_13 ) ;
