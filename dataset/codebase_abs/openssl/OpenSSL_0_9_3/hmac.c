...
memset ( & ( V_1 -> V_2 [ V_3 ] ) , 0 , sizeof( V_1 -> V_2 ) - V_3 ) ;
V_1 -> V_11 = V_3 ;
}
}
if ( V_7 )
...
void F_6 ( T_1 * V_1 , unsigned char * V_14 , int V_3 )
{
...
unsigned char * F_9 ( T_2 * V_17 , unsigned char * V_2 , int V_18 ,
unsigned char * V_19 , int V_20 , unsigned char * V_4 , unsigned int * V_21 )
{
T_1 V_22 ;
