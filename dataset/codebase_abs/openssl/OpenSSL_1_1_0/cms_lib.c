...
int F_44 ( T_7 * V_60 , T_3 * V_61 ,
T_5 * V_62 )
{
int V_63 ;
const T_1 * V_64 ;
F_40 ( & V_64 , NULL , NULL , V_62 ) ;
V_63 = F_14 ( V_64 ) ;
for (; ; ) {
T_7 * V_65 ;
V_61 = F_24 ( V_61 , V_66 ) ;
...
if ( F_46 ( V_65 ) == V_63
|| F_47 ( F_48 ( V_65 ) ) == V_63 )
return F_49 ( V_60 , V_65 ) ;
V_61 = F_50 ( V_61 ) ;
}
}
int F_51 ( T_2 * V_1 , T_8 * V_69 )
{
int V_70 ;
V_70 = F_52 ( V_1 , V_69 ) ;
if ( V_70 > 0 )
...
int F_57 ( T_4 * V_72 , T_8 * V_69 )
{
const T_4 * V_73 = F_58 ( V_69 ) ;
if ( V_73 == NULL )
return - 1 ;
return F_59 ( V_72 , V_73 ) ;
}
int F_60 ( T_10 * * V_74 , T_8 * V_69 )
{
T_10 * V_75 ;
V_75 = F_61 ( T_10 ) ;
if ( ! V_75 )
goto V_58;
if ( ! F_62 ( & V_75 -> V_76 , F_63 ( V_69 ) ) )
goto V_58;
if ( ! F_64 ( V_75 -> V_77 , F_65 ( V_69 ) ) )
goto V_58;
F_66 ( * V_74 , T_10 ) ;
* V_74 = V_75 ;
return 1 ;
