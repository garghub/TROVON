...
V_22 ++ ;
* V_22 = '\0' ;
if ( ( V_27 = F_4 ( sizeof( * V_27 ) ) ) == NULL ) {
F_16 ( V_36 , V_39 ) ;
goto V_38;
}
if ( V_33 == NULL )
V_33 = V_30 ;
V_27 -> V_11 = F_4 ( strlen ( V_34 ) + 1 ) ;
V_27 -> V_44 = NULL ;
if ( V_27 -> V_11 == NULL ) {
F_16 ( V_36 , V_39 ) ;
goto V_38;
}
F_35 ( V_27 -> V_11 , V_34 , strlen ( V_34 ) + 1 ) ;
...
if ( line != NULL )
* line = V_25 ;
F_38 ( V_26 , sizeof V_26 , L_4 , V_25 ) ;
F_39 ( 2 , L_5 , V_26 ) ;
if ( V_35 != V_6 -> V_9 ) {
F_40 ( V_6 -> V_9 ) ;
V_6 -> V_9 = NULL ;
...
static int F_32 ( T_2 * V_6 , char * V_30 , char * * V_45 , char * V_46 )
{
int V_47 , V_48 , V_49 = 0 , V_50 = 0 , V_51 = 0 ;
char * V_21 , * V_52 , * V_53 , * V_22 , * V_54 , * V_55 , * V_56 , V_27 ;
T_4 * V_31 ;
if ( ( V_31 = F_21 () ) == NULL )
return ( 0 ) ;
V_51 = strlen ( V_46 ) + 1 ;
...
if ( ! F_50 ( V_31 ,
( strlen ( V_22 ) + V_31 -> V_60 - ( V_52 - V_46 ) ) ) ) {
F_16 ( V_57 , V_39 ) ;
goto V_38;
}
while ( * V_22 )
...
static char * F_44 ( T_2 * V_6 , char * V_22 )
{
int V_47 = * V_22 ;
V_22 ++ ;
while ( ! ( F_30 ( V_6 , * V_22 ) ) ) {
...
static void F_52 ( const T_5 * V_61 , T_3 * V_62 )
{
if ( V_61 -> V_11 )
F_53 ( V_62 , L_6 , V_61 -> V_30 , V_61 -> V_11 , V_61 -> V_44 ) ;
else
F_53 ( V_62 , L_7 , V_61 -> V_30 ) ;
}
static int F_54 ( const T_2 * V_6 , T_3 * V_62 )
{
F_55 ( V_6 -> V_9 , F_52 , V_62 ) ;
return 1 ;
}
static int F_56 ( const T_2 * V_6 , char V_63 )
{
return F_57 ( V_6 , V_63 ) ;
}
static int F_58 ( const T_2 * V_6 , char V_63 )
{
return V_63 - '0' ;
}
