...
static int F_7 ( const char * V_1 , const char * V_5 , const T_2 * V_6 )
{
int V_7 ;
int V_8 = 0 ;
long V_9 = - 1 ;
...
V_1 = V_14 ;
else if ( strcmp ( V_13 , L_4 ) == 0 )
V_15 = 1 ;
else if ( strcmp ( V_13 , L_5 ) == 0 ) {
V_3 = F_14 ( L_6 ) ;
if ( ! V_3 )
goto V_19;
...
if ( strcmp ( V_14 , L_11 ) == 0 )
V_14 = NULL ;
if ( strcmp ( V_13 , L_12 ) == 0 ) {
