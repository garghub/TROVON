...
F_2 ( V_4 ) * V_5 = NULL ;
F_2 ( V_6 ) * V_7 = NULL ;
if ( strncmp ( V_3 -> V_8 , L_1 , 9 ) == 0 ) {
V_5 = F_3 ( V_2 , V_3 -> V_9 ) ;
if ( ! V_5 )
goto V_10;
} else if ( strcmp ( V_3 -> V_8 , L_2 ) == 0 ) {
int V_11 ;
F_2 ( T_3 ) * V_12 ;
T_4 * V_13 ;
V_13 = F_4 () ;
...
if ( strcmp ( V_27 -> V_32 , V_28 ) == 0 ) {
if ( ! F_20 ( * V_25 , V_27 -> V_33 , 1 ) )
goto V_10;
break;
}
}
...
F_23 ( V_35 , L_9 , V_38 , L_4 , V_38 + 2 , L_4 ) ;
