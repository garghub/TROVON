...
int F_10 ( int * V_15 , int V_16 , int V_17 )
{
T_1 V_10 ;
const T_1 * V_18 = & V_10 ;
const T_1 * * V_11 = NULL ;
...
int F_12 ( int V_7 , int V_21 , int V_6 )
{
T_1 * V_22 ;
if ( V_12 == NULL )
V_12 = F_13 ( F_2 ) ;
...
int V_27 , V_11 ;
# ifdef F_7
for ( V_27 = 0 ; V_27 < F_9 ( V_14 ) ; V_27 ++ ) {
F_12 ( V_14 [ V_27 ] [ 0 ] , V_14 [ V_27 ] [ 1 ] , V_14 [ V_27 ] [ 2 ] ) ;
}
# endif
for ( V_27 = 0 ; V_27 < F_9 ( V_14 ) ; V_27 ++ ) {
V_24 = V_14 [ V_27 ] [ 0 ] ;
...
printf ( L_1 , V_11 ,
F_22 ( V_24 ) , F_22 ( V_25 ) , F_22 ( V_26 ) ) ;
V_24 = 0 ;
V_11 = F_10 ( & V_24 , V_25 , V_26 ) ;
printf ( L_2 , V_11 ,
F_22 ( V_24 ) , F_22 ( V_25 ) , F_22 ( V_26 ) ) ;
}
}
