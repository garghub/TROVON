...
if ( F_20 ( V_3 , V_5 -> V_24 ) <= 0 ) {
F_4 ( V_16 ,
V_25 ) ;
goto V_21;
}
if ( V_5 -> V_24 -> type == V_29 ) {
F_21 ( V_5 -> V_24 ) ;
V_5 -> V_24 = NULL ;
}
}
...
int F_24 ( T_7 * V_32 , const T_4 * V_4 ,
const unsigned char * V_18 , T_6 V_26 )
{
T_2 * V_1 ;
if ( ! V_18 || ! V_26 ) {
...
if ( V_4 ) {
V_32 -> V_35 . V_36 = F_25 ( V_37 ) ;
if ( ! V_32 -> V_35 . V_36 ) {
F_4 ( V_33 , V_17 ) ;
return 0 ;
}
V_32 -> V_30 = F_8 ( V_38 ) ;
V_32 -> V_35 . V_36 -> V_39 = 0 ;
} else if ( F_26 ( V_32 -> V_30 ) != V_38 ) {
F_4 ( V_33 , V_40 ) ;
return 0 ;
}
V_1 = V_32 -> V_35 . V_36 -> V_41 ;
return F_23 ( V_1 , V_4 , V_18 , V_26 ) ;
}
T_1 * F_27 ( T_7 * V_32 )
{
V_37 * V_13 = V_32 -> V_35 . V_36 ;
if ( V_13 -> V_41 -> V_15 && V_13 -> V_42 )
V_13 -> V_39 = 2 ;
return F_1 ( V_13 -> V_41 ) ;
}
