...
F_4 ( V_3 ) ;
F_4 ( V_26 ) ;
V_37 = F_10 ( V_26 , V_38 , F_11 ( V_38 ) ) ;
if ( ! V_37 || V_37 > ( int ) F_11 ( V_38 ) ) {
F_12 ( V_39 , V_40 ) ;
return 0 ;
}
...
int F_13 ( T_2 * V_15 , const T_2 * V_3 , const T_2 * V_4 ,
...
F_4 ( V_4 ) ;
if ( V_3 == V_4 ) {
return F_14 ( V_15 , V_3 , V_26 , V_41 ) ;
}
F_15 ( V_41 ) ;
if ( ( V_7 = F_16 ( V_41 ) ) == NULL )
goto V_45;
...
int F_18 ( T_2 * V_15 , const T_2 * V_3 , const T_2 * V_4 ,
const T_2 * V_26 , T_3 * V_41 )
{
int V_37 = 0 ;
const int V_46 = F_19 ( V_26 ) + 1 ;
int * V_38 = NULL ;
F_4 ( V_3 ) ;
F_4 ( V_4 ) ;
F_4 ( V_26 ) ;
if ( ( V_38 = F_20 ( sizeof( * V_38 ) * V_46 ) ) == NULL )
goto V_45;
...
V_37 = F_13 ( V_15 , V_3 , V_4 , V_38 , V_41 ) ;
F_4 ( V_15 ) ;
V_45:
F_21 ( V_38 ) ;
return V_37 ;
}
int F_14 ( T_2 * V_15 , const T_2 * V_3 , const int V_26 [] ,
T_3 * V_41 )
{
int V_21 , V_37 = 0 ;
T_2 * V_7 ;
...
V_7 -> V_25 [ 2 * V_21 + 1 ] = F_22 ( V_3 -> V_25 [ V_21 ] ) ;
V_7 -> V_25 [ 2 * V_21 ] = F_23 ( V_3 -> V_25 [ V_21 ] ) ;
}
V_7 -> V_24 = 2 * V_3 -> V_24 ;
F_6 ( V_7 ) ;
if ( ! F_7 ( V_15 , V_7 , V_26 ) )
...
V_37 = F_14 ( V_15 , V_3 , V_38 , V_41 ) ;
F_4 ( V_15 ) ;
V_45:
F_21 ( V_38 ) ;
return V_37 ;
}
int F_25 ( T_2 * V_15 , const T_2 * V_3 , const T_2 * V_26 , T_3 * V_41 )
{
...
F_4 ( V_26 ) ;
F_15 ( V_41 ) ;
if ( ( V_4 = F_16 ( V_41 ) ) == NULL )
goto V_45;
if ( ( V_49 = F_16 ( V_41 ) ) == NULL )
goto V_45;
if ( ( V_50 = F_16 ( V_41 ) ) == NULL )
goto V_45;
if ( ( V_51 = F_16 ( V_41 ) ) == NULL )
goto V_45;
...
int F_30 ( T_2 * V_15 , const T_2 * V_65 , const int V_26 [] ,
T_3 * V_41 )
{
T_2 * V_66 ;
int V_37 = 0 ;
F_4 ( V_65 ) ;
F_15 ( V_41 ) ;
if ( ( V_66 = F_16 ( V_41 ) ) == NULL )
goto V_45;
if ( ! F_31 ( V_26 , V_66 ) )
goto V_45;
V_37 = F_25 ( V_15 , V_65 , V_66 , V_41 ) ;
F_4 ( V_15 ) ;
V_45:
F_17 ( V_41 ) ;
return V_37 ;
}
int F_32 ( T_2 * V_15 , const T_2 * V_67 , const T_2 * V_68 ,
const T_2 * V_26 , T_3 * V_41 )
{
T_2 * V_69 = NULL ;
int V_37 = 0 ;
...
if ( V_69 == NULL )
goto V_45;
if ( ! F_25 ( V_69 , V_68 , V_26 , V_41 ) )
goto V_45;
if ( ! F_18 ( V_15 , V_67 , V_69 , V_26 , V_41 ) )
goto V_45;
F_4 ( V_15 ) ;
V_37 = 1 ;
V_45:
...
int F_37 ( T_2 * V_15 , const T_2 * V_70 , const T_2 * V_65 ,
const int V_26 [] , T_3 * V_41 )
{
T_2 * V_66 ;
int V_37 = 0 ;
...
if ( ! F_31 ( V_26 , V_66 ) )
goto V_45;
V_37 = F_32 ( V_15 , V_70 , V_65 , V_66 , V_41 ) ;
F_4 ( V_15 ) ;
V_45:
F_17 ( V_41 ) ;
return V_37 ;
}
int F_38 ( T_2 * V_15 , const T_2 * V_3 , const T_2 * V_4 ,
const int V_26 [] , T_3 * V_41 )
{
...
if ( ! F_14 ( V_50 , V_50 , V_26 , V_41 ) )
goto V_45;
if ( F_40 ( V_4 , V_21 ) ) {
if ( ! F_13 ( V_50 , V_50 , V_3 , V_26 , V_41 ) )
goto V_45;
}
}
if ( ! F_27 ( V_15 , V_50 ) )
...
int F_41 ( T_2 * V_15 , const T_2 * V_3 , const T_2 * V_4 ,
const T_2 * V_26 , T_3 * V_41 )
{
int V_37 = 0 ;
const int V_46 = F_19 ( V_26 ) + 1 ;
...
V_37 = F_38 ( V_15 , V_3 , V_4 , V_38 , V_41 ) ;
F_4 ( V_15 ) ;
V_45:
F_21 ( V_38 ) ;
return V_37 ;
}
int F_42 ( T_2 * V_15 , const T_2 * V_3 , const int V_26 [] ,
T_3 * V_41 )
{
int V_37 = 0 ;
T_2 * V_50 ;
...
if ( ( V_50 = F_16 ( V_41 ) ) == NULL )
goto V_45;
if ( ! F_43 ( V_50 , V_26 [ 0 ] - 1 ) )
goto V_45;
V_37 = F_38 ( V_15 , V_3 , V_50 , V_26 , V_41 ) ;
F_4 ( V_15 ) ;
V_45:
F_17 ( V_41 ) ;
return V_37 ;
}
int F_44 ( T_2 * V_15 , const T_2 * V_3 , const T_2 * V_26 , T_3 * V_41 )
{
int V_37 = 0 ;
const int V_46 = F_19 ( V_26 ) + 1 ;
int * V_38 = NULL ;
...
V_37 = F_42 ( V_15 , V_3 , V_38 , V_41 ) ;
F_4 ( V_15 ) ;
V_45:
F_21 ( V_38 ) ;
return V_37 ;
}
int F_45 ( T_2 * V_15 , const T_2 * V_73 , const int V_26 [] ,
T_3 * V_41 )
{
...
if ( ! F_14 ( V_34 , V_34 , V_26 , V_41 ) )
goto V_45;
if ( ! F_14 ( V_77 , V_76 , V_26 , V_41 ) )
goto V_45;
if ( ! F_13 ( V_52 , V_77 , V_3 , V_26 , V_41 ) )
goto V_45;
...
V_74 ++ ;
} while ( F_26 ( V_76 ) && ( V_74 < V_80 ) );
if ( F_26 ( V_76 ) ) {
F_12 ( V_81 , V_82 ) ;
goto V_45;
}
}
if ( ! F_14 ( V_76 , V_34 , V_26 , V_41 ) )
goto V_45;
...
int F_47 ( T_2 * V_15 , const T_2 * V_3 , const T_2 * V_26 ,
T_3 * V_41 )
{
int V_37 = 0 ;
const int V_46 = F_19 ( V_26 ) + 1 ;
...
int F_31 ( const int V_26 [] , T_2 * V_3 )
{
int V_21 ;
F_4 ( V_3 ) ;
F_8 ( V_3 ) ;
for ( V_21 = 0 ; V_26 [ V_21 ] != - 1 ; V_21 ++ ) {
if ( F_43 ( V_3 , V_26 [ V_21 ] ) == 0 )
return 0 ;
}
F_4 ( V_3 ) ;
return 1 ;
