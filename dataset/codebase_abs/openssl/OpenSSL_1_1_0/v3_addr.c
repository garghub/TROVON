...
{
return ( ( V_1 != NULL &&
V_1 -> V_2 != NULL && V_1 -> V_2 -> V_3 != NULL )
? ( ( V_1 -> V_2 -> V_3 [ 0 ] << 8 ) | ( V_1 -> V_2 -> V_3 [ 1 ] ) )
: 0 ) ;
}
static int F_2 ( unsigned char * V_4 ,
const T_2 * V_5 ,
const int V_6 , const unsigned char V_7 )
{
...
const unsigned V_11 ,
const unsigned char V_7 , const T_2 * V_5 )
{
...
return 0 ;
for ( V_14 = 16 ; V_14 > 1 && V_4 [ V_14 - 1 ] == 0x00 && V_4 [ V_14 - 2 ] == 0x00 ;
V_14 -= 2 ) ;
for ( V_13 = 0 ; V_13 < V_14 ; V_13 += 2 )
F_4 ( V_10 , L_2 , ( V_4 [ V_13 ] << 8 ) | V_4 [ V_13 + 1 ] ,
( V_13 < 14 ? L_3 : L_4 ) ) ;
if ( V_13 < 16 )
F_5 ( V_10 , L_3 ) ;
if ( V_13 == 0 )
...
const unsigned char * V_26 , const int V_6 )
{
unsigned char V_9 ;
int V_13 , V_40 ;
...
unsigned char * V_4 , const int V_42 )
{
...
unsigned char * V_25 ,
unsigned char * V_26 , const int V_6 )
{
T_5 * V_19 ;
int V_13 , V_42 ;
...
int F_32 ( T_7 * V_4 ,
const unsigned V_11 , const unsigned * V_47 )
{
...
const unsigned V_11 ,
const unsigned * V_47 ,
unsigned char * V_33 , const int V_42 )
{
...
unsigned char * V_25 , unsigned char * V_26 , int V_6 )
{
