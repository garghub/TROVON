...
int F_2 ( T_1 * V_1 , const void * V_2 , T_2 V_3 )
{
...
void F_3 ( T_1 * V_1 , const void * V_2 , T_2 V_6 )
{
T_2 V_7 ;
unsigned int V_8 = V_1 -> V_8 ,
V_9 = V_8 % 8 , V_10 = ( 8 - ( unsigned int ) V_6 % 8 ) & 7 ;
const unsigned char * V_5 = V_2 ;
V_1 -> V_11 [ 0 ] += V_6 ;
if ( V_1 -> V_11 [ 0 ] < V_6 ) {
V_7 = 1 ;
...
int F_6 ( unsigned char * V_18 , T_1 * V_1 )
{
unsigned int V_8 = V_1 -> V_8 , V_15 = V_8 / 8 ;
T_2 V_19 , V_20 , V_21 ;
unsigned char * V_22 ;
V_8 %= 8 ;
if ( V_8 )
V_1 -> V_16 [ V_15 ] |= 0x80 >> V_8 ;
else
V_1 -> V_16 [ V_15 ] = 0x80 ;
V_15 ++ ;
if ( V_15 > ( V_14 / 8 - V_12 ) ) {
...
unsigned char * F_8 ( const void * V_5 , T_2 V_3 , unsigned char * V_18 )
{
T_1 V_25 ;
