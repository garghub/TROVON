...
int F_3 ( T_1 * V_1 , const T_2 * V_5 , char * V_3 ,
int V_4 )
{
int V_6 ;
const T_3 * V_7 ;
...
int F_4 ( T_1 * V_1 , const T_2 * V_5 , int V_10 )
{
int V_11 ;
T_4 * V_12 ;
F_10 ( T_4 ) * V_13 ;
...
T_4 * F_6 ( const T_1 * V_1 , int V_15 )
{
...
int F_15 ( T_1 * V_1 , const T_2 * V_5 , int type ,
...
int F_17 ( T_1 * V_1 , const T_4 * V_12 , int V_15 ,
int V_20 )
{
T_4 * V_23 = NULL ;
int V_11 , V_6 , V_24 ;
...
int F_30 ( T_4 * V_12 , const T_2 * V_5 )
{
...
T_2 * F_37 ( const T_4 * V_12 )
{
if ( V_12 == NULL )
return ( NULL ) ;
return ( V_12 -> V_14 ) ;
}
T_3 * F_5 ( const T_4 * V_12 )
{
if ( V_12 == NULL )
return ( NULL ) ;
return ( V_12 -> V_36 ) ;
}
int F_38 ( const T_4 * V_12 )
{
return V_12 -> V_20 ;
}
