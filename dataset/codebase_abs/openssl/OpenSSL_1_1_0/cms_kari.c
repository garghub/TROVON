...
int F_29 ( T_1 * V_1 , T_4 * V_60 ,
T_12 * V_31 , unsigned int V_61 )
{
T_14 * V_8 ;
T_6 * V_19 = NULL ;
V_1 -> V_7 . V_8 = F_30 ( T_14 ) ;
if ( ! V_1 -> V_7 . V_8 )
return 0 ;
V_1 -> type = V_4 ;
V_8 = V_1 -> V_7 . V_8 ;
V_8 -> V_62 = 3 ;
V_19 = F_30 ( T_6 ) ;
if ( ! F_31 ( V_8 -> V_63 , V_19 ) ) {
F_32 ( V_19 , T_6 ) ;
return 0 ;
}
if ( V_61 & V_64 ) {
V_19 -> V_25 -> type = V_28 ;
V_19 -> V_25 -> V_7 . V_29 = F_30 ( V_65 ) ;
if ( V_19 -> V_25 -> V_7 . V_29 == NULL )
return 0 ;
if ( ! F_33 ( & V_19 -> V_25 -> V_7 . V_29 -> V_18 , V_60 ) )
return 0 ;
} else {
V_19 -> V_25 -> type = V_26 ;
if ( ! F_34 ( & V_19 -> V_25 -> V_7 . V_16 , V_60 ) )
return 0 ;
}
if ( ! F_25 ( V_8 , V_31 ) )
return 0 ;
...
V_68 = F_45 () ;
return F_46 ( V_34 , V_68 , NULL , NULL , NULL ) ;
}
int F_47 ( T_17 * V_46 ,
T_1 * V_1 )
{
...
V_71 = V_8 -> V_63 ;
V_51 = V_46 -> V_7 . V_55 -> V_56 ;
if ( ! F_36 ( V_8 , V_51 -> V_67 ) )
return 0 ;
if ( V_8 -> V_14 -> type == - 1 ) {
T_5 * V_12 = V_8 -> V_14 ;
V_12 -> type = V_74 ;
V_12 -> V_7 . V_75 = F_30 ( V_76 ) ;
if ( ! V_12 -> V_7 . V_75 )
return 0 ;
}
if ( ! F_23 ( V_1 , 0 ) )
return 0 ;
for ( V_72 = 0 ; V_72 < F_49 ( V_71 ) ; V_72 ++ ) {
unsigned char * V_47 ;
T_16 V_49 ;
V_19 = F_50 ( V_71 , V_72 ) ;
if ( F_51 ( V_8 -> V_32 , V_19 -> V_66 ) <= 0 )
return 0 ;
if ( ! F_13 ( & V_47 , & V_49 , V_51 -> V_57 , V_51 -> V_58 ,
V_8 , 1 ) )
return 0 ;
F_52 ( V_19 -> V_52 , V_47 , V_49 ) ;
}
return 1 ;
}
