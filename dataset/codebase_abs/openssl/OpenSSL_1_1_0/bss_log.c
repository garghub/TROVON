...
static int F_6 ( T_2 * V_8 , const char * V_9 , int V_10 )
{
int V_11 = V_10 ;
char * V_12 ;
char * V_13 ;
...
static long F_10 ( T_2 * V_8 , int V_28 , long V_4 , void * V_5 )
{
switch ( V_28 ) {
case V_29 :
F_5 ( V_8 ) ;
...
static int F_11 ( T_2 * V_30 , const char * V_17 )
{
int V_31 , V_11 ;
V_31 = strlen ( V_17 ) ;
...
static void F_3 ( T_2 * V_30 , char * V_32 , int V_33 )
{
if ( F_12 () )
...
static void F_8 ( T_2 * V_30 , int V_14 , const char * string )
{
T_3 V_34 [ 2 ] ;
T_4 V_35 = V_36 ;
