...
V_9 = - 1 ;
if ( F_11 ( V_6 , ( unsigned char * ) V_3 -> V_4 ,
...
int F_13 ( const T_7 * V_22 , T_2 * V_2 ,
...
if ( ! F_14 ( F_4 ( V_2 -> V_15 ) , & V_24 , & V_25 ) ) {
F_3 ( V_26 , V_28 ) ;
goto V_14;
}
if ( V_24 == V_29 ) {
...
if ( F_16 ( V_25 ) != V_5 -> V_30 -> V_32 ) {
F_3 ( V_26 , V_33 ) ;
goto V_14;
}
if ( ! F_17 ( V_6 , NULL , type , NULL , V_5 ) ) {
F_3 ( V_26 , V_20 ) ;
V_9 = 0 ;
goto V_14;
}
}
V_11 = F_18 ( V_23 , & V_8 , V_22 ) ;
if ( V_8 == NULL ) {
F_3 ( V_26 , V_13 ) ;
goto V_14;
}
V_9 = F_19 ( V_6 , V_8 , V_11 ) ;
F_10 ( V_8 , ( unsigned int ) V_11 ) ;
if ( ! V_9 ) {
F_3 ( V_26 , V_20 ) ;
goto V_14;
