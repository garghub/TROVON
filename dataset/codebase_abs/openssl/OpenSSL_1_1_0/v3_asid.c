...
return V_19 != 0 ? V_19 : F_5 ( V_10 -> V_13 . V_16 -> V_18 ,
V_11 -> V_13 . V_16 -> V_18 ) ;
}
if ( V_10 -> type == V_12 )
...
T_6 * V_34 = NULL , * V_35 = NULL , * V_36 = NULL , * V_37 =
NULL ;
F_16 ( V_10 , & V_34 , & V_35 ) ;
F_16 ( V_11 , & V_36 , & V_37 ) ;
if ( F_5 ( V_34 , V_36 ) >= 0 ||
...
{
T_6 * V_45 = NULL , * V_46 = NULL , * V_47 = NULL , * V_48 = NULL ;
int V_49 , V_50 ;
