...
{
int V_16 ;
if( ( V_16 = F_20 ( V_1 -> V_11 , V_8 ) ) == V_17 )
{
fprintf ( V_4 , L_6 ) ;
return 0 ;
}
...
if( F_30 ( V_19 , V_30 , V_31 , ( char * ) & V_23 , sizeof V_23 ) < 0 )
{
perror ( L_15 ) ;
exit ( 2 ) ;
}
...
F_40 ( V_25 , & V_38 ) ;
F_40 ( 0 , & V_37 ) ;
V_8 = F_41 ( V_25 + 1 , & V_37 , & V_38 , NULL , NULL ) ;
assert ( V_8 > 0 ) ;
if( F_42 ( V_25 , & V_37 ) )
{
