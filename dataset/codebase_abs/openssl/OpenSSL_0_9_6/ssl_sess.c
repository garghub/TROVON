...
V_17 -> V_23 = NULL ;
V_17 -> V_24 = 0 ;
F_14 ( V_12 , V_17 , & V_17 -> V_16 ) ;
return ( V_17 ) ;
}
int F_15 ( T_2 * V_13 , int V_2 )
{
T_1 * V_17 = NULL ;
...
{
T_1 * V_37 ;
F_18 ( V_17 -> V_38 , V_17 -> V_30 ) ;
F_3 ( V_39 ) ;
V_37 = ( T_1 * ) F_19 ( V_13 -> V_25 -> V_40 , V_17 ) ;
F_4 ( V_39 ) ;
if ( V_37 == NULL ) break;
}
}
...
int F_20 ( T_2 * V_13 , unsigned char * V_38 , int V_44 )
{
T_1 * V_45 = NULL , V_46 ;
int V_47 = 0 ;
V_46 . V_29 = V_13 -> V_27 ;
...
{
F_3 ( V_39 ) ;
V_45 = ( T_1 * ) F_19 ( V_13 -> V_25 -> V_40 , & V_46 ) ;
if ( V_45 != NULL )
F_21 ( & V_45 -> V_5 , 1 , V_4 ) ;
F_4 ( V_39 ) ;
}
...
F_23 ( V_64 , V_63 ) ;
if ( ( V_45 -> V_29 >> 8 ) == V_66 )
V_45 -> V_61 = F_24 ( V_13 , & ( V_62 [ 2 ] ) ) ;
else
V_45 -> V_61 = F_24 ( V_13 , & ( V_62 [ 1 ] ) ) ;
if ( V_45 -> V_61 == NULL )
goto V_49;
}
#if 0
...
int F_22 ( T_6 * V_25 , T_1 * V_69 )
{
int V_45 = 0 ;
T_1 * V_13 ;
F_21 ( & V_69 -> V_5 , 1 , V_4 ) ;
F_26 ( V_39 ) ;
V_13 = ( T_1 * ) F_27 ( V_25 -> V_40 , V_69 ) ;
...
int F_25 ( T_6 * V_25 , T_1 * V_69 )
{
return F_32 ( V_25 , V_69 , 1 ) ;
}
static int F_32 ( T_6 * V_25 , T_1 * V_69 , int V_72 )
{
T_1 * V_37 ;
int V_45 = 0 ;
...
#endif
F_37 ( V_12 , V_17 , & V_17 -> V_16 ) ;
memset ( V_17 -> V_77 , 0 , V_78 ) ;
memset ( V_17 -> V_79 , 0 , V_80 ) ;
memset ( V_17 -> V_38 , 0 , V_48 ) ;
if ( V_17 -> V_81 != NULL ) F_38 ( V_17 -> V_81 ) ;
if ( V_17 -> V_82 != NULL ) F_39 ( V_17 -> V_82 ) ;
if ( V_17 -> V_83 != NULL ) F_40 ( V_17 -> V_83 ) ;
memset ( V_17 , 0 , sizeof( * V_17 ) ) ;
F_41 ( V_17 ) ;
}
int F_42 ( T_2 * V_13 , T_1 * V_2 )
{
int V_45 = 0 ;
T_7 * V_84 ;
if ( V_2 != NULL )
...
long F_47 ( T_1 * V_13 , long V_89 )
{
if ( V_13 == NULL ) return ( 0 ) ;
V_13 -> time = V_89 ;
return ( V_89 ) ;
}
long F_48 ( T_6 * V_13 , long V_89 )
{
long V_64 ;
if ( V_13 == NULL ) return ( 0 ) ;
V_64 = V_13 -> V_26 ;
...
static void F_29 ( T_6 * V_25 , T_1 * V_13 )
{
