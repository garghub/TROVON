...
if( ! ( V_9 = F_4 ( V_5 + F_5 ( & V_12 ) ) ) ) {
F_3 ( V_15 , V_17 ) ;
return NULL ;
}
F_6 ( & V_12 , V_9 , & V_11 , V_4 , V_5 ) ;
V_10 = V_11 ;
if( ! F_7 ( & V_12 , V_9 + V_11 , & V_11 ) ) {
F_8 ( V_9 ) ;
F_3 ( V_15 , V_18 ) ;
return NULL ;
}
...
char * F_9 ( T_1 * V_1 , char * (* F_10)() ,
void (* F_11)( void * ) , const char * V_2 , int V_3 ,
T_3 * V_19 , int V_20 )
{
...
#endif
if ( V_20 & 1 ) V_22 = ( char * ) F_13 ( NULL , & V_21 , V_10 , F_10 ,
F_11 , V_29 , V_30 ) ;
else V_22 = F_10 ( NULL , & V_21 , V_10 ) ;
if ( V_20 & 2 ) memset ( V_9 , 0 , V_10 ) ;
if( ! V_22 ) F_3 ( V_24 , V_31 ) ;
F_8 ( V_9 ) ;
return V_22 ;
}
T_3 * F_14 ( T_1 * V_1 , int (* F_15)() ,
...
if ( V_20 ) V_5 = F_17 ( ( V_34 * ) V_32 , NULL , F_15 , V_29 ,
V_30 , V_35 ) ;
else V_5 = F_15 ( V_32 , NULL ) ;
if ( ! V_5 ) {
F_3 ( V_33 , V_36 ) ;
return NULL ;
}
...
V_21 = V_4 ;
if ( V_20 ) F_17 ( ( V_34 * ) V_32 , & V_21 , F_15 , V_29 ,
V_30 , V_35 ) ;
else F_15 ( V_32 , & V_21 ) ;
