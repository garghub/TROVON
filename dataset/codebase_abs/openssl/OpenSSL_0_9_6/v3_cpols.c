...
static void F_23 ( T_3 * V_17 , T_4 * V_18 , int V_19 )
{
int V_20 ;
if( V_18 -> V_21 ) {
T_5 * V_22 ;
V_22 = V_18 -> V_21 ;
F_24 ( V_17 , L_1 , V_19 , L_2 ,
V_22 -> V_23 -> V_24 ) ;
F_24 ( V_17 , L_3 , V_19 , L_2 ,
F_25 ( V_22 -> V_25 ) > 1 ? L_4 : L_2 ) ;
for( V_20 = 0 ; V_20 < F_25 ( V_22 -> V_25 ) ; V_20 ++ ) {
T_6 * V_26 ;
char * V_27 ;
V_26 = F_26 ( V_22 -> V_25 , V_20 ) ;
if( V_20 ) F_27 ( V_17 , L_5 ) ;
V_27 = F_28 ( NULL , V_26 ) ;
F_27 ( V_17 , V_27 ) ;
F_22 ( V_27 ) ;
}
