...
else if ( ! V_15 && ( V_3 -> V_33 != NULL ) )
{
if ( V_10 == V_34 )
V_5 = ( int ) F_23 ( V_8 , V_3 -> V_33 ) ;
else if ( V_10 == V_22 )
V_5 = F_24 ( V_8 , V_3 -> V_33 ) ;
else {
F_6 ( V_18 , L_12 ) ;
goto V_25;
}
...
V_4 = 0 ;
V_25:
if ( V_8 != NULL ) F_25 ( V_8 ) ;
if ( V_3 != NULL ) F_12 ( V_3 ) ;
EXIT ( V_4 ) ;
}
static T_1 * F_8 ( char * V_11 , int V_35 )
{
T_1 * V_3 = NULL ;
T_2 * V_36 = NULL ;
V_36 = F_2 ( F_3 () ) ;
