...
F_7 ( V_15 , V_10 ) ;
F_7 ( V_15 , V_11 ) ;
F_8 ( V_11 , V_10 , V_12 , 4 , 0x0f0f0f0fL ) ;
F_9 ( V_10 , V_12 , - 2 , 0xcccc0000L ) ;
F_9 ( V_11 , V_12 , - 2 , 0xcccc0000L ) ;
F_8 ( V_11 , V_10 , V_12 , 1 , 0x55555555L ) ;
F_8 ( V_10 , V_11 , V_12 , 8 , 0x00ff00ffL ) ;
F_8 ( V_11 , V_10 , V_12 , 1 , 0x55555555L ) ;
...
V_10 &= 0x0fffffffL ;
V_11 &= 0x0fffffffL ;
V_13 = V_20 [ 0 ] [ ( V_10 ) & 0x3f ] |
V_20 [ 1 ] [ ( ( V_10 >> 6L ) & 0x03 ) | ( ( V_10 >> 7L ) & 0x3c ) ] |
V_20 [ 2 ] [ ( ( V_10 >> 13L ) & 0x0f ) | ( ( V_10 >> 14L ) & 0x30 ) ] |
V_20 [ 3 ] [ ( ( V_10 >> 20L ) & 0x01 ) | ( ( V_10 >> 21L ) & 0x06 ) |
( ( V_10 >> 22L ) & 0x38 ) ] ;
V_12 = V_20 [ 4 ] [ ( V_11 ) & 0x3f ] |
V_20 [ 5 ] [ ( ( V_11 >> 7L ) & 0x03 ) | ( ( V_11 >> 8L ) & 0x3c ) ] |
V_20 [ 6 ] [ ( V_11 >> 15L ) & 0x3f ] |
V_20 [ 7 ] [ ( ( V_11 >> 21L ) & 0x0f ) | ( ( V_11 >> 22L ) & 0x30 ) ] ;
V_14 = ( ( V_12 << 16L ) | ( V_13 & 0x0000ffffL ) ) & 0xffffffffL ;
* ( V_16 ++ ) = F_10 ( V_14 , 30 ) & 0xffffffffL ;
V_14 = ( ( V_13 >> 16L ) | ( V_12 & 0xffff0000L ) ) ;
* ( V_16 ++ ) = F_10 ( V_14 , 26 ) & 0xffffffffL ;
}
}
int F_11 ( T_2 * V_1 , T_3 V_7 )
{
return ( F_4 ( V_1 , V_7 ) ) ;
}
void F_12 ( T_1 * V_1 )
