...
V_15 = ( ( unsigned long ) ( * V_14 ++ & 0x7 ) ) << 18 ;
V_15 |= ( * V_14 ++ & 0x3f ) << 12 ;
V_15 |= ( * V_14 ++ & 0x3f ) << 6 ;
V_15 |= * V_14 ++ & 0x3f ;
...
V_15 = ( ( unsigned long ) ( * V_14 ++ & 0x3 ) ) << 24 ;
V_15 |= ( ( unsigned long ) ( * V_14 ++ & 0x3f ) ) << 18 ;
V_15 |= ( ( unsigned long ) ( * V_14 ++ & 0x3f ) ) << 12 ;
V_15 |= ( * V_14 ++ & 0x3f ) << 6 ;
V_15 |= * V_14 ++ & 0x3f ;
...
V_15 = ( ( unsigned long ) ( * V_14 ++ & 0x1 ) ) << 30 ;
V_15 |= ( ( unsigned long ) ( * V_14 ++ & 0x3f ) ) << 24 ;
V_15 |= ( ( unsigned long ) ( * V_14 ++ & 0x3f ) ) << 18 ;
V_15 |= ( ( unsigned long ) ( * V_14 ++ & 0x3f ) ) << 12 ;
V_15 |= ( * V_14 ++ & 0x3f ) << 6 ;
V_15 |= * V_14 ++ & 0x3f ;
