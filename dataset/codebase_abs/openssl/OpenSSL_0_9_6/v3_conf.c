...
if( ! ( V_29 = F_17 ( V_31 ) ) ) goto V_34;
V_30 = V_29 ;
V_11 -> V_33 ( V_15 , & V_30 ) ;
if( ! ( V_32 = F_18 () ) ) goto V_34;
V_32 -> V_35 = V_29 ;
V_32 -> V_36 = V_31 ;
V_12 = F_19 ( NULL , V_10 , V_5 , V_32 ) ;
if( ! V_12 ) goto V_34;
F_20 ( V_32 ) ;
return V_12 ;
V_34:
...
T_1 * F_21 ( int V_10 , int V_5 , void * V_15 )
{
T_4 * V_11 ;
if( ! ( V_11 = F_12 ( V_10 ) ) ) {
F_7 ( V_39 , V_19 ) ;
...
int F_27 ( T_2 * V_1 , T_3 * V_2 , char * V_47 ,
T_7 * V_48 )
{
T_1 * V_12 ;
F_11 ( V_13 ) * V_14 ;
...
for( V_50 = 0 ; V_50 < F_28 ( V_14 ) ; V_50 ++ ) {
V_49 = F_29 ( V_14 , V_50 ) ;
if( ! ( V_12 = F_1 ( V_1 , V_2 , V_49 -> V_3 , V_49 -> V_4 ) ) )
return 0 ;
if( V_48 ) F_30 ( V_48 , V_12 , - 1 ) ;
F_31 ( V_12 ) ;
}
return 1 ;
}
...
if( ! ( V_12 = F_1 ( V_1 , V_2 , V_49 -> V_3 , V_49 -> V_4 ) ) )
return 0 ;
if( V_51 ) F_33 ( V_51 , V_12 , - 1 ) ;
F_31 ( V_12 ) ;
}
return 1 ;
}
int F_34 ( T_2 * V_1 , T_3 * V_2 , char * V_47 ,
T_9 * V_52 )
{
T_1 * V_12 ;
F_11 ( T_1 ) * V_53 = NULL ;
...
if( V_52 ) V_50 = F_37 ( V_52 , V_53 ) ;
else V_50 = 1 ;
F_38 ( V_53 , F_31 ) ;
return V_50 ;
}
char * F_39 ( T_3 * V_2 , char * V_3 , char * V_47 )
{
if( V_2 -> V_54 -> V_55 )
return V_2 -> V_54 -> V_55 ( V_2 -> V_25 , V_3 , V_47 ) ;
return NULL ;
}
static char * F_40 ( void * V_25 , char * V_47 , char * V_4 )
{
return F_41 ( V_25 , V_47 , V_4 ) ;
}
void F_42 ( T_3 * V_2 , T_2 * V_56 )
{
V_2 -> V_54 = & V_57 ;
V_2 -> V_25 = V_56 ;
}
void F_43 ( T_3 * V_2 , T_7 * V_58 , T_7 * V_59 , T_9 * V_52 ,
T_8 * V_51 , int V_60 )
{
V_2 -> V_61 = V_58 ;
V_2 -> V_62 = V_59 ;
