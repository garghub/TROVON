...
if( ( V_6 > 0 ) && ( V_15 < V_6 ) ) {
F_4 ( V_19 , V_28 ) ;
sprintf ( V_16 , L_1 , V_6 ) ;
F_6 ( 2 , L_2 , V_16 ) ;
return - 1 ;
}
if( ( V_7 > 0 ) && ( V_15 > V_7 ) ) {
F_4 ( V_19 , V_29 ) ;
sprintf ( V_16 , L_1 , V_7 ) ;
F_6 ( 2 , L_3 , V_16 ) ;
return - 1 ;
}
...
int (* F_12)( unsigned long V_51 , void * V_2 ) , void * V_52 )
{
unsigned long V_51 ;
int V_9 ;
while( V_3 ) {
...
int V_9 ;
V_14 = V_52 ;
V_9 = F_14 ( * V_14 , 0xff , V_51 ) ;
* V_14 += V_9 ;
return 1 ;
}
static int F_15 ( unsigned long V_51 )
{
int V_55 ;
