...
#endif
F_20 ( V_27 , V_29 , & V_29 -> V_28 ) ;
if ( V_29 -> V_1 -> V_5 != NULL )
V_29 -> V_1 -> V_5 ( V_29 ) ;
if ( V_29 -> V_12 != NULL ) F_21 ( V_29 -> V_12 ) ;
if ( V_29 -> V_13 != NULL ) F_21 ( V_29 -> V_13 ) ;
if ( V_29 -> V_14 != NULL ) F_21 ( V_29 -> V_14 ) ;
if ( V_29 -> V_15 != NULL ) F_21 ( V_29 -> V_15 ) ;
if ( V_29 -> V_16 != NULL ) F_21 ( V_29 -> V_16 ) ;
if ( V_29 -> V_17 != NULL ) F_21 ( V_29 -> V_17 ) ;
if ( V_29 -> V_18 != NULL ) F_21 ( V_29 -> V_18 ) ;
if ( V_29 -> V_19 != NULL ) F_21 ( V_29 -> V_19 ) ;
if ( V_29 -> V_24 != NULL ) F_22 ( V_29 -> V_24 ) ;
if ( V_29 -> V_25 != NULL ) F_23 ( V_29 -> V_25 ) ;
F_14 ( V_29 ) ;
}
int F_24 ( long V_33 , void * V_34 , T_3 * V_35 ,
T_4 * V_36 , T_5 * V_37 )
{
V_38 ++ ;
return ( F_25 ( V_38 - 1 ,
...
int F_26 ( T_1 * V_29 , int V_39 , void * V_40 )
{
return ( F_27 ( & V_29 -> V_28 , V_39 , V_40 ) ) ;
}
void * F_28 ( T_1 * V_29 , int V_39 )
{
return ( F_29 ( & V_29 -> V_28 , V_39 ) ) ;
}
int F_30 ( T_1 * V_29 )
{
return ( F_31 ( V_29 -> V_12 ) ) ;
}
...
int F_34 ( int V_41 , unsigned char * V_42 , unsigned char * V_43 ,
T_1 * V_3 , int V_44 )
{
return ( V_3 -> V_1 -> V_47 ( V_41 , V_42 , V_43 , V_3 , V_44 ) ) ;
}
int F_35 ( int V_41 , unsigned char * V_42 , unsigned char * V_43 ,
T_1 * V_3 , int V_44 )
{
...
F_40 ( V_53 ) ;
V_51 = F_41 ( V_53 ) ;
if ( ! F_42 ( V_51 , F_43 ( V_3 -> V_12 ) - 1 , 1 , 0 ) ) goto V_54;
if ( ( V_52 = F_44 ( NULL , V_51 , V_3 -> V_12 , V_53 ) ) == NULL ) goto V_54;
if ( ! V_3 -> V_1 -> V_55 ( V_51 , V_51 , V_3 -> V_13 , V_3 -> V_12 , V_53 , V_3 -> V_21 ) )
goto V_54;
V_3 -> V_24 = F_45 ( V_51 , V_52 , V_3 -> V_12 ) ;
V_3 -> V_26 |= V_49 ;
F_46 ( V_52 ) ;
V_7 = 1 ;
V_54:
F_47 ( V_53 ) ;
if ( V_53 != V_50 ) F_48 ( V_53 ) ;
return ( V_7 ) ;
}
int F_49 ( T_1 * V_29 )
{
...
V_56 += ( * V_60 [ V_30 ] ) -> V_63 ;
if ( ( V_15 = F_50 ( ( V_58 + V_56 ) * sizeof( T_8 ) ) ) == NULL )
{
F_13 ( V_64 , V_9 ) ;
return ( 0 ) ;
}
