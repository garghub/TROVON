int F_1 ( T_1 * V_1 , T_2 * V_2 , int type )
{
int V_3 , V_4 = 0 ;
...
{
if ( V_18 == NULL )
V_19 = ( unsigned char * ) F_7 (
( unsigned int ) V_21 + V_3 * 2 ) ;
else
V_19 = ( unsigned char * ) F_8 ( V_18 ,
( unsigned int ) V_21 + V_3 * 2 ) ;
if ( V_19 == NULL )
{
F_6 ( V_25 , V_27 ) ;
if ( V_18 != NULL ) F_9 ( V_18 ) ;
goto V_8;
}
V_18 = V_19 ;
V_22 = V_21 + V_3 * 2 ;
