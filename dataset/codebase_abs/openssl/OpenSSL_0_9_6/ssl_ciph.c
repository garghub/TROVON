...
static int F_22 ( const char * V_91 ,
T_6 * V_61 , T_6 * * V_62 ,
T_6 * * V_63 , T_5 * * V_68 )
{
...
static int F_27 ( const T_4 * const * V_107 ,
const T_4 * const * V_108 )
{
return ( ( * V_107 ) -> V_28 - ( * V_108 ) -> V_28 ) ;
}
int F_28 ( int V_28 , T_8 * V_109 )
{
T_4 * V_21 ;
F_29 ( T_4 ) * V_110 ;
V_21 = ( T_4 * ) F_19 ( sizeof( T_4 ) ) ;
V_21 -> V_28 = V_28 ;
V_21 -> V_111 = V_109 ;
if ( V_27 == NULL )
V_110 = V_27 = F_30 ( F_27 ) ;
else
V_110 = V_27 ;
if ( ( V_110 == NULL ) || ! F_31 ( V_110 , V_21 ) )
{
F_20 ( V_112 , V_90 ) ;
return ( 0 ) ;
}
