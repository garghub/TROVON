...
{
return ( F_6 ( V_1 , & V_16 , V_17 , 0 , 0 , V_5 , 0 ) ) ;
}
int F_7 ( T_1 * V_1 , unsigned char * V_16 , long V_17 , int V_5 , int V_18 )
{
return ( F_6 ( V_1 , & V_16 , V_17 , 0 , 0 , V_5 , V_18 ) ) ;
}
static int F_6 ( T_1 * V_1 , unsigned char * * V_16 , long V_19 , int V_20 ,
...
{
V_24 = V_9 ;
V_29 = F_8 ( & V_9 , & V_17 , & V_2 , & V_3 , V_19 ) ;
#ifdef F_9
V_29 = V_29 ;
#endif
if ( V_29 & 0x80 )
...
V_28 = ( V_9 - V_24 ) ;
V_19 -= V_28 ;
if ( F_4 ( V_1 , L_9 , ( long ) V_20 + ( long ) ( V_24 - * V_16 ) )
<= 0 ) goto V_34;
if ( V_29 != ( V_11 | 1 ) )
{
if ( F_4 ( V_1 , L_10 ,
...
for (; ; )
{
V_30 = F_6 ( V_1 , & V_9 , ( long ) ( V_23 - V_9 ) ,
...
{
V_25 = V_24 ;
if ( F_10 ( & V_31 , & V_25 , V_17 + V_28 ) != NULL )
{
if ( F_2 ( V_1 , L_14 , 1 ) <= 0 ) goto V_34;
F_11 ( V_1 , V_31 ) ;
}
...
V_26 = 1 ;
V_34:
if ( V_31 != NULL ) F_20 ( V_31 ) ;
if ( V_32 != NULL ) F_15 ( V_32 ) ;
* V_16 = V_9 ;
return ( V_26 ) ;
}
