...
while ( V_6 < V_18 )
{
V_12 = F_3 ( V_1 , ( void * ) & ( V_7 [ V_6 ] ) , V_18 - V_6 ) ;
#ifdef F_4
if ( ( V_12 == - 1 ) && ( V_19 == F_4 ) ) continue;
#endif
if ( V_12 <= 0 ) return ( 0 ) ;
V_6 += V_12 ;
}
...
while ( V_6 < V_14 )
{
V_12 = F_3 ( V_1 , ( void * ) & ( V_7 [ V_6 ] ) , V_14 - V_6 ) ;
#ifdef F_4
if ( ( V_12 == - 1 ) && ( V_19 == F_4 ) ) continue;
#endif
if ( V_12 <= 0 ) return ( 0 ) ;
