...
if ( V_11 )
{
V_11 = F_8 ( V_9 -> V_22 , & ( V_3 -> V_10 [ V_3 -> V_20 ] ) , V_11 ) ;
if ( V_11 <= 0 )
{
F_9 ( V_8 ) ;
return ( V_11 ) ;
...
V_18 = V_3 -> V_20 ;
V_15 = V_3 -> V_10 ;
V_14 = F_10 ( & V_15 , & T_4 , & V_16 , & V_17 , V_18 ) ;
if ( V_14 & 0x80 )
{
if ( ( V_3 -> V_20 < V_21 ) &&
( F_11 ( F_12 () ) == V_23 ) )
...
static int F_17 ( T_2 * V_8 , char * V_27 , int V_28 )
{
...
static int F_18 ( T_2 * V_8 , char * V_33 , int V_34 )
{
...
while ( V_13 > 0 )
{
V_11 = F_19 ( V_8 -> V_22 , & ( V_3 -> V_10 [ V_3 -> V_19 ] ) , V_13 ) ;
if ( V_11 <= 0 )
{
F_9 ( V_8 ) ;
return ( V_11 ) ;
...
static long F_21 ( T_2 * V_8 , int V_37 , long V_38 , char * V_5 )
{
T_2 * V_39 ;
T_5 * V_3 , * V_40 ;
long V_14 = 1 ;
...
V_3 -> V_42 = 1 ;
V_3 -> V_29 = 0 ;
F_22 ( & ( V_3 -> V_36 ) , NULL , NULL , NULL ,
V_3 -> V_36 . V_43 ) ;
V_14 = F_23 ( V_8 -> V_22 , V_37 , V_38 , V_5 ) ;
break;
case V_44 :
if ( V_3 -> V_45 <= 0 )
V_14 = 1 ;
...
static long F_25 ( T_2 * V_8 , int V_37 , void * (* F_26)() )
{
long V_14 = 1 ;
...
{
default:
V_14 = F_27 ( V_8 -> V_22 , V_37 , F_26 ) ;
break;
}
return ( V_14 ) ;
}
void F_28 ( T_2 * V_8 , T_6 * V_52 , unsigned char * V_53 , unsigned char * V_11 ,
int V_54 )
{
T_5 * V_3 ;
if ( V_8 == NULL ) return;
...
V_8 -> V_4 = 1 ;
V_3 = ( T_5 * ) V_8 -> V_5 ;
F_22 ( & ( V_3 -> V_36 ) , V_52 , V_53 , V_11 , V_54 ) ;
if ( V_8 -> V_55 != NULL )
