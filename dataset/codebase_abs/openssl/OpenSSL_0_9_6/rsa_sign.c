...
int F_9 ( int V_34 , unsigned char * V_1 , unsigned int V_2 ,
...
V_12 = ( unsigned char * ) F_6 ( ( unsigned int ) V_4 ) ;
if ( V_12 == NULL )
{
F_2 ( V_37 , V_33 ) ;
goto V_40;
...
V_8 = F_10 ( ( int ) V_4 , V_35 , V_12 , V_5 , V_31 ) ;
if ( V_8 <= 0 ) goto V_40;
if( V_34 == V_19 ) {
...
V_11 = V_12 ;
V_6 = F_11 ( NULL , & V_11 , ( long ) V_8 ) ;
if ( V_6 == NULL ) goto V_40;
V_36 = F_12 ( V_6 -> V_13 -> V_23 ) ;
#ifdef F_13
fprintf ( V_42 , L_1 , F_14 ( V_36 ) ,
F_14 ( V_34 ) ) ;
#endif
if ( V_36 != V_34 )
{
