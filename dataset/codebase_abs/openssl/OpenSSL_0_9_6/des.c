...
{
char V_56 [ 8 ] ;
if ( V_41 ) memcpy ( V_56 , & ( V_49 [ V_40 ] ) ,
( unsigned int ) V_41 ) ;
F_14 (
( T_2 * ) V_49 , ( T_2 * ) V_51 ,
( long ) V_40 , V_34 , V_35 , & V_36 ,
& V_37 , V_28 ) ;
if ( V_41 ) memcpy ( & ( V_49 [ V_40 ] ) , V_56 ,
( unsigned int ) V_41 ) ;
}
else
{
...
if ( V_19 )
V_42 = F_18 ( & ( V_49 [ V_41 ] ) , 1 , V_50 , V_54 ) ;
else
...
int F_16 ( unsigned char * V_62 , int V_63 , unsigned int V_38 , T_3 * V_64 )
{
...
V_26 = F_19 ( ( unsigned char * ) V_59 , 45 , V_60 ) ;
...
V_59 [ V_68 + 1 ] = '\0' ;
V_59 [ V_68 + 2 ] = '\0' ;
V_26 = F_19 ( V_59 , V_68 , V_60 ) ;
fwrite ( V_60 , 1 , ( unsigned int ) V_26 , V_64 ) ;
}
fwrite ( V_70 , 1 , strlen ( V_70 ) , V_64 ) ;
}
int F_18 ( unsigned char * V_9 , int V_63 , unsigned int V_38 , T_3 * V_64 )
{
int V_3 , V_26 , V_71 ;
static int V_72 = 0 ;
static int V_73 = 0 ;
...
if ( strncmp ( ( char * ) V_60 , L_17 , 6 ) == 0 ) break;
}
V_67 = 0 ;
}
if ( V_72 ) return ( 0 ) ;
