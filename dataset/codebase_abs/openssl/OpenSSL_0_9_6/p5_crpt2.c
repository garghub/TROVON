...
unsigned char * V_3 , int V_4 , int V_5 ,
...
int F_10 ( T_2 * V_19 , const char * V_1 , int V_2 ,
T_3 * V_20 , T_4 * V_21 , T_5 * V_22 ,
int V_23 )
{
unsigned char * V_24 , * V_3 , V_25 [ V_26 ] ;
int V_4 , V_6 , V_5 , V_27 ;
T_6 * V_28 = NULL ;
const T_4 * V_29 ;
T_7 * V_30 = NULL ;
V_24 = V_20 -> V_31 . V_32 -> V_33 ;
V_27 = V_20 -> V_31 . V_32 -> V_34 ;
if( ! V_20 || ( V_20 -> type != V_35 ) ||
! ( V_28 = F_11 ( NULL , & V_24 , V_27 ) ) ) {
F_12 ( V_36 , V_37 ) ;
return 0 ;
}
if( F_13 ( V_28 -> V_38 -> V_39 ) != V_40 ) {
F_12 ( V_36 ,
V_41 ) ;
goto V_42;
}
V_29 = F_14 (
F_15 ( F_13 ( V_28 -> V_43 -> V_39 ) ) ) ;
if( ! V_29 ) {
F_12 ( V_36 ,
V_44 ) ;
goto V_42;
}
F_16 ( V_19 , V_29 , NULL , NULL , V_23 ) ;
if( F_17 ( V_19 , V_28 -> V_43 -> V_45 ) < 0 ) {
F_12 ( V_36 ,
V_46 ) ;
goto V_42;
}
V_6 = F_18 ( V_19 ) ;
V_24 = V_28 -> V_38 -> V_45 -> V_31 . V_32 -> V_33 ;
V_27 = V_28 -> V_38 -> V_45 -> V_31 . V_32 -> V_34 ;
if( ! V_28 -> V_38 -> V_45 ||
( V_28 -> V_38 -> V_45 -> type != V_35 ) ||
! ( V_30 = F_19 ( NULL , & V_24 , V_27 ) ) ) {
F_12 ( V_36 , V_37 ) ;
goto V_42;
}
F_20 ( V_28 ) ;
V_28 = NULL ;
if( V_30 -> V_47 && ( F_21 ( V_30 -> V_47 ) != V_6 ) ) {
F_12 ( V_36 ,
V_48 ) ;
goto V_42;
}
if( V_30 -> V_49 && ( F_13 ( V_30 -> V_49 -> V_39 ) != V_50 ) ) {
F_12 ( V_36 , V_51 ) ;
goto V_42;
}
...
V_5 = F_21 ( V_30 -> V_5 ) ;
F_1 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_6 , V_25 ) ;
F_16 ( V_19 , NULL , V_25 , NULL , V_23 ) ;
memset ( V_25 , 0 , V_6 ) ;
F_22 ( V_30 ) ;
return 1 ;
V_42:
...
static void F_9 ( const unsigned char * V_10 , int V_55 )
{
