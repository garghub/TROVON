...
V_44 [ V_45 ] = 0 ;
V_47 = V_12 - V_45 ;
V_46 = V_11 - F_7 ( V_12 , V_45 ) - ( V_42 ? 1 : 0 ) ;
if ( V_47 < 0 )
V_47 = 0 ;
if ( V_46 < 0 )
V_46 = 0 ;
...
int F_13 ( T_5 * V_58 , const char * V_6 , ... )
{
T_2 args ;
int V_59 ;
va_start ( args , V_6 ) ;
V_59 = F_14 ( V_58 , V_6 , args ) ;
va_end ( args ) ;
return ( V_59 ) ;
}
int F_14 ( T_5 * V_58 , const char * V_6 , T_2 args )
{
int V_59 ;
T_1 V_4 ;
T_6 char V_60 [ 1024 * 10 ] ;
char * V_61 = V_60 ;
...
if ( V_63 )
{
V_59 = F_16 ( V_58 , V_63 , ( int ) V_4 ) ;
F_17 ( V_63 ) ;
}
else
{
V_59 = F_16 ( V_58 , V_60 , ( int ) V_4 ) ;
}
F_18 () ;
return ( V_59 ) ;
}
int F_19 ( char * V_65 , T_1 V_66 , const char * V_6 , ... )
{
T_2 args ;
int V_59 ;
va_start ( args , V_6 ) ;
V_59 = F_20 ( V_65 , V_66 , V_6 , args ) ;
va_end ( args ) ;
return ( V_59 ) ;
}
int F_20 ( char * V_65 , T_1 V_66 , const char * V_6 , T_2 args )
{
T_1 V_4 ;
int V_5 ;
