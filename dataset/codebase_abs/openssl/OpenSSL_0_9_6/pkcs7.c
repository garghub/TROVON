...
{
case V_31 :
V_28 = V_3 -> V_32 . V_33 -> V_34 ;
V_30 = V_3 -> V_32 . V_33 -> V_35 ;
break;
case V_36 :
V_28 = V_3 -> V_32 . V_37 -> V_34 ;
...
{
V_27 * V_38 ;
for ( V_4 = 0 ; V_4 < F_18 ( V_28 ) ; V_4 ++ )
{
V_38 = F_19 ( V_28 , V_4 ) ;
if( V_14 ) F_20 ( V_7 , V_38 ) ;
else F_21 ( V_7 , V_38 ) ;
if( ! V_15 ) F_22 ( V_7 , V_38 ) ;
F_23 ( V_7 , L_20 ) ;
}
}
if ( V_30 != NULL )
{
V_29 * V_35 ;
for ( V_4 = 0 ; V_4 < F_24 ( V_30 ) ; V_4 ++ )
{
V_35 = F_25 ( V_30 , V_4 ) ;
F_26 ( V_7 , V_35 ) ;
if( ! V_15 ) F_27 ( V_7 , V_35 ) ;
F_23 ( V_7 , L_20 ) ;
}
}
V_16 = 0 ;
