...
#ifdef F_2
struct V_13 { int V_14 : 32 ; int V_15 : 32 ; } * V_16 ;
#else
T_1 * V_16 ;
#endif
if ( V_4 < 1 ) V_4 = 1 ;
...
V_16 = ( T_1 * ) & ( V_2 [ 0 ] ) [ 0 ] ;
#endif
V_6 = F_3 ( ( * V_5 ) [ 0 ] ) | F_4 ( ( * V_5 ) [ 1 ] ) | F_5 ( ( * V_5 ) [ 2 ] ) | F_6 ( ( * V_5 ) [ 3 ] ) ;
V_7 = F_3 ( ( * V_5 ) [ 4 ] ) | F_4 ( ( * V_5 ) [ 5 ] ) | F_5 ( ( * V_5 ) [ 6 ] ) | F_6 ( ( * V_5 ) [ 7 ] ) ;
...
V_7 = ( ( V_8 * ( ( V_9 + V_17 ) & 0xffffffffL ) ) & 0xffffffffL ) % 0x7fffffffL ;
}
if ( V_16 != NULL )
{
#ifdef F_2
