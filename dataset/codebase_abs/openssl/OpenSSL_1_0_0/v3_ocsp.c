...
if ( V_5 -> V_6 )
{
if ( F_2 ( V_3 , L_1 , V_4 , L_2 ) <= 0 ) goto V_7;
if ( ! F_3 ( V_3 , ( V_8 * ) V_5 -> V_6 ) ) goto V_7;
if ( F_4 ( V_3 , L_3 , 1 ) <= 0 ) goto V_7;
}
if ( V_5 -> V_9 )
{
if ( F_2 ( V_3 , L_4 , V_4 , L_2 ) <= 0 ) goto V_7;
if ( F_5 ( V_3 , V_5 -> V_9 ) <= 0 ) goto V_7;
if ( F_4 ( V_3 , L_3 , 1 ) <= 0 ) goto V_7;
}
if ( V_5 -> V_10 )
{
if ( F_2 ( V_3 , L_5 , V_4 , L_2 ) <= 0 ) goto V_7;
...
T_2 * V_3 , int V_4 )
{
if ( F_2 ( V_3 , L_6 , V_4 , L_2 ) <= 0 ) return 0 ;
...
static void * F_21 ( const T_1 * V_1 , T_5 * V_25 ,
const char * V_26 )
{
return F_22 () ;
}
