...
if ( V_34 )
{
if ( ! F_26 ( V_2 , V_20 , V_21 , V_4 , V_18 ) )
{
V_17 = V_38 ;
goto V_31;
}
...
if ( ( V_19 = F_28 ( V_2 ) ) == NULL )
{
V_17 = V_38 ;
goto V_31;
}
if ( ! F_29 ( V_2 , V_23 , NULL ) ||
! F_30 ( V_2 , V_24 , NULL ) )
{
V_17 = V_38 ;
goto V_31;
...
V_15 = ( T_6 ) F_33 ( V_20 ) ;
if ( V_15 < ( V_16 = ( T_6 ) F_33 ( V_21 ) ) )
V_15 = V_16 ;
if ( V_15 < ( V_16 = ( T_6 ) F_33 ( V_4 ) ) )
V_15 = V_16 ;
if ( V_15 < ( V_16 = ( T_6 ) F_33 ( V_22 ) ) )
V_15 = V_16 ;
if ( V_15 < ( V_16 = ( T_6 ) F_33 ( V_23 ) ) )
V_15 = V_16 ;
if ( V_15 < ( V_16 = ( T_6 ) F_33 ( V_24 ) ) )
V_15 = V_16 ;
if ( ( V_25 = F_34 ( V_2 ) ) != NULL )
V_26 = F_35 ( V_2 ) ;
V_15 += 10 ;
if ( ( V_14 = F_36 ( V_15 ) ) == NULL )
{
V_17 = V_32 ;
goto V_31;
}
...
F_22 ( V_39 ) ) <= 0 )
goto V_31;
if ( ( V_20 != NULL ) && ! F_38 ( V_12 , L_8 , V_20 , V_14 ,
V_3 ) )
goto V_31;
}
else
{
if ( ( V_20 != NULL ) && ! F_38 ( V_12 , L_9 , V_20 , V_14 , V_3 ) )
goto V_31;
}
if ( ( V_21 != NULL ) && ! F_38 ( V_12 , L_10 , V_21 , V_14 , V_3 ) )
goto V_31;
if ( ( V_4 != NULL ) && ! F_38 ( V_12 , L_11 , V_4 , V_14 , V_3 ) )
goto V_31;
if ( V_35 == V_40 )
{
if ( ( V_22 != NULL ) && ! F_38 ( V_12 , V_27 , V_22 ,
V_14 , V_3 ) )
goto V_31;
}
else if ( V_35 == V_41 )
{
if ( ( V_22 != NULL ) && ! F_38 ( V_12 , V_28 , V_22 ,
V_14 , V_3 ) )
goto V_31;
}
else
{
if ( ( V_22 != NULL ) && ! F_38 ( V_12 , V_29 , V_22 ,
V_14 , V_3 ) )
goto V_31;
}
if ( ( V_23 != NULL ) && ! F_38 ( V_12 , L_12 , V_23 ,
V_14 , V_3 ) ) goto V_31;
if ( ( V_24 != NULL ) && ! F_38 ( V_12 , L_13 , V_24 ,
V_14 , V_3 ) ) goto V_31;
if ( V_25 && ! F_39 ( V_12 , L_14 , V_25 , V_26 , V_3 ) )
goto V_31;
}
V_5 = 1 ;
V_31:
...
static int F_39 ( T_3 * V_1 , const char * V_43 , const unsigned char * V_44 ,
T_6 V_45 , int V_3 )
{
T_6 V_16 ;
char V_46 [ 128 ] ;
