...
static int F_20 ( const T_1 * V_1 , T_2 * V_37 ,
const T_2 * V_38 , const T_2 * V_19 ,
const T_2 * V_39 , T_4 * V_11 ,
T_5 * V_40 )
{
if ( V_38 -> V_41 == 1 && ( ( V_1 -> V_15 & V_23 ) != 0 ) )
{
T_6 V_42 = V_38 -> V_43 [ 0 ] ;
return F_21 ( V_37 , V_42 , V_19 , V_39 , V_11 , V_40 ) ;
}
else
return F_22 ( V_37 , V_38 , V_19 , V_39 , V_11 , V_40 ) ;
}
