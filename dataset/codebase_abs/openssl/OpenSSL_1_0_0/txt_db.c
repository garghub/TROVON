...
{
V_16 -> V_21 [ V_12 - 1 ] = '\0' ;
if ( ! ( V_13 = F_4 ( V_8 + V_12 ) ) ) goto V_17;
V_12 = 0 ;
}
V_15 = ( char * * ) V_13 ;
V_13 += V_8 ;
...
fprintf ( V_24 , L_1 , V_6 , V_2 , V_9 , V_14 ) ;
#endif
V_4 = 2 ;
goto V_17;
}
...
T_3 * F_13 ( T_1 * V_25 , int V_26 , T_3 * V_27 )
{
T_3 * V_3 ;
F_14 ( T_3 ) * V_28 ;
if ( V_26 >= V_25 -> V_18 )
...
if ( ( V_20 != NULL ) && ( V_20 ( V_35 ) == 0 ) ) continue;
...
if ( V_25 -> V_19 [ V_32 ] != NULL ) F_22 ( V_25 -> V_19 [ V_32 ] ) ;
V_25 -> V_19 [ V_32 ] = V_26 ;
V_25 -> V_20 [ V_32 ] = V_20 ;
return ( 1 ) ;
}
...
if ( ! F_6 ( V_16 , ( int ) ( V_43 * 2 + V_42 ) ) ) goto V_17;
V_13 = V_16 -> V_21 ;
for ( V_41 = 0 ; V_41 < V_42 ; V_41 ++ )
{
V_14 = V_15 [ V_41 ] ;
...
{
if ( ( V_25 -> V_20 [ V_7 ] != NULL ) &&
( V_25 -> V_20 [ V_7 ] ( V_45 ) == 0 ) ) continue;
...
if ( V_25 -> V_19 [ V_7 ] != NULL ) F_22 ( V_25 -> V_19 [ V_7 ] ) ;
F_12 ( V_25 -> V_19 ) ;
}
if ( V_25 -> V_20 != NULL )
F_12 ( V_25 -> V_20 ) ;
