...
int V_97 = 0 ;
int V_37 ;
T_17 V_135 , * V_136 = & V_135 ;
F_44 ( & V_135 ) ;
if( ! F_39 ( V_136 , V_112 -> V_76 -> V_89 ) ) {
F_31 ( V_137 , V_90 ) ;
goto V_41;
}
...
F_31 ( V_137 , V_71 ) ;
V_105 = F_53 () ;
V_97 = V_105 -> V_138 ( V_122 , V_132 , V_133 , V_112 ) ;
goto V_41;
}
if ( V_65 ( V_37 , 0 ,
( unsigned char * ) V_122 , V_126 ,
...
( unsigned char * ) V_112 -> V_98 -> V_91 , F_37 ( V_112 -> V_98 ) ,
( unsigned char * ) V_112 -> V_130 -> V_91 , F_37 ( V_112 -> V_130 ) ,
( unsigned char * ) V_112 -> V_139 -> V_91 , F_37 ( V_112 -> V_139 ) ,
...
static int F_57 ( unsigned char * V_140 , const T_17 * V_139 , T_22 * V_121 )
{
int V_20 = - 1 ,
V_141 ,
V_37 ;
V_141 = F_37 ( V_121 -> V_76 ) ;
if ( ( V_37 = V_58 ( V_69 ) ) <= 0 )
{
const T_3 * V_105 ;
F_31 ( V_142 , V_71 ) ;
V_105 = F_17 () ;
V_20 = V_105 -> V_19 ( V_140 , V_139 , V_121 ) ;
goto V_41;
}
if ( V_61 ( V_37 ,
( unsigned char * ) V_121 -> V_131 -> V_91 , F_37 ( V_121 -> V_131 ) ,
( unsigned char * ) V_139 -> V_91 , F_37 ( V_139 ) ,
...
V_145 = F_37 ( V_121 -> V_76 ) ;
if( F_39 ( V_131 , V_121 -> V_76 -> V_89 ) == NULL ) goto V_41;
do
...
if( F_39 ( V_139 , V_121 -> V_76 -> V_89 ) == NULL ) goto V_41;
if( V_139 == NULL ) goto V_41;
}
else
{
V_139 = V_121 -> V_139 ;
...
if ( V_60 ( V_37 ,
( unsigned char * ) V_131 -> V_91 , & V_145 ,
( unsigned char * ) V_139 -> V_91 , & V_144 ,
...
V_59 ( V_37 ) ;
V_121 -> V_139 = V_139 ;
V_121 -> V_139 -> V_89 = ( V_144 + V_93 - 1 ) / V_93 ;
V_121 -> V_131 = V_131 ;
V_121 -> V_131 -> V_89 = ( V_145 + V_93 - 1 ) / V_93 ;
V_20 = 1 ;
V_41:
return V_20 ;
}
static int F_61 ( unsigned char * V_147 ,
int V_148 )
{
int V_20 = 0 ,
V_37 ;
...
V_148 = V_57 ( V_148 ) ;
V_105 = F_62 () ;
V_105 -> V_150 ( V_147 , V_148 ) ;
V_20 = V_105 -> V_151 ( V_147 , V_148 ) ;
goto V_41;
}
V_148 *= 8 ;
if ( V_67 ( V_37 ,
...
static int F_64 ( T_1 * V_1 , const char * V_153 )
{
if( V_153 && ( strcmp ( V_153 , V_4 ) != 0 ) )
return 0 ;
if( ! F_1 ( V_1 ) )
return 0 ;
return 1 ;
