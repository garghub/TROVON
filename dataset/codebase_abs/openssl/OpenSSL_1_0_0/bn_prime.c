...
int F_15 ( const T_2 * V_2 , int V_19 , T_3 * V_22 , T_1 * V_1 )
{
...
{
T_2 * V_13 ;
if ( ( V_13 = F_6 ( V_18 ) ) == NULL ) goto V_20;
F_22 ( V_13 , V_2 ) ;
V_13 -> V_33 = 0 ;
V_29 = V_13 ;
}
...
const T_2 * V_36 , int V_24 , T_3 * V_18 , T_4 * V_28 )
{
...
{
V_39 += 2 ;
if ( V_39 > V_40 ) goto V_41;
goto V_21;
}
}
if ( ! F_30 ( V_37 , V_39 ) ) return ( 0 ) ;
F_14 ( V_37 ) ;
return ( 1 ) ;
}
...
T_2 * V_43 ;
F_5 ( V_18 ) ;
if ( ( V_43 = F_6 ( V_18 ) ) == NULL ) goto V_20;
if ( ! F_36 ( V_37 , V_9 , 0 , 1 ) ) goto V_20;
if ( ! F_37 ( V_43 , V_37 , V_11 , V_18 ) ) goto V_20;
if ( ! F_38 ( V_37 , V_37 , V_43 ) ) goto V_20;
if ( V_12 == NULL )
{ if ( ! F_30 ( V_37 , 1 ) ) goto V_20; }
else
{ if ( ! F_39 ( V_37 , V_37 , V_12 ) ) goto V_20; }
V_21: for ( V_15 = 1 ; V_15 < V_31 ; V_15 ++ )
{
if ( F_21 ( V_37 , ( T_6 ) V_32 [ V_15 ] ) <= 1 )
{
if ( ! F_39 ( V_37 , V_37 , V_11 ) ) goto V_20;
goto V_21;
}
}
V_8 = 1 ;
...
V_47 = F_6 ( V_18 ) ;
V_46 = F_6 ( V_18 ) ;
if ( V_46 == NULL ) goto V_20;
if ( ! F_11 ( V_46 , V_45 ) ) goto V_20;
if ( ! F_36 ( V_47 , V_9 , 0 , 1 ) ) goto V_20;
if ( ! F_37 ( V_43 , V_47 , V_46 , V_18 ) ) goto V_20;
if ( ! F_38 ( V_47 , V_47 , V_43 ) ) goto V_20;
if ( V_12 == NULL )
{ if ( ! F_30 ( V_47 , 1 ) ) goto V_20; }
else
{
if ( ! F_11 ( V_43 , V_12 ) ) goto V_20;
if ( ! F_39 ( V_47 , V_47 , V_43 ) ) goto V_20;
}
if ( ! F_40 ( V_44 , V_47 ) ) goto V_20;
if ( ! F_30 ( V_44 , 1 ) ) goto V_20;
V_21: for ( V_15 = 1 ; V_15 < V_31 ; V_15 ++ )
{
if ( ( F_21 ( V_44 , ( T_6 ) V_32 [ V_15 ] ) == 0 ) ||
( F_21 ( V_47 , ( T_6 ) V_32 [ V_15 ] ) == 0 ) )
{
if ( ! F_39 ( V_44 , V_44 , V_45 ) ) goto V_20;
if ( ! F_39 ( V_47 , V_47 , V_46 ) ) goto V_20;
goto V_21;
}
}
V_8 = 1 ;
