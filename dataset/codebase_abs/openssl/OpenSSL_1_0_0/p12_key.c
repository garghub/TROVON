...
if( V_2 ) V_21 = V_27 * ( ( V_2 + V_27 - 1 ) / V_27 ) ;
else V_21 = 0 ;
V_22 = V_20 + V_21 ;
V_17 = F_12 ( V_22 ) ;
V_28 = F_13 () ;
...
for ( V_24 = 0 ; V_24 < V_27 ; V_24 ++ ) V_16 [ V_24 ] = V_5 ;
V_18 = V_17 ;
for ( V_24 = 0 ; V_24 < V_20 ; V_24 ++ ) * V_18 ++ = V_3 [ V_24 % V_4 ] ;
for ( V_24 = 0 ; V_24 < V_21 ; V_24 ++ ) * V_18 ++ = V_1 [ V_24 % V_2 ] ;
for (; ; ) {
F_14 ( & V_30 , V_9 , NULL ) ;
F_15 ( & V_30 , V_16 , V_27 ) ;
F_15 ( & V_30 , V_17 , V_22 ) ;
...
V_7 -= V_26 ;
V_8 += V_26 ;
for ( V_25 = 0 ; V_25 < V_27 ; V_25 ++ ) V_15 [ V_25 ] = V_19 [ V_25 % V_26 ] ;
F_20 ( V_15 , V_27 , V_29 ) ;
F_21 ( V_29 , 1 ) ;
for ( V_25 = 0 ; V_25 < V_22 ; V_25 += V_27 ) {
F_20 ( V_17 + V_25 , V_27 , V_28 ) ;
F_22 ( V_28 , V_28 , V_29 ) ;
F_23 ( V_28 , V_15 ) ;
V_23 = F_24 ( V_28 ) ;
if ( V_23 > V_27 ) {
...
F_23 ( V_28 , V_17 + V_25 + V_27 - V_23 ) ;
#endif
} else F_23 ( V_28 , V_17 + V_25 ) ;
}
}
}
void F_9 ( unsigned char * V_18 , int V_35 )
{
for (; V_35 -- ; V_18 ++ ) fprintf ( V_33 , L_6 , * V_18 ) ;
fprintf ( V_33 , L_7 ) ;
}
