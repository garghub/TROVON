...
|| memcmp ( V_4 , V_1 -> V_4 -> V_19 -> V_29 -> V_17 , V_5 ) ) return 0 ;
return 1 ;
}
...
unsigned int V_5 ;
if ( ! V_6 ) V_6 = F_15 () ;
if ( F_16 ( V_1 , V_12 , V_10 , V_11 , V_6 ) ==
V_30 ) {
F_3 ( V_31 , V_32 ) ;
return 0 ;
}
...
else memcpy ( V_1 -> V_4 -> V_10 -> V_17 , V_10 , V_11 ) ;
