...
V_19 = 0 ;
while( V_21 != V_22 ) {
if( V_21 == V_2 && V_5 & V_23 ) V_20 = V_24 ;
else V_20 = 0 ;
switch( type & V_25 ) {
case 4 :
...
if ( V_21 == V_22 && V_5 & V_23 ) V_20 = V_26 ;
if( type & V_27 ) {
unsigned char V_28 [ 6 ] ;
int V_29 ;
V_29 = F_9 ( V_28 , sizeof V_28 , V_4 ) ;
for( V_18 = 0 ; V_18 < V_29 ; V_18 ++ ) {
V_3 = F_4 ( V_28 [ V_18 ] , ( unsigned char ) ( V_5 | V_20 ) , V_17 , V_7 , V_1 ) ;
if( V_3 < 0 ) return - 1 ;
V_19 += V_3 ;
}
} else {
...
while( V_21 != V_22 ) {
V_31 [ 0 ] = V_30 [ * V_21 >> 4 ] ;
V_31 [ 1 ] = V_30 [ * V_21 & 0xf ] ;
if( ! V_7 ( V_1 , V_31 , 2 ) ) return - 1 ;
V_21 ++ ;
}
}
return V_16 << 1 ;
}
static int F_11 ( unsigned long V_32 , T_1 * V_7 , void * V_1 , T_2 * V_33 )
{
T_3 V_34 ;
unsigned char * V_35 , * V_21 ;
int V_19 , V_36 ;
if( ! V_7 ( V_1 , L_6 , 1 ) ) return - 1 ;
if( ! ( V_32 & V_37 ) ) {
V_19 = F_10 ( V_7 , V_1 , V_33 -> V_38 , V_33 -> V_39 ) ;
if( V_19 < 0 ) return - 1 ;
return V_19 + 1 ;
}
V_34 . type = V_33 -> type ;
...
V_21 = V_35 ;
F_12 ( & V_34 , & V_21 ) ;
V_19 = F_10 ( V_7 , V_1 , V_35 , V_36 ) ;
F_14 ( V_35 ) ;
if( V_19 < 0 ) return - 1 ;
return V_19 + 1 ;
}
static int F_15 ( T_1 * V_7 , void * V_1 , unsigned long V_32 , T_2 * V_33 )
{
int V_19 , V_3 ;
int type ;
char V_17 ;
...
V_44 = F_16 ( type ) ;
V_19 += strlen ( V_44 ) ;
if( ! V_7 ( V_1 , V_44 , V_19 ) || ! V_7 ( V_1 , L_7 , 1 ) ) return - 1 ;
V_19 ++ ;
}
if( V_32 & V_45 ) type = - 1 ;
...
V_3 = F_7 ( V_33 -> V_38 , V_33 -> V_39 , type , V_5 , & V_17 , V_7 , NULL ) ;
if( V_3 < 0 ) return - 1 ;
V_19 += V_3 ;
if( V_17 ) V_19 += 2 ;
if( ! V_1 ) return V_19 ;
if( V_17 && ! V_7 ( V_1 , L_8 , 1 ) ) return - 1 ;
if( F_7 ( V_33 -> V_38 , V_33 -> V_39 , type , V_5 , NULL , V_7 , V_1 ) < 0 )
return - 1 ;
if( V_17 && ! V_7 ( V_1 , L_8 , 1 ) ) return - 1 ;
return V_19 ;
}
...
if( V_5 & V_74 )
V_58 = F_20 ( V_51 , V_53 - V_18 - 1 ) ;
else V_58 = F_20 ( V_51 , V_18 ) ;
if( V_52 != - 1 ) {
if( V_52 == V_58 -> V_75 ) {
...
V_3 = F_15 ( V_7 , V_1 , V_5 | V_20 , V_57 ) ;
if( V_3 < 0 ) return - 1 ;
V_19 += V_3 ;
}
return V_19 ;
...
int F_32 ( T_7 * V_87 , T_2 * V_33 , unsigned long V_5 )
{
return F_15 ( F_1 , V_87 , V_5 , V_33 ) ;
}
int F_33 ( T_8 * V_90 , T_2 * V_33 , unsigned long V_5 )
{
return F_15 ( F_3 , V_90 , V_5 , V_33 ) ;
}
...
V_96 |= V_97 ;
V_95 . V_38 = NULL ;
V_92 = F_35 ( & V_33 , V_94 -> V_38 , V_94 -> V_39 , V_96 , V_98 ) ;
