...
unsigned char * V_21 , int V_4 , int V_15 , int V_20 )
{
T_4 * V_12 ;
int V_16 ;
...
const unsigned char * V_21 , int V_4 , int V_15 , int V_20 )
{
T_4 * V_12 ;
int V_16 ;
...
T_4 * F_22 ( T_4 * * V_12 ,
const char * V_22 , int type , const unsigned char * V_21 , int V_4 )
{
T_2 * V_5 ;
T_4 * V_28 ;
V_5 = F_26 ( V_22 , 0 ) ;
...
int type , unsigned char * V_21 , int V_4 )
{
T_2 * V_5 ;
T_4 * V_28 ;
V_5 = F_2 ( V_2 ) ;
...
T_4 * F_16 ( T_4 * * V_12 ,
T_2 * V_5 , int type , const unsigned char * V_21 , int V_4 )
{
T_4 * V_16 ;
...
{
int V_6 ;
if ( ( V_12 == NULL ) || ( ( V_21 == NULL ) && ( V_4 != 0 ) ) ) return ( 0 ) ;
if( ( type > 0 ) && ( type & V_35 ) )
return F_33 ( & V_12 -> V_36 , V_21 ,
V_4 , type ,
F_34 ( V_12 -> V_14 ) ) ? 1 : 0 ;
if ( V_4 < 0 ) V_4 = strlen ( ( const char * ) V_21 ) ;
