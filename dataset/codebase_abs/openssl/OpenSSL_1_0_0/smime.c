...
V_31 |= V_85 ;
for ( V_83 = 0 ; V_83 < F_57 ( V_13 ) ; V_83 ++ )
{
V_10 = F_58 ( V_13 , V_83 ) ;
V_16 = F_58 ( V_14 , V_83 ) ;
...
if ( V_4 == V_57 )
{
if ( ! F_63 ( V_19 , V_24 , V_22 , V_28 , V_31 ) )
{
F_28 ( V_51 , L_124 ) ;
goto V_55;
}
...
{
F_1 ( T_5 ) * V_86 ;
if ( F_64 ( V_19 , V_26 , V_20 , V_29 , V_28 , V_31 ) )
F_28 ( V_51 , L_125 ) ;
else
{
F_28 ( V_51 , L_126 ) ;
...
{
if ( V_4 == V_59 )
F_69 ( V_28 , V_19 , V_29 , V_31 ) ;
else
F_69 ( V_28 , V_19 , V_27 , V_31 ) ;
}
else if ( V_46 == V_48 )
F_70 ( V_28 , V_19 , V_27 , V_31 ) ;
else if ( V_46 == V_77 )
F_71 ( V_28 , V_19 , V_27 , V_31 ) ;
else
{
F_28 ( V_51 , L_131 ) ;
goto V_55;
...
static int V_81 ( int V_87 , T_10 * V_88 )
{
int error ;
error = F_80 ( V_88 ) ;
if ( ( error != V_89 )
