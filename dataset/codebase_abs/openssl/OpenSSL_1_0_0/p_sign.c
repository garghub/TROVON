...
if ( F_12 ( V_17 ) <= 0 )
goto V_19;
if ( F_13 ( V_17 , V_1 -> V_14 ) <= 0 )
goto V_19;
if ( F_14 ( V_17 , V_4 , & V_18 , V_7 , V_9 ) <= 0 )
goto V_19;
* V_5 = V_18 ;
V_10 = 1 ;
V_19:
...
if ( V_1 -> V_14 -> V_23 == NULL )
{
F_16 ( V_21 , V_24 ) ;
return ( 0 ) ;
}
return ( V_1 -> V_14 -> V_23 ( V_1 -> V_14 -> type , V_7 , V_9 , V_4 , V_5 ,
V_6 -> V_6 . V_25 ) ) ;
}
