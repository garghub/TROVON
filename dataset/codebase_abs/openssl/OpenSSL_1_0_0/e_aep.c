...
V_102 = 0 ;
#endif
for ( V_127 = 0 ; V_127 < V_138 ; V_127 ++ )
{
V_139 [ V_127 ] . V_140 = V_141 ;
V_139 [ V_127 ] . V_142 = 0 ;
}
V_65 = V_61 ( V_126 ) ;
if ( V_65 != V_67 )
...
for ( V_127 = 0 ; V_127 < V_138 ; V_127 ++ )
{
if ( V_139 [ V_127 ] . V_140 == V_144 )
{
V_139 [ V_127 ] . V_140 = V_143 ;
* V_126 = V_139 [ V_127 ] . V_142 ;
goto V_123;
}
}
for ( V_127 = 0 ; V_127 < V_138 ; V_127 ++ )
{
if ( V_139 [ V_127 ] . V_140 == V_141 )
{
V_65 = V_61 ( V_126 ) ;
if ( V_65 != V_67 )
{
...
for( V_127 = 0 ; V_127 < V_138 ; V_127 ++ )
{
if ( V_139 [ V_127 ] . V_142 == V_85 )
{
V_139 [ V_127 ] . V_140 = V_144 ;
break;
}
}
F_50 ( V_129 ) ;
...
static T_13 F_39 ( int V_146 , int * V_64 )
{
int V_127 ;
T_13 V_65 = V_67 ;
* V_64 = 0 ;
...
static T_13 V_134 ( T_23 V_147 , T_24 * V_148 )
{
T_14 * V_149 ;
V_149 = ( T_14 * ) V_147 ;
#ifdef F_63
...
static T_13 V_135 ( T_23 V_147 , T_24 V_148 ,
unsigned char * V_151 )
{
T_14 * V_149 ;
#ifndef F_63
...
V_149 = ( T_14 * ) V_147 ;
#ifdef F_63
memcpy ( V_151 , V_149 -> V_114 , V_148 ) ;
#else
for( V_73 = 0 ; V_73 < V_149 -> V_150 ; V_73 ++ )
{
V_99 = ( unsigned char * ) & V_149 -> V_114 [ V_73 ] ;
* ( ( T_24 * ) V_151 ) = ( T_24 )
...
static T_13 V_136 ( void * V_147 , T_24 V_148 ,
unsigned char * V_151 )
{
T_14 * V_149 ;
#ifndef F_63
...
#endif
V_149 = ( T_14 * ) V_147 ;
F_64 ( V_149 , ( int ) ( V_148 << 3 ) ) ;
#ifdef F_63
V_149 -> V_150 = V_148 >> 3 ;
if( ( V_148 & 7 ) != 0 )
V_149 -> V_150 ++ ;
memset ( V_149 -> V_114 , 0 , V_149 -> V_150 << 3 ) ;
memcpy ( V_149 -> V_114 , V_151 , V_148 ) ;
#else
V_149 -> V_150 = V_148 >> 2 ;
for( V_73 = 0 ; V_73 < V_149 -> V_150 ; V_73 ++ )
{
V_149 -> V_114 [ V_73 ] = ( T_24 )
( ( unsigned ) V_151 [ 3 ] << 8 | V_151 [ 2 ] ) << 16 |
( ( unsigned ) V_151 [ 1 ] << 8 | V_151 [ 0 ] ) ;
V_151 += 4 ;
}
#endif
return V_67 ;
