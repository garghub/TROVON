...
#endif
for ( V_4 = 0 ; V_4 < V_7 ; V_4 ++ ) V_6 [ V_4 ] = ( T_5 ) V_5 [ V_4 ] ;
return F_11 ( V_6 ) ;
}
T_1 * F_1 ( void )
{
...
while( V_42 );
if( ! V_36 -> V_49 ) V_36 -> V_44 = NULL ;
if( ! V_36 -> V_47 ) V_36 -> V_46 = NULL ;
if( ! V_36 -> V_50 ) V_36 -> V_48 = NULL ;
if( ! V_36 -> V_52 ) V_36 -> V_51 = NULL ;
return ( V_36 ) ;
}
...
if( V_53 -> V_44 )
{
strcpy ( & V_36 [ V_55 ] , L_4 ) ; V_55 += 2 ;
strncpy ( & V_36 [ V_55 ] , V_53 -> V_44 ,
V_53 -> V_49 ) ; V_55 += V_53 -> V_49 ;
if( V_53 -> V_57 || V_53 -> V_48 || V_53 -> V_51 )
{
V_36 [ V_55 ] = '\\' ; V_55 ++ ;
}
...
{
strncpy ( & V_36 [ V_55 ] , V_53 -> V_46 ,
V_53 -> V_47 ) ; V_55 += V_53 -> V_47 ;
V_36 [ V_55 ] = ':' ; V_55 ++ ;
}
V_41 = V_53 -> V_57 ;
...
+ V_53 -> V_58
- ( V_41 - V_53 -> V_57 ) ;
strncpy ( & V_36 [ V_55 ] , V_41 ,
V_60 - V_41 ) ; V_55 += ( int ) ( V_60 - V_41 ) ;
V_36 [ V_55 ] = '\\' ; V_55 ++ ;
V_41 = V_60 + 1 ;
}
#if 0
...
#endif
strncpy ( & V_36 [ V_55 ] , V_53 -> V_51 ,
V_53 -> V_52 ) ; V_55 += V_53 -> V_52 ;
V_36 [ V_55 ] = '\0' ;
return ( V_36 ) ;
}
static char * F_30 ( T_8 * V_12 , const char * V_61 , const char * V_62 )
{
char * V_63 = NULL ;
...
if ( V_72 == NULL )
{
union { int (* F_33)( void * , char * , int ); void * V_14 ; } V_83 =
{ F_32 } ;
V_72 = V_83 . V_14 ;
}
V_75 = F_34 ( F_35 ( V_84 ) ) ;
...
V_73 , V_74 , NULL , NULL ) ;
# else
V_54 = ( int ) wcslen ( V_78 . V_94 ) ;
if ( V_74 <= 0 ) return V_54 + 1 ;
if ( V_54 >= V_74 ) V_54 = V_74 - 1 ;
