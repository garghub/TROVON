...
T_1 * V_6 = NULL ;
long V_43 = - 1 ;
if ( ! V_4 ) V_4 = getenv ( L_49 ) ;
if ( ! V_4 ) V_4 = getenv ( L_50 ) ;
if ( V_4 &&
( ! ( V_6 = F_24 ( NULL ) ) ||
F_25 ( V_6 , V_4 , & V_43 ) <= 0 ) )
{
...
if ( V_18 != NULL )
{
if ( ( V_48 = F_27 ( V_18 , L_56 ) ) == NULL ) goto V_51;
V_47 = F_32 ( V_48 , NULL ) ;
}
else
{
if ( ! V_12
&& ! ( V_49 = F_33 ( V_11 , L_56 , V_52 ) ) )
goto V_51;
V_47 = F_34 ( V_49 , V_12 , V_13 ,
V_15 , V_16 , V_17 ) ;
}
if ( V_47 == NULL ) goto V_51;
...
T_4 * V_59 = NULL ;
T_10 * V_60 = NULL ;
if ( ! V_13 && ! ( V_13 = F_7 ( L_58 ) ) ) goto V_61;
if ( ! ( V_55 = F_39 () ) ) goto V_61;
if ( ! F_40 ( V_55 , 1 ) ) goto V_61;
if ( ! ( V_57 = F_41 () ) ) goto V_61;
if ( ! ( V_58 = F_42 () ) ) goto V_61;
if ( ! ( V_58 -> V_62 = F_43 ( F_44 ( V_13 ) ) ) ) goto V_61;
if ( ! ( V_58 -> V_63 = F_45 () ) ) goto V_61;
V_58 -> V_63 -> type = V_64 ;
if ( ! F_46 ( V_57 , V_58 ) ) goto V_61;
if ( ( V_56 = F_47 ( V_49 , V_12 , V_13 , & V_11 ) ) == 0 )
goto V_61;
if ( ! F_48 ( V_57 , V_11 , V_56 ) ) goto V_61;
if ( ! F_49 ( V_55 , V_57 ) ) goto V_61;
if ( V_15 && ! ( V_59 = F_22 ( V_15 ) ) ) goto V_61;
if ( V_59 && ! F_50 ( V_55 , V_59 ) ) goto V_61;
if ( ! V_16 && ! ( V_60 = F_51 ( V_65 ) ) ) goto V_61;
if ( V_60 && ! F_52 ( V_55 , V_60 ) ) goto V_61;
if ( ! F_53 ( V_55 , V_17 ) ) goto V_61;
V_3 = 1 ;
V_61:
if ( ! V_3 )
{
...
int V_56 = ( V_73 - 1 ) / 8 + 1 ;
int V_76 ;
if ( V_56 > ( int ) sizeof( V_74 ) ) goto V_61;
if ( F_65 ( V_74 , V_56 ) <= 0 ) goto V_61;
for ( V_76 = 0 ; V_76 < V_56 && ! V_74 [ V_76 ] ; ++ V_76 ) ;
if ( ! ( V_75 = F_66 () ) ) goto V_61;
F_18 ( V_75 -> V_11 ) ;
V_75 -> V_71 = V_56 - V_76 ;
if ( ! ( V_75 -> V_11 = F_59 ( V_75 -> V_71 + 1 ) ) ) goto V_61;
...
{
T_13 * V_81 = F_70 ( V_77 ) ;
if ( ! F_71 ( V_50 , V_81 ) ) goto V_51;
}
else
{
if ( ! F_72 ( V_50 , V_77 ) ) goto V_51;
}
}
else
{
...
{
T_14 * V_82 = F_73 ( V_77 ) ;
if ( ! F_74 ( V_50 , V_82 ) ) goto V_51;
}
else
{
if ( ! F_75 ( V_50 , V_77 ) ) goto V_51;
}
}
V_3 = 1 ;
V_51:
...
T_12 * V_83 = NULL ;
T_15 * V_84 = NULL ;
if ( ! ( V_82 = F_77 ( V_48 , NULL ) ) ) goto V_51;
if ( ! ( V_81 = F_78 ( V_82 ) ) ) goto V_51;
if ( ! ( V_83 = F_79 () ) ) goto V_51;
if ( ! ( V_84 = F_80 () ) ) goto V_51;
if ( ! ( F_81 ( V_84 -> V_85 , V_86 ) ) ) goto V_51;
if ( ! F_82 ( V_83 , V_84 ) ) goto V_51;
F_83 ( V_83 , V_82 , V_81 ) ;
V_82 = NULL ;
V_81 = NULL ;
V_3 = 1 ;
...
if ( ! ( V_5 = F_87 ( V_6 , V_5 ) ) )
goto V_51;
if ( ! ( V_87 = F_88 () ) ) goto V_51;
if ( ! F_89 ( V_6 , V_5 , V_88 , V_87 ) ) goto V_51;
#ifndef F_90
if ( ! F_91 ( V_6 , V_5 , V_30 ) ) goto V_51;
#endif
if ( ! F_92 ( V_6 , V_5 , V_25 , V_87 ) ) goto V_51;
if ( ! F_93 ( V_6 , V_5 , V_26 , V_87 ) ) goto V_51;
if ( ! F_94 ( V_6 , V_5 , V_24 , V_22 , V_87 ) )
goto V_51;
if ( ! F_95 ( V_6 , V_5 , V_15 , V_87 ) ) goto V_51;
if ( ! F_96 ( V_6 , V_5 , V_87 ) ) goto V_51;
if ( ! F_97 ( V_6 , V_5 , V_87 ) ) goto V_51;
if ( ! F_98 ( V_6 , V_5 , V_87 ) ) goto V_51;
if ( ! F_99 ( V_6 , V_5 , V_87 ) )
goto V_51;
if ( ! F_100 ( V_6 , V_5 , V_87 ) ) goto V_51;
if ( ! F_101 ( V_6 , V_5 , V_87 ) ) goto V_51;
if ( ! F_102 ( V_6 , V_5 , V_87 ) ) goto V_51;
...
T_10 * V_91 = NULL ;
T_18 * V_95 = NULL ;
if ( ! ( V_91 = F_66 () ) ) goto V_61;
if ( ! ( V_18 = F_27 ( V_94 , L_55 ) ) )
{
F_30 () ;
F_9 ( V_34 , L_67
L_68 , V_94 ) ;
if ( ! F_81 ( V_91 , 1 ) ) goto V_61;
}
else
{
char V_74 [ 1024 ] ;
...
if ( ! ( V_95 = F_110 ( V_91 , NULL ) ) ) goto V_61;
F_57 ( V_91 ) ;
V_91 = NULL ;
if ( ! F_111 ( V_95 , 1 ) ) goto V_61;
if ( ! ( V_91 = F_112 ( V_95 , NULL ) ) ) goto V_61;
}
V_3 = 1 ;
V_61:
if ( ! V_3 )
...
int V_3 = 0 ;
T_5 * V_19 = NULL ;
if ( ! ( V_19 = F_27 ( V_94 , L_70 ) ) ) goto V_61;
if ( F_114 ( V_19 , V_91 ) <= 0 ) goto V_61;
if ( F_115 ( V_19 , L_71 ) <= 0 ) goto V_61;
V_3 = 1 ;
V_61:
if ( ! V_3 )
F_9 ( V_34 , L_72 ,
...
T_19 * V_96 = NULL ;
int V_3 = 0 ;
if ( ! ( V_48 = F_27 ( V_18 , L_56 ) ) ) goto V_51;
if ( V_31 )
{
if ( ! ( V_82 = F_77 ( V_48 , NULL ) ) ) goto V_51;
}
...
{
if ( ! ( V_77 = F_68 ( V_48 , NULL ) ) ) goto V_51;
}
...
{
if ( ! ( V_89 = F_120 () ) ) goto V_61;
V_89 -> V_98 = V_99 | V_100 ;
if ( V_11 != NULL )
{
V_89 -> V_98 |= V_101 ;
if ( ! ( V_89 -> V_11 = F_27 ( V_11 , L_56 ) ) ) goto V_61;
}
else if ( V_12 != NULL )
{
long V_102 ;
V_89 -> V_98 |= V_103 ;
if ( ! ( V_89 -> V_104 = F_64 ( V_12 ,
& V_102 ) ) )
{
F_9 ( V_34 , L_76 ) ;
goto V_61;
...
{
if ( ! ( V_66 = F_27 ( V_21 , L_56 ) ) ) goto V_61;
if ( ! ( V_97 = F_32 ( V_66 , NULL ) ) ) goto V_61;
if ( ! ( V_89 = F_121 ( V_97 , NULL ) ) ) goto V_61;
}
else
return NULL ;
V_89 -> V_98 |= V_105 ;
if ( ! ( V_89 -> V_106 = F_122 ( V_27 , V_28 ) ) ) goto V_61;
