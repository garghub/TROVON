...
goto V_39;
case V_52 :
if ( V_18 && ! V_18 ( V_53 , V_3 , V_6 , NULL ) )
goto V_54;
if ( ! * V_3 && ! F_10 ( V_3 , V_6 ) )
{
F_7 ( V_37 ,
...
F_13 ( V_3 , V_29 , V_6 ) ;
* V_4 = V_19 ;
if ( V_18 && ! V_18 ( V_57 , V_3 , V_6 , NULL ) )
goto V_54;
return 1 ;
case V_58 :
case V_59 :
...
F_24 ( V_9 -> V_92 ) , V_9 -> V_1 , V_10 , V_11 , V_12 ) ;
if ( ! V_31 )
{
F_7 ( V_89 ,
V_41 ) ;
...
{
V_31 = F_4 ( V_74 , & V_19 , V_5 , F_24 ( V_9 -> V_92 ) ,
- 1 , 0 , V_11 , V_12 ) ;
if ( ! V_31 )
{
F_7 ( V_89 ,
...
V_98 . V_109 = 0 ;
V_98 . V_107 = NULL ;
if ( ! F_28 ( & V_98 , & V_19 , V_95 , V_96 , - 1 , V_42 , 0 ) )
{
V_97 = 1 ;
goto V_39;
}
...
if ( ! F_30 ( V_3 , V_99 , V_5 , V_44 , & V_97 , V_6 ) )
goto V_39;
* V_4 = V_19 ;
V_31 = 1 ;
V_39:
if ( V_97 && V_98 . V_107 ) F_31 ( V_98 . V_107 ) ;
return V_31 ;
}
int F_30 ( T_1 * * V_3 , const unsigned char * V_99 , int V_5 ,
...
V_112 = ( T_11 * ) * V_3 ;
if ( V_44 != V_112 -> type )
F_33 ( V_112 , V_44 , NULL ) ;
V_110 = V_3 ;
V_3 = & V_112 -> V_116 . V_117 ;
}
switch( V_44 )
{
case V_118 :
if ( ! F_34 ( ( V_119 * * ) V_3 , & V_99 , V_5 ) )
goto V_39;
break;
case V_120 :
if ( V_5 )
...
static int F_27 ( const unsigned char * * V_4 , long V_5 , char V_96 )
{
int V_150 ;
long V_95 ;
...
static int F_28 ( T_9 * V_98 , const unsigned char * * V_4 , long V_5 ,
char V_96 , int V_1 , int V_10 , int V_152 )
{
const unsigned char * V_19 , * V_20 ;
long V_95 ;
char V_26 , V_153 ;
...
if ( ! F_9 ( & V_95 , NULL , NULL , & V_153 , & V_26 , & V_19 ,
V_5 , V_1 , V_10 , 0 , NULL ) )
{
F_7 ( V_154 , V_41 ) ;
return 0 ;
...
if ( ! F_28 ( V_98 , & V_19 , V_95 , V_153 , V_1 , V_10 ,
V_152 + 1 ) )
return 0 ;
}
else if ( V_95 && ! F_41 ( V_98 , & V_19 , V_95 ) )
return 0 ;
V_5 -= V_19 - V_20 ;
}
if ( V_96 )
...
static int F_41 ( T_9 * V_98 , const unsigned char * * V_19 , long V_95 )
{
int V_5 ;
if ( V_98 )
{
V_5 = V_98 -> V_108 ;
if ( ! F_29 ( V_98 , V_5 + V_95 ) )
{
F_7 ( V_157 , V_93 ) ;
return 0 ;
}
...
{
V_29 = F_42 ( & V_19 , & V_95 , & V_160 , & V_161 , V_5 ) ;
if ( V_12 )
{
V_12 -> V_31 = V_29 ;
V_12 -> V_95 = V_95 ;
...
V_12 -> V_162 = 1 ;
if ( ! ( V_29 & 0x81 ) && ( ( V_95 + V_12 -> V_163 ) > V_5 ) )
{
F_7 ( V_164 ,
V_165 ) ;
F_26 ( V_12 ) ;
