...
if ( V_9 <= 0 ) goto V_24;
if ( F_16 ( V_14 , V_12 , V_7 ) == NULL ) goto V_24;
...
if ( V_5 -> V_32 & V_33 )
if ( ! F_17 ( & V_5 -> V_34 , V_35 , V_5 -> V_16 , V_15 ) )
goto V_24;
...
static int F_32 ( T_5 * V_43 , int V_38 , T_3 * V_7 ,
T_3 * V_13 , T_4 * V_15 )
{
if ( V_38 )
...
int V_8 ;
F_24 ( V_44 ) ;
V_8 = F_33 ( V_7 , V_13 , V_43 , V_15 ) ;
F_25 ( V_44 ) ;
return V_8 ;
}
}
static int F_34 ( T_5 * V_43 , int V_38 , T_3 * V_7 ,
T_3 * V_13 , T_4 * V_15 )
{
if ( V_38 )
return F_35 ( V_7 , NULL , V_43 , V_15 ) ;
else
{
int V_8 ;
F_26 ( V_44 ) ;
V_8 = F_35 ( V_7 , V_13 , V_43 , V_15 ) ;
F_31 ( V_44 ) ;
return V_8 ;
}
}
...
if ( V_41 != NULL )
if ( ! F_32 ( V_41 , V_47 , V_7 , V_45 , V_15 ) )
goto V_24;
if ( ( V_5 -> V_32 & V_52 ) ||
( ( V_5 -> V_53 != NULL ) &&
( V_5 -> V_54 != NULL ) &&
...
( V_5 -> V_57 != NULL ) ) )
{
if ( ! V_5 -> V_36 -> V_58 ( V_8 , V_7 , V_5 , V_15 ) ) goto V_24;
}
else
{
T_3 V_59 ;
...
if ( V_41 )
if ( ! F_34 ( V_41 , V_47 , V_8 , V_45 , V_15 ) )
goto V_24;
if ( V_6 == V_49 )
{
...
if ( F_16 ( V_3 , ( int ) V_2 , V_7 ) == NULL ) goto V_24;
if ( F_5 ( V_7 , V_5 -> V_16 ) >= 0 )
{
F_4 ( V_63 , V_31 ) ;
goto V_24;
...
if ( F_16 ( V_3 , V_2 , V_7 ) == NULL ) goto V_24;
if ( F_5 ( V_7 , V_5 -> V_16 ) >= 0 )
{
F_4 ( V_66 , V_31 ) ;
goto V_24;
...
if ( V_5 -> V_32 & V_80 )
{
if ( ! F_17 ( & V_5 -> V_81 , V_35 , V_53 , V_15 ) )
goto V_24;
if ( ! F_17 ( & V_5 -> V_82 , V_35 , V_54 , V_15 ) )
goto V_24;
}
}
if ( V_5 -> V_32 & V_33 )
...
V_76 = & V_74 ;
F_40 ( V_76 , V_68 , V_62 ) ;
if ( ! F_52 ( V_69 , V_76 , V_5 -> V_54 , V_15 ) ) goto V_24;
}
else
{
if ( ! F_52 ( V_69 , V_68 , V_5 -> V_54 , V_15 ) ) goto V_24;
}
if ( ! ( V_5 -> V_32 & V_61 ) )
{
V_56 = & V_73 ;
...
V_56 = V_5 -> V_56 ;
if ( ! V_5 -> V_36 -> V_37 ( V_70 , V_69 , V_56 , V_5 -> V_54 , V_15 ,
V_5 -> V_82 ) ) goto V_24;
if ( ! ( V_5 -> V_32 & V_61 ) )
{
V_76 = & V_74 ;
F_40 ( V_76 , V_68 , V_62 ) ;
if ( ! F_52 ( V_69 , V_76 , V_5 -> V_53 , V_15 ) ) goto V_24;
}
else
{
if ( ! F_52 ( V_69 , V_68 , V_5 -> V_53 , V_15 ) ) goto V_24;
}
if ( ! ( V_5 -> V_32 & V_61 ) )
{
V_55 = & V_72 ;
...
V_55 = V_5 -> V_55 ;
if ( ! V_5 -> V_36 -> V_37 ( V_67 , V_69 , V_55 , V_5 -> V_53 , V_15 ,
V_5 -> V_81 ) ) goto V_24;
if ( ! F_41 ( V_67 , V_67 , V_70 ) ) goto V_24;
if ( F_53 ( V_67 ) )
if ( ! F_54 ( V_67 , V_67 , V_5 -> V_53 ) ) goto V_24;
if ( ! F_55 ( V_69 , V_67 , V_5 -> V_57 , V_15 ) ) goto V_24;
if ( ! ( V_5 -> V_32 & V_61 ) )
{
V_77 = & V_75 ;
F_40 ( V_77 , V_69 , V_62 ) ;
...
V_77 = V_69 ;
if ( ! F_52 ( V_67 , V_77 , V_5 -> V_53 , V_15 ) ) goto V_24;
if ( F_53 ( V_67 ) )
if ( ! F_54 ( V_67 , V_67 , V_5 -> V_53 ) ) goto V_24;
if ( ! F_55 ( V_69 , V_67 , V_5 -> V_54 , V_15 ) ) goto V_24;
if ( ! F_54 ( V_67 , V_69 , V_70 ) ) goto V_24;
if ( V_5 -> V_20 && V_5 -> V_16 )
{
if ( ! V_5 -> V_36 -> V_37 ( V_71 , V_67 , V_5 -> V_20 , V_5 -> V_16 , V_15 , V_5 -> V_34 ) ) goto V_24;
if ( ! F_41 ( V_71 , V_71 , V_68 ) ) goto V_24;
if ( ! F_52 ( V_71 , V_71 , V_5 -> V_16 , V_15 ) ) goto V_24;
if ( F_53 ( V_71 ) )
if ( ! F_54 ( V_71 , V_71 , V_5 -> V_16 ) ) goto V_24;
if ( ! F_56 ( V_71 ) )
{
T_3 V_59 ;
T_3 * V_60 = NULL ;
