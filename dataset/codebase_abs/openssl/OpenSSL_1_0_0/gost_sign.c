void F_1 ( const char * V_1 , const unsigned char * V_2 , T_1 V_3 )
{
T_1 V_4 ;
...
T_5 * V_17 = F_7 () ;
F_8 ( V_17 ) ;
if ( F_26 ( V_6 -> V_8 , V_11 -> V_21 ) >= 1 ||
F_26 ( V_6 -> V_7 , V_11 -> V_21 ) >= 1 )
{
F_9 ( V_35 , V_36 ) ;
return 0 ;
}
...
{
T_6 * V_42 = V_43 ;
while ( V_42 -> V_41 != V_44 && V_42 -> V_41 != V_41 ) V_42 ++ ;
if ( V_42 -> V_41 == V_44 )
{
F_9 ( V_45 , V_46 ) ;
return 0 ;
...
if ( V_11 -> V_23 ) { F_19 ( V_11 -> V_23 ) ; }
V_11 -> V_23 = NULL ;
F_32 ( & ( V_11 -> V_23 ) , V_42 -> V_23 ) ;
if ( V_11 -> V_21 ) { F_19 ( V_11 -> V_21 ) ; }
V_11 -> V_21 = NULL ;
F_32 ( & ( V_11 -> V_21 ) , V_42 -> V_21 ) ;
if ( V_11 -> V_22 ) { F_19 ( V_11 -> V_22 ) ; }
V_11 -> V_22 = NULL ;
