...
T_2 * V_2 = NULL ;
T_1 * V_3 = NULL ;
if ( ( V_2 = F_2 ( V_1 , L_1 ) ) == NULL ) goto V_4;
...
T_6 * V_20 = NULL ;
int V_14 = 0 ;
if ( strcmp ( V_6 , L_5 ) == 0 ) return 1 ;
if ( ! ( V_20 = F_13 ( V_6 ) ) ) goto V_17;
if ( strcmp ( V_6 , L_6 ) == 0 )
F_14 ( V_20 , V_21 , 1 , 0 , 0 ) ;
if ( ! F_15 ( V_20 , V_22 ) ) goto V_17;
V_14 = 1 ;
V_17:
if ( ! V_14 )
{
...
if ( ! V_27 ) goto V_4;
if ( ! ( V_28 = F_24 ( V_27 ) ) ) goto V_17;
if ( ! F_25 ( V_13 , V_28 ) ) goto V_17;
V_4:
V_14 = 1 ;
V_17:
F_26 ( V_28 , F_21 ) ;
...
if ( ! ( V_32 = F_28 ( V_30 , V_31 ) ) ) goto V_17;
if ( ! F_29 ( V_13 , V_32 ) ) goto V_17;
V_14 = 1 ;
V_17:
F_30 ( V_32 ) ;
return V_14 ;
...
int F_35 ( T_3 * V_8 , const char * V_9 ,
T_5 * V_13 )
{
int V_14 = 0 ;
int V_37 ;
...
int F_41 ( T_3 * V_8 , const char * V_9 ,
T_5 * V_13 )
{
int V_14 = 0 ;
int V_37 ;
...
{
if ( V_42 -> V_44 ) V_50 = atoi ( V_42 -> V_44 ) ;
}
else if ( strcmp ( V_42 -> V_6 , V_56 ) == 0 )
{
if ( V_42 -> V_44 ) V_51 = atoi ( V_42 -> V_44 ) ;
}
else if ( strcmp ( V_42 -> V_6 , V_57 ) == 0 )
{
if ( V_42 -> V_44 ) V_52 = atoi ( V_42 -> V_44 ) ;
}
else
{
F_6 ( V_9 , V_54 ) ;
...
static int F_49 ( T_3 * V_8 , const char * V_9 , const char * V_61 ,
int V_62 , T_5 * V_13 )
{
