...
{
F_15 ( V_14 ) ;
return ( V_17 == V_24 ) ? V_18 : V_17 - V_24 ;
}
V_25 -= V_18 ;
V_3 -> V_6 += V_18 ;
}
...
static long F_22 ( T_2 * V_14 , int V_26 , T_5 * V_42 )
{
long V_17 = 1 ;
...
{
default:
V_17 = F_23 ( V_14 -> V_19 , V_26 , V_42 ) ;
break;
}
return ( V_17 ) ;
}
void F_24 ( T_2 * V_14 , const T_6 * V_43 , const unsigned char * V_44 ,
const unsigned char * V_18 , int V_45 )
{
T_3 * V_3 ;
if ( V_14 == NULL ) return;
if ( ( V_14 -> V_46 != NULL ) &&
