...
V_15 = V_13 -> V_15 ;
return F_17 ( V_10 , & V_11 , V_12 , V_13 ,
NULL , V_15 , 0 , V_14 ) ;
}
...
else if ( F_22 ( V_10 , L_12 , V_12 , L_2 ,
V_19 ) <= 0 )
return 0 ;
}
V_51 = ( F_27 ( T_3 ) * ) * V_18 ;
...
F_26 ( V_21 -> V_45 ) , NULL , NULL , 1 , V_14 ) )
return 0 ;
}
...
static int F_31 ( T_2 * V_10 , const int bool ,
const T_1 * V_14 )
{
const char * V_56 ;
switch ( bool )
...
static int F_32 ( T_2 * V_10 , T_10 * V_56 ,
const T_1 * V_14 )
{
char * V_57 ;
int V_1 = 1 ;
...
static int F_34 ( T_2 * V_10 , const T_11 * V_58 ,
const T_1 * V_14 )
{
char V_59 [ 80 ] ;
const char * V_60 ;
...
if( ! V_60 )
V_60 = L_2 ;
F_37 ( V_59 , sizeof V_59 , V_58 , 1 ) ;
if ( F_22 ( V_10 , L_20 , V_60 , V_59 ) <= 0 )
return 0 ;
return 1 ;
}
static int F_38 ( T_2 * V_10 , T_12 * V_56 , int V_12 ,
const T_1 * V_14 )
{
if ( V_56 -> type == V_61 )
{
...
return 0 ;
if ( ( V_56 -> V_62 > 0 )
&& F_39 ( V_10 , ( char * ) V_56 -> V_63 , V_56 -> V_62 ,
V_12 + 2 ) <= 0 )
return 0 ;
return 1 ;
}
...
return 0 ;
if ( V_67 && V_67 -> V_68 )
return V_67 -> V_68 ( V_10 , V_18 , V_13 , V_12 , V_14 ) ;
V_56 = ( T_12 * ) * V_18 ;
if ( V_13 -> V_30 == V_33 )
V_64 = V_56 -> type & ~ V_69 ;
else
...
if ( bool == - 1 )
bool = V_13 -> V_78 ;
V_1 = F_31 ( V_10 , bool , V_14 ) ;
}
break;
case V_79 :
case V_80 :
V_1 = F_32 ( V_10 , V_56 , V_14 ) ;
break;
case V_81 :
V_1 = F_41 ( V_10 , V_56 ) ;
break;
...
if ( F_19 ( V_10 , L_3 ) <= 0 )
return 0 ;
if ( F_43 ( V_10 , V_56 -> V_63 , V_56 -> V_62 ,
V_12 , 0 ) <= 0 )
V_1 = 0 ;
V_65 = 0 ;
break;
default:
V_1 = F_44 ( V_10 , V_56 , V_14 -> V_8 ) ;
}
if ( ! V_1 )
return 0 ;
if ( V_65 && F_19 ( V_10 , L_3 ) <= 0 )
return 0 ;
return 1 ;
}
