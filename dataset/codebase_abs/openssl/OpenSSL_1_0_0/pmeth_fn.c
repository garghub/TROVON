...
{
int V_2 ;
if ( ! V_1 || ! V_1 -> V_3 || ! ( V_1 -> V_3 -> V_43 || V_1 -> V_3 -> V_29 || V_1 -> V_3 -> V_38 ) || ! V_1 -> V_3 -> V_48 )
{
F_2 ( V_49 ,
V_6 ) ;
return - 2 ;
}
if ( V_1 -> V_7 != V_45 && V_1 -> V_7 != V_31 && V_1 -> V_7 != V_40 )
{
F_2 ( V_49 ,
V_16 ) ;
return - 1 ;
...
F_18 ( & V_47 -> V_56 , 1 , V_57 ) ;
return 1 ;
}
int F_19 ( T_1 * V_1 , unsigned char * V_58 , T_2 * V_59 )
{
if ( ! V_1 || ! V_1 -> V_3 || ! V_1 -> V_3 -> V_43 )
{
F_2 ( V_60 ,
...
return V_1 -> V_3 -> V_43 ( V_1 , V_58 , V_59 ) ;
}
