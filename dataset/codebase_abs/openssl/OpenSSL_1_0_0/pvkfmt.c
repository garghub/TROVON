...
if ( ! ( V_39 = F_17 () ) )
goto V_40;
if ( ! F_18 ( V_38 -> V_42 , V_38 -> V_41 ,
V_38 -> V_43 , V_38 -> V_2 , V_39 ) )
goto V_40;
F_19 ( V_39 ) ;
}
F_20 ( V_3 , V_38 ) ;
...
static int F_46 ( unsigned char * V_84 ,
const unsigned char * V_85 , unsigned int V_86 ,
...
unsigned int V_86 , unsigned int V_90 ,
T_8 * V_91 , void * V_92 )
{
T_2 * V_3 = NULL ;
const unsigned char * V_2 = * V_1 ;
...
{
char V_94 [ V_95 ] ;
unsigned char V_96 [ 20 ] ;
T_9 V_97 ;
int V_98 , V_99 ;
if ( V_91 )
V_99 = V_91 ( V_94 , V_95 , 0 , V_92 ) ;
else
V_99 = F_54 ( V_94 , V_95 , 0 , V_92 ) ;
if ( V_99 <= 0 )
{
F_7 ( V_100 , V_101 ) ;
return NULL ;
...
if ( ! F_46 ( V_96 , V_2 , V_86 ,
( unsigned char * ) V_94 , V_99 ) )
return NULL ;
V_2 += V_86 ;
memcpy ( V_93 , V_2 , 8 ) ;
V_2 += 8 ;
...
V_7 = V_93 + 8 ;
F_55 ( & V_97 ) ;
F_56 ( & V_97 , F_57 () , NULL , V_96 , NULL ) ;
F_58 ( & V_97 , V_7 , & V_98 , V_2 , V_99 ) ;
F_59 ( & V_97 , V_7 + V_98 , & V_98 ) ;
V_29 = F_1 ( ( const unsigned char * * ) & V_7 ) ;
if ( V_29 != V_23 && V_29 != V_22 )
{
V_7 = V_93 + 8 ;
memset ( V_96 + 5 , 0 , 11 ) ;
F_56 ( & V_97 , F_57 () , NULL , V_96 ,
NULL ) ;
F_60 ( V_96 , 20 ) ;
F_58 ( & V_97 , V_7 , & V_98 , V_2 , V_99 ) ;
F_59 ( & V_97 , V_7 + V_98 ,
...
V_3 = F_53 ( & V_2 , V_86 , V_90 , V_91 , V_92 ) ;
V_37:
if ( V_34 )
{
F_60 ( V_34 , V_104 ) ;
...
T_8 * V_91 , void * V_92 )
{
int V_61 = 24 , V_62 , V_108 ;
unsigned char * V_2 , * V_85 = NULL ;
if ( V_107 )
V_61 += V_109 ;
...
int V_98 , V_99 ;
if ( V_91 )
V_99 = V_91 ( V_94 , V_95 , 1 , V_92 ) ;
else
V_99 = F_54 ( V_94 , V_95 , 1 , V_92 ) ;
if ( V_99 <= 0 )
{
F_7 ( V_110 , V_101 ) ;
goto error;
}
if ( ! F_46 ( V_96 , V_85 , V_109 ,
( unsigned char * ) V_94 , V_99 ) )
goto error;
if ( V_107 == 1 )
memset ( V_96 + 5 , 0 , 11 ) ;
V_2 = V_85 + V_109 + 8 ;
F_55 ( & V_97 ) ;
F_65 ( & V_97 , F_57 () , NULL , V_96 , NULL ) ;
F_60 ( V_96 , 20 ) ;
F_58 ( & V_97 , V_2 , & V_98 , V_2 , V_108 - 8 ) ;
F_59 ( & V_97 , V_2 + V_98 , & V_98 ) ;
F_61 ( & V_97 ) ;
}
return V_61 ;
error:
