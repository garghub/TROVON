...
switch ( V_14 )
{
case V_20 : V_50 = L_24 ; break;
case V_21 : V_50 = L_25 ; break;
case V_22 : V_50 = L_26 ; break;
case V_23 : V_50 = L_27 ; break;
case V_24 : V_50 = L_28 ; break;
case V_25 : V_50 = L_29 ; break;
case V_26 : V_50 = L_30 ; break;
case V_27 : V_50 = L_31 ; break;
}
V_48 . V_51 = V_52 ;
V_48 . V_53 = V_54 ;
V_48 . V_55 = V_12 ;
V_48 . V_56 = sizeof( V_12 ) - 1 ;
F_19 ( & V_49 , & V_47 , & V_48 , V_50 , string ) ;
V_46 = (struct V_45 * ) F_7 ( 8 + V_47 ) ;
V_46 -> V_57 = V_58 ;
memcpy ( V_46 -> V_59 , & V_42 , 3 ) ;
V_46 -> V_60 = 0 ;
memcpy ( & V_46 -> V_61 , V_12 , V_47 ) ;
V_44 . V_51 = V_52 ;
V_44 . V_53 = V_54 ;
V_44 . V_55 = ( char * ) V_46 ;
V_44 . V_56 = V_47 + 8 ;
...
{
#ifdef F_21
F_22 ( V_32 , V_62 | V_63 | V_64 , V_33 ) ;
#else
F_22 ( V_32 , V_62 | V_63 , V_33 ) ;
#endif
}
static void F_8 ( T_3 * V_30 , int V_14 , const char * string )
{
F_23 ( V_14 , L_32 , string ) ;
}
static void F_5 ( T_3 * V_30 )
{
F_24 () ;
