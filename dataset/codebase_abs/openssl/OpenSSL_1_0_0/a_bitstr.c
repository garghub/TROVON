...
int F_13 ( T_1 * V_4 ,
unsigned char * V_11 , int V_28 )
{
int V_15 , V_29 ;
if ( ! V_4 || ! V_4 -> V_13 ) return 1 ;
V_29 = 1 ;
for ( V_15 = 0 ; V_15 < V_4 -> V_10 && V_29 ; ++ V_15 )
{
unsigned char V_30 = V_15 < V_28 ? ~ V_11 [ V_15 ] : 0xff ;
V_29 = ( V_4 -> V_13 [ V_15 ] & V_30 ) == 0 ;
}
return V_29 ;
}
