...
T_2 * V_4 , const T_3 * V_5 , const T_4 * V_6 ,
int V_7 )
{
T_5 V_8 ;
...
V_20 = V_4 -> V_23 . V_24 -> V_27 ;
if ( ! ( V_16 = F_4 ( NULL , & V_20 , V_4 -> V_23 . V_24 -> V_28 ) ) ) {
F_3 ( V_25 , V_26 ) ;
return 0 ;
}
if ( ! V_16 -> V_18 ) V_18 = 1 ;
else V_18 = F_5 ( V_16 -> V_18 ) ;
V_19 = V_16 -> V_19 -> V_27 ;
V_17 = V_16 -> V_19 -> V_28 ;
if( ! V_2 ) V_3 = 0 ;
...
F_15 ( V_5 ) ) ;
F_16 ( V_1 , V_5 , NULL , V_11 , V_13 , V_7 ) ;
F_17 ( V_9 , V_10 ) ;
F_17 ( V_11 , V_12 ) ;
F_17 ( V_13 , V_14 ) ;
return 1 ;
