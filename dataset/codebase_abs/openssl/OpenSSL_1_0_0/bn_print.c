...
int F_23 ( T_1 * * V_27 , const char * V_1 )
{
const char * V_7 = V_1 ;
if ( * V_7 == '-' )
V_7 ++ ;
...
int F_24 ( T_3 * V_34 , const T_1 * V_1 )
{
T_4 * V_35 ;
int V_28 ;
if ( ( V_35 = F_25 ( F_26 () ) ) == NULL )
return ( 0 ) ;
F_27 ( V_35 , V_34 , V_36 ) ;
V_28 = F_28 ( V_35 , V_1 ) ;
F_29 ( V_35 ) ;
...
int F_28 ( T_4 * V_37 , const T_1 * V_1 )
{
int V_2 , V_3 , V_4 , V_5 = 0 ;
int V_28 = 0 ;
if ( ( V_1 -> V_13 ) && ( F_30 ( V_37 , L_1 , 1 ) != 1 ) ) goto V_38;
if ( F_4 ( V_1 ) && ( F_30 ( V_37 , L_2 , 1 ) != 1 ) ) goto V_38;
for ( V_2 = V_1 -> V_8 - 1 ; V_2 >= 0 ; V_2 -- )
{
