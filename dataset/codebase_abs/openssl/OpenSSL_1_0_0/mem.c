...
void * F_26 ( int V_1 , const char * V_2 , int line )
{
void * V_16 = NULL ;
if ( V_1 <= 0 ) return NULL ;
V_4 = 0 ;
...
char * F_27 ( const char * V_3 , const char * V_2 , int line )
{
char * V_16 = F_26 ( strlen ( V_3 ) + 1 , V_2 , line ) ;
strcpy ( V_16 , V_3 ) ;
return V_16 ;
}
void * F_28 ( void * V_3 , int V_1 , const char * V_2 , int line )
{
void * V_16 = NULL ;
if ( V_3 == NULL )
return F_26 ( V_1 , V_2 , line ) ;
if ( V_1 <= 0 ) return NULL ;
if ( V_12 != NULL )
...
void * F_29 ( void * V_3 , int V_19 , int V_1 , const char * V_2 ,
int line )
{
void * V_16 = NULL ;
if ( V_3 == NULL )
...
void * F_32 ( void * V_20 , int V_1 , const char * V_2 , int line )
{
if ( V_20 != NULL ) F_33 ( V_20 ) ;
V_20 = ( char * ) F_34 ( V_1 ) ;
return ( V_20 ) ;
}
void F_35 ( long V_21 )
