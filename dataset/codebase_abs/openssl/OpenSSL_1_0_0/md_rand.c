...
static int F_18 ( unsigned char * V_10 , int V_11 )
{
static volatile int V_30 = 0 ;
int V_13 , V_14 , V_15 , V_31 , V_16 ;
int V_32 ;
int V_33 ;
long V_17 [ 2 ] ;
unsigned char V_18 [ V_6 ] ;
...
if ( V_34 )
{
F_13 ( & V_19 , ( unsigned char * ) & V_34 , sizeof V_34 ) ;
V_34 = 0 ;
}
#endif
F_13 ( & V_19 , V_18 , V_6 ) ;
