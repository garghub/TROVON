...
V_92 = F_33 ( V_107 / V_109 , V_21 , V_105 , V_106 ) ;
memcpy ( V_91 -> V_92 , V_92 , V_109 ) ;
break;
case V_104 :
memcpy ( V_21 -> V_92 , V_91 -> V_92 , V_109 ) ;
V_92 = F_34 ( V_107 / V_109 , V_21 , V_105 , V_106 ) ;
memcpy ( V_91 -> V_92 , V_92 , V_109 ) ;
break;
case V_95 :
memcpy ( V_21 -> V_92 , V_91 -> V_92 , V_109 ) ;
...
else while ( V_116 < V_109 && V_107 != 0 ) {
...
static int
F_39 ( unsigned char * V_127 , int V_128 )
{
...
T_13
int F_41 ( T_1 * V_2 , const char * V_11 , const T_14 * V_130 ) { return 0 ; }
