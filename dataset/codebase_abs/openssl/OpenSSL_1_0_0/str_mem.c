...
static int F_30 ( T_2 * V_2 , void * V_27 )
{
struct V_17 * V_7 = (struct V_17 * ) V_27 ;
if ( ! V_7
|| V_7 -> V_25
...
static int F_31 ( T_2 * V_2 , T_5 V_3 [] ,
T_5 V_4 [] )
{
return 1 ;
}
static int F_32 ( T_2 * V_2 , T_5 V_3 [] ,
T_5 V_4 [] )
{
return 1 ;
}
static int F_33 ( T_2 * V_2 , int V_40 , long V_41 , void * V_42 , void (* F_34)( void ) )
{
return 1 ;
}
