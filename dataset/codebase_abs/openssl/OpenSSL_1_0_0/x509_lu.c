...
return;
V_51 = V_49 -> V_33 ;
for ( V_50 = 0 ; V_50 < F_25 ( V_51 ) ; V_50 ++ )
{
V_52 = F_26 ( V_51 , V_50 ) ;
F_6 ( V_52 ) ;
F_4 ( V_52 ) ;
...
F_27 ( V_51 ) ;
F_28 ( V_49 -> V_31 , V_45 ) ;
F_29 ( V_46 , V_49 , & V_49 -> V_47 ) ;
if ( V_49 -> V_36 )
F_30 ( V_49 -> V_36 ) ;
F_3 ( V_49 ) ;
}
T_1 * F_31 ( T_6 * V_53 , T_2 * V_54 )
{
int V_50 ;
F_24 ( T_1 ) * V_51 ;
T_1 * V_52 ;
...
int F_33 ( T_7 * V_55 , int type , T_3 * V_14 ,
T_4 * V_2 )
{
T_6 * V_8 = V_55 -> V_8 ;
T_1 * V_52 ;
...
int V_50 , V_58 ;
F_34 ( V_59 ) ;
V_57 = F_35 ( V_8 -> V_31 , type , V_14 ) ;
F_36 ( V_59 ) ;
if ( V_57 == NULL || type == V_29 )
{
for ( V_50 = V_55 -> V_60 ; V_50 < F_25 ( V_8 -> V_33 ) ; V_50 ++ )
{
V_52 = F_26 ( V_8 -> V_33 , V_50 ) ;
V_58 = F_8 ( V_52 , type , V_14 , & V_56 ) ;
if ( V_58 < 0 )
{
V_55 -> V_60 = V_58 ;
return V_58 ;
...
V_2 -> type = V_57 -> type ;
V_2 -> V_27 . V_61 = V_57 -> V_27 . V_61 ;
F_37 ( V_2 ) ;
return 1 ;
}
int F_38 ( T_6 * V_8 , T_8 * V_62 )
{
T_4 * V_63 ;
int V_2 = 1 ;
...
else F_42 ( V_8 -> V_31 , V_63 ) ;
F_36 ( V_59 ) ;
return V_2 ;
}
int F_43 ( T_6 * V_8 , T_9 * V_62 )
{
T_4 * V_63 ;
int V_2 = 1 ;
if ( V_62 == NULL ) return 0 ;
...
{
case V_26 :
F_44 ( & V_24 -> V_27 . V_28 -> V_48 , 1 , V_68 ) ;
break;
case V_29 :
F_44 ( & V_24 -> V_27 . V_30 -> V_48 , 1 , V_69 ) ;
break;
}
}
void F_41 ( T_4 * V_24 )
...
int F_45 ( T_6 * V_8 , unsigned long V_70 )
{
return F_46 ( V_8 -> V_36 , V_70 ) ;
}
int F_47 ( T_6 * V_8 , int V_71 )
{
F_48 ( V_8 -> V_36 , V_71 ) ;
return 1 ;
}
...
{
return F_50 ( V_8 -> V_36 , V_72 ) ;
}
int F_51 ( T_6 * V_8 , int V_73 )
{
return F_52 ( V_8 -> V_36 , V_73 ) ;
}
int F_53 ( T_6 * V_8 , T_10 * V_36 )
{
return F_54 ( V_8 -> V_36 , V_36 ) ;
}
void F_55 ( T_6 * V_8 ,
int (* V_35)( int , T_7 * ) )
{
