...
if ( ! F_53 ( V_83 , & ( V_54 -> V_70 [ 0 ] ) , V_60 -> V_77 ) )
return ( 0 ) ;
return ( 1 ) ;
}
static int F_53 ( char * * V_90 , unsigned char * V_91 , int V_2 )
{
int V_92 , V_7 ;
char * V_93 ;
V_93 = * V_90 ;
...
int F_54 ( T_2 * V_22 , char * V_21 , char * V_55 , unsigned char * V_56 ,
long V_18 )
{
T_4 * V_26 ;
int V_27 ;
...
F_55 ( & V_65 ) ;
V_97 = strlen ( V_21 ) ;
if ( ( F_56 ( V_53 , L_16 , 11 ) != 11 ) ||
( F_56 ( V_53 , V_21 , V_97 ) != V_97 ) ||
( F_56 ( V_53 , L_17 , 6 ) != 6 ) )
goto V_58;
V_7 = strlen ( V_55 ) ;
if ( V_7 > 0 )
{
if ( ( F_56 ( V_53 , V_55 , V_7 ) != V_7 ) ||
( F_56 ( V_53 , L_8 , 1 ) != 1 ) )
goto V_58;
}
V_1 = F_33 ( V_17 * 8 ) ;
...
F_57 ( & V_65 , V_1 , & V_99 , & ( V_56 [ V_8 ] ) , V_98 ) ;
if ( ( V_99 ) && ( F_56 ( V_53 , ( char * ) V_1 , V_99 ) != V_99 ) )
goto V_58;
V_7 += V_99 ;
V_18 -= V_98 ;
V_8 += V_98 ;
...
F_58 ( & V_65 , V_1 , & V_99 ) ;
if ( ( V_99 > 0 ) && ( F_56 ( V_53 , ( char * ) V_1 , V_99 ) != V_99 ) ) goto V_58;
F_41 ( V_1 , V_17 * 8 ) ;
F_26 ( V_1 ) ;
V_1 = NULL ;
if ( ( F_56 ( V_53 , L_18 , 9 ) != 9 ) ||
( F_56 ( V_53 , V_21 , V_97 ) != V_97 ) ||
( F_56 ( V_53 , L_17 , 6 ) != 6 ) )
goto V_58;
return ( V_7 + V_99 ) ;
...
int F_59 ( T_2 * V_22 , char * * V_21 , char * * V_55 , unsigned char * * V_56 ,
long * V_18 )
{
T_4 * V_26 ;
int V_27 ;
...
V_7 = F_67 ( & V_65 , ( unsigned char * ) & ( V_110 -> V_56 [ V_105 ] ) , & V_104 ) ;
if ( V_7 < 0 )
{
F_3 ( V_112 , V_114 ) ;
goto V_58;
