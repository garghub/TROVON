...
if( V_6 )
{
const T_2 * V_13 = F_11 ( V_6 , V_2 -> V_9 ) ;
if( ! V_13 )
{
F_9 ( V_11 , V_12 ) ;
return 0 ;
...
F_13 ( F_16 ( V_1 ) <=
( int ) sizeof( V_1 -> V_4 ) ) ;
if( V_4 ) memcpy ( V_1 -> V_30 , V_4 , F_16 ( V_1 ) ) ;
memcpy ( V_1 -> V_4 , V_1 -> V_30 , F_16 ( V_1 ) ) ;
break;
default:
return 0 ;
break;
...
{
if ( V_1 -> V_7 )
return F_18 ( V_1 , V_36 , V_37 , V_38 , V_39 ) ;
else return F_19 ( V_1 , V_36 , V_37 , V_38 , V_39 ) ;
}
int F_20 ( T_1 * V_1 , unsigned char * V_36 , int * V_37 )
{
if ( V_1 -> V_7 )
return F_21 ( V_1 , V_36 , V_37 ) ;
else return F_22 ( V_1 , V_36 , V_37 ) ;
}
int F_23 ( T_1 * V_1 , unsigned char * V_36 , int * V_37 )
{
if ( V_1 -> V_7 )
return F_24 ( V_1 , V_36 , V_37 ) ;
else return F_25 ( V_1 , V_36 , V_37 ) ;
}
...
V_51 = 0 ;
if( ! F_18 ( V_1 , V_36 , V_37 , V_38 , V_39 ) )
return 0 ;
if ( V_47 > 1 && ! V_1 -> V_33 )
{
* V_37 -= V_47 ;
...
int F_25 ( T_1 * V_1 , unsigned char * V_36 , int * V_37 )
{
int V_45 ;
V_45 = F_22 ( V_1 , V_36 , V_37 ) ;
return V_45 ;
}
...
int F_34 ( T_1 * V_13 , int V_57 )
{
if( V_13 -> V_2 -> V_18 & V_58 )
return F_12 ( V_13 , V_59 , V_57 , NULL ) ;
...
int F_35 ( T_1 * V_1 , int V_63 )
{
if ( V_63 ) V_1 -> V_18 &= ~ V_48 ;
else V_1 -> V_18 |= V_48 ;
return 1 ;
}
int F_12 ( T_1 * V_1 , int type , int V_64 , void * V_65 )
{
int V_45 ;
if( ! V_1 -> V_2 ) {
F_9 ( V_66 , V_21 ) ;
...
int F_36 ( T_1 * V_1 , unsigned char * V_3 )
{
if ( V_1 -> V_2 -> V_18 & V_70 )
return F_12 ( V_1 , V_71 , 0 , V_3 ) ;
if ( F_37 ( V_3 , V_1 -> V_17 ) <= 0 )
return 0 ;
return 1 ;
}
int F_38 ( T_1 * V_36 , const T_1 * V_38 )
{
if ( ( V_38 == NULL ) || ( V_38 -> V_2 == NULL ) )
{
F_9 ( V_72 , V_73 ) ;
return 0 ;
}
#ifndef F_6
if ( V_38 -> V_8 && ! F_8 ( V_38 -> V_8 ) )
{
F_9 ( V_72 , V_74 ) ;
return 0 ;
}
#endif
F_7 ( V_36 ) ;
memcpy ( V_36 , V_38 , sizeof *V_36 ) ;
if ( V_38 -> V_15 && V_38 -> V_2 -> V_14 )
{
V_36 -> V_15 = F_3 ( V_38 -> V_2 -> V_14 ) ;
if ( ! V_36 -> V_15 )
{
F_9 ( V_72 , V_16 ) ;
return 0 ;
}
memcpy ( V_36 -> V_15 , V_38 -> V_15 , V_38 -> V_2 -> V_14 ) ;
}
if ( V_38 -> V_2 -> V_18 & V_75 )
return V_38 -> V_2 -> V_67 ( ( T_1 * ) V_38 , V_76 , 0 , V_36 ) ;
return 1 ;
}
