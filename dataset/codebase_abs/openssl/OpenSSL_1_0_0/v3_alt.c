...
T_3 * F_22 ( const T_8 * V_28 , T_1 * V_1 ,
T_9 * V_29 )
{
return F_23 ( NULL , V_28 , V_1 , V_29 , 0 ) ;
}
T_3 * F_24 ( T_3 * V_30 ,
const T_8 * V_28 , T_1 * V_1 ,
int V_31 , char * V_32 , int V_33 )
{
char V_34 = 0 ;
T_3 * V_4 = NULL ;
if( ! V_32 )
...
static int F_30 ( T_3 * V_4 , char * V_32 , T_1 * V_1 )
{
char * V_54 = NULL , * V_55 ;
int V_56 ;
if ( ! ( V_55 = strchr ( V_32 , ';' ) ) )
return 0 ;
if ( ! ( V_4 -> V_25 . V_57 = F_34 () ) )
return 0 ;
F_35 ( V_4 -> V_25 . V_57 -> V_32 ) ;
if ( ! ( V_4 -> V_25 . V_57 -> V_32 = F_36 ( V_55 + 1 , V_1 ) ) )
return 0 ;
V_56 = V_55 - V_32 ;
V_54 = F_37 ( V_56 + 1 ) ;
strncpy ( V_54 , V_32 , V_56 ) ;
V_54 [ V_56 ] = 0 ;
...
static int F_29 ( T_3 * V_4 , char * V_32 , T_1 * V_1 )
{
int V_59 ;
F_39 ( T_9 ) * V_60 ;
T_5 * V_17 ;
