...
{
case V_14 :
F_8 ( ( char * ) V_11 -> _ . V_15 . V_16 ) ;
F_8 ( ( char * ) V_11 -> _ . V_15 . V_17 ) ;
F_8 ( ( char * ) V_11 -> _ . V_15 . V_18 ) ;
break;
default:
break;
}
...
int F_18 ( T_1 * V_19 , const char * V_20 , int V_8 ,
char * V_24 , int V_30 , int V_31 )
{
return F_15 ( V_19 , V_20 , 0 ,
V_27 , V_8 , V_24 , V_30 , V_31 , NULL ) ;
}
int F_19 ( T_1 * V_19 , const char * V_20 , int V_8 ,
char * V_24 , int V_30 , int V_31 )
{
char * V_40 = NULL ;
if ( V_20 )
...
int F_21 ( T_1 * V_19 , const char * V_20 , int V_8 ,
char * V_24 , int V_30 , int V_31 , const char * V_32 )
{
return F_15 ( V_19 , V_20 , 0 ,
V_28 , V_8 , V_24 , V_30 , V_31 , V_32 ) ;
}
int F_22 ( T_1 * V_19 , const char * V_20 , int V_8 ,
char * V_24 , int V_30 , int V_31 , const char * V_32 )
{
char * V_40 = NULL ;
if ( V_20 )
...
T_6 * V_84 , T_7 * V_85 )
{
return F_44 ( V_9 , V_81 , V_82 ,
V_83 , V_84 , V_85 ) ;
}
int F_45 ( T_1 * V_86 , int V_87 , void * V_88 )
{
return ( F_46 ( & V_86 -> V_10 , V_87 , V_88 ) ) ;
}
void * F_47 ( T_1 * V_86 , int V_87 )
{
return ( F_48 ( & V_86 -> V_10 , V_87 ) ) ;
}
...
int F_57 ( T_2 * V_1 , int (* F_58)( T_1 * V_19 , T_3 * V_11 ) )
{
if ( V_1 )
{
V_1 -> V_67 = F_58 ;
...
int F_61 ( T_2 * V_1 , int (* F_62)( T_1 * V_19 , T_3 * V_11 ) )
{
if ( V_1 )
{
V_1 -> V_72 = F_62 ;
...
int F_65 ( T_2 * V_1 , char * (* F_66)( T_1 * V_19 , const char * V_54 , const char * V_55 ) )
{
if ( V_1 )
{
V_1 -> V_56 = F_66 ;
...
const char * F_69 ( T_3 * V_11 )
{
if ( ! V_11 )
return NULL ;
return V_11 -> V_13 ;
}
const char * F_70 ( T_3 * V_11 )
{
if ( ! V_11 )
return NULL ;
switch( V_11 -> type )
...
case V_27 :
case V_14 :
return V_11 -> _ . V_15 . V_16 ;
default:
return NULL ;
}
}
const char * F_36 ( T_3 * V_11 )
{
if ( ! V_11 )
return NULL ;
switch( V_11 -> type )
...
case V_27 :
case V_28 :
return V_11 -> _ . V_34 . V_36 ;
default:
return - 1 ;
}
}
int F_74 ( T_1 * V_19 , T_3 * V_11 , const char * V_93 )
{
...
case V_28 :
{
char V_95 [ F_75 ( V_11 -> _ . V_34 . V_35 ) + 1 ] ;
char V_96 [ F_75 ( V_11 -> _ . V_34 . V_36 ) + 1 ] ;
F_76 ( V_95 , sizeof( V_95 ) , L_4 ,
V_11 -> _ . V_34 . V_35 ) ;
F_76 ( V_96 , sizeof( V_96 ) , L_4 ,
V_11 -> _ . V_34 . V_36 ) ;
if ( V_94 < V_11 -> _ . V_34 . V_35 )
{
V_19 -> V_8 |= V_79 ;
F_4 ( V_97 , V_98 ) ;
F_77 ( 5 , L_5 ,
...
{
if ( strchr ( V_11 -> _ . V_15 . V_17 , * V_37 ) )
{
V_11 -> V_24 [ 0 ] =
V_11 -> _ . V_15 . V_17 [ 0 ] ;
break;
}
if ( strchr ( V_11 -> _ . V_15 . V_18 , * V_37 ) )
{
V_11 -> V_24 [ 0 ] =
V_11 -> _ . V_15 . V_18 [ 0 ] ;
break;
