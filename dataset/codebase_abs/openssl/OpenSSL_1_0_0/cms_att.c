...
int F_3 ( const T_1 * V_1 , int V_3 ,
int V_4 )
{
return F_4 ( V_1 -> V_2 , V_3 , V_4 ) ;
}
int F_5 ( const T_1 * V_1 , T_2 * V_5 ,
int V_4 )
{
...
const void * V_8 , int V_9 )
{
if( F_18 ( & V_1 -> V_2 , V_10 ,
type , V_8 , V_9 ) ) return 1 ;
return 0 ;
}
void * F_19 ( T_1 * V_1 , T_2 * V_11 ,
int V_4 , int type )
{
...
int F_23 ( const T_1 * V_1 , T_2 * V_5 ,
int V_4 )
{
