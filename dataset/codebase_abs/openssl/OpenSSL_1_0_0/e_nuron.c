...
static int F_14 ( T_1 * V_3 , int V_16 , long V_17 , void * V_18 , void (* F_15)( void ) )
{
...
static int F_17 ( T_2 * V_29 , const T_2 * V_30 , T_4 * V_31 , T_3 * V_27 )
{
return F_16 ( V_29 , V_30 , V_31 -> V_32 , V_31 -> V_33 , V_27 ) ;
}
