...
goto V_43;
F_17 () ;
if ( ( V_12 = F_18 ( V_13 ) ) == NULL ) return ( 1 ) ;
F_19 ( V_12 , 1 ) ;
if ( V_16 ) F_20 ( V_12 , V_44 ) ;
F_21 ( V_12 , V_7 ) ;
if( ! F_22 ( V_12 , V_3 , V_4 ) )
goto V_43;
F_23 () ;
if ( ( ! F_24 ( V_12 , V_6 , V_5 ) ) ||
( ! F_25 ( V_12 ) ) )
{
F_26 ( V_30 ) ;
}
...
goto V_43;
#endif
if( ( V_35 = F_29 ( NULL ) ) == NULL )
goto V_43;
if ( V_14 != NULL )
{
F_30 ( V_39 , sizeof V_39 , L_32 , V_14 ) ;
F_31 ( V_35 , V_39 , strlen ( V_39 ) ) ;
while ( ( V_38 = F_32 ( V_35 , V_39 , sizeof( V_39 ) ) ) > 0 )
V_15 += V_38 ;
}
#ifdef F_33
F_34 ( V_35 , V_48 | V_49 ) ;
...
printf ( L_33 , V_34 , V_33 , ( ( double ) V_34 / V_33 ) , V_15 ) ;
printf ( L_34 , V_34 , ( long ) time ( NULL ) - V_36 + V_10 , V_15 / V_34 ) ;
V_45:
if ( ! ( V_17 & 2 ) ) goto V_43;
printf ( L_35 ) ;
if( ( V_35 = F_29 ( NULL ) ) == NULL )
...
F_30 ( V_39 , sizeof V_39 , L_32 , V_14 ) ;
F_31 ( V_35 , V_39 , strlen ( V_39 ) ) ;
while ( F_32 ( V_35 , V_39 , sizeof( V_39 ) ) > 0 )
;
}
#ifdef F_33
F_34 ( V_35 , V_48 | V_49 ) ;
...
static T_1 * F_29 ( T_1 * V_35 )
{
T_3 * V_54 ;
T_1 * V_55 ;
int V_56 , V_38 ;
T_4 V_57 ;
if ( ( V_54 = F_44 ( F_45 () ) ) == NULL )
return ( NULL ) ;
F_46 ( V_54 , V_1 ) ;
if ( V_35 == NULL )
V_55 = F_47 ( V_12 ) ;
...
F_52 ( & V_57 ) ;
F_53 ( V_38 , & V_57 ) ;
F_54 ( V_56 , ( void * ) & V_57 , NULL , NULL , NULL ) ;
continue;
}
break;
}
