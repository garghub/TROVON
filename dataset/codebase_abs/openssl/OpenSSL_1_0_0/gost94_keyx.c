static int F_1 ( unsigned char * V_1 , T_1 * V_2 , T_2 * V_3 )
{
...
static int F_3 ( T_1 * V_7 , T_3 * V_8 , unsigned char * V_9 )
{
...
V_3 -> V_7 = F_5 ( V_7 ) ;
V_11 = F_1 ( V_10 , ( ( V_17 * ) ( F_6 ( V_8 ) ) ) -> V_2 , V_3 ) ;
F_7 ( V_3 ) ;
if ( ! V_11 ) return 0 ;
F_8 ( & V_12 , & V_18 ) ;
F_9 ( & V_12 ) ;
...
int F_17 ( T_5 * V_19 , unsigned char * V_23 , T_6 * V_24 , const unsigned char * V_20 , T_6 V_25 )
{
T_7 * V_26 = NULL ;
...
if ( ! F_32 ( V_26 -> V_46 -> V_48 , V_28 + 8 , 32 ) )
{
goto V_43;
}
if ( V_34 ) {
if ( ! F_33 ( & V_26 -> V_44 -> V_49 , V_23 ? V_22 : V_8 ) )
{
F_21 ( V_37 , V_50 ) ;
goto V_39;
}
...
if ( ! V_34 )
{
if ( F_38 ( V_19 , - 1 , - 1 , V_54 , 3 , NULL ) <= 0 )
{
F_21 ( V_37 ,
V_55 ) ;
goto V_39;
...
int F_40 ( T_5 * V_19 , unsigned char * V_20 , T_6 * V_25 , const unsigned char * V_57 , T_6 V_58 ) {
...
V_26 = F_41 ( NULL , ( const unsigned char * * ) & V_16 ,
V_58 ) ;
if ( ! V_26 )
{
F_21 ( V_64 , V_65 ) ;
