...
case V_45 :
V_7 = F_19 ( V_3 -> V_47 , V_48 , 0 , NULL ) ;
if ( V_7 > 0 )
{
V_3 -> V_49 = V_50 ;
V_7 = F_20 ( V_3 -> V_47 ) ;
if ( V_7 <= 0 ) { V_6 = - 1 ; goto V_25; }
V_3 -> V_49 = V_51 ;
}
V_3 -> V_47 = F_21 ( V_3 -> V_47 ) ;
V_3 -> V_11 = V_46 ;
BREAK ;
case V_46 :
case V_52 :
...
V_3 -> V_59 -> V_89 = V_77 ;
V_76 += 3 ;
F_32 ( V_76 , V_71 ) ; V_3 -> V_41 -> V_90 . V_91 = V_71 ;
F_32 ( V_76 , V_71 ) ; V_3 -> V_41 -> V_90 . V_92 = V_71 ;
F_32 ( V_76 , V_71 ) ; V_3 -> V_59 -> V_93 = V_71 ;
if( V_3 -> V_59 -> V_93 > V_94 )
{
F_30 ( V_3 , V_84 ) ;
F_11 ( V_81 , V_95 ) ;
return - 1 ;
...
V_73 = V_3 -> V_59 -> V_93 ;
V_75 = 10 + ( unsigned long ) V_3 -> V_41 -> V_90 . V_91 + ( unsigned long ) V_3 -> V_41 -> V_90 . V_92 + ( unsigned long ) V_73 ;
if ( V_75 > V_26 )
{
F_30 ( V_3 , V_84 ) ;
F_11 ( V_81 , V_98 ) ;
...
if ( V_71 != V_72 ) return ( F_29 ( V_3 , V_81 , V_71 ) ) ;
if ( V_3 -> V_99 )
V_3 -> V_99 ( 0 , V_3 -> V_23 , 0 , V_76 , ( V_100 ) V_75 , V_3 , V_3 -> V_101 ) ;
V_76 += 10 ;
...
& ( V_76 [ V_3 -> V_41 -> V_90 . V_91 ] ) , & ( V_76 [ V_3 -> V_41 -> V_90 . V_91 ] ) ,
( V_3 -> V_41 -> V_107 ) ? V_108 : V_109 ) ;
...
if ( ( V_71 < 0 ) ||
( ( ! V_70 && ( V_71 != F_36 ( V_78 ) ) )
|| ( V_70 && ( ( V_71 != V_74 ) || ( V_3 -> V_41 -> V_90 . V_91 + ( unsigned int ) V_71 !=
( unsigned int ) F_36 ( V_78 ) ) ) ) ) )
{
F_6 () ;
if ( V_70 )
V_71 = V_74 ;
...
#endif
if ( V_70 ) V_71 += V_3 -> V_41 -> V_90 . V_91 ;
if ( V_71 > V_115 )
{
F_30 ( V_3 , V_84 ) ;
F_11 ( V_81 , V_97 ) ;
...
F_32 ( V_76 , V_71 ) ;
if ( V_71 < V_3 -> V_23 ) V_3 -> V_23 = V_71 ;
F_32 ( V_76 , V_71 ) ; V_3 -> V_41 -> V_90 . V_126 = V_71 ;
F_32 ( V_76 , V_71 ) ; V_3 -> V_41 -> V_90 . V_127 = V_71 ;
F_32 ( V_76 , V_71 ) ; V_3 -> V_41 -> V_128 = V_71 ;
if ( ( V_71 < V_129 ) ||
( V_71 > V_130 ) )
{
F_30 ( V_3 , V_84 ) ;
...
V_76 = ( unsigned char * ) V_3 -> V_24 -> V_80 ;
V_75 = 9 + ( unsigned long ) V_3 -> V_41 -> V_90 . V_126 + ( unsigned long ) V_3 -> V_41 -> V_128 + ( unsigned long ) V_3 -> V_41 -> V_90 . V_127 ;
if ( V_75 > V_26 )
{
F_30 ( V_3 , V_84 ) ;
F_11 ( V_124 , V_98 ) ;
...
V_72 = ( int ) V_75 - V_3 -> V_27 ;
V_71 = F_28 ( V_3 , ( char * ) & ( V_76 [ V_3 -> V_27 ] ) , V_72 ) ;
if ( V_71 != V_72 ) return ( F_29 ( V_3 , V_124 , V_71 ) ) ;
if ( V_3 -> V_99 )
V_3 -> V_99 ( 0 , V_3 -> V_23 , 0 , V_76 , ( V_100 ) V_75 , V_3 , V_3 -> V_101 ) ;
V_76 += 9 ;
...
& V_3 -> V_59 -> V_135 ) ;
if ( V_118 == NULL ) goto V_136;
V_119 = F_42 ( V_3 ) ;
if ( V_3 -> V_137 & V_138 )
{
V_120 = F_43 ( V_119 ) ;
if ( V_120 == NULL ) goto V_136;
V_121 = V_118 ;
}
else
{
...
if ( ! V_37 )
{
F_51 ( & V_3 -> V_15 -> V_146 , 1 , V_147 ) ;
if ( V_3 -> V_59 -> V_144 != NULL )
F_52 ( V_3 -> V_59 -> V_144 ) ;
V_3 -> V_59 -> V_144 = V_3 -> V_15 ;
}
else
{
if ( V_3 -> V_59 -> V_144 == NULL )
{
F_51 ( & V_3 -> V_15 -> V_146 , 1 ,
V_147 ) ;
V_3 -> V_59 -> V_144 = V_3 -> V_15 ;
}
}
...
* ( V_76 ++ ) = V_149 ;
F_53 ( V_3 -> V_23 , V_76 ) ;
V_72 = F_54 ( V_3 -> V_15 -> V_103 [ V_104 ] . V_150 , NULL ) ;
F_53 ( V_72 , V_76 ) ;
F_54 ( V_3 -> V_15 -> V_103 [ V_104 ] . V_150 , & V_141 ) ;
V_72 = 0 ;
V_142 = V_3 -> V_59 -> V_135 ;
V_72 = F_55 ( V_3 , V_3 -> V_59 -> V_135 , V_141 , 0 ) ;
V_141 += V_72 ;
F_53 ( V_72 , V_76 ) ;
}
F_53 ( V_151 , V_76 ) ;
V_3 -> V_41 -> V_152 = V_151 ;
if ( F_37 ( V_3 -> V_41 -> V_153 , ( int ) V_3 -> V_41 -> V_152 ) <= 0 )
return - 1 ;
memcpy ( V_141 , V_3 -> V_41 -> V_153 , V_151 ) ;
V_141 += V_151 ;
V_3 -> V_11 = V_36 ;
...
if ( V_3 -> V_37 )
{
if ( ! F_56 ( V_3 , 1 ) ) return ( - 1 ) ;
}
return ( F_57 ( V_3 ) ) ;
}
static int F_22 ( T_2 * V_3 )
{
unsigned char * V_76 ;
int V_71 , V_72 ;
unsigned long V_75 ;
...
return F_29 ( V_3 , V_157 , V_71 ) ;
}
return ( - 1 ) ;
}
V_3 -> V_11 = V_52 ;
}
if ( V_3 -> V_41 -> V_152 > sizeof V_3 -> V_41 -> V_153 )
{
F_30 ( V_3 , V_84 ) ;
F_11 ( V_155 , V_97 ) ;
return - 1 ;
}
V_75 = 1 + ( unsigned long ) V_3 -> V_41 -> V_152 ;
V_72 = ( int ) V_75 - V_3 -> V_27 ;
V_71 = F_28 ( V_3 , ( char * ) & ( V_76 [ V_3 -> V_27 ] ) , V_72 ) ;
if ( V_71 < V_72 )
{
...
V_76 += 1 ;
if ( memcmp ( V_76 , V_3 -> V_41 -> V_153 , V_3 -> V_41 -> V_152 ) != 0 )
{
F_30 ( V_3 , V_84 ) ;
F_11 ( V_155 , V_158 ) ;
return ( - 1 ) ;
...
V_76 = ( unsigned char * ) V_3 -> V_24 -> V_80 ;
* ( V_76 ++ ) = V_161 ;
if ( V_3 -> V_59 -> V_127 > sizeof V_3 -> V_59 -> V_162 )
{
F_11 ( V_163 , V_97 ) ;
return - 1 ;
}
memcpy ( V_76 , V_3 -> V_59 -> V_162 , ( unsigned int ) V_3 -> V_59 -> V_127 ) ;
V_3 -> V_11 = V_63 ;
...
unsigned char * V_76 , * V_164 , * V_165 ;
unsigned char * V_166 ;
int V_71 , V_167 , V_168 , V_6 = - 1 ;
unsigned long V_75 ;
T_7 * V_150 = NULL ;
F_38 ( T_7 ) * V_142 = NULL ;
V_166 = V_3 -> V_41 -> V_90 . V_169 ;
if ( V_3 -> V_11 == V_53 )
{
V_76 = ( unsigned char * ) V_3 -> V_24 -> V_80 ;
* ( V_76 ++ ) = V_170 ;
* ( V_76 ++ ) = V_171 ;
if ( F_37 ( V_166 , V_172 ) <= 0 )
return - 1 ;
memcpy ( V_76 , V_166 , V_172 ) ;
V_3 -> V_11 = V_54 ;
V_3 -> V_27 = V_172 + 2 ;
V_3 -> V_154 = 0 ;
}
...
if ( V_3 -> V_99 )
V_3 -> V_99 ( 0 , V_3 -> V_23 , 0 , V_76 , 3 , V_3 , V_3 -> V_101 ) ;
if ( V_3 -> V_57 & V_174 )
{
F_30 ( V_3 , V_175 ) ;
F_11 ( V_173 , V_176 ) ;
...
F_32 ( V_76 , V_71 ) ; V_3 -> V_41 -> V_90 . V_181 = V_71 ;
F_32 ( V_76 , V_71 ) ; V_3 -> V_41 -> V_90 . V_182 = V_71 ;
V_3 -> V_11 = V_56 ;
}
V_76 = ( unsigned char * ) V_3 -> V_24 -> V_80 ;
...
V_167 = ( int ) V_75 - V_3 -> V_27 ;
V_71 = F_28 ( V_3 , ( char * ) & ( V_76 [ V_3 -> V_27 ] ) , V_167 ) ;
if ( V_71 < V_167 )
{
V_6 = F_29 ( V_3 , V_173 , V_71 ) ;
goto V_25;
...
V_76 += 6 ;
V_77 = V_76 ;
V_150 = ( T_7 * ) F_58 ( NULL , & V_77 , ( long ) V_3 -> V_41 -> V_90 . V_181 ) ;
if ( V_150 == NULL )
{
F_11 ( V_173 , V_183 ) ;
goto V_184;
}
if ( ( ( V_142 = F_59 () ) == NULL ) || ( ! F_60 ( V_142 , V_150 ) ) )
{
F_11 ( V_173 , V_140 ) ;
goto V_184;
}
...
T_9 * V_185 = NULL ;
F_62 ( & V_13 ) ;
F_63 ( & V_13 , V_3 -> V_13 -> V_186 , NULL ) ;
F_64 ( & V_13 , V_3 -> V_41 -> V_187 ,
V_3 -> V_41 -> V_188 ) ;
F_64 ( & V_13 , V_166 , V_172 ) ;
V_71 = F_54 ( V_3 -> V_15 -> V_103 [ V_104 ] . V_150 , NULL ) ;
V_165 = F_65 ( ( unsigned int ) V_71 ) ;
if ( V_165 == NULL )
{
F_11 ( V_173 , V_140 ) ;
goto V_184;
...
V_164 = V_165 ;
V_71 = F_54 ( V_3 -> V_15 -> V_103 [ V_104 ] . V_150 , & V_164 ) ;
F_64 ( & V_13 , V_165 , ( unsigned int ) V_71 ) ;
F_66 ( V_165 ) ;
V_185 = F_67 ( V_150 ) ;
if ( V_185 == NULL ) goto V_25;
