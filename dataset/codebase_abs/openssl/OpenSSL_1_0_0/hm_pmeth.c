...
static int F_18 ( T_1 * V_1 , unsigned char * V_22 , T_6 * V_23 ,
T_5 * V_19 )
{
unsigned int V_24 ;
T_2 * V_2 = V_1 -> V_5 ;
...
if ( ! V_22 )
return 1 ;
F_20 ( & V_2 -> V_1 , V_22 , & V_24 ) ;
* V_23 = ( T_6 ) V_24 ;
return 1 ;
}
static int F_21 ( T_1 * V_1 , int type , int V_26 , void * V_27 )
{
T_2 * V_2 = V_1 -> V_5 ;
T_4 * V_28 ;
switch ( type )
...
F_22 ( & V_2 -> V_1 , V_28 -> V_5 , V_28 -> V_6 , V_2 -> V_3 ,
V_1 -> V_33 ) ;
break;
default:
return - 2 ;
