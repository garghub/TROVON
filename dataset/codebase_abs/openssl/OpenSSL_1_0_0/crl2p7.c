...
if ( ( V_13 = F_15 () ) == NULL ) goto V_29;
if ( ( V_14 = F_16 () ) == NULL ) goto V_29;
V_13 -> type = F_17 ( V_32 ) ;
V_13 -> V_33 . V_34 = V_14 ;
V_14 -> V_35 -> type = F_17 ( V_36 ) ;
if ( ! F_18 ( V_14 -> V_37 , 1 ) ) goto V_29;
if ( ( V_18 = F_19 () ) == NULL ) goto V_29;
V_14 -> V_15 = V_18 ;
if ( V_15 != NULL )
{
F_20 ( V_18 , V_15 ) ;
...
if ( ( V_20 = F_21 () ) == NULL ) goto V_29;
V_14 -> V_38 = V_20 ;
if( V_17 ) for( V_3 = 0 ; V_3 < F_22 ( V_17 ) ; V_3 ++ ) {
V_12 = F_23 ( V_17 , V_3 ) ;
if ( F_24 ( V_20 , V_12 ) < 0 )
{
F_9 ( V_23 , L_19 ) ;
