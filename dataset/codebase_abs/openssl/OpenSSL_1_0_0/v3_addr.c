...
static void F_2 ( unsigned char * V_4 ,
const T_2 * V_5 ,
const int V_6 ,
const unsigned char V_7 )
{
F_3 ( V_5 -> V_6 >= 0 && V_5 -> V_6 <= V_6 ) ;
if ( V_5 -> V_6 > 0 ) {
...
case V_15 :
F_2 ( V_4 , V_5 , 4 , V_7 ) ;
F_5 ( V_10 , L_1 , V_4 [ 0 ] , V_4 [ 1 ] , V_4 [ 2 ] , V_4 [ 3 ] ) ;
break;
case V_16 :
F_2 ( V_4 , V_5 , 16 , V_7 ) ;
...
F_5 ( V_10 , L_2 , ( V_4 [ V_13 ] << 8 ) | V_4 [ V_13 + 1 ] , ( V_13 < 14 ? L_3 : L_4 ) ) ;
if ( V_13 < 16 )
F_6 ( V_10 , L_3 ) ;
if ( V_13 == 0 )
F_6 ( V_10 , L_3 ) ;
...
F_5 ( V_10 , L_5 , ( V_13 > 0 ? L_3 : L_4 ) , V_5 -> V_3 [ V_13 ] ) ;
F_5 ( V_10 , L_6 , ( int ) ( V_5 -> V_8 & 7 ) ) ;
break;
}
return 1 ;
}
...
{
int V_13 ;
for ( V_13 = 0 ; V_13 < F_8 ( V_18 ) ; V_13 ++ ) {
const T_5 * V_19 = F_9 ( V_18 , V_13 ) ;
F_5 ( V_10 , L_7 , V_17 , L_4 ) ;
switch ( V_19 -> type ) {
case V_20 :
if ( ! F_4 ( V_10 , V_11 , 0x00 , V_19 -> V_21 . V_22 ) )
return 0 ;
F_5 ( V_10 , L_8 , F_10 ( V_19 -> V_21 . V_22 ) ) ;
continue;
case V_23 :
if ( ! F_4 ( V_10 , V_11 , 0x00 , V_19 -> V_21 . V_24 -> V_25 ) )
return 0 ;
F_6 ( V_10 , L_9 ) ;
if ( ! F_4 ( V_10 , V_11 , 0xFF , V_19 -> V_21 . V_24 -> V_26 ) )
return 0 ;
F_6 ( V_10 , L_10 ) ;
continue;
}
...
static int F_11 ( const T_6 * V_27 ,
void * V_28 ,
T_3 * V_10 ,
int V_17 )
{
const T_7 * V_4 = V_28 ;
int V_13 ;
for ( V_13 = 0 ; V_13 < F_12 ( V_4 ) ; V_13 ++ ) {
T_1 * V_1 = F_13 ( V_4 , V_13 ) ;
const unsigned int V_11 = F_1 ( V_1 ) ;
switch ( V_11 ) {
case V_15 :
F_5 ( V_10 , L_11 , V_17 , L_4 ) ;
break;
case V_16 :
F_5 ( V_10 , L_12 , V_17 , L_4 ) ;
break;
default:
F_5 ( V_10 , L_13 , V_17 , L_4 , V_11 ) ;
break;
}
if ( V_1 -> V_2 -> V_6 > 2 ) {
...
static int F_14 ( const T_5 * V_33 ,
const T_5 * V_34 ,
const int V_6 )
{
...
switch ( V_33 -> type ) {
case V_20 :
F_2 ( V_35 , V_33 -> V_21 . V_22 , V_6 , 0x00 ) ;
V_37 = F_10 ( V_33 -> V_21 . V_22 ) ;
break;
case V_23 :
F_2 ( V_35 , V_33 -> V_21 . V_24 -> V_25 , V_6 , 0x00 ) ;
V_37 = V_6 * 8 ;
break;
}
switch ( V_34 -> type ) {
case V_20 :
F_2 ( V_36 , V_34 -> V_21 . V_22 , V_6 , 0x00 ) ;
V_38 = F_10 ( V_34 -> V_21 . V_22 ) ;
break;
case V_23 :
F_2 ( V_36 , V_34 -> V_21 . V_24 -> V_25 , V_6 , 0x00 ) ;
V_38 = V_6 * 8 ;
break;
}
...
{
return F_14 ( * V_33 , * V_34 , 4 ) ;
}
static int F_16 ( const T_5 * const * V_33 ,
const T_5 * const * V_34 )
{
return F_14 ( * V_33 , * V_34 , 16 ) ;
}
static int F_17 ( const unsigned char * V_25 ,
...
T_5 * V_19 ;
int V_13 , V_42 ;
if ( ( V_42 = F_17 ( V_25 , V_26 , V_6 ) ) >= 0 )
return F_18 ( V_41 , V_25 , V_42 ) ;
if ( ( V_19 = F_19 () ) == NULL )
return 0 ;
V_19 -> type = V_23 ;
F_3 ( V_19 -> V_21 . V_24 == NULL ) ;
...
static void F_41 ( T_5 * V_19 ,
unsigned char * V_25 ,
unsigned char * V_26 ,
int V_6 )
{
F_3 ( V_19 != NULL && V_25 != NULL && V_26 != NULL ) ;
switch ( V_19 -> type ) {
case V_20 :
F_2 ( V_25 , V_19 -> V_21 . V_22 , V_6 , 0x00 ) ;
F_2 ( V_26 , V_19 -> V_21 . V_22 , V_6 , 0xFF ) ;
return;
case V_23 :
F_2 ( V_25 , V_19 -> V_21 . V_24 -> V_25 , V_6 , 0x00 ) ;
...
if ( V_4 == NULL )
return 1 ;
for ( V_13 = 0 ; V_13 < F_12 ( V_4 ) - 1 ; V_13 ++ ) {
const T_1 * V_33 = F_13 ( V_4 , V_13 ) ;
const T_1 * V_34 = F_13 ( V_4 , V_13 + 1 ) ;
if ( F_43 ( & V_33 , & V_34 ) >= 0 )
return 0 ;
}
for ( V_13 = 0 ; V_13 < F_12 ( V_4 ) ; V_13 ++ ) {
...
if ( F_8 ( V_18 ) == 0 )
return 0 ;
for ( V_40 = 0 ; V_40 < F_8 ( V_18 ) - 1 ; V_40 ++ ) {
T_5 * V_33 = F_9 ( V_18 , V_40 ) ;
T_5 * V_34 = F_9 ( V_18 , V_40 + 1 ) ;
...
F_46 ( V_18 ) ;
for ( V_13 = 0 ; V_13 < F_8 ( V_18 ) - 1 ; V_13 ++ ) {
T_5 * V_33 = F_9 ( V_18 , V_13 ) ;
T_5 * V_34 = F_9 ( V_18 , V_13 + 1 ) ;
unsigned char V_56 [ V_12 ] , V_57 [ V_12 ] ;
unsigned char V_58 [ V_12 ] , V_59 [ V_12 ] ;
F_41 ( V_33 , V_56 , V_57 , V_6 ) ;
F_41 ( V_34 , V_58 , V_59 , V_6 ) ;
...
return 0 ;
F_50 ( V_34 , F_43 ) ;
for ( V_13 = 0 ; V_13 < F_12 ( V_33 ) ; V_13 ++ ) {
T_1 * V_70 = F_13 ( V_33 , V_13 ) ;
