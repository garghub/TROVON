...
{
if ( V_2 -> V_30 ) V_29 ( V_2 -> V_30 ) ;
if ( ! ( V_2 -> V_30 = F_25 ( V_43 ) ) ) goto V_5;
return 1 ;
V_5:
F_4 ( V_44 , V_7 ) ;
return 0 ;
...
goto V_5;
if ( ! ( V_46 = F_25 ( V_45 ) ) ) goto V_5;
if ( ! F_28 ( V_2 -> V_28 , V_46 ) ) goto V_5;
return 1 ;
V_5:
F_4 ( V_47 , V_7 ) ;
V_29 ( V_46 ) ;
...
goto V_5;
if ( ! F_31 ( V_2 -> V_31 , ( T_8 * ) V_48 ) ) goto V_5;
return 1 ;
V_5:
F_4 ( V_49 , V_7 ) ;
return 0 ;
...
T_13 * V_60 = NULL ;
int V_61 = 0 ;
if ( ! ( V_59 = F_38 () ) ) goto V_5;
if ( ! F_3 ( V_59 -> V_57 , V_57 ) ) goto V_5;
if ( V_58 )
{
if ( ! ( V_60 = F_39 () )
...
goto V_5;
if ( ! F_42 ( V_59 -> V_58 , V_60 ) ) goto V_5;
V_60 = NULL ;
}
if ( ! F_43 ( V_2 -> V_62 , V_59 ) ) goto V_5;
V_61 = 1 ;
V_5:
if ( ! V_61 )
F_4 ( V_63 , V_7 ) ;
...
int F_53 ( T_4 * V_2 , unsigned V_70 )
{
if ( V_70 > V_71 )
return 0 ;
V_2 -> V_72 = V_70 ;
...
goto V_76;
if ( ! F_58 ( V_2 ) ) goto V_76;
if ( ! ( V_45 = F_59 ( V_2 ) ) ) goto V_76;
if ( ! ( V_2 -> V_69 = F_60 ( V_2 , V_45 ) ) )
goto V_76;
if ( ! F_61 ( V_2 ) ) goto V_76;
if ( ! F_62 ( V_2 ) ) goto V_76;
V_74 = 1 ;
V_76:
if ( ! V_74 )
{
...
const T_1 * V_99 ;
T_23 * V_100 = NULL ;
if ( ! ( V_69 = F_81 () ) ) goto V_76;
if ( ! F_82 ( V_69 , 1 ) ) goto V_76;
if ( ! F_83 ( V_69 , V_45 ) ) goto V_76;
...
if ( V_2 -> V_52 & V_102 )
{
if ( ! ( V_100 = F_96 () ) ) goto V_76;
V_100 -> type = V_103 ;
V_100 -> V_104 . V_105 =
F_97 ( V_2 -> V_25 -> V_106 -> V_107 ) ;
if ( ! V_100 -> V_104 . V_105 ) goto V_76;
if ( ! F_98 ( V_69 , V_100 ) ) goto V_76;
}
V_74 = 1 ;
V_76:
if ( ! V_74 )
...
if ( ! F_108 ( V_112 , V_118 ) ) goto V_5;
if ( ! F_3 ( V_112 -> V_104 . V_119 -> V_120 , 3 ) ) goto V_5;
if ( F_109 ( V_2 -> V_68 ) )
{
...
T_24 * V_61 = NULL ;
T_20 * V_139 = NULL ;
if ( ! ( V_61 = F_107 () ) ) goto V_5;
if ( ! ( V_61 -> V_104 . V_140 = F_134 () ) ) goto V_5;
V_61 -> type = F_115 ( V_123 ) ;
if ( ! ( V_139 = F_135 () ) ) goto V_5;
F_136 ( V_61 -> V_104 . V_140 , V_141 , V_139 ) ;
V_139 = NULL ;
if ( ! F_137 ( V_112 , V_61 ) ) goto V_5;
return 1 ;
V_5:
F_138 ( V_139 ) ;
F_126 ( V_61 ) ;
