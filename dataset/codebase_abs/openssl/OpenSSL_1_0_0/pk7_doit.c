...
if ( F_37 ( V_71 , V_73 ) <= 0 )
goto V_22;
if ( F_38 ( V_74 , V_51 , NULL , NULL , NULL , 1 ) <= 0 )
goto V_22;
if ( F_39 ( V_74 , V_26 ) <= 0 )
goto V_22;
if ( F_38 ( V_74 , NULL , NULL , V_26 , V_71 , 1 ) <= 0 )
goto V_22;
if ( V_73 > 0 ) {
if ( V_54 -> V_75 == NULL ) {
V_54 -> V_75 = F_40 () ;
...
V_87 = NULL ;
F_32 ( V_84 , & V_87 ) ;
if ( F_38 ( V_87 , V_51 , NULL , NULL , NULL , 0 ) <= 0 )
goto V_22;
...
if ( F_38 ( V_87 , NULL , NULL , V_30 , NULL , 0 ) <= 0 )
goto V_22;
if ( V_30 )
{
F_44 ( V_30 , V_32 ) ;
...
return NULL ;
V_25 = F_43 ( V_53 , 0 ) ;
if ( F_42 ( V_53 ) <= V_150 ) return ( NULL ) ;
V_25 = F_43 ( V_53 , V_150 ) ;
return ( V_25 -> V_77 ) ;
}
