...
if ( V_18 == NULL )
if ( ! F_5 () ) return ( 0 ) ;
if ( ( V_30 = F_20 ( V_10 ) ) == NULL ) goto V_33;
if ( ! ( V_31 [ V_16 ] = ( T_2 * ) F_21 ( sizeof( T_2 ) ) ) ) goto V_34;
if ( ( V_30 -> V_12 != 0 ) && ( V_10 -> V_13 != NULL ) )
if ( ! ( V_31 [ V_11 ] = ( T_2 * ) F_21 ( sizeof( T_2 ) ) ) ) goto V_34;
if ( V_30 -> V_3 != NULL )
if ( ! ( V_31 [ V_14 ] = ( T_2 * ) F_21 ( sizeof( T_2 ) ) ) ) goto V_34;
if ( V_30 -> V_5 != NULL )
if ( ! ( V_31 [ V_15 ] = ( T_2 * ) F_21 ( sizeof( T_2 ) ) ) ) goto V_34;
...
V_33:
for ( V_7 = V_11 ; V_7 <= V_16 ; V_7 ++ )
if ( V_31 [ V_7 ] != NULL ) F_11 ( V_31 [ V_7 ] ) ;
if ( V_30 != NULL ) F_11 ( V_30 ) ;
return ( V_37 ) ;
}
T_1 * F_24 ( int V_38 )
{
...
V_39 . V_10 = ( T_1 * ) V_1 ;
V_40 = F_25 ( V_18 , & V_39 ) ;
if ( V_40 != NULL ) return ( V_40 -> V_10 -> V_17 ) ;
}
...
if( ( V_54 = ( unsigned char * ) F_21 ( V_48 ) ) == NULL ) return NULL ;
V_9 = V_54 ;
...
if ( V_7 <= 0 ) return ( V_28 ) ;
V_54 [ V_7 - 1 ] = '\0' ;
if ( ! isalnum ( ( unsigned char ) V_54 [ 0 ] ) ) return ( V_28 ) ;
V_30 = V_52 = V_54 ;
...
V_52 = NULL ;
if ( ( V_30 == NULL ) || ( * V_30 == '\0' ) ) return ( V_28 ) ;
if ( ! F_58 ( V_30 , V_52 , V_63 ) ) return ( V_28 ) ;
V_28 ++ ;
}
}
