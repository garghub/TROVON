...
{
if ( V_1 != V_2 &&
( V_12 || ( ( T_1 ) V_1 | ( T_1 ) V_2 | ( T_1 ) V_5 ) % sizeof( long ) == 0 ) )
{
T_3 * V_13 = ( T_3 * ) V_5 ;
...
F_3 ( ( unsigned char * ) V_16 -> V_18 , ( unsigned char * ) V_16 -> V_18 , V_4 ) ;
for( V_7 = 0 ; V_7 < V_17 ; ++ V_7 )
...
F_3 ( ( unsigned char * ) V_20 . V_18 , ( unsigned char * ) V_20 . V_18 , V_4 ) ;
for( V_7 = 0 ; V_7 < V_17 ; ++ V_7 )
...
F_6 ( ( unsigned char * ) V_19 . V_18 , ( unsigned char * ) V_16 -> V_18 , V_4 ) ;
for( V_7 = 0 ; V_7 < V_17 ; ++ V_7 )
...
F_6 ( ( unsigned char * ) V_19 . V_18 , ( unsigned char * ) V_19 . V_18 , V_4 ) ;
for( V_7 = 0 ; V_7 < V_17 ; ++ V_7 )
