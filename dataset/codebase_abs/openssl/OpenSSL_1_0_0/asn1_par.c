...
int F_9 ( T_1 * V_1 , const unsigned char * V_14 , long V_15 , int V_5 , int V_16 )
{
return ( F_8 ( V_1 , & V_14 , V_15 , 0 , 0 , V_5 , V_16 ) ) ;
}
static int F_8 ( T_1 * V_1 , const unsigned char * * V_14 , long V_17 , int V_18 ,
int V_19 , int V_5 , int V_16 )
{
...
V_5 , V_16 ) ;
if ( V_28 == 0 ) { V_24 = 0 ; goto V_32; }
if ( ( V_28 == 2 ) || ( V_8 >= V_21 ) ) break;
}
}
else
while ( V_8 < V_20 )
...
if ( ( V_15 > 0 ) &&
F_2 ( V_1 , ( const char * ) V_8 , ( int ) V_15 )
!= ( int ) V_15 )
goto V_32;
}
else if ( V_2 == V_41 )
...
V_24 = 1 ;
V_32:
if ( V_29 != NULL ) F_22 ( V_29 ) ;
if ( V_30 != NULL ) F_17 ( V_30 ) ;
* V_14 = V_8 ;
return ( V_24 ) ;
}
