...
T_1 V_8 , * V_3 ;
int V_9 = 0 , V_10 ;
if ( V_7 == NULL ) return ( NULL ) ;
if ( ( V_11 == NULL ) && ! F_9 () ) return ( NULL ) ;
V_10 = type & V_12 ;
type &= ~ V_12 ;
V_8 . V_7 = V_7 ;
V_8 . type = type ;
...
if ( V_3 != NULL )
{
if ( ( V_6 != NULL ) && ( F_2 ( V_6 ) > V_3 -> type ) )
{
F_3 ( V_6 ,
V_3 -> type ) -> F_14 ( V_3 -> V_7 , V_3 -> type , V_3 -> V_13 ) ;
}
F_15 ( V_3 ) ;
}
else
...
void F_22 ( int type , void (* V_17)( const T_1 * , void * V_18 ) ,
void * V_18 )
{
struct V_20 V_16 ;
int V_22 ;
V_16 . type = type ;
V_16 . V_21 = F_12 ( F_23 ( V_11 ) * sizeof * V_16 . V_21 ) ;
V_16 . V_22 = 0 ;
F_24 ( type , F_20 , & V_16 ) ;
