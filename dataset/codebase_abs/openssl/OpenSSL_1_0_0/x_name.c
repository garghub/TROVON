...
static int F_23 ( T_1 * * V_1 , unsigned char * * V_38 , const T_2 * V_2 , int V_17 , int V_18 )
{
int V_3 ;
T_3 * V_13 = ( T_3 * ) * V_1 ;
if( V_13 -> V_9 ) {
...
static int F_29 ( T_5 * V_38 , T_1 * * V_12 ,
int V_42 ,
const char * V_43 ,
const T_6 * V_44 )
{
if ( F_30 ( V_38 , ( T_3 * ) * V_12 ,
V_42 , V_44 -> V_45 ) <= 0 )
return 0 ;
return 2 ;
}
...
V_46 = F_31 () ;
V_46 -> V_47 = F_32 ( V_31 -> V_47 ) ;
if ( ! F_33 ( V_46 -> V_48 , V_31 -> V_48 ) )
goto V_33;
if( ! F_20 ( V_5 , V_46 ) )
goto V_33;
V_46 = NULL ;
}
V_13 -> V_8 = F_34 ( V_25 , NULL ) ;
V_21 = F_2 ( V_13 -> V_8 ) ;
if ( ! V_21 )
goto V_33;
V_13 -> V_7 = V_21 ;
...
static int F_33 ( T_7 * V_38 , T_7 * V_15 )
{
unsigned char * V_50 , * V_51 ;
int V_16 , V_28 ;
if ( ! ( F_35 ( V_15 -> type ) & V_52 ) )
{
V_38 -> type = V_15 -> type ;
if ( ! F_36 ( V_38 , V_15 -> V_34 , V_15 -> V_39 ) )
return 0 ;
return 1 ;
}
V_38 -> type = V_53 ;
V_38 -> V_39 = F_37 ( & V_38 -> V_34 , V_15 ) ;
if ( V_38 -> V_39 == - 1 )
return 0 ;
V_50 = V_38 -> V_34 ;
V_51 = V_50 ;
