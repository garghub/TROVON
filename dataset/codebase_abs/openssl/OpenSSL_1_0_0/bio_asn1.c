...
for(; ; )
{
V_27 = F_13 ( V_2 -> V_29 , V_3 -> V_18 + V_3 -> V_19 ,
V_3 -> V_20 ) ;
if ( V_27 <= 0 )
break;
V_3 -> V_20 -= V_27 ;
...
int F_27 ( T_2 * V_2 , T_4 * V_30 , T_4 * V_33 )
{
return F_25 ( V_2 , V_49 , V_30 , V_33 ) ;
}
int F_28 ( T_2 * V_2 , T_4 * * V_62 , T_4 * * V_63 )
{
return F_26 ( V_2 , V_51 , V_62 , V_63 ) ;
}
int F_29 ( T_2 * V_2 , T_4 * V_53 , T_4 * V_54 )
{
return F_25 ( V_2 , V_52 , V_53 , V_54 ) ;
}
int F_30 ( T_2 * V_2 , T_4 * * V_64 , T_4 * * V_65 )
{
