...
unsigned int V_27 , unsigned char * V_28 , unsigned int V_29 )
{
int V_7 = V_20 ;
struct V_8 * V_9 =
(struct V_8 * ) F_11 ( & V_6 -> V_24 ,
...
F_40 ( V_74 ) ;
if( V_76 < 0 ) return ( V_81 > 0 ) ? V_81 : V_76 ;
return V_81 ;
}
V_67 -> V_16 = V_76 ;
V_67 -> V_14 = V_6 -> V_62 ;
...
int V_76 ;
V_19 * V_68 ;
if( ! V_28 || ! V_82 ) return 0 ;
V_6 = ( T_5 * ) V_74 -> V_72 ;
if( V_6 -> V_69 ) return 0 ;
V_68 = & V_6 -> V_68 ;
F_35 ( V_74 ) ;
if( ! V_6 -> V_63 )
{
...
V_19 * V_68 ;
V_6 = ( T_5 * ) V_74 -> V_72 ;
if( ! V_6 -> V_63 || ( V_6 -> V_69 && ! V_6 -> V_85 ) ) return 1 ;
V_68 = & V_6 -> V_68 ;
F_35 ( V_74 ) ;
V_68 -> V_14 = NULL ;
V_68 -> V_16 = 0 ;
...
if( V_6 -> V_69 ) return 1 ;
V_6 -> V_84 = V_6 -> V_63 ;
V_68 -> V_15 = V_6 -> V_63 ;
V_68 -> V_17 = V_6 -> V_66 ;
V_76 = F_16 ( V_68 , V_87 ) ;
if( V_76 == V_78 ) V_6 -> V_69 = 1 ;
else if( V_76 != V_20 )
{
F_32 ( V_88 ,
V_86 ) ;
