...
V_11 = ( unsigned char * ) Malloc ( ( unsigned int ) V_8 + 1 ) ;
if ( V_11 == NULL )
{
F_4 ( V_16 , V_18 ) ;
return ( 0 ) ;
...
int F_6 ( int V_19 , unsigned char * V_1 ,
...
V_11 = ( unsigned char * ) Malloc ( ( unsigned int ) V_4 ) ;
if ( V_11 == NULL )
{
F_4 ( V_21 , V_18 ) ;
goto V_23;
}
V_7 = F_7 ( ( int ) V_4 , V_20 , V_11 , V_5 , V_15 ) ;
if ( V_7 <= 0 ) goto V_23;
V_10 = V_11 ;
V_6 = F_8 ( NULL , & V_10 , ( long ) V_7 ) ;
