...
T_3 * F_36 ( T_3 * * V_1 , unsigned char * * V_2 ,
long V_7 )
{
T_1 * V_49 ;
T_3 * V_50 ;
...
int F_37 ( T_3 * V_1 , unsigned char * * V_2 )
{
T_1 * V_49 = NULL ;
int V_9 ;
if( ! V_1 ) return 0 ;
if( ! F_19 ( & V_49 , V_1 ) ) return 0 ;
V_9 = F_1 ( V_49 , V_2 ) ;
V_13 ( V_49 ) ;
return V_9 ;
}
T_7 * F_38 ( T_7 * * V_1 , unsigned char * * V_2 ,
long V_7 )
{
T_3 * V_12 ;
T_7 * V_44 ;
...
int F_41 ( T_7 * V_1 , unsigned char * * V_2 )
{
T_3 * V_50 ;
int V_9 ;
if( ! V_1 ) return 0 ;
...
T_6 * F_45 ( T_6 * * V_1 , unsigned char * * V_2 ,
long V_7 )
{
T_3 * V_12 ;
T_6 * V_44 ;
...
int F_48 ( T_6 * V_1 , unsigned char * * V_2 )
{
T_3 * V_50 ;
int V_9 ;
if( ! V_1 ) return 0 ;
