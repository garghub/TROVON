...
if ( ! F_20 ( V_43 , & V_42 ) ) goto V_47;
if ( ! F_21 ( & V_42 , V_45 , & V_17 , V_22 , V_23 ) ) goto V_47;
V_44 = V_45 ;
...
V_50 = F_26 ( V_51 , V_53 , V_52 ) ;
F_27 ( V_51 ) ;
if( ! V_50 ) goto V_55;
V_25 = ( char * ) F_23 ( V_50 ) ;
if( V_21 ) {
if( * V_21 ) F_28 ( ( V_58 * ) * V_21 ) ;
* V_21 = V_25 ;
}
F_24 ( V_50 ) ;
}
...
int F_29 ( int (* F_30)() , const char * V_19 , T_1 * V_20 , char * V_21 ,
...
F_12 ( V_24 , V_20 , V_28 ) ;
V_25 = F_31 ( F_30 , V_19 , V_24 , V_21 , V_60 , V_61 , V_52 , V_62 , V_23 ) ;
F_14 ( V_24 ) ;
return ( V_25 ) ;
}
int F_31 ( int (* F_30)() , const char * V_19 , T_3 * V_41 , char * V_21 ,
const T_7 * V_60 , unsigned char * V_61 , int V_52 ,
T_2 * V_62 , void * V_23 )
{
T_8 V_64 ;
...
if ( ( V_65 = F_30 ( V_21 , NULL ) ) < 0 )
{
F_3 ( V_70 , V_72 ) ;
V_65 = 0 ;
goto V_47;
}
V_45 = ( unsigned char * ) Malloc ( ( unsigned int ) V_65 + 20 ) ;
if ( V_45 == NULL )
{
F_3 ( V_70 , V_72 ) ;
goto V_47;
...
if ( F_37 ( V_68 , 8 ) <= 0 )
goto V_47;
F_38 ( V_60 , F_39 () , V_68 , V_61 , V_52 , 1 , V_4 , NULL ) ;
if ( V_61 == ( unsigned char * ) V_1 ) memset ( V_1 , 0 , V_54 ) ;
V_1 [ 0 ] = '\0' ;
F_6 ( V_1 , V_14 ) ;
F_7 ( V_1 , V_66 , 8 , ( char * ) V_68 ) ;
F_40 ( & V_64 , V_60 , V_4 , V_68 ) ;
F_41 ( & V_64 , V_45 , & V_8 , V_45 , V_7 ) ;
F_42 ( & V_64 , & ( V_45 [ V_8 ] ) , & V_7 ) ;
V_7 += V_8 ;
V_25 = 1 ;
}
else
...
V_7 = F_43 ( V_41 , V_19 , V_1 , V_45 , V_7 ) ;
if ( V_7 <= 0 ) V_25 = 0 ;
V_47:
...
int F_21 ( T_4 * V_42 , unsigned char * V_45 , long * V_74 ,
T_2 * V_62 , void * V_23 )
{
...
F_35 ( V_1 , V_1 , V_52 ) ;
#endif
F_38 ( V_42 -> V_42 , F_39 () , & ( V_42 -> V_68 [ 0 ] ) ,
( unsigned char * ) V_1 , V_52 , 1 , V_4 , NULL ) ;
V_8 = ( int ) V_17 ;
F_44 ( & V_64 , V_42 -> V_42 , V_4 , & ( V_42 -> V_68 [ 0 ] ) ) ;
F_45 ( & V_64 , V_45 , & V_7 , V_45 , V_8 ) ;
V_75 = F_46 ( & V_64 , & ( V_45 [ V_7 ] ) , & V_8 ) ;
F_47 ( & V_64 ) ;
...
if ( ! F_50 ( ( unsigned char * * ) & V_43 , & ( V_42 -> V_68 [ 0 ] ) , 8 ) ) return ( 0 ) ;
return ( 1 ) ;
}
static int F_50 ( unsigned char * * V_85 , unsigned char * V_86 , int V_2 )
{
int V_87 , V_7 ;
unsigned char * V_88 ;
V_88 = * V_85 ;
...
int F_51 ( T_1 * V_20 , char * V_19 , char * V_43 , unsigned char * V_45 ,
long V_17 )
{
T_3 * V_24 ;
int V_25 ;
...
F_12 ( V_24 , V_20 , V_28 ) ;
V_25 = F_43 ( V_24 , V_19 , V_43 , V_45 , V_17 ) ;
F_14 ( V_24 ) ;
return ( V_25 ) ;
}
int F_43 ( T_3 * V_41 , const char * V_19 , char * V_43 , unsigned char * V_45 ,
long V_17 )
{
...
F_52 ( & V_64 ) ;
V_92 = strlen ( V_19 ) ;
if ( ( F_53 ( V_41 , L_14 , 11 ) != 11 ) ||
( F_53 ( V_41 , V_19 , V_92 ) != V_92 ) ||
( F_53 ( V_41 , L_15 , 6 ) != 6 ) )
goto V_47;
V_7 = strlen ( V_43 ) ;
if ( V_7 > 0 )
{
if ( ( F_53 ( V_41 , V_43 , V_7 ) != V_7 ) ||
( F_53 ( V_41 , L_8 , 1 ) != 1 ) )
goto V_47;
}
V_1 = ( unsigned char * ) Malloc ( V_54 * 8 ) ;
if ( V_1 == NULL )
{
V_95 = V_72 ;
goto V_47;
...
F_54 ( & V_64 , V_1 , & V_94 , & ( V_45 [ V_8 ] ) , V_93 ) ;
if ( ( V_94 ) && ( F_53 ( V_41 , ( char * ) V_1 , V_94 ) != V_94 ) )
goto V_47;
V_7 += V_94 ;
V_17 -= V_93 ;
V_8 += V_93 ;
...
F_55 ( & V_64 , V_1 , & V_94 ) ;
if ( ( V_94 > 0 ) && ( F_53 ( V_41 , ( char * ) V_1 , V_94 ) != V_94 ) ) goto V_47;
Free ( V_1 ) ;
if ( ( F_53 ( V_41 , L_16 , 9 ) != 9 ) ||
( F_53 ( V_41 , V_19 , V_92 ) != V_92 ) ||
( F_53 ( V_41 , L_15 , 6 ) != 6 ) )
goto V_47;
return ( V_7 + V_94 ) ;
...
int F_56 ( T_1 * V_20 , char * * V_19 , char * * V_43 , unsigned char * * V_45 ,
long * V_17 )
{
T_3 * V_24 ;
int V_25 ;
...
V_7 = F_62 ( & V_64 , ( unsigned char * ) & ( V_105 -> V_45 [ V_100 ] ) , & V_99 ) ;
if ( V_7 < 0 )
{
F_3 ( V_107 , V_109 ) ;
goto V_47;
...
int F_64 ( T_3 * V_41 , V_58 * V_21 , int V_110 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
return F_65 ( V_41 , V_21 , 0 , V_110 , NULL , V_61 , V_52 , V_22 , V_23 ) ;
}
int F_66 ( T_3 * V_41 , V_58 * V_21 , const T_7 * V_60 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
return F_65 ( V_41 , V_21 , 0 , - 1 , V_60 , V_61 , V_52 , V_22 , V_23 ) ;
}
int F_67 ( T_3 * V_41 , V_58 * V_21 , const T_7 * V_60 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
return F_65 ( V_41 , V_21 , 1 , - 1 , V_60 , V_61 , V_52 , V_22 , V_23 ) ;
}
int F_68 ( T_3 * V_41 , V_58 * V_21 , int V_110 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
return F_65 ( V_41 , V_21 , 1 , V_110 , NULL , V_61 , V_52 , V_22 , V_23 ) ;
}
static int F_65 ( T_3 * V_41 , V_58 * V_21 , int V_111 , int V_110 , const T_7 * V_60 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
T_6 * V_51 ;
...
V_51 = F_70 ( V_110 , V_60 , V_61 , V_52 , NULL , 0 , 0 , V_50 ) ;
if( V_61 == V_1 ) memset ( V_1 , 0 , V_52 ) ;
F_24 ( V_50 ) ;
if( V_111 ) V_25 = F_71 ( V_41 , V_51 ) ;
else V_25 = F_72 ( V_41 , V_51 ) ;
F_27 ( V_51 ) ;
return V_25 ;
} else {
if( V_111 ) V_25 = F_73 ( V_41 , V_50 ) ;
else V_25 = F_74 ( V_41 , V_50 ) ;
F_24 ( V_50 ) ;
return V_25 ;
}
}
V_58 * F_75 ( T_3 * V_41 , V_58 * * V_21 , T_2 * V_22 , void * V_23 )
{
T_5 * V_50 = NULL ;
T_6 * V_51 = NULL ;
int V_52 ;
...
int F_77 ( T_1 * V_20 , V_58 * V_21 , const T_7 * V_60 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
return F_78 ( V_20 , V_21 , 1 , - 1 , V_60 , V_61 , V_52 , V_22 , V_23 ) ;
}
int F_79 ( T_1 * V_20 , V_58 * V_21 , int V_110 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
return F_78 ( V_20 , V_21 , 1 , V_110 , NULL , V_61 , V_52 , V_22 , V_23 ) ;
}
int F_80 ( T_1 * V_20 , V_58 * V_21 , int V_110 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
return F_78 ( V_20 , V_21 , 0 , V_110 , NULL , V_61 , V_52 , V_22 , V_23 ) ;
}
int F_81 ( T_1 * V_20 , V_58 * V_21 , const T_7 * V_60 ,
char * V_61 , int V_52 , T_2 * V_22 , void * V_23 )
{
return F_78 ( V_20 , V_21 , 0 , - 1 , V_60 , V_61 , V_52 , V_22 , V_23 ) ;
}
static int F_78 ( T_1 * V_20 , V_58 * V_21 , int V_111 , int V_110 , const T_7 * V_60 ,
char * V_61 , int V_52 ,
T_2 * V_22 , void * V_23 )
{
T_3 * V_41 ;
int V_25 ;
if( ! ( V_41 = F_82 ( V_20 , V_28 ) ) ) {
F_3 ( V_115 , V_27 ) ;
return ( 0 ) ;
}
V_25 = F_65 ( V_41 , V_21 , V_111 , V_110 , V_60 , V_61 , V_52 , V_22 , V_23 ) ;
F_14 ( V_41 ) ;
return V_25 ;
}
V_58 * F_83 ( T_1 * V_20 , V_58 * * V_21 , T_2 * V_22 , void * V_23 )
{
T_3 * V_41 ;
V_58 * V_25 ;
if( ! ( V_41 = F_82 ( V_20 , V_28 ) ) ) {
