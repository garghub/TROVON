...
static int F_4 ( T_2 * V_15 , char * V_16 , int V_17 )
{
...
{
if ( V_3 -> V_8 <= 0 ) break;
V_19 = F_6 ( V_15 -> V_29 , & ( V_3 -> V_33 [ V_3 -> V_5 ] ) ,
V_34 - V_3 -> V_5 ) ;
if ( V_19 <= 0 )
{
V_26 = V_19 ;
...
int V_36 , V_37 ;
V_37 = ( V_19 >> 2 ) << 2 ;
V_36 = F_10 ( ( unsigned char * ) V_3 -> V_32 ,
...
static int F_13 ( T_2 * V_15 , char * V_38 , int V_39 )
{
...
while ( V_24 > 0 )
{
V_19 = F_15 ( V_15 -> V_29 , & ( V_3 -> V_32 [ V_3 -> V_7 ] ) , V_24 ) ;
if ( V_19 <= 0 )
{
F_12 ( V_15 ) ;
return ( V_19 ) ;
...
static long F_18 ( T_2 * V_15 , int V_41 , long V_25 , char * V_12 )
{
T_3 * V_3 ;
long V_18 = 1 ;
int V_19 ;
...
V_3 -> V_9 = 1 ;
V_3 -> V_10 = V_43 ;
V_18 = F_19 ( V_15 -> V_29 , V_41 , V_25 , V_12 ) ;
break;
case V_44 :
if ( V_3 -> V_8 <= 0 )
V_18 = 1 ;
...
static long F_21 ( T_2 * V_15 , int V_41 , void (* F_22)() )
{
long V_18 = 1 ;
