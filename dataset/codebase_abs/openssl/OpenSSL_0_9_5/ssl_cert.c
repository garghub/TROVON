...
int F_22 ( T_3 * V_47 , T_4 * V_48 )
{
return ( F_23 ( & ( V_47 -> V_49 ) , V_48 ) ) ;
}
int F_24 ( T_5 * V_50 , T_4 * V_48 )
{
return ( F_23 ( & ( V_50 -> V_49 ) , V_48 ) ) ;
}
static int F_25 ( T_6 * * V_51 , T_6 * * V_52 )
{
return ( F_26 ( * V_51 , * V_52 ) ) ;
}
