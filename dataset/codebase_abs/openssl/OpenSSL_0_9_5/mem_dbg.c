...
int F_16 ( const char * V_22 , const char * V_23 , int line )
{
T_2 * V_24 , * V_25 ;
int V_2 = 0 ;
if ( F_17 () )
{
F_18 () ;
if ( ( V_24 = ( T_2 * ) Malloc ( sizeof( T_2 ) ) ) == NULL )
{
V_2 = 0 ;
goto V_26;
}
...
void F_23 ( void * V_15 , int V_27 , const char * V_23 , int line ,
int V_28 )
{
T_1 * V_29 , * V_30 ;
T_2 V_17 , * V_25 ;
...
{
F_18 () ;
if ( ( V_29 = ( T_1 * ) Malloc ( sizeof( T_1 ) ) ) == NULL )
{
Free ( V_15 ) ;
F_20 () ;
return;
...
V_29 -> V_36 = NULL ;
if ( V_18 != NULL
&& ( V_25 = ( T_2 * ) F_24 ( V_18 , ( char * ) & V_17 ) ) != NULL )
{
V_29 -> V_36 = V_25 ;
V_25 -> V_20 ++ ;
}
...
void F_26 ( void * V_38 , void * V_39 , int V_27 ,
...
if ( V_38 == NULL )
{
F_23 ( V_39 , V_27 , V_23 , line , 128 | V_28 ) ;
break;
}
if ( F_17 () )
{
...
static void F_27 ( T_1 * V_29 , T_3 * V_40 )
{
char V_41 [ 1024 ] ;
char * V_42 = V_41 ;
T_2 * V_43 ;
...
static void F_31 ( T_1 * V_29 , char * V_57 )
{
union V_58 V_59 ;
V_59 . V_60 = V_57 ;
V_59 . V_61 ( V_29 -> V_33 , V_29 -> V_23 , V_29 -> line , V_29 -> V_27 , V_29 -> V_15 ) ;
}
void F_32 ( void (* V_57)() )
{
union V_58 V_62 ;
