...
static long F_15 ( T_2 * V_17 , int V_26 , void (* F_16)() )
{
long V_28 = 1 ;
if ( V_17 -> V_22 == NULL ) return ( 0 ) ;
switch ( V_26 )
{
default:
V_28 = F_17 ( V_17 -> V_22 , V_26 , F_16 ) ;
break;
}
return ( V_28 ) ;
}
static int F_18 ( T_2 * V_17 , char * V_48 , int V_49 )
{
T_3 * V_3 ;
...
static int F_19 ( T_2 * V_17 , char * V_52 )
{
