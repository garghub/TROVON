...
|| memcmp ( V_4 , V_1 -> V_4 -> V_15 -> V_28 -> V_13 , V_5 ) ) {
F_4 ( V_25 , V_29 ) ;
return 0 ;
}
return 1 ;
...
if ( ! ( V_1 -> V_4 -> V_10 -> V_13 = Malloc ( V_11 ) ) ) {
F_4 ( V_34 , V_35 ) ;
return 0 ;
}
if ( ! V_10 ) {
if ( F_17 ( V_1 -> V_4 -> V_10 -> V_13 , V_11 ) <= 0 )
return 0 ;
}
else memcpy ( V_1 -> V_4 -> V_10 -> V_13 , V_10 , V_11 ) ;
V_1 -> V_4 -> V_15 -> V_16 -> V_17 = F_18 ( F_19 ( V_6 ) ) ;
if ( ! ( V_1 -> V_4 -> V_15 -> V_16 -> V_37 = F_20 () ) ) {
F_4 ( V_34 , V_35 ) ;
return 0 ;
}
V_1 -> V_4 -> V_15 -> V_16 -> V_37 -> type = V_38 ;
return 1 ;
}
