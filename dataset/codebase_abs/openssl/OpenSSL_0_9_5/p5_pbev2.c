...
F_28 ( V_35 , F_29 ( V_29 ) ) ;
F_30 ( & V_34 , V_29 , NULL , V_35 , 0 ) ;
if( F_31 ( & V_34 , V_31 -> V_47 ) < 0 ) {
F_26 ( V_42 ,
V_48 ) ;
goto V_44;
}
F_32 ( & V_34 ) ;
if( ! ( V_37 = F_19 () ) ) goto V_45;
if( ! ( V_39 = F_33 () ) ) goto V_45;
if ( ! V_30 ) V_30 = V_49 ;
if ( ! ( V_39 -> V_50 = Malloc ( V_30 ) ) ) goto V_45;
V_39 -> V_10 = V_30 ;
if ( V_14 ) memcpy ( V_39 -> V_50 , V_14 , V_30 ) ;
else if ( F_34 ( V_39 -> V_50 , V_30 ) <= 0 ) goto V_45;
if( V_16 <= 0 ) V_16 = V_51 ;
if( ! F_35 ( V_37 -> V_16 , V_16 ) ) goto V_45;
