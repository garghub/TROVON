...
V_14 -> type = type ;
V_14 -> V_13 = V_13 ;
V_6 = ( T_1 * ) F_13 ( V_1 , V_14 ) ;
if ( V_6 != NULL )
{
if ( ( V_7 != NULL ) && ( F_5 ( V_7 ) > V_6 -> type ) )
{
F_6 ( V_7 , V_6 -> type )
-> F_14 ( V_6 -> V_8 , V_6 -> type , V_6 -> V_13 ) ;
}
Free ( V_6 ) ;
}
else
...
int F_16 ( const char * V_8 , int type )
{
T_1 V_9 , * V_6 ;
...
static void F_18 ( T_1 * V_14 , int type )
{
if( V_14 == NULL )
return;
if ( ( V_15 < 0 ) || ( V_15 == V_14 -> type ) )
{
F_16 ( V_14 -> V_8 , V_14 -> type ) ;
}
}
