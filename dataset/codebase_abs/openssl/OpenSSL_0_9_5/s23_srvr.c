...
F_23 ( V_10 , & ( V_10 -> V_49 [ 2 ] ) , V_10 -> V_66 - 2 ) ;
V_37 = V_10 -> V_49 ;
V_37 += 5 ;
F_24 ( V_37 , V_41 ) ;
F_24 ( V_37 , V_42 ) ;
F_24 ( V_37 , V_43 ) ;
V_38 = ( unsigned char * ) V_10 -> V_23 -> V_67 ;
if ( ( V_41 + V_42 + V_43 + 11 ) != V_10 -> V_66 )
{
F_19 ( V_59 , V_68 ) ;
goto V_48;
}
* ( V_38 ++ ) = V_53 ;
* ( V_38 ++ ) = V_46 [ 1 ] ;
V_40 = ( V_43 > V_69 ) ? V_69 : V_43 ;
memset ( V_38 , 0 , V_69 ) ;
memcpy ( & ( V_38 [ V_69 - V_40 ] ) , & ( V_37 [ V_41 + V_42 ] ) , V_40 ) ;
V_38 += V_69 ;
* ( V_38 ++ ) = 0 ;
V_45 = 0 ;
V_39 = V_38 ;
...
* ( V_38 ++ ) = 1 ;
* ( V_38 ++ ) = 0 ;
V_40 = ( V_38 - ( unsigned char * ) V_10 -> V_23 -> V_67 ) ;
V_10 -> V_70 -> V_71 . V_72 = 1 ;
V_10 -> V_70 -> V_71 . V_73 = V_62 ;
V_10 -> V_70 -> V_71 . V_74 = V_40 ;
}
if ( type == 1 )
{
#ifdef F_2
...
V_10 -> V_81 = V_82 ;
V_10 -> V_66 = V_44 ;
V_10 -> V_49 = & ( V_10 -> V_76 -> V_83 [ 0 ] ) ;
memcpy ( V_10 -> V_49 , V_11 , V_44 ) ;
V_10 -> V_76 -> V_84 = V_44 ;
V_10 -> V_76 -> V_85 = 0 ;
V_10 -> V_86 = F_3 () ;
V_10 -> V_87 = V_10 -> V_86 -> V_7 ;
#endif
}
if ( ( type == 2 ) || ( type == 3 ) )
{
...
V_10 -> V_81 = V_82 ;
V_10 -> V_66 = V_44 ;
V_10 -> V_49 = & ( V_10 -> V_70 -> V_83 . V_11 [ 0 ] ) ;
memcpy ( V_10 -> V_49 , V_11 , V_44 ) ;
V_10 -> V_70 -> V_83 . V_89 = V_44 ;
V_10 -> V_70 -> V_83 . V_90 = 0 ;
}
else
{
V_10 -> V_66 = 0 ;
V_10 -> V_70 -> V_83 . V_89 = 0 ;
V_10 -> V_70 -> V_83 . V_90 = 0 ;
}
if ( V_10 -> V_56 == V_4 )
V_10 -> V_86 = F_5 () ;
