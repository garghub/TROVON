...
char * V_6 ;
char * V_7 ;
V_6 = ( char * ) Malloc ( V_1 -> V_8 * V_9 * 2 + 2 ) ;
if ( V_6 == NULL )
{
F_2 ( V_10 , V_11 ) ;
goto V_12;
...
V_19 = ( T_2 * ) Malloc ( ( V_17 / V_21 + 1 ) * sizeof( T_2 ) ) ;
V_6 = ( char * ) Malloc ( V_17 + 3 ) ;
if ( ( V_6 == NULL ) || ( V_19 == NULL ) )
{
F_2 ( V_22 , V_11 ) ;
goto V_12;
}
if ( ( V_18 = F_5 ( V_1 ) ) == NULL ) goto V_12;
V_7 = V_6 ;
V_20 = V_19 ;
if ( V_18 -> V_13 ) * ( V_7 ++ ) = '-' ;
if ( V_18 -> V_8 == 0 )
...
V_12:
if ( V_19 != NULL ) Free ( V_19 ) ;
if ( V_18 != NULL ) F_8 ( V_18 ) ;
return ( V_6 ) ;
}
int F_9 ( T_1 * * V_26 , const char * V_1 )
{
T_1 * V_27 = NULL ;
T_2 V_28 = 0 ;
...
if ( F_12 ( V_27 , V_2 * 4 ) == NULL ) goto V_12;
V_3 = V_2 ;
V_30 = 0 ;
V_29 = 0 ;
while ( V_3 > 0 )
...
return ( V_17 ) ;
V_12:
if ( * V_26 == NULL ) F_8 ( V_27 ) ;
return ( 0 ) ;
}
int F_14 ( T_1 * * V_26 , const char * V_1 )
{
T_1 * V_27 = NULL ;
T_2 V_28 = 0 ;
int V_13 = 0 , V_2 , V_3 ;
...
int F_17 ( T_3 * V_33 , const T_1 * V_1 )
{
T_4 * V_34 ;
int V_27 ;
if ( ( V_34 = F_18 ( F_19 () ) ) == NULL )
return ( 0 ) ;
F_20 ( V_34 , V_33 , V_35 ) ;
V_27 = F_21 ( V_34 , V_1 ) ;
F_22 ( V_34 ) ;
...
int F_21 ( T_4 * V_36 , const T_1 * V_1 )
{
int V_2 , V_3 , V_4 , V_5 = 0 ;
int V_27 = 0 ;
if ( ( V_1 -> V_13 ) && ( F_23 ( V_36 , L_1 , 1 ) != 1 ) ) goto V_37;
if ( ( V_1 -> V_8 == 0 ) && ( F_23 ( V_36 , L_2 , 1 ) != 1 ) ) goto V_37;
for ( V_2 = V_1 -> V_8 - 1 ; V_2 >= 0 ; V_2 -- )
{
...
void F_24 ( T_3 * V_38 , const char * V_1 , T_2 * V_34 , int V_39 )
{
int V_2 ;
