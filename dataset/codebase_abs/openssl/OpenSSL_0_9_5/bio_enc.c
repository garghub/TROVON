...
static int F_6 ( T_2 * V_14 , char * V_15 , int V_16 )
{
int V_17 = 0 , V_18 ;
T_3 * V_3 ;
...
{
if ( V_3 -> V_7 <= 0 ) break;
V_18 = F_7 ( V_14 -> V_19 , & ( V_3 -> V_20 [ 8 ] ) , V_21 ) ;
if ( V_18 <= 0 )
{
if ( ! F_8 ( V_14 -> V_19 ) )
{
...
static int F_13 ( T_2 * V_14 , char * V_22 , int V_23 )
{
...
while ( V_24 > 0 )
{
V_18 = F_14 ( V_14 -> V_19 , & ( V_3 -> V_20 [ V_3 -> V_6 ] ) , V_24 ) ;
if ( V_18 <= 0 )
{
F_12 ( V_14 ) ;
return ( V_18 ) ;
...
static long F_15 ( T_2 * V_14 , int V_25 , long V_26 , char * V_11 )
{
T_2 * V_27 ;
T_3 * V_3 , * V_28 ;
long V_17 = 1 ;
...
V_3 -> V_9 = 1 ;
V_3 -> V_8 = 0 ;
F_16 ( & ( V_3 -> V_4 ) , NULL , NULL , NULL ,
V_3 -> V_4 . V_31 ) ;
V_17 = F_17 ( V_14 -> V_19 , V_25 , V_26 , V_11 ) ;
break;
case V_32 :
if ( V_3 -> V_7 <= 0 )
V_17 = 1 ;
...
static long F_18 ( T_2 * V_14 , int V_25 , void (* F_19)() )
{
long V_17 = 1 ;
...
{
default:
V_17 = F_20 ( V_14 -> V_19 , V_25 , F_19 ) ;
break;
}
return ( V_17 ) ;
}
void F_21 ( T_2 * V_14 , const T_5 * V_41 , unsigned char * V_42 ,
unsigned char * V_18 , int V_43 )
{
T_3 * V_3 ;
if ( V_14 == NULL ) return;
if ( ( V_14 -> V_44 != NULL ) &&
( V_14 -> V_44 ( V_14 , V_45 , ( const char * ) V_41 , V_46 , V_43 , 0L ) <= 0 ) )
return;
V_14 -> V_10 = 1 ;
V_3 = ( T_3 * ) V_14 -> V_11 ;
F_16 ( & ( V_3 -> V_4 ) , V_41 , V_42 , V_18 , V_43 ) ;
if ( V_14 -> V_44 != NULL )
V_14 -> V_44 ( V_14 , V_45 , ( const char * ) V_41 , V_46 , V_43 , 1L ) ;
}
