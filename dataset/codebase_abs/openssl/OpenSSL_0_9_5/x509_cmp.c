...
V_28 = V_27 ;
F_23 ( V_17 , & V_28 ) ;
F_24 ( ( unsigned char * ) V_27 , V_3 , & ( V_11 [ 0 ] ) ) ;
if ( V_27 != V_12 ) Free ( V_27 ) ;
V_9 = ( ( ( unsigned long ) V_11 [ 0 ] ) | ( ( unsigned long ) V_11 [ 1 ] << 8L ) |
( ( unsigned long ) V_11 [ 2 ] << 16L ) | ( ( unsigned long ) V_11 [ 3 ] << 24L )
) & 0xffffffffL ;
return ( V_9 ) ;
...
return ( NULL ) ;
return ( F_26 ( V_17 -> V_6 -> V_29 ) ) ;
}
int F_27 ( T_1 * V_17 , T_8 * V_30 )
{
T_8 * V_31 = NULL ;
int V_32 = 0 ;
V_31 = F_25 ( V_17 ) ;
...
#ifndef F_29
case V_36 :
if ( F_30 ( V_31 -> V_37 . V_38 -> V_39 , V_30 -> V_37 . V_38 -> V_39 ) != 0
|| F_30 ( V_31 -> V_37 . V_38 -> V_40 , V_30 -> V_37 . V_38 -> V_40 ) != 0 )
{
F_28 ( V_33 , V_41 ) ;
goto V_35;
}
...
#ifndef F_31
case V_42 :
if ( F_30 ( V_31 -> V_37 . V_43 -> V_44 , V_30 -> V_37 . V_43 -> V_44 ) != 0 )
{
F_28 ( V_33 , V_41 ) ;
goto V_35;
}
