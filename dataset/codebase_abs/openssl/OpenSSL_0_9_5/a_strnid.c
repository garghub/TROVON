...
V_15 = F_6 ( V_8 , V_9 , V_10 , V_11 , V_13 -> V_1 ,
V_13 -> V_18 , V_13 -> V_19 ) ;
} else V_15 = F_7 ( V_8 , V_9 , V_10 , V_11 , V_20 & V_2 ) ;
if( V_15 <= 0 ) return NULL ;
return * V_8 ;
}
static int F_8 ( T_2 * * V_21 , T_2 * * V_22 )
{
return ( * V_21 ) -> V_12 - ( * V_22 ) -> V_12 ;
}
static int F_9 ( T_2 * V_21 , T_2 * V_22 )
{
return V_21 -> V_12 - V_22 -> V_12 ;
}
T_2 * F_5 ( int V_12 )
