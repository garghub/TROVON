...
static void F_20 ( struct V_6 * V_44 )
{
int V_3 ;
if( V_44 == NULL )
return;
...
if ( V_44 -> V_47 != NULL ) Free ( V_44 -> V_47 ) ;
Free ( V_44 ) ;
}
...
int V_4 ;
#ifdef F_24
signal ( F_24 , ( void ( * ) ( int ) ) V_58 ) ;
#endif
V_57 = 1 ;
memset ( & V_56 , 0 , sizeof( V_56 ) ) ;
if ( F_25 ( 0x0101 , & V_56 ) != 0 )
{
V_4 = F_26 () ;
F_13 ( V_59 , V_4 ) ;
F_3 ( V_60 , V_61 ) ;
...
int F_29 ( int V_62 , long type , unsigned long * V_63 )
{
int V_3 ;
V_3 = F_30 ( V_62 , type , V_63 ) ;
if ( V_3 < 0 )
F_13 ( V_64 , F_14 () ) ;
return ( V_3 ) ;
}
...
int V_79 ;
if ( ! F_4 () ) return ( V_80 ) ;
if ( ( V_1 = F_32 ( V_69 ) ) == NULL ) return ( V_80 ) ;
V_77 = V_32 = NULL ;
V_77 = V_1 ;
...
( ( unsigned long ) V_2 [ 3 ] ) ;
V_72 . V_83 . V_84 = F_34 ( V_78 ) ;
}
V_86:
V_18 = F_35 ( V_13 , V_87 , V_88 ) ;
if ( V_18 == V_80 )
{
F_13 ( V_89 , F_14 () ) ;
...
{
int V_3 = 1 ;
V_45 = F_37 ( V_18 , V_27 , F_36 , ( char * ) & V_3 , sizeof( V_3 ) ) ;
V_70 = V_93 ;
}
#endif
if ( F_38 ( V_18 , (struct V_94 * ) & V_72 , sizeof( V_72 ) ) == - 1 )
{
#ifdef F_36
V_79 = F_14 () ;
if ( ( V_70 == V_95 ) &&
...
if ( strcmp ( V_77 , L_12 ) == 0 )
V_73 . V_83 . V_84 = F_34 ( 0x7F000001 ) ;
V_74 = F_35 ( V_13 , V_87 , V_88 ) ;
if ( V_74 != V_80 )
{
int V_97 ;
V_97 = F_39 ( V_74 , (struct V_94 * ) & V_73 ,
sizeof( V_73 ) ) ;
F_40 ( V_74 ) ;
if ( V_97 == V_80 )
{
...
V_104 = sizeof( V_103 ) ;
V_45 = F_43 ( V_24 , (struct V_94 * ) & V_103 , ( void * ) & V_104 ) ;
if ( V_45 == V_80 )
{
F_13 ( V_105 , F_14 () ) ;
F_3 ( V_106 , V_107 ) ;
...
int F_45 ( int V_18 , int V_108 )
{
int V_45 = 0 ;
#if F_46 ( V_109 ) && ( F_46 ( V_110 ) || F_46 ( V_111 ) )
int V_112 ;
#ifdef V_111
V_112 = V_111 ;
#else
...
#endif
#endif
V_45 = F_37 ( V_18 , V_112 , V_109 , ( char * ) & V_108 , sizeof( V_108 ) ) ;
#endif
return ( V_45 == 0 ) ;
}
int F_47 ( int V_18 , int V_113 )
{
int V_45 = - 1 ;
unsigned long V_78 ;
V_78 = V_113 ;
#ifdef F_48
V_45 = F_29 ( V_18 , F_48 , & V_78 ) ;
#endif
return ( V_45 == 0 ) ;
}
