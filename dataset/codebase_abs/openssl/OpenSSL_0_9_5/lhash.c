...
F_3 ( V_1 ) ;
V_10 = F_4 ( V_1 , V_8 , & V_9 ) ;
if ( * V_10 == NULL )
{
if ( ( V_4 = ( T_2 * ) Malloc ( sizeof( T_2 ) ) ) == NULL )
{
V_1 -> error ++ ;
return ( NULL ) ;
}
...
void F_9 ( T_1 * V_1 , void (* F_10)() )
{
F_11 ( V_1 , F_10 , NULL ) ;
}
void F_11 ( T_1 * V_1 , void (* F_10)() , void * V_23 )
{
int V_2 ;
T_2 * V_24 , * V_3 ;
...
static T_2 * * F_4 ( T_1 * V_1 , void * V_8 , unsigned long * V_38 )
{
T_2 * * V_11 , * V_25 ;
...
#endif
V_1 -> V_41 ++ ;
if ( (* F_12)( V_25 -> V_8 , V_8 ) == 0 )
break;
V_11 = & ( V_25 -> V_7 ) ;
}
return ( V_11 ) ;
}
unsigned long F_13 ( const char * V_42 )
{
