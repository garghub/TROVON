...
else if ( ( strcmp ( V_15 [ 0 ] , L_9 ) == 0 ) ||
( strcmp ( V_15 [ 0 ] , L_10 ) == 0 ) ||
( strcmp ( V_15 [ 0 ] , L_11 ) == 0 ) ||
( strcmp ( V_15 [ 0 ] , L_12 ) == 0 ) )
{
V_13 = - 1 ;
goto V_34;
}
...
V_41 = V_45 ;
V_42 = F_33 ( stdout , V_27 ) ;
for ( V_8 = V_46 ; V_8 -> V_32 != NULL ; V_8 ++ )
if ( V_8 -> type == V_41 )
F_21 ( V_42 , L_13 , V_8 -> V_32 ) ;
F_32 ( V_42 ) ;
V_13 = 0 ;
goto V_34;
}
...
static int F_34 ( const void * V_47 , const void * V_48 )
{
const T_1 * V_49 = V_47 ;
const T_1 * V_50 = V_48 ;
...
;
qsort ( V_46 , V_1 , sizeof *V_46 , F_34 ) ;
if ( ( V_13 = F_35 ( V_51 , V_52 ) ) == NULL ) return ( NULL ) ;
