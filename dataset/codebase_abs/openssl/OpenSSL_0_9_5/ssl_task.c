...
int V_40 = 0 ;
V_34 = F_19 ( V_21 ) ;
if ( V_34 == NULL ) goto V_41;
V_35 = F_7 ( F_20 () ) ;
V_36 = F_7 ( F_20 () ) ;
if ( ( V_36 == NULL ) || ( V_35 == NULL ) ) goto V_41;
F_21 ( V_35 , 0 , V_1 ) ;
F_21 ( V_36 , 0 , V_1 ) ;
V_37 = F_7 ( F_22 () ) ;
V_38 = F_7 ( F_22 () ) ;
if ( ( V_37 == NULL ) || ( V_38 == NULL ) ) goto V_41;
F_23 ( V_34 ) ;
F_24 ( V_34 , V_35 , V_36 ) ;
F_25 ( V_38 , V_34 , V_42 ) ;
printf ( L_6 ) ;
...
if ( V_31 == 1 ) {
V_39 = F_26 ( V_38 , V_12 . V_46 , V_12 . V_4 ) ;
if ( V_39 < 0 ) V_31 = 3 ;
else {
V_12 . V_44 = 'A' ;
V_12 . V_45 = 'C' ;
V_12 . V_4 = V_39 ;
V_5 = F_3 ( V_1 , ( char * ) & V_12 , V_39 + V_43 ) ;
if ( ( V_5 & 1 ) == 0 ) break;
V_31 = 0 ;
}
} else if ( V_31 == 2 ) {
V_39 = F_27 ( V_38 , V_12 . V_46 , V_12 . V_4 ) ;
if ( V_39 < 0 ) V_31 = 3 ;
else {
V_12 . V_44 = 'A' ;
V_12 . V_45 = 'C' ;
V_12 . V_4 = 0 ;
V_5 = F_3 ( V_1 , ( char * ) & V_12 , V_43 ) ;
if ( ( V_5 & 1 ) == 0 ) break;
V_31 = 0 ;
}
}
...
if ( V_37 != NULL ) F_28 ( V_37 ) ;
if ( V_38 != NULL ) F_28 ( V_38 ) ;
return ( 0 ) ;
}
