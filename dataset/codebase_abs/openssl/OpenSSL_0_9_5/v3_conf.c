...
int F_32 ( T_2 * V_1 , T_3 * V_2 , char * V_47 ,
T_9 * V_52 )
{
T_1 * V_12 ;
F_11 ( T_1 ) * V_53 = NULL ;
...
if( V_52 ) V_50 = F_35 ( V_52 , V_53 ) ;
else V_50 = 1 ;
F_36 ( V_53 , F_29 ) ;
return V_50 ;
}
char * F_37 ( T_3 * V_2 , char * V_3 , char * V_47 )
{
if( V_2 -> V_54 -> V_55 )
return V_2 -> V_54 -> V_55 ( V_2 -> V_25 , V_3 , V_47 ) ;
return NULL ;
}
static char * F_38 ( void * V_25 , char * V_47 , char * V_4 )
{
return F_39 ( V_25 , V_47 , V_4 ) ;
}
void F_40 ( T_3 * V_2 , T_2 * V_56 )
{
V_2 -> V_54 = & V_57 ;
V_2 -> V_25 = V_56 ;
}
void F_41 ( T_3 * V_2 , T_7 * V_58 , T_7 * V_59 , T_9 * V_52 ,
T_8 * V_51 , int V_60 )
{
V_2 -> V_61 = V_58 ;
V_2 -> V_62 = V_59 ;
