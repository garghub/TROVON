...
static long F_12 ( T_2 * V_7 , int V_14 , void (* F_13)() )
{
long V_10 = 1 ;
if ( V_7 -> V_11 == NULL ) return ( 0 ) ;
switch ( V_14 )
{
default:
V_10 = F_14 ( V_7 -> V_11 , V_14 , F_13 ) ;
break;
}
return ( V_10 ) ;
}
static int F_15 ( T_2 * V_18 , char * V_19 , int V_20 )
{
if ( V_18 -> V_11 == NULL ) return ( 0 ) ;
return ( F_16 ( V_18 -> V_11 , V_19 , V_20 ) ) ;
}
static int F_17 ( T_2 * V_18 , char * V_21 )
{
if ( V_18 -> V_11 == NULL ) return ( 0 ) ;
return ( F_18 ( V_18 -> V_11 , V_21 ) ) ;
}
