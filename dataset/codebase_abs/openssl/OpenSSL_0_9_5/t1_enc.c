...
V_24 = F_2 ( V_63 ) ;
V_67 = F_15 ( V_61 ) ;
V_10 = V_64 ? ( V_67 < F_16 ( V_27 -> V_37 -> V_29 . V_68 ) ?
V_67 : F_16 ( V_27 -> V_37 -> V_29 . V_68 ) ) : V_67 ;
V_65 = F_17 ( V_61 ) ;
...
V_27 -> V_40 -> V_101 = 0 ;
F_19 ( V_60 , V_61 , V_55 , V_56 , ( V_43 & V_102 ) ) ;
#ifdef F_18
printf ( L_4 , V_43 ) ;
{ int V_98 ; for ( V_98 = 0 ; V_98 < F_15 ( V_61 ) ; V_98 ++ ) printf ( L_3 , V_55 [ V_98 ] , ( ( V_98 + 1 ) % 16 ) ? ' ' : '\n' ) ; }
printf ( L_5 ) ;
...
return ( 1 ) ;
if ( ! F_21 ( V_27 -> V_40 , & V_61 , & V_106 , & V_62 ) )
{
F_13 ( V_107 , V_108 ) ;
return ( 0 ) ;
}
...
V_30 = F_15 ( V_61 ) + F_2 ( V_106 ) + F_17 ( V_61 ) ;
V_30 *= 2 ;
F_22 ( V_27 ) ;
if ( ( V_104 = ( unsigned char * ) Malloc ( V_30 ) ) == NULL )
goto V_74;
if ( ( V_105 = ( unsigned char * ) Malloc ( V_30 ) ) == NULL )
goto V_74;
...
F_26 ( V_111 , V_110 -> V_117 , V_110 -> V_118 , V_112 ) ;
if ( ( V_113 != 1 ) && ! V_109 )
{
...
int F_28 ( T_3 * V_27 , T_8 * V_130 , unsigned char * V_6 )
{
unsigned int V_131 ;
T_8 V_11 ;
F_29 ( & V_11 , V_130 ) ;
...
int F_31 ( T_3 * V_27 , T_8 * V_132 , T_8 * V_133 ,
...
int F_32 ( T_3 * V_139 , unsigned char * V_1 , int V_109 )
{
T_7 * V_110 ;
...
int F_33 ( T_3 * V_27 , unsigned char * V_6 , unsigned char * V_31 ,
int V_23 )
{
