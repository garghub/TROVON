...
} else V_8 = F_1 ( stdout , V_29 ) ;
if ( V_9 ) {
if( V_14 == V_30 )
V_21 = F_10 ( V_7 , NULL , NULL , V_23 ) ;
else if( V_14 == V_38 )
V_21 = F_11 ( V_7 , NULL ) ;
else {
F_5 ( V_27 , L_38 ) ;
...
V_20 = F_30 ( V_19 , V_25 , strlen ( V_25 ) ) ;
F_23 ( V_19 ) ;
}
if ( ! V_20 ) {
F_5 ( V_27 , L_44 , V_4 ) ;
...
F_24 ( V_20 ) ;
if( V_15 == V_30 )
F_32 ( V_8 , V_21 , NULL , NULL , 0 , NULL , V_24 ) ;
else if( V_15 == V_38 )
F_33 ( V_8 , V_21 ) ;
else {
F_5 ( V_27 , L_38 ) ;
