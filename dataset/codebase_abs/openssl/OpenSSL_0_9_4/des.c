...
if ( V_49 == NULL )
{
if ( ( ( V_49 = Malloc ( V_50 + 8 ) ) == NULL ) ||
( ( V_51 = Malloc ( V_50 + 8 ) ) == NULL ) )
{
fputs ( L_5 , V_25 ) ;
Exit = 10 ;
goto V_52;
...
{
if ( V_19 )
V_26 = F_15 ( V_51 , 1 , ( unsigned int ) V_40 - V_3 ,
V_57 ) ;
else
...
if ( V_19 )
V_42 = F_17 ( & ( V_49 [ V_41 ] ) , 1 , V_50 , V_54 ) ;
else
...
int F_15 ( unsigned char * V_62 , int V_63 , unsigned int V_38 , T_3 * V_64 )
{
...
V_26 = F_18 ( ( unsigned char * ) V_59 , 45 , V_60 ) ;
...
V_59 [ V_68 + 1 ] = '\0' ;
V_59 [ V_68 + 2 ] = '\0' ;
V_26 = F_18 ( V_59 , V_68 , V_60 ) ;
fwrite ( V_60 , 1 , ( unsigned int ) V_26 , V_64 ) ;
}
fwrite ( V_70 , 1 , strlen ( V_70 ) , V_64 ) ;
}
int F_17 ( unsigned char * V_9 , int V_63 , unsigned int V_38 , T_3 * V_64 )
{
int V_3 , V_26 , V_71 ;
static int V_72 = 0 ;
static int V_73 = 0 ;
...
int F_18 ( unsigned char * V_8 , int V_38 , unsigned char * V_9 )
{
