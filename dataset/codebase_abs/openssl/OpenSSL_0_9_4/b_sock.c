...
V_18 = F_10 ( V_1 , L_2 ) ;
if( V_18 != NULL )
* V_16 = F_11 ( ( unsigned short ) V_18 -> V_22 ) ;
F_7 ( V_21 ) ;
if( V_18 == NULL )
{
if ( strcmp ( V_1 , L_3 ) == 0 )
...
int V_26 ;
V_26 = sizeof( int ) ;
V_3 = F_15 ( V_24 , V_27 , V_28 , ( void * ) & V_25 , ( void * ) & V_26 ) ;
if ( V_3 < 0 )
return ( 1 ) ;
else
return ( V_25 ) ;
}
long F_16 ( int V_29 , int V_30 , char * V_31 )
{
int V_3 ;
char * * V_32 ;
switch ( V_29 )
...
static struct V_6 * F_17 ( struct V_6 * V_44 )
{
struct V_6 * V_45 ;
int V_3 , V_25 ;
F_18 () ;
V_45 = (struct V_6 * ) Malloc ( sizeof( struct V_6 ) ) ;
if ( V_45 == NULL ) return ( NULL ) ;
memset ( V_45 , 0 , sizeof( struct V_6 ) ) ;
for ( V_3 = 0 ; V_44 -> V_46 [ V_3 ] != NULL ; V_3 ++ )
;
V_3 ++ ;
V_45 -> V_46 = ( char * * ) Malloc ( V_3 * sizeof( char * ) ) ;
if ( V_45 -> V_46 == NULL )
goto V_4;
...
;
V_3 ++ ;
V_45 -> V_15 = ( char * * ) Malloc ( V_3 * sizeof( char * ) ) ;
if ( V_45 -> V_15 == NULL )
goto V_4;
memset ( V_45 -> V_15 , 0 , V_3 * sizeof( char * ) ) ;
V_25 = strlen ( V_44 -> V_47 ) + 1 ;
if ( ( V_45 -> V_47 = Malloc ( V_25 ) ) == NULL ) goto V_4;
memcpy ( ( char * ) V_45 -> V_47 , V_44 -> V_47 , V_25 + 1 ) ;
for ( V_3 = 0 ; V_44 -> V_46 [ V_3 ] != NULL ; V_3 ++ )
{
V_25 = strlen ( V_44 -> V_46 [ V_3 ] ) + 1 ;
if ( ( V_45 -> V_46 [ V_3 ] = Malloc ( V_25 ) ) == NULL ) goto V_4;
memcpy ( V_45 -> V_46 [ V_3 ] , V_44 -> V_46 [ V_3 ] , V_25 + 1 ) ;
}
V_45 -> V_48 = V_44 -> V_48 ;
V_45 -> V_12 = V_44 -> V_12 ;
for ( V_3 = 0 ; V_44 -> V_15 [ V_3 ] != NULL ; V_3 ++ )
{
if ( ( V_45 -> V_15 [ V_3 ] = Malloc ( V_44 -> V_48 ) ) == NULL )
goto V_4;
...
static void F_19 ( struct V_6 * V_44 )
{
int V_3 ;
if( V_44 == NULL )
return;
...
if ( V_44 -> V_47 != NULL ) Free ( ( char * ) V_44 -> V_47 ) ;
Free ( V_44 ) ;
}
...
F_19 ( V_40 [ V_49 ] . V_52 ) ;
V_40 [ V_49 ] . V_42 [ 0 ] = '\0' ;
if( ( V_45 = V_40 [ V_49 ] . V_52 = F_17 ( V_45 ) ) == NULL )
{
F_3 ( V_53 , V_54 ) ;
goto V_51;
}
...
int V_4 ;
#ifdef F_23
signal ( F_23 , ( void ( * ) ( int ) ) V_58 ) ;
#endif
V_57 = 1 ;
memset ( & V_56 , 0 , sizeof( V_56 ) ) ;
if ( F_24 ( 0x0101 , & V_56 ) != 0 )
{
V_4 = F_25 () ;
F_12 ( V_59 , V_4 ) ;
F_3 ( V_60 , V_61 ) ;
...
int F_28 ( int V_62 , long type , unsigned long * V_63 )
{
int V_3 ;
V_3 = F_29 ( V_62 , type , V_63 ) ;
if ( V_3 < 0 )
F_12 ( V_64 , F_13 () ) ;
return ( V_3 ) ;
}
...
int V_79 ;
if ( ! F_4 () ) return ( V_80 ) ;
if ( ( V_1 = F_31 ( V_69 ) ) == NULL ) return ( V_80 ) ;
V_77 = V_32 = NULL ;
V_77 = V_1 ;
...
( ( unsigned long ) V_2 [ 3 ] ) ;
V_72 . V_83 . V_84 = F_33 ( V_78 ) ;
}
V_86:
V_18 = F_34 ( V_13 , V_87 , V_88 ) ;
if ( V_18 == V_80 )
{
F_12 ( V_89 , F_13 () ) ;
...
{
int V_3 = 1 ;
V_45 = F_36 ( V_18 , V_27 , F_35 , ( char * ) & V_3 , sizeof( V_3 ) ) ;
V_70 = V_93 ;
}
#endif
if ( F_37 ( V_18 , (struct V_94 * ) & V_72 , sizeof( V_72 ) ) == - 1 )
{
#ifdef F_35
V_79 = F_13 () ;
if ( ( V_70 == V_95 ) &&
...
if ( strcmp ( V_77 , L_12 ) == 0 )
V_73 . V_83 . V_84 = F_33 ( 0x7F000001 ) ;
V_74 = F_34 ( V_13 , V_87 , V_88 ) ;
if ( V_74 != V_80 )
{
int V_97 ;
V_97 = F_38 ( V_74 , (struct V_94 * ) & V_73 ,
sizeof( V_73 ) ) ;
F_39 ( V_74 ) ;
if ( V_97 == V_80 )
{
...
V_104 = sizeof( V_103 ) ;
V_45 = F_42 ( V_24 , (struct V_94 * ) & V_103 , ( void * ) & V_104 ) ;
if ( V_45 == V_80 )
{
F_12 ( V_105 , F_13 () ) ;
F_3 ( V_106 , V_107 ) ;
...
V_78 = F_43 ( V_103 . V_83 . V_84 ) ;
V_75 = F_11 ( V_103 . V_82 ) ;
if ( * V_102 == NULL )
{
if ( ( V_32 = Malloc ( 24 ) ) == NULL )
{
F_3 ( V_106 , V_54 ) ;
goto V_51;
}
...
int F_44 ( int V_18 , int V_108 )
{
int V_45 = 0 ;
#if F_45 ( V_109 ) && ( F_45 ( V_110 ) || F_45 ( V_111 ) )
int V_112 ;
#ifdef V_111
V_112 = V_111 ;
#else
...
#endif
#endif
V_45 = F_36 ( V_18 , V_112 , V_109 , ( char * ) & V_108 , sizeof( V_108 ) ) ;
#endif
return ( V_45 == 0 ) ;
}
int F_46 ( int V_18 , int V_113 )
{
int V_45 = - 1 ;
unsigned long V_78 ;
V_78 = V_113 ;
#ifdef F_47
V_45 = F_28 ( V_18 , F_47 , & V_78 ) ;
#endif
return ( V_45 == 0 ) ;
}
