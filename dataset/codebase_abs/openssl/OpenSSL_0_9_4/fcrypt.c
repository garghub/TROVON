...
char * F_2 ( const char * V_1 , const char * V_2 )
{
static char V_3 [ 14 ] ;
#ifndef F_3
...
F_5 ( V_4 , V_4 , sizeof V_4 ) ;
F_5 ( V_5 , V_5 , sizeof V_5 ) ;
V_6 = F_4 ( V_5 , V_4 , V_3 ) ;
F_6 ( V_6 , V_6 , strlen ( V_6 ) ) ;
return V_6 ;
#endif
}
char * F_4 ( const char * V_1 , const char * V_2 , char * V_6 )
{
...
V_15 [ V_7 ] = 0 ;
F_7 ( & V_15 , V_16 ) ;
F_8 ( & ( V_13 [ 0 ] ) , V_16 , V_11 , V_12 ) ;
V_14 = V_13 [ 0 ] ; F_9 ( V_14 , V_18 ) ;
V_14 = V_13 [ 1 ] ; F_9 ( V_14 , V_18 ) ;
V_10 = 0 ;
V_20 = 0x80 ;
V_17 [ 8 ] = 0 ;
