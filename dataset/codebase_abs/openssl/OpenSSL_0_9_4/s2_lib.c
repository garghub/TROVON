...
{
F_18 ( & V_23 ) ;
F_19 ( & V_23 , V_5 -> V_41 -> V_42 , V_5 -> V_41 -> V_43 ) ;
F_19 ( & V_23 , ( unsigned char * ) & V_27 , 1 ) ;
V_27 ++ ;
F_19 ( & V_23 , V_5 -> V_6 -> V_44 , V_5 -> V_6 -> V_45 ) ;
F_19 ( & V_23 , V_5 -> V_6 -> V_46 , V_5 -> V_6 -> V_47 ) ;
F_20 ( V_36 , & V_23 ) ;
V_36 += V_40 ;
}
}
void F_21 ( T_3 * V_5 , int V_8 )
{
if ( ! V_5 -> error )
{
V_5 -> error = 3 ;
...
error = V_5 -> error ;
V_5 -> error = 0 ;
V_31 = F_23 ( V_5 , & ( V_49 [ 3 - error ] ) , error ) ;
if ( V_31 < 0 )
V_5 -> error = error ;
