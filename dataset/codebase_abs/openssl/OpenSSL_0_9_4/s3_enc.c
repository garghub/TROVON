...
V_10 = F_15 ( V_36 ) ;
V_39 = F_16 ( V_9 ) ;
V_11 = exp ? ( V_39 < F_17 ( V_1 -> V_18 -> V_40 . V_41 ) ?
V_39 : F_17 ( V_1 -> V_18 -> V_40 . V_41 ) ) : V_39 ;
V_12 = F_18 ( V_9 ) ;
if ( ( V_22 == V_63 ) ||
( V_22 == V_64 ) )
{
...
V_1 -> V_15 -> V_67 = 0 ;
F_19 ( V_34 , V_9 , V_30 , V_31 , ( V_22 & V_68 ) ) ;
...
return ( 1 ) ;
if ( ! F_21 ( V_1 -> V_15 , & V_9 , & V_70 , & V_35 ) )
{
F_13 ( V_71 , V_72 ) ;
return ( 0 ) ;
}
...
V_3 = F_16 ( V_9 ) + F_15 ( V_70 ) + F_18 ( V_9 ) ;
V_3 *= 2 ;
F_22 ( V_1 ) ;
if ( ( V_23 = ( unsigned char * ) Malloc ( V_3 ) ) == NULL )
goto V_48;
...
V_1 -> V_18 -> V_40 . V_65 ) ;
Free ( V_1 -> V_18 -> V_40 . V_24 ) ;
V_1 -> V_18 -> V_40 . V_24 = NULL ;
}
V_1 -> V_18 -> V_40 . V_65 = 0 ;
}
int F_23 ( T_1 * V_1 , int V_73 )
{
T_9 * V_74 ;
T_4 * V_75 ;
unsigned long V_76 ;
...
F_26 ( V_75 , V_74 -> V_80 , V_74 -> V_81 , V_76 ) ;
if ( ( V_77 != 1 ) && ! V_73 )
{
...
void F_28 ( T_1 * V_1 )
{
F_29 ( & ( V_1 -> V_18 -> V_88 ) , V_1 -> V_89 -> V_90 ) ;
F_29 ( & ( V_1 -> V_18 -> V_91 ) , V_1 -> V_89 -> V_92 ) ;
}
void F_30 ( T_1 * V_1 , const unsigned char * V_6 , int V_93 )
{
F_31 ( & ( V_1 -> V_18 -> V_88 ) , V_6 , V_93 ) ;
F_31 ( & ( V_1 -> V_18 -> V_91 ) , V_6 , V_93 ) ;
}
int F_32 ( T_1 * V_1 , T_10 * V_89 , unsigned char * V_23 )
{
return ( F_33 ( V_1 , V_89 , NULL , 0 , V_23 ) ) ;
}
int F_34 ( T_1 * V_1 , T_10 * V_94 , T_10 * V_95 ,
unsigned char * V_96 , int V_93 , unsigned char * V_23 )
{
int V_97 ;
V_97 = F_33 ( V_1 , V_94 , V_96 , V_93 , V_23 ) ;
V_23 += V_97 ;
V_97 += F_33 ( V_1 , V_95 , V_96 , V_93 , V_23 ) ;
return ( V_97 ) ;
}
static int F_33 ( T_1 * V_1 , T_10 * V_98 ,
unsigned char * V_96 , int V_93 , unsigned char * V_23 )
{
unsigned int V_97 ;
int V_99 , V_38 ;
...
if ( V_96 != NULL )
F_31 ( & V_89 , V_96 , V_93 ) ;
F_31 ( & V_89 , V_1 -> V_15 -> V_16 ,
V_1 -> V_15 -> V_17 ) ;
F_31 ( & V_89 , V_102 , V_99 ) ;
F_37 ( & V_89 , V_100 , & V_10 ) ;
F_29 ( & V_89 , F_38 ( & V_89 ) ) ;
F_31 ( & V_89 , V_1 -> V_15 -> V_16 ,
V_1 -> V_15 -> V_17 ) ;
F_31 ( & V_89 , V_103 , V_99 ) ;
F_31 ( & V_89 , V_100 , V_10 ) ;
F_37 ( & V_89 , V_23 , & V_97 ) ;
memset ( & V_89 , 0 , sizeof( T_10 ) ) ;
return ( ( int ) V_97 ) ;
}
int F_39 ( T_1 * V_104 , unsigned char * V_37 , int V_73 )
{
T_9 * V_74 ;
...
V_99 = ( 48 / V_109 ) * V_109 ;
F_29 ( & V_107 , V_70 ) ;
F_31 ( & V_107 , V_105 , V_109 ) ;
F_31 ( & V_107 , V_102 , V_99 ) ;
F_31 ( & V_107 , V_106 , 8 ) ;
V_108 = V_74 -> type ;
F_31 ( & V_107 , & V_108 , 1 ) ;
V_23 = V_37 ;
F_40 ( V_74 -> V_82 , V_23 ) ;
F_31 ( & V_107 , V_37 , 2 ) ;
F_31 ( & V_107 , V_74 -> V_81 , V_74 -> V_82 ) ;
F_37 ( & V_107 , V_37 , NULL ) ;
F_29 ( & V_107 , V_70 ) ;
F_31 ( & V_107 , V_105 , V_109 ) ;
F_31 ( & V_107 , V_103 , V_99 ) ;
F_31 ( & V_107 , V_37 , V_109 ) ;
F_37 ( & V_107 , V_37 , & V_109 ) ;
for ( V_10 = 7 ; V_10 >= 0 ; V_10 -- )
if ( ++ V_106 [ V_10 ] ) break;
return ( V_109 ) ;
}
int F_41 ( T_1 * V_1 , unsigned char * V_110 , unsigned char * V_23 ,
int V_93 )
{
...
{
F_29 ( & V_89 , V_1 -> V_89 -> V_92 ) ;
F_31 ( & V_89 , V_111 [ V_10 ] , strlen ( ( const char * ) V_111 [ V_10 ] ) ) ;
F_31 ( & V_89 , V_23 , V_93 ) ;
F_31 ( & V_89 , & ( V_1 -> V_18 -> V_21 [ 0 ] ) ,
V_20 ) ;
F_31 ( & V_89 , & ( V_1 -> V_18 -> V_19 [ 0 ] ) ,
V_20 ) ;
F_37 ( & V_89 , V_6 , & V_38 ) ;
F_29 ( & V_89 , V_1 -> V_89 -> V_90 ) ;
F_31 ( & V_89 , V_23 , V_93 ) ;
F_31 ( & V_89 , V_6 , V_38 ) ;
F_37 ( & V_89 , V_110 , & V_38 ) ;
V_110 += V_38 ;
V_97 += V_38 ;
}
return ( V_97 ) ;
