...
V_9 &= 0x0fffffffL ;
V_10 &= 0x0fffffffL ;
V_12 = V_20 [ 0 ] [ ( V_9 ) & 0x3f ] |
V_20 [ 1 ] [ ( ( V_9 >> 6 ) & 0x03 ) | ( ( V_9 >> 7L ) & 0x3c ) ] |
V_20 [ 2 ] [ ( ( V_9 >> 13 ) & 0x0f ) | ( ( V_9 >> 14L ) & 0x30 ) ] |
V_20 [ 3 ] [ ( ( V_9 >> 20 ) & 0x01 ) | ( ( V_9 >> 21L ) & 0x06 ) |
( ( V_9 >> 22L ) & 0x38 ) ] ;
V_11 = V_20 [ 4 ] [ ( V_10 ) & 0x3f ] |
V_20 [ 5 ] [ ( ( V_10 >> 7L ) & 0x03 ) | ( ( V_10 >> 8L ) & 0x3c ) ] |
V_20 [ 6 ] [ ( V_10 >> 15L ) & 0x3f ] |
V_20 [ 7 ] [ ( ( V_10 >> 21L ) & 0x0f ) | ( ( V_10 >> 22L ) & 0x30 ) ] ;
