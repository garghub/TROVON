...
F_13 () ;
( void ) F_14 ( V_15 ) ;
if ( ( V_46 = F_15 ( V_15 , NULL , NULL , NULL ) ) == NULL )
{
F_16 ( V_39 , L_14 ) ;
goto V_49;
}
...
F_90 ( V_93 ) * V_94 , * V_95 = NULL ;
V_93 * V_96 ;
V_77 = F_30 ( V_57 , V_59 , V_97 ) ;
if ( V_77 == NULL )
{
F_16 ( V_39 , L_94 ,
V_97 ) ;
...
F_16 ( V_39 , L_101 ) ;
F_16 ( V_39 , L_81 ) ;
if ( ! F_62 ( V_85 -> V_100 , 0L ) ) goto V_98;
if ( F_92 ( V_94 ) )
{
V_10 = - 1 ;
V_101: for (; ; )
{
V_10 ++ ;
if ( F_92 ( V_94 ) <= V_10 ) break;
V_96 = F_93 ( V_94 , V_10 ) ;
V_35 = V_84 = NULL ;
type = V_96 -> V_102 ;
if( ! F_94 ( type , L_102 ) || ! F_94 ( type , L_103 ) ||
! F_94 ( type , L_104 ) ||
! F_94 ( type , L_105 ) ) continue;
for( V_35 = V_96 -> V_102 ; * V_35 ; V_35 ++ )
if ( ( * V_35 == ':' ) || ( * V_35 == ',' ) ||
( * V_35 == '.' ) ) {
V_35 ++ ;
if( * V_35 ) type = V_35 ;
...
if ( ( V_87 = F_95 ( type ) ) == V_103 ) goto V_101;
sprintf ( V_86 , L_106 , V_96 -> V_102 ) ;
if ( ( V_90 = F_30 ( V_57 , V_77 , V_86 ) ) == NULL )
V_90 = L_107 ;
sprintf ( V_86 , L_108 , V_96 -> V_102 ) ;
if ( ( V_91 = F_30 ( V_57 , V_77 , V_86 ) ) == NULL )
V_91 = NULL ;
sprintf ( V_86 , L_109 , V_96 -> V_102 ) ;
V_88 = ( int ) F_43 ( V_57 , V_77 , V_86 ) ;
sprintf ( V_86 , L_110 , V_96 -> V_102 ) ;
V_89 = ( int ) F_43 ( V_57 , V_77 , V_86 ) ;
if ( ! F_96 ( V_85 -> V_104 , V_96 -> V_91 , V_90 , V_91 , V_87 ,
V_88 , V_89 ) )
goto V_98;
}
if ( F_97 ( V_85 -> V_104 -> V_105 ) == 0 )
{
F_16 ( V_39 , L_111 ) ;
goto V_98;
}
...
if ( ! F_98 ( V_85 -> V_107 ,
V_96 -> V_91 , V_90 , V_91 , V_87 , V_88 , V_89 ) )
goto V_98;
}
}
}
...
static int F_96 ( T_11 * V_81 , char * V_21 , char * V_90 , char * V_91 ,
int V_87 , int V_88 , int V_89 )
{
int V_10 , V_108 , V_83 = 0 ;
T_12 * V_109 = NULL ;
T_8 char V_86 [ 1024 ] ;
...
V_86 [ -- V_10 ] = '\0' ;
V_108 = F_100 ( ( unsigned char * ) V_86 , - 1 ) ;
if ( F_101 ( V_87 , & V_108 , V_10 , V_88 , V_89 ) == 0 )
goto V_98;
#ifdef F_102
F_103 ( V_86 , V_86 , V_10 ) ;
#endif
if ( ( V_109 = F_104 ( NULL , V_87 , V_108 , ( unsigned char * ) V_86 ,
strlen ( V_86 ) ) )
== NULL ) goto V_98;
if ( ! F_105 ( V_81 , V_109 , F_106 ( V_81 ) , 0 ) )
goto V_98;
V_83 = 1 ;
V_98:
if ( V_109 != NULL ) F_107 ( V_109 ) ;
return ( V_83 ) ;
}
static void T_13 V_67 ( int V_35 , int V_81 , void * V_110 )
{
char V_111 = '*' ;
if ( V_35 == 0 ) V_111 = '.' ;
if ( V_35 == 1 ) V_111 = '+' ;
if ( V_35 == 2 ) V_111 = '*' ;
if ( V_35 == 3 ) V_111 = '\n' ;
F_108 ( ( T_5 * ) V_110 , & V_111 , 1 ) ;
( void ) F_40 ( ( T_5 * ) V_110 ) ;
#ifdef F_109
V_35 = V_81 ;
#endif
}
static int F_101 ( int V_87 , int * type , int V_112 , int V_88 , int V_89 )
{
if ( V_87 == V_113 )
* type = V_114 ;
if ( ( V_87 == V_115 ) && ( * type == V_114 ) )
* type = V_116 ;
if ( ( V_87 == V_117 ) &&
( * type == V_114 ) )
* type = V_116 ;
...
static int F_94 ( char * V_119 , char * V_49 )
{
int V_120 , V_121 ;
char * V_77 ;
V_120 = strlen ( V_49 ) ;
V_121 = strlen ( V_119 ) ;
if( V_120 > V_121 ) return 1 ;
V_77 = V_119 + V_121 - V_120 ;
return strcmp ( V_77 , V_49 ) ;
}
static int F_32 ( T_14 * V_122 )
{
char * V_35 ;
F_90 ( V_93 ) * V_123 ;
V_93 * V_124 ;
int V_10 ;
if( ! ( V_35 = F_30 ( V_122 , NULL , L_121 ) ) ) return 1 ;
if( ! ( V_123 = F_91 ( V_122 , V_35 ) ) ) {
F_16 ( V_39 , L_122 , V_35 ) ;
return 0 ;
}
for( V_10 = 0 ; V_10 < F_92 ( V_123 ) ; V_10 ++ ) {
V_124 = F_93 ( V_123 , V_10 ) ;
if( F_110 ( V_124 -> V_91 , V_124 -> V_102 , V_124 -> V_102 ) == V_103 ) {
F_16 ( V_39 , L_123 ,
V_124 -> V_102 , V_124 -> V_91 ) ;
return 0 ;
}
}
return 1 ;
