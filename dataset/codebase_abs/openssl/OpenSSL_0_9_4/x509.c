...
T_8 V_60 ;
F_88 ( V_5 , 2 ) ;
F_89 ( & V_60 , V_6 , V_5 , NULL , NULL , 0 ) ;
F_16 ( & V_60 , V_97 ) ;
if( ! F_17 ( V_97 , & V_60 , V_98 , V_5 ) ) goto V_55;
}
if ( ! F_90 ( V_5 , V_61 , V_46 ) ) goto V_55;
V_3 = 1 ;
V_55:
F_91 ( & V_104 ) ;
if ( ! V_3 )
...
if ( V_102 != NULL ) F_92 ( V_102 ) ;
if ( V_99 != NULL ) F_23 ( V_99 ) ;
if ( V_25 != NULL ) F_93 ( V_25 ) ;
return ( V_3 ) ;
}
...
if ( V_112 == V_54 )
{
V_61 = F_102 ( V_113 , NULL , NULL , NULL ) ;
}
else
{
F_7 ( V_51 , L_84 ) ;
...
for (; ; )
{
if ( ( V_44 == NULL ) || ( ! F_105 ( V_44 , V_116 + 1024 * 10 ) ) )
goto V_55;
V_9 = F_106 ( V_114 , & ( V_44 -> V_69 [ V_116 ] ) , 1024 * 10 ) ;
V_116 += V_9 ;
if ( V_9 == 0 ) break;
if ( V_9 < 0 )
{
...
V_115 = V_101 ;
if ( ( V_88 = F_107 ( NULL , & V_101 , ( long ) V_116 ) ) == NULL )
goto V_55;
...
V_101 = V_115 ;
V_88 -> V_93 = F_65 () ;
if ( ( V_88 = F_107 ( & V_88 , & V_101 , ( long ) V_116 ) ) == NULL )
goto V_55;
V_5 = ( T_2 * ) V_88 -> V_69 ;
V_88 -> V_69 = NULL ;
}
else if ( V_112 == V_54 )
V_5 = F_108 ( V_114 , NULL , NULL , NULL ) ;
else {
F_7 ( V_51 , L_88 ) ;
goto V_55;
}
...
if ( V_88 != NULL ) F_109 ( V_88 ) ;
if ( V_114 != NULL ) F_23 ( V_114 ) ;
if ( V_44 != NULL ) F_110 ( V_44 ) ;
return ( V_5 ) ;
}
...
T_8 V_41 ;
F_88 ( V_5 , 2 ) ;
F_89 ( & V_41 , V_5 , V_5 , NULL , NULL , 0 ) ;
F_16 ( & V_41 , V_97 ) ;
if( ! F_17 ( V_97 , & V_41 , V_98 , V_5 ) ) goto V_108;
}
if ( ! F_90 ( V_5 , V_61 , V_46 ) ) goto V_108;
return ( 1 ) ;
V_108:
F_12 ( V_51 ) ;
return ( 0 ) ;
