...
int F_6 ( T_1 * V_1 , char * V_5 )
{
return ( F_7 ( V_1 , V_5 , V_1 -> V_4 ) ) ;
}
int F_8 ( T_1 * V_1 , char * V_5 )
{
return ( F_7 ( V_1 , V_5 , 0 ) ) ;
}
char * F_9 ( T_1 * V_1 )
{
...
char * F_16 ( T_1 * V_1 , int V_3 )
{
if( V_1 == NULL ) return NULL ;
return V_1 -> V_5 [ V_3 ] ;
}
char * F_17 ( T_1 * V_1 , int V_3 , char * V_11 )
{
if( V_1 == NULL ) return NULL ;
return ( V_1 -> V_5 [ V_3 ] = V_11 ) ;
}
void F_5 ( T_1 * V_1 )
{
if ( ! V_1 -> V_12 )
