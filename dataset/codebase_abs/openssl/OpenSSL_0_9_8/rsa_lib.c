...
{
F_54 ( V_4 -> V_17 -> V_17 , V_4 -> V_17 -> V_61 * sizeof V_4 -> V_17 -> V_17 [ 0 ] , 0.0 ) ;
}
V_9 = F_55 ( NULL , V_16 , V_4 -> V_15 , V_53 ,
V_4 -> V_2 -> V_62 , V_4 -> V_24 ) ;
if ( V_9 == NULL )
{
F_13 ( V_59 , V_63 ) ;
goto V_54;
...
V_68 [ 5 ] = & V_1 -> V_22 ;
V_65 = sizeof( T_8 ) * 6 ;
V_66 = V_65 / sizeof( T_10 ) + 1 ;
V_64 = 1 ;
for ( V_33 = 0 ; V_33 < 6 ; V_33 ++ )
V_64 += ( * V_68 [ V_33 ] ) -> V_71 ;
if ( ( V_18 = F_60 ( ( V_66 + V_64 ) * sizeof( T_10 ) ) ) == NULL )
{
F_13 ( V_72 , V_11 ) ;
return ( 0 ) ;
}
...
V_69 = * ( V_68 [ V_33 ] ) ;
* ( V_68 [ V_33 ] ) = & ( V_67 [ V_33 ] ) ;
memcpy ( ( char * ) & ( V_67 [ V_33 ] ) , ( char * ) V_69 , sizeof( T_8 ) ) ;
V_67 [ V_33 ] . V_30 = V_73 ;
V_67 [ V_33 ] . V_17 = V_70 ;
memcpy ( ( char * ) V_70 , V_69 -> V_17 , sizeof( T_10 ) * V_69 -> V_71 ) ;
V_70 += V_69 -> V_71 ;
F_24 ( V_69 ) ;
}
V_1 -> V_30 &= ~ ( V_74 | V_75 ) ;
