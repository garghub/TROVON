...
long F_14 ( T_3 * V_5 , int V_18 , void (* F_15)( void ) )
{
return ( 0 ) ;
}
...
long F_17 ( T_5 * V_24 , int V_18 , void (* F_15)( void ) )
{
return ( 0 ) ;
}
...
V_36 = V_5 -> V_6 -> V_39 ;
if ( V_5 -> V_40 -> V_41 < 0 ||
V_5 -> V_40 -> V_41 > ( int ) sizeof( V_5 -> V_40 -> V_42 ) )
{
F_27 ( V_43 , V_44 ) ;
return 0 ;
}
...
{
if ( ( ( V_36 - V_5 -> V_6 -> V_39 ) + F_28 ( V_37 ) ) >
( int ) sizeof( V_5 -> V_6 -> V_39 ) )
{
F_27 ( V_43 , V_44 ) ;
return 0 ;
}
...
error = V_5 -> error ;
V_5 -> error = 0 ;
F_30 ( error >= 0 && error <= ( int ) sizeof( V_51 ) ) ;
