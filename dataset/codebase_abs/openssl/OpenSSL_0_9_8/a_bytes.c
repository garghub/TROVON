...
if ( ! F_18 ( V_28 ) ) goto V_12;
V_1 -> V_3 = V_34 ;
if ( V_1 -> V_17 != NULL ) F_7 ( V_1 -> V_17 ) ;
V_1 -> V_17 = ( unsigned char * ) V_33 . V_17 ;
if ( V_32 != NULL ) F_9 ( V_32 ) ;
return ( 1 ) ;
V_12:
F_8 ( V_40 , V_28 -> error ) ;
if ( V_32 != NULL ) F_9 ( V_32 ) ;
if ( V_33 . V_17 != NULL ) F_7 ( V_33 . V_17 ) ;
return ( 0 ) ;
}
