...
int (* F_2)( char * V_3 , int V_4 , const char * V_5 , int V_6 ) ,
int V_7 )
{
int V_8 , V_9 , V_10 = 0 ;
int V_11 , V_12 , V_13 ;
...
if ( ( V_14 = F_4 () ) == NULL ) goto V_20;
if ( ( V_15 = F_5 () ) == NULL ) goto V_20;
V_14 -> V_21 = 0 ;
V_14 -> V_22 -> V_23 = F_6 ( V_24 ) ;
if ( ( V_14 -> V_22 -> V_25 = F_7 () ) == NULL ) goto V_20;
...
V_15 -> V_30 -> V_28 = 11 ;
V_15 -> V_15 -> V_22 -> V_23 = F_6 ( V_31 ) ;
if ( ( V_15 -> V_15 -> V_22 -> V_25 = F_7 () ) == NULL ) goto V_20;
...
if ( ( V_16 = ( unsigned char * ) F_13 ( V_11 ) ) == NULL )
{
F_14 ( V_32 , V_33 ) ;
goto V_20;
}
V_14 -> V_27 -> V_34 = V_16 ;
F_8 ( V_1 , & V_16 ) ;
if ( ( V_16 = F_13 ( V_12 ) ) == NULL )
{
F_14 ( V_32 , V_33 ) ;
goto V_20;
}
if ( ! F_15 ( V_15 -> V_30 , L_1 , - 1 ) )
{
F_14 ( V_32 , V_33 ) ;
goto V_20;
}
...
V_8 = strlen ( ( char * ) V_3 ) ;
if( V_7 ) {
F_17 ( V_3 , V_8 , V_3 , NULL , F_18 () , NULL ) ;
memcpy ( V_3 + 16 , L_3 , 10 ) ;
V_8 = 26 ;
}
F_19 ( F_20 () , F_18 () , NULL , V_3 , V_8 , 1 , V_17 , NULL ) ;
F_16 ( V_3 , 256 ) ;
V_16 = V_15 -> V_15 -> V_29 -> V_34 ;
F_21 ( & V_19 ) ;
F_22 ( & V_19 , F_20 () , NULL , V_17 , NULL ) ;
F_23 ( & V_19 , V_16 , & V_8 , V_16 , V_12 ) ;
F_24 ( & V_19 , V_16 + V_8 , & V_9 ) ;
F_25 ( & V_19 ) ;
V_10 = F_10 ( V_15 , V_2 ) ;
V_20:
F_12 ( V_15 ) ;
...
V_38 = V_15 -> V_15 -> V_29 -> V_34 ;
if ( F_2 == NULL )
F_2 = V_35 ;
if ( ( V_10 = F_30 ( V_1 , V_15 -> V_15 -> V_29 , F_2 , V_7 ) ) == NULL ) goto V_20;
* V_2 = V_37 ;
V_20:
F_12 ( V_15 ) ;
return V_10 ;
...
F_16 ( V_3 , 256 ) ;
F_21 ( & V_19 ) ;
F_31 ( & V_19 , F_20 () , NULL , V_17 , NULL ) ;
F_32 ( & V_19 , V_30 -> V_34 , & V_8 , V_30 -> V_34 , V_30 -> V_28 ) ;
F_33 ( & V_19 , & ( V_30 -> V_34 [ V_8 ] ) , & V_9 ) ;
F_25 ( & V_19 ) ;
V_30 -> V_28 = V_8 + V_9 ;
V_16 = V_30 -> V_34 ;
