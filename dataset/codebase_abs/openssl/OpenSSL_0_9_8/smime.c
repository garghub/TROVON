...
char * V_35 = NULL , * V_36 = NULL ;
char * V_37 = NULL ;
int V_38 = 0 ;
int V_39 = V_40 , V_41 = V_40 ;
int V_42 = V_43 ;
#ifndef F_2
char * V_44 = NULL ;
#endif
...
else if ( F_20 ( & args , NULL , & V_27 , V_46 , & V_45 ) )
continue;
else
V_27 = 1 ;
args ++ ;
...
#ifndef F_2
V_3 = F_22 ( V_46 , V_44 , 0 ) ;
#endif
if ( ! F_23 ( V_46 , V_35 , NULL , & V_36 , NULL ) )
{
F_21 ( V_46 , L_94 ) ;
goto V_50;
}
...
if ( V_10 && ( V_4 == V_53 ) )
{
if ( ! ( V_20 = F_27 ( V_46 , V_10 , V_43 , NULL ,
V_3 , L_100 ) ) )
{
#if 0
...
if ( V_12 )
{
if ( ! ( V_23 = F_29 ( V_46 , V_12 , V_43 , NULL ,
V_3 , L_101 ) ) )
{
#if 0
...
if ( V_11 && ( V_4 == V_52 ) )
{
if ( ! ( V_19 = F_27 ( V_46 , V_11 , V_43 , NULL ,
V_3 , L_99 ) ) )
{
#if 0
BIO_printf(bio_err, "Can't read recipient certificate file %s\n", recipfile);
...
if ( V_13 )
{
V_21 = F_31 ( V_46 , V_13 , V_42 , 0 , V_36 , V_3 ,
L_102 ) ;
if ( ! V_21 )
goto V_50;
}
...
V_5 = 3 ;
if ( V_4 == V_51 )
V_16 = F_40 ( V_22 , V_24 , V_15 , V_28 ) ;
else if ( V_4 == V_53 )
{
if ( ( V_28 & V_29 ) && ( V_41 == V_40 ) )
V_28 |= V_73 ;
V_16 = F_41 ( V_20 , V_21 , V_23 , V_24 , V_28 ) ;
if ( ! ( V_28 & V_73 ) && ( F_42 ( V_24 ) != 0 ) )
{
F_21 ( V_46 , L_105 ) ;
goto V_50;
}
...
{
F_46 ( V_26 ) ;
if ( ! ( V_26 = F_32 ( V_14 , L_96 ) ) )
{
F_21 ( V_46 , L_108 , V_14 ) ;
goto V_50;
}
}
}
...
if ( V_4 == V_52 )
{
if ( ! F_47 ( V_16 , V_21 , V_19 , V_25 , V_28 ) )
{
F_21 ( V_46 , L_110 ) ;
goto V_50;
}
...
{
F_1 ( T_5 ) * V_74 ;
if ( F_48 ( V_16 , V_23 , V_17 , V_26 , V_25 , V_28 ) )
F_21 ( V_46 , L_111 ) ;
else
{
F_21 ( V_46 , L_112 ) ;
...
{
if ( V_30 )
F_21 ( V_25 , L_114 , V_30 ) ;
if ( V_31 )
F_21 ( V_25 , L_115 , V_31 ) ;
if ( V_32 )
F_21 ( V_25 , L_116 , V_32 ) ;
if ( V_41 == V_40 )
F_53 ( V_25 , V_16 , V_24 , V_28 ) ;
else if ( V_41 == V_43 )
F_52 ( V_25 , V_16 ) ;
else if ( V_41 == V_69 )
F_54 ( V_25 , V_16 ) ;
...
static int V_72 ( int V_76 , T_9 * V_77 )
{
int error ;
error = F_63 ( V_77 ) ;
if ( ( error != V_78 )
