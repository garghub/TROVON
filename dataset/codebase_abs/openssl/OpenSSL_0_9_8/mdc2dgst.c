...
int F_2 ( T_1 * V_1 , const unsigned char * V_7 , T_2 V_8 )
{
T_2 V_9 , V_10 ;
V_9 = V_1 -> V_2 ;
if ( V_9 != 0 )
...
static void F_3 ( T_1 * V_1 , const unsigned char * V_7 , T_2 V_8 )
{
register T_3 V_12 , V_13 ;
