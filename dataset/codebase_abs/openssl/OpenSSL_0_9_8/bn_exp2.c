...
V_26 [ 0 ] = F_7 ( V_7 ) ;
V_28 [ 0 ] = F_7 ( V_7 ) ;
if( ! V_23 || ! V_24 || ! V_26 [ 0 ] || ! V_28 [ 0 ] ) goto V_32;
if ( V_8 != NULL )
V_29 = V_8 ;
else
{
if ( ( V_29 = F_8 () ) == NULL ) goto V_32;
if ( ! F_9 ( V_29 , V_6 , V_7 ) ) goto V_32;
}
V_18 = F_10 ( V_13 ) ;
V_19 = F_10 ( V_14 ) ;
...
if ( ! F_15 ( V_26 [ 0 ] , V_25 , V_29 , V_7 ) ) goto V_32;
if ( V_18 > 1 )
{
if ( ! F_16 ( V_23 , V_26 [ 0 ] , V_26 [ 0 ] , V_29 , V_7 ) ) goto V_32;
V_10 = 1 << ( V_18 - 1 ) ;
for ( V_9 = 1 ; V_9 < V_10 ; V_9 ++ )
{
if( ( ( V_26 [ V_9 ] = F_7 ( V_7 ) ) == NULL ) ||
! F_16 ( V_26 [ V_9 ] , V_26 [ V_9 - 1 ] ,
V_23 , V_29 , V_7 ) )
goto V_32;
}
}
...
if ( ! F_15 ( V_28 [ 0 ] , V_25 , V_29 , V_7 ) ) goto V_32;
if ( V_19 > 1 )
{
if ( ! F_16 ( V_23 , V_28 [ 0 ] , V_28 [ 0 ] , V_29 , V_7 ) ) goto V_32;
V_10 = 1 << ( V_19 - 1 ) ;
for ( V_9 = 1 ; V_9 < V_10 ; V_9 ++ )
{
if( ( ( V_28 [ V_9 ] = F_7 ( V_7 ) ) == NULL ) ||
! F_16 ( V_28 [ V_9 ] , V_28 [ V_9 - 1 ] ,
V_23 , V_29 , V_7 ) )
goto V_32;
}
}
...
V_16 = 0 ;
V_17 = 0 ;
if ( ! F_15 ( V_24 , F_17 () , V_29 , V_7 ) ) goto V_32;
...
F_19 ( V_1 , V_24 , V_29 , V_7 ) ;
V_15 = 1 ;
V_32:
if ( ( V_8 == NULL ) && ( V_29 != NULL ) ) F_20 ( V_29 ) ;
F_21 ( V_7 ) ;
F_2 ( V_1 ) ;
return ( V_15 ) ;
}
