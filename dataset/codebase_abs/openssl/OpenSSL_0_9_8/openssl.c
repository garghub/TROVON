...
static int T_6 V_60 ( const void * V_61 , const void * V_62 )
{
return ( strncmp ( ( ( const T_1 * ) V_61 ) -> V_39 ,
( ( const T_1 * ) V_62 ) -> V_39 , 8 ) ) ;
}
static unsigned long T_6 V_59 ( const void * V_61 )
{
return ( F_38 ( ( ( const T_1 * ) V_61 ) -> V_39 ) ) ;
}
