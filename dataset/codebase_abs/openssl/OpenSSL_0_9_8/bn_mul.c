...
void F_9 ( T_1 * V_1 , T_1 * V_2 , int V_47 , T_1 * V_3 , int V_48 )
{
T_1 * V_39 ;
#ifdef F_3
fprintf ( V_8 , L_16 , V_47 , V_48 ) ;
#endif
if ( V_47 < V_48 )
{
int V_49 ;
T_1 * V_50 ;
V_49 = V_47 ; V_47 = V_48 ; V_48 = V_49 ;
V_50 = V_2 ; V_2 = V_3 ; V_3 = V_50 ;
}
V_39 = & ( V_1 [ V_47 ] ) ;
if ( V_48 <= 0 )
{
( void ) F_28 ( V_1 , V_2 , V_47 , 0 ) ;
return;
}
else
V_39 [ 0 ] = F_28 ( V_1 , V_2 , V_47 , V_3 [ 0 ] ) ;
for (; ; )
{
if ( -- V_48 <= 0 ) return;
V_39 [ 1 ] = F_29 ( & ( V_1 [ 1 ] ) , V_2 , V_47 , V_3 [ 1 ] ) ;
if ( -- V_48 <= 0 ) return;
V_39 [ 2 ] = F_29 ( & ( V_1 [ 2 ] ) , V_2 , V_47 , V_3 [ 2 ] ) ;
if ( -- V_48 <= 0 ) return;
V_39 [ 3 ] = F_29 ( & ( V_1 [ 3 ] ) , V_2 , V_47 , V_3 [ 3 ] ) ;
if ( -- V_48 <= 0 ) return;
V_39 [ 4 ] = F_29 ( & ( V_1 [ 4 ] ) , V_2 , V_47 , V_3 [ 4 ] ) ;
V_39 += 4 ;
V_1 += 4 ;
V_3 += 4 ;
}
