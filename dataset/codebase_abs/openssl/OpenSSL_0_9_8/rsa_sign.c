...
int F_10 ( int V_36 , const unsigned char * V_1 , unsigned int V_2 ,
...
if( ( V_5 -> V_16 & V_17 ) && V_5 -> V_18 -> V_41 )
{
return V_5 -> V_18 -> V_41 ( V_36 , V_1 , V_2 ,
V_37 , V_4 , V_5 ) ;
}
...
V_8 = F_11 ( ( int ) V_4 , V_37 , V_13 , V_5 , V_35 ) ;
if ( V_8 <= 0 ) goto V_42;
if( V_36 == V_20 ) {
...
V_38 = F_13 ( V_6 -> V_14 -> V_24 ) ;
#ifdef F_14
fprintf ( V_44 , L_1 , F_15 ( V_38 ) ,
F_15 ( V_36 ) ) ;
#endif
if ( V_38 != V_36 )
{
