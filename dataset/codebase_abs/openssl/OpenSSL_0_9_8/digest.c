...
int F_14 ( T_1 * V_1 , const void * V_14 ,
T_4 V_15 )
{
return V_1 -> V_5 -> V_16 ( V_1 , V_14 , V_15 ) ;
}
int F_15 ( T_1 * V_1 , unsigned char * V_17 , unsigned int * V_18 )
{
int V_19 ;
V_19 = F_16 ( V_1 , V_17 , V_18 ) ;
F_17 ( V_1 ) ;
return V_19 ;
}
int F_16 ( T_1 * V_1 , unsigned char * V_17 , unsigned int * V_18 )
{
int V_19 ;
F_18 ( V_1 -> V_5 -> V_20 <= V_21 ) ;
...
{
F_1 ( V_24 ) ;
return F_21 ( V_24 , V_25 ) ;
}
int F_21 ( T_1 * V_24 , const T_1 * V_25 )
{
unsigned char * V_26 ;
...
#ifndef F_7
if ( V_25 -> V_4 && ! F_9 ( V_25 -> V_4 ) )
{
F_10 ( V_27 , V_29 ) ;
return 0 ;
}
#endif
if ( V_24 -> V_5 == V_25 -> V_5 )
{
V_26 = V_24 -> V_12 ;
F_19 ( V_24 , V_30 ) ;
}
...
if ( V_24 -> V_5 -> V_11 )
{
if ( V_26 ) V_24 -> V_12 = V_26 ;
else V_24 -> V_12 = F_3 ( V_24 -> V_5 -> V_11 ) ;
memcpy ( V_24 -> V_12 , V_25 -> V_12 , V_24 -> V_5 -> V_11 ) ;
}
if ( V_24 -> V_5 -> V_31 )
return V_24 -> V_5 -> V_31 ( V_24 , V_25 ) ;
return 1 ;
}
int F_22 ( const void * V_14 , T_4 V_15 ,
