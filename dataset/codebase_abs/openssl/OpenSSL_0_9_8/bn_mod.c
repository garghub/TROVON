...
{
if ( ! F_5 ( V_1 , V_8 , V_9 ) ) return 0 ;
if ( F_6 ( V_1 , V_2 ) >= 0 )
return F_7 ( V_1 , V_1 , V_2 ) ;
return 1 ;
}
int F_8 ( T_1 * V_1 , const T_1 * V_8 , const T_1 * V_9 , const T_1 * V_2 , T_2 * V_4 )
{
...
F_11 ( V_2 ) ;
F_12 ( V_4 ) ;
if ( ( V_10 = F_13 ( V_4 ) ) == NULL ) goto V_12;
if ( V_8 == V_9 )
{ if ( ! F_14 ( V_10 , V_8 , V_4 ) ) goto V_12; }
else
{ if ( ! F_15 ( V_10 , V_8 , V_9 , V_4 ) ) goto V_12; }
...
int F_22 ( T_1 * V_1 , const T_1 * V_8 , int V_13 , const T_1 * V_2 , T_2 * V_4 )
{
T_1 * V_14 = NULL ;
int V_11 ;
...
if ( V_15 )
{
if ( ! F_29 ( V_1 , V_1 , V_15 ) ) return 0 ;
V_13 -= V_15 ;
}
else
{
if ( ! F_19 ( V_1 , V_1 ) ) return 0 ;
-- V_13 ;
}
if ( F_21 ( V_1 , V_2 ) >= 0 )
{
