...
{
V_29 * V_40 ;
for ( V_5 = 0 ; V_5 < F_21 ( V_30 ) ; V_5 ++ )
{
V_40 = F_22 ( V_30 , V_5 ) ;
if( V_15 ) F_23 ( V_8 , V_40 ) ;
else F_24 ( V_8 , V_40 ) ;
if( ! V_16 ) F_25 ( V_8 , V_40 ) ;
F_26 ( V_8 , L_22 ) ;
}
}
if ( V_32 != NULL )
{
V_31 * V_37 ;
for ( V_5 = 0 ; V_5 < F_27 ( V_32 ) ; V_5 ++ )
{
V_37 = F_28 ( V_32 , V_5 ) ;
F_29 ( V_8 , V_37 ) ;
if( ! V_16 ) F_30 ( V_8 , V_37 ) ;
F_26 ( V_8 , L_22 ) ;
}
}
V_17 = 0 ;
