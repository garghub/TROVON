...
int V_10 ;
F_8 ( V_9 , V_11 , 0 , & V_10 ) ;
if ( V_10 == 128 ) return ( V_12 ) ;
else if ( V_10 == 64 ) return ( V_13 ) ;
else if ( V_10 == 40 ) return ( V_14 ) ;
else return ( 0 ) ;
}
static int F_9 ( int V_10 )
{
if ( V_10 == V_12 ) return 128 ;
else if ( V_10 == V_13 ) return 64 ;
else if ( V_10 == V_14 ) return 40 ;
else
{
F_10 ( V_15 , V_16 ) ;
return ( 0 ) ;
