...
if ( V_17 -> V_20 [ V_23 ] != NULL ) F_10 ( V_17 -> V_20 [ V_23 ] ) ;
if ( V_17 -> V_20 != NULL ) F_10 ( V_17 -> V_20 ) ;
if ( V_17 -> V_21 != NULL ) F_10 ( V_17 -> V_21 ) ;
if ( V_17 -> V_18 != NULL ) F_12 ( V_17 -> V_18 ) ;
F_10 ( V_17 ) ;
}
...
{
V_2 -> V_22 += 10 ;
V_30 = ( char * * ) F_8 ( V_2 -> V_22 *
sizeof( char * ) ) ;
V_26 = ( int * ) F_8 ( V_2 -> V_22 *
sizeof( int ) ) ;
...
V_2 -> V_20 [ V_2 -> V_19 ] = ( char * ) F_8 ( ( unsigned int ) V_25 + 1 ) ;
...
static int F_13 ( T_2 * V_35 , int type , T_4 * V_36 ,
T_5 * V_7 )
{
T_3 * V_2 ;
union {
...
char V_62 = '/' ;
#ifdef F_16
V_62 = V_2 -> V_20 [ V_23 ] [ strlen ( V_2 -> V_20 [ V_23 ] ) - 1 ] ;
if ( V_62 != ':' && V_62 != '>' && V_62 != ']' )
{
V_62 = ':' ;
}
...
if ( V_62 == '\0' )
{
F_17 ( V_47 -> V_43 , V_47 -> V_63 ,
L_3 , V_2 -> V_20 [ V_23 ] , V_46 ,
V_52 , V_45 ) ;
}
else
{
F_17 ( V_47 -> V_43 , V_47 -> V_63 ,
L_4 , V_2 -> V_20 [ V_23 ] , V_62 , V_46 ,
V_52 , V_45 ) ;
}
V_45 ++ ;
...
if ( type == V_53 )
{
if ( ( F_18 ( V_35 , V_47 -> V_43 ,
V_2 -> V_21 [ V_23 ] ) ) == 0 )
break;
}
else if ( type == V_56 )
{
if ( ( F_19 ( V_35 , V_47 -> V_43 ,
V_2 -> V_21 [ V_23 ] ) ) == 0 )
break;
}
}
F_20 ( V_64 ) ;
V_24 = F_21 ( V_35 -> V_65 -> V_66 , & V_50 ) ;
if( V_24 != - 1 ) V_51 = F_22 ( V_35 -> V_65 -> V_66 , V_24 ) ;
else V_51 = NULL ;
F_23 ( V_64 ) ;
if ( V_51 != NULL )
{
