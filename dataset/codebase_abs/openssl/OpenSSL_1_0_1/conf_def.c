...
* V_23 = '\0' ;
if ( ! F_32 ( V_6 , NULL , & V_30 , V_32 ) ) goto V_38;
...
if ( ! F_32 ( V_6 , V_33 , & ( V_27 -> V_44 ) , V_32 ) ) goto V_38;
...
if ( V_30 != NULL ) F_5 ( V_30 ) ;
return ( 1 ) ;
V_38:
if ( V_20 != NULL ) F_39 ( V_20 ) ;
if ( V_30 != NULL ) F_5 ( V_30 ) ;
if ( line != NULL ) * line = V_25 ;
...
if ( V_27 != NULL )
{
if ( V_27 -> V_11 != NULL ) F_5 ( V_27 -> V_11 ) ;
if ( V_27 -> V_44 != NULL ) F_5 ( V_27 -> V_44 ) ;
if ( V_27 != NULL ) F_5 ( V_27 ) ;
}
return ( 0 ) ;
}
...
T_4 * V_31 ;
if ( ( V_31 = F_21 () ) == NULL ) return ( 0 ) ;
V_53 = strlen ( V_48 ) + 1 ;
if ( ! F_25 ( V_31 , V_53 ) ) goto V_38;
for (; ; )
{
if ( F_47 ( V_6 , * V_48 ) )
{
...
V_48 ++ ;
V_27 = * ( V_48 ++ ) ;
if ( F_30 ( V_6 , V_27 ) ) break;
else if ( V_27 == 'r' ) V_27 = '\r' ;
else if ( V_27 == 'n' ) V_27 = '\n' ;
else if ( V_27 == 'b' ) V_27 = '\b' ;
else if ( V_27 == 't' ) V_27 = '\t' ;
V_31 -> V_9 [ V_52 ++ ] = V_27 ;
}
...
V_31 -> V_9 [ V_52 ] = '\0' ;
if ( * V_47 != NULL ) F_5 ( * V_47 ) ;
* V_47 = V_31 -> V_9 ;
F_5 ( V_31 ) ;
return ( 1 ) ;
V_38:
if ( V_31 != NULL ) F_39 ( V_31 ) ;
return ( 0 ) ;
}
