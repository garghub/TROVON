...
if ( F_16 ( V_28 , V_35 ) != 0 ) { F_17 ( V_28 ) ; continue; }
...
if ( V_34 < V_5 ) { F_17 ( V_28 ) ; continue; }
do
{
int V_38 = 0 ;
#if F_11 ( V_39 )
...
if ( V_38 )
{
V_33 = F_23 ( V_28 , ( unsigned char * ) V_23 + V_24 , V_15 - V_24 ) ;
if ( V_33 > 0 )
V_24 += V_33 ;
#if F_11 ( V_39 )
if ( V_33 == 0 )
...
while ( ( V_33 > 0 ||
( V_52 == V_53 || V_52 == V_54 ) ) && V_32 != 0 && V_24 < V_15 );
F_17 ( V_28 ) ;
}
}
#endif
#ifdef V_22
for ( V_30 = V_29 ; * V_30 && V_24 < V_15 ; V_30 ++ )
{
int V_33 ;
