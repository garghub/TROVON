...
if ( ! F_18 ( V_15 , V_27 , V_29 ) ) goto V_34;
if ( ! F_19 ( V_29 , 1 ) ) goto V_34;
for ( V_25 = 0 ; V_25 < V_22 ; V_25 += V_27 ) {
if ( ! F_18 ( V_17 + V_25 , V_27 , V_28 ) ) goto V_34;
if ( ! F_20 ( V_28 , V_28 , V_29 ) ) goto V_34;
F_21 ( V_28 , V_15 ) ;
V_23 = F_22 ( V_28 ) ;
if ( V_23 > V_27 ) {
F_21 ( V_28 , V_15 ) ;
...
F_21 ( V_28 , V_17 + V_25 + V_27 - V_23 ) ;
#endif
} else F_21 ( V_28 , V_17 + V_25 ) ;
}
}
V_34:
F_3 ( V_36 , V_14 ) ;
...
{
for (; V_37 -- ; V_18 ++ ) fprintf ( V_33 , L_6 , * V_18 ) ;
fprintf ( V_33 , L_7 ) ;
}
