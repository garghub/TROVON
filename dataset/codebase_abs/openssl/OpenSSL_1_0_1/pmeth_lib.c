...
void F_46 ( T_1 * V_13 ,
int (* V_36)( T_2 * V_63 ) ,
int (* V_37)( T_2 * V_63 , unsigned char * V_82 , T_6 * V_83 ,
const unsigned char * V_84 , T_6 V_85 ) )
{
V_13 -> V_36 = V_36 ;
V_13 -> V_37 = V_37 ;
}
void F_47 ( T_1 * V_13 ,
int (* V_38)( T_2 * V_63 ) ,
int (* V_39)( T_2 * V_63 , const unsigned char * V_82 , T_6 V_83 ,
const unsigned char * V_84 , T_6 V_85 ) )
{
V_13 -> V_38 = V_38 ;
V_13 -> V_39 = V_39 ;
...
void F_49 ( T_1 * V_13 ,
int (* V_42)( T_2 * V_63 , T_7 * V_86 ) ,
int (* V_43)( T_2 * V_63 , unsigned char * V_82 , T_6 * V_83 ,
T_7 * V_86 ) )
{
V_13 -> V_42 = V_42 ;
V_13 -> V_43 = V_43 ;
...
void F_50 ( T_1 * V_13 ,
int (* V_44)( T_2 * V_63 , T_7 * V_86 ) ,
int (* V_45)( T_2 * V_63 , const unsigned char * V_82 , int V_83 ,
T_7 * V_86 ) )
{
V_13 -> V_44 = V_44 ;
V_13 -> V_45 = V_45 ;
...
void F_51 ( T_1 * V_13 ,
int (* V_46)( T_2 * V_63 ) ,
int (* F_52)( T_2 * V_63 , unsigned char * V_87 , T_6 * V_88 ,
const unsigned char * V_89 , T_6 V_90 ) )
{
V_13 -> V_46 = V_46 ;
V_13 -> V_47 = F_52 ;
}
void F_53 ( T_1 * V_13 ,
int (* V_48)( T_2 * V_63 ) ,
int (* V_49)( T_2 * V_63 , unsigned char * V_87 , T_6 * V_88 ,
const unsigned char * V_89 , T_6 V_90 ) )
{
V_13 -> V_48 = V_48 ;
V_13 -> V_49 = V_49 ;
...
void F_54 ( T_1 * V_13 ,
int (* V_50)( T_2 * V_63 ) ,
int (* V_51)( T_2 * V_63 , unsigned char * V_91 , T_6 * V_92 ) )
{
V_13 -> V_50 = V_50 ;
V_13 -> V_51 = V_51 ;
}
void F_55 ( T_1 * V_13 ,
int (* V_52)( T_2 * V_63 , int type , int V_67 , void * V_68 ) ,
int (* V_53)( T_2 * V_63 , const char * type , const char * V_74 ) )
{
V_13 -> V_52 = V_52 ;
V_13 -> V_53 = V_53 ;
}
