...
{
V_35 = F_23 () ;
if ( ! F_24 ( V_23 , V_28 , V_35 ) ) return 0 ;
}
if ( ! F_25 ( V_35 , V_29 ) ) return 0 ;
break;
}
case V_14 :
{
...
{
V_36 = F_26 () ;
if ( ! F_24 ( V_23 , V_28 , V_36 ) ) return 0 ;
}
if ( ! F_27 ( V_36 , V_29 ) ) return 0 ;
}
}
return 1 ;
}
...
static int F_36 ( T_5 * V_23 , int V_39 ,
long V_40 , void * V_41 )
{
switch ( V_39 )
{
...
{
T_3 * V_7 ;
if ( ! F_59 ( V_72 , V_73 , 128 ) ) return 0 ;
F_60 ( V_72 , L_1 ) ;
V_7 = F_34 ( V_23 ) ;
if ( ! V_7 )
F_60 ( V_72 , L_2 ) ;
...
if ( ! F_59 ( V_72 , V_73 , 128 ) ) return 0 ;
F_60 ( V_72 , L_7 ) ;
if ( ! F_59 ( V_72 , V_73 + 3 , 128 ) ) return 0 ;
F_60 ( V_72 , L_8 ) ;
F_61 ( V_72 , V_78 ) ;
F_60 ( V_72 , L_3 ) ;
...
if ( ! F_4 ( V_93 -> V_3 , V_94 -> V_3 ) ) return 1 ;
return 0 ;
}
...
T_1 * V_35 ;
T_12 * V_101 = NULL ;
if ( ! F_86 ( & V_98 , & V_96 , & V_99 ,
& V_24 , V_95 ) ) return 0 ;
F_24 ( V_56 , F_20 ( V_98 ) , NULL ) ;
if ( ! F_18 ( V_56 , V_24 ) ) return 0 ;
...
int V_61 = 0 ;
if ( ! V_112 || ! V_113 ) return 0 ;
V_114 = F_70 ( V_112 ) ;
V_115 = F_70 ( V_113 ) ;
if ( ! V_114 || ! V_115 ) return 0 ;
...
{
int V_5 = F_12 ( F_13 ( F_14 ( ( T_5 * ) V_23 ) ) ) ;
return F_116 ( F_15 ( V_5 ) , V_118 ) ;
}
static int F_118 ( T_5 * V_23 , const unsigned char * * V_118 , int V_119 )
{
T_8 * V_120 = NULL ;
T_1 * V_35 = F_14 ( V_23 ) ;
int V_5 ;
...
{
V_35 = F_23 () ;
if ( ! F_24 ( V_23 , V_15 , V_35 ) ) return 0 ;
}
if ( ! F_25 ( V_35 , V_5 ) ) return 0 ;
return 1 ;
}
static int F_121 ( T_5 * V_23 , const unsigned char * * V_118 , int V_119 ) {
T_8 * V_120 = NULL ;
int V_5 ;
T_9 * V_36 = F_14 ( V_23 ) ;
if ( F_119 ( & V_120 , V_118 , V_119 ) == NULL ) {
...
{
V_36 = F_26 () ;
if ( ! F_24 ( V_23 , V_14 , V_36 ) ) return 0 ;
}
if ( ! F_27 ( V_36 , V_5 ) ) return 0 ;
return 1 ;
}
int F_122 ( int V_5 , T_22 * * V_121 , const char * V_122 , const char * V_123 )
{
* V_121 = F_123 ( V_5 ,
V_124 , V_122 , V_123 ) ;
if ( ! * V_121 ) return 0 ;
