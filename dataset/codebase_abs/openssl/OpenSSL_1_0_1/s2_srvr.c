...
if ( F_37 ( V_3 -> V_41 -> V_152 , ( int ) V_3 -> V_41 -> V_151 ) <= 0 )
return - 1 ;
...
memcpy ( V_76 , V_3 -> V_59 -> V_161 , ( unsigned int ) V_3 -> V_59 -> V_127 ) ;
V_3 -> V_11 = V_63 ;
...
F_64 ( & V_13 , V_164 , ( unsigned int ) V_71 ) ;
F_66 ( V_164 ) ;
V_185 = F_67 ( V_149 ) ;
