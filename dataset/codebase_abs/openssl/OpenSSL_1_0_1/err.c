...
void F_46 ( int V_34 , int V_35 , int V_36 , const char * V_37 ,
int line )
{
T_3 * V_38 ;
#ifdef F_47
...
unsigned long F_53 ( const char * * V_37 ,
int * line )
...
static unsigned long F_52 ( int V_48 , int V_40 , const char * * V_37 , int * line ,
const char * * V_46 , int * V_47 )
{
int V_22 = 0 ;
T_3 * V_38 ;
...
{
* V_37 = V_38 -> V_44 [ V_22 ] ;
if ( line != NULL ) * line = V_38 -> V_45 [ V_22 ] ;
}
}
if ( V_46 == NULL )
{
...
{
* V_46 = V_38 -> V_50 [ V_22 ] ;
if ( V_47 != NULL ) * V_47 = V_38 -> V_51 [ V_22 ] ;
}
}
return V_5 ;
}
...
F_50 ( V_38 , V_38 -> V_40 ) ;
V_38 -> V_40 -= 1 ;
if ( V_38 -> V_40 == - 1 ) V_38 -> V_40 = V_29 - 1 ;
}
if ( V_38 -> V_41 == V_38 -> V_40 ) return 0 ;
V_38 -> V_42 [ V_38 -> V_40 ] &= ~ V_78 ;
return 1 ;
