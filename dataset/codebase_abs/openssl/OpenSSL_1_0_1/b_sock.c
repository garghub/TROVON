...
unsigned long V_88 ;
int V_89 ;
if ( F_4 () != 1 ) return ( V_81 ) ;
if ( ( V_1 = F_34 ( V_70 ) ) == NULL ) return ( V_81 ) ;
V_86 = V_87 = NULL ;
V_86 = V_1 ;
...
if ( V_87 ) * V_87 ++ = '\0' ;
else V_87 = V_86 , V_86 = NULL ;
#ifdef F_35
do {
static union { void * V_87 ;
...
( V_92 . V_87 = F_38 ( L_13 ) ) == NULL )
V_91 . V_87 = ( void * ) - 1 ;
}
if ( V_91 . V_87 == ( void * ) - 1 ) break;
...
if ( (* V_91 . F_37 )( V_86 , V_87 , & V_94 , & V_93 ) ) break;
...
{
memset ( & V_80 . V_78 . V_118 , 0 , sizeof( V_80 . V_78 . V_118 ) ) ;
