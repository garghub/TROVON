...
while( V_1 [ V_5 ] == 0 && V_5 <= V_6 ) ++ V_5 ;
V_4 = 0 ;
while ( V_5 <= V_6 ) V_1 [ V_4 ++ ] = V_1 [ V_5 ++ ] ;
return V_4 ;
}
...
{
V_44 = ( char * * ) F_33 ( V_46 -> V_52 , V_4 ) ;
if ( V_44 [ V_53 ] [ 0 ] == V_54 )
{
if ( ( V_45 = ( V_41 * ) F_8 ( sizeof( V_41 ) ) ) == NULL )
goto V_37;
if ( ! ( V_45 -> V_19 = F_11 ( V_44 [ V_55 ] ) )
|| ! ( V_45 -> V_22 = F_34 ( V_29 -> V_31 , V_44 [ V_56 ] ) )
...
if ( ! F_10 ( V_16 , V_44 [ V_55 ] , V_44 [ V_61 ] ) )
goto V_37;
V_40 = V_62 ;
if ( ! F_12 ( V_16 , V_44 [ V_57 ] , V_44 [ V_56 ] ) )
goto V_37;
...
F_49 ( & V_69 , V_68 , NULL ) ;
F_50 ( & V_69 ) ;
if ( F_14 ( V_65 , F_13 ( V_68 , V_67 , NULL ) , F_13 ( V_66 , V_67 , NULL ) ) )
return V_65 ;
V_37: F_3 ( V_65 ) ;
return NULL ;
}
...
if ( V_22 )
{
if ( ! ( V_27 = F_1 ( V_25 , V_22 ) ) ) goto V_37;
V_75 = F_13 ( V_25 , V_27 , NULL ) ;
if ( ! ( V_27 = F_1 ( V_25 , V_23 ) ) ) goto V_37;
...
if( ! F_52 ( V_65 , V_70 , & V_17 , & V_18 , V_75 , V_76 ) ) goto V_37;
F_53 ( V_18 , V_25 ) ;
...
int F_52 ( const char * V_65 , const char * V_70 , T_2 * * V_71 , T_2 * * V_72 , T_2 * V_22 , T_2 * V_23 )
{
int V_73 = 0 ;
T_2 * V_81 = NULL ;
T_8 * V_82 = F_55 () ;
