...
static const char * F_6 ( long V_10 , const T_3 * V_11 , int V_12 )
{
const T_3 * V_13 ;
...
const char * F_7 ( long V_10 )
{
static const T_3 V_16 [] = {
{ V_17 , L_9 } ,
{ V_18 , L_10 } ,
{ V_19 , L_11 } ,
{ V_20 , L_12 } ,
...
const char * F_8 ( long V_10 )
{
static const T_3 V_23 [] = {
{ V_24 , L_15 } ,
{ V_25 , L_16 } ,
{ V_26 , L_17 } } ;
return F_6 ( V_10 , V_23 , 3 ) ;
}
const char * F_9 ( long V_10 )
{
static const T_3 V_27 [] = {
{ V_28 , L_18 } ,
{ V_29 , L_19 } ,
{ V_30 , L_20 } ,
{ V_31 , L_21 } ,
...
{
case V_71 :
F_28 ( V_1 , V_58 -> V_72 . V_73 , 0 , V_74 ) ;
break;
case V_75 :
...
if ( ! F_29 ( V_1 , V_59 -> V_77 ) ) goto V_46;
if ( F_2 ( V_1 , L_39 ) <= 0 ) goto V_46;
for ( V_38 = 0 ; V_38 < F_30 ( V_59 -> V_78 ) ; V_38 ++ )
{
if ( ! F_31 ( V_59 -> V_78 , V_38 ) ) continue;
V_62 = F_31 ( V_59 -> V_78 , V_38 ) ;
V_40 = V_62 -> V_79 ;
...
if ( ! F_29 ( V_1 , V_62 -> V_84 ) )
goto V_46;
if ( V_62 -> V_85 )
{
if ( F_2 ( V_1 , L_44 ) <= 0 ) goto V_46;
if ( ! F_29 ( V_1 , V_62 -> V_85 ) )
goto V_46;
}
if ( F_11 ( V_1 , L_7 , 1 ) <= 0 ) goto V_46;
if ( ! F_16 ( V_1 ,
L_45 ,
V_62 -> V_86 , V_37 , 8 ) )
goto V_46;
