...
int F_7 ( int V_3 , const unsigned char * V_4 , unsigned char * V_5 ,
T_1 * V_6 , int V_7 )
{
#ifdef F_4
if ( F_5 () && ! ( V_6 -> V_8 -> V_9 & V_10 )
...
if ( V_32 == NULL )
goto V_26;
if ( ! F_18 ( V_31 , V_28 , F_19 () ) ) goto V_26;
if ( ! F_18 ( V_32 , V_29 , F_19 () ) ) goto V_26;
if ( ! F_20 ( V_30 , V_31 , V_32 , V_24 ) ) goto V_26;
