...
else return ( V_18 [ ( int ) ( V_17 >> 48 ) ] + 48 ) ;
}
else
{
...
else return ( V_18 [ ( int ) ( V_17 >> 32 ) ] + 32 ) ;
}
}
else
#else
...
else return ( V_18 [ ( int ) ( V_17 >> 16L ) ] + 16 ) ;
}
else
#endif
{
...
V_42 = V_37 [ 0 ] ; V_43 = V_37 [ 1 ] ; V_44 = V_37 [ 2 ] ; V_45 = V_37 [ 3 ] ;
V_36 [ 0 ] = V_42 ; V_36 [ 1 ] = V_43 ; V_36 [ 2 ] = V_44 ; V_36 [ 3 ] = V_45 ;
}
switch ( V_34 -> V_23 & 3 )
{
case 3 : V_36 [ 2 ] = V_37 [ 2 ] ;
case 2 : V_36 [ 1 ] = V_37 [ 1 ] ;
case 1 : V_36 [ 0 ] = V_37 [ 0 ] ;
case 0 :
;
}
}
...
T_1 * F_21 ( const T_1 * V_34 , int V_35 )
{
T_1 * V_46 = NULL ;
F_8 ( V_34 ) ;
if ( V_35 > V_34 -> V_26 )
...
T_1 * F_22 ( const T_1 * V_21 )
{
T_1 * V_47 ;
if ( V_21 == NULL ) return NULL ;
F_8 ( V_21 ) ;
V_47 = F_17 () ;
...
T_1 * F_24 ( T_1 * V_21 , const T_1 * V_34 )
{
int V_22 ;
T_2 * V_36 ;
const T_2 * V_37 ;
F_8 ( V_34 ) ;
if ( V_21 == V_34 ) return ( V_21 ) ;
if ( F_25 ( V_21 , V_34 -> V_23 ) == NULL ) return ( NULL ) ;
#if 1
V_36 = V_21 -> V_25 ;
V_37 = V_34 -> V_25 ;
for ( V_22 = V_34 -> V_23 >> 2 ; V_22 > 0 ; V_22 -- , V_36 += 4 , V_37 += 4 )
...
V_34 -> V_26 = V_52 ;
V_34 -> V_33 = V_53 ;
V_21 -> V_28 = ( V_48 & V_27 ) | ( V_49 & V_16 ) ;
V_34 -> V_28 = ( V_49 & V_27 ) | ( V_48 & V_16 ) ;
F_8 ( V_21 ) ;
F_8 ( V_34 ) ;
}
void F_27 ( T_1 * V_21 )
...
int F_29 ( T_1 * V_21 , T_2 V_55 )
{
F_8 ( V_21 ) ;
if ( F_30 ( V_21 , ( int ) sizeof( T_2 ) * 8 ) == NULL ) return ( 0 ) ;
V_21 -> V_33 = 0 ;
V_21 -> V_25 [ 0 ] = V_55 ;
V_21 -> V_23 = ( V_55 ? 1 : 0 ) ;
F_8 ( V_21 ) ;
...
T_1 * F_31 ( const unsigned char * V_56 , int V_57 , T_1 * V_30 )
{
...
int F_33 ( const T_1 * V_21 , unsigned char * V_62 )
{
int V_59 , V_22 ;
T_2 V_17 ;
F_8 ( V_21 ) ;
...
int F_35 ( const T_1 * V_21 , const T_1 * V_34 )
{
int V_22 ;
...
if ( V_21 -> V_23 > V_34 -> V_23 ) return ( V_67 ) ;
if ( V_21 -> V_23 < V_34 -> V_23 ) return ( V_68 ) ;
for ( V_22 = V_21 -> V_23 - 1 ; V_22 >= 0 ; V_22 -- )
{
V_63 = V_21 -> V_25 [ V_22 ] ;
V_64 = V_34 -> V_25 [ V_22 ] ;
if ( V_63 > V_64 ) return ( V_67 ) ;
if ( V_63 < V_64 ) return ( V_68 ) ;
}
return ( 0 ) ;
}
int F_37 ( T_1 * V_21 , int V_59 )
{
int V_22 , V_69 , V_70 ;
if ( V_59 < 0 )
return 0 ;
...
if ( V_21 -> V_23 <= V_22 )
{
if ( F_25 ( V_21 , V_22 + 1 ) == NULL ) return ( 0 ) ;
...
V_22 = V_59 / V_24 ;
V_69 = V_59 % V_24 ;
if ( V_21 -> V_23 <= V_22 ) return ( 0 ) ;
V_21 -> V_25 [ V_22 ] &= ( ~ ( ( ( T_2 ) 1 ) << V_69 ) ) ;
F_32 ( V_21 ) ;
return ( 1 ) ;
}
int F_39 ( const T_1 * V_21 , int V_59 )
{
int V_22 , V_69 ;
F_8 ( V_21 ) ;
if ( V_59 < 0 ) return 0 ;
...
int F_42 ( const T_2 * V_21 , const T_2 * V_34 , int V_59 )
{
int V_22 ;
T_2 V_71 , V_72 ;
V_71 = V_21 [ V_59 - 1 ] ;
V_72 = V_34 [ V_59 - 1 ] ;
if ( V_71 != V_72 ) return ( ( V_71 > V_72 ) ? 1 : - 1 ) ;
...
int F_43 ( const T_2 * V_21 , const T_2 * V_34 ,
int V_73 , int V_74 )
{
int V_59 , V_22 ;
V_59 = V_73 - 1 ;
