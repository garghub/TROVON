...
static int F_64 ( T_11 * V_70 , const T_4 * V_84 ,
const T_3 * V_85 ,
int V_82 , T_12 * V_86 )
{
T_13 * V_87 ;
...
if ( F_67 ( V_70 , L_10 , 1 ) != 1 )
goto V_18;
if ( ! F_54 ( V_70 , L_11 , V_87 -> V_89 , V_73 , V_82 ) )
goto V_18;
if ( ! F_54 ( V_70 , L_12 , V_87 -> V_90 , V_73 , V_82 ) )
goto V_18;
V_88 = 1 ;
V_18:
if ( V_73 )
...
return F_69 ( V_70 , V_85 , V_82 ) ;
}
static int F_70 ( T_1 * V_1 , int V_92 , long V_93 , void * V_94 )
{
switch ( V_92 )
{
case V_95 :
...
int V_96 , V_97 ;
T_4 * V_98 , * V_99 ;
F_71 ( V_94 , NULL , & V_98 , & V_99 ) ;
if ( V_98 == NULL || V_98 -> V_100 == NULL )
return - 1 ;
V_97 = F_72 ( V_98 -> V_100 ) ;
if ( V_97 == V_101 )
return - 1 ;
if ( ! F_73 ( & V_96 , V_97 , F_74 ( V_1 ) ) )
return - 1 ;
F_75 ( V_99 , F_17 ( V_96 ) , V_20 , 0 ) ;
}
return 1 ;
#ifndef F_76
case V_102 :
