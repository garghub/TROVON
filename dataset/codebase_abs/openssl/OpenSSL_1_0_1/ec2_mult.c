...
T_6 V_38 , const T_4 * V_39 [] , const T_2 * V_40 [] , T_3 * V_4 )
{
T_3 * V_41 = NULL ;
int V_6 = 0 ;
T_6 V_25 ;
...
if ( ( V_23 && ( V_38 > 1 ) ) || ( V_38 > 2 ) || ( V_38 == 0 && F_20 ( V_1 ) ) )
{
V_6 = F_21 ( V_1 , V_22 , V_23 , V_38 , V_39 , V_40 , V_4 ) ;
goto V_7;
}
if ( ( V_42 = F_22 ( V_1 ) ) == NULL ) goto V_7;
if ( ( V_43 = F_22 ( V_1 ) ) == NULL ) goto V_7;
if ( ! F_15 ( V_1 , V_43 ) ) goto V_7;
if ( V_23 )
{
if ( ! F_12 ( V_1 , V_42 , V_23 , V_1 -> V_44 , V_4 ) ) goto V_7;
if ( F_23 ( V_23 ) )
if ( ! V_1 -> V_8 -> V_45 ( V_1 , V_42 , V_4 ) ) goto V_7;
if ( ! V_1 -> V_8 -> V_46 ( V_1 , V_43 , V_43 , V_42 , V_4 ) ) goto V_7;
}
for ( V_25 = 0 ; V_25 < V_38 ; V_25 ++ )
{
if ( ! F_12 ( V_1 , V_42 , V_40 [ V_25 ] , V_39 [ V_25 ] , V_4 ) ) goto V_7;
if ( F_23 ( V_40 [ V_25 ] ) )
if ( ! V_1 -> V_8 -> V_45 ( V_1 , V_42 , V_4 ) ) goto V_7;
if ( ! V_1 -> V_8 -> V_46 ( V_1 , V_43 , V_43 , V_42 , V_4 ) ) goto V_7;
}
if ( ! F_24 ( V_22 , V_43 ) ) goto V_7;
V_6 = 1 ;
V_7:
if ( V_42 ) F_25 ( V_42 ) ;
if ( V_43 ) F_25 ( V_43 ) ;
