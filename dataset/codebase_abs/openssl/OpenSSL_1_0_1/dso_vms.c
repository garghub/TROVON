...
if ( V_12 != NULL && V_12 > V_11 ) V_11 = V_12 ;
if ( V_11 == NULL ) V_11 = strrchr ( V_4 , ':' ) ;
if ( V_11 == NULL )
V_11 = V_4 ;
else
V_11 ++ ;
V_12 = strchr ( V_11 , '.' ) ;
if ( V_12 == NULL ) V_12 = strchr ( V_11 , ';' ) ;
if ( V_12 == NULL ) V_12 = V_11 + strlen ( V_11 ) ;
if ( V_12 - V_11 > V_16
...
static char * F_23 ( T_2 * V_2 , const char * V_50 , const char * V_51 )
{
int V_40 ;
int V_52 , V_53 ;
struct V_54 V_55 ;
