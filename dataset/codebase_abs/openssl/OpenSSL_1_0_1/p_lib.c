...
static void F_14 ( T_1 * V_52 )
{
if ( V_52 -> V_2 && V_52 -> V_2 -> V_57 )
{
V_52 -> V_2 -> V_57 ( V_52 ) ;
V_52 -> V_1 . V_28 = NULL ;
}
...
static int F_48 ( T_8 * V_58 , const T_1 * V_1 , int V_59 ,
const char * V_60 )
{
F_49 ( V_58 , V_59 , 128 ) ;
F_50 ( V_58 , L_3 ,
...
int F_52 ( T_8 * V_58 , const T_1 * V_1 ,
int V_59 , T_9 * V_61 )
{
if ( V_1 -> V_2 && V_1 -> V_2 -> V_62 )
return V_1 -> V_2 -> V_62 ( V_58 , V_1 , V_59 , V_61 ) ;
return F_48 ( V_58 , V_1 , V_59 , L_4 ) ;
}
int F_53 ( T_8 * V_58 , const T_1 * V_1 ,
int V_59 , T_9 * V_61 )
{
if ( V_1 -> V_2 && V_1 -> V_2 -> V_63 )
return V_1 -> V_2 -> V_63 ( V_58 , V_1 , V_59 , V_61 ) ;
return F_48 ( V_58 , V_1 , V_59 , L_5 ) ;
}
int F_54 ( T_8 * V_58 , const T_1 * V_1 ,
int V_59 , T_9 * V_61 )
{
if ( V_1 -> V_2 && V_1 -> V_2 -> V_64 )
return V_1 -> V_2 -> V_64 ( V_58 , V_1 , V_59 , V_61 ) ;
return F_48 ( V_58 , V_1 , V_59 , L_6 ) ;
}
int F_55 ( T_1 * V_1 , int * V_65 )
{
if ( ! V_1 -> V_2 || ! V_1 -> V_2 -> V_66 )
return - 2 ;
return V_1 -> V_2 -> V_66 ( V_1 , V_67 ,
0 , V_65 ) ;
}
