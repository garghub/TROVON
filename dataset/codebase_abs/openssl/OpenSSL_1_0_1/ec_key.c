...
if ( V_26 == NULL )
return 0 ;
if ( ! F_24 ( & V_19 -> V_13 , V_26 , V_21 -> V_27 , V_21 -> V_29 , V_21 -> V_30 ) )
return 0 ;
}
V_19 -> V_9 = V_20 -> V_9 ;
V_19 -> V_10 = V_20 -> V_10 ;
...
if ( ( V_35 = F_22 () ) == NULL ) goto V_37;
if ( ( V_34 = F_31 () ) == NULL ) goto V_37;
if ( V_32 -> V_8 == NULL )
{
V_8 = F_22 () ;
if ( V_8 == NULL )
...
if ( F_42 ( V_32 -> V_6 , V_38 , V_32 -> V_7 ,
V_34 ) != 0 )
{
F_3 ( V_39 , V_45 ) ;
goto V_37;
...
int F_43 ( T_1 * V_46 , T_5 * V_47 , T_5 * V_48 )
{
T_4 * V_34 = NULL ;
T_5 * V_49 , * V_50 ;
T_6 * V_38 = NULL ;
...
void * F_65 ( T_1 * V_46 ,
void * (* V_27)( void * ) , void (* V_29)( void * ) , void (* V_30)( void * ) )
{
return F_66 ( V_46 -> V_13 , V_27 , V_29 , V_30 ) ;
}
void F_67 ( T_1 * V_46 , void * V_28 ,
void * (* V_27)( void * ) , void (* V_29)( void * ) , void (* V_30)( void * ) )
{
T_2 * V_57 ;
F_68 ( V_17 ) ;
V_57 = F_66 ( V_46 -> V_13 , V_27 , V_29 , V_30 ) ;
if ( V_57 == NULL )
F_24 ( & V_46 -> V_13 , V_28 , V_27 , V_29 , V_30 ) ;
F_69 ( V_17 ) ;
}
void F_70 ( T_1 * V_46 , int V_58 )
{
if ( V_46 -> V_6 != NULL )
F_71 ( V_46 -> V_6 , V_58 ) ;
}
int F_72 ( T_1 * V_46 , T_4 * V_34 )
{
if ( V_46 -> V_6 == NULL )
return 0 ;
return F_73 ( V_46 -> V_6 , V_34 ) ;
}
int F_74 ( const T_1 * V_46 )
{
return V_46 -> V_5 ;
}
void F_75 ( T_1 * V_46 , int V_5 )
{
V_46 -> V_5 |= V_5 ;
}
void F_76 ( T_1 * V_46 , int V_5 )
{
V_46 -> V_5 &= ~ V_5 ;
}
