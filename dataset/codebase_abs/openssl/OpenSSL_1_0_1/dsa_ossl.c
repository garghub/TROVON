...
{
if ( ! F_6 ( V_4 , V_10 , & V_5 , & V_6 ) ) goto V_19;
}
else
{
V_5 = V_4 -> V_5 ;
...
if ( ! F_12 ( V_7 , V_7 , V_4 -> V_16 ) ) goto V_19;
if ( ! F_9 ( V_7 , V_7 , V_5 , V_4 -> V_16 , V_10 ) ) goto V_19;
V_13 = F_13 () ;
if ( V_13 == NULL ) goto V_19;
...
static int F_19 ( T_3 * V_4 , T_5 * V_24 , T_4 * * V_25 , T_4 * * V_26 )
{
T_5 * V_10 ;
...
if ( V_24 == NULL )
{
if ( ( V_10 = F_5 () ) == NULL ) goto V_19;
}
else
V_10 = V_24 ;
if ( ( V_6 = F_4 () ) == NULL ) goto V_19;
do
if ( ! F_20 ( & V_27 , V_4 -> V_16 ) ) goto V_19;
while ( F_14 ( & V_27 ) );
if ( ( V_4 -> V_31 & V_32 ) == 0 )
{
F_21 ( & V_27 , V_33 ) ;
...
if ( ( V_4 -> V_31 & V_32 ) == 0 )
{
if ( ! F_23 ( & V_28 , & V_27 ) ) goto V_19;
if ( ! F_10 ( & V_28 , & V_28 , V_4 -> V_16 ) ) goto V_19;
...
if ( ( V_5 = F_27 ( NULL , & V_27 , V_4 -> V_16 , V_10 ) ) == NULL ) goto V_19;
if ( * V_25 != NULL ) F_18 ( * V_25 ) ;
* V_25 = V_5 ;
V_5 = NULL ;
if ( * V_26 != NULL ) F_18 ( * V_26 ) ;
* V_26 = V_6 ;
V_13 = 1 ;
V_19:
if ( ! V_13 )
...
if ( V_24 == NULL ) F_17 ( V_10 ) ;
F_18 ( & V_27 ) ;
F_18 ( & V_28 ) ;
return ( V_13 ) ;
}
static int F_28 ( const unsigned char * V_2 , int V_37 , T_2 * V_38 ,
T_3 * V_4 )
{
T_5 * V_10 ;
T_4 V_39 , V_40 , V_41 ;
...
if ( ( F_27 ( & V_40 , V_38 -> V_7 , V_4 -> V_16 , V_10 ) ) == NULL ) goto V_19;
if ( V_37 > ( V_43 >> 3 ) )
V_37 = ( V_43 >> 3 ) ;
if ( F_8 ( V_2 , V_37 , & V_39 ) == NULL ) goto V_19;
if ( ! F_9 ( & V_39 , & V_39 , & V_40 , V_4 -> V_16 , V_10 ) ) goto V_19;
if ( ! F_9 ( & V_40 , V_38 -> V_6 , & V_40 , V_4 -> V_16 , V_10 ) ) goto V_19;
if ( V_4 -> V_31 & V_34 )
{
V_42 = F_22 ( & V_4 -> V_35 ,
V_36 , V_4 -> V_15 , V_10 ) ;
...
if ( ! F_26 ( & V_39 , & V_41 , V_4 -> V_16 , V_10 ) ) goto V_19;
V_13 = ( F_30 ( & V_39 , V_38 -> V_6 ) == 0 ) ;
V_19:
if ( V_13 != 1 ) F_15 ( V_44 , V_12 ) ;
if ( V_10 != NULL ) F_17 ( V_10 ) ;
F_16 ( & V_39 ) ;
F_16 ( & V_40 ) ;
F_16 ( & V_41 ) ;
