void F_1 ( T_1 * V_1 ,
unsigned int V_2 , unsigned int V_3 , void * V_4 , T_2 V_5 )
{
...
if ( V_14 == 0 ) return;
V_1 -> V_6 . V_7 [ 0 ] |= 0x40 ;
(* V_5)( V_1 -> V_6 . V_7 , V_1 -> V_16 . V_7 , V_1 -> V_4 ) ,
V_1 -> V_9 ++ ;
...
else if ( sizeof( V_14 ) == 8 && V_14 >= ( T_3 ) 1 << ( 32 % ( sizeof( V_14 ) * 8 ) ) ) {
V_1 -> V_16 . V_7 [ 0 ] ^= 0xFF ;
V_1 -> V_16 . V_7 [ 1 ] ^= 0xFF ;
...
(* V_5)( V_1 -> V_16 . V_7 , V_1 -> V_16 . V_7 , V_1 -> V_4 ) ,
V_1 -> V_9 ++ ;
V_15 = 0 ;
} while ( V_14 );
}
...
T_2 V_5 = V_1 -> V_5 ;
void * V_4 = V_1 -> V_4 ;
union { T_4 V_23 [ 2 ] ; V_8 V_7 [ 16 ] ; } V_24 ;
if ( ! ( V_22 & 0x40 ) )
...
V_18 |= V_1 -> V_6 . V_7 [ 15 ] ;
V_1 -> V_6 . V_7 [ 15 ] = 1 ;
if ( V_18 != V_21 ) return - 1 ;
V_1 -> V_9 += ( ( V_21 + 15 ) >> 3 ) | 1 ;
if ( V_1 -> V_9 > ( F_6 ( 1 ) << 61 ) ) return - 2 ;
while ( V_21 >= 16 ) {
#if F_7 ( V_25 )
union { T_4 V_23 [ 2 ] ; V_8 V_7 [ 16 ] ; } V_26 ;
memcpy ( V_26 . V_7 , V_19 , 16 ) ;
V_1 -> V_16 . V_23 [ 0 ] ^= V_26 . V_23 [ 0 ] ;
V_1 -> V_16 . V_23 [ 1 ] ^= V_26 . V_23 [ 1 ] ;
#else
V_1 -> V_16 . V_23 [ 0 ] ^= ( ( T_4 * ) V_19 ) [ 0 ] ;
V_1 -> V_16 . V_23 [ 1 ] ^= ( ( T_4 * ) V_19 ) [ 1 ] ;
#endif
(* V_5)( V_1 -> V_16 . V_7 , V_1 -> V_16 . V_7 , V_4 ) ;
(* V_5)( V_1 -> V_6 . V_7 , V_24 . V_7 , V_4 ) ;
F_4 ( V_1 -> V_6 . V_7 ) ;
#if F_7 ( V_25 )
V_26 . V_23 [ 0 ] ^= V_24 . V_23 [ 0 ] ;
V_26 . V_23 [ 1 ] ^= V_24 . V_23 [ 1 ] ;
memcpy ( V_20 , V_26 . V_7 , 16 ) ;
#else
( ( T_4 * ) V_20 ) [ 0 ] = V_24 . V_23 [ 0 ] ^ ( ( T_4 * ) V_19 ) [ 0 ] ;
( ( T_4 * ) V_20 ) [ 1 ] = V_24 . V_23 [ 1 ] ^ ( ( T_4 * ) V_19 ) [ 1 ] ;
#endif
V_19 += 16 ;
V_20 += 16 ;
V_21 -= 16 ;
...
if ( V_21 ) {
for ( V_15 = 0 ; V_15 < V_21 ; ++ V_15 ) V_1 -> V_16 . V_7 [ V_15 ] ^= V_19 [ V_15 ] ;
(* V_5)( V_1 -> V_16 . V_7 , V_1 -> V_16 . V_7 , V_4 ) ;
(* V_5)( V_1 -> V_6 . V_7 , V_24 . V_7 , V_4 ) ;
for ( V_15 = 0 ; V_15 < V_21 ; ++ V_15 ) V_20 [ V_15 ] = V_24 . V_7 [ V_15 ] ^ V_19 [ V_15 ] ;
}
for ( V_15 = 15 - V_3 ; V_15 < 16 ; ++ V_15 )
V_1 -> V_6 . V_7 [ V_15 ] = 0 ;
(* V_5)( V_1 -> V_6 . V_7 , V_24 . V_7 , V_4 ) ;
V_1 -> V_16 . V_23 [ 0 ] ^= V_24 . V_23 [ 0 ] ;
V_1 -> V_16 . V_23 [ 1 ] ^= V_24 . V_23 [ 1 ] ;
V_1 -> V_6 . V_7 [ 0 ] = V_22 ;
return 0 ;
}
int F_8 ( T_1 * V_1 ,
...
#if F_7 ( V_25 )
memcpy ( V_26 . V_7 , V_19 , 16 ) ;
V_1 -> V_16 . V_23 [ 0 ] ^= ( V_24 . V_23 [ 0 ] ^= V_26 . V_23 [ 0 ] ) ;
V_1 -> V_16 . V_23 [ 1 ] ^= ( V_24 . V_23 [ 1 ] ^= V_26 . V_23 [ 1 ] ) ;
memcpy ( V_20 , V_24 . V_7 , 16 ) ;
#else
V_1 -> V_16 . V_23 [ 0 ] ^= ( ( ( T_4 * ) V_20 ) [ 0 ] = V_24 . V_23 [ 0 ] ^ ( ( T_4 * ) V_19 ) [ 0 ] ) ;
V_1 -> V_16 . V_23 [ 1 ] ^= ( ( ( T_4 * ) V_20 ) [ 1 ] = V_24 . V_23 [ 1 ] ^ ( ( T_4 * ) V_19 ) [ 1 ] ) ;
#endif
(* V_5)( V_1 -> V_16 . V_7 , V_1 -> V_16 . V_7 , V_4 ) ;
V_19 += 16 ;
V_20 += 16 ;
...
V_1 -> V_16 . V_7 [ V_15 ] ^= ( V_20 [ V_15 ] = V_24 . V_7 [ V_15 ] ^ V_19 [ V_15 ] ) ;
(* V_5)( V_1 -> V_16 . V_7 , V_1 -> V_16 . V_7 , V_4 ) ;
}
for ( V_15 = 15 - V_3 ; V_15 < 16 ; ++ V_15 )
V_1 -> V_6 . V_7 [ V_15 ] = 0 ;
...
static void F_9 ( unsigned char * V_17 , T_3 V_27 )
{ T_3 V_18 = 8 , V_28 = 0 ;
V_17 += 8 ;
do {
-- V_18 ;
V_28 += V_17 [ V_18 ] + ( V_27 & 0xff ) ;
V_17 [ V_18 ] = ( unsigned char ) V_28 ;
V_28 >>= 8 ;
V_27 >>= 8 ;
...
if ( V_1 -> V_9 > ( F_6 ( 1 ) << 61 ) ) return - 2 ;
if ( ( V_18 = V_21 / 16 ) ) {
(* V_29)( V_19 , V_20 , V_18 , V_4 , V_1 -> V_6 . V_7 , V_1 -> V_16 . V_7 ) ;
V_18 *= 16 ;
V_19 += V_18 ;
V_20 += V_18 ;
V_21 -= V_18 ;
if ( V_21 ) F_9 ( V_1 -> V_6 . V_7 , V_18 / 16 ) ;
}
if ( V_21 ) {
for ( V_15 = 0 ; V_15 < V_21 ; ++ V_15 ) V_1 -> V_16 . V_7 [ V_15 ] ^= V_19 [ V_15 ] ;
(* V_5)( V_1 -> V_16 . V_7 , V_1 -> V_16 . V_7 , V_4 ) ;
...
T_3 F_12 ( T_1 * V_1 , unsigned char * V_30 , T_3 V_21 )
{ unsigned int V_2 = ( V_1 -> V_6 . V_7 [ 0 ] >> 3 ) & 7 ;
V_2 *= 2 ; V_2 += 2 ;
if ( V_21 < V_2 ) return 0 ;
memcpy ( V_30 , V_1 -> V_16 . V_7 , V_2 ) ;
return V_2 ;
}
