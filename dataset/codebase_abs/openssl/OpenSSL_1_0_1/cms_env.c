...
V_73 . V_69 = ( int ) V_72 ;
return F_39 ( & V_73 , V_74 -> V_79 -> V_80 ) ;
}
static T_14 F_40 ( int V_81 )
{
switch ( V_81 )
{
case V_82 :
...
if ( F_46 ( V_74 -> V_61 , V_74 -> V_62 << 3 , & V_104 ) )
{
F_3 ( V_108 ,
V_110 ) ;
goto V_24;
...
V_106 = F_47 ( & V_104 , NULL , V_105 , V_52 -> V_61 , V_52 -> V_62 ) ;
if ( V_106 <= 0 )
{
F_3 ( V_108 , V_111 ) ;
goto V_24;
...
F_54 ( T_4 ) * V_122 ;
T_4 * V_20 ;
int V_23 , V_107 , V_123 = 0 ;
T_21 * V_56 ;
V_52 = V_1 -> V_6 . V_7 -> V_12 ;
V_56 = F_55 ( V_52 ) ;
if ( ! V_56 || ! V_52 -> V_14 )
return V_56 ;
V_122 = V_1 -> V_6 . V_7 -> V_40 ;
for ( V_23 = 0 ; V_23 < F_56 ( V_122 ) ; V_23 ++ )
{
V_20 = F_57 ( V_122 , V_23 ) ;
switch ( V_20 -> type )
{
case V_25 :
V_107 = F_25 ( V_1 , V_20 ) ;
