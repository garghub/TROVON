...
int V_27 , V_28 , V_29 = 0 , V_30 = 0 , V_31 = 0 , V_32 = V_33 ;
int V_34 = 0 , V_35 = 0 , V_36 = 0 , V_37 = 0 , V_38 = 0 ;
char * V_39 , * V_40 , * V_41 , * V_42 = NULL , * V_43 = NULL , * V_44 = NULL ;
#ifndef F_2
char * V_45 = NULL ;
#endif
char * V_46 = NULL ;
...
{
if ( -- V_1 < 1 ) goto V_70;
if ( ! F_15 ( & V_5 , * ( ++ V_2 ) ) ) goto V_70;
}
else if ( strcmp ( * V_2 , L_29 ) == 0 )
{
if ( -- V_1 < 1 ) goto V_70;
if ( ! F_16 ( & V_6 , * ( ++ V_2 ) ) ) goto V_70;
}
...
if ( V_24 <= 0 )
{
if ( ! F_41 ( V_65 , V_78 , V_85 , & V_24 ) )
V_24 = V_86 ;
}
if ( V_24 < V_87 && ( V_23 == V_88 || V_23 == V_89 ) )
{
F_12 ( V_66 , L_100 ) ;
F_12 ( V_66 , L_101 , V_87 , V_24 ) ;
goto V_71;
}
if ( ! V_12 )
{
V_12 = F_40 ( V_66 , NULL , & V_23 , & V_24 ,
& V_14 , V_4 ) ;
if ( ! V_12 )
goto V_71;
}
...
T_5 * V_100 ;
T_10 V_101 ;
if ( ( V_10 = F_66 () ) == NULL ) goto V_71;
if( V_46 && ! F_67 ( V_10 , 2 ) ) goto V_71;
if ( V_49 )
{
if ( ! F_68 ( V_10 , V_49 ) ) goto V_71;
}
else
{
if ( ! F_69 ( NULL ,
...
if ( ! F_71 ( V_10 , F_72 ( V_11 ) ) ) goto V_71;
if ( ! F_73 ( F_74 ( V_10 ) , 0 ) ) goto V_71;
if ( ! F_75 ( F_76 ( V_10 ) , V_9 , 0 , NULL ) ) goto V_71;
if ( ! F_77 ( V_10 , F_72 ( V_11 ) ) ) goto V_71;
V_100 = F_78 ( V_11 ) ;
if ( ! V_100 || ! F_79 ( V_10 , V_100 ) ) goto V_71;
F_80 ( V_100 ) ;
...
{
if( V_8 )
F_85 ( V_26 , L_123 , F_92 ( V_10 ) , V_5 ) ;
else
F_85 ( V_26 , L_123 , F_72 ( V_11 ) , V_5 ) ;
}
if ( V_50 )
{
T_5 * V_105 ;
...
if( V_36 ) V_19 = F_98 ( V_26 , V_11 ) ;
else V_19 = F_99 ( V_26 , V_11 ) ;
} else {
F_12 ( V_66 , L_128 ) ;
goto V_71;
}
...
if ( ( V_65 != NULL ) && ( V_65 != V_76 ) ) F_103 ( V_65 ) ;
F_30 ( V_25 ) ;
F_104 ( V_26 ) ;
F_80 ( V_18 ) ;
if ( V_12 )
...
if ( V_104 == NULL )
F_27 () ;
if( ( V_104 != NULL ) && ! strcmp ( V_104 , L_109 ) ) V_110 = 1 ;
...
V_19 = F_116 ( V_11 , V_112 , V_114 , V_113 , V_115 , V_108 , V_61 ) ;
}
if( ! V_19 ) goto V_118;
if ( ! F_117 ( V_11 , V_18 ) ) goto V_118;
V_109 = 1 ;
V_118:
return ( V_109 ) ;
}
static int F_86 ( T_3 * V_11 , char * V_37 , unsigned long V_61 , int V_58 )
{
T_11 * V_107 ;
...
static int F_121 ( T_11 * V_107 , char * V_31 , const char * V_120 , char * V_121 ,
int V_122 , int V_123 , int V_124 , unsigned long V_61 , int V_125 )
{
int V_19 , V_109 = 0 ;
T_12 char V_126 [ 1024 ] ;
V_127:
if ( ! V_72 ) F_12 ( V_66 , L_133 , V_31 , V_120 ) ;
( void ) F_122 ( V_66 ) ;
if( V_121 != NULL )
{
...
#endif
if( ! F_127 ( V_19 , V_123 , V_124 ) ) goto V_127;
if ( ! F_128 ( V_107 , V_122 , V_61 ,
( unsigned char * ) V_126 , - 1 , - 1 , V_125 ) ) goto V_118;
V_109 = 1 ;
V_118:
return ( V_109 ) ;
}
...
{
F_12 ( V_66 , L_137 , V_123 ) ;
return ( 0 ) ;
}
if ( ( V_124 >= 0 ) && ( V_128 > V_124 ) )
{
F_12 ( V_66 , L_138 , V_124 ) ;
return ( 0 ) ;
}
return ( 1 ) ;
}
...
static T_4 * F_40 ( T_6 * V_118 , const char * V_132 , int * V_23 ,
long * V_133 , char * * V_134 ,
T_1 * V_135 )
{
T_4 * V_136 = NULL ;
T_5 * V_137 = NULL ;
...
F_133 ( NULL , V_23 , NULL , NULL , NULL ,
V_142 ) ;
#ifndef F_2
if ( V_141 )
F_134 ( V_141 ) ;
