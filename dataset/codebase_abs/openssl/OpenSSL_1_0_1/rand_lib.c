...
static void F_19 ( T_4 * V_16 , unsigned char * V_20 , T_3 V_21 )
{
F_20 ( V_20 , V_21 ) ;
F_18 ( V_20 ) ;
}
static T_3 F_21 ( T_4 * V_16 , unsigned char * * V_17 )
{
...
static int F_23 ( T_4 * V_16 , const void * V_23 , int V_24 ,
double V_11 )
{
...
if ( F_32 ( V_28 , V_30 , sizeof( V_30 ) ) <= 0 )
{
F_29 ( V_32 , V_34 ) ;
return 0 ;
}
