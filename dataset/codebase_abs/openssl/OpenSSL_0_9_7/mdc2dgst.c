...
int F_2 ( T_1 * V_1 , const unsigned char * V_7 , unsigned long V_8 )
{
int V_9 , V_10 ;
V_9 = V_1 -> V_2 ;
if ( V_9 != 0 )
...
static void F_3 ( T_1 * V_1 , const unsigned char * V_7 , unsigned int V_8 )
{
...
int F_9 ( unsigned char * V_20 , T_1 * V_1 )
{
int V_9 , V_10 ;
V_9 = V_1 -> V_2 ;
V_10 = V_1 -> V_3 ;
