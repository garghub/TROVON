...
char * V_1 ;
int V_2 , V_16 ;
if ( ( V_10 == NULL ) || ( V_10 -> V_8 == 0 ) || ( V_11 < 0 )
|| ( V_11 >= V_10 -> V_8 ) ) return ( NULL ) ;
V_1 = V_10 -> V_4 [ V_11 ] ;
if ( V_11 != V_10 -> V_8 - 1 )
{
V_16 = V_10 -> V_8 - 1 ;
...
V_17 = ( char * * ) bsearch ( & V_4 , ( char * ) V_10 -> V_4 ,
V_10 -> V_8 , sizeof( char * ) , F_10 ) ;
if ( V_17 == NULL ) return ( - 1 ) ;
V_2 = ( int ) ( V_17 - V_10 -> V_4 ) ;
for ( ; V_2 > 0 ; V_2 -- )
if ( (* V_10 -> V_6 )( ( const char * const * ) & ( V_10 -> V_4 [ V_2 - 1 ] ) ,
( const char * const * ) & V_4 ) < 0 )
break;
return ( V_2 ) ;
}
int F_12 ( T_1 * V_10 , char * V_4 )
{
...
void F_17 ( T_1 * V_10 , void (* F_18)( void * ) )
{
int V_2 ;
if ( V_10 == NULL ) return;
for ( V_2 = 0 ; V_2 < V_10 -> V_8 ; V_2 ++ )
...
int F_20 ( const T_1 * V_10 )
{
if( V_10 == NULL ) return - 1 ;
return V_10 -> V_8 ;
}
char * F_21 ( const T_1 * V_10 , int V_2 )
{
if( V_10 == NULL ) return NULL ;
return V_10 -> V_4 [ V_2 ] ;
}
char * F_22 ( T_1 * V_10 , int V_2 , char * V_18 )
{
if( V_10 == NULL ) return NULL ;
return ( V_10 -> V_4 [ V_2 ] = V_18 ) ;
}
void F_11 ( T_1 * V_10 )
{
if ( V_10 && ! V_10 -> V_9 )
