...
const char * F_32 ( T_1 * V_19 , int V_62 )
{
if ( V_62 < 0 )
{
F_4 ( V_63 , V_64 ) ;
...
if ( V_62 >= F_33 ( V_19 -> V_6 ) )
{
F_4 ( V_63 , V_65 ) ;
return NULL ;
}
return F_34 ( F_35 ( V_19 -> V_6 , V_62 ) ) ;
}
static int F_36 ( const char * V_66 , T_4 V_60 , T_1 * V_19 )
{
T_3 V_10 ;
...
if ( V_19 -> V_11 & V_70 )
F_38 (
( int ( * ) ( const char * , T_4 , void * ) ) F_36 ,
( void * ) V_19 ) ;
for( V_62 = 0 ; V_62 < F_33 ( V_19 -> V_6 ) ; V_62 ++ )
{
if ( V_19 -> V_5 -> V_67
&& ! V_19 -> V_5 -> V_67 ( V_19 ,
F_35 ( V_19 -> V_6 , V_62 ) ) )
...
int F_39 ( T_1 * V_19 , int V_74 , long V_62 , void * V_37 , void (* F_40)() )
{
if ( V_19 == NULL )
{
F_4 ( V_75 , V_26 ) ;
...
int F_41 ( long V_81 , void * V_82 , T_5 * V_83 ,
T_6 * V_84 , T_7 * V_85 )
{
return F_42 ( V_8 , V_81 , V_82 ,
V_83 , V_84 , V_85 ) ;
}
int F_43 ( T_1 * V_86 , int V_87 , void * V_88 )
{
return ( F_44 ( & V_86 -> V_9 , V_87 , V_88 ) ) ;
}
void * F_45 ( T_1 * V_86 , int V_87 )
{
return ( F_46 ( & V_86 -> V_9 , V_87 ) ) ;
}
void F_47 ( const T_2 * V_5 )
{
V_89 = V_5 ;
}
const T_2 * F_5 ( void )
...
const T_2 * F_49 ( T_1 * V_19 )
{
return V_19 -> V_5 ;
}
const T_2 * F_50 ( T_1 * V_19 , const T_2 * V_5 )
{
V_19 -> V_5 = V_5 ;
return V_19 -> V_5 ;
}
...
int F_53 ( T_2 * V_1 , int (* F_54)( T_1 * V_19 ) )
{
if ( V_1 )
{
V_1 -> V_69 = F_54 ;
...
int F_55 ( T_2 * V_1 , int (* F_56)( T_1 * V_19 , T_3 * V_10 ) )
{
if ( V_1 )
{
V_1 -> V_67 = F_56 ;
...
int F_57 ( T_2 * V_1 , int (* F_58)( T_1 * V_19 ) )
{
if ( V_1 )
{
V_1 -> V_71 = F_58 ;
...
int F_59 ( T_2 * V_1 , int (* F_60)( T_1 * V_19 , T_3 * V_10 ) )
{
if ( V_1 )
{
V_1 -> V_72 = F_60 ;
...
int F_61 ( T_2 * V_1 , int (* F_62)( T_1 * V_19 ) )
{
if ( V_1 )
{
V_1 -> V_73 = F_62 ;
...
const char * F_65 ( T_3 * V_10 )
{
if ( ! V_10 )
return NULL ;
return V_10 -> V_13 ;
}
const char * F_66 ( T_3 * V_10 )
{
if ( ! V_10 )
return NULL ;
switch( V_10 -> type )
...
int F_70 ( T_1 * V_19 , T_3 * V_10 , const char * V_93 )
{
...
case V_28 :
{
char V_95 [ F_71 ( V_10 -> _ . V_34 . V_35 ) + 1 ] ;
char V_96 [ F_71 ( V_10 -> _ . V_34 . V_36 ) + 1 ] ;
F_72 ( V_95 , sizeof( V_95 ) , L_4 ,
V_10 -> _ . V_34 . V_35 ) ;
F_72 ( V_96 , sizeof( V_96 ) , L_4 ,
V_10 -> _ . V_34 . V_36 ) ;
