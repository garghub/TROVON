...
if( V_2 < 2 ) return - 1 ;
if( ( V_4 [ 1 ] & 0xc0 ) != 0x80 ) return - 3 ;
V_5 = ( * V_4 ++ & 0x1f ) << 6 ;
V_5 |= * V_4 ++ & 0x3f ;
if( V_5 < 0x80 ) return - 4 ;
V_6 = 2 ;
} else if( ( * V_4 & 0xf0 ) == 0xe0 ) {
if( V_2 < 3 ) return - 1 ;
if( ( ( V_4 [ 1 ] & 0xc0 ) != 0x80 )
|| ( ( V_4 [ 2 ] & 0xc0 ) != 0x80 ) ) return - 3 ;
V_5 = ( * V_4 ++ & 0xf ) << 12 ;
V_5 |= ( * V_4 ++ & 0x3f ) << 6 ;
V_5 |= * V_4 ++ & 0x3f ;
if( V_5 < 0x800 ) return - 4 ;
V_6 = 3 ;
} else if( ( * V_4 & 0xf8 ) == 0xf0 ) {
if( V_2 < 4 ) return - 1 ;
if( ( ( V_4 [ 1 ] & 0xc0 ) != 0x80 )
|| ( ( V_4 [ 2 ] & 0xc0 ) != 0x80 )
|| ( ( V_4 [ 3 ] & 0xc0 ) != 0x80 ) ) return - 3 ;
V_5 = ( ( unsigned long ) ( * V_4 ++ & 0x7 ) ) << 18 ;
V_5 |= ( * V_4 ++ & 0x3f ) << 12 ;
V_5 |= ( * V_4 ++ & 0x3f ) << 6 ;
V_5 |= * V_4 ++ & 0x3f ;
if( V_5 < 0x10000 ) return - 4 ;
V_6 = 4 ;
...
{
if( ! V_1 ) V_2 = 6 ;
else if( V_2 <= 0 ) return - 1 ;
if( V_5 < 0x80 ) {
if( V_1 ) * V_1 = ( unsigned char ) V_5 ;
return 1 ;
}
if( V_5 < 0x800 ) {
if( V_2 < 2 ) return - 1 ;
