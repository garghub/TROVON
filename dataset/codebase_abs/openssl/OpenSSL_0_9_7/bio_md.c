...
static long F_17 ( T_2 * V_8 , int V_15 , T_5 * V_29 )
{
long V_11 = 1 ;
...
{
default:
V_11 = F_18 ( V_8 -> V_12 , V_15 , V_29 ) ;
break;
}
return ( V_11 ) ;
}
static int F_19 ( T_2 * V_30 , char * V_31 , int V_32 )
{
T_3 * V_3 ;
unsigned int V_11 ;
V_3 = V_30 -> V_5 ;
...
return ( 0 ) ;
F_20 ( V_3 , ( unsigned char * ) V_31 , & V_11 ) ;
return ( ( int ) V_11 ) ;
}
