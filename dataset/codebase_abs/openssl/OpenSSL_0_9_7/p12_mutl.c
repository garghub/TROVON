...
F_6 ( & V_7 ) ;
F_7 ( & V_7 , V_8 , V_9 , V_6 , NULL ) ;
F_8 ( & V_7 , V_1 -> V_22 -> V_23 . V_13 -> V_13 ,
V_1 -> V_22 -> V_23 . V_13 -> V_14 ) ;
F_9 ( & V_7 , V_4 , V_5 ) ;
F_10 ( & V_7 ) ;
return 1 ;
}
int F_11 ( T_1 * V_1 , const char * V_2 , int V_3 )
{
...
unsigned int V_5 ;
if ( ! V_6 ) V_6 = F_13 () ;
if ( F_14 ( V_1 , V_12 , V_10 , V_11 , V_6 ) ==
V_29 ) {
F_4 ( V_30 , V_31 ) ;
return 0 ;
}
...
if ( ! ( F_15 ( V_1 -> V_4 -> V_15 -> V_28 , V_4 , V_5 ) ) ) {
F_4 ( V_30 , V_32 ) ;
return 0 ;
}
return 1 ;
}
int F_14 ( T_1 * V_1 , int V_12 , unsigned char * V_10 , int V_11 ,
const T_2 * V_6 )
{
if ( ! ( V_1 -> V_4 = F_16 () ) ) return V_29 ;
if ( V_12 > 1 ) {
if( ! ( V_1 -> V_4 -> V_12 = F_17 () ) ) {
F_4 ( V_33 , V_34 ) ;
return 0 ;
}
F_18 ( V_1 -> V_4 -> V_12 , V_12 ) ;
}
if ( ! V_11 ) V_11 = V_35 ;
V_1 -> V_4 -> V_10 -> V_14 = V_11 ;
if ( ! ( V_1 -> V_4 -> V_10 -> V_13 = F_19 ( V_11 ) ) ) {
F_4 ( V_33 , V_34 ) ;
return 0 ;
}
if ( ! V_10 ) {
if ( F_20 ( V_1 -> V_4 -> V_10 -> V_13 , V_11 ) < 0 )
return 0 ;
}
else memcpy ( V_1 -> V_4 -> V_10 -> V_13 , V_10 , V_11 ) ;
V_1 -> V_4 -> V_15 -> V_16 -> V_17 = F_21 ( F_22 ( V_6 ) ) ;
if ( ! ( V_1 -> V_4 -> V_15 -> V_16 -> V_36 = F_23 () ) ) {
F_4 ( V_33 , V_34 ) ;
return 0 ;
}
