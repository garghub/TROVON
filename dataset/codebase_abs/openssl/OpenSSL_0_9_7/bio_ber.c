...
if ( V_11 )
{
V_11 = F_9 ( V_9 -> V_22 , & ( V_3 -> V_10 [ V_3 -> V_20 ] ) , V_11 ) ;
if ( V_11 <= 0 )
{
F_10 ( V_8 ) ;
return ( V_11 ) ;
...
V_18 = V_3 -> V_20 ;
V_15 = V_3 -> V_10 ;
V_14 = F_11 ( & V_15 , & T_4 , & V_16 , & V_17 , V_18 ) ;
if ( V_14 & 0x80 )
{
if ( ( V_3 -> V_20 < V_21 ) &&
( F_12 ( F_13 () ) == V_23 ) )
...
static int F_18 ( T_2 * V_8 , char * V_27 , int V_28 )
{
...
static int F_19 ( T_2 * V_8 , char * V_33 , int V_34 )
{
...
while ( V_13 > 0 )
{
V_11 = F_20 ( V_8 -> V_22 , & ( V_3 -> V_10 [ V_3 -> V_19 ] ) , V_13 ) ;
if ( V_11 <= 0 )
{
F_10 ( V_8 ) ;
return ( V_11 ) ;
...
static long F_22 ( T_2 * V_8 , int V_37 , long V_38 , char * V_5 )
{
T_2 * V_39 ;
T_5 * V_3 , * V_40 ;
long V_14 = 1 ;
...
V_3 -> V_42 = 1 ;
V_3 -> V_29 = 0 ;
F_23 ( & ( V_3 -> V_36 ) , NULL , NULL , NULL , NULL ,
V_3 -> V_36 . V_43 ) ;
V_14 = F_24 ( V_8 -> V_22 , V_37 , V_38 , V_5 ) ;
break;
case V_44 :
if ( V_3 -> V_45 <= 0 )
V_14 = 1 ;
...
static long F_26 ( T_2 * V_8 , int V_37 , void * (* F_27)() )
{
long V_14 = 1 ;
if ( V_8 -> V_22 == NULL ) return ( 0 ) ;
switch ( V_37 )
{
default:
V_14 = F_28 ( V_8 -> V_22 , V_37 , F_27 ) ;
break;
}
return ( V_14 ) ;
}
void F_29 ( T_2 * V_8 , T_6 * V_52 , unsigned char * V_53 , unsigned char * V_11 ,
int V_54 )
{
T_5 * V_3 ;
if ( V_8 == NULL ) return;
...
V_8 -> V_4 = 1 ;
V_3 = ( T_5 * ) V_8 -> V_5 ;
F_23 ( & ( V_3 -> V_36 ) , V_52 , NULL , V_53 , V_11 , V_54 ) ;
if ( V_8 -> V_55 != NULL )
