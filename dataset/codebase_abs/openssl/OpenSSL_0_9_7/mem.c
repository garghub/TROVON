...
int F_12 ( void * (* F_8)( T_1 ) , void (* F_10)( void * ) )
{
if ( ! V_4 )
return 0 ;
...
int F_14 ( void (* F_8)( void * , int , const char * , int , int ) ,
...
void F_17 ( void * (* * F_8)( T_1 ) , void * (* * F_9)( void * , T_1 ) ,
void (* * F_10)( void * ) )
{
...
void F_19 ( void * (* * F_8)( T_1 ) , void (* * F_10)( void * ) )
{
...
void F_21 ( void (* * F_8)( void * , int , const char * , int , int ) ,
void (* * F_9)( void * , void * , int , const char * , int , int ) ,
void (* * F_10)( void * , int ) ,
void (* * F_15)( long ) ,
long (* * F_16)( void ) )
...
if ( F_15 != NULL ) * F_15 = V_14 ;
if ( F_16 != NULL ) * F_16 = V_15 ;
}
void * F_22 ( int V_1 , const char * V_2 , int line )
{
void * V_16 = NULL ;
extern unsigned char V_17 ;
V_4 = 0 ;
if ( V_11 != NULL )
{
V_10 = 0 ;
...
#ifdef F_23
fprintf ( V_18 , L_1 , V_16 , V_1 ) ;
#endif
if ( V_11 != NULL )
V_11 ( V_16 , V_1 , V_2 , line , 1 ) ;
if( V_16 && ( V_1 > 2048 ) )
( ( unsigned char * ) V_16 ) [ 0 ] = V_17 ;
return V_16 ;
}
void F_24 ( void * V_3 )
{
...
V_13 ( V_3 , 0 ) ;
#ifdef F_23
fprintf ( V_18 , L_2 , V_3 ) ;
#endif
V_9 ( V_3 ) ;
if ( V_13 != NULL )
V_13 ( NULL , 1 ) ;
}
void * F_25 ( int V_1 , const char * V_2 , int line )
{
void * V_16 = NULL ;
extern unsigned char V_17 ;
V_4 = 0 ;
...
void * F_26 ( void * V_3 , int V_1 , const char * V_2 , int line )
{
void * V_16 = NULL ;
if ( V_3 == NULL )
return F_25 ( V_1 , V_2 , line ) ;
if ( V_12 != NULL )
V_12 ( V_3 , NULL , V_1 , V_2 , line , 0 ) ;
V_16 = V_6 ( V_3 , V_1 , V_2 , line ) ;
#ifdef F_23
fprintf ( V_18 , L_3 , V_3 , V_16 , V_1 ) ;
#endif
if ( V_12 != NULL )
V_12 ( V_3 , V_16 , V_1 , V_2 , line , 1 ) ;
return V_16 ;
}
void * F_27 ( void * V_3 , int V_19 , int V_1 , const char * V_2 ,
int line )
{
void * V_16 = NULL ;
if ( V_3 == NULL )
...
void * F_30 ( void * V_20 , int V_1 , const char * V_2 , int line )
{
if ( V_20 != NULL ) F_31 ( V_20 ) ;
V_20 = ( char * ) F_32 ( V_1 ) ;
return ( V_20 ) ;
}
void F_33 ( long V_21 )
