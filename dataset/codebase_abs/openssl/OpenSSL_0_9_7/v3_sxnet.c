...
if( V_4 == - 1 ) V_4 = strlen ( V_3 ) ;
if( V_4 > 64 ) {
F_3 ( V_13 , V_15 ) ;
return 0 ;
}
if( ! * V_1 ) {
if( ! ( V_11 = F_9 () ) ) goto V_16;
if( ! F_7 ( V_11 -> V_17 , 0 ) ) goto V_16;
* V_1 = V_11 ;
} else V_11 = * V_1 ;
if( F_10 ( V_11 , V_2 ) ) {
F_3 ( V_13 , V_18 ) ;
...
if( ! ( V_12 = F_11 () ) ) goto V_16;
if( V_4 == - 1 ) V_4 = strlen ( V_3 ) ;
if( ! F_12 ( V_12 -> V_3 , V_3 , V_4 ) ) goto V_16;
if( ! F_13 ( V_11 -> V_19 , V_12 ) ) goto V_16;
V_12 -> V_2 = V_2 ;
return 1 ;
V_16:
F_3 ( V_13 , V_10 ) ;
...
if( ! F_20 ( V_12 -> V_2 , V_2 ) ) return V_12 -> V_3 ;
}
return NULL ;
}
