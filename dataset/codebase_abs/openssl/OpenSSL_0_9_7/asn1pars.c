...
if ( V_23 ) {
if( ! ( V_14 = F_17 ( V_23 , L_30 ) ) ) {
F_7 ( V_29 , L_29 , V_23 ) ;
F_11 ( V_29 ) ;
goto V_33;
}
}
if ( ( V_25 = F_18 () ) == NULL ) goto V_33;
if ( ! F_19 ( V_25 , V_37 * 8 ) ) goto V_33;
if ( V_15 == V_28 )
{
T_1 * V_38 ;
if ( ( V_13 = F_2 ( F_20 () ) ) == NULL )
goto V_33;
F_14 ( V_13 , V_11 ) ;
V_38 = V_11 ;
V_11 = V_13 ;
...
for (; ; )
{
if ( ! F_19 ( V_25 , ( int ) V_9 + V_37 ) ) goto V_33;
V_3 = F_21 ( V_11 , & ( V_25 -> V_39 [ V_9 ] ) , V_37 ) ;
if ( V_3 <= 0 ) break;
V_9 += V_3 ;
}
V_20 = V_25 -> V_39 ;
...
V_10 = V_9 ;
for ( V_3 = 0 ; V_3 < F_22 ( V_26 ) ; V_3 ++ )
{
T_4 * V_40 ;
V_7 = atoi ( F_23 ( V_26 , V_3 ) ) ;
if ( V_7 == 0 )
{
F_7 ( V_29 , L_31 , F_23 ( V_26 , V_3 ) ) ;
continue;
}
V_24 += V_7 ;
V_10 -= V_7 ;
V_40 = V_27 ;
V_27 = F_24 ( NULL , & V_24 , V_10 ) ;
F_25 ( V_40 ) ;
if( ! V_27 )
{
F_7 ( V_29 , L_32 ) ;
...
if( V_14 ) {
if( F_26 ( V_14 , V_20 + V_5 , V_8 ) != ( int ) V_8 ) {
F_7 ( V_29 , L_33 ) ;
F_11 ( V_29 ) ;
goto V_33;
}
...
if ( ! V_17 &&
! F_27 ( V_12 , ( unsigned char * ) & ( V_20 [ V_5 ] ) , V_8 ,
V_16 , V_18 ) )
{
F_11 ( V_29 ) ;
goto V_33;
...
if ( V_12 != NULL ) F_29 ( V_12 ) ;
if ( V_13 != NULL ) F_28 ( V_13 ) ;
if ( V_6 != 0 )
F_11 ( V_29 ) ;
if ( V_25 != NULL ) F_30 ( V_25 ) ;
if ( V_27 != NULL ) F_25 ( V_27 ) ;
if ( V_26 != NULL ) F_31 ( V_26 ) ;
F_32 () ;
F_33 () ;
F_34 ( V_6 ) ;
}
