...
static long F_45 ( T_1 * V_1 , int V_63 , V_79 * V_82 )
{
long V_3 = 1 ;
T_2 * V_58 ;
V_58 = ( T_2 * ) V_1 -> V_56 ;
...
case V_80 :
{
V_58 -> V_8 = ( int ( * ) ( const struct V_83 * , int , int ) ) V_82 ;
}
break;
default:
V_3 = 0 ;
...
static int F_46 ( T_1 * V_84 , const char * V_85 )
{
int V_86 , V_3 ;
V_86 = strlen ( V_85 ) ;
V_3 = F_35 ( V_84 , V_85 , V_86 ) ;
return ( V_3 ) ;
}
T_1 * F_47 ( char * V_85 )
{
