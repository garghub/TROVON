...
T_4 * V_21 = NULL , * V_22 = NULL , * V_23 = NULL , * V_24 = NULL , * V_25 = NULL , * V_26 = NULL ;
#define F_1 39
F_2 () ;
if ( V_27 == NULL )
...
V_31:
if ( V_1 != NULL ) F_21 ( V_1 ) ;
if ( V_2 != NULL ) F_21 ( V_2 ) ;
if ( V_21 != NULL ) F_22 ( V_21 ) ;
if ( V_22 != NULL ) F_22 ( V_22 ) ;
if ( V_24 != NULL ) F_22 ( V_24 ) ;
if ( V_23 != NULL ) F_22 ( V_23 ) ;
EXIT ( V_7 ) ;
}
