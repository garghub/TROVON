...
static int F_14 ( int V_17 , T_1 * V_18 , T_1 * V_19 )
{
int (* F_15)( T_1 * , int , int , int ) = V_17 ? F_12 : F_11 ;
int V_20 ;
if ( V_19 -> V_21 || F_16 ( V_19 ) )
{
F_4 ( V_22 , V_23 ) ;
return 0 ;
}
...
if ( V_20 == 1 )
{
if ( ! F_2 ( V_18 ) ) return 0 ;
}
else if ( ! F_18 ( V_19 , V_20 - 2 ) && ! F_18 ( V_19 , V_20 - 3 ) )
{
do
{
if ( ! F_15 ( V_18 , V_20 + 1 , - 1 , 0 ) ) return 0 ;
if ( F_19 ( V_18 , V_19 ) >= 0 )
{
if ( ! F_20 ( V_18 , V_18 , V_19 ) ) return 0 ;
if ( F_19 ( V_18 , V_19 ) >= 0 )
if ( ! F_20 ( V_18 , V_18 , V_19 ) ) return 0 ;
}
}
while ( F_19 ( V_18 , V_19 ) >= 0 );
}
else
{
do
{
if ( ! F_15 ( V_18 , V_20 , - 1 , 0 ) ) return 0 ;
}
while ( F_19 ( V_18 , V_19 ) >= 0 );
}
return 1 ;
}
int F_21 ( T_1 * V_18 , T_1 * V_19 )
{
return F_14 ( 0 , V_18 , V_19 ) ;
}
int F_22 ( T_1 * V_18 , T_1 * V_19 )
{
return F_14 ( 1 , V_18 , V_19 ) ;
}
