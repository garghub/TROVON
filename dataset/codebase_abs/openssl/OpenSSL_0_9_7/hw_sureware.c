...
static int V_31 ( T_6 * V_18 , int V_42 , long V_43 , void * V_3 , void (* F_35)() )
{
int V_16 = 1 ;
switch( V_42 )
{
...
V_125 -> V_18 -> V_136 = V_122 / sizeof( V_131 ) ;
F_59 ( V_125 -> V_18 ) ;
V_125 -> V_130 -> V_136 = V_122 / sizeof( V_131 ) ;
F_59 ( V_125 -> V_130 ) ;
V_124 = F_60 () ;
F_61 ( V_124 , V_125 ) ;
break;
...
V_126 -> V_138 = F_57 () ;
V_126 -> V_139 = F_57 () ;
F_58 ( V_126 -> V_137 , V_122 / sizeof( V_131 ) ) ;
F_58 ( V_126 -> V_3 , V_122 / sizeof( V_131 ) ) ;
F_58 ( V_126 -> V_138 , 20 / sizeof( V_131 ) ) ;
F_58 ( V_126 -> V_139 , V_122 / sizeof( V_131 ) ) ;
if ( ! V_126 -> V_137 || V_126 -> V_137 -> V_132 != ( int ) ( V_122 / sizeof( V_131 ) ) ||
! V_126 -> V_3 || V_126 -> V_3 -> V_132 != ( int ) ( V_122 / sizeof( V_131 ) ) ||
! V_126 -> V_138 || V_126 -> V_138 -> V_132 != 20 / sizeof( V_131 ) ||
! V_126 -> V_139 || V_126 -> V_139 -> V_132 != ( int ) ( V_122 / sizeof( V_131 ) ) )
goto V_70;
V_40 = V_97 ( V_55 , V_120 , V_122 ,
( unsigned long * ) V_126 -> V_137 -> V_133 ,
( unsigned long * ) V_126 -> V_3 -> V_133 ,
( unsigned long * ) V_126 -> V_138 -> V_133 ,
( unsigned long * ) V_126 -> V_139 -> V_133 ) ;
F_47 ( V_55 , V_127 , V_40 ) ;
if ( V_40 != 1 )
{
F_39 ( V_134 , V_135 ) ;
...
V_126 -> V_137 -> V_136 = V_122 / sizeof( V_131 ) ;
F_59 ( V_126 -> V_137 ) ;
V_126 -> V_3 -> V_136 = V_122 / sizeof( V_131 ) ;
F_59 ( V_126 -> V_3 ) ;
V_126 -> V_138 -> V_136 = 20 / sizeof( V_131 ) ;
F_59 ( V_126 -> V_138 ) ;
V_126 -> V_139 -> V_136 = V_122 / sizeof( V_131 ) ;
F_59 ( V_126 -> V_139 ) ;
V_124 = F_60 () ;
F_64 ( V_124 , V_126 ) ;
break;
...
static void V_102 ( void * V_143 , void * V_144 , T_27 * V_145 ,
int V_146 , long V_147 , void * V_148 )
{
if( ! V_92 )
{
F_39 ( V_149 , V_117 ) ;
...
static int F_68 ( int V_150 , const unsigned char * V_151 , unsigned char * V_152 ,
T_25 * V_153 , int V_154 )
{
int V_40 = 0 , V_155 ;
...
else if ( ! ( V_121 = F_69 ( V_153 , V_101 ) ) )
{
F_39 ( V_156 , V_157 ) ;
goto V_70;
}
if ( V_154 == V_158 )
{
V_40 = V_93 ( V_55 , V_150 , ( unsigned char * ) V_151 , & V_155 , V_152 , V_121 , V_159 ) ;
F_47 ( V_55 , V_156 , V_40 ) ;
if ( V_40 != 1 )
goto V_70;
V_40 = V_155 ;
}
...
{
V_40 = V_93 ( V_55 , V_150 , ( unsigned char * ) V_151 , & V_155 , V_152 , V_121 , V_160 ) ;
F_47 ( V_55 , V_156 , V_40 ) ;
if ( V_40 != 1 )
goto V_70;
if ( ( V_114 = F_70 ( V_155 ) ) == NULL )
{
F_71 ( V_156 , V_161 ) ;
goto V_70;
}
memcpy ( V_114 , V_152 , V_155 ) ;
switch ( V_154 )
{
#ifndef F_72
case V_162 :
V_40 = F_73 ( V_152 , V_155 , ( unsigned char * ) V_114 , V_155 , V_155 , NULL , 0 ) ;
break;
#endif
case V_163 :
V_40 = F_74 ( V_152 , V_155 , ( unsigned char * ) V_114 , V_150 , V_155 ) ;
break;
case V_164 :
V_40 = F_75 ( V_152 , V_155 , ( unsigned char * ) V_114 , V_150 , V_155 ) ;
break;
default:
F_71 ( V_156 , V_165 ) ;
goto V_70;
...
static int F_78 ( int V_150 , const unsigned char * V_151 , unsigned char * V_152 ,
T_25 * V_153 , int V_154 )
{
int V_40 = 0 , V_155 ;
char * V_121 = NULL ;
...
{
case V_158 :
V_40 = V_94 ( V_55 , V_150 , ( unsigned char * ) V_151 , & V_155 , V_152 , V_121 , V_159 ) ;
F_47 ( V_55 , V_166 , V_40 ) ;
break;
case V_164 :
default:
F_71 ( V_166 , V_165 ) ;
...
return V_40 == 1 ? V_155 : V_40 ;
}
static T_28 * F_79 ( const unsigned char * V_151 , int V_150 , T_5 * V_8 )
{
int V_40 = 0 ;
char * V_121 = NULL ;
T_28 * V_167 = NULL ;
...
V_167 -> V_1 = F_57 () ;
V_167 -> V_169 = F_57 () ;
F_58 ( V_167 -> V_1 , 20 / sizeof( V_131 ) ) ;
F_58 ( V_167 -> V_169 , 20 / sizeof( V_131 ) ) ;
if ( ! V_167 -> V_1 || V_167 -> V_1 -> V_132 != 20 / sizeof( V_131 ) ||
! V_167 -> V_169 || V_167 -> V_169 -> V_132 != 20 / sizeof( V_131 ) )
goto V_70;
V_40 = V_95 ( V_55 , V_150 , V_151 ,
( unsigned long * ) V_167 -> V_1 -> V_133 ,
( unsigned long * ) V_167 -> V_169 -> V_133 ,
V_121 ) ;
F_47 ( V_55 , V_168 , V_40 ) ;
}
V_167 -> V_1 -> V_136 = 20 / sizeof( V_131 ) ;
F_59 ( V_167 -> V_1 ) ;
V_167 -> V_169 -> V_136 = 20 / sizeof( V_131 ) ;
F_59 ( V_167 -> V_169 ) ;
V_70:
if ( V_167 )
{
...
{
F_58 ( V_1 , V_4 -> V_136 ) ;
if ( V_1 && V_1 -> V_132 == V_4 -> V_136 )
{
V_40 = V_98 ( V_55 ,
V_4 -> V_136 * sizeof( V_131 ) ,
( unsigned long * ) V_4 -> V_133 ,
V_3 -> V_136 * sizeof( V_131 ) ,
( unsigned long * ) V_3 -> V_133 ,
V_2 -> V_136 * sizeof( V_131 ) ,
( unsigned long * ) V_2 -> V_133 ,
( unsigned long * ) V_1 -> V_133 ) ;
F_47 ( V_55 , V_170 , V_40 ) ;
if ( V_40 == 1 )
{
V_1 -> V_136 = V_4 -> V_136 ;
F_59 ( V_1 ) ;
