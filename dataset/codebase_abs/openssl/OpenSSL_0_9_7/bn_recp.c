...
if ( F_19 ( V_19 , & ( V_1 -> V_2 ) ) < 0 )
{
if ( ! F_10 ( V_8 ) ) return 0 ;
...
if ( ! F_21 ( V_14 , V_19 , V_1 -> V_4 ) ) goto V_16;
if ( ! F_16 ( V_22 , V_14 , & ( V_1 -> V_3 ) , V_9 ) ) goto V_16;
if ( ! F_21 ( V_8 , V_22 , V_20 - V_1 -> V_4 ) ) goto V_16;
V_8 -> V_23 = 0 ;
if ( ! F_16 ( V_22 , & ( V_1 -> V_2 ) , V_8 , V_9 ) ) goto V_16;
if ( ! F_22 ( V_11 , V_19 , V_22 ) ) goto V_16;
V_11 -> V_23 = 0 ;
#if 1
V_21 = 0 ;
...
if ( ! F_22 ( V_11 , V_11 , & ( V_1 -> V_2 ) ) ) goto V_16;
if ( ! F_24 ( V_8 , 1 ) ) goto V_16;
}
#endif
V_11 -> V_23 = F_25 ( V_11 ) ? 0 : V_19 -> V_23 ;
...
int F_20 ( T_2 * V_11 , const T_2 * V_19 , int V_26 , T_3 * V_9 )
{
int V_6 = - 1 ;
T_2 V_27 ;
F_2 ( & V_27 ) ;
if ( ! F_10 ( & V_27 ) ) goto V_16;
if ( ! F_26 ( & V_27 , V_26 ) ) goto V_16;
if ( ! F_27 ( V_11 , NULL , & V_27 , V_19 , V_9 ) ) goto V_16;
V_6 = V_26 ;
V_16:
F_6 ( & V_27 ) ;
return ( V_6 ) ;
