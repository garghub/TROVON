...
static void F_25 ( void * V_44 , int V_45 )
{
#ifndef F_26
int V_21 ;
char * V_14 = V_44 ;
for( V_21 = 0 ; V_21 < V_45 ; V_21 += 4 ) {
* ( ( unsigned long * ) & ( V_14 [ V_21 ] ) ) = F_27 ( * ( ( unsigned long * ) & ( V_14 [ V_21 ] ) ) ) ;
}
#endif
}
...
V_3 = V_17 -> V_14 ;
V_12 = & V_3 -> V_12 ;
if( V_3 -> V_4 + 2 * V_12 -> V_42 -> V_46 > V_29 ) return;
F_22 ( V_12 , V_12 -> V_42 , NULL ) ;
F_28 ( V_12 -> V_47 , V_12 -> V_42 -> V_46 ) ;
memcpy ( & ( V_3 -> V_24 [ V_3 -> V_4 ] ) , V_12 -> V_47 , V_12 -> V_42 -> V_46 ) ;
F_25 ( & ( V_3 -> V_24 [ V_3 -> V_4 ] ) , V_12 -> V_42 -> V_46 ) ;
V_3 -> V_4 += V_12 -> V_42 -> V_46 ;
F_29 ( V_12 , V_48 , strlen ( V_48 ) ) ;
F_30 ( V_12 , & ( V_3 -> V_24 [ V_3 -> V_4 ] ) , NULL ) ;
V_3 -> V_4 += V_12 -> V_42 -> V_46 ;
V_3 -> V_10 = 1 ;
V_3 -> V_11 = 0 ;
}
...
V_3 = V_17 -> V_14 ;
V_12 = & V_3 -> V_12 ;
if( V_3 -> V_4 - V_3 -> V_5 < 2 * V_12 -> V_42 -> V_46 ) return;
F_22 ( V_12 , V_12 -> V_42 , NULL ) ;
memcpy ( V_12 -> V_47 , & ( V_3 -> V_24 [ V_3 -> V_5 ] ) , V_12 -> V_42 -> V_46 ) ;
F_25 ( V_12 -> V_47 , V_12 -> V_42 -> V_46 ) ;
V_3 -> V_5 += V_12 -> V_42 -> V_46 ;
F_29 ( V_12 , V_48 , strlen ( V_48 ) ) ;
F_30 ( V_12 , V_49 , NULL ) ;
V_20 = memcmp ( & ( V_3 -> V_24 [ V_3 -> V_5 ] ) , V_49 , V_12 -> V_42 -> V_46 ) == 0 ;
V_3 -> V_5 += V_12 -> V_42 -> V_46 ;
if( V_20 == 1 )
{
V_3 -> V_11 = 0 ;
...
V_51 = V_3 -> V_4 - V_28 ;
V_51 = F_27 ( V_51 ) ;
memcpy ( V_3 -> V_24 , & V_51 , V_28 ) ;
V_51 = F_27 ( V_51 ) ;
F_29 ( V_12 , ( unsigned char * ) & ( V_3 -> V_24 [ V_28 ] ) , V_51 ) ;
F_30 ( V_12 , & ( V_3 -> V_24 [ V_3 -> V_4 ] ) , NULL ) ;
V_3 -> V_4 += V_12 -> V_42 -> V_46 ;
V_3 -> V_10 = 1 ;
}
...
V_3 = V_17 -> V_14 ;
V_12 = & V_3 -> V_12 ;
memcpy ( & V_51 , V_3 -> V_24 , V_28 ) ;
V_51 = F_27 ( V_51 ) ;
if ( V_3 -> V_4 < V_51 + V_28 + V_12 -> V_42 -> V_46 ) return;
F_29 ( V_12 , ( unsigned char * ) & ( V_3 -> V_24 [ V_28 ] ) , V_51 ) ;
F_30 ( V_12 , V_49 , NULL ) ;
if( memcmp ( & ( V_3 -> V_24 [ V_51 + V_28 ] ) , V_49 , V_12 -> V_42 -> V_46 ) == 0 )
{
V_3 -> V_7 = V_51 + V_28 + V_12 -> V_42 -> V_46 ;
V_3 -> V_6 = V_3 -> V_4 ;
V_3 -> V_5 = V_28 ;
V_3 -> V_4 = V_51 + V_28 ;
V_3 -> V_10 = 1 ;
