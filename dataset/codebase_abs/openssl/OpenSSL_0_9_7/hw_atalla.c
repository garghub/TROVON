...
static int V_13 ( T_1 * V_1 , int V_45 , long V_46 , void * V_47 , void (* F_35)() )
{
...
static int F_44 ( T_8 * V_73 , const T_8 * V_74 , T_11 * V_75 )
{
T_9 * V_56 = NULL ;
int V_62 = 0 ;
if( ! V_32 )
...
static int F_47 ( T_12 * V_79 , T_8 * V_80 , T_8 * V_81 ,
...
if ( ! F_49 ( V_80 , V_80 , & V_84 , V_55 , V_56 ) ) goto V_85;
V_62 = 1 ;
V_85:
F_50 ( & V_84 ) ;
return V_62 ;
}
static int F_51 ( T_12 * V_79 , T_8 * V_53 , T_8 * V_54 ,
const T_8 * V_47 , const T_8 * V_55 , T_9 * V_56 ,
T_13 * V_86 )
{
return F_36 ( V_53 , V_54 , V_47 , V_55 , V_56 ) ;
}
static int F_52 ( T_8 * V_53 , const T_8 * V_54 , const T_8 * V_47 ,
const T_8 * V_55 , T_9 * V_56 , T_13 * V_86 )
{
return F_36 ( V_53 , V_54 , V_47 , V_55 , V_56 ) ;
}
static int F_53 ( const T_14 * V_87 , T_8 * V_53 ,
const T_8 * V_54 , const T_8 * V_47 ,
const T_8 * V_55 , T_9 * V_56 , T_13 * V_86 )
{
return F_36 ( V_53 , V_54 , V_47 , V_55 , V_56 ) ;
}
static int F_54 ( T_1 * V_1 , const char * V_88 )
{
