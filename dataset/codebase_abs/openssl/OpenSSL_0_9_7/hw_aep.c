...
static int V_14 ( T_1 * V_1 , int V_72 , long V_73 , void * V_74 , void (* F_40)() )
{
...
const T_14 * V_93 , const T_14 * V_94 ,
const T_14 * V_95 , const T_14 * V_96 , T_15 * V_83 )
{
T_13 V_65 = V_67 ;
T_16 V_85 ;
V_65 = F_44 ( & V_85 ) ;
...
V_65 = V_57 ( V_85 , ( void * ) V_81 , ( void * ) V_74 , ( void * ) V_93 , ( void * ) V_94 , ( void * ) V_95 ,
( void * ) V_96 , ( void * ) V_80 , NULL ) ;
if ( V_65 != V_67 )
{
F_34 ( V_97 , V_99 ) ;
V_65 = F_45 ( V_85 ) ;
...
static int F_48 ( unsigned char * V_100 , int V_101 )
{
T_13 V_65 = V_67 ;
T_16 V_85 ;
F_49 ( V_102 ) ;
if ( V_101 <= V_103 )
{
memcpy ( V_100 , & V_104 [ V_105 - V_103 ] , V_101 ) ;
V_103 -= V_101 ;
F_50 ( V_102 ) ;
}
else
...
if ( V_101 > V_105 )
{
V_65 = V_58 ( V_85 , V_101 , 2 , V_100 , NULL ) ;
if ( V_65 != V_67 )
{
F_34 ( V_91 , V_107 ) ;
goto V_106;
...
{
F_49 ( V_102 ) ;
V_65 = V_58 ( V_85 , V_105 , 2 , & V_104 [ 0 ] , NULL ) ;
if ( V_65 != V_67 )
{
F_34 ( V_91 , V_107 ) ;
goto V_46;
...
static int F_52 ( T_14 * V_108 , const T_14 * V_109 , T_17 * V_110 )
{
T_15 * V_83 = NULL ;
int V_42 = 0 ;
T_13 V_65 = V_67 ;
...
if ( V_110 -> V_93 && V_110 -> V_94 && V_110 -> V_95 && V_110 -> V_96 )
{
V_65 = F_47 ( V_108 , V_109 , V_110 -> V_74 , V_110 -> V_93 , V_110 -> V_94 , V_110 -> V_95 , V_110 -> V_96 , V_83 ) ;
if ( V_65 == V_98 ) {
const T_2 * V_112 = F_17 () ;
V_42 = (* V_112 -> V_113 )( V_108 , V_109 , V_110 ) ;
goto V_46;
}
else if ( V_65 != V_67 )
goto V_46;
...
if ( ! F_56 ( V_118 , V_118 , & V_122 , V_82 , V_83 ) ) goto V_123;
V_42 = 1 ;
V_123:
F_57 ( & V_122 ) ;
return V_42 ;
...
static int F_58 ( T_14 * V_80 , const T_14 * V_81 , const T_14 * V_74 ,
const T_14 * V_82 , T_15 * V_83 , T_19 * V_124 )
{
return F_41 ( V_80 , V_81 , V_74 , V_82 , V_83 ) ;
}
static int F_59 ( const T_20 * V_125 , T_14 * V_80 , const T_14 * V_81 ,
const T_14 * V_74 , const T_14 * V_82 , T_15 * V_83 ,
T_19 * V_124 )
{
return F_41 ( V_80 , V_81 , V_74 , V_82 , V_83 ) ;
...
{
V_100 = ( unsigned char * ) & V_148 -> V_114 [ V_73 ] ;
* ( ( T_24 * ) V_150 ) = ( T_24 )
( ( unsigned ) V_100 [ 1 ] << 8 | V_100 [ 0 ] ) |
( ( unsigned ) V_100 [ 3 ] << 8 | V_100 [ 2 ] ) << 16 ;
V_150 += 4 ;
}
#endif
return V_67 ;
