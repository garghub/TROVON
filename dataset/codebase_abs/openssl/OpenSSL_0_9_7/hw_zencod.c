...
{
for(; -- V_2 > 0 ; -- V_2 , V_1 ++ ) { * V_1 ^= * ( V_1 + V_2 ) ; * ( V_1 + V_2 ) ^= * V_1 ; * V_1 ^= * ( V_1 + V_2 ) ; }
}
static inline void F_2 ( unsigned char * V_1 , const unsigned char * V_3 , int V_2 )
{
for( V_1 += V_2 ; V_2 -- ; ) * -- V_1 = * V_3 ++ ;
}
...
if ( ! ( V_35 = ( T_8 * ) F_35 ( V_55 , V_61 ) ) ||
! ( V_36 = ( T_9 * ) F_35 ( V_55 , V_62 ) ) ||
! ( V_37 = ( T_10 * ) F_35 ( V_55 , V_63 ) ) ||
! ( V_38 = ( T_11 * ) F_35 ( V_55 , V_64 ) ) ||
! ( V_39 = ( T_12 * ) F_35 ( V_55 , V_65 ) ) ||
! ( V_40 = ( T_13 * ) F_35 ( V_55 , V_66 ) ) ||
! ( V_41 = ( T_14 * ) F_35 ( V_55 , V_67 ) ) ||
! ( V_42 = ( T_15 * ) F_35 ( V_55 , V_68 ) ) ||
! ( V_43 = ( T_16 * ) F_35 ( V_55 , V_69 ) ) ||
! ( V_44 = ( T_17 * ) F_35 ( V_55 , V_70 ) ) ||
! ( V_45 = ( T_18 * ) F_35 ( V_55 , V_71 ) ) ||
! ( V_46 = ( T_19 * ) F_35 ( V_55 , V_72 ) ) ||
! ( V_34 = ( T_7 * ) F_35 ( V_55 , V_73 ) ) ||
! ( V_47 = ( T_20 * ) F_35 ( V_55 , V_74 ) ) ||
! ( V_48 = ( T_21 * ) F_35 ( V_55 , V_75 ) ) ||
! ( V_49 = ( T_22 * ) F_35 ( V_55 , V_76 ) ) ||
! ( V_50 = ( T_23 * ) F_35 ( V_55 , V_77 ) ) ||
! ( V_51 = ( T_24 * ) F_35 ( V_55 , V_78 ) ) ||
! ( V_52 = ( T_25 * ) F_35 ( V_55 , V_79 ) ) ||
! ( V_53 = ( T_26 * ) F_35 ( V_55 , V_80 ) ) ||
! ( V_54 = ( T_27 * ) F_35 ( V_55 , V_81 ) ) ) {
F_33 ( V_56 , V_60 ) ;
goto V_58 ;
}
V_82 = V_34 ;
...
static int F_38 ( T_28 * V_114 , const T_28 * V_115 , const T_28 * V_108 , const T_28 * V_116 , T_29 * V_117 )
{
...
V_86 ( & V_118 , ( V_114 -> V_125 - 1 ) * sizeof ( V_126 ) * 8 , ( unsigned char * ) V_114 -> V_1 ) ;
F_42 ( & V_119 , V_115 ) ;
F_42 ( & V_4 , V_108 ) ;
F_42 ( & V_120 , V_116 ) ;
...
if ( V_88 ( & V_118 , & V_119 , & V_108 , & V_132 , & V_133 , & V_134 , & V_135 ) < 0 ) {
PERROR ( L_2 ) ;
F_39 ( V_131 , V_127 ) ;
return 0 ;
}
...
const T_28 * V_116 , T_29 * V_117 , T_32 * V_140 )
{
F_32 () ;
if ( ! V_55 ) {
F_39 ( V_141 , V_105 ) ;
...
static T_33 * F_48 ( const unsigned char * V_144 , int V_145 , T_34 * V_146 )
{
...
static int F_52 ( const unsigned char * V_144 , int V_145 , T_33 * V_149 , T_34 * V_146 )
{
...
F_2 ( V_152 , V_144 , 20 ) ;
V_86 ( & V_148 , 160 , V_152 ) ;
if ( ( V_121 = V_90 ( 0 , & V_148 , & V_108 , & V_132 , & V_147 , & V_118 , & V_114 , & V_3 , & V_160 ) ) < 0 ) {
PERROR ( L_5 ) ;
F_39 ( V_162 , V_127 ) ;
return 0 ;
}
...
static int F_53 ( T_34 * V_146 , T_28 * V_114 , T_28 * V_115 , const T_28 * V_108 , const T_28 * V_116 ,
...
if ( ! F_40 ( V_165 , V_164 -> V_108 -> V_125 ) ||
! F_40 ( V_166 , V_164 -> V_108 -> V_125 ) ) {
F_39 ( V_168 , V_124 ) ;
goto V_154;
}
...
static int F_57 ( unsigned char * V_169 , const T_28 * V_158 , T_35 * V_164 )
{
...
static int F_58 ( const T_35 * V_164 , T_28 * V_114 , const T_28 * V_115 , const T_28 * V_108 , const T_28 * V_116 , T_29 * V_117 ,
T_32 * V_140 )
{
F_32 () ;
return F_38 ( V_114 , V_115 , V_108 , V_116 , V_117 ) ;
...
static int V_20 ( T_2 * V_4 , const T_36 * * V_177 , const int * * V_178 , int V_179 )
{
#ifdef F_63
fprintf ( V_180 , L_8 ) ;
#endif
...
static int F_65 ( T_37 * V_117 , const void * V_148 , unsigned long V_190 )
{
T_30 V_191 ;
int V_187 = 0 ;
V_191 . V_159 = V_190 ;
V_191 . V_148 = ( unsigned char * ) V_148 ;
V_187 = V_99 ( ( V_188 * ) V_117 -> V_189 , ( const T_30 * ) & V_191 ) ;
V_187 = ! V_187 ;
return V_187 ;
}
...
V_193 . V_159 = V_194 ;
V_193 . V_148 = V_192 ;
V_187 = V_100 ( ( V_188 * ) V_117 -> V_189 , ( T_30 * ) & V_193 ) ;
V_187 = ! V_187 ;
return V_187 ;
}
...
static int F_68 ( T_37 * V_117 , const void * V_148 , unsigned long V_190 )
{
T_30 V_191 ;
int V_187 = 0 ;
V_191 . V_159 = V_190 ;
V_191 . V_148 = ( unsigned char * ) V_148 ;
V_187 = V_96 ( ( V_188 * ) V_117 -> V_189 , ( const T_30 * ) & V_191 ) ;
V_187 = ! V_187 ;
return V_187 ;
}
...
V_193 . V_159 = V_195 ;
V_193 . V_148 = V_192 ;
V_187 = V_97 ( ( V_188 * ) V_117 -> V_189 , ( T_30 * ) & V_193 ) ;
V_187 = ! V_187 ;
return V_187 ;
}
...
static int V_21 ( T_2 * V_4 , const T_38 * * V_203 , const int * * V_178 , int V_179 )
{
if ( ! V_203 ) {
* V_178 = V_204 ;
return V_205 ;
...
static int F_74 ( T_39 * V_117 , const unsigned char * V_169 , const unsigned char * V_214 , int V_215 )
{
int V_187 = 0 ;
int V_107 = 0 ;
int V_216 = 0 ;
...
memcpy ( & ( V_217 -> V_221 [ 4 + V_107 * V_117 -> V_220 ] ) , V_169 , V_117 -> V_220 ) ;
}
V_187 = 1 ;
return V_187 ;
}
static int F_75 ( T_39 * V_117 , unsigned char * V_222 , const unsigned char * V_223 , unsigned int V_224 )
{
T_30 V_193 , V_191 ;
T_30 V_225 ;
int V_187 = 0 ;
...
V_187 = V_102 ( & V_193 , & V_191 , ( const T_30 * ) & V_225 , & ( V_217 -> V_221 [ 0 ] ) , & ( V_217 -> V_221 [ 3 ] ) , ! V_217 -> V_219 ) ;
V_187 = ! V_187 ;
V_217 -> V_219 = 1 ;
V_217 = NULL ;
return V_187 ;
}
static int F_76 ( T_39 * V_117 , const unsigned char * V_169 , const unsigned char * V_214 , int V_215 )
{
T_41 * V_226 = NULL ;
int V_187 = 0 ;
...
static int F_77 ( T_39 * V_117 , unsigned char * V_222 , const unsigned char * V_223 , unsigned int V_229 )
{
T_30 V_193 , V_191 ;
...
V_231 . V_159 = 8 ;
V_232 . V_159 = 8 ;
V_230 . V_148 = ( unsigned char * ) ( ( T_41 * ) ( V_117 -> V_218 ) ) -> V_227 ;
V_231 . V_148 = ( unsigned char * ) & ( ( T_41 * ) ( V_117 -> V_218 ) ) -> V_227 [ 8 ] ;
V_232 . V_148 = ( unsigned char * ) & ( ( T_41 * ) ( V_117 -> V_218 ) ) -> V_227 [ 16 ] ;
...
( T_30 * ) & V_230 , ( T_30 * ) & V_231 , ( T_30 * ) & V_232 , & V_214 , V_117 -> V_233 ) ;
V_187 = ! V_187 ;
if ( V_117 -> V_233 == 1 ) {
...
static int F_78 ( T_39 * V_117 , const unsigned char * V_169 , const unsigned char * V_214 , int V_215 )
{
T_42 * V_234 = NULL ;
int V_187 = 0 ;
...
static int F_79 ( T_39 * V_117 , unsigned char * V_222 , const unsigned char * V_223 ,
unsigned int V_224 )
{
T_30 V_193 , V_191 ;
T_30 V_230 , V_231 , V_232 , V_214 ;
...
V_231 . V_159 = 8 ;
V_232 . V_159 = 8 ;
V_230 . V_148 = ( unsigned char * ) ( ( T_42 * ) ( V_117 -> V_218 ) ) -> V_235 ;
V_231 . V_148 = ( unsigned char * ) & ( ( T_42 * ) ( V_117 -> V_218 ) ) -> V_235 [ 8 ] ;
V_232 . V_148 = ( unsigned char * ) & ( ( T_42 * ) ( V_117 -> V_218 ) ) -> V_235 [ 16 ] ;
