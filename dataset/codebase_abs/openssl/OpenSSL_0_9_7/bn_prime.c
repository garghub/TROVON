...
{
T_1 * V_8 ;
if ( ( V_8 = F_21 ( V_13 ) ) == NULL ) goto V_15;
F_22 ( V_8 , V_17 ) ;
V_8 -> V_29 = 0 ;
V_25 = V_8 ;
}
...
V_20 = 1 ;
while ( ! F_25 ( V_21 , V_20 ) )
V_20 ++ ;
if ( ! F_26 ( V_22 , V_21 , V_20 ) )
goto V_15;
V_24 = F_27 () ;
if ( V_24 == NULL )
goto V_15;
if ( ! F_28 ( V_24 , V_25 , V_13 ) )
goto V_15;
for ( V_10 = 0 ; V_10 < V_14 ; V_10 ++ )
{
if ( ! F_29 ( V_23 , V_21 ) )
...
for ( V_10 = 1 ; V_10 < V_27 ; V_10 ++ )
V_33 [ V_10 ] = F_19 ( V_7 , ( T_4 ) V_28 [ V_10 ] ) ;
V_34 = 0 ;
...
static int F_9 ( T_1 * V_7 , int V_2 ,
const T_1 * V_4 , const T_1 * V_5 , T_2 * V_13 )
{
int V_10 , V_1 = 0 ;
T_1 * V_37 ;
F_20 ( V_13 ) ;
if ( ( V_37 = F_21 ( V_13 ) ) == NULL ) goto V_15;
if ( ! F_37 ( V_7 , V_2 , 0 , 1 ) ) goto V_15;
if ( ! F_38 ( V_37 , V_7 , V_4 , V_13 ) ) goto V_15;
if ( ! F_39 ( V_7 , V_7 , V_37 ) ) goto V_15;
if ( V_5 == NULL )
{ if ( ! F_30 ( V_7 , 1 ) ) goto V_15; }
else
{ if ( ! F_40 ( V_7 , V_7 , V_5 ) ) goto V_15; }
V_16: for ( V_10 = 1 ; V_10 < V_27 ; V_10 ++ )
{
if ( F_19 ( V_7 , ( T_4 ) V_28 [ V_10 ] ) <= 1 )
{
if ( ! F_40 ( V_7 , V_7 , V_4 ) ) goto V_15;
goto V_16;
}
}
V_1 = 1 ;
...
static int F_8 ( T_1 * V_38 , int V_2 , const T_1 * V_39 ,
const T_1 * V_5 , T_2 * V_13 )
{
int V_10 , V_1 = 0 ;
T_1 * V_37 , * V_40 , * V_41 ;
V_2 -- ;
...
if ( ! F_40 ( V_41 , V_41 , V_37 ) ) goto V_15;
}
if ( ! F_41 ( V_38 , V_41 ) ) goto V_15;
if ( ! F_30 ( V_38 , 1 ) ) goto V_15;
V_16: for ( V_10 = 1 ; V_10 < V_27 ; V_10 ++ )
{
if ( ( F_19 ( V_38 , ( T_4 ) V_28 [ V_10 ] ) == 0 ) ||
( F_19 ( V_41 , ( T_4 ) V_28 [ V_10 ] ) == 0 ) )
{
if ( ! F_40 ( V_38 , V_38 , V_39 ) ) goto V_15;
if ( ! F_40 ( V_41 , V_41 , V_40 ) ) goto V_15;
goto V_16;
}
}
V_1 = 1 ;
