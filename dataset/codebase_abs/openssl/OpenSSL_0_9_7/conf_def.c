...
* V_23 = '\0' ;
if ( ! F_32 ( V_6 , NULL , & V_31 , V_35 ) ) goto V_41;
if ( ( V_30 = F_33 ( V_6 , V_31 ) ) == NULL )
V_30 = F_24 ( V_6 , V_31 ) ;
if ( V_30 == NULL )
{
F_16 ( V_39 ,
...
strcpy ( V_28 -> V_11 , V_37 ) ;
if ( ! F_32 ( V_6 , V_36 , & ( V_28 -> V_44 ) , V_35 ) ) goto V_41;
if ( strcmp ( V_36 , V_31 ) != 0 )
{
if ( ( V_29 = F_33 ( V_6 , V_36 ) )
== NULL )
V_29 = F_24 ( V_6 , V_36 ) ;
if ( V_29 == NULL )
{
...
static int F_32 ( T_2 * V_6 , char * V_31 , char * * V_50 , char * V_51 )
{
...
V_52 = * V_51 ;
V_51 ++ ;
while ( ! F_30 ( V_6 , * V_51 ) && ( * V_51 != V_52 ) )
{
if ( F_27 ( V_6 , * V_51 ) )
{
V_51 ++ ;
if ( F_30 ( V_6 , * V_51 ) ) break;
}
V_32 -> V_9 [ V_49 ++ ] = * ( V_51 ++ ) ;
}
if ( * V_51 == V_52 ) V_51 ++ ;
}
else if ( F_44 ( V_6 , * V_51 ) )
{
V_52 = * V_51 ;
V_51 ++ ;
while ( ! F_30 ( V_6 , * V_51 ) )
...
else if ( F_27 ( V_6 , * V_51 ) )
{
V_51 ++ ;
V_28 = * ( V_51 ++ ) ;
if ( F_30 ( V_6 , V_28 ) ) break;
...
F_51 ( V_32 , ( strlen ( V_22 ) + V_55 - ( V_56 - V_51 ) ) ) ;
while ( * V_22 )
V_32 -> V_9 [ V_49 ++ ] = * ( V_22 ++ ) ;
V_51 = V_56 ;
}
...
int V_52 = * V_22 ;
V_22 ++ ;
while ( ! ( F_30 ( V_6 , * V_22 ) ) && ( * V_22 != V_52 ) )
{
if ( F_27 ( V_6 , * V_22 ) )
{
V_22 ++ ;
if ( F_30 ( V_6 , * V_22 ) ) return ( V_22 ) ;
}
V_22 ++ ;
}
if ( * V_22 == V_52 ) V_22 ++ ;
...
static char * F_45 ( T_2 * V_6 , char * V_22 )
{
int V_52 = * V_22 ;
V_22 ++ ;
while ( ! ( F_30 ( V_6 , * V_22 ) ) )
...
static void F_53 ( T_5 * V_64 , T_3 * V_65 )
{
if ( V_64 -> V_11 )
F_54 ( V_65 , L_6 , V_64 -> V_31 , V_64 -> V_11 , V_64 -> V_44 ) ;
else
F_54 ( V_65 , L_7 , V_64 -> V_31 ) ;
}
static int F_55 ( const T_2 * V_6 , char V_66 )
{
return F_56 ( V_6 , V_66 ) ;
}
static int F_57 ( const T_2 * V_6 , char V_66 )
{
return V_66 - '0' ;
}
