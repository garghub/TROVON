...
static int V_11 ( T_1 * V_1 , int V_57 , long V_58 , void * V_59 , void (* F_28)() )
{
...
const T_13 * V_71 , const T_13 * V_72 , const T_13 * V_73 ,
const T_13 * V_74 , T_14 * V_68 )
{
if( V_26 == NULL )
{
F_24 ( V_75 , V_56 ) ;
...
static T_16 * F_32 ( const unsigned char * V_80 , int V_81 , T_17 * V_82 )
{
if( V_26 == NULL )
{
F_24 ( V_83 , V_56 ) ;
...
T_13 * V_15 , T_13 * V_89 , T_13 * V_16 , T_13 * V_67 ,
T_14 * V_68 , T_18 * V_90 )
{
T_13 V_91 ;
int V_92 = 0 ;
F_35 ( & V_91 ) ;
if ( ! F_29 ( V_87 , V_88 , V_15 , V_67 , V_68 ) ) goto V_93;
if ( ! F_29 ( & V_91 , V_89 , V_16 , V_67 , V_68 ) ) goto V_93;
if ( ! F_36 ( V_87 , V_87 , & V_91 , V_67 , V_68 ) ) goto V_93;
V_92 = 1 ;
V_93:
F_37 ( & V_91 ) ;
return ( 1 ) ;
...
const T_13 * V_59 , const T_13 * V_67 , T_14 * V_68 ,
T_18 * V_94 )
{
return F_29 ( V_65 , V_66 , V_59 , V_67 , V_68 ) ;
}
static int F_39 ( T_13 * V_65 , const T_13 * V_66 , const T_13 * V_59 ,
const T_13 * V_67 , T_14 * V_68 , T_18 * V_94 )
{
return F_29 ( V_65 , V_66 , V_59 , V_67 , V_68 ) ;
}
static int F_40 ( const T_19 * V_95 , T_13 * V_65 , const T_13 * V_66 , const T_13 * V_59 ,
const T_13 * V_67 , T_14 * V_68 , T_18 * V_94 )
{
return F_29 ( V_65 , V_66 , V_59 , V_67 , V_68 ) ;
}
