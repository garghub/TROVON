...
return ( - 1 ) ;
strcpy ( V_6 . V_17 , V_1 ) ;
V_7 = F_4 ( struct V_5 , V_17 ) + strlen ( V_1 ) ;
V_10 = F_5 ( V_16 , V_18 , 0 ) ;
if ( V_10 == - 1 ) return ( - 1 ) ;
V_11 = 0 ;
while ( ! V_11 )
{
if ( F_6 ( V_10 , (struct V_19 * ) & V_6 , V_7 ) == 0 )
V_11 = 1 ;
else
{
switch ( V_20 )
...
while ( V_9 != V_12 [ 0 ] )
{
V_8 = F_13 ( V_10 , V_14 + V_9 , V_12 [ 0 ] - V_9 ) ;
if ( V_8 >= 0 )
V_9 += V_8 ;
else
{
