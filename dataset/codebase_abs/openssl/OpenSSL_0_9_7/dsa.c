...
F_11 () ;
V_3 = F_12 ( V_26 , V_20 , 0 ) ;
if( ! F_13 ( V_26 , V_21 , V_22 , & V_23 , & V_24 ) ) {
F_8 ( V_26 , L_31 ) ;
goto V_30;
}
V_9 = F_2 ( F_3 () ) ;
...
F_8 ( V_26 , L_32 ) ;
if ( V_11 == V_34 ) {
if( V_15 ) V_5 = F_16 ( V_9 , NULL ) ;
else V_5 = F_17 ( V_9 , NULL ) ;
} else if ( V_11 == V_31 ) {
if( V_15 ) V_5 = F_18 ( V_9 , NULL , NULL , NULL ) ;
else V_5 = F_19 ( V_9 , NULL , NULL , V_23 ) ;
} else
{
F_8 ( V_26 , L_33 ) ;
goto V_30;
...
F_8 ( V_26 , L_37 ) ;
if ( V_12 == V_34 ) {
if( V_15 || V_16 ) V_6 = F_26 ( V_10 , V_5 ) ;
else V_6 = F_27 ( V_10 , V_5 ) ;
} else if ( V_12 == V_31 ) {
if( V_15 || V_16 )
V_6 = F_28 ( V_10 , V_5 ) ;
else V_6 = F_29 ( V_10 , V_5 , V_8 ,
NULL , 0 , NULL , V_24 ) ;
} else {
F_8 ( V_26 , L_38 ) ;
goto V_30;
