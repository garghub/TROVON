...
const T_1 * V_3 , const T_1 * V_4 , T_2 * V_5 ,
T_3 * V_6 )
{
return F_2 ( V_1 , V_2 , V_3 , V_4 , V_5 ) ;
}
...
int V_16 = 0 ;
F_5 ( & V_15 ) ;
if ( ! F_2 ( V_9 , V_10 , V_11 , V_4 , V_5 ) )
goto V_17;
if ( ! F_2 ( & V_15 , V_12 , V_13 , V_4 , V_5 ) )
goto V_17;
if ( ! F_6 ( V_9 , V_9 , & V_15 , V_4 , V_5 ) )
goto V_17;
V_16 = 1 ;
V_17:
F_7 ( & V_15 ) ;
...
static int V_31 ( T_6 * V_18 , int V_42 , long V_43 , void * V_3 ,
void (* F_35) ( void ) )
{
int V_16 = 1 ;
switch ( V_42 ) {
...
static T_24 * F_54 ( T_6 * V_18 , const char * V_120 ,
char * V_121 , unsigned long V_122 ,
char V_123 )
{
T_24 * V_124 = NULL ;
# ifndef F_9
...
if ( ! V_126 -> V_136
|| V_126 -> V_136 -> V_132 != ( int ) ( V_122 / sizeof( V_131 ) )
...
static int F_67 ( int V_151 , const unsigned char * V_152 ,
unsigned char * V_153 , T_25 * V_154 , int V_155 )
{
int V_40 = 0 , V_156 ;
...
else if ( ! ( V_121 = F_68 ( V_154 , V_101 ) ) ) {
F_39 ( V_157 ,
V_158 ) ;
goto V_70;
}
if ( V_155 == V_159 ) {
V_40 =
V_93 ( V_55 , V_151 , ( unsigned char * ) V_152 , & V_156 ,
V_153 , V_121 , V_160 ) ;
F_47 ( V_55 , V_157 ,
V_40 ) ;
if ( V_40 != 1 )
...
case V_163 :
V_40 =
F_71 ( V_153 , V_156 , ( unsigned char * ) V_114 ,
V_156 , V_156 , NULL , 0 ) ;
break;
# endif
case V_164 :
V_40 =
F_72 ( V_153 , V_156 , ( unsigned char * ) V_114 , V_151 ,
V_156 ) ;
break;
case V_165 :
V_40 =
F_73 ( V_153 , V_156 , ( unsigned char * ) V_114 , V_151 ,
V_156 ) ;
break;
default:
F_39 ( V_157 ,
...
static int F_76 ( int V_151 , const unsigned char * V_152 ,
unsigned char * V_153 , T_25 * V_154 , int V_155 )
{
int V_40 = 0 , V_156 ;
char * V_121 = NULL ;
...
case V_159 :
V_40 =
V_94 ( V_55 , V_151 , ( unsigned char * ) V_152 , & V_156 ,
V_153 , V_121 , V_160 ) ;
F_47 ( V_55 , V_167 ,
V_40 ) ;
break;
...
static T_28 * F_77 ( const unsigned char * V_152 , int V_151 ,
T_5 * V_8 )
{
int V_40 = 0 ;
char * V_121 = NULL ;
...
( unsigned long * ) V_168 -> V_170 -> V_133 , V_121 ) ;
F_47 ( V_55 , V_169 ,
V_40 ) ;
}
