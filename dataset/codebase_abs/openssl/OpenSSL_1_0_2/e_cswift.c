...
const T_10 * V_87 , const T_10 * V_88 ,
T_11 * V_56 )
{
T_5 V_61 ;
T_12 V_62 , V_63 ;
...
if ( ! F_43 ( V_59 , V_54 -> V_69 ) || ! F_43 ( V_60 , V_47 -> V_69 + V_85 -> V_69 ) ) {
F_35 ( V_90 , V_70 ) ;
goto V_35;
}
V_61 = V_41 ( V_25 , & V_64 ) ;
...
static int F_55 ( T_10 * V_93 , const T_10 * V_94 , T_14 * V_95 ,
T_11 * V_56 )
{
int V_65 = 0 ;
const T_2 * V_96 ;
...
F_47 ( V_95 -> V_85 ) > 128 ||
F_47 ( V_95 -> V_86 ) > 128 ||
F_47 ( V_95 -> V_87 ) > 128 || F_47 ( V_95 -> V_88 ) > 128 ) {
# ifdef F_56
V_96 = F_57 () ;
# else
# if 0
...
if ( ! F_43 ( V_105 , V_104 -> V_47 -> V_69 ) ||
! F_43 ( V_106 , V_104 -> V_85 -> V_69 ) ||
! F_43 ( V_107 , V_104 -> V_110 -> V_69 ) ||
...
V_64 . type = V_112 ;
V_64 . V_72 . V_104 . V_47 . V_73 = F_44 ( V_104 -> V_47 , ( unsigned char * ) V_105 -> V_74 ) ;
V_64 . V_72 . V_104 . V_47 . V_75 = ( unsigned char * ) V_105 -> V_74 ;
V_64 . V_72 . V_104 . V_85 . V_73 = F_44 ( V_104 -> V_85 , ( unsigned char * ) V_106 -> V_74 ) ;
V_64 . V_72 . V_104 . V_85 . V_75 = ( unsigned char * ) V_106 -> V_74 ;
V_64 . V_72 . V_104 . V_110 . V_73 = F_44 ( V_104 -> V_110 , ( unsigned char * ) V_107 -> V_74 ) ;
V_64 . V_72 . V_104 . V_110 . V_75 = ( unsigned char * ) V_107 -> V_74 ;
V_64 . V_72 . V_104 . V_113 . V_73 = F_44 ( V_104 -> V_111 ,
( unsigned char * ) V_108 -> V_74 ) ;
V_64 . V_72 . V_104 . V_113 . V_75 = ( unsigned char * ) V_108 -> V_74 ;
V_61 = V_41 ( V_25 , & V_64 ) ;
switch ( V_61 ) {
case V_27 :
break;
...
V_65 -> V_115 = F_48 ( ( unsigned char * ) V_60 -> V_74 + 20 , 20 , NULL ) ;
V_35:
if ( V_66 )
F_32 ( V_25 ) ;
if ( V_56 ) {
...
static int F_63 ( const unsigned char * V_102 , int V_116 ,
T_16 * V_117 , T_17 * V_104 )
{
T_4 V_25 ;
T_13 V_64 ;
T_5 V_61 ;
...
V_64 . V_72 . V_104 . V_110 . V_73 = F_44 ( V_104 -> V_110 , ( unsigned char * ) V_107 -> V_74 ) ;
V_64 . V_72 . V_104 . V_110 . V_75 = ( unsigned char * ) V_107 -> V_74 ;
V_64 . V_72 . V_104 . V_113 . V_73 = F_44 ( V_104 -> V_120 ,
( unsigned char * ) V_108 -> V_74 ) ;
V_64 . V_72 . V_104 . V_113 . V_75 = ( unsigned char * ) V_108 -> V_74 ;
V_61 = V_41 ( V_25 , & V_64 ) ;
switch ( V_61 ) {
...
F_44 ( V_117 -> V_53 , V_62 [ 1 ] . V_75 + 20 - F_47 ( V_117 -> V_53 ) ) ;
F_44 ( V_117 -> V_115 , V_62 [ 1 ] . V_75 + 40 - F_47 ( V_117 -> V_115 ) ) ;
V_63 . V_73 = 4 ;
V_63 . V_75 = ( unsigned char * ) ( & V_118 ) ;
V_61 = V_42 ( V_25 , V_121 , V_62 , 2 ,
& V_63 , 1 ) ;
if ( V_61 != V_27 ) {
char V_78 [ F_45 ( V_61 ) + 1 ] ;
F_35 ( V_119 , V_79 ) ;
...
static int F_64 ( const T_18 * V_122 , T_10 * V_53 ,
const T_10 * V_54 , const T_10 * V_47 ,
const T_10 * V_55 , T_11 * V_56 , T_15 * V_100 )
{
return F_40 ( V_53 , V_54 , V_47 , V_55 , V_56 ) ;
}
static int F_65 ( unsigned char * V_123 , int V_124 )
{
T_4 V_25 ;
T_5 V_125 ;
T_12 V_126 ;
int V_66 = 0 ;
int V_65 = 0 ;
unsigned char V_127 [ 1024 ] ;
if ( ! F_30 ( & V_25 ) ) {
F_35 ( V_128 , V_43 ) ;
goto V_35;
}
V_66 = 1 ;
while ( V_124 >= ( int ) sizeof( V_127 ) ) {
V_126 . V_75 = V_123 ;
V_126 . V_73 = sizeof( V_127 ) ;
V_125 =
V_42 ( V_25 , V_129 , NULL , 0 , & V_126 , 1 ) ;
if ( V_125 != V_27 ) {
char V_78 [ 20 ] ;
F_35 ( V_128 , V_79 ) ;
sprintf ( V_78 , L_2 , V_125 ) ;
F_46 ( 2 , L_3 , V_78 ) ;
goto V_35;
}
V_123 += sizeof( V_127 ) ;
...
static int F_67 ( T_1 * V_1 , const char * V_130 )
{
if ( V_130 && ( strcmp ( V_130 , V_4 ) != 0 ) )
return 0 ;
if ( ! F_1 ( V_1 ) )
return 0 ;
return 1 ;
