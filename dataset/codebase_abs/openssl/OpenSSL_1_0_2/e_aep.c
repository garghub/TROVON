...
V_65 = V_56 ( V_85 , ( void * ) V_81 , ( void * ) V_74 , ( void * ) V_82 , ( void * ) V_80 ,
NULL ) ;
if ( V_65 != V_67 ) {
F_34 ( V_87 , V_90 ) ;
V_65 = F_45 ( V_85 ) ;
...
const T_14 * V_94 , const T_14 * V_95 ,
T_15 * V_83 )
{
T_13 V_65 = V_67 ;
T_16 V_85 ;
...
V_65 = V_57 ( V_85 , ( void * ) V_81 , ( void * ) V_74 , ( void * ) V_92 ,
( void * ) V_93 , ( void * ) V_94 , ( void * ) V_95 , ( void * ) V_80 ,
NULL ) ;
if ( V_65 != V_67 ) {
F_34 ( V_96 , V_98 ) ;
V_65 = F_45 ( V_85 ) ;
...
V_65 = F_47 ( V_108 , V_109 , V_110 -> V_74 , V_110 -> V_92 , V_110 -> V_93 , V_110 -> V_94 ,
V_110 -> V_95 , V_83 ) ;
if ( V_65 == V_97 ) {
...
int V_42 = 0 ;
F_53 ( & V_122 ) ;
if ( ! F_41 ( V_118 , V_119 , V_34 , V_82 , V_83 ) )
goto V_123;
if ( ! F_41 ( & V_122 , V_120 , V_35 , V_82 , V_83 ) )
goto V_123;
if ( ! F_54 ( V_118 , V_118 , & V_122 , V_82 , V_83 ) )
goto V_123;
V_42 = 1 ;
V_123:
F_55 ( & V_122 ) ;
