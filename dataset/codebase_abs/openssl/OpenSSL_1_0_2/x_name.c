...
const unsigned char * * V_15 , long V_16 ,
const T_2 * V_2 , int V_17 , int V_18 ,
char V_19 , T_4 * V_20 )
{
...
if ( * V_1 )
F_8 ( V_1 , NULL ) ;
if ( ! F_1 ( & V_27 . V_13 , NULL ) )
goto V_33;
if ( ! F_15 ( V_27 . V_26 -> V_6 , V_21 - V_22 ) )
goto V_33;
...
static int F_24 ( T_1 * * V_1 , unsigned char * * V_38 ,
const T_2 * V_2 , int V_17 , int V_18 )
{
int V_3 ;
T_3 * V_13 = ( T_3 * ) * V_1 ;
