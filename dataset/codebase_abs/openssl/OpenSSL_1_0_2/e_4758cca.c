...
static int V_12 ( T_1 * V_4 , int V_49 , long V_50 , void * V_51 ,
void (* F_32) ( void ) )
{
...
static int F_44 ( int type , const unsigned char * V_98 ,
unsigned int V_99 , const unsigned char * V_100 ,
unsigned int V_101 , const T_4 * V_92 )
{
long V_67 ;
long V_68 ;
long V_102 = V_101 ;
...
{
unsigned char * V_119 ;
V_119 = V_106 = F_33 ( ( unsigned int ) V_105 + 1 ) ;
if ( ! V_106 ) {
F_27 ( V_114 , V_82 ) ;
return 0 ;
}
...
V_32 ( & V_67 , & V_68 , & V_69 ,
V_71 , & V_70 , V_72 ,
& V_66 , V_62 , & V_103 , V_106 ,
& V_102 , ( unsigned char * ) V_100 ) ;
...
unsigned char * V_123 , unsigned int * V_101 ,
const T_4 * V_92 )
{
long V_67 ;
long V_68 ;
...
static int F_34 ( const unsigned char * V_126 ,
long * V_79 ,
unsigned char * V_78 , long * V_77 ,
long * V_76 ,
unsigned char * V_75 )
{
unsigned long V_127 ;
