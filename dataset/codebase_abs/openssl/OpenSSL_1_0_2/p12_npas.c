...
if ( ! F_13 ( V_18 -> V_27 . V_28 -> V_29 -> V_30 ,
& V_15 , & V_16 , & V_17 ) ) {
F_14 ( V_12 , V_31 ) ;
V_12 = NULL ;
}
...
if ( ! ( V_1 -> V_33 -> V_27 . V_34 = F_20 () ) )
goto V_35;
if ( ! F_21 ( V_1 , V_10 ) )
goto V_35;
if ( ! F_22 ( V_1 , V_3 , - 1 , V_22 , & V_24 ) )
goto V_35;
if ( ! ( V_21 = F_20 () ) )
goto V_35;
...
if ( F_26 ( V_38 ) != V_44 )
return 1 ;
if ( ! ( V_39 = F_27 ( V_38 -> V_45 . V_46 , V_2 , - 1 ) ) )
return 0 ;
if ( ! F_13 ( V_38 -> V_45 . V_46 -> V_47 , & V_41 , & V_43 , & V_42 ) )
return 0 ;
