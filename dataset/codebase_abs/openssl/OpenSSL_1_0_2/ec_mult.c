...
T_5 V_9 , const T_3 * V_8 [] , const T_4 * V_35 [] ,
T_6 * V_36 )
{
T_6 * V_37 = NULL ;
const T_3 * V_38 = NULL ;
...
V_46 [ V_15 + 1 ] = NULL ;
V_46 [ V_15 ] =
F_12 ( ( V_15 < V_9 ? V_35 [ V_15 ] : V_18 ) , V_45 [ V_15 ] ,
& V_47 [ V_15 ] ) ;
if ( V_46 [ V_15 ] == NULL )
goto V_30;
if ( V_47 [ V_15 ] > V_48 )
...
for ( V_15 = 0 ; V_15 < V_9 + V_54 ; V_15 ++ ) {
if ( V_15 < V_9 ) {
if ( ! F_25 ( V_52 [ V_15 ] [ 0 ] , V_8 [ V_15 ] ) )
goto V_30;
} else {
if ( ! F_25 ( V_52 [ V_15 ] [ 0 ] , V_38 ) )
goto V_30;
}
if ( V_45 [ V_15 ] > 1 ) {
if ( ! F_26 ( V_1 , V_39 , V_52 [ V_15 ] [ 0 ] , V_36 ) )
goto V_30;
for ( V_28 = 1 ; V_28 < ( ( T_5 ) 1 << ( V_45 [ V_15 ] - 1 ) ) ; V_28 ++ ) {
if ( ! F_27
( V_1 , V_52 [ V_15 ] [ V_28 ] , V_52 [ V_15 ] [ V_28 - 1 ] , V_39 , V_36 ) )
goto V_30;
}
}
}
...
if ( V_65 != V_43 ) {
if ( ! V_44 ) {
if ( ! F_29 ( V_1 , V_22 , V_36 ) )
goto V_30;
}
V_43 = ! V_43 ;
}
if ( V_44 ) {
if ( ! F_25 ( V_22 , V_52 [ V_15 ] [ V_34 >> 1 ] ) )
goto V_30;
V_44 = 0 ;
} else {
if ( ! F_27
( V_1 , V_22 , V_22 , V_52 [ V_15 ] [ V_34 >> 1 ] , V_36 ) )
goto V_30;
}
}
}
