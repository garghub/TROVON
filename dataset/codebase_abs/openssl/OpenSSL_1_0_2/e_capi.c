...
static void F_93 ( T_2 * V_6 , int V_161 , char * V_162 ,
T_20 V_163 )
{
T_3 * V_7 ;
...
static int F_100 ( T_2 * V_6 , T_22 * V_172 , T_10 * V_173 ,
T_10 V_174 )
{
T_10 V_77 , V_85 ;
T_23 V_175 ;
...
F_103 ( V_7 , L_25 ) ;
for ( V_174 = 0 ; ; V_174 ++ ) {
V_5 = F_100 ( V_6 , & V_181 , & V_173 , V_174 ) ;
if ( V_5 == 2 )
break;
if ( V_5 == 0 )
break;
F_103 ( V_7 , L_26 , V_174 , V_181 , V_173 ) ;
F_9 ( V_181 ) ;
}
return 1 ;
}
...
int V_5 = 1 ;
T_24 V_141 ;
T_10 V_85 , V_174 , V_182 , V_183 = 0 , V_184 ;
T_22 V_185 ;
T_23 V_186 = NULL ;
F_11 ( V_6 , L_27 , V_6 -> V_186 ,
V_6 -> V_35 ) ;
if ( V_6 -> V_186 && sizeof( V_179 ) != sizeof( char ) ) {
if ( ( V_184 =
F_104 ( V_169 , 0 , V_6 -> V_186 , - 1 , NULL , 0 ) ) ) {
V_186 = F_102 ( V_184 * sizeof( V_180 ) ) ;
F_104 ( V_169 , 0 , V_6 -> V_186 , - 1 , ( V_180 * ) V_186 ,
V_184 ) ;
}
if ( ! V_186 ) {
F_3 ( V_187 , V_61 ) ;
...
V_186 = ( V_179 * ) V_6 -> V_186 ;
if ( ! F_105
( & V_141 , NULL , V_186 , V_6 -> V_35 , V_188 ) ) {
F_3 ( V_187 ,
V_189 ) ;
F_59 () ;
return 0 ;
...
V_182 = 0 ;
if ( ! F_106
( V_141 , V_190 , ( V_193 * ) V_185 , & V_184 , V_182 ) ) {
V_85 = F_97 () ;
if ( V_85 == V_176 )
goto V_194;
F_3 ( V_187 , V_192 ) ;
...
F_11 ( V_6 , L_29 ,
V_185 , V_184 , V_174 , V_182 ) ;
if ( ! V_185 [ 0 ] && ( V_184 == V_183 ) ) {
F_11 ( V_6 , L_30 ) ;
goto V_194;
}
F_103 ( V_7 , L_31 , V_174 , V_185 ) ;
}
V_85:
V_5 = 0 ;
V_194:
...
T_25 * F_108 ( T_2 * V_6 , T_26 V_195 )
{
T_10 V_77 ;
T_25 * V_196 ;
if ( ! F_109
( V_195 , V_197 , NULL , & V_77 ) )
return NULL ;
V_196 = F_60 ( V_77 ) ;
if ( ! V_196 ) {
F_3 ( V_198 , V_61 ) ;
...
static void F_110 ( T_2 * V_6 , T_3 * V_7 ,
T_25 * V_196 )
{
char * V_181 = NULL , * V_200 = NULL ;
if ( ! V_196 ) {
F_103 ( V_7 , L_32 ) ;
return;
}
V_181 = F_98 ( V_196 -> V_201 ) ;
V_200 = F_98 ( V_196 -> V_202 ) ;
if ( ! V_181 || ! V_200 )
goto V_85;
F_103 ( V_7 , L_33 ) ;
F_103 ( V_7 , L_34 , V_181 ,
V_196 -> V_203 ) ;
F_103 ( V_7 , L_35 , V_200 ,
V_196 -> V_204 ) ;
V_85:
if ( V_181 )
F_9 ( V_181 ) ;
...
char * F_111 ( T_2 * V_6 , T_26 V_195 )
{
T_27 V_205 ;
T_10 V_154 ;
F_11 ( V_6 , L_36 ) ;
if ( ! F_109
( V_195 , V_206 , NULL , & V_154 ) )
return NULL ;
V_205 = F_60 ( V_154 ) ;
if ( F_109
( V_195 , V_206 , V_205 , & V_154 ) ) {
char * V_207 = F_98 ( V_205 ) ;
F_9 ( V_205 ) ;
return V_207 ;
}
F_3 ( V_208 , V_209 ) ;
...
void F_112 ( T_2 * V_6 , T_3 * V_7 , T_26 V_195 )
{
T_28 * V_210 ;
unsigned char * V_4 ;
unsigned long V_182 = V_6 -> V_30 ;
if ( V_182 & V_211 ) {
char * V_207 ;
V_207 = F_111 ( V_6 , V_195 ) ;
if ( V_207 ) {
F_103 ( V_7 , L_37 , V_207 ) ;
F_9 ( V_207 ) ;
} else
F_103 ( V_7 , L_38 ) ;
}
V_4 = V_195 -> V_212 ;
V_210 = F_113 ( NULL , & V_4 , V_195 -> V_213 ) ;
if ( ! V_210 )
F_103 ( V_7 , L_39 ) ;
if ( V_182 & V_214 ) {
F_103 ( V_7 , L_40 ) ;
F_114 ( V_7 , F_115 ( V_210 ) , 0 , V_215 ) ;
F_103 ( V_7 , L_41 ) ;
F_114 ( V_7 , F_116 ( V_210 ) , 0 , V_215 ) ;
F_103 ( V_7 , L_42 ) ;
}
if ( V_182 & V_216 )
F_117 ( V_7 , V_210 , V_215 , 0 ) ;
if ( V_182 & V_217 ) {
T_25 * V_196 ;
V_196 = F_108 ( V_6 , V_195 ) ;
F_110 ( V_6 , V_7 , V_196 ) ;
if ( V_196 )
F_9 ( V_196 ) ;
}
...
V_17 = L_43 ;
F_11 ( V_6 , L_45 , V_17 ) ;
V_219 = F_120 ( V_6 , V_17 ) ;
if ( ! V_219 )
return 0 ;
if ( V_68 ) {
V_195 = F_122 ( V_6 , V_68 , V_219 ) ;
if ( ! V_195 ) {
V_5 = 0 ;
goto V_85;
}
...
for ( V_174 = 0 ; ; V_174 ++ ) {
V_195 = F_124 ( V_219 , V_195 ) ;
if ( ! V_195 )
break;
F_103 ( V_7 , L_46 , V_174 ) ;
F_112 ( V_6 , V_7 , V_195 ) ;
}
}
V_85:
...
static T_26 F_122 ( T_2 * V_6 , const char * V_68 ,
T_29 V_219 )
{
T_26 V_195 = NULL ;
char * V_207 = NULL ;
...
static T_9 * F_127 ( T_2 * V_6 , const V_179 * V_200 ,
V_179 * V_181 , T_10 V_173 , T_10 V_145 )
{
T_9 * V_75 ;
T_10 V_228 = 0 ;
...
F_11 ( V_6 , L_47 ,
V_200 , V_181 , V_173 ) ;
else if ( V_6 && V_6 -> V_23 >= V_164 && V_6 -> V_25 ) {
char * V_229 = F_98 ( ( V_180 * ) V_200 ) ;
char * V_230 = F_98 ( ( V_180 * ) V_181 ) ;
F_11 ( V_6 , L_47 ,
V_229 , V_230 , V_173 ) ;
if ( V_230 )
F_9 ( V_230 ) ;
...
if ( V_6 -> V_19 & V_20 )
V_228 = V_231 ;
if ( ! F_105 ( & V_75 -> V_141 , V_200 , V_181 , V_173 , V_228 ) ) {
F_3 ( V_232 , V_189 ) ;
F_59 () ;
goto V_85;
}
if ( ! F_128 ( V_75 -> V_141 , V_145 , & V_75 -> V_75 ) ) {
F_3 ( V_232 , V_233 ) ;
F_59 () ;
F_107 ( V_75 -> V_141 , 0 ) ;
goto V_85;
...
static T_9 * F_129 ( T_2 * V_6 , T_26 V_195 )
{
T_9 * V_75 = NULL ;
T_25 * V_196 = NULL ;
char * V_181 = NULL , * V_200 = NULL ;
...
goto V_85;
if ( sizeof( V_179 ) != sizeof( char ) )
V_75 = F_127 ( V_6 , ( V_179 * ) V_196 -> V_202 ,
( V_179 * ) V_196 -> V_201 ,
...
if ( ! V_181 || ! V_200 )
goto V_85;
V_75 = F_127 ( V_6 , ( V_179 * ) V_200 , ( V_179 * ) V_181 ,
V_196 -> V_203 , V_196 -> V_204 ) ;
}
V_85:
if ( V_196 )
...
case V_224 :
case V_227 :
V_219 = F_120 ( V_6 , NULL ) ;
if ( ! V_219 )
return NULL ;
V_195 = F_122 ( V_6 , V_68 , V_219 ) ;
if ( V_195 ) {
V_75 = F_129 ( V_6 , V_195 ) ;
F_123 ( V_195 ) ;
}
F_125 ( V_219 , 0 ) ;
break;
...
V_180 * V_200 , * V_181 ;
T_10 V_77 ;
if ( ( V_77 = F_104 ( V_169 , 0 , V_68 , - 1 , NULL , 0 ) ) &&
( V_200 = F_102 ( V_77 * sizeof( V_180 ) ) ,
F_104 ( V_169 , 0 , V_68 , - 1 , V_200 , V_77 ) ) &&
( V_77 =
F_104 ( V_169 , 0 , V_6 -> V_186 , - 1 , NULL , 0 ) )
&& ( V_181 =
F_102 ( V_77 * sizeof( V_180 ) ) , F_104 ( V_169 ,
0 ,
V_6 -> V_186 ,
- 1 ,
V_181 ,
V_77 ) ) )
V_75 =
F_127 ( V_6 , ( V_179 * ) V_200 , ( V_179 * ) V_181 ,
V_6 -> V_35 , V_6 -> V_27 ) ;
} else
V_75 = F_127 ( V_6 , ( V_179 * ) V_68 ,
( V_179 * ) V_6 -> V_186 ,
V_6 -> V_35 , V_6 -> V_27 ) ;
break;
}
...
static int F_13 ( T_2 * V_6 , T_22 V_172 , T_10 type ,
int V_243 )
{
...
if ( sizeof( V_179 ) != sizeof( char ) ) {
T_10 V_77 ;
if ( ( V_77 = F_104 ( V_169 , 0 , V_172 , - 1 , NULL , 0 ) ) ) {
V_175 = F_102 ( V_77 * sizeof( V_180 ) ) ;
F_104 ( V_169 , 0 , V_172 , - 1 , ( V_180 * ) V_175 , V_77 ) ;
}
} else
V_175 = ( V_179 * ) V_172 ;
if ( ! V_175 || ! F_105 ( & V_141 , NULL , V_175 , type ,
V_188 ) ) {
F_3 ( V_244 ,
V_189 ) ;
F_59 () ;
...
return 0 ;
V_245 = F_13 ( V_6 , V_172 , type , 0 ) ;
F_9 ( V_172 ) ;
return V_245 ;
}
T_30
int F_131 ( T_1 * V_1 , const char * V_68 , const T_31 * V_246 )
{
return 0 ;
}
void F_52 ( void )
