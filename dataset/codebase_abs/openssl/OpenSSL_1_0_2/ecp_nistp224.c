...
V_34 [ 3 ] = ( ( T_8 ) V_35 [ 3 ] ) * V_55 + ( ( T_8 ) V_35 [ 1 ] ) * V_57 ;
...
static void F_30 ( T_2 V_34 , const T_2 V_35 , T_6 V_74 )
{
unsigned V_37 ;
const T_6 V_75 = - V_74 ;
...
const int V_90 , const T_2 V_91 , const T_2 V_92 ,
const T_2 V_93 )
{
...
static void F_33 ( const T_10 V_99 , unsigned int V_100 ,
const T_2 V_101 [] [ 3 ] , T_2 V_34 [ 3 ] )
{
unsigned V_37 , V_102 ;
T_6 * V_103 = & V_34 [ 0 ] [ 0 ] ;
...
const T_5 V_106 [] ,
const unsigned V_107 , const T_3 * V_108 ,
const int V_90 , const T_2 V_101 [] [ 17 ] [ 3 ] ,
const T_2 V_109 [ 2 ] [ 16 ] [ 3 ] )
{
int V_37 , V_110 ;
unsigned V_111 ;
...
V_113 [ 0 ] , V_113 [ 1 ] , V_113 [ 2 ] , 1 , V_64 [ 0 ] , V_64 [ 1 ] , V_64 [ 2 ] ) ;
} else {
...
const T_4 * V_66 , const T_4 * V_128 ,
T_13 * V_129 )
{
int V_1 = 0 ;
T_13 * V_130 = NULL ;
...
static void F_54 ( T_15 V_111 , T_2 V_149 [ ] [ 3 ] ,
T_2 V_150 [ ] )
{
F_55 ( V_111 ,
V_149 ,
...
if ( V_90 )
V_150 =
F_38 ( ( V_107 * 17 + 1 ) * sizeof( T_2 ) ) ;
if ( ( V_155 == NULL ) || ( V_101 == NULL )
|| ( V_90 && ( V_150 == NULL ) ) ) {
F_7 ( V_161 , V_118 ) ;
goto V_134;
}
...
if ( V_102 & 1 ) {
F_32 ( V_101 [ V_37 ] [ V_102 ] [ 0 ] , V_101 [ V_37 ] [ V_102 ] [ 1 ] ,
V_101 [ V_37 ] [ V_102 ] [ 2 ] , V_101 [ V_37 ] [ 1 ] [ 0 ] ,
V_101 [ V_37 ] [ 1 ] [ 1 ] , V_101 [ V_37 ] [ 1 ] [ 2 ] , 0 ,
V_101 [ V_37 ] [ V_102 - 1 ] [ 0 ] ,
V_101 [ V_37 ] [ V_102 - 1 ] [ 1 ] ,
V_101 [ V_37 ] [ V_102 - 1 ] [ 2 ] ) ;
} else {
F_31 ( V_101 [ V_37 ] [ V_102 ] [ 0 ] , V_101 [ V_37 ] [ V_102 ] [ 1 ] ,
V_101 [ V_37 ] [ V_102 ] [ 2 ] , V_101 [ V_37 ] [ V_102 / 2 ] [ 0 ] ,
V_101 [ V_37 ] [ V_102 / 2 ] [ 1 ] ,
V_101 [ V_37 ] [ V_102 / 2 ] [ 2 ] ) ;
}
}
}
}
...
V_154 ,
V_90 , ( const T_2 ( * ) [ 17 ] [ 3 ] ) V_101 , V_109 ) ;
} else
F_35 ( V_76 , V_77 , V_78 ,
( const T_5 ( * ) ) V_155 , V_107 ,
...
return 0 ;
F_47 ( V_129 ) ;
if ( ( ( V_141 = F_48 ( V_129 ) ) == NULL ) || ( ( V_142 = F_48 ( V_129 ) ) == NULL ) )
goto V_134;
if ( V_125 -> V_157 == NULL )
goto V_134;
V_157 = F_57 ( V_125 ) ;
...
F_31 ( V_124 -> V_109 [ 1 ] [ V_37 ] [ 0 ] , V_124 -> V_109 [ 1 ] [ V_37 ] [ 1 ] ,
V_124 -> V_109 [ 1 ] [ V_37 ] [ 2 ] , V_124 -> V_109 [ 0 ] [ V_37 ] [ 0 ] ,
V_124 -> V_109 [ 0 ] [ V_37 ] [ 1 ] , V_124 -> V_109 [ 0 ] [ V_37 ] [ 2 ] ) ;
for ( V_102 = 0 ; V_102 < 27 ; ++ V_102 ) {
F_31 ( V_124 -> V_109 [ 1 ] [ V_37 ] [ 0 ] , V_124 -> V_109 [ 1 ] [ V_37 ] [ 1 ] ,
V_124 -> V_109 [ 1 ] [ V_37 ] [ 2 ] , V_124 -> V_109 [ 1 ] [ V_37 ] [ 0 ] ,
V_124 -> V_109 [ 1 ] [ V_37 ] [ 1 ] , V_124 -> V_109 [ 1 ] [ V_37 ] [ 2 ] ) ;
}
if ( V_37 == 8 )
break;
F_31 ( V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 0 ] ,
V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 1 ] ,
V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 2 ] , V_124 -> V_109 [ 1 ] [ V_37 ] [ 0 ] ,
V_124 -> V_109 [ 1 ] [ V_37 ] [ 1 ] , V_124 -> V_109 [ 1 ] [ V_37 ] [ 2 ] ) ;
for ( V_102 = 0 ; V_102 < 27 ; ++ V_102 ) {
F_31 ( V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 0 ] ,
V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 1 ] ,
V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 2 ] ,
V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 0 ] ,
V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 1 ] ,
V_124 -> V_109 [ 0 ] [ 2 * V_37 ] [ 2 ] ) ;
}
}
...
F_32 ( V_124 -> V_109 [ V_37 ] [ 6 ] [ 0 ] , V_124 -> V_109 [ V_37 ] [ 6 ] [ 1 ] ,
...
