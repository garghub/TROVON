...
return ( 0 ) ;
V_3 = ( T_3 * ) V_17 -> V_14 ;
if ( ( V_3 == NULL ) || ( V_17 -> V_23 == NULL ) || ( V_17 -> V_13 == 0 ) )
return ( 0 ) ;
while ( V_19 > 0 ) {
if ( V_3 -> V_10 ) {
...
memcpy ( ( unsigned char * ) ( & ( V_3 -> V_24 [ V_3 -> V_4 ] ) ) ,
( unsigned char * ) V_26 , V_22 ) ;
V_3 -> V_4 += V_22 ;
V_27 -= V_22 ;
V_26 += V_22 ;
...
V_3 = V_17 -> V_14 ;
V_12 = & V_3 -> V_12 ;
if ( V_3 -> V_4 + 2 * V_12 -> V_42 -> V_51 > V_29 )
return 1 ;
...
V_3 = V_17 -> V_14 ;
V_12 = & V_3 -> V_12 ;
if ( ( int ) ( V_3 -> V_4 - V_3 -> V_5 ) < 2 * V_12 -> V_42 -> V_51 )
return 1 ;
if ( ! F_22 ( V_12 , V_12 -> V_42 , NULL ) )
goto V_52;
...
V_3 -> V_11 = 0 ;
if ( V_3 -> V_4 != V_3 -> V_5 ) {
memmove ( V_3 -> V_24 , & ( V_3 -> V_24 [ V_3 -> V_5 ] ) ,
V_3 -> V_4 - V_3 -> V_5 ) ;
}
V_3 -> V_4 -= V_3 -> V_5 ;
V_3 -> V_5 = 0 ;
...
V_57 <<= 8 ;
V_57 |= V_3 -> V_24 [ 3 ] ;
if ( V_3 -> V_4 < V_57 + V_28 + V_12 -> V_42 -> V_51 )
return 1 ;
if ( ! F_27 ( V_12 ,
( unsigned char * ) & ( V_3 -> V_24 [ V_28 ] ) , V_57 ) )
goto V_52;
if ( ! F_28 ( V_12 , V_55 , NULL ) )
goto V_52;
if ( memcmp ( & ( V_3 -> V_24 [ V_57 + V_28 ] ) , V_55 , V_12 -> V_42 -> V_51 ) ==
0 ) {
