...
int F_59 ( T_4 * V_81 , T_8 * V_75 )
{
F_60 ( V_75 , - 1 , - 1 ) ;
if ( ! V_75 -> V_82 )
return - 1 ;
return F_61 ( V_81 , V_75 -> V_82 ) ;
}
int F_62 ( T_10 * * V_83 , T_8 * V_75 )
{
T_10 * V_84 ;
V_84 = F_63 ( T_10 ) ;
if ( ! V_84 )
goto V_64;
if ( ! F_64 ( & V_84 -> V_85 , F_65 ( V_75 ) ) )
goto V_64;
if ( ! F_66 ( V_84 -> V_86 , F_67 ( V_75 ) ) )
goto V_64;
if ( * V_83 )
F_68 ( * V_83 , T_10 ) ;
* V_83 = V_84 ;
