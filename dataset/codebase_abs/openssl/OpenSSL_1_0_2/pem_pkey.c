...
return F_20 ( ( V_31 * ) V_2 -> V_23 -> V_36 ,
V_29 , V_1 , V_2 , NULL , NULL , 0 , 0 , NULL ) ;
}
T_1 * F_25 ( T_8 * V_37 , T_1 * * V_2 , T_3 * V_3 ,
void * V_4 )
{
T_2 * V_38 ;
T_1 * V_10 ;
...
T_9 * F_32 ( T_2 * V_1 , T_9 * * V_2 , T_3 * V_3 , void * V_4 )
{
char * V_5 = NULL ;
const unsigned char * V_6 = NULL ;
unsigned char * V_7 = NULL ;
...
T_9 * F_35 ( T_8 * V_37 , T_9 * * V_2 , T_3 * V_3 , void * V_4 )
{
T_2 * V_38 ;
T_9 * V_10 ;
if ( ( V_38 = F_26 ( F_27 () ) ) == NULL ) {
