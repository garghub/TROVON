...
memcpy ( V_10 , V_6 -> V_14 , ( unsigned int ) V_6 -> V_13 ) ;
else {
V_11 = V_6 -> V_14 + V_6 -> V_13 - 1 ;
V_10 += V_6 -> V_13 - 1 ;
V_9 = V_6 -> V_13 ;
while ( ! * V_11 ) {
* ( V_10 -- ) = 0 ;
...
V_4 = ( * V_6 ) ;
V_10 = * V_7 ;
V_24 = F_13 ( & V_10 , & V_15 , & V_25 , & V_26 , V_13 ) ;
if ( V_24 & 0x80 ) {
V_9 = V_27 ;
goto V_21;
}
...
long V_34 ;
V_6 -> type = V_19 ;
if ( V_6 -> V_13 < ( int ) ( sizeof( long ) + 1 ) ) {
if ( V_6 -> V_14 != NULL )
F_9 ( V_6 -> V_14 ) ;
if ( ( V_6 -> V_14 =
( unsigned char * ) F_8 ( sizeof( long ) + 1 ) ) != NULL )
memset ( ( char * ) V_6 -> V_14 , 0 , sizeof( long ) + 1 ) ;
}
if ( V_6 -> V_14 == NULL ) {
F_10 ( V_35 , V_20 ) ;
return ( 0 ) ;
...
V_36 <<= 8 ;
V_36 |= ( unsigned char ) V_6 -> V_14 [ V_9 ] ;
}
if ( V_3 )
V_36 = - V_36 ;
return ( V_36 ) ;
...
if ( V_4 -> V_13 < V_15 + 4 ) {
unsigned char * V_41 = F_19 ( V_4 -> V_14 , V_15 + 4 ) ;
if ( ! V_41 ) {
F_10 ( V_39 , V_20 ) ;
goto V_21;
}
...
{
T_2 * V_4 ;
if ( ( V_4 = F_22 ( V_38 -> V_14 , V_38 -> V_13 , V_37 ) ) == NULL )
F_10 ( V_42 , V_43 ) ;
