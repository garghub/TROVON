...
L_36 , V_21 ) ;
if ( ! V_34
|| ! F_16 ( V_34 , V_21 , NULL , 0 , NULL , NULL ,
& V_32 ) ) {
if ( V_34 )
F_17 ( V_34 ) ;
F_18 ( V_23 ) ;
...
static int T_5 V_33 ( int V_46 , int V_49 , T_3 * V_32 )
{
char V_50 = '*' ;
if ( V_46 == 0 )
V_50 = '.' ;
