...
fflush ( V_8 ) ;
V_4 [ 0 ] = '\0' ;
fgets ( V_4 , sizeof V_4 , V_11 ) ;
V_6 = strlen ( V_4 ) ;
if ( V_6 > 0 )
V_4 [ -- V_6 ] = '\0' ;
if ( ! F_7 ( ( V_12 * ) V_2 -> V_13 -> V_14 , V_4 , V_6 ) )
goto V_10;
if ( ! F_8 ( V_2 , V_3 , F_9 () ) )
goto V_10;
F_10 ( stdout , V_2 ) ;
...
V_6 = F_22 ( V_3 , NULL ) ;
if ( ( V_20 = ( unsigned char * ) malloc ( V_6 + 1 ) ) == NULL )
goto V_10;
V_21 = V_20 ;
F_22 ( V_3 , & V_21 ) ;
if ( ! F_23 ( V_17 -> V_26 , V_20 , V_6 ) )
goto V_10;
free ( V_20 ) ;
F_24 ( T_8 -> V_13 -> V_27 ) ;
T_8 -> V_13 -> V_27 = V_17 ;
