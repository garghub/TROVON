...
return V_1 -> V_6 -> V_7 ( V_1 , V_2 , V_3 ,
V_4 , V_5 ) ;
}
...
T_5 F_7 ( const T_1 * V_1 , const T_2 * V_2 ,
T_6 V_17 , unsigned char * V_18 ,
T_5 V_19 , T_4 * V_5 )
{
if ( V_1 -> V_6 -> V_20 == 0
&& ! ( V_1 -> V_6 -> V_8 & V_9 ) ) {
...
if ( V_1 -> V_6 -> V_8 & V_9 ) {
if ( V_1 -> V_6 -> V_13 == V_14 )
return F_8 ( V_1 , V_2 , V_17 , V_18 , V_19 , V_5 ) ;
else
#ifdef F_4
{
F_2 ( V_21 , V_15 ) ;
...
if ( V_1 -> V_6 -> V_8 & V_9 ) {
if ( V_1 -> V_6 -> V_13 == V_14 )
return F_11 ( V_1 , V_2 , V_18 , V_19 , V_5 ) ;
else
#ifdef F_4
{
F_2 ( V_23 , V_15 ) ;
...
#else
return F_12 ( V_1 , V_2 , V_18 , V_19 , V_5 ) ;
#endif
}
