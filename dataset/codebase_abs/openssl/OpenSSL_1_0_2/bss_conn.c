...
( ( unsigned long ) V_2 -> V_18 [ 2 ] << 8L ) | ( ( unsigned long ) V_2 -> V_18 [ 3 ] ) ;
...
V_4 = 1 ;
V_4 = F_16 ( V_1 -> V_33 , V_40 , V_38 , ( char * ) & V_4 ,
sizeof( V_4 ) ) ;
if ( V_4 < 0 ) {
F_12 ( V_31 , F_13 () ) ;
F_6 ( 4 , L_1 , V_2 -> V_11 ,
...
F_17 ( V_1 ) ;
V_3 = F_18 ( V_1 -> V_33 ,
(struct V_42 * ) & V_2 -> V_22 , sizeof( V_2 -> V_22 ) ) ;
V_1 -> V_43 = 0 ;
if ( V_3 < 0 ) {
if ( F_19 ( V_3 ) ) {
F_20 ( V_1 ) ;
...
char V_70 [ 16 ] ;
unsigned char * V_6 = V_56 ;
F_39 ( V_70 , sizeof V_70 , L_4 ,
...
char V_70 [ F_40 ( int ) + 1 ] ;
F_39 ( V_70 , sizeof V_70 , L_5 , * ( int * ) V_56 ) ;
if ( V_58 -> V_15 != NULL )
F_4 ( V_58 -> V_15 ) ;
V_58 -> V_15 = F_5 ( V_70 ) ;
V_58 -> V_20 = * ( int * ) V_56 ;
...
case V_81 :
{
int (* * F_45) ( const T_1 * V_57 , int V_9 , int V_82 );
F_45 = ( int (**) ( const T_1 * V_57 , int V_9 , int V_82 ) ) V_56 ;
* F_45 = V_58 -> V_8 ;
}
break;
default:
...
static long F_46 ( T_1 * V_1 , int V_63 , V_79 * V_83 )
{
long V_3 = 1 ;
T_2 * V_58 ;
V_58 = ( T_2 * ) V_1 -> V_56 ;
...
{
V_58 -> V_8 =
( int ( * ) ( const struct V_84 * , int , int ) ) V_83 ;
}
break;
default:
V_3 = 0 ;
...
static int F_47 ( T_1 * V_85 , const char * V_86 )
{
int V_87 , V_3 ;
V_87 = strlen ( V_86 ) ;
V_3 = F_35 ( V_85 , V_86 , V_87 ) ;
return ( V_3 ) ;
}
T_1 * F_48 ( const char * V_86 )
{
T_1 * V_3 ;
V_3 = F_49 ( F_25 () ) ;
if ( V_3 == NULL )
