...
if ( !
( V_39 =
F_24 ( V_7 -> V_3 . V_9 , V_7 -> V_3 . V_12 , V_40 , V_7 -> V_3 . V_11 ,
V_7 -> V_3 . V_5 ) ) )
goto V_24;
V_42 = F_25 ( V_39 ) ;
...
F_27 ( V_39 , V_43 ) ;
V_41 =
V_7 -> V_44 -> V_45 -> V_46 ( V_7 , V_38 , V_43 ,
V_42 ) ;
V_24:
if ( V_43 ) {
F_13 ( V_43 , V_42 ) ;
...
char * V_48 = NULL ;
unsigned char * V_43 = NULL ;
if ( F_29 ( V_7 -> V_3 . V_8 , V_7 -> V_3 . V_5 ) == 0 )
goto V_24;
if ( ! ( V_40 = F_23 ( V_7 -> V_3 . V_9 , V_7 -> V_3 . V_8 , V_7 -> V_3 . V_5 ) ) )
goto V_24;
...
V_7 -> V_3 . V_14 ) ) )
goto V_24;
if ( ! ( V_47 = F_30 ( V_7 -> V_3 . V_7 , V_7 -> V_3 . V_4 , V_48 ) ) )
goto V_24;
if ( !
( V_39 =
F_31 ( V_7 -> V_3 . V_5 , V_7 -> V_3 . V_8 , V_7 -> V_3 . V_6 , V_47 ,
V_7 -> V_3 . V_10 , V_40 ) ) )
goto V_24;
V_42 = F_25 ( V_39 ) ;
if ( ( V_43 = F_26 ( V_42 ) ) == NULL )
...
int F_32 ( T_2 * V_7 , int * V_28 )
{
T_5 * V_49 = & V_7 -> V_3 ;
if ( F_33 ( V_49 -> V_6 , V_49 -> V_5 ) >= 0 || F_33 ( V_49 -> V_8 , V_49 -> V_5 ) >= 0
|| F_34 ( V_49 -> V_8 ) ) {
* V_28 = V_50 ;
return 0 ;
}
if ( F_35 ( V_49 -> V_5 ) < V_49 -> V_18 ) {
* V_28 = V_51 ;
return 0 ;
}
if ( V_49 -> V_15 ) {
if ( V_49 -> V_15 ( V_7 , V_49 -> V_14 ) <= 0 ) {
* V_28 = V_51 ;
return 0 ;
}
} else if ( ! F_36 ( V_49 -> V_6 , V_49 -> V_5 ) ) {
* V_28 = V_51 ;
return 0 ;
}
return 1 ;
...
int F_37 ( T_2 * V_7 )
{
unsigned char V_52 [ V_27 ] ;
F_11 ( V_52 , sizeof( V_52 ) ) ;
V_7 -> V_3 . V_10 = F_12 ( V_52 , sizeof( V_52 ) , V_7 -> V_3 . V_10 ) ;
F_13 ( V_52 , sizeof( V_52 ) ) ;
if ( !
( V_7 -> V_3 . V_9 = F_38 ( V_7 -> V_3 . V_10 , V_7 -> V_3 . V_5 , V_7 -> V_3 . V_6 ) ) )
return - 1 ;
return 1 ;
}
T_4 * F_39 ( T_2 * V_7 )
...
int F_43 ( T_1 * V_2 , char * V_53 )
{
return F_44 ( V_2 , V_54 , 0 , V_53 ) ;
}
int F_45 ( T_1 * V_2 , char * V_55 )
{
return F_44 ( V_2 , V_56 , 0 , V_55 ) ;
}
int F_46 ( T_1 * V_2 , int V_18 )
{
return F_44 ( V_2 , V_57 , V_18 ,
NULL ) ;
}
int F_47 ( T_1 * V_2 ,
int (* F_48) ( T_2 * , void * ) )
{
return F_49 ( V_2 , V_58 ,
( void ( * ) ( void ) ) F_48 ) ;
}
int F_50 ( T_1 * V_2 , void * V_59 )
{
return F_44 ( V_2 , V_60 , 0 , V_59 ) ;
}
int F_51 ( T_1 * V_2 ,
int (* F_48) ( T_2 * , int * , void * ) )
{
return F_49 ( V_2 , V_61 ,
( void ( * ) ( void ) ) F_48 ) ;
}
int F_52 ( T_1 * V_2 ,
char * (* F_48) ( T_2 * , void * ) )
{
return F_49 ( V_2 , V_62 ,
( void ( * ) ( void ) ) F_48 ) ;
}
