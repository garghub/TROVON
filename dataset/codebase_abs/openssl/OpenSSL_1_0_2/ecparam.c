...
const T_7 * V_60 ;
int V_61 , V_62 = 0 ;
const T_8 * V_63 = F_31 ( V_3 ) ;
if ( ( V_31 = F_32 () ) == NULL || ( V_32 = F_32 () ) == NULL ||
( V_33 = F_32 () ) == NULL || ( V_34 = F_32 () ) == NULL ||
( V_35 = F_32 () ) == NULL ||
( V_36 = F_32 () ) == NULL ) {
perror ( L_85 ) ;
goto V_42;
...
V_61 = ( F_33 ( V_63 ) == V_64 ) ;
if ( V_61 ) {
if ( ! F_34 ( V_3 , V_31 , V_32 , V_33 , NULL ) )
goto V_42;
} else {
goto V_42;
}
if ( ( V_60 = F_35 ( V_3 ) ) == NULL )
goto V_42;
if ( ! F_36 ( V_3 , V_60 ,
F_37 ( V_3 ) ,
V_34 , NULL ) )
goto V_42;
if ( ! F_38 ( V_3 , V_35 , NULL ) )
goto V_42;
if ( ! F_39 ( V_3 , V_36 , NULL ) )
goto V_42;
if ( ! V_31 || ! V_32 || ! V_33 || ! V_34 || ! V_35 || ! V_36 )
goto V_42;
V_62 = F_40 ( V_35 ) ;
if ( ( V_59 = ( T_6 ) F_41 ( V_31 ) ) > V_58 )
V_58 = V_59 ;
if ( ( V_59 = ( T_6 ) F_41 ( V_32 ) ) > V_58 )
V_58 = V_59 ;
if ( ( V_59 = ( T_6 ) F_41 ( V_33 ) ) > V_58 )
V_58 = V_59 ;
if ( ( V_59 = ( T_6 ) F_41 ( V_34 ) ) > V_58 )
V_58 = V_59 ;
if ( ( V_59 = ( T_6 ) F_41 ( V_35 ) ) > V_58 )
V_58 = V_59 ;
if ( ( V_59 = ( T_6 ) F_41 ( V_36 ) ) > V_58 )
V_58 = V_59 ;
...
F_42 ( V_24 , V_31 , L_86 , V_62 , V_37 ) ;
F_42 ( V_24 , V_32 , L_87 , V_62 , V_37 ) ;
F_42 ( V_24 , V_33 , L_88 , V_62 , V_37 ) ;
F_42 ( V_24 , V_34 , L_89 , V_62 , V_37 ) ;
F_42 ( V_24 , V_35 , L_90 , V_62 , V_37 ) ;
F_42 ( V_24 , V_36 , L_91 , V_62 , V_37 ) ;
F_7 ( V_24 , L_92 ) ;
F_7 ( V_24 , L_93 , V_62 ) ;
F_7 ( V_24 , L_94 ) ;
F_7 ( V_24 , L_95 ) ;
...
static int F_42 ( T_3 * V_24 , T_4 * V_23 , const char * V_66 ,
