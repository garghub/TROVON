...
if ( ( V_22 -> V_1 != NULL ) && ( V_22 -> V_1 -> V_27 != NULL ) )
V_22 -> V_1 -> V_27 ( V_22 ) ;
F_5 ( V_22 ) ;
return ( 1 ) ;
}
...
void F_16 ( T_1 * V_28 ,
long (* F_17) ( struct V_29 * , int , const char * , int ,
long , long ) )
{
V_28 -> V_6 = F_17 ;
}
...
if ( V_23 > 0 )
V_28 -> V_17 += ( unsigned long ) V_23 ;
if ( F_17 != NULL )
V_23 = ( int ) F_17 ( V_28 , V_37 | V_39 , V_32 , V_33 , 0L , ( long ) V_23 ) ;
return ( V_23 ) ;
}
...
if ( V_23 > 0 )
V_28 -> V_18 += ( unsigned long ) V_23 ;
if ( F_17 != NULL )
V_23 = ( int ) F_17 ( V_28 , V_44 | V_39 , V_40 , V_41 , 0L , ( long ) V_23 ) ;
return ( V_23 ) ;
}
...
F_17 = V_28 -> V_6 ;
if ( ( F_17 != NULL ) && ( ( V_23 = ( int ) F_17 ( V_28 , V_47 , V_40 , 0 , 0L , 1L ) ) <= 0 ) )
return ( V_23 ) ;
if ( ! V_28 -> V_8 ) {
F_3 ( V_46 , V_38 ) ;
return ( - 2 ) ;
...
V_28 -> V_18 += ( unsigned long ) V_23 ;
if ( F_17 != NULL )
V_23 = ( int ) F_17 ( V_28 , V_47 | V_39 , V_40 , 0 , 0L , ( long ) V_23 ) ;
return ( V_23 ) ;
}
...
F_17 = V_28 -> V_6 ;
if ( ( F_17 != NULL ) && ( ( V_23 = ( int ) F_17 ( V_28 , V_50 , V_40 , V_41 , 0L , 1L ) ) <= 0 ) )
return ( V_23 ) ;
if ( ! V_28 -> V_8 ) {
F_3 ( V_49 , V_38 ) ;
return ( - 2 ) ;
...
if ( F_17 != NULL )
V_23 = ( int ) F_17 ( V_28 , V_50 | V_39 , V_40 , V_41 , 0L , ( long ) V_23 ) ;
return ( V_23 ) ;
}
...
if ( F_17 != NULL )
V_2 = F_17 ( V_28 , V_60 | V_39 , V_57 , V_53 , V_54 , V_2 ) ;
return ( V_2 ) ;
}
long F_30 ( T_1 * V_28 , int V_53 ,
void (* F_31) ( struct V_29 * , int , const char * , int ,
long , long ) )
{
long V_2 ;
long (* F_17) ( T_1 * , int , const char * , int , long , long );
...
if ( F_17 != NULL )
V_2 = F_17 ( V_28 , V_60 | V_39 , ( void * ) & F_31 , V_53 , 0 , V_2 ) ;
return ( V_2 ) ;
}
T_3 F_32 ( T_1 * V_5 )
{
