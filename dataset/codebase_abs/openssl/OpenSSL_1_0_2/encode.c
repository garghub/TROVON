...
const unsigned char * V_7 , int V_8 )
{
int V_19 = - 1 , V_20 = 0 , V_21 = - 1 , V_13 = 0 , V_9 , V_22 , V_23 , V_24 , V_25 , V_26 ;
unsigned char * V_27 ;
V_24 = V_1 -> V_3 ;
V_27 = V_1 -> V_12 ;
V_25 = V_1 -> V_4 ;
V_26 = V_1 -> V_18 ;
if ( ( V_8 == 0 ) || ( ( V_24 == 0 ) && ( F_9 ( V_7 [ 0 ] ) == V_28 ) ) ) {
V_21 = 0 ;
goto V_29;
}
...
if ( ( V_22 == V_28 && ( V_24 & 3 ) == 0 ) || ( V_24 >= 64 ) ) {
if ( ( V_22 != V_28 ) && ( V_24 >= 64 ) )
V_26 = 1 ;
if ( V_24 > 0 ) {
V_22 = F_11 ( V_5 , V_27 , V_24 ) ;
V_24 = 0 ;
if ( V_22 < 0 ) {
V_21 = 0 ;
goto V_29;
...
{
int V_9 , V_13 = 0 , V_33 , V_34 , V_35 , V_27 ;
unsigned long V_17 ;
while ( ( F_9 ( * V_15 ) == V_36 ) && ( V_24 > 0 ) ) {
V_15 ++ ;
V_24 -- ;
}
...
V_35 = F_9 ( * ( V_15 ++ ) ) ;
V_27 = F_9 ( * ( V_15 ++ ) ) ;
if ( ( V_33 & 0x80 ) || ( V_34 & 0x80 ) || ( V_35 & 0x80 ) || ( V_27 & 0x80 ) )
return ( - 1 ) ;
V_17 = ( ( ( ( unsigned long ) V_33 ) << 18L ) |
( ( ( unsigned long ) V_34 ) << 12L ) |
( ( ( unsigned long ) V_35 ) << 6L ) | ( ( ( unsigned long ) V_27 ) ) ) ;
...
int F_13 ( unsigned char * V_37 , int V_38 )
{
...
if ( ( V_9 == 1 ) && ( F_9 ( V_37 [ 0 ] ) == V_32 ) )
return ( V_3 ) ;
if ( ( V_9 == 2 ) && ( F_9 ( V_37 [ 0 ] ) == V_32 ) &&
( F_9 ( V_37 [ 0 ] ) == V_32 ) )
return ( V_3 ) ;
return ( 1 ) ;
}
