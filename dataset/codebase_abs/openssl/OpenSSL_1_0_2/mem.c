...
int F_12 ( void * (* F_8) ( T_1 , const char * , int ) ,
void * (* F_9) ( void * , T_1 , const char * ,
int ) , void (* F_10) ( void * ) )
{
if ( ! V_4 )
return 0 ;
...
int F_14 ( void * (* F_8) ( T_1 , const char * , int ) ,
void (* F_10) ( void * ) )
{
if ( ! V_4 )
return 0 ;
...
void (* F_9) ( void * , void * , int ,
const char * , int , int ) ,
void (* F_10) ( void * , int ) , void (* F_16) ( long ) ,
long (* F_17) ( void ) )
{
if ( ! V_10 )
return 0 ;
...
void F_19 ( void * (* * F_8) ( T_1 , const char * , int ) ,
void * (* * F_9) ( void * , T_1 , const char * ,
int ) , void (* * F_10) ( void * ) )
{
if ( F_8 != NULL )
