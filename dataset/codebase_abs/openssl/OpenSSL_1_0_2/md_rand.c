...
int F_18 ( unsigned char * V_10 , int V_11 , int V_30 , int V_31 )
{
static volatile int V_32 = 0 ;
int V_13 , V_14 , V_15 , V_33 , V_16 ;
int V_34 ;
int V_35 ;
long V_17 [ 2 ] ;
unsigned char V_18 [ V_6 ] ;
...
#ifndef F_19
if ( V_36 ) {
F_13 ( & V_19 , ( unsigned char * ) & V_36 , sizeof V_36 ) ;
V_36 = 0 ;
}
#endif
F_13 ( & V_19 , V_18 , V_6 ) ;
...
{
return F_18 ( V_10 , V_11 , 0 , 1 ) ;
}
static int F_28 ( unsigned char * V_10 , int V_11 )
{
return F_18 ( V_10 , V_11 , 1 , 1 ) ;
}
