...
F_47 ( V_50 , & V_67 -> V_79 [ V_67 -> V_81 - F_46 ( V_50 ) ] ) ;
...
F_47 ( V_57 , ( unsigned char * ) V_60 -> V_74 + V_65 - F_46 ( V_57 ) ) ;
V_64 = V_65 ;
...
V_99 = ( char * ) V_98 -> V_79 - ( char * ) V_98 ;
V_101 = F_46 ( V_90 ) ;
V_100 = V_101 + 8 ;
if ( ( V_103 > V_100 ) || ( V_105 > V_100 ) ||
( V_107 > V_100 ) || ( V_104 > V_101 ) || ( V_106 > V_101 ) ) {
F_36 ( V_108 , V_109 ) ;
goto V_33;
}
...
int V_63 = 0 ;
F_55 ( & V_128 ) ;
if ( ! F_41 ( V_124 , V_125 , F_31 , V_58 , V_59 ) )
goto V_129;
if ( ! F_41 ( & V_128 , V_126 , F_32 , V_58 , V_59 ) )
goto V_129;
if ( ! F_56 ( V_124 , V_124 , & V_128 , V_58 , V_59 ) )
goto V_129;
V_63 = 1 ;
V_129:
F_57 ( & V_128 ) ;
