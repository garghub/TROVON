...
if ( V_20 >= V_25 ) {
memcpy ( & ( V_3 -> V_6 [ V_3 -> V_12 + V_3 -> V_11 ] ) , V_24 , V_25 ) ;
V_3 -> V_11 += V_25 ;
return ( V_21 + V_25 ) ;
}
if ( V_3 -> V_11 != 0 ) {
if ( V_20 > 0 ) {
memcpy ( & ( V_3 -> V_6 [ V_3 -> V_12 + V_3 -> V_11 ] ) , V_24 , V_20 ) ;
V_24 += V_20 ;
V_25 -= V_20 ;
V_21 += V_20 ;
V_3 -> V_11 += V_20 ;
...
V_28 = 0 ;
V_29 = V_3 -> V_4 ;
for ( V_20 = 0 ; V_20 < V_3 -> V_9 ; V_20 ++ ) {
if ( V_29 [ V_3 -> V_10 + V_20 ] == '\n' )
V_28 ++ ;
}
break;
case V_38 :
