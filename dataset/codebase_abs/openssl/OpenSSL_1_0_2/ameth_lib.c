...
int V_67 ) ,
int (* V_50) ( const T_2 * V_31 ,
unsigned char * * V_66 ) ,
int (* V_51) ( const T_2 * V_59 ) ,
int (* V_52) ( T_2 * V_23 ,
const T_2 * V_24 ) ,
int (* V_53) ( const T_2 * V_6 ,
const T_2 * V_7 ) ,
int (* V_54) ( T_4 * V_61 ,
const T_2 * V_31 ,
int V_62 , T_5 * V_63 ) )
