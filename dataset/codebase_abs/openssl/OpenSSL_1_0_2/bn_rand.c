...
static int F_15 ( int V_17 , T_1 * V_18 , const T_1 * V_19 )
{
int (* F_16) ( T_1 * , int , int , int ) =
V_17 ? F_13 : F_12 ;
int V_20 ;
int V_21 = 100 ;
...
do {
if ( ! F_16 ( V_18 , V_20 + 1 , - 1 , 0 ) )
return 0 ;
if ( F_20 ( V_18 , V_19 ) >= 0 ) {
if ( ! F_21 ( V_18 , V_18 , V_19 ) )
return 0 ;
if ( F_20 ( V_18 , V_19 ) >= 0 )
if ( ! F_21 ( V_18 , V_18 , V_19 ) )
return 0 ;
...
int F_22 ( T_1 * V_18 , const T_1 * V_19 )
{
return F_15 ( 0 , V_18 , V_19 ) ;
}
int F_23 ( T_1 * V_18 , const T_1 * V_19 )
{
