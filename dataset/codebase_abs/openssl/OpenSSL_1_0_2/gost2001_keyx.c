...
int F_23 ( T_7 * V_18 , unsigned char * V_14 ,
T_1 * V_20 )
{
T_8 * V_21 = F_24 ( V_18 ) ;
T_8 * V_22 = F_25 ( V_18 ) ;
...
int F_30 ( T_7 * V_28 , unsigned char * V_29 ,
T_1 * V_30 , const unsigned char * V_14 ,
T_1 V_31 )
{
T_9 * V_32 = NULL ;
T_8 * V_33 = F_24 ( V_28 ) ;
...
if ( ! F_44
( V_32 -> V_50 -> V_52 , V_36 + 8 , 32 ) ) {
goto V_44;
}
if ( V_38 ) {
if ( ! F_45
( & V_32 -> V_48 -> V_53 , V_29 ? V_40 : V_33 ) ) {
F_27 ( V_41 ,
V_54 ) ;
goto V_44;
}
...
F_48 ( V_40 ) ;
if ( ! V_38 ) {
if ( F_49 ( V_28 , - 1 , - 1 , V_57 , 3 , NULL )
<= 0 ) {
F_27 ( V_41 , V_58 ) ;
goto V_44;
}
}
if ( ( * V_30 = F_50 ( V_32 , V_29 ? & V_29 : NULL ) ) > 0 )
V_37 = 1 ;
F_51 ( V_32 ) ;
return V_37 ;
V_44:
...
int F_52 ( T_7 * V_28 , unsigned char * V_14 ,
T_1 * V_31 , const unsigned char * V_59 ,
T_1 V_60 )
{
...
V_32 = F_53 ( NULL , ( const unsigned char * * ) & V_10 , V_60 ) ;
if ( ! V_32 ) {
F_27 ( V_66 ,
V_67 ) ;
return - 1 ;
