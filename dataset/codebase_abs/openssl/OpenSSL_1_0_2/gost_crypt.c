...
F_10 ( & ( V_14 -> V_18 ) , V_20 ) ;
if ( V_21 )
memcpy ( V_19 -> V_26 , V_21 , F_11 ( V_19 ) ) ;
...
const unsigned char * V_21 , int V_22 )
{
return F_9 ( V_19 , V_20 , V_21 , V_22 , V_8 ,
V_28 ) ;
}
static void F_14 ( void * V_19 , unsigned char * V_21 , unsigned char * V_29 )
{
struct V_13 * V_14 = V_19 ;
assert ( V_14 -> V_17 % 8 == 0 && V_14 -> V_17 <= 1024 ) ;
if ( V_14 -> V_16 && V_14 -> V_17 == 1024 ) {
F_15 ( & ( V_14 -> V_18 ) , V_21 ) ;
}
F_16 ( & ( V_14 -> V_18 ) , V_21 , V_29 ) ;
V_14 -> V_17 = V_14 -> V_17 % 1024 + 8 ;
}
...
V_30 = V_32 [ 0 ] | ( V_32 [ 1 ] << 8 ) | ( V_32 [ 2 ] << 16 ) | ( ( T_3 ) V_32 [ 3 ] << 24 ) ;
V_30 += 0x01010101 ;
...
V_30 = V_32 [ 4 ] | ( V_32 [ 5 ] << 8 ) | ( V_32 [ 6 ] << 16 ) | ( ( T_3 ) V_32 [ 7 ] << 24 ) ;
V_31 = V_30 ;
V_30 += 0x01010104 ;
if ( V_31 > V_30 )
V_30 ++ ;
...
T_4 V_39 = 0 ;
if ( V_19 -> V_40 ) {
for ( V_39 = V_19 -> V_40 , V_38 = 0 ; V_39 < 8 && V_38 < V_35 ;
V_39 ++ , V_38 ++ , V_36 ++ , V_37 ++ ) {
if ( ! V_19 -> V_41 )
V_19 -> V_29 [ V_39 + 8 ] = * V_36 ;
* V_37 = V_19 -> V_29 [ V_39 ] ^ ( * V_36 ) ;
if ( V_19 -> V_41 )
V_19 -> V_29 [ V_39 + 8 ] = * V_37 ;
}
if ( V_39 == 8 ) {
...
if ( ! V_19 -> V_41 )
memcpy ( V_19 -> V_21 , V_36 , 8 ) ;
for ( V_39 = 0 ; V_39 < 8 ; V_39 ++ ) {
V_37 [ V_39 ] = V_19 -> V_29 [ V_39 ] ^ V_36 [ V_39 ] ;
}
if ( V_19 -> V_41 )
memcpy ( V_19 -> V_21 , V_37 , 8 ) ;
}
if ( V_38 < V_35 ) {
F_14 ( V_19 -> V_24 , V_19 -> V_21 , V_19 -> V_29 ) ;
if ( ! V_19 -> V_41 )
memcpy ( V_19 -> V_29 + 8 , V_36 , V_35 - V_38 ) ;
for ( V_39 = 0 ; V_38 < V_35 ; V_39 ++ , V_38 ++ ) {
V_37 [ V_39 ] = V_19 -> V_29 [ V_39 ] ^ V_36 [ V_39 ] ;
}
V_19 -> V_40 = V_39 ;
if ( V_19 -> V_41 )
memcpy ( V_19 -> V_29 + 8 , V_37 , V_39 ) ;
} else {
V_19 -> V_40 = 0 ;
}
return 1 ;
...
memset ( V_14 -> V_71 , 0 , sizeof( V_14 -> V_71 ) ) ;
V_14 -> V_17 = 0 ;
V_14 -> V_72 = 0 ;
V_14 -> V_16 = 1 ;
F_8 ( & ( V_14 -> V_18 ) , & V_27 ) ;
...
static void F_38 ( struct V_68 * V_14 ,
...
if ( V_14 -> V_72 ) {
for ( V_38 = V_14 -> V_72 ; V_38 < 8 && V_73 > 0 ; V_73 -- , V_38 ++ , V_52 ++ ) {
V_14 -> V_71 [ V_38 ] = * V_52 ;
}
if ( V_38 == 8 ) {
F_38 ( V_14 , V_14 -> V_71 ) ;
...
if ( V_14 -> V_72 ) {
int V_38 ;
for ( V_38 = V_14 -> V_72 ; V_38 < 8 ; V_38 ++ ) {
V_14 -> V_71 [ V_38 ] = 0 ;
}
F_38 ( V_14 , V_14 -> V_71 ) ;
}
...
F_10 ( & ( ( (struct V_68 * ) ( V_19 -> V_69 ) ) -> V_18 ) ,
V_43 ) ;
( (struct V_68 * ) ( V_19 -> V_69 ) ) -> V_74 = 1 ;
return 1 ;
}
default:
return 0 ;
