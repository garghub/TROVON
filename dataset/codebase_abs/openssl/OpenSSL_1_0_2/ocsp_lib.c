...
if ( ! ( V_12 -> V_18 = F_13 ( V_10 ) ) )
goto V_16;
if ( ( V_12 -> V_22 = F_14 () ) == NULL )
goto V_16;
V_12 -> V_22 -> type = V_23 ;
if ( ! F_15 ( V_7 , V_1 , V_14 , & V_11 ) )
goto V_24;
if ( ! ( F_16 ( V_13 -> V_25 , V_14 , V_11 ) ) )
goto V_16;
if ( ! F_17 ( V_8 -> V_26 , V_8 -> V_27 , V_14 , & V_11 , V_1 , NULL ) )
goto V_16;
if ( ! ( F_16 ( V_13 -> V_28 , V_14 , V_11 ) ) )
goto V_16;
if ( V_9 ) {
F_18 ( V_13 -> V_9 ) ;
if ( ! ( V_13 -> V_9 = F_19 ( V_9 ) ) )
goto V_16;
}
return V_13 ;
V_24:
...
int F_26 ( const char * V_33 , char * * V_34 , char * * V_35 , char * * V_36 ,
int * V_37 )
{
char * V_38 , * V_39 ;
char * V_40 , * V_41 ;
