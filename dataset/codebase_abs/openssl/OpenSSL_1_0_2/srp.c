...
{
if ( V_11 > 0 ) {
char * * V_3 = F_3 ( V_1 -> V_1 -> V_6 , V_17 ) ;
if ( V_3 [ V_7 ] [ 0 ] != 'I' ) {
F_4 ( V_1 , V_9 , V_17 , V_11 , L_4 ) ;
F_4 ( V_1 , V_9 , F_1 ( V_1 , V_3 [ V_18 ] , 'I' ) , V_11 ,
L_3 ) ;
}
}
}
...
int V_4 ;
if ( ( V_20 =
( char * * ) F_9 ( sizeof( char * ) * ( V_14 + 1 ) ) ) == NULL ) {
F_5 ( V_15 , L_5 ) ;
return 0 ;
}
...
V_19 [ V_7 ] = F_38 ( L_59 ) ;
V_19 [ V_18 ] = F_38 ( V_32 ) ;
if ( ! V_19 [ V_8 ] || ! V_19 [ V_18 ] || ! V_19 [ V_7 ]
|| ! V_19 [ V_77 ] || ! V_19 [ V_78 ] || ( V_48
&&
( ! ( V_19
[ V_79 ]
=
...
V_23 ) ;
if ( ( V_80 =
F_1 ( V_1 , V_19 [ V_18 ] , V_5 ) ) >= 0 )
V_20 =
( char * * ) F_3 ( V_1 ->
V_1 -> V_6 ,
V_17 ) ;
if ( ! F_13
( V_23 , V_19 [ V_77 ] , V_19 [ V_78 ] ,
V_20 ? V_20 [ V_78 ] : V_19 [ V_18 ] ,
V_20 ? V_20 [ V_77 ] : NULL , V_28 ,
V_15 , V_11 ) ) {
F_5 ( V_15 ,
L_63 ,
V_23 ) ;
...
T_4 F_5 ( V_15 , L_69 ) ;
if ( ! F_39 ( V_54 , L_70 , V_1 ) )
goto V_71;
T_4 F_5 ( V_15 , L_71 ) ;
if ( ! F_40 ( V_54 , L_70 , L_72 ) )
goto V_71;
T_4 F_5 ( V_15 , L_73 ) ;
}
V_50 = ( V_51 != 0 ) ;
