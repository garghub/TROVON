...
static int F_8 ( T_2 * V_16 , int V_17 , T_1 * V_7 ,
const char * V_9 )
{
...
V_19 = F_10 ( V_16 , V_34 , V_19 , NULL , NULL ) ;
} while ( V_19 > 0 );
if ( V_23 > 0 )
F_7 ( V_7 , L_11 ) ;
V_20 = 1 ;
...
T_5 V_61 ;
if ( F_32 ( V_16 ) != NULL
&& ! F_2 ( & V_55 , L_27 , & V_54 , 256 ) )
goto V_49;
if ( F_33 ( V_16 ) != NULL
&& ! F_2 ( & V_55 , L_28 , & V_54 , 256 ) )
goto V_49;
if ( F_34 ( V_16 ) != NULL
&& ! F_2 ( & V_55 , L_29 , & V_54 , 256 ) )
goto V_49;
if ( F_35 ( V_16 ) != NULL
&& ! F_2 ( & V_55 , L_30 , & V_54 , 256 ) )
goto V_49;
V_59 = F_36 ( V_16 ) ;
if ( ! V_59 )
goto V_62;
