...
if ( V_1 != NULL ) {
if ( ( V_4 -> V_1 = F_5 ( V_1 ) ) == NULL )
goto V_7;
}
if ( V_2 != NULL ) {
if ( ( V_4 -> V_2 = F_5 ( V_2 ) ) == NULL )
goto V_7;
}
if ( ( V_4 -> V_3 = F_5 ( V_3 ) ) == NULL )
goto V_7;
if ( F_6 ( V_3 , V_8 ) != 0 )
F_7 ( V_4 -> V_3 , V_8 ) ;
V_4 -> V_9 = - 1 ;
...
if ( ! F_14 ( V_13 -> V_1 , V_13 -> V_1 , V_13 -> V_1 , V_13 -> V_3 , V_14 ) )
goto V_7;
if ( ! F_14 ( V_13 -> V_2 , V_13 -> V_2 , V_13 -> V_2 , V_13 -> V_3 , V_14 ) )
goto V_7;
}
V_4 = 1 ;
V_7:
...
return ( 0 ) ;
if ( V_11 != NULL ) {
if ( ! F_17 ( V_11 , V_13 -> V_2 ) )
V_4 = 0 ;
}
if ( ! F_14 ( V_21 , V_21 , V_13 -> V_1 , V_13 -> V_3 , V_14 ) )
V_4 = 0 ;
return V_4 ;
}
...
int F_19 ( T_2 * V_21 , const T_2 * V_11 , T_1 * V_13 ,
T_3 * V_14 )
{
int V_4 ;
F_2 ( V_21 ) ;
