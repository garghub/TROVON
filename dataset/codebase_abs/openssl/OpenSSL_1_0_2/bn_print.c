...
V_20 =
( T_2 * ) F_2 ( ( V_17 / V_22 + 1 ) * sizeof( T_2 ) ) ;
V_6 = ( char * ) F_2 ( V_17 + 3 ) ;
...
int V_2 , V_3 , V_4 , V_5 = 0 ;
int V_28 = 0 ;
if ( ( V_1 -> V_13 ) && ( F_30 ( V_37 , L_1 , 1 ) != 1 ) )
goto V_38;
if ( F_4 ( V_1 ) && ( F_30 ( V_37 , L_2 , 1 ) != 1 ) )
goto V_38;
for ( V_2 = V_1 -> V_8 - 1 ; V_2 >= 0 ; V_2 -- ) {
...
V_39 ++ ;
#ifdef F_32
F_11 ( V_40 , sizeof V_40 , L_3 ,
( int ) sizeof( V_41 ) * 8 , ( int ) sizeof( T_2 ) * 8 ) ;
#else
F_11 ( V_40 , sizeof V_40 , L_3 ,
