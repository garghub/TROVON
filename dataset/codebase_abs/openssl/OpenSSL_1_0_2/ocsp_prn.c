...
T_6 * V_42 = V_36 -> V_43 ;
T_7 * V_44 = V_36 -> V_45 ;
if ( F_11 ( V_1 , L_26 , 19 ) <= 0 )
goto V_46;
V_39 = F_12 ( V_42 -> V_47 ) ;
if ( F_2 ( V_1 , L_27 , V_39 + 1 , V_39 ) <= 0 )
goto V_46;
if ( V_42 -> V_48 != NULL ) {
...
if ( F_2 ( V_1 , L_38 ) <= 0 )
goto V_46;
if ( ! F_29 ( V_1 , V_59 -> V_77 ) )
goto V_46;
if ( F_2 ( V_1 , L_39 ) <= 0 )
goto V_46;
for ( V_38 = 0 ; V_38 < F_30 ( V_59 -> V_78 ) ; V_38 ++ ) {
if ( ! F_31 ( V_59 -> V_78 , V_38 ) )
continue;
