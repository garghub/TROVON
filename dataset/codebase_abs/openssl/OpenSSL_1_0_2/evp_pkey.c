...
int F_18 ( const T_1 * V_25 , int V_27 , int V_28 )
{
...
{
if ( F_29 ( & V_25 -> V_26 , V_29 , type , V_32 , V_33 ) )
return 1 ;
return 0 ;
}
int F_30 ( T_1 * V_25 ,
...
const unsigned char * V_32 , int V_33 )
{
if ( F_31 ( & V_25 -> V_26 , V_27 , type , V_32 , V_33 ) )
return 1 ;
return 0 ;
}
int F_32 ( T_1 * V_25 ,
...
const unsigned char * V_32 , int V_33 )
{
if ( F_33 ( & V_25 -> V_26 , V_34 , type , V_32 , V_33 ) )
return 1 ;
return 0 ;
}
