...
const char * F_24 ( int V_27 )
{
T_8 V_28 ;
for ( V_28 = 0 ; V_28 < sizeof( V_38 ) / sizeof( V_39 ) ; V_28 ++ ) {
if ( V_38 [ V_28 ] . V_27 == V_27 )
return V_38 [ V_28 ] . V_40 ;
}
return NULL ;
}
int F_25 ( const char * V_40 )
{
T_8 V_28 ;
for ( V_28 = 0 ; V_28 < sizeof( V_38 ) / sizeof( V_39 ) ; V_28 ++ ) {
if ( ! strcmp ( V_38 [ V_28 ] . V_40 , V_40 ) )
