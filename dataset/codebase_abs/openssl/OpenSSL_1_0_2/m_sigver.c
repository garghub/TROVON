...
T_2 * V_21 ;
if ( ! V_17 )
return V_2 -> V_6 -> V_22 ( V_2 , V_17 , V_18 , V_1 ) ;
V_21 = F_13 ( V_1 -> V_2 ) ;
if ( ! V_21 )
return 0 ;
V_20 = V_21 -> V_6 -> V_22 ( V_21 , V_17 , V_18 , V_1 ) ;
F_14 ( V_21 ) ;
return V_20 ;
}
if ( V_2 -> V_6 -> V_22 )
...
return 0 ;
if ( V_19 )
V_20 = V_23 . V_2 -> V_6 -> V_22 ( V_23 . V_2 ,
V_17 , V_18 , & V_23 ) ;
else
V_20 = F_17 ( & V_23 , V_24 , & V_26 ) ;
F_18 ( & V_23 ) ;
if ( V_19 || ! V_20 )
return V_20 ;
...
if ( V_19 ) {
if ( V_2 -> V_6 -> V_22 ( V_2 , V_17 , V_18 , V_1 ) <= 0 )
return 0 ;
} else {
int V_27 = F_20 ( V_1 -> V_28 ) ;
if ( V_27 < 0 || F_19 ( V_2 , V_17 , V_18 , NULL , V_27 ) <= 0 )
return 0 ;
}
}
return 1 ;
}
int F_21 ( T_1 * V_1 , const unsigned char * V_29 ,
T_6 V_18 )
{
T_1 V_23 ;
unsigned char V_24 [ V_25 ] ;
...
return - 1 ;
if ( V_30 ) {
V_20 = V_23 . V_2 -> V_6 -> V_31 ( V_23 . V_2 ,
V_29 , V_18 , & V_23 ) ;
} else
V_20 = F_17 ( & V_23 , V_24 , & V_26 ) ;
F_18 ( & V_23 ) ;
if ( V_30 || ! V_20 )
return V_20 ;
return F_22 ( V_1 -> V_2 , V_29 , V_18 , V_24 , V_26 ) ;
}
