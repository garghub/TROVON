...
int type , unsigned char V_5 , char * V_18 , T_1 * V_7 ,
void * V_1 )
{
int V_19 , V_20 , V_3 ;
...
V_3 =
F_4 ( V_29 [ V_19 ] , ( unsigned char ) ( V_5 | V_21 ) ,
V_18 , V_7 , V_1 ) ;
if ( V_3 < 0 )
return - 1 ;
V_20 += V_3 ;
...
V_3 =
F_4 ( V_4 , ( unsigned char ) ( V_5 | V_21 ) , V_18 ,
V_7 , V_1 ) ;
if ( V_3 < 0 )
return - 1 ;
V_20 += V_3 ;
...
static int F_11 ( unsigned long V_33 , T_1 * V_7 , void * V_1 ,
T_2 * V_34 )
{
T_3 V_35 ;
...
static int F_15 ( T_1 * V_7 , void * V_1 , unsigned long V_33 ,
T_2 * V_34 )
{
int V_20 , V_3 ;
int type ;
...
V_44 = F_16 ( type ) ;
V_20 += strlen ( V_44 ) ;
if ( ! V_7 ( V_1 , V_44 , V_20 ) || ! V_7 ( V_1 , L_8 , 1 ) )
return - 1 ;
V_20 ++ ;
}
if ( V_33 & V_45 )
...
int F_27 ( T_7 * V_87 , T_4 * V_88 , int V_50 ,
unsigned long V_5 )
{
if ( V_5 == V_89 )
...
int F_29 ( T_8 * V_90 , T_4 * V_88 , int V_50 ,
unsigned long V_5 )
{
if ( V_5 == V_89 ) {
T_7 * V_91 ;
...
V_95 . V_5 = 0 ;
V_92 =
F_35 ( & V_34 , V_94 -> V_39 , V_94 -> V_40 , V_96 ,
V_98 ) ;
if ( V_92 < 0 )
return V_92 ;
* V_87 = V_95 . V_39 ;
