...
F_5 ( & V_1 -> V_12 , V_6 ) ;
F_5 ( & V_1 -> V_13 , V_6 ) ;
if ( ( V_1 -> V_14 == NULL ) && ( ( V_1 -> V_14 = ( T_2 * )
F_6 ( sizeof( T_2 ) ) )
== NULL ) )
goto V_15;
V_3 = V_1 -> V_14 ;
F_7 ( V_3 ) ;
if ( ( V_1 -> V_16 == NULL ) && ( ( V_1 -> V_16 = ( T_2 * )
F_6 ( sizeof
( T_2 ) ) ) ==
NULL ) )
goto V_15;
...
F_10 ( V_4 , V_5 , NULL ,
& ( V_1 -> V_18 -> V_20 [ ( V_2 ) ? V_7 : 0 ] ) ,
V_1 -> V_8 -> V_22 ) ;
F_11 ( V_3 , V_5 , NULL ,
& ( V_1 -> V_18 -> V_20 [ ( V_2 ) ? 0 : V_7 ] ) ,
V_1 -> V_8 -> V_22 ) ;
...
if ( V_29 == 8 )
V_28 = ( V_28 + 7 ) / 8 * 8 ;
if ( F_13 ( V_27 , V_1 -> V_18 -> V_34 , V_1 -> V_18 -> V_34 , V_28 ) < 1 )
return 0 ;
return 1 ;
}
