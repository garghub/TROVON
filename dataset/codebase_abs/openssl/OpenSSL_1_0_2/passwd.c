...
F_25 ( & V_47 , F_26 () , NULL ) ;
F_27 ( & V_47 , ( V_16 & 1 ) ? ( unsigned const char * ) V_8 : V_42 ,
( V_16 & 1 ) ? V_48 : sizeof V_42 ) ;
if ( V_16 % 3 )
F_27 ( & V_47 , V_44 , V_49 ) ;
if ( V_16 % 7 )
F_27 ( & V_47 , V_8 , V_48 ) ;
F_27 ( & V_47 , ( V_16 & 1 ) ? V_42 : ( unsigned const char * ) V_8 ,
...
char * V_8 , T_2 * V_15 , int V_20 , int V_21 ,
int V_22 , T_1 V_26 , int V_23 , int V_24 ,
int V_25 )
{
char * V_57 = NULL ;
assert ( V_55 != NULL ) ;
