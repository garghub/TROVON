...
T_3 * V_40 ;
if ( V_38 == NULL )
if ( ( V_38 = V_39 = F_6 () ) == NULL )
return 0 ;
F_7 ( V_38 ) ;
if ( ( V_40 = F_8 ( V_38 ) ) == NULL )
goto V_41;
if ( F_9 ( F_10 () , V_35 ) == 0 )
V_34 -> V_33 = V_42 ;
else if ( F_9 ( F_11 () , V_35 ) == 0 )
V_34 -> V_33 = V_43 ;
else if ( F_9 ( F_12 () , V_35 ) == 0 )
V_34 -> V_33 = V_44 ;
else if ( F_9 ( F_13 () , V_35 ) == 0 )
V_34 -> V_33 = V_45 ;
else if ( F_9 ( F_14 () , V_35 ) == 0 )
V_34 -> V_33 = V_46 ;
else {
F_15 ( V_47 , V_48 ) ;
goto V_41;
}
V_1 = F_16 ( V_34 , V_35 , V_36 , V_37 , V_38 ) ;
V_41:
F_17 ( V_38 ) ;
if ( V_39 != NULL )
F_18 ( V_39 ) ;
...
if ( ! V_38 )
if ( ( V_50 = V_38 = F_6 () ) == NULL )
goto V_41;
if ( ! F_19 ( V_49 , V_36 , V_37 , V_38 ) )
goto V_41;
