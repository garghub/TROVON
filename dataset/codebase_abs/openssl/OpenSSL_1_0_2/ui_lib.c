...
char * V_20 = NULL ;
if ( V_19 -> V_5 -> V_56 )
V_20 = V_19 -> V_5 -> V_56 ( V_19 , V_54 , V_55 ) ;
else {
char V_57 [] = L_1 ;
char V_58 [] = L_2 ;
char V_59 [] = L_3 ;
...
V_11 . type = V_52 ;
V_11 . V_13 = V_66 ;
if ( V_19 -> V_5 -> V_67 && ! V_19 -> V_5 -> V_67 ( V_19 , & V_11 ) )
return - 1 ;
return 0 ;
}
int F_39 ( T_1 * V_19 )
...
V_11 -> V_24 [ 0 ] = V_11 -> _ . V_15 . V_17 [ 0 ] ;
break;
}
if ( strchr ( V_11 -> _ . V_15 . V_18 , * V_37 ) ) {
V_11 -> V_24 [ 0 ] = V_11 -> _ . V_15 . V_18 [ 0 ] ;
break;
}
}
}
