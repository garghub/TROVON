...
T_1 * V_3 ;
int V_4 ;
if ( ( V_3 = F_2 ( sizeof( T_1 ) ) ) == NULL )
goto V_5;
if ( ( V_3 -> V_6 = F_2 ( sizeof( V_7 * ) * V_8 ) ) == NULL )
goto V_9;
...
V_54 = V_36 | ( * V_2 ) ;
V_36 += 0x100 ;
V_55 = ( int ) ( ( V_54 >> 2 ) ^ V_54 ) & 0x0f ;
V_3 = ( V_3 << V_55 ) | ( V_3 >> ( 32 - V_55 ) ) ;
V_3 &= 0xFFFFFFFFL ;
V_3 ^= V_54 * V_54 ;
V_2 ++ ;
}
...
unsigned long F_16 ( const T_1 * V_35 )
{
