...
unsigned char * V_5 ;
int V_13 , V_6 ;
if ( V_15 <= 0 || V_15 > V_42 || V_2 == NULL || ( V_3 = * V_2 ) == NULL ||
V_3 [ V_15 - 1 ] & 0x80 ) {
F_5 ( V_43 , V_44 ) ;
return NULL ;
}
...
V_38 -> V_5 = NULL ;
if ( ( V_5 == NULL ) || ( V_38 -> V_6 < V_6 ) ) {
V_38 -> V_6 = 0 ;
if ( V_5 != NULL )
F_11 ( V_5 ) ;
V_5 = ( unsigned char * ) F_12 ( V_6 ) ;
if ( V_5 == NULL ) {
V_13 = V_47 ;
goto V_25;
}
...
T_1 * F_25 ( int V_52 , unsigned char * V_5 , int V_15 ,
