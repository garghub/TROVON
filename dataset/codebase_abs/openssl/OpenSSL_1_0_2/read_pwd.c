int F_1 ( char * V_1 , int V_2 , const char * V_3 , int V_4 )
{
char V_5 [ V_6 ] ;
int V_7 ;
V_7 =
F_2 ( V_1 , V_5 , ( V_2 > V_6 ) ? V_6 : V_2 , V_3 ,
V_4 ) ;
F_3 ( V_5 , V_6 ) ;
return ( V_7 ) ;
}
...
return ( - 1 ) ;
V_15 =
F_13 ( 0 , V_16 , V_32 , & V_11 , 0 , 0 , V_13 , 12 , 0 , 0 ,
0 , 0 ) ;
...
V_14 [ 2 ] = V_13 [ 2 ] ;
V_15 =
F_13 ( 0 , V_16 , V_37 , & V_11 , 0 , 0 , V_14 , 12 , 0 , 0 , 0 ,
0 ) ;
if ( ( V_15 != V_31 ) || ( V_11 . V_33 != V_31 ) )
return ( - 1 ) ;
# endif
...
# if F_8 ( V_35 ) && ! F_8 ( F_6 )
if ( V_21 >= 2 )
V_35 ( fileno ( V_23 ) , & V_13 ) ;
# endif
# ifdef F_6
if ( V_21 >= 2 )
V_15 =
F_13 ( 0 , V_16 , V_37 , & V_11 , 0 , 0 , V_13 , 12 , 0 , 0 ,
0 , 0 ) ;
# endif
if ( V_21 >= 1 )
F_16 () ;
