...
V_99 [ 0 ] . V_101 = V_97 ;
V_99 [ 1 ] . V_9 = 0 ;
V_98 = ( T_20 * ) F_26 ( T_19 -> V_102 , & V_99 [ 0 ] ) ;
if( ! V_98 ) {
V_98 = F_27 ( T_20 ) ;
V_98 -> V_103 = 0 ;
V_98 -> V_104 = 0 ;
...
T_17 = ( T_16 * ) F_73 ( V_34 -> V_141 -> V_142 , V_143 ) ;
if( ! T_17 ) {
T_17 = F_27 ( T_16 ) ;
T_17 -> V_144 = F_74 ( V_145 , L_23 ) ;
F_75 ( V_34 -> V_141 -> V_142 , V_143 , T_17 ) ;
}
T_19 = ( T_18 * ) F_76 ( T_17 -> V_144 , V_34 -> V_35 -> V_146 ) ;
if( ! T_19 ) {
T_19 = F_27 ( T_18 ) ;
