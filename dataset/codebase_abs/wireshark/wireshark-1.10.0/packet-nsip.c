...
static void
F_12 ( T_1 * V_1 , T_2 * V_2 , int V_16 ) {
T_4 V_25 ;
if ( V_2 -> V_14 ) {
V_25 = F_13 ( V_2 -> V_7 , V_2 -> V_8 ) ;
F_7 ( V_2 -> V_14 , V_26 ,
V_2 -> V_7 , V_16 , V_1 -> V_10 ,
V_25 ,
L_7 , V_25 ) ;
...
F_11 ( V_2 -> V_24 , L_8 , V_25 ) ;
}
V_2 -> V_8 += V_1 -> V_9 ;
}
static void
F_14 ( T_1 * V_1 , T_2 * V_2 , int V_16 ) {
T_5 * V_27 ;
if ( V_2 -> V_14 ) {
...
if ( V_28 ) {
F_16 ( V_28 , V_27 , V_2 -> V_20 , V_2 -> V_14 ) ;
}
else {
V_2 -> V_8 += V_1 -> V_9 ;
}
...
T_4 V_29 = F_13 ( V_2 -> V_7 , V_2 -> V_8 ) ;
if ( V_2 -> V_14 ) {
F_18 ( V_2 -> V_14 , V_30 , V_2 -> V_7 ,
V_16 , V_1 -> V_10 , V_29 ) ;
}
V_2 -> V_8 += V_1 -> V_9 ;
if ( F_8 ( V_2 -> V_20 -> V_21 , V_22 ) ) {
...
F_11 ( V_2 -> V_24 , L_11 , V_29 ) ;
}
static void
F_19 ( T_1 * V_1 , T_2 * V_2 , int V_16 ) {
T_4 V_31 = F_13 ( V_2 -> V_7 , V_2 -> V_8 ) ;
if ( V_2 -> V_14 ) {
F_18 ( V_2 -> V_14 , V_32 , V_2 -> V_7 ,
V_16 , V_1 -> V_10 , V_31 ) ;
}
V_2 -> V_8 += V_1 -> V_9 ;
if ( F_8 ( V_2 -> V_20 -> V_21 , V_22 ) ) {
...
F_11 ( V_2 -> V_24 , L_13 , V_31 ) ;
}
static T_6 *
F_20 ( T_7 * V_33 , T_2 * V_2 , T_8 * V_34 ) {
T_4 V_35 ;
T_9 V_36 ;
struct V_37 V_38 ;
T_6 * V_39 = NULL ;
...
break;
case V_47 :
F_25 ( V_2 -> V_7 , V_2 -> V_8 , & V_38 ) ;
F_23 ( V_40 , V_48 , V_2 -> V_7 ,
V_2 -> V_8 , V_33 -> V_45 ,
V_49 ) ;
F_11 ( V_39 , L_15 ,
...
static T_6 *
F_27 ( T_7 * V_33 , T_1 * V_1 , T_2 * V_2 , int V_16 ) {
int V_53 ;
...
L_28 , V_80 ) ;
V_40 = F_21 ( V_39 , V_81 ) ;
F_32 ( V_40 , V_82 , V_2 -> V_7 ,
V_2 -> V_8 , 1 ,
V_80 & V_83 ) ;
F_32 ( V_40 , V_84 , V_2 -> V_7 ,
V_2 -> V_8 , 1 ,
V_80 & V_85 ) ;
F_18 ( V_40 , V_86 ,
V_2 -> V_7 , V_2 -> V_8 , 1 ,
...
if ( F_8 ( V_2 -> V_20 -> V_21 , V_22 ) ) {
if ( V_80 & V_83 ) {
F_39 ( V_2 -> V_20 -> V_21 , V_22 , V_23 , L_29 ) ;
F_11 ( V_2 -> V_24 , L_30 ) ;
}
if ( V_80 & V_85 ) {
F_39 ( V_2 -> V_20 -> V_21 , V_22 , V_23 , L_31 ) ;
F_11 ( V_2 -> V_24 , L_32 ) ;
}
}
}
...
break;
case V_98 :
F_27 ( & V_70 , V_1 , V_2 , V_88 ) ;
break;
case V_99 :
F_27 ( & V_72 , V_1 , V_2 , V_88 ) ;
break;
case V_100 :
F_28 ( V_1 , V_2 , V_88 ) ;
break;
...
static void
F_42 ( T_1 * V_105 , int V_106 , T_2 * V_2 ) {
int V_53 ;
...
T_10 V_108 ;
F_38 ( V_105 , V_2 , V_2 -> V_8 ) ;
F_42 ( & V_105 [ 1 ] , 1 , V_2 ) ;
V_27 = F_44 ( V_2 -> V_7 , V_2 -> V_8 ) ;
if ( V_109 ) {
F_16 ( V_109 , V_27 , V_2 -> V_20 , V_2 -> V_110 ) ;
}
else {
V_108 = F_41 ( V_2 -> V_7 , V_2 -> V_8 ) ;
...
static void
F_59 ( T_5 * V_7 , T_11 * V_20 , T_8 * V_131 ) {
T_3 V_112 ;
...
V_2 . V_110 = V_131 ;
V_20 -> V_132 = L_34 ;
F_60 ( V_20 -> V_21 , V_133 , L_34 ) ;
F_61 ( V_20 -> V_21 , V_22 ) ;
V_112 = F_2 ( V_7 , 0 ) ;
V_2 . V_8 ++ ;
if ( V_131 ) {
V_2 . V_24 = F_23 ( V_131 , V_134 , V_7 , 0 , - 1 ,
V_49 ) ;
V_14 = F_21 ( V_2 . V_24 , V_135 ) ;
...
{ & V_63 ,
{ L_58 , L_59 ,
V_144 , 8 , F_65 ( & V_145 ) , V_64 ,
NULL , V_141 }
} ,
{ & V_65 ,
{ L_60 , L_61 ,
V_139 , V_146 , NULL , V_66 ,
NULL , V_141 }
} ,
{ & V_68 ,
{ L_62 , L_63 ,
V_139 , V_143 , F_64 ( V_147 ) , 0x0 ,
NULL , V_141 }
} ,
{ & V_44 ,
{ L_64 , L_65 ,
...
{ & V_48 ,
{ L_64 , L_66 ,
V_150 , V_149 , NULL , 0x0 ,
NULL , V_141 }
} ,
{ & V_76 ,
{ L_67 , L_68 ,
V_144 , 8 , F_65 ( & V_145 ) , V_77 ,
NULL , V_141 }
} ,
{ & V_78 ,
{ L_69 , L_70 ,
V_139 , V_146 , NULL , V_79 ,
NULL , V_141 }
} ,
{ & V_82 ,
{ L_71 , L_72 ,
V_144 , 8 , F_65 ( & V_145 ) , V_83 ,
NULL , V_141 }
} ,
{ & V_84 ,
{ L_73 , L_74 ,
V_144 , 8 , F_65 ( & V_145 ) , V_85 ,
NULL , V_141 }
} ,
{ & V_86 ,
{ L_75 , L_76 ,
V_139 , V_146 , NULL , V_87 ,
NULL , V_141 }
} ,
{ & V_74 ,
{ L_77 , L_78 ,
...
V_134 = F_66 ( L_85 ,
L_34 , L_86 ) ;
F_67 ( V_134 , V_138 , F_68 ( V_138 ) ) ;
F_69 ( V_151 , F_68 ( V_151 ) ) ;
F_70 ( L_87 , F_59 , V_134 ) ;
F_71 ( & V_153 , V_154 , V_155 ) ;
V_152 = F_72 ( V_134 , V_156 ) ;
F_73 ( V_152 , L_88 ) ;
F_73 ( V_152 , L_89 ) ;
F_74 ( V_152 , L_90 , L_91 ,
L_92
V_154 L_93 ,
& V_153 , V_155 ) ;
}
...
F_75 ( T_9 V_157 )
{
F_76 ( L_94 , V_157 , V_28 ) ;
}
static void
F_77 ( T_9 V_157 )
{
F_78 ( L_94 , V_157 , V_28 ) ;
}
void
V_156 ( void ) {
