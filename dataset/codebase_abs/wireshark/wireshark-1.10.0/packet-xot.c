...
static void F_7 ( T_4 * V_2 , T_2 * T_3 , T_8 * V_20 )
{
int V_3 = 0 ;
T_5 V_21 ;
T_5 V_4 ;
...
V_21 = F_3 ( V_2 , V_3 + 0 ) ;
V_4 = F_3 ( V_2 , V_3 + 2 ) ;
if ( F_9 ( T_3 -> V_25 , V_27 ) )
F_10 ( T_3 -> V_25 , V_27 , L_2 ,
V_21 , V_4 ) ;
if ( F_9 ( T_3 -> V_25 , V_27 ) && V_3 == 0 &&
F_2 ( V_2 , V_3 ) > V_6 + V_4 )
...
static void F_20 ( T_4 * V_2 , T_2 * T_3 , T_8 * V_20 )
{
int V_3 = 0 ;
...
static int F_21 ( T_4 * V_2 , T_2 * T_3 , T_8 * V_20 , void * T_11 V_1 )
{
int V_10 = F_22 ( V_2 ) ;
int V_56 = 0 ;
