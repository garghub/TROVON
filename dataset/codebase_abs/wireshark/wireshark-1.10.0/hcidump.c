...
V_1 -> V_17 . V_25 = V_9 ;
V_1 -> V_17 . V_13 = V_9 ;
V_1 -> V_17 . V_26 . V_27 . V_28 = ( V_6 . V_29 ? FALSE : TRUE ) ;
return TRUE ;
}
static T_1 F_10 ( T_2 * V_1 , T_4 V_30 ,
struct V_31 * V_17 , T_5 * V_32 , int V_33 ,
int * V_2 , T_3 * * V_3 )
{
union V_34 * V_26 = & V_17 -> V_26 ;
struct V_5 V_6 ;
int V_8 ;
if ( F_11 ( V_1 -> V_35 , V_30 , V_36 , V_2 ) == - 1 )
return FALSE ;
V_8 = F_3 ( & V_6 , V_11 , V_1 -> V_35 ) ;
if ( V_8 != V_11 ) {
* V_2 = F_4 ( V_1 -> V_35 , V_3 ) ;
if ( * V_2 == 0 && V_8 != 0 )
* V_2 = V_12 ;
return FALSE ;
}
V_8 = F_3 ( V_32 , V_33 , V_1 -> V_35 ) ;
if ( V_8 != V_33 ) {
* V_2 = F_4 ( V_1 -> V_35 , V_3 ) ;
if ( * V_2 == 0 )
* V_2 = V_12 ;
...
if ( ( V_6 . V_29 != 0 && V_6 . V_29 != 1 ) || V_6 . V_37 != 0
|| F_5 ( V_6 . V_13 ) < 1 )
return 0 ;
