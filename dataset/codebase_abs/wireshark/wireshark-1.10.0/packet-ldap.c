...
static void
F_231 ( T_11 * V_42 , T_23 * V_81 , T_10 * V_46 , T_15 V_338 )
{
int V_43 = 0 ;
T_26 * V_350 ;
T_15 V_351 = FALSE ;
...
V_94 = NULL ;
V_350 = F_232 ( V_81 ) ;
V_98 = ( T_24 * ) F_233 ( V_350 , V_25 ) ;
if ( V_98 == NULL ) {
V_98 = F_20 ( T_24 , 1 ) ;
V_98 -> V_123 = F_19 ( F_1 , F_2 ) ;
V_98 -> V_124 = F_19 ( F_3 , F_4 ) ;
F_234 ( V_350 , V_25 , V_98 ) ;
V_98 -> V_354 = V_355 ;
V_355 = V_98 ;
}
switch ( V_98 -> V_157 ) {
...
V_339 = F_227 ( V_42 , V_43 ) ;
if( ! V_351 && ( F_235 ( V_42 , V_43 , 5 ) )
&& ( F_236 ( V_42 , V_43 ) <= ( T_1 ) ( F_237 ( V_42 , V_43 ) - 4 ) )
...
F_238 ( V_81 -> V_91 , V_356 , V_81 -> V_357 ) ;
if( V_349 ) {
...
if ( ! V_369 ) {
if( ! V_81 -> V_378 ) {
V_368 = F_229 ( V_367 , V_370 ) ;
}
}
if ( V_369 ) {
T_13 * V_379 = NULL ;
T_10 * V_380 = NULL ;
F_238 ( V_81 -> V_91 , V_92 , L_69 ) ;
if ( V_361 ) {
...
F_251 ( V_46 , V_418 , V_42 , V_43 , 4 , F_236 ( V_42 , V_43 ) ) ;
V_43 += 4 ;
...
{
return F_236 ( V_42 , V_43 ) + 4 ;
}
static void
F_254 ( T_11 * V_42 , T_23 * V_81 , T_10 * V_46 )
{
F_231 ( V_42 , V_81 , V_46 , FALSE ) ;
return;
}
static T_1
...
T_29 V_662 ;
V_457 = F_294 ( L_77 ) ;
F_269 ( L_76 , V_663 , V_457 ) ;
V_662 = F_275 ( F_270 , V_358 ) ;
F_269 ( L_558 , V_664 , V_662 ) ;
V_167 = F_294 ( L_559 ) ;
V_377 = F_294 ( L_560 ) ;
V_165 = F_294 ( L_561 ) ;
V_170 = F_294 ( L_562 ) ;
...
if( V_665 != V_659 ) {
if( V_665 )
F_268 ( V_665 , L_77 , TRUE ) ;
V_665 = V_659 ;
if( V_665 )
F_267 ( V_665 , L_77 , TRUE ) ;
}
}
