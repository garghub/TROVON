...
if ( F_13 ( V_8 -> V_20 , V_22 ) ) {
F_14 ( V_8 -> V_20 , V_22 , L_3 ,
F_15 ( V_12 , V_33 , L_4 ) ,
V_15 , V_17 ) ;
}
if ( V_10 ) {
...
V_3 += 1 ;
F_16 ( V_10 , V_42 , V_2 , V_3 , 1 , V_12 ) ;
V_3 += 1 ;
if ( V_10 )
F_17 ( L_5 , V_2 , V_3 , V_10 ) ;
V_3 += V_16 ;
V_18 = FALSE ;
break;
case V_43 :
...
if ( V_11 != NULL )
F_20 ( V_11 , V_3 ) ;
if ( V_18 && F_21 ( V_2 , V_3 ) ) {
V_19 = F_22 ( V_2 , V_3 ) ;
F_23 ( V_19 , V_8 , V_1 ) ;
}
}
static void
F_19 ( T_2 * V_2 , int V_3 , T_1 * V_1 )
{
T_6 * V_11 ;
T_1 * V_55 ;
if ( V_1 ) {
...
{ & V_37 ,
{ L_5 , L_12 ,
V_67 , 8 , F_26 ( & V_68 ) , 0x80 ,
NULL , V_66 }
} ,
{ & V_38 ,
{ L_13 , L_14 ,
V_67 , 8 , F_26 ( & V_69 ) , 0x40 ,
NULL , V_66 }
} ,
{ & V_39 ,
{ L_15 , L_16 ,
V_67 , 8 , F_26 ( & V_70 ) , 0x04 ,
NULL , V_66 }
} ,
{ & V_40 ,
{ L_17 , L_18 ,
V_67 , 8 , F_26 ( & V_70 ) , 0x02 ,
NULL , V_66 }
} ,
{ & V_41 ,
{ L_19 , L_20 ,
V_67 , 8 , F_26 ( & V_70 ) , 0x01 ,
NULL , V_66 }
} ,
{ & V_56 ,
{ L_21 , L_22 ,
...
{ & V_58 ,
{ L_23 , L_24 ,
V_67 , 8 , F_26 ( & V_71 ) , 0x80 ,
NULL , V_66 }
} ,
{ & V_59 ,
{ L_25 , L_26 ,
V_67 , 8 , F_26 ( & V_72 ) , 0x40 ,
NULL , V_66 }
} ,
{ & V_60 ,
{ L_27 , L_28 ,
V_67 , 8 , F_26 ( & V_70 ) , 0x20 ,
NULL , V_66 }
} ,
{ & V_61 ,
{ L_29 , L_30 ,
V_67 , 8 , F_26 ( & V_70 ) , 0x10 ,
NULL , V_66 }
} ,
{ & V_62 ,
{ L_31 , L_32 ,
V_67 , 8 , F_26 ( & V_70 ) , 0x08 ,
NULL , V_66 }
} ,
{ & V_46 ,
{ L_33 , L_34 ,
...
V_30 = F_27 ( L_49 , L_2 , L_50 ) ;
F_28 ( V_30 , V_63 , F_29 ( V_63 ) ) ;
F_30 ( V_75 , F_29 ( V_75 ) ) ;
}
void
F_31 ( void )
...
switch ( V_79 ) {
case V_84 :
F_14 ( V_8 -> V_20 , V_22 , L_53 ,
V_15 , V_17 ) ;
break;
case V_85 :
F_14 ( V_8 -> V_20 , V_22 , L_54 ,
V_15 , V_17 ) ;
break;
case V_86 :
F_14 ( V_8 -> V_20 , V_22 , L_55 ,
V_15 , V_17 ) ;
break;
case V_87 :
F_14 ( V_8 -> V_20 , V_22 , L_56 ,
V_15 , V_17 ) ;
break;
case V_88 :
F_14 ( V_8 -> V_20 , V_22 ,
...
L_64 ,
F_35 ( V_2 , V_3 + 2 ) ) ;
F_17 ( L_65 , V_2 , V_3 + 4 , V_78 ) ;
F_17 ( L_66 , V_2 , V_3 + 20 , V_78 ) ;
}
V_3 += 1 + 1 + 2 + V_16 + V_16 ;
if ( V_79 == V_89 && F_21 ( V_2 , V_3 ) ) {
V_19 = F_22 ( V_2 , V_3 ) ;
F_23 ( V_19 , V_8 , V_1 ) ;
}
}
