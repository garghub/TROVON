...
static void
F_40 ( unsigned int * V_51 , T_11 * V_52 , T_12 * V_53 ,
int V_68 , T_5 V_54 )
{
int V_65 ;
F_26 ( V_51 , V_52 , V_53 ) ;
...
break;
case V_29 :
F_40 ( V_51 , V_52 , V_53 , V_73 , V_54 ) ;
break;
case V_31 :
F_40 ( V_51 , V_52 , V_53 , V_74 , V_54 ) ;
break;
case V_27 :
F_40 ( V_51 , V_52 , V_53 , V_75 , V_54 ) ;
break;
case V_28 :
F_40 ( V_51 , V_52 , V_53 , V_76 , V_54 ) ;
break;
case V_30 :
F_40 ( V_51 , V_52 , V_53 , V_77 , V_54 ) ;
break;
case V_26 :
F_40 ( V_51 , V_52 , V_53 , V_78 , V_54 ) ;
break;
case V_32 :
F_38 ( V_51 , V_52 , V_53 ) ;
break;
default:
F_40 ( V_51 , V_52 , V_53 , V_68 , V_54 ) ;
}
return 0 ;
}
static void
F_45 ( unsigned int * V_51 , T_11 * V_52 , T_12 * V_53 ,
int V_79 )
{
T_14 * V_69 ;
T_12 * V_80 ;
...
F_37 ( V_51 , V_52 , V_80 , V_57 ) ;
V_40 = F_37 ( V_51 , V_52 , V_80 , V_61 ) ;
...
static void
F_48 ( unsigned int * V_51 , T_11 * V_52 , T_12 * V_53 )
{
T_12 * V_80 ;
T_12 * V_83 ;
T_14 * V_69 , * V_84 ;
...
static void
F_50 ( T_11 * V_52 , T_16 * V_95 , T_12 * V_96 )
{
T_15 * V_97 = NULL ;
if ( V_95 -> V_98 || V_96 ) {
V_97 = F_49 ( V_52 ) ;
...
if ( V_95 -> V_98 ) {
F_51 ( V_95 -> V_98 , V_99 , L_15 ) ;
V_100 ++ ;
if ( V_95 -> V_101 -> V_102 != V_103 ) {
F_52 ( V_95 -> V_98 , V_104 ) ;
V_100 = 0 ;
}
V_103 = V_95 -> V_101 -> V_102 ;
F_53 ( V_95 -> V_98 , TRUE ) ;
F_54 ( V_95 -> V_98 , V_104 , L_16 , V_97 -> V_89 ) ;
}
if ( V_96 ) {
unsigned int V_51 ;
T_14 * V_69 ;
T_12 * V_53 ;
V_69 = F_55 ( V_96 , V_105 , V_52 , 0 , - 1 ,
L_17 , V_97 -> V_89 ) ;
V_51 = 9 ;
V_53 = F_47 ( V_69 , V_106 ) ;
...
static T_1
F_56 ( T_16 * V_95 V_109 , T_11 * V_52 , int V_51 )
{
return F_34 ( V_52 , V_51 + 4 ) + 8 ;
}
static int
F_57 ( T_11 * V_52 , T_16 * V_95 , T_12 * V_96 , void * V_6 V_109 )
{
if ( F_46 ( V_52 ) < 4 ) {
return 0 ;
}
if ( F_58 ( V_52 , 0 , V_110 , 4 ) == - 1 ) {
return 0 ;
}
F_59 ( V_52 , V_95 , V_96 , TRUE , 8 , F_56 ,
F_50 ) ;
if ( V_100 > 0 ) {
F_53 ( V_95 -> V_98 , TRUE ) ;
F_60 ( V_95 -> V_98 , V_104 , L_18 , V_100 + 1 ) ;
}
return 1 ;
}
static void
...
F_64 ( V_105 , V_112 , F_65 ( V_112 ) ) ;
F_66 ( V_129 , F_65 ( V_129 ) ) ;
F_67 ( L_57 , F_57 , V_105 ) ;
F_68 ( & F_61 ) ;
V_111 = F_69 ( V_105 ,
V_130 ) ;
F_70 ( V_111 , L_58 ,
...
static T_1 V_135 = 0 ;
if( ! V_133 ) {
V_134 = F_72 ( F_57 , V_105 ) ;
F_73 ( L_66 , F_57 , V_105 ) ;
V_133 = TRUE ;
}
if( V_135 != 0 && V_135 != V_132 ) {
F_74 ( L_63 , V_135 , V_134 ) ;
}
if( V_132 != 0 && V_135 != V_132 ) {
F_75 ( L_63 , V_132 , V_134 ) ;
}
V_135 = V_132 ;
