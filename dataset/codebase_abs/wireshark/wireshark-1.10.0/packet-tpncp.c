...
V_4 += 16 ;
if ( V_30 [ V_37 ] . V_19 ) {
V_43 = F_21 ( L_6 , F_19 ( V_37 , V_49 , L_4 ) , V_37 ) ;
...
V_4 += 12 ;
if ( V_32 [ V_37 ] . V_19 ) {
V_43 = F_21 ( L_8 , F_19 ( V_37 , V_50 , L_4 ) , V_37 ) ;
V_35 = F_22 ( V_34 , V_2 , V_4 , - 1 , L_7 , V_43 ) ;
...
T_13 * V_117 ;
T_16 * V_64 ;
V_117 = F_21 ( L_7 V_118 L_30 V_118 L_31 , F_40 () ) ;
if ( ( V_64 = F_41 ( V_117 , L_32 ) ) == NULL )
return ( - 1 ) ;
F_26 ( V_49 , V_64 ) ;
F_26 ( V_50 , V_64 ) ;
F_29 ( V_64 ) ;
...
static T_19 V_120 , V_121 ;
if ( V_51 == - 1 )
return;
if ( ! V_119 ) {
V_120 = F_43 ( F_15 , V_51 ) ;
V_121 = F_43 ( F_24 , V_51 ) ;
V_119 = TRUE ;
}
else {
F_44 ( L_33 , V_122 , V_121 ) ;
F_44 ( L_34 , V_123 , V_120 ) ;
F_44 ( L_33 , V_124 , V_121 ) ;
F_44 ( L_34 , V_125 , V_120 ) ;
}
V_122 = V_126 ;
V_123 = V_127 ;
V_124 = V_128 ;
V_125 = V_129 ;
F_45 ( L_33 , V_126 , V_121 ) ;
F_45 ( L_34 , V_127 , V_120 ) ;
}
void F_46 ( void ) {
T_1 V_88 ;
T_20 * V_130 ;
...
V_132 ;
F_52 ( V_131 , F_35 ( V_131 ) ) ;
F_53 ( L_30 , F_15 , V_51 ) ;
V_130 = F_54 ( V_51 , F_42 ) ;
F_55 ( V_130 , L_37 ,
L_38 ,
L_39 , 10 , & V_126 ) ;
F_55 ( V_130 , L_40 ,
