...
V_98 = F_20 ( V_97 , V_105 ) ;
F_21 ( V_1 , V_2 , V_3 , V_98 ) ;
break;
default:
...
L_114 ,
V_69 ) ;
V_148 = F_20 ( V_97 , V_150 ) ;
F_37 ( V_148 , V_151 , V_1 , V_2 + 1 , 1 , V_152 ) ;
F_37 ( V_148 , V_153 , V_1 , V_2 + 1 , 1 , V_152 ) ;
if ( V_69 & V_154 ) {
F_37 ( V_148 , V_155 , V_1 , V_2 + 1 , 1 , V_152 ) ;
}
...
static void
F_38 ( T_1 * V_1 , T_8 * V_158 , T_2 * V_4 )
{
int V_2 = 0 ;
T_2 * V_159 = NULL ;
T_7 * V_97 ;
...
#endif
F_39 ( V_158 -> V_166 , V_167 , L_117 ) ;
if ( V_4 ) {
V_97 = F_37 ( V_4 , V_168 , V_1 , V_2 , - 1 ,
V_169 ) ;
V_159 = F_20 ( V_97 , V_170 ) ;
F_40 ( V_159 , V_171 , V_1 , V_2 , 1 , F_2 ( V_1 , V_2 ) ) ;
}
V_2 += 1 ;
V_161 = F_2 ( V_1 , V_2 ) & 0xF ;
if ( V_159 != NULL )
F_40 ( V_159 , V_172 , V_1 , V_2 , 1 , V_161 ) ;
V_2 += 1 ;
if ( V_161 != 0 ) {
F_41 ( V_1 , V_162 , V_2 , V_161 ) ;
if ( V_159 != NULL ) {
F_42 ( V_159 , V_173 ,
V_1 , V_2 , 1 , ( V_162 [ 0 ] & 0x80 ) != 0 ) ;
V_162 [ 0 ] &= 0x7F ;
F_43 ( V_159 , V_174 , V_1 , V_2 , V_161 , V_162 ) ;
}
V_2 += V_161 ;
}
V_163 = F_2 ( V_1 , V_2 ) ;
if ( F_44 ( V_158 -> V_166 , V_175 ) ) {
F_45 ( V_158 -> V_166 , V_175 ,
F_4 ( V_163 , V_93 ,
L_118 ) ) ;
}
if ( V_159 != NULL )
F_40 ( V_159 , V_176 , V_1 , V_2 , 1 , V_163 ) ;
V_2 += 1 ;
V_164 = F_2 ( V_1 , V_2 ) ;
if ( V_159 != NULL ) {
V_97 = F_40 ( V_159 , V_177 , V_1 ,
V_2 , 1 , V_164 ) ;
V_160 = F_20 ( V_97 , V_178 ) ;
F_42 ( V_160 , V_179 , V_1 ,
V_2 , 1 , V_164 ) ;
if ( V_164 & V_180 ) {
F_40 ( V_160 , V_181 , V_1 ,
V_2 , 1 , V_164 ) ;
}
}
V_2 += 1 ;
V_165 = F_7 ( V_1 , V_2 ) ;
if ( V_159 != NULL )
F_40 ( V_159 , V_182 , V_1 , V_2 , 2 , V_165 ) ;
V_2 += 2 ;
#if 0
codeset = 0;
