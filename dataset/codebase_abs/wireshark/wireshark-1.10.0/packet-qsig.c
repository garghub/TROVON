...
V_4 = F_732 ( L_1404 , L_1405 , V_1007 , V_983 ) ;
F_721 () ;
}
void F_733 ( void ) {
int V_909 ;
...
F_736 ( L_1408 , V_910 [ V_909 ] . V_908 , V_1795 ) ;
F_736 ( L_1409 , V_910 [ V_909 ] . V_908 , V_1796 ) ;
V_963 = V_910 [ V_909 ] . V_908 ;
V_964 = ( const T_18 * ) F_703 ( V_965 , & V_963 ) ;
if ( V_964 ) {
F_737 ( L_1410 , V_964 , V_1795 ) ;
F_737 ( L_1411 , V_964 , V_1796 ) ;
}
}
V_1797 = F_735 ( F_712 , V_929 ) ;
for ( V_909 = 0 ; V_909 < ( int ) F_697 ( V_914 ) ; V_909 ++ ) {
F_736 ( L_1412 , V_914 [ V_909 ] . V_913 , V_1797 ) ;
}
V_1798 = F_738 ( F_719 , V_929 ) ;
F_736 ( L_1407 , V_958 | V_959 , V_1798 ) ;
V_1798 = F_738 ( F_720 , V_929 ) ;
F_736 ( L_1407 , V_960 | V_961 , V_1798 ) ;
F_737 ( L_1413 , L_1414 , V_1794 ) ;
}
