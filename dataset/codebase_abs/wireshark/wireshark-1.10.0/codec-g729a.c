...
return 0 ;
if ( ! V_7 )
return ( V_6 / V_12 ) * V_13 * sizeof( short ) ;
while ( ( V_6 >= V_12 ) &&
( ( * V_8 - V_11 ) >= V_13 * sizeof( short ) ) ) {
if ( F_8 ( V_2 -> V_3 , ( unsigned char * ) V_9 , V_2 -> V_14 ) ) {
memcpy ( V_10 , V_2 -> V_14 , V_13 * sizeof( short ) ) ;
V_10 += V_13 ;
V_11 += V_13 * sizeof( short ) ;
}
V_9 += V_12 ;
V_6 -= V_12 ;
}
