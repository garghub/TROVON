...
static int
F_11 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 , void * T_8 V_41 ) {
T_5 V_7 = 0 ;
T_7 V_4 = 0 , V_11 ;
T_4 * V_5 ;
T_3 * V_42 ;
...
F_14 ( V_2 -> V_43 , V_45 , L_12 ,
F_15 ( V_7 , V_46 , L_13 ) ) ;
V_5 = F_9 ( V_3 , V_47 , V_1 , 0 , - 1 , V_28 ) ;
V_42 = F_7 ( V_5 , V_48 ) ;
V_4 = 0 ;
V_11 = - 1 ;
while ( V_4 > V_11 ) {
V_11 = V_4 ;
V_4 += F_1 ( V_1 , V_2 , V_42 , V_4 ) ;
}
return F_12 ( V_1 ) ;
}
static void
...
V_47 = F_26 ( L_37 ,
L_11 , L_38 ) ;
F_27 ( V_47 , V_53 , F_28 ( V_53 ) ) ;
F_29 ( V_66 , F_28 ( V_66 ) ) ;
V_65 = F_30 ( V_47 , F_20 ) ;
V_51 = F_31 () ;
F_32 ( V_65 , L_14 , L_39 , L_40 , & V_52 , 65535 ) ;
}
void
F_33 ( void )
{
