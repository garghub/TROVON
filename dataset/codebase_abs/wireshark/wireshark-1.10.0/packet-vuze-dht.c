...
F_7 ( V_8 , L_2 , F_8 ( & V_9 ) , F_9 ( V_1 , V_4 ) ) ;
V_4 += V_24 ;
return V_4 ;
}
static int
F_10 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 )
{
T_6 * V_8 ;
T_4 * V_7 ;
V_8 = F_3 ( V_3 , V_25 , V_1 , V_4 , F_2 ( V_1 , V_4 + 2 ) + 5 ,
L_3 ,
F_11 ( F_2 ( V_1 , V_4 ) , V_26 , L_4 ) ,
F_2 ( V_1 , V_4 + 1 ) ) ;
V_7 = F_4 ( V_8 , V_27 ) ;
...
static int
F_12 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_30 )
{
T_6 * V_8 ;
T_4 * V_7 ;
int V_31 ;
...
V_4 = F_10 ( V_1 , V_2 , V_7 , V_4 ) ;
return V_4 ;
}
static int
F_13 ( T_1 * V_1 , T_2 T_3 * V_2 , T_4 * V_3 , int V_4 )
{
T_6 * V_8 ;
T_4 * V_7 ;
T_8 V_34 ;
...
F_7 ( V_8 , L_7 , V_34 , F_14 ( V_1 , V_4 , V_34 ) ) ;
V_4 += V_34 ;
return V_4 ;
}
static int
F_15 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_39 )
{
T_6 * V_8 ;
T_4 * V_7 ;
int V_31 ;
...
V_4 = F_13 ( V_1 , V_2 , V_7 , V_4 ) ;
return V_4 ;
}
static int
F_16 ( T_1 * V_1 , T_2 T_3 * V_2 , T_4 * V_3 , int V_4 , int V_42 )
{
T_6 * V_8 ;
T_4 * V_7 ;
int V_43 = - 1 ;
...
F_7 ( V_8 ,
L_9 ,
F_17 ( V_1 , V_4 ) , F_17 ( V_1 , V_4 + V_48 ) ) ;
...
F_7 ( V_8 , L_7 , V_53 , F_14 ( V_1 , V_4 , V_53 ) ) ;
V_4 += V_53 ;
V_4 = F_10 ( V_1 , V_2 , V_7 , V_4 ) ;
...
static int
F_18 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_42 )
{
T_6 * V_8 ;
T_4 * V_7 ;
int V_61 ;
...
V_4 = F_16 ( V_1 , V_2 , V_7 , V_4 , V_42 ) ;
return V_4 ;
}
static int
F_19 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_65 , int V_42 )
{
T_6 * V_8 ;
T_4 * V_7 ;
int V_31 ;
...
V_4 = F_18 ( V_1 , V_2 , V_7 , V_4 , V_42 ) ;
return V_4 ;
}
static int
F_20 ( T_1 * V_1 , T_2 T_3 * V_2 , T_4 * V_3 , int V_4 )
{
T_6 * V_8 ;
T_4 * V_7 ;
T_8 V_68 ;
...
V_7 = F_4 ( V_8 , V_70 ) ;
F_7 ( V_8 , L_12 ,
F_2 ( V_1 , V_4 ) , F_2 ( V_1 , V_4 + V_13 ) , F_14 ( V_1 , V_4 + V_13 + V_13 , V_68 ) ) ;
...
static int
F_21 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_42 )
{
T_6 * V_8 ;
T_4 * V_7 ;
T_8 V_31 ;
...
V_4 = F_20 ( V_1 , V_2 , V_7 , V_4 ) ;
}
return V_4 ;
}
static int
F_22 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int * V_79 , int * V_42 )
{
F_5 ( V_3 , V_80 , V_1 , V_4 , V_55 , V_14 ) ;
V_4 += V_55 ;
F_5 ( V_3 , V_81 , V_1 , V_4 , V_48 , V_14 ) ;
* V_79 = F_17 ( V_1 , V_4 ) ;
F_23 ( V_2 -> V_82 , V_83 , L_14 , F_11 ( * V_79 , V_84 , L_4 ) ) ;
V_4 += V_48 ;
...
static int
F_24 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int * V_79 , int * V_42 )
{
F_5 ( V_3 , V_81 , V_1 , V_4 , V_48 , V_14 ) ;
* V_79 = F_17 ( V_1 , V_4 ) ;
F_23 ( V_2 -> V_82 , V_83 , L_14 , F_11 ( * V_79 , V_84 , L_4 ) ) ;
...
static int
F_25 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_42 )
{
if( V_42 >= V_94 )
{
V_4 = F_21 ( V_1 , V_2 , V_3 , V_4 , V_42 ) ;
}
return V_4 ;
}
static int
...
V_39 = F_2 ( V_1 , V_4 ) ;
V_4 += V_13 ;
V_4 = F_15 ( V_1 , V_2 , V_3 , V_4 , V_39 ) ;
F_5 ( V_3 , V_98 , V_1 , V_4 , V_13 , V_14 ) ;
V_65 = F_2 ( V_1 , V_4 ) ;
V_4 += V_13 ;
V_4 = F_19 ( V_1 , V_2 , V_3 , V_4 , V_65 , V_42 ) ;
return V_4 ;
}
static int
F_27 ( T_1 * V_1 , T_2 T_3 * V_2 , T_4 * V_3 , int V_4 , int V_42 )
{
if( V_42 >= V_99 )
{
T_8 V_100 ;
...
static int
F_29 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_42 )
{
T_8 V_30 ;
if( V_42 >= V_95 )
{
...
V_30 = F_9 ( V_1 , V_4 ) ;
V_4 += V_24 ;
V_4 = F_12 ( V_1 , V_2 , V_3 , V_4 , V_30 ) ;
return V_4 ;
}
static int
F_30 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_42 T_3 )
{
...
static int
F_31 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_42 )
{
T_5 V_115 ;
T_8 V_30 ;
if( V_42 >= V_99 )
...
V_4 = F_18 ( V_1 , V_2 , V_3 , V_4 , V_42 ) ;
}
return V_4 ;
}
static int
F_32 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , int V_4 , int V_42 T_3 )
{
T_8 V_120 ;
T_5 V_121 ;
T_8 V_122 ;
...
V_120 = F_17 ( V_1 , V_4 ) ;
F_23 ( V_2 -> V_82 , V_83 , L_16 , F_11 ( V_120 , V_124 , L_4 ) ) ;
V_4 += V_48 ;
switch( V_120 )
{
case V_125 :
...
static int
F_33 ( T_1 * V_1 , T_2 T_3 * V_2 , T_4 * V_3 , int V_4 , int V_42 T_3 )
{
T_5 V_121 ;
T_8 V_122 ;
F_5 ( V_3 , V_96 , V_1 , V_4 , V_48 , V_14 ) ;
...
static int
F_34 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_3 , void * T_9 T_3 )
{
T_6 * V_8 ;
T_4 * V_7 ;
int V_79 , V_131 ;
int V_132 = 0 ;
F_35 ( V_2 -> V_82 , V_133 , L_18 ) ;
F_36 ( V_2 -> V_82 , V_83 ) ;
V_8 = F_5 ( V_3 , V_134 , V_1 , 0 , - 1 , V_20 ) ;
V_7 = F_4 ( V_8 , V_135 ) ;
if( F_2 ( V_1 , 0 ) & 0x80 )
{
V_132 = F_22 ( V_1 , V_2 , V_7 , V_132 , & V_79 , & V_131 ) ;
}
else
{
V_132 = F_24 ( V_1 , V_2 , V_7 , V_132 , & V_79 , & V_131 ) ;
}
switch( V_79 )
{
case V_136 :
break;
case V_137 :
V_132 = F_25 ( V_1 , V_2 , V_7 , V_132 , V_131 ) ;
break;
case V_138 :
...
F_40 ( V_134 , V_146 , F_41 ( V_146 ) ) ;
F_42 ( V_162 , F_41 ( V_162 ) ) ;
F_43 ( L_144 , F_34 , V_134 ) ;
V_163 = F_44 ( V_134 , V_164 ) ;
F_45 ( V_163 , L_145 ,
L_146 ,
L_147 ,
10 , & V_165 ) ;
...
V_164 ( void )
{
static T_13 V_166 = FALSE ;
static T_14 V_167 ;
static T_8 V_168 ;
if ( ! V_166 )
{
V_167 = F_46 ( F_34 , V_134 ) ;
V_166 = TRUE ;
}
else
{
F_47 ( L_148 , V_168 , V_167 ) ;
}
V_168 = V_165 ;
F_48 ( L_148 , V_165 , V_167 ) ;
}
