...
V_5 = F_29 ( V_1 ) ;
V_100 = F_3 ( V_1 , V_4 ++ ) ;
V_105 = F_30 ( ( T_6 ) V_100 , V_113 , & V_102 ) ;
if ( V_106 && ! V_106 -> V_108 . V_109 . V_114 ) {
V_106 -> V_108 . V_109 . V_114 = F_31 ( F_32 ( ( T_6 ) V_100 , V_113 , L_5 ) ) ;
}
if ( V_105 == NULL )
{
V_103 =
F_33 ( V_2 , V_115 , V_1 , 0 , V_5 ,
L_6 ,
V_100 ) ;
V_104 = F_34 ( V_103 , V_116 ) ;
}
else
{
V_103 =
F_33 ( V_2 , V_115 , V_1 , 0 , - 1 ,
L_7 ,
V_105 ) ;
V_104 = F_34 ( V_103 , V_117 [ V_102 ] ) ;
F_35 ( T_5 -> V_111 , V_112 , L_8 , V_105 ) ;
F_36 ( V_104 , V_118 ,
...
{
(* V_122 [ V_102 ])( V_1 , V_104 , T_5 , V_4 , V_5 - V_4 ) ;
}
}
void
F_38 ( void )
...
{ & V_20 ,
{ L_26 , L_27 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x80 ,
NULL , V_128 }
} ,
{ & V_21 ,
{ L_28 , L_29 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x40 ,
NULL , V_128 }
} ,
{ & V_22 ,
{ L_30 , L_31 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x20 ,
NULL , V_128 }
} ,
{ & V_23 ,
{ L_32 , L_33 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x08 ,
NULL , V_128 }
} ,
{ & V_24 ,
{ L_34 , L_35 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x10 ,
NULL , V_128 }
} ,
{ & V_25 ,
{ L_36 , L_37 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x04 ,
NULL , V_128 }
} ,
{ & V_26 ,
{ L_38 , L_39 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x02 ,
NULL , V_128 }
} ,
{ & V_27 ,
{ L_40 , L_41 ,
V_133 , 8 , F_40 ( & V_134 ) , 0x01 ,
NULL , V_128 }
} ,
{ & V_28 ,
{ L_42 , L_43 ,
...
{ & V_31 ,
{ L_48 , L_49 ,
V_126 , V_127 , F_39 ( V_135 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_32 ,
{ L_50 , L_51 ,
V_126 , V_127 , F_39 ( V_136 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_34 ,
{ L_52 , L_53 ,
V_126 , V_127 , F_39 ( V_137 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_35 ,
{ L_54 , L_55 ,
V_126 , V_127 , F_39 ( V_138 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_40 ,
{ L_56 , L_57 ,
V_126 , V_127 , F_39 ( V_139 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_41 ,
{ L_58 , L_59 ,
V_126 , V_127 , F_39 ( V_140 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_42 ,
{ L_60 , L_61 ,
V_126 , V_127 , F_39 ( V_141 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_43 ,
{ L_62 , L_63 ,
...
{ & V_44 ,
{ L_66 , L_67 ,
V_126 , V_127 , F_39 ( V_142 ) , 0x0 ,
NULL , V_128 }
} ,
{ & V_46 ,
{ L_68 , L_69 ,
V_126 , V_127 , F_39 ( V_143 ) , 0x0 ,
NULL , V_128 }
} ,
} ;
#define F_41 1
T_12 * V_144 [ F_41 + V_145 +
V_146 ] ;
V_144 [ 0 ] = & V_116 ;
V_124 = F_41 ;
...
V_115 =
F_42 ( L_70 , L_71 , L_72 ) ;
F_43 ( V_115 , V_125 , F_44 ( V_125 ) ) ;
F_45 ( V_144 , F_44 ( V_144 ) ) ;
F_46 ( L_72 , F_27 , V_115 ) ;
}
void
F_47 ( void )
{
