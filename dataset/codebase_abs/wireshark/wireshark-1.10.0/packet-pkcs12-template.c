...
T_15 V_68 ;
int V_69 = 0 ;
V_69 = F_41 ( V_63 , 0 , & V_64 , & V_65 , & V_67 ) ;
V_69 = F_42 ( V_63 , V_69 , & V_68 , & V_66 ) ;
if( ( V_64 == V_70 ) && ( V_67 == V_71 ) )
return V_69 ;
return 0 ;
}
static void F_43 ( T_2 * V_63 , T_16 * V_61 , T_1 * V_1 ) {
int V_69 = 0 ;
T_7 V_72 ;
F_44 ( & V_72 , V_73 , TRUE , V_61 ) ;
if( ( V_69 = F_40 ( V_63 ) ) > 0 )
F_45 ( FALSE , V_63 , V_69 , & V_72 , V_1 , V_74 ) ;
else
F_46 ( V_1 , V_63 , 0 , 1 , L_9 ) ;
}
static void F_47 ( T_2 * V_63 , T_16 * V_61 , T_1 * V_1 )
{
int V_69 = 0 ;
T_7 V_72 ;
F_44 ( & V_72 , V_73 , TRUE , V_61 ) ;
V_69 = F_40 ( V_63 ) ;
F_48 ( FALSE , V_63 , V_69 , & V_72 , V_1 , V_75 ) ;
}
static void F_49 ( T_2 * V_63 , T_16 * V_61 , T_1 * V_1 )
{
int V_69 = 0 ;
T_7 V_72 ;
F_44 ( & V_72 , V_73 , TRUE , V_61 ) ;
if( ( V_69 = F_40 ( V_63 ) ) > 0 )
F_50 ( FALSE , V_63 , V_69 , & V_72 , V_1 , V_76 ) ;
else
F_46 ( V_1 , V_63 , 0 , 1 , L_9 ) ;
}
void F_51 ( void ) {
...
T_19 * V_82 ;
V_83 = F_52 ( V_84 , V_85 , V_86 ) ;
F_53 ( V_83 , V_77 , F_54 ( V_77 ) ) ;
F_55 ( V_81 , F_54 ( V_81 ) ) ;
V_82 = F_56 ( V_83 , NULL ) ;
F_57 ( V_82 , L_12 ,
L_13 ,
