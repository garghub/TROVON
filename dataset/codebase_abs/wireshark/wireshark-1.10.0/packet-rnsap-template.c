...
{
return ( F_6 ( V_8 , V_1 , 0 , V_2 , V_3 ) ) ? F_3 ( V_1 ) : 0 ;
}
static int F_7 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 , void * T_4 V_4 )
{
if ( ! V_9 ) return 0 ;
return ( F_8 ( V_10 , V_9 , V_1 , V_2 , V_3 ) ) ? F_3 ( V_1 ) : 0 ;
}
static int F_9 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 , void * T_4 V_4 )
{
if ( ! V_9 ) return 0 ;
return ( F_8 ( V_11 , V_9 , V_1 , V_2 , V_3 ) ) ? F_3 ( V_1 ) : 0 ;
}
static int F_10 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 , void * T_4 V_4 )
{
if ( ! V_9 ) return 0 ;
return ( F_8 ( V_12 , V_9 , V_1 , V_2 , V_3 ) ) ? F_3 ( V_1 ) : 0 ;
}
static void
...
F_20 ( V_21 , F_19 ( V_21 ) ) ;
F_21 ( L_2 , F_11 , V_17 ) ;
V_5 = F_22 ( L_3 , L_4 , V_25 , V_26 ) ;
V_7 = F_22 ( L_5 , L_6 , V_25 , V_26 ) ;
V_10 = F_22 ( L_7 , L_8 , V_27 , V_28 ) ;
V_11 = F_22 ( L_9 , L_10 , V_27 , V_28 ) ;
V_12 = F_22 ( L_11 , L_12 , V_27 , V_28 ) ;
}
void
F_23 ( void )
{
