...
V_118 = ( T_20 * ) F_66 ( V_114 ) ;
if( V_97 ) {
F_67 ( V_97 ) ;
V_97 = NULL ;
}
V_97 = ( T_20 * ) F_68 ( V_114 ) ;
...
V_128 = ( unsigned char * ) F_68 ( V_126 ) ;
if ( V_128 == NULL )
return - 1 ;
}
if ( V_127 ) {
...
if ( V_136 ) {
T_20 * V_139 ;
V_139 = ( T_20 * ) F_75 ( V_136 , F_33 ( V_132 ) ) ;
F_67 ( V_136 ) ;
...
static int
F_85 ( T_3 * T_4 , T_16 * V_9 V_1 , T_8 * T_9 , void * V_125 V_1 )
{
T_15 * V_33 ;
T_8 * V_34 ;
int T_5 = 0 ;
...
static int
F_86 ( T_3 * T_4 , T_16 * V_9 , T_8 * T_9 , void * V_125 V_1 )
{
T_15 * V_33 ;
T_8 * V_34 ;
int T_5 = 0 ;
...
T_6 V_48 ;
F_38 ( & V_48 , V_49 , TRUE , V_9 ) ;
V_5 = ( T_11 * ) F_88 ( V_9 -> V_176 , V_10 , 0 ) ;
