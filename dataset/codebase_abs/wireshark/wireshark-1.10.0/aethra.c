...
for (; ; ) {
* V_41 = F_6 ( V_1 -> V_12 ) ;
if ( ! F_7 ( V_1 -> V_12 , & V_6 , & V_1 -> V_46 . V_47 ,
V_2 , V_3 ) )
return FALSE ;
V_43 = F_5 ( V_6 . V_43 ) ;
if ( V_43 < ( sizeof V_6 - sizeof V_6 . V_43 ) ) {
* V_2 = V_48 ;
* V_3 = F_8 ( L_1 ,
V_43 , ( unsigned int ) ( sizeof V_6 - sizeof V_6 . V_43 ) ) ;
return FALSE ;
}
V_44 = V_43 - ( T_6 ) ( sizeof V_6 - sizeof V_6 . V_43 ) ;
if ( V_44 != 0 ) {
F_9 ( V_1 -> V_49 , V_44 ) ;
if ( ! F_10 ( V_1 -> V_12 , F_11 ( V_1 -> V_49 ) ,
V_44 , V_2 , V_3 ) )
return FALSE ;
}
#if 0
...
V_45 = F_12 ( V_6 . V_58 ) ;
V_1 -> V_46 . V_59 = V_60 ;
V_1 -> V_46 . V_61 . V_62 = V_8 -> V_35 + ( V_45 / 1000 ) ;
V_1 -> V_46 . V_61 . V_63 = ( V_45 % 1000 ) * 1000000 ;
V_1 -> V_46 . V_64 = V_44 ;
V_1 -> V_46 . V_65 = V_44 ;
return TRUE ;
}
static T_4
V_21 ( T_1 * V_1 , T_5 V_66 ,
struct V_67 * V_46 , T_7 * V_68 , int V_69 ,
int * V_2 , T_2 * * V_3 )
{
union V_70 * V_47 = & V_46 -> V_47 ;
struct V_42 V_6 ;
if ( F_13 ( V_1 -> V_71 , V_66 , V_72 , V_2 ) == - 1 )
return FALSE ;
if ( ! F_7 ( V_1 -> V_71 , & V_6 , V_47 , V_2 , V_3 ) )
return FALSE ;
if ( ! F_10 ( V_1 -> V_71 , V_68 , V_69 , V_2 , V_3 ) )
return FALSE ;
return TRUE ;
}
static T_4
F_7 ( T_8 V_12 , struct V_42 * V_6 ,
union V_70 * V_47 , int * V_2 , T_2 * * V_3 )
{
int V_4 ;
V_9 = V_10 ;
...
V_47 -> V_73 . V_74 = ( V_6 -> V_52 & V_75 ) ;
V_47 -> V_73 . V_76 = 0 ;
return TRUE ;
}
static T_4
F_10 ( T_8 V_12 , T_7 * V_68 , int V_69 , int * V_2 ,
T_2 * * V_3 )
{
int V_4 ;
V_9 = V_10 ;
V_4 = F_2 ( V_68 , V_69 , V_12 ) ;
if ( V_4 != V_69 ) {
* V_2 = F_3 ( V_12 , V_3 ) ;
if ( * V_2 == 0 )
* V_2 = V_13 ;
