...
if ( ! F_12 ( ( V_40 * ) V_11 , & V_12 , NULL , NULL , NULL , V_10 -> V_30 -> V_39 ) ) {
return 0 ;
}
if ( ! V_12 )
return 0 ;
...
V_17 = F_8 ( V_8 -> V_24 , V_41 ) ;
if( ! V_17 || V_17 -> V_26 < 1 ) {
return 0 ;
}
V_14 = V_17 -> V_26 ;
V_18 = F_8 ( V_8 -> V_24 , V_42 ) ;
if( ! V_18 || V_18 -> V_26 < 1 ) {
return 0 ;
}
V_15 = V_18 -> V_26 ;
...
static T_8
F_16 ( T_9 V_47 , T_9 V_28 V_6 , T_9 T_10 V_6 )
{
T_1 * V_2 = ( T_1 * ) V_47 ;
if( V_2 -> V_1 ) {
F_17 ( ( T_9 ) V_2 -> V_1 ) ;
...
static T_8
F_20 ( T_9 V_47 V_6 , T_9 V_28 V_6 , T_9 T_10 V_6 )
{
return TRUE ;
}
static T_11
F_21 ( T_12 V_48 , T_12 V_49 )
{
int V_50 = F_22 ( V_48 ) ;
int V_51 = F_22 ( V_49 ) ;
return V_50 == V_51 ;
