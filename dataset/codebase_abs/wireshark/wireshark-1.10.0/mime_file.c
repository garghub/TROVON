...
static T_1
F_7 ( T_2 * V_1 , T_4 V_20 , struct V_21 * V_12 V_22 , T_6 * V_23 , int V_24 , int * V_2 , T_3 * * V_3 )
{
...
V_31 = ( T_7 ) F_12 ( V_31 , sizeof( V_27 ) ) ;
...
V_29 = FALSE ;
for ( V_30 = 0 ; V_30 < V_32 ; V_30 ++ ) {
if ( ( T_7 ) V_28 >= V_33 [ V_30 ] . V_34 && ! memcmp ( V_27 , V_33 [ V_30 ] . V_35 , F_12 ( V_33 [ V_30 ] . V_34 , ( T_7 ) V_28 ) ) ) {
if ( ! V_29 ) {
V_29 = TRUE ;
} else
return 0 ;
