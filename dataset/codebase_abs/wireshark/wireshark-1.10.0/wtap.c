...
F_17 ( V_21 , V_23 , V_24 ) ;
V_25 = (struct V_22 * ) V_21 -> V_26 ;
}
int F_18 ( void ) {
F_15 () ;
return V_24 ;
}
int F_19 ( const char * V_27 , const char * V_28 ) {
struct V_22 V_29 ;
F_15 () ;
V_29 . V_27 = F_20 ( V_27 ) ;
V_29 . V_28 = F_20 ( V_28 ) ;
...
F_49 ( T_2 * V_1 )
{
return F_50 ( V_1 -> V_38 ) ;
}
T_4
F_51 ( T_2 * V_1 , T_1 V_64 ,
struct V_63 * V_58 , T_16 * V_65 , int V_62 ,
int * V_2 , T_7 * * V_56 )
{
V_58 -> V_66 = 0 ;
V_58 -> V_59 = V_1 -> V_9 ;
V_58 -> V_62 = V_58 -> V_61 = V_62 ;
if ( ! V_1 -> V_67 ( V_1 , V_64 , V_58 , V_65 , V_62 , V_2 , V_56 ) )
return FALSE ;
