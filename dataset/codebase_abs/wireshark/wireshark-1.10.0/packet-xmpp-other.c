...
T_1 * V_46 ;
const T_9 * V_56 [] = { L_16 } ;
const T_9 * V_57 [] = { L_17 , L_18 , L_19 , L_20 , L_21 } ;
...
T_5 * V_31 ;
T_1 * V_32 ;
const T_9 * V_117 [] = { L_60 , L_61 , L_62 , L_63 } ;
...
T_5 * V_123 ;
T_1 * V_124 ;
const T_9 * V_117 [] = { L_68 , L_69 , L_70 , L_71 ,
...
const T_9 * V_160 [] = { L_92 , L_93 , L_94 , L_95 } ;
T_7 * V_161 ;
T_4 * V_162 , * V_163 ;
T_9 * V_164 = F_49 ( L_9 ) ;
...
while( ( V_162 = F_50 ( V_4 , V_160 , F_7 ( V_160 ) ) ) != NULL )
{
if( strcmp ( V_164 , L_9 ) != 0 )
V_164 = F_51 ( L_96 , V_164 , V_162 -> V_168 ) ;
else
V_164 = F_49 ( V_162 -> V_168 ) ;
}
...
while( ( V_42 = F_17 ( V_4 , L_12 ) ) != NULL )
{
F_55 ( V_32 , V_2 , V_3 , V_42 ) ;
}
while( ( V_177 = F_17 ( V_4 , L_104 ) ) != NULL )
{
F_56 ( V_32 , V_2 , V_3 , V_177 ) ;
}
while( ( V_178 = F_17 ( V_4 , L_105 ) ) != NULL )
{
F_57 ( V_32 , V_2 , V_3 , V_178 ) ;
}
F_8 ( V_32 , V_2 , V_3 , V_4 ) ;
}
static void
...
T_5 * V_45 ;
T_1 * V_46 ;
const T_9 * V_182 [] = { L_106 , L_107 , L_19 , L_108 , L_109 } ;
T_10 * V_183 = F_21 ( V_182 , F_7 ( V_182 ) ) ;
const T_9 * V_184 [] = { L_19 , L_110 , L_111 , L_112 } ;
...
T_4 * V_222 ;
const T_9 * V_223 [] = { L_135 , L_136 , L_137 , L_138 , L_139 } ;
if( ( V_222 = F_50 ( V_4 , V_223 , F_7 ( V_223 ) ) ) != NULL )
{
