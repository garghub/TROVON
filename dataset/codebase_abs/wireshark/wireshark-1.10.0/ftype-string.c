...
F_5 ( ! V_3 ) ;
F_2 ( V_1 ) ;
V_1 -> V_2 . string = ( V_4 * ) F_6 ( ( const V_4 * ) V_2 ) ;
}
static int
F_7 ( T_1 * V_1 , T_4 V_5 )
{
...
static T_3
F_19 ( const T_1 * V_25 , const T_1 * V_26 )
{
return ( strcmp ( V_25 -> V_2 . string , V_26 -> V_2 . string ) == 0 ) ;
}
static T_3
F_20 ( const T_1 * V_25 , const T_1 * V_26 )
{
return ( strcmp ( V_25 -> V_2 . string , V_26 -> V_2 . string ) != 0 ) ;
}
static T_3
F_21 ( const T_1 * V_25 , const T_1 * V_26 )
{
return ( strcmp ( V_25 -> V_2 . string , V_26 -> V_2 . string ) > 0 ) ;
}
static T_3
F_22 ( const T_1 * V_25 , const T_1 * V_26 )
{
return ( strcmp ( V_25 -> V_2 . string , V_26 -> V_2 . string ) >= 0 ) ;
}
static T_3
F_23 ( const T_1 * V_25 , const T_1 * V_26 )
{
return ( strcmp ( V_25 -> V_2 . string , V_26 -> V_2 . string ) < 0 ) ;
}
static T_3
F_24 ( const T_1 * V_25 , const T_1 * V_26 )
{
return ( strcmp ( V_25 -> V_2 . string , V_26 -> V_2 . string ) <= 0 ) ;
}
static T_3
F_25 ( const T_1 * V_27 , const T_1 * V_28 )
{
...
static T_3
F_26 ( const T_1 * V_27 , const T_1 * V_28 )
{
