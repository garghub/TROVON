...
L_3 , V_25 , V_26 ) ;
V_24 = F_15 ( V_23 , V_27 ) ;
F_16 ( V_24 , V_28 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_24 , V_30 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
return V_5 ;
}
static int
...
if ( V_45 ) {
char * V_65 ;
V_65 = ( char * ) F_24 ( V_1 , V_47 ,
V_54 ) ;
V_61 = ( char * ) memcpy ( F_25 ( V_54 + 1 ) , V_65 , V_54 ) ;
} else {
V_61 = ( char * ) F_26 ( V_1 ,
F_25 ( V_54 + 1 ) , V_47 , V_54 ) ;
}
V_61 [ V_54 ] = '\0' ;
if ( V_50 ) {
if ( V_50 != V_54 ) {
...
{
return F_19 ( V_1 , V_5 , V_3 , NULL , V_42 ,
FALSE , 0 , TRUE , V_46 ) ;
}
static void
...
T_9 * V_85 ;
T_3 * V_86 ;
V_85 = F_14 ( V_3 , V_1 , V_5 , 8 , L_17 , V_84 ) ;
V_86 = F_15 ( V_85 , V_87 ) ;
...
V_68 V_107 = 0 ;
V_106 = F_4 ( V_1 , V_5 ) ;
V_65 = ( char * ) F_24 ( V_1 , V_5 + 4 , V_106 ) ;
if ( V_3 )
{
T_5 V_108 ;
V_108 = F_23 ( 4 + V_106 + 1 ) ;
if ( ( ( V_106 + 1 ) == V_109 ) &&
( F_49 ( V_65 , V_110 ,
V_106 ) == 0 ) )
{
...
T_9 * V_117 ;
T_3 * V_118 ;
V_117 = F_14 ( V_3 , V_1 , V_5 , - 1 , L_22 ) ;
V_118 = F_15 ( V_117 , V_119 ) ;
F_16 ( V_118 , V_28 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_118 , V_30 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_118 , V_120 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_5 += 4 ;
...
V_128 , V_129 ) ;
V_5 = F_17 ( V_1 , V_118 , V_5 , & V_32 ) ;
V_5 = F_18 ( V_1 , V_118 , V_5 , & V_40 ) ;
if ( V_32 & V_130 )
{
...
{
case V_142 :
V_140 = F_16 ( V_3 , V_143 , V_1 , V_5 , 4 , V_29 ) ;
F_56 ( V_140 , 8 ) ;
break;
case V_144 :
F_16 ( V_3 , V_145 , V_1 , V_5 , 4 , V_29 ) ;
F_16 ( V_3 , V_146 , V_1 , V_5 + 4 , 4 , V_29 ) ;
break;
case V_147 :
V_5 = F_41 ( V_1 , V_5 , V_2 , V_3 , L_21 , NULL ) ;
break;
...
{
F_16 ( V_3 , V_148 , V_1 , V_5 , 8 , V_29 ) ;
V_5 += 8 ;
F_16 ( V_3 , V_149 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_150 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_151 , V_1 , V_5 , 8 , V_29 ) ;
V_5 += 8 ;
F_16 ( V_3 , V_152 , V_1 , V_5 , 8 , V_29 ) ;
V_5 += 8 ;
F_16 ( V_3 , V_153 , V_1 , V_5 , 8 , V_29 ) ;
V_5 += 8 ;
F_16 ( V_3 , V_154 , V_1 , V_5 , 8 , V_29 ) ;
V_5 += 8 ;
F_16 ( V_3 , V_155 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_156 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_157 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_158 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_159 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_5 += 4 ;
F_16 ( V_3 , V_160 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_161 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
return V_5 ;
}
static int
...
F_16 ( V_3 , V_162 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_163 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_5 = F_48 ( V_1 , V_3 , V_5 ) ;
F_16 ( V_3 , V_164 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_5 += 4 ;
F_60 ( V_1 , V_3 , V_5 ) ;
V_5 = F_62 ( V_1 ) - 16 ;
...
V_5 = F_41 ( V_1 , V_5 , V_2 , V_3 , L_21 , NULL ) ;
V_5 = F_57 ( V_1 , V_3 , V_5 ) ;
F_16 ( V_3 , V_176 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_177 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
return V_5 ;
}
static int
...
int V_5 , T_2 * V_2 V_4 )
{
F_16 ( V_3 , V_179 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_180 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
return V_5 ;
}
static int
...
F_16 ( V_3 , V_187 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_188 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
return V_5 ;
}
static int
...
if ( V_3 )
{
V_117 = F_14 ( V_3 , V_1 , V_5 , 4 ,
L_28 , V_217 ) ;
if ( V_117 )
V_118 = F_15 ( V_117 , V_219 ) ;
}
V_5 += 4 ;
...
V_5 += 4 ;
V_5 += 4 ;
F_16 ( V_3 , V_221 , V_1 , V_5 , 8 , V_29 ) ;
V_5 += 8 ;
V_5 += 4 ;
V_220 = F_4 ( V_1 , V_5 ) ;
F_16 ( V_3 , V_222 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
...
V_225 = F_4 ( V_1 , V_5 ) ;
F_16 ( V_3 , V_233 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_224 = F_4 ( V_1 , V_5 ) ;
F_16 ( V_3 , V_234 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
...
if ( V_3 )
{
V_255 = F_14 ( V_3 , V_1 , V_5 , 48 ,
L_31 , V_254 ) ;
if ( V_255 )
V_256 = F_15 ( V_255 ,
V_257 ) ;
}
F_16 ( V_256 , V_258 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_256 , V_259 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
...
{
T_5 V_181 , V_33 ;
F_16 ( V_3 , V_270 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_181 = F_4 ( V_1 , V_5 ) ;
F_16 ( V_3 , V_271 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
for ( V_33 = 0 ; V_33 < V_181 ; V_33 ++ )
V_5 = F_41 ( V_1 , V_5 , V_2 , V_3 , L_21 , NULL ) ;
return V_5 ;
...
V_5 += 4 ;
V_274 = F_4 ( V_1 , V_5 ) ;
F_16 ( V_3 , V_277 , V_1 , V_5 , 4 , V_29 ) ;
if ( ( V_274 > 0 ) && ( V_3 ) )
{
V_275 = F_14 ( V_3 , V_1 , V_5 ,
V_274 * 40 , L_32 ,
V_274 ) ;
if ( V_275 )
V_276 = F_15 ( V_275 ,
...
int V_5 )
{
F_16 ( V_3 , V_279 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_280 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_281 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_5 = F_46 ( V_1 , V_3 , V_5 , V_282 ,
NULL ) ;
F_16 ( V_3 , V_283 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_284 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
F_16 ( V_3 , V_285 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_5 += 4 ;
return V_5 ;
}
...
T_5 V_189 ;
T_16 * V_77 = NULL ;
F_121 ( V_2 -> V_19 , V_303 , L_33 ) ;
F_122 ( V_2 -> V_19 , V_20 ) ;
if ( V_22 )
{
V_23 = F_16 ( V_22 , V_304 , V_1 , 0 , - 1 , V_305 ) ;
if ( V_23 )
V_301 = F_15 ( V_23 , V_306 ) ;
}
F_14 ( V_301 , V_1 , 0 , - 1 , L_34 ) ;
V_300 = F_14 ( V_301 , V_1 , 0 , V_307 ,
L_35 ) ;
if ( V_300 )
V_302 = F_15 ( V_300 , V_308 ) ;
F_16 ( V_302 , V_309 , V_1 , V_5 , 4 , V_29 ) ;
V_5 += 4 ;
V_8 = F_4 ( V_1 , V_5 ) ;
...
{
F_121 ( V_2 -> V_19 , V_20 , L_36 ) ;
F_14 ( V_301 , V_1 , V_5 , - 1 , L_37 ) ;
return TRUE ;
}
V_5 = F_88 ( V_1 , V_302 , V_5 ) ;
F_124 ( V_2 -> V_19 , V_20 ,
F_11 ( V_189 , V_317 , L_38 ) ) ;
F_125 ( V_2 -> V_19 , V_20 ,
( V_8 == V_12 ) ? L_39 : L_40 ) ;
if ( V_8 == V_12 )
{
...
F_127 ( V_325 ) , 0 , NULL , V_321 } } ,
{ & V_188 ,
{ L_55 , L_56 , V_319 , V_322 ,
F_127 ( V_317 ) , 0 , NULL , V_321 } } ,
#if 0
{ &hf_pvfs_handle,
...
F_127 ( V_326 ) , 0 , L_64 , V_321 } } ,
{ & V_41 ,
{ L_65 , L_66 , V_319 , V_320 ,
F_127 ( V_327 ) , 0 , L_67 , V_321 } } ,
{ & V_18 ,
{ L_68 , L_69 , V_319 , V_320 ,
F_127 ( V_21 ) , 0 , NULL , V_321 } } ,
{ & V_121 ,
...
F_127 ( V_332 ) , 0 , NULL , V_321 } } ,
{ & V_138 ,
{ L_125 , L_126 , V_319 , V_322 ,
F_127 ( V_333 ) , 0 , NULL , V_321 } } ,
{ & V_141 ,
{ L_127 , L_128 , V_319 , V_322 ,
F_127 ( V_334 ) , 0 , NULL , V_321 } } ,
{ & V_243 ,
...
V_304 = F_128 ( L_271 ,
L_33 , L_272 ) ;
F_129 ( V_304 , V_318 , F_130 ( V_318 ) ) ;
F_131 ( V_338 , F_130 ( V_338 ) ) ;
F_132 ( F_115 ) ;
V_339 = F_133 ( V_304 , NULL ) ;
F_134 ( V_339 , L_273 ,
L_274 ,
L_275
L_276 ,
...
{
T_20 V_340 ;
V_340 = F_136 ( F_5 , V_304 ) ;
F_137 ( L_277 , V_341 , V_340 ) ;
F_138 ( L_278 , F_5 , V_304 ) ;
}
