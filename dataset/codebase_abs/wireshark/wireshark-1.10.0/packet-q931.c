...
F_36 ( F_37 ( V_4 ) , L_120 , F_22 ( V_1 , V_2 , V_3 ) ) ;
if ( V_116 == 1 ) {
if ( V_115 . V_125 != V_126 ) {
V_115 . V_127 = F_15 ( V_1 , V_2 , V_3 ) ;
V_115 . V_128 = V_3 ;
F_38 ( V_1 , V_4 , V_2 , V_3 , V_115 ) ;
}
}
...
void
F_42 ( T_1 * V_1 , T_11 * V_147 , int V_2 , int V_3 ,
T_2 * V_4 )
{
T_3 V_12 ;
T_1 * V_148 = NULL ;
...
switch ( V_12 ) {
case V_150 :
V_148 = F_43 ( V_1 , V_2 , V_3 , V_3 ) ;
F_2 ( V_4 , V_1 , V_2 , V_3 , L_128 , V_3 ) ;
if ( ! F_44 ( V_151 , V_148 , V_147 , V_4 , NULL ) ) {
F_45 ( V_152 , V_148 , V_147 , V_4 , NULL ) ;
}
break;
case V_153 :
...
static void
F_47 ( T_1 * V_1 , int V_2 , int V_3 , T_2 * V_4 ,
const char * V_106 )
{
if ( V_3 != 0 ) {
F_2 ( V_4 , V_1 , V_2 , V_3 , L_131 , V_106 ,
F_22 ( V_1 , V_2 , V_3 ) ) ;
F_36 ( F_37 ( V_4 ) , L_132 , F_22 ( V_1 , V_2 , V_3 ) ) ;
}
}
static void
F_48 ( T_1 * V_1 , T_11 * V_147 , T_2 * V_4 ,
T_6 V_155 )
{
int V_2 = 0 ;
T_2 * V_156 = NULL ;
...
F_50 ( V_59 ) ;
V_58 = TRUE ;
F_51 ( V_147 -> V_171 , V_172 , L_133 ) ;
V_48 = F_3 ( V_1 , V_2 ) ;
if ( V_4 ) {
V_158 = F_4 ( V_4 , V_173 , V_1 , V_2 , - 1 ,
V_124 ) ;
V_156 = F_52 ( V_158 , V_174 ) ;
F_5 ( V_1 , V_2 , V_156 ) ;
}
V_2 += 1 ;
...
case 2 : V_162 = F_53 ( V_1 , V_2 ) ; break;
case 3 : V_162 = F_54 ( V_1 , V_2 ) ; break;
default: V_162 = F_55 ( V_1 , V_2 ) ;
}
if ( V_160 != 0 ) {
F_56 ( V_1 , V_161 , V_2 , V_160 ) ;
if ( V_156 != NULL ) {
F_9 ( V_156 , V_176 ,
...
F_12 ( V_164 , V_185 [ 0 ] , L_134 ) ) ;
V_157 = F_52 ( V_159 , V_186 ) ;
F_2 ( V_157 , V_1 , V_2 , 1 , L_75 ,
F_12 ( V_164 , V_185 [ 0 ] , L_20 ) ) ;
F_2 ( V_157 , V_1 , V_2 + 1 , 1 , L_135 , V_165 ) ;
F_1 ( V_1 , V_2 + 2 , V_165 , V_157 ) ;
V_166 = ( F_3 ( V_1 , V_2 + 2 ) & 0x80 ) != 0 ;
V_167 = ( F_3 ( V_1 , V_2 + 2 ) & 0x7F ) != 0 ;
V_163 = F_3 ( V_1 , V_2 + 3 ) ;
if ( F_58 ( V_147 -> V_171 , V_179 ) ) {
F_62 ( V_147 -> V_171 , V_179 , L_136 ,
F_11 ( V_163 , & V_51 , L_137 ) ) ;
}
V_2 += 1 + 1 + V_165 ;
V_168 = F_60 ( V_1 , V_2 ) ;
...
if ( V_169 -> V_191 != NULL ) {
V_148 = F_66 ( V_1 , V_169 -> V_192 , V_169 -> V_3 , V_169 -> V_3 ) ;
F_67 ( V_147 , V_148 , L_138 ) ;
if ( V_4 ) {
T_12 * V_193 ;
...
F_2 ( V_156 , V_1 , V_2 , F_60 ( V_1 , V_2 ) , L_147 ) ;
break;
}
if ( F_71 ( V_210 , V_199 ) ||
F_71 ( V_211 , ( V_199 << 8 ) | V_164 ) ) {
V_148 = F_43 ( V_1 , V_2 , V_165 + 2 , V_165 + 2 ) ;
...
F_12 ( V_164 , V_185 [ V_199 ] , L_134 ) ) ;
V_157 = F_52 ( V_158 , V_186 ) ;
F_2 ( V_157 , V_1 , V_2 , 1 , L_75 ,
...
if ( F_58 ( V_147 -> V_171 , V_179 ) ) {
F_62 ( V_147 -> V_171 , V_179 , L_136 ,
F_11 ( F_3 ( V_1 , V_2 + 3 ) , & V_51 , L_137 ) ) ;
}
if ( F_3 ( V_1 , V_2 + 2 ) & 0x80 ) {
V_202 = TRUE ;
} else {
F_2 ( V_156 , V_1 , V_2 + 4 , F_60 ( V_1 , V_2 + 4 ) , L_148 ) ;
...
static T_6
F_78 ( T_1 * V_1 , T_11 * V_147 , T_2 * V_4 , void * V_192 V_78 )
{
int V_265 ;
V_265 = F_79 ( V_1 , 3 ) ;
if ( V_265 == - 1 ) {
...
{
F_48 ( V_1 , V_147 , V_4 , TRUE ) ;
}
static void
F_84 ( T_1 * V_1 , T_11 * V_147 , T_2 * V_4 )
{
F_48 ( V_1 , V_147 , V_4 , FALSE ) ;
}
static void
...
static T_14 V_269 [] = {
{ & V_9 ,
{ L_152 , L_153 , V_270 , V_271 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_175 ,
{ L_154 , L_155 , V_270 , V_273 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_176 ,
{ L_156 , L_157 , V_274 , V_275 , F_91 ( & V_276 ) , 0x0 ,
NULL , V_272 } } ,
{ & V_177 ,
{ L_158 , L_159 , V_277 , V_275 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_181 ,
{ L_160 , L_161 , V_270 , V_271 | V_278 , & V_51 , 0x0 ,
NULL , V_272 } } ,
{ & V_180 ,
{ L_162 , L_163 , V_270 , V_271 , F_92 ( V_50 ) , 0x0 ,
NULL , V_272 } } ,
{ & V_5 ,
{ L_164 , L_165 , V_270 , V_271 | V_278 , & V_51 , 0x0 ,
NULL , V_272 } } ,
{ & V_21 ,
{ L_166 , L_167 , V_270 , V_271 ,
...
{ & V_28 ,
{ L_186 , L_187 , V_270 , V_271 | V_278 ,
& V_289 , 0x1f , NULL , V_272 } } ,
{ & V_56 ,
{ L_188 , L_189 , V_270 , V_273 | V_278 , & V_98 , 0x0f ,
NULL , V_272 } } ,
{ & V_228 ,
{ L_190 , L_191 , V_270 , V_273 | V_278 , & V_290 , 0x7f ,
NULL , V_272 } } ,
{ & V_119 ,
{ L_192 , L_193 , V_270 , V_271 , F_92 ( V_291 ) , 0x70 ,
NULL , V_272 } } ,
{ & V_118 ,
{ L_194 , L_195 , V_270 , V_271 , F_92 ( V_292 ) , 0x0f ,
NULL , V_272 } } ,
{ & V_120 ,
{ L_196 , L_197 , V_270 , V_271 , F_92 ( V_293 ) , 0x03 ,
NULL , V_272 } } ,
{ & V_121 ,
{ L_198 , L_199 , V_270 , V_271 , F_92 ( V_294 ) , 0x60 ,
NULL , V_272 } } ,
{ & V_20 ,
{ L_200 , L_201 ,
...
NULL , V_272 } } ,
{ & V_252 ,
{ L_206 , L_207 , V_298 , V_275 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_254 ,
{ L_208 , L_209 , V_298 , V_275 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_250 ,
{ L_210 , L_211 , V_298 , V_275 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_258 ,
{ L_212 , L_213 , V_298 , V_275 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_82 ,
{ L_214 , L_215 , V_274 , 8 , NULL , 0x40 ,
L_216 , V_272 } } ,
{ & V_83 ,
{ L_217 , L_218 , V_274 , 8 , F_91 ( & V_299 ) , 0x20 ,
L_219 , V_272 } } ,
{ & V_84 ,
{ L_220 , L_221 , V_274 , 8 , F_91 ( & V_300 ) , 0x08 ,
L_222 , V_272 } } ,
{ & V_85 ,
{ L_223 , L_224 , V_274 , 8 , NULL , 0x04 ,
L_225 , V_272 } } ,
{ & V_88 ,
{ L_226 , L_227 , V_270 , V_271 , V_301 , 0x03 ,
L_228 , V_272 } } ,
{ & V_87 ,
{ L_226 , L_227 , V_270 , V_271 , V_302 , 0x03 ,
L_228 , V_272 } } ,
{ & V_94 ,
{ L_229 , L_230 , V_274 , 8 , F_91 ( & V_303 ) , 0x10 ,
L_231 , V_272 } } ,
{ & V_95 ,
{ L_232 , L_233 , V_270 , V_271 , V_304 , 0xF ,
L_234 , V_272 } } ,
{ & V_97 ,
{ L_235 , L_236 , V_270 , V_273 , NULL , 0x7F ,
NULL , V_272 } } ,
{ & V_305 ,
{ L_237 , L_238 , V_274 , V_275 , NULL , 0x0 ,
L_239 , V_272 } } ,
{ & V_306 ,
{ L_240 , L_241 , V_274 , V_275 , NULL , 0x0 ,
L_242 , V_272 } } ,
{ & V_307 ,
{ L_243 , L_244 , V_274 , V_275 , NULL , 0x0 ,
L_245 , V_272 } } ,
{ & V_308 ,
{ L_246 , L_247 , V_274 , V_275 , NULL , 0x0 ,
L_248 , V_272 } } ,
{ & V_309 ,
{ L_249 , L_250 , V_310 , V_275 , NULL , 0x0 ,
L_251 , V_272 } } ,
{ & V_311 ,
{ L_252 , L_253 , V_312 , V_273 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_313 ,
{ L_254 , L_255 , V_310 , V_275 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_314 ,
{ L_256 , L_257 , V_315 , V_275 , NULL , 0x0 ,
NULL , V_272 } } ,
{ & V_195 ,
{ L_258 , L_259 , V_310 , V_275 , NULL , 0x0 ,
L_260 , V_272 } } ,
{ & V_316 ,
{ L_261 , L_262 , V_312 , V_273 , NULL , 0x0 ,
L_263 , V_272 } } ,
} ;
static T_10 * V_317 [] = {
& V_174 ,
...
T_15 * V_320 ;
V_173 = F_93 ( L_133 , L_133 , L_264 ) ;
F_94 ( V_173 , V_269 , F_95 ( V_269 ) ) ;
F_96 ( V_317 , F_95 ( V_317 ) ) ;
F_97 ( F_88 ) ;
F_98 ( L_264 , F_84 , V_173 ) ;
F_98 ( L_265 , F_82 , V_173 ) ;
V_321 = F_99 ( L_265 ) ;
V_267 = F_100 ( F_83 ,
V_173 ) ;
F_98 ( L_266 , F_85 , V_173 ) ;
F_98 ( L_267 , F_86 , V_173 ) ;
F_98 ( L_268 , F_87 , V_173 ) ;
V_210 = F_101 ( L_269 , L_270 , V_270 , V_271 ) ;
V_211 = F_101 ( L_267 , L_271 , V_322 , V_271 ) ;
F_102 ( L_272 , & V_151 ) ;
...
T_16 V_324 ;
V_323 = F_99 ( L_264 ) ;
F_107 ( L_280 , V_325 , V_323 ) ;
V_324 = F_99 ( L_266 ) ;
F_107 ( L_281 , V_326 , V_324 ) ;
V_224 = F_99 ( L_282 ) ;
V_152 = F_99 ( L_283 ) ;
F_108 ( L_284 , F_78 , V_173 ) ;
}
static void F_50 ( V_170 * V_327 )
{
if( V_327 == NULL ) {
return;
}
