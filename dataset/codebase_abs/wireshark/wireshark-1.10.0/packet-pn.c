...
T_5 * V_4 , T_8 V_10 , int V_15 )
{
if ( V_4 ) {
if( V_15 == V_16 )
F_25 ( V_4 , V_17 , V_1 , V_2 , V_10 , F_26 ( V_1 , V_2 , V_10 ) ) ;
else
F_25 ( V_4 , V_18 , V_1 , V_2 , V_10 , F_26 ( V_1 , V_2 , V_10 ) ) ;
}
return V_2 + V_10 ;
}
int
F_27 ( T_1 * V_1 , int V_2 , T_3 * T_4 V_3 ,
T_5 * V_4 , T_8 V_10 , const char * V_19 )
{
if ( V_4 ) {
F_22 ( V_4 , V_20 , V_1 , V_2 , V_10 , L_1 ,
L_4 , V_19 , V_10 ) ;
}
return V_2 + V_10 ;
}
...
T_5 * V_4 , T_8 V_10 )
{
F_29 ( V_4 , V_21 , V_1 , 0 , 10000 , V_22 ) ;
return V_2 + V_10 ;
}
int
...
T_5 * V_4 , int V_10 )
{
F_22 ( V_4 , V_23 , V_1 , V_2 , V_10 , L_1 ,
L_5 , V_10 ) ;
return V_2 + V_10 ;
}
int
...
if ( V_2 % 4 ) {
V_24 = 4 - ( V_2 % 4 ) ;
F_22 ( V_4 , V_23 , V_1 , V_2 , V_24 , L_1 ,
L_5 , V_24 ) ;
}
return V_2 + V_24 ;
}
void
F_32 ( T_3 * T_4 , T_12 * V_25 , const char * V_19 )
{
F_33 ( T_4 -> V_26 , V_27 , V_19 ) ;
F_34 ( V_25 , L_6 , V_19 ) ;
}
void
F_35 ( int V_28 )
