...
int V_11 ;
V_11 = F_12 ( V_1 , V_2 ) ;
V_21 = F_15 ( V_1 , V_2 , V_11 , TRUE ) ;
F_16 ( V_4 , V_22 , V_1 , V_2 , V_11 * 2 , V_21 , L_2 , V_21 ) ;
V_2 += V_11 * 2 ;
return V_2 ;
}
static int
F_17 ( T_1 * V_1 , int V_2 , T_2 * V_3 V_7 , T_3 * V_4 , T_4 * V_5 V_7 )
{
char * V_21 ;
int V_11 ;
V_11 = F_12 ( V_1 , V_2 ) ;
V_21 = F_15 ( V_1 , V_2 , V_11 , TRUE ) ;
F_16 ( V_4 , V_23 , V_1 , V_2 , V_11 * 2 , V_21 , L_3 , V_21 ) ;
V_2 += V_11 * 2 ;
return V_2 ;
}
static int
...
{
V_24 = 0 ;
V_2 = F_19 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_25 , & V_24 ) ;
return V_2 ;
}
static int
...
static int
F_21 ( T_1 * V_1 , int V_2 , T_2 * V_3 V_7 , T_3 * V_4 , T_4 * V_5 V_7 )
{
while( V_26 && V_24 ) {
char * V_21 ;
int V_11 ;
V_11 = F_12 ( V_1 , V_26 ) ;
V_21 = F_15 ( V_1 , V_26 , V_11 , TRUE ) ;
F_16 ( V_4 , V_28 , V_1 , V_26 , V_11 * 2 , V_21 , L_4 , V_21 ) ;
V_26 += V_11 * 2 ;
V_24 -- ;
}
return V_2 ;
...
int
F_22 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * T_8 V_7 , T_4 * V_5 V_7 , int V_6 V_7 , T_7 T_9 V_7 )
{
T_10 * V_29 = NULL ;
T_3 * V_4 = NULL ;
T_7 V_30 ;
V_31 ;
if ( T_8 ) {
V_29 = F_23 ( T_8 , V_6 , V_1 , V_2 , 4 , TRUE ) ;
V_4 = F_24 ( V_29 , V_32 ) ;
}
...
if ( ! V_30 )
F_25 ( V_29 , L_6 ) ;
F_26 ( V_4 , V_33 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0001 ) ) {
F_25 ( V_29 , L_7 ) ;
if ( V_30 & ( ~ ( 0x0001 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0001 ) ) ;
F_26 ( V_4 , V_34 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0002 ) ) {
F_25 ( V_29 , L_9 ) ;
if ( V_30 & ( ~ ( 0x0002 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0002 ) ) ;
F_26 ( V_4 , V_35 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0004 ) ) {
F_25 ( V_29 , L_10 ) ;
if ( V_30 & ( ~ ( 0x0004 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0004 ) ) ;
F_26 ( V_4 , V_36 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0008 ) ) {
F_25 ( V_29 , L_11 ) ;
if ( V_30 & ( ~ ( 0x0008 ) ) )
F_25 ( V_29 , L_8 ) ;
...
int
F_27 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * T_8 V_7 , T_4 * V_5 V_7 , int V_6 V_7 , T_7 T_9 V_7 )
{
T_10 * V_29 = NULL ;
T_3 * V_4 = NULL ;
T_7 V_30 ;
...
if ( ! V_30 )
F_25 ( V_29 , L_6 ) ;
F_26 ( V_4 , V_38 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0000 ) ) {
F_25 ( V_29 , L_13 ) ;
if ( V_30 & ( ~ ( 0x0000 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0000 ) ) ;
F_26 ( V_4 , V_39 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0001 ) ) {
F_25 ( V_29 , L_14 ) ;
if ( V_30 & ( ~ ( 0x0001 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0001 ) ) ;
F_26 ( V_4 , V_40 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0002 ) ) {
F_25 ( V_29 , L_15 ) ;
if ( V_30 & ( ~ ( 0x0002 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0002 ) ) ;
F_26 ( V_4 , V_41 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0004 ) ) {
F_25 ( V_29 , L_16 ) ;
if ( V_30 & ( ~ ( 0x0004 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0004 ) ) ;
F_26 ( V_4 , V_42 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0008 ) ) {
F_25 ( V_29 , L_17 ) ;
if ( V_30 & ( ~ ( 0x0008 ) ) )
F_25 ( V_29 , L_8 ) ;
...
V_30 &= ( ~ ( 0x0008 ) ) ;
F_26 ( V_4 , V_43 , V_1 , V_2 - 4 , 4 , V_30 ) ;
if ( V_30 & ( 0x0010 ) ) {
F_25 ( V_29 , L_18 ) ;
if ( V_30 & ( ~ ( 0x0010 ) ) )
F_25 ( V_29 , L_8 ) ;
...
static int
F_28 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_29 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_44 , 0 ) ;
return V_2 ;
}
static int
F_30 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_29 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_45 , 0 ) ;
return V_2 ;
}
int
F_31 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * T_8 V_7 , T_4 * V_5 V_7 , int V_6 V_7 , T_7 T_9 V_7 )
{
T_10 * V_29 = NULL ;
T_3 * V_4 = NULL ;
int V_46 ;
...
V_46 = V_2 ;
if ( T_8 ) {
V_29 = F_23 ( T_8 , V_6 , V_1 , V_2 , - 1 , TRUE ) ;
V_4 = F_24 ( V_29 , V_48 ) ;
}
...
{
V_2 = F_34 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_62 , 0 ) ;
return V_2 ;
}
static int
F_49 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_34 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_63 , 0 ) ;
return V_2 ;
}
int
F_50 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * T_8 V_7 , T_4 * V_5 V_7 , int V_6 V_7 , T_7 T_9 V_7 )
{
T_10 * V_29 = NULL ;
T_3 * V_4 = NULL ;
int V_46 ;
...
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_65 , V_66 , L_19 , V_67 ) ;
return V_2 ;
}
static int
V_65 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_53 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_67 , 0 ) ;
return V_2 ;
}
static int
F_54 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_68 , V_69 , L_20 , V_70 ) ;
return V_2 ;
}
static int
...
T_7 V_71 ;
V_3 -> V_72 = L_21 ;
V_2 = F_56 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_73 , & V_71 ) ;
if ( V_71 != 0 && F_57 ( V_3 -> V_74 , V_75 ) )
F_58 ( V_3 -> V_74 , V_75 , L_22 , F_59 ( V_71 , V_76 , L_23 ) ) ;
return V_2 ;
}
static int
...
V_2 = F_61 ( V_3 , V_1 , V_2 , V_5 ) ;
V_2 = F_54 ( V_1 , V_2 , V_3 , V_4 , V_5 ) ;
V_2 = F_61 ( V_3 , V_1 , V_2 , V_5 ) ;
return V_2 ;
}
static int
F_62 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_77 , V_66 , L_19 , V_78 ) ;
return V_2 ;
}
static int
V_77 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_53 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_78 , 0 ) ;
return V_2 ;
}
static int
F_63 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_79 , V_69 , L_20 , V_80 ) ;
return V_2 ;
}
static int
...
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_81 , V_66 , L_19 , V_82 ) ;
return V_2 ;
}
static int
V_81 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_53 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_82 , V_83 ) ;
return V_2 ;
}
static int
...
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_84 , V_66 , L_19 , V_85 ) ;
return V_2 ;
}
static int
V_84 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_53 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_85 , 0 ) ;
return V_2 ;
}
static int
...
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_99 , V_69 , L_33 , V_100 ) ;
return V_2 ;
}
static int
V_99 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_31 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_100 , 0 ) ;
return V_2 ;
}
static int
...
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_108 , V_69 , L_33 , V_109 ) ;
return V_2 ;
}
static int
V_108 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_31 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_109 , 0 ) ;
return V_2 ;
}
static int
...
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_116 , V_69 , L_33 , V_117 ) ;
return V_2 ;
}
static int
V_116 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_31 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_117 , 0 ) ;
return V_2 ;
}
static int
...
{
V_2 = F_52 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_150 , V_66 , L_19 , V_151 ) ;
return V_2 ;
}
static int
V_150 ( T_1 * V_1 V_7 , int V_2 V_7 , T_2 * V_3 V_7 , T_3 * V_4 V_7 , T_4 * V_5 V_7 )
{
V_2 = F_53 ( V_1 , V_2 , V_3 , V_4 , V_5 , V_151 , 0 ) ;
return V_2 ;
}
static int
...
{ & V_40 ,
{ L_65 , L_66 , V_161 , 32 , F_161 ( & V_162 ) , ( 0x0002 ) , NULL , V_155 } } ,
{ & V_39 ,
{ L_67 , L_68 , V_161 , 32 , F_161 ( & V_163 ) , ( 0x0001 ) , NULL , V_155 } } ,
{ & V_119 ,
...
{ & V_43 ,
{ L_75 , L_76 , V_161 , 32 , F_161 ( & V_164 ) , ( 0x0010 ) , NULL , V_155 } } ,
{ & V_97 ,
...
{ & V_34 ,
{ L_108 , L_109 , V_161 , 32 , F_161 ( & V_168 ) , ( 0x0002 ) , NULL , V_155 } } ,
{ & V_104 ,
...
{ & V_33 ,
{ L_138 , L_139 , V_161 , 32 , F_161 ( & V_172 ) , ( 0x0001 ) , NULL , V_155 } } ,
{ & V_50 ,
...
{ & V_35 ,
{ L_187 , L_188 , V_161 , 32 , F_161 ( & V_177 ) , ( 0x0004 ) , NULL , V_155 } } ,
{ & V_73 ,
{ L_189 , L_190 , V_153 , V_178 , F_162 ( V_76 ) , 0 , NULL , V_155 } } ,
{ & V_127 ,
...
{ & V_38 ,
{ L_206 , L_207 , V_161 , 32 , F_161 ( & V_179 ) , ( 0x0000 ) , NULL , V_155 } } ,
} ;
static V_14 * V_180 [] = {
& V_181 ,
& V_32 ,
...
V_182 = F_163 ( L_208 , L_209 , L_210 ) ;
F_164 ( V_182 , V_152 , F_165 ( V_152 ) ) ;
F_166 ( V_180 , F_165 ( V_180 ) ) ;
}
void F_167 ( void )
{
F_168 ( V_182 , V_181 ,
