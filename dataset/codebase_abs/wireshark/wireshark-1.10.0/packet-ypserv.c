...
if( V_6 < 0 ) {
V_7 = F_4 ( V_6 , V_9 , L_1 ) ;
if ( F_5 ( T_3 -> V_10 , V_11 ) ) {
F_6 ( T_3 -> V_10 , V_11 , L_2 , V_7 ) ;
}
F_7 ( V_4 , L_3 , V_7 ) ;
}
return V_2 ;
...
const char * V_14 ;
F_7 ( V_4 , L_9 ) ;
V_2 = F_9 ( V_1 , V_4 , V_12 , V_2 , & V_14 ) ;
if ( F_5 ( T_3 -> V_10 , V_11 ) ) {
F_6 ( T_3 -> V_10 , V_11 , L_10 , V_14 ) ;
}
F_7 ( V_4 , L_10 , V_14 ) ;
V_2 = F_9 ( V_1 , V_4 , V_15 , V_2 , & V_14 ) ;
if ( F_5 ( T_3 -> V_10 , V_11 ) ) {
F_6 ( T_3 -> V_10 , V_11 , L_11 , V_14 ) ;
}
F_7 ( V_4 , L_11 , V_14 ) ;
V_2 = F_9 ( V_1 , V_4 , V_16 , V_2 , & V_14 ) ;
if ( F_5 ( T_3 -> V_10 , V_11 ) ) {
F_6 ( T_3 -> V_10 , V_11 , L_12 , V_14 ) ;
}
F_7 ( V_4 , L_12 , V_14 ) ;
return V_2 ;
}
...
if( V_6 >= 0 ) {
V_2 = F_9 ( V_1 , V_4 , V_17 , V_2 , & V_14 ) ;
if ( F_5 ( T_3 -> V_10 , V_11 ) ) {
F_6 ( T_3 -> V_10 , V_11 , L_2 , V_14 ) ;
}
F_7 ( V_4 , L_2 , V_14 ) ;
} else {
...
F_7 ( V_4 , L_18 ) ;
if( V_4 ) {
V_18 = F_22 ( V_4 , V_21 , V_1 ,
V_2 , - 1 , V_22 ) ;
if( V_18 )
V_19 = F_23 ( V_18 , V_23 ) ;
}
V_2 = F_9 ( V_1 , V_19 , V_12 , V_2 , NULL ) ;
V_2 = F_9 ( V_1 , V_19 , V_15 , V_2 , NULL ) ;
V_2 = F_3 ( V_1 , V_19 , V_24 , V_2 ) ;
V_2 = F_9 ( V_1 , V_19 , V_25 , V_2 , NULL ) ;
F_22 ( V_4 , V_26 , V_1 , V_2 , 4 , V_27 ) ;
V_2 += 4 ;
...
static int
F_26 ( T_1 * V_1 V_3 , int V_2 , T_2 * T_3 V_3 , T_4 * V_4 )
{
F_7 ( V_4 , L_20 ) ;
return V_2 ;
}
...
{ & V_35 , {
L_30 , L_31 , V_36 , V_37 ,
F_37 ( V_38 ) , 0 , NULL , V_39 } } ,
{ & V_40 , {
L_32 , L_33 , V_36 , V_37 ,
F_37 ( V_41 ) , 0 , NULL , V_39 } } ,
{ & V_12 , {
L_34 , L_35 , V_42 , V_43 ,
NULL , 0 , NULL , V_39 } } ,
{ & V_13 , {
L_36 , L_37 , V_44 , V_43 ,
F_38 ( & V_45 ) , 0x0 , NULL , V_39 } } ,
{ & V_15 , {
L_38 , L_39 , V_42 , V_43 ,
NULL , 0 , NULL , V_39 } } ,
{ & V_25 , {
...
{ & V_8 , {
L_60 , L_61 , V_47 , V_37 ,
F_37 ( V_9 ) , 0 , NULL , V_39 } } ,
{ & V_21 , {
L_62 , L_63 , V_48 , V_43 ,
NULL , 0 , NULL , V_39 } } ,
{ & V_30 , {
L_64 , L_65 , V_47 , V_37 ,
F_37 ( V_49 ) , 0 , NULL , V_39 } } ,
} ;
static T_9 * V_50 [] = {
& V_51 ,
& V_23 ,
