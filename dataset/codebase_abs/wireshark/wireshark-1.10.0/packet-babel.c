...
static int
F_8 ( T_2 * V_14 , T_3 * V_15 , T_4 * V_16 , void * T_5 V_17 )
{
T_6 * V_18 ;
...
return 0 ;
V_23 = F_10 ( V_14 , 1 ) ;
F_11 ( V_15 -> V_25 , V_26 , L_3 ) ;
F_11 ( V_15 -> V_25 , V_27 , L_3 ) ;
if ( V_23 != 2 ) {
F_12 ( V_15 -> V_25 , V_27 , L_4 , V_23 ) ;
return 2 ;
}
if ( V_16 ) {
V_18 = F_13 ( V_16 , V_28 , V_14 , 0 , - 1 , V_29 ) ;
V_22 = F_14 ( V_18 , V_30 ) ;
F_13 ( V_22 , V_31 , V_14 , 0 , 1 , V_29 ) ;
F_13 ( V_22 , V_32 , V_14 , 1 , 1 , V_29 ) ;
F_13 ( V_22 , V_33 ,
V_14 , 2 , 2 , V_34 ) ;
}
V_24 = F_15 ( V_14 , 2 ) ;
...
V_9 = F_10 ( V_14 , V_37 + 1 ) ;
V_35 = V_9 + 2 ;
}
F_16 ( V_15 -> V_25 , V_27 , L_5 ,
F_17 ( type , V_39 , L_6 ) ) ;
V_18 = F_18 ( V_22 , V_40 ,
V_14 , V_37 , V_35 , type ,
L_7 ,
...
int V_54 =
F_7 ( F_10 ( V_14 , V_37 + 2 ) ,
F_19 ( V_14 , V_37 + 8 , V_9 - 6 ) ,
V_9 - 6 ,
V_53 ) ;
F_13 ( V_36 , V_55 ,
V_14 , V_37 + 4 , 2 , V_34 ) ;
...
T_7 V_5 = F_10 ( V_14 , V_37 + 2 ) ;
T_7 V_64 = F_10 ( V_14 , V_37 + 3 ) ;
T_7 V_4 = F_10 ( V_14 , V_37 + 4 ) ;
int V_54 =
F_6 ( V_5 , V_4 ,
F_10 ( V_14 , V_37 + 5 ) ,
F_19 ( V_14 , V_37 + 12 , V_9 - 10 ) ,
V_5 == 1 ? V_19 : V_20 ,
V_9 - 10 , V_7 ) ;
if ( V_54 >= 0 && ( V_64 & 0x80 ) ) {
if ( V_5 == 1 )
...
T_4 * V_52 ;
unsigned char V_7 [ 16 ] ;
T_7 V_4 = F_10 ( V_14 , V_37 + 3 ) ;
int V_54 =
F_6 ( F_10 ( V_14 , V_37 + 2 ) , V_4 ,
0 ,
F_19 ( V_14 , V_37 + 4 , V_9 - 2 ) ,
NULL ,
V_9 - 2 , V_7 ) ;
