...
if ( ! F_17 ( V_26 , V_53 , V_56 , V_2 , V_3 ) )
return - 1 ;
if ( V_1 -> V_24 == V_18 &&
...
if ( F_12 ( V_26 , V_100 , V_102 , V_2 ) == - 1 )
return FALSE ;
V_63 -> V_103 . V_65 = 4 ;
V_63 -> V_103 . V_104 = FALSE ;
V_63 -> V_103 . V_105 = FALSE ;
V_63 -> V_103 . V_106 = V_107 ;
V_63 -> V_103 . V_69 =
V_108 |
V_109 |
V_110 ;
V_63 -> V_103 . V_94 = V_99 . V_94 ;
V_63 -> V_103 . V_111 = V_99 . V_112 ;
V_63 -> V_103 . V_113 = V_99 . signal ;
* V_58 = V_100 + 8 + 4 ;
return TRUE ;
}
int F_21 ( int V_114 )
...
if ( V_114 == V_115 )
return V_116 ;
if ( V_114 < 0 || ( unsigned ) V_114 >= V_117 || V_118 [ V_114 ] == - 1 )
return V_119 ;
return 0 ;
}
T_5 F_22 ( T_12 * V_120 , int * V_2 )
{
struct V_5 V_121 ;
V_120 -> V_122 = V_123 ;
if ( ! F_23 ( V_120 , & F_2 , sizeof F_2 , V_2 ) )
return FALSE ;
V_121 . V_30 = F_24 ( 2 ) ;
V_121 . V_36 = F_24 ( V_118 [ V_120 -> V_114 ] ) ;
if ( ! F_23 ( V_120 , & V_121 , sizeof V_121 , V_2 ) )
return FALSE ;
return TRUE ;
}
static T_5 V_123 ( T_12 * V_120 ,
const struct V_52 * V_49 ,
const T_10 * V_124 , int * V_2 , T_3 * * V_3 V_125 )
{
const union V_81 * V_63 = & V_49 -> V_63 ;
struct V_7 V_8 ;
int V_126 ;
T_4 V_127 ;
static const char V_128 [ 4 ] = { 0 } ;
struct V_62 V_129 ;
int V_130 ;
if ( V_49 -> V_67 != V_68 ) {
* V_2 = V_131 ;
...
if ( V_120 -> V_114 == V_18 )
V_130 = sizeof ( struct V_62 ) ;
else
V_130 = 0 ;
V_126 = ( int ) sizeof V_8 + V_49 -> V_77 + V_130 ;
V_127 = ( ( V_126 + 3 ) & ~ 3 ) - V_126 ;
V_126 += V_127 ;
if ( V_49 -> V_77 + V_130 > V_60 ) {
* V_2 = V_132 ;
return FALSE ;
}
V_8 . V_59 = F_24 ( V_49 -> V_78 + V_130 ) ;
V_8 . V_33 = F_24 ( V_49 -> V_77 + V_130 ) ;
V_8 . V_32 = F_24 ( V_126 ) ;
V_8 . V_133 = 0 ;
V_8 . V_74 = F_24 ( V_49 -> V_72 . V_73 ) ;
V_8 . V_76 = F_24 ( V_49 -> V_72 . V_75 / 1000 ) ;
if ( ! F_23 ( V_120 , & V_8 , sizeof V_8 , V_2 ) )
return FALSE ;
if ( V_120 -> V_114 == V_18 ) {
V_129 . V_85 =
...
V_129 . V_83 = ( T_10 ) V_63 -> V_79 . V_83 ;
V_129 . V_84 = F_25 ( V_63 -> V_79 . V_84 ) ;
if ( ! F_23 ( V_120 , & V_129 , sizeof V_129 , V_2 ) )
return FALSE ;
}
if ( ! F_23 ( V_120 , V_124 , V_49 -> V_77 , V_2 ) )
return FALSE ;
if ( ! F_23 ( V_120 , V_128 , V_127 , V_2 ) )
return FALSE ;
return TRUE ;
}
