...
T_3 = F_11 ( T_2 , T_3 , T_5 , T_7 , T_8 , NULL ) ;
return T_3 ;
}
static int
...
T_4 V_10 ;
int T_3 = 0 ;
static const char * V_11 [] = { L_1 , L_2 , L_3 } ;
if ( ! F_25 ( T_2 , 0 , 4 ) )
return FALSE ;
V_7 = F_26 ( T_2 , 0 ) ;
F_27 ( & V_8 , V_7 ) ;
...
F_31 ( V_6 -> V_12 , V_14 ,
L_5 , F_33 ( & V_8 ) + 1 ) ;
if ( F_34 ( & V_8 ) && F_35 ( & V_8 ) ) {
V_9 = ( int ) ( F_36 ( & V_8 ) - sizeof V_8 ) ;
F_37 ( & V_6 -> V_15 , V_16 , 0 , NULL ) ;
F_31 ( V_6 -> V_12 , V_17 ,
L_6 , F_38 ( & V_8 ) / 1000 ) ;
F_37 ( & V_6 -> V_18 , V_16 , 0 , NULL ) ;
F_31 ( V_6 -> V_12 , V_19 ,
L_7 , F_39 ( & V_8 ) / ( float ) 1000 ) ;
}
if ( T_7 == NULL )
return TRUE ;
F_40 ( & V_10 , V_20 , TRUE , V_6 ) ;
T_3 = F_14 ( T_2 , T_3 , & V_10 ,
T_7 , V_21 ) ;
if ( V_9 > 0 ) {
unsigned int V_22 ;
F_41 ( T_7 , V_23 , T_2 ,
...
static void
F_43 ( T_1 * T_2 , T_10 * V_6 , T_6 * T_7 )
{
T_4 V_10 ;
F_44 ( V_6 -> V_12 , V_13 , L_8 ) ;
F_45 ( V_6 -> V_12 , V_14 ) ;
if ( T_7 == NULL )
return;
F_40 ( & V_10 , V_20 , TRUE , V_6 ) ;
...
static void
F_46 ( T_1 * T_2 , T_10 * V_6 , T_6 * T_7 )
{
F_44 ( V_6 -> V_12 , V_13 , L_9 ) ;
F_45 ( V_6 -> V_12 , V_14 ) ;
F_41 ( T_7 , V_27 , T_2 ,
0 , - 1 , V_24 ) ;
}
static T_9
F_47 ( T_1 * T_2 , T_10 * V_6 , T_6 * T_7 , void * T_12 V_1 )
{
int V_28 ;
if ( ! F_25 ( T_2 , 0 , 3 ) )
return FALSE ;
...
{ & V_34 ,
{ L_13 , L_14 ,
V_35 , V_36 , F_50 ( V_37 ) , 0 ,
NULL , V_33 } } ,
{ & V_38 ,
{ L_15 , L_16 ,
V_35 , V_36 , F_50 ( V_39 ) , 0 ,
NULL , V_33 } } ,
{ & V_40 ,
{ L_17 , L_18 ,
V_35 , V_36 , F_50 ( V_41 ) , 0 ,
NULL , V_33 } } ,
{ & V_42 ,
{ L_19 , L_20 ,
V_35 , V_36 , NULL , 0 ,
...
{ & V_63 ,
{ L_61 , L_62 ,
V_35 , V_36 , F_50 ( V_64 ) , 0 ,
NULL , V_33 } } ,
#line 151 "../../asn1/mpeg-audio/packet-mpeg-audio-template.c"
{ & V_23 ,
{ L_63 , L_64 ,
V_31 , V_32 , NULL , 0 , NULL , V_33 } } ,
{ & V_25 ,
{ L_65 , L_66 ,
V_31 , V_32 , NULL , 0 , NULL , V_33 } } ,
{ & V_26 ,
{ L_8 , L_67 ,
V_65 , V_32 , NULL , 0 , NULL , V_33 } } ,
{ & V_27 ,
{ L_9 , L_68 ,
V_65 , V_32 , NULL , 0 , NULL , V_33 } } ,
} ;
...
V_21 = F_51 (
L_69 , L_70 , L_71 ) ;
F_52 ( V_21 , V_29 , F_53 ( V_29 ) ) ;
F_54 ( V_66 , F_53 ( V_66 ) ) ;
}
void
F_55 ( void )
{
F_56 ( L_72 , F_47 , L_70 , L_73 , V_21 , V_67 ) ;
}
