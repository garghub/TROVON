...
static void
F_18 ( T_1 * V_1 , T_7 T_8 V_6 , int T_9 V_6 , char * V_26 )
{
T_2 V_27 ;
if ( V_1 -> V_2 . V_4 < 0 ) {
* V_26 ++ = '-' ;
...
static void
F_21 ( T_1 * V_1 , T_7 T_8 V_6 , int T_9 , char * V_26 )
{
if ( ( T_9 == V_28 ) || ( T_9 == V_29 ) )
{
* V_26 ++ = '0' ;
* V_26 ++ = 'x' ;
...
static void
F_26 ( T_1 * V_1 , T_7 T_8 V_6 , int T_9 V_6 , char * V_26 )
{
F_21 ( V_1 , T_8 , V_28 , V_26 ) ;
}
static T_4
F_27 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_3 == V_32 -> V_2 . V_3 ;
}
static T_4
F_28 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_3 != V_32 -> V_2 . V_3 ;
}
static T_4
F_29 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_3 > V_32 -> V_2 . V_3 ;
}
static T_4
F_30 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_3 >= V_32 -> V_2 . V_3 ;
}
static T_4
F_31 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_3 < V_32 -> V_2 . V_3 ;
}
static T_4
F_32 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_3 <= V_32 -> V_2 . V_3 ;
}
static T_4
F_33 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_4 > V_32 -> V_2 . V_4 ;
}
static T_4
F_34 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_4 >= V_32 -> V_2 . V_4 ;
}
static T_4
F_35 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_4 < V_32 -> V_2 . V_4 ;
}
static T_4
F_36 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_4 <= V_32 -> V_2 . V_4 ;
}
static T_4
F_37 ( const T_1 * V_31 , const T_1 * V_32 )
{
return ( ( V_31 -> V_2 . V_3 & V_32 -> V_2 . V_3 ) != 0 ) ;
}
static void
F_38 ( T_1 * V_1 )
{
...
if ( V_2 > V_8 ) {
if ( V_7 != NULL )
* V_7 = F_7 ( L_10 V_36 L_11 , V_5 , V_8 ) ;
return FALSE ;
}
V_1 -> V_2 . V_34 = V_2 ;
return TRUE ;
...
{
return F_43 ( V_1 , V_5 , T_5 , V_7 , V_35 ) ;
}
static T_4
...
T_11 V_2 ;
char * V_9 ;
if ( ! strchr ( V_5 , '-' ) && F_45 ( V_5 , NULL , 0 ) > V_37 ) {
if ( V_7 != NULL )
* V_7 = F_7 ( L_3 , V_5 ) ;
return FALSE ;
}
...
if ( V_7 != NULL )
* V_7 = F_7 ( L_12 V_36 L_11 , V_5 , V_8 ) ;
return FALSE ;
}
V_1 -> V_2 . V_33 = ( T_10 ) V_2 ;
return TRUE ;
}
static T_4
F_52 ( T_1 * V_1 , const char * V_5 , T_4 T_5 , T_6 * * V_7 )
{
return F_51 ( V_1 , V_5 , T_5 , V_7 , V_37 , V_38 ) ;
}
static T_4
...
static void
F_58 ( T_1 * V_1 , T_7 T_8 V_6 , int T_9 V_6 , char * V_26 )
{
T_10 V_27 ;
if ( V_1 -> V_2 . V_33 < 0 ) {
* V_26 ++ = '-' ;
...
static void
F_61 ( T_1 * V_1 , T_7 T_8 V_6 , int T_9 V_6 , char * V_26 )
{
if ( ( T_9 == V_28 ) || ( T_9 == V_29 ) )
{
* V_26 ++ = '0' ;
* V_26 ++ = 'x' ;
V_26 = F_62 ( V_26 , V_1 -> V_2 . V_34 ) ;
* V_26 ++ = '\0' ;
}
else
{
F_59 ( V_1 -> V_2 . V_34 , V_26 , 21 ) ;
}
}
static T_4
F_63 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_34 == V_32 -> V_2 . V_34 ;
}
static T_4
F_64 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_34 != V_32 -> V_2 . V_34 ;
}
static T_4
F_65 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_34 > V_32 -> V_2 . V_34 ;
}
static T_4
F_66 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_34 >= V_32 -> V_2 . V_34 ;
}
static T_4
F_67 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_34 < V_32 -> V_2 . V_34 ;
}
static T_4
F_68 ( const T_1 * V_31 , const T_1 * V_32 )
{
return V_31 -> V_2 . V_34 <= V_32 -> V_2 . V_34 ;
}
static T_4
F_69 ( const T_1 * V_31 , const T_1 * V_32 )
{
return ( T_11 ) V_31 -> V_2 . V_33 > ( T_11 ) V_32 -> V_2 . V_33 ;
}
static T_4
F_70 ( const T_1 * V_31 , const T_1 * V_32 )
{
return ( T_11 ) V_31 -> V_2 . V_33 >= ( T_11 ) V_32 -> V_2 . V_33 ;
}
static T_4
F_71 ( const T_1 * V_31 , const T_1 * V_32 )
{
return ( T_11 ) V_31 -> V_2 . V_33 < ( T_11 ) V_32 -> V_2 . V_33 ;
}
static T_4
F_72 ( const T_1 * V_31 , const T_1 * V_32 )
{
return ( T_11 ) V_31 -> V_2 . V_33 <= ( T_11 ) V_32 -> V_2 . V_33 ;
}
static T_4
F_73 ( const T_1 * V_31 , const T_1 * V_32 )
{
return ( ( V_31 -> V_2 . V_34 & V_32 -> V_2 . V_34 ) != 0 ) ;
}
static void
F_74 ( T_1 * V_1 )
{
...
static void
F_76 ( T_1 * V_1 , T_7 T_8 V_6 , int T_9 V_6 , char * V_26 )
{
* V_26 ++ = ( V_1 -> V_2 . V_3 ) ? '1' : '0' ;
* V_26 = '\0' ;
}
static T_4
F_77 ( const T_1 * V_31 , const T_1 * V_32 )
{
if ( V_31 -> V_2 . V_3 ) {
if ( V_32 -> V_2 . V_3 ) {
return TRUE ;
...
static T_4
F_78 ( const T_1 * V_31 , const T_1 * V_32 )
{
return ( ! F_77 ( V_31 , V_32 ) ) ;
}
static T_4
...
memcpy ( V_41 . V_39 , V_39 -> V_43 , 8 ) ;
F_82 ( V_39 , TRUE ) ;
V_1 -> V_2 . V_44 = F_83 ( V_41 . V_2 ) ;
return TRUE ;
}
static int
...
static void
F_85 ( T_1 * V_1 , T_7 T_8 V_6 , int T_9 V_6 , char * V_26 )
{
union {
T_10 V_2 ;
T_13 V_39 [ 8 ] ;
} V_41 ;
V_41 . V_2 = F_86 ( V_1 -> V_2 . V_44 ) ;
F_87 ( V_26 , V_45 , L_14 ,
V_41 . V_39 [ 0 ] , V_41 . V_39 [ 1 ] , V_41 . V_39 [ 2 ] , V_41 . V_39 [ 3 ] ,
V_41 . V_39 [ 4 ] , V_41 . V_39 [ 5 ] , V_41 . V_39 [ 6 ] , V_41 . V_39 [ 7 ] ) ;
}
void
F_88 ( void )
{
