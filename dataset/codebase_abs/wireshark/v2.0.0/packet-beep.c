...
static void
F_35 ( T_4 * V_11 , T_5 * V_12 , T_6 * V_14 )
{
int V_13 ;
struct V_29 * V_30 ;
...
V_13 = 0 ;
V_30 = (struct V_29 * ) F_36 ( F_37 () , V_12 , V_89 , 0 ) ;
if ( ! V_30 ) {
V_7 = F_38 ( V_12 ) ;
V_87 . V_7 = V_7 -> V_90 ;
V_47 = (struct V_46 * ) F_39 ( V_10 , & V_87 ) ;
if ( ! V_47 ) {
V_88 = F_40 ( F_37 () , struct V_3 ) ;
V_88 -> V_7 = V_7 -> V_90 ;
...
F_42 ( V_12 -> V_92 , V_93 , L_21 ) ;
if ( F_33 ( V_11 , V_13 ) > 0 )
F_43 ( V_12 -> V_92 , V_94 , F_18 ( V_11 , V_13 , F_33 ( V_11 , V_13 ) ) ) ;
if ( V_14 ) {
...
int V_96 = V_30 -> V_96 ;
V_96 = F_25 ( V_96 , F_34 ( 0 , F_33 ( V_11 , V_13 ) ) ) ;
if ( V_14 && ( V_96 > 0 ) ) {
F_10 ( V_14 , V_78 , V_11 , V_13 , V_96 , V_23 | V_37 ) ;
}
V_13 += V_96 ;
}
...
if ( F_33 ( V_11 , V_13 ) > 0 ) {
F_28 ( V_11 , V_13 , V_12 , V_86 , V_47 , V_30 ) ;
}
}
void
F_45 ( void )
...
static T_10 V_40 [] = {
{ & V_65 ,
{ L_22 , L_23 , V_97 , V_98 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_64 ,
{ L_24 , L_25 , V_100 , V_98 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_101 ,
{ L_26 , L_27 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
#if 0
{ &hf_beep_rsp,
...
#endif
{ & V_104 ,
{ L_28 , L_29 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_18 ,
{ L_30 , L_31 , V_105 , V_106 , F_46 ( V_107 ) , 0x0 , NULL , V_99 } } ,
{ & V_68 ,
{ L_32 , L_33 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_76 ,
{ L_34 , L_35 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_71 ,
{ L_36 , L_37 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_73 ,
{ L_38 , L_39 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_66 ,
{ L_40 , L_41 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_36 ,
{ L_42 , L_43 , V_100 , V_98 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_39 ,
{ L_17 , L_44 , V_100 , V_98 , NULL , 0x0 , NULL , V_99 } } ,
#if 0
{ &hf_beep_status,
{ "Status", "beep.status", FT_UINT8, BASE_HEX, VALS(beep_status_vals), 0x0, NULL, HFILL }},
#endif
{ & V_80 ,
{ L_45 , L_46 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_82 ,
{ L_47 , L_48 , V_102 , V_103 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_78 ,
{ L_49 , L_50 , V_100 , V_98 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_70 ,
{ L_51 , L_52 , V_100 , V_98 , NULL , 0x0 , NULL , V_99 } } ,
{ & V_22 ,
{ L_53 , L_54 , V_108 , V_98 , NULL , 0x0 , NULL , V_99 } } ,
} ;
static T_1 * V_109 [] = {
& V_95 ,
& V_38 ,
...
static T_11 V_110 [] = {
{ & V_20 , { L_55 , V_111 , V_112 , L_56 , V_113 } } ,
{ & V_25 , { L_57 , V_111 , V_112 , L_58 , V_113 } } ,
{ & V_26 , { L_59 , V_111 , V_112 , L_60 , V_113 } } ,
{ & V_27 , { L_61 , V_111 , V_112 , L_62 , V_113 } } ,
} ;
T_12 * V_114 ;
T_13 * V_115 ;
V_89 = F_47 ( L_63 ,
L_21 , L_64 ) ;
F_48 ( V_89 , V_40 , F_49 ( V_40 ) ) ;
F_50 ( V_109 , F_49 ( V_109 ) ) ;
V_115 = F_51 ( V_89 ) ;
F_52 ( V_115 , V_110 , F_49 ( V_110 ) ) ;
F_53 ( & F_4 ) ;
F_54 ( & F_6 ) ;
V_114 = F_55 ( V_89 , V_116 ) ;
F_56 ( V_114 , L_65 , L_66 ,
L_67
L_68 ,
10 , & V_49 ) ;
F_57 ( V_114 , L_69 ,
...
static T_3 V_119 ;
if ( ! V_117 ) {
V_118 = F_58 ( F_35 , V_89 ) ;
V_117 = TRUE ;
}
else {
F_59 ( L_65 , V_119 , V_118 ) ;
}
V_119 = V_49 ;
F_60 ( L_65 , V_49 , V_118 ) ;
}
