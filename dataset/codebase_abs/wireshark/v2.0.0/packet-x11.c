...
V_161 ) ;
V_380 -> V_540 = V_169 -> V_541 -> V_542 ;
V_380 -> V_543 = 0 ;
F_106 ( V_380 -> V_385 , F_107 ( V_380 -> V_543 ) ,
( int * ) V_544 ) ;
}
static void F_108 ( T_1 * V_1 , T_13 * V_169 ,
T_2 * V_527 , const char V_160 * V_15 , T_17 * volatile V_380 ,
T_3 V_5 )
{
...
const T_21 * V_571 )
{
F_106 ( V_572 , ( V_573 ) V_11 , ( V_573 ) F_115 ) ;
F_106 ( V_574 , ( V_573 ) V_11 , ( V_573 ) V_568 ) ;
F_106 ( V_575 , ( V_573 ) V_11 , ( V_573 ) V_569 ) ;
if ( V_570 )
F_106 ( V_576 , ( V_573 ) V_11 , ( V_573 ) V_570 ) ;
F_106 ( V_577 , ( V_573 ) V_11 , ( V_573 ) V_571 ) ;
}
static void F_116 ( int V_578 , T_1 * V_1 , T_13 * V_169 , int * V_2 , T_2 * V_3 ,
T_17 * V_380 , T_3 V_5 )
{
const T_15 * V_579 ;
void (* F_115)( T_1 * V_1 , T_13 * V_169 , int * V_2 , T_2 * V_3 , T_3 V_5 );
V_579 = F_5 ( V_578 , V_380 -> V_580 ) ;
if ( ! V_579 )
return;
F_115 = ( void ( * ) ( T_1 * , T_13 * , int * , T_2 * , T_3 ) ) F_117 ( V_572 , V_579 ) ;
if ( F_115 )
F_115 ( V_1 , V_169 , V_2 , V_3 , V_5 ) ;
}
static void F_118 ( int V_578 , T_1 * V_1 , T_13 * V_169 , int * V_2 , T_2 * V_3 ,
T_17 * V_380 , T_3 V_5 )
{
void (* F_115)( T_1 * V_1 , T_13 * V_169 , int * V_2 , T_2 * V_3 , T_3 V_5 );
F_115 = ( void ( * ) ( T_1 * , T_13 * , int * , T_2 * , T_3 ) ) F_117 ( V_380 -> V_384 , F_107 ( V_578 ) ) ;
if ( F_115 )
F_115 ( V_1 , V_169 , V_2 , V_3 , V_5 ) ;
else
F_119 () ;
...
V_579 = F_9 ( V_1 , * V_2 ) ;
( * V_2 ) ++ ;
V_581 = F_5 ( V_579 , V_380 -> V_580 ) ;
if ( V_581 ) {
F_7 ( V_3 , V_582 , V_1 , * V_2 , 1 , V_579 , L_46 , V_579 , V_581 ) ;
} else {
F_18 ( V_3 , V_582 , V_1 , * V_2 , 1 , V_579 ) ;
}
V_278 ( V_583 ) ;
V_24 = F_122 ( V_584 ) ;
V_24 = V_24 * 4 + 32 ;
...
if ( V_581 ) {
T_20 * V_585 ;
V_585 = ( T_20 * ) F_117 ( V_576 , V_581 ) ;
if ( V_585 ) {
int V_166 ;
int V_578 = F_21 ( V_1 , * V_2 ) ;
for ( V_166 = 0 ; V_585 [ V_166 ] . V_586 != NULL ; V_166 ++ ) {
if ( V_585 [ V_166 ] . V_587 == V_578 ) {
* V_2 += 2 ;
V_585 [ V_166 ] . V_586 ( V_1 , V_24 , V_2 , V_3 , V_5 ) ;
return;
}
}
}
...
static void F_123 ( T_17 * V_380 , T_22 * V_589 ,
int V_590 , unsigned int V_591 , unsigned int V_592 )
{
const char * * V_593 ;
T_19 * V_569 ;
T_21 * V_571 ;
int V_166 ;
V_589 -> V_594 = V_590 ;
V_593 = ( const char * * ) F_117 ( V_574 , V_589 -> V_595 ) ;
while ( V_593 && * V_593 && V_592 <= V_596 ) {
for ( V_166 = 0 ; V_166 <= V_596 ; V_166 ++ ) {
if ( V_380 -> V_597 [ V_166 ] . V_595 == NULL ) {
V_380 -> V_597 [ V_166 ] . V_594 = V_592 ;
V_380 -> V_597 [ V_166 ] . V_595 = * V_593 ;
break;
} else if ( V_380 -> V_597 [ V_166 ] . V_594 == V_592 ) {
V_380 -> V_597 [ V_166 ] . V_595 = * V_593 ;
break;
}
}
...
V_569 = ( T_19 * ) F_117 ( V_575 , V_589 -> V_595 ) ;
while ( V_569 && V_569 -> V_11 && V_591 <= V_598 ) {
for ( V_166 = 0 ; V_166 <= V_598 ; V_166 ++ ) {
if ( V_380 -> V_599 [ V_166 ] . V_595 == NULL ) {
V_380 -> V_599 [ V_166 ] . V_594 = V_591 ;
V_380 -> V_599 [ V_166 ] . V_595 = V_569 -> V_11 ;
break;
} else if ( V_380 -> V_599 [ V_166 ] . V_594 == V_591 ) {
V_380 -> V_599 [ V_166 ] . V_595 = V_569 -> V_11 ;
break;
}
}
F_106 ( V_380 -> V_383 , F_107 ( V_591 ) , ( V_573 ) V_569 -> V_586 ) ;
V_591 ++ ;
V_569 ++ ;
}
V_571 = ( T_21 * ) F_117 ( V_577 , V_589 -> V_595 ) ;
if ( V_571 )
for ( V_166 = 0 ; V_571 [ V_166 ] . V_586 ; V_166 ++ )
F_106 ( V_380 -> V_384 ,
F_107 ( V_590 | ( V_571 [ V_166 ] . V_587 << 8 ) ) ,
( V_573 ) V_571 [ V_166 ] . V_586 ) ;
}
...
T_6 * V_13 ;
T_2 * V_3 ;
int V_24 , V_578 , V_166 ;
T_8 V_600 , V_601 , V_602 ;
T_10 F_98 ;
T_4 V_603 ;
T_18 V_530 ;
T_15 * V_11 ;
...
++ V_380 -> V_543 ;
F_126 () ;
F_127 ( V_169 -> V_604 , V_605 , L_47 , V_15 ,
F_128 ( V_578 , V_380 -> V_580 ,
L_48 ) ) ;
F_45 ( V_13 , L_49 ,
V_578 , F_128 ( V_578 , V_380 -> V_580 ,
L_48 ) ) ;
switch( V_578 ) {
case V_439 :
F_98 = F_21 ( V_1 , 4 ) ;
...
V_166 = 0 ;
while( V_166 < V_606 ) {
if ( V_380 -> V_580 [ V_166 ] . V_595 == NULL ) {
V_380 -> V_580 [ V_166 ] . V_595 = V_11 ;
V_380 -> V_580 [ V_166 ] . V_594 = - 1 ;
F_106 ( V_380 -> V_386 ,
F_107 ( V_380 -> V_543 ) ,
( int * ) & V_380 -> V_580 [ V_166 ] ) ;
break;
} else if ( strcmp ( V_380 -> V_580 [ V_166 ] . V_595 ,
V_11 ) == 0 ) {
F_106 ( V_380 -> V_386 ,
F_107 ( V_380 -> V_543 ) ,
( int * ) & V_380 -> V_580 [ V_166 ] ) ;
...
F_85 ( V_617 ) ;
F_102 ( 2 ) ;
F_76 ( V_288 , V_618 , V_26 ) ;
F_76 ( V_288 , V_618 , V_27 ) ;
F_76 ( V_278 , V_618 , V_28 ) ;
F_76 ( V_278 , V_618 , V_29 ) ;
F_76 ( V_278 , V_618 , V_612 ) ;
F_76 ( F_131 , V_618 , V_619 ) ;
F_76 ( V_271 , V_618 , V_620 ) ;
V_302 ;
F_134 () ;
break;
case V_403 :
...
F_130 () ;
F_148 ( V_292 ) ;
F_149 ( F_87 , ( V_254 - V_249 - ( V_600 ? 2 : 0 ) ) / 2 ) ;
F_134 () ;
break;
case V_479 :
F_102 ( 1 ) ;
...
V_602 = F_159 ( V_135 ) ;
F_102 ( 2 ) ;
F_162 ( V_723 , V_380 -> V_133 , V_601 , V_600 , V_602 ) ;
break;
case V_422 :
F_102 ( 1 ) ;
F_130 () ;
V_380 -> V_724 . V_725 . V_134
= F_147 ( V_134 ) ;
F_159 ( V_726 ) ;
F_102 ( 2 ) ;
break;
...
F_130 () ;
F_75 ( V_727 ) ;
F_76 ( F_109 , V_728 , V_729 ) ;
F_76 ( F_109 , V_728 , V_730 ) ;
F_76 ( V_288 , V_728 , V_731 ) ;
F_76 ( V_288 , V_728 , V_732 ) ;
F_76 ( V_288 , V_728 , V_733 ) ;
F_76 ( V_271 , V_728 , V_734 ) ;
F_76 ( F_147 , V_728 , V_735 ) ;
F_76 ( V_271 , V_728 , V_736 ) ;
V_302 ;
break;
case V_465 :
F_102 ( 1 ) ;
...
break;
default:
F_116 ( V_578 , V_1 , V_169 , V_2 , V_3 , V_380 , V_5 ) ;
break;
}
if ( ( V_530 = F_105 ( V_1 , V_249 ) ) > 0 )
F_113 ( V_530 ) ;
...
int V_24 ;
T_1 * volatile V_768 ;
while ( ( V_762 = F_105 ( V_1 , V_249 ) ) > 0 ) {
if ( V_769 && V_169 -> V_770 ) {
if ( V_762 < 4 ) {
V_169 -> V_771 = V_249 ;
V_169 -> V_772 = V_773 ;
return;
...
V_767 = F_167 ( V_169 ) ;
if ( ( V_380 = ( T_17 * ) F_168 ( V_767 , V_531 ) )
== NULL )
V_380 = F_169 ( V_767 ) ;
V_5 = F_100 ( V_1 , V_169 , V_380 ) ;
V_578 = F_9 ( V_1 , 0 ) ;
V_763 = F_21 ( V_1 , V_249 + 2 ) ;
if ( V_763 == 0 ) {
V_13 = F_20 ( V_527 , V_531 , V_1 , V_249 , - 1 , V_161 ) ;
F_48 ( V_169 , V_13 , & V_774 , L_50 ) ;
return;
}
if ( V_380 -> V_540 == V_169 -> V_541 -> V_542 ||
( F_117 ( V_380 -> V_385 ,
F_107 ( V_380 -> V_543 ) ) == ( int * ) V_775 &&
( V_578 == 'B' || V_578 == 'l' ) &&
( V_763 == 11 || V_763 == 2816 ) ) ) {
V_764 = TRUE ;
if ( V_380 -> V_5 == V_776 ) {
...
V_765 = F_21 ( V_1 , V_249 + 6 ) ;
V_766 = F_21 ( V_1 , V_249 + 8 ) ;
V_763 = 12 + F_104 ( V_765 ) +
F_104 ( V_766 ) ;
} else {
V_764 = FALSE ;
V_763 *= 4 ;
...
if ( V_24 > V_763 )
V_24 = V_763 ;
V_768 = F_170 ( V_1 , V_249 , V_24 , V_763 ) ;
if ( V_764 ) {
F_171 ( V_169 -> V_604 , V_605 , L_51 ) ;
} else {
if ( V_15 == NULL ) {
F_171 ( V_169 -> V_604 , V_605 , L_52 ) ;
V_15 = L_53 ;
}
}
F_172 {
if ( V_764 ) {
F_101 ( V_768 , V_169 , V_527 ,
V_380 , V_5 ) ;
} else {
F_124 ( V_768 , V_169 , V_527 , V_15 ,
V_380 , V_5 ) ;
}
}
F_173 {
F_174 ( V_1 , V_169 , V_527 , V_777 , V_778 ) ;
}
V_779 ;
V_249 += V_763 ;
V_15 = L_54 ;
...
V_380 -> V_387 = V_381 ;
V_381 = V_380 ;
for ( V_166 = 0 ; V_580 [ V_166 ] . V_595 != NULL ; V_166 ++ ) {
V_380 -> V_580 [ V_166 ] . V_594 = V_580 [ V_166 ] . V_594 ;
V_380 -> V_580 [ V_166 ] . V_595 = V_580 [ V_166 ] . V_595 ;
}
for (; V_166 <= V_606 ; V_166 ++ ) {
V_380 -> V_580 [ V_166 ] . V_594 = 0 ;
V_380 -> V_580 [ V_166 ] . V_595 = NULL ;
}
for ( V_166 = 0 ; V_597 [ V_166 ] . V_595 != NULL ; V_166 ++ ) {
V_380 -> V_597 [ V_166 ] . V_594 = V_597 [ V_166 ] . V_594 ;
V_380 -> V_597 [ V_166 ] . V_595 = V_597 [ V_166 ] . V_595 ;
}
for (; V_166 <= V_596 + 1 ; V_166 ++ ) {
V_380 -> V_597 [ V_166 ] . V_594 = 0 ;
V_380 -> V_597 [ V_166 ] . V_595 = NULL ;
}
for ( V_166 = 0 ; V_599 [ V_166 ] . V_595 != NULL ; V_166 ++ ) {
V_380 -> V_599 [ V_166 ] . V_594 = V_599 [ V_166 ] . V_594 ;
V_380 -> V_599 [ V_166 ] . V_595 = V_599 [ V_166 ] . V_595 ;
}
for (; V_166 <= V_598 + 1 ; V_166 ++ ) {
V_380 -> V_599 [ V_166 ] . V_594 = 0 ;
V_380 -> V_599 [ V_166 ] . V_595 = NULL ;
}
V_380 -> V_383 = F_175 ( V_781 , V_782 ) ;
V_380 -> V_384 = F_175 ( V_781 , V_782 ) ;
V_380 -> V_385 = F_175 ( V_781 , V_782 ) ;
V_380 -> V_386 = F_175 ( V_781 , V_782 ) ;
F_106 ( V_380 -> V_385 , ( int * ) 0 , ( int * ) V_775 ) ;
V_380 -> V_5 = V_776 ;
F_176 ( V_767 , V_531 , V_380 ) ;
return V_380 ;
}
static void
F_177 ( T_1 * V_1 , T_13 * V_169 , T_2 * V_527 )
{
volatile int V_249 , V_763 ;
T_1 * volatile V_768 ;
T_23 * V_767 ;
T_17 * volatile V_380 ;
volatile T_3 V_5 ;
...
F_107 ( V_380 -> V_543 ) ) == ( int * ) V_544
|| ( V_380 -> V_551 == V_169 -> V_541 -> V_542 ) ) {
V_763 = 8 + F_21 ( V_1 , V_249 + 6 ) * 4 ;
F_178 ( V_763 , V_762 ,
L_55 ,
F_108 ) ;
} else {
...
{
int V_784 ;
V_784 = V_763 = 32 + F_2 ( V_1 , V_249 + 4 ) * 4 ;
F_179 ( V_784 < 32 , V_785 ) ;
F_178 ( V_763 , V_762 ,
L_57 , V_786 ) ;
break;
}
...
const char * volatile V_15 , T_17 * volatile V_380 ,
T_3 V_5 )
{
int V_249 = 0 , * V_2 = & V_249 , V_24 , V_530 , V_578 ;
int V_590 , V_788 , V_592 , V_591 ;
T_22 * V_589 ;
T_6 * V_13 ;
T_2 * V_3 ;
V_13 = F_20 ( V_527 , V_531 , V_1 , 0 , - 1 , V_161 ) ;
V_3 = F_16 ( V_13 , V_532 ) ;
V_788 = F_21 ( V_1 , V_249 + 2 ) ;
V_578 = F_180 ( F_117 ( V_380 -> V_385 ,
F_107 ( V_788 ) ) ) ;
if ( V_380 -> V_540 == 0 && V_380 -> V_789 == FALSE ) {
V_380 -> V_543 = V_788 ;
V_380 -> V_789 = TRUE ;
}
if ( V_578 == V_790 ) {
F_127 ( V_169 -> V_604 , V_605 ,
L_59 , V_15 ) ;
F_45 ( V_13 , L_60 ) ;
} else {
F_127 ( V_169 -> V_604 , V_605 , L_47 ,
V_15 ,
F_128 ( V_578 & 0xFF , V_380 -> V_580 ,
L_48 ) ) ;
if ( V_578 > 0xFF )
F_45 ( V_13 , L_61 ,
V_578 & 0xFF , V_578 >> 8 , F_128 ( V_578 & 0xFF ,
V_380 -> V_580 ,
L_48 ) ) ;
else
F_45 ( V_13 , L_62 ,
...
V_589 = ( T_22 * ) F_117 ( V_380 -> V_386 ,
F_107 ( V_788 ) ) ;
if ( V_589 != NULL ) {
V_590 = F_9 ( V_1 , V_249 + 9 ) ;
V_591 = F_9 ( V_1 , V_249 + 10 ) ;
V_592 = F_9 ( V_1 , V_249 + 11 ) ;
F_123 ( V_380 , V_589 , V_590 , V_591 , V_592 ) ;
F_181 ( V_380 -> V_386 ,
F_107 ( V_788 ) ) ;
}
break;
...
break;
default:
F_118 ( V_578 , V_1 , V_169 , V_2 , V_3 , V_380 , V_5 ) ;
}
if ( ( V_530 = F_105 ( V_1 , V_249 ) ) > 0 )
F_113 ( V_530 ) ;
}
...
V_335 = * V_2 ;
V_336 = 1 ;
V_13 = F_18 ( V_3 , V_810 , V_1 , * V_2 , 1 ,
V_334 ) ;
V_337 = F_16 ( V_13 , V_811 ) ;
F_78 ( F_185 , V_665 ) ;
F_78 ( F_185 , V_796 ) ;
* V_2 += 1 ;
}
static void
V_787 ( T_1 * V_1 , T_13 * V_169 , T_2 * V_527 ,
const char * volatile V_15 , T_17 * volatile V_380 ,
T_3 V_5 )
{
unsigned char V_812 ;
...
V_3 = F_16 ( V_13 , V_532 ) ;
V_812 = F_58 ( V_1 , 0 ) ;
V_813 = ( V_812 & 0x80 ) ? L_63 : L_15 ;
F_127 ( V_169 -> V_604 , V_605 , L_64 ,
V_15 , V_813 ,
F_128 ( V_812 & 0x7F , V_380 -> V_599 ,
L_65 ) ) ;
F_45 ( V_13 , L_66 ,
V_812 , V_813 ,
F_128 ( V_812 & 0x7F , V_380 -> V_599 ,
...
if ( V_527 == NULL )
return;
F_186 ( V_1 , V_812 , V_813 , V_3 , V_380 , V_5 ) ;
return;
}
static void
F_186 ( T_1 * V_1 , unsigned char V_812 , const char * V_813 ,
T_2 * V_3 , T_17 * volatile V_380 ,
T_3 V_5 )
{
int V_249 = 0 , * V_2 = & V_249 , V_530 ;
F_7 ( V_3 , V_814 , V_1 , V_249 , 1 ,
V_812 ,
L_67 ,
V_812 , V_813 ,
F_128 ( V_812 & 0x7F , V_380 -> V_599 ,
...
break;
default:
F_120 ( V_812 & 0x7F , V_1 , V_2 , V_3 , V_380 , V_5 ) ;
break;
}
if ( ( V_530 = F_105 ( V_1 , V_249 ) ) > 0 )
F_113 ( V_530 ) ;
...
static void
V_783 ( T_1 * V_1 , T_13 * V_169 , T_2 * V_527 ,
const char * volatile V_15 , T_17 * volatile V_380 V_160 ,
T_3 V_5 )
{
int V_249 = 0 , * V_2 = & V_249 , V_530 ;
unsigned char V_861 ;
...
V_3 = F_16 ( V_13 , V_532 ) ;
V_299 ( error ) ;
V_861 = F_58 ( V_1 , V_249 ) ;
F_127 ( V_169 -> V_604 , V_605 , L_47 ,
V_15 , F_128 ( V_861 , V_380 -> V_597 , L_68 ) ) ;
F_7 ( V_3 , V_862 , V_1 , V_249 , 1 ,
V_861 ,
L_69 ,
V_861 ,
F_128 ( V_861 , V_380 -> V_597 ,
L_68 ) ) ;
++ V_249 ;
F_45 ( V_13 , L_70 ,
V_861 , F_128 ( V_861 , V_380 -> V_597 ,
L_68 ) ) ;
if ( V_527 == NULL )
return;
V_278 ( V_863 ) ;
...
static void
F_189 ( T_1 * V_1 , T_13 * V_169 , T_2 * V_527 )
{
F_171 ( V_169 -> V_604 , V_875 , L_71 ) ;
...
static T_25 V_886 [] = {
{ & V_632 , { L_72 , V_887 , V_888 , L_73 , V_889 } } ,
{ & V_774 , { L_74 , V_887 , V_888 , L_75 , V_889 } } ,
{ & V_173 , { L_76 , V_887 , V_888 , L_77 , V_889 } } ,
} ;
T_26 * V_890 ;
T_27 * V_891 ;
V_531 = F_191 ( L_71 , L_71 , L_78 ) ;
F_192 ( V_531 , V_4 , F_3 ( V_4 ) ) ;
F_193 ( V_876 , F_3 ( V_876 ) ) ;
V_891 = F_194 ( V_531 ) ;
F_195 ( V_891 , V_886 , F_3 ( V_886 ) ) ;
F_196 ( F_90 ) ;
V_572 = F_175 ( V_892 , V_893 ) ;
V_574 = F_175 ( V_892 , V_893 ) ;
V_575 = F_175 ( V_892 , V_893 ) ;
V_576 = F_175 ( V_892 , V_893 ) ;
V_577 = F_175 ( V_892 , V_893 ) ;
F_197 () ;
V_890 = F_198 ( V_531 , NULL ) ;
F_199 ( V_890 , L_79 ,
L_80 ,
L_81
L_82 ,
...
{
T_28 V_894 ;
V_894 = F_201 ( F_189 , V_531 ) ;
F_202 ( L_83 , V_895 , V_894 ) ;
F_202 ( L_83 , V_896 , V_894 ) ;
F_202 ( L_83 , V_897 , V_894 ) ;
}
