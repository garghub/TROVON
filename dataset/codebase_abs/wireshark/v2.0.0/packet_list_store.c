...
if ( V_196 )
F_86 ( & V_191 , V_64 ) ;
F_87 ( & V_191 , V_63 . V_198 , & V_194 , F_88 ( V_96 , & V_195 ) , V_96 , V_64 ) ;
if ( V_190 )
V_96 -> V_197 = F_89 ( & V_191 ) ;
if ( V_196 ) {
F_90 ( & V_191 , FALSE , FALSE ) ;
for( V_113 = 0 ; V_113 < V_64 -> V_65 ; ++ V_113 )
F_45 ( V_58 , V_87 , V_113 , V_64 ) ;
}
if ( V_190 )
...
V_201 = ( T_7 ) strlen ( V_63 . V_64 . V_97 [ V_113 ] . V_125 ) ;
if ( V_201 > V_200 ) {
V_200 = V_201 ;
V_199 = V_188 ;
}
...
T_14 * V_87 ;
T_32 V_188 ;
const T_19 * V_202 = NULL ;
T_32 V_200 = 0 ;
if ( ! V_58 -> V_68 )
F_50 ( V_58 ) ;
for( V_188 = 0 ; V_188 < F_29 ( V_58 -> V_67 ) ; ++ V_188 ) {
V_87 = F_28 ( V_58 -> V_67 , V_188 ) ;
if ( V_87 -> V_108 [ V_115 ] > V_200 ) {
V_202 = V_87 -> V_94 [ V_115 ] ;
V_200 = V_87 -> V_108 [ V_115 ] ;
}
}
return V_202 ;
}
