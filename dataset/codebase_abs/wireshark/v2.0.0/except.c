...
T_2 T_3 static void F_8 ( T_4 * V_21 )
{
struct V_22 * V_23 ;
...
struct V_32 * V_48 , const T_1 V_49 [] , T_5 V_50 )
{
V_48 -> V_24 = V_49 ;
V_48 -> V_40 = V_50 ;
V_48 -> V_38 . V_39 = 0 ;
...
T_2 T_3 void F_20 ( long V_51 , long V_52 , const char * V_53 )
{
T_4 V_21 ;
V_21 . V_24 . V_16 = V_51 ;
V_21 . V_24 . V_19 = V_52 ;
...
T_2 T_3 void F_24 ( long V_51 , long V_52 , const char * V_53 , void * V_55 )
{
T_4 V_21 ;
V_21 . V_24 . V_16 = V_51 ;
V_21 . V_24 . V_19 = V_52 ;
...
T_2 T_3 void F_25 ( long V_51 , long V_52 , const char * V_56 , ... )
{
...
unsigned long V_19 ( T_4 * V_60 )
{
return V_60 -> V_24 . V_19 ;
}
unsigned long V_16 ( T_4 * V_60 )
{
return V_60 -> V_24 . V_16 ;
}
const char * V_42 ( T_4 * V_60 )
{
return V_60 -> V_42 ;
}
void * F_28 ( T_4 * V_60 )
...
void F_30 ( void * (* F_31)( T_5 ) , void (* F_32)( void * ) )
{
F_33 ( F_31 ) ;
F_34 ( F_32 ) ;
}
