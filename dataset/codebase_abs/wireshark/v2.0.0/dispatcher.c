...
V_36 = F_25 ( V_36 ) ) {
V_37 = ( T_8 * ) V_36 -> V_42 ;
F_26 ( V_4 , L_10 , V_37 -> V_43 , V_37 -> V_43 ) ;
if ( V_37 -> V_44 != NULL )
F_26 ( V_4 , L_11 , V_37 -> V_44 ) ;
if ( V_37 -> V_45 != NULL )
F_26 ( V_4 , L_12 , V_37 -> V_45 ) ;
for ( V_38 = F_27 ( V_37 -> V_46 , 0 ) ; V_38 != NULL ;
V_38 = F_28 ( V_38 ) ) {
V_39 = ( T_10 * ) V_38 -> V_42 ;
switch( V_39 -> V_47 ) {
case V_48 :
if ( F_29 ( V_49 , & V_39 -> V_38 . V_50 , V_41 ,
F_22 ) ) {
F_26 ( V_4 , L_13 , V_41 ) ;
} else {
F_30 ( V_4 , L_14 ) ;
...
F_30 ( V_4 , L_19 ) ;
V_40 = F_32 ( V_37 -> V_43 , 0 , NULL , V_35 , NULL ) ;
if ( V_40 != NULL ) {
if ( V_40 -> V_55 != NULL ) {
T_7 * V_56 = V_40 -> V_55 ;
T_13 * V_57 ;
F_30 ( V_4 , L_20 ) ;
for (; V_56 != NULL ; V_56 = F_25 ( V_56 ) ) {
V_57 = ( T_13 * ) V_56 -> V_42 ;
F_26 ( V_4 , L_21 , V_57 -> V_43 , ( V_57 -> V_58 ) ? V_57 -> V_58 : L_22 ) ;
}
F_31 ( V_4 , V_4 -> V_27 - 2 ) ;
F_30 ( V_4 , L_23 ) ;
}
F_26 ( V_4 , L_24 , V_40 -> V_59 ? L_25 : L_26 ) ;
if ( V_40 -> V_59 ) {
F_33 ( V_40 ) ;
V_40 = F_32 ( V_37 -> V_43 , 1 , NULL , V_35 , NULL ) ;
if ( V_40 -> V_55 != NULL ) {
T_7 * V_56 = V_40 -> V_55 ;
T_13 * V_57 ;
F_30 ( V_4 , L_27 ) ;
...
return F_7 ( V_61 ? V_61 : L_22 ) ;
}
static char * F_39 ( char * * T_2 V_10 ) {
return F_5 ( L_32 , ( ( ( float ) V_62 ) / 1000000.0 ) ) ;
}
static T_3 F_40 ( char * V_11 , char * * T_2 ) {
char * V_12 ;
int V_63 = ( int ) strtol ( V_11 , & V_12 , 10 ) ;
if ( V_12 <= V_11 ) {
* T_2 = F_7 ( L_4 ) ;
return FALSE ;
}
...
return F_52 ( V_67 , V_68 ) ;
}
static struct V_19 * F_53 ( struct V_6 * V_69 , int V_24 ) {
int V_18 ;
struct V_19 * V_20 = V_69 -> V_21 ;
int V_22 = V_69 -> V_22 ;
for( V_18 = 0 ; V_18 < V_22 ; V_18 ++ ) {
struct V_19 * V_23 = & ( V_20 [ V_18 ] ) ;
...
struct V_19 * V_23 = & ( V_20 [ V_18 ] ) ;
if ( V_23 -> V_8 == V_8 ) {
if ( V_23 -> V_74 || V_6 -> V_74 ) {
F_62 ( V_6 -> V_82 , NULL , V_23 -> V_24 , V_83 , V_23 -> V_9 ) ;
} else {
char * V_84 = NULL ;
T_6 * V_85 ;
if ( F_63 ( V_78 ) ) {
...
V_84 = F_5 (
L_41 ,
V_8 , F_66 ( V_78 ) , F_67 ( V_78 ) ? L_42 : L_43 ) ;
} else if ( F_68 ( V_78 ) ) {
V_84 = F_5 (
L_44 ,
V_8 , F_69 ( V_78 ) ) ;
}
V_85 = V_6 -> V_31 . V_32 -> V_86 ( V_84 ) ;
F_18 ( V_87 , V_84 ) ;
if ( V_84 ) F_3 ( V_84 ) ;
F_62 ( V_6 -> V_82 , V_85 , V_23 -> V_24 , V_88 , 0 ) ;
...
static long F_72 ( T_14 * V_91 , T_4 V_27 , T_15 V_24 , T_16 type , T_17 V_9 , void * V_42 ) {
T_6 V_92 ;
struct V_19 * V_23 = (struct V_19 * ) V_42 ;
...
return F_62 ( V_6 -> V_82 , & V_92 , V_24 , type , V_9 ) ;
V_94:
F_70 ( V_23 , V_117 ) ;
V_23 -> V_74 = TRUE ;
F_15 ( V_23 -> V_8 , V_25 ) ;
...
F_76 ( V_123 ) ;
F_76 ( V_124 ) ;
F_78 ( V_24 , V_122 , V_121 , V_9 , & V_14 ) ;
exit ( F_79 () ) ;
return;
}
default: {
...
static long F_81 ( T_14 * V_91 , T_4 V_27 , T_15 V_24 , T_16 type , T_17 V_9 , void * V_42 V_10 ) {
T_6 V_92 ;
V_92 . V_42 = V_91 ;
V_92 . V_27 = ( V_93 ) V_27 ;
V_6 -> V_9 = V_9 ;
F_14 ( ( 1 , L_58 , F_82 ( type ) , V_24 , V_9 ) ) ;
if ( V_24 == 0 ) {
F_14 ( ( 2 , L_59 ) ) ;
switch( type ) {
case V_133 :
...
case V_134 :
F_14 ( ( 2 , L_60 , V_9 ) ) ;
F_62 ( V_6 -> V_82 , NULL , V_24 , V_100 , V_9 ) ;
return 0 ;
case V_135 : {
char * V_136 ;
char * V_137 ;
...
return F_62 ( V_23 -> V_73 , & V_92 , V_24 , type , V_9 ) ;
}
default:
...
int F_85 ( void ) {
int V_82 = V_6 -> V_82 ;
int V_158 = V_6 -> V_158 . V_72 ;
struct V_19 * V_21 = V_6 -> V_21 ;
F_14 ( ( 5 , L_70 , V_158 , V_82 ) ) ;
do {
T_19 V_159 ;
T_19 V_160 ;
struct V_19 * V_23 ;
...
if ( V_23 -> V_24 > 0 ) {
V_162 ++ ;
F_87 ( V_23 -> V_70 . V_72 , & V_159 ) ;
F_87 ( V_23 -> V_70 . V_72 , & V_160 ) ;
}
}
F_14 ( ( 4 , L_71 , V_162 , V_164 . V_131 ) ) ;
V_164 . V_129 = ( int ) ( V_62 / 1000000 ) ;
V_164 . V_131 = ( int ) ( V_62 % 1000000 ) ;
V_161 = F_80 ( V_165 , & V_159 , NULL , & V_160 , & V_164 ) ;
F_14 ( ( 5 , L_72 , V_162 , V_161 ) ) ;
if ( V_161 < 0 ) {
F_14 ( ( 1 , L_73 , F_75 ( V_126 ) ) ) ;
continue;
}
if ( F_88 ( V_158 , & V_159 ) ) {
long V_166 = F_89 ( & ( V_6 -> V_158 ) , F_81 , V_6 ) ;
if ( V_166 < 0 ) {
F_14 ( ( 1 , L_74 ) ) ;
continue;
}
...
for ( V_23 = V_21 ; V_23 -> V_8 ; V_23 ++ ) {
if ( V_23 -> V_70 . V_72 > 0 ) {
if ( F_88 ( V_23 -> V_70 . V_72 , & V_160 ) ) {
struct V_163 V_167 ;
V_167 . V_129 = 0 ;
V_167 . V_131 = V_168 ;
F_14 ( ( 1 , L_77 , V_23 -> V_24 ) ) ;
F_15 ( V_23 -> V_8 , V_25 ) ;
F_80 ( 0 , NULL , NULL , NULL , & V_167 ) ;
F_54 ( V_23 ) ;
continue;
}
if ( F_88 ( V_23 -> V_70 . V_72 , & V_159 ) ) {
long V_166 = F_89 ( & ( V_23 -> V_70 ) , F_72 , V_23 ) ;
if ( V_166 < 0 ) {
