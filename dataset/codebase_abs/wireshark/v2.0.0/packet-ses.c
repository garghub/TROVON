...
T_12 V_163 ;
T_9 V_164 = 0 ;
V_161 = F_31 ( V_4 -> V_165 -> V_166 ,
& V_4 -> V_167 , & V_4 -> V_168 , V_4 -> V_169 ,
V_4 -> V_170 , V_4 -> V_171 , 0 ) ;
if ( V_161 != NULL ) {
V_164 = V_161 -> V_172 ;
}
V_163 = F_29 ( V_1 , V_2 ) ;
V_122 = F_2 ( V_135 , V_173 , V_1 , V_2 ,
V_163 , V_11 ) ;
...
if( type == V_178 )
V_177 = TRUE ;
F_39 ( V_4 -> V_144 , V_179 , V_177 ? L_14 : L_15 ) ;
F_40 ( V_4 -> V_144 , V_145 ) ;
if ( ( type == V_180 ) || ( type == V_181 ) )
V_2 = F_20 ( V_1 , V_2 , V_4 , V_5 , V_182 , FALSE ) ;
while ( F_29 ( V_1 , V_2 ) > 0 )
V_2 = F_20 ( V_1 , V_2 , V_4 , V_5 , V_183 , V_177 ) ;
}
...
static T_5
F_45 ( T_1 * V_1 , T_3 * V_4 , T_4 * V_185 , void * T_13 V_186 )
{
int V_2 = 0 ;
T_6 type ;
int V_13 ;
...
{ & V_173 ,
{ L_112 , L_113 , V_221 , V_195 ,
NULL , 0x00 , NULL , V_192 } } ,
{ & V_222 ,
{ L_114 , L_115 , V_221 , V_195 ,
NULL , 0x00 , NULL , V_192 } } ,
{ & V_223 ,
{ L_116 , L_117 , V_224 , V_195 ,
NULL , 0x00 , NULL , V_192 } } ,
{ & V_225 ,
{ L_118 , L_119 , V_196 ,
V_195 , NULL , 0x0 , NULL , V_192 } } ,
{ & V_226 ,
{ L_120 ,
L_121 , V_196 , V_195 ,
NULL , 0x0 , NULL , V_192 } } ,
...
{ & V_228 ,
{ L_124 , L_125 ,
V_196 , V_195 , NULL , 0x0 , NULL , V_192 } } ,
{ & V_229 ,
{ L_126 , L_127 , V_224 ,
V_195 , NULL , 0x00 , NULL , V_192 } } ,
{ & V_230 ,
{ L_128 , L_129 , V_231 , V_190 ,
NULL , 0x00 , NULL , V_192 } } ,
{ & V_232 ,
{ L_130 , L_131 , V_224 , V_195 ,
NULL , 0x00 , L_132 , V_192 } } ,
{ & V_233 ,
{ L_133 , L_134 , V_231 , V_190 ,
NULL , 0x00 , L_135 , V_192 } } ,
{ & V_10 , { L_136 , L_137 , V_194 , V_195 , NULL , 0x0 , NULL , V_192 } } ,
{ & V_70 , { L_39 , L_138 , V_189 , V_202 , NULL , 0x0 , NULL , V_192 } } ,
{ & V_28 , { L_139 , L_140 , V_196 , 8 , F_51 ( & V_234 ) , V_235 , NULL , V_192 } } ,
{ & V_29 , { L_141 , L_142 , V_196 , 8 , F_51 ( & V_236 ) , V_72 , NULL , V_192 } } ,
{ & V_30 , { L_143 , L_144 , V_196 , 8 , F_51 ( & V_236 ) , V_237 , NULL , V_192 } } ,
{ & V_31 , { L_145 , L_146 , V_196 , 8 , F_51 ( & V_236 ) , V_238 , NULL , V_192 } } ,
{ & V_32 , { L_147 , L_148 , V_196 , 8 , F_51 ( & V_236 ) , V_239 , NULL , V_192 } } ,
{ & V_107 , { L_149 , L_150 , V_189 , V_190 | V_191 , & V_240 , 0x0 , NULL , V_192 } } ,
{ & V_126 , { L_151 , L_152 , V_189 , V_190 | V_191 , & V_125 , 0x0 , NULL , V_192 } } ,
{ & V_128 , { L_153 , L_154 , V_231 , V_190 , NULL , 0x0 , NULL , V_192 } } ,
{ & V_134 , { L_155 , L_156 , V_221 , V_195 , NULL , 0x0 , NULL , V_192 } } ,
} ;
static T_12 * V_241 [] =
{
& V_148 ,
...
static T_15 V_244 [] = {
{ & V_66 , { L_157 , V_245 , V_246 , L_158 , V_247 } } ,
{ & V_127 , { L_159 , V_245 , V_246 , L_160 , V_247 } } ,
} ;
T_16 * V_248 ;
T_17 * V_249 ;
V_151 = F_52 ( V_250 , L_15 , L_161 ) ;
F_53 ( V_151 , V_188 , F_54 ( V_188 ) ) ;
F_55 ( V_241 , F_54 ( V_241 ) ) ;
V_249 = F_56 ( V_151 ) ;
F_57 ( V_249 , V_244 , F_54 ( V_244 ) ) ;
F_58 ( & F_41 ) ;
F_59 ( & F_43 ) ;
V_248 = F_60 ( V_151 , NULL ) ;
F_61 ( V_248 , L_162 ,
L_163 ,
L_164 ,
& V_160 ) ;
...
V_176 = F_64 ( L_165 ) ;
V_9 = F_64 ( L_166 ) ;
F_65 ( L_167 , F_45 , L_168 , L_169 , V_151 , V_251 ) ;
F_65 ( L_170 , F_45 , L_171 , L_172 , V_151 , V_251 ) ;
}
void F_66 ( void )
{
V_147 = F_52 ( V_252 , L_173 , L_174 ) ;
}
void
F_67 ( void )
{
F_65 ( L_175 , F_45 , L_176 , L_177 , V_147 , V_251 ) ;
}
