...
V_32 = ( V_34 * ) F_10 ( sizeof( V_34 ) ) ;
V_33 = ( T_12 * ) F_10 ( sizeof( T_12 ) ) ;
* V_33 = F_96 ( V_22 -> V_4 -> V_7 , V_22 -> V_11 ) ;
F_97 ( V_32 , V_35 , 4 , V_33 ) ;
F_98 ( V_1 , V_32 ) ;
F_17 ( 1 ) ;
}
T_5 F_99 ( T_1 * V_1 ) {
...
V_32 = F_102 ( V_34 , 1 ) ;
V_36 = ( T_13 * ) F_103 ( NULL , V_22 -> V_4 -> V_7 , V_22 -> V_11 , V_22 -> V_8 ) ;
F_97 ( V_32 , V_37 , 6 , V_36 ) ;
F_98 ( V_1 , V_32 ) ;
F_17 ( 1 ) ;
}
T_5 F_104 ( T_1 * V_1 ) {
...
V_12 = F_33 () ;
if ( V_39 == 0 ) {
F_35 ( V_12 , ( const T_13 * ) F_103 ( F_114 () , V_22 -> V_4 -> V_7 , V_22 -> V_11 , V_22 -> V_8 ) , V_22 -> V_8 ) ;
F_37 ( V_1 , V_12 ) ;
F_107 ( V_1 , V_22 -> V_8 ) ;
}
else if ( ( V_39 & V_57 ) == 0 ) {
...
V_27 V_45 = 0 ;
T_6 * V_46 = F_133 ( V_22 -> V_4 -> V_7 , V_22 -> V_11 , V_22 -> V_8 ,
V_39 , V_12 , & V_45 ) ;
if ( ! V_46 || V_45 == 0 ) {
F_134 ( V_12 , TRUE ) ;
F_109 ( V_1 ) ;
...
#define F_137 3
T_8 V_22 = F_60 ( V_1 , 1 ) ;
int V_58 = ( int ) F_26 ( V_1 , F_136 , 0 ) ;
int V_8 = ( int ) F_26 ( V_1 , F_137 , 1 ) ;
if ( ! ( V_22 && V_22 -> V_4 ) ) return 0 ;
if ( V_22 -> V_4 -> V_5 ) {
F_32 ( V_1 , L_2 ) ;
return 0 ;
}
if ( ( V_58 + V_8 ) > ( V_22 -> V_8 << 3 ) ) {
F_32 ( V_1 , L_21 ) ;
return 0 ;
}
if ( V_8 <= 8 ) {
F_21 ( V_1 , ( V_25 ) ( V_13 ) F_138 ( V_22 -> V_4 -> V_7 , V_22 -> V_11 * 8 + V_58 , V_8 ) ) ;
return 1 ;
} else if ( V_8 <= 16 ) {
F_21 ( V_1 , F_139 ( V_22 -> V_4 -> V_7 , V_22 -> V_11 * 8 + V_58 , V_8 , FALSE ) ) ;
return 1 ;
} else if ( V_8 <= 32 ) {
F_21 ( V_1 , F_140 ( V_22 -> V_4 -> V_7 , V_22 -> V_11 * 8 + V_58 , V_8 , FALSE ) ) ;
return 1 ;
} else if ( V_8 <= 64 ) {
F_73 ( V_1 , F_141 ( V_22 -> V_4 -> V_7 , V_22 -> V_11 * 8 + V_58 , V_8 , FALSE ) ) ;
F_17 ( 1 ) ;
} else {
F_32 ( V_1 , L_22 , V_8 ) ;
return 0 ;
...
#define F_144 3
T_8 V_22 = F_60 ( V_1 , 1 ) ;
int V_11 = ( int ) F_26 ( V_1 , F_143 , 0 ) ;
int V_8 ;
if ( ! ( V_22 && V_22 -> V_4 ) ) return 0 ;
V_8 = ( int ) F_26 ( V_1 , F_144 , V_22 -> V_8 - V_11 ) ;
if ( V_22 -> V_4 -> V_5 ) {
F_32 ( V_1 , L_2 ) ;
return 0 ;
}
...
T_8 V_22 = F_60 ( V_1 , 1 ) ;
#ifdef F_147
const T_7 * V_59 = F_148 ( V_1 , F_146 , L_23 ) ;
T_3 * V_60 ;
#endif
if ( ! ( V_22 && V_22 -> V_4 ) ) return 0 ;
if ( V_22 -> V_4 -> V_5 ) {
...
#ifdef F_147
V_60 = F_149 ( V_22 -> V_4 -> V_7 , V_22 -> V_4 -> V_7 , V_22 -> V_11 , V_22 -> V_8 ) ;
if ( V_60 ) {
F_150 ( V_61 , V_60 , V_59 ) ;
if ( F_44 ( V_1 , V_60 , 0 , F_13 ( V_60 ) ) ) {
F_17 ( 1 ) ;
}
}
#else
...
#define F_156 3
T_8 V_22 = F_60 ( V_1 , 1 ) ;
int V_11 = ( int ) F_26 ( V_1 , F_155 , 0 ) ;
int V_8 = ( int ) F_26 ( V_1 , F_156 , - 1 ) ;
if ( ! V_22 || ! V_22 -> V_4 ) return 0 ;
if ( V_22 -> V_4 -> V_5 ) {
F_32 ( V_1 , L_2 ) ;
return 0 ;
...
V_15 -> V_8 <= F_34 ( V_15 -> V_4 -> V_7 , V_15 -> V_11 ) &&
V_16 -> V_8 <= F_34 ( V_16 -> V_4 -> V_7 , V_16 -> V_11 ) )
{
