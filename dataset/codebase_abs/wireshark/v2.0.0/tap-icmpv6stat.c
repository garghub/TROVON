...
{
double V_8 , V_9 ;
V_8 = * ( const double * ) V_6 ;
V_9 = * ( const double * ) V_7 ;
if ( V_8 < V_9 )
return - 1 ;
if ( V_8 > V_9 )
return 1 ;
...
static T_4
F_4 ( void * V_1 , T_5 * T_6 V_10 , T_7 * T_8 V_10 , const void * V_11 )
{
T_1 * V_2 = ( T_1 * ) V_1 ;
const T_9 * V_12 = ( const T_9 * ) V_11 ;
double V_13 , * V_14 ;
if ( V_12 == NULL )
return FALSE ;
if ( V_12 -> V_15 ) {
...
static void
F_13 ( const char * V_31 , void * T_11 V_10 )
{
T_1 * V_2 ;
