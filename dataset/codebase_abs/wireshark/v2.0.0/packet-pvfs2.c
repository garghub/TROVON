...
{
T_7 V_81 ;
V_81 = ( ( T_7 ) F_5 ( V_1 , V_5 + 4 ) ) << 32 |
F_5 ( V_1 , V_5 ) ;
F_49 ( V_3 , V_41 , V_1 , V_5 , 8 , V_81 ) ;
if ( V_104 )
* V_104 = V_81 ;
return V_5 + 8 ;
}
...
if ( V_230 < V_228 )
{
F_101 ( V_233 , V_2 , & V_246 , V_1 , V_5 , - 1 ) ;
}
return V_5 ;
}
static int
...
static T_17 *
F_121 ( T_7 V_295 , T_6 V_299 )
{
T_17 * V_300 ;
T_16 * V_301 ;
V_301 = F_122 ( F_123 () , T_16 ) ;
V_301 -> V_295 = V_295 ;
V_300 = F_122 ( F_123 () , T_17 ) ;
F_124 ( V_298 , V_301 , V_300 ) ;
V_300 -> V_302 = V_299 ;
return V_300 ;
}
static T_10
...
V_81 = F_121 ( V_295 , V_2 -> V_315 -> V_299 ) ;
}
else
{
T_16 V_297 ;
...
V_297 . V_295 = V_295 ;
V_81 = ( T_17 * ) F_127 ( V_298 , & V_297 ) ;
if ( V_81 && ! V_2 -> V_315 -> V_316 . V_317 )
{
if ( V_81 -> V_318 == 0 )
V_81 -> V_318 = V_2 -> V_315 -> V_299 ;
else
{
if ( V_81 -> V_319 == 0 )
V_81 -> V_319 = V_2 -> V_315 -> V_299 ;
}
}
}
if ( V_81 && ( V_81 -> V_319 == V_2 -> V_315 -> V_299 ) )
{
F_125 ( V_2 -> V_20 , V_21 , L_29 ) ;
F_14 ( V_304 , V_320 , V_1 , V_5 , - 1 , V_77 ) ;
return TRUE ;
}
V_5 = F_88 ( V_1 , V_305 , V_5 ) ;
F_128 ( V_2 -> V_20 , V_21 ,
...
F_132 ( F_87 ) , 0 , NULL , V_325 } } ,
{ & V_191 ,
{ L_47 , L_48 , V_323 , V_326 ,
F_131 ( V_330 ) , 0 , NULL , V_325 } } ,
{ & V_192 ,
{ L_49 , L_50 , V_323 , V_326 ,
F_131 ( V_321 ) , 0 , NULL , V_325 } } ,
#if 0
{ &hf_pvfs_handle,
...
F_131 ( V_331 ) , 0 , L_58 , V_325 } } ,
{ & V_40 ,
{ L_59 , L_60 , V_323 , V_324 ,
F_131 ( V_332 ) , 0 , L_61 , V_325 } } ,
{ & V_18 ,
{ L_62 , L_63 , V_323 , V_324 ,
F_131 ( V_19 ) , 0 , NULL , V_325 } } ,
{ & V_121 ,
...
F_131 ( V_337 ) , 0 , NULL , V_325 } } ,
{ & V_139 ,
{ L_119 , L_120 , V_323 , V_326 ,
F_131 ( V_338 ) , 0 , NULL , V_325 } } ,
{ & V_142 ,
{ L_121 , L_122 , V_323 , V_326 ,
F_131 ( V_339 ) , 0 , NULL , V_325 } } ,
{ & V_248 ,
...
V_307 = F_133 ( L_280 ,
L_27 , L_281 ) ;
F_134 ( V_307 , V_322 , F_135 ( V_322 ) ) ;
F_136 ( V_345 , F_135 ( V_345 ) ) ;
V_351 = F_137 ( V_307 ) ;
F_138 ( V_351 , V_346 , F_135 ( V_346 ) ) ;
F_139 ( F_117 ) ;
F_140 ( F_119 ) ;
V_350 = F_141 ( V_307 , NULL ) ;
F_142 ( V_350 , L_282 ,
L_283 ,
L_284
L_285 ,
...
{
T_23 V_352 ;
V_352 = F_144 ( F_6 , V_307 ) ;
F_145 ( L_286 , V_353 , V_352 ) ;
F_146 ( L_287 , F_6 , L_288 , L_289 , V_307 , V_354 ) ;
}
