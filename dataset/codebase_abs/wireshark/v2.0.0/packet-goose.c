...
if( V_30 != 8 )
{
F_28 ( T_9 , T_7 -> V_36 , & V_37 , T_4 , T_5 , V_30 ) ;
if( T_10 >= 0 )
{
F_29 ( T_9 , T_10 , T_4 , T_5 , V_30 , L_1 ) ;
}
return T_5 ;
}
V_31 = F_30 ( T_4 , T_5 ) ;
V_32 = F_31 ( T_4 , T_5 + 4 ) * 0x100 ;
V_33 = ( T_11 ) ( ( ( V_38 ) V_32 * F_32 ( 1000000000 ) ) / F_32 ( 0x100000000 ) ) ;
V_34 . V_39 = V_31 ;
V_34 . V_40 = V_33 ;
V_35 = F_33 ( F_34 () , & V_34 , V_41 , TRUE ) ;
if( T_10 >= 0 )
{
F_29 ( T_9 , T_10 , T_4 , T_5 , V_30 , V_35 ) ;
}
return T_5 ;
return T_5 ;
}
...
T_5 = F_47 ( T_2 , T_7 , T_9 , T_4 , T_5 , T_10 , NULL ) ;
return T_5 ;
}
static int
...
static void
F_52 ( T_3 * T_4 , T_14 * V_36 , T_8 * V_51 )
{
int T_5 = 0 ;
int V_52 ;
T_15 V_53 ;
...
T_8 * T_9 = NULL ;
T_6 V_55 ;
F_53 ( & V_55 , V_56 , TRUE , V_36 ) ;
F_54 ( V_36 -> V_57 , V_58 , V_59 ) ;
F_55 ( V_36 -> V_57 , V_60 ) ;
if ( V_51 ) {
V_54 = F_56 ( V_51 , V_61 , T_4 , 0 , - 1 , V_62 ) ;
T_9 = F_57 ( V_54 , V_63 ) ;
F_56 ( T_9 , V_64 , T_4 , T_5 , 2 , V_65 ) ;
V_53 = F_58 ( T_4 , T_5 + 2 ) ;
F_56 ( T_9 , V_66 , T_4 , T_5 + 2 , 2 , V_65 ) ;
F_56 ( T_9 , V_67 , T_4 , T_5 + 4 , 2 , V_65 ) ;
F_56 ( T_9 , V_68 , T_4 , T_5 + 6 , 2 , V_65 ) ;
T_5 = 8 ;
while ( T_5 < V_53 ) {
V_52 = T_5 ;
T_5 = F_51 ( FALSE , T_4 , T_5 , & V_55 , T_9 , - 1 ) ;
if ( T_5 == V_52 ) {
F_28 ( T_9 , V_36 , & V_69 , T_4 , T_5 , - 1 ) ;
return;
}
}
}
...
{
{ & V_64 ,
{ L_2 , L_3 , V_71 , V_72 , NULL , 0x0 , NULL , V_73 } } ,
{ & V_66 ,
{ L_4 , L_5 , V_71 , V_74 , NULL , 0x0 , NULL , V_73 } } ,
{ & V_67 ,
{ L_6 , L_7 , V_71 , V_72 , NULL , 0x0 , NULL , V_73 } } ,
{ & V_68 ,
{ L_8 , L_9 , V_71 , V_72 , NULL , 0x0 , NULL , V_73 } } ,
...
{ & V_81 ,
{ L_18 , L_19 ,
V_82 , V_74 , F_60 ( V_83 ) , 0 ,
L_20 , V_73 } } ,
{ & V_84 ,
{ L_21 , L_22 ,
V_82 , V_74 , F_60 ( V_85 ) , 0 ,
L_23 , V_73 } } ,
{ & V_86 ,
{ L_24 , L_25 ,
V_82 , V_74 , F_60 ( V_87 ) , 0 ,
L_26 , V_73 } } ,
{ & V_88 ,
{ L_27 , L_28 ,
V_76 , V_77 , NULL , 0 ,
...
{ & V_109 ,
{ L_64 , L_65 ,
V_82 , V_74 , F_60 ( V_110 ) , 0 ,
NULL , V_73 } } ,
{ & V_111 ,
{ L_66 , L_67 ,
V_80 , V_74 , F_60 ( V_112 ) , 0 ,
L_68 , V_73 } } ,
{ & V_113 ,
{ L_43 , L_44 ,
V_80 , V_74 , NULL , 0 ,
...
static T_19 V_152 [] = {
{ & V_37 , { L_136 , V_153 , V_154 , L_137 , V_155 } } ,
{ & V_69 , { L_138 , V_156 , V_157 , L_139 , V_155 } } ,
} ;
T_20 * V_158 ;
V_61 = F_61 ( V_59 , V_159 , V_160 ) ;
F_62 ( L_140 , F_52 , V_61 ) ;
F_63 ( V_61 , V_70 , F_64 ( V_70 ) ) ;
F_65 ( V_151 , F_64 ( V_151 ) ) ;
V_158 = F_66 ( V_61 ) ;
F_67 ( V_158 , V_152 , F_64 ( V_152 ) ) ;
}
void F_68 ( void ) {
T_21 V_161 ;
V_161 = F_69 ( L_140 ) ;
F_70 ( L_141 , V_162 , V_161 ) ;
}
