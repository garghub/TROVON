...
if ( ! F_9 ( V_1 , 3 , V_2 ) )
return FALSE ;
if ( ! F_10 ( V_1 , & V_21 , sizeof V_21 , V_2 , V_13 ) )
return FALSE ;
if ( V_21 == 0xba ) {
T_8 V_22 ;
T_8 V_23 ;
T_11 V_24 ;
T_10 V_25 ;
if ( ! F_10 ( V_1 , & V_22 , sizeof V_22 , V_2 , V_13 ) )
return FALSE ;
...
T_13 V_36 ;
if ( ! F_10 ( V_1 , & V_36 , sizeof V_36 , V_2 , V_13 ) )
return FALSE ;
V_36 = F_12 ( V_36 ) ;
V_17 = 6 + V_36 ;
}
...
static T_3
F_18 ( T_4 * V_8 , int * V_2 , T_6 * * V_13 , T_2 * V_44 )
{
* V_44 = F_2 ( V_8 -> V_1 ) ;
...
struct V_50 * V_51 ;
T_7 * V_14 ;
if ( ! F_10 ( V_8 -> V_1 , V_49 , sizeof V_49 ,
V_2 , V_13 ) ) {
if ( * V_2 != V_48 )
return V_52 ;
return V_53 ;
