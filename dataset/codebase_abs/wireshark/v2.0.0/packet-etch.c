...
F_54 ( V_93 -> V_97 , TRUE ) ;
F_55 ( V_93 -> V_97 , V_103 , L_15 , F_49 ( V_96 ) ) ;
}
if ( V_94 ) {
unsigned int V_51 ;
T_14 * V_68 ;
...
if ( V_99 > 0 ) {
F_54 ( V_93 -> V_97 , TRUE ) ;
F_61 ( V_93 -> V_97 , V_103 , L_17 , V_99 + 1 ) ;
}
return 1 ;
}
static void
...
static T_1 V_134 = 0 ;
if( ! V_133 ) {
F_74 ( L_67 , F_58 , L_68 , L_69 , V_104 , V_135 ) ;
V_133 = TRUE ;
}
if( V_134 != 0 && V_134 != V_132 ) {
F_75 ( L_64 , V_134 , V_129 ) ;
}
if( V_132 != 0 && V_134 != V_132 ) {
F_76 ( L_64 , V_132 , V_129 ) ;
}
V_134 = V_132 ;
