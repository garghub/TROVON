...
static int
F_33 ( T_9 * V_20 , T_10 * V_21 , T_11 * V_82 , void * V_83 )
{
int V_50 = 0 ;
int V_84 ;
T_14 * V_29 ;
...
T_19 * V_68 = NULL ;
T_22 V_86 ;
F_34 ( & V_86 , V_87 , TRUE , V_21 ) ;
if ( V_83 == NULL )
return 0 ;
V_86 . V_88 = V_83 ;
V_89 = V_82 ;
V_85 = F_35 ( V_21 ) ;
V_68 = ( T_19 * ) F_36 ( V_85 , V_90 ) ;
if ( V_68 == NULL ) {
V_68 = ( T_19 * ) F_37 ( sizeof( T_19 ) ) ;
V_68 -> V_74 = F_38 ( F_21 , F_22 ) ;
V_68 -> V_75 = F_38 ( F_23 , F_24 ) ;
F_39 ( V_85 , V_90 , V_68 ) ;
V_68 -> V_91 = V_69 ;
V_69 = V_68 ;
}
V_29 = F_10 ( V_82 , V_90 , V_20 , 0 , - 1 , V_31 ) ;
V_22 = F_11 ( V_29 , V_92 ) ;
F_12 ( V_21 -> V_33 , V_34 , L_7 ) ;
F_40 ( V_21 -> V_33 , V_49 ) ;
while ( F_41 ( V_20 , V_50 ) > 0 ) {
V_84 = V_50 ;
V_50 = F_42 ( FALSE , V_20 , V_50 , & V_86 , V_22 , - 1 ) ;
if( V_50 == V_84 ) {
...
static T_24 V_109 [] = {
{ & V_56 , { L_18 , V_110 , V_111 , L_19 , V_112 } } ,
{ & V_93 , { L_20 , V_110 , V_111 , L_8 , V_112 } } ,
} ;
T_25 * V_113 ;
V_90 = F_50 ( V_114 , V_115 , V_116 ) ;
F_51 ( L_21 , F_33 , V_90 ) ;
F_52 ( V_90 , V_95 , F_53 ( V_95 ) ) ;
F_54 ( V_100 , F_53 ( V_100 ) ) ;
V_113 = F_55 ( V_90 ) ;
F_56 ( V_113 , V_109 , F_53 ( V_109 ) ) ;
V_53 = F_57 ( L_1 , L_22 , V_117 , V_97 ) ;
