...
V_16 -> V_35 = V_12 -> V_36 -> V_37 ;
V_16 -> V_38 = V_12 -> V_39 ;
V_16 -> V_40 = V_12 -> V_41 ;
V_16 -> V_42 = F_13 ( F_14 ( V_12 -> V_43 ) ) ;
if ( V_13 -> V_44 == NULL )
{
V_16 -> V_45 = F_15 ( L_1 V_46 L_2 , V_13 -> V_47 ) ;
}
else
{
V_16 -> V_45 = F_15 ( L_3 V_46 L_2 , V_13 -> V_44 , V_13 -> V_47 ) ;
}
if ( V_14 . type == V_23 )
{
V_17 = F_16 ( V_12 -> V_48 , V_14 . V_13 . V_24 . V_24 , sizeof( V_14 . V_13 . V_24 . V_24 ) ) ;
V_18 = F_16 ( V_12 -> V_48 , V_15 . V_13 . V_24 . V_24 , sizeof( V_15 . V_13 . V_24 . V_24 ) ) ;
V_16 -> V_49 = F_15 ( L_4 V_50 L_5 ,
V_17 ,
V_18 ,
V_13 -> V_51 ) ;
}
...
{
V_16 -> V_49 = F_15 ( L_6 V_46 L_7 V_52 L_8 V_46 L_7 V_52 L_9 V_50 L_5 ,
V_14 . V_13 . V_26 . V_27 ,
F_17 ( V_12 -> V_48 , & ( V_14 . V_13 . V_26 . V_29 ) ) ,
V_14 . V_13 . V_26 . V_30 ,
V_15 . V_13 . V_26 . V_27 ,
F_17 ( V_12 -> V_48 , & ( V_15 . V_13 . V_26 . V_29 ) ) ,
V_15 . V_13 . V_26 . V_30 ,
V_13 -> V_51 ) ;
}
V_16 -> V_53 = ( V_54 ) F_18 ( V_13 -> V_51 ) ;
V_16 -> V_55 = TRUE ;
V_16 -> V_56 = 1 ;
F_19 ( V_1 . V_2 -> V_57 , V_16 ) ;
return ( 1 ) ;
}
static T_11 F_20 ( void * T_5 V_6 , T_6 * V_12 , T_12 * T_13 V_6 , const void * V_13 )
{
const T_7 * V_58 = ( const T_7 * ) V_13 ;
if ( ( V_1 . V_8 == V_9 ) || ( V_12 -> V_36 -> V_59 . V_60 == 1 ) )
{
F_9 ( V_12 , V_58 ) ;
return ( TRUE ) ;
}
