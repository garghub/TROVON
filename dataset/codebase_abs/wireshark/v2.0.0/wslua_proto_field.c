...
if ( F_14 ( V_13 , F_34 ) ) {
type = (enum V_1 ) F_42 ( V_13 , F_34 ) ;
} else {
type = F_1 ( F_27 ( V_13 , F_34 ) ) ;
}
V_26 = F_26 ( V_13 , F_33 , type ) ;
if ( F_14 ( V_13 , F_36 ) ) {
V_8 = ( unsigned ) F_43 ( V_13 , F_36 , V_12 ) ;
} else {
V_8 = F_5 ( F_41 ( V_13 , F_36 , L_13 ) ) ;
}
switch ( type ) {
case V_38 :
if ( V_8 != V_12 ) {
...
if ( V_8 == V_12 ) {
V_8 = V_53 ;
} else if ( V_8 < V_53 || V_8 > V_54 ) {
F_44 ( F_31 , V_39 , L_17
L_18 ) ;
return 0 ;
}
if ( ( V_8 == V_55 || V_8 == V_56 ) &&
( type == V_48 || type == V_49 || type == V_50 || type == V_51 || type == V_52 ) )
{
F_44 ( F_31 , V_39 , L_19 ) ;
return 0 ;
}
if ( V_29 >= F_35 && ! F_8 ( V_13 , F_35 ) ) {
if ( type == V_47 || type == V_52 ) {
V_35 = F_21 ( V_13 , F_35 ) ;
} else {
V_34 = F_6 ( V_13 , F_35 ) ;
}
...
unsigned V_95 = ( type == V_38 ) ? V_12 : V_53 ;
unsigned V_8 = ( unsigned ) F_43 ( V_13 , 3 , V_95 ) ;
enum V_31 V_32 = V_33 ;
T_3 * V_34 = NULL ;
T_6 * V_35 = NULL ;
...
const T_1 * V_26 = F_26 ( V_13 , 1 , type ) ;
const T_1 * V_30 = F_41 ( V_13 , 2 , V_26 ) ;
unsigned V_8 = ( unsigned ) F_43 ( V_13 , 3 , V_12 ) ;
T_7 * V_21 = NULL ;
T_11 V_36 = F_40 ( V_13 , 5 , 0 ) ;
const T_1 * V_37 = F_41 ( V_13 , 6 , NULL ) ;
if ( V_36 == 0x0 && V_8 != V_12 ) {
...
const T_1 * V_26 = NULL ;
const T_1 * V_30 = F_41 ( V_13 , 2 , V_26 ) ;
unsigned V_8 = ( unsigned ) F_43 ( V_13 , 3 , V_59 ) ;
const T_1 * V_37 = NULL ;
if ( type == V_58 ) {
V_26 = F_26 ( V_13 , 1 , type ) ;
V_37 = F_41 ( V_13 , 4 , NULL ) ;
