...
F_5 ( T_2 -> V_19 , V_20 , L_1 ) ;
F_13 ( T_2 -> V_19 , V_21 ) ;
V_27 = F_14 ( V_25 , V_32 , V_3 , 0 , - 1 , L_6 ) ;
V_2 = F_15 ( V_27 , V_33 ) ;
V_28 = F_16 ( V_3 , V_4 ) ;
...
V_37 = F_18 ( V_3 , V_4 ) & 0x0f ;
V_4 += 1 ;
V_29 = ( T_16 * ) F_19 ( V_26 -> V_29 , V_37 ) ;
if( ! V_29 ) {
V_29 = F_10 ( F_11 () , T_16 ) ;
V_29 -> V_46 = 0xff ;
V_29 -> V_47 = NULL ;
F_20 ( V_26 -> V_29 , V_37 , V_29 ) ;
}
V_30 = ( T_17 * ) F_19 ( V_26 -> V_30 , T_2 -> V_48 -> V_49 ) ;
if( ! V_30 ) {
V_30 = F_10 ( F_11 () , T_17 ) ;
V_30 -> V_37 = V_37 ;
V_30 -> V_50 = 0xffff ;
...
V_30 -> V_54 = V_39 ;
V_30 -> V_55 = 0 ;
V_30 -> V_56 = T_2 -> V_48 -> V_57 ;
V_30 -> V_58 = T_2 -> V_48 -> V_49 ;
V_30 -> V_59 = 0 ;
V_30 -> V_38 = 0 ;
V_30 -> V_60 = 0 ;
V_30 -> V_61 = NULL ;
F_20 ( V_26 -> V_30 , T_2 -> V_48 -> V_49 , V_30 ) ;
}
F_2 ( V_2 , V_62 , V_3 , V_4 , 1 , V_24 ) ;
V_35 = F_18 ( V_3 , V_4 ) & 0x1f ;
V_4 += 1 ;
V_36 = V_35 ;
if( V_36 > F_21 ( V_3 , V_4 ) ) {
V_36 = F_21 ( V_3 , V_4 ) ;
}
if( V_36 ) {
V_34 = F_22 ( V_3 , V_4 , V_36 , V_35 ) ;
F_23 ( V_34 , T_2 , V_25 , V_63 , V_30 , V_29 ) ;
}
return F_8 ( V_3 ) ;
}
...
V_4 += 4 ;
F_2 ( V_2 , V_67 , V_3 , V_4 , 1 , V_24 ) ;
V_64 = F_18 ( V_3 , V_4 ) ;
V_30 = ( T_17 * ) F_24 ( V_26 -> V_30 , T_2 -> V_48 -> V_49 ) ;
if( ! V_30 ) {
return F_8 ( V_3 ) ;
}
V_30 -> V_59 = T_2 -> V_48 -> V_49 ;
V_29 = ( T_16 * ) F_19 ( V_26 -> V_29 , V_30 -> V_37 ) ;
if( ! V_29 ) {
return F_8 ( V_3 ) ;
}
if( ! V_64 ) {
...
{
const T_19 V_68 [] = { 0x55 , 0x53 , 0x42 , 0x43 } ;
const T_19 V_69 [] = { 0x55 , 0x53 , 0x42 , 0x53 } ;
if ( F_17 ( V_3 ) < 4 )
return FALSE ;
if ( F_28 ( V_3 , 0 , V_68 , sizeof( V_68 ) ) == 0 ||
F_28 ( V_3 , 0 , V_69 , sizeof( V_69 ) ) == 0 ) {
...
{ & V_67 ,
{ L_25 , L_26 , V_75 , V_72 ,
F_30 ( V_77 ) , 0x0 , NULL , V_73 } } ,
{ & V_23 ,
{ L_27 , L_28 , V_75 , V_72 , F_30 ( V_22 ) , 0x0 ,
NULL , V_73 } } ,
{ & V_6 ,
{ L_29 , L_30 , V_78 , V_72 , NULL , 0x0 ,
NULL , V_73 } } ,
{ & V_8 ,
{ L_31 , L_32 , V_78 , V_74 , NULL , 0x0 ,
NULL , V_73 } } ,
{ & V_9 ,
{ L_33 , L_34 , V_78 , V_74 , NULL , 0x0 ,
NULL , V_73 } } ,
{ & V_10 ,
{ L_35 , L_36 , V_75 , V_74 , NULL , 0x0 ,
NULL , V_73 } } ,
} ;
static T_10 * V_79 [] = {
& V_33 ,
} ;
V_32 = F_31 ( L_6 , L_1 , L_37 ) ;
F_32 ( V_32 , V_70 , F_33 ( V_70 ) ) ;
F_34 ( V_79 , F_33 ( V_79 ) ) ;
F_35 ( L_37 , F_9 , V_32 ) ;
}
void
...
V_81 = F_39 ( F_4 , V_32 ) ;
F_38 ( L_39 , V_82 , V_81 ) ;
F_40 ( L_38 , F_27 , L_40 , L_41 , V_32 , V_83 ) ;
}
