...
F_16 ( F_15 () , & ( V_14 -> V_24 ) , & V_21 [ V_15 ] . V_24 ) ;
...
T_3 * V_57 = NULL ;
int V_15 ;
F_26 ( V_2 -> V_58 , V_59 , L_1 ) ;
V_56 = F_27 ( V_3 , V_60 , V_1 , 0 , - 1 , V_61 ) ;
V_57 = F_28 ( V_56 , V_62 ) ;
for ( V_15 = 0 ; V_15 < V_20 ; V_15 ++ ) {
V_21 [ V_15 ] . V_43 = V_63 ;
}
return F_29 ( V_1 , V_2 , V_57 , T_4 ) ;
}
void F_30 ( void )
{
T_15 * V_64 ;
...
T_18 * V_86 ;
V_60 = F_31 ( V_87 , V_88 , V_89 ) ;
F_32 ( V_60 , V_65 , F_33 ( V_65 ) ) ;
F_34 ( V_74 , F_33 ( V_74 ) ) ;
V_86 = F_35 ( V_60 ) ;
F_36 ( V_86 , V_78 , F_33 ( V_78 ) ) ;
F_37 ( L_16 , F_25 , V_60 ) ;
V_64 = F_38 ( V_60 , NULL ) ;
for ( V_15 = 0 ; V_15 < 16 ; V_15 ++ ) {
F_39 ( V_64 , V_90 [ V_15 ] . V_91 , V_90 [ V_15 ] . V_92 , V_90 [ V_15 ] . V_93 , V_55 [ V_15 ] , V_94 , FALSE ) ;
}
V_5 = F_40 ( L_17 , L_18 , V_95 , V_96 ) ;
V_7 = F_40 ( L_19 , L_20 , V_95 , V_96 ) ;
V_9 = F_40 ( L_21 , L_22 , V_97 , V_68 ) ;
V_10 = F_40 ( L_23 , L_24 , V_97 , V_68 ) ;
V_11 = F_40 ( L_25 , L_26 , V_97 , V_68 ) ;
F_41 ( F_21 ) ;
F_42 ( F_23 ) ;
}
void
