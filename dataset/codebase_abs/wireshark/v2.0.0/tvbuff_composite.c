...
V_1 -> V_8 = ( T_4 * ) F_12 ( NULL , V_1 , 0 , - 1 ) ;
return V_1 -> V_8 + V_13 ;
}
F_13 () ;
}
static void *
F_14 ( T_1 * V_1 , void * V_21 , T_3 V_13 , T_3 V_14 )
{
struct V_2 * V_3 = (struct V_2 * ) V_1 ;
T_4 * V_22 = ( T_4 * ) V_21 ;
T_3 V_15 , V_16 ;
...
if ( F_10 ( V_17 , V_18 , V_14 ) ) {
F_9 ( ! V_1 -> V_8 ) ;
return F_15 ( V_17 , V_22 , V_18 , V_14 ) ;
}
else {
V_23 = F_16 ( V_17 , V_18 ) ;
F_9 ( V_23 > 0 ) ;
F_15 ( V_17 , V_22 , V_18 , V_23 ) ;
V_13 += V_23 ;
V_14 -= V_23 ;
if ( V_14 > 0 ) {
F_14 ( V_1 , V_22 + V_23 , V_13 , V_14 ) ;
}
return V_22 ;
}
F_13 () ;
