...
T_2 *
F_9 ( const T_1 * string , const T_3 V_9 , const T_1 V_18 )
{
static T_2 * V_10 [ 3 ] ;
static int V_11 [ 3 ] ;
static int V_12 ;
...
T_4
F_11 ( const char * V_19 , T_6 * V_20 , T_4 V_21 )
{
T_5 V_22 ;
...
T_4
F_16 ( const T_2 * V_19 , T_6 * V_20 , const T_2 * * V_39 ,
...
return FALSE ;
V_22 = ( T_5 ) strtoul ( V_46 , NULL , 16 ) ;
F_14 ( V_20 , & V_22 , 1 ) ;
} else {
F_14 ( V_20 , ( const T_5 * ) V_23 , 1 ) ;
}
V_23 ++ ;
}
return TRUE ;
...
const T_2 *
F_18 ( const T_6 * V_20 , const T_2 * V_48 )
{
static T_2 * V_10 [ 3 ] ;
static T_7 V_11 [ 3 ] ;
static T_7 V_12 ;
...
return NULL ;
V_54 = F_20 () ;
F_14 ( V_54 , V_53 -> V_1 , V_53 -> V_9 ) ;
return V_54 ;
}
T_4
F_21 ( const char * V_55 , T_6 * V_20 )
{
return F_22 ( V_55 , V_20 , TRUE ) ;
}
T_4
F_22 ( const char * V_55 , T_6 * V_20 , T_4 V_56 )
{
T_9 V_57 , V_58 , V_59 , V_16 ;
...
T_5 *
F_31 ( const char * string , T_3 * V_73 )
{
T_3 V_74 ;
const char * V_23 ;
T_2 V_15 ;
...
char *
F_33 ( const char * string , T_4 V_76 )
{
if ( V_76 ) {
return F_34 ( string , - 1 ) ;
} else {
return F_35 ( string ) ;
}
}
char *
F_36 ( const char * V_67 , const char * V_69 )
{
T_11 V_77 = strlen ( V_67 ) ;
T_11 V_78 = strlen ( V_69 ) ;
while ( V_77 -- >= V_78 ) {
if ( ! F_37 ( V_67 , V_69 , V_78 ) )
return ( char * ) V_67 ;
V_67 ++ ;
}
return NULL ;
...
char *
F_40 ( char * V_61 , const char * string )
{
const T_2 * V_23 ;
T_2 V_15 ;
char * V_80 ;
...
F_41 ( V_81 , sizeof( V_81 ) , L_9 , ( unsigned char ) V_15 ) ;
* V_80 ++ = '\\' ;
* V_80 ++ = 'x' ;
* V_80 ++ = V_81 [ 0 ] ;
* V_80 ++ = V_81 [ 1 ] ;
...
void
F_43 ( unsigned char * V_85 , const unsigned char * V_86 , int V_9 )
{
int V_16 , V_87 ;
T_12 V_61 ;
for ( V_16 = 0 , V_87 = 0 ; V_87 < V_9 ; V_87 ++ ) {
V_61 = F_42 ( V_86 [ V_87 ] ) ;
V_16 += F_44 ( V_61 , & ( V_85 [ V_16 ] ) ) ;
}
V_85 [ V_16 ] = 0 ;
return;
}
T_2 *
F_45 ( const T_2 * V_88 , const T_2 V_18 )
{
const T_2 * V_23 ;
T_2 * V_24 , * V_89 ;
if( ! V_88 )
...
T_2 *
F_46 ( const T_2 * V_88 , const char V_18 )
{
const T_2 * V_23 ;
T_2 * V_24 , * V_89 ;
if( ! V_88 )
...
T_2 *
F_47 ( const T_2 * V_88 , const T_2 * V_90 , const T_2 * V_91 )
{
T_2 * * V_92 ;
T_2 * V_89 ;
if ( ! V_88 || ! V_90 ) {
