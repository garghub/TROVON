...
static T_10 *
F_22 ( T_11 V_45 , T_3 * V_2 , T_6 * V_14 , T_2 * V_1 , T_12 * V_46 , T_7 * V_47 )
{
T_10 * V_48 ;
T_5 * V_49 ;
if ( ! F_23 ( V_14 ) ) {
...
V_48 = F_24 ( F_25 () , T_10 ) ;
V_48 -> V_50 = F_26 ( V_14 ) ;
V_48 -> V_51 = V_14 -> V_52 -> V_53 ;
F_27 ( V_46 -> V_54 , V_47 , V_48 , 0 ) ;
} else {
V_48 = ( T_10 * ) F_28 ( V_46 -> V_54 , V_47 , 0 ) ;
if ( V_48 ) {
V_48 -> V_55 = F_26 ( V_14 ) ;
}
}
...
F_6 ( V_49 ) ;
if ( ! V_45 ) {
F_29 ( & V_56 , & V_14 -> V_52 -> V_53 , & V_48 -> V_51 ) ;
V_49 = F_30 ( V_1 , V_59 , V_2 , 0 , 0 , & V_56 ) ;
F_6 ( V_49 ) ;
if ( F_31 ( & V_60 , & V_56 ) < 0 )
...
if( V_63 ) {
if( F_35 ( ( char * ) F_8 ( F_9 () , V_2 , V_3 , V_15 - V_3 , V_10 ) , V_21 ) )
F_36 ( V_1 , V_64 , V_2 , V_3 , V_15 - V_3 , ( const struct V_65 * ) V_21 ) ;
else
...
V_5 = F_19 ( V_1 , V_67 , V_2 , V_3 , 0 , ( ( T_9 * ) ( V_14 -> V_70 . V_72 ) ) [ 0 ] ) ;
else
V_5 = F_36 ( V_1 , V_64 , V_2 , V_3 , 0 , ( const struct V_65 * ) ( V_14 -> V_70 . V_72 ) ) ;
F_6 ( V_5 ) ;
...
static int
F_38 ( T_3 * V_2 , T_6 * V_14 , T_2 * V_73 , void * V_72 V_74 )
{
T_11 V_75 = FALSE ;
T_1 V_15 = 0 ;
T_1 V_7 = 0 ;
...
if( V_15 == - 1 )
return 0 ;
F_40 ( V_14 -> V_83 , V_84 , L_11 ) ;
F_41 ( V_14 -> V_83 , V_85 ) ;
V_5 = F_3 ( V_73 , V_86 , V_2 , 0 , - 1 , V_11 ) ;
V_1 = F_4 ( V_5 , V_87 ) ;
F_3 ( V_1 , V_88 , V_2 , 0 , V_15 , V_10 | V_11 ) ;
V_47 = F_8 ( F_9 () , V_2 , 0 , V_15 , V_10 ) ;
...
V_5 = F_3 ( V_1 , V_97 , V_2 , V_7 , ( T_1 ) strlen ( L_18 ) , V_10 | V_11 ) ;
V_77 = F_8 ( F_9 () , V_2 , V_7 , ( T_1 ) strlen ( L_18 ) , V_10 ) ;
...
if( F_35 ( ( char * ) F_8 ( F_9 () , V_2 , V_15 , V_7 - V_15 , V_10 ) , V_21 ) )
F_36 ( V_1 , V_106 , V_2 , V_15 , V_7 - V_15 , ( const struct V_65 * ) V_21 ) ;
else
...
if ( F_35 ( ( char * ) F_8 ( F_9 () , V_2 , V_15 , V_62 , V_10 ) , V_21 ) ) {
V_80 . type = V_119 ;
V_80 . V_118 = 16 ;
V_80 . V_72 = F_57 ( F_9 () , V_21 , 16 ) ;
F_36 ( V_1 , V_106 , V_2 , V_15 , V_62 , ( const struct V_65 * ) V_21 ) ;
}
else
...
if ( V_120 ) {
if ( V_80 . V_118 )
F_58 ( V_14 , & V_80 , V_81 , 0 , L_11 , V_14 -> V_52 -> V_121 , 0 , NULL ) ;
}
if ( V_122 ) {
if ( V_80 . V_118 )
F_59 ( V_14 , & V_80 , V_81 + 1 , 0 , L_11 , V_14 -> V_52 -> V_121 ) ;
}
}
break;
default:
...
F_64 ( V_86 , V_126 , F_65 ( V_126 ) ) ;
F_66 ( V_150 , F_65 ( V_150 ) ) ;
V_125 = F_67 ( V_86 ) ;
F_68 ( V_125 , V_143 , F_65 ( V_143 ) ) ;
V_124 = F_69 ( V_86 , V_152 ) ;
F_70 ( V_124 , L_111 ,
L_112 ,
L_112 ,
10 ,
...
static T_20 V_159 , V_160 ;
if( ! V_158 ) {
V_159 = F_72 ( F_38 , V_86 ) ;
V_160 = F_72 ( F_38 , V_86 ) ;
V_158 = TRUE ;
}
if( V_156 != 0 && V_156 != V_153 )
F_73 ( L_111 , V_156 , V_159 ) ;
if( V_153 != 0 && V_156 != V_153 )
F_21 ( L_111 , V_153 , V_159 ) ;
V_156 = V_153 ;
if( V_157 != 0 && V_157 != V_154 )
F_73 ( L_113 , V_157 , V_160 ) ;
if( V_154 != 0 && V_157 != V_154 )
F_21 ( L_113 , V_154 , V_160 ) ;
V_157 = V_154 ;
V_122 = F_74 ( L_122 ) ;
V_38 = F_74 ( L_123 ) ;
V_120 = F_74 ( L_124 ) ;
V_94 = F_74 ( L_125 ) ;
V_60 . V_161 = ( V_155 - V_155 % 1000 ) / 1000 ;
V_60 . V_162 = ( V_155 % 1000 ) * 1000 ;
}
