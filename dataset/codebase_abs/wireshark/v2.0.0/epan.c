...
void
F_84 ( T_9 * V_18 , struct V_31 * V_32 ,
...
#endif
F_78 () ;
F_85 ( V_18 , V_32 , V_25 , V_8 , V_33 ) ;
F_80 () ;
}
void
F_86 ( T_9 * V_18 , struct V_31 * V_32 ,
T_11 * V_25 , T_5 * V_8 , T_12 * V_33 )
{
F_78 () ;
F_82 ( V_18 ) ;
...
void
F_91 ( T_9 * V_18 , const T_13 * V_34 )
{
F_92 ( V_34 , V_18 -> V_24 ) ;
}
const T_1 *
F_93 ( T_9 * V_18 , T_14 * V_35 ,
T_15 V_36 ,
T_1 * V_37 ,
T_1 * V_38 , const int V_39 )
{
return F_94 ( V_18 -> V_24 , V_35 , V_36 , V_37 , V_38 , V_39 ) ;
}
void
F_95 ( T_9 * V_18 , const T_8 V_40 , const T_8 V_41 )
{
F_96 ( V_18 , V_18 -> V_21 . V_33 ) ;
F_97 ( & V_18 -> V_21 , V_40 , V_41 ) ;
}
T_8
F_98 ( T_9 * V_18 ,
const char * V_42 )
...
if ( V_44 < 0 )
return FALSE ;
V_43 = F_100 ( V_18 -> V_24 , V_44 ) ;
V_45 = ( V_43 -> V_46 > 0 ) ? TRUE : FALSE ;
F_101 ( V_43 , TRUE ) ;
return V_45 ;
}
void
...
F_103 ( V_47 , L_2 ) ;
#ifdef F_16
F_103 ( V_47 , L_11 V_51 ) ;
#else
F_103 ( V_47 , L_12 ) ;
#endif
F_103 ( V_47 , L_2 ) ;
#ifdef F_13
F_103 ( V_47 , L_13 V_52 ) ;
#else
F_103 ( V_47 , L_14 ) ;
#endif
F_103 ( V_47 , L_2 ) ;
...
void
F_110 ( T_17 * V_47
#if ! F_111 ( F_16 ) && ! F_111 ( F_13 )
V_53
#endif
)
{
#ifdef F_16
F_112 ( V_47 , L_20 , F_113 ( NULL ) ) ;
#endif
#ifdef F_13
F_112 ( V_47 , L_21 , F_14 ( NULL ) ) ;
#endif
}
