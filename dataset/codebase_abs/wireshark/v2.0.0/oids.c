...
T_7 * V_23 = ( T_7 * ) F_20 ( NULL , V_21 , V_9 , ':' ) ;
...
V_100 -> V_6 = F_47 ( L_44 , V_102 , V_103 ) ;
F_21 ( V_102 ) ;
F_21 ( V_103 ) ;
V_100 -> V_106 = - 2 ;
...
char * V_39 , * V_41 ;
if( ! V_10 || T_11 == 0 )
return F_10 ( V_184 , L_96 ) ;
V_39 = ( char * ) F_89 ( V_184 , ( ( T_11 ) * 11 ) + 2 ) ;
V_41 = V_39 ;
if ( ! V_185 )
* V_41 ++ = '.' ;
do {
V_41 += F_90 ( V_41 , 12 , L_97 , * V_10 ++ ) ;
} while( -- T_11 );
if ( V_41 != V_39 ) * ( V_41 - 1 ) = '\0' ; else * ( V_39 ) = '\0' ;
return V_39 ;
}
static T_6 F_91 ( const char * V_155 ) {
...
T_6 F_17 ( T_25 * V_184 , const char * V_155 , T_1 * * V_186 ) {
const char * V_40 = V_155 ;
T_1 * V_10 ;
T_1 * V_187 ;
T_6 V_13 = F_91 ( V_155 ) ;
...
* V_186 = V_10 = F_92 ( V_184 , T_1 , V_13 ) ;
V_187 = V_10 + V_13 ;
do switch( * V_40 ) {
case '.' :
V_4 = 0 ;
...
T_6 F_19 ( T_25 * V_184 , const T_8 * V_188 , T_9 V_9 , T_1 * * V_186 ) {
return F_93 ( V_184 , V_188 , V_9 , V_186 , TRUE ) ;
}
T_6 F_93 ( T_25 * V_184 , const T_8 * V_188 , T_9 V_9 , T_1 * * V_186 ,
T_18 V_189 ) {
T_9 V_11 ;
T_6 V_13 = V_189 ? 1 : 0 ;
T_1 * V_10 ;
T_1 * V_190 ;
T_26 V_4 = 0 ;
for ( V_11 = 0 ; V_11 < V_9 ; V_11 ++ ) { if ( ! ( V_188 [ V_11 ] & 0x80 ) ) V_13 ++ ; }
* V_186 = V_10 = ( T_1 * ) F_94 ( V_184 , sizeof( T_1 ) * V_13 ) ;
V_190 = V_10 + V_13 ;
if ( V_189 && V_13 == 1 ) {
* V_10 = 0 ;
return V_13 ;
}
else if ( ! V_189 && V_13 == 0 ) {
return V_13 ;
}
for ( V_11 = 0 ; V_11 < V_9 ; V_11 ++ ) {
T_8 V_191 = V_188 [ V_11 ] ;
V_4 <<= 7 ;
V_4 |= V_191 & 0x7F ;
if ( V_191 & 0x80 ) {
continue;
...
if ( V_189 ) {
T_1 V_192 = 0 ;
if ( V_4 >= 40 ) { V_192 ++ ; V_4 -= 40 ; }
if ( V_4 >= 40 ) { V_192 ++ ; V_4 -= 40 ; }
* V_10 ++ = V_192 ;
V_189 = FALSE ;
}
if( V_10 >= V_190 || V_4 > 0xffffffff ) {
F_9 ( V_184 , * V_186 ) ;
* V_186 = NULL ;
return 0 ;
}
...
T_2 * F_95 ( T_6 T_11 , T_1 * V_10 , T_6 * V_193 , T_6 * V_194 ) {
T_2 * V_195 = & V_1 ;
T_6 V_11 ;
if( ! ( V_10 && * V_10 <= 2 ) ) {
* V_193 = 0 ;
...
T_2 * V_196 = ( T_2 * ) F_6 ( V_195 -> V_2 , V_10 [ V_11 ] ) ;
if ( V_196 ) {
V_195 = V_196 ;
} else {
goto V_197;
...
T_2 * F_96 ( T_25 * V_184 , const T_8 * V_198 , T_9 V_199 , T_1 * * V_186 , T_6 * V_200 , T_6 * V_201 ) {
T_6 V_22 = F_19 ( V_184 , V_198 , V_199 , V_186 ) ;
return F_95 ( V_22 , * V_186 , V_200 , V_201 ) ;
}
T_2 * F_97 ( T_25 * V_184 , const T_7 * V_20 , T_1 * * V_186 , T_6 * V_193 , T_6 * V_194 ) {
T_6 V_22 = F_17 ( V_184 , V_20 , V_186 ) ;
return F_95 ( V_22 , * V_186 , V_193 , V_194 ) ;
}
T_7 * F_98 ( T_25 * V_184 , const T_8 * V_21 , T_9 V_9 ) {
T_1 * V_202 = NULL ;
T_7 * V_203 ;
T_6 V_204 = F_19 ( NULL , V_21 , V_9 , & V_202 ) ;
V_203 = F_99 ( V_184 , V_204 , V_202 ) ;
F_9 ( NULL , V_202 ) ;
return V_203 ;
}
T_7 * F_100 ( T_25 * V_184 , const T_8 * V_21 , T_9 V_9 ) {
T_1 * V_202 = NULL ;
T_7 * V_203 ;
T_6 V_204 = F_93 ( NULL , V_21 , V_9 , & V_202 , FALSE ) ;
V_203 = F_88 ( V_184 , V_202 , V_204 , FALSE ) ;
F_9 ( NULL , V_202 ) ;
return V_203 ;
}
T_6 F_101 ( T_25 * V_184 , T_6 V_22 , T_1 * V_10 , T_8 * * V_205 ) {
T_6 V_206 = 0 ;
T_6 V_11 ;
T_1 V_4 ;
T_8 * V_207 ;
...
* V_205 = V_207 = ( T_8 * ) F_94 ( V_184 , V_206 ) ;
for ( V_4 = V_10 [ 0 ] * 40 , V_11 = 1 ; V_11 < V_22 ; V_11 ++ , V_4 = 0 ) {
T_6 T_11 ;
V_4 += V_10 [ V_11 ] ;
...
switch( T_11 ) {
default: * V_205 = NULL ; return 0 ;
case 5 : * ( V_207 ++ ) = ( ( V_4 & 0xF0000000 ) >> 28 ) | 0x80 ;
case 4 : * ( V_207 ++ ) = ( ( V_4 & 0x0FE00000 ) >> 21 ) | 0x80 ;
case 3 : * ( V_207 ++ ) = ( ( V_4 & 0x001FC000 ) >> 14 ) | 0x80 ;
case 2 : * ( V_207 ++ ) = ( ( V_4 & 0x00003F80 ) >> 7 ) | 0x80 ;
case 1 : * ( V_207 ++ ) = V_4 & 0x0000007F ; break;
}
}
return V_206 ;
}
T_7 * F_102 ( T_25 * V_184 , const T_8 * V_208 , T_6 T_11 ) {
T_1 * V_10 = NULL ;
T_7 * V_203 ;
T_6 V_22 = F_19 ( NULL , V_208 , T_11 , & V_10 ) ;
if ( V_22 ) {
V_203 = F_15 ( V_184 , V_10 , V_22 ) ;
} else {
V_203 = F_10 ( V_184 , L_15 ) ;
}
F_9 ( NULL , V_10 ) ;
return V_203 ;
}
T_7 * F_103 ( T_25 * V_184 , const T_8 * V_208 , T_6 T_11 ) {
T_1 * V_10 = NULL ;
T_7 * V_203 ;
T_6 V_22 = F_93 ( NULL , V_208 , T_11 , & V_10 , FALSE ) ;
if ( V_22 ) {
V_203 = F_88 ( V_184 , V_10 , V_22 , FALSE ) ;
} else {
V_203 = F_10 ( V_184 , L_15 ) ;
}
F_9 ( NULL , V_10 ) ;
...
T_6 F_104 ( T_25 * V_184 , const char * V_20 , T_8 * * V_198 ) {
T_1 * V_10 ;
T_1 V_22 ;
T_6 V_199 ;
if ( ( V_22 = F_17 ( NULL , V_20 , & V_10 ) ) &&
( V_199 = F_101 ( V_184 , V_22 , V_10 , V_198 ) ) ) {
F_9 ( NULL , V_10 ) ;
return V_199 ;
}
F_9 ( NULL , V_10 ) ;
...
T_7 * F_105 ( T_25 * V_184 , const T_7 * V_20 ) {
T_1 * V_202 ;
T_6 V_204 ;
T_7 * V_209 ;
V_204 = F_17 ( NULL , V_20 , & V_202 ) ;
V_209 = F_99 ( V_184 , V_204 , V_202 ) ;
F_9 ( NULL , V_202 ) ;
return V_209 ;
}
T_7 * F_99 ( T_25 * V_184 , T_1 V_114 , T_1 * V_10 ) {
T_6 V_193 ;
T_6 V_194 ;
T_2 * V_21 ;
if( ! ( V_10 && * V_10 <= 2 ) )
return F_10 ( V_184 , L_101 ) ;
V_21 = F_95 ( V_114 , V_10 , & V_193 , & V_194 ) ;
while ( ! V_21 -> V_6 ) {
if ( ! ( V_21 = V_21 -> V_16 ) ) {
...
if ( V_194 ) {
T_7 * V_203 ,
* V_210 = F_15 ( NULL , V_10 , V_193 ) ,
* V_211 = F_15 ( NULL , & ( V_10 [ V_193 ] ) , V_194 ) ;
V_203 = F_106 ( V_184 , L_44 , V_21 -> V_6 ? V_21 -> V_6 : V_210 , V_211 ) ;
F_9 ( NULL , V_210 ) ;
F_9 ( NULL , V_211 ) ;
return V_203 ;
} else {
return V_21 -> V_6 ? F_10 ( V_184 , V_21 -> V_6 ) : F_15 ( V_184 , V_10 , V_193 ) ;
}
}
extern void F_107 ( T_25 * V_184 , T_6 V_9 , T_1 * V_10 , T_7 * * V_212 , T_7 * * V_213 ) {
* V_212 = F_99 ( V_184 , V_9 , V_10 ) ;
* V_213 = F_15 ( V_184 , V_10 , V_9 ) ;
}
extern void F_108 ( T_25 * V_184 , const T_8 * V_21 , T_9 V_9 , T_7 * * V_212 , T_7 * * V_213 ) {
T_1 * V_10 = NULL ;
T_6 V_22 = F_19 ( NULL , V_21 , V_9 , & V_10 ) ;
* V_212 = F_99 ( V_184 , V_22 , V_10 ) ;
* V_213 = F_15 ( V_184 , V_10 , V_22 ) ;
F_9 ( NULL , V_10 ) ;
}
void F_109 ( T_25 * V_184 , const T_7 * V_20 , T_7 * * V_212 , T_7 * * V_213 ) {
T_1 * V_10 ;
T_6 V_22 ;
...
#define F_110 ";"
V_28 = F_111 ( L_102 ) ;
F_26 ( V_148 , L_103 , V_28 ) ;
F_30 ( V_28 ) ;
V_28 = F_112 ( L_102 , FALSE ) ;
F_26 ( V_148 , L_104 , V_28 ) ;
F_30 ( V_28 ) ;
#else
#define F_110 ":"
V_28 = F_113 () ;
...
continue;
F_26 ( V_148 , F_110 L_104 , V_180 [ V_11 ] . V_6 ) ;
}
...
char * F_115 ( T_1 V_114 , T_1 * V_10 ) {
T_8 * V_214 = NULL ;
T_8 * V_215 = NULL ;
T_1 * V_216 = NULL ;
T_1 * V_217 ;
char * V_203 ;
char * V_218 = F_15 ( NULL , V_10 , V_114 ) ;
T_6 V_219 = F_101 ( NULL , V_114 , V_10 , & V_214 ) ;
T_6 V_220 = F_19 ( NULL , V_214 , V_219 , & V_216 ) ;
char * V_221 = F_102 ( NULL , V_214 , V_219 ) ;
T_6 V_222 = F_104 ( NULL , V_218 , & V_215 ) ;
T_6 V_223 = F_17 ( V_218 , & V_217 ) ;
V_203 = F_106 ( F_116 () ,
L_106
L_107
L_108
...
L_111
, V_218
, V_219 , F_20 ( F_116 () , V_214 , V_219 , ':' )
, V_216 ? F_15 ( F_116 () , V_216 , V_220 ) : L_14
, V_221
, V_222 , F_20 ( F_116 () , V_215 , V_222 , ':' )
, V_217 ? F_15 ( F_116 () , V_217 , V_223 ) : L_14
) ;
F_9 ( NULL , V_218 ) ;
F_9 ( NULL , V_216 ) ;
F_9 ( NULL , V_214 ) ;
...
void F_117 ( T_2 * V_224 , T_28 * V_225 ) {
static const char * V_226 [] = { L_112 , L_113 , L_114 , L_115 , L_116 , L_117 , L_118 , L_119 , L_120 , L_121 } ;
static const char * V_227 [] = { L_122 , L_123 ,
L_124 , L_125 , L_126 ,
L_127 , L_128 , L_129 , L_130 } ;
T_29 * V_228 = F_118 ( V_225 , NULL , 0 , 0 ,
L_131 ,
V_224 -> V_6 ? V_224 -> V_6 : L_15 ,
V_224 -> V_4 ,
V_224 -> V_7 <= V_141 ? V_226 [ V_224 -> V_7 ] : L_132 ,
V_224 -> V_15 ) ;
T_28 * V_229 = F_119 ( V_228 , 0 ) ;
T_5 * V_8 ;
for( V_8 = V_224 -> V_8 ; V_8 ; V_8 = V_8 -> V_111 ) {
F_118 ( V_229 , NULL , 0 , 0 ,
L_133 ,
V_8 -> V_6 ,
V_8 -> V_112 <= V_230 ? V_227 [ V_8 -> V_112 ] : L_132
) ;
} ;
if ( V_224 -> V_16 ) {
V_228 = F_118 ( V_229 , NULL , 0 , 0 , L_134 ) ;
V_229 = F_119 ( V_228 , 0 ) ;
F_117 ( V_224 -> V_16 , V_229 ) ;
}
}
