...
fprintf ( V_14 , L_73 ) ;
fprintf ( V_14 , L_7 ) ;
fprintf ( V_14 , V_129 L_19 ,
V_67 . V_130 == TRUE ? L_9 : L_10 ) ;
if ( F_55 () != NULL ) {
fprintf ( V_14 , L_74 ) ;
if ( F_56 () )
fprintf ( V_14 , V_131 L_19 , F_57 ( F_55 () ) ) ;
else
fprintf ( V_14 , V_131 L_19 , F_55 () ) ;
}
fclose ( V_14 ) ;
return TRUE ;
}
...
V_132 = strtol ( V_11 , & V_26 , 0 ) ;
if ( V_26 == V_11 || * V_26 != '\0' )
return V_133 ;
V_67 . V_68 = ( V_30 ) V_132 ;
} else if ( strcmp ( T_4 , V_69 ) == 0 ) {
V_132 = strtol ( V_11 , & V_26 , 0 ) ;
if ( V_26 == V_11 || * V_26 != '\0' )
return V_133 ;
V_67 . V_70 = ( V_30 ) V_132 ;
...
if ( V_132 <= 0 )
return V_133 ;
V_67 . V_77 = ( V_30 ) V_132 ;
V_67 . V_134 = TRUE ;
} else if ( strcmp ( T_4 , V_81 ) == 0 ) {
if ( ( strcmp ( V_11 , V_135 ) != 0 ) && F_59 ( V_11 , FALSE ) ) {
F_60 ( V_11 ) ;
}
...
if ( V_132 <= 0 )
return V_133 ;
V_67 . V_83 = ( V_30 ) V_132 ;
} else if ( strncmp ( T_4 , V_15 , sizeof( V_15 ) - 1 ) == 0 ) {
char * V_136 = & T_4 [ sizeof( V_15 ) - 1 ] ;
char * V_137 = strchr ( V_136 , '.' ) ;
if ( V_137 ) {
* V_137 = '\0' ;
V_137 ++ ;
F_15 ( V_136 , V_137 , V_11 ) ;
}
...
T_9 * V_139 , * V_140 ;
T_2 * V_6 ;
const T_7 * V_141 = F_62 ( V_142 ) ;
int V_143 = ( int ) strlen ( V_141 ) ;
...
} else if ( strcmp ( T_4 , V_94 ) == 0 || ( strcmp ( T_4 , L_75 ) == 0 ) ) {
if ( F_16 ( V_11 , L_16 ) == 0 ) {
V_67 . V_95 = TRUE ;
}
else {
...
V_67 . V_110 =
( V_144 ) F_1 ( V_11 , V_109 , V_145 ) ;
} else if ( strcmp ( T_4 , V_111 ) == 0 ) {
V_67 . V_113 =
F_1 ( V_11 , V_112 , V_146 ) ;
} else if ( strcmp ( T_4 , V_114 ) == 0 ) {
V_67 . V_116 =
( V_147 ) F_1 ( V_11 , V_115 , V_148 ) ;
} else if ( strcmp ( T_4 , V_117 ) == 0 ) {
V_132 = strtol ( V_11 , & V_26 , 0 ) ;
if ( V_26 == V_11 || * V_26 != '\0' )
return V_133 ;
V_67 . V_118 = ( V_30 ) V_132 ;
} else if ( strcmp ( T_4 , V_119 ) == 0 ) {
V_132 = strtol ( V_11 , & V_26 , 0 ) ;
if ( V_26 == V_11 || * V_26 != '\0' )
return V_133 ;
V_67 . V_120 = ( V_30 ) V_132 ;
...
V_140 = F_22 ( V_139 ) ;
while ( V_140 ) {
if ( strcmp ( ( const char * ) V_140 -> V_8 , L_18 ) == 0 ) {
F_37 ( V_139 ) ;
return V_133 ;
}
if ( strncmp ( ( const char * ) V_140 -> V_8 , V_141 , V_143 ) != 0 ) {
if ( F_64 ( ( const T_7 * ) V_140 -> V_8 ) == - 1 ) {
F_37 ( V_139 ) ;
return V_133 ;
}
}
...
V_140 = F_22 ( V_139 ) ;
while ( V_140 ) {
T_7 * V_152 = F_12 ( ( const T_7 * ) V_140 -> V_8 ) ;
V_6 = ( T_2 * ) F_11 ( sizeof( T_2 ) ) ;
if ( strncmp ( V_152 , V_141 , V_143 ) != 0 ) {
V_6 -> V_6 = F_64 ( V_152 ) ;
V_6 -> V_9 = NULL ;
} else {
V_6 -> V_6 = V_142 ;
V_6 -> V_9 = F_12 ( & V_152 [ V_143 + 1 ] ) ;
}
F_3 ( V_152 ) ;
if ( V_6 -> V_6 == - 1 ) {
F_3 ( V_6 -> V_9 ) ;
...
V_140 = V_140 -> V_39 ;
V_6 -> V_18 = ( V_30 ) strtol ( ( const char * ) V_140 -> V_8 , & V_26 , 0 ) ;
if ( V_26 == V_140 -> V_8 || ( * V_26 != '\0' && * V_26 != ':' ) ) {
F_3 ( V_6 -> V_9 ) ;
F_3 ( V_6 ) ;
return V_133 ;
}
...
if ( strcmp ( T_4 , V_156 ) == 0 ) {
if ( F_56 () )
F_67 ( F_68 ( V_11 ) ) ;
else
F_67 ( V_11 ) ;
} else if ( strcmp ( T_4 , V_157 ) == 0 ) {
F_69 ( V_11 ) ;
} else if ( strcmp ( T_4 , V_57 ) == 0 ) {
F_20 ( NULL , V_11 ) ;
} else if ( F_70 ( T_4 , V_57 L_76 ) ) {
...
V_160 = F_61 ( V_158 , V_26 , NULL , TRUE ) ;
* V_159 = ':' ;
return V_160 ;
}
T_8
F_73 ( char * * V_161 , int * V_162 )
{
char * V_60 ;
T_6 * V_14 ;
V_67 . V_68 = 20 ;
...
V_60 = F_45 ( V_64 , FALSE ) ;
* V_161 = NULL ;
if ( ( V_14 = F_46 ( V_60 , L_77 ) ) != NULL ) {
F_74 ( V_60 , V_14 , F_58 , NULL ) ;
fclose ( V_14 ) ;
} else {
if ( V_63 != V_165 ) {
* V_162 = V_63 ;
...
* V_161 = NULL ;
if ( ( V_14 = F_46 ( V_60 , L_77 ) ) != NULL ) {
F_74 ( V_60 , V_14 , F_61 , NULL ) ;
fclose ( V_14 ) ;
V_166 = F_45 ( V_64 , FALSE ) ;
if ( ! F_76 ( V_166 ) ) {
V_14 = F_46 ( V_60 , L_77 ) ;
F_74 ( V_60 , V_14 , F_58 , NULL ) ;
fclose ( V_14 ) ;
...
V_168 = ( T_2 * ) V_139 -> V_8 ;
if ( V_168 -> V_6 == V_6 ) {
if ( V_6 != V_142 || strcmp ( V_9 , V_168 -> V_9 ) == 0 ) {
return V_168 -> V_18 ;
}
}
V_139 = V_139 -> V_39 ;
