...
V_5 -> V_12 = V_62 ;
V_5 -> V_14 = L_2 ;
} else if ( V_29 != ( V_53 -> V_54 & 0xffffffffUL ) ) {
V_5 -> V_12 = V_62 ;
V_5 -> V_14 = L_3 ;
}
}
...
struct V_20 * V_103 ;
T_3 V_43 ;
if ( V_102 != V_104 && V_102 != V_87 && V_102 != V_105 ) {
F_43 () ;
}
if ( V_102 == V_105 ) {
if ( F_29 ( V_21 , V_106 ) == - 1 ) {
* V_12 = V_21 -> V_12 ;
return - 1 ;
}
if ( V_101 == 0 ) {
...
T_3 V_108 = ( unsigned ) ( V_21 -> V_71 - V_21 -> V_31 ) ;
if ( - V_101 <= V_108 ) {
T_3 V_109 = ( unsigned ) ( - V_101 ) ;
V_21 -> V_8 += V_109 ;
V_21 -> V_71 -= V_109 ;
V_21 -> V_22 -= V_109 ;
return V_21 -> V_22 ;
...
if ( V_103 -> V_34 == V_37 ) {
#ifdef F_19
V_110 = V_103 -> V_16 - ( V_103 -> V_47 . V_48 . V_45 ? 1 : 0 ) ;
#else
V_110 = V_103 -> V_16 ;
#endif
V_111 = V_103 -> V_31 ;
...
#endif
{
V_111 = ( V_21 -> V_22 + V_101 ) ;
V_110 = V_103 -> V_16 + ( V_111 - V_103 -> V_31 ) ;
}
if ( F_34 ( V_21 -> V_10 , V_110 , V_104 ) == - 1 ) {
* V_12 = V_13 ;
return - 1 ;
}
F_10 ( V_21 ) ;
...
T_13
F_46 ( T_2 V_21 , T_5 V_113 , int * V_12 )
{
if ( F_42 ( V_21 , V_113 , V_87 , V_12 ) == - 1 )
return FALSE ;
return TRUE ;
}
T_5
F_47 ( T_2 V_99 )
{
return V_99 -> V_22 + ( V_99 -> V_82 ? V_99 -> V_107 : 0 ) ;
}
T_5
F_48 ( T_2 V_99 )
{
...
int
F_49 ( T_2 V_99 , T_12 * V_114 , int * V_12 )
{
if ( F_35 ( V_99 -> V_10 , V_114 ) == - 1 ) {
if ( V_12 != NULL )
* V_12 = V_13 ;
return - 1 ;
}
...
V_117 = ( unsigned char * ) memchr ( V_21 -> V_71 , '\n' , V_43 ) ;
if ( V_117 != NULL )
V_43 = ( unsigned ) ( V_117 - V_21 -> V_71 ) + 1 ;
memcpy ( V_6 , V_21 -> V_71 , V_43 ) ;
V_21 -> V_8 -= V_43 ;
V_21 -> V_71 += V_43 ;
V_21 -> V_22 += V_43 ;
...
int
F_56 ( T_2 V_118 , T_17 * * V_14 )
{
if ( V_118 -> V_12 != 0 && V_14 ) {
* V_14 = F_57 ( V_118 -> V_14 ) ;
}
return V_118 -> V_12 ;
}
void
...
T_18 V_5 ;
int V_119 ;
V_10 = F_38 ( V_94 , V_98 | V_120 | V_121 | V_122 , 0666 ) ;
if ( V_10 == - 1 )
return NULL ;
V_5 = F_64 ( V_10 ) ;
if ( V_5 == NULL ) {
...
V_9 = V_93 ;
do {
if ( V_53 -> V_58 == 0 || ( V_129 != V_60 &&
( V_129 != V_130 || V_9 == V_69 ) ) ) {
V_8 = V_53 -> V_59 - V_5 -> V_71 ;
if ( V_8 ) {
V_115 = F_69 ( V_5 -> V_10 , V_5 -> V_71 , ( unsigned int ) V_8 ) ;
if ( V_115 < 0 ) {
V_5 -> V_12 = V_13 ;
return - 1 ;
}
...
int
F_74 ( T_18 V_5 , T_13 V_137 )
{
int V_9 = 0 ;
if ( F_68 ( V_5 , V_130 ) == - 1 && V_9 == 0 )
V_9 = V_5 -> V_12 ;
( void ) F_75 ( & ( V_5 -> V_53 ) ) ;
F_24 ( V_5 -> V_31 ) ;
F_24 ( V_5 -> V_16 ) ;
