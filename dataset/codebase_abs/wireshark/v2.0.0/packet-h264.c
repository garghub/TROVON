...
static int
F_68 ( T_4 * V_4 , T_9 * T_10 V_29 , T_3 * V_2 , void * T_17 V_29 )
{
int V_30 = 0 ;
F_69 ( V_2 , V_4 , V_30 ,
V_301 , V_302 ,
...
static int
F_70 ( T_4 * V_4 , T_9 * T_10 V_29 , T_3 * V_2 , void * T_17 V_29 )
{
int V_30 = 0 ;
F_69 ( V_2 , V_4 , V_30 ,
V_304 , V_305 ,
...
static int
F_72 ( T_4 * V_4 , T_9 * T_10 V_29 , T_3 * V_2 V_29 , void * T_17 )
{
int V_30 = 0 ;
T_16 V_310 ;
const T_13 * V_311 ;
...
static int
F_77 ( T_4 * V_4 , T_9 * T_10 , T_3 * V_2 , void * T_17 )
{
T_18 * V_312 ;
if ( T_17 == NULL )
return 0 ;
...
static T_19 * F_78 ( const T_13 * V_315 ) {
T_19 * V_316 = NULL ;
T_19 * V_317 ;
...
static int
F_79 ( T_4 * V_4 V_29 , T_9 * T_10 , T_3 * V_2 , void * T_17 )
{
T_18 * V_312 ;
if ( T_17 == NULL )
return 0 ;
...
if ( V_2 ) {
T_19 * V_316 ;
V_316 = F_78 ( T_10 -> V_319 ) ;
if ( V_316 ) {
F_27 ( V_312 -> V_314 , L_44 , V_316 -> V_19 ) ;
F_27 ( F_80 ( F_81 ( V_2 ) ) , L_45 , V_316 -> V_19 ) ;
} else {
...
static void F_82 ( T_2 V_320 ) {
if ( V_320 >= 96 && V_320 <= 127 )
F_83 ( L_47 , V_320 , V_321 ) ;
}
static void F_84 ( T_2 V_320 ) {
if ( V_320 >= 96 && V_320 <= 127 )
F_85 ( L_47 , V_320 , V_321 ) ;
}
void
F_86 ( void )
{
...
{ & V_290 ,
{ L_52 , L_53 ,
V_328 , V_24 , F_76 ( V_329 ) , 0x1f ,
NULL , V_327 }
} ,
{ & V_292 ,
{ L_54 , L_55 ,
V_325 , 8 , F_87 ( & V_330 ) , 0x80 ,
NULL , V_327 }
} ,
{ & V_293 ,
{ L_56 , L_57 ,
V_325 , 8 , F_87 ( & V_331 ) , 0x40 ,
NULL , V_327 }
} ,
{ & V_294 ,
{ L_58 , L_59 ,
...
V_285 = F_88 ( L_420 , L_34 , L_421 ) ;
F_89 ( V_285 , V_324 , F_90 ( V_324 ) ) ;
F_91 ( V_356 , F_90 ( V_356 ) ) ;
V_323 = F_92 ( V_285 ) ;
F_93 ( V_323 , V_357 , F_90 ( V_357 ) ) ;
V_322 = F_94 ( V_285 , V_364 ) ;
F_95 ( V_322 , L_422 ,
L_423 ,
L_424
L_425 ,
& V_365 , 127 ) ;
F_96 ( L_421 , F_58 , V_285 ) ;
}
void
V_364 ( void )
{
...
T_19 * V_316 ;
V_321 = F_97 ( L_421 ) ;
F_98 ( L_426 , L_34 , V_321 ) ;
F_98 ( L_426 , L_427 , V_321 ) ;
F_98 ( L_426 , L_428 , V_321 ) ;
V_368 = F_99 ( F_79 , V_285 ) ;
for ( V_316 = V_318 ; V_316 -> V_315 ; V_316 ++ ) {
if ( V_316 -> V_19 )
F_98 ( L_429 , V_316 -> V_315 , V_368 ) ;
if ( V_316 -> V_369 )
F_98 ( L_430 , V_316 -> V_315 , F_99 ( V_316 -> V_369 , V_285 ) ) ;
}
V_367 = TRUE ;
} else {
F_100 ( V_366 , F_82 ) ;
