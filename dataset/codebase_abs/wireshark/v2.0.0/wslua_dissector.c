...
V_2 = F_50 ( V_2 ) ;
V_24 = F_50 ( V_24 ) ;
V_34 -> V_36 = F_51 ( V_2 , V_24 , type , V_27 ) ;
V_34 -> V_2 = V_2 ;
V_34 -> V_24 = V_24 ;
V_34 -> V_37 = TRUE ;
V_34 -> V_38 = FALSE ;
...
type = F_73 ( V_34 -> V_2 ) ;
if ( type == V_29 ) {
const T_3 * V_49 = F_3 ( V_1 , F_82 ) ;
F_84 ( V_34 -> V_2 , V_46 ) ;
F_74 ( V_34 -> V_2 , V_49 , V_46 ) ;
} else if ( type == V_26 || type == V_32 || type == V_31 || type == V_33 ) {
if ( F_76 ( V_1 , F_82 ) ) {
int V_50 = ( int ) F_77 ( V_1 , F_82 ) ;
F_84 ( V_34 -> V_2 , V_46 ) ;
F_78 ( V_34 -> V_2 , V_50 , V_46 ) ;
} else {
const T_3 * V_49 = F_3 ( V_1 , F_82 ) ;
...
type = F_73 ( V_34 -> V_2 ) ;
if ( type == V_29 ) {
T_3 * V_49 = F_50 ( F_3 ( V_1 , F_86 ) ) ;
F_88 ( V_34 -> V_2 , V_49 , V_46 ) ;
F_75 ( V_49 ) ;
} else if ( type == V_26 || type == V_32 || type == V_31 || type == V_33 ) {
if ( F_76 ( V_1 , F_86 ) ) {
int V_50 = ( int ) F_77 ( V_1 , F_86 ) ;
F_89 ( V_34 -> V_2 , V_50 , V_46 ) ;
} else {
const T_3 * V_49 = F_3 ( V_1 , F_86 ) ;
T_19 * V_51 = NULL ;
if ( F_79 ( & V_51 , V_49 , V_52 ) == V_53 )
F_90 ( V_34 -> V_2 , V_51 , V_46 ) ;
else {
F_75 ( V_51 ) ;
F_7 ( F_85 , V_54 , L_8 ) ;
return 0 ;
...
F_27 {
if ( type == V_29 ) {
const T_3 * V_49 = F_3 ( V_1 , F_94 ) ;
V_15 = F_98 ( V_34 -> V_36 , V_49 , V_12 -> V_16 , V_13 -> V_17 , V_14 -> V_18 , NULL ) ;
if ( V_15 > 0 ) {
V_55 = TRUE ;
}
} else if ( type == V_26 || type == V_32 || type == V_31 || type == V_33 ) {
int V_50 = ( int ) F_77 ( V_1 , F_94 ) ;
V_15 = F_99 ( V_34 -> V_36 , V_50 , V_12 -> V_16 , V_13 -> V_17 , V_14 -> V_18 ) ;
if ( V_15 > 0 ) {
V_55 = TRUE ;
}
} else {
...
type = F_73 ( V_34 -> V_2 ) ;
if ( type == V_29 ) {
const T_3 * V_49 = F_3 ( V_1 , F_101 ) ;
V_46 = F_102 ( V_34 -> V_36 , V_49 ) ;
} else if ( type == V_26 || type == V_32 || type == V_31 || type == V_33 ) {
int V_50 = ( int ) F_77 ( V_1 , F_101 ) ;
V_46 = F_103 ( V_34 -> V_36 , V_50 ) ;
}
if ( V_46 ) {
F_5 ( V_1 , V_46 ) ;
F_6 ( 1 ) ;
...
#define F_106 2
T_13 V_34 = F_68 ( V_1 , 1 ) ;
T_18 V_57 = F_70 ( V_1 , F_106 ) ;
T_21 V_46 = NULL ;
if ( ! V_57 -> V_46 ) {
V_57 -> V_46 = F_107 ( V_57 -> V_58 , V_59 , V_57 -> V_60 ) ;
}
V_46 = V_57 -> V_46 ;
F_108 ( V_34 -> V_2 , V_46 ) ;
return 0 ;
