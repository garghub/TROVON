...
V_44 = F_18 ( V_28 [ V_24 ] , L_8 , 3 ) ;
if ( V_44 [ 0 ] == NULL || V_44 [ 1 ] == NULL || V_44 [ 2 ] == NULL ) {
F_19 ( V_44 ) ;
continue;
}
V_45 = F_29 ( T_8 , 1 ) ;
V_45 -> V_47 = ( int ) strtol ( V_44 [ 0 ] , NULL , 10 ) ;
V_45 -> V_10 = F_5 ( V_44 [ 1 ] ) ;
if ( strcmp ( V_44 [ 2 ] , L_17 ) != 0 )
V_45 -> V_48 = F_5 ( V_44 [ 2 ] ) ;
else
V_45 -> V_48 = NULL ;
F_19 ( V_44 ) ;
V_43 = F_10 ( V_43 , V_45 ) ;
