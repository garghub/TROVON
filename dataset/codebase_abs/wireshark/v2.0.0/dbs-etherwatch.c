...
static T_10
F_15 ( char * V_99 , T_9 * V_11 , int V_100 ) {
int V_101 , V_14 ;
int V_102 ;
...
V_101 ++ ;
return F_13 ( & V_99 [ V_101 ] , V_11 , V_109 , V_110 ) ;
}
static T_10
F_13 ( char * V_111 , T_9 * V_11 , char V_112 , char V_113 ) {
int V_101 , V_53 ;
V_101 = 0 ;
V_53 = 0 ;
while( V_111 [ V_101 ] != V_113 ) {
if( ! ( F_14 ( V_111 [ V_101 ] ) &&
F_14 ( V_111 [ V_101 + 1 ] ) ) ) {
return 0 ;
}
if( F_17 ( V_111 [ V_101 ] ) ) {
V_11 [ V_53 ] = ( V_111 [ V_101 ] - '0' ) << 4 ;
} else {
V_11 [ V_53 ] = ( F_18 ( V_111 [ V_101 ] ) - 'A' + 10 ) << 4 ;
}
V_101 ++ ;
if( F_17 ( V_111 [ V_101 ] ) ) {
V_11 [ V_53 ] += V_111 [ V_101 ] - '0' ;
} else {
V_11 [ V_53 ] += F_18 ( V_111 [ V_101 ] ) - 'A' + 10 ;
}
V_101 ++ ;
V_53 ++ ;
while( V_111 [ V_101 ] == V_112 ) {
V_101 ++ ;
}
}
return V_53 ;
