...
F_90 ( V_56 , ( T_12 * ) V_55 , FALSE ) ;
}
static void F_91 ( T_17 * T_18 V_1 ) {
const char * V_55 = F_71 ( F_86 ( V_54 ) ) ;
F_92 ( & V_57 , V_55 , FALSE ) ;
}
static void F_93 ( const T_12 * T_20 V_1 ,
T_21 T_22 V_1 ,
const T_12 * V_58 ,
T_3 V_13 V_1 ) {
fputs ( V_58 , V_59 ) ;
}
static void F_94 ( T_17 * T_18 V_1 ) {
F_95 ( & V_57 ) ;
}
static T_7 F_96 ( T_17 * T_18 V_1 , const char * V_60 , const char * V_61 , char * * V_62 ) {
int V_63 = 0 ;
T_23 * V_64 = NULL ;
* V_62 = NULL ;
switch ( V_57 . V_65 ) {
...
if ( V_61 ) {
if ( ! F_97 ( V_61 , & V_64 , V_62 ) ) {
return FALSE ;
}
}
if ( F_98 ( & V_57 , V_60 , V_70 , FALSE , & V_63 ) != V_71 ) {
* V_62 = F_70 ( F_99 ( V_63 ) ) ;
...
static struct V_74 * F_102 ( T_17 * T_18 V_1 , const T_12 * V_37 , const T_12 * V_75 , T_7 V_76 , T_7 * V_77 ) {
return F_103 ( V_78 , V_37 , V_75 , V_76 , V_77 ) ;
}
static void F_104 ( struct V_74 * V_4 , float V_79 , const T_12 * V_75 ) {
F_105 ( V_4 , V_79 , V_75 ) ;
}
static void F_106 ( struct V_74 * V_4 ) {
F_107 ( V_4 ) ;
}
static void F_108 ( T_17 * T_18 V_1 ) {
if ( V_57 . V_65 == V_67 ) F_109 ( & V_57 ) ;
}
static void F_110 ( void * T_24 V_1 , T_3 V_2 ) {
T_25 * V_80 = ( T_25 * ) V_2 ;
V_80 -> V_81 ( V_80 -> V_82 ) ;
if ( V_80 -> V_83 ) F_95 ( & V_57 ) ;
}
static void F_111 ( const char * V_84 ,
T_26 V_85 ,
void (* V_81)( T_3 ) ,
T_3 V_82 ,
T_7 V_83 ) {
T_25 * V_80 = ( T_25 * ) F_11 ( sizeof( T_25 ) ) ;
