...
switch ( V_15 -> V_58 ) {
case 1 :
V_86 = sizeof ( struct V_87 ) ;
break;
case 2 :
V_86 = sizeof ( struct V_89 ) ;
break;
}
if ( ! F_15 ( V_16 , & V_7 , V_86 , V_2 , V_3 ) )
return V_105 ;
switch ( V_15 -> V_58 ) {
case 1 :
V_96 = F_5 ( & V_7 . V_88 . V_106 ) ;
V_95 = F_5 ( & V_7 . V_88 . V_107 ) ;
break;
case 2 :
V_96 = F_7 ( & V_7 . V_90 . V_106 ) ;
V_95 = F_7 ( & V_7 . V_90 . V_107 ) ;
break;
}
if ( V_95 > V_108 ) {
* V_2 = V_62 ;
...
V_2 , V_3 ) )
return V_105 ;
V_96 -= ( V_112 ) sizeof ( struct V_111 ) ;
V_95 -= ( V_112 ) sizeof ( struct V_111 ) ;
break;
default:
break;
}
switch ( V_15 -> V_58 ) {
case 1 :
V_91 = ( ( T_9 ) F_7 ( & V_7 . V_88 . V_113 ) ) * 1000000 ;
break;
case 2 :
V_91 = F_17 ( & V_7 . V_90 . V_113 ) * 10 ;
V_91 *= 100 ;
break;
}
V_93 = 0 ;
...
V_93 += ( T_10 ) ( V_92 / 1000000000 ) ;
V_94 = ( int ) ( V_92 % 1000000000 ) ;
V_71 -> V_85 = V_114 | V_115 ;
V_71 -> V_116 . V_93 = V_15 -> V_55 + V_93 ;
V_71 -> V_116 . V_94 = V_94 ;
V_71 -> V_117 = V_95 ;
V_71 -> V_118 = V_96 ;
...
V_15 -> V_58 > 2 ) {
if ( V_15 -> V_58 > 2 ) {
V_97 = ( int ) sizeof ( struct V_102 ) ;
} else {
switch ( V_15 -> V_59 ) {
case 1 :
V_97 = ( int ) sizeof ( struct V_98 ) ;
break;
case 2 :
V_97 = ( int ) sizeof ( struct V_100 ) ;
break;
default:
V_97 = ( int ) sizeof ( struct V_102 ) ;
break;
...
if ( ! F_3 ( V_16 , & V_104 , V_97 , V_2 , V_3 ) )
return V_105 ;
V_26 = F_5 ( V_104 . V_99 . V_26 ) ;
...
struct V_111 V_136 ;
T_11 V_137 , V_138 ;
if ( ! F_3 ( V_16 , & V_136 , sizeof ( struct V_111 ) ,
V_2 , V_3 ) )
return FALSE ;
...
if ( ! V_15 -> V_156 ) {
V_15 -> V_172 . V_93 = V_71 -> V_116 . V_93 ;
V_15 -> V_172 . V_94 =
( V_71 -> V_116 . V_94 / 1000000 ) * 1000000 ;
V_15 -> V_156 = TRUE ;
}
if ( V_150 -> V_146 == V_74 )
V_167 = sizeof ( struct V_111 ) ;
else
V_167 = 0 ;
V_93 = ( T_9 ) ( V_71 -> V_116 . V_93 - V_15 -> V_172 . V_93 ) ;
V_94 = V_71 -> V_116 . V_94 - V_15 -> V_172 . V_94 ;
while ( V_94 < 0 ) {
V_94 += 1000000000 ;
V_93 -- ;
}
switch ( V_150 -> V_30 ) {
case V_23 :
V_161 . V_113 = F_29 ( V_93 * 1000 + ( V_94 + 500000 ) / 1000000 ) ;
V_161 . V_106 = F_30 ( V_71 -> V_118 + V_167 ) ;
V_161 . V_107 = F_30 ( V_71 -> V_117 + V_167 ) ;
V_163 = & V_161 ;
V_86 = sizeof V_161 ;
break;
case V_24 :
V_162 . V_113 = F_31 ( V_93 * 1000000 + ( V_94 + 500 ) / 1000 ) ;
V_162 . V_106 = F_29 ( V_71 -> V_118 + V_167 ) ;
V_162 . V_107 = F_29 ( V_71 -> V_117 + V_167 ) ;
V_163 = & V_162 ;
V_86 = sizeof V_162 ;
break;
default:
...
V_177 . V_57 = F_30 ( V_15 -> V_172 . V_94 / 1000000 ) ;
