...
static void
F_19 ( T_2 * V_13 , T_7 V_23 , int T_8 V_15 , char * V_29 )
{
...
static int
F_20 ( T_2 * V_13 , T_7 V_23 V_15 , int T_8 V_15 )
{
T_4 * V_24 ;
int V_25 ;
V_24 = F_21 ( NULL , & V_13 -> V_3 . time ) ;
V_25 = ( int ) strlen ( V_24 ) ;
F_18 ( NULL , V_24 ) ;
return V_25 ;
}
static void
F_22 ( T_2 * V_13 , T_7 V_23 V_15 , int T_8 V_15 , char * V_29 )
{
T_4 * V_24 ;
V_24 = F_21 ( NULL , & V_13 -> V_3 . time ) ;
strcpy ( V_29 , V_24 ) ;
