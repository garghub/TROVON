...
T_10 * V_34 ;
T_11 * V_35 = NULL ;
V_34 = F_11 ( V_2 -> V_36 -> V_37 , & V_2 -> V_38 , & V_2 -> V_39 , V_2 -> V_40 , V_2 -> V_41 , V_2 -> V_42 , 0 ) ;
if ( V_34 ) {
V_35 = ( T_11 * ) F_12 ( V_34 , V_43 ) ;
if ( V_35 )
V_32 = F_13 ( V_44 , V_35 -> V_45 ) ;
}
if ( V_32 ) {
F_14 ( V_32 , V_1 , V_2 , V_12 , NULL ) ;
return;
} else if ( F_15 ( V_46 , V_1 , V_2 , V_12 , & V_33 , NULL ) ) {
return;
}
switch ( V_13 ) {
case V_47 :
{
const T_5 * V_48 = V_2 -> V_49 ;
V_2 -> V_49 = NULL ;
switch ( V_50 ) {
case V_51 :
case V_52 :
default:
F_16 ( V_53 , V_1 , V_2 , V_12 ) ;
break;
case V_54 :
F_16 ( V_55 , V_1 , V_2 , V_12 ) ;
break;
case V_56 :
F_16 ( V_57 , V_1 , V_2 , V_12 ) ;
break;
}
V_2 -> V_49 = V_48 ;
}
...
static void
F_17 ( T_1 * V_1 , T_2 * V_2 , T_6 * V_12 , T_6 * V_60 , T_4 V_13 )
{
const T_3 V_3 = 0 , V_16 = F_6 ( V_1 ) ;
T_7 * V_14 ;
T_6 * V_31 ;
...
static int
F_18 ( T_1 * V_1 , T_2 * V_2 , T_6 * V_12 , void * T_12 V_66 )
{
T_7 * V_14 , * V_67 ;
T_4 V_68 , V_13 ;
T_13 V_69 ;
...
V_69 = ( F_19 ( V_1 , 1 ) & V_75 ) != 0 ;
V_71 = V_72 + ( V_69 ? 4 : 0 ) ;
F_22 ( V_2 -> V_76 , V_77 , L_4 ) ;
F_22 ( V_2 -> V_76 , V_78 , L_4 ) ;
V_14 = F_7 ( V_12 , V_79 , V_1 , 0 , V_71 , V_19 ) ;
V_60 = F_8 ( V_14 , V_80 ) ;
F_7 ( V_60 , V_81 , V_1 , 0 , 1 , V_19 ) ;
V_68 = ( F_19 ( V_1 , 0 ) & V_82 ) >> 4 ;
F_7 ( V_60 , V_83 , V_1 , 0 , 1 , V_22 ) ;
F_7 ( V_60 , V_84 , V_1 , 0 , 1 , V_22 ) ;
V_13 = F_19 ( V_1 , 0 ) & V_85 ;
F_23 ( V_2 -> V_76 , V_78 , L_5 , F_24 ( V_13 , V_86 , L_6 ) ) ;
F_25 ( V_2 -> V_76 , V_78 , V_68 ? L_7 : L_8 ) ;
F_7 ( V_60 , V_87 , V_1 , 1 , 1 , V_19 ) ;
F_25 ( V_2 -> V_76 , V_78 , V_69 ? L_9 : L_8 ) ;
...
V_73 = F_29 ( V_1 , V_71 , V_4 , V_4 ) ;
}
F_17 ( V_73 , V_2 , V_12 , V_60 , V_13 ) ;
}
return F_30 ( V_1 ) ;
}
static T_3
F_31 ( T_2 * V_2 V_66 , T_1 * V_1 , int V_3 , void * T_12 V_66 )
{
T_3 V_93 , V_4 ;
T_13 V_69 ;
V_93 = 2 ;
V_69 = F_19 ( V_1 , V_3 + 1 ) & V_75 ;
V_4 = F_19 ( V_1 , V_3 + 1 ) & V_74 ;
V_3 += 2 ;
if ( V_4 == 126 ) {
if ( F_32 ( V_1 , V_3 ) < 2 )
return 0 ;
...
static int
F_33 ( T_1 * V_1 , T_2 * V_2 , T_6 * V_12 , void * T_12 )
{
F_34 ( V_1 , V_2 , V_12 , TRUE , 2 ,
F_31 , F_18 , T_12 ) ;
return F_30 ( V_1 ) ;
}
void
...
V_44 = F_39 ( L_66 ,
L_67 , V_101 , V_100 ) ;
F_40 ( V_79 , V_94 , F_41 ( V_94 ) ) ;
F_42 ( V_108 , F_41 ( V_108 ) ) ;
V_116 = F_43 ( V_79 ) ;
F_44 ( V_116 , V_110 , F_41 ( V_110 ) ) ;
F_45 ( L_64 , F_33 , V_79 ) ;
V_115 = F_46 ( V_79 , V_117 ) ;
F_47 ( V_115 , L_68 ,
L_69 ,
L_70 ,
& V_50 , V_114 , V_52 ) ;
