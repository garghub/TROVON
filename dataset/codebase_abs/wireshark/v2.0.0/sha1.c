...
void F_10 ( T_1 * V_1 , T_2 V_17 [ V_18 ] )
{
T_3 V_19 , V_20 ;
T_3 V_21 , V_22 ;
T_2 V_23 [ 8 ] ;
...
void F_12 ( T_14 * V_25 , const T_2 * V_26 , T_3 V_27 )
{
T_3 V_28 ;
T_2 V_29 [ 64 ] ;
memset ( V_29 , 0x36 , 64 ) ;
memset ( V_25 -> V_30 , 0x5C , 64 ) ;
for( V_28 = 0 ; V_28 < V_27 ; V_28 ++ )
{
if( V_28 >= 64 ) break;
V_29 [ V_28 ] ^= V_26 [ V_28 ] ;
V_25 -> V_30 [ V_28 ] ^= V_26 [ V_28 ] ;
}
F_1 ( & V_25 -> V_1 ) ;
F_9 ( & V_25 -> V_1 , V_29 , 64 ) ;
}
void F_13 ( T_14 * V_25 , const T_2 * V_31 , T_3 V_32 )
{
F_9 ( & V_25 -> V_1 , V_31 , V_32 ) ;
}
void F_14 ( T_14 * V_25 , T_2 V_17 [ V_18 ] )
{
T_2 V_33 [ V_18 ] ;
F_10 ( & V_25 -> V_1 , V_33 ) ;
F_1 ( & V_25 -> V_1 ) ;
F_9 ( & V_25 -> V_1 , V_25 -> V_30 , 64 ) ;
F_9 ( & V_25 -> V_1 , V_33 , V_18 ) ;
F_10 ( & V_25 -> V_1 , V_17 ) ;
}
void F_15 ( const T_2 * V_26 , T_3 V_27 , const T_2 * V_31 , T_3 V_32 ,
T_2 V_17 [ V_18 ] )
{
T_14 V_25 ;
F_12 ( & V_25 , V_26 , V_27 ) ;
...
char V_38 [ 41 ] ;
T_1 V_1 ;
unsigned char V_31 [ 1000 ] ;
unsigned char V_39 [ V_18 ] ;
if( V_34 < 2 )
{
printf ( L_1 ) ;
...
if( V_28 < 2 )
{
F_9 ( & V_1 , ( T_2 * ) V_40 [ V_28 ] ,
strlen ( V_40 [ V_28 ] ) ) ;
}
else
{
memset ( V_31 , 'a' , 1000 ) ;
for( V_37 = 0 ; V_37 < 1000 ; V_37 ++ )
{
F_9 ( & V_1 , ( T_2 * ) V_31 , 1000 ) ;
}
}
F_10 ( & V_1 , V_39 ) ;
for( V_37 = 0 ; V_37 < V_18 ; V_37 ++ )
{
F_16 ( V_38 + V_37 * 2 , 41 - V_37 * 2 , L_3 , V_39 [ V_37 ] ) ;
}
if( memcmp ( V_38 , V_41 [ V_28 ] , 40 ) )
{
printf ( L_4 ) ;
return ( 1 ) ;
}
...
{
if( ! ( V_36 = F_17 ( V_35 [ 1 ] , L_7 ) ) )
{
printf ( L_8 , F_18 ( V_42 ) ) ;
return ( 1 ) ;
}
F_1 ( & V_1 ) ;
while( ( V_28 = fread ( V_31 , 1 , sizeof( V_31 ) , V_36 ) ) > 0 )
{
F_9 ( & V_1 , V_31 , V_28 ) ;
}
F_10 ( & V_1 , V_39 ) ;
