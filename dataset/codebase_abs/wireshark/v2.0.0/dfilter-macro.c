...
V_3 -> V_4 = F_7 ( & ( V_6 -> V_11 ) , V_17 , V_6 -> V_8 -> V_18 , NULL ) ;
V_3 -> V_10 = TRUE ;
...
void F_9 ( void * V_19 ) {
F_10 ( V_7 , F_1 , NULL ) ;
F_11 ( ( V_20 * ) V_19 , F_3 , NULL ) ;
}
static T_9 * F_12 ( T_9 * V_16 , T_9 * * args , T_9 * * error ) {
T_10 * V_21 ;
int V_22 = 0 ;
T_11 * V_23 = NULL ;
T_5 * V_3 ;
...
T_11 * V_29 = & ( V_30 [ V_27 ] ) ;
if ( V_29 -> V_10 && F_13 ( V_29 -> V_16 , V_16 ) ) {
V_23 = V_29 ;
break;
}
}
...
V_26 = F_14 ( NULL , V_21 -> V_32 ) ;
F_19 ( V_21 , TRUE ) ;
return V_26 ;
}
static const T_9 * F_20 ( const T_9 * V_21 , T_12 V_33 , T_9 * * error ) {
...
#define F_22 ( T_14 ) if (n) g_string_free(n,TRUE); n = NULL
#define F_23 () \
do { \
FGS(name); \
FGS(arg); \
...
T_9 * V_43 ;
F_28 ( args , NULL ) ;
V_43 = F_12 ( V_16 -> V_32 , ( T_9 * * ) args -> V_44 , error ) ;
if ( V_43 == NULL )
goto V_45;
V_41 = TRUE ;
F_29 ( V_38 , V_43 ) ;
...
F_23 () ;
if ( V_41 ) {
const T_9 * V_43 = F_20 ( V_38 -> V_32 , V_33 + 1 , error ) ;
F_19 ( V_38 , TRUE ) ;
return V_43 ;
} else {
const T_9 * V_46 = F_14 ( NULL , V_38 -> V_32 ) ;
F_19 ( V_38 , TRUE ) ;
return V_46 ;
}
}
...
const T_9 * F_31 ( const T_9 * V_21 , T_9 * * error ) {
return F_20 ( V_21 , 0 , error ) ;
}
...
V_23 -> V_52 = V_49 = V_48 = F_21 ( V_23 -> V_21 ) ;
V_40 = V_23 -> V_21 ;
F_28 ( V_25 , V_49 ) ;
while ( V_40 && * V_40 ) {
switch ( * V_40 ) {
...
F_16 ( V_23 ) ;
V_58 -> V_16 = F_21 ( V_23 -> V_16 ) ;
V_58 -> V_21 = F_21 ( V_23 -> V_21 ) ;
V_58 -> V_10 = V_23 -> V_10 ;
if ( V_23 -> V_25 ) {
T_12 V_59 = 0 ;
V_58 -> V_52 = F_21 ( V_23 -> V_21 ) ;
{
