...
T_15 F_17 ( T_12 * V_70 , int * V_62 , T_1 * * T_13 V_71 ) {
T_1 V_51 [ V_52 ] ;
T_1 * V_53 = NULL ;
...
V_59 ) ) );
if ( F_9 ( V_78 , V_51 , ( V_56 ) ( ( T_3 ) V_57 | ( T_3 ) V_58 ) ,
V_59 ) ) {
V_70 -> V_73 = V_79 ;
V_70 -> V_80 = V_25 ;
} else if ( F_9 ( V_81 , V_51 , ( V_56 ) ( ( T_3 ) V_57 | ( T_3 ) V_58 ) ,
V_59 ) ) {
V_70 -> V_73 = V_82 ;
V_70 -> V_80 = V_27 ;
} else if ( F_9 ( V_83 , V_51 , ( V_56 ) ( ( T_3 ) V_57 | ( T_3 ) V_58 ) ,
V_59 ) ) {
V_70 -> V_73 = V_84 ;
V_70 -> V_80 = V_26 ;
...
T_1 * V_109 ;
T_3 V_110 ;
const struct V_16 * V_17 = ( const struct V_16 * ) V_103 -> V_111 ;
if ( V_33 -> V_65 != V_66 ) {
* V_62 = V_112 ;
return FALSE ;
}
...
const union V_114 * V_115 = & V_33 -> V_115 ;
V_110 = V_115 -> V_116 . V_8 ;
}
V_5 = ( const struct V_4 * ) ( const void * ) V_3 ;
V_7 = ( const struct V_6 * ) ( const void * ) V_3 ;
V_105 = F_27 ( V_5 -> V_13 ) ;
...
V_21 = F_27 ( V_5 -> V_21 ) ;
V_18 = F_27 ( V_5 -> V_117 ) ;
V_19 = F_27 ( V_5 -> V_118 ) / 1000000 ;
if ( V_110 == 1 ) {
V_9 = ( const T_2 * ) ( V_5 + 1 ) ;
V_1 = F_1 ( V_9 [ 0 ] ) ;
V_22 = V_9 + 1 ;
V_107 = 1 + ( T_3 ) strlen ( V_22 ) + 1 ;
V_106 = V_9 + V_107 ;
} else if ( V_110 == 2 ) {
V_9 = ( const T_2 * ) ( V_7 + 1 ) ;
V_1 = F_1 ( V_9 [ 0 ] ) ;
...
V_49 = F_3 ( V_17 , V_18 , V_19 , V_20 , V_21 , V_1 , V_22 , V_108 ) ;
if ( ! V_49 ) {
F_29 ( log ) ;
return FALSE ;
}
V_104 = ( T_5 ) strlen ( V_49 ) ;
if ( ! F_30 ( V_103 , V_49 , V_104 , V_62 ) ) {
F_29 ( log ) ;
return FALSE ;
}
V_103 -> V_120 += V_104 ;
...
case V_30 :
case V_31 :
if ( V_17 -> type == V_103 -> V_97 ) {
if ( ! F_30 ( V_103 , ( const T_1 * ) V_3 , V_33 -> V_67 , V_62 ) ) {
return FALSE ;
}
} else {
* V_62 = V_121 ;
...
static T_7 F_31 ( T_16 * V_103 , T_18 V_122 , int * V_62 V_71 ) {
struct V_16 * V_17 ;
...
T_7 F_33 ( T_16 * V_103 , int * V_62 ) {
return F_31 ( V_103 , V_25 , V_62 ) ;
}
T_7 F_34 ( T_16 * V_103 , int * V_62 ) {
return F_31 ( V_103 , V_26 , V_62 ) ;
}
T_7 F_35 ( T_16 * V_103 , int * V_62 ) {
return F_31 ( V_103 , V_27 , V_62 ) ;
}
T_7 F_36 ( T_16 * V_103 , int * V_62 ) {
return F_31 ( V_103 , V_29 , V_62 ) ;
}
T_7 F_37 ( T_16 * V_103 , int * V_62 ) {
return F_31 ( V_103 , V_28 , V_62 ) ;
}
T_7 F_38 ( T_16 * V_103 , int * V_62 ) {
return F_31 ( V_103 , V_30 , V_62 ) ;
}
T_7 F_39 ( T_16 * V_103 , int * V_62 ) {
return F_31 ( V_103 , V_31 , V_62 ) ;
}
