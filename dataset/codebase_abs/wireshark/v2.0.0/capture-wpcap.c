...
if ( F_40 ( V_61 [ V_59 ] . V_36 + sizeof( L_10 ) - 1 ,
V_36 ) == 0 )
...
return V_61 [ V_59 ] . V_36 + sizeof( L_10 ) - 1 ;
}
return NULL ;
}
}
...
{
if ( strstr ( V_74 , L_12 ) != NULL ||
strstr ( V_74 , L_13 ) != NULL ) {
return F_18 ( L_14
L_15
L_16 ,
V_74 ) ;
}
return F_18 ( L_17 , V_74 ) ;
}
void
F_54 ( T_12 * V_93 )
{
F_55 ( V_93 , L_18 F_56 ( V_94 ) L_19 ) ;
}
void
F_57 ( T_12 * V_93 )
{
