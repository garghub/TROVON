...
V_9 = F_6 ( V_1 , V_8 ) ;
V_8 += 1 ;
F_7 ( V_2 -> V_18 , V_22 , F_8 ( V_9 , V_26 , L_5 ) ) ;
if ( V_9 >= 0x11 && V_9 <= 0x20 ) {
F_9 ( V_7 , L_6 ) ;
F_7 ( V_2 -> V_18 , V_22 , L_6 ) ;
} else {
F_9 ( V_7 , L_7 ) ;
F_7 ( V_2 -> V_18 , V_22 , L_7 ) ;
}
if ( V_9 & 0x01 ) {
switch( V_9 ) {
case 0x01 :
...
V_11 = F_10 ( V_1 , V_8 ) ;
V_8 += 2 ;
F_11 ( V_2 -> V_18 , V_22 , L_8 , V_11 ) ;
if ( V_11 == 0xFFFF ) {
F_9 ( V_7 , L_9 ) ;
F_7 ( V_2 -> V_18 , V_22 , L_9 ) ;
...
V_10 = F_6 ( V_1 , V_8 ) ;
V_8 += 1 ;
F_11 ( V_2 -> V_18 , V_22 , L_17 , F_8 ( V_10 , V_37 , L_18 ) ) ;
if ( V_9 >= 0x11 && V_9 <= 0x20 ) {
switch( V_9 ) {
case 0x12 :
...
F_9 ( V_7 , L_19 ) ;
V_8 += 1 ;
F_2 ( V_6 , V_39 , V_1 , V_8 , 2 , V_25 ) ;
V_8 += 2 ;
F_2 ( V_6 , V_40 , V_1 , V_8 , 2 , V_25 ) ;
V_8 += 2 ;
F_2 ( V_6 , V_41 , V_1 , V_8 , 2 , V_25 ) ;
V_8 += 2 ;
break;
case 0x14 :
V_7 = F_2 ( V_6 , V_33 , V_1 , V_8 , 4 , V_25 ) ;
...
static T_12 V_64 [] = {
{ & V_28 , { L_55 , V_65 , V_66 , L_56 , V_67 } } ,
{ & V_42 , { L_57 , V_65 , V_66 , L_58 , V_67 } } ,
{ & V_45 , { L_59 , V_65 , V_66 , L_60 , V_67 } } ,
} ;
V_15 = F_21 ( L_61 , L_62 , L_63 ) ;
V_68 = F_22 ( L_63 , F_1 , V_15 ) ;
F_23 ( V_15 , V_48 , F_24 ( V_48 ) ) ;
F_25 ( V_63 , F_24 ( V_63 ) ) ;
V_47 = F_26 ( V_15 ) ;
F_27 ( V_47 , V_64 , F_24 ( V_64 ) ) ;
V_46 = F_28 ( V_15 , NULL ) ;
F_29 ( V_46 , L_64 ,
L_65 ,
L_66 ) ;
