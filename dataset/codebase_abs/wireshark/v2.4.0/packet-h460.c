...
if ( V_140 -> V_348 & V_349 ) V_140 -> V_144 = F_140 ( F_141 () , L_389 , V_140 -> V_143 ) ;
if ( V_140 -> V_348 & V_350 ) V_140 -> V_145 = F_140 ( F_141 () , L_390 , V_140 -> V_143 ) ;
if ( V_140 -> V_348 & V_351 ) V_140 -> V_146 = F_140 ( F_141 () , L_391 , V_140 -> V_143 ) ;
if ( V_140 -> V_348 & V_352 ) V_140 -> V_147 = F_140 ( F_141 () , L_392 , V_140 -> V_143 ) ;
if ( V_140 -> V_353 ) V_140 -> V_354 = F_142 ( V_140 -> V_353 , V_344 ) ;
}
}
void F_143 ( void )
{
T_12 * V_140 ;
T_16 V_355 ;
V_137 = F_144 ( L_393 , V_344 ) ;
V_138 = F_144 ( L_394 , V_344 ) ;
V_355 = F_142 ( F_128 , V_344 ) ;
for ( V_140 = V_142 ; V_140 -> V_143 ; V_140 ++ ) {
if ( V_140 -> V_144 ) F_145 ( L_395 , V_140 -> V_144 , V_355 ) ;
if ( V_140 -> V_145 ) F_145 ( L_395 , V_140 -> V_145 , V_355 ) ;
if ( V_140 -> V_146 ) F_145 ( L_396 , V_140 -> V_146 , V_355 ) ;
if ( V_140 -> V_147 ) F_145 ( L_396 , V_140 -> V_147 , V_355 ) ;
if ( V_140 -> V_354 ) {
if ( V_140 -> V_144 ) F_145 ( L_397 , V_140 -> V_144 , V_140 -> V_354 ) ;
if ( V_140 -> V_145 ) F_145 ( L_397 , V_140 -> V_145 , V_140 -> V_354 ) ;
if ( V_140 -> V_146 ) F_145 ( L_398 , V_140 -> V_146 , V_140 -> V_354 ) ;
if ( V_140 -> V_147 ) F_145 ( L_398 , V_140 -> V_147 , V_140 -> V_354 ) ;
}
}
}
