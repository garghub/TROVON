...
F_8 ( V_93 , V_95 ,
V_1 , V_2 + 4 + 4 + V_89 * 8 , 4 , V_10 ) ;
F_8 ( V_93 , V_96 ,
V_1 , V_2 + 4 + 4 + V_89 * 8 + 4 , 4 , V_10 ) ;
}
}
}
...
T_6 V_201 = { 0x0002A803 , 0x0000 , 0x0000 , { 0xC0 , 0 , 0 , 0 , 0 , 0 , 0 , 0x46 } } ;
T_6 V_202 = { 0x0002A801 , 0x0000 , 0x0000 , { 0xC0 , 0 , 0 , 0 , 0 , 0 , 0 , 0x46 } } ;
F_42 ( & V_201 , L_191 ) ;
F_42 ( & V_202 , L_192 ) ;
V_64 = F_43 ( L_193 ,
L_3 , L_194 ) ;
...
{
T_15 V_203 ;
V_203 = F_48 ( F_23 , V_64 ) ;
V_138 = F_48 ( F_22 , V_64 ) ;
F_49 ( L_195 , V_204 , V_203 ) ;
}
