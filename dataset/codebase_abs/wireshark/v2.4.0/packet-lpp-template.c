...
static int F_160 ( T_5 * V_122 , T_6 * V_123 , T_7 * V_124 , void * T_8 V_125 ) {
T_7 * V_126 ;
T_9 * V_127 ;
V_127 = F_161 ( V_124 , V_128 , V_122 , 0 , - 1 , V_129 ) ;
F_162 ( V_123 -> V_130 , V_131 , L_75 , L_76 ) ;
V_126 = F_163 ( V_127 , V_132 ) ;
return F_164 ( V_122 , V_123 , V_126 , NULL ) ;
}
void F_165 ( void ) {
static T_10 V_133 [] = {
...
{ & V_143 ,
{ L_85 , L_86 ,
V_144 , V_145 , F_167 ( & V_146 ) , 0 ,
NULL , V_138 } } ,
{ & V_147 ,
{ L_87 , L_88 ,
V_144 , V_145 , F_167 ( & V_148 ) , 0 ,
NULL , V_138 } } ,
{ & V_149 ,
{ L_89 , L_90 ,
V_144 , V_145 , F_167 ( & V_148 ) , 0 ,
...
V_128 = F_168 ( V_158 , V_159 , V_160 ) ;
F_169 ( L_93 , F_160 , V_128 ) ;
F_170 ( V_128 , V_133 , F_171 ( V_133 ) ) ;
F_172 ( V_152 , F_171 ( V_152 ) ) ;
}
void
F_173 ( void )
{
V_161 = F_174 ( L_94 , V_128 ) ;
}
