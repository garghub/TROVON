...
V_80 . V_46 = V_46 ;
V_80 . V_77 = V_77 ;
V_80 . V_86 = ( T_7 ) ( ( V_81 >> 32 ) & 0xffffffff ) ;
V_80 . V_87 = ( T_7 ) ( V_81 & 0xffffffff ) ;
V_80 . V_88 = V_23 ;
V_80 . V_89 = V_24 ;
...
if( ! V_40 && V_79 == 0 && V_47 == 0 ) {
for ( V_83 = 0 ; V_83 < V_84 ; V_83 ++ ) {
V_82 [ V_83 ] = 0 ;
}
V_82 [ V_83 ] = ( V_46 & 0x000000ff ) ;
V_83 ++ ;
V_82 [ V_83 ] = ( V_46 & 0x0000ff00 ) >> 8 ;
V_83 ++ ;
V_82 [ V_83 ] = ( V_46 & 0x00ff0000 ) >> 16 ;
V_83 ++ ;
V_82 [ V_83 ] = ( V_46 & 0xff000000 ) >> 24 ;
V_83 ++ ;
return F_1 ( V_1 , ( const T_3 * ) & V_82 , V_83 , V_4 , V_5 ) ;
}
if ( V_84 ) {
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_38 , V_84 , V_4 , V_5 ) )
return FALSE ;
}
if ( ! F_6 ( V_1 , V_56 , V_40 ,
V_4 , V_5 ) )
...
#ifdef F_11
F_12 ( & V_96 ) ;
V_81 = ( ( ( T_5 ) ( T_7 ) V_96 . V_98 ) << 32 ) +
( T_7 ) V_96 . V_99 ;
V_81 /= 10 ;
V_81 -= F_13 ( 11644473600000000 ) ;
#else
F_14 ( & V_96 , NULL ) ;
V_81 = ( T_5 ) ( V_96 . V_100 ) * 1000000 +
( T_5 ) ( V_96 . V_101 ) ;
#endif
V_46 = ( T_7 ) ( sizeof( struct V_95 ) + sizeof( T_7 ) ) ;
V_47 = 0 ;
if ( V_93 != V_102 ) {
V_47 += ( T_7 ) ( sizeof( struct V_34 ) +
sizeof( T_5 ) ) ;
...
V_95 . V_46 = V_46 ;
V_95 . V_77 = V_77 ;
V_95 . V_86 = ( T_7 ) ( ( V_81 >> 32 ) & 0xffffffff ) ;
V_95 . V_87 = ( T_7 ) ( V_81 & 0xffffffff ) ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_95 , sizeof( struct V_95 ) , V_4 , V_5 ) )
return FALSE ;
if ( ! F_6 ( V_1 , V_56 , V_40 ,
V_4 , V_5 ) )
return FALSE ;
...
V_34 . type = V_106 ;
V_34 . V_39 = sizeof( T_5 ) ;
V_104 = ( T_7 ) ( ( V_91 >> 32 ) & 0xffffffff ) ;
V_105 = ( T_7 ) ( V_91 & 0xffffffff ) ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_34 , sizeof( struct V_34 ) , V_4 , V_5 ) )
return FALSE ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_104 , sizeof( T_7 ) , V_4 , V_5 ) )
return FALSE ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_105 , sizeof( T_7 ) , V_4 , V_5 ) )
return FALSE ;
}
if ( V_92 != 0 ) {
T_7 V_104 , V_105 ;
V_34 . type = V_107 ;
V_34 . V_39 = sizeof( T_5 ) ;
V_104 = ( T_7 ) ( ( V_92 >> 32 ) & 0xffffffff ) ;
V_105 = ( T_7 ) ( V_92 & 0xffffffff ) ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_34 , sizeof( struct V_34 ) , V_4 , V_5 ) )
return FALSE ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_104 , sizeof( T_7 ) , V_4 , V_5 ) )
return FALSE ;
...
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_34 , sizeof( struct V_34 ) , V_4 , V_5 ) )
return FALSE ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_93 , sizeof( T_5 ) , V_4 , V_5 ) )
return FALSE ;
}
if ( V_94 != V_102 ) {
V_34 . type = V_109 ;
...
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_34 , sizeof( struct V_34 ) , V_4 , V_5 ) )
return FALSE ;
if ( ! F_1 ( V_1 , ( const T_3 * ) & V_94 , sizeof( T_5 ) , V_4 , V_5 ) )
return FALSE ;
}
if ( V_47 != 0 ) {
V_34 . type = V_60 ;
