...
const T_1 *
F_39 ( const T_6 V_1 , const T_11 * V_32 , T_5 * V_7 )
{
T_5 V_8 = 0 ;
if( V_32 ) {
while( V_32 [ V_8 ] . V_9 ) {
...
const T_1 *
F_40 ( const T_6 V_1 , const T_11 * V_32 )
{
T_5 V_11 = 0 ;
return F_39 ( V_1 , V_32 , & V_11 ) ;
}
const T_1 *
F_41 ( const T_12 * V_1 , const T_13 V_35 , const T_14 * V_36 , const char * V_3 )
{
const T_1 * V_4 ;
F_2 ( V_3 != NULL ) ;
V_4 = F_42 ( V_1 , V_35 , V_36 ) ;
if ( V_4 != NULL )
return V_4 ;
return F_7 ( F_5 () , V_3 ) ;
}
const T_1 *
F_42 ( const T_12 * V_1 , const T_13 V_35 , const T_14 * V_36 )
{
T_9 V_8 = 0 ;
if ( V_36 ) {
while ( V_36 [ V_8 ] . V_9 ) {
if ( V_36 [ V_8 ] . V_37 == V_35 && ! memcmp ( V_36 [ V_8 ] . V_10 , V_1 , V_35 ) ) {
return V_36 [ V_8 ] . V_9 ;
}
V_8 ++ ;
}
...
const T_1 *
F_43 ( const T_12 * V_38 , const T_13 V_39 , const T_14 * V_36 , const char * V_3 )
{
const T_1 * V_4 ;
F_2 ( V_3 != NULL ) ;
V_4 = F_44 ( V_38 , V_39 , V_36 ) ;
if ( V_4 != NULL )
return V_4 ;
return F_7 ( F_5 () , V_3 ) ;
}
const T_1 *
F_44 ( const T_12 * V_38 , const T_13 V_39 , const T_14 * V_36 )
{
T_9 V_8 = 0 ;
if ( V_36 ) {
while ( V_36 [ V_8 ] . V_9 ) {
if ( V_39 >= V_36 [ V_8 ] . V_37 &&
! memcmp ( V_36 [ V_8 ] . V_10 , V_38 , V_36 [ V_8 ] . V_37 ) ) {
return V_36 [ V_8 ] . V_9 ;
}
V_8 ++ ;
}
