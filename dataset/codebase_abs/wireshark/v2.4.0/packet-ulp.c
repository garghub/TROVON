...
static int
F_73 ( T_5 * T_6 V_11 , int T_7 V_11 , T_4 * V_9 V_11 , T_8 * T_9 V_11 , int T_10 V_11 ) {
T_7 = F_32 ( T_6 , T_7 , V_9 , T_9 , T_10 ,
V_51 , V_52 ) ;
return T_7 ;
}
...
T_7 = F_79 ( T_6 , T_7 , V_9 , T_9 , T_10 , NULL ) ;
return T_7 ;
}
static int
...
static int
F_81 ( T_5 * T_6 V_11 , int T_7 V_11 , T_4 * V_9 V_11 , T_8 * T_9 V_11 , int T_10 V_11 ) {
...
static int
F_87 ( T_5 * T_6 V_11 , int T_7 V_11 , T_4 * V_9 V_11 , T_8 * T_9 V_11 , int T_10 V_11 ) {
T_7 = F_32 ( T_6 , T_7 , V_9 , T_9 , T_10 ,
V_62 , V_63 ) ;
return T_7 ;
}
...
static int
F_112 ( T_5 * T_6 V_11 , int T_7 V_11 , T_4 * V_9 V_11 , T_8 * T_9 V_11 , int T_10 V_11 ) {
T_7 = F_41 ( T_6 , T_7 , V_9 , T_9 , T_10 ,
1 , 8 , FALSE , NULL , NULL ) ;
return T_7 ;
}
...
T_7 = F_252 ( T_6 , T_7 , V_9 , T_9 , T_10 ,
V_242 , V_242 , FALSE ) ;
return T_7 ;
}
static int
...
9 , 9 , FALSE , & V_39 , NULL ) ;
if ( V_39 ) {
V_9 -> V_16 = F_110 ( T_9 , T_10 , V_39 , 0 , 9 , V_42 ) ;
}
return T_7 ;
}
static int
...
static int
F_264 ( T_5 * T_6 V_11 , int T_7 V_11 , T_4 * V_9 V_11 , T_8 * T_9 V_11 , int T_10 V_11 ) {
#line 399 "./asn1/ulp/ulp.cnf"
T_5 * V_39 ;
T_7 = F_41 ( T_6 , T_7 , V_9 , T_9 , - 1 ,
1 , 1 , FALSE , & V_39 , NULL ) ;
if ( V_39 ) {
V_9 -> V_16 = F_110 ( T_9 , T_10 , V_39 , 0 , 1 , V_44 ) ;
}
return T_7 ;
}
static int
...
F_305 ( V_9 -> V_16 , L_46 , 15 * V_35 , V_35 ) ;
}
return T_7 ;
}
static int
...
F_305 ( V_9 -> V_16 , L_46 , 30 * V_35 , V_35 ) ;
}
return T_7 ;
}
static int
...
static int
F_317 ( T_5 * T_6 V_11 , int T_7 V_11 , T_4 * V_9 V_11 , T_8 * T_9 V_11 , int T_10 V_11 ) {
T_7 = F_32 ( T_6 , T_7 , V_9 , T_9 , T_10 ,
V_304 , V_305 ) ;
return T_7 ;
}
...
1 , 8192 , FALSE , & V_323 ) ;
if ( V_323 && V_324 ) {
F_330 ( V_324 , V_323 , V_9 -> V_22 , T_9 ) ;
}
return T_7 ;
}
static int
...
1 , 60000 , FALSE , & V_325 ) ;
if ( V_325 && V_326 ) {
F_330 ( V_326 , V_325 , V_9 -> V_22 , T_9 ) ;
}
return T_7 ;
}
static int
...
static int
F_343 ( T_5 * T_6 V_11 , int T_7 V_11 , T_4 * V_9 V_11 , T_8 * T_9 V_11 , int T_10 V_11 ) {
T_7 = F_58 ( T_6 , T_7 , V_9 , T_9 , T_10 ,
...
V_484 , V_485 ,
& V_483 ) ;
F_439 ( V_9 -> V_22 -> V_486 , V_487 , L_47 , F_440 ( V_483 , V_488 , L_48 ) ) ;
return T_7 ;
}
static int
...
F_442 ( V_9 -> V_22 -> V_486 , V_493 , V_494 ) ;
F_443 ( V_9 -> V_22 -> V_486 , V_487 ) ;
#line 40 "./asn1/ulp/ulp.cnf"
T_7 = F_32 ( T_6 , T_7 , V_9 , V_490 , T_10 ,
V_495 , V_496 ) ;
return T_7 ;
}
static int F_444 ( T_5 * T_6 V_11 , T_12 * V_22 V_11 , T_8 * T_9 V_11 , void * T_13 V_11 ) {
int T_7 = 0 ;
T_4 V_497 ;
F_445 ( & V_497 , V_498 , FALSE , V_22 ) ;
T_7 = F_441 ( T_6 , T_7 , & V_497 , T_9 , V_499 ) ;
T_7 += 7 ; T_7 >>= 3 ;
return T_7 ;
}
static T_14
F_446 ( T_12 * V_22 V_11 , T_5 * T_6 , int T_7 , void * T_13 V_11 )
{
return F_447 ( T_6 , T_7 ) ;
}
static int
F_448 ( T_5 * T_6 , T_12 * V_22 , T_8 * T_9 , void * T_13 )
{
F_449 ( T_6 , V_22 , T_9 , V_500 , V_501 ,
F_446 , F_444 , T_13 ) ;
return F_450 ( T_6 ) ;
}
void F_451 ( void ) {
...
{ & V_539 ,
{ L_122 , L_123 ,
V_507 , V_508 , F_452 ( V_540 ) , 0 ,
NULL , V_505 } } ,
{ & V_541 ,
{ L_124 , L_125 ,
V_507 , V_508 , F_452 ( V_542 ) , 0 ,
NULL , V_505 } } ,
{ & V_543 ,
{ L_126 , L_127 ,
V_544 , V_545 , NULL , 0 ,
...
{ & V_604 ,
{ L_244 , L_245 ,
V_507 , V_508 , F_452 ( V_605 ) , 0 ,
NULL , V_505 } } ,
{ & V_606 ,
{ L_246 , L_247 ,
V_507 , V_508 , F_452 ( V_607 ) , 0 ,
NULL , V_505 } } ,
{ & V_608 ,
{ L_248 , L_249 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_619 ,
{ L_269 , L_270 ,
V_507 , V_508 , F_452 ( V_620 ) , 0 ,
NULL , V_505 } } ,
{ & V_621 ,
{ L_271 , L_272 ,
V_507 , V_508 , F_452 ( V_622 ) , 0 ,
L_273 , V_505 } } ,
{ & V_623 ,
{ L_274 , L_275 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_626 ,
{ L_280 , L_281 ,
V_507 , V_508 , F_452 ( V_627 ) , 0 ,
NULL , V_505 } } ,
{ & V_628 ,
{ L_282 , L_283 ,
V_507 , V_508 , F_452 ( V_629 ) , 0 ,
NULL , V_505 } } ,
{ & V_630 ,
{ L_284 , L_285 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_686 ,
{ L_391 , L_392 ,
V_507 , V_508 , F_452 ( V_687 ) , 0 ,
L_393 , V_505 } } ,
{ & V_688 ,
{ L_394 , L_395 ,
V_507 , V_508 , F_452 ( V_689 ) , 0 ,
NULL , V_505 } } ,
{ & V_690 ,
{ L_396 , L_397 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_704 ,
{ L_425 , L_426 ,
V_507 , V_508 , F_452 ( V_705 ) , 0 ,
NULL , V_505 } } ,
{ & V_706 ,
{ L_427 , L_428 ,
V_507 , V_508 , F_452 ( V_707 ) , 0 ,
NULL , V_505 } } ,
{ & V_708 ,
{ L_429 , L_430 ,
V_507 , V_508 , NULL , 0 ,
...
{ & V_870 ,
{ L_753 , L_754 ,
V_507 , V_508 , F_452 ( V_871 ) , 0 ,
NULL , V_505 } } ,
{ & V_872 ,
{ L_755 , L_756 ,
V_507 , V_508 , F_452 ( V_873 ) , 0 ,
NULL , V_505 } } ,
{ & V_874 ,
{ L_757 , L_758 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_881 ,
{ L_770 , L_771 ,
V_507 , V_508 , F_452 ( V_882 ) , 0 ,
NULL , V_505 } } ,
{ & V_883 ,
{ L_772 , L_773 ,
V_507 , V_829 , F_453 ( F_4 ) , 0 ,
L_774 , V_505 } } ,
{ & V_884 ,
{ L_775 , L_776 ,
V_728 , V_829 , F_453 ( F_5 ) , 0 ,
L_777 , V_505 } } ,
{ & V_885 ,
{ L_778 , L_779 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_888 ,
{ L_785 , L_786 ,
V_507 , V_508 | V_596 , & V_889 , 0 ,
L_787 , V_505 } } ,
{ & V_890 ,
{ L_788 , L_789 ,
V_507 , V_508 | V_596 , & V_891 , 0 ,
L_790 , V_505 } } ,
{ & V_892 ,
{ L_791 , L_792 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_893 ,
{ L_793 , L_794 ,
V_507 , V_508 , F_452 ( V_894 ) , 0 ,
NULL , V_505 } } ,
{ & V_895 ,
{ L_795 , L_796 ,
V_507 , V_508 | V_596 , & V_896 , 0 ,
L_370 , V_505 } } ,
{ & V_897 ,
{ L_797 , L_798 ,
V_507 , V_829 , F_453 ( F_12 ) , 0 ,
L_782 , V_505 } } ,
{ & V_898 ,
{ L_368 , L_369 ,
V_507 , V_508 , NULL , 0 ,
...
{ & V_913 ,
{ L_825 , L_826 ,
V_507 , V_508 , F_452 ( V_914 ) , 0 ,
NULL , V_505 } } ,
{ & V_915 ,
{ L_827 , L_828 ,
V_507 , V_508 , F_452 ( V_916 ) , 0 ,
NULL , V_505 } } ,
{ & V_917 ,
{ L_829 , L_830 ,
V_507 , V_508 , F_452 ( V_918 ) , 0 ,
L_831 , V_505 } } ,
{ & V_919 ,
{ L_832 , L_833 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_937 ,
{ L_865 , L_866 ,
V_507 , V_829 , F_453 ( F_9 ) , 0 ,
NULL , V_505 } } ,
{ & V_938 ,
{ L_867 , L_868 ,
V_507 , V_829 , F_453 ( F_10 ) , 0 ,
NULL , V_505 } } ,
{ & V_939 ,
{ L_869 , L_870 ,
V_507 , V_508 , NULL , 0 ,
...
{ & V_954 ,
{ L_898 , L_899 ,
V_955 , V_508 | V_596 , & V_889 , 0 ,
NULL , V_505 } } ,
{ & V_956 ,
{ L_900 , L_901 ,
V_955 , V_508 | V_596 , & V_957 , 0 ,
NULL , V_505 } } ,
{ & V_958 ,
{ L_902 , L_903 ,
V_560 , V_504 , F_454 ( & V_959 ) , 0 ,
NULL , V_505 } } ,
{ & V_960 ,
{ L_898 , L_899 ,
V_955 , V_508 | V_596 , & V_889 , 0 ,
...
{ & V_1042 ,
{ L_1062 , L_1063 ,
V_507 , V_829 , F_453 ( F_15 ) , 0 ,
L_1064 , V_505 } } ,
{ & V_1043 ,
{ L_1065 , L_1066 ,
V_507 , V_829 , F_453 ( F_16 ) , 0 ,
L_1067 , V_505 } } ,
{ & V_1044 ,
{ L_813 , L_814 ,
V_507 , V_508 , NULL , 0 ,
...
{ & V_1059 ,
{ L_1094 , L_1095 ,
V_728 , V_508 | V_596 , & V_1060 , 0 ,
L_1096 , V_505 } } ,
{ & V_1061 ,
{ L_1097 , L_1098 ,
V_728 , V_508 | V_596 , & V_1062 , 0 ,
L_1096 , V_505 } } ,
{ & V_1063 ,
{ L_1099 , L_1100 ,
V_728 , V_508 | V_596 , & V_1064 , 0 ,
L_1096 , V_505 } } ,
{ & V_1065 ,
{ L_1101 , L_1102 ,
V_507 , V_508 , F_452 ( V_1066 ) , 0 ,
NULL , V_505 } } ,
{ & V_1067 ,
{ L_1103 , L_1104 ,
V_728 , V_508 | V_596 , & V_1060 , 0 ,
...
{ & V_1075 ,
{ L_1122 , L_1123 ,
V_507 , V_508 , F_452 ( V_1076 ) , 0 ,
L_1124 , V_505 } } ,
{ & V_1077 ,
{ L_1125 , L_1126 ,
V_507 , V_829 , F_453 ( F_17 ) , 0 ,
L_1127 , V_505 } } ,
{ & V_1078 ,
{ L_1128 , L_1129 ,
V_507 , V_829 , F_453 ( F_17 ) , 0 ,
...
{ & V_1114 ,
{ L_1193 , L_1194 ,
V_507 , V_829 , F_453 ( F_20 ) , 0 ,
L_243 , V_505 } } ,
{ & V_1115 ,
{ L_1195 , L_1196 ,
V_507 , V_508 | V_596 , & V_1064 , 0 ,
L_240 , V_505 } } ,
{ & V_1116 ,
{ L_1197 , L_1198 ,
V_507 , V_829 , F_453 ( F_20 ) , 0 ,
...
{ & V_1121 ,
{ L_1207 , L_1208 ,
V_507 , V_829 , F_453 ( F_21 ) , 0 ,
L_782 , V_505 } } ,
{ & V_1122 ,
{ L_1209 , L_1210 ,
V_507 , V_508 , F_452 ( V_1123 ) , 0 ,
NULL , V_505 } } ,
{ & V_1124 ,
{ L_1211 , L_1212 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_1147 ,
{ L_1246 , L_1247 ,
V_507 , V_829 , F_453 ( F_22 ) , 0 ,
L_1248 , V_505 } } ,
{ & V_1148 ,
{ L_829 , L_830 ,
V_507 , V_508 , F_452 ( V_1149 ) , 0 ,
L_1249 , V_505 } } ,
{ & V_1150 ,
{ L_832 , L_833 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_1193 ,
{ L_770 , L_771 ,
V_507 , V_508 , F_452 ( V_1194 ) , 0 ,
L_1328 , V_505 } } ,
{ & V_1195 ,
{ L_772 , L_773 ,
V_507 , V_829 , F_453 ( F_23 ) , 0 ,
L_774 , V_505 } } ,
{ & V_1196 ,
{ L_775 , L_776 ,
V_728 , V_829 , F_453 ( F_24 ) , 0 ,
L_777 , V_505 } } ,
{ & V_1197 ,
{ L_1329 , L_1330 ,
V_503 , V_504 , NULL , 0 ,
...
{ & V_290 ,
{ L_1379 , L_1380 ,
V_560 , 16 , F_454 ( & V_1219 ) , 0x8000 ,
NULL , V_505 } } ,
{ & V_291 ,
{ L_1381 , L_1382 ,
V_560 , 16 , F_454 ( & V_1219 ) , 0x4000 ,
NULL , V_505 } } ,
{ & V_292 ,
{ L_1383 , L_1384 ,
V_560 , 16 , F_454 ( & V_1219 ) , 0x2000 ,
NULL , V_505 } } ,
{ & V_293 ,
{ L_1385 , L_1386 ,
V_560 , 16 , F_454 ( & V_1219 ) , 0x1000 ,
NULL , V_505 } } ,
{ & V_294 ,
{ L_1387 , L_1388 ,
V_560 , 16 , F_454 ( & V_1219 ) , 0x0800 ,
NULL , V_505 } } ,
{ & V_295 ,
{ L_1389 , L_1390 ,
V_955 , V_1220 , NULL , 0x07ff ,
NULL , V_505 } } ,
} ;
static T_16 * V_1221 [] = {
& V_492 ,
...
T_17 * V_1223 ;
V_491 = F_455 ( V_1224 , V_494 , V_1225 ) ;
V_1226 = F_456 ( L_1391 , F_448 , V_491 ) ;
F_457 ( V_491 , V_502 , F_458 ( V_502 ) ) ;
F_459 ( V_1221 , F_458 ( V_1221 ) ) ;
V_1223 = F_460 ( V_491 , NULL ) ;
F_461 ( V_1223 , L_1392 ,
L_1393 ,
L_1394
L_1395 ,
...
{
T_18 V_1227 ;
F_463 ( L_1396 , L_1397 , V_1226 ) ;
F_463 ( L_1396 , L_1398 , V_1226 ) ;
V_1227 = F_464 ( F_444 , V_491 ) ;
V_324 = F_465 ( L_170 , V_491 ) ;
V_326 = F_465 ( L_548 , V_491 ) ;
F_466 ( L_1399 , V_1228 , V_1226 ) ;
F_466 ( L_1400 , V_1228 , V_1227 ) ;
}
