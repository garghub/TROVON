...
for( V_24 = 0 ; V_24 < V_23 ; V_2 ++ ) {
V_25 = * V_2 ;
V_26 = ( ( V_25 & V_30 ) << ( 7 - V_29 ) ) | V_27 ;
V_27 = V_25 >> V_29 ;
if ( ( V_28 != V_2 ) || ( V_29 == 7 ) ) {
V_21 = F_22 ( V_11 , V_26 ,
V_21 ) ;
...
for( V_24 = 0 ; V_24 < V_23 ; V_2 ++ ) {
V_25 = * V_2 ;
V_26 = ( V_25 >> ( 8 - V_29 ) ) | V_27 ;
V_27 = ( V_25 << ( V_29 - 1 ) ) & 0x7f ;
if ( ( V_28 != V_2 ) || ( V_29 == 7 ) ) {
F_3 ( V_11 , V_26 ) ;
V_24 ++ ;
}
...
void
F_25 ( T_1 * V_31 , T_6 V_32 )
{
T_6 V_10 ;
T_1 * V_33 ;
V_33 = V_31 ;
for ( V_10 = 0 ; V_10 < V_32 ; V_10 ++ , V_33 ++ ) {
* V_33 = V_34 [ * V_33 ] ;
}
}
T_1
...
T_1 *
F_27 ( T_2 * V_1 , const T_1 * V_2 , T_3 V_3 , const T_5 V_7 [ 256 ] )
{
T_4 * V_4 ;
V_4 = F_2 ( V_1 , V_3 + 1 , 0 ) ;
while ( V_3 > 0 ) {
...
T_1 *
F_28 ( T_2 * V_1 , const T_1 * V_2 , T_3 V_3 )
{
T_3 V_10 ;
T_1 * V_16 ;
T_4 * V_11 ;
V_11 = F_2 ( V_1 , V_3 + 1 , 0 ) ;
for ( V_10 = 0 , V_16 = ( T_1 * ) V_2 ; V_10 < V_3 ; V_16 ++ , V_10 ++ ) {
if ( ! V_35 [ * V_16 ] ) {
F_4 ( V_11 , V_6 ) ;
} else if ( ( * V_16 & 0xf0 ) == 0xc0 ) {
T_3 V_36 = * V_16 & 0x0f ;
if ( ( ! V_16 [ 1 ] || V_16 [ 1 ] == 0x20 ) && V_37 [ V_36 ] ) {
F_4 ( V_11 , V_37 [ V_36 ] ) ;
} else if ( V_38 [ V_36 ] && V_38 [ V_36 ] [ V_16 [ 1 ] >> 5 ] &&
( * V_38 [ V_36 ] [ V_16 [ 1 ] >> 5 ] ) [ V_16 [ 1 ] & 0x1f ] ) {
F_4 ( V_11 , ( * V_38 [ V_36 ] [ V_16 [ 1 ] >> 5 ] ) [ V_16 [ 1 ] & 0x1f ] ) ;
} else {
F_4 ( V_11 , V_16 [ 1 ] ) ;
F_4 ( V_11 , V_35 [ * V_16 ] ) ;
}
