...
#define F_23 2
#define F_24 1
if ( F_3 ( V_1 ) < V_46 ) { return FALSE ; }
V_42 = F_25 ( V_1 , 0 ) & 0x7f ;
if ( V_42 != 0x00 && V_42 != 0x20 && V_42 != 0x40 && V_42 != 0x60 ) {
return FALSE ;
}
V_42 = F_25 ( V_1 , F_23 ) ;
if ( V_42 != 0x00 && V_42 != 0x40 && V_42 != 0x80 ) {
return FALSE ;
}
V_45 = F_22 ;
V_44 = F_25 ( V_1 , V_45 ) ;
...
if ( V_44 != ( F_20 ( V_1 ) - V_45 ) ) {
return FALSE ;
}
V_42 = F_25 ( V_1 , F_24 ) ;
if ( V_42 > V_47 ) { return FALSE ; }
V_43 = F_26 ( V_1 , V_45 + 1 ) ;
if ( V_43 > 0x1ff ) {
return FALSE ;
}
...
V_30 = F_28 ( V_61 , V_62 , V_63 ) ;
F_29 ( V_30 , V_49 , F_30 ( V_49 ) ) ;
F_31 ( V_58 , F_30 ( V_58 ) ) ;
V_64 = F_32 ( L_9 , F_11 , V_30 ) ;
V_13 = F_33 ( L_10 , L_11 , V_30 , V_65 , V_66 ) ;
V_15 = F_33 ( L_12 , L_13 , V_30 , V_65 , V_66 ) ;
V_16 = F_33 ( L_14 , L_15 , V_30 , V_65 , V_66 ) ;
V_17 = F_33 ( L_16 , L_17 , V_30 , V_65 , V_66 ) ;
V_20 = F_33 ( L_18 , L_19 , V_30 , V_65 , V_66 ) ;
V_22 = F_33 ( L_20 , L_21 , V_30 , V_65 , V_66 ) ;
V_23 = F_33 ( L_22 , L_23 , V_30 , V_65 , V_66 ) ;
V_24 = F_33 ( L_24 , L_25 , V_30 , V_65 , V_66 ) ;
V_67 = F_33 ( L_26 , L_27 , V_30 , V_68 , V_66 ) ;
V_48 = F_34 ( V_30 , V_69 ) ;
F_35 ( V_48 , L_28 , L_29 ,
L_30 , 10 ,
& V_70 ) ;
...
F_40 ( L_38 , V_70 , V_64 ) ;
V_73 = V_70 ;
F_41 ( L_39 , F_21 , L_40 , L_41 , V_30 , V_78 ) ;
F_41 ( L_42 , F_21 , L_43 , L_44 , V_30 , V_78 ) ;
}
