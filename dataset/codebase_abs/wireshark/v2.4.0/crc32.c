...
F_9 ( V_11 , V_4 [ V_10 ] , V_3 ) ;
return ( ~ V_11 ) ;
}
T_1
F_10 ( const T_3 * V_4 , T_4 V_5 , T_1 V_9 )
{
T_4 V_10 ;
T_1 V_11 ;
V_11 = V_9 ;
...
T_1
F_11 ( const T_3 * V_4 , T_4 V_5 , T_1 V_9 )
{
T_4 V_11 ;
V_11 = ( T_4 ) V_9 ;
while( V_5 -- != 0 )
...
T_1
F_12 ( const T_3 * V_4 , T_4 V_5 , T_1 V_9 )
{
T_1 V_6 = V_9 ;
if ( V_5 > 0 )
{
...
{
T_3 V_14 = * V_4 ++ ;
V_6 = V_15 [ ( ( V_6 >> 16 ) ^ V_14 ) & 0xff ] ^ ( V_6 << 8 ) ;
}
}
return ( V_6 & 0x00ffffff ) ;
}
