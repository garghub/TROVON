...
V_4 = 0 ;
V_11 = 0 ;
V_16 = F_9 ( F_7 () , V_13 , ( V_4 << 3 ) + V_11 , V_6 ) ;
F_10 ( V_18 , V_16 , V_6 ) ;
F_5 ( V_3 , V_10 , V_13 , 0 ,
V_12 , V_18 ) ;
break;
...
T_21 V_290 ;
T_10 V_102 ;
V_290 = F_107 ( F_92 , V_234 ) ;
F_108 ( L_306 , L_307 , V_290 ) ;
for ( V_102 = 0 ; V_102 < ( ( sizeof( V_176 ) / sizeof( V_291 ) ) - 1 ) ; V_102 ++ )
{
