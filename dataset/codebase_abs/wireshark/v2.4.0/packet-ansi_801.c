...
F_2 ( V_4 , 2 ) ;
V_6 = V_5 ;
F_3 ( V_3 , V_97 , V_1 , V_5 , 1 , V_20 ) ;
V_5 ++ ;
F_3 ( V_3 , V_98 , V_1 , V_5 , 1 , V_20 ) ;
V_5 ++ ;
F_4 ( V_4 , V_5 - V_6 ) ;
}
static void
...
switch ( ( V_18 & 0x0e ) >> 1 )
{
case 0x00 : V_24 = L_25 ; break;
case 0x01 : V_24 = L_26 ; break;
default: V_24 = L_1 ; break;
}
...
case 0x02 : V_24 = L_29 ; break;
case 0x03 : V_24 = L_30 ; break;
case 0x04 : V_24 = L_31 ; break;
default: V_24 = L_1 ; break;
}
...
switch ( V_134 )
{
case 0x00 : V_24 = L_34 ; break;
case 0x01 : V_24 = L_34 ; break;
...
{ & V_97 ,
{ L_246 , L_247 ,
V_197 , V_198 | V_215 , & V_216 , 0x0 ,
NULL , V_199 }
} ,
{ & V_98 ,
{ L_248 , L_249 ,
V_197 , V_198 | V_215 , & V_217 , 0x0 ,
NULL , V_199 }
} ,
} ;
#define F_64 3
T_8 * V_218 [ F_64 + V_219 + V_220 + V_221 + V_222 ] ;
static T_13 V_223 [] = {
{ & V_178 , { L_250 , V_224 , V_225 , L_251 , V_226 } } ,
{ & V_177 , { L_252 , V_224 , V_225 , L_253 , V_226 } } ,
{ & V_227 , { L_254 , V_224 , V_228 , L_255 , V_226 } } ,
} ;
T_14 * V_229 ;
V_218 [ 0 ] = & V_194 ;
V_218 [ 1 ] = & V_106 ;
...
{
V_140 [ V_78 ] = - 1 ;
V_218 [ V_195 ] = & V_140 [ V_78 ] ;
}
for ( V_78 = 0 ; V_78 < V_220 ; V_78 ++ , V_195 ++ )
{
V_148 [ V_78 ] = - 1 ;
V_218 [ V_195 ] = & V_148 [ V_78 ] ;
}
for ( V_78 = 0 ; V_78 < V_221 ; V_78 ++ , V_195 ++ )
{
V_152 [ V_78 ] = - 1 ;
V_218 [ V_195 ] = & V_152 [ V_78 ] ;
}
for ( V_78 = 0 ; V_78 < V_222 ; V_78 ++ , V_195 ++ )
{
V_157 [ V_78 ] = - 1 ;
V_218 [ V_195 ] = & V_157 [ V_78 ] ;
}
V_190 =
F_65 ( V_191 , L_256 , L_257 ) ;
F_66 ( V_190 , V_196 , F_67 ( V_196 ) ) ;
F_68 ( V_218 , F_67 ( V_218 ) ) ;
V_229 = F_69 ( V_190 ) ;
F_70 ( V_229 , V_223 , F_67 ( V_223 ) ) ;
V_230 = F_71 ( L_257 , F_57 , V_190 ) ;
}
void
F_72 ( void )
{
F_73 ( L_258 , V_193 , V_230 ) ;
F_73 ( L_258 , V_231 , V_230 ) ;
F_73 ( L_259 , V_193 , V_230 ) ;
F_73 ( L_259 , V_231 , V_230 ) ;
}
