...
T_8 * F_37 ( T_5 * V_19 , T_9 V_24 , T_9 V_25 ,
...
F_39 ( V_32 ) , V_34 ) ;
V_35 = F_26 ( V_19 , V_24 , V_25 , F_39 ( V_32 ) ) ;
V_35 -> V_20 = V_20 ;
if( V_21 != NULL ) {
V_20 -> V_21 = V_21 ;
V_19 -> V_16 = NULL ;
...
return F_42 ( V_32 , V_25 , V_33 , V_36 , V_20 -> V_21 ,
V_39 , V_40 , V_41 ) ;
}
...
T_12 * F_44 ( const T_8 * V_37 )
{
F_28 ( V_37 ) ;
return V_37 -> V_20 -> V_21 ;
}
T_9 F_45 ( const T_8 * V_37 )
{
F_28 ( V_37 ) ;
