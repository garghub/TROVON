...
V_26 += V_25 ;
V_7 = F_11 ( V_8 , V_57 , V_1 , V_9 , 0 , V_25 ) ;
F_10 ( V_7 ) ;
V_22 += 1 ;
}
V_7 = F_11 ( V_6 , V_58 , V_1 , V_9 , 0 , V_26 ) ;
F_10 ( V_7 ) ;
if ( V_27 && V_27 -> V_59 && V_27 -> V_60 > 0 ) {
}
if ( V_27 && V_27 -> V_61 && V_27 -> V_62 ) {
T_10 V_63 ;
F_12 ( & V_63 , & V_2 -> V_64 , & V_27 -> V_61 -> V_64 ) ;
V_7 = F_11 ( V_6 , V_65 , V_1 , V_9 , 0 , F_13 ( & V_63 ) ) ;
F_10 ( V_7 ) ;
V_7 = F_11 ( V_6 , V_66 , V_1 , V_9 , 0 , V_27 -> V_61 -> V_67 ) ;
F_10 ( V_7 ) ;
F_12 ( & V_63 , & V_2 -> V_64 , & V_27 -> V_61 -> V_68 ) ;
V_7 = F_11 ( V_6 , V_69 , V_1 , V_9 , 0 , F_13 ( & V_63 ) ) ;
F_10 ( V_7 ) ;
if ( ! V_2 -> V_70 -> V_71 . V_72 ) {
V_27 -> V_62 -> V_26 += V_26 ;
V_27 -> V_62 -> V_67 += V_26 ;
}
V_7 = F_11 ( V_6 , V_73 , V_1 , V_9 , 0 , V_27 -> V_61 -> V_26 ) ;
F_10 ( V_7 ) ;
V_7 = F_11 ( V_6 , V_74 , V_1 , V_9 , 0 , V_27 -> V_61 -> V_26 - F_13 ( & V_63 ) ) ;
F_10 ( V_7 ) ;
}
F_14 ( V_2 -> V_28 , V_75 , L_3 , V_10 ) ;
return V_9 ;
}
void
F_15 ( void )
...
{ & V_48 ,
{ L_16 , L_17 ,
V_81 , V_83 , F_16 ( V_84 ) , 0xC0 ,
NULL , V_80 }
} ,
{ & V_49 ,
{ L_18 , L_19 ,
V_81 , V_83 , F_16 ( V_85 ) , 0x30 ,
NULL , V_80 }
} ,
{ & V_50 ,
{ L_20 , L_21 ,
V_81 , V_83 , F_16 ( V_86 ) , 0x0C ,
NULL , V_80 }
} ,
{ & V_51 ,
{ L_22 , L_23 ,
V_81 , V_83 , F_16 ( V_87 ) , 0x02 ,
NULL , V_80 }
} ,
{ & V_52 ,
{ L_24 , L_25 ,
V_81 , V_83 , F_16 ( V_88 ) , 0x01 ,
NULL , V_80 }
} ,
{ & V_53 ,
{ L_26 , L_27 ,
...
{ & V_56 ,
{ L_30 , L_31 ,
V_89 , V_82 | V_90 , & V_91 , 0x00 ,
NULL , V_80 }
} ,
{ & V_57 ,
{ L_32 , L_33 ,
V_92 , V_93 | V_90 , & V_94 , 0x00 ,
NULL , V_80 }
} ,
{ & V_58 ,
{ L_34 , L_35 ,
...
static T_14 V_97 [] = {
{ & V_47 , { L_48 , V_98 , V_99 , L_49 , V_100 } } ,
} ;
V_30 = F_17 ( L_50 , L_1 , L_51 ) ;
F_18 ( V_30 , V_78 , F_19 ( V_78 ) ) ;
F_20 ( V_96 , F_19 ( V_96 ) ) ;
V_77 = F_21 ( V_30 ) ;
F_22 ( V_77 , V_97 , F_19 ( V_97 ) ) ;
F_23 ( L_51 , F_1 , V_30 ) ;
V_76 = F_24 ( V_30 , NULL ) ;
F_25 ( V_76 , L_52 ,
L_53 ,
