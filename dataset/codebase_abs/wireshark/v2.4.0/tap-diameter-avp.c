...
V_56 ++ ;
if ( V_56 > 2 ) {
if ( strlen ( V_55 [ 2 ] ) > 0 && V_55 [ 2 ] [ 0 ] != '*' ) {
if ( ! F_19 ( V_55 [ 2 ] , NULL , & V_36 -> V_31 ) ) {
fprintf ( V_15 , L_10 , V_55 [ 2 ] ) ;
F_20 ( V_55 ) ;
exit ( 1 ) ;
}
}
...
F_20 ( V_55 ) ;
V_36 -> V_58 = F_22 ( V_58 , FALSE ) ;
V_59 = F_23 ( L_5 , V_36 , V_36 -> V_58 , 0 , NULL , F_10 , F_14 ) ;
if ( V_59 ) {
F_9 ( V_36 ) ;
fprintf ( V_15 , L_13 ,
V_59 -> V_60 ) ;
