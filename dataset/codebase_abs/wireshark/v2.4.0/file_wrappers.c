...
#endif
V_1 -> V_12 = ( unsigned char * ) F_33 ( ( V_85 ) V_79 ) ;
V_1 -> V_27 = ( unsigned char * ) F_33 ( ( ( V_85 ) V_79 ) << 1 ) ;
V_1 -> V_13 = V_79 ;
...
const char * V_92 ;
#endif
if ( ( V_6 = F_38 ( V_90 , V_93 | V_94 , 0000 ) ) == - 1 )
return NULL ;
V_91 = F_31 ( V_6 ) ;
if ( V_91 == NULL ) {
F_39 ( V_6 ) ;
...
void
F_41 ( T_1 V_95 , T_12 T_13 V_96 , T_14 * V_97 )
{
V_95 -> V_24 = V_97 ;
}
T_4
F_42 ( T_1 V_17 , T_4 V_98 , int V_99 , int * V_8 )
{
struct V_16 * V_100 ;
T_2 V_34 ;
if ( V_99 != V_101 && V_99 != V_82 && V_99 != V_102 ) {
F_43 () ;
}
if ( V_99 == V_102 ) {
if ( F_29 ( V_17 , V_103 ) == - 1 ) {
* V_8 = V_17 -> V_8 ;
return - 1 ;
}
if ( V_98 == 0 ) {
...
V_17 -> V_77 = FALSE ;
if ( V_98 < 0 && V_17 -> V_66 ) {
T_2 V_105 = ( unsigned ) ( V_17 -> V_66 - V_17 -> V_27 ) ;
if ( - V_98 <= V_105 ) {
T_2 V_106 = ( unsigned ) ( - V_98 ) ;
V_17 -> V_4 += V_106 ;
V_17 -> V_66 -= V_106 ;
V_17 -> V_18 -= V_106 ;
return V_17 -> V_18 ;
...
if ( ( V_100 = F_4 ( V_17 , V_17 -> V_18 + V_98 ) ) && ( V_98 < 0 || V_98 > V_38 || V_100 -> V_30 == V_75 ) ) {
T_4 V_107 , V_108 ;
#ifdef F_25
if ( V_100 -> V_30 == V_39 ) {
#ifdef F_15
V_107 = V_100 -> V_12 - ( V_100 -> V_40 . V_41 . V_37 ? 1 : 0 ) ;
#else
V_107 = V_100 -> V_12 ;
#endif
V_108 = V_100 -> V_27 ;
} else if ( V_100 -> V_30 == V_74 ) {
V_107 = V_100 -> V_12 ;
V_108 = V_100 -> V_27 ;
} else
#endif
{
V_108 = ( V_17 -> V_18 + V_98 ) ;
V_107 = V_100 -> V_12 + ( V_108 - V_100 -> V_27 ) ;
}
if ( F_34 ( V_17 -> V_6 , V_107 , V_101 ) == - 1 ) {
* V_8 = V_9 ;
return - 1 ;
}
F_44 ( V_17 ) ;
...
T_15 * V_46 = & V_17 -> V_46 ;
F_26 ( V_46 ) ;
V_46 -> V_45 = V_100 -> V_40 . V_41 . V_45 ;
V_46 -> V_47 = V_100 -> V_40 . V_41 . V_47 ;
#ifdef F_15
if ( V_100 -> V_40 . V_41 . V_37 ) {
T_1 V_1 = V_17 ;
int V_5 = F_9 () ;
if ( V_5 == - 1 ) {
if ( V_1 -> V_8 == 0 ) {
...
( void ) F_45 ( V_46 , V_100 -> V_40 . V_41 . V_37 , V_5 >> ( 8 - V_100 -> V_40 . V_41 . V_37 ) ) ;
}
#endif
( void ) F_46 ( V_46 , V_100 -> V_40 . V_41 . V_44 , V_43 ) ;
V_17 -> V_30 = V_39 ;
} else if ( V_100 -> V_30 == V_74 ) {
T_15 * V_46 = & V_17 -> V_46 ;
F_26 ( V_46 ) ;
...
#endif
V_17 -> V_30 = V_100 -> V_30 ;
V_98 = ( V_17 -> V_18 + V_98 ) - V_108 ;
V_17 -> V_18 = V_108 ;
if ( V_98 ) {
V_17 -> V_77 = TRUE ;
V_17 -> V_104 = V_98 ;
}
return V_17 -> V_18 + V_98 ;
}
if ( V_17 -> V_30 == V_75 && V_17 -> V_18 + V_98 >= V_17 -> V_76
&& ( V_98 < 0 || V_98 >= V_17 -> V_4 )
&& ( V_17 -> V_24 ) )
{
if ( F_34 ( V_17 -> V_6 , V_98 - V_17 -> V_4 , V_82 ) == - 1 ) {
* V_8 = V_9 ;
return - 1 ;
}
V_17 -> V_7 += ( V_98 - V_17 -> V_4 ) ;
V_17 -> V_4 = 0 ;
V_17 -> V_11 = FALSE ;
V_17 -> V_77 = FALSE ;
V_17 -> V_8 = 0 ;
...
if ( F_34 ( V_17 -> V_6 , V_17 -> V_81 , V_101 ) == - 1 ) {
* V_8 = V_9 ;
return - 1 ;
}
F_44 ( V_17 ) ;
...
V_34 = ( T_4 ) V_17 -> V_4 > V_98 ? ( unsigned ) V_98 : V_17 -> V_4 ;
V_17 -> V_4 -= V_34 ;
V_17 -> V_66 += V_34 ;
V_17 -> V_18 += V_34 ;
V_98 -= V_34 ;
...
F_47 ( T_1 V_95 )
{
return V_95 -> V_18 + ( V_95 -> V_77 ? V_95 -> V_104 : 0 ) ;
}
T_4
F_48 ( T_1 V_95 )
{
...
int
F_49 ( T_1 V_95 , T_11 * V_110 , int * V_8 )
{
if ( F_35 ( V_95 -> V_6 , V_110 ) == - 1 ) {
if ( V_8 != NULL )
* V_8 = V_9 ;
return - 1 ;
}
...
int
F_51 ( void * V_2 , unsigned int V_25 , T_1 V_17 )
{
T_2 V_111 , V_34 ;
if ( V_25 == 0 )
return 0 ;
...
char *
F_54 ( char * V_2 , int V_25 , T_1 V_17 )
{
T_2 V_42 , V_34 ;
char * V_112 ;
unsigned char * V_113 ;
...
int
F_56 ( T_1 V_114 , T_16 * * V_10 )
{
if ( V_114 -> V_8 != 0 && V_10 ) {
* V_10 = F_57 ( V_114 -> V_10 ) ;
}
return V_114 -> V_8 ;
}
void
...
T_17
F_63 ( const char * V_90 )
{
int V_6 ;
T_17 V_1 ;
int V_115 ;
V_6 = F_38 ( V_90 , V_94 | V_116 | V_117 | V_118 , 0666 ) ;
if ( V_6 == - 1 )
return NULL ;
V_1 = F_64 ( V_6 ) ;
if ( V_1 == NULL ) {
...
static int
F_67 ( T_17 V_1 , int V_125 )
{
int V_5 ;
T_3 V_111 ;
T_18 V_4 ;
T_10 V_46 = & ( V_1 -> V_46 ) ;
if ( V_1 -> V_13 == 0 && F_65 ( V_1 ) == - 1 )
return - 1 ;
V_5 = V_89 ;
do {
...
if ( V_4 ) {
V_111 = F_68 ( V_1 -> V_6 , V_1 -> V_66 , ( unsigned int ) V_4 ) ;
if ( V_111 < 0 ) {
V_1 -> V_8 = V_9 ;
return - 1 ;
}
...
unsigned
F_71 ( T_17 V_1 , const void * V_2 , T_2 V_25 )
{
T_2 V_128 = V_25 ;
T_2 V_34 ;
T_10 V_46 ;
...
V_25 -= V_34 ;
if ( V_25 && F_67 ( V_1 , V_53 ) == - 1 )
return 0 ;
} while ( V_25 );
}
else {
if ( V_46 -> V_14 && F_67 ( V_1 , V_53 ) == - 1 )
return 0 ;
V_46 -> V_14 = V_25 ;
#ifdef F_19
