...
static void
V_110 ( T_1 * V_122 , T_2 V_31 )
{
T_6 V_18 = * ( T_6 * ) V_31 ;
T_1 * V_11 ;
V_11 = ( T_1 * ) F_2 ( F_3 ( V_122 ) , V_108 ) ;
if ( V_11 != NULL ) {
F_8 ( F_3 ( V_11 ) , V_5 , NULL ) ;
} else {
switch ( V_18 ) {
...
static T_17
V_81 ( T_1 * V_123 , T_20 * T_19 ,
T_2 V_31 V_2 )
{
void (* F_86)( T_1 * , T_2 , T_2 );
T_2 V_124 ;
T_2 V_125 ;
if ( T_19 -> type == V_126 ) {
F_86 = ( void ( * ) ( T_1 * , void * , void * ) ) F_2 ( F_3 ( V_123 ) , V_82 ) ;
V_124 = F_2 ( F_3 ( V_123 ) , V_84 ) ;
V_125 = F_2 ( F_3 ( V_123 ) , V_85 ) ;
if ( F_86 )
(* F_86)( V_123 , V_124 , V_125 ) ;
}
return FALSE ;
}
static void
...
{
T_1 * V_26 = F_74 ( F_87 ( V_65 ) ) ;
T_1 * V_16 = F_79 ( V_26 ) ;
T_16 * V_118 ;
T_7 V_28 ;
T_1 * V_51 = ( T_1 * ) F_2 ( F_3 ( V_16 ) , V_87 ) ;
T_1 * V_54 = ( T_1 * ) F_2 ( F_3 ( V_16 ) , V_89 ) ;
T_1 * V_127 = ( T_1 * ) F_2 ( F_3 ( V_16 ) , V_128 ) ;
T_1 * V_129 = ( T_1 * ) F_2 ( F_3 ( V_16 ) , V_130 ) ;
...
T_7 V_28 ;
T_22 * args = ( T_22 * ) T_3 ;
T_9 * V_132 = ( T_9 * ) args -> V_133 -> V_31 ;
V_26 = F_19 ( F_2 ( F_3 ( V_16 ) , V_30 ) ) ;
V_27 = F_20 ( F_21 ( V_26 ) ) ;
F_23 ( V_27 , & V_28 ) ;
F_24 ( V_27 , & V_28 , 0 , V_132 -> V_32 , 1 , args -> V_133 , - 1 ) ;
if ( F_74 ( V_26 ) == args -> V_134 ) {
F_66 ( F_56 ( V_26 ) ,
& V_28 ) ;
}
}
...
V_24 = F_90 ( V_18 , V_32 , V_33 ) ;
args . V_134 = V_26 ;
args . V_133 = V_24 ;
F_91 ( F_17 ( V_18 ) , F_89 , & args ) ;
}
static T_17
F_92 ( T_16 * V_118 , T_23 * T_24 V_2 , T_7 * V_28 ,
T_2 V_31 )
{
T_5 * V_117 = ( T_5 * ) V_31 ;
T_9 * V_25 = ( T_9 * ) V_117 -> V_31 ;
T_5 * V_135 ;
F_76 ( V_118 , V_28 , 1 , & V_135 , - 1 ) ;
if ( V_117 == V_135 ) {
...
T_7 V_28 ;
F_97 ( V_118 , & V_28 , V_136 ) ;
F_98 ( F_20 ( V_118 ) , & V_28 ) ;
}
static void
...
if ( F_75 ( V_65 , & V_118 , & V_28 ) ) {
F_76 ( V_118 , & V_28 , 1 , & V_24 , - 1 ) ;
T_24 = F_99 ( V_118 , & V_28 ) ;
V_136 = F_100 ( T_24 ) ;
F_101 ( T_24 ) ;
if ( V_24 != NULL ) {
F_102 ( V_18 , V_24 ) ;
F_91 ( F_17 ( V_18 ) , F_96 , V_136 ) ;
}
F_67 ( V_136 ) ;
}
}
...
V_54 = ( T_1 * ) F_2 ( F_3 ( V_16 ) , V_89 ) ;
V_137 = F_103 ( V_54 ) ;
if ( F_104 ( V_16 ) && F_105 ( F_28 ( V_16 ) ) ) {
F_27 ( F_28 ( V_137 ) , TRUE ) ;
F_106 ( F_28 ( V_137 ) ,
F_28 ( V_16 ) ) ;
}
}
static void
F_107 ( T_1 * V_1 , const T_8 * const V_138 )
{
T_25 * V_139 ;
T_26 * V_140 ;
V_139 = F_108 () ; ;
V_140 = F_109 ( V_1 ) ;
F_110 ( V_139 , V_138 , - 1 , NULL ) ;
F_111 ( V_140 , F_112 ( V_139 ) , V_141 ) ;
F_58 ( V_139 ) ;
}
static void
F_113 ( T_1 * V_1 , T_27 V_142 , T_27 V_143 , T_27 V_144 )
{
#if F_114 ( 3 , 0 , 0 )
static T_28 V_145 = { 0 , 0 , 0 , 1.0 } ;
T_8 * V_138 ;
V_138 = F_115 ( L_31 , V_142 / 256 , V_143 / 256 , V_144 / 256 ) ;
F_107 ( V_1 , V_138 ) ;
F_67 ( V_138 ) ;
F_116 ( V_1 , V_146 , & V_145 ) ;
F_117 ( V_1 , & V_145 , & V_145 ) ;
#else
static T_29 V_145 = { 0 , 0 , 0 , 0 } ;
T_29 V_147 ;
V_147 . V_148 = 0 ;
V_147 . V_142 = V_142 ;
V_147 . V_143 = V_143 ;
V_147 . V_144 = V_144 ;
F_118 ( V_1 , V_149 , & V_145 ) ;
F_119 ( V_1 , V_149 , & V_147 ) ;
F_120 ( V_1 , & V_145 , & V_145 ) ;
#endif
}
void
F_61 ( T_1 * V_1 )
{
#if F_114 ( 3 , 0 , 0 )
F_116 ( V_1 , V_146 , NULL ) ;
F_107 ( V_1 , L_32 ) ;
F_117 ( V_1 , NULL , NULL ) ;
#else
F_118 ( V_1 , V_149 , NULL ) ;
F_119 ( V_1 , V_149 , NULL ) ;
F_120 ( V_1 , NULL , NULL ) ;
#endif
}
void
F_121 ( T_1 * V_1 )
{
F_113 ( V_1 , V_112 . V_150 . V_142 , V_112 . V_150 . V_143 , V_112 . V_150 . V_144 ) ;
}
static void
F_122 ( T_1 * V_1 )
{
F_113 ( V_1 , V_112 . V_151 . V_142 , V_112 . V_151 . V_143 , V_112 . V_151 . V_144 ) ;
}
void
F_123 ( T_1 * V_1 )
{
F_113 ( V_1 , V_112 . V_152 . V_142 , V_112 . V_152 . V_143 , V_112 . V_152 . V_144 ) ;
}
void
F_95 ( T_1 * V_1 , T_2 T_3 V_2 )
{
const T_8 * V_33 ;
T_30 * V_153 ;
T_31 * V_154 = NULL ;
...
V_159 = F_125 ( V_161 ,
V_33 , V_162 , V_163 ) ;
for ( V_160 = 0 ; V_160 < F_126 ( V_159 ) ; V_160 += 1 ) {
if ( V_159 [ V_160 ] && * V_159 [ V_160 ] ) {
V_156 = F_127 ( V_159 [ V_160 ] ) ;
if ( V_156 != 0 ) {
F_121 ( V_1 ) ;
if ( V_155 )
F_128 ( L_33 ) ;
