...
if ( V_15 > 0 ) {
if ( ! F_3 ( V_8 -> V_19 , NULL , V_15 , V_9 , V_10 ) )
return V_21 ;
}
V_11 += V_15 ;
}
...
if ( V_17 . V_35 != V_36 ) {
* V_9 = V_37 ;
* V_10 = F_7 ( L_5 , V_17 . V_35 ) ;
return V_21 ;
}
if ( F_10 ( V_17 . V_38 ) == V_39 ) {
* V_9 = V_37 ;
* V_10 = F_7 ( L_6 , V_17 . V_38 ) ;
return V_21 ;
}
V_8 -> V_40 = F_10 ( V_17 . V_38 ) ;
V_18 -> V_41 = 0 ;
V_18 -> V_38 = F_11 ( V_8 -> V_40 ) ;
V_8 -> V_42 = V_43 ;
V_8 -> V_44 = V_45 ;
V_8 -> V_46 = NULL ;
V_8 -> V_47 = NULL ;
...
V_8 -> V_49 = V_50 ;
V_8 -> V_51 = V_52 ;
if ( F_12 ( V_8 -> V_19 , V_16 , V_53 , V_9 ) == - 1 )
return V_21 ;
if ( F_1 () != NULL ) {
* V_9 = V_54 ;
return V_21 ;
...
static T_9 V_43 ( T_2 * V_8 , int * V_9 , T_3 * * V_10 ,
T_10 * V_56 )
{
int V_57 ;
int V_58 ;
...
static T_9 V_45 ( T_2 * V_8 , T_10 V_67 ,
...
int V_11 ;
int V_58 ;
if ( F_12 ( V_8 -> V_71 , V_67 , V_53 , V_9 ) == - 1 )
return FALSE ;
...
V_15 = V_14 . V_32 - ( int ) sizeof V_14 ;
if ( V_15 > 0 ) {
if ( ! F_3 ( V_19 , NULL , V_15 , V_9 , V_10 ) )
return - 1 ;
}
V_11 += V_15 ;
}
...
V_4 = localtime ( & V_59 -> V_105 . V_106 ) ;
if ( V_4 != NULL ) {
V_111 = * V_4 ;
if ( V_111 . V_7 > 0 ) {
V_110 = V_111 ;
...
if ( V_125 != NULL )
F_25 ( V_123 , 64 , L_11 , asctime ( V_125 ) ) ;
else
F_25 ( V_123 , 64 , L_12 ) ;
V_124 = strlen ( V_123 ) ;
V_121 . type = V_131 ;
