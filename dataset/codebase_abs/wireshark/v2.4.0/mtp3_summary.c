...
F_44 ( F_43 ( V_46 ) , V_48 ) ;
F_28 ( V_48 ) ;
if ( V_42 . V_69 == V_42 . V_70 &&
V_42 . V_69 >= 2 ) {
F_46 ( V_54 , V_55 , L_19 , V_42 . V_71 ) ;
F_22 ( V_54 , V_48 ) ;
F_46 ( V_54 , V_55 , L_20 , V_24 ) ;
F_22 ( V_54 , V_48 ) ;
}
F_46 ( V_54 , V_55 , L_21 , V_42 . V_70 ) ;
F_22 ( V_54 , V_48 ) ;
V_53 = F_45 ( L_22 ) ;
...
F_28 ( V_49 ) ;
V_50 = ( T_1 * ) F_49 ( F_11 ( V_49 ) , V_72 ) ;
F_50 ( V_43 , V_50 , V_73 ) ;
F_51 ( V_43 , L_32 , F_52 ( V_74 ) , NULL ) ;
F_53 ( V_43 ) ;
F_54 ( V_43 ) ;
}
static void
...
void * V_75 )
{
F_56 ( * V_76 ) [ V_77 ] = ( F_56 ( * ) [ V_77 ] ) V_75 ;
V_34 = 0 ;
memset ( V_76 , 0 , V_77 * sizeof( F_56 ) ) ;
}
static T_15
F_57 (
void * V_75 ,
...
{
F_56 ( * V_76 ) [ V_77 ] = ( F_56 ( * ) [ V_77 ] ) V_75 ;
const T_20 * V_79 = ( const T_20 * ) V_78 ;
int V_28 ;
if ( V_79 -> V_36 >= V_33 )
{
return ( FALSE ) ;
...
while ( V_28 < V_34 )
{
if ( memcmp ( & V_79 -> V_80 , & ( * V_76 ) [ V_28 ] . V_80 , sizeof( V_81 ) ) == 0 )
{
if ( memcmp ( & V_79 -> V_82 , & ( * V_76 ) [ V_28 ] . V_82 , sizeof( V_81 ) ) == 0 )
{
break;
}
}
...
( * V_76 ) [ V_28 ] . V_80 = V_79 -> V_80 ;
( * V_76 ) [ V_28 ] . V_82 = V_79 -> V_82 ;
( * V_76 ) [ V_28 ] . V_36 [ V_79 -> V_36 ] . V_30 ++ ;
( * V_76 ) [ V_28 ] . V_36 [ V_79 -> V_36 ] . V_37 += V_79 -> V_37 ;
return ( TRUE ) ;
}
void
F_58 ( void )
