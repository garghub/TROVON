...
F_21 ( T_10 V_59 )
{
if ( V_59 < 10 ) return 100000000 ;
if ( V_59 < 100 ) return 10000000 ;
if ( V_59 < 1000 ) return 1000000 ;
if ( V_59 < 10000 ) return 100000 ;
if ( V_59 < 100000 ) return 10000 ;
if ( V_59 < 1000000 ) return 1000 ;
if ( V_59 < 10000000 ) return 100 ;
if ( V_59 < 100000000 ) return 10 ;
return 1 ;
}
static T_5
F_14 ( T_2 * V_1 , T_11 V_7 , struct V_47 * V_40 ,
T_9 * V_29 , int * V_2 , T_3 * * V_3 )
{
T_7 * V_31 = ( T_7 * ) V_1 -> V_38 ;
T_8 V_42 ;
T_5 V_60 , V_61 ;
int V_28 , line , V_62 , V_43 ;
...
L_8
L_9 ,
& V_64 , V_68 , & V_63 , & V_65 , & V_66 , & V_67 , & V_59 , V_69 ,
V_70 , type ) ;
if ( V_28 == 10 )
{
if ( V_64 < 0 )
...
V_40 -> V_88 . V_90 = V_59 * F_21 ( V_59 ) ;
}
V_40 -> V_91 = V_63 ;
V_40 -> V_92 = V_14 ;
V_40 -> V_93 . V_94 . V_95 = - 1 ;
V_49 = ( char * ) F_7 ( V_63 * 2 ) ;
V_50 = 0 ;
memcpy ( & V_49 [ 0 ] , V_69 , 12 ) ;
V_50 += 12 ;
memcpy ( & V_49 [ 12 ] , V_70 , 12 ) ;
V_50 += 12 ;
...
V_40 -> V_97 = ( ( T_10 ) V_50 ) / 2 ;
F_23 ( V_29 , V_40 -> V_97 ) ;
F_24 ( V_49 , F_25 ( V_29 ) , V_50 ) ;
* V_2 = 0 ;
F_12 ( V_49 ) ;
return TRUE ;
V_96:
...
static T_5
F_24 ( const char * V_100 , V_34 * V_29 , T_12 V_91 )
{
T_12 V_56 ;
int V_101 ;
T_4 V_102 ;
