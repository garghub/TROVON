...
F_12 ( V_3 , V_28 , V_2 , V_4 , 4 , V_16 , & T_6 -> V_29 ) ;
T_6 -> V_30 = F_6 ( V_2 , V_4 + 4 ) ;
if ( T_6 -> V_29 == 0 ) {
return L_3 ;
}
F_2 ( V_3 , V_31 , V_2 , V_4 + 4 , 1 , V_16 ) ;
if ( T_6 -> V_30 == 0 ) {
return F_8 ( F_9 () , L_4 , T_6 -> V_29 ) ;
} else {
return F_8 ( F_9 () , L_5 , T_6 -> V_29 , T_6 -> V_30 ) ;
}
}
static const T_1 * F_13 ( T_2 * V_1 , T_3 * V_2 , T_4 * V_3 , int V_4 , int V_5 , T_5 * T_6 V_6 ) {
T_9 * V_32 ;
if ( V_5 < 2 ) {
F_5 ( V_3 , V_1 , & V_13 , V_2 , V_4 , V_5 ) ;
return NULL ;
...
V_32 -> V_36 = ( T_1 * ) F_15 ( F_9 () , V_2 , V_4 + 1 , V_5 , V_37 | V_9 ) ;
V_32 -> V_38 = V_5 - 1 ;
F_16 ( V_2 , V_3 , V_4 - 1 , V_5 , * V_32 ) ;
return NULL ;
}
static const T_1 * F_17 ( T_2 * V_1 , T_3 * V_2 , T_4 * V_3 , int V_4 , int V_5 , T_5 * T_6 V_6 ) {
T_9 * V_32 ;
if ( V_5 < 2 ) {
F_5 ( V_3 , V_1 , & V_13 , V_2 , V_4 , V_5 ) ;
return NULL ;
...
static const T_1 * F_18 ( T_2 * V_1 , T_3 * V_2 , T_4 * V_3 , int V_4 , int V_5 , T_5 * T_6 ) {
if ( V_5 < 1 ) {
F_5 ( V_3 , V_1 , & V_13 , V_2 , V_4 , V_5 ) ;
return NULL ;
}
T_6 -> V_40 = F_19 ( F_9 () , V_2 , V_4 , 20 ) ;
F_2 ( V_3 , V_41 , V_2 , V_4 , 20 , V_9 ) ;
F_20 ( V_2 , V_4 , 20 , V_3 ) ;
return NULL ;
}
static const T_1 * F_21 ( T_2 * V_1 , T_3 * V_2 , T_4 * V_3 , int V_4 , int V_5 , T_5 * T_6 ) {
if ( V_5 < 1 ) {
F_5 ( V_3 , V_1 , & V_13 , V_2 , V_4 , V_5 ) ;
return NULL ;
}
T_6 -> V_42 = F_19 ( F_9 () , V_2 , V_4 , 20 ) ;
F_2 ( V_3 , V_43 , V_2 , V_4 , 20 , V_9 ) ;
F_20 ( V_2 , V_4 , 20 , V_3 ) ;
return NULL ;
}
static const T_1 * F_22 ( T_2 * V_1 , T_3 * V_2 , T_4 * V_3 , int V_4 , int V_5 , T_5 * T_6 V_6 ) {
if ( V_5 != 12 ) {
F_5 ( V_3 , V_1 , & V_13 , V_2 , V_4 , V_5 ) ;
return NULL ;
}
...
static const T_1 * F_24 ( T_2 * V_1 , T_3 * V_2 , T_4 * V_3 , int V_4 , int V_5 , T_5 * T_6 ) {
if ( V_5 != 4 ) {
F_5 ( V_3 , V_1 , & V_13 , V_2 , V_4 , V_5 ) ;
return NULL ;
}
T_6 -> V_60 = F_25 ( V_2 , V_4 ) ;
...
F_31 ( V_3 , V_1 , & V_10 , V_2 , V_4 , 14 , L_6 ) ;
return NULL ;
}
...
F_31 ( V_3 , V_1 , & V_10 , V_2 , V_4 , 7 , L_7 ) ;
return NULL ;
}
...
T_7 * V_7 ;
V_3 = F_50 ( V_3 , V_2 , 0 , 0 , V_181 , NULL , L_8 ) ;
if ( V_180 -> V_182 ) {
...
T_7 * V_194 ;
T_4 * V_195 = F_50 ( V_3 , V_2 , 0 , 0 , V_181 , & V_194 , L_9 ) ;
do {
V_194 = F_51 ( V_195 , V_196 , V_2 , 0 , 0 , V_193 -> V_197 ) ;
F_54 ( V_194 , L_10 ,
F_55 ( V_193 -> V_198 , & V_199 , L_11 ) ,
V_193 -> V_197 ) ;
F_52 ( V_194 ) ;
...
T_6 -> V_182 = F_25 ( V_2 , 0 ) ;
T_6 -> V_198 = F_6 ( V_2 , 4 ) ;
F_3 ( V_1 , V_7 , & V_213 ) ;
F_61 ( V_1 -> V_205 , V_214 , F_62 ( T_6 -> V_198 , V_215 , L_12 ) ) ;
...
F_64 ( V_1 -> V_205 , V_214 , L_13 , V_227 ) ;
V_5 -= 3 + V_224 ;
V_4 += 3 + V_224 ;
}
if ( V_233 ) {
...
V_180 -> V_40 = NULL ;
if ( T_6 -> V_42 ) {
T_1 * V_201 = F_8 ( F_66 () , L_14 , T_6 -> V_42 , V_180 -> V_62 ) ;
F_67 ( V_201 ) ;
...
if ( T_6 -> V_40 ) {
T_1 * V_201 = F_8 ( F_66 () , L_14 , T_6 -> V_40 , V_180 -> V_62 ) ;
F_67 ( V_201 ) ;
...
{ & V_28 ,
{ L_55 , L_56 ,
V_241 , V_245 | V_253 , F_73 ( V_254 ) , 0 ,
NULL , V_243 }
} ,
{ & V_31 ,
{ L_57 , L_58 ,
V_244 , V_245 | V_253 , F_73 ( V_255 ) , 0 ,
NULL , V_243 }
} ,
{ & V_41 ,
{ L_59 , L_60 ,
...
{ & V_67 ,
{ L_93 , L_94 ,
V_244 , V_245 , F_73 ( V_258 ) , 0x80 ,
NULL , V_243 }
} ,
{ & V_68 ,
{ L_95 , L_96 ,
V_244 , V_245 , F_73 ( V_258 ) , 0x40 ,
NULL , V_243 }
} ,
{ & V_69 ,
{ L_97 , L_98 ,
V_244 , V_245 , F_73 ( V_258 ) , 0x20 ,
NULL , V_243 }
} ,
{ & V_70 ,
{ L_99 , L_100 ,
V_244 , V_245 , F_73 ( V_258 ) , 0x10 ,
NULL , V_243 }
} ,
{ & V_71 ,
{ L_101 , L_102 ,
V_244 , V_245 , F_73 ( V_258 ) , 0x08 ,
NULL , V_243 }
} ,
{ & V_72 ,
{ L_103 , L_104 ,
V_244 , V_245 , F_73 ( V_258 ) , 0x04 ,
L_105 , V_243 }
} ,
{ & V_73 ,
{ L_106 , L_107 ,
V_244 , V_245 , F_73 ( V_258 ) , 0x02 ,
L_108 , V_243 }
} ,
{ & V_74 ,
{ L_109 , L_110 ,
V_244 , V_245 , F_73 ( V_259 ) , 0x01 ,
NULL , V_243 }
} ,
{ & V_75 ,
{ L_111 , L_112 ,
...
{ & V_127 ,
{ L_185 , L_186 ,
V_244 , V_245 , F_73 ( V_261 ) , 0 ,
NULL , V_243 }
} ,
{ & V_128 ,
{ L_187 , L_188 ,
V_244 , V_245 , F_73 ( V_262 ) , 0x07 ,
NULL , V_243 }
} ,
{ & V_130 ,
{ L_189 , L_190 ,
...
static T_18 V_266 [] = {
{ & V_13 , { L_262 , V_267 , V_268 , L_263 , V_269 } } ,
{ & V_10 , { L_264 , V_270 , V_268 , L_265 , V_269 } } ,
{ & V_191 , { L_266 , V_271 , V_268 , L_267 , V_269 } } ,
{ & V_18 , { L_268 , V_271 , V_268 , L_269 , V_269 } } ,
{ & V_213 , { L_270 , V_271 , V_272 , L_271 , V_269 } } ,
} ;
V_209 = F_74 ( V_273 , V_207 , L_272 ) ;
V_274 = F_75 ( L_272 , F_58 , V_209 ) ;
F_76 ( V_209 , V_240 , F_77 ( V_240 ) ) ;
F_78 ( V_229 , F_77 ( V_229 ) ) ;
V_239 = F_79 ( V_209 ) ;
F_80 ( V_239 , V_266 , F_77 ( V_266 ) ) ;
