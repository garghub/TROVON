...
T_21 V_65 ;
int V_66 = 0 ;
V_66 = F_38 ( V_60 , 0 , & V_61 , & V_62 , & V_64 ) ;
V_66 = F_39 ( V_60 , V_66 , & V_65 , & V_63 ) ;
if( ( V_61 == V_67 ) && ( V_64 == V_68 ) )
return V_66 ;
return 0 ;
}
static int F_40 ( T_2 * V_60 , T_9 * T_10 , T_1 * V_1 , void * T_22 V_31 ) {
int V_66 = 0 ;
T_11 V_69 ;
F_41 ( & V_69 , V_70 , TRUE , T_10 ) ;
if( ( V_66 = F_37 ( V_60 ) ) > 0 )
F_42 ( FALSE , V_60 , V_66 , & V_69 , V_1 , V_71 ) ;
else
F_43 ( V_1 , T_10 , & V_72 , V_60 , 0 , 1 ) ;
return F_6 ( V_60 ) ;
}
static int F_44 ( T_2 * V_60 , T_9 * T_10 , T_1 * V_1 , void * T_22 V_31 )
{
int V_66 = 0 ;
T_11 V_69 ;
F_41 ( & V_69 , V_70 , TRUE , T_10 ) ;
V_66 = F_37 ( V_60 ) ;
F_45 ( FALSE , V_60 , V_66 , & V_69 , V_1 , V_73 ) ;
return F_6 ( V_60 ) ;
}
static int F_46 ( T_2 * V_60 , T_9 * T_10 , T_1 * V_1 , void * T_22 V_31 )
{
int V_66 = 0 ;
T_11 V_69 ;
F_41 ( & V_69 , V_70 , TRUE , T_10 ) ;
if( ( V_66 = F_37 ( V_60 ) ) > 0 )
F_47 ( FALSE , V_60 , V_66 , & V_69 , V_1 , V_74 ) ;
else
F_43 ( V_1 , T_10 , & V_72 , V_60 , 0 , 1 ) ;
return F_6 ( V_60 ) ;
}
...
T_26 * V_86 ;
T_27 * V_87 ;
V_88 = F_49 ( V_89 , V_90 , V_91 ) ;
F_50 ( V_88 , V_75 , F_51 ( V_75 ) ) ;
F_52 ( V_81 , F_51 ( V_81 ) ) ;
V_87 = F_53 ( V_88 ) ;
F_54 ( V_87 , V_82 , F_51 ( V_82 ) ) ;
V_86 = F_55 ( V_88 , NULL ) ;
F_56 ( V_86 , L_15 ,
L_16 ,
L_17
