...
if ( ! F_17 ( V_48 , & V_49 , & V_43 ) || ( * V_49 != '\0' && ! F_14 ( * V_49 ) ) ) {
* V_2 = V_58 ;
* V_3 = F_18 ( L_10 , V_48 ) ;
return FALSE ;
}
...
V_48 = strstr ( V_50 , V_47 ) ;
if ( V_48 )
V_46 . V_53 = ( int ) ( V_48 - V_50 ) / 3 ;
V_46 . V_52 -= 1900 ;
V_46 . V_60 = - 1 ;
V_35 -> V_61 = V_62 ;
V_35 -> V_63 = V_64 ;
V_35 -> V_65 . V_66 = mktime ( & V_46 ) ;
V_35 -> V_65 . V_67 = V_45 * 10000000 ;
V_35 -> V_68 = V_43 ;
V_35 -> V_69 = V_43 ;
F_19 ( V_5 , V_43 ) ;
V_51 = F_20 ( V_5 ) ;
...
static T_3
F_21 ( char * V_70 , T_10 * V_5 , long V_71 ,
int V_72 , int V_73 ) {
int V_40 ;
char * V_74 ;
int V_75 ;
static const int V_76 [ 16 ] = { 39 , 37 , 35 , 33 , 28 , 26 , 24 , 22 , 17 , 15 , 13 , 11 , 6 , 4 , 2 , 0 } ;
char V_77 [ 3 ] = { 0 , 0 , 0 } ;
V_74 = V_70 ;
V_75 = ( int ) strtoul ( V_74 + 45 + V_72 , NULL , 16 ) ;
if ( V_75 != V_71 ) {
return FALSE ;
}
if ( V_73 > 16 )
...
V_77 [ 0 ] = V_70 [ V_76 [ V_40 ] + V_72 ] ;
V_77 [ 1 ] = V_70 [ V_76 [ V_40 ] + 1 + V_72 ] ;
V_5 [ V_71 + V_40 ] = ( T_10 ) strtoul ( V_77 , NULL , 16 ) ;
}
return TRUE ;
}
