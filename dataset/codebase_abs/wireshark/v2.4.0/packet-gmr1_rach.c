...
static void
F_8 ( T_6 * V_26 , T_7 V_27 )
{
T_8 V_28 = V_27 ;
F_9 ( V_26 , V_29 , L_5 ,
abs ( V_28 ) / 2912.7f , V_28 < 0 ? L_6 : L_7 , V_28 ) ;
}
static void
F_10 ( T_6 * V_26 , T_7 V_27 )
{
T_8 V_28 = V_27 ;
F_9 ( V_26 , V_29 , L_5 ,
abs ( V_28 ) / 2912.70555f , V_28 < 0 ? L_8 : L_9 , V_28 ) ;
}
static void
F_11 ( T_1 * V_1 , int V_2 , T_2 * V_3 V_30 , T_3 * V_7 )
{
T_7 V_31 , V_32 ;
V_31 = ( F_12 ( V_1 , V_2 ) >> 12 ) & 0x7ffff ;
V_32 = F_12 ( V_1 , V_2 + 1 ) & 0xfffff ;
if ( V_31 == 0x40000 ) {
F_13 ( V_7 , V_33 , V_1 , V_2 , 5 , V_31 ,
L_10 ) ;
return;
} else if ( V_32 == 0x80000 ) {
F_13 ( V_7 , V_34 , V_1 , V_2 , 5 , V_32 ,
L_11 ) ;
return;
}
F_3 ( V_7 , V_35 ,
...
static void
F_14 ( T_6 * V_26 , T_7 V_27 )
{
if ( V_27 == 0xfffff ) {
F_9 ( V_26 , V_29 , L_12 , V_27 ) ;
} else if ( ( V_27 & 0xf8000 ) == 0xf8000 ) {
F_9 ( V_26 , V_29 , L_13 , V_27 , V_27 & 0x7fff ) ;
} else {
F_9 ( V_26 , V_29 , L_14 , V_27 ) ;
}
}
static void
...
F_9 ( V_26 , V_29 , L_22 , V_27 - 1100 , V_27 ) ;
} else if ( V_27 >= 1200 && V_27 <= 1209 ) {
F_9 ( V_26 , V_29 , L_23 , V_27 - 1200 , V_27 ) ;
} else {
F_15 ( V_26 , V_27 ) ;
}
}
...
{
if ( V_27 == 0xffff ) {
F_9 ( V_26 , V_29 , L_24 , V_27 ) ;
} else {
F_9 ( V_26 , V_29 , L_25 , V_27 , V_27 ) ;
}
}
static int
F_18 ( T_6 * V_26 , int V_36 , T_1 * V_1 , int V_2 )
{
T_9 V_37 [ 5 ] ;
int V_38 , V_39 , V_40 ;
...
if ( V_37 [ V_39 + 1 ] <= 999 )
{
V_38 += F_9 ( V_26 + V_38 , V_36 - V_38 , L_15 , V_37 [ V_39 ] ) ;
}
...
{
V_38 += F_9 ( V_26 + V_38 , V_36 - V_38 , L_26 , V_37 [ V_39 ] / 10 ) ;
V_40 = 1 ;
break;
}
else if ( V_37 [ V_39 + 1 ] == 1021 )
{
V_38 += F_9 ( V_26 + V_38 , V_36 - V_38 , L_27 , V_37 [ V_39 ] / 100 ) ;
V_40 = 1 ;
break;
}
...
{
return F_9 ( V_26 , V_36 , L_28 ) ;
}
}
if ( ! V_40 ) {
if ( V_37 [ 4 ] <= 999 )
{
V_38 += F_9 ( V_26 + V_38 , V_36 - V_38 , L_15 , V_37 [ 4 ] ) ;
}
else if ( V_37 [ 4 ] >= 1100 && V_37 [ 4 ] <= 1199 )
{
V_38 += F_9 ( V_26 + V_38 , V_36 - V_38 , L_26 , V_37 [ 4 ] - 1100 ) ;
}
else if ( V_37 [ 4 ] >= 1200 && V_37 [ 4 ] <= 1209 )
{
V_38 += F_9 ( V_26 + V_38 , V_36 - V_38 , L_27 , V_37 [ 4 ] - 1200 ) ;
}
else
{
return F_9 ( V_26 , V_36 , L_28 ) ;
...
if ( V_5 ) {
T_6 V_26 [ 32 ] ;
F_18 ( V_26 , sizeof( V_26 ) , V_1 , V_2 + 3 ) ;
F_20 ( V_3 -> V_16 , V_17 , L_30 , V_26 ) ;
V_41 = F_21 (
...
V_96 = F_27 (
V_7 , V_101 , V_1 , 0 , V_99 , L_37 , V_98 ) ;
V_97 = F_5 ( V_96 , V_102 ) ;
if ( ! V_100 ) {
F_6 ( V_3 -> V_16 , V_17 , L_28 ) ;
F_28 ( V_1 , V_3 , V_7 ) ;
return F_29 ( V_1 ) ;
}
...
{ & V_33 ,
{ L_63 , L_64 ,
V_116 , V_117 , F_33 ( F_8 ) , 0x7ffff0 ,
NULL , V_106 }
} ,
{ & V_34 ,
{ L_65 , L_66 ,
V_116 , V_117 , F_33 ( F_10 ) , 0x0fffff ,
NULL , V_106 }
} ,
{ & V_45 ,
{ L_67 , L_68 ,
...
{ & V_46 ,
{ L_70 , L_71 ,
V_118 , V_117 , F_33 ( F_14 ) , 0x0fffff ,
NULL , V_106 }
} ,
{ & V_47 ,
{ L_72 , L_73 ,
...
{ & V_50 ,
{ L_77 , L_78 ,
V_122 , V_117 , F_33 ( F_15 ) , 0x3ff0 ,
NULL , V_106 }
} ,
{ & V_51 ,
{ L_79 , L_80 ,
V_122 , V_117 , F_33 ( F_15 ) , 0x0ffc ,
NULL , V_106 }
} ,
{ & V_52 ,
{ L_81 , L_82 ,
V_122 , V_117 , F_33 ( F_15 ) , 0x03ff ,
NULL , V_106 }
} ,
{ & V_53 ,
{ L_83 , L_84 ,
V_122 , V_117 , F_33 ( F_15 ) , 0xffc0 ,
NULL , V_106 }
} ,
{ & V_54 ,
{ L_85 , L_86 ,
V_122 , V_117 , F_33 ( F_16 ) , 0x3ff8 ,
NULL , V_106 }
} ,
{ & V_55 ,
{ L_87 , L_88 ,
