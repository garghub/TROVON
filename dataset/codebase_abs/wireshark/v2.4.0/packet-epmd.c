...
F_8 ( V_4 , V_20 , V_2 , V_3 + 2 , V_5 , V_21 | V_22 , F_9 () , & V_6 ) ;
V_3 += 2 + V_5 ;
if ( F_10 ( V_2 , V_3 ) >= 2 ) {
T_6 V_23 = 0 ;
V_23 = F_7 ( V_2 , V_3 ) ;
...
case V_27 :
V_5 = F_11 ( V_2 , V_3 ) ;
F_8 ( V_4 , V_20 , V_2 , V_3 , V_5 , V_21 | V_22 , F_9 () , & V_6 ) ;
break;
case V_28 :
F_2 ( V_4 , V_14 , V_2 , V_3 , 2 , V_8 ) ;
V_3 += 2 ;
...
V_34 = F_17 ( V_1 -> V_44 , & V_1 -> V_45 , & V_1 -> V_46 , V_47 , V_33 , 0 , V_48 ) ;
F_18 ( V_34 , V_49 ) ;
}
break;
}
...
static int
F_21 ( T_2 * V_2 , T_1 * V_1 , T_4 * V_4 , void * T_10 V_30 ) {
T_4 * V_50 ;
T_11 * V_51 ;
if ( ! F_19 ( V_2 ) )
return ( 0 ) ;
