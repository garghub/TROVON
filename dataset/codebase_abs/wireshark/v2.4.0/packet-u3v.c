...
static void
F_21 ( T_8 * V_122 , T_6 * V_14 , T_9 * V_123 , T_7 V_124 , T_7 V_24 , T_4 * V_3 , T_10 * V_125 )
{
T_2 V_1 = 0 ;
T_7 V_15 = V_124 ;
const T_1 * V_4 = NULL ;
...
static void
F_22 ( T_8 * V_122 , T_6 * V_14 , T_9 * V_123 V_151 , T_7 V_124 , T_7 V_24 , T_4 * V_3 V_151 , T_10 * V_125 V_151 )
{
T_12 * V_127 = NULL ;
T_13 V_15 = V_124 ;
F_12 ( V_123 -> V_129 , V_130 , L_9 , F_11 ( V_14 , V_124 + 2 ) ) ;
...
static void
F_23 ( T_8 * V_122 , T_6 * V_14 , T_9 * V_123 , T_15 * T_16 V_151 )
{
T_5 V_15 = 0 ;
T_5 V_154 = 0 ;
T_2 V_155 = 0 ;
...
V_15 += 2 ;
F_12 ( V_123 -> V_129 , V_130 , L_10 V_13 L_11 ,
V_155 ,
F_24 ( V_154 , V_163 , L_12 ) ) ;
if ( V_154 == V_164 ||
V_154 == V_165 ||
V_154 == V_166 ) {
...
static void
F_25 ( T_8 * V_122 , T_6 * V_14 , T_9 * V_123 , T_15 * T_16 V_151 )
{
T_7 V_15 = 0 ;
T_2 V_155 ;
T_12 * V_127 = NULL ;
...
V_15 += 8 ;
F_12 ( V_123 -> V_129 , V_130 , L_13 V_13 L_14 , V_155 ) ;
if ( F_26 ( V_14 , V_15 ) >= 4 ) {
F_9 ( V_122 , V_170 , V_14 , V_15 , 4 , V_31 ) ;
V_15 += 4 ;
}
...
static void
F_27 ( T_8 * V_122 , T_6 * V_14 , T_9 * V_123 , T_15 * T_16 V_151 )
{
T_12 * V_127 = NULL ;
V_127 = F_9 ( V_122 , V_180 , V_14 , 0 , - 1 , V_35 ) ;
V_122 = F_13 ( V_127 , V_181 ) ;
F_9 ( V_122 , V_182 , V_14 , 0 , - 1 , V_35 ) ;
F_19 ( V_123 -> V_129 , V_130 , L_15 ) ;
}
static int
F_28 ( T_6 * V_14 , T_9 * V_123 , T_8 * V_183 , void * V_184 )
{
T_7 V_15 = 0 ;
...
V_192 = F_31 ( V_14 , 0 ) ;
if ( ( F_32 ( V_14 ) >= 4 ) && ( ( V_200 == V_192 ) || ( V_201 == V_192 ) ) ) {
V_196 = TRUE ;
}
if ( ( ( F_32 ( V_14 ) >= 4 ) && ( ( V_202 == V_192 ) || ( V_203 == V_192 ) ) )
...
V_15 += 2 ;
F_12 ( V_123 -> V_129 , V_130 , L_19 , V_194 ) ;
} else if ( V_192 == V_200 && ( ( V_190 % 2 ) == 1 ) ) {
V_194 = F_24 ( V_190 , V_215 , L_20 ) ;
...
V_15 += 2 ;
F_12 ( V_123 -> V_129 , V_130 , L_21 ,
V_194 ,
F_24 ( V_191 , V_225 , L_22 ) ) ;
} else {
return 0 ;
}
...
V_125 = ( T_10 * ) F_37 ( F_30 () , V_123 , V_213 , V_189 ) ;
}
if ( ! V_125 ) {
V_125 = F_29 ( F_4 () , T_10 ) ;
V_125 -> V_148 = 0 ;
...
break;
case V_241 :
F_22 ( V_122 , V_14 , V_123 , V_15 , V_188 , V_3 , V_125 ) ;
break;
default:
...
switch ( V_192 ) {
case V_202 :
F_23 ( V_185 , V_14 , V_123 , T_16 ) ;
break;
case V_203 :
F_25 ( V_185 , V_14 , V_123 , T_16 ) ;
break;
default:
F_27 ( V_185 , V_14 , V_123 , T_16 ) ;
break;
}
}
return F_38 ( V_14 ) ;
...
V_244 = F_31 ( V_14 , V_15 ) ;
V_193 = F_9 ( V_183 , V_251 , V_14 , V_15 , 4 , V_35 ) ;
F_15 ( V_193 , L_24 , V_244 >> 16 , V_244 & 0xFFFF ) ;
...
V_213 = F_45 ( L_25 , L_16 , L_26 ) ;
F_46 ( V_213 , V_275 , F_47 ( V_275 ) ) ;
F_48 ( V_270 , F_47 ( V_270 ) ) ;
V_276 = F_49 ( L_26 , F_28 , V_213 ) ;
}
void
F_50 ( void )
{
T_18 V_277 = NULL ;
F_51 ( L_27 , V_210 , V_276 ) ;
F_52 ( L_27 , F_39 , L_28 , L_26 , V_213 , V_278 ) ;
V_277 = F_53 ( F_40 , V_213 ) ;
F_51 ( L_29 , V_210 , V_277 ) ;
}
