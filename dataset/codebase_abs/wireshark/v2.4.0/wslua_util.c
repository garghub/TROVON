...
V_15 = F_11 ( V_1 ) ;
if ( F_53 ( V_1 , V_26 ) != 0 ) F_58 ( V_1 ) ;
F_6 ( V_26 ) ;
F_32 ( V_1 , 0 , V_32 ) ;
return F_11 ( V_1 ) - V_15 ;
}
static int F_59 ( T_2 * V_1 V_33 ) {
return 0 ;
}
static void F_60 ( const char * V_34 , void * V_35 ) {
T_8 * V_36 = ( T_8 * ) V_35 ;
T_2 * V_1 = V_36 -> V_1 ;
F_61 ( V_1 , 0 ) ;
F_62 ( V_1 , F_59 ) ;
F_63 ( V_1 , V_37 , V_36 -> V_38 ) ;
F_2 ( V_1 , V_34 ) ;
switch ( F_64 ( V_1 , 1 , 0 , 1 ) ) {
case 0 :
break;
case V_39 :
F_65 ( L_13 ) ;
...
#define F_68 1
#define F_69 2
const char * V_41 = F_14 ( V_1 , F_68 ) ;
T_8 * V_36 = ( T_8 * ) F_70 ( sizeof( T_8 ) ) ;
T_9 V_42 ;
V_36 -> V_1 = V_1 ;
F_31 ( V_1 , F_69 ) ;
V_36 -> V_38 = F_71 ( V_1 , V_37 ) ;
F_72 ( V_1 , 1 ) ;
V_42 . V_43 = V_44 ;
V_42 . V_45 = NULL ;
V_42 . V_46 = V_41 ;
