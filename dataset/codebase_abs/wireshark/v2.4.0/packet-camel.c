...
static void
F_438 ( struct V_612 * V_614 , T_10 * V_17 ,
T_1 V_624 )
{
...
F_1 ( 12 , L_14 ) ;
#endif
F_440 ( & V_633 , & V_17 -> V_630 , & V_614 -> V_625 [ V_634 ] . V_28 ) ;
...
F_438 ( V_614 , V_17 , V_634 ) ;
#ifdef F_431
F_1 ( 11 , L_22 ) ;
#endif
V_614 -> V_639 -> V_641 = F_442 ;
}
}
static void
F_446 ( T_15 * V_30 , T_10 * V_17 ,
T_16 * V_33 ,
struct V_20 * V_631 ,
T_1 V_642 )
{
...
T_24 * V_643 , * V_644 ;
#ifdef F_431
F_1 ( 10 , L_23 , F_447 ( V_642 , V_15 , L_24 ) , V_17 -> V_627 ) ;
#endif
V_632 . V_609 = V_631 -> V_635 ;
#ifdef F_431
F_1 ( 11 , L_13 , V_632 . V_609 ) ;
...
static void
F_450 ( T_16 * V_33 , T_15 * V_30 , T_23 * V_652 ,
T_1 V_625 )
{
T_24 * V_643 ;
if ( V_620 ) {
switch( V_625 ) {
case V_653 :
V_643 = F_451 ( V_33 , V_654 , V_30 , 0 , 0 , V_652 ) ;
F_449 ( V_643 ) ;
break;
case V_646 :
case V_647 :
case V_648 :
V_643 = F_451 ( V_33 , V_655 , V_30 , 0 , 0 , V_652 ) ;
F_449 ( V_643 ) ;
break;
case V_649 :
V_643 = F_451 ( V_33 , V_656 , V_30 , 0 , 0 , V_652 ) ;
F_449 ( V_643 ) ;
break;
case V_657 :
V_643 = F_451 ( V_33 , V_658 , V_30 , 0 , 0 , V_652 ) ;
F_449 ( V_643 ) ;
break;
case V_659 :
V_643 = F_451 ( V_33 , V_660 , V_30 , 0 , 0 , V_652 ) ;
F_449 ( V_643 ) ;
break;
case V_661 :
V_643 = F_451 ( V_33 , V_662 , V_30 , 0 , 0 , V_652 ) ;
F_449 ( V_643 ) ;
break;
default:
break;
...
F_440 ( & V_633 , & V_17 -> V_630 , & V_614 -> V_625 [ V_642 ] . V_28 ) ;
V_631 -> V_24 [ V_642 ] . V_25 = TRUE ;
V_631 -> V_24 [ V_642 ] . V_636 = V_633 ;
V_631 -> V_24 [ V_642 ] . V_28 = V_614 -> V_625 [ V_642 ] . V_28 ;
F_450 ( V_33 , V_30 , & V_633 , V_642 ) ;
}
}
}
void
F_453 ( T_15 * V_30 , T_10 * V_17 , T_16 * V_33 ,
struct V_20 * V_631 )
{
#ifdef F_431
...
case 64 :
F_439 ( V_17 , V_631 ) ;
F_454 ( (struct V_637 * ) V_631 -> V_639 , V_17 ) ;
break;
case 80 :
F_445 ( V_17 , V_631 ) ;
F_446 ( V_30 , V_17 , V_33 , V_631 ,
...
static int
F_455 ( T_9 T_17 V_7 , T_15 * V_30 , int V_31 , T_18 * T_19 V_7 , T_16 * V_33 ,
...
F_457 ( T_19 -> V_17 -> V_110 , V_111 , F_93 ( V_674 , V_676 , L_42 ) ) ;
F_92 ( T_19 -> V_17 -> V_110 , V_111 , L_5 ) ;
V_103 = FALSE ;
...
static int
F_458 ( T_15 * V_30 , T_10 * V_17 , T_16 * V_677 , void * V_22 )
{
T_24 * V_678 ;
...
V_114 = F_443 () ;
F_455 ( FALSE , V_30 , 0 , & V_489 , V_33 , - 1 , V_668 ) ;
if ( V_622 &&
V_114 -> V_639 ) {
if ( V_620 && V_33 ) {
V_679 = F_460 ( V_33 , V_30 , 0 , 0 , V_683 , NULL , L_44 ) ;
}
F_453 ( V_30 , V_17 , V_679 , V_114 ) ;
F_444 ( V_640 , V_17 , V_114 ) ;
}
return F_461 ( V_30 ) ;
}
static int
F_462 ( T_15 * V_30 , T_10 * V_17 , T_16 * V_677 , void * V_22 )
{
T_24 * V_678 ;
T_16 * V_33 = NULL , * V_679 = NULL ;
struct V_667 * V_668 = (struct V_667 * ) V_22 ;
...
static void F_465 ( T_25 * V_684 , T_26 V_9 , void * V_10 )
{
int V_685 = sizeof( V_686 ) / sizeof( V_687 ) ;
T_27 * V_688 = F_466 ( L_48 , V_685 , 0 , NULL , V_9 , V_10 ) ;
int V_13 ;
...
{
const char * V_697 = F_468 ( V_13 , V_113 ) ;
char * V_698 ;
if ( V_697 ) {
V_698 = F_469 ( L_49 , V_697 ) ;
} else {
V_698 = F_469 ( L_50 , V_13 ) ;
}
V_689 [ V_690 ] . V_694 . V_699 = V_698 ;
F_470 ( V_688 , V_13 , V_685 , V_689 ) ;
}
}
static T_9
F_471 ( void * V_700 , T_10 * V_17 V_7 , T_11 * T_12 V_7 , const void * V_701 )
{
...
return FALSE ;
V_704 = F_472 ( V_688 , V_703 -> V_108 , V_692 ) ;
V_704 -> V_694 . V_695 ++ ;
F_473 ( V_688 , V_703 -> V_108 , V_692 , V_704 ) ;
return TRUE ;
}
static void
F_474 ( T_27 * V_688 )
...
{
V_709 = F_472 ( V_688 , V_708 , V_692 ) ;
V_709 -> V_694 . V_695 = 0 ;
F_473 ( V_688 , V_708 , V_692 , V_709 ) ;
}
}
static void
F_475 ( T_27 * V_688 V_7 , T_1 T_30 V_7 , T_1 V_710 , T_28 * V_711 )
{
if ( V_710 != V_690 ) return;
F_476 ( ( char * ) V_711 -> V_694 . V_699 ) ;
}
static void F_477 ( T_8 V_712 )
{
if ( V_712 ) {
F_478 ( V_712 , V_713 ) ;
}
...
if ( ! V_714 ) {
V_714 = TRUE ;
F_482 ( L_51 , V_716 , V_681 , L_52 ) ;
F_482 ( L_53 , V_717 , V_681 , L_54 ) ;
F_482 ( L_55 , V_717 , V_681 , L_56 ) ;
F_482 ( L_57 , V_717 , V_681 , L_58 ) ;
F_482 ( L_59 , V_713 , V_681 , L_60 ) ;
F_482 ( L_61 , V_713 , V_681 , L_62 ) ;
F_482 ( L_63 , V_713 , V_681 , L_64 ) ;
F_482 ( L_65 , V_713 , V_681 , L_66 ) ;
F_482 ( L_67 , V_713 , V_681 , L_68 ) ;
#line 1 "./asn1/camel/packet-camel-dis-tab.c"
F_483 ( L_69 , F_373 , V_681 , L_70 ) ;
F_483 ( L_71 , F_425 , V_681 , L_72 ) ;
#line 1319 "./asn1/camel/packet-camel-template.c"
} else {
F_484 ( V_715 , F_477 ) ;
F_6 ( F_485 () , V_715 ) ;
}
V_715 = F_486 ( F_485 () , V_718 ) ;
F_484 ( V_715 , F_479 ) ;
}
void F_487 ( void ) {
T_32 * V_719 ;
...
{ & V_187 ,
{ L_80 , L_81 ,
V_724 , V_722 , F_488 ( V_727 ) , 0 , NULL , V_723 } } ,
{ & V_203 ,
{ L_82 , L_83 ,
V_724 , V_728 , F_488 ( V_729 ) , 0 ,
NULL , V_723 } } ,
{ & V_205 ,
{ L_84 , L_85 ,
V_724 , V_728 , F_488 ( V_730 ) , 0 ,
NULL , V_723 } } ,
{ & V_206 ,
{ L_86 , L_87 ,
V_731 , V_732 , NULL , 0 ,
...
{ & V_335 ,
{ L_95 , L_96 ,
V_724 , V_722 , F_488 ( V_735 ) , 0x7F ,
L_97 , V_723 } } ,
{ & V_44 ,
{ L_98 , L_99 ,
V_736 , V_722 , F_488 ( V_737 ) , 0 ,
NULL , V_723 } } ,
{ & V_265 ,
{ L_100 , L_101 ,
V_736 , V_722 , F_488 ( V_738 ) , 0 ,
NULL , V_723 } } ,
{ & V_266 ,
{ L_102 , L_103 ,
V_736 , V_722 , NULL , 0 ,
...
{ & V_267 ,
{ L_104 , L_105 ,
V_736 , V_722 , F_488 ( V_739 ) , 0 ,
NULL , V_723 } } ,
{ & V_336 ,
{ L_106 , L_107 ,
V_736 , V_722 , F_488 ( V_740 ) , 0 ,
NULL , V_723 } } ,
{ & V_337 ,
{ L_108 , L_109 ,
V_736 , V_722 , NULL , 0 ,
...
{ & V_492 ,
{ L_146 , L_147 ,
V_736 , V_722 , F_488 ( V_749 ) , 0 ,
NULL , V_723 } } ,
{ & V_493 ,
{ L_148 , L_149 ,
V_736 , V_722 , F_488 ( V_750 ) , 0 ,
NULL , V_723 } } ,
{ & V_494 ,
{ L_150 , L_151 ,
V_736 , V_722 , F_488 ( V_751 ) , 0 ,
NULL , V_723 } } ,
{ & V_495 ,
{ L_152 , L_153 ,
V_748 , V_732 , NULL , 0 ,
...
{ & V_498 ,
{ L_158 , L_159 ,
V_736 , V_722 , F_488 ( V_752 ) , 0 ,
NULL , V_723 } } ,
{ & V_499 ,
{ L_160 , L_161 ,
V_736 , V_722 , F_488 ( V_753 ) , 0 ,
NULL , V_723 } } ,
{ & V_500 ,
{ L_162 , L_163 ,
V_748 , V_732 , NULL , 0 ,
...
{ & V_547 ,
{ L_256 , L_257 ,
V_736 , V_722 , F_488 ( V_757 ) , 0 ,
NULL , V_723 } } ,
{ & V_758 ,
{ L_258 , L_259 ,
V_736 , V_722 , F_488 ( V_759 ) , 0 ,
NULL , V_723 } } ,
{ & V_760 ,
{ L_260 , L_261 ,
V_736 , V_722 , NULL , 0 ,
...
{ & V_775 ,
{ L_296 , L_297 ,
V_736 , V_722 , F_488 ( V_776 ) , 0 ,
NULL , V_723 } } ,
{ & V_777 ,
{ L_298 , L_299 ,
V_736 , V_722 , F_488 ( V_778 ) , 0 ,
NULL , V_723 } } ,
{ & V_779 ,
{ L_300 , L_301 ,
V_736 , V_722 , F_488 ( V_780 ) , 0 ,
NULL , V_723 } } ,
{ & V_781 ,
{ L_302 , L_303 ,
V_748 , V_732 , NULL , 0 ,
...
{ & V_808 ,
{ L_358 , L_359 ,
V_736 , V_722 , F_488 ( V_809 ) , 0 ,
L_360 , V_723 } } ,
{ & V_810 ,
{ L_361 , L_362 ,
V_736 , V_722 , F_488 ( V_811 ) , 0 ,
NULL , V_723 } } ,
{ & V_812 ,
{ L_363 , L_364 ,
V_765 , V_732 , NULL , 0 ,
...
{ & V_818 ,
{ L_358 , L_359 ,
V_736 , V_722 , F_488 ( V_819 ) , 0 ,
L_375 , V_723 } } ,
{ & V_820 ,
{ L_376 , L_377 ,
V_736 , V_722 , F_488 ( V_821 ) , 0 ,
NULL , V_723 } } ,
{ & V_822 ,
{ L_369 , L_370 ,
V_748 , V_732 , NULL , 0 ,
...
{ & V_839 ,
{ L_414 , L_415 ,
V_736 , V_722 , F_488 ( V_840 ) , 0 ,
NULL , V_723 } } ,
{ & V_841 ,
{ L_416 , L_417 ,
V_736 , V_722 , F_488 ( V_842 ) , 0 ,
NULL , V_723 } } ,
{ & V_843 ,
{ L_418 , L_419 ,
V_736 , V_722 , F_488 ( V_844 ) , 0 ,
NULL , V_723 } } ,
{ & V_845 ,
{ L_420 , L_421 ,
V_736 , V_722 , F_488 ( V_846 ) , 0 ,
NULL , V_723 } } ,
{ & V_847 ,
{ L_422 , L_423 ,
V_736 , V_722 , NULL , 0 ,
...
{ & V_871 ,
{ L_469 , L_470 ,
V_736 , V_722 , F_488 ( V_872 ) , 0 ,
NULL , V_723 } } ,
{ & V_873 ,
{ L_471 , L_472 ,
V_736 , V_722 , F_488 ( V_874 ) , 0 ,
NULL , V_723 } } ,
{ & V_875 ,
{ L_473 , L_474 ,
V_736 , V_722 , F_488 ( V_876 ) , 0 ,
NULL , V_723 } } ,
{ & V_877 ,
{ L_475 , L_476 ,
V_748 , V_732 , NULL , 0 ,
...
{ & V_935 ,
{ L_589 , L_590 ,
V_736 , V_722 , F_488 ( V_936 ) , 0 ,
L_591 , V_723 } } ,
{ & V_937 ,
{ L_592 , L_593 ,
V_736 , V_722 , F_488 ( V_938 ) , 0 ,
L_594 , V_723 } } ,
{ & V_939 ,
{ L_595 , L_596 ,
V_748 , V_732 , NULL , 0 ,
...
{ & V_997 ,
{ L_712 , L_713 ,
V_736 , V_722 , F_488 ( V_998 ) , 0 ,
NULL , V_723 } } ,
{ & V_999 ,
{ L_714 , L_715 ,
V_736 , V_722 , F_488 ( V_1000 ) , 0 ,
NULL , V_723 } } ,
{ & V_1001 ,
{ L_716 , L_717 ,
V_734 , V_732 , NULL , 0 ,
...
{ & V_1033 ,
{ L_778 , L_779 ,
V_736 , V_722 , F_488 ( V_1034 ) , 0 ,
NULL , V_723 } } ,
{ & V_1035 ,
{ L_780 , L_781 ,
V_736 , V_722 , F_488 ( V_1036 ) , 0 ,
NULL , V_723 } } ,
{ & V_1037 ,
{ L_782 , L_783 ,
V_748 , V_732 , NULL , 0 ,
...
{ & V_1038 ,
{ L_784 , L_785 ,
V_721 , V_722 , F_488 ( V_1039 ) , 0 ,
L_280 , V_723 } } ,
{ & V_1040 ,
{ L_786 , L_787 ,
V_721 , V_722 , F_488 ( V_1041 ) , 0 ,
L_280 , V_723 } } ,
{ & V_1042 ,
{ L_788 , L_789 ,
V_721 , V_722 , F_488 ( V_1043 ) , 0 ,
L_280 , V_723 } } ,
{ & V_1044 ,
{ L_790 , L_791 ,
V_736 , V_722 , F_488 ( V_1045 ) , 0 ,
NULL , V_723 } } ,
{ & V_1046 ,
{ L_792 , L_793 ,
V_736 , V_722 , NULL , 0 ,
...
{ & V_1086 ,
{ L_866 , L_867 ,
V_736 , V_722 , F_488 ( V_1087 ) , 0 ,
NULL , V_723 } } ,
{ & V_1088 ,
{ L_868 , L_869 ,
V_736 , V_722 , F_488 ( V_1089 ) , 0 ,
NULL , V_723 } } ,
{ & V_1090 ,
{ L_870 , L_871 ,
V_736 , V_722 , NULL , 0 ,
...
{ & V_1231 ,
{ L_1116 , L_1117 ,
V_736 , V_722 , F_488 ( V_1232 ) , 0 ,
NULL , V_723 } } ,
{ & V_1233 ,
{ L_1118 , L_1119 ,
V_736 , V_722 , F_488 ( V_1234 ) , 0 ,
NULL , V_723 } } ,
{ & V_1235 ,
{ L_1120 , L_1121 ,
V_721 , V_722 , NULL , 0 ,
...
{ & V_1243 ,
{ L_830 , L_831 ,
V_736 , V_722 , F_488 ( V_1244 ) , 0 ,
NULL , V_723 } } ,
{ & V_1245 ,
{ L_1136 , L_1137 ,
V_721 , V_722 , F_488 ( V_1246 ) , 0 ,
L_1138 , V_723 } } ,
{ & V_1247 ,
{ L_1108 , L_1139 ,
V_721 , V_722 , F_488 ( V_1248 ) , 0 ,
L_1140 , V_723 } } ,
{ & V_1249 ,
{ L_1110 , L_1141 ,
V_721 , V_722 , F_488 ( V_1250 ) , 0 ,
L_1142 , V_723 } } ,
{ & V_1251 ,
{ L_1112 , L_1143 ,
V_721 , V_722 , F_488 ( V_1252 ) , 0 ,
L_1144 , V_723 } } ,
{ & V_1253 ,
{ L_1120 , L_1121 ,
V_721 , V_722 , NULL , 0 ,
...
V_681 = F_490 ( V_1267 , V_1266 , V_1268 ) ;
V_713 = F_491 ( L_1158 , F_464 , V_681 ) ;
V_716 = F_491 ( L_1159 , F_458 , V_681 ) ;
V_717 = F_491 ( L_1160 , F_462 , V_681 ) ;
F_492 ( V_681 , V_720 , F_493 ( V_720 ) ) ;
F_494 ( V_1255 , F_493 ( V_1255 ) ) ;
V_1261 = F_495 ( V_681 ) ;
F_496 ( V_1261 , V_1257 , F_493 ( V_1257 ) ) ;
F_497 ( & V_1269 ) ;
V_1269 . V_1270 = F_498 ( L_1161 ,
L_1162 , V_681 ,
V_736 , V_728 ) ;
V_1269 . V_1271 = F_498 ( L_1163 ,
L_1164 , V_681 ,
V_736 , V_728 ) ;
V_1269 . V_1272 = F_498 ( L_1165 ,
L_1166 , V_681 ,
V_736 , V_728 ) ;
F_499 ( F_485 () , & V_718 , L_1167 , V_1273 ) ;
V_719 = F_500 ( V_681 , F_481 ) ;
F_501 ( V_719 , L_1168 , L_1169 ,
L_1170 ,
& V_189 , V_1274 , FALSE ) ;
F_502 ( V_719 , L_1171 ,
L_1172 ,
...
& V_621 ) ;
F_504 ( & F_437 ) ;
V_615 = F_505 ( F_485 () , F_435 () , F_428 , F_427 ) ;
V_640 = F_506 ( V_1266 ) ;
F_507 ( V_681 , V_1266 , 1 , F_7 , F_2 , NULL ) ;
F_508 ( & V_1264 ) ;
}
