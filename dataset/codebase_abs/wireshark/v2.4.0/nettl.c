...
V_7 = F_5 ( V_69 . V_7 ) ;
V_70 -= V_80 ;
if ( ! F_2 ( V_9 , NULL , V_70 , V_2 , V_3 ) )
return FALSE ;
if ( ( F_10 ( & V_69 . V_82 ) & V_83 ) == 0 ) {
V_56 -> V_59 = V_43 ;
V_73 = F_10 ( & V_69 . V_73 ) ;
V_74 = F_10 ( & V_69 . V_74 ) ;
V_75 = 0 ;
...
|| ( V_7 == V_30 )
|| ( V_7 == V_32 ) ) {
if ( ! F_2 ( V_9 , NULL , 3 , V_2 , V_3 ) )
return FALSE ;
V_75 = 3 ;
} else if ( V_7 == V_39 ) {
if ( ! F_2 ( V_9 , NULL , 26 , V_2 , V_3 ) )
return FALSE ;
V_75 = 26 ;
} else if ( V_7 == V_105 ) {
if ( ! F_2 ( V_9 , NULL , 8 , V_2 , V_3 ) )
return FALSE ;
V_75 = 8 ;
} else {
V_75 = 0 ;
...
case V_107 :
V_56 -> V_59 = V_50 ;
if ( ! F_2 ( V_9 , & V_72 , V_108 ,
V_2 , V_3 ) )
return FALSE ;
V_73 = F_11 ( & V_72 . V_73 ) ;
V_74 = F_11 ( & V_72 . V_74 ) ;
if ( V_8 -> V_23 ) {
if ( ! F_2 ( V_9 , NULL , 2 , V_2 , V_3 ) )
return FALSE ;
}
V_75 = 0 ;
break;
...
V_56 -> V_112 = V_113 ;
V_56 -> V_114 = V_115 | V_116 ;
V_56 -> V_117 = V_73 - V_75 ;
if ( V_74 < V_75 ) {
* V_2 = V_81 ;
* V_3 = F_9 ( L_3 ,
V_74 , V_75 ) ;
...
V_76 = V_74 - V_75 ;
V_56 -> V_74 = V_76 ;
V_56 -> V_118 . V_119 = F_10 ( & V_69 . V_120 ) ;
V_56 -> V_118 . V_121 = F_10 ( & V_69 . V_122 ) * 1000 ;
V_66 -> V_8 . V_7 = V_7 ;
V_66 -> V_8 . V_123 = F_10 ( & V_69 . V_123 ) ;
V_66 -> V_8 . V_82 = F_10 ( & V_69 . V_82 ) ;
V_66 -> V_8 . V_124 = F_10 ( & V_69 . V_124 ) ;
V_66 -> V_8 . V_125 = F_11 ( & V_69 . V_125 ) ;
if ( V_56 -> V_74 > V_126 ) {
* V_2 = V_81 ;
* V_3 = F_9 ( L_4 ,
V_56 -> V_74 , V_126 ) ;
...
T_6 F_15 ( T_13 * V_133 , int * V_2 )
{
struct V_4 V_5 ;
V_133 -> V_134 = V_135 ;
memset ( & V_5 , 0 , sizeof( V_5 ) ) ;
memcpy ( V_5 . V_10 , V_16 , sizeof( V_5 . V_10 ) ) ;
F_16 ( V_5 . V_17 , L_5 , V_136 ) ;
...
if ( ! F_18 ( V_133 , & V_5 , sizeof V_5 , V_2 ) )
return FALSE ;
V_133 -> V_142 += sizeof( V_5 ) ;
return TRUE ;
}
static T_6 V_135 ( T_13 * V_133 ,
const struct V_62 * V_56 ,
const T_12 * V_79 , int * V_2 , T_3 * * V_3 V_143 )
{
...
V_69 . V_82 = F_19 ( V_106 ) ;
V_69 . V_120 = F_19 ( V_56 -> V_118 . V_119 ) ;
V_69 . V_122 = F_19 ( V_56 -> V_118 . V_121 / 1000 ) ;
V_69 . V_74 = F_19 ( V_56 -> V_74 ) ;
V_69 . V_73 = F_19 ( V_56 -> V_117 ) ;
V_69 . V_123 = - 1 ;
V_69 . V_124 = - 1 ;
V_69 . V_125 = - 1 ;
switch ( V_56 -> V_59 ) {
...
case V_49 :
case V_131 :
V_69 . V_7 = F_17 ( V_66 -> V_8 . V_7 ) ;
V_69 . V_123 = F_19 ( V_66 -> V_8 . V_123 ) ;
V_69 . V_82 = F_19 ( V_66 -> V_8 . V_82 ) ;
V_69 . V_124 = F_19 ( V_66 -> V_8 . V_124 ) ;
V_69 . V_125 = F_17 ( V_66 -> V_8 . V_125 ) ;
break;
case V_146 :
V_69 . V_7 = F_17 ( V_38 ) ;
break;
...
if ( ! F_18 ( V_133 , & V_69 , sizeof( V_69 ) , V_2 ) )
return FALSE ;
V_133 -> V_142 += sizeof( V_69 ) ;
memset ( V_77 , 0 , sizeof V_77 ) ;
if ( ! F_18 ( V_133 , V_77 , 4 , V_2 ) )
return FALSE ;
V_133 -> V_142 += 4 ;
if ( ( V_56 -> V_59 == V_129 ) ||
( V_56 -> V_59 == V_34 ) ) {
if ( ! F_18 ( V_133 , V_77 , 3 , V_2 ) )
return FALSE ;
V_133 -> V_142 += 3 ;
}
if ( ! F_18 ( V_133 , V_79 , V_56 -> V_74 , V_2 ) )
return FALSE ;
V_133 -> V_142 += V_56 -> V_74 ;
return TRUE ;
}
