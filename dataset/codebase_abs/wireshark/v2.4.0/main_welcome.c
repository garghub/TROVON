...
if ( V_38 != NULL && ( ( V_38 -> V_39 == 3 && V_38 -> V_40 == 1 ) || ( V_38 -> V_39 == 6 && V_38 -> V_40 == 14 ) ) ) {
F_47 ( V_35 , L_7 ) ;
} else {
F_47 ( V_35 , V_41 . V_42 ) ;
}
...
static T_4
F_65 ( T_1 * T_15 V_15 , T_11 * T_6 V_15 , T_7 V_57 )
{
F_66 ( ( T_9 * ) V_57 ) ;
return FALSE ;
}
...
V_72 = F_68 ( V_69 -> V_73 , & V_70 ) ;
F_69 ( V_74 ) ;
V_69 -> V_72 = V_72 ;
if( V_72 == 0 ) {
V_71 = F_70 ( V_70 . V_75 , ( V_76 ) ( V_77 | V_78 ) ) ;
F_71 ( V_69 -> V_47 , L_12 ) ;
F_48 ( V_69 -> V_47 , L_13 , V_71 ) ;
F_42 ( V_71 ) ;
} else {
F_47 ( V_69 -> V_47 , L_14 ) ;
}
...
static void F_76 ( T_1 * V_28 V_15 , T_7 V_57 ) {
T_16 * V_69 = ( T_16 * ) V_57 ;
if ( ! V_69 ) {
return;
}
...
static T_1 *
F_79 ( const T_9 * V_73 , T_1 * * V_79 , T_18 * V_83 )
{
T_1 * V_28 ;
T_1 * V_14 ;
T_12 * V_47 ;
...
T_16 * V_69 ;
V_47 = F_46 ( V_73 ) ;
V_86 = F_80 ( V_47 -> V_47 , V_47 -> V_90 ) ;
if ( V_86 > V_89 ) {
V_87 = F_81 ( V_47 -> V_47 , 20 ) - V_47 -> V_47 ;
V_88 = F_81 ( V_47 -> V_47 , V_86 - V_89 ) - V_47 -> V_47 ;
F_82 ( V_47 , V_87 , V_88 ) ;
F_83 ( V_47 , V_87 , L_15 V_91 L_15 ) ;
}
V_85 = F_84 ( V_47 -> V_47 , - 1 ) ;
F_50 ( V_47 , TRUE ) ;
V_28 = F_36 ( V_85 ) ;
* V_79 = V_28 ;
F_85 ( F_38 ( V_28 ) , 5 , 2 ) ;
...
V_69 -> V_84 = 0 ;
F_19 ( F_7 ( V_83 ) ) ;
F_33 ( V_28 , L_16 , F_34 ( F_76 ) , V_69 ) ;
F_42 ( V_85 ) ;
#if F_88 ( 2 , 31 , 0 )
F_89 ( L_17 , F_67 , V_69 ) ;
#else
F_90 ( F_67 , V_69 , FALSE , NULL ) ;
#endif
V_69 -> V_84 = F_91 ( 200 , F_73 , V_69 ) ;
V_14 = F_31 () ;
#if F_21 ( 3 , 0 , 0 )
F_27 ( V_14 , V_16 , & V_20 ) ;
#else
...
F_33 ( V_14 , L_18 , F_34 ( F_65 ) , ( T_9 * ) V_73 ) ;
return V_14 ;
}
void
F_92 ( void )
...
void
F_94 ( const char * V_95 , T_18 * V_83 )
{
T_1 * V_28 ;
T_1 * V_1 ;
T_1 * V_79 ;
V_28 = F_79 ( V_95 , & V_79 , V_83 ) ;
V_1 = F_10 ( V_94 ) ;
...
T_26 V_102 ;
F_96 ( V_96 , & V_99 , V_97 ) ;
F_97 ( V_96 , & V_99 , V_103 , & V_100 , - 1 ) ;
for ( V_101 = 0 ; V_101 < V_104 . V_105 -> V_90 ; V_101 ++ ) {
V_102 = F_98 ( V_104 . V_105 , T_26 , V_101 ) ;
...
V_102 . V_107 = TRUE ;
V_104 . V_105 = F_99 ( V_104 . V_105 , V_101 ) ;
F_100 ( V_104 . V_105 , V_101 , V_102 ) ;
if ( F_101 () ) {
F_102 ( F_87 ( V_100 ) , V_102 . V_108 ) ;
}
if ( F_103 () ) {
F_104 ( F_87 ( V_100 ) ) ;
}
...
static T_4
F_109 ( T_23 * V_96 , T_24 * V_97 V_15 , T_25 * V_99 ,
T_7 V_111 )
{
T_9 * V_100 ;
T_1 * V_112 ;
...
void
F_114 ( T_9 * V_106 , T_4 V_115 )
{
T_1 * V_112 ;
T_23 * V_96 ;
T_27 V_113 ;
V_112 = ( T_1 * ) F_11 ( F_7 ( V_56 ) , V_114 ) ;
V_96 = F_115 ( F_111 ( V_112 ) ) ;
V_113 . V_106 = F_87 ( V_106 ) ;
V_113 . V_115 = V_115 ;
F_116 ( F_117 ( V_96 ) , ( V_116 ) ( F_109 ) , ( T_7 ) & V_113 ) ;
}
void
F_118 ( T_4 V_110 )
{
...
for ( V_101 = 0 ; V_101 < V_104 . V_105 -> V_90 ; V_101 ++ ) {
V_102 = F_98 ( V_104 . V_105 , T_26 , V_101 ) ;
V_117 = strcmp ( V_102 . V_106 , L_19 ) ;
if ( V_117 ) {
F_114 ( V_102 . V_106 , V_110 ) ;
} else {
F_114 ( V_102 . V_106 , FALSE ) ;
}
}
}
void
F_119 ( T_9 * V_118 , T_2 V_119 )
{
T_1 * V_112 ;
T_23 * V_96 ;
T_25 V_99 ;
...
T_9 * V_120 ;
V_112 = ( T_1 * ) F_11 ( F_7 ( V_56 ) , V_114 ) ;
V_113 = F_110 ( F_111 ( V_112 ) ) ;
V_96 = F_115 ( F_111 ( V_112 ) ) ;
V_102 = F_98 ( V_104 . V_105 , T_26 , V_119 ) ;
if ( F_120 ( V_96 , & V_99 ) ) {
do {
F_97 ( V_96 , & V_99 , V_103 , & V_120 , - 1 ) ;
if ( strcmp ( V_120 , V_118 ) == 0 ) {
F_121 ( F_122 ( V_96 ) , & V_99 , V_121 , F_123 ( F_124 ( F_125 ( & V_102 ) ) ) , V_122 , V_102 . V_123 , V_103 , V_102 . V_106 , - 1 ) ;
if ( V_102 . V_108 ) {
F_112 ( V_113 , & V_99 ) ;
}
break;
}
} while ( F_126 ( V_96 , & V_99 ) );
F_42 ( V_120 ) ;
}
}
void
...
V_112 = ( T_1 * ) F_11 ( F_7 ( V_56 ) , V_114 ) ;
V_96 = F_115 ( F_111 ( V_112 ) ) ;
V_124 = F_128 ( V_96 , NULL ) ;
V_125 = F_39 ( L_21 , V_124 - 1 ) ;
if ( F_129 ( V_96 , & V_99 , V_125 ) ) {
F_130 ( F_122 ( V_96 ) , & V_99 ) ;
F_121 ( F_122 ( V_96 ) , & V_99 , V_121 , F_123 ( F_124 ( V_49 ) ) , V_122 , V_102 . V_123 , V_103 , V_102 . V_106 , - 1 ) ;
}
}
static void
F_131 ( void )
...
T_26 V_102 ;
T_4 V_136 = FALSE ;
V_135 = F_135 ( V_137 , V_138 , V_139 , V_139 ) ;
F_136 ( V_135 ) ;
F_137 ( F_111 ( V_132 ) , F_117 ( V_135 ) ) ;
V_113 = F_110 ( F_111 ( V_132 ) ) ;
for ( V_101 = 0 ; V_101 < V_104 . V_105 -> V_90 ; V_101 ++ ) {
V_102 = F_98 ( V_104 . V_105 , T_26 , V_101 ) ;
if ( ! V_102 . V_134 ) {
F_130 ( V_135 , & V_99 ) ;
F_121 ( V_135 , & V_99 , V_121 , F_123 ( F_124 ( F_125 ( & V_102 ) ) ) , V_122 , V_102 . V_123 , V_103 , V_102 . V_106 , - 1 ) ;
if ( V_102 . V_108 ) {
F_112 ( V_113 , & V_99 ) ;
}
}
...
F_133 () ;
V_136 = TRUE ;
F_138 ( F_139 ( V_113 ) , F_95 , ( T_7 ) & V_136 , NULL ) ;
}
static void
F_140 ( T_1 * V_28 V_15 , T_7 T_8 V_15 )
{
F_131 () ;
F_141 () ;
}
...
V_131 = F_144 ( NULL , NULL ) ;
F_133 () ;
F_145 ( F_23 ( V_131 ) , V_156 ) ;
F_146 ( F_23 ( V_131 ) , V_157 , V_157 ) ;
F_6 ( F_7 ( V_56 ) , V_127 , V_142 ) ;
V_132 = F_147 () ;
F_148 ( F_7 ( V_132 ) , L_25 , FALSE , NULL ) ;
F_33 ( V_132 , L_26 , F_34 ( V_158 ) , ( T_7 ) V_56 ) ;
F_6 ( F_7 ( V_56 ) , V_114 , V_132 ) ;
V_146 = F_149 () ;
V_145 = F_150 () ;
F_151 ( V_146 , V_145 , FALSE ) ;
F_152 ( V_146 , V_145 , L_27 , V_121 , NULL ) ;
V_145 = F_153 () ;
F_151 ( V_146 , V_145 , TRUE ) ;
F_152 ( V_146 , V_145 , L_28 , V_122 , NULL ) ;
F_154 ( F_111 ( V_132 ) , V_146 ) ;
F_155 ( F_156 ( F_111 ( V_132 ) , 0 ) , TRUE ) ;
V_145 = F_153 () ;
V_146 = F_157 ( L_29 ,
F_158 ( V_145 ) ,
L_28 , V_103 ,
...
F_165 ( F_41 ( V_28 ) , TRUE ) ;
F_42 ( V_147 ) ;
F_37 ( F_38 ( V_28 ) , 0.0f , 0.0f ) ;
F_3 ( F_4 ( V_140 ) , V_28 , FALSE , FALSE , 5 ) ;
#if F_21 ( 2 , 18 , 0 )
F_33 ( V_28 , L_54 , F_34 ( V_173 ) , NULL ) ;
#endif
...
static void
F_179 ( T_34 * T_35 V_15 )
{
F_59 () ;
}
void
F_180 ( T_28 T_6 , T_7 V_57 , T_7 T_8 V_15 )
{
switch( T_6 ) {
case ( V_203 ) :
break;
...
{
static const T_9 V_34 [] = L_85 ;
F_55 ( V_34 ) ;
}
static void
F_188 ( T_36 * T_37 V_15 )
{
F_59 () ;
}
void
F_189 ( T_28 T_6 , T_36 * T_37 ,
T_7 T_8 V_15 )
{
switch( T_6 ) {
case ( V_228 ) :
