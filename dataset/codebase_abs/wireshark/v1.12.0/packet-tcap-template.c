...
static struct V_43 *
F_37 ( struct V_14 * V_84 ,
T_7 * V_33 )
{
struct V_14 * V_85 ;
struct V_43 * V_86 = NULL ;
#ifdef F_26
V_85 = (struct V_14 * ) F_38 ( sizeof( struct V_14 ) ) ;
#else
V_85 = F_39 ( struct V_14 ) ;
#endif
V_85 -> V_17 = V_84 -> V_17 ;
#ifdef F_26
V_86 = (struct V_43 * ) F_27 ( sizeof( struct V_43 ) ) ;
#else
V_86 = F_28 ( struct V_43 ) ;
#endif
V_86 -> V_19 = V_85 ;
V_86 -> V_17 = V_84 -> V_17 ;
...
static struct V_31 *
F_40 ( struct V_20 * V_74 ,
struct V_43 * V_44 )
{
struct V_20 * V_88 ;
struct V_31 * V_45 = NULL ;
#ifdef F_26
V_88 = (struct V_20 * ) F_38 ( sizeof( struct V_20 ) ) ;
#else
V_88 = F_39 ( struct V_20 ) ;
#endif
V_88 -> V_21 = V_74 -> V_21 ;
V_88 -> V_24 = V_74 -> V_24 ;
V_88 -> V_22 = V_74 -> V_22 ;
...
static struct V_59 *
F_41 ( struct V_26 * V_77 ,
struct V_43 * V_44 )
{
struct V_26 * V_89 ;
struct V_59 * V_61 = NULL ;
#ifdef F_26
V_89 = (struct V_26 * ) F_38 ( sizeof( struct V_26 ) ) ;
#else
V_89 = F_39 ( struct V_26 ) ;
#endif
V_89 -> V_21 = V_77 -> V_21 ;
V_89 -> V_27 = V_77 -> V_27 ;
V_89 -> V_28 = V_77 -> V_28 ;
...
static struct V_66 *
F_42 ( struct V_29 * V_80 ,
struct V_43 * V_44 )
{
struct V_29 * V_90 ;
struct V_66 * V_68 = NULL ;
#ifdef F_26
V_90 = (struct V_29 * ) F_38 ( sizeof( struct V_29 ) ) ;
#else
V_90 = F_39 ( struct V_29 ) ;
#endif
V_90 -> V_21 = V_80 -> V_21 ;
V_90 -> V_24 = V_80 -> V_24 ;
V_90 -> V_22 = V_80 -> V_22 ;
...
static struct V_51 *
F_43 ( struct V_30 * V_91 ,
struct V_43 * V_44 )
{
struct V_30 * V_92 ;
struct V_51 * V_54 = NULL ;
#ifdef F_26
V_92 = (struct V_30 * ) F_38 ( sizeof( struct V_30 ) ) ;
#else
V_92 = F_39 ( struct V_30 ) ;
#endif
V_92 -> V_21 = V_91 -> V_21 ;
V_92 -> V_24 = V_91 -> V_24 ;
V_92 -> V_22 = V_91 -> V_22 ;
...
static struct V_43 *
F_49 ( T_9 * V_101 , T_7 * V_33 , T_10 * V_102 ,
struct V_103 * V_104 )
{
...
{
V_106 . V_22 = F_50 ( ( const V_113 * ) V_33 -> V_110 . V_114 ) ;
V_106 . V_23 = F_50 ( ( const V_113 * ) V_33 -> V_112 . V_114 ) ;
} else {
V_106 . V_22 = F_51 ( F_52 ( F_53 () , & V_33 -> V_110 ) ) ;
V_106 . V_23 = F_51 ( F_52 ( F_53 () , & V_33 -> V_112 ) ) ;
}
V_106 . V_21 = F_17 ( & V_106 ) ;
#ifdef F_29
F_13 ( 10 , L_27 , V_33 -> V_36 -> V_37 ) ;
F_13 ( 11 , L_28 , V_106 . V_21 ) ;
F_13 ( 51 , L_29 , F_52 ( F_53 () , & V_33 -> V_110 ) , F_52 ( F_53 () , & V_33 -> V_112 ) ) ;
...
V_44 = V_32 -> V_34 ;
if ( V_97 && V_102 ) {
V_108 = F_54 ( V_102 , V_101 , 0 , - 1 , L_38 ) ;
F_55 ( V_108 ) ;
V_109 = F_56 ( V_108 , V_119 ) ;
...
V_44 &&
V_44 -> V_17 ) {
V_108 = F_54 ( V_102 , V_101 , 0 , 0 , L_38 ) ;
F_55 ( V_108 ) ;
V_109 = F_56 ( V_108 , V_119 ) ;
...
if ( V_33 -> V_110 . type == V_111 && V_33 -> V_112 . type == V_111 )
{
V_123 . V_22 = F_50 ( ( const V_113 * ) V_33 -> V_110 . V_114 ) ;
V_123 . V_23 = F_50 ( ( const V_113 * ) V_33 -> V_112 . V_114 ) ;
} else {
V_123 . V_22 = F_51 ( F_52 ( F_53 () , & V_33 -> V_110 ) ) ;
V_123 . V_23 = F_51 ( F_52 ( F_53 () , & V_33 -> V_112 ) ) ;
}
...
if ( V_33 -> V_110 . type == V_111 && V_33 -> V_112 . type == V_111 )
{
V_124 . V_22 = F_50 ( ( const V_113 * ) V_33 -> V_110 . V_114 ) ;
V_124 . V_23 = F_50 ( ( const V_113 * ) V_33 -> V_112 . V_114 ) ;
} else {
V_124 . V_22 = F_51 ( F_52 ( F_53 () , & V_33 -> V_110 ) ) ;
V_124 . V_23 = F_51 ( F_52 ( F_53 () , & V_33 -> V_112 ) ) ;
}
...
F_13 ( 11 , L_29 , F_52 ( F_53 () , & V_33 -> V_110 ) , F_52 ( F_53 () , & V_33 -> V_112 ) ) ;
F_13 ( 51 , L_57 , V_124 . V_24 ) ;
#endif
V_82 = F_36 ( & V_124 , V_33 , TRUE ) ;
if( ! V_82 ) {
#ifdef F_29
F_13 ( 12 , L_58 ) ;
#endif
...
if ( V_33 -> V_110 . type == V_111 && V_33 -> V_112 . type == V_111 )
{
V_128 . V_22 = F_50 ( ( const V_113 * ) V_33 -> V_110 . V_114 ) ;
V_128 . V_23 = F_50 ( ( const V_113 * ) V_33 -> V_112 . V_114 ) ;
} else {
V_128 . V_22 = F_51 ( F_52 ( F_53 () , & V_33 -> V_110 ) ) ;
V_128 . V_23 = F_51 ( F_52 ( F_53 () , & V_33 -> V_112 ) ) ;
}
...
F_13 ( 1 , L_66 ) ;
#endif
V_130 = F_49 ( V_101 , V_33 , V_102 , V_104 ) ;
break;
case V_133 :
#ifdef F_29
F_13 ( 1 , L_67 ) ;
...
V_165 = FALSE ;
V_166 = NULL ;
F_75 ( FALSE , V_101 , 0 , & V_146 , V_102 , - 1 ) ;
if ( V_99 && ! V_165 ) {
V_144 = F_65 ( V_101 , V_33 , V_154 , V_164 ) ;
V_162 . V_34 = V_144 ;
if ( V_144 && V_160 && ! V_144 -> V_167 ) {
F_76 ( V_144 -> V_168 , V_160 , sizeof( V_144 -> V_168 ) ) ;
V_144 -> V_167 = TRUE ;
if ( ( V_145 = F_77 ( V_169 , V_160 ) ) ) {
V_144 -> V_145 = V_145 ;
V_144 -> V_170 = TRUE ;
}
}
...
T_16 * V_191 ;
V_157 = F_82 ( V_192 , V_193 , V_194 ) ;
F_83 ( V_157 , V_173 , F_84 ( V_173 ) ) ;
F_85 ( V_187 , F_84 ( V_187 ) ) ;
V_191 = F_86 ( V_157 , NULL ) ;
#if 0
...
F_87 ( V_191 , L_115 ) ;
#endif
F_88 ( & V_195 , L_116 , V_196 ) ;
V_197 = F_89 () ;
F_90 ( V_191 , L_117 , L_118 ,
L_119 ,
& V_195 , V_196 ) ;
F_91 ( V_191 , L_120 ,
L_121 ,
...
L_131 ,
10 , & V_117 ) ;
V_3 = F_48 ( V_198 , V_199 ) ;
V_5 = F_48 ( V_198 , V_199 ) ;
F_93 ( L_132 , F_68 , V_157 ) ;
V_4 = F_94 ( F_68 , V_157 ) ;
F_95 ( & V_200 ) ;
}
...
static int
F_100 ( T_13 * V_201 , T_10 * V_102 , T_9 * V_101 , int V_202 )
{
T_5 V_203 , V_204 , V_205 ;
T_9 * V_206 ;
T_10 * V_207 ;
T_11 * V_107 ;
T_14 V_147 ;
...
T_1 V_210 ;
T_8 V_211 ;
while ( F_101 ( V_101 , V_202 ) > 0 )
{
V_204 = V_202 ;
V_202 = F_69 ( V_101 , V_202 , & V_147 , & V_148 , & V_149 ) ;
V_203 = V_202 ;
V_202 = F_102 ( V_101 , V_202 , & V_208 , & V_211 ) ;
V_205 = V_202 ;
V_209 = V_203 - V_204 ;
V_210 = V_205 - V_203 ;
if ( V_148 )
{
V_107 = F_54 ( V_102 , V_101 , V_204 ,
V_208 + ( V_205 - V_204 ) ,
L_133 ) ;
V_207 = F_56 ( V_107 , V_188 ) ;
F_57 ( V_207 , V_174 , V_101 ,
V_204 , V_209 , V_149 ,
L_134 ) ;
F_58 ( V_207 , V_174 , V_101 , V_204 ,
V_209 , V_147 ) ;
F_58 ( V_207 , V_178 , V_101 , V_203 ,
V_210 , V_208 ) ;
if ( V_208 - ( 2 * V_211 ) )
{
V_206 = F_103 ( V_101 , V_202 , V_208 - ( 2 * V_211 ) ,
V_208 - ( 2 * V_211 ) ) ;
F_100 ( V_201 , V_207 , V_206 , 0 ) ;
}
if ( V_211 )
F_54 ( V_207 , V_101 , V_202 + V_208 - 2 , 2 , L_135 ) ;
V_202 += V_208 ;
}
else
{
...
F_58 ( V_207 , V_174 , V_101 , V_204 ,
V_209 , V_149 ) ;
F_58 ( V_207 , V_178 , V_101 ,
V_204 + V_209 , V_210 , V_208 ) ;
if ( V_208 )
{
V_206 = F_103 ( V_101 , V_202 , V_208 , V_208 ) ;
F_104 ( TRUE , V_201 , V_102 , V_206 , 0 ,
V_180 , NULL ) ;
}
V_202 += V_208 ;
}
...
static void F_74 ( struct V_212 * V_213 )
{
memset ( V_213 , 0 , sizeof( struct V_212 ) ) ;
}
static int
F_105 ( T_8 T_18 V_6 , T_9 * V_101 , int V_202 , T_13 * V_201 V_6 , T_10 * V_102 , int T_19 V_6 )
{
T_2 V_145 = NULL ;
T_8 V_214 = FALSE ;
...
if ( V_99 ) {
if ( ! V_165 ) {
V_144 = F_65 ( V_101 , V_201 -> V_33 , V_154 , V_164 ) ;
V_165 = TRUE ;
V_166 = V_144 ;
V_162 . V_34 = V_144 ;
} else{
...
if ( V_214 ) {
F_106 ( V_145 , V_101 , V_201 -> V_33 , V_102 , V_201 -> V_163 ) ;
F_107 ( V_201 -> V_33 -> V_155 , V_218 ) ;
}
return V_202 ;
}
void F_108 ( T_2 V_219 , T_9 * V_101 , T_7 * V_33 , T_10 * V_102 ) {
V_217 = V_219 ;
F_109 {
