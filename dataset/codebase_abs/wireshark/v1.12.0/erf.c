...
T_4 V_52 ;
T_5 V_15 ;
if ( F_5 ( V_1 -> V_59 , V_56 , V_39 , V_2 ) == - 1 )
return FALSE ;
do {
...
V_61 -> erf . V_54 . V_11 = F_6 ( & V_52 -> V_11 ) ;
V_61 -> erf . V_54 . type = V_52 -> type ;
V_61 -> erf . V_54 . V_78 = V_52 -> V_78 ;
V_61 -> erf . V_54 . V_16 = F_4 ( V_52 -> V_16 ) ;
V_61 -> erf . V_54 . V_79 = F_4 ( V_52 -> V_79 ) ;
V_61 -> erf . V_54 . V_80 = F_4 ( V_52 -> V_80 ) ;
type = V_52 -> type ;
while ( type & 0x80 ) {
F_13 ( & V_62 , sizeof( V_62 ) , V_20 , V_2 ,
V_3 ) ;
if ( V_53 != NULL )
...
{
V_54 -> V_95 = F_16 ( V_52 -> V_80 ) ;
V_54 -> V_96 = F_18 ( F_16 ( V_52 -> V_80 ) ,
F_16 ( V_52 -> V_16 ) - ( T_5 ) sizeof( * V_52 ) - V_64 ) ;
}
if ( * V_15 > V_23 ) {
* V_2 = V_68 ;
* V_3 = F_14 ( L_2 ,
...
static T_10 F_20 ( T_14 * V_102 , int V_97 , const union V_60 * V_61 , int * V_2 )
{
...
F_21 ( & V_103 [ 0 ] , V_61 -> erf . V_54 . V_11 ) ;
V_103 [ 8 ] = V_61 -> erf . V_54 . type ;
V_103 [ 9 ] = V_61 -> erf . V_54 . V_78 ;
F_22 ( & V_103 [ 10 ] , V_61 -> erf . V_54 . V_16 ) ;
F_22 ( & V_103 [ 12 ] , V_61 -> erf . V_54 . V_79 ) ;
F_22 ( & V_103 [ 14 ] , V_61 -> erf . V_54 . V_80 ) ;
...
case V_33 :
case V_34 :
F_23 ( & V_105 [ 0 ] , V_61 -> erf . V_91 . V_13 ) ;
V_110 += ( int ) sizeof( struct V_106 ) ;
break;
case V_36 :
case V_37 :
case V_38 :
F_22 ( & V_105 [ 0 ] , V_61 -> erf . V_91 . V_14 ) ;
...
if ( ! F_24 ( V_102 , V_103 , V_109 , V_2 ) )
return FALSE ;
V_102 -> V_113 += V_109 ;
V_111 = V_61 -> erf . V_54 . type & 0x80 ;
if( V_111 ) {
do{
F_25 ( V_81 + ( V_4 * 8 ) , V_61 -> erf . V_66 [ V_4 ] . V_81 ) ;
if( V_4 == V_108 - 1 ) V_81 [ V_4 * 8 ] = V_81 [ V_4 * 8 ] & 0x7F ;
V_111 = V_81 [ V_4 * 8 ] & 0x80 ;
V_4 ++ ;
}while( V_111 && V_4 < V_108 );
if ( ! F_24 ( V_102 , V_81 , 8 * V_4 , V_2 ) )
return FALSE ;
V_102 -> V_113 += 8 * V_4 ;
}
if( ! F_24 ( V_102 , V_105 , V_110 , V_2 ) )
return FALSE ;
V_102 -> V_113 += V_110 ;
return TRUE ;
}
...
if( ! F_20 ( V_102 , V_97 , V_61 , V_2 ) ) return FALSE ;
if( ! F_24 ( V_102 , V_114 , V_54 -> V_96 , V_2 ) ) return FALSE ;
V_102 -> V_113 += V_54 -> V_96 ;
while( V_102 -> V_113 < V_116 ) {
if( ! F_24 ( V_102 , L_5 , 1 , V_2 ) ) return FALSE ;
V_102 -> V_113 ++ ;
}
return TRUE ;
}
V_115 . erf . V_54 . V_11 = ( ( T_7 ) V_54 -> V_11 . V_75 << 32 ) + ( ( ( T_7 ) V_54 -> V_11 . V_76 << 32 ) / 1000 / 1000 / 1000 ) ;
V_115 . erf . V_54 . type = F_19 ( V_97 ) ;
...
V_119 = F_27 ( V_114 , V_54 -> V_96 , 0xFFFFFFFF ) ;
...
if( ! F_20 ( V_102 , V_44 , & V_115 , V_2 ) ) return FALSE ;
if( ! F_24 ( V_102 , V_114 , V_54 -> V_96 - V_117 , V_2 ) ) return FALSE ;
V_102 -> V_113 += V_54 -> V_96 - V_117 ;
if( V_118 ) {
if( ! F_24 ( V_102 , & V_119 , 4 , V_2 ) ) return FALSE ;
V_102 -> V_113 += 4 ;
}
if( V_117 == 0 ) {
...
V_131 . V_132 = V_44 ;
V_131 . V_133 = 1000000000 ;
V_131 . V_134 = F_30 ( V_44 ) ;
V_131 . V_135 = 65535 ;
V_131 . V_136 = NULL ;
V_131 . V_137 = 0 ;
V_131 . V_138 = 0x09 ;
...
V_131 . V_145 = NULL ;
for ( V_4 = 0 ; V_4 < 4 ; V_4 ++ ) {
V_131 . V_146 = F_14 ( L_6 , 'A' + V_4 ) ;
V_131 . V_147 = F_14 ( L_7 , V_4 , 'A' + V_4 ) ;
F_31 ( V_1 -> V_148 , V_131 ) ;
}
return 0 ;
}
