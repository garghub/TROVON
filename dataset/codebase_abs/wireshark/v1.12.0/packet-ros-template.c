...
T_14 * V_29 = F_18 ( V_22 , V_51 , 0 , F_19 ( V_20 , V_50 ) , L_5 , V_1 ) ;
T_11 * V_53 = F_11 ( V_29 , V_54 ) ;
F_20 ( V_21 , V_29 , & V_55 ,
L_6 , V_1 ) ;
F_21 ( V_21 , V_51 , V_50 , V_53 ) ;
}
V_50 += F_19 ( V_20 , V_50 ) ;
return V_50 ;
}
...
static int
F_34 ( T_9 * V_20 , T_10 * V_21 , T_11 * V_81 , void * V_82 )
{
int V_50 = 0 ;
int V_83 ;
T_14 * V_29 ;
...
T_19 * V_67 = NULL ;
T_22 V_85 ;
F_35 ( & V_85 , V_86 , TRUE , V_21 ) ;
if ( V_82 == NULL )
return 0 ;
V_85 . V_87 = V_82 ;
V_88 = V_81 ;
V_84 = F_36 ( V_21 ) ;
V_67 = ( T_19 * ) F_37 ( V_84 , V_89 ) ;
if ( V_67 == NULL ) {
V_67 = ( T_19 * ) F_38 ( sizeof( T_19 ) ) ;
V_67 -> V_73 = F_39 ( F_22 , F_23 ) ;
V_67 -> V_74 = F_39 ( F_24 , F_25 ) ;
F_40 ( V_84 , V_89 , V_67 ) ;
V_67 -> V_90 = V_68 ;
V_68 = V_67 ;
}
...
F_41 ( V_21 -> V_33 , V_49 ) ;
while ( F_42 ( V_20 , V_50 ) > 0 ) {
V_83 = V_50 ;
V_50 = F_43 ( FALSE , V_20 , V_50 , & V_85 , V_22 , - 1 ) ;
if( V_50 == V_83 ) {
V_29 = F_18 ( V_22 , V_20 , V_50 , - 1 , L_8 ) ;
if( V_29 ) {
F_44 ( V_21 , V_29 , & V_92 ) ;
V_53 = F_11 ( V_29 , V_54 ) ;
F_21 ( V_21 , V_20 , V_50 , V_53 ) ;
}
break;
}
}
...
static T_24 V_100 [] = {
{ & V_55 , { L_18 , V_101 , V_102 , L_19 , V_103 } } ,
{ & V_92 , { L_20 , V_101 , V_102 , L_8 , V_103 } } ,
} ;
T_25 * V_104 ;
V_89 = F_50 ( V_105 , V_106 , V_107 ) ;
F_51 ( L_21 , F_34 , V_89 ) ;
F_52 ( V_89 , V_94 , F_53 ( V_94 ) ) ;
F_54 ( V_99 , F_53 ( V_99 ) ) ;
V_104 = F_55 ( V_89 ) ;
F_56 ( V_104 , V_100 , F_53 ( V_100 ) ) ;
V_52 = F_57 ( L_1 , L_22 , V_108 , V_96 ) ;
V_6 = F_39 ( V_109 , V_110 ) ;
V_10 = F_39 ( V_109 , V_110 ) ;
V_8 = F_58 ( L_21 ) ;
F_59 ( F_46 ) ;
}
void F_60 ( void ) {
