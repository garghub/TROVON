...
V_4 += 1 ;
F_14 ( V_19 -> V_38 , V_70 , F_13 ( V_61 , & V_69 , L_3 ) ) ;
...
if ( F_15 ( V_3 , V_4 ) > 3 ) {
V_28 = F_16 ( V_3 , V_4 , F_15 ( V_3 , V_4 ) - 3 , F_15 ( V_3 , V_4 ) - 3 ) ;
F_17 ( V_74 , V_28 , V_19 , V_22 ) ;
}
V_4 += F_15 ( V_3 , V_4 ) - 3 ;
break;
case 0x01 :
...
case 0x04 :
V_4 = F_1 ( V_73 , V_22 , V_3 , V_4 ) ;
V_23 = F_8 ( V_22 , V_77 , V_3 , V_4 , F_15 ( V_3 , V_4 ) - 3 , V_41 ) ;
V_24 = F_9 ( V_23 , V_78 ) ;
if ( F_15 ( V_3 , V_4 ) > 3 ) {
V_28 = F_16 ( V_3 , V_4 , F_15 ( V_3 , V_4 ) - 3 , F_15 ( V_3 , V_4 ) - 3 ) ;
F_17 ( V_74 , V_28 , V_19 , V_24 ) ;
}
V_4 += F_15 ( V_3 , V_4 ) - 3 ;
break;
case 0x05 :
...
V_24 = F_9 ( V_23 , V_89 ) ;
F_17 ( V_90 , F_16 ( V_3 , V_4 , 5 , 5 ) , V_19 , V_24 ) ;
V_4 += 5 ;
...
default:
if ( F_15 ( V_3 , V_4 ) > 3 ) {
F_18 ( V_22 , V_19 , & V_93 , V_3 , V_4 , F_15 ( V_3 , V_4 ) - 3 ) ;
V_4 += F_15 ( V_3 , V_4 ) - 3 ;
}
}
} else {
...
case 0x01 :
if ( V_26 > 0 ) {
F_14 ( V_19 -> V_38 , V_70 , L_6 ) ;
F_8 ( V_22 , V_106 , V_3 , V_4 , V_26 , V_41 ) ;
V_4 += V_26 ;
} else {
F_14 ( V_19 -> V_38 , V_70 , L_7 ) ;
}
break;
case 0x02 :
if ( V_26 > 0 ) {
if ( F_19 ( V_3 , V_4 ) > V_26 ) {
F_14 ( V_19 -> V_38 , V_70 , L_6 ) ;
F_8 ( V_22 , V_106 , V_3 , V_4 , V_26 , V_41 ) ;
V_4 += V_26 ;
} else {
T_11 * V_107 ;
F_14 ( V_19 -> V_38 , V_70 , L_8 ) ;
V_107 = F_20 ( F_21 () , T_11 ) ;
V_107 -> V_27 = V_27 ;
V_107 -> V_108 = 0 ;
V_107 -> V_109 = 0 ;
V_107 -> V_110 = 0 ;
V_107 -> V_111 = 0 ;
V_28 = F_16 ( V_3 , V_4 , V_26 , V_26 ) ;
F_22 ( V_112 , V_28 , V_19 , V_2 , V_107 ) ;
V_4 += V_26 ;
}
}
break;
...
V_34 = F_5 ( F_24 ( V_3 , V_4 ) ) ;
V_23 = F_25 ( V_22 , V_156 , V_3 , V_4 , 3 , V_34 ) ;
V_4 += 3 ;
if ( V_33 == V_30 ) {
...
static T_15 V_184 [] = {
{ & V_93 , { L_140 , V_185 , V_186 , L_141 , V_187 } } ,
{ & V_47 , { L_142 , V_185 , V_186 ,
L_143 , V_187 } } ,
{ & V_51 , { L_144 , V_185 , V_188 ,
L_145 , V_187 } } ,
{ & V_49 , { L_146 , V_185 , V_189 ,
L_147 , V_187 } } ,
{ & V_158 , { L_148 , V_185 , V_186 ,
L_149 , V_187 } } ,
{ & V_160 , { L_150 , V_185 , V_190 , L_151 , V_187 } } ,
{ & V_159 , { L_152 , V_185 , V_188 , L_153 , V_187 } } ,
} ;
static T_1 * V_191 [] = {
& V_42 ,
& V_63 ,
...
V_40 = F_27 ( L_154 ,
L_155 , L_156 ) ;
V_192 = F_28 ( L_156 , F_6 , V_40 ) ;
F_29 ( V_40 , V_163 , F_30 ( V_163 ) ) ;
F_31 ( V_191 , F_30 ( V_191 ) ) ;
V_162 = F_32 ( V_40 ) ;
F_33 ( V_162 , V_184 , F_30 ( V_184 ) ) ;
V_161 = F_34 ( V_40 , NULL ) ;
F_35 ( V_161 , L_157 ,
L_158 ,
L_159 ) ;
}
