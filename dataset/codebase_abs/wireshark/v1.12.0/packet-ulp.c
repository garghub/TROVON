...
T_3 = F_42 ( T_2 , T_3 , T_5 , T_7 , T_8 , NULL ) ;
return T_3 ;
}
static int
...
1 , 8192 , FALSE , & V_275 ) ;
if ( V_275 && V_276 ) {
F_257 ( V_276 , V_275 , T_5 -> V_277 , T_7 ) ;
}
return T_3 ;
}
static int
...
1 , 60000 , FALSE , & V_278 ) ;
if ( V_278 && V_279 ) {
F_257 ( V_279 , V_278 , T_5 -> V_277 , T_7 ) ;
}
return T_3 ;
}
static int
...
V_437 , V_438 ,
& V_436 ) ;
F_364 ( T_5 -> V_277 -> V_439 , V_440 , L_4 , F_365 ( V_436 , V_441 , L_5 ) ) ;
return T_3 ;
}
static int
...
T_10 * V_442 ;
T_6 * V_443 ;
V_442 = F_367 ( T_7 , V_444 , T_2 , 0 , - 1 , V_445 ) ;
V_443 = F_368 ( V_442 , V_446 ) ;
F_369 ( T_5 -> V_277 -> V_439 , V_447 , V_448 ) ;
F_370 ( T_5 -> V_277 -> V_439 , V_440 ) ;
#line 39 "../../asn1/ulp/ulp.cnf"
T_3 = F_5 ( T_2 , T_3 , T_5 , V_443 , T_8 ,
V_449 , V_450 ) ;
return T_3 ;
}
static int F_371 ( T_1 * T_2 V_1 , T_11 * V_277 V_1 , T_6 * T_7 V_1 , void * T_12 V_1 ) {
int T_3 = 0 ;
T_4 V_451 ;
F_372 ( & V_451 , V_452 , FALSE , V_277 ) ;
T_3 = F_366 ( T_2 , T_3 , & V_451 , T_7 , V_453 ) ;
T_3 += 7 ; T_3 >>= 3 ;
return T_3 ;
}
static T_13
F_373 ( T_11 * V_277 V_1 , T_1 * T_2 , int T_3 )
{
return F_374 ( T_2 , T_3 ) ;
}
static int
F_375 ( T_1 * T_2 , T_11 * V_277 , T_6 * T_7 , void * T_12 )
{
F_376 ( T_2 , V_277 , T_7 , V_454 , V_455 ,
F_373 , F_371 , T_12 ) ;
return F_377 ( T_2 ) ;
}
void F_378 ( void ) {
...
{ & V_493 ,
{ L_79 , L_80 ,
V_461 , V_462 , F_379 ( V_494 ) , 0 ,
NULL , V_459 } } ,
{ & V_495 ,
{ L_81 , L_82 ,
V_461 , V_462 , F_379 ( V_496 ) , 0 ,
NULL , V_459 } } ,
{ & V_497 ,
{ L_83 , L_84 ,
V_490 , V_458 , NULL , 0 ,
...
{ & V_554 ,
{ L_203 , L_204 ,
V_461 , V_462 , F_379 ( V_555 ) , 0 ,
NULL , V_459 } } ,
{ & V_556 ,
{ L_205 , L_206 ,
V_461 , V_462 , F_379 ( V_557 ) , 0 ,
NULL , V_459 } } ,
{ & V_558 ,
{ L_207 , L_208 ,
V_457 , V_458 , NULL , 0 ,
...
{ & V_569 ,
{ L_228 , L_229 ,
V_461 , V_462 , F_379 ( V_570 ) , 0 ,
NULL , V_459 } } ,
{ & V_571 ,
{ L_230 , L_231 ,
V_461 , V_462 , F_379 ( V_572 ) , 0 ,
L_232 , V_459 } } ,
{ & V_573 ,
{ L_233 , L_234 ,
V_457 , V_458 , NULL , 0 ,
...
{ & V_576 ,
{ L_239 , L_240 ,
V_461 , V_462 , F_379 ( V_577 ) , 0 ,
NULL , V_459 } } ,
{ & V_578 ,
{ L_241 , L_242 ,
V_461 , V_462 , F_379 ( V_579 ) , 0 ,
NULL , V_459 } } ,
{ & V_580 ,
{ L_243 , L_244 ,
V_457 , V_458 , NULL , 0 ,
...
{ & V_634 ,
{ L_351 , L_352 ,
V_461 , V_462 , F_379 ( V_635 ) , 0 ,
NULL , V_459 } } ,
{ & V_636 ,
{ L_353 , L_354 ,
V_461 , V_462 , F_379 ( V_637 ) , 0 ,
NULL , V_459 } } ,
{ & V_638 ,
{ L_355 , L_356 ,
V_457 , V_458 , NULL , 0 ,
...
{ & V_652 ,
{ L_384 , L_385 ,
V_461 , V_462 , F_379 ( V_653 ) , 0 ,
NULL , V_459 } } ,
{ & V_654 ,
{ L_386 , L_387 ,
V_461 , V_462 , F_379 ( V_655 ) , 0 ,
NULL , V_459 } } ,
{ & V_656 ,
{ L_388 , L_389 ,
V_461 , V_462 , NULL , 0 ,
...
{ & V_806 ,
{ L_699 , L_700 ,
V_461 , V_462 , F_379 ( V_807 ) , 0 ,
NULL , V_459 } } ,
{ & V_808 ,
{ L_701 , L_702 ,
V_461 , V_462 , F_379 ( V_809 ) , 0 ,
NULL , V_459 } } ,
{ & V_810 ,
{ L_703 , L_704 ,
V_457 , V_458 , NULL , 0 ,
...
{ & V_846 ,
{ L_771 , L_772 ,
V_461 , V_462 , F_379 ( V_847 ) , 0 ,
NULL , V_459 } } ,
{ & V_848 ,
{ L_773 , L_774 ,
V_461 , V_462 , F_379 ( V_849 ) , 0 ,
NULL , V_459 } } ,
{ & V_850 ,
{ L_775 , L_776 ,
V_461 , V_462 , F_379 ( V_851 ) , 0 ,
L_777 , V_459 } } ,
{ & V_852 ,
{ L_778 , L_779 ,
V_457 , V_458 , NULL , 0 ,
...
T_16 * V_1115 ;
V_444 = F_380 ( V_1116 , V_448 , V_1117 ) ;
F_381 ( L_1284 , F_375 , V_444 ) ;
F_382 ( V_444 , V_456 , F_383 ( V_456 ) ) ;
F_384 ( V_1113 , F_383 ( V_1113 ) ) ;
V_1115 = F_385 ( V_444 , V_1118 ) ;
F_386 ( V_1115 , L_1285 ,
L_1286 ,
L_1287
L_1288 ,
...
V_1118 ( void )
{
static T_17 V_1121 = FALSE ;
static T_18 V_1122 , V_1123 ;
static T_13 V_1124 , V_1125 ;
if ( ! V_1121 ) {
V_1122 = F_388 ( L_1284 ) ;
F_389 ( L_1295 , L_1296 , V_1122 ) ;
V_1123 = F_390 ( F_371 , V_444 ) ;
V_276 = F_388 ( L_129 ) ;
V_279 = F_388 ( L_507 ) ;
V_1121 = TRUE ;
} else {
F_391 ( L_1289 , V_1124 , V_1122 ) ;
F_391 ( L_1292 , V_1125 , V_1123 ) ;
}
V_1124 = V_1119 ;
F_392 ( L_1289 , V_1119 , V_1122 ) ;
V_1125 = V_1120 ;
F_392 ( L_1292 , V_1120 , V_1123 ) ;
}
