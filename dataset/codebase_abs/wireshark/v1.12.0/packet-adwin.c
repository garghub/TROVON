...
void * V_116 = & V_115 ;
F_28 ( V_27 , V_1 , V_114 , 4 ,
L_12 ,
V_110 , V_115 , * ( float * ) V_116 , V_115 ) ;
V_113 = F_21 ( V_27 , V_117 , V_1 , V_114 , 4 , V_38 ) ;
F_29 ( V_113 ) ;
...
F_21 ( V_3 , V_121 , V_1 , 4 , 4 , V_38 ) ;
if ( ! V_112 ) {
F_28 ( V_27 , V_1 , 8 , 350 * 4 , L_11 ) ;
return;
}
...
{
const T_11 * V_101 ;
T_4 V_122 , V_110 , V_102 , V_4 ;
V_102 = F_17 ( V_1 , 0 ) ;
V_101 = F_26 ( V_102 , & V_103 ) ;
if ( V_101 ) {
* V_28 = F_18 ( F_11 () , L_13 , V_101 ) ;
} else {
* V_28 = F_18 ( F_11 () , L_14 , V_102 ) ;
}
V_4 = F_17 ( V_1 , 4 ) ;
F_1 ( V_1 , V_2 , V_3 , V_4 , V_104 ) ;
if ( ! V_3 )
...
F_21 ( V_3 , V_106 , V_1 , 0 , 4 , V_38 ) ;
F_21 ( V_3 , V_39 , V_1 , 4 , 4 , V_38 ) ;
F_21 ( V_3 , V_121 , V_1 , 1408 , 4 , V_38 ) ;
...
F_21 ( V_3 , V_121 , V_1 , 4 , 4 , V_78 ) ;
F_21 ( V_3 , V_43 , V_1 , 8 , 4 , V_42 ) ;
if ( ! V_112 ) {
F_28 ( V_27 , V_1 , 12 , 336 * 4 , L_11 ) ;
return;
}
...
F_20 ( V_3 , V_128 ) ;
F_21 ( V_3 , V_39 , V_1 , 0 , 4 , V_78 ) ;
F_21 ( V_3 , V_129 , V_1 , 4 , 4 , V_78 ) ;
F_21 ( V_3 , V_130 , V_1 , 8 , 4 , V_78 ) ;
F_21 ( V_27 , V_131 , V_1 , 12 , 4 , V_78 ) ;
F_21 ( V_27 , V_132 , V_1 , 16 , 4 , V_78 ) ;
F_21 ( V_27 , V_133 , V_1 , 20 , 4 , V_78 ) ;
V_125 = F_33 ( V_1 , 12 ) ;
V_126 = F_33 ( V_1 , 16 ) ;
switch( V_125 ) {
case 0 : F_28 ( V_3 , V_1 , 12 , 12 ,
L_18 ,
V_126 ) ;
break;
case 1 : V_127 = F_33 ( V_1 , 20 ) ;
F_28 ( V_3 , V_1 , 12 , 12 ,
L_19 ,
V_126 , V_127 ) ;
break;
case 2 : F_28 ( V_3 , V_1 , 12 , 12 ,
L_20 ) ;
break;
default:
F_28 ( V_3 , V_1 , 12 , 12 ,
...
static int
F_35 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_134 , void * T_13 V_135 )
{
T_9 * V_136 , * V_137 ;
T_3 * V_3 , * V_27 ;
T_11 * V_28 ;
...
|| V_138 == V_147 ) )
return ( 0 ) ;
F_37 ( V_2 -> V_148 , V_149 , L_22 ) ;
F_38 ( V_2 -> V_148 , V_150 ) ;
if ( V_134 ) {
V_136 = F_21 ( V_134 , V_9 , V_1 , 0 , - 1 , V_42 ) ;
V_3 = F_39 ( V_136 , V_151 ) ;
V_137 = F_21 ( V_3 , V_9 , V_1 , 0 , - 1 , V_42 ) ;
V_27 = F_39 ( V_137 , V_152 ) ;
F_40 ( V_137 , L_23 ) ;
} else {
V_3 = NULL ;
V_27 = NULL ;
...
break;
case V_144 :
F_30 ( V_1 , V_2 , V_3 , V_27 ) ;
V_28 = F_41 ( F_11 () , L_25 ) ;
break;
case V_145 :
F_31 ( V_1 , V_2 , V_3 , V_27 , & V_28 ) ;
break;
case V_146 :
...
break;
default:
V_28 = F_18 ( F_11 () , L_28 , V_138 ) ;
break;
}
F_42 ( V_2 -> V_148 , V_150 , V_28 ) ;
return ( F_36 ( V_1 ) ) ;
}
void
F_43 ( void )
{
static int V_153 = FALSE ;
static T_14 V_154 ;
...
F_45 ( L_29 , V_155 , V_154 ) ;
}
V_155 = V_156 ;
F_46 ( L_29 , V_156 , V_154 ) ;
}
void
F_47 ( void )
{
...
{ & V_170 ,
{ L_91 , L_92 ,
V_162 , V_161 | V_166 , & V_171 , 0x0 ,
NULL , V_160 }
} ,
{ & V_46 ,
{ L_93 , L_94 ,
V_158 , V_161 | V_166 , & V_172 , 0x0 ,
NULL , V_160 }
} ,
{ & V_40 ,
{ L_95 , L_96 ,
...
V_9 = F_48 ( L_140 ,
L_22 , L_141 ) ;
F_49 ( V_9 , V_157 , F_50 ( V_157 ) ) ;
F_51 ( V_177 , F_50 ( V_177 ) ) ;
V_178 = F_52 ( V_9 , F_43 ) ;
F_53 ( V_178 , L_29 , L_142 ,
L_143
L_144 ,
10 , & V_156 ) ;
F_54 ( V_178 , L_145 ,
