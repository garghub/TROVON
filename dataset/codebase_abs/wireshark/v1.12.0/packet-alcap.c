...
V_3 = F_10 ( V_7 , V_181 ) ;
if ( V_180 -> V_182 ) {
V_7 = F_50 ( V_3 , V_183 , V_2 , 0 , 0 , V_180 -> V_182 ) ;
F_51 ( V_7 ) ;
}
if ( V_180 -> V_60 ) {
V_7 = F_50 ( V_3 , V_184 , V_2 , 0 , 0 , V_180 -> V_60 ) ;
F_51 ( V_7 ) ;
}
if ( V_180 -> V_29 ) {
V_7 = F_50 ( V_3 , V_185 , V_2 , 0 , 0 , V_180 -> V_29 ) ;
F_51 ( V_7 ) ;
}
if ( V_180 -> V_30 ) {
V_7 = F_50 ( V_3 , V_186 , V_2 , 0 , 0 , V_180 -> V_30 ) ;
F_51 ( V_7 ) ;
}
if ( V_180 -> V_62 ) {
V_7 = F_50 ( V_3 , V_187 , V_2 , 0 , 0 , V_180 -> V_62 ) ;
F_51 ( V_7 ) ;
}
if ( V_180 -> V_42 ) {
V_7 = F_52 ( V_3 , V_188 , V_2 , 0 , 0 , V_180 -> V_42 ) ;
F_51 ( V_7 ) ;
}
if ( V_180 -> V_40 ) {
V_7 = F_52 ( V_3 , V_189 , V_2 , 0 , 0 , V_180 -> V_40 ) ;
F_51 ( V_7 ) ;
}
if( V_180 -> V_14 ) {
V_7 = F_50 ( V_3 , V_190 , V_2 , 0 , 0 , V_180 -> V_14 ) ;
F_51 ( V_7 ) ;
...
T_7 * V_194 = F_31 ( V_3 , V_2 , 0 , 0 , L_11 ) ;
T_4 * V_195 = F_10 ( V_194 , V_181 ) ;
do {
V_194 = F_50 ( V_195 , V_196 , V_2 , 0 , 0 , V_193 -> V_197 ) ;
F_53 ( V_194 , L_12 ,
F_54 ( V_193 -> V_198 , & V_199 , L_13 ) ,
V_193 -> V_197 ) ;
F_51 ( V_194 ) ;
} while ( ( V_193 = V_193 -> V_200 ) );
}
}
extern void F_55 ( T_4 * V_3 , T_3 * V_2 , T_2 * V_1 , const T_1 * V_201 ) {
T_10 * V_180 = ( T_10 * ) F_56 ( V_202 , V_201 , 0 ) ;
if ( V_180 ) {
...
T_6 -> V_198 = F_6 ( V_2 , 4 ) ;
V_198 = F_61 ( T_6 -> V_198 ) ;
F_3 ( V_1 , V_7 , & V_213 ) ;
F_60 ( V_1 -> V_205 , V_214 , V_198 -> V_215 ) ;
...
F_63 ( V_1 -> V_205 , V_214 , L_14 , V_227 ) ;
V_5 -= 3 + V_224 ;
V_4 += 3 + V_224 ;
}
if ( V_233 ) {
...
switch ( T_6 -> V_198 ) {
case 5 :
if( ! ( V_180 = ( T_10 * ) F_64 ( V_234 , T_6 -> V_60 ) ) ) {
V_180 = F_15 ( F_65 () , T_10 ) ;
V_180 -> V_182 = 0 ;
V_180 -> V_60 = T_6 -> V_60 ;
V_180 -> V_29 = T_6 -> V_29 ;
V_180 -> V_30 = T_6 -> V_30 ;
...
V_180 -> V_40 = NULL ;
if ( T_6 -> V_42 ) {
T_1 * V_201 = F_8 ( F_65 () , L_15 , T_6 -> V_42 , V_180 -> V_62 ) ;
F_66 ( V_201 ) ;
V_180 -> V_42 = F_67 ( F_65 () , T_6 -> V_42 ) ;
if ( ! F_56 ( V_202 , V_201 , 0 ) ) {
F_68 ( V_202 , V_201 , V_180 , 0 ) ;
}
}
if ( T_6 -> V_40 ) {
T_1 * V_201 = F_8 ( F_65 () , L_15 , T_6 -> V_40 , V_180 -> V_62 ) ;
F_66 ( V_201 ) ;
V_180 -> V_40 = F_67 ( F_65 () , T_6 -> V_40 ) ;
if ( ! F_56 ( V_202 , V_201 , 0 ) ) {
F_68 ( V_202 , V_201 , V_180 , 0 ) ;
}
}
V_180 -> V_192 = NULL ;
V_180 -> V_14 = 0 ;
F_69 ( V_234 , V_180 -> V_60 , V_180 ) ;
}
break;
case 4 :
if( ( V_180 = ( T_10 * ) F_64 ( V_234 , T_6 -> V_182 ) ) ) {
V_180 -> V_182 = T_6 -> V_60 ;
F_69 ( V_235 , V_180 -> V_182 , V_180 ) ;
}
break;
case 6 :
case 12 :
...
case 14 :
if( ( V_180 = ( T_10 * ) F_64 ( V_234 , T_6 -> V_182 ) )
|| ( V_180 = ( T_10 * ) F_64 ( V_235 , T_6 -> V_182 ) ) ) {
if( T_6 -> V_14 )
V_180 -> V_14 = T_6 -> V_14 ;
}
break;
case 7 :
V_180 = ( T_10 * ) F_64 ( V_234 , T_6 -> V_182 ) ;
if( V_180 ) {
V_180 -> V_14 = T_6 -> V_14 ;
} else if ( ( V_180 = ( T_10 * ) F_64 ( V_235 , T_6 -> V_182 ) ) ) {
V_180 -> V_14 = T_6 -> V_14 ;
}
break;
default:
...
{ & V_218 ,
{ L_23 , L_24 ,
V_245 , V_246 , F_71 ( V_250 ) , 0x40 ,
L_25 , V_244 }
} ,
{ & V_219 ,
{ L_26 , L_27 ,
V_245 , V_246 , F_71 ( V_251 ) , 0x30 ,
L_28 , V_244 }
} ,
{ & V_220 ,
{ L_29 , L_30 ,
V_245 , V_246 , F_71 ( V_250 ) , 0x04 ,
L_25 , V_244 }
} ,
{ & V_221 ,
{ L_31 , L_32 ,
V_245 , V_246 , F_71 ( V_251 ) , 0x03 ,
L_28 , V_244 }
} ,
{ & V_8 ,
{ L_33 , L_34 ,
...
{ & V_15 ,
{ L_41 , L_42 ,
V_245 , V_246 , F_71 ( V_253 ) , 0x03 ,
NULL , V_244 }
} ,
{ & V_17 ,
{ L_43 , L_44 ,
V_245 , V_246 , F_71 ( V_19 ) , 0x7f ,
NULL , V_244 }
} ,
{ & V_20 ,
{ L_45 , L_44 ,
...
{ & V_67 ,
{ L_94 , L_95 ,
V_245 , V_246 , F_71 ( V_256 ) , 0x80 ,
NULL , V_244 }
} ,
{ & V_68 ,
{ L_96 , L_97 ,
V_245 , V_246 , F_71 ( V_256 ) , 0x40 ,
NULL , V_244 }
} ,
{ & V_69 ,
{ L_98 , L_99 ,
V_245 , V_246 , F_71 ( V_256 ) , 0x20 ,
NULL , V_244 }
} ,
{ & V_70 ,
{ L_100 , L_101 ,
V_245 , V_246 , F_71 ( V_256 ) , 0x10 ,
NULL , V_244 }
} ,
{ & V_71 ,
{ L_102 , L_103 ,
V_245 , V_246 , F_71 ( V_256 ) , 0x08 ,
NULL , V_244 }
} ,
{ & V_72 ,
{ L_104 , L_105 ,
V_245 , V_246 , F_71 ( V_256 ) , 0x04 ,
L_106 , V_244 }
} ,
{ & V_73 ,
{ L_107 , L_108 ,
V_245 , V_246 , F_71 ( V_256 ) , 0x02 ,
L_109 , V_244 }
} ,
{ & V_74 ,
{ L_110 , L_111 ,
V_245 , V_246 , F_71 ( V_257 ) , 0x01 ,
NULL , V_244 }
} ,
{ & V_75 ,
{ L_112 , L_113 ,
...
{ & V_127 ,
{ L_186 , L_187 ,
V_245 , V_246 , F_71 ( V_259 ) , 0 ,
NULL , V_244 }
} ,
{ & V_128 ,
{ L_188 , L_189 ,
V_245 , V_246 , F_71 ( V_260 ) , 0x07 ,
NULL , V_244 }
} ,
{ & V_130 ,
{ L_190 , L_191 ,
...
static T_18 V_264 [] = {
{ & V_13 , { L_263 , V_265 , V_266 , L_264 , V_267 } } ,
{ & V_10 , { L_265 , V_268 , V_266 , L_266 , V_267 } } ,
{ & V_191 , { L_267 , V_269 , V_266 , L_268 , V_267 } } ,
{ & V_18 , { L_269 , V_269 , V_266 , L_270 , V_267 } } ,
{ & V_213 , { L_271 , V_269 , V_270 , L_272 , V_267 } } ,
} ;
V_209 = F_72 ( V_271 , V_207 , L_273 ) ;
F_73 ( L_273 , F_57 , V_209 ) ;
F_74 ( V_209 , V_241 , F_75 ( V_241 ) ) ;
F_76 ( V_229 , F_75 ( V_229 ) ) ;
V_240 = F_77 ( V_209 ) ;
F_78 ( V_240 , V_264 , F_75 ( V_264 ) ) ;
V_239 = F_79 ( V_209 , NULL ) ;
F_80 ( V_239 , L_274 ,
L_275 ,
L_276 ,
& V_233 ) ;
V_235 = F_81 ( F_82 () , F_65 () ) ;
V_234 = F_81 ( F_82 () , F_65 () ) ;
V_202 = F_81 ( F_82 () , F_65 () ) ;
}
void
F_83 ( void )
{
T_19 V_272 = F_84 ( L_273 ) ;
F_85 ( L_277 , V_273 , V_272 ) ;
}
