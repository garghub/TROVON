...
F_32 ( ( V_18 ) ? V_18 : V_34 , V_17 , T_7 -> V_27 , T_9 , T_7 -> V_2 ) ;
if ( ! V_18 ) {
F_33 ( T_7 -> V_27 , T_9 , & V_35 , L_6 , V_19 ) ;
}
return T_5 ;
}
static int
...
if ( ! V_36 ) {
V_36 = F_17 ( T_4 , ( T_7 -> V_32 == V_33 ) ? T_5 >> 3 : T_5 , 0 , 0 ) ;
}
F_32 ( ( V_39 ) ? V_39 : V_34 , V_36 , T_7 -> V_27 , T_9 , T_7 -> V_2 ) ;
if ( ! V_39 ) {
F_33 ( T_7 -> V_27 , T_9 , & V_35 , L_6 , V_19 ) ;
}
}
...
F_31 ( T_7 -> V_2 -> V_30 , V_19 , T_7 -> V_2 -> V_31 ) ;
if ( ! V_44 ) {
V_44 = F_17 ( T_4 , ( T_7 -> V_32 == V_33 ) ? T_5 >> 3 : T_5 , 0 , 0 ) ;
}
F_32 ( ( V_45 ) ? V_45 : V_34 , V_44 , T_7 -> V_27 , T_9 , T_7 -> V_2 ) ;
if ( ! V_45 ) {
F_33 ( T_7 -> V_27 , T_9 , & V_35 , L_6 , V_19 ) ;
}
return T_5 ;
...
F_40 ( V_51 , F_41 ( V_50 , F_42 ( V_52 ) , L_1 ) , 64 ) ;
return T_5 ;
}
static int
...
F_40 ( V_51 , F_41 ( V_50 , F_42 ( V_53 ) , L_1 ) , 64 ) ;
return T_5 ;
}
static int
...
F_40 ( V_51 , F_41 ( V_50 , F_42 ( V_54 ) , L_1 ) , 64 ) ;
return T_5 ;
}
static int
...
F_40 ( V_51 , F_41 ( V_50 , F_42 ( V_55 ) , L_1 ) , 64 ) ;
return T_5 ;
}
static int
...
int T_5 = 0 ;
T_6 V_63 ;
F_51 ( & V_63 , V_64 , TRUE , V_27 ) ;
T_5 = F_48 ( FALSE , T_4 , T_5 , & V_63 , T_9 , V_65 ) ;
return T_5 ;
}
static int F_52 ( T_3 * T_4 , T_14 * V_27 , T_8 * T_9 , void * T_15 ) {
if ( T_15 == NULL )
return 0 ;
V_60 = F_53 ( T_15 ) ;
F_54 ( V_60 ) ;
...
{ & V_81 ,
{ L_28 , L_29 ,
V_67 , V_68 , F_42 ( V_82 ) , 0 ,
NULL , V_70 } } ,
{ & V_83 ,
{ L_30 , L_31 ,
V_67 , V_68 , F_42 ( V_84 ) , 0 ,
NULL , V_70 } } ,
{ & V_85 ,
{ L_32 , L_33 ,
V_72 , V_68 , NULL , 0 ,
...
{ & V_95 ,
{ L_51 , L_52 ,
V_67 , V_68 , F_42 ( V_96 ) , 0 ,
NULL , V_70 } } ,
{ & V_97 ,
{ L_53 , L_54 ,
V_72 , V_68 , F_42 ( V_52 ) , 0 ,
L_55 , V_70 } } ,
{ & V_98 ,
{ L_20 , L_56 ,
V_72 , V_68 , F_42 ( V_53 ) , 0 ,
L_57 , V_70 } } ,
{ & V_99 ,
{ L_22 , L_58 ,
V_72 , V_68 , F_42 ( V_54 ) , 0 ,
L_59 , V_70 } } ,
{ & V_100 ,
{ L_24 , L_60 ,
V_72 , V_68 , F_42 ( V_55 ) , 0 ,
L_61 , V_70 } } ,
{ & V_101 ,
{ L_32 , L_33 ,
V_72 , V_68 , NULL , 0 ,
...
T_18 * V_108 ;
V_109 = F_56 ( V_110 , V_111 , V_112 ) ;
F_57 ( V_109 ) ;
F_58 ( V_109 , V_66 , F_59 ( V_66 ) ) ;
F_60 ( V_103 , F_59 ( V_103 ) ) ;
V_108 = F_61 ( V_109 ) ;
F_62 ( V_108 , V_104 , F_59 ( V_104 ) ) ;
F_63 ( V_112 , F_52 , V_109 ) ;
}
void F_64 ( void ) {
V_34 = F_65 ( L_68 ) ;
}
