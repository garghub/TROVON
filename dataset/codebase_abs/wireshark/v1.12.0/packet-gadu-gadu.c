...
V_39 = F_63 ( V_26 , V_22 , V_27 , 5 , L_31 , V_3 ) ;
V_101 = F_64 ( V_39 , V_102 ) ;
...
static int
F_67 ( T_5 * V_22 , T_1 * V_2 , T_8 * V_26 , int V_27 )
{
...
T_11 * V_39 ;
char * V_3 ;
V_39 = F_63 ( V_26 , V_22 , V_27 , 0 , L_35 ) ;
V_101 = F_64 ( V_39 , V_102 ) ;
...
F_63 ( V_26 , V_22 , V_27 , V_104 , L_39 ) ;
F_74 ( V_2 , V_105 , L_40 ) ;
F_75 ( V_106 , V_105 , V_2 , V_26 , NULL ) ;
} else
F_63 ( V_26 , V_22 , V_27 , V_104 , L_41 ) ;
V_27 += V_104 ;
return V_27 ;
}
static int
...
type = F_21 ( V_22 , V_27 ) ;
F_14 ( V_26 , & V_107 , V_22 , V_27 , 1 , V_42 ) ;
V_27 += 1 ;
V_39 = F_27 ( V_26 , & V_108 , V_22 , 0 , 0 , V_109 ) ;
F_25 ( V_39 ) ;
switch ( type ) {
case V_110 :
...
F_14 ( V_26 , & V_107 , V_22 , V_27 , 1 , V_42 ) ;
V_27 += 1 ;
F_14 ( V_26 , & V_112 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
V_111 = F_21 ( V_22 , V_27 ) ;
...
type = F_21 ( V_22 , V_27 ) ;
F_14 ( V_26 , & V_113 , V_22 , V_27 , 1 , V_42 ) ;
V_27 += 1 ;
switch ( type ) {
case V_114 :
V_27 = F_72 ( V_22 , V_2 , V_26 , V_27 ) ;
...
F_14 ( V_26 , & V_115 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
return V_27 ;
}
static int
...
F_14 ( V_26 , & V_115 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
F_14 ( V_26 , & V_116 , V_22 , V_27 , 8 , V_30 ) ;
V_27 += 8 ;
return V_27 ;
}
static int
...
F_14 ( V_26 , & V_116 , V_22 , V_27 , 8 , V_30 ) ;
V_27 += 8 ;
F_14 ( V_26 , & V_117 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
F_14 ( V_26 , & V_118 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
F_14 ( V_26 , & V_115 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
F_14 ( V_26 , & V_119 , V_22 , V_27 , 255 , V_61 | V_30 ) ;
V_27 += 255 ;
return V_27 ;
}
static int
...
F_14 ( V_26 , & V_121 , V_22 , V_27 , 1 , V_42 ) ;
V_27 += 1 ;
F_14 ( V_26 , & V_122 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
while ( ( V_120 = F_11 ( V_22 , V_27 , - 1 , '\0' ) ) > 0 ) {
F_14 ( V_26 , & V_123 , V_22 , V_27 , ( V_120 - V_27 ) + 1 , V_30 | V_29 ) ;
V_27 = V_120 + 1 ;
}
return V_27 ;
}
...
F_14 ( V_26 , & V_124 , V_22 , V_27 , 1 , V_42 ) ;
V_27 += 1 ;
F_14 ( V_26 , & V_125 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
while ( ( V_120 = F_11 ( V_22 , V_27 , - 1 , '\0' ) ) > 0 ) {
F_14 ( V_26 , & V_126 , V_22 , V_27 , ( V_120 - V_27 ) + 1 , V_30 | V_29 ) ;
V_27 = V_120 + 1 ;
}
return V_27 ;
}
...
V_127 = F_88 ( V_22 , V_27 ) ;
V_128 = F_75 ( V_106 , V_127 , V_2 , V_26 , NULL ) ;
return V_27 + V_128 ;
}
static int
...
V_129 = F_64 ( V_39 , V_131 ) ;
}
V_130 = F_16 ( V_22 , V_27 ) ;
F_14 ( V_129 , ( V_2 -> V_132 == V_133 ) ? & V_134 : & V_135 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
F_14 ( V_129 , & V_136 , V_22 , V_27 , 4 , V_42 ) ;
V_27 += 4 ;
if ( V_2 -> V_132 == V_133 ) {
switch ( V_130 ) {
case V_137 :
V_27 = F_17 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_138 :
V_27 = F_19 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_139 :
V_27 = F_32 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_140 :
V_27 = F_34 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_141 :
V_27 = F_33 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_142 :
V_27 = F_35 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_143 :
V_27 = F_36 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_144 :
V_27 = F_39 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_145 :
V_27 = F_41 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_146 :
V_27 = F_45 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_147 :
V_27 = F_47 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_148 :
V_27 = F_49 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_149 :
V_27 = F_50 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_150 :
V_27 = F_51 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_151 :
V_27 = F_52 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_152 :
V_27 = F_82 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_153 :
V_27 = F_71 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_154 :
V_27 = F_78 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_155 :
V_27 = F_79 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_156 :
V_27 = F_80 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_157 :
V_27 = F_86 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_158 :
V_27 = F_87 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_159 :
case V_160 :
case V_161 :
...
default:
{
const char * V_178 = F_91 ( V_130 , V_179 ) ;
if ( V_178 )
F_18 ( V_2 -> V_34 , V_35 , V_178 ) ;
else
F_92 ( V_2 -> V_34 , V_35 , L_54 , V_130 ) ;
break;
}
}
} else {
switch ( V_130 ) {
case V_180 :
V_27 = F_26 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_181 :
V_27 = F_30 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_182 :
V_27 = F_31 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_183 :
V_27 = F_55 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_184 :
V_27 = F_65 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_185 :
V_27 = F_66 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_186 :
V_27 = F_67 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_187 :
V_27 = F_56 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_188 :
V_27 = F_58 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_189 :
V_27 = F_59 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_190 :
V_27 = F_60 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_161 :
V_27 = F_70 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_144 :
V_27 = F_39 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_191 :
V_27 = F_43 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_192 :
V_27 = F_46 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_193 :
V_27 = F_48 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_194 :
V_27 = F_53 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_195 :
V_27 = F_54 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_196 :
V_27 = F_81 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_169 :
V_27 = F_83 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_197 :
V_27 = F_84 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_198 :
V_27 = F_76 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_199 :
V_27 = F_77 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_200 :
V_27 = F_85 ( V_22 , V_2 , V_129 , V_27 ) ;
break;
case V_160 :
case V_201 :
case V_202 :
...
default:
{
const char * V_178 = F_91 ( V_130 , V_210 ) ;
if ( V_178 )
F_18 ( V_2 -> V_34 , V_35 , V_178 ) ;
else
F_92 ( V_2 -> V_34 , V_35 , L_55 , V_130 ) ;
break;
}
}
}
if ( F_62 ( V_22 , V_27 ) > 0 ) {
F_14 ( V_129 , & V_56 , V_22 , V_27 , - 1 , V_30 ) ;
}
return F_12 ( V_22 ) ;
}
static T_14
F_93 ( T_1 * V_2 V_33 , T_5 * V_22 , int V_27 )
{
T_2 V_28 = F_16 ( V_22 , V_27 + 4 ) ;
return V_28 + 8 ;
}
static int
F_94 ( T_5 * V_22 , T_1 * V_2 , T_8 * V_26 , void * T_13 )
{
...
return 0 ;
F_18 ( V_2 -> V_34 , V_213 , L_56 ) ;
F_90 ( V_2 -> V_34 , V_35 ) ;
F_95 ( V_22 , V_2 , V_26 , V_214 , 8 , F_93 , F_89 , T_13 ) ;
return F_12 ( V_22 ) ;
}
void
F_96 ( void )
...
T_15 * V_216 ;
int V_217 ;
V_217 = F_98 ( L_57 , L_56 , L_58 ) ;
V_6 = F_99 ( V_217 ) ;
V_216 = F_100 ( V_217 , NULL ) ;
F_101 ( V_216 , L_59 ,
L_60 ,
L_61
L_62 ,
& V_214 ) ;
F_102 ( V_217 , V_25 , F_103 ( V_25 ) ) ;
F_104 ( V_215 , F_103 ( V_215 ) ) ;
V_218 = F_105 ( F_94 , V_217 ) ;
}
void
F_106 ( void )
{
F_107 ( L_63 , V_219 , V_218 ) ;
V_106 = F_108 ( L_64 ) ;
}
