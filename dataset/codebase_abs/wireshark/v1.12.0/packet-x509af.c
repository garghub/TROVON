...
const char * V_2 ;
T_5 = F_5 ( T_2 , T_7 , T_9 , T_4 , T_5 , V_3 , & T_7 -> V_4 . V_5 ) ;
V_6 = T_7 -> V_4 . V_5 ;
if( T_7 -> V_4 . V_5 ) {
V_2 = F_6 ( T_7 -> V_4 . V_5 ) ;
F_7 ( T_9 , L_1 , V_2 ? V_2 : T_7 -> V_4 . V_5 ) ;
}
return T_5 ;
}
static int
...
T_5 = F_9 ( T_7 -> V_4 . V_5 , T_4 , T_5 , T_7 -> V_7 , T_9 , NULL ) ;
return T_5 ;
}
int
...
NULL ) ;
V_14 = F_20 () ;
F_7 ( F_21 ( T_9 ) , L_1 , V_14 ? V_14 : L_2 ) ;
return T_5 ;
}
static int
...
const char * V_2 ;
T_5 = F_5 ( T_2 , T_7 , T_9 , T_4 , T_5 , V_19 , & T_7 -> V_4 . V_5 ) ;
if( T_7 -> V_4 . V_5 ) {
V_2 = F_6 ( T_7 -> V_4 . V_5 ) ;
F_7 ( T_9 , L_1 , V_2 ? V_2 : T_7 -> V_4 . V_5 ) ;
}
...
T_5 = F_27 ( T_2 , T_7 , T_9 , T_4 , T_5 , T_10 , NULL ) ;
return T_5 ;
}
static int
...
T_12 V_23 ;
T_13 V_24 ;
T_5 = F_29 ( T_7 -> V_7 , T_9 , T_4 , T_5 , & V_20 , & V_21 , & V_23 ) ;
T_5 = F_30 ( T_7 -> V_7 , T_9 , T_4 , T_5 , & V_24 , & V_22 ) ;
T_5 = F_9 ( T_7 -> V_4 . V_5 , T_4 , T_5 , T_7 -> V_7 , T_9 , NULL ) ;
return T_5 ;
}
int
...
void F_61 ( T_3 * T_4 V_1 , T_14 * V_7 V_1 , T_8 * T_9 V_1 ) {
T_6 V_79 ;
F_62 ( & V_79 , V_80 , TRUE , V_7 ) ;
F_35 ( FALSE , T_4 , 0 , & V_79 , T_9 , V_81 ) ;
}
static void F_63 ( T_3 * T_4 V_1 , T_14 * V_7 V_1 , T_8 * T_9 V_1 ) {
T_6 V_79 ;
F_62 ( & V_79 , V_80 , TRUE , V_7 ) ;
F_40 ( FALSE , T_4 , 0 , & V_79 , T_9 , V_82 ) ;
}
static void F_64 ( T_3 * T_4 V_1 , T_14 * V_7 V_1 , T_8 * T_9 V_1 ) {
T_6 V_79 ;
F_62 ( & V_79 , V_80 , TRUE , V_7 ) ;
F_46 ( FALSE , T_4 , 0 , & V_79 , T_9 , V_83 ) ;
}
static void F_65 ( T_3 * T_4 V_1 , T_14 * V_7 V_1 , T_8 * T_9 V_1 ) {
T_6 V_79 ;
F_62 ( & V_79 , V_80 , TRUE , V_7 ) ;
F_52 ( FALSE , T_4 , 0 , & V_79 , T_9 , V_84 ) ;
}
static void F_66 ( T_3 * T_4 V_1 , T_14 * V_7 V_1 , T_8 * T_9 V_1 ) {
T_6 V_79 ;
F_62 ( & V_79 , V_80 , TRUE , V_7 ) ;
F_60 ( FALSE , T_4 , 0 , & V_79 , T_9 , V_85 ) ;
}
const char * F_67 ( void ) {
return V_6 ;
}
static int
F_68 ( T_3 * T_4 , T_14 * V_7 , T_8 * V_86 , void * T_15 V_1 )
{
T_16 * V_87 = NULL ;
T_8 * T_9 = NULL ;
T_6 V_79 ;
F_62 ( & V_79 , V_80 , TRUE , V_7 ) ;
F_69 ( V_7 -> V_88 , V_89 , L_3 ) ;
F_69 ( V_7 -> V_88 , V_90 , L_4 ) ;
if( V_86 ) {
V_87 = F_70 ( V_86 , T_4 , 0 , - 1 , L_4 ) ;
T_9 = F_71 ( V_87 , V_91 ) ;
}
