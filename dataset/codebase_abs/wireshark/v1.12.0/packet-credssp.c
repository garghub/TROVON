...
static void F_20 ( T_3 * T_4 V_1 , T_12 * V_5 V_1 , T_8 * T_9 V_1 ) {
T_6 V_29 ;
F_21 ( & V_29 , V_30 , TRUE , V_5 ) ;
F_19 ( FALSE , T_4 , 0 , & V_29 , T_9 , V_31 ) ;
}
static void
F_22 ( T_3 * T_4 , T_12 * V_5 , T_8 * V_32 )
{
T_13 * V_33 = NULL ;
T_8 * T_9 = NULL ;
if( V_32 ) {
...
static T_1
F_27 ( T_3 * T_4 , T_12 * V_5 , T_8 * V_32 , void * T_14 V_1 )
{
T_6 V_29 ;
int T_5 = 0 ;
T_15 V_40 ;
...
if( ( V_40 == V_44 ) && ( V_42 == V_45 ) && ( V_41 == TRUE ) ) {
T_5 = F_30 ( T_4 , T_5 , NULL , NULL ) ;
T_5 = F_29 ( T_4 , T_5 , & V_40 , & V_41 , & V_42 ) ;
if( ( V_40 == V_46 ) && ( V_42 == 0 ) ) {
T_5 = F_30 ( T_4 , T_5 , NULL , NULL ) ;
T_5 = F_29 ( T_4 , T_5 , & V_40 , & V_41 , & V_42 ) ;
if( ( V_40 == V_44 ) && ( V_42 == V_47 ) ) {
T_5 = F_30 ( T_4 , T_5 , & V_43 , NULL ) ;
if( ( V_43 == 1 ) && ( F_31 ( T_4 , T_5 ) == 2 ) ) {
if ( F_32 ( V_48 ) ) {
T_18 * V_49 ;
T_19 V_50 ;
V_50 = V_51 + V_52 + V_53 +
V_54 + V_55 ;
V_49 = F_33 ( V_5 , L_2 , - 1 , & V_50 , 1 ) ;
V_49 -> V_56 = V_56 ( T_4 ) ;
V_49 -> V_57 = V_57 ( T_4 ) ;
V_49 -> V_58 = T_4 ;
F_34 ( V_48 , V_5 , V_49 ) ;
...
V_34 = F_36 ( V_88 , V_89 , V_90 ) ;
F_37 ( L_2 , F_22 , V_34 ) ;
F_38 ( V_34 , V_59 , F_39 ( V_59 ) ) ;
F_40 ( V_87 , F_39 ( V_87 ) ) ;
F_41 ( L_2 , & V_4 ) ;
}
void F_42 ( void ) {
