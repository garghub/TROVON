...
{
return F_55 ( V_101 , V_6 , F_47 ) ;
}
void *
F_57 ( const void * V_101 , T_3 V_6 )
{
...
{
return memcpy ( F_48 ( V_6 ) , V_101 , V_6 ) ;
}
static T_5 *
F_59 ( const T_5 * V_11 , T_4 V_12 , void * F_52 ( T_3 ) )
{
T_4 V_103 ;
T_8 V_6 ;
T_5 * V_102 ;
...
{
return F_59 ( V_11 , V_12 , F_47 ) ;
}
static T_5 *
F_63 ( const T_5 * V_11 , T_4 V_12 )
{
return F_59 ( V_11 , V_12 , F_48 ) ;
}
T_5 *
F_64 ( const T_5 * V_11 , ... )
{
...
T_5 * *
F_66 ( const T_5 * string , const T_5 * V_105 , int V_106 )
{
T_5 * V_107 ;
T_5 * V_108 ;
T_13 V_109 ;
...
static T_8
F_73 ( T_8 V_123 , T_8 V_124 , T_8 V_125 )
{
...
V_129 = F_73 ( V_128 -> V_131 , V_124 , V_128 -> V_125 ) ;
...
T_16 *
F_77 ( const T_5 * V_133 )
{
T_16 * V_128 ;
V_128 = F_75 ( F_73 ( 0 , V_133 ? strlen ( V_133 ) + 1 : 0 , 0 ) , 0 ) ;
if ( V_133 ) {
T_8 V_134 ;
V_134 = F_9 ( V_128 -> V_132 , V_133 , V_128 -> V_131 ) ;
V_128 -> V_6 = F_78 ( V_134 , V_128 -> V_131 - 1 ) ;
}
return V_128 ;
}
T_16 *
F_79 ( T_16 * V_128 , const T_5 * V_132 )
{
T_8 V_135 , V_134 ;
if ( ! V_128 || ! V_132 || V_132 [ 0 ] == '\0' ) {
return V_128 ;
}
V_135 = V_128 -> V_131 - V_128 -> V_6 ;
V_134 = F_9 ( & V_128 -> V_132 [ V_128 -> V_6 ] , V_132 , V_135 ) ;
if ( V_134 < V_135 ) {
V_128 -> V_6 += V_134 ;
} else {
V_128 -> V_132 [ V_128 -> V_6 ] = '\0' ;
F_74 ( V_128 , V_128 -> V_6 + V_134 + 1 ) ;
V_135 = V_128 -> V_131 - V_128 -> V_6 ;
V_134 = F_9 ( & V_128 -> V_132 [ V_128 -> V_6 ] , V_132 , V_135 ) ;
V_128 -> V_6 += F_78 ( V_135 - 1 , V_134 ) ;
}
return V_128 ;
}
static void
F_80 ( T_16 * V_128 , const T_5 * V_136 , T_4 V_12 )
{
T_4 V_103 ;
T_8 V_135 , V_134 ;
F_60 ( V_103 , V_12 ) ;
V_135 = V_128 -> V_131 - V_128 -> V_6 ;
V_134 = F_7 ( & V_128 -> V_132 [ V_128 -> V_6 ] , ( V_104 ) V_135 , V_136 , V_12 ) ;
if ( V_134 < V_135 ) {
V_128 -> V_6 += V_134 ;
} else {
V_128 -> V_132 [ V_128 -> V_6 ] = '\0' ;
F_74 ( V_128 , V_128 -> V_6 + V_134 + 1 ) ;
V_135 = V_128 -> V_131 - V_128 -> V_6 ;
V_134 = F_7 ( & V_128 -> V_132 [ V_128 -> V_6 ] , ( V_104 ) V_135 , V_136 , V_103 ) ;
V_128 -> V_6 += F_78 ( V_135 - 1 , V_134 ) ;
}
va_end ( V_103 ) ;
}
void
F_81 ( T_16 * V_128 , const T_5 * V_136 , ... )
{
T_4 V_12 ;
va_start ( V_12 , V_136 ) ;
F_80 ( V_128 , V_136 , V_12 ) ;
va_end ( V_12 ) ;
}
void
F_82 ( T_16 * V_128 , const T_5 * V_136 , ... )
{
T_4 V_12 ;
if ( ! V_128 ) {
return;
...
T_16 *
F_83 ( T_16 * V_128 , const T_5 V_137 )
{
if ( ! V_128 ) {
return V_128 ;
}
if ( V_128 -> V_131 < V_128 -> V_6 + 1 + 1 ) {
F_74 ( V_128 , V_128 -> V_6 + 1 + 1 ) ;
}
if ( V_128 -> V_131 >= V_128 -> V_6 + 1 + 1 ) {
V_128 -> V_132 [ V_128 -> V_6 ] = V_137 ;
V_128 -> V_6 ++ ;
V_128 -> V_132 [ V_128 -> V_6 ] = '\0' ;
}
return V_128 ;
