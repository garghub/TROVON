...
char *
F_55 ( char * V_6 , int V_29 , T_2 V_21 )
{
T_3 V_49 , V_43 ;
char * V_115 ;
unsigned char * V_116 ;
...
int
F_57 ( T_2 V_117 , T_17 * * V_14 )
{
if ( V_117 -> V_12 != 0 && V_14 ) {
* V_14 = F_58 ( V_117 -> V_14 ) ;
}
return V_117 -> V_12 ;
}
void
...
static int
F_69 ( T_18 V_5 , int V_128 )
{
int V_9 ;
T_4 V_114 ;
T_19 V_8 ;
T_11 V_53 = & ( V_5 -> V_53 ) ;
if ( V_5 -> V_17 == 0 && F_67 ( V_5 ) == - 1 )
return - 1 ;
V_9 = V_94 ;
do {
...
if ( V_8 ) {
V_114 = F_70 ( V_5 -> V_10 , V_5 -> V_71 , ( unsigned int ) V_8 ) ;
if ( V_114 < 0 ) {
V_5 -> V_12 = V_13 ;
return - 1 ;
}
...
unsigned
F_73 ( T_18 V_5 , const void * V_6 , T_3 V_29 )
{
T_3 V_131 = V_29 ;
T_3 V_43 ;
T_11 V_53 ;
...
V_29 -= V_43 ;
if ( V_29 && F_69 ( V_5 , V_60 ) == - 1 )
return 0 ;
} while ( V_29 );
}
else {
if ( V_53 -> V_18 && F_69 ( V_5 , V_60 ) == - 1 )
return 0 ;
V_53 -> V_18 = V_29 ;
V_53 -> V_19 = ( V_132 * ) V_6 ;
V_5 -> V_22 += V_29 ;
...
{
int V_9 = 0 ;
if ( F_69 ( V_5 , V_129 ) == - 1 && V_9 == 0 )
V_9 = V_5 -> V_12 ;
( void ) F_76 ( & ( V_5 -> V_53 ) ) ;
F_24 ( V_5 -> V_31 ) ;
F_24 ( V_5 -> V_16 ) ;
V_5 -> V_12 = V_94 ;
if ( F_66 ( V_5 -> V_10 ) == - 1 && V_9 == 0 )
V_9 = V_13 ;
F_24 ( V_5 ) ;
return V_9 ;
}
