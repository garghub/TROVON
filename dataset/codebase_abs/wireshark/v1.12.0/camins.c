...
static T_1
F_12 ( T_9 * V_40 , int * V_4 , T_5 * * V_5 , V_24 * V_41 )
{
* V_41 = F_13 ( V_40 -> V_1 ) ;
return F_9 ( V_40 -> V_1 , & V_40 -> V_31 , V_40 -> V_42 , V_4 ,
V_5 ) ;
}
static T_1
F_14 ( T_9 * V_40 , V_24 V_43 ,
struct V_30 * V_44 , T_8 * V_2 , int * V_4 , T_5 * * V_5 )
{
if ( - 1 == F_7 ( V_40 -> V_45 , V_43 , V_46 , V_4 ) )
return FALSE ;
return F_9 ( V_40 -> V_45 , V_44 , V_2 , V_4 , V_5 ) ;
}
int F_15 ( T_9 * V_40 , int * V_4 , T_5 * * V_5 V_47 )
{
T_3 V_48 = 0 ;
T_3 V_49 = 0 ;
T_3 V_10 [ 2 ] ;
int V_6 ;
do {
V_6 = F_2 ( V_10 , sizeof( V_10 ) , V_40 -> V_1 ) ;
if ( V_6 != sizeof( V_10 ) )
break;
