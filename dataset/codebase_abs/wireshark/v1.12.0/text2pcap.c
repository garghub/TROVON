...
if ( V_138 > 6 ) {
for ( V_14 = V_138 - 6 ; V_14 != 0 ; V_14 -- )
V_116 /= 10 ;
} else if ( V_138 < 6 ) {
for ( V_14 = 6 - V_138 ; V_14 != 0 ; V_14 -- )
V_116 *= 10 ;
}
}
}
...
F_38 () ;
#endif
while ( ( V_4 = F_39 ( V_173 , V_174 , L_97 ) ) != - 1 ) {
switch ( V_4 ) {
case '?' : F_34 ( TRUE ) ; break;
case 'h' : F_34 ( FALSE ) ; break;
case 'd' : if ( ! V_120 ) V_132 ++ ; break;
case 'D' : V_36 = TRUE ; break;
case 'q' : V_120 = TRUE ; V_132 = FALSE ; break;
case 'l' : V_126 = ( T_1 ) strtol ( V_175 , NULL , 0 ) ; break;
case 'm' : V_11 = ( T_1 ) strtol ( V_175 , NULL , 0 ) ; break;
case 'n' : V_113 = TRUE ; break;
case 'o' :
if ( V_175 [ 0 ] != 'h' && V_175 [ 0 ] != 'o' && V_175 [ 0 ] != 'd' ) {
fprintf ( V_5 , L_98 , V_175 ) ;
F_34 ( TRUE ) ;
}
switch ( V_175 [ 0 ] ) {
case 'o' : V_6 = 8 ; break;
...
case 'e' :
V_42 = TRUE ;
if ( sscanf ( V_175 , L_99 , & V_39 ) < 1 ) {
fprintf ( V_5 , L_100 , V_175 ) ;
F_34 ( TRUE ) ;
}
break;
case 'i' :
V_40 = TRUE ;
V_55 = strtol ( V_175 , & V_137 , 10 ) ;
if ( V_137 == V_175 || * V_137 != '\0' || V_55 < 0 ||
V_55 > 255 ) {
fprintf ( V_5 , L_101 , V_175 ) ;
F_34 ( TRUE ) ;
}
V_42 = TRUE ;
V_39 = 0x800 ;
...
V_84 = FALSE ;
V_76 = FALSE ;
V_109 = ( T_1 ) strtol ( V_175 , & V_137 , 10 ) ;
if ( V_137 == V_175 || ( * V_137 != ',' && * V_137 != '\0' ) ) {
fprintf ( V_5 , L_102 , V_4 ) ;
F_34 ( TRUE ) ;
}
if ( * V_137 == '\0' ) {
...
V_137 ++ ;
V_175 = V_137 ;
V_108 = ( T_1 ) strtol ( V_175 , & V_137 , 10 ) ;
if ( V_137 == V_175 || ( * V_137 != ',' && * V_137 != '\0' ) ) {
fprintf ( V_5 , L_104 ) ;
F_34 ( TRUE ) ;
}
...
V_137 ++ ;
V_175 = V_137 ;
V_111 = ( T_1 ) strtol ( V_175 , & V_137 , 10 ) ;
if ( V_137 == V_175 || * V_137 != '\0' ) {
...
V_137 ++ ;
V_175 = V_137 ;
V_105 = ( T_1 ) strtoul ( V_175 , & V_137 , 10 ) ;
if ( V_137 == V_175 || * V_137 != '\0' ) {
fprintf ( V_5 , L_108 , V_4 ) ;
F_34 ( TRUE ) ;
}
V_40 = TRUE ;
V_55 = 132 ;
...
V_41 = FALSE ;
V_92 = FALSE ;
V_81 = ( T_1 ) strtol ( V_175 , & V_137 , 10 ) ;
if ( V_137 == V_175 || ( * V_137 != ',' && * V_137 != '\0' ) ) {
fprintf ( V_5 , L_109 ) ;
F_34 ( TRUE ) ;
}
...
V_137 ++ ;
V_175 = V_137 ;
V_80 = ( T_1 ) strtol ( V_175 , & V_137 , 10 ) ;
if ( V_137 == V_175 || * V_137 != '\0' ) {
fprintf ( V_5 , L_111 ) ;
F_34 ( TRUE ) ;
}
...
V_42 = TRUE ;
if ( V_38 == TRUE ) {
if ( F_40 ( V_176 , V_175 , V_58 ) <= 0 ) {
fprintf ( V_5 , L_115 , V_4 , V_137 ) ;
F_34 ( TRUE ) ;
}
} else {
if ( F_40 ( V_177 , V_175 , & V_50 ) <= 0 ) {
fprintf ( V_5 , L_115 , V_4 , V_137 ) ;
F_34 ( TRUE ) ;
}
}
...
if ( V_38 == TRUE ) {
if ( F_40 ( V_176 , V_137 , V_57 ) <= 0 ) {
fprintf ( V_5 , L_117 , V_4 , V_137 ) ;
F_34 ( TRUE ) ;
}
} else {
if ( F_40 ( V_177 , V_137 , & V_47 ) <= 0 ) {
fprintf ( V_5 , L_117 , V_4 , V_137 ) ;
F_34 ( TRUE ) ;
}
}
...
if ( V_178 >= V_173 || V_173 - V_178 < 2 ) {
fprintf ( V_5 , L_118 ) ;
F_34 ( TRUE ) ;
}
if ( strcmp ( V_174 [ V_178 ] , L_119 ) ) {
V_125 = F_41 ( V_174 [ V_178 ] ) ;
V_179 = F_42 ( V_125 , L_120 ) ;
if ( ! V_179 ) {
fprintf ( V_5 , L_121 ,
V_125 , F_18 ( V_180 ) ) ;
exit ( 1 ) ;
...
if ( strcmp ( V_174 [ V_178 + 1 ] , L_119 ) ) {
V_118 = F_41 ( V_174 [ V_178 + 1 ] ) ;
V_114 = F_42 ( V_118 , L_123 ) ;
if ( ! V_114 ) {
fprintf ( V_5 , L_124 ,
V_118 , F_18 ( V_180 ) ) ;
exit ( 1 ) ;
...
V_139 . V_146 = - 1 ;
if ( ! V_120 ) {
fprintf ( V_5 , L_127 , V_125 ) ;
fprintf ( V_5 , L_128 , V_118 ) ;
fprintf ( V_5 , L_129 , V_113 ? L_130 : L_131 ) ;
if ( V_42 ) fprintf ( V_5 , L_132 ,
V_39 ) ;
if ( V_40 ) fprintf ( V_5 , L_133 ,
V_55 ) ;
if ( V_76 ) fprintf ( V_5 , L_134 ,
V_81 , V_80 ) ;
if ( V_84 ) fprintf ( V_5 , L_135 ,
V_81 , V_80 ) ;
if ( V_41 ) fprintf ( V_5 , L_136 ,
V_109 , V_108 , V_111 ) ;
if ( V_92 ) fprintf ( V_5 , L_137 ,
V_99 , V_101 , V_103 , V_105 ) ;
}
}
int
main ( int V_173 , char * V_174 [] )
{
F_35 ( V_173 , V_174 ) ;
assert ( V_179 != NULL ) ;
assert ( V_114 != NULL ) ;
...
fprintf ( V_5 , L_138 ) ;
if ( ! V_120 ) {
fprintf ( V_5 , L_139 V_183 L_140 ,
V_147 , ( V_147 == 1 ) ? L_10 : L_141 ,
V_121 , ( V_121 == 1 ) ? L_10 : L_141 ,
V_117 , ( V_117 == 1 ) ? L_10 : L_141 ) ;
}
return 0 ;
}
