...
V_2 ++ ;
V_7 = F_3 ( V_1 , V_2 ) ;
F_6 ( V_29 , V_32 , V_1 , V_2 + 1 , V_7 , V_23 | V_11 ) ;
return ( V_2 + V_7 + 1 ) ;
}
}
...
{
V_7 = F_3 ( V_1 , V_2 + 1 ) ;
F_6 ( V_3 , V_52 , V_1 , V_2 + 2 , V_7 , V_23 | V_11 ) ;
V_2 += V_7 + 2 ;
}
return ( V_2 ) ;
}
...
V_2 += 1 ;
V_7 = F_3 ( V_1 , V_2 ) ;
F_6 ( V_3 , V_54 , V_1 , V_2 + 1 , V_7 , V_23 | V_11 ) ;
V_2 += V_7 + 2 ;
if( ! F_3 ( V_1 , V_2 ) )
{
V_2 += 1 ;
V_7 = F_3 ( V_1 , V_2 ) ;
F_6 ( V_3 , V_55 , V_1 , V_2 + 1 , V_7 , V_23 | V_11 ) ;
return ( V_2 + 1 ) ;
}
return ( V_2 + 2 ) ;
}
...
{
V_7 = F_3 ( V_1 , V_2 + 1 ) ;
F_6 ( V_3 , V_54 , V_1 , V_2 + 2 , V_7 , V_23 | V_11 ) ;
V_2 += V_7 + 1 ;
}
V_2 ++ ;
if( F_3 ( V_1 , V_2 ) )
...
if( V_102 != '\\' )
F_6 ( V_3 , V_109 , V_1 , V_2 + 1 , V_101 , V_23 | V_11 ) ;
else
{
...
{
case 12 :
F_6 ( V_3 , V_111 , V_103 , 0 , V_101 / 2 , V_11 ) ;
break;
case 64 :
F_6 ( V_3 , V_112 , V_103 , 0 , V_101 / 2 , V_9 ) ;
break;
case 128 :
F_6 ( V_3 , V_113 , V_103 , 0 , V_101 / 2 , V_11 ) ;
break;
}
}
else
...
break;
case V_189 :
F_6 ( V_3 , V_190 , V_1 , V_2 , V_100 , V_23 | V_11 ) ;
break;
case V_191 :
case V_192 :
case V_193 :
...
{
V_7 = F_3 ( V_1 , V_2 + 1 ) ;
F_6 ( V_3 , V_195 , V_1 , V_2 + 2 , V_7 , V_23 | V_11 ) ;
V_2 += V_7 ;
}
break;
case V_196 :
...
break;
case V_198 :
F_6 ( V_3 , V_199 , V_1 , V_2 , V_100 , V_23 | V_11 ) ;
break;
case V_200 :
for( V_4 = 0 ; V_4 < F_3 ( V_1 , V_2 ) ; V_4 ++ )
{
V_7 = F_3 ( V_1 , V_2 + 1 ) ;
F_6 ( V_3 , V_201 , V_1 , V_2 + 2 , V_7 , V_23 | V_11 ) ;
V_2 += V_7 ;
}
break;
case V_202 :
...
break;
case V_210 :
F_12 ( V_3 , V_1 , V_2 , V_100 , L_18 , F_47 ( F_48 () , V_1 , V_2 , V_100 ) ) ;
break;
default :
if( type > 63 && type < 100 )
F_12 ( V_3 , V_1 , V_2 , V_100 , L_19 , F_47 ( F_48 () , V_1 , V_2 , V_100 ) ) ;
else if( type > 100 && type < 255 )
F_12 ( V_3 , V_1 , V_2 , V_100 , L_20 , F_47 ( F_48 () , V_1 , V_2 , V_100 ) ) ;
else
F_12 ( V_3 , V_1 , V_2 , V_100 , L_21 , F_47 ( F_48 () , V_1 , V_2 , V_100 ) ) ;
}
return;
}
static void F_49 ( T_2 * V_1 , T_8 * V_211 , T_3 * V_212 )
{
T_9 * V_213 = NULL ;
int V_2 = 0 ;
T_9 * V_214 = NULL ;
...
T_3 * V_3 = NULL ;
T_4 V_224 = 0 ;
F_50 ( V_211 -> V_225 , V_226 , L_22 ) ;
F_51 ( V_211 -> V_225 , V_227 ) ;
if ( V_212 )
{
V_213 = F_6 ( V_212 , V_228 , V_1 , 0 , - 1 , V_11 ) ;
}
V_215 = F_52 ( V_213 , V_229 ) ;
if( V_215 )
V_214 = F_6 ( V_215 , V_230 , V_1 , V_2 , 1 , V_9 ) ;
if( V_214 )
{
V_216 = F_52 ( V_214 , V_231 ) ;
...
V_2 += 1 ;
V_223 = F_52 ( V_214 , V_238 ) ;
V_217 = F_3 ( V_1 , V_2 ) ;
V_217 = V_217 & 0xF0 ;
V_217 >>= 4 ;
F_6 ( V_223 , V_239 , V_1 , V_2 , 2 , V_9 ) ;
F_53 ( V_211 -> V_225 , V_227 , L_23 , F_54 ( V_217 , V_240 , L_24 ) ) ;
V_218 = F_3 ( V_1 , V_2 ) ;
V_218 = V_218 & 0x0C ;
V_218 >>= 2 ;
if( V_223 )
F_6 ( V_223 , V_241 , V_1 , V_2 , 2 , V_9 ) ;
F_53 ( V_211 -> V_225 , V_227 , L_23 , F_54 ( V_218 , V_242 , L_24 ) ) ;
V_219 = F_3 ( V_1 , V_2 ) ;
V_219 = V_219 & 0xF0 ;
V_219 >>= 4 ;
V_220 = F_5 ( V_1 , V_2 ) ;
...
F_53 ( V_211 -> V_225 , V_227 , L_25 , F_54 ( V_220 , V_244 , L_24 ) ) ;
break;
case 2 :
if( V_223 )
F_6 ( V_223 , V_245 , V_1 , V_2 , 2 , V_9 ) ;
F_53 ( V_211 -> V_225 , V_227 , L_25 , F_54 ( V_220 , V_246 , L_24 ) ) ;
break;
case 3 :
if( V_223 )
F_6 ( V_223 , V_247 , V_1 , V_2 , 2 , V_9 ) ;
F_53 ( V_211 -> V_225 , V_227 , L_25 , F_54 ( V_220 , V_248 , L_24 ) ) ;
break;
case 4 :
if( V_223 )
F_6 ( V_223 , V_249 , V_1 , V_2 , 2 , V_9 ) ;
F_53 ( V_211 -> V_225 , V_227 , L_25 , F_54 ( V_220 , V_250 , L_24 ) ) ;
break;
}
V_2 += 2 ;
if( V_215 )
...
if( V_7 <= ( T_10 ) V_221 )
{
V_214 = F_12 ( V_215 , V_1 , V_2 , 1 + V_222 + ( T_6 ) V_7 , L_26 , F_54 ( F_3 ( V_1 , V_2 ) , V_253 , L_27 ) ) ;
V_3 = F_52 ( V_214 , V_254 ) ;
if( V_3 )
{
...
V_228 = F_63 ( L_414 , L_22 , L_415 ) ;
F_64 ( V_228 , V_258 , F_65 ( V_258 ) ) ;
F_66 ( V_461 , F_65 ( V_461 ) ) ;
}
void F_67 ( void )
{
T_13 V_462 ;
V_462 = F_68 ( F_49 , V_228 ) ;
F_69 ( L_416 , V_463 , V_462 ) ;
F_69 ( L_417 , V_463 , V_462 ) ;
F_69 ( L_418 , V_464 , V_462 ) ;
}
