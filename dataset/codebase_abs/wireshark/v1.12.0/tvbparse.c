...
const char V_82 ,
const char V_83 ) {
T_4 * V_84 = F_44 ( L_29 , V_83 , V_82 ) ;
T_4 * V_85 = F_44 ( L_30 , V_82 ) ;
T_3 * V_86 = F_8 ( - 1 , V_85 , NULL , NULL , NULL ) ;
return F_24 ( V_2 , V_9 , V_26 , V_27 ,
F_36 ( - 1 , NULL , NULL , NULL ,
V_86 ,
F_36 ( - 1 , NULL , NULL , NULL ,
F_24 ( - 1 , NULL , NULL , NULL ,
F_18 ( - 1 , V_84 , NULL , NULL , NULL ) ,
F_15 ( - 1 , 0 , 0 , V_85 , NULL , NULL , NULL ) ,
NULL ) ,
NULL ) ,
V_86 ,
NULL ) ,
...
void F_45 ( void * T_10 V_87 ,
const void * T_11 V_87 ,
T_1 * V_6 ) {
V_6 -> V_3 += 1 ;
V_6 -> V_4 -= 2 ;
}
...
static void F_51 ( T_2 * V_1 , T_1 * V_89 ) {
T_13 * V_90 = F_52 ( F_29 () ) ;
while ( V_89 ) {
if( V_89 -> V_5 -> V_29 ) {
#ifdef F_2
if ( F_2 & V_91 ) F_3 ( L_32 , V_89 -> V_2 , V_89 -> V_3 , V_89 -> V_4 ) ;
#endif
...
#ifdef F_2
if ( F_2 & V_91 ) F_3 ( L_33 , V_89 -> V_2 , V_89 -> V_3 , V_89 -> V_4 ) ;
#endif
if( V_89 -> V_5 -> V_30 ) V_89 -> V_5 -> V_30 ( V_1 -> V_9 , V_89 -> V_5 -> V_9 , V_89 ) ;
}
V_89 = V_89 -> V_11 ;
while( ! V_89 && F_54 ( V_90 ) > 0 ) {
V_89 = ( T_1 * ) F_55 ( V_90 ) ;
#ifdef F_2
if ( F_2 & V_91 ) F_3 ( L_33 , V_89 -> V_2 , V_89 -> V_3 , V_89 -> V_4 ) ;
#endif
...
int V_3 = V_1 -> V_3 ;
#ifdef F_2
if ( F_2 & V_92 ) F_3 ( L_34 , V_3 ) ;
#endif
V_3 += F_5 ( V_1 , V_3 ) ;
#ifdef F_2
if ( F_2 & V_92 ) F_3 ( L_35 , V_3 ) ;
#endif
V_13 = V_5 -> V_17 ( V_1 , V_3 , V_5 , & V_6 ) ;
if ( V_13 >= 0 ) {
#ifdef F_2
if ( F_2 & V_92 ) F_3 ( L_36 , V_13 ) ;
#endif
return TRUE ;
} else {
#ifdef F_2
if ( F_2 & V_92 ) F_3 ( L_37 ) ;
#endif
return FALSE ;
}
}
...
int V_3 = V_1 -> V_3 ;
#ifdef F_2
if ( F_2 & V_93 ) F_3 ( L_38 , V_3 ) ;
#endif
V_3 += F_5 ( V_1 , V_3 ) ;
#ifdef F_2
if ( F_2 & V_93 ) F_3 ( L_39 , V_3 ) ;
#endif
V_13 = V_5 -> V_17 ( V_1 , V_3 , V_5 , & V_6 ) ;
if ( V_13 >= 0 ) {
#ifdef F_2
if ( F_2 & V_93 ) F_3 ( L_40 , V_13 ) ;
#endif
F_51 ( V_1 , V_6 ) ;
V_1 -> V_3 = V_3 + V_13 ;
#ifdef F_2
if ( F_2 & V_93 ) F_3 ( L_41 , V_1 -> V_3 ) ;
#endif
return V_6 ;
} else {
return NULL ;
...
#ifdef F_2
if ( F_2 & V_94 ) F_3 ( L_43 ) ;
#endif
return NULL ;
}
}
void F_59 ( T_14 * V_95 , T_1 * V_89 ) {
T_13 * V_90 = F_52 ( F_29 () ) ;
struct V_96 * V_97 = F_60 ( F_29 () , struct V_96 ) ;
T_15 * V_98 ;
V_97 -> V_95 = V_95 ;
V_97 -> V_99 = V_89 ;
while ( V_89 ) {
V_98 = F_61 ( V_97 -> V_95 , V_89 -> V_8 , V_89 -> V_3 , V_89 -> V_4 , L_44 , F_62 ( V_89 -> V_8 , V_89 -> V_3 , V_89 -> V_4 ) ) ;
if( V_89 -> V_10 ) {
V_97 -> V_99 = V_89 ;
F_53 ( V_90 , V_97 ) ;
V_97 = F_60 ( F_29 () , struct V_96 ) ;
V_97 -> V_95 = F_63 ( V_98 , 0 ) ;
V_89 = V_89 -> V_10 ;
continue;
}
V_89 = V_89 -> V_11 ;
while( ! V_89 && F_54 ( V_90 ) > 0 ) {
V_97 = (struct V_96 * ) F_55 ( V_90 ) ;
V_89 = V_97 -> V_99 -> V_11 ;
}
}
}
