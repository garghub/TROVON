...
V_44 . V_68 . time = 0 ;
V_44 . V_68 . V_89 = V_90 ;
V_46 = (struct V_45 * ) F_16 ( F_17 () , V_39 , F_18 ( L_2 ) , 0 ) ;
if ( V_46 )
V_44 . V_91 = V_46 -> V_92 ;
else
...
V_21 = F_19 ( T_5 , 1 ) ;
* V_21 = V_44 ;
V_11 -> V_15 = F_20 ( V_11 -> V_15 , V_21 ) ;
}
F_21 ( & ( V_21 -> V_68 ) , V_39 , V_43 ) ;
...
static T_7
F_25 ( const T_14 * V_111 )
{
int V_107 ;
for ( V_107 = V_112 - 1 ; V_107 > - 1 ; V_107 -- ) {
if ( F_26 ( V_113 [ V_107 ] . V_114 , V_111 , ( strlen ( V_113 [ V_107 ] . V_114 ) ) ) == 0 )
...
V_115 -> V_52 = V_43 -> V_53 ;
if ( V_115 -> V_52 < 96 ) {
V_123 = F_24 ( V_115 -> V_52 ) ;
} else{
if ( V_43 -> V_54 != NULL ) {
if ( F_26 ( L_3 , V_43 -> V_54 , ( strlen ( L_3 ) ) ) == 0 ) {
V_123 = 0 ;
V_115 -> V_93 |= V_143 ;
} else{
if( V_43 -> V_144 != 0 ) {
...
V_115 -> V_78 ++ ;
if ( V_115 -> V_78 == V_151 ) V_115 -> V_78 = 0 ;
} ;
V_115 -> V_77 += V_43 -> V_100 + 28 ;
V_115 -> V_76 = ( double ) ( V_115 -> V_77 * 8 ) / 1000 ;
V_115 -> V_79 ++ ;
if ( V_115 -> V_79 == V_151 ) V_115 -> V_79 = 0 ;
if ( V_43 -> V_135 ) {
V_115 -> V_152 = V_43 -> V_129 - V_115 -> V_80 ;
