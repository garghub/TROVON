...
V_52 -> V_96 = V_97 | V_98 ;
V_52 -> V_99 = V_54 . V_64 ;
V_52 -> V_100 = V_54 . V_92 ;
V_62 = ( double ) V_54 . V_66 . V_67 +
( double ) V_54 . V_66 . V_69 * 4294967296.0 ;
V_62 *= 1.0e-9 ;
V_62 -= V_101 ;
V_52 -> V_102 . V_103 = ( V_104 ) V_62 ;
V_52 -> V_102 . V_105 = ( T_3 ) ( ( V_62 - V_52 -> V_102 . V_103 ) * 1000000000 ) ;
switch ( V_1 -> V_25 ) {
case V_28 :
V_52 -> V_106 . V_72 = V_54 . V_72 ;
if ( V_29 -> V_48 )
V_52 -> V_106 . V_72 . V_107 = 4 ;
else {
if ( V_52 -> V_99 < 4 || V_52 -> V_100 < 4 ) {
* V_3 = V_32 ;
* V_4 = F_9 ( L_20 ) ;
return FALSE ;
}
V_52 -> V_106 . V_72 . V_107 = 0 ;
V_52 -> V_99 -= 4 ;
V_52 -> V_100 -= 4 ;
V_61 = 4 ;
}
V_52 -> V_106 . V_72 . V_108 = FALSE ;
break;
case V_27 :
if ( V_52 -> V_99 < 4 || V_52 -> V_100 < 4 ) {
* V_3 = V_32 ;
...
V_52 -> V_106 . V_109 . V_107 = 0 ;
V_52 -> V_99 -= 4 ;
V_52 -> V_100 -= 4 ;
V_61 = 4 ;
break;
}
if ( ! F_16 ( V_7 , V_53 , V_52 -> V_100 , V_3 , V_4 ) )
return - 1 ;
return V_61 ;
}
...
static T_11
V_41 ( T_1 * V_1 , T_12 V_112 ,
struct V_51 * V_52 , T_7 * V_53 , int * V_3 , T_2 * * V_4 )
{
if ( F_11 ( V_1 -> V_113 , V_112 , V_114 , V_3 ) == - 1 )
return FALSE ;
if ( F_13 ( V_1 , V_1 -> V_113 , V_52 , V_53 , V_3 , V_4 ) == - 1 ) {
if ( * V_3 == 0 )
* V_3 = V_9 ;
return FALSE ;
}
