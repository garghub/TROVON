...
T_7 * V_34 , int * V_2 , T_2 * * V_3 )
{
if ( F_6 ( V_1 -> V_35 , V_32 , V_16 , V_2 ) == - 1 )
return FALSE ;
if ( ! F_9 ( V_1 , V_1 -> V_35 , V_30 , V_34 , V_2 , V_3 ) ) {
if ( * V_2 == 0 ) {
* V_2 = V_11 ;
}
return FALSE ;
...
V_30 -> V_45 = V_12 ;
V_30 -> V_46 = V_12 ;
V_30 -> V_47 . V_48 = V_5 . V_37 ;
V_30 -> V_47 . V_49 = V_5 . V_38 * 1000 ;
switch ( V_5 . type ) {
case V_50 :
V_30 -> V_51 = V_52 ;
break;
...
V_30 -> V_54 . V_55 . V_59 = ( V_5 . V_14 == V_60 ) ;
