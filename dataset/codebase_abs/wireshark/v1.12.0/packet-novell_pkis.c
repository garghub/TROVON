...
static void F_37 ( T_3 * T_4 V_1 , T_11 * T_12 V_1 , T_8 * T_9 V_1 ) {
T_6 V_36 ;
F_38 ( & V_36 , V_37 , TRUE , T_12 ) ;
F_32 ( FALSE , T_4 , 0 , & V_36 , T_9 , V_38 ) ;
}
static void F_39 ( T_3 * T_4 V_1 , T_11 * T_12 V_1 , T_8 * T_9 V_1 ) {
T_6 V_36 ;
F_38 ( & V_36 , V_37 , TRUE , T_12 ) ;
F_36 ( FALSE , T_4 , 0 , & V_36 , T_9 , V_39 ) ;
}
void F_40 ( void )
{
#line 1 "../../asn1/novell_pkis/packet-novell_pkis-dis-tab.c"
F_41 ( L_1 , F_37 , V_40 , L_2 ) ;
F_41 ( L_3 , F_39 , V_40 , L_4 ) ;
...
if ( V_40 != - 1 ) return;
V_40 = F_44 ( L_106 , L_107 , L_107 ) ;
F_45 ( V_40 , V_41 , F_46 ( V_41 ) ) ;
F_47 ( V_95 , F_46 ( V_95 ) ) ;
}
