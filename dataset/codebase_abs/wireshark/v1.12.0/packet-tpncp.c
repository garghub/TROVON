...
static int F_15 ( T_2 * V_2 , T_11 * V_33 , T_5 * V_34 , void * T_12 V_35 ) {
T_3 * V_3 = NULL , * V_36 = NULL ;
T_5 * V_37 = NULL ;
T_1 V_4 = 0 ;
T_13 V_38 , V_39 = 0 ;
...
if ( V_34 ) {
V_3 = F_5 ( V_34 , V_52 , V_2 , 0 , - 1 , V_22 ) ;
V_37 = F_2 ( V_3 , V_53 ) ;
F_7 ( V_37 , V_54 , V_2 , 0 , 2 , V_42 ) ;
F_7 ( V_37 , V_55 , V_2 , 2 , 2 , V_41 ) ;
F_7 ( V_37 , V_56 , V_2 , 4 , 2 , V_40 ) ;
F_7 ( V_37 , V_57 , V_2 , 6 , 2 , V_43 ) ;
if ( V_33 -> V_45 == V_46 ) {
if ( F_19 ( V_38 , V_50 ) ) {
F_7 ( V_37 , V_58 , V_2 , 8 , 4 , V_38 ) ;
F_8 ( V_37 , V_59 , V_2 , 12 , 4 , V_39 ) ;
V_4 += 16 ;
if ( V_30 [ V_38 ] . V_19 ) {
V_44 = F_20 ( F_21 () , L_6 ,
F_18 ( V_38 , V_50 , L_4 ) , V_38 ) ;
V_36 = F_22 ( V_34 , V_2 , V_4 , - 1 , L_7 , V_44 ) ;
F_13 ( V_38 , V_2 , V_36 , & V_4 ) ;
}
}
}
else {
if ( F_19 ( V_38 , V_51 ) ) {
F_7 ( V_37 , V_60 , V_2 , 8 , 4 , V_38 ) ;
V_4 += 12 ;
if ( V_32 [ V_38 ] . V_19 ) {
V_44 = F_20 ( F_21 () , L_8 ,
F_18 ( V_38 , V_51 , L_4 ) , V_38 ) ;
V_36 = F_22 ( V_34 , V_2 , V_4 , - 1 , L_7 , V_44 ) ;
F_14 ( V_38 , V_2 , V_36 , & V_4 ) ;
}
}
}
}
...
static T_15 F_24 ( T_11 * V_33 V_35 , T_2 * V_2 , T_1 V_4 ) {
T_8 V_61 ;
V_61 = F_9 ( V_2 , V_4 + 2 ) ;
V_61 += 4 ;
return V_61 ;
}
static int F_25 ( T_2 * V_2 , T_11 * V_33 , T_5 * V_34 , void * T_12 ) {
if ( V_33 -> V_62 )
F_26 ( V_2 , V_33 , V_34 , V_63 , 4 , F_24 , F_15 , T_12 ) ;
else
F_15 ( V_2 , V_33 , V_34 , T_12 ) ;
return F_23 ( V_2 ) ;
}
static T_1 F_27 ( T_16 string [] , T_17 * V_64 ) {
T_1 V_65 = 0 , V_66 = 0 ;
T_14 * V_67 , * V_68 ;
V_68 = ( T_14 * ) F_28 ( V_69 ) ;
V_68 [ 0 ] = 0 ;
...
static T_1 F_31 ( T_17 * V_64 ) {
T_1 V_65 = 0 , V_73 = 0 , V_74 = 0 ;
T_18 V_75 = TRUE ;
T_14 * V_68 = NULL , * V_76 = NULL ,
* V_77 = NULL , * V_78 = NULL ;
V_68 = ( T_14 * ) F_28 ( V_69 ) ;
V_68 [ 0 ] = 0 ;
V_76 = ( T_14 * ) F_28 ( V_69 ) ;
...
static T_1 F_34 ( T_4 * V_5 , T_17 * V_64 ) {
static T_18 V_83 = FALSE ;
T_14 * V_84 = NULL , * V_85 = NULL , * V_86 = NULL ;
T_1 V_74 , V_1 , V_87 = - 1 ,
V_26 , V_19 ,
V_20 , V_27 ;
T_15 V_88 ;
...
V_89 . V_96 . V_104 = - 1 ;
if ( ! V_83 ) {
V_105 = V_106 + ( int ) F_36 ( V_90 ) - 1 ;
if ( ( V_107 = ( T_19 * ) F_37 ( V_107 , V_105 * sizeof( T_19 ) ) ) == NULL ) {
return ( - 1 ) ;
}
for ( V_88 = 0 ; V_88 < F_36 ( V_90 ) ; V_88 ++ ) {
...
T_1 V_118 ;
T_17 * V_64 ;
V_117 = F_39 ( L_7 V_119 L_30 V_119 L_31 , F_41 () ) ;
if ( ( V_64 = F_42 ( V_117 , L_32 ) ) == NULL ) {
F_30 ( V_117 ) ;
return ( - 1 ) ;
}
F_30 ( V_117 ) ;
V_118 = F_27 ( V_50 , V_64 ) ;
if ( V_118 != 0 )
goto V_120;
V_118 = F_27 ( V_51 , V_64 ) ;
if ( V_118 != 0 )
goto V_120;
V_118 = F_31 ( V_64 ) ;
if ( V_118 != 0 )
goto V_120;
V_118 = F_34 ( V_30 , V_64 ) ;
if ( V_118 != 0 )
goto V_120;
V_118 = F_34 ( V_32 , V_64 ) ;
V_120:
fclose ( V_64 ) ;
return V_118 ;
}
...
return;
if ( ! V_121 ) {
V_122 = F_44 ( F_25 , V_52 ) ;
V_121 = TRUE ;
}
else {
F_45 ( L_33 , V_123 , V_122 ) ;
F_45 ( L_34 , V_124 , V_125 ) ;
F_45 ( L_33 , V_126 , V_122 ) ;
F_45 ( L_34 , V_127 , V_125 ) ;
}
if( V_128 ) {
V_123 = V_129 ;
V_124 = V_130 ;
V_126 = V_131 ;
V_127 = V_132 ;
F_46 ( L_33 , V_129 , V_122 ) ;
F_46 ( L_34 , V_130 , V_125 ) ;
}
}
void F_47 ( void ) {
T_1 V_88 ;
...
V_135 ;
F_53 ( V_134 , F_36 ( V_134 ) ) ;
}
V_125 = F_54 ( L_30 , F_15 , V_52 ) ;
V_133 = F_55 ( V_52 , F_43 ) ;
F_56 ( V_133 , L_38 ,
L_39 ,
L_40
L_41
