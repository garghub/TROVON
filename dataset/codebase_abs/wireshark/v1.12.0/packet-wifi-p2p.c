...
void F_32 ( T_5 * V_42 , T_6 * V_92 , T_2 * V_3 ,
int V_4 , T_7 V_121 )
{
T_4 V_35 = 0 ;
T_3 V_122 = 0 ;
...
V_122 = F_4 ( V_3 , V_4 ) ;
V_35 = F_20 ( V_3 , V_4 + 1 ) ;
V_2 = F_26 ( V_92 , V_3 , V_4 , 3 + V_35 , L_24 ,
F_10 ( V_122 , V_123 ,
L_25 ) ) ;
V_1 = F_27 ( V_2 , V_124 ) ;
...
int F_35 ( T_6 * V_92 , T_2 * V_3 , int V_4 )
{
...
void F_36 ( T_5 * V_42 , T_6 * V_92 , T_2 * V_3 ,
int V_4 , T_8 V_153 )
{
T_1 * V_47 ;
...
if ( V_155 > F_37 ( V_3 , V_4 + 2 ) ) {
F_16 ( V_42 , V_47 , & V_159 , L_29 ) ;
return;
}
type = F_4 ( V_3 , V_4 + 2 ) ;
V_157 = F_4 ( V_3 , V_4 + 3 ) ;
V_47 = F_26 ( V_92 , V_3 , V_4 , 2 + V_155 ,
L_30 ,
V_157 , F_10 ( type , V_160 ,
L_27 ) ) ;
V_156 = F_27 ( V_47 , V_161 ) ;
...
{ & V_125 ,
{ L_31 , L_32 ,
V_170 , V_171 , F_41 ( V_123 ) , 0x0 , NULL , V_172 } } ,
{ & V_126 ,
{ L_33 , L_34 ,
...
{ & V_163 ,
{ L_196 , L_197 ,
V_170 , V_171 , F_41 ( V_160 ) , 0x0 , NULL ,
V_172 } } ,
{ & V_164 ,
{ L_198 , L_199 ,
V_170 , V_171 , NULL , 0x0 , NULL , V_172 } } ,
...
static T_10 V_206 [] = {
{ & V_66 , { L_214 , V_207 , V_208 , L_8 , V_209 } } ,
{ & V_68 , { L_215 , V_207 , V_208 , L_216 , V_209 } } ,
{ & V_159 , { L_217 , V_207 , V_208 , L_218 , V_209 } } ,
{ & V_168 , { L_219 , V_207 , V_208 , L_220 , V_209 } } ,
} ;
T_11 * V_210 ;
V_211 = F_42 ( L_221 , L_222 , L_223 ) ;
