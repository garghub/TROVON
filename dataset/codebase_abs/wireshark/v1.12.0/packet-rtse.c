...
& string ) ;
if( V_35 && string )
F_23 ( V_22 -> V_12 -> V_36 , V_37 , L_8 , F_24 ( string , 0 , F_25 ( string ) ) ) ;
return V_11 ;
}
static int
...
V_11 = F_18 ( TRUE , V_22 , V_13 , V_10 , V_11 , T_9 , & V_32 ) ;
return V_11 ;
}
int
...
& V_52 ) ;
if( V_52 != - 1 )
F_23 ( V_22 -> V_12 -> V_36 , V_37 , L_10 , F_42 ( V_52 , V_53 , L_11 ) ) ;
return V_11 ;
}
static int
...
int V_57 = - 1 ;
F_34 ( V_22 -> V_12 -> V_36 , V_37 , L_13 ) ;
V_11 = F_18 ( T_7 , V_22 , V_13 , V_10 , V_11 , T_9 ,
& V_57 ) ;
if( V_57 != - 1 )
F_23 ( V_22 -> V_12 -> V_36 , V_37 , L_14 , V_57 ) ;
return V_11 ;
}
static int
...
T_3 * V_15 = NULL ;
struct V_30 * V_31 = (struct V_30 * ) V_22 -> V_29 ;
V_11 = F_27 ( FALSE , V_22 , V_13 , V_10 , V_11 , T_9 , & V_15 ) ;
if( V_15 ) {
if( V_31 )
V_31 -> V_44 = ( V_58 | V_46 ) ;
V_11 = F_47 ( FALSE , V_13 , V_15 , 0 , V_22 , - 1 , F_15 ) ;
}
return V_11 ;
}
static int
...
& V_52 ) ;
if( V_52 != - 1 )
F_23 ( V_22 -> V_12 -> V_36 , V_37 , L_10 , F_42 ( V_52 , V_59 , L_11 ) ) ;
return V_11 ;
}
static int
...
static int
F_54 ( T_3 * V_10 , T_4 * V_12 , T_5 * V_64 , void * V_14 )
{
int V_11 = 0 ;
int V_65 ;
T_6 * V_17 ;
...
V_67 = F_59 ( & V_87 ,
V_12 , V_69 , NULL ) ;
V_15 = F_60 ( V_10 , V_11 , V_12 , L_17 ,
V_67 , & V_88 , NULL , V_64 ) ;
}
V_17 = F_61 ( V_64 , V_89 , V_15 ? V_15 : V_10 , 0 , - 1 , V_90 ) ;
V_13 = F_12 ( V_17 , V_91 ) ;
...
F_23 ( V_12 -> V_36 , V_37 , L_21 ,
V_68 , F_63 ( V_68 , L_19 , L_20 ) ) ;
} else if ( V_75 && V_31 -> V_76 == V_78 ) {
if ( V_15 ) {
V_31 -> V_44 = ( V_58 | V_46 ) ;
F_47 ( FALSE , V_13 , V_15 , 0 , & V_72 , - 1 , F_15 ) ;
V_28 = NULL ;
return 1 ;
} else {
V_11 = F_25 ( V_10 ) ;
...
if( V_11 == V_65 ) {
V_17 = F_10 ( V_13 , V_10 , V_11 , - 1 , L_22 ) ;
F_67 ( V_12 , V_17 , & V_97 ) ;
V_18 = F_12 ( V_17 , V_19 ) ;
...
{ & V_127 ,
{ L_70 , L_71 ,
V_121 , V_114 , F_71 ( V_128 ) , 0 ,
NULL , V_102 } } ,
{ & V_129 ,
{ L_72 , L_73 ,
V_113 , V_114 , F_71 ( V_130 ) , 0 ,
L_74 , V_102 } } ,
{ & V_131 ,
{ L_75 , L_76 ,
V_121 , V_114 , F_71 ( V_132 ) , 0 ,
NULL , V_102 } } ,
{ & V_133 ,
{ L_77 , L_78 ,
V_113 , V_114 , F_71 ( V_130 ) , 0 ,
...
T_16 * V_155 ;
T_17 * V_156 ;
V_89 = F_72 ( V_157 , V_158 , V_159 ) ;
F_73 ( L_1 , F_54 , V_89 ) ;
F_74 ( V_89 , V_99 , F_75 ( V_99 ) ) ;
F_76 ( V_148 , F_75 ( V_148 ) ) ;
V_155 = F_77 ( V_89 ) ;
F_78 ( V_155 , V_151 , F_75 ( V_151 ) ) ;
F_79 ( & F_68 ) ;
V_156 = F_80 ( L_108 , V_89 , NULL ) ;
F_81 ( V_156 , L_109 ,
L_110 ,
L_111
L_112
L_113
L_114 , & V_75 ) ;
V_16 = F_82 ( L_3 , L_115 , V_144 , V_101 ) ;
V_8 = F_83 ( V_160 , V_161 ) ;
}
void F_84 ( void ) {
}
