...
T_6 * V_17 = F_10 ( V_13 , V_15 , 0 , F_11 ( V_10 , V_11 ) , L_4 , V_1 ) ;
T_5 * V_18 = F_12 ( V_17 , V_19 ) ;
F_13 ( V_12 , V_17 , & V_20 ,
L_5 , V_1 ) ;
F_14 ( V_12 , V_15 , V_11 , V_18 ) ;
}
V_11 += F_11 ( V_10 , V_11 ) ;
return V_11 ;
}
...
static int
F_17 ( T_3 * V_10 , T_4 * V_12 , T_5 * V_30 , void * V_14 )
{
int V_11 = 0 ;
int V_31 ;
T_6 * V_17 ;
...
T_12 * V_39 = NULL ;
T_8 V_40 ;
F_18 ( & V_40 , V_41 , TRUE , V_12 ) ;
if ( V_14 == NULL )
return 0 ;
V_38 = (struct V_37 * ) V_14 ;
V_28 = V_30 ;
V_40 . V_29 = V_38 ;
F_19 ( V_12 -> V_42 , V_43 , L_6 ) ;
F_20 ( V_12 -> V_42 , V_44 ) ;
if ( V_45 &&
( ( V_38 -> V_46 == V_47 ) ||
( V_38 -> V_46 == V_48 ) ) ) {
V_39 = F_21 ( V_12 -> V_49 -> V_50 ,
...
V_33 = F_22 ( & V_57 ,
V_12 , V_35 , NULL ) ;
V_15 = F_23 ( V_10 , V_11 , V_12 , L_7 ,
V_33 , & V_58 , NULL , V_30 ) ;
}
V_17 = F_24 ( V_30 , V_59 , V_15 ? V_15 : V_10 , 0 , - 1 , V_60 ) ;
V_13 = F_12 ( V_17 , V_61 ) ;
...
if ( V_15 ) {
V_38 -> V_67 = ( V_68 | V_69 ) ;
F_31 ( FALSE , V_13 , V_15 , 0 , & V_40 , - 1 , F_15 ) ;
V_28 = NULL ;
return 1 ;
} else {
V_11 = F_32 ( V_10 ) ;
...
if( V_11 == V_31 ) {
V_17 = F_10 ( V_13 , V_10 , V_11 , - 1 , L_12 ) ;
F_35 ( V_12 , V_17 , & V_70 ) ;
V_18 = F_12 ( V_17 , V_19 ) ;
F_14 ( V_12 , V_10 , V_11 , V_18 ) ;
break;
}
}
}
...
T_16 * V_97 ;
T_17 * V_98 ;
V_59 = F_39 ( V_99 , V_100 , V_101 ) ;
F_40 ( L_1 , F_17 , V_59 ) ;
F_41 ( V_59 , V_72 , F_42 ( V_72 ) ) ;
F_43 ( V_90 , F_42 ( V_90 ) ) ;
V_97 = F_44 ( V_59 ) ;
F_45 ( V_97 , V_93 , F_42 ( V_93 ) ) ;
F_46 ( & F_36 ) ;
V_98 = F_47 ( L_40 , V_59 , NULL ) ;
F_48 ( V_98 , L_41 ,
L_42 ,
L_43
L_44
L_45
L_46 , & V_45 ) ;
V_16 = F_49 ( L_3 , L_47 , V_102 , V_74 ) ;
V_8 = F_50 ( V_103 , V_104 ) ;
}
void F_51 ( void ) {
}
