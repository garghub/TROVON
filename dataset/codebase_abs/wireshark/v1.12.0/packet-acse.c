...
V_11 = F_18 ( T_6 , V_18 ) ;
if( V_11 ) {
if( strcmp ( V_11 , V_117 ) == 0 ) {
F_127 ( V_103 , T_11 , T_12 , - 1 ,
L_11 , V_117 ) ;
F_131 ( V_118 ) ;
}
F_23 ( V_11 , T_11 , T_12 , T_6 , V_103 , NULL ) ;
} else {
F_132 ( V_103 , T_6 , & V_119 ,
T_11 , T_12 , - 1 ) ;
}
V_21 = NULL ;
return 0 ;
...
if( V_15 -> V_108 == V_115 )
{
V_105 = F_133 ( V_103 , V_120 , T_11 , 0 , - 1 , V_121 ) ;
T_16 = F_134 ( V_105 , V_122 ) ;
F_135 ( T_6 -> V_63 , V_123 , L_12 ) ;
F_136 ( T_6 -> V_63 , V_64 ) ;
}
else
{
V_105 = F_133 ( V_103 , V_124 , T_11 , 0 , - 1 , V_121 ) ;
T_16 = F_134 ( V_105 , V_122 ) ;
F_135 ( T_6 -> V_63 , V_123 , L_13 ) ;
F_136 ( T_6 -> V_63 , V_64 ) ;
}
...
{ & V_153 ,
{ L_64 , L_65 ,
V_136 , V_132 , F_139 ( V_154 ) , 0 ,
L_66 , V_130 } } ,
{ & V_155 ,
{ L_67 , L_68 ,
V_136 , V_132 , F_139 ( V_156 ) , 0 ,
L_69 , V_130 } } ,
{ & V_157 ,
{ L_70 , L_71 ,
V_131 , V_132 , NULL , 0 ,
...
{ & V_176 ,
{ L_110 , L_111 ,
V_136 , V_132 , F_139 ( V_177 ) , 0 ,
L_112 , V_130 } } ,
{ & V_178 ,
{ L_113 , L_114 ,
V_136 , V_132 , F_139 ( V_179 ) , 0 ,
L_115 , V_130 } } ,
{ & V_180 ,
{ L_116 , L_117 ,
V_136 , V_132 , F_139 ( V_154 ) , 0 ,
...
{ & V_194 ,
{ L_138 , L_139 ,
V_136 , V_132 , F_139 ( V_84 ) , 0 ,
L_140 , V_130 } } ,
{ & V_195 ,
{ L_141 , L_142 ,
V_136 , V_132 , F_139 ( V_196 ) , 0 ,
L_143 , V_130 } } ,
{ & V_197 ,
{ L_105 , L_106 ,
V_136 , V_132 , NULL , 0 ,
...
{ & V_231 ,
{ L_206 , L_207 ,
V_131 , V_132 , F_139 ( V_232 ) , 0 ,
NULL , V_130 } } ,
{ & V_233 ,
{ L_208 , L_209 ,
V_136 , V_132 , F_139 ( V_234 ) , 0 ,
NULL , V_130 } } ,
{ & V_235 ,
{ L_210 , L_211 ,
V_136 , V_132 , F_139 ( V_236 ) , 0 ,
NULL , V_130 } } ,
{ & V_237 ,
{ L_212 , L_213 ,
V_139 , V_129 , NULL , 0 ,
...
static T_20 V_259 [] = {
{ & V_119 , { L_251 , V_260 , V_261 , L_252 , V_262 } } ,
} ;
T_21 * V_263 ;
V_124 = F_140 ( V_264 , V_265 , V_266 ) ;
F_141 ( L_253 , F_124 , V_124 ) ;
V_120 = F_140 ( V_267 , V_268 , V_269 ) ;
F_142 ( V_124 , V_126 , F_143 ( V_126 ) ) ;
F_144 ( V_258 , F_143 ( V_258 ) ) ;
V_263 = F_145 ( V_124 ) ;
F_146 ( V_263 , V_259 , F_143 ( V_259 ) ) ;
}
void F_147 ( void ) {
T_22 V_270 = F_148 ( L_253 ) ;
F_149 ( L_254 , L_255 ) ;
F_150 ( V_117 , V_270 , V_124 , L_256 ) ;
}
