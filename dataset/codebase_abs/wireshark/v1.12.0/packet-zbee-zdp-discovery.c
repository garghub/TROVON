...
void
F_12 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 , V_8 V_14 )
{
T_7 * V_15 ;
T_3 * V_16 = NULL ;
T_4 V_4 = 0 , V_17 ;
T_4 V_18 = ( V_14 >= V_19 ) ? ( int ) sizeof( T_6 ) : ( int ) sizeof( V_8 ) ;
T_6 V_10 ;
T_6 V_20 ;
V_8 V_21 ;
V_8 V_22 ;
V_10 = F_3 ( V_3 , V_11 , V_1 , & V_4 , ( int ) sizeof( T_6 ) , NULL ) ;
V_20 = F_3 ( V_3 , V_23 , V_1 , & V_4 , ( int ) sizeof( T_6 ) , NULL ) ;
V_21 = F_3 ( V_3 , V_24 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( V_3 && V_21 ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_21 * V_18 , L_4 ) ;
V_16 = F_14 ( V_15 , V_25 ) ;
}
for ( V_17 = 0 ; V_17 < V_21 ; V_17 ++ ) F_3 ( V_16 , V_26 , V_1 , & V_4 , V_18 , NULL ) ;
V_22 = F_3 ( V_3 , V_27 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( V_3 && V_22 ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_22 * V_18 , L_5 ) ;
V_16 = F_14 ( V_15 , V_28 ) ;
}
for ( V_17 = 0 ; V_17 < V_22 ; V_17 ++ ) F_3 ( V_16 , V_29 , V_1 , & V_4 , V_18 , NULL ) ;
...
V_32 = ( T_8 * ) F_21 ( F_22 () , V_31 + 1 ) ;
V_32 = ( T_8 * ) F_23 ( V_1 , V_32 , V_4 , V_31 ) ;
V_32 [ V_31 ] = '\0' ;
if ( V_3 ) {
...
if ( V_3 ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_36 , L_8 ) ;
V_16 = F_14 ( V_15 , V_41 ) ;
}
for ( V_17 = 0 ; V_17 < V_36 ; V_17 ++ ) {
F_3 ( V_16 , V_42 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
}
F_4 ( V_3 , V_2 , L_1 , F_5 ( V_5 ) ) ;
F_6 ( V_1 , V_4 , V_2 , V_3 ) ;
}
...
if ( V_3 ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_45 , L_9 ) ;
V_16 = F_14 ( V_15 , V_47 ) ;
}
for ( V_17 = 0 ; V_17 < V_45 ; V_17 ++ ) {
( void ) F_3 ( V_16 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
}
F_4 ( V_3 , V_2 , L_1 , F_5 ( V_5 ) ) ;
F_6 ( V_1 , V_4 , V_2 , V_3 ) ;
}
...
F_3 ( V_3 , V_9 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( ( V_3 ) && ( V_51 ) ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_51 * ( int ) sizeof( T_6 ) , L_10 ) ;
V_16 = F_14 ( V_15 , V_53 ) ;
}
for ( V_17 = 0 ; V_17 < V_51 ; V_17 ++ ) {
( void ) F_3 ( V_16 , V_54 , V_1 , & V_4 , ( int ) sizeof( T_6 ) , NULL ) ;
}
}
F_4 ( V_3 , V_2 , L_11 , F_42 ( V_50 ) ) ;
if ( V_50 == V_55 ) {
...
V_45 = F_3 ( V_3 , V_46 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( V_3 && V_45 ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_45 * ( int ) sizeof( V_8 ) , L_14 ) ;
V_16 = F_14 ( V_15 , V_47 ) ;
}
for ( V_17 = 0 ; V_17 < V_45 ; V_17 ++ ) {
( void ) F_3 ( V_16 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
...
V_45 = F_3 ( V_3 , V_46 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( V_3 && V_45 ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_45 * ( int ) sizeof( V_8 ) , L_15 ) ;
V_16 = F_14 ( V_15 , V_47 ) ;
}
for ( V_17 = 0 ; V_17 < V_45 ; V_17 ++ ) {
( void ) F_3 ( V_16 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
...
V_50 = F_40 ( V_3 , V_1 , & V_4 ) ;
V_10 = F_3 ( V_3 , V_11 , V_1 , & V_4 , ( int ) sizeof( T_6 ) , NULL ) ;
if ( ( V_14 >= V_19 ) || ( V_50 == V_55 ) ) {
V_31 = F_3 ( V_3 , V_33 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
}
else V_31 = 0 ;
V_32 = F_52 ( F_22 () , V_1 , V_4 , V_31 ) ;
if ( V_3 ) {
F_24 ( V_3 , V_34 , V_1 , V_4 , V_31 , V_32 ) ;
}
V_4 += V_31 ;
...
for ( V_17 = V_60 ; ( V_17 < V_21 ) && F_41 ( V_1 , V_4 , V_18 ) ; V_17 ++ ) {
F_3 ( V_3 , V_26 , V_1 , & V_4 , V_18 , NULL ) ;
}
for ( V_17 -= V_21 ; ( V_17 < V_22 ) && F_41 ( V_1 , V_4 , V_18 ) ; V_17 ++ ) {
F_3 ( V_3 , V_29 , V_1 , & V_4 , V_18 , NULL ) ;
}
F_4 ( V_3 , V_2 , L_2 , V_10 ) ;
F_4 ( V_3 , V_2 , L_11 , F_42 ( V_50 ) ) ;
F_6 ( V_1 , V_4 , V_2 , V_3 ) ;
...
V_15 = F_13 ( V_3 , V_1 , V_4 , V_45 * ( int ) sizeof( V_8 ) , L_14 ) ;
V_16 = F_14 ( V_15 , V_47 ) ;
for ( V_17 = V_60 ; ( V_17 < V_45 ) && F_41 ( V_1 , V_4 , ( int ) sizeof( V_8 ) ) ; V_17 ++ ) {
( void ) F_3 ( V_16 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
}
}
F_4 ( V_3 , V_2 , L_2 , V_10 ) ;
