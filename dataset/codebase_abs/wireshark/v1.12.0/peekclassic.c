...
{
if ( F_11 ( V_1 -> V_57 , V_54 , V_58 , V_2 ) == - 1 )
return FALSE ;
if ( F_9 ( V_1 , V_1 -> V_57 , V_50 , V_56 ,
V_2 , V_3 ) == - 1 ) {
if ( * V_2 == 0 )
* V_2 = V_13 ;
return FALSE ;
...
static int F_9 ( T_1 * V_1 , T_8 V_12 ,
struct V_55 * V_50 , T_7 * V_56 , int * V_2 , T_2 * * V_3 )
{
T_9 V_59 [ V_60 ] ;
int V_5 ;
...
T_12 V_64 ;
V_52 V_65 ;
V_5 = F_3 ( V_59 , sizeof( V_59 ) , V_12 ) ;
if ( V_5 != ( int ) sizeof( V_59 ) ) {
* V_2 = F_4 ( V_12 , V_3 ) ;
if ( * V_2 == 0 && V_5 > 0 )
* V_2 = V_13 ;
return - 1 ;
...
V_50 -> V_70 = V_71 ;
V_50 -> V_72 = V_73 | V_74 ;
V_64 = ( T_12 ) ( V_63 / 1000000 ) ;
V_65 = ( V_52 ) ( V_63 - V_64 * 1000000 ) ;
V_50 -> V_75 . V_76 = V_64 - V_32 ;
V_50 -> V_75 . V_77 = V_65 * 1000 ;
V_50 -> V_78 = V_61 ;
V_50 -> V_53 = V_49 ;
switch ( V_1 -> V_8 ) {
case V_23 :
V_50 -> V_79 . V_80 . V_81 = 0 ;
V_50 -> V_79 . V_80 . V_82 = FALSE ;
if ( V_50 -> V_78 < 4 || V_50 -> V_53 < 4 ) {
* V_2 = V_83 ;
* V_3 = F_14 ( L_1 ) ;
return - 1 ;
}
...
break;
case V_21 :
V_50 -> V_79 . V_84 . V_81 = ( V_62 & 0x01 ) ? 0 : 4 ;
break;
}
...
if ( F_11 ( V_1 -> V_57 , V_54 , V_58 , V_2 ) == - 1 )
return FALSE ;
if ( ! F_16 ( V_1 , V_1 -> V_57 , V_50 , V_56 ,
V_2 , V_3 ) ) {
if ( * V_2 == 0 )
* V_2 = V_13 ;
return FALSE ;
...
static T_5 F_16 ( T_1 * V_1 , T_8 V_12 ,
struct V_55 * V_50 , T_7 * V_56 , int * V_2 , T_2 * * V_3 )
{
...
#endif
unsigned int V_87 ;
F_17 ( V_59 , sizeof( V_59 ) , V_12 , V_2 ,
V_3 ) ;
V_61 = F_12 ( & V_59 [ V_88 ] ) ;
V_49 = F_12 ( & V_59 [ V_89 ] ) ;
#if 0
...
V_50 -> V_70 = V_71 ;
V_50 -> V_72 = V_73 | V_74 ;
V_50 -> V_75 . V_76 = V_9 -> V_7 . V_31
+ ( V_63 / 1000 ) ;
V_50 -> V_75 . V_77 = 1000 * ( V_63 % 1000 ) * 1000 ;
V_50 -> V_78 = V_61 ;
V_50 -> V_53 = V_49 ;
V_50 -> V_92 = V_93 ;
for ( V_87 = 0 ; V_87 < V_94 ; V_87 ++ ) {
if ( V_95 [ V_87 ] . V_86 == V_86 ) {
V_50 -> V_92 = V_95 [ V_87 ] . V_96 ;
}
}
switch ( V_50 -> V_92 ) {
case V_21 :
V_50 -> V_79 . V_84 . V_81 = 0 ;
break;
}
