...
V_46 != V_51 && V_46 != V_52 &&
V_46 != V_53 && V_46 != V_54 &&
V_46 != V_57 && V_46 != V_55 && V_46 != V_56 &&
V_46 != V_58 && V_46 != V_59 && V_46 != V_60 && V_46 != V_61 &&
V_46 != V_62 )
{
if ( V_23 ) {
F_19 ( V_23 ) ;
...
if( V_46 == V_52 || V_46 == V_51 ) {
if( ! strchr ( V_44 , '.' ) || ! V_23 ) {
T_3 * V_63 ;
if ( V_23 ) {
F_19 ( V_23 ) ;
}
V_63 = F_56 ( V_44 , T_12 -> string , NULL ) ;
V_23 = F_57 ( V_1 , V_63 , FALSE , & V_32 ) ;
F_20 ( F_18 ( V_42 ) , V_22 , V_23 ) ;
F_5 ( V_63 ) ;
F_5 ( V_45 ) ;
return V_32 ;
}
} else if( V_46 == V_62 && ! V_23 ) {
if( strlen ( V_44 ) > 1 ) {
V_44 [ strlen ( V_44 ) - 1 ] = '\0' ;
if( strchr ( V_44 , '.' ) ) {
V_23 = F_57 ( V_1 , V_44 , FALSE , NULL ) ;
F_20 ( F_18 ( V_42 ) , V_22 , V_23 ) ;
} else if( strlen ( V_44 ) && F_1 ( V_1 , ( int ) strlen ( V_44 ) + 2 ) ) {
V_23 = F_57 ( V_1 , V_44 , TRUE , NULL ) ;
F_20 ( F_18 ( V_42 ) , V_22 , V_23 ) ;
}
}
F_5 ( V_45 ) ;
...
T_3 * V_64 = F_56 ( V_44 , T_12 -> string , NULL ) ;
if( ! strchr ( V_64 , '.' ) && F_1 ( V_1 , ( int ) strlen ( V_64 ) ) ) {
V_23 = F_57 ( V_1 , V_64 , TRUE , & V_32 ) ;
F_20 ( F_18 ( V_42 ) , V_22 , V_23 ) ;
}
F_5 ( V_64 ) ;
F_5 ( V_45 ) ;
...
if( F_59 ( V_43 , & V_18 , & V_19 ) ) {
T_3 * V_68 ;
if( V_46 != V_57 || strchr ( V_44 , '.' ) ) {
F_14 ( V_18 , & V_19 , 0 , & V_68 , - 1 ) ;
F_6 ( V_1 , V_68 ) ;
F_5 ( V_68 ) ;
}
if( V_46 != V_57 ) {
...
break;
case V_62 :
F_69 ( V_1 , V_13 , V_23 , V_44 , V_42 ) ;
break;
default: {
T_3 * V_69 ;
V_69 = F_56 ( V_44 , T_12 -> string , NULL ) ;
if( ! F_39 ( V_1 , V_23 , V_13 , V_69 , & V_32 ) ) {
F_19 ( V_23 ) ;
F_20 ( F_18 ( V_42 ) , V_22 , NULL ) ;
}
F_5 ( V_69 ) ;
...
const T_3 * V_70 , T_1 V_71 , T_1 * V_32 )
{
void * V_72 , * V_73 ;
T_21 * V_74 ;
unsigned int V_75 ;
...
const T_3 * V_36 = NULL ;
int V_3 ;
V_75 = ( unsigned int ) strlen ( V_70 ) ;
if( V_70 [ V_75 - 1 ] == '.' )
F_71 ( V_70 ) ;
for ( V_3 = F_72 ( & V_72 ) ; V_3 != - 1 ; V_3 = F_73 ( & V_72 ) ) {
V_74 = F_74 ( V_3 ) ;
if ( ! F_75 ( V_74 ) )
continue;
if ( V_71 ) {
const T_3 * V_64 = F_76 ( V_3 ) ;
if ( ! F_41 ( V_70 , V_64 , V_75 ) ) {
F_35 ( V_13 , V_64 ) ;
if ( strlen ( V_64 ) == V_75 ) {
V_39 = TRUE ;
}
...
for ( V_76 = F_77 ( V_3 , & V_73 ) ;
V_76 != NULL ;
V_76 = F_78 ( & V_73 ) )
{
if ( V_76 -> V_77 != - 1 )
continue;
if( ! F_41 ( V_70 , V_76 -> V_78 , V_75 ) ) {
F_35 ( V_13 , V_76 -> V_78 ) ;
if ( strlen ( V_76 -> V_78 ) == V_75 ) {
V_39 = TRUE ;
}
V_37 ++ ;
if ( V_37 == 1 )
...
if ( V_37 == 1 && ! V_39 && V_32 &&
strncmp ( V_70 , V_36 , V_75 ) == 0 )
{
* V_32 = F_22 ( V_1 , V_23 , V_36 , V_75 ) ;
}
...
F_82 ( T_9 * V_18 )
{
F_80 ( F_81 ( V_18 ) , 0 , V_80 ) ;
}
static T_2 *
F_57 ( T_2 * V_1 , const T_3 * V_70 ,
T_1 V_71 , T_1 * V_32 )
{
T_2 * V_23 ;
T_2 * V_13 ;
...
V_23 = F_83 ( V_85 ) ;
V_81 = F_84 ( NULL , NULL ) ;
F_85 ( F_86 ( V_81 ) , V_86 , V_86 ) ;
F_87 ( F_86 ( V_81 ) , V_87 ) ;
F_88 ( F_89 ( V_23 ) , V_81 ) ;
V_13 = F_90 () ;
F_91 ( F_29 ( V_13 ) , TRUE ) ;
F_25 ( V_13 ) ;
F_20 ( F_18 ( V_23 ) , V_65 , V_13 ) ;
if ( ! F_70 ( V_1 , V_13 , V_23 , V_70 , V_71 , V_32 ) ) {
F_19 ( V_23 ) ;
return NULL ;
}
V_18 = F_12 ( F_29 ( V_13 ) ) ;
...
F_92 ( V_1 , L_11 , F_93 ( F_21 ) , V_42 ) ;
F_92 ( V_23 , L_12 , F_93 ( V_88 ) , NULL ) ;
#if F_46 ( 3 , 0 , 0 )
F_47 ( V_13 , & V_33 , NULL ) ;
#else
F_48 ( V_13 , & V_33 ) ;
...
F_50 ( V_23 , V_84 . V_40 ,
( V_33 . V_41 < 200 ? V_33 . V_41 + 8 : 200 ) ) ;
F_51 ( F_52 ( V_23 ) , V_84 . V_40 ,
( V_33 . V_41 < 200 ? V_33 . V_41 + 8 : 200 ) ) ;
F_94 ( F_95 ( V_1 ) , & V_82 , & V_83 ) ;
#if F_46 ( 3 , 0 , 0 )
V_82 += V_84 . V_89 ;
V_83 += ( V_84 . V_90 + V_84 . V_41 ) ;
#else
V_83 += V_84 . V_41 ;
#endif
F_96 ( F_52 ( V_23 ) , V_82 , V_83 ) ;
F_97 ( V_23 ) ;
V_43 = F_58 ( F_29 ( V_13 ) ) ;
F_65 ( V_43 ) ;
return V_23 ;
...
F_98 ( V_29 ) ;
F_79 ( V_18 ) ;
if ( ! F_70 ( V_1 , V_27 , V_23 , V_44 , V_71 , NULL ) ) {
F_19 ( V_23 ) ;
F_20 ( F_18 ( V_91 ) , V_22 , NULL ) ;
return;
}
