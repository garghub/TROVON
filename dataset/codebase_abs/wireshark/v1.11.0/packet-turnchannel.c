...
F_5 ( V_2 -> V_11 , V_13 , L_2 , V_6 ) ;
V_8 = F_6 ( V_3 , V_14 , V_1 , 0 , - 1 , V_15 ) ;
V_9 = F_7 ( V_8 , V_16 ) ;
F_8 ( V_9 , V_17 , V_1 , 0 , 2 , V_6 ) ;
F_8 ( V_9 , V_18 , V_1 , 2 , 2 , V_7 ) ;
if ( V_5 > V_10 ) {
T_1 * V_19 ;
T_5 V_20 , V_21 ;
V_21 = F_9 ( V_1 , V_10 ) ;
...
V_19 = F_11 ( V_1 , V_10 , V_21 ,
V_20 ) ;
if ( ! F_12 ( V_22 ,
V_19 , V_2 , V_3 , NULL ) ) {
F_13 ( V_23 , V_19 , V_2 , V_3 ) ;
}
}
return F_2 ( V_1 ) ;
}
...
static T_5
F_15 ( T_2 * V_2 V_4 , T_1 * V_1 , int V_24 )
{
