...
F_23 ( & T_4 , V_76 ) ;
F_24 ( & T_4 , & V_43 -> V_82 , F_25 ( V_75 , & V_43 -> V_83 ) , V_75 , NULL ) ;
V_28 = T_4 . V_84 . V_28 ;
F_26 ( & T_4 ) ;
F_12 ( & V_69 ) ;
if ( V_69 . V_70 == 0 ) {
...
struct V_85 * F_28 ( double V_89 , unsigned int V_87 )
{
struct V_85 * V_88 ;
...
void F_29 ( struct V_85 * * V_90 , struct V_85 * V_91 )
{
struct V_85 * V_88 , * V_86 = * V_90 ;
for ( V_88 = V_86 ; V_88 ; V_88 = V_88 -> V_23 ) {
if ( ! V_88 -> V_23 )
break;
}
...
void F_30 ( struct V_85 * * V_90 , struct V_85 * V_92 )
{
struct V_85 * V_88 , * V_86 = * V_90 ;
if ( ! V_92 || ! V_86 )
return;
