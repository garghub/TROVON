...
if ( V_14 - V_4 > 0 )
V_20 = V_14 - V_4 ;
V_6 = F_11 ( V_3 , V_1 , V_4 , V_20 , L_1 ) ;
V_30 = F_12 ( V_6 , V_32 ) ;
while ( V_4 < V_14 - 2 )
{
V_29 = F_9 ( V_1 , V_4 ) ;
V_6 = F_13 ( V_30 , V_33 , V_1 , V_4 , 1 ,
V_29 , L_2 , F_14 ( V_29 ,
V_34 , L_3 ) ) ;
V_31 = F_12 ( V_6 , V_35 ) ;
V_4 += 1 ;
...
static T_10
F_18 ( T_2 * V_2 V_120 , T_1 * V_1 , T_4 V_4 V_120 )
{
return F_2 ( V_1 , 0 ) + 8 ;
}
static void
...
F_14 ( V_124 , V_126 , L_3 ) , V_14 ) ;
V_6 = F_3 ( V_3 , V_127 , V_1 , 0 , - 1 , V_25 ) ;
V_30 = F_12 ( V_6 , V_128 ) ;
V_6 = F_11 ( V_30 , V_1 , 0 , 8 , L_8 ) ;
V_122 = F_12 ( V_6 , V_129 ) ;
F_3 ( V_122 , V_36 , V_1 , 0 , 4 , V_8 ) ;
F_3 ( V_122 , V_130 , V_1 , 4 , 4 , V_8 ) ;
V_121 = F_11 ( V_30 , V_1 , V_4 , - 1 , L_9 ) ;
V_123 = F_12 ( V_121 , V_131 ) ;
switch ( V_124 )
{
case V_132 :
...
static int
F_24 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 , void * T_11 V_120 )
{
T_4 V_14 ;
T_5 V_124 ;
V_14 = F_25 ( V_1 ) ;
...
return 0 ;
V_124 = F_2 ( V_1 , 4 ) ;
if ( F_26 ( V_124 , V_126 ) == NULL )
return 0 ;
if ( V_3 )
{
F_27 ( V_1 , V_2 , V_3 , V_198 , 4 ,
F_18 , F_19 ) ;
}
return V_14 ;
}
...
{ & V_130 ,
{ L_12 , L_13 ,
V_201 , V_202 , F_29 ( V_126 ) , 0x0 , NULL , V_203 } } ,
{ & V_57 ,
{ L_14 , L_15 ,
V_201 , V_202 , F_29 ( V_54 ) ,
0x0 , NULL , V_203 } } ,
{ & V_51 ,
{ L_16 , L_17 ,
V_201 , V_202 , NULL , 0x0 , NULL , V_203 } } ,
...
{ & V_19 ,
{ L_90 , L_91 ,
V_207 , V_202 , F_29 ( V_208 ) , 0x0 , NULL , V_203 } } ,
{ & V_68 ,
{ L_92 , L_93 ,
V_201 , V_202 , NULL , 0x0 ,
L_94 , V_203 } } ,
...
{ & V_71 ,
{ L_136 , L_137 ,
V_206 , 32 , F_30 ( & V_212 ) , 0x01 , NULL , V_203 } } ,
{ & V_73 ,
{ L_138 , L_139 ,
V_201 , V_202 , F_29 ( V_213 ) , 0x0 ,
L_140 , V_203 } } ,
{ & V_75 ,
{ L_141 , L_142 ,
V_201 , V_202 , F_29 ( V_214 ) , 0x0 ,
L_143 , V_203 } } ,
{ & V_77 ,
{ L_144 , L_145 ,
V_201 , V_202 , F_29 ( V_205 ) , 0x0 ,
...
{ & V_22 ,
{ L_229 , L_230 ,
V_220 , V_202 , F_29 ( V_221 ) , 0x0 ,
L_231 , V_203 } } ,
{ & V_23 ,
{ L_232 , L_233 ,
V_220 , V_202 , F_29 ( V_222 ) , 0x0 ,
L_234 , V_203 } } ,
{ & V_27 ,
{ L_235 , L_236 ,
V_201 , V_202 , F_29 ( V_223 ) , 0x0 , NULL , V_203 } } ,
{ & V_28 ,
{ L_237 , L_238 ,
V_201 , V_202 , F_29 ( V_224 ) , 0x0 ,
L_239
L_240 , V_203 } } ,
{ & V_39 ,
{ L_241 , L_242 ,
...
static T_14 V_226 [] = {
{ & V_9 , { L_244 , V_227 , V_228 , L_245 , V_229 } } ,
{ & V_10 , { L_246 , V_227 , V_228 ,
L_247 , V_229 } } ,
{ & V_11 , { L_248 , V_227 , V_228 , L_249 , V_229 } } ,
{ & V_12 , { L_250 , V_227 , V_228 , L_251 , V_229 } } ,
{ & V_13 , { L_252 , V_227 , V_230 , L_253 , V_229 } } ,
{ & V_37 , { L_254 , V_231 , V_232 , L_255 , V_229 } } ,
{ & V_56 , { L_256 , V_227 , V_230 , L_257 , V_229 } } ,
{ & V_119 , { L_258 , V_227 , V_230 , L_259 , V_229 } } ,
{ & V_151 , { L_260 , V_227 , V_230 , L_261 , V_229 } } ,
{ & V_152 , { L_262 , V_227 , V_230 , L_263 , V_229 } } ,
} ;
T_15 * V_233 ;
V_127 = F_31 ( L_264 , L_6 , L_265 ) ;
F_32 ( V_127 , V_200 , F_33 ( V_200 ) ) ;
F_34 ( V_225 , F_33 ( V_225 ) ) ;
V_233 = F_35 ( V_127 ) ;
F_36 ( V_233 , V_226 , F_33 ( V_226 ) ) ;
V_234 = F_37 ( L_265 , F_24 , V_127 ) ;
V_199 = F_38 ( V_127 , NULL ) ;
F_39 ( V_199 , L_266 , L_267 ,
L_268 ,
10 , & V_235 ) ;
F_40 ( V_199 , L_269 ,
L_270 ,
...
F_42 ( L_272 , V_236 , V_234 ) ;
if ( V_235 != 0 && V_236 != V_235 )
F_43 ( L_272 , V_235 , V_234 ) ;
V_236 = V_235 ;
}
