...
static void F_11 ( T_2 * V_1 , T_3 * V_6 , T_4 V_7 , T_4 V_8 , T_4 V_9 )
{
T_5 * V_10 ;
T_3 * V_11 ;
T_4 V_2 ;
...
F_12 ( V_11 , ( * V_14 [ V_7 ] . V_18 ) , V_1 , V_2 , V_9 - V_2 , V_34 ) ;
V_35 = ( V_34 & 0xF0 ) >> 4 ;
F_13 ( V_42 , V_34 , ( V_35 <= 0x07 ? 0xC0 : 0xF0 ) , 8 ) ;
F_14 ( V_11 , V_43 , V_1 , V_2 , 1 ,
V_35 , L_46 , V_42 , F_15 ( V_43 ) -> V_44 ,
F_16 ( V_35 , V_45 , L_47 ) , V_35
) ;
if ( V_35 <= 0x07 )
{
V_36 = ( V_34 & 0x20 ) >> 5 ;
F_13 ( V_42 , V_34 , 0x20 , 8 ) ;
F_14 ( V_11 , V_46 , V_1 , V_2 , 1 ,
V_36 , L_46 , V_42 , F_15 ( V_46 ) -> V_44 ,
F_16 ( V_36 , V_47 , L_47 ) , V_36
) ;
V_37 = ( V_34 & 0x10 ) >> 4 ;
F_13 ( V_42 , V_34 , 0x10 , 8 ) ;
F_14 ( V_11 , V_48 , V_1 , V_2 , 1 ,
V_37 , L_46 , V_42 , F_15 ( V_48 ) -> V_44 ,
F_16 ( V_37 , V_49 , L_47 ) , V_37
) ;
V_38 = ( V_34 & 0x0C ) >> 2 ;
F_13 ( V_42 , V_34 , 0x0C , 8 ) ;
F_14 ( V_11 , V_50 , V_1 , V_2 , 1 ,
V_38 , L_46 , V_42 , F_15 ( V_50 ) -> V_44 ,
F_16 ( V_38 , V_51 , L_47 ) , V_38
) ;
if ( V_37 )
{
V_39 = ( V_34 & 0x03 ) ;
F_13 ( V_42 , V_34 , 0x03 , 8 ) ;
F_14 ( V_11 , V_52 , V_1 , V_2 , 1 ,
V_39 , L_46 , V_42 , F_15 ( V_52 ) -> V_44 ,
F_16 ( V_39 , V_53 , L_47 ) , V_39
) ;
}
}
...
{
V_40 = ( V_34 & 0x04 ) >> 2 ;
F_13 ( V_42 , V_34 , 0x04 , 8 ) ;
F_14 ( V_11 , V_54 , V_1 , V_2 , 1 ,
V_40 , L_46 , V_42 , F_15 ( V_54 ) -> V_44 ,
F_16 ( V_40 , V_55 , L_47 ) , V_40
) ;
V_41 = ( V_34 & 0x03 ) ;
F_13 ( V_42 , V_34 , 0x03 , 8 ) ;
F_14 ( V_11 , V_56 , V_1 , V_2 , 1 ,
V_41 , L_46 , V_42 , F_15 ( V_56 ) -> V_44 ,
F_16 ( V_41 , V_57 , L_47 ) , V_41
) ;
}
else if ( V_35 == 0x0F )
{
...
static void
F_17 ( T_2 * V_1 , T_3 * V_6 , T_4 V_58 , T_7 V_59 , T_8 V_60 , T_8 V_61 , T_8 V_62 )
{
T_1 V_63 = 0 ;
T_4 V_64 ;
T_4 V_2 = 0 ;
...
if ( V_6 )
{
V_65 = F_18 ( V_6 , V_67 , V_1 , 0 , V_58 + 1 , V_68 ) ;
V_66 = F_5 ( V_65 , V_69 ) ;
F_12 ( V_66 , V_70 , V_1 , V_71 , V_72 , V_61 ) ;
F_12 ( V_66 , V_73 , V_1 , V_74 , V_75 , V_62 ) ;
}
V_2 = V_74 + V_75 ;
while ( V_2 < V_58 && F_2 ( V_1 , V_2 ) == V_76 )
{
V_9 = F_19 ( V_1 , V_2 + 1 , V_58 , V_76 ) ;
if ( V_9 == - 1 )
break;
...
if ( V_6 && V_60 != V_76 )
{
F_12 ( V_66 , V_78 , V_1 , V_58 - 2 , 2 , V_59 ) ;
}
}
static void
F_21 ( T_2 * V_1 , T_9 * V_79 , T_3 * V_6 )
{
T_8 V_61 = 0 ;
T_8 V_62 = 0 ;
T_7 V_59 = 0 ;
...
T_10 V_81 = TRUE ;
T_8 V_60 , V_82 , V_83 ;
V_58 = F_19 ( V_1 , V_74 + V_75 , - 1 , V_84 ) ;
if ( V_58 == - 1 ) return;
...
V_59 = ( F_22 ( F_2 ( V_1 , V_58 - 2 ) ) << 4 ) + F_22 ( F_2 ( V_1 , V_58 - 1 ) ) ;
for (; V_2 < ( V_58 - 2 ) ; V_2 ++ )
{
V_80 += F_2 ( V_1 , V_2 ) ;
V_80 &= 0xFF ;
...
F_23 ( V_79 -> V_85 , V_86 , L_48 ) ;
if ( V_81 )
F_24 ( V_79 -> V_85 , V_87 , F_16 ( V_61 , V_88 , L_47 ) ) ;
else
F_25 ( V_79 -> V_85 , V_87 , L_49 , F_16 ( V_61 , V_88 , L_47 ) , L_50 ) ;
F_17 ( V_1 , V_6 , V_58 , V_59 , V_60 , V_61 , V_62 ) ;
}
static T_10
F_26 ( T_2 * V_1 , T_9 * V_79 , T_3 * V_6 , void * T_11 V_89 )
{
int V_58 ;
T_8 V_90 = 0 ;
if ( F_27 ( V_1 ) < V_91 )
...
if ( F_2 ( V_1 , 0 ) != V_92 )
return FALSE ;
V_58 = F_19 ( V_1 , V_71 , - 1 , V_84 ) ;
if ( V_58 == - 1 )
{
return FALSE ;
}
V_90 = F_1 ( V_1 , V_71 , V_72 ) ;
if ( F_28 ( V_90 , V_88 ) == NULL )
return FALSE ;
if ( F_2 ( V_1 , V_71 + V_72 ) != V_93 )
return FALSE ;
...
{
V_104 [ V_5 ] = - 1 ;
V_102 [ V_5 + 1 ] = & ( V_104 [ V_5 ] ) ;
V_14 [ V_5 ] . V_15 = & ( V_104 [ V_5 ] ) ;
V_14 [ V_5 ] . V_18 = & ( V_101 [ V_5 ] ) ;
V_14 [ V_5 ] . V_77 = V_105 [ V_5 ] ;
} ;
V_67 = F_30 ( L_147 , L_48 , L_148 ) ;
F_31 ( V_67 , V_94 , F_32 ( V_94 ) ) ;
F_33 ( V_102 , F_32 ( V_102 ) ) ;
}
void
F_34 ( void )
{
T_13 V_106 ;
F_35 ( L_149 , F_26 , V_67 ) ;
V_106 = F_36 ( F_21 , V_67 ) ;
F_37 ( L_150 , V_106 ) ;
}
