...
const T_13 * V_219 ;
T_16 * V_220 ;
V_220 = F_61 ( T_10 -> V_221 ) ;
F_62 ( V_220 ) ;
V_218 = F_63 ( V_4 , V_30 ) ;
V_219 = F_64 ( V_218 , F_65 ( V_222 ) ) ;
if ( V_219 ) {
F_27 ( V_220 -> V_223 , L_28 , V_219 ) ;
}
V_30 += 2 ;
return V_30 ;
}
...
static T_17 * F_67 ( const T_13 * V_224 ) {
T_17 * V_225 = NULL ;
T_17 * V_226 ;
for ( V_226 = V_227 ; V_226 -> V_224 ; V_226 ++ ) {
if ( ! strcmp ( V_224 , V_226 -> V_224 ) ) { V_225 = V_226 ; break; }
}
return V_225 ;
}
static void
...
if ( V_2 ) {
T_17 * V_225 ;
V_225 = F_67 ( T_10 -> V_228 ) ;
if ( V_225 ) {
F_27 ( V_220 -> V_223 , L_29 , V_225 -> V_19 ) ;
F_27 ( F_69 ( F_70 ( V_2 ) ) , L_30 , V_225 -> V_19 ) ;
} else {
F_27 ( V_220 -> V_223 , L_31 , T_10 -> V_228 ) ;
}
}
}
static void F_71 ( T_2 V_229 ) {
if ( V_229 >= 96 && V_229 <= 127 )
F_72 ( L_32 , V_229 , V_230 ) ;
}
static void F_73 ( T_2 V_229 ) {
if ( V_229 >= 96 && V_229 <= 127 )
F_74 ( L_32 , V_229 , V_230 ) ;
}
void
F_75 ( void )
{
...
{ & V_201 ,
{ L_33 , L_34 ,
V_234 , 8 , F_76 ( & V_235 ) , 0x80 ,
NULL , V_236 }
} ,
{ & V_202 ,
{ L_35 , L_36 ,
V_237 , V_24 , NULL , 0x60 ,
NULL , V_236 }
} ,
{ & V_203 ,
{ L_37 , L_38 ,
V_237 , V_24 , F_65 ( V_197 ) , 0x1f ,
NULL , V_236 }
} ,
{ & V_205 ,
{ L_39 , L_40 ,
V_234 , 8 , F_76 ( & V_238 ) , 0x80 ,
NULL , V_236 }
} ,
{ & V_206 ,
{ L_41 , L_42 ,
V_234 , 8 , F_76 ( & V_239 ) , 0x40 ,
NULL , V_236 }
} ,
{ & V_207 ,
{ L_43 , L_44 ,
V_237 , V_24 , NULL , 0x20 ,
NULL , V_236 }
} ,
{ & V_99 ,
{ L_45 , L_46 ,
...
{ & V_103 ,
{ L_53 , L_54 ,
V_237 , V_24 , NULL , 0x80 ,
NULL , V_236 }
} ,
{ & V_104 ,
{ L_55 , L_56 ,
V_237 , V_24 , NULL , 0x40 ,
NULL , V_236 }
} ,
{ & V_105 ,
{ L_57 , L_58 ,
...
{ & V_106 ,
{ L_59 , L_60 ,
V_237 , V_24 , NULL , 0x10 ,
NULL , V_236 }
} ,
{ & V_107 ,
{ L_61 , L_62 ,
V_237 , V_24 , NULL , 0x0f ,
NULL , V_236 }
} ,
{ & V_108 ,
{ L_63 , L_64 ,
V_237 , V_24 , NULL , 0xff ,
NULL , V_236 }
} ,
{ & V_179 ,
{ L_65 , L_66 ,
...
static T_21 V_261 [] = {
{ & V_115 , { L_284 , V_262 , V_263 , L_285 , V_264 } } ,
} ;
V_198 = F_77 ( L_286 , L_21 , L_287 ) ;
F_78 ( V_198 , V_233 , F_79 ( V_233 ) ) ;
F_80 ( V_260 , F_79 ( V_260 ) ) ;
V_232 = F_81 ( V_198 ) ;
F_82 ( V_232 , V_261 , F_79 ( V_261 ) ) ;
V_231 = F_83 ( V_198 , V_265 ) ;
F_84 ( V_231 , L_288 ,
L_289 ,
L_290
L_291 ,
...
V_265 ( void )
{
static T_22 * V_267 = NULL ;
static T_1 V_268 = FALSE ;
if ( ! V_268 ) {
T_23 V_269 ;
T_17 * V_225 ;
V_230 = F_86 ( L_287 ) ;
F_87 ( L_292 , L_21 , V_230 ) ;
V_269 = F_88 ( F_68 , V_198 ) ;
for ( V_225 = V_227 ; V_225 -> V_224 ; V_225 ++ ) {
if ( V_225 -> V_19 )
F_87 ( L_293 , V_225 -> V_224 , V_269 ) ;
if ( V_225 -> V_270 )
F_87 ( L_294 , V_225 -> V_224 , F_89 ( V_225 -> V_270 , V_198 ) ) ;
}
V_268 = TRUE ;
} else {
F_90 ( V_267 , F_71 ) ;
