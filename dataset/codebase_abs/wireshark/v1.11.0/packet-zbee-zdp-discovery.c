...
T_3 * V_15 = NULL ;
T_4 V_4 = 0 , V_16 ;
T_4 V_17 = ( V_2 -> V_18 >= V_19 ) ? ( int ) sizeof( T_6 ) : ( int ) sizeof( V_8 ) ;
T_6 V_10 ;
T_6 V_20 ;
V_8 V_21 ;
V_8 V_22 ;
...
F_3 ( V_3 , V_9 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( ( V_3 ) && ( V_51 ) ) {
V_14 = F_13 ( V_3 , V_1 , V_4 , V_51 * ( int ) sizeof( T_6 ) , L_10 ) ;
V_15 = F_14 ( V_14 , V_53 ) ;
}
...
V_45 = F_3 ( V_3 , V_46 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( V_3 && V_45 ) {
V_14 = F_13 ( V_3 , V_1 , V_4 , V_45 * ( int ) sizeof( V_8 ) , L_14 ) ;
V_15 = F_14 ( V_14 , V_47 ) ;
}
for ( V_16 = 0 ; V_16 < V_45 ; V_16 ++ ) {
( void ) F_3 ( V_15 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
...
V_45 = F_3 ( V_3 , V_46 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( V_3 && V_45 ) {
V_14 = F_13 ( V_3 , V_1 , V_4 , V_45 * ( int ) sizeof( V_8 ) , L_15 ) ;
V_15 = F_14 ( V_14 , V_47 ) ;
}
for ( V_16 = 0 ; V_16 < V_45 ; V_16 ++ ) {
( void ) F_3 ( V_15 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
...
for ( V_16 = V_60 ; ( V_16 < V_21 ) && F_41 ( V_1 , V_4 , V_17 ) ; V_16 ++ ) {
F_3 ( V_3 , V_26 , V_1 , & V_4 , V_17 , NULL ) ;
}
for ( V_16 -= V_21 ; ( V_16 < V_22 ) && F_41 ( V_1 , V_4 , V_17 ) ; V_16 ++ ) {
...
V_14 = F_13 ( V_3 , V_1 , V_4 , V_45 * ( int ) sizeof( V_8 ) , L_14 ) ;
V_15 = F_14 ( V_14 , V_47 ) ;
for ( V_16 = V_60 ; ( V_16 < V_45 ) && F_41 ( V_1 , V_4 , ( int ) sizeof( V_8 ) ) ; V_16 ++ ) {
( void ) F_3 ( V_15 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
}
}
F_4 ( V_3 , V_2 , L_2 , V_10 ) ;
