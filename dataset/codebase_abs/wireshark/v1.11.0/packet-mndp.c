...
static int
F_12 ( T_5 * V_9 , T_6 * V_10 , T_7 * V_33 )
{
T_9 * V_34 ;
T_7 * V_11 ;
T_2 V_12 = 0 ;
T_2 V_35 ;
F_13 ( V_10 -> V_36 , V_37 , V_38 ) ;
V_35 = F_14 ( V_9 ) ;
V_34 = F_9 ( V_33 , V_39 , V_9 , V_12 , - 1 ,
V_31 ) ;
V_11 = F_8 ( V_34 , V_40 ) ;
F_9 ( V_11 , V_41 , V_9 , V_12 , 2 ,
V_31 ) ;
V_12 += 2 ;
F_9 ( V_11 , V_42 , V_9 , V_12 , 2 ,
V_25 ) ;
V_12 += 2 ;
while ( V_12 < V_35 ) {
...
static int
F_17 ( T_5 * V_9 , T_6 * V_10 , T_7 * V_33 , void * T_12 V_13 )
{
if ( ! F_15 ( V_9 ) ) {
return 0 ;
}
return F_12 ( V_9 , V_10 , V_33 ) ;
}
void
F_18 ( void )
{
...
V_39 = F_20 ( V_66 , V_38 , L_32 ) ;
F_21 ( V_39 , V_44 , F_22 ( V_44 ) ) ;
F_23 ( V_65 , F_22 ( V_65 ) ) ;
}
void
F_24 ( void )
