...
if( ! V_36 -> V_96 -> V_4 . V_97 ) {
if( V_4 & V_10 ) {
V_86 = F_27 ( F_28 () , T_13 ) ;
V_86 -> V_98 = V_36 -> V_96 -> V_99 ;
V_86 -> V_100 = 0 ;
V_86 -> V_101 = V_36 -> V_96 -> V_102 ;
F_31 ( V_85 -> V_95 , V_83 , ( void * ) V_86 ) ;
} else {
V_86 = ( T_13 * ) F_32 ( V_85 -> V_95 , V_83 ) ;
if( V_86 ) {
V_86 -> V_100 = V_36 -> V_96 -> V_99 ;
}
}
} else {
V_86 = ( T_13 * ) F_32 ( V_85 -> V_95 , V_83 ) ;
...
if( V_86 -> V_100 ) {
T_4 * V_103 ;
V_103 = F_2 ( V_80 , V_104 , V_2 , 0 , 0 , V_86 -> V_100 ) ;
F_34 ( V_103 ) ;
}
} else {
if( V_86 -> V_98 ) {
T_4 * V_103 ;
T_14 V_105 ;
V_103 = F_2 ( V_80 , V_106 , V_2 , 0 , 0 , V_86 -> V_98 ) ;
F_34 ( V_103 ) ;
F_35 ( & V_105 , & V_36 -> V_96 -> V_102 , & V_86 -> V_101 ) ;
V_103 = F_36 ( V_80 , V_107 , V_2 , 0 , 0 , & V_105 ) ;
F_34 ( V_103 ) ;
}
}
F_15 ( V_80 , V_108 , V_2 , V_3 , 2 , V_61 ) ;
V_3 += 2 ;
F_15 ( V_80 , V_109 , V_2 , V_3 , 2 , V_59 ) ;
V_3 += 2 ;
...
V_81 ) ;
V_3 += 2 ;
F_15 ( V_80 , V_111 , V_2 , V_3 , 4 , V_59 ) ;
V_3 += 4 ;
...
T_1 * V_37 ;
T_4 * V_114 ;
V_113 = F_16 ( V_2 , V_3 , V_39 , V_39 ) ;
V_114 = F_12 ( V_80 , V_2 , V_3 , V_39 , L_20 ) ;
V_37 = F_3 ( V_114 , V_66 ) ;
if ( V_37 != NULL ) {
F_8 ( V_113 , V_36 , V_37 ) ;
}
...
static int
F_37 ( T_2 * V_2 , T_7 * V_36 , T_1 * V_79 , void * V_68 V_115 )
{
T_3 V_116 ;
T_6 V_82 ;
T_3 V_4 ;
