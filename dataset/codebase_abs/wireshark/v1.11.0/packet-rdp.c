...
if ( V_7 -> V_15 & V_20 ) {
string = F_7 ( F_8 () , V_1 , V_2 , V_8 , V_19 ) ;
F_9 ( V_14 , L_2 , string ) ;
}
if ( V_7 -> V_15 & V_21 ) {
T_3 * V_22 ;
if ( V_7 -> V_13 != - 1 )
V_22 = F_10 ( V_14 , V_7 -> V_13 ) ;
else
F_5 ( L_3 ) ;
if ( V_7 -> V_23 )
...
static int
F_14 ( T_1 * V_1 , int V_2 , T_2 * V_3 , T_3 * V_4 , T_7 V_34 , T_8 * V_35 )
{
T_3 * V_22 ;
T_6 * V_14 ;
T_9 V_36 = 0 ;
...
T_4 V_53 [] = {
F_16 ( V_54 , 8 ) ,
F_17 ( V_55 , 4 , V_56 , V_41 ) ,
V_28
} ;
T_4 V_57 [] = {
F_17 ( V_58 , 12 , V_59 , V_53 ) ,
V_28
} ;
...
V_22 = F_10 ( V_14 , V_64 ) ;
if ( V_35 )
V_35 -> V_65 = F_18 ( V_36 , V_66 ) ;
for ( V_62 = 0 ; V_62 < F_18 ( V_36 , V_66 ) ; V_62 ++ ) {
if ( V_35 ) {
V_35 -> V_67 [ V_62 ] . V_68 = - 1 ;
V_35 -> V_67 [ V_62 ] . V_69 = F_19 ( F_8 () , V_1 , V_2 , 8 ) ;
}
...
static int
F_20 ( T_1 * V_1 , int V_2 , T_2 * V_3 , T_3 * V_4 , T_9 * V_70 ) {
T_9 V_15 = 0 ;
T_4 V_71 [] = {
...
static int
F_22 ( T_1 * V_1 , int V_2 , T_2 * V_3 , T_3 * V_4 , T_8 * V_35 , T_10 V_83 , T_9 * V_70 ) {
T_4 V_84 [] = {
...
T_4 V_53 [] = {
F_15 ( V_106 , 4 , V_34 ) ,
F_17 ( V_107 , 4 , V_108 , V_96 ) ,
V_28
} ;
T_4 V_109 [] = {
F_17 ( V_110 , 8 , V_111 , V_53 ) ,
F_21 ( V_112 , - 1 ) ,
V_28
} ;
...
if ( V_113 != V_160 )
F_13 ( V_3 -> V_32 , V_33 , L_4 , F_25 ( V_113 , V_161 , L_6 ) ) ;
V_5 = NULL ;
switch( V_113 ) {
case V_162 :
break;
...
if ( V_113 == V_160 )
F_13 ( V_3 -> V_32 , V_33 , L_4 , F_25 ( V_115 , V_185 , L_6 ) ) ;
return V_2 ;
}
static int
F_26 ( T_1 * V_1 , int V_2 , T_2 * V_3 , T_3 * V_4 , T_9 V_186 ) {
T_7 V_62 ;
T_9 V_187 ;
T_4 V_188 [] = {
...
V_2 = F_1 ( V_1 , V_2 , V_3 , V_4 , V_5 , 0 ) ;
V_2 = F_26 ( V_1 , V_2 , V_3 , V_4 , V_186 ) ;
...
static T_3 *
F_29 ( T_1 * V_1 , T_2 * V_3 , T_3 * V_204 )
{
T_6 * V_205 ;
T_3 * V_4 ;
F_30 ( V_3 -> V_32 , V_206 , L_7 ) ;
F_31 ( V_3 -> V_32 , V_33 ) ;
V_205 = F_6 ( V_204 , V_207 , V_1 , 0 , - 1 , V_18 ) ;
V_4 = F_10 ( V_205 , V_208 ) ;
return V_4 ;
}
static void
F_32 ( T_1 * V_1 , T_2 * V_3 , T_3 * V_4 ) {
T_6 * V_14 ;
int V_2 = 0 ;
T_9 V_15 = 0 ;
...
F_17 ( V_236 , 16 , V_237 , V_224 ) ,
F_21 ( V_238 , 4 ) ,
{ V_239 , 64 , NULL , 0 , V_20 , NULL } ,
F_17 ( V_240 , 16 , V_241 , V_224 ) ,
F_21 ( V_242 , 4 ) ,
V_28 ,
} ;
T_4 V_243 [] = {
...
if ( V_35 && ( F_35 () == V_35 -> V_314 ) ) {
V_2 = F_22 ( V_1 , V_2 , V_3 , V_4 , V_35 , FALSE , & V_15 ) ;
if ( ! ( V_15 & V_300 ) ) {
T_3 * V_22 ;
V_14 = F_6 ( V_4 , V_315 , V_1 , V_2 , - 1 , V_18 ) ;
V_22 = F_10 ( V_14 , V_316 ) ;
V_2 = F_1 ( V_1 , V_2 , V_3 , V_22 , V_283 , 0 ) ;
V_218 &= V_317 ;
if ( V_218 != V_318 )
F_13 ( V_3 -> V_32 , V_33 , L_4 , F_25 ( V_218 , V_319 , L_6 ) ) ;
switch( V_218 ) {
case V_320 :
F_27 ( V_1 , V_2 , V_3 , V_22 ) ;
break;
case V_321 :
F_28 ( V_1 , V_2 , V_3 , V_22 ) ;
break;
case V_322 :
break;
case V_318 :
F_24 ( V_1 , V_2 , V_3 , V_22 ) ;
break;
case V_323 :
break;
default:
...
F_12 ( V_1 , V_2 , V_3 , V_4 , L_13 ) ;
}
static void
F_37 ( T_1 * V_1 , T_2 * V_3 , T_3 * V_4 ) {
int V_2 = 0 ;
T_6 * V_14 ;
T_3 * V_22 ;
T_12 type ;
...
V_22 = F_10 ( V_14 , V_403 ) ;
V_396 = F_1 ( V_1 , V_2 , V_3 , V_22 , V_384 , 0 ) ;
V_35 -> V_314 = V_371 ;
F_46 ( V_3 , V_371 , F_32 , V_207 ) ;
if ( V_36 > 0 ) {
V_386 [ 0 ] . V_11 = V_36 * 2 ;
F_1 ( V_1 , V_396 , V_3 , V_22 , V_386 , 0 ) ;
if ( V_22 )
V_22 = F_10 ( V_22 -> V_29 , V_404 ) ;
...
{ & V_375 ,
{ L_103 , L_104 ,
V_416 , V_412 , F_48 ( V_399 ) , 0 ,
NULL , V_410 } } ,
{ & V_376 ,
{ L_105 , L_106 ,
V_416 , V_412 , F_48 ( V_400 ) , 0 ,
NULL , V_410 } } ,
{ & V_380 ,
{ L_107 , L_108 ,
V_416 , V_414 , NULL , 0 ,
...
{ & V_274 ,
{ L_257 , L_258 ,
V_416 , V_414 , F_48 ( V_437 ) , 0 ,
NULL , V_410 } } ,
{ & V_275 ,
{ L_259 , L_260 ,
V_416 , V_414 , F_48 ( V_438 ) , 0 ,
NULL , V_410 } } ,
{ & V_141 ,
{ L_261 , L_262 ,
V_411 , V_414 , NULL , 0 ,
...
{ & V_226 ,
{ L_385 , L_386 ,
V_411 , V_414 , F_48 ( V_464 ) , 0 ,
NULL , V_410 } } ,
{ & V_227 ,
{ L_387 , L_388 ,
V_411 , V_414 , F_48 ( V_465 ) , 0 ,
NULL , V_410 } } ,
{ & V_228 ,
{ L_389 , L_390 ,
V_411 , V_414 , F_48 ( V_466 ) , 0 ,
NULL , V_410 } } ,
{ & V_229 ,
{ L_391 , L_392 ,
V_411 , V_414 , NULL , 0 ,
...
T_14 * V_468 ;
V_207 = F_49 ( V_469 , V_470 , V_471 ) ;
F_50 ( V_207 , V_407 , F_51 ( V_407 ) ) ;
F_52 ( V_467 , F_51 ( V_467 ) ) ;
V_468 = F_53 ( V_207 , V_472 ) ;
F_54 ( V_468 , L_415 , L_416 ,
L_417
L_418 ,
10 , & V_473 ) ;
}
...
V_474 = F_56 ( L_419 ) ;
V_472 () ;
F_57 ( L_420 , F_37 , V_207 ) ;
F_57 ( L_421 , F_43 , V_207 ) ;
}
static void
V_472 ( void ) {
static T_7 V_475 = 0 ;
if ( ( V_475 > 0 ) && ( V_475 != 102 ) && V_474 )
F_58 ( L_415 , V_475 , V_474 ) ;
V_475 = V_473 ;
if ( ( V_475 > 0 ) && ( V_475 != 102 ) && V_474 )
F_59 ( L_415 , V_475 , V_474 ) ;
}
