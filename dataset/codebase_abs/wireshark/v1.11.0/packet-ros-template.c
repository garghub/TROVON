...
static void
F_34 ( T_9 * V_20 , T_10 * V_21 , T_11 * V_82 )
{
int V_51 = 0 ;
int V_83 ;
T_14 * V_27 = NULL ;
...
if( ! V_21 -> V_31 ) {
if( V_82 ) {
F_18 ( V_82 , V_20 , V_51 , - 1 ,
L_7 ) ;
}
return ;
}
V_84 = F_36 ( V_21 ) ;
V_68 = ( T_19 * ) F_37 ( V_84 , V_88 ) ;
if ( V_68 == NULL ) {
V_68 = ( T_19 * ) F_38 ( sizeof( T_19 ) ) ;
V_68 -> V_74 = F_39 ( F_22 , F_23 ) ;
V_68 -> V_75 = F_39 ( F_24 , F_25 ) ;
F_40 ( V_84 , V_88 , V_68 ) ;
V_68 -> V_89 = V_69 ;
V_69 = V_68 ;
}
if( V_82 ) {
V_27 = F_10 ( V_82 , V_88 , V_20 , 0 , - 1 , V_32 ) ;
V_22 = F_11 ( V_27 , V_90 ) ;
}
...
V_83 = V_51 ;
V_51 = F_43 ( FALSE , V_20 , V_51 , & V_85 , V_22 , - 1 ) ;
if( V_51 == V_83 ) {
V_27 = F_18 ( V_22 , V_20 , V_51 , - 1 , L_9 ) ;
if( V_27 ) {
F_44 ( V_21 , V_27 , & V_91 ) ;
V_54 = F_11 ( V_27 , V_55 ) ;
...
static T_24 V_99 [] = {
{ & V_56 , { L_19 , V_100 , V_101 , L_20 , V_102 } } ,
{ & V_91 , { L_21 , V_100 , V_101 , L_9 , V_102 } } ,
} ;
T_25 * V_103 ;
V_88 = F_49 ( V_104 , V_105 , V_106 ) ;
F_50 ( L_22 , F_34 , V_88 ) ;
F_51 ( V_88 , V_93 , F_52 ( V_93 ) ) ;
F_53 ( V_98 , F_52 ( V_98 ) ) ;
V_103 = F_54 ( V_88 ) ;
F_55 ( V_103 , V_99 , F_52 ( V_99 ) ) ;
V_53 = F_56 ( L_1 , L_23 , V_107 , V_95 ) ;
V_6 = F_39 ( V_108 , V_109 ) ;
V_10 = F_39 ( V_108 , V_109 ) ;
V_8 = F_57 ( L_22 ) ;
F_58 ( F_45 ) ;
}
void F_59 ( void ) {
