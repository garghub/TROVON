...
V_79 = TRUE ;
case V_85 :
V_77 = ( float ) F_51 ( V_65 -> V_48 , NULL ) ;
V_78 = ( float ) F_51 ( V_71 -> V_48 , NULL ) ;
if ( V_79 ) {
...
extern T_10 * F_52 ( const T_3 * V_36 ,
T_10 * V_65 ,
T_10 * V_71 ,
T_11 V_66 ) {
...
extern T_10 * F_54 ( const T_3 * V_36 , T_10 * V_65 , T_10 * V_71 , T_11 V_66 ) {
T_10 * V_70 = F_29 ( V_36 ) ;
T_12 * V_88 = NULL ;
T_12 * V_68 = NULL ;
T_14 V_8 ;
...
extern T_10 * F_55 ( T_15 V_91 , const T_3 * V_36 , T_10 * V_65 , T_10 * V_71 , T_11 V_66 ) {
T_10 * V_27 = NULL ;
switch ( V_91 ) {
case V_92 :
V_27 = F_54 ( V_36 , V_65 , V_71 , V_66 ) ;
break;
case V_93 :
...
extern void F_57 ( T_10 * V_65 , T_16 * V_71 ) {
T_10 * V_27 = NULL ;
T_12 * V_68 ;
T_12 * V_98 ;
T_12 * V_42 ;
...
V_27 = F_55 ( V_71 -> V_99 , V_65 -> V_36 , V_65 , V_71 -> V_96 , TRUE ) ;
if ( V_27 ) {
switch ( V_71 -> V_100 ) {
case V_101 :
F_36 ( V_27 , TRUE ) ;
...
extern T_17 * F_58 ( const T_3 * V_36 ) {
...
extern void F_59 ( T_17 * V_105 , T_10 * V_27 ) {
...
extern T_10 * F_62 ( T_17 * V_105 , void * * V_56 ) {
T_18 * V_59 ;
#ifdef F_25
...
extern void F_63 ( T_17 * V_105 , T_11 V_106 , T_11 V_60 ) {
T_10 * V_27 ;
#ifdef F_25
F_1 ( V_34 , 3 , V_29 , L_46 , V_105 ) ;
#endif
while( ( V_27 = F_61 ( V_105 ) ) ) {
if ( V_106 ) {
F_36 ( V_27 , V_60 ) ;
}
}
...
static T_17 * F_64 ( T_2 * V_23 , T_17 * V_105 , T_10 * V_57 , int V_107 , const T_3 * V_4 , ... ) {
T_4 V_7 ;
T_3 * V_108 ;
T_17 * V_109 = NULL ;
T_3 * V_110 ;
...
V_108 = F_65 ( V_4 , V_7 ) ;
va_end ( V_7 ) ;
V_110 = F_66 ( L_47 , V_105 -> V_36 , V_107 , V_108 ) ;
V_109 = F_58 ( V_110 ) ;
F_42 ( V_108 ) ;
F_42 ( V_110 ) ;
if ( V_23 ) fclose ( V_23 ) ;
if ( V_105 ) F_63 ( V_105 , TRUE , TRUE ) ;
if ( V_57 ) F_36 ( V_57 , TRUE ) ;
return V_109 ;
}
extern T_17 * F_67 ( T_3 * V_111 ) {
T_2 * V_23 = NULL ;
T_3 V_8 ;
int V_73 = 0 ;
V_50 V_107 = 1 ;
...
#ifndef F_68
if ( ! F_69 () ) {
return F_64 ( V_23 , V_105 , V_57 , V_107 , L_48 ) ;
}
#endif
V_119 = V_114 ;
if ( ( V_23 = F_70 ( V_111 , L_49 ) ) ) {
while( ( V_8 = ( T_3 ) fgetc ( V_23 ) ) ) {
if ( feof ( V_23 ) ) {
if ( ferror ( V_23 ) ) {
F_71 ( V_111 , V_120 ) ;
return F_64 ( V_23 , V_105 , V_57 , V_107 , L_50 , V_111 ) ;
}
break;
}
if ( V_8 == '\n' ) {
...
if ( V_73 >= V_113 - 1 ) {
return F_64 ( V_23 , V_105 , V_57 , V_107 , L_51 ) ;
}
switch( V_119 ) {
case V_118 :
switch ( V_8 ) {
...
V_36 [ V_73 ++ ] = V_8 ;
V_36 [ V_73 ] = '\0' ;
F_72 ( V_112 , sizeof( V_112 ) , L_52 , V_111 , V_107 ) ;
V_57 = F_29 ( V_112 ) ;
continue;
case '#' :
V_119 = V_118 ;
continue;
default:
return F_64 ( V_23 , V_105 , V_57 , V_107 , L_53 , V_8 ) ;
}
case V_115 :
V_73 = 0 ;
V_36 [ 0 ] = '\0' ;
...
continue;
case '\n' :
return F_64 ( V_23 , V_105 , V_57 , V_107 , L_54 ) ;
default:
return F_64 ( V_23 , V_105 , V_57 , V_107 , L_55 , V_8 ) ;
}
case V_117 :
switch ( V_8 ) {
case '\\' :
...
continue;
case '\n' :
return F_64 ( V_23 , V_105 , V_57 , V_107 , L_56 ) ;
default:
V_40 [ V_73 ++ ] = V_8 ;
continue;
}
...
F_73 ( V_111 , V_120 , FALSE ) ;
return F_64 ( NULL , V_105 , NULL , 0 , L_57 , V_111 ) ;
}
}
