...
if ( V_6 ) {
F_11 ( V_1 -> V_10 , V_11 , L_2 , V_6 ) ;
}
}
static void
F_12 ( T_1 * V_1 V_30 , T_2 * V_2 , T_3 V_3 , T_4 * V_4 ) {
F_2 ( V_4 , V_14 , V_2 , V_3 , 2 , V_8 ) ;
V_3 += 2 ;
...
V_3 += 2 ;
if ( ! V_32 ) {
F_15 ( V_1 -> V_10 , V_11 , L_3 ) ;
} else {
F_11 ( V_1 -> V_10 , V_11 , L_4 , V_32 ) ;
}
break;
case V_40 :
V_32 = F_3 ( V_2 , V_3 ) ;
...
F_11 ( V_1 -> V_10 , V_11 , L_5 , V_6 , V_33 ) ;
if ( ! V_1 -> V_41 -> V_42 . V_43 ) {
V_34 = F_16 ( V_1 -> V_41 -> V_44 , & V_1 -> V_45 , & V_1 -> V_46 , V_47 , V_33 , 0 , V_48 ) ;
F_17 ( V_34 , V_49 ) ;
}
break;
}
...
static int
F_20 ( T_2 * V_2 , T_1 * V_1 , T_4 * V_4 , void * T_11 V_30 ) {
T_4 * V_50 ;
T_12 * V_51 ;
if ( ! F_18 ( V_2 ) )
return ( 0 ) ;
F_21 ( V_1 -> V_10 , V_52 , V_53 ) ;
...
V_54 = F_24 ( V_70 , V_53 , V_71 ) ;
F_25 ( V_54 , V_58 , F_26 ( V_58 ) ) ;
F_27 ( V_69 , F_26 ( V_69 ) ) ;
F_28 ( V_71 , F_20 , V_54 ) ;
}
void
