...
V_37 = F_17 ( F_16 () , V_38 ) ;
V_37 -> V_39 = ( V_40 ) F_18 ( V_1 , V_10 ) ;
V_37 -> type = V_41 ;
V_37 -> V_42 = 0 ;
F_19 ( & V_2 -> V_43 , V_44 , sizeof( V_38 ) , ( V_45 * ) V_37 ) ;
if ( V_9 % 4 )
V_9 = V_9 + ( 4 - ( V_9 % 4 ) ) ;
V_10 += V_9 - 1 ;
return V_10 ;
...
if ( V_9 % 4 == 0 )
{
F_21 ( V_7 , V_47 , V_1 , V_10 , V_9 , F_22 ( V_1 , V_10 ) ) ;
F_23 ( & V_2 -> V_48 , V_49 , V_1 , V_10 , 4 ) ;
F_24 ( & V_2 -> V_43 , & V_2 -> V_48 ) ;
}
else
{
struct V_50 V_51 ;
F_25 ( V_1 , V_10 , & V_51 ) ;
F_26 ( V_7 , V_52 , V_1 , V_10 , V_9 , ( V_45 * ) & V_51 ) ;
F_23 ( & V_2 -> V_48 , V_53 , V_1 , V_10 , 6 ) ;
F_24 ( & V_2 -> V_43 , & V_2 -> V_48 ) ;
}
}
else if ( V_32 == 4 )
...
F_23 ( & V_2 -> V_48 , V_55 , V_1 , V_10 , V_9 ) ;
F_24 ( & V_2 -> V_43 , & V_2 -> V_48 ) ;
}
if ( V_9 % 4 )
V_9 = V_9 + ( 4 - ( V_9 % 4 ) ) ;
...
V_61 = F_17 ( F_16 () , V_38 ) ;
V_61 -> V_39 = ( V_40 ) F_18 ( V_1 , V_10 ) ;
V_61 -> type = V_41 ;
V_61 -> V_42 = 0 ;
F_19 ( & V_2 -> V_62 , V_44 , sizeof( V_38 ) , ( V_45 * ) V_61 ) ;
if ( V_9 % 4 )
V_9 = V_9 + ( 4 - ( V_9 % 4 ) ) ;
V_10 += V_9 - 1 ;
return V_10 ;
...
if ( V_9 % 4 == 0 )
{
F_21 ( V_7 , V_64 , V_1 , V_10 , V_9 , F_22 ( V_1 , V_10 ) ) ;
F_23 ( & V_2 -> V_65 , V_49 , V_1 , V_10 , 4 ) ;
F_24 ( & V_2 -> V_62 , & V_2 -> V_65 ) ;
}
else
{
struct V_50 V_51 ;
F_25 ( V_1 , V_10 , & V_51 ) ;
F_26 ( V_7 , V_66 , V_1 , V_10 , V_9 , ( V_45 * ) & V_51 ) ;
F_23 ( & V_2 -> V_65 , V_53 , V_1 , V_10 , 6 ) ;
F_24 ( & V_2 -> V_62 , & V_2 -> V_65 ) ;
}
}
else if ( V_56 == 4 )
...
F_23 ( & V_2 -> V_65 , V_55 , V_1 , V_10 , V_9 ) ;
F_24 ( & V_2 -> V_62 , & V_2 -> V_65 ) ;
}
if ( V_9 % 4 )
V_9 = V_9 + ( 4 - ( V_9 % 4 ) ) ;
