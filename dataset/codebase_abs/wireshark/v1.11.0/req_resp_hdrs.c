...
V_11 = line + 18 ;
V_23 = V_11 ;
V_24 = ( T_7 ) strlen ( V_11 ) ;
while ( V_23 < V_11 + V_24 &&
( * V_23 == ' ' || * V_23 == '\t' ) )
V_23 ++ ;
if ( V_23 <= V_11 + V_24 ) {
if ( F_8 ( V_23 , L_7 , 7 )
...
V_28 = F_6 ( F_7 () , V_1 , V_6 ,
V_10 ) ;
V_29 = V_28 ;
if ( ( V_29 = strchr ( V_29 , ';' ) ) ) {
* V_29 = '\0' ;
}
if ( sscanf ( V_28 , L_8 , & V_26 ) < 1 ) {
return TRUE ;
}
if ( V_26 > ( T_7 ) 1 << 31 ) {
return TRUE ;
...
V_30 = F_6 ( F_7 () , V_1 , 0 , sizeof( L_10 ) - 1 ) ;
if ( ( strncmp ( V_30 , L_11 , sizeof( L_11 ) - 1 ) == 0 ) ||
( strncmp ( V_30 , L_10 , sizeof( L_10 ) - 1 ) == 0 ) ) {
return TRUE ;
}
}
if ( ! F_9 ( V_1 , V_6 , V_12 ) ) {
