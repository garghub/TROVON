...
V_84 [ 3 ] = ( V_87 >> 24 ) & 0xFF ;
F_55 ( & V_85 , V_84 , 4 ) ;
F_55 ( & V_85 , ( T_20 * ) V_76 , V_77 ) ;
F_55 ( & V_85 , ( T_20 * ) V_78 , V_79 ) ;
F_55 ( & V_85 , ( T_20 * ) V_80 , V_81 ) ;
F_56 ( & V_85 , V_86 ) ;
...
V_116 = ( T_20 * ) F_66 ( F_67 () , V_114 ) ;
V_97 = ( T_20 * ) F_66 ( V_9 -> V_117 , V_114 ) ;
for( V_113 = V_118 ; V_113 ; V_113 = V_113 -> V_119 ) {
if( V_113 -> V_112 != V_112 ) {
continue;
}
memcpy ( V_116 , V_115 , V_114 ) ;
V_100 = F_58 ( V_9 ,
V_116 ,
V_97 ,
V_113 -> V_120 ,
...
if ( V_100 >= 0 ) {
F_44 ( T_9 , NULL , 0 , 0 , L_4 , V_113 -> V_122 ) ;
V_9 -> V_123 = F_68 ( T_4 ,
V_97 ,
V_100 , V_100 ) ;
F_69 ( V_9 , V_9 -> V_123 , L_5 ) ;
return;
}
}
return;
...
static int
F_70 ( void * V_124 , int V_36 , T_17 V_125 , int V_126 )
{
unsigned char * V_127 , V_128 [ 256 ] ;
T_19 V_129 ;
if ( V_36 == 0 )
return 0 ;
V_125 %= V_36 ;
...
return 0 ;
V_129 = V_36 - V_125 ;
if ( V_125 <= sizeof( V_128 ) ) {
V_127 = V_128 ;
} else {
V_127 = ( unsigned char * ) F_71 ( V_125 ) ;
if ( V_127 == NULL )
return - 1 ;
}
if ( V_126 ) {
memcpy ( V_127 , V_124 , V_125 ) ;
memmove ( V_124 , ( unsigned char * ) V_124 + V_125 , V_129 ) ;
memcpy ( ( unsigned char * ) V_124 + V_129 , V_127 , V_125 ) ;
} else {
memcpy ( V_127 , ( unsigned char * ) V_124 + V_129 , V_125 ) ;
memmove ( ( unsigned char * ) V_124 + V_125 , V_124 , V_129 ) ;
memcpy ( V_124 , V_127 , V_125 ) ;
}
if ( V_125 > sizeof( V_128 ) )
F_72 ( V_127 ) ;
return 0 ;
...
V_91 = F_33 ( V_130 ) + F_33 ( V_131 ) ;
V_134 = ( T_20 * ) F_66 ( V_9 -> V_117 , V_91 ) ;
F_62 ( V_130 , V_134 ,
0 , F_33 ( V_130 ) ) ;
F_62 ( V_131 , V_134 + F_33 ( V_130 ) ,
0 , F_33 ( V_131 ) ) ;
if ( V_133 ) {
V_125 += V_132 ;
}
F_70 ( V_134 , V_91 , V_125 , TRUE ) ;
V_136 = F_68 ( V_131 , V_134 ,
V_91 , V_91 ) ;
F_69 ( V_9 , V_136 , L_6 ) ;
V_135 = F_74 ( T_9 , V_9 , V_73 , V_136 ,
V_112 , & V_91 ) ;
if ( V_135 ) {
T_20 * V_138 ;
V_138 = ( T_20 * ) F_75 ( V_135 , F_33 ( V_131 ) ) ;
F_72 ( V_135 ) ;
V_9 -> V_123 = F_68 ( V_131 ,
V_138 ,
F_33 ( V_131 ) ,
F_33 ( V_131 ) ) ;
F_69 ( V_9 , V_9 -> V_123 , L_5 ) ;
...
if ( ( V_139 == V_146 ) ||
( V_139 == V_147 ) ) {
F_30 ( T_9 , V_148 , T_4 , T_5 , 8 ,
V_38 ) ;
T_5 += 8 ;
}
V_9 -> V_149 = ( V_140 != V_150 ) ;
#ifdef F_77
#define F_78 32
if( V_9 -> V_109 ) {
if( ! V_9 -> V_106 ) {
...
int V_141 = T_5 ;
V_163 = F_85 ( T_4 , T_5 ) ;
T_5 = F_83 ( T_4 , T_5 , T_9 , V_163 ) ;
V_9 -> V_149 = ( V_163 & 2 ) ;
F_30 ( T_9 , V_165 , T_4 , T_5 , 1 ,
V_38 ) ;
T_5 += 1 ;
V_132 = F_59 ( T_4 , T_5 ) ;
F_30 ( T_9 , V_166 , T_4 , T_5 , 2 ,
V_167 ) ;
T_5 += 2 ;
#if F_82 ( V_152 ) || F_82 ( V_153 )
V_125 = F_59 ( T_4 , T_5 ) ;
...
#if F_82 ( V_152 ) || F_82 ( V_153 )
{
T_3 * V_130 = F_81 ( T_4 , 16 , V_164 , V_164 ) ;
if ( V_9 -> V_149 ) {
if( V_9 -> V_106 ) {
F_73 ( T_9 ,
V_9 ,
...
static int
F_86 ( T_3 * T_4 , T_16 * V_9 V_1 , T_8 * T_9 , void * V_124 V_1 )
{
T_15 * V_33 ;
T_8 * V_34 ;
int T_5 = 0 ;
...
static int
F_87 ( T_3 * T_4 , T_16 * V_9 , T_8 * T_9 , void * V_124 V_1 )
{
T_15 * V_33 ;
T_8 * V_34 ;
int T_5 = 0 ;
...
- 1 , V_38 ) ;
V_34 = F_31 ( V_33 , V_173 ) ;
T_5 = F_35 ( FALSE , T_4 , T_5 , & V_48 , V_34 , - 1 ) ;
return T_5 ;
}
static void
F_88 ( T_3 * T_4 , T_16 * V_9 , T_8 * V_174 )
{
T_15 * V_33 ;
T_8 * V_34 ;
int T_5 = 0 ;
...
T_6 V_48 ;
F_38 ( & V_48 , V_49 , TRUE , V_9 ) ;
V_5 = ( T_11 * ) F_89 ( V_9 -> V_175 , V_10 , 0 ) ;
if ( ! V_5 && ! V_9 -> V_175 -> V_163 . V_176 ) {
V_6 = F_90 ( V_9 -> V_175 -> V_177 , & V_9 -> V_178 , & V_9 -> V_179 ,
V_9 -> V_180 , V_9 -> V_181 ,
V_9 -> V_182 , 0 ) ;
if ( V_6 ) {
V_5 = ( T_11 * ) F_91 ( V_6 ,
V_10 ) ;
if ( V_5 )
F_92 ( V_9 -> V_175 , V_10 , 0 , V_5 ) ;
}
}
V_33 = F_30 ( V_174 , V_10 , T_4 , T_5 ,
- 1 , V_38 ) ;
V_34 = F_31 ( V_33 , V_173 ) ;
F_25 ( FALSE , T_4 , T_5 , & V_48 , V_34 , - 1 ) ;
}
void F_93 ( void ) {
static T_24 V_183 [] = {
{ & V_37 ,
{ L_7 , L_8 ,
V_184 , V_185 , NULL , 0x0 , L_9 ,
V_186 } } ,
{ & V_50 ,
{ L_10 , L_11 , V_187 ,
V_185 , NULL , 0 , NULL , V_186 } } ,
{ & V_52 ,
{ L_12 , L_13 , V_188 ,
V_185 , NULL , 0 , NULL , V_186 } } ,
{ & V_53 ,
{ L_14 , L_15 , V_189 , V_190 ,
F_94 ( V_191 ) , 0 , L_16 , V_186 } } ,
{ & V_142 ,
{ L_17 , L_18 , V_189 , V_190 ,
F_94 ( V_192 ) , 0 , L_19 , V_186 } } ,
{ & V_143 ,
{ L_20 , L_21 , V_189 , V_190 ,
F_94 ( V_193 ) , 0 , L_22 , V_186 } } ,
{ & V_144 ,
{ L_23 , L_24 , V_187 , V_185 ,
NULL , 0 , L_25 , V_186 } } ,
{ & V_145 ,
{ L_26 , L_27 , V_187 , V_185 ,
NULL , 0 , L_28 , V_186 } } ,
{ & V_148 ,
{ L_29 , L_30 , V_187 , V_185 ,
NULL , 0 , L_31 , V_186 } } ,
{ & V_165 ,
{ L_32 , L_33 , V_187 , V_185 ,
NULL , 0 , L_34 , V_186 } } ,
{ & V_158 ,
{ L_35 , L_36 , V_194 , V_190 ,
NULL , 0 , L_37 , V_186 } } ,
{ & V_162 ,
{ L_38 , L_39 , V_195 , 8 ,
F_95 ( & V_196 ) , 0x01 , NULL , V_186 } } ,
{ & V_161 ,
{ L_40 , L_41 , V_195 , 8 ,
F_95 ( & V_196 ) , 0x02 , NULL , V_186 } } ,
{ & V_160 ,
{ L_42 , L_43 , V_195 , 8 ,
F_95 ( & V_196 ) , 0x04 , NULL , V_186 } } ,
{ & V_166 ,
{ L_44 , L_45 , V_189 , V_197 ,
NULL , 0 , L_46 , V_186 } } ,
{ & V_168 ,
{ L_47 , L_48 , V_189 , V_197 ,
NULL , 0 , L_49 , V_186 } } ,
{ & V_169 ,
{ L_50 , L_51 , V_198 , V_197 ,
NULL , 0 , L_52 , V_186 } } ,
...
V_10 = F_96 ( V_223 , V_224 , V_225 ) ;
F_97 ( L_97 , F_88 , V_10 ) ;
V_226 = F_96 ( L_98 ,
L_98 ,
L_99 ) ;
F_97 ( L_99 , F_37 , V_226 ) ;
F_98 ( L_100 , F_86 , V_226 ) ;
F_99 ( V_10 , V_183 , F_100 ( V_183 ) ) ;
F_101 ( V_222 , F_100 ( V_222 ) ) ;
}
void F_102 ( void ) {
T_26 V_227 , V_228 ;
T_26 V_229 , V_230 ;
V_227 = F_103 ( L_97 ) ;
V_228 = F_104 ( F_87 , V_10 ) ;
F_105 ( L_101 , V_10 , V_173 ,
V_227 , V_228 ,
L_102 ) ;
V_229 = F_103 ( L_99 ) ;
V_230 = F_103 ( L_100 ) ;
F_105 ( L_103 , V_226 , V_51 ,
V_229 , V_230 ,
L_104 ) ;
F_105 ( L_105 , V_226 , V_51 ,
V_229 , V_230 ,
L_106 ) ;
F_105 ( L_107 , V_226 , V_51 ,
V_229 , V_230 ,
L_108 ) ;
}
