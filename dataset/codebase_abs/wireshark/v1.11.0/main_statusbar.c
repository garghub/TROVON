...
V_59 . V_60 ,
V_59 . V_62 ,
( 100.0 * V_59 . V_62 ) / V_59 . V_60 ) ;
if( V_59 . V_63 ) {
F_65 ( V_58 , L_12 V_61 L_13 ,
V_59 . V_63 , ( 100.0 * V_59 . V_63 ) / V_59 . V_60 ) ;
}
if( V_59 . V_64 ) {
F_65 ( V_58 , L_12 V_61 L_14 ,
V_59 . V_65 , ( 100.0 * V_59 . V_65 ) / V_59 . V_60 ) ;
}
if( V_59 . V_66 ) {
F_65 ( V_58 , L_12 V_61 L_15 ,
V_59 . V_66 , ( 100.0 * V_59 . V_66 ) / V_59 . V_60 ) ;
}
if( ! V_59 . V_67 ) {
T_7 V_68 = F_66 ( & V_59 ) ;
F_65 ( V_58 , L_12 V_61 L_16 ,
V_68 / 60000 ,
V_68 % 60000 / 1000 ,
V_68 % 1000 ) ;
}
...
static void
F_84 ( const char * V_88 , T_12 V_89 , T_13 * V_90 )
{
T_2 * V_91 ;
F_78 () ;
V_91 = F_85 ( V_89 , ( V_92 ) ( V_93 | V_94 ) ) ;
F_2 ( L_27 ,
( V_88 ) ? V_88 : L_9 , V_91 ,
( long ) V_90 -> V_95 / 3600 ,
( long ) V_90 -> V_95 % 3600 / 60 ,
( long ) V_90 -> V_95 % 60 ) ;
F_6 ( V_91 ) ;
}
static void
...
static void
F_88 ( T_14 * T_15 , const char * V_96 )
{
T_2 * V_97 ;
F_7 () ;
V_97 = F_89 ( T_15 -> V_98 ) ;
...
{
F_7 () ;
F_84 ( T_15 -> V_98 , T_15 -> V_99 , & ( T_15 -> V_100 ) ) ;
F_82 () ;
}
static void
F_91 ( T_16 * T_17 V_18 )
...
F_7 () ;
V_102 = F_95 ( V_101 ) ;
if ( T_15 -> V_99 / 1024 / 1024 > 10 ) {
F_2 ( L_31 V_104 L_32 ,
V_102 -> V_69 ,
V_101 -> V_103 ,
T_15 -> V_99 / 1024 / 1024 ) ;
} else if ( T_15 -> V_99 / 1024 > 10 ) {
F_2 ( L_31 V_104 L_33 ,
V_102 -> V_69 ,
V_101 -> V_103 ,
T_15 -> V_99 / 1024 ) ;
...
T_2 * V_105 ;
F_8 ( F_5 ( V_36 ) , V_52 ) ;
V_105 = F_67 ( L_36 , F_101 ( T_15 ) ) ;
F_4 ( F_5 ( V_36 ) , V_52 , V_105 ) ;
F_6 ( V_105 ) ;
}
static void
