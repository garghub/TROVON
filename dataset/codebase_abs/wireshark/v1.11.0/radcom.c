...
struct V_38 * V_35 , T_6 * V_39 , int T_7 V_40 ,
int * V_2 , T_2 * * V_3 )
{
if ( F_4 ( V_1 -> V_41 , V_37 , V_42 , V_2 ) == - 1 )
return FALSE ;
if ( ! F_7 ( V_1 , V_1 -> V_41 , V_35 , V_39 , V_2 ,
V_3 ) ) {
if ( * V_2 == 0 ) {
* V_2 = V_13 ;
}
...
static T_4
F_7 ( T_1 * V_1 , T_8 V_12 , struct V_38 * V_35 , T_6 * V_39 ,
int * V_2 , T_2 * * V_3 )
{
struct V_43 V_44 ;
int V_4 ;
...
V_46 = F_8 ( & V_44 . V_46 ) ;
V_35 -> V_50 = V_51 | V_52 ;
V_48 . V_53 = F_8 ( & V_44 . V_54 . V_55 ) - 1900 ;
V_48 . V_56 = ( V_44 . V_54 . V_57 & 0x0f ) - 1 ;
V_48 . V_58 = V_44 . V_54 . V_59 ;
V_47 = F_9 ( & V_44 . V_54 . V_47 ) ;
V_48 . V_60 = V_47 / 3600 ;
V_48 . V_61 = ( V_47 % 3600 ) / 60 ;
V_48 . V_62 = V_47 % 60 ;
V_48 . V_63 = - 1 ;
V_35 -> V_64 . V_65 = mktime ( & V_48 ) ;
V_35 -> V_64 . V_66 = F_9 ( & V_44 . V_54 . V_67 ) * 1000 ;
switch ( V_1 -> V_28 ) {
case V_30 :
V_35 -> V_68 . V_69 . V_70 = - 1 ;
break;
case V_29 :
V_35 -> V_68 . V_71 . V_72 = ( V_44 . V_73 & 0x1 ) ?
0x00 : V_74 ;
T_7 -= 2 ;
V_46 -= 2 ;
break;
...
V_35 -> V_75 = V_46 ;
V_35 -> V_76 = T_7 ;
if ( ! F_11 ( V_12 , V_39 , T_7 , V_2 , V_3 ) )
return FALSE ;
return TRUE ;
}
static T_4
F_10 ( T_8 V_12 , T_3 * V_77 , int T_7 , int * V_2 ,
T_2 * * V_3 )
{
int V_4 ;
V_10 = V_11 ;
V_4 = F_2 ( V_77 , T_7 , V_12 ) ;
if ( V_4 != T_7 ) {
* V_2 = F_3 ( V_12 , V_3 ) ;
if ( * V_2 == 0 )
* V_2 = V_13 ;
