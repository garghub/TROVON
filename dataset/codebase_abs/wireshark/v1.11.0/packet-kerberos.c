...
V_15 -> V_13 = ( char * ) F_9 ( V_27 . V_54 . V_13 . V_37 , V_27 . V_54 . V_13 . V_36 ) ;
V_23 = V_15 ;
}
}while( V_26 == 0 );
V_26 = F_15 ( V_30 , V_25 , & V_28 ) ;
...
V_26 = F_24 ( V_30 , & ( V_27 . V_54 ) , ( V_57 ) 0 , & V_55 ) ;
if( V_26 ) {
return NULL ;
}
V_56 = ( T_12 * ) F_9 ( V_45 , V_36 ) ;
...
F_23 ( V_2 , NULL , 0 , 0 , L_12 , V_44 -> V_20 ) ;
F_26 ( V_30 , V_55 ) ;
V_48 = ( char * ) F_9 ( V_37 . V_37 , V_37 . V_36 ) ;
if ( V_43 ) {
* V_43 = V_37 . V_36 ;
}
return V_48 ;
...
static int
F_63 ( T_2 * V_2 , T_3 * V_3 , int V_82 , T_23 * T_24 V_24 )
{
...
static int
F_68 ( T_2 * V_2 , T_3 * V_3 , int V_82 , T_23 * T_24 V_24 )
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_119 , V_120 , V_121 ) ;
return V_82 ;
}
static int
F_70 ( T_2 * V_2 , T_3 * V_3 , int V_82 , T_23 * T_24 V_24 )
{
...
static int F_74 ( T_2 * V_2 , T_3 * V_3 , int V_82 , T_23 * T_24 V_24 )
{
...
char * V_129 ;
T_27 * V_130 = NULL ;
V_82 = F_76 ( T_24 -> V_1 , V_2 , V_3 , V_82 , & V_128 , & V_78 , & V_4 ) ;
V_82 = F_77 ( T_24 -> V_1 , V_2 , V_3 , V_82 , & V_52 , NULL ) ;
V_129 = ( char * ) F_78 ( F_79 () , V_131 ) ;
V_129 [ 0 ] = '\0' ;
switch( V_127 ) {
case V_132 :
...
break;
default:
F_23 ( V_2 , V_3 , V_82 , V_52 , L_29 ) ;
}
if( V_130 ) {
F_67 ( F_86 ( V_130 ) , L_22 , V_129 ) ;
F_67 ( F_87 ( V_130 , 2 ) , L_22 , V_129 ) ;
}
V_82 += V_52 ;
return V_82 ;
}
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_152 , V_153 , V_154 ) ;
return V_82 ;
}
static int
F_93 ( T_2 * V_2 , T_3 * V_3 , int V_82 , T_23 * T_24 V_24 )
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_155 , V_156 , V_157 ) ;
return V_82 ;
}
static int
...
V_160 = FALSE ;
F_67 ( V_2 , L_22 , F_62 ( V_158 , V_161 , L_31 ) ) ;
return V_82 ;
}
static int
...
{
char V_51 [ 256 ] ;
V_82 = F_99 ( T_24 , V_2 , V_3 , V_82 , V_166 , V_51 , 255 ) ;
if( V_2 ) {
F_67 ( V_2 , L_34 , V_167 , V_51 ) ;
V_167 = '/' ;
}
return V_82 ;
}
...
{
V_167 = ' ' ;
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_168 , - 1 , - 1 ) ;
return V_82 ;
}
static int
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_197 , - 1 , - 1 ) ;
return V_82 ;
}
static int
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_199 , - 1 , - 1 ) ;
return V_82 ;
}
static int
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_225 , V_226 , V_227 ) ;
return V_82 ;
}
static int
...
V_53 = F_81 ( V_3 , V_82 ) ;
F_151 ( V_2 , V_241 , V_3 , V_82 , 1 , V_53 >> 4 ) ;
V_82 ++ ;
if ( V_238 ) {
* V_238 = V_53 ;
}
...
V_82 += 2 ;
V_50 = F_166 ( F_79 () , V_3 , V_82 , V_281 , V_202 ) ;
F_160 ( V_2 , V_286 , V_3 , V_82 , V_281 , V_50 ) ;
V_82 += V_281 ;
return V_82 ;
}
static int
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_317 , - 1 , - 1 ) ;
return V_82 ;
}
static int
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_324 , - 1 , - 1 ) ;
return V_82 ;
}
static int
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_348 , V_349 , V_350 ) ;
return V_82 ;
}
static int
...
V_82 += 4 ;
F_80 ( V_2 , V_358 , V_3 , V_82 , V_52 , V_144 ) ;
V_82 += V_52 ;
...
{
V_82 = F_69 ( FALSE , T_24 , V_2 , V_3 , V_82 , V_396 , V_397 , V_398 ) ;
return V_82 ;
}
static int
...
static T_35 V_619 [] = {
{ & V_49 , { L_534 , V_620 , V_621 , L_535 , V_622 } } ,
} ;
T_36 * V_623 ;
T_37 * V_624 ;
V_494 = F_275 ( L_536 , L_47 , L_537 ) ;
F_276 ( V_494 , V_519 , F_277 ( V_519 ) ) ;
F_278 ( V_618 , F_277 ( V_618 ) ) ;
V_624 = F_279 ( V_494 ) ;
F_280 ( V_624 , V_619 , F_277 ( V_619 ) ) ;
V_623 = F_281 ( V_494 , F_270 ) ;
F_282 ( V_623 , L_538 ,
L_539 ,
L_540
L_541 ,
...
static int F_284 ( T_3 * V_3 , int V_82 , T_1 * V_1 ,
T_2 * V_2 , T_12 * V_238 V_24 )
{
T_3 * V_625 ;
V_625 = F_120 ( V_3 , V_82 ) ;
F_252 ( V_625 , V_1 , V_2 , FALSE , NULL ) ;
...
V_626 = F_288 ( F_262 ,
V_494 ) ;
F_289 ( L_551 , V_421 , V_429 ) ;
F_289 ( L_552 , V_627 , V_626 ) ;
F_290 ( V_628 ,
V_629 ,
& V_630 ) ;
F_290 ( V_631 ,
