...
T_6 V_100 , T_1 V_181 ,
struct V_140 * V_58 , int * V_25 , T_3 * * V_26 )
{
int V_182 = 0 ;
T_6 V_183 ;
switch ( V_180 ) {
...
case V_185 :
if ( V_179 == V_184 ) {
if ( ! F_9 ( V_22 , & V_58 -> V_24 , V_25 , V_26 ) )
return - 1 ;
}
V_58 -> V_24 . V_186 . V_187 = - 1 ;
break;
case V_188 :
case V_189 :
case V_190 :
case V_191 :
V_58 -> V_24 . V_192 . V_187 = - 1 ;
V_58 -> V_24 . V_192 . V_193 = FALSE ;
V_58 -> V_24 . V_192 . V_48 = 0 ;
V_58 -> V_24 . V_192 . V_194 = 0 ;
V_58 -> V_24 . V_192 . V_195 = 0 ;
break;
case V_14 :
if ( V_181 && V_100 < V_64 ) {
* V_25 = V_66 ;
...
if ( ! F_15 ( V_22 , & V_58 -> V_24 ,
V_25 , V_26 ) )
return - 1 ;
V_182 = V_88 ;
break;
case V_196 :
V_58 -> V_24 . V_130 . V_73 = FALSE ;
break;
case V_20 :
if ( V_181 &&
...
if ( ! F_23 ( V_22 , & V_58 -> V_24 , V_25 , V_26 ) )
return - 1 ;
V_182 = V_133 ;
break;
case V_21 :
...
if ( ! F_25 ( V_22 , V_58 , & V_58 -> V_24 ,
V_25 , V_26 ) )
return - 1 ;
V_182 = ( int ) sizeof( struct V_143 ) ;
if ( ! F_27 ( V_22 , & V_58 -> V_24 , V_25 , V_26 ,
& V_183 ) )
return - 1 ;
V_182 += V_183 ;
if ( ! F_29 ( V_22 , & V_58 -> V_24 , V_25 , V_26 ,
& V_183 ) )
return - 1 ;
V_182 += V_183 ;
if ( V_181 &&
