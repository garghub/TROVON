...
const T_1 *
F_16 ( const T_2 V_1 , const T_7 * V_14 )
{
if ( V_14 ) {
...
const T_1 *
F_17 ( const T_2 V_1 , T_7 * V_14 , T_4 * V_6 )
{
if ( V_14 ) {
const T_3 * V_2 = V_14 -> V_18 ( V_1 , V_14 ) ;
if ( V_2 ) {
...
const T_1 *
F_18 ( const T_2 V_1 , const T_7 * V_14 , const char * V_3 )
{
const T_1 * V_4 ;
F_2 ( V_3 != NULL ) ;
V_4 = F_16 ( V_1 , V_14 ) ;
...
const T_1 *
F_19 ( const T_2 V_1 , const T_7 * V_14 ,
const char * V_5 )
{
const T_1 * V_4 ;
F_2 ( V_5 != NULL ) ;
...
static const T_3 *
F_20 ( const T_2 V_1 , const T_7 * V_14 )
{
...
F_24 ( L_1 ,
V_14 -> V_20 , V_7 , V_21 [ V_7 ] . V_9 , V_30 ) ;
type = V_27 ;
break;
}
if ( V_31 > V_21 [ V_7 ] . V_9 ) {
F_24 ( L_2 ,
V_14 -> V_20 , V_7 , V_21 [ V_7 ] . V_9 , V_31 ) ;
type = V_27 ;
break;
}
}
...
const T_1 *
F_26 ( const T_1 * V_1 , const T_9 * V_2 , const char * V_3 )
{
const T_1 * V_4 ;
F_2 ( V_3 != NULL ) ;
V_4 = F_27 ( V_1 , V_2 ) ;
...
const T_1 *
F_28 ( const T_1 * V_1 , const T_9 * V_2 , T_4 * V_6 )
{
T_4 V_7 = 0 ;
if( V_2 ) {
while ( V_2 [ V_7 ] . V_8 ) {
...
const T_1 *
F_27 ( const T_1 * V_1 , const T_9 * V_2 )
{
T_4 V_10 ;
return F_28 ( V_1 , V_2 , & V_10 ) ;
}
const T_1 *
F_29 ( const T_2 V_1 , const T_10 * V_32 , const char * V_3 )
{
const T_1 * V_4 = NULL ;
F_2 ( V_3 != NULL ) ;
V_4 = F_30 ( V_1 , V_32 ) ;
...
const T_1 *
F_31 ( const T_2 V_1 , const T_10 * V_32 ,
const char * V_5 )
{
const T_1 * V_4 = NULL ;
F_2 ( V_5 != NULL ) ;
...
const T_1 *
F_32 ( const T_2 V_1 , const T_10 * V_32 , T_4 * V_6 )
{
T_4 V_7 = 0 ;
if( V_32 ) {
while( V_32 [ V_7 ] . V_8 ) {
...
const T_1 *
F_30 ( const T_2 V_1 , const T_10 * V_32 )
{
T_4 V_10 = 0 ;
return F_32 ( V_1 , V_32 , & V_10 ) ;
}
T_11
F_33 ( const T_7 * V_14 )
{
