...
V_30 = F_16 ( V_29 [ 4 ] , L_6 , 0 ) ;
for ( V_25 = 0 ; V_30 [ V_25 ] != NULL ; V_25 ++ ) {
V_4 = F_18 ( T_3 , 1 ) ;
if ( F_19 ( V_35 , V_30 [ V_25 ] , & V_4 -> V_16 . V_17 ) > 0 ) {
V_4 -> V_14 = V_15 ;
} else if ( F_19 ( V_36 , V_30 [ V_25 ] ,
& V_4 -> V_16 . V_18 ) > 0 ) {
V_4 -> V_14 = V_37 ;
} else {
F_8 ( V_4 ) ;
