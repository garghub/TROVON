...
F_20 ( V_27 , F_22 ( (struct V_51 * ) & V_22 -> V_22 . V_50 ) ) ;
break;
default:
break;
}
...
V_26 . V_33 = TRUE ;
V_26 . V_52 . V_53 = V_54 ;
V_26 . V_52 . V_55 . V_56 = F_10 ( V_30 . V_57 . V_56 ) ;
V_26 . V_52 . V_55 . V_58 = F_10 ( V_30 . V_57 . V_58 ) ;
V_26 . V_52 . V_55 . V_59 = V_30 . V_57 . V_59 ;
V_26 . V_52 . V_55 . V_60 = F_10 ( V_30 . V_57 . V_60 ) ;
V_26 . V_52 . V_55 . V_61 = F_10 ( V_30 . V_57 . V_61 ) ;
...
V_26 . V_70 = V_13 -> V_71 ;
#endif
for ( V_7 = V_13 -> V_72 ; V_7 != NULL ; V_7 = F_8 ( V_7 ) ) {
V_25 = ( T_11 * ) V_7 -> V_36 ;
if ( V_14 == 0 ) {
V_26 . V_73 = V_25 -> V_74 ;
}
V_24 = ( T_10 * ) F_27 ( sizeof( T_10 ) ) ;
if ( V_25 -> V_75 != NULL ) {
V_24 -> V_74 = V_25 -> V_74 ;
...
V_26 . V_9 = * V_10 ;
V_26 . V_79 = 0 ;
if ( ( V_26 . V_80 = F_29 ( V_9 -> V_37 ) ) == - 1 ) {
V_26 . V_80 = V_30 . V_57 . V_81 ;
}
if ( ( V_26 . V_82 = F_30 ( V_9 -> V_37 ) ) == - 1 ) {
V_26 . V_82 = V_30 . V_57 . V_82 ;
}
if ( F_31 ( V_9 -> V_37 ) == - 1 ) {
V_26 . V_83 = V_30 . V_57 . V_83 ;
} else {
V_26 . V_83 = ( T_8 ) F_31 ( V_9 -> V_37 ) ;
}
V_26 . V_84 = F_10 ( V_30 . V_57 . V_84 ) ;
#if F_26 ( F_15 ) || F_26 ( V_68 )
if ( ( V_26 . V_85 = F_32 ( V_9 -> V_37 ) ) == - 1 ) {
...
V_100 = F_28 ( V_100 , V_99 ) ;
}
}
for ( V_18 = 0 ; V_18 < V_30 . V_31 -> V_32 ; V_18 ++ ) {
V_26 = F_5 ( V_30 . V_31 , T_12 , V_18 ) ;
V_29 = FALSE ;
for ( V_101 = V_100 ; V_101 != NULL ; V_101 = F_8 ( V_101 ) ) {
