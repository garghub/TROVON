...
if ( V_10 == 1 ) {
F_11 ( V_9 , L_4 , F_12 ( ( V_20 * ) F_13 ( F_14 () , V_2 , V_3 + V_14 , V_12 ) , V_12 ) ) ;
}
if ( V_10 == 2 ) {
F_11 ( V_9 , L_5 , F_12 ( ( V_20 * ) F_13 ( F_14 () , V_2 , V_3 + V_14 , V_12 ) , V_12 ) ) ;
}
}
return V_14 + V_12 ;
}
...
if ( V_8 ) {
if ( V_22 ) V_21 = - V_21 ;
F_16 ( V_8 , V_23 , V_2 , V_3 , V_14 , V_21 ) ;
if ( V_10 == 2 ) {
F_11 ( V_9 , L_8 , V_21 ) ;
}
}
...
V_26 = F_2 ( V_2 , V_3 ) ;
if ( V_8 ) {
V_27 = F_17 ( V_2 , T_3 , V_3 , V_4 , NULL , V_24 , NULL , 0 ) ;
if ( V_27 < 0 ) V_27 = V_4 ;
}
switch ( V_26 ) {
case 'd' :
...
V_29 = - 1 ;
if ( V_4 - V_28 > 2 )
V_29 = F_17 ( V_2 , T_3 , V_3 + V_14 + V_28 , V_4 - V_28 , NULL , V_24 + 1 , NULL , 0 ) ;
if ( V_29 < 0 ) {
if ( V_32 ) {
...
F_17 ( V_2 , T_3 , V_3 + V_14 + V_28 , V_4 - V_28 , V_31 , V_24 + 1 , V_9 , 2 ) ;
}
V_14 += V_28 + V_29 ;
V_4 -= V_28 + V_29 ;
}
...
V_27 = F_17 ( V_2 , T_3 , V_3 + V_14 , V_4 , V_31 , V_24 + 1 , V_9 , 0 ) ;
...
return - 1 ;
case 'i' :
return F_15 ( V_2 , T_3 , V_3 , V_4 , V_8 , V_25 , V_10 ) ;
default:
if ( V_26 >= '1' && V_26 <= '9' ) {
...
static void
F_19 ( T_4 * V_2 , T_2 * T_3 V_1 ,
int V_3 , int V_4 , T_7 * V_8 )
{
F_17 ( V_2 , T_3 , V_3 , V_4 , V_8 , 0 , NULL , 0 ) ;
}
static void
F_20 ( T_4 * V_2 , T_2 * T_3 , T_7 * V_8 )
{
int V_3 = 0 ;
int V_39 ;
int V_40 = 0 ;
...
T_6 V_45 , V_46 , V_47 ;
T_6 V_12 ;
if ( F_21 ( V_2 , V_3 + V_5 , 1 ) ) {
V_4 = F_4 ( V_2 , V_3 ) ;
type = F_2 ( V_2 , V_3 + V_5 ) ;
if ( type == V_48 && V_4 > 4 ) {
if ( ! F_21 ( V_2 , V_3 + V_5 , 4 ) )
return;
V_42 = F_4 ( V_2 , V_3 + V_5 ) ;
if ( 4 + V_42 + 1 <= V_4 ) {
if ( ! F_21 ( V_2 , V_3 + V_5 + 4 , V_42 + 1 ) )
return;
...
F_24 ( T_3 -> V_53 , V_54 , L_17 , V_45 , V_46 , V_47 ) ;
break;
case V_6 :
...
F_11 ( V_9 , L_18 , V_45 ) ;
F_24 ( T_3 -> V_53 , V_54 , L_18 , V_45 ) ;
break;
case V_75 :
F_10 ( V_41 , V_76 , V_2 , V_3 , V_4 , V_19 ) ;
F_11 ( V_9 , L_19 , V_4 ) ;
F_24 ( T_3 -> V_53 , V_54 , L_19 , V_4 ) ;
break;
case V_77 :
V_45 = F_4 ( V_2 , V_3 ) ;
...
F_24 ( T_3 -> V_53 , V_54 , L_20 , V_45 , V_46 , V_4 ) ;
break;
case V_79 :
case V_80 :
F_19 ( V_2 , T_3 , V_3 , V_4 , V_41 ) ;
break;
case V_81 :
V_12 = F_4 ( V_2 , V_3 ) ;
...
static int
F_25 ( T_4 * V_2 , T_2 * T_3 V_1 , T_7 * V_8 )
{
int V_3 = 0 ;
int V_39 ;
char * V_87 ;
F_23 ( T_3 -> V_53 , V_54 , L_21 ) ;
...
V_87 = F_26 ( F_14 () , V_2 , V_3 + ( int ) strlen ( V_94 [ V_39 ] . V_95 ) ,
V_94 [ V_39 ] . V_96 ) ;
...
static
void F_27 ( T_4 * V_2 , T_2 * T_3 , T_7 * V_8 )
{
T_8 * V_9 ;
F_23 ( T_3 -> V_53 , V_97 , L_23 ) ;
F_23 ( T_3 -> V_53 , V_54 , L_24 ) ;
...
F_28 ( T_3 -> V_53 , V_54 , L_25 ) ;
F_29 ( T_3 -> V_53 , V_54 ) ;
}
static
void F_30 ( T_4 * V_2 , T_2 * T_3 , T_7 * V_8 )
{
F_31 ( V_2 , T_3 , V_8 , V_100 , V_5 ,
F_1 , F_27 ) ;
}
static
T_11 F_32 ( T_4 * V_2 , T_2 * T_3 ,
...
{ & V_63 ,
{ L_40 , L_41 , V_104 , V_105 , F_37 ( V_52 ) , 0x0 , NULL , V_106 }
} ,
{ & V_55 ,
...
{ & V_62 ,
{ L_47 , L_48 , V_104 , V_105 , F_37 ( V_112 ) , 0x0 , NULL , V_106 }
} ,
{ & V_76 ,
...
T_16 * V_118 ;
V_98 = F_38 ( L_23 , L_23 , L_82 ) ;
F_39 ( V_98 , V_103 , F_40 ( V_103 ) ) ;
F_41 ( V_116 , F_40 ( V_116 ) ) ;
F_42 ( L_83 , F_30 , V_98 ) ;
V_118 = F_43 ( V_98 , NULL ) ;
F_44 ( V_118 , L_84 ,
L_85 ,
L_86
L_87 ,
