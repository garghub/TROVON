...
static void F_38 ( T_1 * V_5 , T_2 * V_1 ,
T_7 * V_36 )
{
T_7 * V_38 = NULL ;
T_8 * V_39 = NULL ;
...
static T_3
F_29 ( const char * V_52 , T_9 V_16 )
{
T_9 V_78 ;
for ( V_78 = 1 ; V_78 < F_42 ( V_79 ) ; V_78 ++ ) {
