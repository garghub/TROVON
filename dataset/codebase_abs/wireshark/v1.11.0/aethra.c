...
T_6 * V_56 , int V_57 , int * V_2 , T_2 * * V_3 )
{
struct V_42 V_6 ;
if ( F_9 ( V_1 -> V_58 , V_54 , V_59 , V_2 ) == - 1 )
return FALSE ;
if ( ! F_7 ( V_1 , V_1 -> V_58 , & V_6 , V_43 , V_2 , V_3 ) )
return FALSE ;
if ( ! F_8 ( V_1 -> V_58 , V_56 , V_57 , V_2 , V_3 ) )
return FALSE ;
return TRUE ;
}
static T_4
...
V_60 = F_5 ( V_6 -> V_60 ) ;
if ( V_60 < ( sizeof *V_6 - sizeof V_6 -> V_60 ) ) {
* V_2 = V_63 ;
* V_3 = F_10 ( L_1 ,
V_60 ,
( unsigned int ) ( sizeof *V_6 - sizeof V_6 -> V_60 ) ) ;
return FALSE ;
}
V_61 = V_60 - ( T_8 ) ( sizeof *V_6 - sizeof V_6 -> V_60 ) ;
V_62 = F_11 ( V_6 -> V_64 ) ;
V_43 -> V_65 = V_66 ;
V_43 -> V_67 . V_68 = V_8 -> V_35 + ( V_62 / 1000 ) ;
V_43 -> V_67 . V_69 = ( V_62 % 1000 ) * 1000000 ;
V_43 -> V_44 = V_61 ;
V_43 -> V_70 = V_61 ;
