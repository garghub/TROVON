...
struct V_4 * V_5 ,
T_5 * V_6 , int T_11 V_40 , int * V_7 , T_6 * * V_8 )
{
if ( F_14 ( V_2 -> V_41 , V_39 , V_42 , V_7 ) == - 1 )
return FALSE ;
return F_4 ( V_2 , V_2 -> V_41 , V_5 , V_6 , V_7 , V_8 ) ;
}
