...
if ( V_51 != 0 && F_39 ( V_3 -> V_54 , V_55 ) )
F_40 ( V_3 -> V_54 , V_55 , L_11 , F_41 ( V_51 , V_56 , L_12 ) ) ;
return V_2 ;
}
static int
...
static int
F_81 ( T_1 * V_1 V_5 , int V_2 V_5 , T_2 * V_3 V_5 , T_3 * V_4 V_5 , T_4 * T_5 V_5 )
{
V_3 -> V_52 = L_28 ;
return V_2 ;
}
...
{ & V_53 ,
{ L_68 , L_69 , V_89 , V_90 , F_83 ( V_56 ) , 0 , NULL , V_82 } } ,
{ & V_9 ,
...
V_93 = F_84 ( L_80 , L_81 , L_82 ) ;
F_85 ( V_93 , V_79 , F_86 ( V_79 ) ) ;
F_87 ( V_91 , F_86 ( V_91 ) ) ;
}
void F_88 ( void )
{
