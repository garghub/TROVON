...
} else if ( isdigit ( ( unsigned char ) V_10 ) ) {
V_18 = 0 ;
V_13 = strtoul ( V_8 , & V_9 , 10 ) ;
if ( V_8 == V_9 ) {
F_6 ( V_1 ) ;
return V_14 ;
}
...
void
F_9 ( T_1 * V_1 , void (* F_10)( T_4 V_13 ) )
{
T_4 V_11 , V_25 ;
if ( V_1 && F_10 ) {
for ( V_11 = 0 ; V_11 < V_1 -> V_3 ; V_11 ++ ) {
...
for ( V_11 = 0 ; V_11 < V_1 -> V_3 ; V_11 ++ ) {
if ( V_1 -> V_16 [ V_11 ] . V_17 == V_1 -> V_16 [ V_11 ] . V_21 ) {
F_13 ( V_27 , L_1 , V_26 ? L_2 : L_3 , V_1 -> V_16 [ V_11 ] . V_17 ) ;
} else {
F_13 ( V_27 , L_4 , V_26 ? L_2 : L_3 , V_1 -> V_16 [ V_11 ] . V_17 , V_1 -> V_16 [ V_11 ] . V_21 ) ;
}
V_26 = TRUE ;
}
}
