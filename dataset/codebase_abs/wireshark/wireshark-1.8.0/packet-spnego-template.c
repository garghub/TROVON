...
const T_12 * V_84 ;
static int V_85 = 0 ;
static T_12 * V_86 [ 4 ] = { NULL , NULL , NULL , NULL } ;
static T_12 * V_87 = NULL ;
T_12 * V_66 ;
V_85 ++ ;
if( V_85 >= 4 ) {
V_85 = 0 ;
...
V_66 = F_38 ( V_83 ) ;
for( V_82 = V_88 ; V_82 ; V_82 = V_82 -> V_89 ) {
if( V_82 -> V_81 != V_81 ) {
continue;
}
memcpy ( V_87 , V_84 , V_83 ) ;
V_69 = F_27 ( V_2 ,
V_87 ,
V_66 ,
V_82 -> V_90 ,
...
if ( V_69 >= 0 ) {
F_12 ( V_3 , NULL , 0 , 0 , L_4 , V_82 -> V_92 ) ;
V_2 -> V_93 = F_39 ( V_1 ,
V_66 ,
V_69 , V_69 ) ;
F_40 ( V_2 -> V_93 , F_37 ) ;
F_41 ( V_2 , V_2 -> V_93 , L_5 ) ;
return;
}
}
return;
...
static int
F_42 ( void * V_94 , int V_14 , T_5 V_95 , int V_96 )
{
unsigned char * V_97 , V_98 [ 256 ] ;
T_11 V_99 ;
if ( V_14 == 0 )
return 0 ;
V_95 %= V_14 ;
...
if ( V_96 ) {
memcpy ( V_97 , V_94 , V_95 ) ;
memmove ( V_94 , ( unsigned char * ) V_94 + V_95 , V_99 ) ;
memcpy ( ( unsigned char * ) V_94 + V_99 , V_97 , V_95 ) ;
} else {
memcpy ( V_97 , ( unsigned char * ) V_94 + V_99 , V_95 ) ;
memmove ( ( unsigned char * ) V_94 + V_95 , V_94 , V_99 ) ;
memcpy ( V_94 , V_97 , V_95 ) ;
}
if ( V_95 > sizeof( V_98 ) )
F_37 ( V_97 ) ;
return 0 ;
...
V_60 = F_28 ( V_101 ) + F_28 ( V_102 ) ;
V_105 = F_38 ( V_60 ) ;
F_32 ( V_101 , V_105 ,
0 , F_28 ( V_101 ) ) ;
F_32 ( V_102 , V_105 + F_28 ( V_101 ) ,
0 , F_28 ( V_102 ) ) ;
if ( V_104 ) {
V_95 += V_103 ;
}
F_42 ( V_105 , V_60 , V_95 , TRUE ) ;
V_107 = F_39 ( V_102 , V_105 ,
V_60 , V_60 ) ;
F_40 ( V_107 , F_37 ) ;
F_41 ( V_2 , V_107 , L_6 ) ;
V_106 = F_44 ( V_3 , V_2 , V_42 , V_107 ,
V_81 , & V_60 ) ;
if ( V_106 ) {
T_12 * V_109 ;
V_109 = F_45 ( V_106 , F_28 ( V_102 ) ) ;
F_37 ( V_106 ) ;
V_2 -> V_93 = F_39 ( V_102 ,
V_109 ,
F_28 ( V_102 ) ,
...
static int
F_14 ( T_1 * V_1 , int V_6 , T_2 * V_2 V_100 , T_3 * V_3 )
{
T_5 V_110 ;
V_110 = F_9 ( V_1 , V_6 ) ;
F_10 ( V_3 , V_113 , V_1 , V_6 , 2 ,
...
#if F_51 ( V_123 ) || F_51 ( V_124 )
{
T_1 * V_101 = F_50 ( V_1 , 16 , V_135 , V_135 ) ;
if ( V_2 -> V_120 ) {
if( V_2 -> V_75 ) {
F_43 ( V_3 ,
V_2 ,
...
static int
F_16 ( T_1 * V_1 , int V_6 , T_2 * V_2 V_100 , T_3 * V_3 )
{
T_12 V_134 ;
int V_135 ;
V_134 = F_54 ( V_1 , V_6 ) ;
...
static int
F_55 ( T_1 * V_1 , T_2 * V_2 V_100 , T_3 * V_3 )
{
T_4 * V_4 ;
T_3 * V_5 ;
int V_6 = 0 ;
...
- 1 , V_18 ) ;
V_5 = F_4 ( V_4 , V_146 ) ;
V_6 = F_57 ( FALSE , V_1 , V_6 , & V_15 , V_5 , - 1 ) ;
return V_6 ;
}
static void
F_58 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_147 )
{
T_4 * V_4 ;
T_3 * V_5 ;
int V_6 = 0 ;
...
T_10 V_15 ;
F_2 ( & V_15 , V_16 , TRUE , V_2 ) ;
V_149 = F_59 ( V_2 -> V_150 , V_145 ) ;
if ( ! V_149 && ! V_2 -> V_150 -> V_134 . V_151 ) {
V_148 = F_60 ( V_2 -> V_150 -> V_152 , & V_2 -> V_153 , & V_2 -> V_154 ,
V_2 -> V_155 , V_2 -> V_156 ,
V_2 -> V_157 , 0 ) ;
if ( V_148 ) {
V_149 = F_61 ( V_148 ,
V_145 ) ;
if ( V_149 )
F_62 ( V_2 -> V_150 , V_145 , V_149 ) ;
}
}
V_4 = F_3 ( V_147 , V_145 , V_1 , V_6 ,
- 1 , V_18 ) ;
V_5 = F_4 ( V_4 , V_146 ) ;
V_6 = F_63 ( FALSE , V_1 , V_6 , & V_15 , V_5 , - 1 ) ;
}
void F_64 ( void ) {
static T_17 V_158 [] = {
{ & V_159 ,
...
F_65 ( V_167 ) , 0 , L_16 , V_162 } } ,
{ & V_113 ,
{ L_17 , L_18 , V_165 , V_166 ,
F_65 ( V_168 ) , 0 , L_19 , V_162 } } ,
{ & V_114 ,
{ L_20 , L_21 , V_165 , V_166 ,
F_65 ( V_169 ) , 0 , L_22 , V_162 } } ,
{ & V_115 ,
...
{ & V_133 ,
{ L_38 , L_39 , V_171 , 8 ,
F_66 ( & V_172 ) , 0x01 , NULL , V_162 } } ,
{ & V_132 ,
{ L_40 , L_41 , V_171 , 8 ,
F_66 ( & V_172 ) , 0x02 , NULL , V_162 } } ,
{ & V_131 ,
{ L_42 , L_43 , V_171 , 8 ,
F_66 ( & V_172 ) , 0x04 , NULL , V_162 } } ,
{ & V_137 ,
...
V_145 = F_67 ( V_177 , V_178 , V_179 ) ;
F_68 ( L_53 , F_58 , V_145 ) ;
V_180 = F_67 ( L_54 ,
L_54 ,
L_55 ) ;
F_68 ( L_55 , F_1 , V_180 ) ;
F_69 ( L_56 , F_55 , V_180 ) ;
F_70 ( V_145 , V_158 , F_71 ( V_158 ) ) ;
F_72 ( V_175 , F_71 ( V_175 ) ) ;
}
void F_73 ( void ) {
T_19 V_181 , V_182 ;
T_19 V_183 , V_184 ;
V_181 = F_74 ( L_53 ) ;
V_182 = F_75 ( F_56 , V_145 ) ;
F_76 ( L_57 , V_145 , V_146 ,
V_181 , V_182 ,
L_58 ) ;
V_183 = F_74 ( L_55 ) ;
V_184 = F_74 ( L_56 ) ;
F_76 ( L_59 , V_180 , V_19 ,
V_183 , V_184 ,
L_60 ) ;
F_76 ( L_61 , V_180 , V_19 ,
V_183 , V_184 ,
L_62 ) ;
F_76 ( L_63 , V_180 , V_19 ,
V_183 , V_184 ,
L_64 ) ;
}
