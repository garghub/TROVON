...
T_3 * V_28 = F_23 ( V_5 -> V_22 . V_48 , V_20 ) ;
T_1 * V_49 = NULL ;
int V_50 ;
...
if ( V_53 < 0 )
return - 1 ;
V_54 = F_28 ( V_55 -> V_8 , V_55 -> V_3 , V_55 -> V_4 ) ;
#ifdef F_2
if ( F_2 & V_61 ) F_3 ( L_20 , V_54 ) ;
#endif
if ( ( V_56 = F_29 ( V_5 -> V_22 . V_62 . V_63 , V_54 ) ) ) {
...
static int F_34 ( T_2 * V_1 , int V_3 , const T_3 * V_5 , T_1 * * V_6 ) {
T_5 V_20 ;
int V_4 = 0 ;
int V_32 = V_3 ;
T_1 * V_60 = NULL ;
...
static int F_36 ( T_2 * V_1 , int V_3 , const T_3 * V_5 , T_1 * * V_6 ) {
T_5 V_69 = 0 ;
int V_32 = V_3 ;
T_1 * V_60 = NULL ;
#ifdef F_2
...
static int F_39 ( T_2 * V_1 , const int V_3 , const T_3 * V_5 , T_1 * * V_6 ) {
T_1 * V_49 = NULL ;
int V_4 = 0 ;
int V_74 = V_3 ;
#ifdef F_2
...
static int F_42 ( T_2 * V_1 , const int V_3 , const T_3 * V_5 , T_1 * * V_6 ) {
...
static int F_44 ( T_2 * V_1 , const int V_3 , const T_3 * V_5 V_83 , T_1 * * V_6 ) {
if ( V_3 == V_1 -> V_24 ) {
...
const char V_84 ,
const char V_85 ) {
T_4 * V_86 = F_47 ( L_29 , V_85 , V_84 ) ;
T_4 * V_87 = F_47 ( L_30 , V_84 ) ;
T_3 * V_88 = F_8 ( - 1 , V_87 , NULL , NULL , NULL ) ;
return F_24 ( V_2 , V_9 , V_26 , V_27 ,
F_35 ( - 1 , NULL , NULL , NULL ,
V_88 ,
F_35 ( - 1 , NULL , NULL , NULL ,
...
void * V_9 ,
const T_3 * V_15 ) {
T_2 * V_1 = F_4 ( sizeof( T_2 ) ) ;
#ifdef F_2
if ( F_2 & V_89 ) F_3 ( L_31 , V_3 , V_4 ) ;
#endif
V_1 -> V_8 = V_8 ;
V_1 -> V_3 = V_3 ;
V_4 = ( V_4 == - 1 ) ? ( int ) F_50 ( V_8 ) : V_4 ;
V_1 -> V_24 = V_3 + V_4 ;
V_1 -> V_9 = V_9 ;
V_1 -> V_15 = V_15 ;
return V_1 ;
...
if ( F_2 & V_89 ) F_3 ( L_31 , V_3 , V_4 ) ;
#endif
V_4 = ( V_4 == - 1 ) ? ( int ) F_50 ( V_1 -> V_8 ) : V_4 ;
if( F_52 ( V_1 -> V_8 , V_3 ) >= V_4 ) {
V_1 -> V_3 = V_3 ;
V_1 -> V_24 = V_3 + V_4 ;
return TRUE ;
} else {
...
static void F_54 ( T_2 * V_1 , T_1 * V_90 ) {
T_13 V_91 = F_55 () ;
while ( V_90 ) {
if( V_90 -> V_5 -> V_29 ) {
#ifdef F_2
...
T_1 * F_61 ( T_2 * V_1 , const T_3 * V_5 ) {
T_1 * V_6 = NULL ;
int V_4 = 0 ;
int V_3 = V_1 -> V_3 ;
int V_74 = V_3 - 1 ;
...
void F_62 ( T_14 * V_96 , T_1 * V_90 ) {
T_13 V_91 = F_55 () ;
struct V_97 * V_98 = F_4 ( sizeof( struct V_97 ) ) ;
T_15 * V_99 ;
V_98 -> V_96 = V_96 ;
V_98 -> V_100 = V_90 ;
while ( V_90 ) {
V_99 = F_63 ( V_98 -> V_96 , V_90 -> V_8 , V_90 -> V_3 , V_90 -> V_4 , L_44 , F_64 ( V_90 -> V_8 , V_90 -> V_3 , V_90 -> V_4 ) ) ;
if( V_90 -> V_10 ) {
V_98 -> V_100 = V_90 ;
F_56 ( V_91 , V_98 ) ;
V_98 = F_4 ( sizeof( struct V_97 ) ) ;
V_98 -> V_96 = F_65 ( V_99 , 0 ) ;
V_90 = V_90 -> V_10 ;
continue;
}
V_90 = V_90 -> V_11 ;
