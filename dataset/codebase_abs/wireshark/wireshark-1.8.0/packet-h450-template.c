...
if ( ! V_12 )
return V_10 ;
V_9 = F_7 ( V_8 , V_19 , V_6 , 0 , 0 , V_1 ) ;
F_8 ( V_9 ) ;
V_13 = F_9 ( V_1 , F_10 ( V_20 ) ) ;
if ( V_13 ) {
F_11 ( V_11 -> V_15 . V_21 , L_1 , V_13 ) ;
if ( V_11 -> V_22 >= 0 )
F_11 ( F_12 ( F_13 ( V_8 ) , V_11 -> V_22 ) , L_2 , V_13 ) ;
}
if ( V_12 -> V_23 && ( F_14 ( V_6 , V_10 ) > 0 ) )
V_10 = V_12 -> V_23 ( V_6 , V_7 , V_8 ) ;
else
if ( F_14 ( V_6 , V_10 ) > 0 ) {
F_15 ( V_8 , V_6 , V_10 , - 1 , L_3 ) ;
V_10 += F_14 ( V_6 , V_10 ) ;
}
return V_10 ;
}
static int
F_16 ( T_4 * V_6 , T_5 * V_7 , T_6 * V_8 ) {
T_7 * V_9 ;
int V_10 ;
T_8 * V_11 ;
T_2 V_1 ;
...
if ( V_12 -> V_24 && ( F_14 ( V_6 , V_10 ) > 0 ) )
V_10 = V_12 -> V_24 ( V_6 , V_7 , V_8 ) ;
else
if ( F_14 ( V_6 , V_10 ) > 0 ) {
F_15 ( V_8 , V_6 , V_10 , - 1 , L_4 ) ;
V_10 += F_14 ( V_6 , V_10 ) ;
}
return V_10 ;
}
static int
F_17 ( T_4 * V_6 , T_5 * V_7 , T_6 * V_8 ) {
T_7 * V_9 ;
int V_10 ;
T_8 * V_11 ;
T_2 V_4 ;
...
if ( ! V_25 )
return V_10 ;
V_9 = F_7 ( V_8 , V_26 , V_6 , 0 , 0 , V_4 ) ;
F_8 ( V_9 ) ;
V_13 = F_9 ( V_4 , F_10 ( V_27 ) ) ;
if ( V_13 ) {
F_11 ( V_11 -> V_15 . V_21 , L_1 , V_13 ) ;
if ( V_11 -> V_22 >= 0 )
F_11 ( F_12 ( F_13 ( V_8 ) , V_11 -> V_22 ) , L_2 , V_13 ) ;
}
if ( V_25 -> V_28 && ( F_14 ( V_6 , V_10 ) > 0 ) )
V_10 = V_25 -> V_28 ( V_6 , V_7 , V_8 ) ;
else
if ( F_14 ( V_6 , V_10 ) > 0 ) {
F_15 ( V_8 , V_6 , V_10 , - 1 , L_5 ) ;
V_10 += F_14 ( V_6 , V_10 ) ;
}
return V_10 ;
}
