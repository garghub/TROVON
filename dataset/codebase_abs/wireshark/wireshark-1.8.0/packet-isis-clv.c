...
const char * V_11 = F_10 ( V_1 , V_3 , V_4 ) ;
F_12 ( V_2 , V_10 ,
V_1 , V_3 , V_4 ,
V_11 , L_16 , V_4 , V_11 ) ;
}
...
void
F_13 ( T_1 * V_1 , T_2 * V_2 , int V_3 , int V_4 ,
int V_10 )
{
T_5 V_12 ;
const char * V_13 ;
...
F_19 ( V_1 , V_15 , V_3 , sizeof( V_15 ) ) ;
if ( V_2 ) {
F_20 ( V_2 , V_10 , V_1 , V_3 , 16 , V_15 ) ;
}
V_3 += 16 ;
V_4 -= 16 ;
}
...
void
F_22 ( T_1 * V_1 , T_2 * V_2 , int V_3 , int V_4 )
{
T_7 V_16 ;
T_3 * V_7 ;
if ( ! V_2 ) return;
...
V_4 = F_2 ( V_1 , V_3 ) ;
V_3 += 1 ;
V_26 = ( sizeof( V_23 ) + sizeof( V_4 ) + V_4 ) ;
V_20 -= V_26 ;
if ( V_20 < 0 ) {
F_3 ( V_1 , V_2 , V_3 ,
L_37 ,
...
V_24 = 0 ;
while ( ( V_19 [ V_24 ] . V_27 != NULL ) && ( V_19 [ V_24 ] . V_28 != V_23 ) ) {
V_24 ++ ;
}
if ( V_19 [ V_24 ] . V_27 ) {
if ( V_2 ) {
