...
V_11 = F_6 ( V_1 , V_46 + ( sizeof( T_3 ) * V_12 ) ) ;
F_10 ( V_9 , V_47 , V_1 ,
V_46 + ( sizeof( T_3 ) * V_12 ) , sizeof( T_3 ) ,
...
static int
F_23 ( T_1 * V_1 , T_6 * V_72 , T_2 * V_88 )
{
T_4 * V_89 ;
T_2 * V_73 ;
F_24 ( V_72 -> V_75 , V_90 , L_9 ) ;
if ( V_88 ) {
V_89 = F_14 ( V_88 , V_91 , V_1 , 0 , - 1 , V_67 ) ;
V_73 = F_9 ( V_89 , V_92 ) ;
} else {
V_73 = NULL ;
} ;
...
V_91 = F_26 ( L_10 , L_9 , L_11 ) ;
F_27 ( V_91 , V_94 , F_28 ( V_94 ) ) ;
F_29 ( V_93 , F_28 ( V_93 ) ) ;
}
void
F_30 ( void )
