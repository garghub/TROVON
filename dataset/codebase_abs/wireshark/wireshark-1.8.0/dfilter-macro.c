...
static T_13 * F_21 ( T_13 * V_16 , T_13 * * args , const T_13 * * error ) {
T_14 * V_27 ;
int V_33 = 0 ;
T_11 * V_24 = NULL ;
T_5 * V_3 ;
...
static T_13 * F_28 ( const T_13 * V_27 , T_10 V_38 , const T_13 * * error ) {
...
F_30 () ;
if ( V_46 ) {
T_13 * V_48 = F_28 ( V_43 -> V_37 , V_38 + 1 , error ) ;
F_27 ( V_43 , TRUE ) ;
return ( * error ) ? NULL : V_48 ;
} else {
T_13 * V_51 = F_26 ( V_43 -> V_37 ) ;
F_27 ( V_43 , TRUE ) ;
return V_51 ;
}
}
...
T_13 * F_36 ( const T_13 * V_27 , const T_13 * * error ) {
...
V_54 -> V_55 () ;
V_31 = F_33 () ;
V_32 = F_38 ( FALSE , FALSE , sizeof( int ) ) ;
V_24 -> V_56 = V_30 = V_53 = F_39 ( V_24 -> V_27 ) ;
V_45 = V_24 -> V_27 ;
F_34 ( V_31 , V_30 ) ;
while ( V_45 && * V_45 ) {
switch ( * V_45 ) {
...
static void * F_44 ( void * V_60 , const void * V_61 , T_18 T_19 V_1 ) {
T_11 * V_62 = ( T_11 * ) V_60 ;
const T_11 * V_24 = ( const T_11 * ) V_61 ;
F_23 ( V_24 ) ;
V_62 -> V_16 = F_39 ( V_24 -> V_16 ) ;
V_62 -> V_27 = F_39 ( V_24 -> V_27 ) ;
V_62 -> V_10 = V_24 -> V_10 ;
if ( V_24 -> V_31 ) {
T_10 V_63 = 0 ;
V_62 -> V_56 = F_39 ( V_24 -> V_27 ) ;
{
...
V_62 -> V_31 = ( T_13 * * ) F_45 ( V_24 -> V_31 , ( V_63 + 1 ) * ( T_10 ) sizeof( void * ) ) ;
V_63 = 0 ;
...
V_62 -> V_32 = ( int * ) F_45 ( V_24 -> V_32 , ( -- V_63 ) * ( T_10 ) sizeof( int ) ) ;
}
F_23 ( V_62 ) ;
return V_62 ;
}
static T_1 F_46 ( void * V_45 V_1 , const char * V_67 , unsigned V_68 , const void * T_20 V_1 , const void * T_21 V_1 , const char * * error ) {
T_10 V_21 ;
if ( V_68 == 0 ) {
* error = L_15 ;
return FALSE ;
...
void F_47 ( void ) {
static T_22 V_70 [] = {
F_48 ( V_71 , V_16 , L_17 , F_46 , L_18 ) ,
F_49 ( V_71 , V_27 , L_19 , L_20 ) ,
V_72
} ;
V_54 = F_50 ( L_21 ,
sizeof( T_11 ) ,
...
void F_53 ( const T_11 * V_24 , const char * V_76 , const char * V_77 , int line )
{
printf ( L_23 ) ;
if( V_24 == NULL ) {
