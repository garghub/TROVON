...
static int
F_35 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
V_51 = F_36 ( T_21 , T_23 , V_22 , V_20 , V_51 , T_24 ,
& V_83 ) ;
return V_51 ;
}
static int
F_37 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
V_51 = F_38 ( T_21 , T_23 , V_22 , V_20 , V_51 , T_24 ) ;
return V_51 ;
}
int
F_39 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
V_51 = F_40 ( T_23 , V_22 , V_20 , V_51 ,
V_84 , T_24 , V_85 ,
NULL ) ;
return V_51 ;
}
...
static int
F_43 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
#line 30 "../../asn1/ros/ros.cnf"
char * V_1 ;
struct V_29 * V_30 = (struct V_29 * ) T_23 -> V_21 -> V_31 ;
F_21 ( V_22 , V_20 , V_51 , - 1 , L_7 ) ;
F_28 ( V_20 , T_23 -> V_21 , V_22 , V_83 , TRUE ) ;
if( V_30 && V_30 -> V_86 && ( V_1 = F_44 ( T_23 -> V_21 , V_30 -> V_86 ) ) ) {
V_30 -> V_36 = ( V_87 | V_45 ) ;
V_30 -> V_36 |= V_15 ;
...
static int
F_45 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
V_51 = F_46 ( T_21 , T_23 , V_22 , V_20 , V_51 ,
V_89 , T_24 , V_90 ) ;
return V_51 ;
}
static int
...
char * V_1 ;
struct V_29 * V_30 = (struct V_29 * ) T_23 -> V_21 -> V_31 ;
F_21 ( V_22 , V_20 , V_51 , - 1 , L_8 ) ;
F_28 ( V_20 , T_23 -> V_21 , V_22 , V_83 , FALSE ) ;
if( V_30 && V_30 -> V_86 && ( V_1 = F_44 ( T_23 -> V_21 , V_30 -> V_86 ) ) ) {
V_30 -> V_36 = ( V_87 | V_47 ) ;
V_30 -> V_36 |= V_15 ;
V_51 = F_16 ( V_1 , V_20 , V_51 , T_23 -> V_21 , V_88 ) ;
...
static int
F_53 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
#line 169 "../../asn1/ros/ros.cnf"
T_25 V_97 ;
V_51 = F_36 ( T_21 , T_23 , V_22 , V_20 , V_51 , T_24 ,
& V_97 ) ;
if ( F_14 ( T_23 -> V_21 -> V_34 , V_50 ) ) {
F_54 ( T_23 -> V_21 -> V_34 , V_50 , L_9 , F_13 ( V_97 , V_98 , L_10 ) ) ;
}
return V_51 ;
}
static int
...
& V_97 ) ;
if ( F_14 ( T_23 -> V_21 -> V_34 , V_50 ) ) {
F_54 ( T_23 -> V_21 -> V_34 , V_50 , L_9 , F_13 ( V_97 , V_99 , L_11 ) ) ;
}
return V_51 ;
}
static int
...
& V_97 ) ;
if ( F_14 ( T_23 -> V_21 -> V_34 , V_50 ) ) {
F_54 ( T_23 -> V_21 -> V_34 , V_50 , L_9 , F_13 ( V_97 , V_100 , L_12 ) ) ;
}
return V_51 ;
}
static int
...
& V_97 ) ;
if ( F_14 ( T_23 -> V_21 -> V_34 , V_50 ) ) {
F_54 ( T_23 -> V_21 -> V_34 , V_50 , L_9 , F_13 ( V_97 , V_101 , L_13 ) ) ;
}
return V_51 ;
}
static int
...
V_51 = F_59 ( T_21 , V_20 , V_51 , T_23 , V_22 , T_24 ) ;
return V_51 ;
}
static int
...
static int
F_68 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
V_51 = F_69 ( T_21 , T_23 , V_22 , V_20 , V_51 , T_24 , NULL ) ;
return V_51 ;
}
int
F_70 ( T_3 T_21 V_3 , T_9 * V_20 V_3 , int V_51 V_3 , T_22 * T_23 V_3 , T_11 * V_22 V_3 , int T_24 V_3 ) {
V_51 = F_40 ( T_23 , V_22 , V_20 , V_51 ,
V_109 , T_24 , V_110 ,
NULL ) ;
return V_51 ;
...
static void
F_71 ( T_9 * V_20 , T_10 * V_21 , T_11 * V_111 )
{
int V_51 = 0 ;
int V_112 ;
T_14 * V_27 = NULL ;
...
T_19 * V_69 = NULL ;
T_22 V_114 ;
F_72 ( & V_114 , V_115 , TRUE , V_21 ) ;
V_88 = V_111 ;
if( ! V_21 -> V_31 ) {
if( V_111 ) {
F_21 ( V_111 , V_20 , V_51 , - 1 ,
L_21 ) ;
}
return ;
}
V_113 = F_73 ( V_21 ) ;
V_69 = F_74 ( V_113 , V_116 ) ;
if ( V_69 == NULL ) {
V_69 = F_75 ( sizeof( T_19 ) ) ;
V_69 -> V_75 = F_76 ( F_24 , F_25 ) ;
V_69 -> V_76 = F_76 ( F_26 , F_27 ) ;
F_77 ( V_113 , V_116 , V_69 ) ;
V_69 -> V_117 = V_70 ;
V_70 = V_69 ;
}
if( V_111 ) {
...
V_112 = V_51 ;
V_51 = F_67 ( FALSE , V_20 , V_51 , & V_114 , V_22 , - 1 ) ;
if( V_51 == V_112 ) {
V_27 = F_21 ( V_22 , V_20 , V_51 , - 1 , L_23 ) ;
if( V_27 ) {
F_22 ( V_21 , V_27 , V_56 , V_57 , L_23 ) ;
V_54 = F_11 ( V_27 , V_55 ) ;
