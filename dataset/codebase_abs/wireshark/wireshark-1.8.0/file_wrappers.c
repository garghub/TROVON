...
static int
F_3 ( T_2 V_5 , unsigned char * V_6 , unsigned int V_7 , unsigned * V_8 )
{
int V_9 ;
* V_8 = 0 ;
do {
...
return - 1 ;
if ( V_5 -> V_15 == 0 ) {
if ( F_3 ( V_5 , V_5 -> V_16 , V_5 -> V_17 , ( unsigned * ) & ( V_5 -> V_18 ) ) == - 1 )
return - 1 ;
V_5 -> V_19 = V_5 -> V_16 ;
}
return 0 ;
...
static void
F_7 ( T_2 V_21 , T_3 V_32 , T_3 V_33 , int V_34 )
{
...
static void
F_18 ( T_2 V_21 , struct V_39 * V_44 , int V_45 , T_3 V_32 , T_3 V_33 )
{
...
V_35 -> V_47 . V_48 . V_52 = V_21 -> V_53 . V_52 ;
V_35 -> V_47 . V_48 . V_54 = V_21 -> V_53 . V_54 ;
F_9 ( V_21 -> V_28 , V_35 ) ;
}
}
static void
...
static int
F_29 ( T_2 V_5 , T_3 V_29 )
{
unsigned V_43 ;
while ( V_29 )
if ( V_5 -> V_8 ) {
V_43 = ( T_3 ) V_5 -> V_8 > V_29 ? ( unsigned ) V_29 : V_5 -> V_8 ;
V_5 -> V_8 -= V_43 ;
V_5 -> V_71 += V_43 ;
V_5 -> V_22 += V_43 ;
V_29 -= V_43 ;
...
void
F_41 ( T_2 V_99 , T_10 T_11 V_36 , T_12 * V_82 )
{
V_99 -> V_28 = V_82 ;
}
T_3
F_42 ( T_2 V_21 , T_3 V_100 , int V_101 , int * V_12 )
{
struct V_20 * V_102 ;
unsigned V_43 ;
if ( V_101 != V_103 && V_101 != V_88 ) {
F_43 () ;
}
if ( V_101 == V_103 )
V_100 -= V_21 -> V_22 ;
...
V_100 += V_21 -> V_104 ;
V_21 -> V_82 = 0 ;
if ( V_100 < 0 && V_21 -> V_71 ) {
unsigned V_105 = ( unsigned ) ( V_21 -> V_71 - V_21 -> V_31 ) ;
if ( - V_100 <= V_105 ) {
unsigned V_106 = ( unsigned ) ( - V_100 ) ;
V_21 -> V_8 += V_106 ;
V_21 -> V_71 -= V_106 ;
V_21 -> V_22 -= V_106 ;
return V_21 -> V_22 ;
...
if ( ( V_102 = F_6 ( V_21 , V_21 -> V_22 + V_100 ) ) && ( V_100 < 0 || V_100 > V_46 || V_102 -> V_34 == V_80 ) ) {
T_3 V_107 , V_108 ;
#ifdef F_11
if ( V_102 -> V_34 == V_37 ) {
#ifdef F_19
V_107 = V_102 -> V_16 - ( V_102 -> V_47 . V_48 . V_45 ? 1 : 0 ) ;
#else
V_107 = V_102 -> V_16 ;
#endif
V_108 = V_102 -> V_31 ;
} else if ( V_102 -> V_34 == V_79 ) {
V_107 = V_102 -> V_16 ;
V_108 = V_102 -> V_31 ;
} else
#endif
{
V_108 = ( V_21 -> V_22 + V_100 ) ;
V_107 = V_102 -> V_16 + ( V_108 - V_102 -> V_31 ) ;
}
if ( F_34 ( V_21 -> V_10 , V_107 , V_103 ) == - 1 ) {
* V_12 = V_13 ;
return - 1 ;
}
F_10 ( V_21 ) ;
...
T_13 * V_53 = & V_21 -> V_53 ;
F_26 ( V_53 ) ;
V_53 -> V_52 = V_102 -> V_47 . V_48 . V_52 ;
V_53 -> V_54 = V_102 -> V_47 . V_48 . V_54 ;
#ifdef F_19
if ( V_102 -> V_47 . V_48 . V_45 ) {
T_2 V_5 = V_21 ;
int V_9 = F_13 () ;
if ( V_9 == - 1 ) {
if ( V_5 -> V_12 == 0 ) {
...
( void ) F_44 ( V_53 , V_102 -> V_47 . V_48 . V_45 , V_9 >> ( 8 - V_102 -> V_47 . V_48 . V_45 ) ) ;
}
#endif
( void ) F_45 ( V_53 , V_102 -> V_47 . V_48 . V_51 , V_50 ) ;
V_21 -> V_34 = V_37 ;
} else if ( V_102 -> V_34 == V_79 ) {
T_13 * V_53 = & V_21 -> V_53 ;
F_26 ( V_53 ) ;
...
#endif
V_21 -> V_34 = V_102 -> V_34 ;
V_100 = ( V_21 -> V_22 + V_100 ) - V_108 ;
V_21 -> V_22 = V_108 ;
if ( V_100 ) {
V_21 -> V_82 = 1 ;
V_21 -> V_104 = V_100 ;
}
return V_21 -> V_22 + V_100 ;
}
if ( V_21 -> V_34 == V_80 && V_21 -> V_22 + V_100 >= V_21 -> V_81
&& ( V_100 < 0 || V_100 >= V_21 -> V_8 ) )
{
if ( F_34 ( V_21 -> V_10 , V_100 - V_21 -> V_8 , V_88 ) == - 1 ) {
* V_12 = V_13 ;
return - 1 ;
}
V_21 -> V_11 += ( V_100 - V_21 -> V_8 ) ;
V_21 -> V_8 = 0 ;
V_21 -> V_15 = 0 ;
V_21 -> V_82 = 0 ;
V_21 -> V_12 = 0 ;
...
if ( F_34 ( V_21 -> V_10 , V_21 -> V_87 , V_103 ) == - 1 ) {
* V_12 = V_13 ;
return - 1 ;
}
F_10 ( V_21 ) ;
...
V_43 = ( T_3 ) V_21 -> V_8 > V_100 ? ( unsigned ) V_100 : V_21 -> V_8 ;
V_21 -> V_8 -= V_43 ;
V_21 -> V_71 += V_43 ;
V_21 -> V_22 += V_43 ;
V_100 -= V_43 ;
...
T_3
F_46 ( T_2 V_21 , T_3 V_110 , int * V_12 )
{
return F_42 ( V_21 , V_110 , V_88 , V_12 ) ;
}
T_3
F_47 ( T_2 V_99 )
{
return V_99 -> V_22 + ( V_99 -> V_82 ? V_99 -> V_104 : 0 ) ;
}
T_3
F_48 ( T_2 V_99 )
{
...
int
F_49 ( T_2 V_99 , T_14 * V_111 , int * V_12 )
{
if ( F_50 ( V_99 -> V_10 , V_111 ) == - 1 ) {
if ( V_12 != NULL )
* V_12 = V_13 ;
return - 1 ;
}
...
V_114 = ( unsigned char * ) memchr ( V_21 -> V_71 , '\n' , V_43 ) ;
if ( V_114 != NULL )
V_43 = ( unsigned ) ( V_114 - V_21 -> V_71 ) + 1 ;
memcpy ( V_6 , V_21 -> V_71 , V_43 ) ;
V_21 -> V_8 -= V_43 ;
V_21 -> V_71 += V_43 ;
V_21 -> V_22 += V_43 ;
...
int
F_56 ( T_2 V_115 , T_15 * * V_14 )
{
if ( V_115 -> V_12 != 0 ) {
* V_14 = ( V_115 -> V_14 == NULL ) ? NULL : F_57 ( V_115 -> V_14 ) ;
return V_115 -> V_12 ;
}
return 0 ;
}
...
T_16 V_5 ;
int V_116 ;
V_10 = F_38 ( V_94 , V_98 | V_117 | V_118 | V_119 , 0666 ) ;
if ( V_10 == - 1 )
return NULL ;
V_5 = F_64 ( V_10 ) ;
if ( V_5 == NULL ) {
...
V_9 = V_93 ;
do {
if ( V_53 -> V_58 == 0 || ( V_126 != V_60 &&
( V_126 != V_127 || V_9 == V_69 ) ) ) {
V_8 = ( unsigned ) ( V_53 -> V_59 - V_5 -> V_71 ) ;
if ( V_8 ) {
V_112 = F_69 ( V_5 -> V_10 , V_5 -> V_71 , V_8 ) ;
if ( V_112 < 0 ) {
V_5 -> V_12 = V_13 ;
return - 1 ;
}
if ( ( unsigned ) V_112 != V_8 ) {
V_5 -> V_12 = V_128 ;
return - 1 ;
}
}
...
unsigned
F_72 ( T_16 V_5 , const void * V_6 , unsigned V_29 )
{
unsigned V_129 = V_29 ;
unsigned V_43 ;
T_9 V_53 ;
