...
if ( V_1 ) V_5 = F_3 ( V_1 , V_2 , * V_3 , 2 * sizeof( T_7 ) + sizeof( T_8 ) , L_32 , V_25 ) ;
V_6 += sizeof( T_7 ) ;
V_26 = F_6 ( V_2 , * V_3 + V_6 ) ;
V_27 = F_5 ( V_2 , * V_3 + V_6 + sizeof( T_8 ) ) ;
if ( V_1 ) {
F_7 ( V_5 , L_33 , V_27 ) ;
...
if ( V_1 ) {
T_9 V_30 = 1 ;
V_5 = F_3 ( V_1 , V_2 , V_3 , sizeof( T_10 ) , L_39 ) ;
...
V_3 += sizeof( T_10 ) ;
F_14 ( V_1 , V_31 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
F_14 ( V_1 , V_32 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
...
T_6 V_17 ;
T_8 V_33 ;
V_17 = F_20 ( V_1 , V_34 , V_2 , & V_3 , sizeof( T_6 ) , NULL ) ;
if ( V_4 -> V_15 >= V_16 ) {
V_33 = F_6 ( V_2 , V_3 ) ;
if ( V_1 ) {
F_21 ( V_1 , V_35 , V_2 , V_3 , sizeof( T_8 ) , V_33 & V_36 ) ;
F_21 ( V_1 , V_37 , V_2 , V_3 , sizeof( T_8 ) , V_33 & V_38 ) ;
}
V_3 += sizeof( T_8 ) ;
}
...
T_3 V_3 = 0 ;
F_14 ( V_1 , V_31 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
F_14 ( V_1 , V_40 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
F_15 ( V_2 , V_3 , V_4 , V_1 ) ;
}
void
...
T_8 V_41 ;
F_28 ( V_1 , V_2 , & V_3 ) ;
V_41 = F_14 ( V_1 , V_31 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
if ( V_41 == V_42 ) {
F_14 ( V_1 , V_43 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
F_14 ( V_1 , V_44 , V_2 , & V_3 , sizeof( T_7 ) , NULL ) ;
}
else if ( V_41 == V_45 ) {
F_14 ( V_1 , V_43 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
}
else if ( V_41 <= V_46 ) {
F_14 ( V_1 , V_47 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
}
F_15 ( V_2 , V_3 , V_4 , V_1 ) ;
}
void
...
F_14 ( V_1 , V_50 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
F_14 ( V_1 , V_32 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
V_49 = F_14 ( V_1 , V_51 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
if ( V_1 && V_49 ) {
...
V_49 = F_14 ( V_1 , V_51 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
if ( V_1 && V_49 ) {
V_5 = F_3 ( V_1 , V_2 , V_3 , V_49 * ( sizeof( T_7 ) + sizeof( T_6 ) ) , L_50 ) ;
V_48 = F_32 ( V_5 , V_56 ) ;
} else {
V_48 = NULL ;
}
...
T_7 V_58 = F_5 ( V_2 , V_3 + sizeof( T_6 ) ) ;
if ( V_48 ) {
F_3 ( V_48 , V_2 , V_3 , sizeof( T_7 ) + sizeof( T_6 ) , L_51 , F_10 ( V_57 ) , V_58 ) ;
}
V_3 += sizeof( T_7 ) + sizeof( T_6 ) ;
}
F_22 ( V_1 , V_4 , L_46 , F_33 ( V_26 ) ) ;
F_15 ( V_2 , V_3 , V_4 , V_1 ) ;
}
...
F_14 ( V_1 , V_61 , V_2 , & V_3 , sizeof( T_7 ) , NULL ) ;
F_14 ( V_1 , V_62 , V_2 , & V_3 , sizeof( T_7 ) , NULL ) ;
V_60 = F_14 ( V_1 , V_63 , V_2 , & V_3 , sizeof( T_8 ) , NULL ) ;
for ( V_28 = 0 , V_59 = 0 ; V_28 < ( 8 * sizeof( T_10 ) ) ; V_28 ++ ) {
T_8 V_64 ;
if ( ! ( ( 1 << V_28 ) & V_29 ) ) {
continue;
}
...
V_64 = F_6 ( V_2 , V_3 ) ;
if ( V_1 ) {
F_3 ( V_1 , V_2 , V_3 , sizeof( T_8 ) , L_52 , V_28 , V_64 ) ;
}
V_3 += sizeof( T_8 ) ;
V_59 ++ ;
}
