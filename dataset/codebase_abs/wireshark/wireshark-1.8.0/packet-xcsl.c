...
if ( F_10 ( V_10 -> V_18 , V_20 ) )
F_11 ( V_10 -> V_18 , V_20 , L_2 , V_4 ) ;
break;
case 2 :
if ( isdigit ( V_4 [ 0 ] ) ) {
T_9 * V_21 ;
...
F_13 ( V_21 , L_4 , V_16 ) ;
if ( V_15 != 0 && F_10 ( V_10 -> V_18 , V_20 ) )
F_11 ( V_10 -> V_18 , V_20 , L_5 , V_16 ) ;
} else {
V_13 = TRUE ;
...
if ( F_10 ( V_10 -> V_18 , V_20 ) ) {
if ( V_13 == TRUE ) {
F_11 ( V_10 -> V_18 , V_20 , L_6 , V_4 ) ;
} else {
if ( V_14 == 0 ) {
F_11 ( V_10 -> V_18 , V_20 , L_7 , V_4 ) ;
} else {
F_11 ( V_10 -> V_18 , V_20 , L_6 , V_4 ) ;
}
}
...
static T_1 F_14 ( T_2 * V_1 , T_6 * V_10 , T_7 * V_11 ) {
T_3 V_2 = 0 ;
T_4 * V_35 ;
if ( F_15 ( V_1 , V_2 ) >= 5 ) {
V_35 = F_16 ( V_1 , V_2 , 5 ) ;
if ( strncmp ( V_35 , L_8 , 4 ) == 0 && ( V_35 [ 4 ] == ';' || V_35 [ 4 ] == '-' ) ) {
F_3 ( V_1 , V_10 , V_11 ) ;
return TRUE ;
}
}
