...
if ( V_2 ) {
V_94 = F_23 ( V_2 , V_195 , V_4 , 0 , - 1 , V_100 ) ;
V_189 = F_24 ( V_94 , V_196 ) ;
type = F_25 ( V_4 , V_30 ) & 0x1f ;
if( type == 28 )
V_186 = F_34 ( V_189 , V_4 , V_30 , 1 , L_23 ) ;
else
V_186 = F_34 ( V_189 , V_4 , V_30 , 1 , L_24 ) ;
V_175 = F_24 ( V_186 , V_197 ) ;
F_23 ( V_175 , V_198 , V_4 , V_30 , 1 , V_27 ) ;
F_23 ( V_175 , V_199 , V_4 , V_30 , 1 , V_27 ) ;
F_54 ( T_10 -> V_193 , V_200 , L_25 ,
F_8 ( type , V_201 , L_26 ) ) ;
...
static int
F_55 ( T_4 * V_4 , T_9 * T_10 V_29 , T_3 * V_2 )
{
int V_30 = 0 ;
F_56 ( V_2 , V_4 , V_30 ,
V_208 , V_209 ,
...
static int
F_57 ( T_4 * V_4 , T_9 * T_10 V_29 , T_3 * V_2 )
{
int V_30 = 0 ;
F_56 ( V_2 , V_4 , V_30 ,
V_211 , V_212 ,
...
static int
F_58 ( T_4 * V_4 , T_9 * T_10 V_29 , T_3 * V_2 )
{
int V_30 = 0 ;
F_56 ( V_2 , V_4 , V_30 ,
V_214 , V_215 ,
...
static int
F_59 ( T_4 * V_4 , T_9 * T_10 , T_3 * V_2 V_29 )
{
int V_30 = 0 ;
T_14 V_217 ;
const T_13 * V_218 = NULL ;
T_15 * V_219 ;
V_219 = F_60 ( T_10 -> V_220 ) ;
F_61 ( V_219 ) ;
V_217 = F_62 ( V_4 , V_30 ) ;
V_218 = F_63 ( V_217 , F_64 ( V_221 ) ) ;
if ( V_218 ) {
...
static int
F_65 ( T_4 * V_4 , T_9 * T_10 V_29 , T_3 * V_2 V_29 )
{
T_15 * V_219 ;
V_219 = F_60 ( T_10 -> V_220 ) ;
F_61 ( V_219 ) ;
...
static T_16 * F_66 ( const T_13 * V_223 ) {
T_16 * V_224 = NULL ;
T_16 * V_225 ;
...
static void
F_67 ( T_4 * V_4 V_29 , T_9 * T_10 , T_3 * V_2 )
{
T_15 * V_219 ;
T_16 * V_224 = NULL ;
V_219 = F_60 ( T_10 -> V_220 ) ;
F_61 ( V_219 ) ;
if ( V_2 ) {
V_224 = F_66 ( T_10 -> V_227 ) ;
if ( V_224 ) {
F_26 ( V_219 -> V_222 , L_30 , V_224 -> V_19 ) ;
F_26 ( F_68 ( F_69 ( V_2 ) ) , L_31 , V_224 -> V_19 ) ;
} else {
F_26 ( V_219 -> V_222 , L_32 , T_10 -> V_227 ) ;
}
}
}
static void F_70 ( T_2 V_228 ) {
if ( V_228 >= 96 && V_228 <= 127 )
F_71 ( L_33 , V_228 , V_229 ) ;
}
static void F_72 ( T_2 V_228 ) {
if ( V_228 >= 96 && V_228 <= 127 )
F_73 ( L_33 , V_228 , V_229 ) ;
}
void
F_74 ( void )
{
static T_17 * V_230 = NULL ;
static T_1 V_231 = FALSE ;
if ( ! V_231 ) {
T_18 V_232 ;
T_16 * V_224 ;
V_229 = F_75 ( L_34 ) ;
F_76 ( L_35 , L_22 , V_229 ) ;
V_232 = F_77 ( F_67 , V_195 ) ;
for ( V_224 = V_226 ; V_224 -> V_223 ; V_224 ++ ) {
if ( V_224 -> V_19 )
F_76 ( L_36 , V_224 -> V_223 , V_232 ) ;
if ( V_224 -> V_233 )
F_76 ( L_37 , V_224 -> V_223 , F_78 ( V_224 -> V_233 , V_195 ) ) ;
}
V_231 = TRUE ;
} else {
F_79 ( V_230 , F_70 ) ;
...
{ & V_198 ,
{ L_38 , L_39 ,
V_237 , 8 , F_82 ( & V_238 ) , 0x80 ,
NULL , V_239 }
} ,
{ & V_199 ,
{ L_40 , L_41 ,
V_240 , V_24 , NULL , 0x60 ,
NULL , V_239 }
} ,
{ & V_202 ,
{ L_42 , L_43 ,
V_240 , V_24 , F_64 ( V_201 ) , 0x1f ,
NULL , V_239 }
} ,
{ & V_204 ,
{ L_44 , L_45 ,
V_237 , 8 , F_82 ( & V_241 ) , 0x80 ,
NULL , V_239 }
} ,
{ & V_205 ,
{ L_46 , L_47 ,
V_237 , 8 , F_82 ( & V_242 ) , 0x40 ,
NULL , V_239 }
} ,
{ & V_206 ,
{ L_48 , L_49 ,
V_240 , V_24 , NULL , 0x20 ,
NULL , V_239 }
} ,
{ & V_99 ,
{ L_50 , L_51 ,
...
{ & V_103 ,
{ L_58 , L_59 ,
V_240 , V_24 , NULL , 0x80 ,
NULL , V_239 }
} ,
{ & V_104 ,
{ L_60 , L_61 ,
V_240 , V_24 , NULL , 0x40 ,
NULL , V_239 }
} ,
{ & V_105 ,
{ L_62 , L_63 ,
...
{ & V_106 ,
{ L_64 , L_65 ,
V_240 , V_24 , NULL , 0x10 ,
NULL , V_239 }
} ,
{ & V_107 ,
{ L_66 , L_67 ,
V_240 , V_24 , NULL , 0x0f ,
NULL , V_239 }
} ,
{ & V_108 ,
{ L_68 , L_69 ,
V_240 , V_24 , NULL , 0xff ,
NULL , V_239 }
} ,
{ & V_178 ,
{ L_70 , L_71 ,
...
V_195 = F_83 ( L_293 , L_22 , L_34 ) ;
F_84 ( V_195 , V_236 , F_85 ( V_236 ) ) ;
F_86 ( V_265 , F_85 ( V_265 ) ) ;
V_235 = F_87 ( V_195 , F_74 ) ;
F_88 ( V_235 , L_294 ,
L_295 ,
L_296
L_297 ,
& V_234 , 127 ) ;
F_89 ( L_34 , F_52 , V_195 ) ;
}
