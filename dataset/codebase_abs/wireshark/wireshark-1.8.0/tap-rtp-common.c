...
V_44 . V_68 . time = 0 ;
V_44 . V_68 . V_89 = V_90 ;
V_46 = F_16 ( V_39 -> V_56 , F_17 ( L_2 ) ) ;
if ( V_46 )
V_44 . V_91 = V_46 -> V_92 ;
else
V_44 . V_91 = 0xFFFFFFFF ;
V_21 = F_18 ( sizeof( T_5 ) ) ;
* V_21 = V_44 ;
...
if ( V_115 -> V_69 ) {
V_115 -> V_84 = V_43 -> V_124 ;
V_115 -> V_85 = V_43 -> V_124 ;
V_115 -> V_125 = V_43 -> V_124 ;
V_115 -> V_88 = V_116 ;
V_115 -> V_80 = V_43 -> V_126 ;
V_115 -> V_127 = V_43 -> V_126 ;
V_115 -> time = V_116 ;
V_115 -> V_128 = 0 ;
V_115 -> V_52 = V_43 -> V_53 ;
V_115 -> V_89 = V_43 -> V_53 ;
V_115 -> V_129 [ V_115 -> V_79 ] . V_130 = V_43 -> V_100 + 28 ;
V_115 -> V_129 [ V_115 -> V_79 ] . time = V_116 ;
V_115 -> V_79 ++ ;
...
V_115 -> V_93 = 0 ;
if ( ( V_43 -> V_124 < V_115 -> V_84 ) && ( V_115 -> V_87 == FALSE ) ) {
V_115 -> V_86 ++ ;
V_115 -> V_87 = TRUE ;
}
else if ( ( V_43 -> V_124 == 0 ) && ( V_115 -> V_85 == 65535 ) &&
( V_115 -> V_87 == FALSE ) ) {
V_115 -> V_86 ++ ;
V_115 -> V_87 = TRUE ;
}
else if ( ( V_43 -> V_124 > V_115 -> V_84 ) && ( V_115 -> V_87 != FALSE ) ) {
V_115 -> V_87 = FALSE ;
}
if ( ( V_115 -> V_125 + 1 == V_43 -> V_124 ) || ( V_115 -> V_93 & V_131 ) )
V_115 -> V_125 = V_43 -> V_124 ;
else if ( ( V_115 -> V_125 == 65535 ) && ( V_43 -> V_124 == 0 ) )
V_115 -> V_125 = V_43 -> V_124 ;
else if ( V_115 -> V_125 + 1 < V_43 -> V_124 ) {
V_115 -> V_125 = V_43 -> V_124 ;
V_115 -> V_83 ++ ;
V_115 -> V_93 |= V_95 ;
}
...
if ( V_115 -> V_127 > V_43 -> V_126 ) {
V_119 = ( double ) ( V_43 -> V_126 + 0xffffffff - V_115 -> V_127 + 1 ) ;
} else{
V_119 = ( double ) ( V_43 -> V_126 - V_115 -> V_127 ) ;
}
if ( V_123 != 0 ) {
V_115 -> V_123 = V_123 ;
V_119 = V_119 / ( V_123 / 1000 ) ;
if ( ! V_115 -> V_69 ) {
V_121 = V_115 -> time + ( V_119 - V_115 -> V_128 ) ;
...
V_115 -> V_128 = V_119 ;
V_115 -> V_141 = V_119 - V_120 ;
V_122 = fabs ( V_115 -> V_141 ) ;
if( V_122 > fabs ( V_115 -> V_142 ) ) {
V_115 -> V_142 = V_115 -> V_141 ;
}
#if 0
...
#endif
V_115 -> V_143 += 1.0 * V_116 ;
V_115 -> V_144 += 1.0 * V_119 ;
V_115 -> V_145 += 1.0 * V_116 * V_116 ;
V_115 -> V_146 += 1.0 * V_116 * V_119 ;
}
V_115 -> V_129 [ V_115 -> V_79 ] . V_130 = V_43 -> V_100 + V_39 -> V_147 + 8 ;
V_115 -> V_129 [ V_115 -> V_79 ] . time = V_116 ;
while ( ( V_115 -> V_129 [ V_115 -> V_78 ] . time + 1000 ) < V_116 ) {
V_115 -> V_77 -= V_115 -> V_129 [ V_115 -> V_78 ] . V_130 ;
V_115 -> V_78 ++ ;
if ( V_115 -> V_78 == V_148 ) V_115 -> V_78 = 0 ;
} ;
V_115 -> V_77 += V_43 -> V_100 + V_39 -> V_147 + 8 ;
V_115 -> V_76 = ( double ) ( V_115 -> V_77 * 8 ) / 1000 ;
V_115 -> V_79 ++ ;
if ( V_115 -> V_79 == V_148 ) V_115 -> V_79 = 0 ;
if ( V_43 -> V_132 ) {
V_115 -> V_149 = V_43 -> V_126 - V_115 -> V_80 ;
if ( V_43 -> V_126 > V_115 -> V_80 ) {
V_115 -> V_93 |= V_133 ;
}
else{
V_115 -> V_93 |= V_94 ;
