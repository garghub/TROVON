...
static char *
F_27 ( T_5 * V_6 , T_2 V_5 , T_2 V_20 )
{
char * V_11 = F_4 ( L_54 ,
F_28 ( V_6 , V_20 + V_5 , NULL ) ) ;
return V_11 ;
}
static char *
F_29 ( T_5 * V_6 , T_2 V_5 , T_2 V_20 )
{
char * V_11 = F_4 ( L_55 ,
F_28 ( V_6 , V_20 + V_5 , NULL ) ) ;
return V_11 ;
...
static char *
F_31 ( T_5 * V_6 V_8 , T_2 V_5 , T_2 V_20 V_8 )
{
char * V_11 = F_4 ( L_57 ,
F_32 ( V_5 , & V_21 ,
L_58 ) ) ;
...
static char *
F_33 ( T_5 * V_6 V_8 , T_2 V_5 , T_2 V_20 V_8 )
{
char * V_11 = F_4 ( L_57 ,
F_34 ( V_5 , V_22 ,
L_59 ) ) ;
...
static char *
F_35 ( T_5 * V_6 V_8 , T_2 V_5 , T_2 V_20 V_8 )
{
char * V_11 = F_4 ( L_57 ,
F_34 ( V_5 , V_23 ,
L_60 ) ) ;
...
static const T_10 *
F_36 ( T_5 * V_6 , T_2 V_7 )
{
T_2 V_24 = F_14 ( V_6 , V_7 + 0 ) ;
T_9 V_25 = F_12 ( V_6 , V_7 + 4 ) ;
...
static const T_10 * F_37 ( T_2 V_30 )
{
...
static const char *
F_41 ( const T_3 * V_37 , T_6 T_8 , T_6 T_7 ) {
const T_1 * V_38 ;
const char * V_39 ;
if ( V_37 ) {
...
static void
F_43 ( T_5 * V_6 , T_13 * V_43 , T_14 * V_44 )
{
F_44 ( V_6 , V_43 , V_44 , NULL ) ;
}
static void
F_45 ( T_5 * V_6 , T_13 * V_43 , T_14 * V_44 )
{
F_44 ( V_6 , V_43 , V_44 , & V_45 ) ;
}
static void
...
T_6 V_63 = 0 ;
T_6 V_64 = 0 ;
F_38 ( ( L_66 , V_43 -> V_65 -> V_66 ) ) ;
switch ( V_51 = F_9 ( V_6 , 0 ) ) {
case 0x00 :
break;
case 0x01 :
case 0x02 :
...
static void
F_57 ( T_14 * V_44 , T_5 * V_6 , T_2 V_20 ,
T_2 V_58 )
{
T_2 V_85 = V_20 ;
T_2 V_52 = 0 ;
T_2 V_86 = V_20 + V_58 ;
F_56 ( V_44 , V_6 , V_85 , V_86 ,
L_87 ) ;
while ( V_85 < V_86 ) {
V_52 = F_51 ( V_6 , V_85 ) ;
F_56 ( V_44 , V_6 , V_85 , V_52 ,
L_88 ,
V_85 - V_20 , V_52 ,
...
static const char * F_60 ( T_6 V_60 ) {
...
while ( V_85 < V_88 ) {
V_19 = F_9 ( V_6 , V_85 ) ;
F_38 ( ( L_90 , * V_60 , V_19 , V_85 , V_88 ) ) ;
if ( ( V_19 & 0x3F ) < 4 ) switch ( V_19 ) {
case 0x00 :
* V_63 = F_9 ( V_6 , V_85 + 1 ) ;
F_56 ( V_44 , V_6 , V_85 , 2 ,
L_91
L_92
L_93 ,
* V_63 ) ;
...
( * V_60 ) -- ;
V_85 ++ ;
F_38 ( ( L_99 , * V_60 , V_85 - V_7 ) ) ;
return ( V_85 - V_7 ) ;
case 0x02 :
V_90 = F_3 ( V_6 , V_85 + 1 , & V_52 ) ;
F_56 ( V_44 , V_6 , V_85 , 1 + V_52 ,
L_94
L_100
L_101 ,
* V_60 , * V_63 , F_60 ( * V_60 ) , V_90 ) ;
V_85 += 1 + V_52 ;
break;
case 0x03 :
...
L_107 ,
* V_60 , * V_63 , F_60 ( * V_60 ) ) ;
V_52 = F_62 ( V_44 , V_6 , V_85 ,
V_20 , * V_60 , V_64 , V_31 ) ;
V_85 += V_52 ;
if ( V_85 >= V_88 ) {
F_38 ( ( L_108 , * V_60 , V_85 - V_7 ) ) ;
F_63 ( V_99 ) ;
}
F_56 ( V_44 , V_6 , V_85 - 1 , 1 ,
L_94
L_109
L_110 ,
* V_60 , * V_63 , F_60 ( * V_60 ) ) ;
...
V_39 = F_4 ( L_111 , V_19 & 0x03 ,
F_41 ( V_31 -> V_98 , 0 , V_19 ) ) ;
F_56 ( V_44 , V_6 , V_85 , 1 + V_52 ,
L_94
L_112
L_113 ,
* V_60 , * V_63 , V_19 & 0x0f , F_60 ( * V_60 ) ,
V_39 ) ;
F_53 ( V_39 ) ;
}
V_85 += 1 + V_52 ;
...
V_92 = 0 ;
if ( ( V_19 & 0x3F ) == 4 ) {
F_38 ( ( L_120 , V_19 , V_85 ) ) ;
V_91 = F_3 ( V_6 , V_85 + 1 , & V_92 ) ;
V_89 = F_51 ( V_6 , V_20 + V_91 ) ;
V_96 = ( T_17 * ) F_64 ( V_6 , V_20 + V_91 , V_89 ) ;
V_94 = 0 ;
} else {
V_94 = V_19 & 0x3F ;
V_96 = F_41 ( V_31 -> V_103 , * V_63 ,
V_94 ) ;
}
if ( V_19 & 0x40 ) {
if ( V_97 ) {
...
F_38 ( ( L_139 , * V_60 , V_85 - V_7 ) ) ;
return ( V_85 - V_7 ) ;
}
static T_2
F_59 ( T_14 * V_44 , T_5 * V_6 , T_2 V_7 ,
T_2 V_20 , T_6 * V_60 ,
T_6 * V_63 , T_6 * V_64 )
{
T_2 V_88 = F_61 ( V_6 ) ;
...
if ( F_9 ( V_6 , 0 ) ) {
V_91 = F_3 ( V_6 , V_85 + 1 , & V_52 ) ;
F_56 ( V_44 , V_6 , V_85 , 1 + V_52 + V_91 ,
L_94
L_117
L_144 ,
* V_60 , * V_63 , F_60 ( * V_60 ) , V_91 ) ;
V_85 += 1 + V_52 + V_91 ;
} else {
F_56 ( V_44 , V_6 , V_85 , 1 ,
L_94
...
F_38 ( ( L_121 , V_85 ) ) ;
( * V_60 ) ++ ;
V_52 = F_59 ( V_44 , V_6 , V_85 , V_20 , V_60 ,
V_63 , V_64 ) ;
V_85 += V_52 ;
} else {
if ( ( V_19 & 0x3F ) == 4 ) {
...
L_169
L_166 ,
V_60 , * V_64 , V_19 & 0x7f , F_60 ( V_60 ) ,
F_41 ( V_31 -> V_111 , * V_64 , V_19 ) ) ;
V_85 ++ ;
} else {
V_106 = V_19 & 0x7f ;
F_56 ( V_44 , V_6 , V_85 , 1 ,
...
L_170
L_171 ,
V_60 , * V_64 , V_106 , F_60 ( V_60 ) ,
F_41 ( V_31 -> V_112 , * V_64 , V_19 ) ) ;
V_85 ++ ;
}
}
}
...
F_69 ( V_69 , V_114 , F_70 ( V_114 ) ) ;
F_71 ( V_123 , F_70 ( V_123 ) ) ;
V_113 = F_72 ( V_69 , NULL ) ;
F_73 ( V_113 ,
L_195 ,
L_196 ,
L_197
...
L_206 ,
& V_80 ) ;
F_74 ( L_194 , F_43 , V_69 ) ;
F_74 ( L_207 , F_45 , V_69 ) ;
}
void
F_75 ( void )
{
