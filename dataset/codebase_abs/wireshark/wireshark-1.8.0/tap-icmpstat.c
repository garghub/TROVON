...
if ( V_12 -> V_15 ) {
V_13 = F_5 ( & V_12 -> V_13 ) ;
V_14 = F_6 ( sizeof( double ) ) ;
if ( V_14 == NULL )
return 0 ;
* V_14 = V_13 ;
V_2 -> V_3 = F_7 ( V_2 -> V_3 , V_14 , F_3 ) ;
V_2 -> V_16 ++ ;
if ( V_2 -> V_4 > V_13 ) {
V_2 -> V_17 = V_12 -> V_15 ;
V_2 -> V_4 = V_13 ;
...
if ( V_2 -> V_16 & 1 )
* V_24 = * ( double * ) F_9 ( V_26 , V_2 -> V_16 / 2 ) ;
else {
* V_24 =
( * ( double * ) F_9 ( V_26 , ( V_2 -> V_16 - 1 ) / 2 ) +
* ( double * ) F_9 ( V_26 , V_2 -> V_16 / 2 ) ) / 2 ;
}
for ( ; V_26 ; V_26 = F_10 ( V_26 ) ) {
...
static void
F_12 ( const char * V_31 , void * T_10 V_10 )
{
T_1 * V_2 ;
