...
struct V_10 * V_16 ;
T_5 * V_17 = NULL ;
V_16 = F_8 ( sizeof( struct V_10 ) * V_18 ) ;
fprintf ( V_4 , L_27 ) ;
...
struct V_10 * V_19 ;
T_5 * V_17 = NULL ;
V_19 = F_8 ( sizeof( struct V_10 ) * V_20 ) ;
fprintf ( V_4 , L_28 ) ;
...
F_21 ( V_21 , V_22 ) ;
#endif
while ( ( V_23 = F_22 ( V_21 , V_22 , L_29 ) ) != - 1 ) {
switch ( V_23 ) {
case 'w' :
V_45 = V_49 ;
break;
...
if ( V_31 == V_56 ) {
int V_57 , V_58 ;
V_57 = F_30 ( V_33 [ 0 ] . V_55 ) ;
for ( V_15 = 1 ; V_15 < V_26 ; V_15 ++ ) {
V_58 = F_30 ( V_33 [ V_15 ] . V_55 ) ;
if ( V_57 != V_58 ) {
fprintf ( V_4 , L_39 ) ;
fprintf ( V_4 , L_40 ) ;
fprintf ( V_4 , L_41 ,
...
V_32 = F_31 ( V_45 , V_60 | V_61 | V_62 | V_63 , 0644 ) ;
if ( V_32 == - 1 ) {
fprintf ( V_4 , L_44 ,
V_45 , F_32 ( V_64 ) ) ;
exit ( 1 ) ;
...
if ( ! F_43 ( V_38 , V_36 , F_44 ( V_34 -> V_55 ) ,
F_45 ( V_34 -> V_55 ) , & V_41 ) ) {
V_47 = TRUE ;
break;
}
