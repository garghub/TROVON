...
{
return ( F_2 ( V_8 , V_7 , V_1 , V_2 , V_3 ) ) ? F_3 ( V_1 ) : 0 ;
}
static int F_6 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 )
{
return ( F_2 ( V_9 , V_7 , V_1 , V_2 , V_3 ) ) ? F_3 ( V_1 ) : 0 ;
}
void F_7 ( void ) {
static T_4 V_10 [] = {
...
V_13 = F_8 ( V_14 , V_15 , V_16 ) ;
F_9 ( L_1 , V_17 , V_13 ) ;
F_10 ( V_13 , V_10 , F_11 ( V_10 ) ) ;
F_12 ( V_11 , F_11 ( V_11 ) ) ;
V_4 = F_13 ( L_2 , L_3 , V_18 , V_19 ) ;
V_6 = F_13 ( L_4 , L_5 , V_18 , V_19 ) ;
V_8 = F_13 ( L_6 , L_7 , V_18 , V_19 ) ;
V_9 = F_13 ( L_8 , L_9 , V_18 , V_19 ) ;
}
void
F_14 ( void )
{
