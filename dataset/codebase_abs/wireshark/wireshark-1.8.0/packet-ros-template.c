...
{
T_9 * V_52 ;
V_52 = F_17 ( V_20 , V_51 , F_18 ( V_20 , V_51 ) , F_19 ( V_20 , V_51 ) ) ;
if( ! F_8 ( V_1 , V_52 , V_21 , V_22 ) &&
! F_20 ( V_53 , V_1 , V_52 , V_21 , V_22 ) ) {
T_14 * V_27 = F_21 ( V_22 , V_52 , 0 , F_18 ( V_20 , V_51 ) , L_5 , V_1 ) ;
T_11 * V_54 = F_11 ( V_27 , V_55 ) ;
F_22 ( V_21 , V_27 , V_56 , V_57 ,
L_6 , V_1 ) ;
F_23 ( V_21 , V_52 , V_51 , V_54 ) ;
}
V_51 += F_18 ( V_20 , V_51 ) ;
return V_51 ;
}
...
F_24 ( T_16 V_58 )
{
const T_17 * V_59 = V_58 ;
return V_59 -> V_60 ;
}
static T_18
F_25 ( T_16 V_61 , T_16 V_62 )
{
const T_17 * V_63 = V_61 ;
const T_17 * V_64 = V_62 ;
...
static T_17 *
F_28 ( T_9 * V_20 , T_10 * V_21 , T_11 * V_22 , T_15 V_60 , T_3 V_66 )
{
T_17 V_67 , * V_68 = NULL ;
T_19 * V_69 = V_70 ;
V_67 . V_60 = V_60 ;
...
V_68 = F_9 ( V_69 -> V_75 , & V_67 ) ;
if( V_68 ) {
V_68 -> V_71 = V_67 . V_71 ;
} else {
if( V_66 ) {
V_67 . V_60 = V_60 ;
V_68 = F_9 ( V_69 -> V_76 , & V_67 ) ;
if( V_68 ) {
F_29 ( V_69 -> V_76 , V_68 ) ;
}
if( ! V_68 ) {
V_68 = F_30 ( sizeof( T_17 ) ) ;
}
V_68 -> V_60 = V_60 ;
...
T_14 * V_27 = NULL ;
if( V_68 -> V_71 ) {
V_27 = F_31 ( V_22 , V_79 , V_20 , 0 , 0 , V_68 -> V_74 ) ;
F_32 ( V_27 ) ;
} else {
T_20 V_80 ;
V_27 = F_31 ( V_22 , V_81 , V_20 , 0 , 0 , V_68 -> V_65 ) ;
F_32 ( V_27 ) ;
F_33 ( & V_80 , & V_21 -> V_72 -> V_78 , & V_68 -> V_77 ) ;
V_27 = F_34 ( V_22 , V_82 , V_20 , 0 , 0 , & V_80 ) ;
F_32 ( V_27 ) ;
}
}
return V_68 ;
...
static void
F_35 ( T_9 * V_20 , T_10 * V_21 , T_11 * V_83 )
{
int V_51 = 0 ;
int V_84 ;
T_14 * V_27 = NULL ;
...
T_19 * V_69 = NULL ;
T_22 V_86 ;
F_36 ( & V_86 , V_87 , TRUE , V_21 ) ;
V_88 = V_83 ;
if( ! V_21 -> V_31 ) {
if( V_83 ) {
F_21 ( V_83 , V_20 , V_51 , - 1 ,
L_7 ) ;
}
return ;
}
...
V_69 = F_38 ( V_85 , V_89 ) ;
if ( V_69 == NULL ) {
V_69 = F_39 ( sizeof( T_19 ) ) ;
V_69 -> V_75 = F_40 ( F_24 , F_25 ) ;
V_69 -> V_76 = F_40 ( F_26 , F_27 ) ;
F_41 ( V_85 , V_89 , V_69 ) ;
V_69 -> V_90 = V_70 ;
V_70 = V_69 ;
}
...
F_42 ( V_21 -> V_34 , V_50 ) ;
while ( F_19 ( V_20 , V_51 ) > 0 ) {
V_84 = V_51 ;
V_51 = F_43 ( FALSE , V_20 , V_51 , & V_86 , V_22 , - 1 ) ;
if( V_51 == V_84 ) {
V_27 = F_21 ( V_22 , V_20 , V_51 , - 1 , L_9 ) ;
if( V_27 ) {
F_22 ( V_21 , V_27 , V_56 , V_57 , L_9 ) ;
V_54 = F_11 ( V_27 , V_55 ) ;
F_23 ( V_21 , V_20 , V_51 , V_54 ) ;
}
break;
}
}
...
V_6 = F_40 ( V_103 , V_104 ) ;
V_10 = F_40 ( V_103 , V_104 ) ;
V_8 = F_54 ( L_19 ) ;
F_55 ( F_44 ) ;
}
void F_56 ( void ) {
