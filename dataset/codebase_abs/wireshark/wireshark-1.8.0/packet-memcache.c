...
F_7 ( V_8 , V_53 , L_2 ) ,
F_7 ( V_67 , V_83 , L_24 ) , V_67 ) ;
}
}
static T_9
F_20 ( T_4 * V_2 , const int V_89 , int V_3 ,
T_5 * V_90 , T_9 * V_91 )
{
const T_12 * V_92 ;
...
line = F_23 ( V_2 , V_3 , V_97 ) ;
V_93 = line + V_97 ;
while ( ++ V_96 < V_89 ) {
V_95 = F_24 ( line , V_93 , & V_92 ) ;
if ( V_95 == 0 ) {
return FALSE ;
}
V_3 += ( int ) ( V_92 - line ) ;
...
static T_9
F_26 ( T_4 * V_2 , T_2 * T_3 , const int V_3 ,
const int V_99 , T_5 V_100 )
{
T_7 V_101 , V_102 ;
if ( ! F_27 ( V_2 , V_99 , V_100 ) ) {
V_101 = F_28 ( V_2 , V_99 ) ;
V_102 = F_29 ( V_2 , V_99 ) ;
if ( V_101 < V_102 ) {
return FALSE ;
...
V_101 = F_28 ( V_2 , V_98 ) ;
V_97 = F_21 ( V_2 , V_98 , - 1 , & V_98 , TRUE ) ;
...
switch ( type ) {
case V_111 :
V_108 = F_20 ( V_2 , 5 , V_3 , & V_100 , & V_91 ) ;
if ( ! V_108 ) {
return FALSE ;
}
break;
case V_112 :
V_108 = F_20 ( V_2 , 4 , V_3 , & V_100 , & V_91 ) ;
if ( ! V_108 ) {
return FALSE ;
}
break;
...
if ( V_106 && V_91 ) {
return ! F_26 ( V_2 , T_3 , V_3 , V_98 , V_100 ) ;
}
return TRUE ;
}
static int
F_31 ( T_4 * V_2 , int V_3 , T_2 * T_3 , T_6 * V_6 )
{
const T_12 * line ;
const T_12 * V_93 ;
int V_113 ;
...
line = F_23 ( V_2 , V_3 , V_114 ) ;
V_93 = line + V_114 ;
V_117 = V_119 ;
V_116 =
F_32 ( ( const V_120 * ) line ,
V_114 , & V_8 , & V_117 ,
& V_107 , & V_118 ) ;
if ( V_116 ) {
if ( ! F_30 ( V_2 , V_3 , T_3 , V_121 ,
V_122 , V_117 ,
V_107 ) )
{
return - 1 ;
...
static int
F_35 ( T_4 * V_2 , T_2 * T_3 , T_6 * V_6 , int V_3 ,
int V_100 , T_8 V_8 )
{
T_7 V_115 ;
T_9 V_123 = FALSE ;
...
static T_1
F_36 ( const T_12 * line , const T_12 * V_93 ,
...
V_3 += ( int ) ( V_92 - line ) ;
line = V_92 ;
V_128 = F_36 ( line , V_93 , & V_124 , & V_125 ) ;
...
F_40 ( V_6 , V_88 , V_2 , V_3 , V_95 , V_138 ) ;
V_95 = F_24 ( line , V_93 , & V_92 ) ;
if ( V_95 != 0 ) {
return - 1 ;
}
...
V_3 = V_98 ;
V_3 = F_35 ( V_2 , T_3 , V_6 , V_3 , V_90 , V_8 ) ;
if ( V_3 == - 1 ) {
return V_3 ;
}
}
...
static int
F_41 ( T_4 * V_2 , T_2 * T_3 , T_6 * V_6 , int V_3 ,
...
static int
F_32 ( const V_120 * V_148 , int V_97 , T_8 * V_8 ,
T_13 * type , int * V_107 ,
T_14 * V_118 )
{
...
static void
F_43 ( T_4 * V_2 , T_2 * T_3 , T_6 * V_6 )
{
int V_3 = 0 ;
int V_152 ;
while ( F_29 ( V_2 , V_3 ) != 0 ) {
V_152 = F_31 ( V_2 , V_3 , T_3 , V_6 ) ;
if ( V_152 == - 1 )
break;
V_3 += V_152 ;
F_44 ( T_3 -> V_68 , V_71 ) ;
...
static void
F_45 ( T_4 * V_2 , T_2 * T_3 , T_6 * V_6 )
{
T_7 V_3 = 0 ;
T_8 V_66 ;
V_66 = F_13 ( V_2 , V_3 ) ;
if ( F_14 ( V_66 , V_75 ) != NULL ) {
F_46 ( V_2 , T_3 , V_6 , V_122 , 12 ,
F_1 , F_10 ) ;
} else {
F_43 ( V_2 , T_3 , V_6 ) ;
}
...
{ & V_74 ,
{ L_54 , L_55 ,
V_154 , V_155 , F_49 ( V_75 ) , 0x0 ,
L_56 , V_156 } } ,
{ & V_76 ,
{ L_57 , L_58 ,
V_154 , V_155 , F_49 ( V_53 ) , 0x0 ,
L_59 , V_156 } } ,
{ & V_78 ,
{ L_60 , L_61 ,
...
T_17 * V_167 ;
V_72 = F_50 ( V_168 , V_70 , V_169 ) ;
F_51 ( L_135 , F_45 , V_72 ) ;
F_51 ( L_136 , F_47 , V_72 ) ;
F_52 ( V_72 , V_153 , F_53 ( V_153 ) ) ;
F_54 ( V_166 , F_53 ( V_166 ) ) ;
V_167 = F_55 ( V_72 , NULL ) ;
F_56 ( V_167 , L_137 ,
L_138 ,
L_139
L_140
...
V_170 = F_58 ( L_135 ) ;
V_171 = F_58 ( L_136 ) ;
F_59 ( L_149 , V_172 , V_170 ) ;
F_59 ( L_150 , V_172 , V_171 ) ;
}
