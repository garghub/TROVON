...
char *
F_62 ( const char * V_4 , T_2 V_85 , T_2 T_9
#ifndef F_2
V_86
#endif
)
...
#ifdef F_2
if ( ! T_9 ) {
if ( F_7 ( V_1 , & V_64 ) != 0 && V_6 == V_65 ) {
V_87 = F_17 (
L_17 V_30 L_28 V_30 L_17 ,
F_61 () , V_4 ) ;
if ( F_7 ( V_87 , & V_64 ) == 0 ) {
F_18 ( V_1 ) ;
V_1 = V_87 ;
...
int
F_65 ( int T_10 V_86 , const char * V_88 )
{
T_3 * V_89 , * V_90 ;
V_90 = strchr ( V_88 , ':' ) ;
if ( V_90 == NULL ) {
...
if ( strcmp ( V_88 , L_29 ) == 0 ) {
V_42 = V_89 ;
} else if ( strcmp ( V_88 , L_30 ) == 0 ) {
V_77 = V_89 ;
} else {
return 1 ;
}
...
{
int V_111 , V_112 , V_113 , V_114 , V_93 ;
T_11 * V_115 = NULL ;
