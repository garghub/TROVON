...
const char * V_2 ;
T_5 = F_5 ( T_2 , T_7 , T_9 , T_4 , T_5 , V_3 , & V_4 ) ;
if( V_4 ) {
V_2 = F_6 ( V_4 ) ;
F_7 ( T_9 , L_1 , V_2 ? V_2 : V_4 ) ;
}
return T_5 ;
}
static int
...
T_5 = F_9 ( V_4 , T_4 , T_5 , T_7 -> V_5 , T_9 ) ;
return T_5 ;
}
int
...
NULL ) ;
V_12 = F_20 () ;
F_7 ( F_21 ( T_9 ) , L_1 , V_12 ? V_12 : L_2 ) ;
return T_5 ;
}
static int
...
const char * V_2 ;
T_5 = F_5 ( T_2 , T_7 , T_9 , T_4 , T_5 , V_17 , & V_18 ) ;
if( V_18 ) {
V_2 = F_6 ( V_18 ) ;
F_7 ( T_9 , L_1 , V_2 ? V_2 : V_18 ) ;
}
return T_5 ;
}
static int
...
T_12 V_22 ;
T_13 V_23 ;
T_5 = F_29 ( T_7 -> V_5 , T_9 , T_4 , T_5 , & V_19 , & V_20 , & V_22 ) ;
T_5 = F_30 ( T_7 -> V_5 , T_9 , T_4 , T_5 , & V_23 , & V_21 ) ;
T_5 = F_9 ( V_18 , T_4 , T_5 , T_7 -> V_5 , T_9 ) ;
return T_5 ;
}
int
...
void F_61 ( T_3 * T_4 V_1 , T_14 * V_5 V_1 , T_8 * T_9 V_1 ) {
T_6 V_78 ;
F_62 ( & V_78 , V_79 , TRUE , V_5 ) ;
F_35 ( FALSE , T_4 , 0 , & V_78 , T_9 , V_80 ) ;
}
static void F_63 ( T_3 * T_4 V_1 , T_14 * V_5 V_1 , T_8 * T_9 V_1 ) {
T_6 V_78 ;
F_62 ( & V_78 , V_79 , TRUE , V_5 ) ;
F_40 ( FALSE , T_4 , 0 , & V_78 , T_9 , V_81 ) ;
}
static void F_64 ( T_3 * T_4 V_1 , T_14 * V_5 V_1 , T_8 * T_9 V_1 ) {
T_6 V_78 ;
F_62 ( & V_78 , V_79 , TRUE , V_5 ) ;
F_46 ( FALSE , T_4 , 0 , & V_78 , T_9 , V_82 ) ;
}
static void F_65 ( T_3 * T_4 V_1 , T_14 * V_5 V_1 , T_8 * T_9 V_1 ) {
T_6 V_78 ;
F_62 ( & V_78 , V_79 , TRUE , V_5 ) ;
F_52 ( FALSE , T_4 , 0 , & V_78 , T_9 , V_83 ) ;
}
static void F_66 ( T_3 * T_4 V_1 , T_14 * V_5 V_1 , T_8 * T_9 V_1 ) {
T_6 V_78 ;
F_62 ( & V_78 , V_79 , TRUE , V_5 ) ;
F_60 ( FALSE , T_4 , 0 , & V_78 , T_9 , V_84 ) ;
}
const char * F_67 ( void ) {
return V_4 ;
}
static int
F_68 ( T_3 * T_4 , T_14 * V_5 , T_8 * V_85 )
{
T_15 * V_86 = NULL ;
T_8 * T_9 = NULL ;
T_6 V_78 ;
F_62 ( & V_78 , V_79 , TRUE , V_5 ) ;
F_69 ( V_5 -> V_87 , V_88 , L_3 ) ;
F_69 ( V_5 -> V_87 , V_89 , L_4 ) ;
if( V_85 ) {
V_86 = F_70 ( V_85 , T_4 , 0 , - 1 , L_4 ) ;
