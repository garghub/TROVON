...
char * V_40 ;
if ( 0 ) {
if ( V_29 != V_41 && V_29 != V_42 && V_29 != V_43 ) {
F_14 ( V_33 , V_34 , L_6 ,
V_21 -> V_24 [ 1 ] ) ;
return;
}
}
V_40 = F_17 ( F_18 ( V_21 -> V_24 [ 1 ] ) ) ;
...
{
F_21 ( V_6 , V_21 -> V_45 , sizeof( V_6 ) ) ;
}
break;
case V_46 :
if ( V_21 -> V_45 == NULL ) {
F_20 ( V_6 , sizeof( V_6 ) , L_8 , V_40 ) ;
}
else
{
F_20 ( V_6 , sizeof( V_6 ) , L_9 , V_21 -> V_45 ) ;
}
break;
case V_47 :
...
F_20 ( V_6 , sizeof( V_6 ) , L_13 , V_31 , V_40 ) ;
break;
default:
F_14 ( V_33 , V_34 , L_14 , type ) ;
}
F_5 ( V_40 ) ;
}
switch( V_29 ) {
...
break;
case V_38 :
F_20 ( V_6 , sizeof( V_6 ) , L_15 , V_21 -> V_24 [ 0 ] , V_21 -> V_24 [ 1 ] ) ;
F_29 ( V_6 ) ;
break;
case V_39 :
{
...
{
F_10 ( T_14 , V_5 , F_38 ( V_48 , 0 ) ) ;
}
static void
F_42 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_38 ( V_49 , 0 ) ) ;
}
static void
F_43 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_38 ( V_50 , 0 ) ) ;
}
static void
...
{
F_10 ( T_14 , V_5 , F_45 ( V_48 , 0 ) ) ;
}
static void
F_49 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_45 ( V_49 , 0 ) ) ;
}
static void
F_50 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_45 ( V_50 , 0 ) ) ;
}
static void
F_51 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_52 ( V_44 , 0 ) ) ;
}
static void
F_53 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_52 ( V_46 , 0 ) ) ;
}
static void
F_54 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_55 ( V_44 , 0 ) ) ;
}
static void
F_56 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_55 ( V_46 , 0 ) ) ;
}
static void
F_57 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_58 ( V_44 , 0 ) ) ;
}
static void
F_59 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_58 ( V_46 , 0 ) ) ;
}
static void
F_60 ( T_13 * T_14 , T_6 V_5 )
{
F_10 ( T_14 , V_5 , F_61 ( V_44 , 0 ) ) ;
}
static void
...
T_23 * V_67 ;
T_24 * error = NULL ;
V_18 -> V_32 = F_68 ( F_69 ( V_18 -> V_68 ) ) ;
F_70 ( V_18 -> V_32 , V_69 ) ;
F_71 ( F_72 ( V_18 -> V_32 ) , L_18 , F_73 ( F_65 ) , NULL ) ;
V_67 = F_74 ( L_19 ) ;
F_75 ( V_67 ,
( T_6 ) V_70 ,
F_76 ( V_70 ) ,
...
V_18 -> V_62 = F_81 ( V_66 , L_21 ) ;
F_71 ( V_18 -> V_68 , L_22 , F_73 ( F_34 ) , V_18 ) ;
}
void
F_82 ( T_9 * V_18 , T_11 V_22 , T_13 * V_74 )
{
T_25 * V_75 ;
T_13 * V_76 ;
T_1 * T_2 ;
...
V_77 = F_86 ( V_75 ) ;
F_87 ( V_18 -> V_68 , TRUE ) ;
F_88 ( F_69 ( V_76 ) , FALSE ) ;
F_89 ( F_72 ( V_75 ) ) ;
V_2 = F_90 () ;
T_2 = F_91 ( L_23 , V_2 , NULL ) ;
F_92 ( T_2 , V_9 ) ;
F_93 ( T_2 , TRUE ) ;
F_94 ( T_2 , V_2 , V_81 ,
F_95 ( V_9 ) , NULL ) ;
...
F_98 ( T_2 , 80 ) ;
F_99 ( T_2 , 80 ) ;
F_100 ( F_69 ( V_18 -> V_68 ) , T_2 ) ;
V_2 = F_90 () ;
T_2 = F_91 ( L_24 , V_2 , L_1 , V_35 , NULL ) ;
F_92 ( T_2 , V_35 ) ;
F_93 ( T_2 , TRUE ) ;
F_94 ( T_2 , V_2 , F_1 ,
F_95 ( V_35 ) , NULL ) ;
...
F_100 ( F_69 ( V_18 -> V_68 ) , T_2 ) ;
V_2 = F_90 () ;
T_2 = F_91 ( L_25 , V_2 , L_1 , V_36 , NULL ) ;
F_92 ( T_2 , V_36 ) ;
F_93 ( T_2 , TRUE ) ;
F_97 ( T_2 , V_83 ) ;
F_98 ( T_2 , 300 ) ;
...
T_2 = F_91 ( L_26 , V_2 , L_1 , V_84 , NULL ) ;
F_92 ( T_2 , V_84 ) ;
F_93 ( T_2 , TRUE ) ;
F_97 ( T_2 , V_83 ) ;
F_98 ( T_2 , 80 ) ;
F_100 ( F_69 ( V_18 -> V_68 ) , T_2 ) ;
V_18 -> V_85 = F_101 ( NULL , NULL ) ;
F_102 ( F_103 ( V_18 -> V_85 ) , F_104 ( V_18 -> V_68 ) ) ;
F_105 ( F_106 ( V_74 ) , V_18 -> V_85 , TRUE , TRUE , 0 ) ;
F_107 ( V_18 -> V_68 , V_36 ) ;
F_108 ( V_18 -> V_68 , TRUE ) ;
F_109 ( F_69 ( V_18 -> V_68 ) , TRUE ) ;
F_88 ( F_69 ( V_18 -> V_68 ) , TRUE ) ;
F_110 ( V_18 -> V_85 ) ;
V_18 -> V_22 = V_22 ;
V_18 -> V_86 = F_111 ( 100 ) ;
...
V_91 . V_92 = 0 ;
V_91 . V_45 = NULL ;
F_114 ( V_18 -> V_23 , V_91 ) ;
V_21 = & F_9 ( V_18 -> V_23 , T_12 , V_88 ) ;
V_21 -> V_24 [ 0 ] = ( char * ) F_115 ( V_18 -> V_86 , V_19 -> V_25 ) ;
V_21 -> V_24 [ 1 ] = ( char * ) F_115 ( V_18 -> V_86 , V_19 -> V_26 ) ;
V_75 = F_116 ( F_117 ( V_18 -> V_68 ) ) ;
F_118 ( V_75 , & V_21 -> V_4 , NULL ) ;
F_119 ( V_75 , & V_21 -> V_4 ,
V_9 , F_120 ( V_19 -> V_93 , V_94 ) ,
V_35 , V_21 -> V_24 [ 0 ] ,
V_36 , V_21 -> V_24 [ 1 ] , - 1 ) ;
if ( V_19 -> V_95 ) {
char * V_96 ;
F_121 ( F_122 ( V_19 -> V_95 ) ) ;
V_96 = F_123 ( F_122 ( V_19 -> V_95 ) , NULL ) ;
if ( V_96 != NULL )
V_21 -> V_45 = F_115 ( V_18 -> V_86 , V_96 ) ;
}
V_18 -> V_22 = ++ V_87 ;
}
V_21 = & F_9 ( V_18 -> V_23 , T_12 , V_88 ) ;
...
V_84 , V_21 -> V_92 ,
- 1 ) ;
F_20 ( V_90 , sizeof( V_90 ) , L_27 , V_19 -> V_97 ) ;
#if 0
...
#else
if ( V_21 -> V_92 > 1000 ) {
F_124 ( V_75 , & V_89 , & V_21 -> V_4 ) ;
}
else {
F_118 ( V_75 , & V_89 , & V_21 -> V_4 ) ;
}
F_119 ( V_75 , & V_89 ,
#endif
V_9 , V_10 ,
