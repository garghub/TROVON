static void F_1 ( unsigned V_1 , char * V_2 , ... ) {
T_1 V_3 ;
if ( V_1 > V_4 ) return;
va_start ( V_3 , V_2 ) ;
...
V_19 = F_8 ( sizeof( struct V_8 ) ) ;
V_19 -> V_11 = V_15 -> V_11 ;
V_20 = F_8 ( sizeof( struct V_14 ) ) ;
F_9 ( V_20 ) ;
V_20 -> V_18 = V_21 ++ ;
#ifdef F_6
...
#ifdef F_6
F_1 ( 70 , L_16 , V_57 ) ;
F_1 ( 70 , L_17 , V_16 -> V_24 [ V_48 ] . V_25 , V_16 -> V_24 [ V_48 ] . V_28 ) ;
...
V_57 = V_62 ;
} else if ( V_16 -> V_24 [ V_48 ] . V_25 != 0
&& V_16 -> V_24 [ V_48 ] . V_25 < V_22 -> V_26 -> V_27 ) {
V_57 = V_48 ;
}
#ifdef F_6
F_1 ( 70 , L_26 , V_57 ) ;
