...
void F_12 ( const T_2 * V_24 , T_3 V_25 , const T_2 * V_26 , T_3 V_27 ,
T_2 V_17 [ 20 ] )
{
T_3 V_28 ;
T_1 V_1 ;
...
char V_36 [ 41 ] ;
T_1 V_1 ;
unsigned char V_26 [ 1000 ] ;
unsigned char V_37 [ 20 ] ;
if( V_32 < 2 )
{
printf ( L_1 ) ;
...
if( V_28 < 2 )
{
F_9 ( & V_1 , ( V_38 * ) V_39 [ V_28 ] ,
strlen ( V_39 [ V_28 ] ) ) ;
}
else
{
memset ( V_26 , 'a' , 1000 ) ;
for( V_35 = 0 ; V_35 < 1000 ; V_35 ++ )
{
F_9 ( & V_1 , ( V_38 * ) V_26 , 1000 ) ;
}
}
F_10 ( & V_1 , V_37 ) ;
for( V_35 = 0 ; V_35 < 20 ; V_35 ++ )
{
F_13 ( V_36 + V_35 * 2 , 41 - V_35 * 2 , L_3 , V_37 [ V_35 ] ) ;
}
if( memcmp ( V_36 , V_40 [ V_28 ] , 40 ) )
{
printf ( L_4 ) ;
return ( 1 ) ;
}
...
{
if( ! ( V_34 = fopen ( V_33 [ 1 ] , L_7 ) ) )
{
perror ( L_8 ) ;
return ( 1 ) ;
}
F_1 ( & V_1 ) ;
while( ( V_28 = fread ( V_26 , 1 , sizeof( V_26 ) , V_34 ) ) > 0 )
{
F_9 ( & V_1 , V_26 , V_28 ) ;
}
F_10 ( & V_1 , V_37 ) ;
