...
static T_1 *
F_31 ( T_10 * V_32 , const T_3 V_45 , const T_2 * V_13 , const T_2 * V_2 ,
...
T_1 *
F_32 ( const T_3 V_45 , const T_2 * V_48 , const T_2 * V_49 , const T_11 V_7 ,
...
void
F_34 ( T_1 * V_24 , const int V_59 , void * V_60 )
{
T_12 * V_61 = F_25 ( sizeof( T_12 ) ) ;
V_61 -> V_59 = V_59 ;
V_61 -> V_60 = V_60 ;
V_24 -> V_25 = F_35 ( V_24 -> V_25 , ( T_8 * ) V_61 ,
F_33 ) ;
}
void *
F_36 ( const T_1 * V_24 , const int V_59 )
{
T_12 V_62 , * V_61 ;
T_13 * V_63 ;
V_62 . V_59 = V_59 ;
V_62 . V_60 = NULL ;
V_63 = F_37 ( V_24 -> V_25 , ( T_8 * ) & V_62 ,
F_33 ) ;
if ( V_63 != NULL ) {
V_61 = ( T_12 * ) V_63 -> V_64 ;
return V_61 -> V_60 ;
...
F_33 ) ;
while( V_63 ) {
V_24 -> V_25 = F_39 ( V_24 -> V_25 , V_63 -> V_64 ) ;
V_63 = V_63 -> V_37 ;
}
}
void
F_40 ( T_1 * V_1 , const T_14 V_65 )
{
V_1 -> V_15 = V_65 ;
}
T_15
F_41 ( const T_2 * V_48 , const T_2 * V_49 , const T_11 V_7 ,
const T_3 V_50 , const T_3 V_51 , T_16 * V_66 , T_17 * V_67 ,
T_18 * V_68 )
{
T_1 * V_1 ;
V_1 = F_32 ( V_67 -> V_69 -> V_70 , V_48 , V_49 , V_7 , V_50 ,
V_51 , 0 ) ;
if ( V_1 != NULL ) {
int V_71 ;
if ( V_1 -> V_15 == NULL )
return FALSE ;
V_71 = F_42 ( V_1 -> V_15 , V_66 , V_67 ,
V_68 ) ;
if( ! V_71 ) {
return FALSE ;
}
...
{
T_1 * V_24 = NULL ;
if( ( V_24 = F_32 ( V_67 -> V_69 -> V_70 , & V_67 -> V_72 , & V_67 -> V_73 ,
V_67 -> V_7 , V_67 -> V_74 ,
V_67 -> V_75 , 0 ) ) == NULL ) {
