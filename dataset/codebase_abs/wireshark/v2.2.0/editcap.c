...
F_84 ( V_93 ) ;
if ( F_85 ( F_86 ( V_95 , V_163 , 0 ) , V_164 , & V_132 ) != V_165 ) {
F_87 ( F_86 ( V_95 , V_163 , 0 ) , V_164 , L_131 V_166 ) ;
}
V_99 = F_44 ( V_93 ,
...
if ( V_14 -> V_21 & V_22 ) {
if ( V_158 ) {
if ( V_168 . V_5 || V_168 . V_55 ) {
if ( ! V_56 . V_50 ) {
T_2 V_74 ;
T_2 V_76 ;
V_74 = V_14 -> V_23 ;
F_23 ( & V_76 , & V_74 , & V_168 ) ;
if ( V_76 . V_5 < 0 || V_76 . V_55 < 0 ) {
V_131 = * V_14 ;
V_131 . V_23 . V_5 = V_168 . V_5 + V_56 . V_53 . V_5 ;
V_131 . V_23 . V_55 = V_168 . V_55 ;
...
if ( V_135 ) {
F_16 ( V_14 , V_4 , ( T_7 * ) & V_14 -> V_167 ) ;
}
if ( V_154 ) {
if ( F_17 ( V_4 , V_14 -> V_167 ) ) {
if ( V_36 ) {
fprintf ( V_28 , L_136 ,
V_118 , V_14 -> V_167 ) ;
...
if ( V_129 > V_14 -> V_167 ) {
fprintf ( V_28 , L_139 ,
V_129 , V_14 -> V_167 , V_118 ) ;
}
if ( V_156 > 0.0 && V_129 <= V_14 -> V_167 ) {
int V_169 = 0 ;
if ( F_77 ( V_106 ) == V_170 )
V_169 = F_93 ( V_4 ) ;
V_169 += V_129 ;
for ( V_43 = V_169 ; V_43 < ( int ) V_14 -> V_167 ; V_43 ++ ) {
if ( rand () <= V_156 * V_171 ) {
V_121 = rand () / ( V_171 / V_172 + 1 ) ;
if ( V_121 < V_173 ) {
V_4 [ V_43 ] ^= 1 << ( rand () / ( V_171 / 8 + 1 ) ) ;
V_121 = V_172 ;
} else {
V_121 -= V_174 ;
}
if ( V_121 < V_174 ) {
V_4 [ V_43 ] = rand () / ( V_171 / 255 + 1 ) ;
V_121 = V_172 ;
} else {
V_121 -= V_174 ;
}
if ( V_121 < V_175 ) {
V_4 [ V_43 ] = V_176 [ rand () / ( V_171 / V_177 + 1 ) ] ;
V_121 = V_172 ;
} else {
V_121 -= V_175 ;
}
if ( V_121 < V_178 ) {
if ( ( unsigned int ) V_43 < V_14 -> V_167 - 2 )
...
if ( V_121 < V_179 ) {
for ( V_107 = V_43 ; V_107 < ( int ) V_14 -> V_167 ; V_107 ++ )
V_4 [ V_107 ] = 0xAA ;
V_43 = V_14 -> V_167 ;
}
}
...
{
int V_186 = 0 ;
for ( V_186 = 0 ; V_4 [ V_186 ] != '\0' ; V_186 ++ ) ;
V_186 ++ ;
V_186 ++ ;
for (; V_4 [ V_186 ] != '\0' ; V_186 ++ ) ;
V_186 ++ ;
for (; V_4 [ V_186 ] != '\0' ; V_186 ++ ) ;
V_186 ++ ;
for (; V_4 [ V_186 ] != '\0' ; V_186 ++ ) ;
...
static void
F_92 ( T_24 V_116 , struct V_13 * V_187 ,
const struct V_13 * V_188 , T_6 * * V_4 ,
T_4 V_117 )
{
...
if ( V_116 . V_150 < 0 ) {
V_116 . V_149 += V_188 -> V_167 + V_116 . V_150 ;
V_116 . V_150 = 0 ;
}
if ( V_116 . V_152 > 0 ) {
V_116 . V_153 += V_116 . V_152 - V_188 -> V_167 ;
V_116 . V_152 = 0 ;
}
if ( V_116 . V_148 && V_116 . V_151 ) {
if ( V_116 . V_149 > ( ( int ) V_188 -> V_167 + V_116 . V_153 ) ) {
int V_191 , V_192 ;
V_192 = V_188 -> V_167 + V_116 . V_153 + V_116 . V_151 ;
V_191 = - V_116 . V_151 ;
V_116 . V_153 = V_116 . V_148 + V_116 . V_149 - V_188 -> V_167 ;
V_116 . V_151 = - V_116 . V_148 ;
V_116 . V_148 = V_191 ;
V_116 . V_149 = V_192 ;
}
}
if ( V_188 -> V_167 < ( T_7 ) ( V_116 . V_149 - V_116 . V_153 ) ) {
V_116 . V_148 = 0 ;
V_116 . V_151 = 0 ;
}
if ( ( T_7 ) ( V_116 . V_148 - V_116 . V_151 ) >
( V_188 -> V_167 - ( T_7 ) ( V_116 . V_149 - V_116 . V_153 ) ) ) {
V_116 . V_148 = V_188 -> V_167 - ( V_116 . V_149 - V_116 . V_153 ) ;
V_116 . V_151 = 0 ;
}
if ( V_116 . V_148 > 0 ) {
* V_187 = * V_188 ;
...
V_187 -> V_167 - V_116 . V_148 ) ;
} else {
* V_4 += V_116 . V_148 ;
}
V_187 -> V_167 -= V_116 . V_148 ;
if ( V_117 ) {
if ( V_188 -> V_59 > ( T_7 ) V_116 . V_148 )
V_187 -> V_59 -= V_116 . V_148 ;
else
V_187 -> V_59 = 0 ;
}
V_188 = V_187 ;
...
* V_187 = * V_188 ;
if ( V_116 . V_153 < 0 ) {
memmove ( * V_4 + ( T_10 ) V_187 -> V_167 + ( V_116 . V_151 + V_116 . V_153 ) ,
* V_4 + ( T_10 ) V_187 -> V_167 + V_116 . V_153 ,
- V_116 . V_153 ) ;
}
V_187 -> V_167 += V_116 . V_151 ;
if ( V_117 ) {
if ( ( ( signed int ) V_188 -> V_59 + V_116 . V_151 ) > 0 )
V_187 -> V_59 += V_116 . V_151 ;
else
V_187 -> V_59 = 0 ;
}
}
