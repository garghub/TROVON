...
const V_64 * V_66 = F_28 ( ( const char * ) V_57 -> V_19 , L_20 ) ;
...
V_89 -> V_39 = V_87 -> V_96 ;
V_89 -> V_40 = V_87 -> V_40 ;
V_90 = F_49 ( V_32 , V_89 -> V_39 , - 1 , NULL , V_97 ) ;
if( ( V_91 = F_50 ( V_90 , V_98 ) ) != NULL )
{
V_89 -> V_45 = F_51 ( F_4 () , V_91 -> V_99 -> V_32 , V_91 -> V_99 -> V_39 , V_91 -> V_99 -> V_72 , V_100 ) ;
}
V_41 = V_87 -> V_101 ;
while( V_41 )
{
...
if ( V_41 -> V_7 != NULL ) {
V_104 = F_52 ( V_41 -> V_7 ) ;
V_7 = ( V_64 * ) F_36 ( F_4 () , V_104 + 1 ) ;
F_53 ( V_41 -> V_7 , V_7 , 0 , V_104 ) ;
}
V_63 -> V_39 = V_41 -> V_96 ;
V_63 -> V_40 = V_41 -> V_40 ;
V_63 -> V_7 = V_7 ;
...
static T_11
F_57 ( V_74 V_108 , V_74 V_7 V_54 , V_74 V_109 )
{
V_64 * V_84 = ( V_64 * ) V_109 ;
if( strcmp ( V_84 , L_5 ) == 0 )
{
const V_64 * V_110 = F_28 ( ( const char * ) V_108 , L_20 ) ;
...
static T_5 *
F_60 ( T_2 * V_33 , const V_64 * V_84 , const V_64 * V_111 )
{
V_64 * V_112 ;
T_5 * V_73 ;
if( strcmp ( V_111 , L_25 ) == 0 )
V_112 = F_3 ( F_4 () , V_84 ) ;
else if( strcmp ( V_84 , L_5 ) == 0 )
V_112 = F_61 ( F_4 () , L_28 , V_84 , V_111 ) ;
else
V_112 = F_61 ( F_4 () , L_28 , V_111 , V_84 ) ;
V_73 = ( T_5 * ) F_58 ( V_33 -> V_58 , V_112 ) ;
if( ! V_73 )
{
V_73 = ( T_5 * ) F_59 ( V_33 -> V_58 , F_57 , ( V_74 ) V_84 ) ;
}
...
{
V_113 = F_51 ( F_4 () , V_32 , V_33 -> V_39 , V_33 -> V_40 , V_100 ) ;
}
return V_113 ;
}
V_64 *
...
{
V_113 = F_51 ( F_4 () , V_32 , V_63 -> V_39 , V_63 -> V_40 , V_100 ) ;
}
return V_113 ;
}
static void
...
if ( V_114 -> V_115 == NULL )
return NULL ;
V_73 = F_3 ( F_4 () , V_114 -> V_115 -> V_116 ) ;
return V_73 ;
}
void
F_74 ( T_7 * V_31 , T_2 * V_33 , T_1 * V_1 , T_8 * V_32 , const T_21 * V_58 , T_9 V_117 )
{
T_10 * V_56 = F_25 ( V_31 ) ;
T_5 * V_63 ;
T_9 V_75 ;
...
F_19 ( V_56 , L_17 ) ;
for( V_75 = 0 ; V_75 < V_117 && V_58 != NULL ; V_75 ++ )
{
V_63 = F_2 ( V_33 , V_58 [ V_75 ] . V_29 ) ;
if( V_63 )
{
if( V_58 [ V_75 ] . V_118 != NULL )
{
if( V_63 -> V_29 )
F_21 ( V_31 , * V_58 [ V_75 ] . V_118 , V_32 , V_63 -> V_39 , V_63 -> V_40 , V_63 -> V_7 , L_21 , V_63 -> V_29 , V_63 -> V_7 ) ;
else
F_16 ( V_31 , * V_58 [ V_75 ] . V_118 , V_32 , V_63 -> V_39 , V_63 -> V_40 , V_63 -> V_7 ) ;
}
else
{
F_21 ( V_31 , V_119 , V_32 , V_63 -> V_39 , V_63 -> V_40 , V_63 -> V_7 ,
...
} else if( V_58 [ V_75 ] . V_121 )
{
F_24 ( V_1 , V_56 , & V_122 , L_29 , V_58 [ V_75 ] . V_29 , V_33 -> V_29 ) ;
}
if( V_58 [ V_75 ] . V_123 )
{
if( V_63 )
V_58 [ V_75 ] . V_123 ( V_1 , V_56 , V_58 [ V_75 ] . V_29 , V_63 -> V_7 , V_58 [ V_75 ] . V_19 ) ;
else
V_58 [ V_75 ] . V_123 ( V_1 , V_56 , V_58 [ V_75 ] . V_29 , NULL , V_58 [ V_75 ] . V_19 ) ;
}
}
F_19 ( V_56 , L_24 ) ;
...
void
F_75 ( T_7 * V_31 , T_2 * V_33 , T_1 * V_1 , T_8 * V_32 , const T_22 * V_58 , T_9 V_117 )
{
T_10 * V_56 = F_25 ( V_31 ) ;
T_5 * V_63 ;
T_9 V_75 ;
T_11 V_62 = FALSE ;
T_6 * V_124 , * V_125 = F_26 ( V_33 -> V_95 ) ;
T_6 * V_126 , * V_127 = F_27 ( V_33 -> V_95 ) ;
V_124 = V_125 ;
V_126 = V_127 ;
if( V_33 -> V_45 )
F_19 ( V_56 , L_12 , V_33 -> V_45 ) ;
...
{
for ( V_75 = 0 ; V_75 < V_117 && V_58 != NULL ; V_75 ++ ) {
if( strcmp ( ( const char * ) ( V_127 -> V_19 ) , V_58 [ V_75 ] . V_128 ) == 0 )
{
V_63 = F_60 ( V_33 , V_58 [ V_75 ] . V_129 . V_29 , ( const V_64 * ) ( V_125 -> V_19 ) ) ;
if( ! V_63 && V_33 -> V_45 && strcmp ( ( const char * ) V_125 -> V_19 , V_33 -> V_45 ) == 0 )
V_63 = F_60 ( V_33 , V_58 [ V_75 ] . V_129 . V_29 , L_25 ) ;
if ( V_63 ) {
if ( V_58 [ V_75 ] . V_129 . V_118 != NULL ) {
if ( V_63 -> V_29 )
F_21 ( V_31 , * V_58 [ V_75 ] . V_129 . V_118 , V_32 , V_63 -> V_39 , V_63 -> V_40 , V_63 -> V_7 , L_21 , V_63 -> V_29 , V_63 -> V_7 ) ;
else
F_16 ( V_31 , * V_58 [ V_75 ] . V_129 . V_118 , V_32 , V_63 -> V_39 , V_63 -> V_40 , V_63 -> V_7 ) ;
} else {
F_21 ( V_31 , V_119 , V_32 , V_63 -> V_39 , V_63 -> V_40 , V_63 -> V_7 ,
L_21 , V_63 -> V_29 ? V_63 -> V_29 : V_58 [ V_75 ] . V_129 . V_29 , V_63 -> V_7 ) ;
}
if ( V_58 [ V_75 ] . V_129 . V_120 ) {
if ( V_62 ) {
F_19 ( V_56 , L_18 ) ;
}
F_19 ( V_56 , L_19 , V_63 -> V_29 ? V_63 -> V_29 : V_58 [ V_75 ] . V_129 . V_29 , V_63 -> V_7 ) ;
V_62 = TRUE ;
}
} else if ( V_58 [ V_75 ] . V_129 . V_121 ) {
F_24 ( V_1 , V_56 , & V_122 , L_29 , V_58 [ V_75 ] . V_129 . V_29 , V_33 -> V_29 ) ;
}
if ( V_58 [ V_75 ] . V_129 . V_123 ) {
if ( V_63 )
V_58 [ V_75 ] . V_129 . V_123 ( V_1 , V_56 , V_58 [ V_75 ] . V_129 . V_29 , V_63 -> V_7 , V_58 [ V_75 ] . V_129 . V_19 ) ;
else
V_58 [ V_75 ] . V_129 . V_123 ( V_1 , V_56 , V_58 [ V_75 ] . V_129 . V_29 , NULL , V_58 [ V_75 ] . V_129 . V_19 ) ;
}
}
}
V_125 = V_125 -> V_46 ;
...
void
F_77 ( T_7 * V_31 , T_2 * V_88 , T_1 * V_1 , T_8 * V_32 , T_24 * V_130 , T_9 V_117 )
{
T_9 V_75 ;
for( V_75 = 0 ; V_75 < V_117 && V_130 != NULL ; V_75 ++ )
{
T_2 * V_91 = NULL ;
if( V_130 [ V_75 ] . type == V_131 )
{
T_11 V_132 = TRUE ;
const T_23 * V_76 = ( const T_23 * ) ( V_130 [ V_75 ] . V_19 ) ;
while( V_132 && ( V_91 = F_42 ( V_88 , V_76 -> V_29 , V_76 -> V_84 , V_76 -> V_85 ) ) != NULL )
{
V_130 [ V_75 ] . F_78 ( V_31 , V_32 , V_1 , V_91 ) ;
if( V_130 [ V_75 ] . V_133 == V_134 )
V_132 = FALSE ;
}
} else if( V_130 [ V_75 ] . type == V_135 )
{
T_11 V_132 = TRUE ;
const V_64 * V_29 = ( const V_64 * ) ( V_130 [ V_75 ] . V_19 ) ;
while( V_132 && ( V_91 = F_39 ( V_88 , V_29 ) ) != NULL )
{
V_130 [ V_75 ] . F_78 ( V_31 , V_32 , V_1 , V_91 ) ;
if( V_130 [ V_75 ] . V_133 == V_134 )
V_132 = FALSE ;
...
else if( V_130 [ V_75 ] . type == V_136 )
{
T_11 V_132 = TRUE ;
const T_23 * V_63 = ( const T_23 * ) ( V_130 [ V_75 ] . V_19 ) ;
while( V_132 && ( V_91 = F_41 ( V_88 , V_63 -> V_84 , V_63 -> V_85 ) ) != NULL )
{
V_130 [ V_75 ] . F_78 ( V_31 , V_32 , V_1 , V_91 ) ;
if( V_130 [ V_75 ] . V_133 == V_134 )
V_132 = FALSE ;
}
} else if( V_130 [ V_75 ] . type == V_137 )
{
T_11 V_132 = TRUE ;
const T_13 * V_81 = ( const T_13 * ) ( V_130 [ V_75 ] . V_19 ) ;
while( V_132 && ( V_91 = F_40 ( V_88 , ( const V_64 * * ) V_81 -> V_19 , V_81 -> V_40 ) ) != NULL )
{
V_130 [ V_75 ] . F_78 ( V_31 , V_32 , V_1 , V_91 ) ;
if( V_130 [ V_75 ] . V_133 == V_134 )
V_132 = FALSE ;
...
{
const T_13 * V_138 = ( const T_13 * ) V_19 ;
T_12 V_75 ;
T_11 V_139 = FALSE ;
V_64 * * V_140 = ( char * * ) V_138 -> V_19 ;
if ( V_7 != NULL ) {
for ( V_75 = 0 ; V_75 < V_138 -> V_40 ; V_75 ++ ) {
if ( strcmp ( V_7 , V_140 [ V_75 ] ) == 0 ) {
V_139 = TRUE ;
break;
}
}
if ( ! V_139 ) {
F_24 ( V_1 , V_56 , & V_141 , L_30 , V_29 , V_7 ) ;
}
}
}
void
F_80 ( const V_64 * V_142 , const V_64 * V_84 , T_2 * V_88 , T_5 * (* F_81)( T_2 * V_33 ) )
{
T_2 * V_33 = NULL ;
T_5 * V_143 = NULL ;
V_33 = F_39 ( V_88 , V_142 ) ;
if( V_33 )
V_143 = F_81 ( V_33 ) ;
if( V_143 )
F_48 ( V_88 -> V_58 , ( V_74 ) V_84 , V_143 ) ;
}
T_5 *
F_82 ( T_2 * V_91 )
{
...
static void
F_83 ( V_74 V_108 , V_74 V_7 , V_74 V_109 )
{
T_25 * V_144 = ( T_25 * ) V_109 ;
F_48 ( V_144 , V_108 , V_7 ) ;
}
void F_47 ( T_25 * V_145 , T_25 * V_144 )
{
F_84 ( V_145 , F_83 , V_144 ) ;
}
