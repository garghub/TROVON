...
static int
F_50 ( const T_2 * V_54 , T_17 * V_55 , T_12 V_43 , T_14 V_41 )
{
#define F_51 128
T_2 * V_1 = NULL ;
T_2 * V_56 = NULL ;
...
T_6 V_10 = 0 ;
int V_59 ;
T_18 V_60 , V_61 , V_62 , V_63 , V_64 , V_65 ;
T_4 V_5 = FALSE ;
T_4 V_66 = FALSE ;
int V_49 = 0 ;
V_1 = ( T_2 * ) F_27 ( V_57 + 1 ) ;
V_56 = ( T_2 * ) F_27 ( V_58 + 1 ) ;
while ( 1 ) {
if ( V_66 ) {
do {
V_59 = F_52 ( V_55 ) ;
} while ( V_59 != V_67 && V_59 != '\n' );
if ( V_59 == V_67 )
break;
V_5 = FALSE ;
V_66 = FALSE ;
}
while ( ( V_59 = F_52 ( V_55 ) ) != V_67 && F_53 ( V_59 ) ) {
if ( V_59 == '\n' ) {
continue;
}
}
...
if ( fscanf ( V_55 , L_6 ,
& V_63 , & V_64 , & V_65 , & V_60 , & V_61 , & V_62 ) == 6 ) {
T_3 V_3 , V_4 ;
T_1 * V_6 ;
T_11 * V_68 ;
T_2 * V_28 = NULL ;
if ( ! F_17 ( V_56 , & V_68 , & V_28 ) ) {
F_55 ( L_7 ,
V_1 , V_54 , V_28 ) ;
F_12 ( V_28 ) ;
V_14 . V_69 = TRUE ;
...
T_4
F_60 ( const T_2 * V_54 , T_12 V_43 , T_2 * * V_25 , T_14 V_41 )
{
T_17 * V_55 ;
int V_49 ;
if ( ( V_55 = F_57 ( V_54 , L_9 ) ) == NULL ) {
...
static T_4
F_62 ( T_5 * V_9 , T_17 * V_55 , T_4 V_74 )
{
struct V_73 V_30 ;
V_30 . V_55 = V_55 ;
V_30 . V_74 = V_74 ;
...
T_4
F_65 ( const T_2 * V_54 , T_5 * V_9 , T_4 V_76 , T_2 * * V_25 )
{
T_17 * V_55 ;
if ( ( V_55 = F_57 ( V_54 , L_20 ) ) == NULL ) {
* V_25 = F_7 ( L_21 ,
