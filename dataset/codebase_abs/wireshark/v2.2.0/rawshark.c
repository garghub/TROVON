...
V_95 = V_96 ;
V_37 = V_38 ;
while ( ( V_47 = F_56 ( V_42 , V_43 , V_73 , V_71 , NULL ) ) != - 1 ) {
switch ( V_47 ) {
case 'd' :
if ( ! F_24 ( V_97 ) ) {
F_50 ( L_50 , V_97 ) ;
...
V_63 [ V_79 ] = F_67 ( V_42 , V_43 , V_114 ) ;
}
}
if ( V_37 == V_38 ) {
F_50 ( L_77 ) ;
...
F_73 ( & V_94 . V_115 , V_64 -> V_116 , TRUE ) ;
if ( V_79 != 0 ) {
for ( V_48 = 0 ; V_48 < V_79 ; V_48 ++ ) {
T_2 * V_117 ;
if ( ! F_74 ( V_63 [ V_48 ] , & V_78 [ V_80 ] , & V_117 ) ) {
F_50 ( L_40 , V_117 ) ;
F_15 ( V_117 ) ;
F_75 ( V_94 . V_118 ) ;
#ifdef F_76
...
while ( V_120 != 0 ) {
T_21 V_124 = F_81 ( V_125 , V_123 , ( int ) V_120 ) ;
if ( V_124 <= 0 ) {
F_50 ( L_78 ) ;
exit ( 2 ) ;
}
...
static T_13
F_83 ( struct V_126 * V_127 , T_22 * V_128 , int * V_7 , T_2 * * V_129 , T_23 * V_130 ) {
struct V_131 V_132 ;
struct V_133 V_134 ;
T_21 V_135 = 0 ;
...
while ( V_136 > 0 ) {
V_135 = F_81 ( V_125 , V_137 , ( int ) V_136 ) ;
if ( V_135 == 0 ) {
* V_7 = 0 ;
* V_129 = NULL ;
return FALSE ;
...
T_25 V_154 ;
F_85 ( & V_127 ) ;
F_86 ( & V_154 , V_153 -> V_118 , TRUE , FALSE ) ;
while ( F_83 ( & V_127 , V_128 , & V_7 , & V_129 , & V_130 ) ) {
F_87 ( V_153 , & V_154 , V_130 , & V_127 , V_128 ) ;
}
F_88 ( & V_154 ) ;
F_89 ( & V_127 ) ;
if ( V_7 != 0 ) {
...
static T_13
F_87 ( T_24 * V_153 , T_25 * V_154 , T_23 V_158 ,
...
V_153 -> V_162 ++ ;
F_91 ( & V_160 , V_153 -> V_162 , V_159 , V_158 , V_163 ) ;
V_161 = TRUE ;
if ( V_79 > 0 ) {
for( V_48 = 0 ; V_48 < V_80 ; V_48 ++ ) {
F_92 ( V_154 , V_78 [ V_48 ] ) ;
}
}
printf ( L_88 , ( unsigned long int ) V_153 -> V_162 ) ;
F_93 ( & V_160 , & V_153 -> V_164 ,
& V_165 , V_166 ) ;
if ( V_165 == & V_160 ) {
V_167 = V_160 ;
V_165 = & V_167 ;
}
F_94 ( V_154 , V_153 -> V_168 , V_159 , F_95 ( & V_160 , V_128 ) , & V_160 , & V_153 -> V_115 ) ;
F_96 ( & V_160 , & V_163 ) ;
V_169 = V_160 ;
V_166 = & V_169 ;
V_170 = V_160 ;
...
static const char * F_101 ( T_27 * V_172 )
{
const char * V_40 ;
if ( ! V_172 ) {
return L_91 ;
...
V_40 = F_102 ( V_172 -> type ) ;
if ( V_40 == NULL ) {
V_40 = L_91 ;
}
return V_40 ;
}
static void F_103 ( T_27 * V_172 , char * V_123 , int V_174 )
{
if ( V_172 -> type != V_175 )
{
F_104 ( V_123 , F_105 ( V_172 -> V_176 ) , V_174 ) ;
}
else
{
F_106 ( V_123 , V_174 , L_93 , V_172 -> V_176 ) ;
}
}
static T_13 F_107 ( T_28 * V_177 , int V_178 )
{
T_27 * V_179 ;
char * V_180 = NULL ;
char * V_181 = NULL ;
...
{
V_183 = F_108 ( & V_177 -> V_191 , V_194 , V_177 -> V_179 -> V_176 ) ;
V_180 = F_109 ( NULL , & V_177 -> V_191 ,
V_194 , V_177 -> V_179 -> V_176 ) ;
V_181 = V_180 ;
if ( F_110 ( V_177 -> V_191 . V_192 -> V_192 ) && V_183 > 2 ) {
V_180 [ V_183 - 1 ] = '\0' ;
V_181 ++ ;
}
}
...
V_184 = ( T_29 * ) F_65 ( V_81 , V_48 ) ;
if ( V_184 -> V_195 ) {
F_112 ( V_182 , V_184 -> V_195 ) ;
} else {
switch ( V_184 -> V_196 ) {
case V_197 :
F_112 ( V_182 , V_179 -> V_198 ) ;
break;
case V_199 :
F_112 ( V_182 , V_181 ) ;
break;
...
switch( V_179 -> type ) {
case V_175 :
V_187 = F_113 ( & V_177 -> V_191 ) ;
V_189 = ( const struct T_31 * ) V_179 -> V_173 ;
F_112 ( V_182 , V_187 ? V_189 -> V_201 : V_189 -> V_202 ) ;
break;
case V_203 :
case V_204 :
case V_205 :
case V_206 :
F_114 ( ! V_179 -> V_207 ) ;
V_186 = F_115 ( & V_177 -> V_191 ) ;
if ( V_179 -> V_176 & V_208 ) {
F_112 ( V_182 , F_116 ( V_186 , F_117 ( V_179 -> V_173 ) , L_94 ) ) ;
} else if ( V_179 -> V_176 & V_209 ) {
F_112 ( V_182 , F_118 ( V_186 , ( V_210 * ) V_179 -> V_173 , L_94 ) ) ;
} else {
F_112 ( V_182 , F_119 ( V_186 , F_120 ( V_179 -> V_173 ) , L_94 ) ) ;
}
break;
case V_211 :
case V_212 :
...
case V_214 :
F_114 ( ! V_179 -> V_207 ) ;
V_188 = ( T_23 ) F_121 ( & V_177 -> V_191 ) ;
if ( V_179 -> V_176 & V_215 ) {
F_112 ( V_182 , F_122 ( V_188 , ( const V_216 * ) ( V_179 -> V_173 ) , L_94 ) ) ;
}
break;
case V_217 :
case V_218 :
...
case V_220 :
F_114 ( ! V_179 -> V_207 ) ;
V_185 = F_123 ( & V_177 -> V_191 ) ;
if ( ! V_179 -> V_207 && V_179 -> V_176 & V_208 ) {
F_112 ( V_182 , F_116 ( V_185 , F_117 ( V_179 -> V_173 ) , L_94 ) ) ;
} else if ( V_179 -> V_176 & V_209 ) {
F_112 ( V_182 , F_118 ( V_185 , ( V_210 * ) V_179 -> V_173 , L_94 ) ) ;
} else {
F_112 ( V_182 , F_119 ( V_185 , F_120 ( V_179 -> V_173 ) , L_94 ) ) ;
}
break;
case V_221 :
case V_222 :
...
V_187 = F_113 ( & V_177 -> V_191 ) ;
if ( V_179 -> V_176 & V_215 ) {
F_112 ( V_182 , F_122 ( V_187 , ( const V_216 * ) ( V_179 -> V_173 ) , L_94 ) ) ;
}
break;
default:
break;
...
static int
F_125 ( void * V_225 , T_32 * T_33 V_2 , T_25 * V_154 , const void * T_34 V_2 )
{
T_35 * V_226 = ( T_35 * ) V_225 ;
T_18 * V_227 ;
T_19 V_48 ;
V_227 = F_126 ( V_154 -> V_228 , V_226 -> V_229 ) ;
if( ! V_227 ) {
printf ( L_97 ) ;
return 0 ;
}
for ( V_48 = 0 ; V_48 < V_227 -> V_113 ; V_48 ++ ) {
F_107 ( ( T_28 * ) V_227 -> V_230 [ V_48 ] , V_226 -> V_178 ) ;
}
return 0 ;
}
static void
...
F_103 ( V_172 , V_233 , sizeof( V_233 ) ) ;
printf ( L_99 ,
V_234 ,
F_101 ( V_172 ) ,
V_233 ) ;
V_226 = ( T_35 * ) F_128 ( sizeof( T_35 ) ) ;
V_226 -> V_229 = V_172 -> V_235 ;
V_226 -> V_236 = V_231 ;
V_226 -> V_178 = V_234 ++ ;
V_232 = F_129 ( L_100 , V_226 , V_226 -> V_236 , V_237 , NULL , F_125 , NULL ) ;
if( V_232 ) {
fprintf ( V_14 , L_101 ,
V_232 -> V_40 ) ;
F_31 ( V_232 , TRUE ) ;
...
static void
F_130 ( T_36 V_196 , T_2 * V_195 ) {
T_29 * V_184 = ( T_29 * ) F_128 ( sizeof( T_29 ) ) ;
V_184 -> V_196 = V_196 ;
...
{
fprintf ( V_14 , L_107 ) ;
fprintf ( V_14 , F_134 ( V_7 , V_241 ) , V_156 ) ;
fprintf ( V_14 , L_1 ) ;
}
static const T_37 *
F_135 ( void * T_38 V_2 , V_122 V_242 )
{
...
T_40
F_80 ( T_24 * V_153 , const char * V_249 )
{
if ( ( V_125 = F_3 ( V_249 ) ) < 0 )
return V_250 ;
F_75 ( V_153 -> V_118 ) ;
V_153 -> V_118 = F_136 ( V_153 ) ;
V_153 -> V_251 = NULL ;
V_153 -> V_252 = 0 ;
