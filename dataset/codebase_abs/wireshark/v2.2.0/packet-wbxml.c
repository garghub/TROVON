...
F_49 ( V_52 , L_68 , F_50 ( V_13 , strlen ( V_13 ) ) ) ;
F_51 ( V_52 , V_53 ) ;
V_49 += V_53 ;
}
}
...
V_49 += V_53 ;
if ( V_49 >= V_60 ) {
F_39 ( ( L_106 , * V_57 , V_49 - V_7 ) ) ;
F_64 ( V_99 ) ;
}
F_60 ( V_45 , V_100 , V_6 , V_49 - 1 , 1 ,
L_107 ,
* V_57 , * V_88 , F_52 ( * V_57 ) ) ;
break;
case 0x80 :
...
V_61 = F_56 ( V_6 , V_22 + V_63 ) ;
V_93 = ( const T_17 * ) F_65 ( V_6 , V_22 + V_63 , V_61 ) ;
V_91 = 0 ;
} else {
V_91 = V_21 & 0x3F ;
if ( V_33 != NULL ) {
V_93 = F_42 ( V_33 -> V_102 , * V_88 ,
V_91 ) ;
} else {
V_93 = F_4 ( F_5 () , L_116 ,
V_91 ) ;
...
F_58 ( V_45 , V_104 , V_6 , V_49 , 1 , V_93 ,
L_119 ,
...
F_58 ( V_45 , V_106 , V_6 , V_49 , 1 , V_93 ,
L_122 ,
* V_57 , * V_88 , F_52 ( * V_57 ) , V_93 ) ;
V_49 += 1 + V_89 ;
}
...
F_55 ( V_45 , V_107 , V_6 , V_49 - 1 , 1 , * V_88 ,
L_126 ,
* V_57 , * V_88 , F_52 ( * V_57 ) ) ;
} else {
F_58 ( V_45 , V_108 , V_6 , V_49 , 1 , V_93 ,
L_127 ,
* V_57 , * V_88 , F_52 ( * V_57 ) , V_93 ) ;
V_49 += 1 + V_89 ;
V_53 = F_53 ( V_45 , V_6 , V_10 ,
...
static void
F_66 ( T_5 * V_6 , T_9 * V_10 , T_14 * V_45 ,
const T_11 * V_109 )
{
T_16 * V_52 ;
T_14 * V_110 ;
...
T_6 V_88 = 0 ;
T_6 V_59 = 0 ;
F_39 ( ( L_132 , V_10 -> V_122 ) ) ;
switch ( V_114 = F_10 ( V_6 , 0 ) ) {
case 0x00 :
break;
case 0x01 :
case 0x02 :
...
break;
default:
F_67 ( V_10 -> V_123 , V_124 , L_133 , V_114 ) ;
V_52 = F_68 ( V_45 , V_125 , V_6 , 0 , - 1 , V_126 ) ;
F_49 ( V_52 , L_134 , V_114 ) ;
return;
}
V_116 = F_3 ( V_6 , 1 , & V_118 , V_10 , & V_12 ) ;
if ( ! V_116 ) {
V_117 = F_3 ( V_6 , 1 + V_118 , & V_53 , V_10 , & V_12 ) ;
V_118 += V_53 ;
}
V_7 = 1 + V_118 ;
switch ( V_114 ) {
...
case 0x02 :
case 0x03 :
V_47 = F_3 ( V_6 , V_7 , & V_115 , V_10 , & V_12 ) ;
V_7 += V_115 ;
break;
default:
F_69 () ;
...
F_3 ( V_6 , V_7 , & V_119 , V_10 , & V_12 ) ;
V_22 = V_7 + V_119 ;
if ( V_116 ) {
V_121 = F_4 ( F_5 () , L_135 ,
F_33 ( V_114 , & V_127 , L_89 ) ,
F_33 ( V_116 , & V_128 , L_89 ) ) ;
} else {
V_53 = F_56 ( V_6 , V_22 + V_117 ) ;
V_121 = F_4 ( F_5 () , L_135 ,
F_33 ( V_114 , & V_127 , L_89 ) ,
F_57 ( V_6 , V_22 + V_117 , V_53 - 1 ) ) ;
}
F_67 ( V_10 -> V_123 , V_124 , L_136 , V_121 ) ;
V_52 = F_68 ( V_45 , V_125 , V_6 , 0 , - 1 , V_126 ) ;
F_49 ( V_52 , L_137 , V_121 ) ;
V_110 = F_70 ( V_52 , V_129 ) ;
F_47 ( V_110 , V_130 ,
V_6 , 0 , 1 , V_114 ) ;
if ( V_116 ) {
F_47 ( V_110 , V_131 ,
...
F_68 ( V_110 , V_132 ,
V_6 , 1 , V_118 , V_133 | V_126 ) ;
}
V_7 = 1 + V_118 ;
if ( V_47 ) {
F_47 ( V_110 , V_134 ,
V_6 , 1 + V_118 , V_115 , V_47 ) ;
V_7 += V_115 ;
}
V_46 = F_3 ( V_6 , V_7 , & V_53 , V_10 , & V_12 ) ;
V_22 = V_7 + V_53 ;
V_111 = F_46 ( V_110 ,
V_6 , V_7 , V_53 + V_46 , V_135 , NULL , L_138 ,
V_46 ) ;
if ( V_46 ) {
F_44 ( V_111 , V_6 ,
V_22 , V_46 ,
...
V_7 += V_53 + V_46 ;
V_112 = F_71 ( V_110 , V_6 , V_7 , - 1 ,
V_136 , & V_52 , L_139 ) ;
if ( V_137 ) {
F_72 ( V_10 , V_52 , & V_138 ) ;
return;
}
if ( V_109 != NULL ) {
V_120 = V_109 ;
...
V_10 -> V_140 , V_6 , V_7 ) ;
if ( ! V_120 ) {
F_72 ( V_10 , V_52 , & V_141 ) ;
} else {
F_49 ( V_52 ,
L_141
L_142 ,
V_10 -> V_140 , V_120 -> V_139 ) ;
}
}
}
if ( V_120 && V_142 ) {
F_72 ( V_10 , V_52 , & V_143 ) ;
V_120 = NULL ;
}
V_113 = F_71 ( V_112 , V_6 , V_7 , - 1 , V_144 , NULL ,
L_143 ) ;
V_53 = F_61 ( V_113 ,
...
static int
F_73 ( T_5 * V_6 , T_9 * V_10 , T_14 * V_45 , void * T_18 V_8 )
{
F_66 ( V_6 , V_10 , V_45 , NULL ) ;
return F_74 ( V_6 ) ;
}
static int
F_75 ( T_5 * V_6 , T_9 * V_10 , T_14 * V_45 , void * T_18 V_8 )
{
F_66 ( V_6 , V_10 , V_45 , & V_145 ) ;
return F_74 ( V_6 ) ;
}
void
F_76 ( void )
...
static T_21 V_162 [] = {
{ & V_138 , { L_205 , V_163 , V_164 , L_206 , V_165 } } ,
{ & V_141 , { L_207 , V_166 , V_167 , L_208 , V_165 } } ,
{ & V_143 , { L_209 , V_163 , V_164 , L_210 , V_165 } } ,
{ & V_12 , { L_211 , V_168 , V_169 , L_212 , V_165 } } ,
{ & V_95 , { L_213 , V_166 , V_167 , L_214 , V_165 } }
} ;
T_22 * V_170 ;
V_125 = F_77 (
L_215 ,
...
F_78 ( V_125 , V_147 , F_79 ( V_147 ) ) ;
F_80 ( V_161 , F_79 ( V_161 ) ) ;
V_170 = F_81 ( V_125 ) ;
F_82 ( V_170 , V_162 , F_79 ( V_162 ) ) ;
V_146 = F_83 ( V_125 , NULL ) ;
F_84 ( V_146 ,
L_218 ,
L_219 ,
L_220
...
L_229 ,
& V_137 ) ;
F_85 ( L_217 , F_73 , V_125 ) ;
F_85 ( L_230 , F_75 , V_125 ) ;
}
void
F_86 ( void )
{
