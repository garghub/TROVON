...
if ( F_7 ( V_1 -> V_16 , & V_1 -> V_24 , V_28 , & V_30 , V_2 ,
V_3 ) != 0 && * V_2 != 0 ) {
return V_34 ;
}
if ( V_30 . V_36 == 0 ) {
...
if ( * V_2 == 0 ) {
* V_2 = V_77 ;
* V_3 = F_13 ( ( V_30 . V_78 != NULL ) ? V_30 . V_78 : L_1 ) ;
}
} else {
if ( * V_2 == 0 ) {
* V_2 = V_77 ;
...
static T_11 V_48 ( T_2 * V_1 , int * V_2 , T_3 * * V_3 ,
T_1 * V_79 )
{
...
if ( V_27 == - 1 )
return FALSE ;
if ( ! F_10 ( V_26 , V_1 -> V_16 , & V_1 -> V_24 , V_1 -> V_80 ,
V_1 -> V_46 , V_2 , V_3 ) )
return FALSE ;
* V_79 = V_27 ;
return TRUE ;
}
static T_11 V_50 ( T_2 * V_1 , T_1 V_81 ,
struct V_58 * V_24 , T_13 * V_28 ,
int * V_2 , T_3 * * V_3 )
{
T_10 * V_26 = ( T_10 * ) V_1 -> V_32 ;
if ( F_5 ( V_1 -> V_82 , V_81 , V_23 , V_2 ) == - 1 )
return FALSE ;
if ( ! F_10 ( V_26 , V_1 -> V_82 , V_24 , V_28 ,
V_1 -> V_46 , V_2 , V_3 ) )
return FALSE ;
return TRUE ;
}
