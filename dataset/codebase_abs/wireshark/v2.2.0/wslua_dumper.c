...
V_65 = (struct V_64 * ) ( V_62 -> V_65 -> V_60 ) ;
if ( ! V_65 )
return 0 ;
V_63 = F_60 ( V_65 ) ;
memset ( & V_45 , 0 , sizeof( V_45 ) ) ;
...
V_45 . V_58 = V_62 -> V_58 ;
V_45 . V_59 = * V_62 -> V_59 ;
if ( V_62 -> V_68 -> V_69 . V_70 )
V_45 . V_71 = F_63 ( F_64 () , F_65 ( V_62 -> V_72 , V_62 -> V_68 ) ) ;
else if ( V_62 -> V_68 -> V_69 . V_73 )
V_45 . V_71 = F_63 ( F_64 () , V_62 -> V_74 -> V_71 ) ;
V_60 = ( const T_8 * ) F_66 ( F_64 () , V_63 , 0 , V_45 . V_57 ) ;
