...
if ( V_41 ) {
char * V_42 = F_34 ( NULL , V_41 ) ;
F_10 ( V_41 ) ;
return V_42 ;
}
}
return F_34 ( NULL , V_39 ) ;
}
char *
...
V_39 = F_37 ( NULL , L_17 , V_34 -> V_47 , V_34 -> V_48 ) ;
V_45 = F_31 ( V_39 , V_6 ) ;
F_38 ( NULL , V_39 ) ;
...
static int
#if V_53 > 31
F_40 ( T_13 V_31 , float * V_32 , float * V_33 ) {
T_3 * V_6 ;
T_12 * V_34 ;
T_7 V_17 ;
for ( V_17 = 0 ; V_17 < F_16 () ; V_17 ++ ) {
...
char *
F_42 ( T_7 V_29 , struct V_56 V_31 , const char * V_43 ) {
T_3 * V_6 ;
T_13 V_57 ;
const char * V_44 ;
char * V_39 , * V_45 = NULL ;
...
char *
F_42 ( T_7 V_29 V_12 , struct V_56 V_31 V_12 , const char * V_43 ) {
if ( V_43 == NULL )
return NULL ;
return F_34 ( NULL , V_43 ) ;
}
...
for ( V_17 = 0 ; V_17 < V_18 ; V_17 ++ ) {
if ( V_19 [ V_17 ] . V_15 ) {
F_48 ( V_62 , L_20 , V_19 [ V_17 ] . V_15 , V_63 ) ;
}
}
F_49 ( V_62 , V_62 -> T_5 - 1 ) ;
return F_50 ( V_62 , FALSE ) ;
}
T_7
F_16 ( void ) {
return 0 ;
...
if ( V_43 == NULL )
return NULL ;
return ( char * ) F_34 ( NULL , V_43 ) ;
}
char *
F_42 ( T_7 V_29 V_12 , T_11 V_31 V_12 , const char * V_43 ) {
if ( V_43 == NULL )
return NULL ;
return ( char * ) F_34 ( NULL , V_43 ) ;
}
