...
T_9 V_19 = F_23 ( V_1 , 2 ) ;
if ( ! V_8 -> V_3 ) return 0 ;
V_8 -> V_3 -> V_20 . V_21 = V_19 -> V_21 ;
V_8 -> V_3 -> V_20 . V_22 = V_19 -> V_22 ;
return 0 ;
}
static int F_24 ( T_2 * V_1 ) {
T_1 V_8 = F_12 ( V_1 , 1 ) ;
T_9 V_19 = ( T_9 ) F_25 ( sizeof( V_23 ) ) ;
if ( ! V_19 ) return 0 ;
V_19 -> V_21 = V_8 -> V_3 -> V_20 . V_21 ;
V_19 -> V_22 = V_8 -> V_3 -> V_20 . V_22 ;
F_26 ( V_1 , V_19 ) ;
return 1 ;
}
...
if ( F_29 ( V_1 , 2 ) ) {
T_10 V_12 = 0 ;
const T_8 * V_24 = F_30 ( V_1 , 2 , & V_12 ) ;
F_31 ( V_8 -> V_4 , V_12 ) ;
memcpy ( F_32 ( V_8 -> V_4 ) , V_24 , V_12 ) ;
...
T_11 * F_39 ( T_2 * V_1 , const struct V_2 * V_3 , const T_12 * V_25 ) {
T_11 V_5 = ( T_11 ) F_25 ( sizeof( struct V_26 ) ) ;
V_5 -> V_3 = V_3 ;
V_5 -> V_25 = V_25 ;
V_5 -> V_7 = FALSE ;
return F_40 ( V_1 , V_5 ) ;
...
int V_16 = 0 ;
if ( ! V_8 -> V_25 || ! V_8 -> V_3 || ! V_15 -> V_27 ) {
F_15 ( V_1 , L_11 ) ;
return 0 ;
}
if ( V_12 > V_8 -> V_3 -> V_11 )
V_12 = V_8 -> V_3 -> V_11 ;
if ( ! F_48 ( V_15 -> V_27 , V_8 -> V_25 , ( T_10 ) ( V_12 ) , & V_16 ) ) {
F_17 ( V_1 , FALSE ) ;
...
T_11 V_8 = F_46 ( V_1 , 1 ) ;
if ( ! V_8 -> V_25 || ! V_8 -> V_3 ) return 0 ;
F_34 ( V_1 , V_8 -> V_25 , V_8 -> V_3 -> V_11 ) ;
return 1 ;
}
int F_53 ( T_2 * V_1 ) {
F_37 ( T_11 ) ;
