...
V_95 = F_45 ( L_33 , L_34 , V_26 , V_96 , V_82 ) ;
F_32 () ;
}
void F_46 ( void ) {
int V_2 ;
...
T_17 V_101 ;
V_97 = F_47 ( L_35 , V_26 ) ;
V_102 = F_47 ( L_36 , V_26 ) ;
V_98 = F_48 ( F_5 , V_26 ) ;
V_99 = F_48 ( F_21 , V_26 ) ;
for ( V_2 = 0 ; V_2 < ( int ) F_2 ( V_3 ) ; V_2 ++ ) {
F_49 ( L_37 , V_3 [ V_2 ] . V_1 , V_98 ) ;
F_49 ( L_38 , V_3 [ V_2 ] . V_1 , V_99 ) ;
V_62 = V_3 [ V_2 ] . V_1 ;
...
V_100 = F_48 ( F_22 , V_26 ) ;
for ( V_2 = 0 ; V_2 < ( int ) F_2 ( V_7 ) ; V_2 ++ ) {
F_49 ( L_41 , V_7 [ V_2 ] . V_6 , V_100 ) ;
}
V_101 = F_48 ( F_30 , V_26 ) ;
F_49 ( L_36 , V_57 | V_58 , V_101 ) ;
V_101 = F_48 ( F_31 , V_26 ) ;
F_49 ( L_36 , V_59 | V_60 , V_101 ) ;
F_50 ( L_42 , L_43 , V_97 ) ;
}
