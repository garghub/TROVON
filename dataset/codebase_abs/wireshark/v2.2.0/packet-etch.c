...
V_101 = V_93 -> V_100 ;
F_54 ( V_93 -> V_97 , V_102 , L_15 , F_49 ( V_96 ) ) ;
}
if ( V_94 ) {
unsigned int V_51 ;
T_14 * V_68 ;
...
F_51 , V_6 ) ;
if ( V_99 > 0 ) {
F_60 ( V_93 -> V_97 , V_102 , L_17 , V_99 + 1 ) ;
}
return 1 ;
}
static void
...
void V_129 ( void )
{
static T_19 V_132 = FALSE ;
static T_1 V_133 = 0 ;
if( ! V_132 ) {
F_73 ( L_67 , F_57 , L_68 , L_69 , V_103 , V_134 ) ;
V_132 = TRUE ;
}
if( V_133 != 0 && V_133 != V_131 ) {
F_74 ( L_64 , V_133 , V_128 ) ;
}
if( V_131 != 0 && V_133 != V_131 ) {
F_75 ( L_64 , V_131 , V_128 ) ;
}
V_133 = V_131 ;
