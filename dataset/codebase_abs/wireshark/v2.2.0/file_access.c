...
T_12 *
F_85 ( const char * V_32 , int V_77 , int V_112 ,
int V_129 , T_4 V_130 , int * V_35 )
{
return F_86 ( V_32 , V_77 , V_112 , V_129 , V_130 , NULL , NULL , NULL , V_35 ) ;
}
T_12 *
...
T_12 *
F_91 ( char * * V_137 , const char * V_138 ,
int V_77 , int V_112 ,
int V_129 , T_4 V_130 , int * V_35 )
{
return F_92 ( V_137 , V_138 , V_77 , V_112 , V_129 , V_130 , NULL , NULL , NULL , V_35 ) ;
}
T_12 *
F_92 ( char * * V_137 , const char * V_138 ,
int V_77 , int V_112 ,
int V_129 , T_4 V_130 ,
T_10 * V_62 ,
T_13 * V_131 ,
...
T_12 *
F_95 ( int V_38 , int V_77 , int V_112 , int V_129 ,
T_4 V_130 , int * V_35 )
{
return F_96 ( V_38 , V_77 , V_112 , V_129 , V_130 , NULL , NULL , NULL , V_35 ) ;
}
T_12 *
...
T_12 *
F_97 ( int V_77 , int V_112 , int V_129 ,
T_4 V_130 , int * V_35 )
{
return F_98 ( V_77 , V_112 , V_129 , V_130 , NULL , NULL , NULL , V_35 ) ;
}
T_12 *
...
static T_4
F_88 ( T_12 * V_133 , int V_77 , T_4 V_130 , int * V_35 )
{
int V_38 ;
T_4 V_143 ;
if( V_130 ) {
...
V_38 = F_99 ( ( V_144 * ) V_133 -> V_52 ) ;
if ( F_100 ( V_38 , 1 , V_145 ) == ( V_146 ) - 1 )
V_143 = TRUE ;
else {
F_100 ( V_38 , 0 , V_67 ) ;
V_143 = FALSE ;
...
T_4
F_101 ( T_12 * V_133 , const struct V_148 * V_149 ,
const T_15 * V_150 , int * V_35 , T_2 * * V_36 )
{
* V_35 = 0 ;
* V_36 = NULL ;
return ( V_133 -> V_151 ) ( V_133 , V_149 , V_150 , V_35 , V_36 ) ;
}
void
F_102 ( T_12 * V_133 )
{
#ifdef F_103
if( V_133 -> V_130 ) {
F_104 ( ( V_152 ) V_133 -> V_52 ) ;
} else
#endif
{
fflush ( ( V_144 * ) V_133 -> V_52 ) ;
}
}
T_4
F_105 ( T_12 * V_133 , int * V_35 )
{
T_4 V_153 = TRUE ;
if ( V_133 -> V_154 != NULL ) {
if ( ! ( V_133 -> V_154 ) ( V_133 , V_35 ) )
V_153 = FALSE ;
}
V_43 = V_155 ;
if ( F_89 ( V_133 ) == V_156 ) {
...
void
F_107 ( T_12 * V_133 , T_16 V_157 )
{
V_133 -> V_157 = V_157 ;
}
T_4
F_108 ( T_12 * V_133 , T_17 * V_158 )
{
...
static T_14
F_87 ( T_12 * V_133 , const char * V_32 )
{
if( V_133 -> V_130 ) {
return F_109 ( V_32 ) ;
} else {
return F_110 ( V_32 , L_18 ) ;
}
}
static T_14
F_87 ( T_12 * V_133 V_127 , const char * V_32 )
{
return F_110 ( V_32 , L_18 ) ;
}
static T_14
F_94 ( T_12 * V_133 , int V_38 )
{
if( V_133 -> V_130 ) {
return F_111 ( V_38 ) ;
} else {
return F_112 ( V_38 , L_18 ) ;
}
}
static T_14
F_94 ( T_12 * V_133 V_127 , int V_38 )
{
return F_112 ( V_38 , L_18 ) ;
}
T_4
F_113 ( T_12 * V_133 , const void * V_159 , T_5 V_160 , int * V_35 )
{
T_5 V_161 ;
#ifdef F_103
if ( V_133 -> V_130 ) {
V_161 = F_114 ( ( V_152 ) V_133 -> V_52 , V_159 , ( unsigned int ) V_160 ) ;
if ( V_161 == 0 ) {
* V_35 = F_115 ( ( V_152 ) V_133 -> V_52 ) ;
return FALSE ;
}
} else
#endif
{
V_43 = V_162 ;
V_161 = fwrite ( V_159 , 1 , V_160 , ( V_144 * ) V_133 -> V_52 ) ;
if ( V_161 != V_160 ) {
if ( ferror ( ( V_144 * ) V_133 -> V_52 ) )
* V_35 = V_43 ;
else
* V_35 = V_163 ;
return FALSE ;
...
#ifdef F_103
if( V_133 -> V_130 ) {
return F_116 ( ( V_152 ) V_133 -> V_52 , V_133 -> V_140 ) ;
} else
#endif
{
return V_133 -> V_140 ? fflush ( ( V_144 * ) V_133 -> V_52 ) : fclose ( ( V_144 * ) V_133 -> V_52 ) ;
}
}
T_16
F_117 ( T_12 * V_133 , T_16 V_164 , int V_165 , int * V_35 )
{
#ifdef F_103
if( V_133 -> V_130 ) {
* V_35 = V_166 ;
...
#endif
{
if ( - 1 == fseek ( ( V_144 * ) V_133 -> V_52 , ( long ) V_164 , V_165 ) ) {
* V_35 = V_43 ;
return - 1 ;
} else
{
...
#endif
{
if ( - 1 == ( V_167 = ftell ( ( V_144 * ) V_133 -> V_52 ) ) ) {
* V_35 = V_43 ;
return - 1 ;
} else
{
