...
T_3 F_18 ( const char * V_8 , const T_1 V_14 , const T_4 * V_21 , int V_22 , int V_23 , T_5 * V_24 , const union V_25 * V_26 )
{
struct V_2 * V_10 ;
struct V_17 * V_18 ;
V_10 = (struct V_2 * ) F_8 ( V_5 , V_8 ) ;
...
if ( V_18 == NULL )
return FALSE ;
return V_18 -> V_15 ( V_21 , V_22 , V_23 , V_24 , V_26 ) ;
}
T_1 F_19 ( T_6 * V_27 , const int V_16 )
{
T_7 * V_28 = ( T_7 * ) F_8 ( V_27 -> V_29 , F_14 ( V_16 ) ) ;
if ( V_28 == NULL )
return 0 ;
return V_28 -> V_30 ;
}
void F_20 ( T_5 * V_24 , const int V_16 )
{
T_7 * V_28 = ( T_7 * ) F_8 ( V_24 -> V_27 , F_14 ( V_16 ) ) ;
if ( V_28 == NULL )
{
V_28 = F_21 ( T_7 , 1 ) ;
F_11 ( V_24 -> V_27 , F_14 ( V_16 ) , ( V_13 ) V_28 ) ;
}
V_28 -> V_30 ++ ;
}
