...
T_5 = F_2 ( T_2 , T_4 , T_5 , T_7 , T_9 , T_10 ) ;
return T_5 ;
}
static int
...
T_5 = F_18 ( T_2 , T_7 , T_9 , T_4 , T_5 , T_10 , NULL ) ;
return T_5 ;
}
static int
...
T_5 = F_29 ( T_2 , T_9 , T_4 , T_5 , T_7 , T_10 , NULL ) ;
return T_5 ;
}
static int
...
static int F_108 ( T_3 * T_4 V_1 , T_11 * T_12 V_1 , T_8 * T_9 V_1 , void * T_13 V_1 ) {
int T_5 = 0 ;
T_6 V_144 ;
F_109 ( & V_144 , V_145 , TRUE , T_12 ) ;
T_5 = F_106 ( FALSE , T_4 , T_5 , & V_144 , T_9 , V_146 ) ;
return T_5 ;
}
static int F_110 ( T_3 * T_4 V_1 , T_11 * T_12 V_1 , T_8 * T_9 V_1 , void * T_13 V_1 ) {
int T_5 = 0 ;
T_6 V_144 ;
F_109 ( & V_144 , V_145 , TRUE , T_12 ) ;
T_5 = F_44 ( FALSE , T_4 , T_5 , & V_144 , T_9 , V_147 ) ;
return T_5 ;
}
static int F_111 ( T_3 * T_4 V_1 , T_11 * T_12 V_1 , T_8 * T_9 V_1 , void * T_13 V_1 ) {
int T_5 = 0 ;
T_6 V_144 ;
F_109 ( & V_144 , V_145 , TRUE , T_12 ) ;
T_5 = F_107 ( FALSE , T_4 , T_5 , & V_144 , T_9 , V_148 ) ;
return T_5 ;
}
static int
F_112 ( T_3 * T_4 , T_11 * T_12 , T_8 * V_149 , void * T_13 )
{
int T_5 = 0 ;
int V_150 ;
T_14 * V_151 ;
T_8 * T_9 ;
struct V_152 * V_153 ;
int (* F_113)( T_1 T_2 V_1 , T_3 * T_4 , int T_5 , T_6 * T_7 , T_8 * T_9 , int T_10 V_1 ) = NULL ;
const char * V_154 ;
T_6 V_144 ;
if ( T_13 == NULL )
return 0 ;
V_153 = (struct V_152 * ) T_13 ;
F_109 ( & V_144 , V_145 , TRUE , T_12 ) ;
V_151 = F_114 ( V_149 , V_155 , T_4 , 0 , - 1 , V_156 ) ;
T_9 = F_115 ( V_151 , V_157 ) ;
F_116 ( T_12 -> V_158 , V_159 , L_1 ) ;
F_117 ( T_12 -> V_158 , V_160 ) ;
V_144 . V_161 = V_153 ;
...
break;
default:
F_118 ( T_9 , T_12 , & V_170 , T_4 , T_5 , - 1 ,
L_14 , V_153 -> V_162 & V_169 ) ;
break;
}
break;
case ( V_168 | V_166 ) :
...
break;
default:
F_119 ( T_9 , T_12 , & V_170 , T_4 , T_5 , - 1 ) ;
break;
}
break;
case ( V_168 | V_167 ) :
...
break;
default:
F_119 ( T_9 , T_12 , & V_179 , T_4 , T_5 , - 1 ) ;
break;
}
break;
default:
F_119 ( T_9 , T_12 , & V_180 , T_4 , T_5 , - 1 ) ;
return F_120 ( T_4 ) ;
}
if( F_113 ) {
F_116 ( T_12 -> V_158 , V_160 , V_154 ) ;
while ( F_121 ( T_4 , T_5 ) > 0 ) {
V_150 = T_5 ;
T_5 = (* F_113)( FALSE , T_4 , T_5 , & V_144 , T_9 , - 1 ) ;
if( T_5 == V_150 ) {
F_119 ( T_9 , T_12 , & V_181 , T_4 , T_5 , - 1 ) ;
break;
}
}
}
...
{ & V_330 ,
{ L_303 , L_304 ,
V_186 , V_187 , F_123 ( V_331 ) , 0 ,
NULL , V_185 } } ,
{ & V_332 ,
{ L_305 , L_306 ,
V_186 , V_187 , F_123 ( V_333 ) , 0 ,
L_307 , V_185 } } ,
{ & V_334 ,
{ L_308 , L_309 ,
V_277 , V_184 , NULL , 0 ,
...
static T_17 V_353 [] = {
{ & V_170 , { L_338 , V_354 , V_355 , L_339 , V_356 } } ,
{ & V_179 , { L_340 , V_354 , V_355 , L_341 , V_356 } } ,
{ & V_180 , { L_342 , V_354 , V_355 , L_343 , V_356 } } ,
{ & V_181 , { L_344 , V_357 , V_358 , L_345 , V_356 } } ,
} ;
T_18 * V_359 ;
T_19 * V_360 ;
V_155 = F_124 ( V_361 , V_362 , V_363 ) ;
V_364 = F_125 ( L_346 , F_112 , V_155 ) ;
F_126 ( V_155 , V_182 , F_127 ( V_182 ) ) ;
F_128 ( V_352 , F_127 ( V_352 ) ) ;
V_360 = F_129 ( V_155 ) ;
F_130 ( V_360 , V_353 , F_127 ( V_353 ) ) ;
V_359 = F_131 ( L_347 , V_155 , V_365 ) ;
F_132 ( V_359 , L_348 , L_349 ,
L_350
L_351 ,
10 , & V_366 ) ;
}
...
F_134 ( L_352 , F_108 , V_155 , L_353 ) ;
F_134 ( L_354 , F_108 , V_155 , L_355 ) ;
F_134 ( L_356 , F_110 , V_155 , L_357 ) ;
F_134 ( L_358 , F_110 , V_155 , L_359 ) ;
F_134 ( L_360 , F_111 , V_155 , L_361 ) ;
#line 320 "./asn1/dsp/packet-dsp-template.c"
F_135 ( L_362 , L_363 ) ;
V_367 = F_136 ( L_364 ) ;
F_137 ( L_365 , V_364 , 0 , L_366 , FALSE ) ;
}
static void
V_365 ( void )
{
static T_20 V_368 = 0 ;
if( ( V_368 > 0 ) && ( V_368 != 102 ) && V_367 )
F_138 ( L_348 , V_368 , V_367 ) ;
V_368 = V_366 ;
if( ( V_368 > 0 ) && ( V_368 != 102 ) && V_367 )
F_139 ( L_348 , V_366 , V_367 ) ;
}
