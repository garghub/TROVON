...
F_27 ( V_51 , V_52 , V_53 ) ;
F_30 ( V_51 , V_52 , V_53 ) ;
F_29 ( V_53 , V_62 , V_52 , * V_51 , 1 , V_56 ) ;
( * V_51 ) ++ ;
...
if ( V_54 <= V_25 ||
V_54 >= V_24 ) {
F_29 ( V_53 , V_67 , V_52 , * V_51 , 1 , V_58 ) ;
( * V_51 ) ++ ;
return V_54 ;
}
switch( V_54 ) {
...
V_99 ++ ;
if ( V_93 -> V_100 -> V_101 != V_102 ) {
F_53 ( V_93 -> V_97 , V_103 ) ;
V_99 = 0 ;
}
V_102 = V_93 -> V_100 -> V_101 ;
F_54 ( V_93 -> V_97 , TRUE ) ;
F_55 ( V_93 -> V_97 , V_103 , L_14 , F_49 ( V_96 ) ) ;
}
if ( V_94 ) {
unsigned int V_51 ;
T_14 * V_68 ;
T_13 * V_53 ;
V_68 = F_56 ( V_94 , V_104 , V_52 , 0 , - 1 ,
L_15 , F_49 ( V_96 ) ) ;
V_51 = 9 ;
V_53 = F_47 ( V_68 , V_105 ) ;
F_29 ( V_53 , V_106 , V_52 , 0 , 4 , V_58 ) ;
F_29 ( V_53 , V_61 , V_52 , 4 , 4 , V_58 ) ;
F_29 ( V_53 , V_107 , V_52 , 8 , 1 , V_56 ) ;
F_45 ( & V_51 , V_52 , V_53 , 0 ) ;
}
return F_46 ( V_52 ) ;
}
static T_1
F_57 ( T_16 * V_93 V_95 , T_12 * V_52 , int V_51 )
{
return F_33 ( V_52 , V_51 + 4 ) + 8 ;
}
static int
F_58 ( T_12 * V_52 , T_16 * V_93 , T_13 * V_94 , void * V_6 )
{
if ( F_46 ( V_52 ) < 4 ) {
return 0 ;
}
if ( F_59 ( V_52 , 0 , V_108 , 4 ) == - 1 ) {
return 0 ;
}
F_60 ( V_52 , V_93 , V_94 , TRUE , 8 , F_57 ,
F_51 , V_6 ) ;
if ( V_99 > 0 ) {
F_54 ( V_93 -> V_97 , TRUE ) ;
F_61 ( V_93 -> V_97 , V_103 , L_16 , V_99 + 1 ) ;
}
return 1 ;
}
static void
...
F_66 ( V_104 , V_110 , F_67 ( V_110 ) ) ;
F_68 ( V_128 , F_67 ( V_128 ) ) ;
V_129 = F_69 ( L_57 , F_58 , V_104 ) ;
F_70 ( & F_62 ) ;
V_109 = F_71 ( V_104 ,
V_130 ) ;
F_72 ( V_109 , L_58 ,
...
static T_1 V_134 = 0 ;
if( ! V_133 ) {
F_74 ( L_66 , F_58 , V_104 ) ;
V_133 = TRUE ;
}
if( V_134 != 0 && V_134 != V_132 ) {
F_75 ( L_63 , V_134 , V_129 ) ;
}
if( V_132 != 0 && V_134 != V_132 ) {
F_76 ( L_63 , V_132 , V_129 ) ;
}
V_134 = V_132 ;
