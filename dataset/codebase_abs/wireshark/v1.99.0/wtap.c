...
V_7 -> V_61 . V_63 = V_7 -> V_16 ;
if ( ! V_7 -> V_64 ( V_7 , V_8 , V_59 , V_60 ) ) {
if ( * V_8 == 0 )
* V_8 = F_55 ( V_7 -> V_10 , V_59 ) ;
return FALSE ;
}
if ( V_7 -> V_61 . V_65 > V_7 -> V_61 . V_49 )
V_7 -> V_61 . V_65 = V_7 -> V_61 . V_49 ;
F_56 ( V_7 -> V_61 . V_62 != V_34 ) ;
return TRUE ;
}
T_1
F_57 ( T_17 V_10 , void * V_66 , unsigned int V_67 , int * V_8 ,
T_11 * * V_59 )
{
int V_68 ;
V_68 = F_58 ( V_66 , V_67 , V_10 ) ;
if ( V_68 < 0 || ( T_9 ) V_68 != V_67 ) {
* V_8 = F_55 ( V_10 , V_59 ) ;
if ( * V_8 == 0 && V_68 > 0 )
* V_8 = V_69 ;
return FALSE ;
...
T_1
F_59 ( T_17 V_10 , void * V_66 , unsigned int V_67 , int * V_8 ,
T_11 * * V_59 )
{
int V_68 ;
V_68 = F_58 ( V_66 , V_67 , V_10 ) ;
...
T_1
F_60 ( T_17 V_10 , T_18 * V_66 , T_9 V_70 , int * V_8 ,
T_11 * * V_59 )
{
F_61 ( V_66 , V_70 ) ;
V_71 = V_72 ;
return F_59 ( V_10 , F_62 ( V_66 ) , V_70 , V_8 ,
V_59 ) ;
}
T_6
F_63 ( T_7 * V_7 )
{
return F_64 ( V_7 -> V_10 ) ;
}
struct V_73 *
F_65 ( T_7 * V_7 )
{
...
F_66 ( T_7 * V_7 )
{
return F_62 ( V_7 -> V_41 ) ;
}
T_1
F_67 ( T_7 * V_7 , T_6 V_74 ,
struct V_73 * V_61 , T_18 * V_66 , int * V_8 , T_11 * * V_59 )
{
if ( ! V_7 -> V_75 ( V_7 , V_74 , V_61 , V_66 , V_8 , V_59 ) )
return FALSE ;
if ( V_61 -> V_65 > V_61 -> V_49 )
V_61 -> V_65 = V_61 -> V_49 ;
F_56 ( V_61 -> V_62 != V_34 ) ;
return TRUE ;
}
