...
if ( ! V_5 -> V_24 && ( V_2 % 8 ) ) {
T_2 V_30 = 8 - ( V_2 % 8 ) ;
F_25 ( V_4 , V_1 , V_2 , V_30 , L_12 , V_30 ) ;
V_2 += V_30 ;
}
return F_24 ( V_1 , V_2 , V_3 ,
V_4 , V_5 , V_6 , V_7 , V_8 ) ;
...
case V_17 :
if ( V_14 -> V_18 ) {
F_7 ( V_15 , 64 , L_13 V_31 L_14 , F_8 ( ( T_7 ) V_12 , ( const V_19 * ) V_14 -> V_18 , L_2 ) , V_12 ) ;
} else {
F_7 ( V_15 , 64 , L_15 V_31 L_16 , V_12 ) ;
}
break;
case V_20 :
if ( V_14 -> V_18 ) {
F_7 ( V_15 , 64 , L_17 V_31 L_18 , F_8 ( ( T_7 ) V_12 , ( const V_19 * ) V_14 -> V_18 , L_2 ) , V_12 ) ;
} else {
F_7 ( V_15 , 64 , L_19 V_31 L_20 , V_12 ) ;
}
break;
default:
F_9 ( L_6 ) ;
...
int
F_36 ( T_1 * V_1 , T_2 V_2 , T_3 * V_3 V_25 ,
T_4 * V_4 , T_5 * V_5 , T_6 * V_6 ,
int V_7 , T_16 * V_8 )
{
static T_16 V_32 ;
...
V_32 . V_33 = F_37 ( V_1 , V_2 , V_6 ) ;
F_38 ( V_1 , V_2 + 4 , V_6 , & V_32 . V_34 ) ;
if ( V_4 ) {
F_39 ( V_4 , V_7 , V_1 , V_2 , 20 , V_35 ) ;
}
if ( V_8 ) {
* V_8 = V_32 ;
}
