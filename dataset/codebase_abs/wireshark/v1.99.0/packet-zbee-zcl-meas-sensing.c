...
switch ( V_5 ) {
case V_7 :
F_3 ( T_6 , V_8 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_9 :
F_3 ( T_6 , V_10 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_11 :
...
static void
F_20 ( T_5 * T_6 , T_1 * T_2 , T_7 * V_2 )
{
F_3 ( T_6 , V_42 , T_2 , * V_2 , 2 , V_4 ) ;
}
static void
F_21 ( T_5 * T_6 , T_1 * T_2 , T_7 * V_2 , T_8 V_5 , T_7 V_6 )
{
switch ( V_5 ) {
case V_43 :
...
static void
F_29 ( T_5 * T_6 , T_1 * T_2 , T_7 * V_2 )
{
F_3 ( T_6 , V_62 , T_2 , * V_2 , 2 , V_4 ) ;
}
static void
F_30 ( T_5 * T_6 , T_1 * T_2 , T_7 * V_2 , T_8 V_5 , T_7 V_6 )
{
switch ( V_5 ) {
case V_63 :
F_3 ( T_6 , V_64 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_65 :
F_3 ( T_6 , V_66 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_67 :
F_3 ( T_6 , V_68 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_69 :
F_3 ( T_6 , V_70 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_71 :
F_3 ( T_6 , V_72 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_73 :
F_3 ( T_6 , V_74 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_75 :
F_3 ( T_6 , V_76 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_77 :
F_3 ( T_6 , V_78 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_79 :
...
static void
F_38 ( T_5 * T_6 , T_1 * T_2 , T_7 * V_2 )
{
F_3 ( T_6 , V_92 , T_2 , * V_2 , 2 , V_4 ) ;
}
static void
F_39 ( T_5 * T_6 , T_1 * T_2 , T_7 * V_2 , T_8 V_5 , T_7 V_6 )
{
switch ( V_5 ) {
case V_93 :
F_3 ( T_6 , V_94 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_95 :
F_3 ( T_6 , V_96 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_97 :
F_3 ( T_6 , V_98 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
case V_99 :
F_3 ( T_6 , V_100 , T_2 , * V_2 , 2 , V_4 ) ;
* V_2 += 2 ;
break;
default:
F_5 ( T_2 , T_6 , V_2 , V_6 ) ;
