...
if ( F_98 ( & V_57 , V_60 , V_71 , FALSE , & V_63 ) != V_72 ) {
* V_62 = F_99 ( V_63 ) ;
...
static T_22 * F_102 ( const T_10 * V_37 , const T_10 * V_75 , T_7 V_76 , T_7 * V_77 ) {
return ( T_22 * ) F_103 ( V_78 , V_37 , V_75 , V_76 , V_77 ) ;
}
static void F_104 ( T_22 * V_4 , float V_79 , const T_10 * V_75 ) {
F_105 ( ( V_80 * ) V_4 , V_79 , V_75 ) ;
}
...
T_24 * V_81 = ( T_24 * ) V_2 ;
V_81 -> V_82 ( V_81 -> V_83 ) ;
if ( V_81 -> V_84 ) F_95 ( & V_57 ) ;
}
static void F_111 ( const char * V_85 ,
T_25 V_86 ,
void (* V_82)( T_3 ) ,
T_3 V_83 ,
T_7 V_84 ) {
T_24 * V_81 = ( T_24 * ) F_11 ( sizeof( T_24 ) ) ;
