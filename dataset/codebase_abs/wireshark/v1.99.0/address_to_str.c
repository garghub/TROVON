...
F_34 ( V_4 , V_13 , L_6 , F_40 ( & V_25 [ 8 ] ) ,
F_39 ( & V_25 [ 0 ] ) , F_39 ( & V_25 [ 4 ] ) ) ;
}
}
static void
F_41 ( const T_2 * V_30 , T_1 * V_4 , int V_13 ) {
T_2 V_31 ;
T_9 V_32 ;
T_9 V_33 ;
T_7 V_34 ;
...
static void
F_42 ( const T_10 * V_23 , T_1 * V_4 , int V_13 ) {
if ( V_23 -> V_15 >= 16 ) {
#define F_43 ((int)(sizeof("GID: ") - 1))
F_34 ( V_4 , V_13 , L_8 ) ;
if ( V_13 < F_43 ||
F_44 ( V_35 , V_23 -> V_30 , V_4 + F_43 ,
V_13 - F_43 ) == NULL )
F_34 ( V_4 , V_13 , V_20 ) ;
} else {
T_9 V_36 ;
...
V_39 = ( T_1 * ) F_6 ( 512 ) ;
V_40 = F_48 ( V_39 , V_1 , 8 , ':' ) ;
V_37 = ( V_1 [ 0 ] & 0xF0 ) >> 4 ;
switch ( V_37 ) {
case V_41 :
case V_42 :
memcpy ( V_38 , & V_1 [ 2 ] , 6 ) ;
F_34 ( V_40 , 512 - 23 , L_10 , F_49 ( V_38 ) ) ;
break;
case V_43 :
...
T_1 *
F_50 ( T_3 * V_2 , const T_4 V_3 )
{
return F_47 ( F_4 ( V_2 , V_3 , 8 ) ) ;
}
const T_1 *
F_51 ( const T_2 * V_1 )
{
...
T_1 *
F_54 ( T_11 * V_45 , const T_10 * V_23 )
{
T_1 * V_8 ;
V_8 = ( T_1 * ) F_55 ( V_45 , V_46 ) ;
F_56 ( V_23 , V_8 , V_46 ) ;
return V_8 ;
}
T_1 *
F_53 ( const T_10 * V_23 )
{
T_1 * V_8 ;
V_8 = ( T_1 * ) F_6 ( V_46 ) ;
F_56 ( V_23 , V_8 , V_46 ) ;
...
void
F_56 ( const T_10 * V_23 , T_1 * V_4 , int V_13 )
{
const T_2 * V_47 ;
struct V_48 V_49 ;
T_9 V_50 ;
...
break;
case V_54 :
V_52 = F_48 ( V_52 , ( const T_2 * ) V_23 -> V_30 , 6 , ':' ) ;
break;
case V_55 :
...
V_52 = F_57 ( V_52 , & V_47 [ 0 ] , 4 ) ;
* V_52 ++ = '.' ;
V_52 = F_57 ( V_52 , & V_47 [ 4 ] , 6 ) ;
break;
case V_58 :
F_58 ( V_23 , V_4 , V_13 ) ;
break;
...
break;
case V_62 :
F_60 ( ( const T_2 * ) V_23 -> V_30 , V_23 -> V_15 , V_4 , V_13 ) ;
break;
case V_63 :
V_52 = F_15 ( V_52 , L_11 ) ;
V_52 = F_57 ( V_52 , ( const T_2 * ) V_23 -> V_30 , 1 ) ;
break;
case V_64 :
V_52 = F_48 ( V_52 , ( const T_2 * ) V_23 -> V_30 , 3 , '.' ) ;
break;
case V_65 :
F_61 ( ( const V_66 * ) V_23 -> V_30 , V_4 , V_13 ) ;
break;
case V_67 :
F_14 ( V_4 , ( const T_1 * ) V_23 -> V_30 , V_13 ) ;
break;
case V_68 :
V_52 = F_48 ( V_52 , ( const T_2 * ) V_23 -> V_30 , 8 , ':' ) ;
break;
case V_69 : {
...
break;
case V_71 :
F_41 ( ( const T_2 * ) V_23 -> V_30 , V_4 , V_13 ) ;
break;
case V_72 :
F_42 ( V_23 , V_4 , V_13 ) ;
break;
