...
V_87 -> V_28 = V_16 ;
} else if ( F_22 ( V_29 -> V_31 , L_39 ) == 0 ) {
V_87 -> V_28 = V_97 ;
} else {
printf ( L_40 , V_29 -> V_31 ) ;
F_34 ( V_87 ) ;
return NULL ;
}
if ( ( V_29 = F_26 ( V_32 -> V_35 , V_52 ) )
!= NULL ) {
T_2 * V_98 = F_20 ( V_29 -> V_31 , - 1 , L_41 ) ;
if ( V_98 == NULL ) {
printf ( L_42 ,
V_29 -> V_31 ) ;
F_34 ( V_87 ) ;
...
!= NULL ) {
V_31 -> V_101 = F_6 ( V_29 -> V_31 ) ;
}
if ( ( V_29 = F_26 ( V_32 -> V_35 , V_50 ) )
!= NULL ) {
V_31 -> V_100 = ( V_29 -> V_31 [ 0 ] == 't' || V_29 -> V_31 [ 0 ] == 'T' ) ;
}
...
while ( V_102 ) {
T_5 * V_103 = NULL ;
if ( ( V_103 = F_40 ( args , V_102 ) ) != NULL )
args = F_42 ( args , ( T_12 ) V_103 ) ;
V_102 = V_102 -> V_39 ;
}
return args ;
}
...
( * V_104 ) -> V_66 = F_6 ( V_29 -> V_31 ) ;
return 1 ;
}
int F_45 ( T_7 * V_102 ,
T_10 * * V_106 ) {
T_10 * V_107 = NULL , * V_108 = NULL ;
while ( V_102 ) {
T_10 * V_104 ;
if ( F_44 ( V_102 , & V_104 ) >= 0 && V_104 != NULL ) {
if ( V_107 == NULL ) {
V_107 = V_108 = V_104 ;
} else {
V_108 -> V_68 = V_104 ;
...
int F_46 ( T_7 * V_32 , T_11 * * V_109 ) {
T_6 * V_29 = NULL ;
T_17 V_90 = V_91 ;
* V_109 = NULL ;
if ( V_32 == NULL )
return - 1 ;
if ( F_22 ( V_32 -> V_34 , L_50 ) == 0 ) {
V_90 = V_110 ;
}
if ( V_90 == V_91 )
return - 1 ;
...
if ( sscanf ( V_29 -> V_31 , L_3 , & ( ( * V_109 ) -> V_70 ) ) != 1 ) {
printf ( L_52 ) ;
F_31 ( * V_109 ) ;
return - 1 ;
}
...
( * V_109 ) -> V_66 = F_6 ( V_29 -> V_31 ) ;
return 1 ;
}
int F_47 ( T_7 * V_102 , T_11 * * V_111 ) {
T_11 * V_112 = NULL , * V_113 = NULL ;
while ( V_102 ) {
T_11 * V_109 ;
if ( F_46 ( V_102 , & V_109 ) >= 0 && V_109 != NULL ) {
if ( V_112 == NULL ) {
V_112 = V_113 = V_109 ;
} else {
V_113 -> V_72 = V_109 ;
