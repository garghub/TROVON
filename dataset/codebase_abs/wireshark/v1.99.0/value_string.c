...
const T_1 *
F_19 ( const T_2 V_1 , T_7 * V_14 , T_4 * V_6 )
{
if ( V_14 ) {
const T_3 * V_2 = V_14 -> V_18 ( V_1 , V_14 ) ;
if ( V_2 ) {
...
const T_1 *
F_20 ( const T_2 V_1 , T_7 * V_14 , const char * V_3 )
{
const T_1 * V_4 ;
F_2 ( V_3 != NULL ) ;
V_4 = F_18 ( V_1 , V_14 ) ;
...
const T_3 *
V_19 ( const T_2 V_1 , T_7 * V_14 )
{
const T_3 * V_21 = V_14 -> V_15 ;
const T_8 V_25 = V_14 -> V_16 ;
enum { V_26 , V_27 , V_28 } type = V_28 ;
T_2 V_29 ;
T_8 V_30 ;
T_8 V_7 ;
F_2 ( ( V_21 [ V_25 ] . V_9 == 0 ) &&
...
if ( ( type == V_28 ) && ( V_21 [ V_7 ] . V_9 != ( V_7 + V_30 ) ) ) {
type = V_27 ;
}
if ( type == V_27 ) {
if ( V_29 > V_21 [ V_7 ] . V_9 ) {
F_26 ( L_1
L_2 ,
V_14 -> V_20 , V_7 , V_21 [ V_7 ] . V_9 , V_21 [ V_7 ] . V_9 , V_29 , V_29 ) ;
type = V_26 ;
break;
}
...
const T_1 *
F_31 ( const T_2 V_1 , const T_10 * V_31 , const char * V_3 )
{
const T_1 * V_4 = NULL ;
F_2 ( V_3 != NULL ) ;
V_4 = F_32 ( V_1 , V_31 ) ;
...
const T_1 *
F_33 ( const T_2 V_1 , const T_10 * V_31 ,
const char * V_5 )
{
const T_1 * V_4 = NULL ;
F_2 ( V_5 != NULL ) ;
...
const T_1 *
F_34 ( const T_2 V_1 , const T_10 * V_31 , T_4 * V_6 )
{
T_4 V_7 = 0 ;
if( V_31 ) {
while( V_31 [ V_7 ] . V_8 ) {
if( ( V_1 >= V_31 [ V_7 ] . V_32 ) && ( V_1 <= V_31 [ V_7 ] . V_33 ) ) {
* V_6 = V_7 ;
return ( V_31 [ V_7 ] . V_8 ) ;
}
V_7 ++ ;
...
const T_1 *
F_32 ( const T_2 V_1 , const T_10 * V_31 )
{
T_4 V_10 = 0 ;
return F_34 ( V_1 , V_31 , & V_10 ) ;
}
T_11
F_35 ( const T_7 * V_14 )
{
