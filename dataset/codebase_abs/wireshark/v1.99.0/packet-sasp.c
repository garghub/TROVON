...
static T_9 F_37 ( T_4 * V_2 , T_5 * V_10 , T_9 V_3 , T_5 * * V_72 )
{
T_7 * V_73 ;
T_5 * V_74 ;
T_10 V_75 ;
...
V_135 = F_26 ( V_74 , V_2 , V_3 , - 1 , V_137 , NULL , L_41 ) ;
F_6 ( V_135 , V_138 ,
V_2 , V_3 , 2 , V_23 ) ;
V_3 += 2 ;
F_6 ( V_135 , V_139 ,
...
V_2 , V_3 , 1 , V_23 ) ;
V_3 += 1 ;
F_42 ( V_142 , V_2 , V_3 , 1 , L_43 , NULL ,
V_152 , V_143 , V_23 , 0 ) ;
V_3 += 1 ;
F_6 ( V_142 , V_153 ,
V_2 , V_3 , 2 , V_23 ) ;
...
T_8 V_155 ;
T_8 V_34 ;
V_154 = F_26 ( V_10 , V_2 , V_3 , - 1 , V_156 , NULL , L_44 ) ;
F_6 ( V_154 , V_157 ,
V_2 , V_3 , 2 , V_23 ) ;
V_3 += 2 ;
F_6 ( V_154 , V_158 ,
...
V_2 , V_3 , 2 , V_23 ) ;
V_3 += 2 ;
V_3 = F_41 ( V_2 , V_154 , V_3 ) ;
for ( V_34 = 0 ; V_34 < V_155 ; V_34 ++ )
V_3 = F_45 ( V_2 , V_154 , V_3 ) ;
return V_3 ;
}
void F_46 ( void )
{
...
static T_16 V_191 [] = {
{ & V_21 , { L_244 , V_192 , V_193 , L_245 , V_194 } }
} ;
T_17 * V_195 ;
T_18 * V_196 ;
V_16 = F_48 ( L_246 , L_1 , L_247 ) ;
F_49 ( V_16 , V_160 , F_50 ( V_160 ) ) ;
F_51 ( V_188 , F_50 ( V_188 ) ) ;
V_196 = F_52 ( V_16 ) ;
F_53 ( V_196 , V_191 , F_50 ( V_191 ) ) ;
V_195 = F_54 ( V_16 , NULL ) ;
F_55 ( V_195 , L_248 ,
L_249 ,
L_250
L_251
...
{
T_19 V_197 ;
V_197 = F_57 ( F_24 , V_16 ) ;
F_58 ( L_255 , V_198 , V_197 ) ;
}
