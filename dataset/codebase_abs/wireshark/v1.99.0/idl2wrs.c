...
static const char *
F_11 ( const char * V_25 , const char * V_26 , const char * V_27 , const char * V_28 , const char * V_29 , const char * V_30 , const char * V_31 , const char * V_32 )
{
T_7 * V_23 ;
T_6 * V_22 ;
for( V_22 = V_20 ; V_22 ; V_22 = V_22 -> V_7 ) {
...
static void
F_13 ( const char * V_17 , const char * V_18 )
{
T_9 * V_37 ;
...
static T_11 *
F_17 ( const char * V_4 , const char * V_61 , const char * V_28 , const char * V_29 , const char * V_31 , const char * V_30 , int V_54 ) {
T_11 * V_62 ;
FPRINTF ( NULL , L_58 , V_4 , V_61 , V_28 , V_29 , V_31 , V_30 , V_54 ) ;
V_62 = ( T_11 * ) malloc ( sizeof( T_11 ) ) ;
V_62 -> V_7 = V_63 ;
V_62 -> V_4 = F_3 ( V_4 ) ;
V_62 -> V_64 = F_3 ( V_61 ) ;
V_62 -> V_28 = F_3 ( V_28 ) ;
...
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
V_91 = F_17 ( L_162 , V_61 , L_85 , L_79 , L_1 , L_87 , 4 ) ;
}
}
return V_91 ;
}
...
V_37 = V_37 -> V_7 ;
if( F_16 ( V_37 -> V_39 ) ) {
fprintf ( V_3 , L_168 , V_37 -> V_39 ) ;
Exit ( 10 ) ;
}
V_4 = V_37 -> V_39 ;
V_37 = V_37 -> V_7 ;
if( strcmp ( V_37 -> V_39 , L_169 ) ) {
fprintf ( V_3 , L_170 ) ;
Exit ( 10 ) ;
}
V_37 = V_37 -> V_7 ;
...
if( V_98 ) {
if( V_98 -> V_44 ) {
fprintf ( V_3 , L_177 , V_98 -> V_44 ) ;
Exit ( 10 ) ;
}
}
if( strcmp ( V_37 -> V_39 , L_178 ) ) {
fprintf ( V_3 , L_179 ) ;
Exit ( 10 ) ;
}
V_37 = V_37 -> V_7 ;
...
if( V_93 == 1 ) {
FPRINTF ( V_73 , L_184 , V_71 , V_94 ) ;
FPRINTF ( V_74 , L_185 , V_71 , V_94 ) ;
FPRINTF ( V_92 , L_186 , V_61 ) ;
FPRINTF ( V_75 , L_20 ) ;
FPRINTF ( V_75 , L_187 ) ;
FPRINTF ( V_75 , L_188 , V_61 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_189 ) ;
if( ! V_102 ) {
FPRINTF ( V_75 , L_190 ) ;
...
V_37 = V_37 -> V_7 ;
for( V_10 = 0 ; ! strcmp ( V_37 -> V_39 , L_201 ) ; V_37 = V_37 -> V_7 ) {
V_10 ++ ;
if( V_54 < 4 ) {
V_54 = 4 ;
}
...
sprintf ( V_104 , L_202 , V_100 ) ;
if( ! strcmp ( L_30 , V_37 -> V_39 ) ) {
V_100 = 0 ;
} else if( ! strcmp ( L_201 , V_37 -> V_39 ) ) {
V_11 = F_5 ( V_11 , V_10 + 1 ) ;
V_100 = 0 ;
V_101 = 1 ;
V_37 = V_37 -> V_7 ;
} else if( strcmp ( V_104 , V_37 -> V_39 ) ) {
fprintf ( V_3 , L_203 , V_94 , V_104 , V_37 -> V_39 ) ;
V_37 = V_37 -> V_7 ;
Exit ( 10 ) ;
} else {
V_37 = V_37 -> V_7 ;
...
sprintf ( V_97 , L_205 , V_71 , V_94 , V_99 ) ;
if( V_93 == 0 ) {
char V_27 [ 256 ] ;
const char * V_105 ;
sprintf ( V_95 , L_206 , V_71 , V_94 , V_99 ) ;
V_96 = F_3 ( V_95 ) ;
if( F_12 ( V_95 ) ) {
sprintf ( V_27 , L_207 , V_71 , V_94 , V_99 ) ;
V_105 = F_11 ( V_97 , V_99 , V_27 , V_43 -> V_28 , V_43 -> V_29 , V_43 -> V_65 , V_43 -> V_31 , L_81 ) ;
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_96 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_209 , F_4 ( V_96 ) ) ;
FPRINTF ( V_75 , L_210 , V_43 -> V_64 , V_105 ) ;
FPRINTF ( V_75 , L_211 ) ;
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
} else {
FPRINTF ( NULL , L_212 , V_95 ) ;
}
if( V_101 ) {
V_13 = V_11 -> type ;
V_11 = V_11 -> V_7 ;
sprintf ( V_95 , L_213 , V_13 , V_96 ) ;
if( F_12 ( V_95 ) ) {
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_95 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_214 , V_96 , F_6 ( V_13 ) , V_99 ) ;
FPRINTF ( V_75 , L_211 ) ;
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
} else {
...
sprintf ( V_95 , L_215 , V_96 ) ;
if( F_12 ( V_95 ) ) {
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_95 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_216 , V_100 ) ;
FPRINTF ( V_75 , L_217 ) ;
FPRINTF ( V_75 , L_218 , V_96 ) ;
FPRINTF ( V_75 , L_219 ) ;
FPRINTF ( V_75 , L_20 ) ;
FPRINTF ( V_75 , L_211 ) ;
FPRINTF ( V_75 , L_109 ) ;
...
break;
case V_55 :
sprintf ( V_95 , L_220 , V_96 ) ;
if( F_12 ( V_95 ) ) {
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_95 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_221 , V_96 ) ;
FPRINTF ( V_75 , L_211 ) ;
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
} else {
...
break;
case V_56 :
sprintf ( V_95 , L_222 , V_96 ) ;
if( F_12 ( V_95 ) ) {
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_95 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_223 , V_96 ) ;
FPRINTF ( V_75 , L_211 ) ;
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
} else {
...
break;
case V_55 | V_56 :
sprintf ( V_95 , L_224 , V_96 ) ;
if( F_12 ( V_95 ) ) {
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_95 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_225 , V_96 ) ;
FPRINTF ( V_75 , L_211 ) ;
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
} else {
...
FPRINTF ( V_75 , L_108 ) ;
FPRINTF ( V_75 , L_109 ) ;
F_17 ( V_94 , V_61 , L_230 , L_127 , L_1 , L_80 , V_54 ) ;
}
V_103:
FPRINTF ( NULL , L_231 , V_94 , V_93 ) ;
if( V_93 == 1 ) {
...
V_37 = V_37 -> V_7 ;
V_37 = V_37 -> V_7 ;
if( ! V_37 || strcmp ( V_37 -> V_39 , L_165 ) ) {
fprintf ( V_3 , L_233 ) ;
Exit ( 10 ) ;
}
V_37 = V_37 -> V_7 ;
...
V_106 = V_40 -> V_7 -> V_39 ;
sprintf ( V_61 , L_102 , V_71 , V_106 ) ;
FPRINTF ( NULL , L_241 , V_106 , V_93 ) ;
if( V_93 == 1 ) {
FPRINTF ( V_73 , L_184 , V_71 , V_106 ) ;
FPRINTF ( V_74 , L_185 , V_71 , V_106 ) ;
FPRINTF ( V_92 , L_186 , V_61 ) ;
FPRINTF ( V_75 , L_20 ) ;
FPRINTF ( V_75 , L_187 ) ;
FPRINTF ( V_75 , L_242 , V_61 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_189 ) ;
FPRINTF ( V_75 , L_190 ) ;
switch( V_54 ) {
...
V_4 = V_37 -> V_39 ;
V_37 = V_37 -> V_7 ;
sprintf ( V_107 , L_205 , V_71 , V_106 , V_4 ) ;
if( strcmp ( V_37 -> V_39 , L_169 ) ) {
fprintf ( V_3 , L_250 ) ;
Exit ( 10 ) ;
}
...
if( V_93 == 0 ) {
char V_27 [ 256 ] , V_109 [ 256 ] , V_110 [ 256 ] ;
sprintf ( V_27 , L_207 , V_71 , V_106 , V_4 ) ;
sprintf ( V_109 , L_202 , V_54 * 8 ) ;
sprintf ( V_110 , L_255 , V_4 ) ;
F_11 ( V_107 , V_4 , V_27 , L_256 , V_109 , V_110 , V_5 , L_81 ) ;
...
if( V_93 == 1 ) {
FPRINTF ( V_75 , L_260 , V_107 , V_54 , V_54 ) ;
...
switch( V_54 ) {
case 1 :
F_17 ( V_106 , V_61 , L_119 , L_86 , L_1 , L_80 , V_54 ) ;
break;
case 4 :
F_17 ( V_106 , V_61 , L_85 , L_86 , L_1 , L_80 , V_54 ) ;
break;
default:
fprintf ( V_3 , L_245 , V_54 ) ;
Exit ( 10 ) ;
...
V_112 = V_40 -> V_7 -> V_39 ;
sprintf ( V_61 , L_275 , V_71 , V_112 ) ;
FPRINTF ( NULL , L_276 , V_112 , V_93 ) ;
...
if( V_93 == 1 ) {
FPRINTF ( V_73 , L_184 , V_71 , V_112 ) ;
FPRINTF ( V_74 , L_185 , V_71 , V_112 ) ;
FPRINTF ( V_75 , L_20 ) ;
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_242 , V_61 ) ;
FPRINTF ( V_75 , L_106 ) ;
...
FPRINTF ( V_75 , L_195 ) ;
FPRINTF ( V_75 , L_196 ) ;
FPRINTF ( V_75 , L_280 , V_71 , V_112 , V_112 ) ;
FPRINTF ( V_75 , L_199 ) ;
FPRINTF ( V_75 , L_20 ) ;
switch( V_113 ) {
case 1 :
...
sprintf ( V_97 , L_290 , V_71 , V_112 , F_26 ( V_98 -> V_45 ) , V_37 -> V_39 ) ;
if( V_93 == 0 ) {
char V_27 [ 256 ] ;
const char * V_105 ;
sprintf ( V_95 , L_291 , V_71 , V_112 , F_26 ( V_98 -> V_45 ) , V_37 -> V_39 ) ;
V_96 = F_3 ( V_95 ) ;
sprintf ( V_27 , L_207 , V_71 , V_112 , V_37 -> V_39 ) ;
V_105 = F_11 ( V_97 , V_37 -> V_39 , V_27 , V_43 -> V_28 , V_43 -> V_29 , V_43 -> V_65 , V_43 -> V_31 , L_81 ) ;
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_96 ) ;
FPRINTF ( V_75 , L_106 ) ;
FPRINTF ( V_75 , L_292 , F_4 ( V_96 ) ) ;
FPRINTF ( V_75 , L_293 , V_43 -> V_64 , V_105 ) ;
FPRINTF ( V_75 , L_108 ) ;
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
while( V_10 -- ) {
sprintf ( V_95 , L_213 , V_96 , L_2 ) ;
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_95 ) ;
FPRINTF ( V_75 , L_106 ) ;
...
switch( V_113 ) {
case 2 :
F_17 ( V_112 , V_61 , L_78 , L_79 , L_1 , L_80 , V_54 ) ;
break;
case 4 :
F_17 ( V_112 , V_61 , L_85 , L_79 , L_1 , L_80 , V_54 ) ;
break;
default:
...
V_37 = V_37 -> V_7 ;
FPRINTF ( NULL , L_311 , V_115 , V_93 ) ;
if( V_93 == 0 ) {
FPRINTF ( V_117 , L_312 , V_116 , V_115 ) ;
FPRINTF ( V_117 , L_313 , V_71 , V_115 ) ;
FPRINTF ( V_117 , L_314 , V_71 , V_115 ) ;
V_116 ++ ;
}
if( ( V_93 == 1 ) || ( V_93 == 2 ) ) {
FPRINTF ( V_75 , L_20 ) ;
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_315 , V_71 , V_115 , ( V_93 == 1 ) ? L_316 : L_317 ) ;
FPRINTF ( V_75 , L_106 ) ;
}
V_51 = 0 ;
while( V_37 ) {
...
sprintf ( V_97 , L_205 , V_71 , V_115 , V_37 -> V_39 ) ;
if( V_93 == 0 ) {
char V_27 [ 256 ] ;
const char * V_105 ;
sprintf ( V_95 , L_206 , V_71 , V_115 , V_37 -> V_39 ) ;
V_96 = F_3 ( V_95 ) ;
sprintf ( V_27 , L_207 , V_71 , V_115 , V_37 -> V_39 ) ;
V_105 = F_11 ( V_97 , V_37 -> V_39 , V_27 , V_43 -> V_28 , V_43 -> V_29 , V_43 -> V_65 , V_43 -> V_31 , L_81 ) ;
FPRINTF ( V_75 , L_104 ) ;
FPRINTF ( V_75 , L_208 , V_96 ) ;
FPRINTF ( V_75 , L_106 ) ;
...
{
T_9 * V_37 ;
T_12 * V_118 , * V_119 , * V_120 ;
char * V_121 ;
long V_108 ;
int V_122 , V_123 ;
char V_61 [ 256 ] , V_30 [ 256 ] , V_124 [ 256 ] ;
V_123 = 16 ;
V_37 = V_38 ;
if( strcmp ( V_37 -> V_39 , L_175 ) ) {
fprintf ( V_3 , L_331 ) ;
...
if( ! strcmp ( V_37 -> V_39 , L_169 ) ) {
V_37 = V_37 -> V_7 ;
V_108 = strtol ( V_37 -> V_39 , & V_121 , 0 ) ;
if ( V_121 == V_37 -> V_39 || * V_121 ) {
fprintf ( V_3 , L_338 ) ;
Exit ( 10 ) ;
}
V_119 -> V_108 = V_108 ;
...
FPRINTF ( V_92 , L_20 ) ;
for( V_119 = V_118 ; V_119 ; V_119 = V_119 -> V_7 ) {
FPRINTF ( V_92 , L_343 , V_119 -> V_4 , V_119 -> V_108 ) ;
}
FPRINTF ( V_92 , L_20 ) ;
...
for( V_119 = V_118 ; V_119 ; V_119 = V_119 -> V_7 ) {
FPRINTF ( V_75 , L_346 , V_119 -> V_108 , V_119 -> V_4 ) ;
}
FPRINTF ( V_75 , L_347 ) ;
FPRINTF ( V_75 , L_95 ) ;
FPRINTF ( V_75 , L_20 ) ;
...
FPRINTF ( V_75 , L_109 ) ;
FPRINTF ( V_75 , L_20 ) ;
sprintf ( V_124 , L_349 , V_30 ) ;
switch( V_123 ) {
case 16 :
F_17 ( V_37 -> V_39 , V_61 , L_111 , L_79 , L_1 , V_124 , 2 ) ;
break;
case 32 :
F_17 ( V_37 -> V_39 , V_61 , L_116 , L_79 , L_1 , V_124 , 4 ) ;
break;
default:
fprintf ( V_3 , L_348 ) ;
Exit ( 10 ) ;
...
static void F_31 ( char * V_125 )
{
T_13 * V_126 ;
V_126 = ( T_13 * ) malloc ( sizeof( T_13 ) ) ;
V_126 -> V_7 = V_127 ;
V_127 = V_126 ;
V_126 -> V_4 = F_3 ( V_125 ) ;
}
...
T_13 * V_128 ;
T_14 V_129 ;
for( V_128 = V_127 ; V_128 ; V_128 = V_128 -> V_7 ) {
V_129 = strlen ( V_128 -> V_4 ) ;
for( V_37 = V_38 ; V_37 ; V_37 = V_37 -> V_7 ) {
if( ! strncmp ( V_37 -> V_39 , V_128 -> V_4 , V_129 ) ) {
V_37 -> V_39 += V_129 ;
}
}
}
}
static int Exit ( int V_130 )
{
fprintf ( V_3 , L_351 ) ;
F_18 ( 10 ) ;
exit ( V_130 ) ;
...
static void
F_34 ( const char * V_4 , T_1 * V_131 )
{
T_1 * V_132 ;
fprintf ( V_131 , L_353 , V_4 ) ;
V_132 = fopen ( V_4 , L_354 ) ;
while( ! feof ( V_132 ) ) {
int V_80 ;
V_80 = fgetc ( V_132 ) ;
if( V_80 != - 1 ) {
...
while( ! feof ( V_1 ) ) {
V_136 [ 0 ] = 0 ;
if( ! fgets ( V_136 , 1023 , V_1 ) || ! V_136 [ 0 ] ) {
continue;
}
if( V_136 [ 0 ] == '#' ) {
} else if( ! strncmp ( V_136 , L_357 , 6 ) ) {
T_8 * V_137 ;
char * V_39 , * V_4 ;
V_39 = V_136 + 6 ;
V_39 = F_35 ( V_39 , & V_4 ) ;
V_137 = ( T_8 * ) malloc ( sizeof( T_8 ) ) ;
V_137 -> V_7 = V_36 ;
V_36 = V_137 ;
V_137 -> V_4 = V_4 ;
FPRINTF ( NULL , L_358 , V_137 -> V_4 ) ;
} else if( ! strncmp ( V_136 , L_359 , 4 ) ) {
char * V_4 , * V_61 , * V_28 , * V_29 ;
char * V_31 , * V_30 , * V_138 ;
char * V_39 ;
int V_54 ;
V_39 = V_136 + 4 ;
V_39 = F_35 ( V_39 , & V_4 ) ;
...
} else if( ! strncmp ( V_136 , L_361 , 11 ) ) {
char * V_61 , * V_5 ;
char * V_39 ;
V_39 = V_136 + 11 ;
V_39 = F_35 ( V_39 , & V_61 ) ;
...
F_8 ( V_17 , V_18 ) ;
} else if( ! strncmp ( V_136 , L_367 , 14 ) ) {
char * V_112 , * V_139 ;
int V_53 ;
T_5 * V_14 ;
char * V_39 ;
V_39 = V_136 + 14 ;
V_39 = F_35 ( V_39 , & V_112 ) ;
V_39 = F_35 ( V_39 , & V_139 ) ;
V_53 = atoi ( V_139 ) ;
FPRINTF ( NULL , L_368 , V_112 , V_53 ) ;
V_14 = ( T_5 * ) malloc ( sizeof( T_5 ) ) ;
V_14 -> V_7 = V_15 ;
V_15 = V_14 ;
V_14 -> V_4 = F_3 ( V_112 ) ;
V_14 -> V_16 = V_53 ;
} else if( ! strncmp ( V_136 , L_369 , 12 ) ) {
char * V_125 ;
char * V_39 ;
V_39 = V_136 + 12 ;
V_39 = F_35 ( V_39 , & V_125 ) ;
FPRINTF ( NULL , L_370 , V_125 ) ;
F_31 ( V_125 ) ;
} else {
fprintf ( V_3 , L_371 , V_136 ) ;
exit ( 10 ) ;
}
}
}
int main ( int V_140 , char * V_141 [] )
{
char V_142 [ 256 ] ;
char V_143 [ 256 ] ;
char V_144 [ 256 ] ;
...
V_117 = fopen ( L_379 , L_373 ) ;
V_76 = fopen ( L_380 , L_373 ) ;
sprintf ( V_142 , L_381 , V_141 [ 1 ] ) ;
V_1 = fopen ( V_142 , L_354 ) ;
if( V_1 ) {
F_36 ( V_1 ) ;
fclose ( V_1 ) ;
}
sprintf ( V_142 , L_382 , V_141 [ 1 ] ) ;
V_1 = fopen ( V_142 , L_354 ) ;
if( ! V_1 ) {
fprintf ( V_3 , L_383 , V_142 ) ;
Exit ( 0 ) ;
}
V_90 = 0 ;
V_88 = 0 ;
...
if( ! strcmp ( V_40 -> V_39 , L_236 ) ) {
F_25 ( 0 ) ;
F_25 ( 1 ) ;
continue;
}
}
if( ! strcmp ( V_38 -> V_39 , L_162 )
...
sprintf ( V_143 , L_392 , V_141 [ 1 ] ) ;
V_145 = fopen ( V_143 , L_354 ) ;
if( ! V_145 ) {
fprintf ( V_3 , L_393 , V_143 ) ;
exit ( 10 ) ;
}
while( ! feof ( V_145 ) ) {
line [ 0 ] = 0 ;
if( ! fgets ( line , 1024 , V_145 ) || ! line [ 0 ] ) {
continue;
}
