...
T_30 V_257 = 0 ;
for ( V_174 = 0 ; V_174 < V_79 -> V_20 ; V_174 ++ ) {
V_259 = F_28 ( V_79 , int , V_174 ) ;
F_108 ( V_249 , V_259 ) ;
}
V_249 = F_103 ( V_249 , V_257 ) ;
return ( T_7 * ) F_31 ( V_249 , FALSE ) ;
...
F_79 ( V_271 , V_272 , F_7 ( L_42 ) , V_273 ? 1 : 0 ) ;
}
F_69 ( V_155 , V_271 ) ;
...
if( V_89 -> V_326 != NULL ) {
V_155 = F_64 ( V_154 , V_306 ) ;
F_69 ( V_155 , F_9 ( F_117 ( V_89 -> V_326 ) ) ) ;
}
F_115 ( V_154 , V_89 ) ;
switch( V_89 -> V_314 ) {
case ( V_317 ) :
V_155 = F_64 ( V_154 , V_327 ) ;
break;
case ( V_318 ) :
...
static void
F_114 ( T_5 V_154 , T_5 V_330 , V_170 V_222 , T_13 * V_89 ) {
T_5 V_155 ;
T_7 V_331 [ V_332 ] ;
if ( ! V_89 ) return;
switch( V_222 ) {
...
case ( V_334 << 16 ) | V_306 :
V_155 = F_64 ( V_154 , V_329 ) ;
F_65 ( V_155 , V_335 , 0 , 0 ) ;
break;
case ( V_248 << 16 ) | V_306 :
F_65 ( V_330 , V_336 , ( V_170 ) V_332 , ( V_85 ) V_331 ) ;
F_119 ( V_89 , F_18 ( V_331 ) ) ;
F_115 ( V_154 , V_89 ) ;
break;
case ( V_333 << 16 ) | V_321 :
if ( F_65 ( V_330 , V_157 , 0 , 0 ) == V_158 ) {
...
static T_25 T_26
V_95 ( T_5 V_337 , T_27 V_221 , V_170 V_222 , V_85 V_223 ) {
T_5 V_155 , V_57 ;
T_28 * V_224 = ( T_28 * ) V_223 ;
T_7 V_225 [ V_18 ] ;
switch( V_221 ) {
case V_226 :
if( V_22 != NULL ) {
V_155 = F_64 ( V_337 , V_227 ) ;
F_69 ( V_155 , F_9 ( V_22 ) ) ;
}
V_155 = F_64 ( V_337 , V_338 ) ;
F_65 ( V_155 , V_168 , TRUE , 0 ) ;
V_96 = V_97 ;
F_68 ( V_337 , NULL ) ;
break;
...
static T_25 T_26
V_104 ( T_5 V_341 , T_27 V_221 , V_170 V_222 , V_85 V_223 ) {
T_5 V_155 ;
T_28 * V_224 = ( T_28 * ) V_223 ;
T_1 V_342 ;
int V_174 , V_343 ;
...
case ( V_344 << 16 ) | V_161 :
default:
F_114 ( V_341 , V_155 , V_222 , & V_105 . V_89 ) ;
F_63 ( V_341 , & V_105 ) ;
break;
}
break;
...
break;
case V_345 :
V_343 = V_224 -> V_264 -> V_31 ;
if ( V_343 == 2 )
V_105 . V_106 = V_107 ;
else
V_105 . V_106 = V_346 ;
if ( V_343 == 3 || V_343 == 4 || V_343 == 5 || V_343 == 6 )
V_342 = FALSE ;
else
V_342 = TRUE ;
for ( V_174 = V_347 ; V_174 <= V_167 ; V_174 ++ ) {
V_155 = F_64 ( V_341 , V_174 ) ;
F_66 ( V_155 , V_342 ) ;
}
break;
case V_245 :
...
static T_25 T_26
V_137 ( T_5 V_341 , T_27 V_221 , V_170 V_222 , V_85 V_223 ) {
T_5 V_155 ;
V_11 * V_261 = ( V_11 * ) V_223 ;
T_7 V_349 [ V_272 ] ;
T_28 * V_224 = ( T_28 * ) V_223 ;
switch( V_221 ) {
case V_226 :
F_79 ( V_349 , V_272 , F_7 ( L_60 ) ,
V_261 -> V_84 , F_9 ( F_121 ( V_261 -> V_84 , L_1 , L_61 ) ) ) ;
V_155 = F_64 ( V_341 , V_350 ) ;
F_69 ( V_155 , V_349 ) ;
break;
case V_240 :
switch ( V_224 -> V_241 . V_242 ) {
...
static T_25 T_26
V_148 ( T_5 V_341 , T_27 V_221 , V_170 V_222 , V_85 V_223 ) {
T_5 V_155 ;
V_11 * V_261 = ( V_11 * ) V_223 ;
T_7 V_352 [ V_272 ] ;
T_28 * V_224 = ( T_28 * ) V_223 ;
switch( V_221 ) {
case V_226 :
F_79 ( V_352 , V_272 , F_7 ( L_62 ) ,
V_261 -> V_84 , F_9 ( F_121 ( V_261 -> V_84 , L_1 , L_61 ) ) ) ;
V_155 = F_64 ( V_341 , V_353 ) ;
F_69 ( V_155 , V_352 ) ;
break;
case V_240 :
switch ( V_224 -> V_241 . V_242 ) {
