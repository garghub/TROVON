...
V_12 = ( T_4 * ) F_4 ( V_18 ) ;
V_14 = F_5 ( V_13 ) ;
switch ( ( V_9 -> V_19 = F_6 ( V_9 , V_12 , V_14 ) ) )
{
case V_20 :
V_9 -> V_21 = V_22 ;
break;
...
if ( ( F_9 ( V_9 -> V_28 , 0 , V_29 , V_10 ) ) == - 1 )
{
* V_10 = F_10 ( V_9 -> V_28 , V_11 ) ;
F_7 ( V_12 ) ;
return 0 ;
}
if ( ! F_11 ( V_9 -> V_28 , V_12 , V_14 , V_10 , V_11 ) )
{
F_7 ( V_12 ) ;
if ( * V_10 != V_30 )
return - 1 ;
...
V_9 -> V_50 = V_51 ;
V_9 -> V_52 . V_53 . V_54 = V_15 -> V_46 ;
V_9 -> V_52 . V_53 . V_55 = 0 ;
* V_10 = 0 ;
return 1 ;
}
static T_2
F_6 ( T_3 * V_9 , T_4 * V_12 , T_6 V_56 )
{
T_4 * V_57 = V_12 ;
int V_58 ;
V_58 = F_13 ( V_57 , V_56 , V_9 -> V_28 ) ;
if ( V_58 == V_56 ) {
for ( ; V_56 > ( T_6 ) ( F_14 ( sizeof( V_59 ) , sizeof( V_60 ) ) ) ; V_57 ++ , V_56 -- )
{
#define F_15 ((nspr_signature_v10_t*)dp)
if ( ( F_16 ( & F_15 -> V_61 ) == V_62 ) &&
( F_16 ( & F_15 -> V_63 ) <= V_56 ) &&
( ( T_6 ) sizeof( V_59 ) <= V_56 ) &&
( ! F_17 ( F_15 -> V_64 ) ) )
return V_20 ;
#undef F_15
...
if ( ( F_18 -> V_65 == V_66 ) &&
( F_18 -> V_67 <= V_56 ) &&
( ( T_6 ) sizeof( V_60 ) <= V_56 ) )
{
if ( ! F_19 ( F_18 -> V_64 ) )
return V_23 ;
else if ( ! F_20 ( F_18 -> V_64 ) )
return V_25 ;
}
#undef F_18
}
...
if ( V_9 -> V_19 == V_20 )
return F_21 ( V_9 ) ;
else if ( V_9 -> V_19 == V_23 )
return F_22 ( V_9 ) ;
else if ( V_9 -> V_19 == V_25 )
return F_22 ( V_9 ) ;
return FALSE ;
}
static T_8 V_32 ( T_3 * V_9 , int * V_10 , T_4 * * V_11 , T_5 * V_69 )
{
T_7 * V_15 = ( T_7 * ) V_9 -> V_41 ;
T_1 V_49 = V_15 -> V_49 ;
T_4 * V_12 = V_15 -> V_42 ;
T_6 V_45 = V_15 -> V_45 ;
T_6 V_44 = V_15 -> V_44 ;
...
{
while ( ( V_45 < V_44 ) &&
( ( V_44 - V_45 ) >= ( ( T_6 ) sizeof( V_70 -> V_61 ) ) ) )
{
#define F_23 ( V_52 , type , T_11 ) \
...
V_45 = 0 ;
V_15 -> V_43 += V_44 ;
V_44 = F_5 ( ( V_15 -> V_13 - V_15 -> V_43 ) ) ;
}while( ( V_44 > 0 ) && ( V_58 = F_13 ( V_12 , V_44 , V_9 -> V_28 ) ) && ( V_58 == V_44 ) );
return FALSE ;
}
static T_8 V_35 ( T_3 * V_9 , int * V_10 , T_4 * * V_11 , T_5 * V_69 )
{
T_7 * V_15 = ( T_7 * ) V_9 -> V_41 ;
T_1 V_49 = V_15 -> V_49 ;
T_4 * V_12 = V_15 -> V_42 ;
...
{
while ( ( V_45 < V_44 ) &&
( ( V_44 - V_45 ) >= ( ( T_6 ) sizeof( ( ( V_78 * ) & V_12 [ V_45 ] ) -> V_79 ) ) ) )
{
switch ( ( ( V_78 * ) & V_12 [ V_45 ] ) -> V_79 )
{
#define F_23 ( V_52 , type , T_11 ) \
case NSPR_PDPKTRACEFULLTX_V##type:\
case NSPR_PDPKTRACEFULLTXB_V##type:\
...
#define F_29 ( V_52 , type , T_11 ) \
case NSPR_PDPKTRACEPARTTX_V##type:\
case NSPR_PDPKTRACEPARTTXB_V##type:\
case NSPR_PDPKTRACEPARTRX_V##type:\
case NSPR_PDPKTRACEPARTNEWRX_V##type:\
PACKET_DESCRIBE(phdr,TIMEDEF,PPSIZEDEFV,type,v##type##_part,pp,pktracepart_v##type,acttype);
F_23 ( & V_9 -> V_52 , 20 , 200 ) ;
F_24 ( & V_9 -> V_52 , 20 , 200 ) ;
F_23 ( & V_9 -> V_52 , 21 , 201 ) ;
F_24 ( & V_9 -> V_52 , 21 , 201 ) ;
F_23 ( & V_9 -> V_52 , 22 , 202 ) ;
F_24 ( & V_9 -> V_52 , 22 , 202 ) ;
F_23 ( & V_9 -> V_52 , 23 , 203 ) ;
F_24 ( & V_9 -> V_52 , 23 , 203 ) ;
F_28 ( & V_9 -> V_52 , 24 , 204 ) ;
F_29 ( & V_9 -> V_52 , 24 , 204 ) ;
F_28 ( & V_9 -> V_52 , 25 , 205 ) ;
F_29 ( & V_9 -> V_52 , 25 , 205 ) ;
F_28 ( & V_9 -> V_52 , 26 , 206 ) ;
F_29 ( & V_9 -> V_52 , 26 , 206 ) ;
#undef F_23
#undef F_28
#undef F_24
#undef F_29
...
switch ( V_90 -> V_79 )
{
#define F_31 ( V_52 , type , T_11 ) \
case NSPR_PDPKTRACEFULLTX_V##type:\
case NSPR_PDPKTRACEFULLTXB_V##type:\
case NSPR_PDPKTRACEFULLRX_V##type:\
case NSPR_PDPKTRACEFULLNEWRX_V##type:\
PACKET_DESCRIBE(phdr, TIMEDEF, FPSIZEDEFV,type,v##type##_full,fp,pktracefull_v##type,acttype);
F_31 ( & V_9 -> V_52 , 30 , 300 ) ;
#undef F_31
case V_80 :
{
V_45 += F_30 ( V_90 ) ;
F_25 ( V_15 , F_26 ( & ( ( V_82 * ) & V_12 [ V_45 ] ) -> V_74 ) , F_16 ( & ( ( V_82 * ) & V_12 [ V_45 ] ) -> V_75 ) ) ;
break;
}
case V_83 :
{
F_27 ( V_15 , F_16 ( & ( ( V_82 * ) & V_12 [ V_45 ] ) -> V_75 ) ) ;
V_45 += F_30 ( V_90 ) ;
break;
}
default:
...
static T_8 V_34 ( T_3 * V_9 , T_5 V_91 ,
struct V_92 * V_52 , T_14 * V_93 , int * V_10 , T_4 * * V_11 )
{
T_15 V_94 ;
T_16 V_95 ;
T_13 * V_96 ;
...
T_10 * V_71 ;
* V_10 = 0 ;
if ( F_9 ( V_9 -> V_98 , V_91 , V_29 , V_10 ) == - 1 )
return FALSE ;
if ( ! F_11 ( V_9 -> V_98 , ( void * ) & V_94 , sizeof V_94 ,
V_10 , V_11 ) )
return FALSE ;
V_95 = F_32 ( & V_94 ) ;
F_33 ( V_93 , V_95 ) ;
...
if ( ! F_11 ( V_9 -> V_98 , V_96 + sizeof V_94 , V_97 ,
V_10 , V_11 ) )
return FALSE ;
}
#define F_23 ( V_52 , type , T_11 ) \
...
if ( F_9 ( V_9 -> V_98 , V_91 , V_29 , V_10 ) == - 1 )
return FALSE ;
if ( ! F_11 ( V_9 -> V_98 , ( void * ) & V_94 , 2 , V_10 , V_11 ) )
return FALSE ;
V_101 = 2 ;
if ( V_94 . V_102 & V_103 ) {
if ( ! F_11 ( V_9 -> V_98 , ( void * ) & V_94 . V_104 , 1 ,
V_10 , V_11 ) )
return FALSE ;
V_101 = 3 ;
}
...
if ( ! F_11 ( V_9 -> V_98 , V_96 + V_101 , V_97 ,
V_10 , V_11 ) )
return FALSE ;
}
#define F_23 ( V_52 , type , T_11 ) \
...
memset ( V_115 . V_64 , 0 , V_119 ) ;
F_41 ( V_115 . V_64 , V_59 , V_119 ) ;
if ( ! F_42 ( V_107 , & V_115 , V_117 ,
V_10 ) )
return FALSE ;
V_15 -> V_111 += ( T_19 ) V_117 ;
} else if ( V_107 -> V_19 == V_23 )
{
T_21 V_120 ;
V_120 . V_65 = V_66 ;
V_120 . V_67 = V_121 ;
memcpy ( V_120 . V_64 , V_60 , sizeof( V_60 ) ) ;
if ( ! F_42 ( V_107 , & V_120 , V_120 . V_67 ,
V_10 ) )
return FALSE ;
V_15 -> V_111 += ( T_19 ) V_120 . V_67 ;
} else if ( V_107 -> V_19 == V_25 )
{
T_22 V_122 ;
V_122 . V_65 = V_123 ;
V_122 . V_67 = V_124 ;
memcpy ( V_122 . V_64 , V_125 , sizeof( V_125 ) ) ;
if ( ! F_42 ( V_107 , & V_122 , V_122 . V_67 ,
V_10 ) )
return FALSE ;
V_15 -> V_111 += ( T_19 ) V_122 . V_67 ;
} else
{
F_43 () ;
return FALSE ;
...
static T_8
F_44 ( T_17 * V_107 , const struct V_92 * V_52 ,
...
V_128 = F_45 ( ( T_2 ) V_52 -> V_53 . V_54 - ( T_2 ) ( V_49 / 1000000000 ) ) ;
...
static T_8 V_110 ( T_17 * V_107 , const struct V_92 * V_52 ,
const T_13 * V_96 , int * V_10 )
{
T_18 * V_15 = ( T_18 * ) V_107 -> V_41 ;
if ( V_52 -> V_136 != V_137 ) {
...
switch ( V_52 -> V_139 . V_140 . V_136 )
{
case V_141 :
if ( V_107 -> V_19 == V_20 )
{
if ( V_15 -> V_111 + V_52 -> V_142 >= V_15 -> V_112 )
{
...
if ( ! F_42 ( V_107 , V_96 , V_52 -> V_142 , V_10 ) )
return FALSE ;
V_15 -> V_111 += ( T_19 ) V_52 -> V_142 ;
} else if ( V_107 -> V_19 == V_23 )
{
* V_10 = V_144 ;
return FALSE ;
