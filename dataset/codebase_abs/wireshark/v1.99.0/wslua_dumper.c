...
V_42 . V_46 = V_47 ;
V_42 . V_48 = V_49 ;
V_42 . V_43 . V_50 = ( unsigned int ) ( floor ( V_43 ) ) ;
V_42 . V_43 . V_51 = ( unsigned int ) ( floor ( ( V_43 - ( double ) V_42 . V_43 . V_50 ) * 1000000000 ) ) ;
V_42 . V_52 = V_40 -> V_52 ;
V_42 . V_53 = V_40 -> V_52 ;
V_42 . V_54 = F_54 ( V_29 ) ;
V_42 . V_55 = * V_2 -> V_5 ;
if ( ! F_55 ( V_29 , & V_42 , V_40 -> V_56 , & V_34 ) ) {
F_31 ( V_1 , L_9 ,
F_34 ( V_34 ) ) ;
}
return 0 ;
...
V_62 = (struct V_61 * ) ( V_57 -> V_62 -> V_56 ) ;
if ( ! V_62 )
return 0 ;
V_60 = F_59 ( V_62 ) ;
memset ( & V_42 , 0 , sizeof( V_42 ) ) ;
V_42 . V_46 = V_47 ;
V_42 . V_48 = V_49 | V_63 ;
V_42 . V_43 . V_50 = V_57 -> V_58 -> V_64 . V_50 ;
V_42 . V_43 . V_51 = V_57 -> V_58 -> V_64 . V_51 ;
V_42 . V_52 = F_60 ( V_60 ) ;
V_42 . V_53 = F_61 ( V_60 ) ;
V_42 . V_54 = V_57 -> V_58 -> V_59 ;
V_42 . V_55 = * V_57 -> V_55 ;
if ( V_57 -> V_65 )
V_42 . V_66 = F_62 ( F_63 () , V_57 -> V_65 ) ;
V_56 = ( const T_7 * ) F_64 ( F_63 () , V_60 , 0 , V_42 . V_53 ) ;
if ( ! F_55 ( V_29 , & V_42 , V_56 , & V_34 ) ) {
F_31 ( V_1 , L_9 ,
F_34 ( V_34 ) ) ;
}
return 0 ;
