...
static int
F_9 ( T_1 * T_2 , T_3 * T_4 V_1 , T_5 * T_6 )
{
int V_2 ;
if ( F_3 ( T_2 ) < 16 ) {
return 0 ;
...
static int
F_13 ( T_1 * T_2 , T_3 * T_4 V_1 , T_5 * T_6 )
{
int V_2 ;
if ( F_3 ( T_2 ) < 20 ) {
return 0 ;
...
static int
F_16 ( T_1 * T_2 , T_3 * T_4 V_1 , T_5 * T_6 )
{
int V_2 ;
if ( F_3 ( T_2 ) < 20 ) {
return 0 ;
...
static int
F_42 ( T_1 * T_2 , T_3 * T_4 , T_5 * T_6 , void * T_9 V_1 )
{
T_7 * V_6 ;
T_5 * V_70 ;
T_8 V_58 ;
...
return 0 ;
F_43 ( T_4 -> V_8 , V_74 , L_3 ) ;
F_44 ( T_4 -> V_8 , V_9 ,
F_45 ( V_58 , V_75 , L_4 ) ) ;
if ( T_6 ) {
V_6 = F_7 ( T_6 , V_76 , T_2 , 0 , - 1 ,
V_19 ) ;
V_70 = F_8 ( V_6 , V_77 ) ;
F_7 ( V_70 , V_78 , T_2 ,
0 , 4 , V_11 ) ;
