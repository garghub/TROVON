...
const T_3 * V_38 = F_32 ( F_28 () , V_26 , F_33 ( V_25 , V_31 ) , 0 ) ;
if ( V_25 <= V_31 )
{
V_61 = L_9 ;
V_62 = L_8 ;
...
F_42 ( T_10 -> V_100 , V_101 , L_36 ) ;
F_42 ( T_10 -> V_100 , V_101 ,
F_4 ( V_96 , V_102 , L_37 ) ) ;
if ( V_96 == V_98 || V_96 == V_99 )
{
F_42 ( T_10 -> V_100 , V_101 , L_38 ) ;
F_42 ( T_10 -> V_100 , V_101 ,
F_43 ( V_97 , & V_103 , L_39 ) ) ;
}
F_42 ( T_10 -> V_100 , V_101 , L_40 ) ;
{
T_6 * V_104 ;
T_7 * V_46 ;
T_11 V_105 ;
...
F_10 ( V_46 , L_42 ) ;
V_106 = F_45 ( V_13 , V_16 , V_25 ,
F_46 ( V_13 , V_16 ) ) ;
V_105 = F_47 ( T_10 -> V_100 ) ;
F_48 ( T_10 -> V_100 , FALSE ) ;
F_49 ( V_108 , V_106 , T_10 , V_104 ) ;
F_48 ( T_10 -> V_100 , V_105 ) ;
}
return;
}
case V_109 :
...
V_13 , V_16 , V_25 , V_48 ) ;
F_36 ( V_46 ) ;
V_111 = F_50 ( V_13 , V_16 ) ;
V_112 = F_51 ( V_111 , & V_114 , L_2 ) ;
F_24 (
V_110 , V_10 -> V_115 ,
V_13 , V_16 , 3 , V_111 ,
L_43 , V_112 , V_111 ) ;
...
const V_22 * V_26 = F_17 ( V_13 , V_16 , V_25 ) ;
const T_3 * V_38 =
F_32 ( F_28 () , V_26 , F_33 ( V_25 , V_31 ) , 0 ) ;
if ( V_25 <= V_31 )
{
V_61 = L_22 ;
V_62 = L_44 ;
...
T_7 * V_121 ;
T_12 V_122 = F_33 (
( T_12 ) ( 4 + V_25 + V_120 ) , F_46 ( V_13 , V_16 ) ) ;
V_15 = F_30 (
V_14 , V_10 -> V_123 ,
V_13 , V_16 , V_122 , V_48 ) ;
F_44 ( V_15 , L_47 , V_10 -> V_36 ) ;
if ( V_10 -> V_33 == V_117 )
{
F_10 ( V_15 , L_48 , type ) ;
}
...
else if ( F_46 ( V_13 , V_16 ) > 0 )
{
T_5 * V_129 ;
V_129 = F_45 (
V_13 , V_16 ,
F_33 ( V_25 , F_46 ( V_13 , V_16 ) ) ,
V_25 ) ;
F_52 ( V_129 , T_10 , V_119 ) ;
}
else
{
F_55 ( V_13 , V_16 , V_25 + V_120 ) ;
}
}
else
{
...
{
T_5 * V_129 ;
V_129 = F_58 ( V_13 , V_16 ) ;
V_16 += F_52 ( V_129 , T_10 , V_14 ) ;
}
F_59 ( T_10 -> V_100 , V_101 , L_54 , V_132 ) ;
if ( V_134 )
{
F_59 ( T_10 -> V_100 , V_101 , L_55 , V_133 ) ;
}
else
{
F_59 ( T_10 -> V_100 , V_101 , L_56 , V_133 ) ;
}
return V_16 ;
}
static const T_3 *
...
#endif
if ( F_62 ( V_13 , 0 , 1 ) && F_23 ( V_13 , 0 ) != 1 )
{
return 0 ;
}
F_63 ( T_10 -> V_100 , V_155 , L_57 ) ;
F_64 ( T_10 -> V_100 , V_101 ) ;
V_16 = 0 ;
if ( V_2 == NULL )
{
F_65 ( NULL ) ;
...
for ( V_47 = 0 ; V_47 < F_66 ( V_171 ) ; ++ V_47 )
{
V_26 = & V_171 [ V_47 ] ;
if ( V_151 == V_26 -> V_151 )
{
...
V_154 = V_26 ? F_60 ( 0x1f & V_150 , V_26 -> V_172 , V_7 ) : V_146 ;
if ( V_154 == NULL )
{
V_154 = V_146 ;
}
...
{
F_53 ( T_10 , V_46 , & V_173 ,
L_69 ,
0x1f & V_150 ) ;
}
F_67 ( T_10 -> V_100 , V_101 , V_154 ) ;
V_16 += 1 ;
V_25 = F_25 ( V_13 , V_16 ) ;
if ( V_14 )
{
F_68 (
V_147 , F_69 ( V_157 , V_25 ) ) ;
V_46 = F_54 (
V_148 , V_174 ,
V_13 , V_16 , 2 , V_25 ) ;
}
...
break;
case V_69 :
V_188 = F_76 ( L_73 , V_3 -> type ) ;
break;
case V_124 :
V_188 = F_76 ( L_74 , V_3 -> type ) ;
break;
case V_43 :
V_188 = F_76 ( L_75 , V_3 -> type ) ;
break;
default:
V_188 = F_76 ( L_76 , V_3 -> type ) ;
break;
}
F_72 (
& V_3 -> V_123 , V_36 , V_181 , V_189 , V_190 , V_188 ) ;
V_36 = F_75 ( L_25 ) ;
V_181 = F_71 ( F_76 ( L_77 , V_3 -> V_36 ) ) ;
V_184 = F_76 ( L_78 , V_3 -> type ) ;
switch ( V_3 -> V_33 )
{
case V_117 :
F_77 ( V_184 ) ;
...
V_187 . V_185 =
F_83 ( FALSE , TRUE , sizeof( T_17 ) ) ;
F_84 (
V_187 . V_185 , V_205 , F_66 ( V_205 ) ) ;
V_187 . V_215 =
F_83 ( FALSE , TRUE , sizeof( T_12 * ) ) ;
F_84 (
V_187 . V_215 , V_206 , F_66 ( V_206 ) ) ;
if ( V_2 )
{
T_1 * V_3 ;
for ( V_3 = V_2 -> V_4 ; V_3 ; V_3 = V_3 -> V_5 )
...
{
T_21 * V_216 ;
T_22 * V_217 = F_83 ( TRUE , TRUE , sizeof( V_218 ) ) ;
