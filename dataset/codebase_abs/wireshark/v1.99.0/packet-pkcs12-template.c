...
F_45 ( & V_72 , V_73 , TRUE , V_61 ) ;
V_69 = F_41 ( V_63 ) ;
F_49 ( FALSE , V_63 , V_69 , & V_72 , V_1 , V_76 ) ;
}
...
F_45 ( & V_72 , V_73 , TRUE , V_61 ) ;
if( ( V_69 = F_41 ( V_63 ) ) > 0 )
F_51 ( FALSE , V_63 , V_69 , & V_72 , V_1 , V_77 ) ;
else
F_47 ( V_1 , V_61 , & V_75 , V_63 , 0 , 1 ) ;
}
void F_52 ( void ) {
...
static T_19 V_83 [] = {
{ & V_75 , { L_11 , V_84 , V_85 , L_12 , V_86 } } ,
} ;
T_20 * V_87 ;
T_21 * V_88 ;
V_89 = F_53 ( V_90 , V_91 , V_92 ) ;
F_54 ( V_89 , V_78 , F_55 ( V_78 ) ) ;
F_56 ( V_82 , F_55 ( V_82 ) ) ;
V_88 = F_57 ( V_89 ) ;
F_58 ( V_88 , V_83 , F_55 ( V_83 ) ) ;
V_87 = F_59 ( V_89 , NULL ) ;
F_60 ( V_87 , L_13 ,
L_14 ,
L_15
