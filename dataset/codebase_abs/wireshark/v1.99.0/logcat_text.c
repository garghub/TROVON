...
T_11 * T_14 V_71 ) {
* T_14 = F_10 ( V_70 -> V_48 ) ;
return F_6 ( V_70 -> V_48 , & V_70 -> V_33 , V_70 -> V_72 ,
V_70 -> V_73 ) ;
}
static T_7 F_16 ( T_12 * V_70 , T_11 V_74 ,
struct V_32 * V_33 , T_9 * V_49 , int * V_62 V_71 , T_1 * * T_13 V_71 ) {
if ( F_12 ( V_70 -> V_75 , V_74 , V_64 , V_62 ) == - 1 )
return FALSE ;
if ( ! F_6 ( V_70 -> V_75 , V_33 , V_49 ,
V_70 -> V_73 ) ) {
if ( * V_62 == 0 )
* V_62 = V_76 ;
return FALSE ;
...
int F_17 ( T_12 * V_70 , int * V_62 , T_1 * * T_13 V_71 ) {
T_1 V_51 [ V_52 ] ;
T_1 * V_53 = NULL ;
...
V_59 ) ) );
if ( F_9 ( V_77 , V_51 , ( V_56 ) ( ( T_3 ) V_57 | ( T_3 ) V_58 ) ,
V_59 ) ) {
V_70 -> V_73 = V_78 ;
V_70 -> V_79 = V_25 ;
} else if ( F_9 ( V_80 , V_51 , ( V_56 ) ( ( T_3 ) V_57 | ( T_3 ) V_58 ) ,
V_59 ) ) {
V_70 -> V_73 = V_81 ;
V_70 -> V_79 = V_27 ;
...
V_70 -> V_73 = V_68 ;
V_70 -> V_79 = V_29 ;
} else if ( F_9 ( V_85 , V_51 , ( V_56 ) ( ( T_3 ) V_57 | ( T_3 ) V_58 ) ,
V_59 ) ) {
V_70 -> V_73 = V_86 ;
V_70 -> V_79 = V_28 ;
...
V_70 -> V_73 = V_69 ;
V_70 -> V_79 = V_30 ;
} else if ( F_9 ( V_88 , V_51 , ( V_56 ) ( ( T_3 ) V_57 | ( T_3 ) V_58 ) ,
V_59 ) ) {
V_70 -> V_73 = V_54 ;
V_70 -> V_79 = V_31 ;
} else {
...
static T_7 F_25 ( T_15 * V_100 ,
const struct V_32 * V_33 ,
const T_2 * V_3 , int * V_62 )
{
T_1 * V_49 ;
T_3 V_101 ;
T_1 V_1 ;
...
T_1 * V_106 ;
T_3 V_107 ;
const struct V_16 * V_17 = ( const struct V_16 * ) V_100 -> V_108 ;
if ( V_33 -> V_65 != V_66 ) {
* V_62 = V_109 ;
return FALSE ;
}
...
const union V_111 * V_112 = & V_33 -> V_112 ;
V_107 = V_112 -> V_113 . V_8 ;
}
V_5 = ( const struct V_4 * ) ( const void * ) V_3 ;
V_7 = ( const struct V_6 * ) ( const void * ) V_3 ;
V_102 = F_27 ( V_5 -> V_13 ) ;
...
V_21 = F_27 ( V_5 -> V_21 ) ;
V_18 = F_27 ( V_5 -> V_114 ) ;
V_19 = F_27 ( V_5 -> V_115 ) / 1000000 ;
if ( V_107 == 1 ) {
V_9 = ( const T_2 * ) ( V_5 + 1 ) ;
V_1 = F_1 ( V_9 [ 0 ] ) ;
V_22 = V_9 + 1 ;
V_104 = 1 + ( T_3 ) strlen ( V_22 ) + 1 ;
V_103 = V_9 + V_104 ;
} else if ( V_107 == 2 ) {
V_9 = ( const T_2 * ) ( V_7 + 1 ) ;
V_1 = F_1 ( V_9 [ 0 ] ) ;
...
V_49 = F_3 ( V_17 , V_18 , V_19 , V_20 , V_21 , V_1 , V_22 , V_105 ) ;
if ( ! V_49 ) {
F_29 ( log ) ;
return FALSE ;
}
V_101 = ( T_5 ) strlen ( V_49 ) ;
if ( ! F_30 ( V_100 , V_49 , V_101 , V_62 ) ) {
F_29 ( log ) ;
return FALSE ;
}
V_100 -> V_117 += V_101 ;
...
case V_30 :
case V_31 :
if ( V_17 -> type == V_100 -> V_94 ) {
if ( ! F_30 ( V_100 , ( const T_1 * ) V_3 , V_33 -> V_67 , V_62 ) ) {
return FALSE ;
}
} else {
* V_62 = V_118 ;
...
static T_7 F_31 ( T_15 * V_100 , T_17 V_119 , int * V_62 V_71 ) {
struct V_16 * V_17 ;
...
T_7 F_33 ( T_15 * V_100 , int * V_62 ) {
return F_31 ( V_100 , V_25 , V_62 ) ;
}
T_7 F_34 ( T_15 * V_100 , int * V_62 ) {
return F_31 ( V_100 , V_26 , V_62 ) ;
}
T_7 F_35 ( T_15 * V_100 , int * V_62 ) {
return F_31 ( V_100 , V_27 , V_62 ) ;
}
T_7 F_36 ( T_15 * V_100 , int * V_62 ) {
return F_31 ( V_100 , V_29 , V_62 ) ;
}
T_7 F_37 ( T_15 * V_100 , int * V_62 ) {
return F_31 ( V_100 , V_28 , V_62 ) ;
}
T_7 F_38 ( T_15 * V_100 , int * V_62 ) {
return F_31 ( V_100 , V_30 , V_62 ) ;
}
T_7 F_39 ( T_15 * V_100 , int * V_62 ) {
return F_31 ( V_100 , V_31 , V_62 ) ;
}
