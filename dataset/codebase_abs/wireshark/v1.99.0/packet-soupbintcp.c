...
sizeof( struct V_10 ) ) ;
V_10 -> V_32 = V_19 ;
F_20 ( F_16 () , V_7 , V_31 , 0 , V_10 ) ;
}
} else {
V_10 = (struct V_10 * ) F_21 ( F_16 () , V_7 , V_31 , 0 ) ;
if ( V_10 ) {
V_19 = V_10 -> V_32 ;
} else {
V_19 = 0 ;
...
F_23 ( V_14 ,
V_38 ,
V_6 , V_18 , V_16 - 1 , V_25 | V_33 ) ;
break;
case 'A' :
F_23 ( V_14 ,
V_39 ,
V_6 , V_18 , 10 , V_25 | V_33 ) ;
V_18 += 10 ;
V_12 = F_11 ( F_12 () , V_6 , V_18 , 20 , V_25 ) ;
F_26 ( V_14 ,
V_40 ,
V_6 , V_18 , 20 ,
L_8 , L_9 , atoi ( V_12 ) ) ;
