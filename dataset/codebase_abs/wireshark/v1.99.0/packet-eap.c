...
static void
F_11 ( T_1 * V_1 , T_2 * V_2 , int V_3 , T_3 V_4 )
{
T_3 V_14 = V_4 ;
...
type ) ;
V_43 = F_14 ( V_42 , V_48 ) ;
F_15 ( V_43 , V_49 , V_2 , V_44 , 1 , type ) ;
V_44 += 1 ;
V_45 -= 1 ;
if ( V_45 <= 0 )
break;
...
type ) ;
V_43 = F_14 ( V_42 , V_55 ) ;
F_15 ( V_43 , V_56 , V_2 , V_44 , 1 , type ) ;
V_44 += 1 ;
V_45 -= 1 ;
if ( V_45 <= 0 )
break;
...
static int
F_17 ( T_2 * V_2 , T_4 * V_5 , T_1 * V_59 , void * T_8 V_60 )
{
T_7 V_61 ;
T_9 V_62 ;
T_7 V_63 ;
...
T_1 * V_70 = NULL ;
T_6 * V_71 = NULL ;
F_18 ( V_5 -> V_72 , V_73 , L_4 ) ;
F_19 ( V_5 -> V_72 , V_74 ) ;
V_61 = F_8 ( V_2 , 0 ) ;
F_20 ( V_5 -> V_72 , V_74 ,
F_21 ( V_61 , V_75 , L_5 ) ) ;
if ( V_5 -> V_76 == V_5 -> V_77 ) {
V_65 = F_22 ( V_5 -> V_78 -> V_79 , & V_5 -> V_80 , & V_5 -> V_81 ,
V_5 -> V_82 , V_5 -> V_76 ,
0 , V_83 ) ;
} else {
V_65 = F_22 ( V_5 -> V_78 -> V_79 , & V_5 -> V_81 , & V_5 -> V_80 ,
V_5 -> V_82 , V_5 -> V_84 ,
0 , V_83 ) ;
}
if ( V_65 == NULL ) {
if ( V_5 -> V_76 == V_5 -> V_77 ) {
V_65 = F_23 ( V_5 -> V_78 -> V_79 , & V_5 -> V_80 , & V_5 -> V_81 ,
V_5 -> V_82 , V_5 -> V_76 ,
0 , V_85 ) ;
} else {
V_65 = F_23 ( V_5 -> V_78 -> V_79 , & V_5 -> V_81 , & V_5 -> V_80 ,
V_5 -> V_82 , V_5 -> V_84 ,
0 , V_85 ) ;
}
}
V_66 = ( T_11 * ) F_24 ( V_65 , V_86 ) ;
if ( V_66 == NULL ) {
V_66 = F_25 ( F_26 () , T_11 ) ;
V_66 -> V_87 = - 1 ;
V_66 -> V_88 = 0 ;
...
V_64 = V_62 ;
if ( V_59 ) {
V_69 = F_2 ( V_59 , V_86 , V_2 , 0 , V_64 , V_25 ) ;
V_1 = F_14 ( V_69 , V_90 ) ;
F_2 ( V_1 , V_91 , V_2 , 0 , 1 , V_7 ) ;
F_2 ( V_1 , V_92 , V_2 , 1 , 1 , V_7 ) ;
F_2 ( V_1 , V_93 , V_2 , 2 , 2 , V_7 ) ;
}
switch ( V_61 ) {
case V_94 :
case V_89 :
...
case V_96 :
V_63 = F_8 ( V_2 , 4 ) ;
F_28 ( V_5 -> V_72 , V_74 , L_6 ,
F_29 ( V_63 , & V_97 ,
L_7 ) ) ;
if ( V_59 )
V_71 = F_2 ( V_1 , V_98 , V_2 , 4 , 1 , V_7 ) ;
if ( ( V_64 > 5 ) || ( ( V_64 == 5 ) && ( V_63 == V_99 ) ) ) {
int V_3 = 5 ;
T_3 V_4 = V_64 - V_3 ;
switch ( V_63 ) {
case V_99 :
if ( V_59 ) {
F_2 ( V_1 , V_100 , V_2 , V_3 , V_4 , V_27 | V_25 ) ;
}
if( ! V_5 -> V_78 -> V_101 . V_102 ) {
V_66 -> V_68 = 0 ;
V_66 -> V_87 = - 1 ;
}
break;
...
if ( V_4 < V_133 )
V_133 = V_4 ;
V_67 = ( T_12 * ) F_31 ( F_26 () , V_5 , V_86 , 0 ) ;
if ( V_67 == NULL ) {
if ( ! V_5 -> V_78 -> V_101 . V_102 ) {
if ( V_66 -> V_87 != - 1 ) {
V_121 = TRUE ;
...
{
T_6 * V_138 ;
V_132 = F_34 ( V_2 , V_136 -> V_139 ) ;
F_35 ( V_5 , V_132 , L_8 ) ;
F_36 ( V_136 , & V_140 ,
V_1 , V_5 , V_132 , & V_138 ) ;
F_37 ( V_141 , V_132 , V_5 , V_1 ) ;
if ( ! V_5 -> V_78 -> V_101 . V_102 )
V_66 -> V_87 = - 1 ;
}
V_5 -> V_137 = V_134 ;
} else {
V_132 = F_38 ( V_2 , V_3 , V_133 , V_4 ) ;
F_37 ( V_141 , V_132 , V_5 , V_1 ) ;
}
}
}
...
{
T_1 * V_160 ;
V_160 = F_39 ( V_1 , V_2 , V_3 , V_4 , V_161 , NULL , L_9 ) ;
...
{ & V_6 , {
L_138 , L_139 ,
V_167 , V_172 , F_42 ( V_190 ) , 0x0 ,
NULL , V_166 } } ,
{ & V_8 , {
L_140 , L_141 ,
V_164 , V_172 , F_42 ( V_191 ) , 0x0 ,
NULL , V_166 } }
} ;
static T_3 * V_192 [] = {
& V_90 ,
...
V_86 = F_43 ( L_151 ,
L_4 , L_152 ) ;
F_44 ( V_86 , V_163 , F_45 ( V_163 ) ) ;
F_46 ( V_192 , F_45 ( V_192 ) ) ;
V_200 = F_47 ( V_86 ) ;
F_48 ( V_200 , V_195 , F_45 ( V_195 ) ) ;
V_201 = F_49 ( L_152 , F_17 , V_86 ) ;
F_50 ( F_5 ) ;
}
void
F_51 ( void )
