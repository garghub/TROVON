...
V_7 = NULL ;
if ( V_4 ) {
V_7 = F_3 ( V_4 , V_1 , V_3 , V_12 + 4 + ( 4 - ( V_12 % 4 ) ) ,
V_19 , NULL , L_1 ,
V_9 , F_4 ( type , & V_20 ,
L_2 ) ) ;
F_5 ( V_7 , V_21 , V_1 ,
...
V_13 = V_12 ;
while ( V_13 >= 4 ) {
F_9 ( V_1 , V_3 + 4 , & V_15 , & exp , & V_16 , & V_17 ) ;
if ( V_15 <= V_76 ) {
F_10 ( V_7 , V_77 ,
...
F_12 ( V_7 , V_1 , V_3 + 4 + V_12 , V_14 , L_15 ) ;
}
V_12 += V_14 ;
}
V_5 -= 4 + V_12 ;
...
if ( V_4 ) {
while ( V_5 >= 4 ) {
F_9 ( V_1 , V_3 , & V_15 , & exp , & V_16 , & V_109 ) ;
...
F_23 ( V_106 , V_148 ,
V_1 , V_3 , 3 , V_15 ) ;
F_22 ( V_6 , L_24 , F_11 ( V_15 , V_78 ,
L_10 ) ) ;
} else {
F_5 ( V_106 , V_148 ,
V_1 , V_3 , 3 , V_15 , L_25 , V_15 ) ;
}
F_22 ( V_6 , L_26 , exp , V_16 ) ;
F_23 ( V_106 , V_149 ,
V_1 , V_3 + 2 , 1 , exp ) ;
F_23 ( V_106 , V_150 ,
V_1 , V_3 + 2 , 1 , V_16 ) ;
...
static void
F_24 ( T_1 * V_1 , T_2 * V_2 , T_3 V_3 , T_4 * V_4 , int V_5 )
{
...
F_7 ( V_4 , V_166 , V_1 ,
V_3 + 2 , 1 , V_23 ) ;
V_153 = F_7 ( V_4 , V_167 , V_1 ,
V_3 + 3 , 1 , V_23 ) ;
V_154 = F_19 ( V_153 , V_168 ) ;
F_7 ( V_154 , V_169 , V_1 ,
V_3 + 3 , 1 , V_23 ) ;
F_7 ( V_154 , V_170 , V_1 ,
V_3 + 3 , 1 , V_23 ) ;
V_153 = F_7 ( V_154 , V_171 , V_1 ,
V_3 + 3 , 1 , V_23 ) ;
}
V_111 = F_20 ( V_1 , V_3 + 2 ) ;
switch ( V_111 ) {
...
V_161 = F_20 ( V_1 , V_3 ) ;
V_160 = F_2 ( V_1 , V_3 + 1 ) ;
V_154 = F_21 ( V_4 , V_1 , V_3 - 4 , V_160 + 8 ,
V_168 , & V_156 , L_30 ) ;
switch ( V_161 ) {
case V_183 :
if ( ! V_4 )
...
F_7 ( V_154 , V_186 , V_1 ,
V_3 + 3 , 1 , V_23 ) ;
V_155 = F_21 ( V_154 , V_1 , V_3 + 4 , V_160 ,
V_187 , NULL , L_31 ) ;
F_7 ( V_155 , V_188 ,
...
break;
case V_198 :
V_154 = F_21 ( V_4 , V_1 , V_3 - 4 , V_158 + 4 ,
V_168 , NULL , L_40 ) ;
while ( V_5 >= 4 ) {
if ( V_4 ) {
F_9 ( V_1 , V_3 , & V_15 , & V_163 , & V_164 , & V_109 ) ;
V_155 = F_3 ( V_154 , V_1 , V_3 , 4 ,
V_187 , & V_157 , L_22 , V_9 ) ;
F_22 ( V_157 , L_41 , V_15 , V_109 ) ;
F_12 ( V_155 , V_1 , V_3 , 3 , L_42 , V_15 ) ;
F_12 ( V_155 , V_1 , V_3 + 2 , 1 , L_43 , V_163 ) ;
F_12 ( V_155 , V_1 , V_3 + 2 , 1 , L_44 , V_164 ) ;
F_7 ( V_155 , V_199 ,
V_1 , V_3 + 3 , 1 , V_23 ) ;
}
V_5 -= 4 ;
...
break;
case V_200 : {
V_111 = F_20 ( V_1 , V_3 + 1 ) ;
V_162 = F_20 ( V_1 , V_3 + 2 ) ;
V_154 = F_21 ( V_4 , V_1 , V_3 - 4 , V_162 + 12 ,
V_168 , NULL , L_45 ) ;
F_7 ( V_154 , V_201 , V_1 , V_3 , 1 , V_23 ) ;
F_7 ( V_154 , V_202 , V_1 , V_3 + 1 , 1 , V_23 ) ;
F_7 ( V_154 , V_203 , V_1 , V_3 + 2 , 1 , V_23 ) ;
F_7 ( V_154 , V_204 , V_1 , V_3 + 3 , 1 , V_23 ) ;
switch ( V_111 ) {
case V_205 :
F_12 ( V_154 , V_1 , V_3 + 4 , 0 , L_46 ) ;
V_5 += 4 ;
V_3 -= 4 ;
break;
case V_206 :
F_7 ( V_154 , V_207 , V_1 , V_3 + 4 , 4 , V_23 ) ;
break;
case V_208 :
F_7 ( V_154 , V_209 , V_1 , V_3 + 4 , 16 , V_30 ) ;
V_5 -= 12 ;
V_3 += 12 ;
break;
}
...
default:
V_154 = F_21 ( V_4 , V_1 , V_3 , V_158 , V_168 , NULL , L_47 ) ;
F_7 ( V_154 , V_210 , V_1 , V_3 - 4 , 2 , V_23 ) ;
F_7 ( V_154 , V_211 , V_1 , V_3 - 2 , 2 , V_23 ) ;
F_7 ( V_154 , V_212 , V_1 , V_3 , V_158 , V_30 ) ;
V_5 -= V_158 ;
break;
}
}
...
static void
F_25 ( T_1 * V_1 , T_2 * V_2 , T_3 V_3 , T_4 * V_4 , int V_5 , T_9 V_213 )
{
T_4 * V_6 ;
T_8 type ;
T_6 V_9 = 1 ;
T_7 V_15 ;
T_8 exp , V_16 , V_17 ;
V_6 = F_7 ( V_4 , V_214 , V_1 , V_3 , 1 , V_23 ) ;
type = F_20 ( V_1 , V_3 ) ;
V_3 += 1 ;
V_5 -= 1 ;
F_7 ( V_4 , V_215 , V_1 , V_3 , 3 , V_23 ) ;
V_3 += 3 ;
V_5 -= 3 ;
...
while ( V_5 >= 4 ) {
T_4 * V_222 ;
F_9 ( V_1 , V_3 , & V_15 , & exp , & V_16 , & V_17 ) ;
V_222 = F_3 ( V_4 , V_1 , V_3 , 4 , V_223 , & V_6 , L_48 , V_9 ) ;
F_22 ( V_6 , L_23 , V_15 ) ;
if ( V_15 <= V_76 ) {
F_5 ( V_222 , V_224 ,
...
static void
F_27 ( T_1 * V_1 , T_2 * V_2 , T_3 V_3 , T_4 * V_4 , int V_5 )
{
int V_228 ;
while ( V_5 >= 4 ) {
V_228 = F_28 ( V_1 , V_2 , V_3 , V_4 , V_5 , TRUE ) ;
V_5 -= V_228 ;
V_3 += V_228 ;
}
}
static int
F_28 ( T_1 * V_1 , T_2 * V_2 , T_3 V_3 , T_4 * V_4 , int V_5 , T_9 V_229 )
{
...
type = V_231 ;
if ( V_4 ) {
V_230 = F_3 ( V_4 , V_1 , V_3 , V_12 + 4 , V_232 , NULL ,
L_52 , V_229 ? L_53 : L_54 ,
F_4 ( type , & V_233 , L_55 ) ) ;
if ( V_229 ) {
F_5 ( V_230 , V_234 , V_1 ,
V_3 , 2 , V_11 , L_3 ,
...
V_6 = F_7 ( V_230 , V_236 , V_1 , V_3 + 2 , 2 , V_23 ) ;
}
if ( V_12 == 0 )
return 4 ;
switch ( type ) {
...
F_25 ( V_1 , V_2 , V_3 + 4 , V_230 , V_12 , FALSE ) ;
break;
case V_244 :
if ( V_12 < 24 ) {
F_8 ( V_2 , V_6 , & V_243 ,
...
F_25 ( V_1 , V_2 , V_3 + 4 , V_230 , V_12 , TRUE ) ;
break;
#if 0
case TLV_RTO_IPv4:
if (length != 4) {
...
int
F_31 ( T_1 * V_1 , T_2 * V_2 , T_4 * V_4 , void * T_10 V_271 )
{
...
F_33 ( V_2 -> V_275 , V_276 , L_63 ) ;
F_34 ( V_2 -> V_275 , V_277 ) ;
V_5 = F_29 ( V_1 , V_3 ) ;
V_274 = F_20 ( V_1 , V_3 + 4 ) ;
if ( ( ( ! F_35 ( V_274 ) ) && ( V_5 < 16 ) ) ||
( ( F_35 ( V_274 ) ) && ( V_5 < 32 ) ) ) {
F_33 ( V_2 -> V_275 , V_277 , L_64 ) ;
if ( V_4 ) {
V_6 = F_7 ( V_4 , V_278 , V_1 , 0 , - 1 , V_30 ) ;
V_273 = F_19 ( V_6 , V_279 ) ;
F_12 ( V_273 , V_1 , V_3 , V_5 ,
L_65 ,
V_5 , ( F_35 ( V_274 ) ) ? 32 : 16 ) ;
}
return 0 ;
}
F_36 ( V_2 -> V_275 , V_277 ,
F_37 ( V_274 , V_280 , L_66 ) ) ;
if ( V_4 ) {
V_6 = F_7 ( V_4 , V_278 , V_1 , 0 , - 1 , V_30 ) ;
V_273 = F_19 ( V_6 , V_279 ) ;
F_7 ( V_273 ,
...
while ( F_29 ( V_1 , V_3 ) > 0 ) {
V_272 = F_28 ( V_1 , V_2 , V_3 , V_273 , V_5 , FALSE ) ;
V_3 += V_272 ;
V_5 -= V_272 ;
}
return F_32 ( V_1 ) ;
...
{ & V_290 ,
{ L_88 , L_89 ,
V_305 , V_301 , F_39 ( V_280 ) , 0x0 , L_90 , V_302 }
} ,
{ & V_291 ,
{ L_91 , L_92 ,
V_305 , V_301 , F_39 ( V_306 ) , 0x0 , L_93 , V_302 }
} ,
{ & V_292 ,
{ L_94 , L_95 ,
...
{ & V_54 ,
{ L_181 , L_182 ,
V_300 , V_301 , F_39 ( V_316 ) , 0x0 , L_183 , V_302 }
} ,
{ & V_61 ,
{ L_184 , L_185 ,
...
{ & V_58 ,
{ L_181 , L_193 ,
V_300 , V_301 , F_39 ( V_316 ) , 0x0 , L_194 , V_302 }
} ,
{ & V_59 ,
{ L_70 , L_195 ,
...
{ & V_77 ,
{ L_211 , L_212 ,
V_317 , V_301 , F_39 ( V_78 ) , 0x0 , L_213 , V_302 }
} ,
{ & V_112 ,
{ L_214 , L_215 ,
...
{ & V_148 ,
{ L_270 , L_271 ,
V_317 , V_301 , F_39 ( V_78 ) , 0x0 , L_272 , V_302 }
} ,
{ & V_149 ,
{ L_273 , L_274 ,
...
{ & V_151 ,
{ L_279 , L_280 ,
V_305 , V_301 , F_39 ( V_152 ) , 0x0 ,
L_281 , V_302 }
} ,
{ & V_239 ,
{ L_282 , L_283 ,
V_305 , V_301 , F_39 ( V_320 ) , 0x0 , L_284 , V_302 }
} ,
{ & V_240 ,
{ L_15 , L_285 ,
...
{ & V_224 ,
{ L_211 , L_304 ,
V_317 , V_301 , F_39 ( V_78 ) , 0x0 , L_305 , V_302 }
} ,
{ & V_225 ,
{ L_306 , L_307 ,
...
{ & V_166 ,
{ L_217 , L_370 ,
V_305 , V_301 , F_39 ( V_318 ) , 0x0 , L_371 , V_302 }
} ,
{ & V_167 ,
{ L_220 , L_372 ,
...
{ & V_201 ,
{ L_419 , L_420 ,
V_305 , V_301 , F_39 ( V_323 ) , 0x0 ,
L_421 , V_302 }
} ,
{ & V_202 ,
{ L_217 , L_422 ,
V_305 , V_301 , F_39 ( V_324 ) , 0x0 ,
L_423 , V_302 }
} ,
{ & V_203 ,
{ L_424 , L_425 ,
...
{ & V_252 ,
{ L_465 , L_466 ,
V_300 , V_301 , F_39 ( V_325 ) , 0x0 , L_467 , V_302 }
} ,
{ & V_253 ,
{ L_115 , L_468 ,
...
V_278 = F_40 ( L_491 ,
L_492 , L_493 ) ;
F_41 ( V_278 , V_299 , F_42 ( V_299 ) ) ;
F_43 ( V_326 , F_42 ( V_326 ) ) ;
V_335 = F_44 ( V_278 ) ;
F_45 ( V_335 , V_327 , F_42 ( V_327 ) ) ;
V_334 = F_46 ( V_278 , V_336 ) ;
F_47 ( V_334 , L_494 , L_495 ,
L_496
L_497 ,
10 , & V_337 ) ;
}
...
F_49 ( L_494 , V_340 , V_339 ) ;
}
V_340 = V_337 ;
F_50 ( L_494 , V_337 , V_339 ) ;
}
