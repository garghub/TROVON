...
static int
F_3 ( T_4 * V_2 , T_2 * T_3 , T_6 * V_8 , void * T_7 V_1 )
{
char V_9 [ V_6 + 1 ] ;
T_5 V_4 ;
T_4 * V_10 = NULL ;
...
static int
F_15 ( T_4 * V_2 , T_2 * T_3 , T_6 * V_8 , void * T_7 )
{
...
static T_9
F_17 ( T_4 * V_2 , T_2 * T_3 , T_6 * V_8 , void * T_7 )
{
char V_9 [ V_6 ] ;
if ( F_18 ( V_2 ) < V_7 )
return FALSE ;
