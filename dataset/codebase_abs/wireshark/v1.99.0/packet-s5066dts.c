...
static T_2 F_38 ( T_4 * V_25 V_144 , T_1 * V_1 , int V_2 V_144 )
{
T_2 V_26 ;
T_2 V_61 ;
T_2 V_62 ;
...
{ & V_56 ,
{ L_40 , L_41 , V_190 , V_191 , F_14 , 0x0 , NULL , V_185 }
} ,
{ & V_57 ,
{ L_42 , L_43 , V_190 , V_191 , F_14 , 0x0 , NULL , V_185 }
} ,
{ & V_66 ,
...
if ( V_165 == - 1 )
{
V_165 = F_52 ( L_198 , L_199 , L_200 ) ;
F_53 ( V_165 , V_182 , F_54 ( V_182 ) ) ;
F_55 ( V_201 , F_54 ( V_201 ) ) ;
V_206 = F_56 ( V_165 ) ;
F_57 ( V_206 , V_202 , F_54 ( V_202 ) ) ;
F_58 ( V_156 , F_48 , V_165 ) ;
}
V_181 = F_59 ( V_165 , V_207 ) ;
F_60 ( V_181 , L_201 ,
L_202 ,
L_203 ,
& V_180 ) ;
...
static int V_211 ;
if ( ! V_208 ) {
V_209 = F_62 ( F_47 , V_165 ) ;
F_63 ( L_207 , V_212 , V_209 ) ;
V_210 = F_62 ( F_48 , V_165 ) ;
V_208 = TRUE ;
}
else {
