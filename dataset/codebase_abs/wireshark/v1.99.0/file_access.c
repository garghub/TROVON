...
int
F_59 ( const struct V_92 * V_96 , const int V_97 )
{
struct V_92 * V_98 ;
F_58 () ;
...
T_10 *
F_79 ( const char * V_31 , int V_71 , int V_110 ,
...
T_10 *
F_80 ( const char * V_31 , int V_71 , int V_110 ,
...
T_10 *
F_88 ( int V_37 , int V_71 , int V_110 , int V_126 ,
T_4 V_127 , int * V_34 )
{
return F_89 ( V_37 , V_71 , V_110 , V_126 , V_127 , NULL , NULL , V_34 ) ;
}
T_10 *
F_89 ( int V_37 , int V_71 , int V_110 , int V_126 ,
...
static T_4
F_83 ( int V_71 , int V_110 , T_4 V_127 , int * V_34 )
{
if ( ! F_67 ( V_71 ) ) {
* V_34 = V_132 ;
return FALSE ;
...
static T_10 *
F_82 ( int V_71 , int V_110 , int V_126 , T_4 V_127 , int * V_34 )
{
T_10 * V_130 ;
...
static T_4
F_85 ( T_10 * V_130 , int V_71 , T_4 V_127 , int * V_34 )
{
int V_37 ;
T_4 V_134 ;
if( V_127 ) {
...
T_4
F_92 ( T_10 * V_130 , const struct V_139 * V_140 ,
const T_14 * V_141 , int * V_34 )
{
return ( V_130 -> V_142 ) ( V_130 , V_140 , V_141 , V_34 ) ;
}
void
F_93 ( T_10 * V_130 )
{
...
void
F_98 ( T_10 * V_130 , T_15 V_147 )
{
V_130 -> V_147 = V_147 ;
}
T_4
F_99 ( T_10 * V_130 , T_16 * V_148 )
{
...
static T_13
F_84 ( T_10 * V_130 , const char * V_31 )
{
if( V_130 -> V_127 ) {
return F_100 ( V_31 ) ;
} else {
...
static T_13
F_84 ( T_10 * V_130 V_124 , const char * V_31 )
{
return F_101 ( V_31 , L_18 ) ;
}
static T_13
F_90 ( T_10 * V_130 , int V_37 )
{
if( V_130 -> V_127 ) {
return F_102 ( V_37 ) ;
} else {
...
static T_13
F_90 ( T_10 * V_130 V_124 , int V_37 )
{
return fdopen ( V_37 , L_18 ) ;
}
T_4
F_103 ( T_10 * V_130 , const void * V_149 , T_5 V_150 , int * V_34 )
{
T_5 V_151 ;
#ifdef F_94
if ( V_130 -> V_127 ) {
V_151 = F_104 ( ( V_143 ) V_130 -> V_50 , V_149 , ( unsigned int ) V_150 ) ;
if ( V_151 == 0 ) {
* V_34 = F_105 ( ( V_143 ) V_130 -> V_50 ) ;
return FALSE ;
}
} else
#endif
{
V_151 = fwrite ( V_149 , 1 , V_150 , ( V_135 * ) V_130 -> V_50 ) ;
if ( V_151 != V_150 ) {
...
T_15
F_107 ( T_10 * V_130 , T_15 V_153 , int V_154 , int * V_34 )
{
#ifdef F_94
if( V_130 -> V_127 ) {
* V_34 = V_155 ;
...
#endif
{
if ( - 1 == fseek ( ( V_135 * ) V_130 -> V_50 , ( long ) V_153 , V_154 ) ) {
* V_34 = V_41 ;
return - 1 ;
} else
{
...
#endif
{
if ( - 1 == ( V_156 = ftell ( ( V_135 * ) V_130 -> V_50 ) ) ) {
* V_34 = V_41 ;
return - 1 ;
} else
{
