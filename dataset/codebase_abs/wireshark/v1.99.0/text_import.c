...
char * V_4 ;
while ( ( V_4 = strchr ( V_96 , '\r' ) ) != NULL ) * V_4 = ' ' ;
fprintf ( V_5 , L_6 , V_96 ) ;
fprintf ( V_5 , L_7 , V_80 , ( T_1 ) V_77 , V_79 ) ;
}
V_94 = 0 ;
}
static void
...
fprintf ( V_5 , L_10 ,
V_114 [ V_115 ] , V_116 [ V_113 ] , V_1 ? V_1 : L_11 ) ;
}
switch( V_115 ) {
case V_117 :
switch( V_113 ) {
...
break;
default:
fprintf ( V_5 , L_13 , V_115 ) ;
exit ( - 1 ) ;
}
if ( V_97 >= 2 )
fprintf ( V_5 , L_14 , V_114 [ V_115 ] ) ;
}
void
F_18 ( T_5 * V_127 )
{
