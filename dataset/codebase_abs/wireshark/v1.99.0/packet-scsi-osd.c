...
if ( V_149 ) {
V_152 -> V_157 = T_5 -> V_159 -> V_160 ;
}
if ( V_150 ) {
V_152 -> V_158 = T_5 -> V_159 -> V_160 ;
}
if ( V_4 ) {
V_154 = F_22 ( V_4 , V_161 ) ;
}
if ( V_152 -> V_157 ) {
T_1 * V_162 ;
V_162 = F_27 ( V_154 , V_163 , V_1 , 0 , 0 , V_152 -> V_157 ) ;
F_42 ( V_162 ) ;
}
if ( V_152 -> V_158 ) {
T_1 * V_162 ;
V_162 = F_27 ( V_154 , V_164 , V_1 , 0 , 0 , V_152 -> V_158 ) ;
F_42 ( V_162 ) ;
}
}
return V_4 ;
...
V_2 += 1 ;
V_2 += 3 ;
F_5 ( T_5 , V_1 , V_2 , V_3 , V_165 , T_7 , TRUE , FALSE ) ;
V_2 += 8 ;
V_2 += 24 ;
if ( V_21 ) {
...
{
F_2 ( V_3 , V_168 , V_1 , V_2 , 8 , V_11 ) ;
if ( V_49 ) {
T_22 V_169 = F_47 ( V_1 , V_2 ) ;
if ( V_169 > F_48 ( 0xFFFFFFFF ) ) {
V_169 = F_48 ( 0xFFFFFFFF ) ;
}
V_49 -> V_50 -> V_169 = ( T_9 ) V_169 ;
}
}
static int
F_49 ( T_2 * V_1 , int V_2 , T_3 * V_3 )
{
F_2 ( V_3 , V_170 , V_1 , V_2 , 8 , V_6 ) ;
V_2 += 8 ;
return V_2 ;
}
static int
...
{
F_2 ( V_3 , V_172 , V_1 , V_2 , 8 , V_6 ) ;
V_2 += 8 ;
return V_2 ;
}
static T_1 *
F_52 ( T_2 * V_1 , int V_2 , T_3 * V_3 , const int V_173 )
{
T_1 * V_4 ;
V_4 = F_2 ( V_3 , V_173 , V_1 , V_2 , 8 , V_6 ) ;
return V_4 ;
}
static void
...
T_11 V_174 = ( V_106 == 0x8817 ) || ( V_106 == 0x8897 ) ;
...
V_2 += 1 ;
F_23 ( V_1 , V_2 , V_3 , V_49 ) ;
if ( ! V_174 ) F_44 ( V_1 , V_2 , V_3 ) ;
if ( V_21 ) F_7 ( V_1 , V_2 , V_3 ) ;
V_2 += 1 ;
F_24 ( V_1 , V_2 , V_3 ) ;
V_2 += 1 ;
V_2 += 3 ;
F_5 ( T_5 , V_1 , V_2 , V_3 , V_175 , T_7 , FALSE , FALSE ) ;
V_2 += 8 ;
if ( V_174 ) {
F_52 ( V_1 , V_2 , V_3 , V_176 ) ;
} else {
}
V_2 += 8 ;
if ( V_21 ) {
...
V_2 += 4 ;
V_2 += 3 ;
F_2 ( V_3 , V_181 , V_1 , V_2 , 1 , V_11 ) ;
if ( V_21 ) {
T_1 * V_4 ;
V_4 = F_2 ( V_3 , V_182 , V_1 , V_2 , 1 , V_11 ) ;
...
if ( V_180 ) {
if ( V_174 ) {
V_37 = F_52 ( V_1 , V_2 , V_3 , V_176 ) ;
} else {
V_37 = F_5 ( T_5 , V_1 , V_2 , V_3 , V_175 , T_7 , FALSE , FALSE ) ;
}
} else {
...
T_9 V_186 ;
T_3 * V_83 ;
if ( V_2 + 8 > V_177 ) break;
V_83 = F_22 ( V_37 , V_187 ) ;
F_2 ( V_83 , V_139 , V_1 , V_2 , 1 , V_11 ) ;
V_2 += 1 ;
V_2 += 5 ;
V_186 = V_2 + 2 + F_11 ( V_1 , V_2 ) ;
V_2 += 2 ;
if ( V_186 > V_177 + 8 ) break;
while ( V_2 + 16 < V_186 ) {
T_9 V_22 = F_11 ( V_1 , V_2 + 14 ) ;
T_1 * V_188 ;
T_3 * V_189 = F_20 ( V_83 , V_1 , V_2 , 16 + V_22 , V_41 , & V_188 , L_7 ) ;
V_2 = F_9 ( T_5 , V_1 , V_189 , V_188 , V_2 , T_7 , TRUE ) ;
}
V_2 = V_186 ;
}
}
...
V_2 += 1 ;
F_23 ( V_1 , V_2 , V_3 , V_49 ) ;
if ( V_21 ) F_2 ( V_3 , V_192 , V_1 , V_2 , 1 , V_11 ) ;
V_2 += 1 ;
F_24 ( V_1 , V_2 , V_3 ) ;
V_2 += 1 ;
V_2 += 3 ;
F_5 ( T_5 , V_1 , V_2 , V_3 , V_175 , T_7 , FALSE , TRUE ) ;
V_2 += 8 ;
V_2 += 24 ;
if ( V_21 ) {
F_31 ( T_5 , V_1 , V_2 , V_3 , V_49 ) ;
...
{
F_2 ( V_3 , V_195 , V_1 , V_2 , 7 , V_6 ) ;
}
static void
F_61 ( T_2 * V_1 , int V_2 , T_3 * V_3 )
{
F_2 ( V_3 , V_196 , V_1 , V_2 , 20 , V_6 ) ;
}
static void
...
if ( V_178 < 12 ) return;
V_177 = F_47 ( V_1 , V_2 ) ;
if ( ( T_9 ) ( V_178 - 8 ) < V_177 ) V_177 = ( T_9 ) ( V_178 - 8 ) ;
F_50 ( V_1 , V_2 , V_3 ) ;
V_2 += 8 ;
V_2 += 3 ;
V_4 = F_2 ( V_3 , V_182 , V_1 , V_2 , 1 , V_11 ) ;
...
if ( ! V_49 || ! V_49 -> V_209 || ! V_49 -> V_209 -> V_210 || ! V_49 -> V_50 ) {
return;
}
T_19 = ( T_18 * ) F_87 ( V_49 -> V_209 -> V_210 , V_211 ) ;
if ( ! T_19 ) {
T_19 = F_39 ( F_40 () , T_18 ) ;
T_19 -> V_212 = F_88 ( F_40 () ) ;
F_89 ( V_49 -> V_209 -> V_210 , V_211 , T_19 ) ;
}
T_7 = ( T_6 * ) F_90 ( T_19 -> V_212 , V_49 -> V_50 -> V_213 ) ;
if ( ! T_7 ) {
T_7 = F_39 ( F_40 () , T_6 ) ;
T_7 -> V_156 = F_88 ( F_40 () ) ;
F_91 ( T_19 -> V_212 , V_49 -> V_50 -> V_213 , ( void * ) T_7 ) ;
}
if ( V_147 && V_148 ) {
...
V_106 = F_11 ( V_1 , V_2 ) ;
if ( V_49 && V_49 -> V_50 ) {
if ( ( ! T_5 -> V_159 -> V_216 . V_217 ) || ( ! V_49 -> V_50 -> V_51 ) ) {
T_15 * V_51 ;
V_51 = F_39 ( F_40 () , T_15 ) ;
V_51 -> V_106 = V_106 ;
V_51 -> V_52 = 0 ;
...
if ( V_106 ) {
T_1 * V_43 ;
V_43 = F_93 ( V_3 , V_218 , V_1 , 0 , 0 , V_106 , L_28 , V_106 ) ;
F_42 ( V_43 ) ;
}
V_30 = F_85 ( V_106 ) ;
if ( V_30 ) {
...
{ & V_47 ,
{ L_37 , L_38 , V_232 , 8 ,
F_95 ( & V_233 ) , 0x10 , NULL , V_229 } } ,
{ & V_48 ,
{ L_39 , L_40 , V_232 , 8 ,
F_95 ( & V_233 ) , 0x08 , NULL , V_229 } } ,
{ & V_53 ,
{ L_41 , L_42 , V_225 , V_226 ,
F_96 ( V_234 ) , 0x30 , NULL , V_229 } } ,
{ & V_54 ,
{ L_43 , L_44 , V_225 , V_226 ,
F_96 ( V_235 ) , 0x0 , NULL , V_229 } } ,
{ & V_55 ,
...
F_96 ( V_241 ) , 0 , NULL , V_229 } } ,
{ & V_117 ,
{ L_87 , L_88 , V_231 , V_226 ,
NULL , 0 , NULL , V_229 } } ,
{ & V_119 ,
{ L_89 , L_90 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x8000 , NULL , V_229 } } ,
{ & V_120 ,
{ L_91 , L_92 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x4000 , NULL , V_229 } } ,
{ & V_121 ,
{ L_93 , L_94 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x2000 , NULL , V_229 } } ,
{ & V_122 ,
{ L_95 , L_96 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x1000 , NULL , V_229 } } ,
{ & V_123 ,
{ L_97 , L_98 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x0800 , NULL , V_229 } } ,
{ & V_124 ,
{ L_99 , L_100 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x0400 , NULL , V_229 } } ,
{ & V_125 ,
{ L_101 , L_102 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x0200 , NULL , V_229 } } ,
{ & V_126 ,
{ L_103 , L_104 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x0100 , NULL , V_229 } } ,
{ & V_127 ,
{ L_105 , L_106 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x0080 , NULL , V_229 } } ,
{ & V_128 ,
{ L_107 , L_108 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x0040 , NULL , V_229 } } ,
{ & V_129 ,
{ L_109 , L_110 , V_232 , 16 ,
F_95 ( & V_233 ) , 0x0020 , NULL , V_229 } } ,
{ & V_140 ,
{ L_111 , L_112 , V_225 , V_226 ,
F_96 ( V_242 ) , 0xf0 , NULL , V_229 } } ,
{ & V_141 ,
...
{ & V_181 ,
{ L_145 , L_146 , V_232 , 8 ,
F_95 ( & V_244 ) , 0x02 , NULL , V_229 } } ,
{ & V_185 ,
{ L_147 , L_148 , V_232 , 8 ,
F_95 ( & V_245 ) , 0x01 , NULL , V_229 } } ,
{ & V_184 ,
{ L_149 , L_150 , V_232 , 8 ,
F_95 ( & V_246 ) , 0x01 , NULL , V_229 } } ,
{ & V_190 ,
...
F_96 ( V_249 ) , 0x03 , NULL , V_229 } } ,
{ & V_202 ,
{ L_176 , L_177 , V_225 , V_230 ,
F_96 ( V_250 ) , 0x03 , NULL , V_229 } } ,
{ & V_204 ,
{ L_178 , L_179 , V_225 , V_230 ,
F_96 ( V_251 ) , 0x03 , NULL , V_229 } } ,
{ & V_203 ,
{ L_180 , L_181 , V_225 , V_230 ,
F_96 ( V_252 ) , 0x03 , NULL , V_229 } } ,
{ & V_34 ,
{ L_182 , L_183 , V_225 , V_226 ,
F_96 ( V_253 ) , 0x0f , NULL , V_229 } } ,
{ & V_36 ,
...
NULL , 0 , NULL , V_229 } } ,
{ & V_255 ,
{ L_85 , L_195 , V_225 , V_226 , F_96 ( V_241 ) , 0 , NULL , V_229 } } ,
{ & V_256 ,
...
{ & V_12 ,
{ L_202 , L_203 , V_225 , V_226 , F_96 ( V_258 ) , 0x0F , NULL , V_229 } } ,
{ & V_13 ,
{ L_204 , L_205 , V_232 , 8 , 0 , 0x40 , NULL , V_229 } } ,
{ & V_182 ,
{ L_206 , L_207 , V_225 , V_226 , F_96 ( V_259 ) , 0xFC , NULL , V_229 } } ,
{ & V_206 ,
{ L_208 , L_209 , V_225 , V_230 , 0 , 0x80 , NULL , V_229 } } ,
{ & V_192 ,
{ L_210 , L_211 , V_225 , V_226 , F_96 ( V_260 ) , 0x07 , NULL , V_229 } } ,
{ & V_205 ,
...
{ & V_103 ,
{ L_218 , L_219 , V_225 , V_226 , F_96 ( V_261 ) , 0 , NULL , V_229 } } ,
{ & V_105 ,
{ L_220 , L_221 , V_231 , V_226 , NULL , 0 , NULL , V_229 } } ,
{ & V_111 ,
{ L_222 , L_223 , V_231 , V_226 , F_96 ( V_262 ) , 0 , NULL , V_229 } } ,
{ & V_112 ,
{ L_224 , L_225 , V_225 , V_230 , NULL , 0x7 , NULL , V_229 } } ,
{ & V_113 ,
{ L_226 , L_227 , V_237 , V_230 , NULL , 0 , NULL , V_229 } } ,
{ & V_89 ,
{ L_228 , L_229 , V_225 , V_226 , F_96 ( V_263 ) , 0x0f , NULL , V_229 } } ,
{ & V_94 ,
...
{ & V_183 , { L_242 , V_268 , V_271 , L_243 , V_270 } } ,
...
V_211 = F_97 ( L_260 , L_260 , L_261 ) ;
F_98 ( V_211 , V_223 , F_99 ( V_223 ) ) ;
F_100 ( V_264 , F_99 ( V_264 ) ) ;
V_222 = F_101 ( V_211 ) ;
F_102 ( V_222 , V_267 , F_99 ( V_267 ) ) ;
}
