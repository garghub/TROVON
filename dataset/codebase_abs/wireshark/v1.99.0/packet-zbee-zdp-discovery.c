...
F_3 ( V_3 , V_11 , V_1 , & V_4 , ( int ) sizeof( T_6 ) , NULL ) ;
V_5 = F_2 ( V_3 , V_6 , V_1 , & V_4 , ( int ) sizeof( T_5 ) , NULL ) ;
F_18 ( V_3 , V_29 , V_1 , & V_4 ) ;
F_4 ( V_3 , V_2 , L_1 , F_5 ( V_5 ) ) ;
F_6 ( V_1 , V_4 , V_2 , V_3 ) ;
}
void
F_19 ( T_1 * V_1 , T_2 * V_2 , T_3 * V_3 , V_8 V_14 )
{
T_4 V_4 = 0 ;
T_6 V_10 ;
V_8 V_30 ;
...
V_15 = F_13 ( V_3 , V_1 , V_4 , V_35 , V_40 , NULL , L_8 ) ;
...
V_15 = F_13 ( V_3 , V_1 , V_4 , V_44 , V_46 , NULL , L_9 ) ;
...
F_3 ( V_3 , V_9 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( ( V_3 ) && ( V_50 ) ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_50 * ( int ) sizeof( T_6 ) ,
V_52 , NULL , L_10 ) ;
}
...
V_44 = F_3 ( V_3 , V_45 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
if ( V_3 && V_44 ) {
V_15 = F_13 ( V_3 , V_1 , V_4 , V_44 * ( int ) sizeof( V_8 ) ,
V_46 , NULL , L_14 ) ;
}
for ( V_16 = 0 ; V_16 < V_44 ; V_16 ++ ) {
( void ) F_3 ( V_15 , V_13 , V_1 , & V_4 , ( int ) sizeof( V_8 ) , NULL ) ;
...
V_31 = F_51 ( F_21 () , V_1 , V_4 , V_30 , V_57 ) ;
if ( V_3 ) {
F_23 ( V_3 , V_33 , V_1 , V_4 , V_30 , V_31 ) ;
}
V_4 += V_30 ;
