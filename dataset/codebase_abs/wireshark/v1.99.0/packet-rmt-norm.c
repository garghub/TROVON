...
if ( V_18 ) {
F_4 ( V_7 , V_23 , V_8 , V_9 , 1 , V_24 ) ; V_9 += 1 ;
}
F_4 ( V_7 , V_25 , V_8 , V_9 , 2 , V_13 ) ; V_9 += 2 ;
if ( F_14 ( V_8 , V_9 ) > 0 ) {
T_8 V_26 ;
T_4 * V_27 ;
int V_28 ;
V_27 = F_15 ( V_8 , V_9 ) ;
V_26 . V_20 = V_20 ;
V_28 = F_16 ( V_29 , V_27 , V_17 , V_7 , & V_26 ) ;
if ( V_28 > 0 )
V_9 += V_28 ;
}
return V_9 ;
...
T_4 * V_8 , T_2 V_9 , T_1 V_30 )
{
T_9 V_31 ;
T_7 * V_32 = ( T_7 * ) F_18 ( F_12 () , V_17 , V_21 , 0 ) ;
memset ( & V_31 , 0 , sizeof( V_31 ) ) ;
if ( V_32 != NULL )
V_31 . V_33 = V_32 -> V_20 ;
V_9 += F_19 ( V_7 , V_8 , V_17 , V_9 , F_20 ( V_30 ) , & V_31 ,
V_34 , V_35 ) ;
return V_9 ;
}
...
T_3 * V_38 , * V_39 ;
T_11 V_28 ;
V_38 = F_22 ( V_7 , V_8 , V_9 , - 1 , V_40 , & V_36 , L_1 ) ;
F_4 ( V_38 , V_41 , V_8 , V_9 , 1 , V_13 ) ; V_9 += 1 ;
V_37 = F_4 ( V_38 , V_42 , V_8 , V_9 , 1 , V_13 ) ;
V_39 = F_23 ( V_37 , V_43 ) ;
F_4 ( V_39 , V_44 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_45 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_46 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_47 , V_8 , V_9 , 1 , V_13 ) ;
V_9 += 1 ;
V_28 = F_24 ( V_8 , V_9 ) ;
F_4 ( V_38 , V_48 , V_8 , V_9 , 2 , V_13 ) ; V_9 += 2 ;
F_25 ( V_36 , 4 + V_28 ) ;
if ( V_28 > 4 ) {
F_10 ( V_38 , V_8 , V_9 , V_17 , 1 ) ;
}
V_9 += V_28 ;
return V_9 ;
}
...
T_3 * V_39 ;
V_9 = F_3 ( V_7 , V_8 , V_9 ) ;
V_36 = F_4 ( V_7 , V_50 , V_8 , V_9 , 1 , V_13 ) ;
V_49 = F_5 ( V_8 , V_9 ) ;
V_39 = F_23 ( V_36 , V_43 ) ;
F_4 ( V_39 , V_51 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_52 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_53 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_54 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_55 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_56 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_57 , V_8 , V_9 , 1 , V_13 ) ;
V_9 += 1 ;
V_9 = F_10 ( V_7 , V_8 , V_9 , V_17 , 0 ) ;
if ( V_9 < F_20 ( V_30 ) ) {
V_9 = F_17 ( V_7 , V_17 , V_8 , V_9 , V_30 ) ;
}
if ( V_49 & V_58 ) {
V_39 = F_22 ( V_7 , V_8 , V_9 , 8 , V_59 , NULL , L_2 ) ;
F_4 ( V_39 , V_23 , V_8 , V_9 , 2 , V_13 ) ; V_9 += 2 ;
F_4 ( V_39 , V_60 , V_8 , V_9 , 2 , V_13 ) ; V_9 += 2 ;
F_4 ( V_39 , V_61 , V_8 , V_9 , 4 , V_13 ) ; V_9 += 4 ;
}
if ( F_14 ( V_8 , V_9 ) > 0 )
F_4 ( V_7 , V_62 , V_8 , V_9 , - 1 , V_24 ) ;
}
static void F_27 ( T_3 * V_7 , T_5 * V_17 , T_4 * V_8 , T_2 V_9 , T_1 V_30 )
{
T_10 * V_36 ;
T_3 * V_39 ;
T_7 * V_19 ;
...
T_4 * V_8 , T_2 V_9 , T_1 V_30 )
{
F_4 ( V_7 , V_50 , V_8 , V_9 , 1 , V_13 ) ; V_9 += 1 ;
...
V_37 = F_4 ( V_66 , V_69 , V_8 , V_9 , 1 , V_13 ) ;
V_39 = F_23 ( V_37 , V_43 ) ;
F_4 ( V_39 , V_70 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_71 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_72 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_73 , V_8 , V_9 , 1 , V_13 ) ;
F_4 ( V_39 , V_74 , V_8 , V_9 , 1 , V_13 ) ;
V_9 += 1 ;
V_11 = F_1 ( F_5 ( V_8 , V_9 ) ) ;
...
switch( V_81 ) {
case V_86 :
V_9 = F_30 ( V_7 , V_17 , V_8 , V_9 , V_30 ) ;
break;
case V_87 :
V_9 = F_28 ( V_7 , V_17 , V_8 , V_9 , V_30 ) ;
break;
case V_88 :
V_9 = F_32 ( V_7 , V_17 , V_8 , V_9 ) ;
break;
case V_89 :
V_9 = F_29 ( V_7 , V_17 , V_8 , V_9 , V_30 ) ;
break;
case V_90 :
...
V_36 = F_4 ( V_7 , V_21 , V_8 , V_9 , - 1 , V_24 ) ;
V_100 = F_23 ( V_36 , V_102 ) ;
F_9 ( V_100 , V_103 , V_8 , V_9 , 1 , V_99 ) ;
if ( V_99 != 1 ) {
F_42 ( V_17 , V_36 , & V_104 ) ;
...
switch( type ) {
case V_110 :
F_27 ( V_100 , V_17 , V_8 , V_9 , V_30 ) ;
break;
case V_111 :
F_26 ( V_100 , V_17 , V_8 , V_9 , V_30 ) ;
break;
case V_112 :
F_34 ( V_100 , V_17 , V_8 , V_9 , V_30 ) ;
break;
case V_113 :
F_37 ( V_100 , V_17 , V_8 , V_9 , V_30 ) ;
break;
case V_114 :
F_38 ( V_100 , V_17 , V_8 , V_9 , V_30 ) ;
break;
default:
if ( F_14 ( V_8 , V_9 ) > 0 )
F_4 ( V_100 , V_62 , V_8 , V_9 , - 1 , V_24 ) ;
break;
}
return F_44 ( V_8 ) ;
}
...
{ & V_61 ,
{ L_52 , L_53 ,
V_133 , V_119 , NULL , 0x0 ,
NULL , V_120 }
} ,
{ & V_85 ,
{ L_54 , L_55 ,
V_118 , V_119 , F_47 ( V_84 ) , 0x0 ,
NULL , V_120 }
} ,
{ & V_63 ,
{ L_56 , L_57 ,
...
{ & V_62 ,
{ L_112 , L_113 ,
V_144 , V_123 , NULL , 0x0 ,
NULL , V_120 }
} ,
{ & V_22 ,
{ L_114 , L_115 ,
V_118 , V_119 , F_47 ( V_145 ) , 0x0 ,
NULL , V_120 }
}
} ;
static T_6 * V_146 [] = {
...
static T_15 V_147 [] = {
{ & V_104 , { L_116 , V_148 , V_149 , L_117 , V_150 } }
} ;
T_16 * V_151 ;
T_17 * V_152 ;
V_21 = F_48 ( L_118 , L_7 , L_119 ) ;
F_49 ( V_21 , V_117 , F_50 ( V_117 ) ) ;
F_51 ( V_146 , F_50 ( V_146 ) ) ;
V_152 = F_52 ( V_21 ) ;
F_53 ( V_152 , V_147 , F_50 ( V_147 ) ) ;
V_151 = F_54 ( V_21 , NULL ) ;
F_55 ( V_151 , L_120 ,
L_121 ,
L_122 ,
& V_116 ) ;
...
{
static T_18 V_153 ;
V_153 = F_57 ( F_39 , V_21 ) ;
F_58 ( L_123 , V_153 ) ;
F_59 ( L_124 , F_45 , V_21 ) ;
V_29 = F_60 ( L_125 ) ;
}
