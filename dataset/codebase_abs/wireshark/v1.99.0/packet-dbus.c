...
static int
F_16 ( T_3 * V_3 , T_4 * V_4 , T_5 * V_5 , int V_6 , int V_30 )
{
const int V_8 = V_6 ;
T_7 * V_9 ;
T_14 V_31 ;
...
V_40 , ( int ) strlen ( V_37 . V_28 ) + 1 , V_37 . V_28 ) ;
return V_6 ;
}
break;
case V_41 :
if ( ! strcmp ( T_2 , L_11 ) ) {
T_6 V_42 ;
V_6 = F_3 ( V_3 , V_4 , V_5 , V_6 , 'g' , & V_42 ) ;
if ( V_6 != - 1 )
V_4 -> V_43 = V_42 . V_28 ;
return V_6 ;
}
...
T_7 * V_9 ;
T_8 V_30 ;
V_9 = F_20 ( V_5 , & V_47 , V_3 , V_6 , 0 , V_48 ) ;
V_46 = F_21 ( V_9 , V_49 ) ;
V_30 = F_4 ( V_3 , V_6 ) ;
F_20 ( V_46 , & V_50 , V_3 , V_6 , 1 , V_4 -> V_51 ) ;
F_22 ( V_9 , L_17 , F_23 ( V_30 , V_52 , L_18 ) ) ;
V_6 += 1 ;
V_6 = F_16 ( V_3 , V_4 , V_46 , V_6 , V_30 ) ;
if ( V_6 == - 1 )
break;
V_6 = ( V_6 + 7 ) & ~ 7 ;
F_24 ( V_9 , V_3 , V_6 ) ;
...
T_7 * V_9 ;
T_8 type ;
V_9 = F_20 ( V_5 , & V_54 , V_3 , V_6 , 0 , V_48 ) ;
V_53 = F_21 ( V_9 , V_55 ) ;
F_20 ( V_53 , & V_56 , V_3 , V_6 , 1 , V_24 | V_48 ) ;
V_6 += 1 ;
type = F_4 ( V_3 , V_6 ) ;
F_26 ( V_4 -> V_16 -> V_57 , V_58 , F_27 ( type , V_59 , L_19 ) ) ;
F_20 ( V_53 , & V_60 , V_3 , V_6 , 1 , V_4 -> V_51 ) ;
V_6 += 1 ;
F_20 ( V_53 , & V_61 , V_3 , V_6 , 1 , V_4 -> V_51 ) ;
V_6 += 1 ;
F_20 ( V_53 , & V_62 , V_3 , V_6 , 1 , V_4 -> V_51 ) ;
V_6 += 1 ;
V_4 -> V_63 = V_4 -> V_14 ( V_3 , V_6 ) ;
F_20 ( V_53 , & V_64 , V_3 , V_6 , 4 , V_4 -> V_51 ) ;
V_6 += 4 ;
F_20 ( V_53 , & V_65 , V_3 , V_6 , 4 , V_4 -> V_51 ) ;
V_6 += 4 ;
V_4 -> V_45 = V_4 -> V_14 ( V_3 , V_6 ) ;
F_20 ( V_53 , & V_66 , V_3 , V_6 , 4 , V_4 -> V_51 ) ;
V_6 += 4 ;
return V_6 ;
}
static int
...
T_5 * V_67 ;
T_7 * V_9 ;
if ( V_4 -> V_63 && V_4 -> V_43 [ 0 ] ) {
const char * T_2 = V_4 -> V_43 ;
V_9 = F_20 ( V_5 , & V_68 , V_3 , V_6 , 0 , V_48 ) ;
V_67 = F_21 ( V_9 , V_69 ) ;
while ( * T_2 ) {
T_6 V_10 ;
...
if ( V_5 ) {
T_7 * V_9 = F_20 ( V_5 , V_80 , V_3 , 0 , - 1 , V_48 ) ;
V_70 = F_21 ( V_9 , V_81 ) ;
}
V_6 = 0 ;
...
static T_14
F_31 ( T_15 * V_16 V_2 , T_3 * V_3 , int V_6 )
{
T_9 (* F_32)( T_3 * , const T_17 );
T_9 V_82 , V_83 ;
switch ( F_4 ( V_3 , V_6 ) ) {
case 'l' :
F_32 = V_74 ;
...
V_83 = V_84 + F_32 ( V_3 , V_6 + 12 ) ;
V_83 = ( V_83 + 7 ) & ~ 7 ;
V_82 = F_32 ( V_3 , V_6 + 4 ) ;
return V_83 + V_82 ;
}
static int
F_33 ( T_3 * V_3 , T_15 * V_16 , T_5 * V_5 , void * T_16 )
{
return F_29 ( V_3 , V_16 , V_5 , T_16 ) ;
}
static int
F_34 ( T_3 * V_3 , T_15 * V_16 , T_5 * V_5 , void * T_16 )
{
F_35 ( V_3 , V_16 , V_5 , V_85 , V_84 , F_31 , F_33 , T_16 ) ;
return F_36 ( V_3 ) ;
}
void
F_37 ( void )
...
{ & V_26 , { L_23 , V_89 , V_90 , L_24 , V_91 } } ,
{ & V_27 , { L_25 , V_89 , V_90 , L_26 , V_91 } } ,
{ & V_29 , { L_27 , V_89 , V_90 , L_28 , V_91 } } ,
} ;
T_20 * V_92 ;
int V_93 ;
