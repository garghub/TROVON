...
V_5 -> V_10 = V_10 ;
V_5 -> V_78 = FALSE ;
V_5 -> V_86 = F_34 ( V_5 -> V_10 , 0 , V_87 ) ;
if ( V_5 -> V_86 == - 1 ) V_5 -> V_86 = 0 ;
V_5 -> V_11 = V_5 -> V_86 ;
F_30 ( V_5 ) ;
#ifdef F_32
if ( F_35 ( V_10 , & V_83 ) >= 0 ) {
...
#endif
V_5 -> V_16 = ( unsigned char * ) F_33 ( V_84 ) ;
V_5 -> V_31 = ( unsigned char * ) F_33 ( V_84 << 1 ) ;
V_5 -> V_17 = V_84 ;
...
void
F_41 ( T_2 V_99 , T_13 T_14 V_36 , T_15 * V_100 )
{
V_99 -> V_28 = V_100 ;
}
T_5
...
&& ( V_21 -> V_28 ) )
{
if ( F_34 ( V_21 -> V_10 , V_101 - V_21 -> V_8 , V_87 ) == - 1 ) {
* V_12 = V_13 ;
return - 1 ;
}
...
if ( F_34 ( V_21 -> V_10 , V_21 -> V_86 , V_104 ) == - 1 ) {
* V_12 = V_13 ;
return - 1 ;
}
F_10 ( V_21 ) ;
...
{
if ( F_42 ( V_21 , V_111 , V_87 , V_12 ) == - 1 )
return FALSE ;
return TRUE ;
}
T_5
...
int
F_49 ( T_2 V_99 , T_12 * V_112 , int * V_12 )
{
if ( F_35 ( V_99 -> V_10 , V_112 ) == - 1 ) {
if ( V_12 != NULL )
* V_12 = V_13 ;
return - 1 ;
}
...
int
F_51 ( void * V_6 , unsigned int V_29 , T_2 V_21 )
{
T_3 V_113 , V_43 ;
if ( V_29 == 0 )
return 0 ;
...
{
if ( V_116 -> V_12 != 0 && V_14 ) {
* V_14 = F_57 ( V_116 -> V_14 ) ;
}
return V_116 -> V_12 ;
}
void
...
int V_9 ;
T_11 V_53 = & ( V_5 -> V_53 ) ;
V_5 -> V_16 = ( unsigned char * ) F_33 ( V_5 -> V_84 ) ;
V_5 -> V_31 = ( unsigned char * ) F_33 ( V_5 -> V_84 ) ;
if ( V_5 -> V_16 == NULL || V_5 -> V_31 == NULL ) {
F_24 ( V_5 -> V_31 ) ;
F_24 ( V_5 -> V_16 ) ;
V_5 -> V_12 = V_66 ;
