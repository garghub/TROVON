...
static int
F_94 ( T_3 * T_4 , T_12 * V_35 , T_8 * V_127 , void * V_128 )
{
int T_5 = 0 ;
int V_129 ;
T_13 * V_130 ;
...
if ( V_128 == NULL )
return 0 ;
V_132 = (struct V_131 * ) V_128 ;
F_91 ( & V_122 , V_123 , TRUE , V_35 ) ;
V_122 . V_134 = V_132 ;
V_130 = F_96 ( V_127 , V_135 , T_4 , 0 , - 1 , V_136 ) ;
T_9 = F_97 ( V_130 , V_137 ) ;
F_98 ( V_35 -> V_36 , V_138 , L_5 ) ;
F_99 ( V_35 -> V_36 , V_37 ) ;
switch( V_132 -> V_139 & V_140 ) {
case ( V_141 | V_142 ) :
F_95 = F_1 ;
V_133 = L_6 ;
break;
...
break;
default:
F_100 ( T_9 , V_35 , & V_148 , T_4 , T_5 , - 1 ,
L_17 , V_132 -> V_139 & V_146 ) ;
break;
}
break;
default:
...
if( F_95 ) {
F_98 ( V_35 -> V_36 , V_37 , V_133 ) ;
while ( F_103 ( T_4 , T_5 ) > 0 ) {
V_129 = T_5 ;
T_5 = (* F_95)( FALSE , T_4 , T_5 , & V_122 , T_9 , - 1 ) ;
if( T_5 == V_129 ) {
F_101 ( T_9 , V_35 , & V_150 , T_4 , T_5 , - 1 ) ;
break;
}
}
}
...
{ & V_169 ,
{ L_48 , L_49 ,
V_156 , V_157 , F_105 ( V_170 ) , 0 ,
NULL , V_154 } } ,
{ & V_171 ,
{ L_50 , L_51 ,
V_156 , V_157 , F_105 ( V_172 ) , 0 ,
NULL , V_154 } } ,
{ & V_173 ,
{ L_52 , L_53 ,
V_152 , V_153 , NULL , 0 ,
...
{ & V_204 ,
{ L_112 , L_113 ,
V_156 , V_157 , F_105 ( V_205 ) , 0 ,
NULL , V_154 } } ,
{ & V_206 ,
{ L_114 , L_115 ,
V_156 , V_157 , F_105 ( V_38 ) , 0 ,
L_116 , V_154 } } ,
{ & V_207 ,
{ L_117 , L_118 ,
V_152 , V_153 , NULL , 0 ,
...
{ & V_225 ,
{ L_153 , L_154 ,
V_156 , V_157 , F_105 ( V_226 ) , 0 ,
NULL , V_154 } } ,
{ & V_227 ,
{ L_114 , L_115 ,
V_156 , V_157 , F_105 ( V_58 ) , 0 ,
NULL , V_154 } } ,
{ & V_228 ,
{ L_155 , L_156 ,
V_152 , V_153 , NULL , 0 ,
...
static T_16 V_280 [] = {
{ & V_147 , { L_255 , V_281 , V_282 , L_256 , V_283 } } ,
{ & V_148 , { L_257 , V_281 , V_282 , L_258 , V_283 } } ,
{ & V_149 , { L_259 , V_281 , V_282 , L_260 , V_283 } } ,
{ & V_150 , { L_261 , V_284 , V_285 , L_262 , V_283 } } ,
} ;
T_17 * V_286 ;
T_18 * V_287 ;
V_135 = F_106 ( V_288 , V_289 , V_290 ) ;
F_107 ( L_263 , F_94 , V_135 ) ;
F_108 ( V_135 , V_151 , F_109 ( V_151 ) ) ;
F_110 ( V_279 , F_109 ( V_279 ) ) ;
V_287 = F_111 ( V_135 ) ;
F_112 ( V_287 , V_280 , F_109 ( V_280 ) ) ;
V_286 = F_113 ( L_264 , V_135 , V_291 ) ;
F_114 ( V_286 , L_265 , L_266 ,
L_267
L_268 ,
10 , & V_292 ) ;
}
...
F_116 ( L_269 , L_270 , F_117 ( F_93 , V_135 ) ) ;
F_116 ( L_269 , L_271 , F_117 ( F_90 , V_135 ) ) ;
F_116 ( L_269 , L_272 , F_117 ( F_90 , V_135 ) ) ;
F_116 ( L_269 , L_273 , F_117 ( F_92 , V_135 ) ) ;
F_116 ( L_269 , L_274 , F_117 ( F_92 , V_135 ) ) ;
...
F_118 ( L_281 , L_282 ) ;
V_293 = F_119 ( L_263 ) ;
F_120 ( L_283 , V_293 , 0 , L_284 , FALSE ) ;
F_121 ( L_285 , V_293 , 0 , L_286 , FALSE ) ;
F_121 ( L_287 , V_293 , 0 , L_288 , FALSE ) ;
F_118 ( L_289 , L_290 ) ;
V_294 = F_119 ( L_291 ) ;
F_122 ( V_177 , L_292 ) ;
}
...
{
static T_20 V_295 = 0 ;
if( ( V_295 > 0 ) && ( V_295 != 102 ) && V_294 )
F_123 ( L_265 , V_295 , V_294 ) ;
V_295 = V_292 ;
if( ( V_295 > 0 ) && ( V_295 != 102 ) && V_294 )
F_124 ( L_265 , V_292 , V_294 ) ;
}
