...
static int
F_7 ( T_1 * V_1 V_5 , T_10 T_11 V_5 , int T_12 V_5 )
{
return 13 ;
}
static void
...
static T_2
F_11 ( const T_1 * V_24 , const T_1 * V_25 )
{
return F_10 ( V_24 -> V_2 . V_3 ) == F_10 ( V_25 -> V_2 . V_3 ) ;
}
static T_2
...
T_8 V_30 ;
T_8 V_31 ;
V_26 = F_10 ( V_24 -> V_2 . V_3 ) ;
V_27 = F_10 ( V_25 -> V_2 . V_3 ) ;
if ( V_26 == V_27 )
return FALSE ;
switch ( V_26 ) {
case V_16 :
...
static T_2
F_19 ( T_1 * V_1 , const char * V_4 , T_2 T_3 V_5 , T_4 * * T_5 V_5 )
{
const char * V_6 = V_4 ;
char V_7 ;
T_6 V_8 = 0 ;
...
static void
F_20 ( T_1 * V_1 , T_10 T_11 V_5 , int T_12 V_5 , char * V_18 , unsigned int V_19 )
{
T_8 V_10 ;
T_7 V_9 ;
T_7 V_8 ;
...
static int
F_21 ( T_1 * V_1 V_5 , T_10 T_11 V_5 , int T_12 V_5 )
{
return 136 ;
}
static void
F_22 ( T_1 * V_1 , T_7 V_2 )
{
V_1 -> V_2 . V_34 = V_2 ;
}
static T_7
...
{
return F_24 ( V_24 -> V_2 . V_34 ) == F_24 ( V_25 -> V_2 . V_34 ) ;
}
static T_2
...
T_8 V_30 ;
T_8 V_31 ;
V_26 = F_24 ( V_24 -> V_2 . V_34 ) ;
V_27 = F_24 ( V_25 -> V_2 . V_34 ) ;
if ( V_26 == V_27 )
return FALSE ;
switch ( V_26 ) {
case V_38 :
