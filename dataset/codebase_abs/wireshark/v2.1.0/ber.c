...
static T_1 F_8 ( T_2 * V_1 , T_6 V_24 , struct V_3 * V_4 ,
T_4 * V_5 , int * V_6 , T_5 * * V_7 )
{
if( V_24 > 0 ) {
* V_6 = 0 ;
...
if ( F_9 ( V_1 -> V_25 , V_24 , V_26 , V_6 ) == - 1 )
return FALSE ;
...
T_6 V_8 ;
int V_22 = 0 , V_34 ;
if ( ! F_12 ( V_1 -> V_2 , & V_27 , F_11 , V_6 , V_7 ) ) {
if ( * V_6 != V_35 )
return V_36 ;
return V_37 ;
}
...
V_30 = V_28 & 0x1F ;
if( ! ( V_31 &&
( ( ( V_29 == V_38 ) && ( ( V_30 == V_39 ) || ( V_30 == V_40 ) ) ) ||
( ( ( V_29 == V_41 ) || ( V_29 == V_42 ) ) && ( V_30 < 32 ) ) ) ) )
return V_37 ;
V_32 = V_27 [ V_22 ++ ] ;
if( V_32 != 0x80 ) {
if( ! ( V_32 & 0x80 ) )
