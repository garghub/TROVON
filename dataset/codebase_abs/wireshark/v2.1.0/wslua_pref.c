...
switch ( F_50 ( & V_6 , V_44 , F_51 ( V_1 , V_43 ) ) ) {
case V_45 :
break;
case V_46 :
...
V_50 = V_49 ;
do {
if ( V_50 -> V_11 && F_63 ( V_50 -> V_11 , V_11 ) ) {
F_64 ( V_1 , L_11 , V_11 ) ;
return 0 ;
}
for ( V_51 = V_11 ; * V_51 != '\0' ; V_51 ++ ) {
if ( ! F_65 ( * V_51 ) && ! F_66 ( * V_51 ) && * V_51 != '_' && * V_51 != '.' )
{
F_64 ( V_1 , L_12
L_13 , V_11 ) ;
return 0 ;
...
V_18 -> V_16 = F_13 ( V_11 ) ;
if ( ! V_49 -> V_54 -> V_56 ) {
V_49 -> V_54 -> V_56 = F_67 ( V_49 -> V_54 -> V_57 ,
V_58 ) ;
}
switch( V_18 -> type ) {
case V_21 :
...
V_49 = V_49 -> V_55 ;
do {
if ( F_63 ( V_49 -> V_11 , V_11 ) ) {
switch ( V_49 -> type ) {
case V_21 : F_78 ( V_1 , V_49 -> V_13 . V_23 ) ; break;
case V_24 : F_79 ( V_1 , ( V_59 ) V_49 -> V_13 . V_25 ) ; break;
case V_26 : F_80 ( V_1 , V_49 -> V_13 . V_27 ) ; break;
case V_30 : F_79 ( V_1 , ( V_59 ) V_49 -> V_13 . V_10 ) ; break;
case V_36 :
{
char * V_60 = F_81 ( NULL , V_49 -> V_13 . V_39 ) ;
F_80 ( V_1 , V_60 ) ;
F_82 ( NULL , V_60 ) ;
}
break;
default: F_74 ( F_76 , L_14 ) ; return 0 ;
}
F_75 ( 1 ) ;
}
