...
L_167 ,
10 , & V_270 ) ;
V_16 = F_86 ( L_14 , L_168 , V_60 , V_229 , V_241 , V_271 ) ;
V_17 = F_86 ( L_15 , L_169 , V_60 , V_229 , V_241 , V_271 ) ;
}
void
V_269 ( void )
{
...
static T_10 V_274 ;
if ( ! V_272 ) {
F_87 ( L_170 , F_72 , L_171 , L_172 , V_60 , V_275 ) ;
F_87 ( L_173 , F_72 , L_174 , L_175 , V_60 , V_275 ) ;
V_273 = F_88 ( F_69 , V_60 ) ;
V_89 = F_89 ( L_176 , V_268 ) ;
V_13 = F_89 ( L_177 , V_60 ) ;
V_15 = F_89 ( L_178 , V_60 ) ;
V_272 = TRUE ;
} else {
F_90 ( L_179 , V_274 , V_273 ) ;
}
F_91 ( L_179 , V_270 , V_273 ) ;
V_274 = V_270 ;
}
