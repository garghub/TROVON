...
if ( V_30 == V_36 ) {
F_23 ( V_40 , V_43 , ( T_7 ) ( V_43 / 1000 ) , V_41 , V_41 , T_6 , & V_45 , & V_44 ) ;
F_11 ( L_19 , V_46 , V_41 ) ;
V_41 = 0 ;
V_30 = V_47 ;
V_46 ++ ;
...
T_12 * V_4 ;
memset ( V_51 , 0x0 , 255 ) ;
if ( F_25 ( V_7 , V_50 , ( T_7 ) strlen ( V_50 ) ) == V_49 )
return FALSE ;
...
static T_3 F_26 ( T_4 V_16 , const char * V_17 , const char * V_18 , const unsigned long int V_22 )
{
char * V_50 = NULL ;
T_3 V_7 ;
int V_56 = 0 ;
...
V_56 = F_25 ( V_7 , V_58 , ( V_59 ) strlen ( V_58 ) ) ;
V_6 ( V_58 ) ;
if ( V_56 == V_49 )
goto error;
...
static int F_36 ( const char * V_60 , const unsigned int V_61 , const char * V_62 , const char * V_63 ,
...
V_16 = F_39 ( V_60 , V_61 , V_62 , V_63 , V_64 , V_65 , & V_67 ) ;
if ( ! V_16 ) {
F_16 ( L_42 , V_67 ) ;
goto V_69;
}
if ( ! F_40 ( V_40 , 1 , V_70 , FALSE , & V_45 , & V_44 ) ) {
F_16 ( L_43 ) ;
goto V_69;
}
V_7 = F_26 ( V_16 , V_17 , V_18 , V_22 ) ;
if ( ! V_7 ) {
V_56 = V_14 ;
goto V_69;
}
...
static void F_41 ( const char * V_71 )
{
printf ( L_46 ) ;
printf ( L_47 ) ;
printf ( L_48 , V_71 ) ;
...
static int F_42 ( char * V_72 , unsigned int V_2 )
{
unsigned V_73 = 0 ;
char * V_74 ;
if ( ! V_72 ) {
...
int V_56 = V_14 ;
T_13 * V_87 = F_45 ( T_13 , 1 ) ;
#ifdef F_46
T_14 V_88 ;
F_47 () ;
#endif
F_48 ( V_87 , V_89 , V_90 , V_91 , NULL ) ;
F_49 ( V_87 , V_76 , L_98 , 147 , L_99 ) ;
V_92 = 0 ;
V_93 = 0 ;
if ( V_77 == 1 ) {
F_41 ( V_78 [ 0 ] ) ;
...
F_11 ( L_44 ) ;
while ( ( V_79 = F_50 ( V_77 , V_78 , L_101 , V_95 , & V_80 ) ) != - 1 ) {
switch ( V_79 ) {
case V_96 :
F_41 ( V_78 [ 0 ] ) ;
V_56 = V_15 ;
...
if ( V_87 -> V_111 ) {
V_56 = F_42 ( V_87 -> V_72 , V_2 ) ;
goto V_94;
}
#ifdef F_46
V_79 = F_53 ( F_54 ( 1 , 1 ) , & V_88 ) ;
if ( V_79 != 0 ) {
if ( V_98 )
F_16 ( L_107 , V_79 ) ;
goto V_94;
...
int T_15 F_56 ( T_16 V_113 , T_16 V_114 ,
T_17 V_115 , int V_116 ) {
return main ( V_117 , V_118 ) ;
}
