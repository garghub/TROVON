...
V_35 -> V_60 = V_61 ;
V_35 -> V_62 = V_63 ;
V_35 -> V_64 . V_65 = mktime ( & V_46 ) ;
V_35 -> V_64 . V_66 = V_45 * 10000000 ;
V_35 -> V_67 = V_43 ;
V_35 -> V_68 = V_43 ;
F_18 ( V_5 , V_43 ) ;
V_50 = F_19 ( V_5 ) ;
...
static T_3
F_20 ( char * V_69 , T_9 * V_5 , long V_70 ,
int V_71 , int V_72 ) {
int V_40 ;
char * V_73 ;
int V_74 ;
static const int V_75 [ 16 ] = { 39 , 37 , 35 , 33 , 28 , 26 , 24 , 22 , 17 , 15 , 13 , 11 , 6 , 4 , 2 , 0 } ;
char V_76 [ 3 ] = { 0 , 0 , 0 } ;
V_73 = V_69 ;
V_74 = ( int ) strtoul ( V_73 + 45 + V_71 , NULL , 16 ) ;
if ( V_74 != V_70 ) {
return FALSE ;
}
if ( V_72 > 16 )
...
V_76 [ 0 ] = V_69 [ V_75 [ V_40 ] + V_71 ] ;
V_76 [ 1 ] = V_69 [ V_75 [ V_40 ] + 1 + V_71 ] ;
V_5 [ V_70 + V_40 ] = ( T_9 ) strtoul ( V_76 , NULL , 16 ) ;
}
return TRUE ;
}
