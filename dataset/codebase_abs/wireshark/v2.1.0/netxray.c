...
break;
case V_21 :
memset ( & V_100 -> V_116 . V_121 , 0 , sizeof( V_100 -> V_116 . V_121 ) ) ;
if ( V_8 . V_119 . V_120 [ 2 ] == 0xff &&
V_8 . V_119 . V_120 [ 3 ] == 0xff ) {
if ( V_24 -> V_90 ) {
...
V_100 -> V_116 . V_121 . V_126 = TRUE ;
V_100 -> V_116 . V_121 . V_127 =
V_8 . V_119 . V_120 [ 12 ] ;
V_100 -> V_116 . V_121 . V_128 = TRUE ;
V_100 -> V_116 . V_121 . V_129 =
V_8 . V_119 . V_120 [ 13 ] ;
V_100 -> V_116 . V_121 . V_130 = TRUE ;
V_100 -> V_116 . V_121 . V_131 =
V_8 . V_119 . V_120 [ 14 ] ;
if ( V_8 . V_119 . V_120 [ 15 ] != 0xFF ) {
V_100 -> V_116 . V_121 . V_132 = TRUE ;
V_100 -> V_116 . V_121 . V_133 =
V_8 . V_119 . V_120 [ 15 ] * 100 / 127 ;
}
break;
case V_77 :
V_100 -> V_116 . V_134 . V_135 =
( V_8 . V_119 . V_120 [ 12 ] & 0x01 ) ;
V_100 -> V_116 . V_134 . V_127 =
V_8 . V_119 . V_120 [ 13 ] & 0x1F ;
switch ( V_24 -> V_23 ) {
case 1 :
if ( V_100 -> V_116 . V_134 . V_127 == 16 )
V_100 -> V_116 . V_134 . V_127 = 0 ;
else if ( V_100 -> V_116 . V_134 . V_127 > 16 )
V_100 -> V_116 . V_134 . V_127 -= 1 ;
break;
case 2 :
if ( V_100 -> V_116 . V_134 . V_127 == 24 )
V_100 -> V_116 . V_134 . V_127 = 0 ;
else if ( V_100 -> V_116 . V_134 . V_127 > 24 )
V_100 -> V_116 . V_134 . V_127 -= 1 ;
break;
}
if ( V_8 . V_119 . V_120 [ 2 ] == 0xff &&
...
case V_76 :
case V_72 :
V_100 -> V_116 . V_136 . V_137 =
( V_8 . V_119 . V_120 [ 12 ] & 0x01 ) ? 0x00 : V_138 ;
if ( V_8 . V_119 . V_120 [ 2 ] == 0xff &&
V_8 . V_119 . V_120 [ 3 ] == 0xff ) {
V_98 = 4 ;
}
...
case V_79 :
case V_81 :
V_100 -> V_116 . V_139 . V_140 =
( V_8 . V_119 . V_120 [ 12 ] & 0x01 ) ? TRUE : FALSE ;
break;
case V_20 :
V_100 -> V_116 . V_141 . V_137 = 0 ;
if ( V_8 . V_119 . V_120 [ 8 ] & 0x01 )
V_100 -> V_116 . V_141 . V_137 |= V_142 ;
if ( V_8 . V_119 . V_120 [ 9 ] & 0x04 )
V_100 -> V_116 . V_141 . V_137 |= V_143 ;
V_100 -> V_116 . V_141 . V_144 = V_8 . V_119 . V_120 [ 11 ] ;
V_100 -> V_116 . V_141 . V_145 = F_14 ( & V_8 . V_119 . V_120 [ 12 ] ) ;
V_100 -> V_116 . V_141 . V_127 =
( V_8 . V_119 . V_120 [ 15 ] & 0x10 ) ? 1 : 0 ;
V_100 -> V_116 . V_141 . V_146 = 0 ;
switch ( V_8 . V_119 . V_120 [ 0 ] & 0x70 ) {
case 0x00 :
V_100 -> V_116 . V_141 . V_147 = V_148 ;
V_100 -> V_116 . V_141 . type = V_149 ;
V_100 -> V_116 . V_141 . V_150 = V_151 ;
break;
case 0x10 :
V_100 -> V_116 . V_141 . V_147 = V_148 ;
V_100 -> V_116 . V_141 . type = V_149 ;
...
case 0x60 :
case 0x70 :
V_100 -> V_116 . V_141 . V_147 = V_152 ;
switch ( V_8 . V_119 . V_120 [ 0 ] & 0x07 ) {
case 0x01 :
case 0x02 :
V_100 -> V_116 . V_141 . V_147 = V_153 ;
V_100 -> V_116 . V_141 . type = V_149 ;
V_100 -> V_116 . V_141 . V_150 = V_151 ;
break;
case 0x03 :
V_100 -> V_116 . V_141 . type = V_154 ;
V_100 -> V_116 . V_141 . V_150 = V_151 ;
break;
case 0x00 :
case 0x04 :
case 0x05 :
V_100 -> V_116 . V_141 . type = V_155 ;
V_100 -> V_116 . V_141 . V_150 = V_151 ;
break;
case 0x06 :
V_100 -> V_116 . V_141 . type = V_149 ;
...
if ( V_1 -> V_22 == V_20 &&
! ( V_100 -> V_116 . V_141 . V_137 & V_142 ) ) {
if ( V_100 -> V_116 . V_141 . V_147 == V_148 ) {
V_171 = F_15 ( V_107 ) ;
F_16 ( V_100 , V_171 ) ;
} else if ( V_100 -> V_116 . V_141 . V_147 == V_152 &&
V_100 -> V_116 . V_141 . type == V_155 ) {
V_171 = F_15 ( V_107 ) ;
F_17 ( V_100 , V_171 ) ;
}
...
case V_70 :
case V_79 :
V_192 . V_120 [ 12 ] |= V_116 -> V_139 . V_140 ? 0x01 : 0x00 ;
break;
case V_72 :
V_192 . V_120 [ 12 ] |= ( V_116 -> V_136 . V_137 & V_138 ) ? 0x00 : 0x01 ;
break;
}
if ( ! F_25 ( V_181 , & V_192 , sizeof( V_192 ) , V_2 ) )
return FALSE ;
