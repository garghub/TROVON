...
#else
V_41 += F_91 ( V_41 , 12 , L_97 , * V_10 ++ ) ;
#endif
} while( -- T_11 );
if ( V_41 != V_39 ) * ( V_41 - 1 ) = '\0' ; else * ( V_39 ) = '\0' ;
return V_39 ;
}
static T_6 F_92 ( const char * V_155 ) {
...
* V_186 = V_10 = F_93 ( V_184 , T_1 , V_13 ) ;
V_187 = V_10 + V_13 ;
do switch( * V_40 ) {
case '.' :
V_4 = 0 ;
...
return F_94 ( V_184 , V_188 , V_9 , V_186 , TRUE ) ;
}
T_6 F_94 ( T_25 * V_184 , const T_8 * V_188 , T_9 V_9 , T_1 * * V_186 ,
T_18 V_189 ) {
T_9 V_11 ;
T_6 V_13 = V_189 ? 1 : 0 ;
T_1 * V_10 ;
...
* V_186 = V_10 = ( T_1 * ) F_95 ( V_184 , sizeof( T_1 ) * V_13 ) ;
V_190 = V_10 + V_13 ;
if ( V_189 && V_13 == 1 ) {
* V_10 = 0 ;
return V_13 ;
...
T_2 * F_96 ( T_6 T_11 , T_1 * V_10 , T_6 * V_193 , T_6 * V_194 ) {
T_2 * V_195 = & V_1 ;
T_6 V_11 ;
if( ! ( V_10 && * V_10 <= 2 ) ) {
* V_193 = 0 ;
...
T_2 * F_97 ( T_25 * V_184 , const T_8 * V_198 , T_9 V_199 , T_1 * * V_186 , T_6 * V_200 , T_6 * V_201 ) {
T_6 V_22 = F_19 ( V_184 , V_198 , V_199 , V_186 ) ;
return F_96 ( V_22 , * V_186 , V_200 , V_201 ) ;
}
T_2 * F_98 ( T_25 * V_184 , const T_7 * V_20 , T_1 * * V_186 , T_6 * V_193 , T_6 * V_194 ) {
T_6 V_22 = F_17 ( V_184 , V_20 , V_186 ) ;
return F_96 ( V_22 , * V_186 , V_193 , V_194 ) ;
}
T_7 * F_99 ( T_25 * V_184 , const T_8 * V_21 , T_9 V_9 ) {
T_1 * V_202 = NULL ;
T_7 * V_203 ;
T_6 V_204 = F_19 ( NULL , V_21 , V_9 , & V_202 ) ;
V_203 = F_100 ( V_184 , V_204 , V_202 ) ;
F_9 ( NULL , V_202 ) ;
return V_203 ;
}
T_7 * F_101 ( T_25 * V_184 , const T_8 * V_21 , T_9 V_9 ) {
T_1 * V_202 = NULL ;
T_7 * V_203 ;
T_6 V_204 = F_94 ( NULL , V_21 , V_9 , & V_202 , FALSE ) ;
V_203 = F_88 ( V_184 , V_202 , V_204 , FALSE ) ;
F_9 ( NULL , V_202 ) ;
return V_203 ;
}
T_6 F_102 ( T_25 * V_184 , T_6 V_22 , T_1 * V_10 , T_8 * * V_205 ) {
T_6 V_206 = 0 ;
T_6 V_11 ;
T_1 V_4 ;
T_8 * V_207 ;
...
* V_205 = V_207 = ( T_8 * ) F_95 ( V_184 , V_206 ) ;
for ( V_4 = V_10 [ 0 ] * 40 , V_11 = 1 ; V_11 < V_22 ; V_11 ++ , V_4 = 0 ) {
T_6 T_11 ;
V_4 += V_10 [ V_11 ] ;
...
T_7 * F_104 ( T_25 * V_184 , const T_8 * V_208 , T_6 T_11 ) {
T_1 * V_10 = NULL ;
T_7 * V_203 ;
T_6 V_22 = F_94 ( NULL , V_208 , T_11 , & V_10 , FALSE ) ;
if ( V_22 ) {
...
T_6 F_105 ( T_25 * V_184 , const char * V_20 , T_8 * * V_198 ) {
T_1 * V_10 ;
T_1 V_22 ;
T_6 V_199 ;
if ( ( V_22 = F_17 ( NULL , V_20 , & V_10 ) ) &&
( V_199 = F_102 ( V_184 , V_22 , V_10 , V_198 ) ) ) {
F_9 ( NULL , V_10 ) ;
return V_199 ;
}
F_9 ( NULL , V_10 ) ;
...
T_7 * F_106 ( T_25 * V_184 , const T_7 * V_20 ) {
T_1 * V_202 ;
T_6 V_204 ;
T_7 * V_209 ;
V_204 = F_17 ( NULL , V_20 , & V_202 ) ;
V_209 = F_100 ( V_184 , V_204 , V_202 ) ;
F_9 ( NULL , V_202 ) ;
return V_209 ;
}
T_7 * F_100 ( T_25 * V_184 , T_1 V_114 , T_1 * V_10 ) {
T_6 V_193 ;
T_6 V_194 ;
T_2 * V_21 ;
if( ! ( V_10 && * V_10 <= 2 ) )
return F_10 ( V_184 , L_101 ) ;
V_21 = F_96 ( V_114 , V_10 , & V_193 , & V_194 ) ;
while ( ! V_21 -> V_6 ) {
if ( ! ( V_21 = V_21 -> V_16 ) ) {
...
V_203 = F_107 ( V_184 , V_21 -> V_6 ? V_21 -> V_6 : V_210 , L_44 , V_211 , NULL ) ;
F_9 ( NULL , V_210 ) ;
F_9 ( NULL , V_211 ) ;
return V_203 ;
} else {
...
extern void F_108 ( T_25 * V_184 , T_6 V_9 , T_1 * V_10 , T_7 * * V_212 , T_7 * * V_213 ) {
* V_212 = F_100 ( V_184 , V_9 , V_10 ) ;
* V_213 = F_15 ( V_184 , V_10 , V_9 ) ;
}
extern void F_109 ( T_25 * V_184 , const T_8 * V_21 , T_9 V_9 , T_7 * * V_212 , T_7 * * V_213 ) {
T_1 * V_10 = NULL ;
T_6 V_22 = F_19 ( NULL , V_21 , V_9 , & V_10 ) ;
* V_212 = F_100 ( V_184 , V_22 , V_10 ) ;
* V_213 = F_15 ( V_184 , V_10 , V_22 ) ;
F_9 ( NULL , V_10 ) ;
}
void F_110 ( T_25 * V_184 , const T_7 * V_20 , T_7 * * V_212 , T_7 * * V_213 ) {
T_1 * V_10 ;
T_6 V_22 ;
...
continue;
F_26 ( V_148 , F_111 L_104 , V_180 [ V_11 ] . V_6 ) ;
}
...
T_6 V_219 = F_102 ( NULL , V_114 , V_10 , & V_214 ) ;
T_6 V_220 = F_19 ( NULL , V_214 , V_219 , & V_216 ) ;
char * V_221 = F_103 ( NULL , V_214 , V_219 ) ;
T_6 V_222 = F_105 ( NULL , V_218 , & V_215 ) ;
...
L_111
, V_218
, V_219 , F_20 ( F_118 () , V_214 , V_219 , ':' )
, V_216 ? F_15 ( F_118 () , V_216 , V_220 ) : L_14
, V_221
, V_222 , F_20 ( F_118 () , V_215 , V_222 , ':' )
, V_217 ? F_15 ( F_118 () , V_217 , V_223 ) : L_14
) ;
F_9 ( NULL , V_218 ) ;
F_9 ( NULL , V_216 ) ;
F_9 ( NULL , V_214 ) ;
...
void F_119 ( T_2 * V_224 , T_28 * V_225 ) {
...
if ( V_224 -> V_16 ) {
V_228 = F_120 ( V_229 , NULL , 0 , 0 , L_134 ) ;
V_229 = F_121 ( V_228 , 0 ) ;
F_119 ( V_224 -> V_16 , V_229 ) ;
}
}
