...
V_4 = F_738 ( L_1408 , L_1409 , V_927 , V_1006 , V_982 , V_1798 ) ;
F_725 () ;
}
void F_739 ( void ) {
int V_908 ;
...
T_26 V_1802 ;
T_26 V_1803 ;
V_1799 = F_740 ( L_1410 , V_927 ) ;
V_14 = F_740 ( L_1411 , V_927 ) ;
V_1800 = F_741 ( F_700 , V_927 ) ;
V_1801 = F_741 ( F_714 , V_927 ) ;
for ( V_908 = 0 ; V_908 < ( int ) F_697 ( V_909 ) ; V_908 ++ ) {
F_742 ( L_1412 , V_909 [ V_908 ] . V_907 , V_1800 ) ;
F_742 ( L_1413 , V_909 [ V_908 ] . V_907 , V_1801 ) ;
V_962 = V_909 [ V_908 ] . V_907 ;
V_963 = ( const T_17 * ) F_703 ( V_964 , & V_962 ) ;
if ( V_963 ) {
F_743 ( L_1414 , V_963 , V_1800 ) ;
F_743 ( L_1415 , V_963 , V_1801 ) ;
}
}
V_1802 = F_741 ( F_715 , V_927 ) ;
for ( V_908 = 0 ; V_908 < ( int ) F_697 ( V_913 ) ; V_908 ++ ) {
F_742 ( L_1416 , V_913 [ V_908 ] . V_912 , V_1802 ) ;
}
V_1803 = F_741 ( F_723 , V_927 ) ;
F_742 ( L_1411 , V_957 | V_958 , V_1803 ) ;
V_1803 = F_741 ( F_724 , V_927 ) ;
F_742 ( L_1411 , V_959 | V_960 , V_1803 ) ;
F_743 ( L_1417 , L_1418 , V_1799 ) ;
}
