...
static int
F_40 ( unsigned char * V_284 , T_18 V_285 , unsigned char * V_286 ,
T_18 V_287 , int * V_2 , T_3 * * V_3 )
{
unsigned char * V_288 = V_284 ;
unsigned char * V_289 = V_286 ;
unsigned char * V_290 = V_288 + V_285 ;
unsigned char * V_291 = V_289 + V_287 ;
unsigned int V_292 ;
...
{
V_294 = ( unsigned int ) ( ( * V_288 ) >> 4 ) & 0xF ;
V_295 = ( unsigned int ) ( ( * V_288 ) & 0xF ) ;
V_288 ++ ;
switch ( V_294 )
{
case 0 :
...
case 1 :
F_41 ( 1 ) ;
V_98 = V_295 + ( ( unsigned int ) ( * V_288 ++ ) << 4 ) + 19 ;
F_43 ( V_98 ) ;
break;
case 2 :
V_298 ;
F_41 ( 1 ) ;
V_98 = ( unsigned int ) ( * V_288 ++ ) + 16 ;
F_44 ( V_296 , V_98 ) ;
break;
default :
V_298 ;
...
T_19 V_299 ;
T_20 * V_300 ;
unsigned char * V_301 = ( unsigned char * ) V_88 ;
T_21 * V_302 ;
unsigned int V_303 ;
unsigned int V_304 ;
V_21 = ( T_6 * ) V_1 -> V_44 ;
...
if ( V_1 -> V_33 == V_35 ) {
if ( ! F_12 ( V_299 , V_88 , V_48 , V_2 , V_3 ) )
return FALSE ;
V_300 -> V_50 += V_48 ;
V_300 -> V_51 += V_48 ;
return TRUE ;
...
if ( V_300 -> V_47 == NULL ) {
V_300 -> V_47 = ( unsigned char * ) F_11 ( V_305 ) ;
if ( V_119 ) {
V_21 -> V_54 = V_21 -> V_52 ;
} else {
if ( V_1 -> V_42 != NULL ) {
F_45 ( V_21 -> V_52 == NULL ) ;
V_302 = F_46 ( T_21 , 1 ) ;
V_302 -> V_306 = V_300 -> V_51 ;
V_302 -> V_307 = V_300 -> V_50 ;
V_21 -> V_52 = F_47 ( V_21 -> V_52 ,
V_302 ) ;
V_21 -> V_53 = V_21 -> V_52 ;
}
}
if ( ! F_48 ( V_299 , V_300 , V_2 , V_3 ) )
return FALSE ;
}
while ( V_48 > 0 ) {
V_304 = V_300 -> V_48 - V_300 -> V_49 ;
if ( V_304 == 0 ) {
if ( V_119 ) {
...
if ( V_303 > V_304 )
V_303 = V_304 ;
memcpy ( V_301 , & V_300 -> V_47 [ V_300 -> V_49 ] ,
V_303 ) ;
V_48 -= V_303 ;
V_301 += V_303 ;
V_300 -> V_49 += V_303 ;
...
static T_9
F_48 ( T_19 V_299 , T_20 * V_300 , int * V_2 ,
T_3 * * V_3 )
{
int V_309 ;
...
V_313 = ( unsigned char * ) F_11 ( V_315 ) ;
if ( ! F_4 ( V_299 , V_313 , V_309 , V_2 , V_3 ) ) {
F_32 ( V_313 ) ;
return FALSE ;
}
V_300 -> V_51 += V_309 ;
if ( V_312 ) {
memcpy ( V_300 -> V_47 , V_313 , V_309 ) ;
V_314 = V_309 ;
} else {
V_314 = F_40 ( V_313 , V_309 ,
V_300 -> V_47 , V_305 , V_2 ,
V_3 ) ;
if ( V_314 < 0 ) {
F_32 ( V_313 ) ;
return FALSE ;
...
static T_9
F_18 ( T_2 * V_1 , T_5 V_296 , int * V_2 , T_3 * * V_3 )
{
T_6 * V_21 ;
T_5 V_316 ;
T_22 * V_318 , * V_319 ;
...
V_21 = ( T_6 * ) V_1 -> V_44 ;
if ( V_1 -> V_33 == V_35 ) {
if ( F_10 ( V_1 -> V_42 , V_296 , V_43 , V_2 ) == - 1 )
return FALSE ;
return TRUE ;
}
V_316 = V_296 - V_21 -> rand . V_50 ;
V_318 = NULL ;
if ( V_316 > 0 ) {
...
V_320 = ( T_21 * ) V_319 -> V_265 ;
if ( V_320 -> V_307 > V_296 )
break;
V_318 = V_319 ;
}
if ( V_318 == NULL ) {
...
while ( V_318 ) {
V_321 = ( T_21 * ) V_318 -> V_265 ;
if ( V_321 -> V_307 <= V_296 )
break;
V_318 = F_51 ( V_318 ) ;
}
if ( V_318 == NULL ) {
...
if ( V_318 != NULL ) {
V_321 = ( T_21 * ) V_318 -> V_265 ;
if ( F_10 ( V_1 -> V_42 , V_321 -> V_306 , V_43 , V_2 ) == - 1 )
return FALSE ;
if ( V_21 -> rand . V_47 == NULL ) {
V_21 -> rand . V_47 = ( unsigned char * ) F_11 ( V_305 ) ;
}
V_21 -> V_54 = V_318 ;
