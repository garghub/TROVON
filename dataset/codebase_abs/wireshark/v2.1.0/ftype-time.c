...
static T_1
F_9 ( T_2 * V_13 , const char * V_14 , T_1 T_3 V_15 , T_4 * * V_16 )
{
const char * V_17 ;
char * V_18 ;
T_1 V_19 = FALSE ;
...
static T_1
F_11 ( T_2 * V_13 , const char * V_14 , T_4 * * V_16 )
{
struct V_21 V_21 ;
char * V_17 ;
...
static T_1
F_12 ( T_2 * V_13 , const char * V_14 , T_1 T_3 V_15 , T_4 * * V_16 )
{
return F_11 ( V_13 , V_14 , V_16 ) ;
}
static void
F_13 ( T_2 * V_13 )
{
...
static int
F_16 ( T_2 * V_13 , T_7 V_23 , int T_8 V_15 )
{
T_4 * V_24 ;
int V_25 ;
V_24 = F_17 ( NULL , & V_13 -> V_3 . time , V_26 ,
V_23 == V_27 ) ;
...
static void
F_19 ( T_2 * V_13 , T_7 V_23 , int T_8 V_15 , char * V_29 , unsigned int V_30 )
{
T_4 * V_24 = F_17 ( NULL , & V_13 -> V_3 . time , V_26 ,
V_23 == V_27 ) ;
if ( V_23 == V_28 ) {
* V_29 ++ = '\"' ;
}
...
static int
F_21 ( T_2 * V_13 , T_7 V_23 V_15 , int T_8 V_15 )
{
T_4 * V_24 ;
int V_25 ;
V_24 = F_22 ( NULL , & V_13 -> V_3 . time ) ;
V_25 = ( int ) strlen ( V_24 ) ;
F_18 ( NULL , V_24 ) ;
return V_25 ;
}
static void
F_23 ( T_2 * V_13 , T_7 V_23 V_15 , int T_8 V_15 , char * V_29 , unsigned int V_30 )
{
T_4 * V_24 ;
V_24 = F_22 ( NULL , & V_13 -> V_3 . time ) ;
F_20 ( V_29 , V_24 , V_30 ) ;
