...
#endif
if ( V_108 )
V_109 = L_48 F_82 L_49 ;
else
V_109 = L_50 F_82 L_49 ;
break;
default:
F_83 ( V_110 , sizeof( V_110 ) ,
L_51 ,
V_108 ? L_52 : L_53 ,
F_84 ( V_107 ) ) ;
V_109 = V_110 ;
...
T_5
F_66 ( const char * V_115 )
{
T_1 V_116 ;
if ( ! V_115 ) {
return FALSE ;
}
#if F_12 ( V_117 ) && V_117 < 1900
V_116 . V_118 = 1 ;
F_7 ( V_115 , & V_116 ) ;
if ( V_116 . V_118 == 0 ) {
return TRUE ;
...
T_5
F_86 ( const char * V_119 , const char * V_120 )
{
#ifdef F_2
char V_121 [ V_97 ] , V_122 [ V_97 ] ;
if( F_87 ( V_121 , V_119 , V_97 ) == NULL ) {
return FALSE ;
}
if( F_87 ( V_122 , V_120 , V_97 ) == NULL ) {
return FALSE ;
}
...
T_5
F_67 ( const char * V_126 , const char * V_127 )
{
int V_128 , V_129 , V_107 ;
T_3 V_130 , V_131 ;
T_11 * V_132 = NULL ;
V_128 = F_88 ( V_126 , V_133 | V_134 , 0000 ) ;
if ( V_128 < 0 ) {
F_89 ( V_126 , V_6 , FALSE ) ;
goto V_135;
}
V_129 = F_88 ( V_127 , V_136 | V_137 | V_138 | V_134 , 0644 ) ;
if ( V_129 < 0 ) {
F_89 ( V_127 , V_6 , TRUE ) ;
F_90 ( V_128 ) ;
goto V_135;
...
#define F_91 65536
V_132 = ( T_11 * ) F_13 ( F_91 ) ;
while ( ( V_130 = F_92 ( V_128 , V_132 , F_91 ) ) > 0 ) {
V_131 = F_93 ( V_129 , V_132 , V_130 ) ;
if ( V_131 < V_130 ) {
if ( V_131 < 0 )
V_107 = V_6 ;
else
