...
static T_9
F_15 ( T_6 * V_14 , T_10 * V_56 , T_11 * V_43 , int V_57 )
{
T_12 * V_58 ;
T_13 * V_59 ;
int V_60 , V_21 ;
...
V_14 -> V_63 [ V_57 ] = TRUE ;
while ( V_43 ) {
V_58 = F_16 ( V_56 , V_43 -> V_15 ) ;
if ( ( V_58 == NULL ) || ( F_17 ( V_58 ) == 0 ) ) {
V_43 = V_43 -> V_65 ;
continue;
}
else {
...
static T_9
F_19 ( T_6 * V_14 , T_15 * V_66 , int V_57 )
{
V_14 -> V_64 [ V_57 ] = F_20 ( NULL , V_66 ) ;
return TRUE ;
}
static T_9
F_21 ( T_6 * V_14 , T_16 V_67 , int V_68 , int V_69 )
{
T_14 * V_70 , * V_71 ;
V_70 = V_14 -> V_64 [ V_68 ] ;
while ( V_70 ) {
...
static void
F_25 ( T_6 * V_14 , int V_73 , int V_74 , T_18 * V_75 )
{
T_14 * V_76 , * V_77 ;
T_15 * V_78 , * V_79 ;
V_77 = NULL ;
