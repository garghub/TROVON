...
V_2 += F_28 ( V_1 , V_2 , V_117 , L_32 ) ;
V_20 = F_15 ( V_1 , V_2 + 1 ) ;
if ( V_20 + 3 + V_2 + 1 < V_115 )
V_2 += F_28 ( V_1 , V_2 , V_117 , L_33 ) ;
}
F_28 ( V_1 , V_2 , V_117 , L_34 ) ;
break;
}
case V_131 :
{
...
static int
F_33 ( T_1 * V_1 , T_10 * V_140 , T_3 * V_3 , void * T_11 V_141 )
{
#define F_34 12
...
F_36 ( V_140 -> V_150 , V_151 , L_36 ) ;
F_37 ( V_140 -> V_150 , V_152 ) ;
V_142 = F_15 ( V_1 , 0 ) ;
if ( V_142 == 1 ) {
V_149 = F_30 ( V_114 , & V_121 , L_23 ) ;
}
F_38 ( V_140 -> V_150 , V_152 , L_21 , V_149 ) ;
V_143 = F_15 ( V_1 , 8 ) ;
V_144 = F_19 ( V_1 , 10 ) ;
V_145 = F_19 ( V_1 , 11 ) ;
if ( V_3 ) {
T_4 * V_153 ;
V_153 = F_2 ( V_3 , V_154 , V_1 , 0 , - 1 , V_18 ) ;
F_16 ( V_153 , L_37 ,
F_30 ( V_114 , & V_121 , L_23 ) ) ;
V_147 = F_3 ( V_153 , V_155 ) ;
F_2 ( V_147 , V_156 , V_1 , 0 , 2 , V_7 ) ;
F_2 ( V_147 , V_157 , V_1 , 2 , 1 , V_7 ) ;
F_2 ( V_147 , V_158 , V_1 , 3 , 1 , V_7 ) ;
F_2 ( V_147 , V_159 , V_1 , 4 , 2 , V_7 ) ;
F_2 ( V_147 , V_76 , V_1 , 6 , 2 , V_7 ) ;
F_2 ( V_147 , V_160 , V_1 , 8 , 2 , V_7 ) ;
F_2 ( V_147 , V_161 , V_1 , 10 , 1 , V_7 ) ;
F_2 ( V_147 , V_6 , V_1 , 11 , 1 , V_7 ) ;
}
V_146 = F_39 ( & V_162 ,
V_1 , F_35 ,
V_140 ,
...
V_135 = F_31 ( V_1 , F_35 ) ;
if ( V_145 ) {
F_40 ( V_140 -> V_150 , V_152 ,
L_38 , V_144 ) ;
F_41 ( V_1 , F_35 , V_140 ,
L_39 , V_146 , & V_163 ,
NULL , V_147 ) ;
F_42 ( V_135 , V_140 , V_3 ) ;
} else {
if ( V_144 > 0 ) {
V_148 = F_41 ( V_1 , F_35 , V_140 ,
L_39 , V_146 , & V_163 ,
NULL , V_147 ) ;
if ( V_148 ) {
F_36 ( V_140 -> V_150 , V_152 , L_40 ) ;
F_43 ( V_140 -> V_150 , V_152 , L_41 , V_149 ) ;
V_135 = V_148 ;
V_20 = F_32 ( V_135 ) ;
}
}
if ( V_3 ) {
F_29 ( V_135 , V_147 , V_114 , V_20 ) ;
}
}
return F_44 ( V_1 ) ;
}
...
{ & V_157 ,
{ L_45 , L_46 ,
V_169 , V_170 , F_50 ( V_171 ) , 0x0 ,
L_47 , V_168 } } ,
{ & V_158 ,
{ L_48 , L_49 ,
V_169 , V_167 | V_172 , & V_121 , 0x0 ,
NULL , V_168 } } ,
{ & V_159 ,
{ L_50 , L_51 ,
V_166 , V_170 , NULL , 0x0 ,
NULL , V_168 } } ,
{ & V_76 ,
{ L_52 , L_53 ,
V_166 , V_167 , NULL , 0x0 ,
...
{ & V_9 ,
{ L_63 , L_64 ,
V_175 , 8 , F_51 ( & V_176 ) , V_177 ,
L_65 , V_168 } } ,
{ & V_10 ,
{ L_66 , L_67 ,
V_175 , 8 , F_51 ( & V_178 ) , V_179 ,
L_68 , V_168 } } ,
{ & V_11 ,
{ L_69 , L_70 ,
V_175 , 8 , F_51 ( & V_180 ) , V_181 ,
L_71 , V_168 } } ,
{ & V_12 ,
{ L_72 , L_73 ,
V_175 , 8 , F_51 ( & V_182 ) , V_128 ,
L_74 , V_168 } } ,
{ & V_13 ,
{ L_75 , L_76 ,
V_175 , 8 , F_51 ( & V_183 ) , V_184 ,
L_77 , V_168 } } ,
{ & V_14 ,
{ L_78 , L_79 ,
V_175 , 8 , F_51 ( & V_185 ) , V_186 ,
L_80 , V_168 } } ,
{ & V_15 ,
{ L_81 , L_82 ,
V_175 , 8 , F_51 ( & V_187 ) , V_188 ,
L_83 , V_168 } } ,
{ & V_16 ,
{ L_50 , L_84 ,
V_175 , 8 , F_51 ( & V_189 ) , V_190 ,
L_85 , V_168 } } ,
{ & V_75 ,
{ L_45 , L_86 ,
V_169 , V_170 , F_50 ( V_191 ) , 0x0 ,
L_87 , V_168 } } ,
{ & V_45 ,
{ L_69 , L_88 ,
V_173 , V_174 , NULL , 0x0 ,
...
{ & V_130 ,
{ L_178 , L_179 ,
V_169 , V_170 , F_50 ( V_195 ) , 0x0 ,
NULL , V_168 } } ,
{ & V_196 ,
{ L_180 , L_181 ,
V_197 , V_174 , NULL , 0x00 ,
NULL , V_168 } } ,
{ & V_198 ,
{ L_182 , L_183 ,
V_199 , V_174 , NULL , 0x00 ,
NULL , V_168 } } ,
{ & V_200 ,
{ L_184 , L_185 ,
V_175 , V_174 , NULL , 0x00 ,
NULL , V_168 } } ,
{ & V_201 ,
{ L_186 , L_187 ,
V_175 , V_174 , NULL , 0x00 ,
...
V_154 = F_52 ( L_200 , L_36 , L_201 ) ;
F_53 ( & F_45 ) ;
F_54 ( & F_47 ) ;
F_55 ( V_154 , V_165 , F_56 ( V_165 ) ) ;
F_57 ( V_209 , F_56 ( V_209 ) ) ;
V_212 = F_58 ( L_201 , F_33 , V_154 ) ;
}
void
F_59 ( void )
{
F_60 ( L_202 , V_213 , V_212 ) ;
}
