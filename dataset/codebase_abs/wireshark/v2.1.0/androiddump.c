...
static int F_39 ( T_9 * V_92 , const char * V_111 , unsigned short * V_112 ) {
...
V_84 = F_40 ( ( char * ) V_114 , V_15 , V_118 , 15 + V_160 , V_95 ) ;
if ( V_84 <= 0 || V_84 > V_15 ) {
F_4 ( L_40 ) ;
F_26 ( V_63 ) ;
return V_161 ;
...
V_84 = F_40 ( ( char * ) V_114 , V_15 , V_177 , strlen ( V_177 ) - 6 + strlen ( V_174 ) , V_174 ) ;
if ( V_84 <= 0 || V_84 > V_15 ) {
F_4 ( L_45 ) ;
F_26 ( V_63 ) ;
return V_178 ;
...
static int F_44 ( char * V_1 , char * V_4 ,
