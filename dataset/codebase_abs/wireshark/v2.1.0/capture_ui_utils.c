...
T_1 *
F_34 ( const T_1 * V_51 , const T_5 * V_28 )
{
if ( V_51 && V_51 [ 0 ] ) {
#ifdef F_27
T_1 * V_36 = V_28 -> V_32 ? V_28 -> V_32 : V_28 -> V_31 ;
return F_20 ( L_5 , V_51 , V_36 ) ;
#else
return F_20 ( L_5 , V_51 , V_28 -> V_31 ) ;
#endif
}
if ( V_28 -> V_32 ) {
#ifdef F_27
return F_20 ( L_7 , V_28 -> V_32 ) ;
#else
return F_20 ( L_5 , V_28 -> V_32 , V_28 -> V_31 ) ;
#endif
}
if ( V_28 -> V_33 ) {
return F_20 ( L_5 , V_28 -> V_33 , V_28 -> V_31 ) ;
}
return F_3 ( V_28 -> V_31 ) ;
}
