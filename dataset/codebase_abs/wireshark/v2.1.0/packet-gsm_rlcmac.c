...
static void
F_36 ( T_4 * T_5 , T_8 * T_9 , T_2 * T_3 , T_19 * V_42 )
{
T_15 * V_45 ;
T_2 * V_46 ;
T_20 V_44 ;
...
L_29 ) ;
V_46 = F_23 ( V_45 , V_51 ) ;
if ( ( V_43 > 8 ) && ( F_37 ( T_5 , 0 , 9 , V_23 ) == 0x1F9 ) )
{
F_19 ( & V_44 , 0 , V_43 , T_9 ) ;
F_25 ( V_46 , & V_44 , F_26 ( V_227 ) , T_5 , & V_42 -> V_47 . V_228 , V_51 ) ;
}
else if ( ( V_43 > 8 ) && ( F_20 ( T_5 , 0 , 6 ) == 0x37 ) )
{
F_19 ( & V_44 , 0 , V_43 , T_9 ) ;
F_25 ( V_46 , & V_44 , F_26 ( V_229 ) , T_5 , & V_42 -> V_47 . V_230 , V_51 ) ;
}
else if ( F_20 ( T_5 , 0 , 6 ) == 0x1F )
{
F_19 ( & V_44 , 0 , V_43 , T_9 ) ;
F_25 ( V_46 , & V_44 , F_26 ( V_231 ) , T_5 , & V_42 -> V_47 . V_232 , V_51 ) ;
}
else if ( F_20 ( T_5 , 0 , 3 ) == 0x0 )
{
F_19 ( & V_44 , 0 , V_43 , T_9 ) ;
F_25 ( V_46 , & V_44 , F_26 ( V_233 ) , T_5 , & V_42 -> V_47 . V_234 , V_51 ) ;
}
else
{
F_32 ( T_3 , T_9 , & V_235 , T_5 , 0 , - 1 ) ;
F_16 ( T_5 , T_9 , T_3 ) ;
}
}
static void
F_38 ( T_4 * T_5 , T_8 * T_9 , T_2 * T_3 , T_19 * V_42 )
{
T_20 V_44 ;
T_10 V_172 = F_20 ( T_5 , 0 , 2 ) ;
T_17 V_43 = F_29 ( T_5 ) * 8 ;
...
V_42 -> V_178 & 0x0F ) ;
V_46 = F_23 ( V_45 , V_51 ) ;
V_42 -> V_47 . V_236 . V_237 = 0 ;
V_42 -> V_47 . V_236 . V_238 = 0 ;
F_19 ( & V_44 , 0 , V_43 , T_9 ) ;
F_25 ( V_46 , & V_44 , F_26 ( V_239 ) , T_5 , & V_42 -> V_47 . V_236 , V_51 ) ;
T_6 = V_44 . T_6 ;
V_27 = V_42 -> V_47 . V_236 . V_181 ;
T_6 += 8 * F_7 ( T_5 , V_46 , T_9 ,
T_6 / 8 ,
& V_25 ,
V_26 ,
& V_27 ) ;
if ( V_42 -> V_47 . V_236 . V_237 )
{
F_8 ( V_46 , V_240 , T_5 , T_6 , 32 , V_23 ) ;
T_6 += 32 ;
}
if ( V_42 -> V_47 . V_236 . V_238 )
{
F_8 ( V_46 , V_241 , T_5 , T_6 , 7 , V_23 ) ;
T_6 += 7 ;
...
{
F_21 ( T_3 , V_49 , T_5 , T_6 >> 3 , - 1 , L_32 ) ;
F_24 ( T_9 -> V_52 , V_53 , L_16 , L_21 ) ;
}
else if ( V_42 -> V_178 == V_188 )
{
...
{
F_34 ( T_3 , T_9 , & V_203 , T_5 , T_6 >> 3 , - 1 , L_33 ,
V_42 -> V_178 & 0x0F ) ;
}
}
static void
F_39 ( T_4 * T_5 , T_8 * T_9 , T_2 * T_3 , T_19 * V_42 , T_22 * V_204 )
{
if ( V_42 -> V_205 & V_206 )
{
F_32 ( T_3 , T_9 , & V_207 , T_5 , 0 , - 1 ) ;
...
L_35 ) ;
V_46 = F_23 ( V_45 , V_51 ) ;
V_42 -> V_47 . V_242 . V_238 = 0 ;
V_204 -> V_208 = V_209 ;
F_19 ( & V_44 , 0 , V_43 , T_9 ) ;
switch ( V_42 -> V_178 )
{
case V_210 :
F_25 ( V_46 , & V_44 , F_26 ( V_243 ) , T_5 , & V_42 -> V_47 . V_242 , V_51 ) ;
V_204 -> V_208 = V_213 [ V_42 -> V_47 . V_242 . V_214 ] ;
break;
case V_215 :
F_25 ( V_46 , & V_44 , F_26 ( V_244 ) , T_5 , & V_42 -> V_47 . V_242 , V_51 ) ;
V_204 -> V_208 = V_217 [ V_42 -> V_47 . V_242 . V_214 ] ;
break;
case V_218 :
F_25 ( V_46 , & V_44 , F_26 ( V_245 ) , T_5 , & V_42 -> V_47 . V_242 , V_51 ) ;
V_204 -> V_208 = V_220 [ V_42 -> V_47 . V_242 . V_214 ] ;
break;
default:
F_32 ( T_3 , T_9 , & V_221 , T_5 , 0 , - 1 ) ;
break;
}
V_204 -> V_47 . V_246 . V_247 = V_42 -> V_47 . V_242 . V_238 ;
V_204 -> V_47 . V_246 . V_223 = V_42 -> V_47 . V_242 . V_224 ;
V_204 -> V_47 . V_246 . V_225 = ( V_42 -> V_47 . V_242 . V_224 + V_42 -> V_47 . V_242 . V_226 ) % 2048 ;
}
}
static void
F_40 ( T_4 * T_5 , T_8 * T_9 , T_2 * T_3 , T_19 * V_42 , T_23 * V_246 )
{
T_15 * V_45 ;
T_2 * V_248 ;
T_12 V_28 = 0 ;
...
T_14 V_27 , V_249 ;
T_17 V_250 ;
V_250 = ( V_42 -> V_205 & V_251 ) ? V_246 -> V_225 : V_246 -> V_223 ;
F_24 ( T_9 -> V_52 , V_53 , L_16 , L_36 ) ;
V_45 = F_21 ( T_3 , V_49 , T_5 , V_28 , - 1 ,
L_37 ,
( V_42 -> V_205 & V_251 ) ? 2 : 1 ,
V_250 ) ;
V_248 = F_23 ( V_45 , V_252 ) ;
F_11 ( V_248 , V_253 , T_5 , 6 , 1 , & V_249 , V_23 ) ;
F_11 ( V_248 , V_35 , T_5 , 7 , 1 , & V_27 , V_23 ) ;
V_28 ++ ;
V_28 += F_12 ( T_5 , V_248 , T_9 , V_28 ,
& V_25 ,
V_26 ,
& V_27 ) ;
if ( V_249 )
{
F_8 ( V_248 , V_240 , T_5 , V_28 * 8 , 32 , V_23 ) ;
V_28 += 4 ;
}
if ( V_246 -> V_247 )
{
F_8 ( V_248 , V_241 , T_5 , V_28 * 8 , 7 , V_23 ) ;
F_11 ( V_248 , V_35 , T_5 , ( V_28 * 8 ) + 7 , 1 , & V_27 , V_23 ) ;
V_28 ++ ;
}
if ( V_27 )
{
F_17 ( T_5 , T_9 , V_248 , V_28 ,
F_29 ( T_5 ) , V_25 , V_26 ) ;
}
else
{
...
static void
F_41 ( T_4 * T_5 , T_8 * T_9 , T_2 * T_3 , T_21 * V_42 , T_24 * V_222 )
{
T_15 * V_45 ;
T_2 * V_248 ;
T_12 V_28 = 0 ;
...
T_10 V_25 = F_30 ( V_26 ) ;
T_14 V_254 , V_27 ;
V_250 = ( V_42 -> V_205 & V_251 ) ? V_222 -> V_225 : V_222 -> V_223 ;
F_24 ( T_9 -> V_52 , V_53 , L_16 , L_36 ) ;
V_45 = F_21 ( T_3 , V_49 , T_5 , V_28 , - 1 ,
L_38 ,
( V_42 -> V_205 & V_251 ) ? 2 : 1 ,
V_250 ) ;
V_248 = F_23 ( V_45 , V_252 ) ;
F_11 ( V_248 , V_255 , T_5 , 6 , 1 , & V_254 , V_23 ) ;
F_11 ( V_248 , V_35 , T_5 , 7 , 1 , & V_27 , V_23 ) ;
V_28 ++ ;
V_28 += F_12 ( T_5 , V_248 , T_9 , 1 ,
& V_25 ,
V_26 ,
& V_27 ) ;
if ( V_27 )
...
static int
F_42 ( T_4 * T_5 , T_8 * T_9 , T_2 * T_3 , void * V_42 )
{
T_21 * V_256 ;
T_22 * V_204 = ( T_22 * ) V_42 ;
V_256 = F_43 ( F_44 () , T_21 ) ;
if ( ( V_204 != NULL ) && ( V_204 -> V_257 == V_258 ) )
{
V_256 -> V_178 = V_204 -> V_178 ;
V_256 -> V_205 = V_204 -> V_205 ;
}
else
{
V_256 -> V_178 = V_188 ;
...
case V_260 :
case V_261 :
F_28 ( T_5 , T_9 , T_3 , V_256 ) ;
break;
case V_218 :
case V_215 :
case V_210 :
if ( V_256 -> V_205 & ( V_262 | V_251 ) )
{
F_41 ( T_5 , T_9 , T_3 , V_256 , & V_204 -> V_47 . V_222 ) ;
}
else
{
F_35 ( T_5 , T_9 , T_3 , V_256 , V_204 ) ;
}
break;
default:
F_34 ( T_3 , T_9 , & V_263 , T_5 , 0 , - 1 , L_39 , V_256 -> V_178 ) ;
break;
}
return F_29 ( T_5 ) ;
}
static int
F_45 ( T_4 * T_5 , T_8 * T_9 , T_2 * T_3 , void * V_42 )
{
T_19 * V_264 ;
T_22 * V_204 = ( T_22 * ) V_42 ;
V_264 = F_43 ( F_44 () , T_19 ) ;
if ( ( V_204 != NULL ) && ( V_204 -> V_257 == V_258 ) )
{
V_264 -> V_178 = V_204 -> V_178 ;
V_264 -> V_205 = V_204 -> V_205 ;
}
else if ( F_29 ( T_5 ) < 3 )
{
V_264 -> V_178 = V_265 ;
...
{
case V_265 :
F_36 ( T_5 , T_9 , T_3 , V_264 ) ;
break;
case V_188 :
case V_259 :
case V_260 :
case V_261 :
F_38 ( T_5 , T_9 , T_3 , V_264 ) ;
break;
case V_218 :
case V_215 :
case V_210 :
if ( V_264 -> V_205 & ( V_262 | V_251 ) )
{
F_40 ( T_5 , T_9 , T_3 , V_264 , & V_204 -> V_47 . V_246 ) ;
}
else
{
F_39 ( T_5 , T_9 , T_3 , V_264 , V_204 ) ;
}
break;
default:
F_34 ( T_3 , T_9 , & V_263 , T_5 , 0 , - 1 , L_39 , V_264 -> V_178 ) ;
break;
}
return F_29 ( T_5 ) ;
}
...
{ & V_282 ,
{ L_54 , L_55 ,
V_279 , V_280 , F_48 ( & V_283 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_253 ,
{ L_56 , L_57 ,
V_279 , V_280 , F_48 ( & V_284 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_285 ,
{ L_58 , L_59 ,
V_279 , V_280 , F_48 ( & V_286 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_287 ,
...
{ & V_289 ,
{ L_62 , L_63 ,
V_270 , V_271 , F_47 ( V_290 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_291 ,
{ L_64 , L_65 ,
V_270 , V_292 | V_293 , & V_294 , 0x0 ,
NULL , V_273
}
} ,
{ & V_295 ,
{ L_64 , L_65 ,
V_270 , V_292 | V_293 , & V_296 , 0x0 ,
NULL , V_273
}
} ,
{ & V_297 ,
{ L_64 , L_65 ,
V_270 , V_292 | V_293 , & V_298 , 0x0 ,
NULL , V_273
}
} ,
{ & V_34 ,
{ L_66 , L_67 ,
V_270 , V_271 , F_47 ( V_299 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_300 ,
...
{ & V_412 ,
{ L_282 , L_283 ,
V_270 , V_271 , F_47 ( V_413 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_414 ,
{ L_284 , L_285 ,
V_270 , V_271 , F_47 ( V_415 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_416 ,
{ L_286 , L_287 ,
V_270 , V_271 , F_47 ( V_417 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_418 ,
...
{ & V_455 ,
{ L_355 , L_356 ,
V_279 , V_280 , F_48 ( & V_456 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_457 ,
{ L_357 , L_358 ,
V_270 , V_271 | V_293 , & V_50 , 0x0 ,
NULL , V_273
}
} ,
{ & V_458 ,
{ L_359 , L_360 ,
V_270 , V_271 , F_47 ( V_459 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_460 ,
...
{ & V_616 ,
{ L_652 , L_653 ,
V_270 , V_271 , F_47 ( V_617 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_618 ,
{ L_654 , L_655 ,
V_279 , V_280 , F_48 ( & V_619 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_620 ,
...
{ & V_926 ,
{ L_1157 , L_1158 ,
V_270 , V_271 , F_47 ( V_927 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_928 ,
{ L_1159 , L_1160 ,
V_270 , V_271 , F_47 ( V_929 ) , 0x0 ,
NULL , V_273
}
} ,
{ & V_930 ,
...
#endif
{ & V_20 , { L_587 , L_2070 , V_277 , V_271 , NULL , 0x0 , NULL , V_273 } } ,
{ & V_21 , { L_589 , L_2071 , V_277 , V_271 , NULL , 0x0 , NULL , V_273 } } ,
{ & V_22 , { L_583 , L_2072 , V_277 , V_271 , NULL , 0x0 , NULL , V_273 } } ,
} ;
static T_26 V_1465 [] = {
{ & V_33 , { L_2073 , V_1466 , V_1467 , L_2074 , V_1468 } } ,
{ & V_182 , { L_2075 , V_1469 , V_1467 , L_2076 , V_1468 } } ,
{ & V_203 , { L_2077 , V_1470 , V_1471 , L_2078 , V_1468 } } ,
{ & V_207 , { L_2079 , V_1466 , V_1471 , L_2080 , V_1468 } } ,
{ & V_221 , { L_2081 , V_1466 , V_1471 , L_2082 , V_1468 } } ,
{ & V_263 , { L_2083 , V_1470 , V_1471 , L_2084 , V_1468 } } ,
{ & V_235 , { L_2085 , V_1470 , V_1471 , L_2086 , V_1468 } } ,
{ & V_1472 , { L_2087 , V_1466 , V_1471 , L_2088 , V_1468 } } ,
} ;
T_27 * V_1473 ;
V_49 = F_49 ( L_2089 ,
L_2090 , L_2091 ) ;
F_50 ( V_49 , V_268 , F_30 ( V_268 ) ) ;
F_51 ( V_266 , F_30 ( V_266 ) ) ;
V_1473 = F_52 ( V_49 ) ;
F_53 ( V_1473 , V_1465 , F_30 ( V_1465 ) ) ;
F_54 ( L_2092 , F_45 , V_49 ) ;
F_54 ( L_2093 , F_42 , V_49 ) ;
}
void F_55 ( void )
{
V_1474 = F_56 ( L_2094 ) ;
