...
T_1 * V_1 ;
char V_68 [ V_69 * 4 ] ;
if ( F_27 ( ( char * ) V_60 , V_62 , & V_66 , V_68 ) == - 1 ) {
* V_63 = V_70 ;
if ( V_64 != NULL )
* V_64 = F_28 ( V_68 ) ;
return NULL ;
...
if ( F_41 ( V_75 [ V_7 ] . V_2 + sizeof( L_17 ) - 1 ,
V_2 ) == 0 )
...
int
F_47 ( const char * V_80 )
{
return F_40 ( V_80 ) ;
}
int
F_48 ( T_18 * V_81 , const char * T_19
#ifndef F_49
V_3 )
T_8
F_50 ( T_18 * V_82 , int V_83 , char * V_2 ,
char * V_84 , T_20 V_85 ,
char * V_86 , T_20 V_87 )
{
char * V_88 ;
...
V_88 = F_53 ( V_82 ) ;
#else
if ( F_48 ( V_82 , V_2 ) == V_83 )
return TRUE ;
V_88 =
L_18 ;
#endif
F_54 ( V_84 , ( V_89 ) V_85 , L_19 ,
V_2 , V_88 ) ;
if ( strstr ( V_88 , L_20 ) == NULL )
F_54 ( V_86 , ( V_89 ) V_87 , V_90 ) ;
else
V_86 [ 0 ] = '\0' ;
return FALSE ;
}
...
static T_8
F_65 ( const char * V_98 )
{
int V_99 ;
struct V_100 V_101 ;
T_22 V_102 ;
V_99 = F_66 ( V_103 , V_104 , 0 ) ;
if ( V_99 == - 1 )
return FALSE ;
memset ( & V_101 , 0 , sizeof V_101 ) ;
F_67 ( V_101 . V_105 , V_98 , sizeof V_101 . V_105 ) ;
memset ( & V_102 , 0 , sizeof V_102 ) ;
V_101 . V_106 = ( V_107 ) & V_102 ;
#if F_68 ( V_108 )
if ( F_69 ( V_99 , V_108 , & V_101 ) == 0 ) {
F_70 ( V_99 ) ;
return TRUE ;
}
#else
if ( F_69 ( V_99 , V_109 , & V_101 ) == 0 ) {
F_70 ( V_99 ) ;
return TRUE ;
}
#endif
...
T_17 *
F_78 ( T_21 * V_93 , char * * V_64 )
{
#if F_68 ( V_114 ) && F_68 ( V_115 )
T_17 * V_78 ;
char V_68 [ V_69 ] ;
T_18 * V_81 ;
int V_94 ;
...
V_68 [ 0 ] = '\0' ;
V_81 = F_79 ( V_93 -> V_2 , V_113 , 0 , 0 , & V_62 ,
V_68 ) ;
if ( V_81 == NULL ) {
if ( V_64 != NULL )
* V_64 = F_15 ( V_68 [ 0 ] == '\0' ? L_26 : V_68 ) ;
