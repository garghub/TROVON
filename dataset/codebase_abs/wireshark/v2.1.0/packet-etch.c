...
V_101 = V_93 -> V_100 ;
F_54 ( V_93 -> V_97 , TRUE ) ;
F_55 ( V_93 -> V_97 , V_102 , L_15 , F_49 ( V_96 ) ) ;
}
if ( V_94 ) {
unsigned int V_51 ;
T_14 * V_68 ;
T_13 * V_53 ;
V_68 = F_56 ( V_94 , V_103 , V_52 , 0 , - 1 ,
L_16 , F_49 ( V_96 ) ) ;
V_51 = 9 ;
...
if ( V_99 > 0 ) {
F_54 ( V_93 -> V_97 , TRUE ) ;
F_61 ( V_93 -> V_97 , V_102 , L_17 , V_99 + 1 ) ;
}
return 1 ;
}
static void
...
F_66 ( V_103 , V_109 , F_67 ( V_109 ) ) ;
F_68 ( V_127 , F_67 ( V_127 ) ) ;
V_128 = F_69 ( L_58 , F_58 , V_103 ) ;
F_70 ( & F_62 ) ;
V_108 = F_71 ( V_103 ,
V_129 ) ;
F_72 ( V_108 , L_59 ,
...
static T_1 V_133 = 0 ;
if( ! V_132 ) {
F_74 ( L_67 , F_58 , L_68 , L_69 , V_103 , V_134 ) ;
V_132 = TRUE ;
}
if( V_133 != 0 && V_133 != V_131 ) {
F_75 ( L_64 , V_133 , V_128 ) ;
}
if( V_131 != 0 && V_133 != V_131 ) {
F_76 ( L_64 , V_131 , V_128 ) ;
}
V_133 = V_131 ;
