...
char * V_39 = F_30 ( V_35 ) ;
F_31 ( V_3 , & V_40 , V_35 -> V_1 , V_35 -> V_10 , V_35 -> V_31 , V_39 ) ;
F_10 ( V_3 , L_7 , V_39 ) ;
}
}
}
static void F_32 ( void * V_27 , const void * T_8 V_26 , T_9 * V_28 ) {
T_5 * V_4 = ( T_5 * ) V_27 ;
T_3 * V_3 = ( T_3 * ) F_25 ( V_4 -> V_21 ) ;
T_3 * V_29 ;
T_4 * V_6 ;
...
static void F_33 ( void * V_27 , const void * T_8 V_26 , T_9 * T_10 V_26 ) {
T_5 * V_4 = ( T_5 * ) V_27 ;
F_27 ( V_4 -> V_21 ) ;
}
static int
F_34 ( char * V_43 , T_1 * V_1 , int V_10 , int V_44 )
{
int V_31 = F_35 ( ( V_45 ) * V_43 ) ;
if ( V_31 == - 1 || ( ( V_46 ) ( V_10 + V_31 ) ) >= ( V_46 ) V_44 ) {
* V_43 = '?' ;
return 1 ;
}
F_36 ( V_1 , V_43 + 1 , V_10 + 1 , V_31 - 1 ) ;
if ( ! F_37 ( V_43 , V_31 , NULL ) ) {
* V_43 = '?' ;
return 1 ;
}
return V_31 ;
}
static char * F_30 ( T_9 * V_28 )
{
...
int V_58 ;
V_47 [ V_49 ] = V_50 ;
V_58 = F_34 ( & V_47 [ V_49 ] , V_28 -> V_1 , V_48 , V_28 -> V_31 ) ;
V_49 += V_58 ;
V_48 += ( V_58 - 1 ) ;
}
}
...
case V_38 :
if ( V_28 -> V_31 >= 2 )
F_31 ( V_3 , & V_61 , V_28 -> V_1 , V_28 -> V_10 , V_28 -> V_31 , F_30 ( V_28 ) ) ;
else
F_8 ( V_3 , & V_61 , V_28 -> V_1 , V_28 -> V_10 , V_28 -> V_31 , V_62 | V_19 ) ;
break;
case V_63 :
F_8 ( V_3 , & V_64 , V_28 -> V_1 , V_28 -> V_10 , V_28 -> V_31 , V_62 | V_19 ) ;
break;
case V_65 :
F_8 ( V_3 , & V_66 , V_28 -> V_1 , V_28 -> V_10 , V_28 -> V_31 , V_19 ) ;
break;
case V_67 :
F_8 ( V_3 , & V_68 , V_28 -> V_1 , V_28 -> V_10 , V_28 -> V_31 , V_19 ) ;
break;
case V_69 :
F_8 ( V_3 , & V_70 , V_28 -> V_1 , V_28 -> V_10 , V_28 -> V_31 , V_19 ) ;
break;
case V_71 :
case V_72 :
break;
default:
F_49 ( V_3 , V_28 -> V_1 , V_28 -> V_10 , V_28 -> V_31 ) ;
break;
}
}
...
T_15 * V_81 ;
T_15 * V_82 ;
#define F_51 ( V_37 , T_16 , T_17 , T_18 , T_19 ) \
tvbparse_some(id, 0, 1, private_data, before_cb, after_cb, wanted)
T_15 * V_83 = F_52 ( - 1 , L_8 , NULL , NULL , NULL ) ;
V_78 = F_53 ( V_38 , NULL , NULL , NULL ,
V_83 ,
F_54 ( - 1 , 0 , V_84 , NULL , NULL , NULL ,
...
V_83 ,
NULL ) ;
V_82 = F_52 ( - 1 , L_13 , NULL , NULL , NULL ) ;
V_80 = F_55 ( - 1 , NULL , NULL , NULL ,
...
NULL ) ) ,
NULL ) ;
V_81 = F_55 ( - 1 , NULL , NULL , F_48 ,
F_58 ( V_65 , L_21 , NULL , NULL , NULL ) ,
F_58 ( V_67 , L_22 , NULL , NULL , NULL ) ,
F_58 ( V_69 , L_23 , NULL , NULL , NULL ) ,
& V_73 ,
& V_74 ,
V_79 ,
V_78 ,
NULL ) ;
V_76 = F_53 ( V_72 , NULL , F_32 , F_33 ,
...
NULL ) ;
V_74 = * V_76 ;
V_77 = F_53 ( - 1 , NULL , F_28 , F_29 ,
V_78 ,
F_52 ( - 1 , L_26 , NULL , NULL , NULL ) ,
V_81 ,
NULL ) ;
V_75 = F_53 ( V_71 , NULL , F_24 , F_26 ,
...
NULL ) ;
V_73 = * V_75 ;
V_22 = F_57 ( - 1 , 1 , 0 , L_29 , NULL , NULL , NULL ) ;
V_23 = F_55 ( - 1 , NULL , NULL , NULL ,
V_75 ,
V_76 ,
NULL ) ;
}
...
{
V_46 V_31 = F_22 ( V_1 ) ;
const V_45 * V_43 = F_60 ( F_12 () , V_1 , 0 , V_31 , V_62 ) ;
...
#endif
V_87 = F_64 ( L_3 , L_2 , L_30 ) ;
V_18 = F_65 ( V_87 ) ;
F_66 ( V_87 , V_86 , F_67 ( V_86 ) ) ;
F_68 ( V_85 , F_67 ( V_85 ) ) ;
V_88 = F_69 ( L_30 , F_1 , V_87 ) ;
F_50 () ;
}
void
F_70 ( void )
{
T_22 V_89 = F_71 ( F_23 , V_87 ) ;
F_72 ( L_31 , F_59 , L_32 , L_33 , V_87 , V_90 ) ;
F_72 ( L_34 , F_59 , L_35 , L_36 , V_87 , V_90 ) ;
F_73 ( L_37 , V_91 , V_89 ) ;
F_74 ( L_38 , L_39 , V_88 ) ;
F_74 ( L_38 , L_40 , V_88 ) ;
F_74 ( L_38 , L_41 , V_88 ) ;
