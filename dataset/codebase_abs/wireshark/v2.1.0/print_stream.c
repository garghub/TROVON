...
#endif
if ( F_16 ( F_17 ( V_15 -> V_3 ) ) && V_23 ) {
V_19 = F_18 ( line , - 1 , V_23 , L_2 , L_3 , NULL , NULL , NULL ) ;
}
if ( V_19 ) {
#ifdef F_13
T_7 V_24 = ( T_7 ) wcslen ( ( V_25 * ) V_19 ) ;
F_19 ( ( V_26 ) F_20 ( F_21 ( V_15 -> V_3 ) ) , V_19 , V_24 , & V_24 , NULL ) ;
#else
fputs ( V_19 , V_15 -> V_3 ) ;
#endif
F_22 ( V_19 ) ;
...
static T_3 *
F_25 ( T_2 V_1 , T_1 * V_3 )
{
T_3 * V_27 ;
T_6 * V_15 ;
V_15 = ( T_6 * ) F_26 ( sizeof *V_15 ) ;
V_15 -> V_1 = V_1 ;
V_15 -> V_3 = V_3 ;
V_27 = ( T_3 * ) F_26 ( sizeof ( T_3 ) ) ;
V_27 -> V_7 = & V_28 ;
V_27 -> V_16 = V_15 ;
return V_27 ;
}
...
char V_35 [ V_36 ] ;
F_29 ( V_35 , V_10 , V_36 ) ;
fprintf ( V_15 -> V_3 , L_9 , V_9 ,
V_35 ) ;
fputs ( L_10 ,
V_15 -> V_3 ) ;
fputs ( L_11 ,
V_15 -> V_3 ) ;
fprintf ( V_15 -> V_3 , L_12 , V_9 ) ;
return ! ferror ( V_15 -> V_3 ) ;
}
static T_2
F_34 ( T_3 * V_4 )
