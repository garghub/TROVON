...
return;
F_27 ( & V_130 [ V_128 ] , V_1 , V_129 ) ;
V_128 += ( int ) V_127 ;
if ( V_131 >= 2 ) {
char * V_4 ;
char V_132 [ V_129 ] ;
F_27 ( V_132 , V_130 , V_129 ) ;
while ( ( V_4 = strchr ( V_132 , '\r' ) ) != NULL ) * V_4 = ' ' ;
fprintf ( V_5 , L_8 , V_132 ) ;
}
}
}
static void
...
while ( ( V_4 = strchr ( V_130 , '\r' ) ) != NULL ) * V_4 = ' ' ;
fprintf ( V_5 , L_9 , V_130 ) ;
fprintf ( V_5 , L_12 , V_119 , ( T_1 ) V_115 , V_116 ) ;
}
V_128 = 0 ;
}
static void
...
{
if ( V_131 >= 1 )
fprintf ( V_5 , L_13 , V_30 ? L_14 : L_15 ) ;
F_13 ( V_30 ) ;
V_146 ++ ;
F_28 () ;
}
...
break;
default:
fprintf ( V_5 , L_19 , V_154 ) ;
exit ( 1 ) ;
}
if ( V_131 >= 2 )
fprintf ( V_5 , L_20 , V_153 [ V_154 ] ) ;
return;
V_158:
fprintf ( V_5 , L_21 , V_154 ) ;
exit ( 1 ) ;
}
static void
F_33 ( T_6 * V_169 )
...
L_22
L_92 ,
F_21 () , V_172 -> V_1 , V_173 -> V_1 ) ;
while ( ( V_4 = F_41 ( V_170 , V_171 , L_93 , V_175 , NULL ) ) != - 1 ) {
switch ( V_4 ) {
case 'h' :
printf ( L_91
L_94
...
case 'l' : V_125 = ( T_1 ) strtol ( V_177 , NULL , 0 ) ; break;
case 'm' : V_11 = ( T_1 ) strtol ( V_177 , NULL , 0 ) ; break;
case 'n' : V_113 = TRUE ; break;
case 'o' :
if ( V_177 [ 0 ] != 'h' && V_177 [ 0 ] != 'o' && V_177 [ 0 ] != 'd' ) {
fprintf ( V_5 , L_96 , V_177 ) ;
F_33 ( V_5 ) ;
exit ( 1 ) ;
}
switch ( V_177 [ 0 ] ) {
...
case 'e' :
V_42 = TRUE ;
if ( sscanf ( V_177 , L_97 , & V_39 ) < 1 ) {
fprintf ( V_5 , L_98 , V_177 ) ;
F_33 ( V_5 ) ;
exit ( 1 ) ;
}
break;
case 'i' :
V_40 = TRUE ;
V_55 = strtol ( V_177 , & V_136 , 10 ) ;
if ( V_136 == V_177 || * V_136 != '\0' || V_55 < 0 ||
V_55 > 255 ) {
fprintf ( V_5 , L_99 , V_177 ) ;
F_33 ( V_5 ) ;
exit ( 1 ) ;
}
V_42 = TRUE ;
...
V_84 = FALSE ;
V_76 = FALSE ;
V_109 = ( T_1 ) strtol ( V_177 , & V_136 , 10 ) ;
if ( V_136 == V_177 || ( * V_136 != ',' && * V_136 != '\0' ) ) {
...
V_136 ++ ;
V_177 = V_136 ;
V_108 = ( T_1 ) strtol ( V_177 , & V_136 , 10 ) ;
if ( V_136 == V_177 || ( * V_136 != ',' && * V_136 != '\0' ) ) {
fprintf ( V_5 , L_102 ) ;
F_33 ( V_5 ) ;
exit ( 1 ) ;
...
V_136 ++ ;
V_177 = V_136 ;
V_111 = ( T_1 ) strtol ( V_177 , & V_136 , 10 ) ;
if ( V_136 == V_177 || * V_136 != '\0' ) {
...
V_136 ++ ;
V_177 = V_136 ;
V_105 = ( T_1 ) strtoul ( V_177 , & V_136 , 10 ) ;
if ( V_136 == V_177 || * V_136 != '\0' ) {
...
V_41 = FALSE ;
V_92 = FALSE ;
V_81 = ( T_1 ) strtol ( V_177 , & V_136 , 10 ) ;
if ( V_136 == V_177 || ( * V_136 != ',' && * V_136 != '\0' ) ) {
fprintf ( V_5 , L_107 ) ;
F_33 ( V_5 ) ;
exit ( 1 ) ;
...
V_136 ++ ;
V_177 = V_136 ;
V_80 = ( T_1 ) strtol ( V_177 , & V_136 , 10 ) ;
if ( V_136 == V_177 || * V_136 != '\0' ) {
fprintf ( V_5 , L_109 ) ;
F_33 ( V_5 ) ;
exit ( 1 ) ;
...
if ( V_178 >= V_170 || V_170 - V_178 < 2 ) {
fprintf ( V_5 , L_117 ) ;
F_33 ( V_5 ) ;
exit ( 1 ) ;
}
if ( strcmp ( V_171 [ V_178 ] , L_118 ) ) {
V_124 = F_46 ( V_171 [ V_178 ] ) ;
V_179 = F_47 ( V_124 , L_119 ) ;
if ( ! V_179 ) {
fprintf ( V_5 , L_120 ,
V_124 , F_18 ( V_180 ) ) ;
exit ( 1 ) ;
...
if ( strcmp ( V_171 [ V_178 + 1 ] , L_118 ) ) {
V_118 = F_46 ( V_171 [ V_178 + 1 ] ) ;
V_114 = F_47 ( V_118 , L_122 ) ;
if ( ! V_114 ) {
fprintf ( V_5 , L_123 ,
V_118 , F_18 ( V_180 ) ) ;
exit ( 1 ) ;
...
V_138 . V_145 = - 1 ;
if ( ! V_120 ) {
fprintf ( V_5 , L_126 , V_124 ) ;
fprintf ( V_5 , L_127 , V_118 ) ;
fprintf ( V_5 , L_128 , V_113 ? L_129 : L_130 ) ;
if ( V_42 ) fprintf ( V_5 , L_131 ,
V_39 ) ;
if ( V_40 ) fprintf ( V_5 , L_132 ,
V_55 ) ;
if ( V_76 ) fprintf ( V_5 , L_133 ,
V_81 , V_80 ) ;
if ( V_84 ) fprintf ( V_5 , L_134 ,
V_81 , V_80 ) ;
if ( V_41 ) fprintf ( V_5 , L_135 ,
V_109 , V_108 , V_111 ) ;
if ( V_92 ) fprintf ( V_5 , L_136 ,
V_99 , V_101 , V_103 , V_105 ) ;
}
}
int
main ( int V_170 , char * V_171 [] )
{
F_34 ( V_170 , V_171 ) ;
assert ( V_179 != NULL ) ;
assert ( V_114 != NULL ) ;
...
fprintf ( V_5 , L_137 ) ;
if ( ! V_120 ) {
fprintf ( V_5 , L_138 V_183 L_139 ,
V_146 , ( V_146 == 1 ) ? L_7 : L_140 ,
V_121 , ( V_121 == 1 ) ? L_7 : L_140 ,
V_117 , ( V_117 == 1 ) ? L_7 : L_140 ) ;
}
return 0 ;
}
