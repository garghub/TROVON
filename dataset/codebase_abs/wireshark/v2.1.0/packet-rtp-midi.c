...
static int
F_76 ( T_1 * V_1 , T_2 * T_3 V_2 , T_4 * V_3 , void * T_12 V_2 )
{
T_11 * V_599 ;
T_4 * V_600 ;
unsigned int V_4 = 0 ;
...
if ( V_601 & V_620 ) {
T_4 * V_621 ;
V_621 = F_33 ( V_600 , V_1 , V_4 , - 1 , V_622 , NULL , V_623 ) ;
V_601 = F_2 ( V_1 , V_4 ) ;
F_8 ( V_621 , V_624 , V_1 , V_4 , 1 , V_31 ) ;
F_8 ( V_621 , V_625 , V_1 , V_4 , 1 , V_31 ) ;
F_8 ( V_621 , V_626 , V_1 , V_4 , 1 , V_31 ) ;
F_8 ( V_621 , V_627 , V_1 , V_4 , 1 , V_31 ) ;
V_602 = V_601 & V_628 ;
F_8 ( V_621 , V_629 , V_1 , V_4 , 1 , V_31 ) ;
V_4 ++ ;
F_8 ( V_621 , V_630 , V_1 , V_4 , 2 , V_31 ) ;
V_4 += 2 ;
if ( V_601 & V_631 ) {
V_6 = F_75 ( V_1 , T_3 , V_621 , V_4 ) ;
if ( - 1 == V_6 ) {
return V_4 ;
}
V_4 += V_6 ;
...
if ( V_601 & V_632 ) {
T_4 * V_633 ;
V_633 = F_33 ( V_621 , V_1 , V_4 , - 1 , V_634 , NULL , V_635 ) ;
for ( V_7 = 0 ; V_7 <= V_602 ; V_7 ++ ) {
V_6 = F_62 ( V_1 , T_3 , V_633 , V_4 ) ;
if ( - 1 == V_6 ) {
return V_4 ;
}
V_4 += V_6 ;
...
V_605 = F_83 ( V_787 , V_604 , V_788 ) ;
F_84 ( V_605 , V_637 , F_85 ( V_637 ) ) ;
F_86 ( V_784 , F_85 ( V_784 ) ) ;
V_636 = F_87 ( V_605 , V_789 ) ;
F_88 ( V_636 , L_618 , L_619 , L_620 , 10 , & V_790 ) ;
F_89 ( V_788 , F_76 , V_605 ) ;
}
void
V_789 ( void )
{
static T_16 V_791 ;
static int V_792 = FALSE ;
if ( ! V_792 ) {
V_791 = F_90 ( V_788 ) ;
F_91 ( L_621 , L_622 , V_791 ) ;
V_792 = TRUE ;
}
else {
F_92 ( L_623 , V_793 , V_791 ) ;
}
if ( V_790 > 95 ) {
V_793 = V_790 ;
F_93 ( L_623 , V_793 , V_791 ) ;
}
}
