...
F_48 ( V_14 -> V_83 , V_85 , L_14 , V_20 ) ;
V_5 = F_3 ( V_1 , V_92 , V_2 , V_15 , - 1 , V_10 | V_11 ) ;
V_1 = F_4 ( V_5 , V_93 ) ;
V_82 = F_49 ( V_2 , V_15 ) ;
F_50 ( V_94 , V_82 , V_14 , V_1 ) ;
break;
}
case 'p' :
case 'v' :
...
if ( V_62 == 'e' )
F_48 ( V_14 -> V_83 , V_85 , L_22 , V_20 ) ;
else
F_48 ( V_14 -> V_83 , V_85 , L_12 , V_20 ) ;
V_5 = F_3 ( V_1 , V_89 , V_2 , V_15 , - 1 , V_11 ) ;
V_1 = F_4 ( V_5 , V_90 ) ;
if( V_48 && V_48 -> V_104 ) {
V_5 = F_54 ( V_1 , V_103 , V_2 , V_15 , 0 , V_48 -> V_104 ) ;
F_6 ( V_5 ) ;
}
if ( V_62 == 'e' ) {
V_62 = F_55 ( V_2 , V_15 , - 1 , & V_7 , FALSE ) ;
V_77 = F_8 ( F_9 () , V_2 , V_15 , V_62 , V_10 ) ;
V_5 = F_3 ( V_1 , V_114 , V_2 , V_15 , ( T_1 ) strlen ( V_77 ) , V_10 | V_11 ) ;
F_5 ( V_5 , L_4 , F_51 ( V_77 , V_115 , L_5 ) ) ;
break;
}
...
if ( V_120 ) {
if ( V_80 . V_118 )
F_57 ( V_14 , & V_80 , V_81 , 0 , L_11 , V_14 -> V_51 , 0 , NULL ) ;
}
if ( V_121 ) {
if ( V_80 . V_118 )
F_58 ( V_14 , & V_80 , V_81 + 1 , 0 , L_11 , V_14 -> V_51 ) ;
}
}
break;
default:
...
F_63 ( V_86 , V_125 , F_64 ( V_125 ) ) ;
F_65 ( V_149 , F_64 ( V_149 ) ) ;
V_124 = F_66 ( V_86 ) ;
F_67 ( V_124 , V_142 , F_64 ( V_142 ) ) ;
V_123 = F_68 ( V_86 , V_151 ) ;
F_69 ( V_123 , L_111 ,
L_112 ,
L_112 ,
10 ,
...
if( ! V_157 ) {
V_158 = F_71 ( F_37 , V_86 ) ;
V_159 = F_71 ( F_37 , V_86 ) ;
V_157 = TRUE ;
}
if( V_155 != 0 && V_155 != V_152 )
F_72 ( L_111 , V_155 , V_158 ) ;
if( V_152 != 0 && V_155 != V_152 )
F_21 ( L_111 , V_152 , V_158 ) ;
V_155 = V_152 ;
if( V_156 != 0 && V_156 != V_153 )
F_72 ( L_113 , V_156 , V_159 ) ;
if( V_153 != 0 && V_156 != V_153 )
F_21 ( L_113 , V_153 , V_159 ) ;
V_156 = V_153 ;
V_121 = F_73 ( L_122 , V_86 ) ;
V_38 = F_73 ( L_123 , V_86 ) ;
V_120 = F_73 ( L_124 , V_86 ) ;
V_94 = F_73 ( L_125 , V_86 ) ;
