...
F_11 ( V_47 ) ;
V_42 = F_12 ( V_49 ) ;
F_13 ( V_42 , V_50 , V_41 , strlen ( V_41 ) ) ;
F_3 ( V_41 ) ;
V_48 = V_47 -> V_24 ;
F_13 ( V_42 , V_51 , F_14 ( V_47 , TRUE ) , V_48 ) ;
F_15 ( V_42 , V_52 , L_2 , F_16 () ) ;
V_44 = F_17 ( T_10 , 1 ) ;
V_44 -> V_53 = F_9 ( FALSE , FALSE , sizeof( T_8 ) ) ;
V_45 = F_12 ( V_54 ) ;
V_46 = ( T_11 * ) F_18 ( V_45 ) ;
V_46 -> V_55 = V_56 ;
V_46 -> V_57 = 1000000000 ;
V_46 -> V_58 = F_19 ( V_56 ) ;
V_46 -> V_59 = V_60 ;
F_13 ( V_45 , V_61 , L_3 , strlen ( L_3 ) ) ;
F_20 ( V_45 , V_62 , 9 ) ;
F_21 ( V_44 -> V_53 , V_45 ) ;
F_21 ( V_43 , V_42 ) ;
V_6 -> V_39 = F_22 ( V_27 , V_63 , V_56 , V_60 , FALSE ,
V_43 , V_44 , NULL , & V_9 ) ;
if ( V_6 -> V_39 == NULL ) {
F_23 ( V_9 != 0 ) ;
return V_9 ;
...
char *
F_27 ( const char * V_64 , const char * V_65 , T_5 * V_6 )
{
T_12 * V_66 ;
V_6 -> V_26 = F_19 ( V_56 ) ;
V_66 = F_28 ( V_64 ,
