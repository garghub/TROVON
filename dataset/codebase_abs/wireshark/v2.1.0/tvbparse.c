...
if ( V_51 < 0 )
return - 1 ;
V_52 = F_29 ( F_5 () , V_53 -> V_8 , V_53 -> V_3 , V_53 -> V_4 , V_61 ) ;
#ifdef F_2
if ( F_2 & V_59 ) F_3 ( L_18 , V_52 ) ;
#endif
if ( ( V_54 = ( T_3 * ) F_30 ( V_5 -> V_22 . V_60 . V_62 , V_52 ) ) ) {
V_55 = V_54 -> V_17 ( V_1 , V_3 + V_51 , V_54 , & V_56 ) ;
} else if ( V_5 -> V_22 . V_60 . V_63 ) {
V_55 = V_5 -> V_22 . V_60 . V_63 -> V_17 ( V_1 , V_3 + V_51 , V_5 -> V_22 . V_60 . V_63 , & V_56 ) ;
if ( V_55 < 0 )
return - 1 ;
} else {
return - 1 ;
...
V_28 -> V_29 = V_26 ;
V_28 -> V_30 = V_27 ;
V_28 -> V_22 . V_60 . V_62 = F_32 ( V_65 , V_66 ) ;
V_28 -> V_22 . V_60 . V_52 = V_52 ;
V_28 -> V_22 . V_60 . V_63 = V_63 ;
va_start ( V_50 , V_63 ) ;
while( ( V_64 = va_arg ( V_50 , T_4 * ) ) ) {
V_49 = va_arg ( V_50 , T_3 * ) ;
F_33 ( V_28 -> V_22 . V_60 . V_62 , V_64 , V_49 ) ;
}
va_end ( V_50 ) ;
return V_28 ;
}
...
if ( V_3 > V_1 -> V_24 )
return - 1 ;
V_13 = V_5 -> V_22 . V_70 -> V_17 ( V_1 , V_3 , V_5 -> V_22 . V_70 , & V_47 ) ;
if( V_13 >= 0 ) {
if ( V_58 ) {
if ( V_47 -> V_4 )
V_58 -> V_4 = ( V_47 -> V_3 - V_58 -> V_3 ) + V_47 -> V_4 ;
...
int V_73 = V_3 ;
#ifdef F_2
if ( F_2 & V_74 ) F_3 ( L_25 ) ;
#endif
if ( V_3 + V_5 -> V_22 . V_75 . V_70 -> V_4 > V_1 -> V_24 )
return - 1 ;
do {
V_4 = V_5 -> V_22 . V_75 . V_70 -> V_17 ( V_1 , V_73 ++ , V_5 -> V_22 . V_75 . V_70 , & V_47 ) ;
} while( V_4 < 0 && V_73 + 1 < V_1 -> V_24 );
if ( V_4 >= 0 ) {
V_47 -> V_2 = V_5 -> V_2 ;
V_47 -> V_11 = NULL ;
V_47 -> V_12 = NULL ;
...
V_47 -> V_3 = V_3 ;
( * V_6 ) = V_47 ;
switch ( V_5 -> V_22 . V_75 . V_76 ) {
case V_77 :
V_47 -> V_4 = V_73 - V_3 - 1 + V_4 ;
#ifdef F_2
if ( F_2 & V_74 ) F_3 ( L_26 , V_73 - V_3 - 1 + V_4 ) ;
#endif
return V_73 - V_3 - 1 + V_4 ;
case V_78 :
V_47 -> V_4 = V_73 - V_3 - 1 ;
#ifdef F_2
if ( F_2 & V_74 ) F_3 ( L_26 , V_73 - V_3 - 1 + V_4 ) ;
...
V_47 -> V_4 = V_73 - V_3 - 1 ;
#ifdef F_2
if ( F_2 & V_74 ) F_3 ( L_26 , V_73 - V_3 - 1 ) ;
#endif
return V_73 - V_3 - 1 ;
default:
F_41 () ;
...
T_3 * V_28 = ( T_3 * ) F_10 ( sizeof( T_3 ) ) ;
V_28 -> V_17 = F_40 ;
V_28 -> V_22 . V_75 . V_76 = V_80 ;
V_28 -> V_22 . V_75 . V_70 = V_49 ;
V_28 -> V_2 = V_2 ;
V_28 -> V_9 = V_9 ;
V_28 -> V_29 = V_26 ;
V_28 -> V_30 = V_27 ;
...
const char V_81 ,
const char V_82 ) {
T_4 * V_83 = F_44 ( L_27 , V_82 , V_81 ) ;
T_4 * V_84 = F_44 ( L_28 , V_81 ) ;
T_3 * V_85 = F_9 ( - 1 , V_84 , NULL , NULL , NULL ) ;
return F_25 ( V_2 , V_9 , V_26 , V_27 ,
F_36 ( - 1 , NULL , NULL , NULL ,
V_85 ,
F_36 ( - 1 , NULL , NULL , NULL ,
F_25 ( - 1 , NULL , NULL , NULL ,
F_19 ( - 1 , V_83 , NULL , NULL , NULL ) ,
F_16 ( - 1 , 0 , 0 , V_84 , NULL , NULL , NULL ) ,
NULL ) ,
NULL ) ,
V_85 ,
NULL ) ,
...
void F_45 ( void * T_12 V_86 ,
const void * T_13 V_86 ,
T_1 * V_6 ) {
V_6 -> V_3 += 1 ;
V_6 -> V_4 -= 2 ;
}
...
static void F_51 ( T_2 * V_1 , T_1 * V_88 ) {
T_15 * V_89 = F_52 ( F_5 () ) ;
while ( V_88 ) {
if( V_88 -> V_5 -> V_29 ) {
#ifdef F_2
if ( F_2 & V_90 ) F_3 ( L_30 , V_88 -> V_2 , V_88 -> V_3 , V_88 -> V_4 ) ;
#endif
V_88 -> V_5 -> V_29 ( V_1 -> V_9 , V_88 -> V_5 -> V_9 , V_88 ) ;
}
if( V_88 -> V_10 ) {
F_53 ( V_89 , V_88 ) ;
V_88 = V_88 -> V_10 ;
...
#ifdef F_2
if ( F_2 & V_90 ) F_3 ( L_31 , V_88 -> V_2 , V_88 -> V_3 , V_88 -> V_4 ) ;
#endif
if( V_88 -> V_5 -> V_30 ) V_88 -> V_5 -> V_30 ( V_1 -> V_9 , V_88 -> V_5 -> V_9 , V_88 ) ;
}
V_88 = V_88 -> V_11 ;
while( ! V_88 && F_54 ( V_89 ) > 0 ) {
V_88 = ( T_1 * ) F_55 ( V_89 ) ;
#ifdef F_2
if ( F_2 & V_90 ) F_3 ( L_31 , V_88 -> V_2 , V_88 -> V_3 , V_88 -> V_4 ) ;
#endif
...
int V_3 = V_1 -> V_3 ;
#ifdef F_2
if ( F_2 & V_91 ) F_3 ( L_32 , V_3 ) ;
#endif
V_3 += F_6 ( V_1 , V_3 ) ;
#ifdef F_2
if ( F_2 & V_91 ) F_3 ( L_33 , V_3 ) ;
#endif
V_13 = V_5 -> V_17 ( V_1 , V_3 , V_5 , & V_6 ) ;
if ( V_13 >= 0 ) {
#ifdef F_2
if ( F_2 & V_91 ) F_3 ( L_34 , V_13 ) ;
#endif
return TRUE ;
} else {
#ifdef F_2
if ( F_2 & V_91 ) F_3 ( L_35 ) ;
#endif
return FALSE ;
}
}
...
int V_3 = V_1 -> V_3 ;
#ifdef F_2
if ( F_2 & V_92 ) F_3 ( L_36 , V_3 ) ;
#endif
V_3 += F_6 ( V_1 , V_3 ) ;
#ifdef F_2
if ( F_2 & V_92 ) F_3 ( L_37 , V_3 ) ;
#endif
V_13 = V_5 -> V_17 ( V_1 , V_3 , V_5 , & V_6 ) ;
if ( V_13 >= 0 ) {
#ifdef F_2
if ( F_2 & V_92 ) F_3 ( L_38 , V_13 ) ;
#endif
F_51 ( V_1 , V_6 ) ;
V_1 -> V_3 = V_3 + V_13 ;
#ifdef F_2
...
int V_73 = V_3 - 1 ;
#ifdef F_2
if ( F_2 & V_93 ) F_3 ( L_36 , V_1 -> V_3 ) ;
#endif
do {
V_4 = V_5 -> V_17 ( V_1 , V_73 + 1 , V_5 , & V_6 ) ;
} while( V_4 < 0 && ++ V_73 < V_1 -> V_24 );
if ( V_4 >= 0 ) {
#ifdef F_2
if ( F_2 & V_93 ) F_3 ( L_40 , V_73 , V_4 ) ;
#endif
F_51 ( V_1 , V_6 ) ;
V_1 -> V_3 = V_73 + V_4 ;
#ifdef F_2
...
#ifdef F_2
if ( F_2 & V_93 ) F_3 ( L_41 ) ;
#endif
return NULL ;
}
}
void F_59 ( T_16 * V_94 , T_1 * V_88 ) {
T_15 * V_89 = F_52 ( F_5 () ) ;
struct V_95 * V_96 = F_4 ( F_5 () , struct V_95 ) ;
T_17 * V_97 ;
V_96 -> V_94 = V_94 ;
V_96 -> V_98 = V_88 ;
while ( V_88 ) {
V_97 = F_60 ( V_96 -> V_94 , V_88 -> V_8 , V_88 -> V_3 , V_88 -> V_4 ) ;
if( V_88 -> V_10 ) {
V_96 -> V_98 = V_88 ;
F_53 ( V_89 , V_96 ) ;
V_96 = F_4 ( F_5 () , struct V_95 ) ;
V_96 -> V_94 = F_61 ( V_97 , 0 ) ;
V_88 = V_88 -> V_10 ;
continue;
}
V_88 = V_88 -> V_11 ;
while( ! V_88 && F_54 ( V_89 ) > 0 ) {
V_96 = (struct V_95 * ) F_55 ( V_89 ) ;
V_88 = V_96 -> V_98 -> V_11 ;
}
}
}
