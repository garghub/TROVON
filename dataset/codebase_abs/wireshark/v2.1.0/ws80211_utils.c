...
int F_75 ( const char * V_129 , int V_70 , int V_153 , int V_18 V_154 , int V_18 V_155 )
{
int V_130 , V_4 ;
struct V_23 * T_2 ;
struct V_25 * V_26 ;
...
int F_75 ( const char * V_129 V_18 , int V_70 V_18 , int V_18 V_153 , int V_18 V_154 , int V_18 V_155 )
{
return - 1 ;
}
int F_78 ( const T_11 * V_157 V_18 )
