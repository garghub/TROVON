...
F_191 ( L_348 , V_326 , V_348 , V_345 -> V_265 , V_349 ) ;
}
}
...
V_51 = F_193 ( V_35 ) ? V_90 : V_136 ;
}
* V_355 = ':' ;
return V_51 ;
}
T_6
F_197 ( const char * V_21 )
{
T_13 * V_357 , * V_358 ;
T_29 V_124 ;
if ( V_1 . V_235 && V_21 ) {
...
char
F_201 ( const char * string , T_34 * V_363 )
{
char V_36 ;
...
static T_6
F_202 ( T_13 * V_373 , const T_13 * V_49 )
{
struct V_374
{
const char * V_373 ;
...
F_205 () ;
if ( F_201 ( V_49 , & V_392 ) != '\0' )
return V_136 ;
}
} else if ( F_202 ( V_373 , V_49 ) ) {
} else {
...
if ( V_4 == NULL ) {
V_1 . V_352 = TRUE ;
if ( ( strcmp ( V_373 , V_138 ) == 0 ) ||
( strcmp ( V_373 , V_114 ) == 0 ) ) {
V_4 = F_53 ( V_26 , V_373 ) ;
}
...
if ( ( V_4 -> V_5 . V_86 -> V_300 != F_206 ( V_380 ) ) ||
( V_4 -> V_5 . V_86 -> V_301 != F_207 ( V_380 ) ) ||
( V_4 -> V_5 . V_86 -> V_302 != F_208 ( V_380 ) ) ) {
V_63 -> V_37 = TRUE ;
V_4 -> V_5 . V_86 -> V_300 = F_206 ( V_380 ) ;
V_4 -> V_5 . V_86 -> V_301 = F_207 ( V_380 ) ;
V_4 -> V_5 . V_86 -> V_302 = F_208 ( V_380 ) ;
}
break;
...
F_9 ( V_60 . V_26 -> V_1 , F_214 , & V_60 ) ;
if ( F_45 ( V_26 ) )
return F_11 ( V_26 , F_216 , T_3 ) ;
return 0 ;
}
int
F_217 ( char * * V_324 )
