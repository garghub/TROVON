...
V_61 = F_44 ( V_12 , FALSE ) ;
return V_61 ;
}
extern T_3 * F_45 ( T_10 * V_27 ) {
T_12 * V_8 ;
T_13 * V_12 = F_40 ( L_7 ) ;
T_3 * V_60 ;
T_3 * V_61 ;
...
extern void F_46 ( T_10 * V_62 , T_10 * V_63 , T_11 V_64 ) {
T_12 * V_65 = NULL ;
T_12 * V_66 = NULL ;
T_14 V_8 ;
T_8 * V_67 ;
...
while( V_66 -> V_25 ) {
if( V_65 -> V_25 ) {
V_8 = F_47 ( V_65 -> V_25 -> V_42 , V_66 -> V_25 -> V_42 ) ;
} else {
V_8 = - 1 ;
}
if ( V_8 > 0 ) {
...
extern T_10 * F_48 ( const T_3 * V_36 , T_10 * V_27 , T_11 V_64 ) {
T_10 * V_68 = F_30 ( V_36 ) ;
void * V_55 = NULL ;
T_8 * V_25 ;
T_8 * V_67 ;
...
extern T_8 * F_49 ( T_8 * V_63 , T_8 * V_69 ) {
T_3 * * V_70 ;
int V_71 ;
T_3 * V_72 ;
T_6 V_73 ;
...
V_77 = TRUE ;
case V_83 :
V_75 = ( float ) F_52 ( V_63 -> V_47 , NULL ) ;
V_76 = ( float ) F_52 ( V_69 -> V_47 , NULL ) ;
if ( V_77 ) {
...
case V_85 :
return F_53 ( V_63 -> V_47 , V_69 -> V_47 ) ? V_63 : NULL ; ;
}
return NULL ;
}
...
V_8 = F_47 ( V_86 -> V_25 -> V_42 , V_66 -> V_25 -> V_42 ) ;
if ( V_8 > 0 ) {
if ( V_86 -> V_25 ) V_86 = V_86 -> V_52 ;
} else if ( V_8 < 0 ) {
if ( V_66 -> V_25 ) V_66 = V_66 -> V_52 ;
} else {
V_87 = F_49 ( V_66 -> V_25 , V_86 -> V_25 ) ;
if( V_87 ) {
if ( V_64 ) {
V_67 = F_29 ( V_87 ) ;
if ( ! F_32 ( V_68 , V_67 ) ) {
...
extern T_10 * F_56 ( const T_3 * V_36 , T_10 * V_63 , T_10 * V_69 , T_11 V_64 ) {
T_10 * V_68 = F_30 ( V_36 ) ;
T_12 * V_86 = NULL ;
T_12 * V_66 = NULL ;
T_14 V_8 ;
...
extern T_10 * F_57 ( T_15 V_89 , const T_3 * V_36 , T_10 * V_63 , T_10 * V_69 , T_11 V_64 ) {
T_10 * V_27 = NULL ;
switch ( V_89 ) {
case V_90 :
V_27 = F_56 ( V_36 , V_63 , V_69 , V_64 ) ;
break;
case V_91 :
...
break;
case V_93 :
V_27 = F_48 ( V_36 , V_63 , V_64 ) ;
F_46 ( V_27 , V_69 , V_64 ) ;
break;
}
return V_27 ;
}
extern void F_58 ( T_16 * V_69 ) {
T_16 * V_52 ;
for (; V_69 ; V_69 = V_52 ) {
V_52 = V_69 -> V_52 ;
F_43 ( V_69 -> V_36 ) ;
...
extern void F_59 ( T_10 * V_63 , T_16 * V_69 ) {
T_10 * V_27 = NULL ;
T_12 * V_66 ;
T_12 * V_96 ;
T_12 * V_42 ;
...
V_27 = F_57 ( V_69 -> V_97 , V_63 -> V_36 , V_63 , V_69 -> V_94 , TRUE ) ;
if ( V_27 ) {
switch ( V_69 -> V_98 ) {
case V_99 :
F_37 ( V_27 , TRUE ) ;
...
extern T_17 * F_60 ( const T_3 * V_36 ) {
...
extern void F_61 ( T_17 * V_103 , T_10 * V_27 ) {
...
extern T_10 * F_64 ( T_17 * V_103 , void * * V_55 ) {
T_18 * V_58 ;
#ifdef F_26
...
extern void F_65 ( T_17 * V_103 , T_11 V_104 , T_11 V_59 ) {
T_10 * V_27 ;
#ifdef F_26
F_1 ( V_34 , 3 , V_29 , L_46 , V_103 ) ;
#endif
while( ( V_27 = F_63 ( V_103 ) ) ) {
if ( V_104 ) {
F_37 ( V_27 , V_59 ) ;
}
}
...
static T_17 * F_66 ( T_2 * V_23 , T_17 * V_103 , T_10 * V_56 , int V_105 , const T_3 * V_4 , ... ) {
T_4 V_7 ;
T_3 * V_106 ;
T_17 * V_107 = NULL ;
T_3 * V_108 ;
...
V_106 = F_67 ( V_4 , V_7 ) ;
va_end ( V_7 ) ;
V_108 = F_68 ( L_47 , V_103 -> V_36 , V_105 , V_106 ) ;
V_107 = F_60 ( V_108 ) ;
F_43 ( V_106 ) ;
F_43 ( V_108 ) ;
if ( V_23 ) fclose ( V_23 ) ;
if ( V_103 ) F_65 ( V_103 , TRUE , TRUE ) ;
if ( V_56 ) F_37 ( V_56 , TRUE ) ;
return V_107 ;
}
extern T_17 * F_69 ( T_3 * V_109 ) {
T_2 * V_23 = NULL ;
T_3 V_8 ;
int V_71 = 0 ;
V_49 V_105 = 1 ;
...
#ifndef F_70
if ( ! F_71 () ) {
return F_66 ( V_23 , V_103 , V_56 , V_105 , L_48 ) ;
}
#endif
V_117 = V_112 ;
if ( ( V_23 = F_72 ( V_109 , L_49 ) ) ) {
while( ( V_8 = ( T_3 ) fgetc ( V_23 ) ) ) {
if ( feof ( V_23 ) ) {
if ( ferror ( V_23 ) ) {
F_73 ( V_109 , V_118 ) ;
return F_66 ( V_23 , V_103 , V_56 , V_105 , L_50 , V_109 ) ;
}
break;
}
if ( V_8 == '\n' ) {
...
if ( V_71 >= V_111 - 1 ) {
return F_66 ( V_23 , V_103 , V_56 , V_105 , L_51 ) ;
}
switch( V_117 ) {
case V_116 :
switch ( V_8 ) {
...
V_36 [ V_71 ++ ] = V_8 ;
V_36 [ V_71 ] = '\0' ;
F_74 ( V_110 , sizeof( V_110 ) , L_52 , V_109 , V_105 ) ;
V_56 = F_30 ( V_110 ) ;
continue;
case '#' :
V_117 = V_116 ;
continue;
default:
return F_66 ( V_23 , V_103 , V_56 , V_105 , L_53 , V_8 ) ;
}
case V_113 :
V_71 = 0 ;
V_36 [ 0 ] = '\0' ;
...
continue;
case '\n' :
return F_66 ( V_23 , V_103 , V_56 , V_105 , L_54 ) ;
default:
return F_66 ( V_23 , V_103 , V_56 , V_105 , L_55 , V_8 ) ;
}
case V_115 :
switch ( V_8 ) {
case '\\' :
...
continue;
case '\n' :
return F_66 ( V_23 , V_103 , V_56 , V_105 , L_56 ) ;
default:
V_40 [ V_71 ++ ] = V_8 ;
continue;
}
...
F_75 ( V_109 , V_118 , FALSE ) ;
return F_66 ( NULL , V_103 , NULL , 0 , L_57 , V_109 ) ;
}
}
