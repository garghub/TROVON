...
F_6 ( line , V_12 ) ) ;
if ( V_3 ) {
V_5 = F_7 ( V_3 , V_20 , V_1 , 0 , - 1 , V_21 ) ;
V_7 = F_8 ( V_5 , V_22 ) ;
if ( V_9 ) {
V_6 = F_9 ( V_7 , V_23 , V_1 , 0 , 0 , TRUE ) ;
} else {
V_6 = F_9 ( V_7 , V_24 , V_1 , 0 , 0 , TRUE ) ;
}
F_10 ( V_6 ) ;
V_5 = F_11 ( V_7 , V_1 , V_10 , V_11 - V_10 ) ;
V_8 = F_8 ( V_5 , V_25 ) ;
V_13 = F_12 ( line , line + V_12 , & V_14 ) ;
if ( V_13 != 0 ) {
if ( V_9 ) {
F_13 ( V_8 , V_26 , V_1 , V_10 ,
V_13 , F_6 ( line , V_13 ) ) ;
} else {
F_13 ( V_8 , V_27 , V_1 , V_10 ,
V_13 , F_6 ( line , V_13 ) ) ;
}
V_10 += ( T_7 ) ( V_14 - line ) ;
V_12 -= ( int ) ( V_14 - line ) ;
...
if ( V_12 != 0 ) {
if ( V_9 ) {
F_13 ( V_8 , V_28 , V_1 , V_10 ,
V_12 , F_6 ( line , V_12 ) ) ;
} else {
F_13 ( V_8 , V_29 , V_1 , V_10 ,
V_12 , F_6 ( line , V_12 ) ) ;
}
}
}
