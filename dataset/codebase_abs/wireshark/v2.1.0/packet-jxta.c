...
if ( NULL != V_235 ) {
V_230 = F_80 ( V_235 , V_30 , T_4 , V_31 ) ;
}
} else if ( 0 == strcmp ( L_29 , V_191 ) ) {
T_13 * V_236 = F_81 ( V_30 , V_30 , 0 , F_82 ( V_30 ) ) ;
if( NULL != V_236 ) {
F_83 ( T_4 , V_236 , L_30 ) ;
V_230 = F_30 ( L_31 , V_236 , T_4 , V_31 ) ;
if( V_230 > 0 ) {
V_230 = F_82 ( V_30 ) ;
}
}
} else {
V_230 = F_84 ( V_237 , V_191 , V_30 , T_4 , V_31 , V_234 ) ? F_82 ( V_30 ) : 0 ;
if( V_230 != ( int ) F_82 ( V_30 ) ) {
}
}
if ( 0 == V_230 ) {
V_230 = F_85 ( V_238 , V_30 , T_4 , V_31 , V_234 ) ;
}
T_4 -> V_233 = V_232 ;
}
if( 0 == V_230 ) {
...
static T_27 V_240 [] = {
{ & V_164 ,
{ L_32 , L_33 , V_241 , V_242 , NULL , 0x0 ,
L_34 , V_243 }
} ,
{ & V_163 ,
{ L_35 , L_36 , V_241 , V_242 , NULL , 0x0 ,
L_37 , V_243 }
} ,
{ & V_166 ,
{ L_38 , L_39 , V_241 , V_242 , NULL , 0x0 ,
L_40 , V_243 }
} ,
{ & V_57 ,
{ L_41 , L_6 , V_244 , V_242 , NULL , 0x0 ,
NULL , V_243 }
} ,
{ & V_61 ,
{ L_42 , L_43 , V_241 , V_242 , NULL , 0x0 ,
L_44 , V_243 }
} ,
{ & V_102 ,
{ L_9 , L_45 , V_244 , V_242 , NULL , 0x00 ,
L_46 , V_243 }
} ,
{ & V_105 ,
{ L_47 , L_48 , V_245 , V_242 , NULL , 0x00 ,
L_49 , V_243 }
} ,
{ & V_106 ,
{ L_42 , L_50 , V_241 , V_242 , NULL , 0x0 ,
L_51 , V_243 }
} ,
{ & V_107 ,
{ L_52 , L_53 , V_241 , V_242 , NULL , 0x0 ,
L_54 , V_243 }
} ,
{ & V_108 ,
{ L_55 , L_56 , V_241 , V_242 , NULL , 0x0 ,
L_57 , V_243 }
} ,
{ & V_109 ,
{ L_58 , L_59 , V_241 , V_242 , NULL , 0x0 ,
L_60 , V_243 }
} ,
{ & V_113 ,
{ L_61 , L_62 , V_241 , V_242 , NULL , 0x0 ,
L_63 , V_243 }
} ,
{ & V_116 ,
{ L_64 , L_65 , V_241 , V_242 , NULL , 0x0 ,
L_66 , V_243 }
} ,
{ & V_118 ,
{ L_67 , L_68 , V_241 , V_242 , NULL , 0x0 ,
L_69 , V_243 }
} ,
{ & V_114 ,
{ L_70 , L_71 , V_241 , V_242 , NULL , 0x0 ,
L_72 , V_243 }
} ,
{ & V_125 ,
{ L_73 , L_74 , V_244 , V_242 , NULL , 0x0 ,
L_75 , V_243 }
} ,
{ & V_129 ,
{ L_76 , L_77 , V_244 , V_242 , NULL , 0x0 ,
L_78 , V_243 }
} ,
{ & V_132 ,
{ L_79 , L_80 , V_246 , V_242 , NULL , 0x0 ,
L_81 , V_243 }
} ,
{ & V_136 ,
{ L_82 , L_83 , V_247 , V_248 , NULL , 0x0 ,
L_84 , V_243 }
} ,
{ & V_137 ,
{ L_85 , L_86 , V_249 , V_242 , NULL , 0x0 ,
L_87 , V_243 }
} ,
{ & V_162 ,
{ L_32 , L_3 , V_241 , V_242 , NULL , 0x0 ,
L_88 , V_243 }
} ,
{ & V_161 ,
{ L_35 , L_89 , V_241 , V_242 , NULL , 0x0 ,
L_90 , V_243 }
} ,
{ & V_165 ,
{ L_38 , L_91 , V_241 , V_242 , NULL , 0x0 ,
L_92 , V_243 }
} ,
{ & V_160 ,
{ L_42 , L_93 , V_241 , V_242 , NULL , 0x0 ,
L_94 , V_243 }
} ,
{ & V_167 ,
{ L_70 , L_95 , V_250 , V_248 , NULL , 0x0 ,
L_96 , V_243 }
} ,
{ & V_171 ,
{ L_97 , L_98 , V_250 , V_251 , NULL , 0x0 ,
L_99 , V_243 }
} ,
{ & V_169 ,
{ L_100 , L_101 , V_245 , 2 , F_88 ( & V_252 ) , 0x01 ,
L_102 , V_243 }
} ,
{ & V_170 ,
{ L_103 , L_104 , V_245 , 2 , F_88 ( & V_252 ) , 0x02 ,
L_105 , V_243 }
} ,
{ & V_173 ,
{ L_106 , L_107 , V_247 , V_248 , NULL , 0x0 ,
L_108 , V_243 }
} ,
{ & V_174 ,
{ L_109 , L_110 , V_246 , V_242 , NULL , 0x0 ,
L_111 , V_243 }
} ,
{ & V_175 ,
{ L_112 , L_113 , V_247 , V_248 , NULL , 0x0 ,
L_114 , V_243 }
} ,
{ & V_186 ,
{ L_115 , L_116 , V_244 , V_242 , NULL , 0x0 ,
NULL , V_243 }
} ,
{ & V_197 ,
{ L_42 , L_117 , V_241 , V_242 , NULL , 0x0 ,
L_118 , V_243 }
} ,
{ & V_198 ,
{ L_119 , L_120 , V_250 , V_248 , NULL , 0x0 ,
L_121 , V_243 }
} ,
{ & V_220 ,
{ L_119 , L_120 , V_247 , V_248 , NULL , 0x0 ,
L_121 , V_243 }
} ,
{ & V_199 ,
{ L_97 , L_122 , V_250 , V_251 , NULL , 0x0 ,
L_123 , V_243 }
} ,
{ & V_194 ,
{ L_124 , L_125 , V_245 , 3 , F_88 ( & V_252 ) , 0x01 ,
L_126 , V_243 }
} ,
{ & V_195 ,
{ L_127 , L_128 , V_245 , 3 , F_88 ( & V_252 ) , 0x02 ,
L_129 , V_243 }
} ,
{ & V_196 ,
{ L_130 , L_131 , V_245 , 3 , F_88 ( & V_252 ) , 0x04 ,
L_132 , V_243 }
} ,
{ & V_213 ,
{ L_133 , L_134 , V_245 , 6 , F_88 ( & V_252 ) , 0x01 ,
L_135 , V_243 }
} ,
{ & V_214 ,
{ L_136 , L_137 , V_245 , 6 , F_88 ( & V_252 ) , 0x02 ,
L_138 , V_243 }
} ,
{ & V_215 ,
{ L_127 , L_125 , V_245 , 6 , F_88 ( & V_252 ) , 0x04 ,
L_126 , V_243 }
} ,
{ & V_216 ,
{ L_130 , L_131 , V_245 , 6 , F_88 ( & V_252 ) , 0x08 ,
L_132 , V_243 }
} ,
{ & V_217 ,
{ L_130 , L_128 , V_245 , 6 , F_88 ( & V_252 ) , 0x10 ,
L_129 , V_243 }
} ,
{ & V_218 ,
{ L_139 , L_140 , V_245 , 6 , F_88 ( & V_252 ) , 0x20 ,
L_141 , V_243 }
} ,
{ & V_221 ,
{ L_142 , L_143 , V_247 , V_248 , NULL , 0x0 ,
L_144 , V_243 }
} ,
{ & V_201 ,
{ L_145 , L_146 , V_246 , V_242 , NULL , 0x0 ,
L_147 , V_243 }
} ,
{ & V_224 ,
{ L_148 , L_149 , V_247 , V_248 , NULL , 0x0 ,
L_150 , V_243 }
} ,
{ & V_227 ,
{ L_151 , L_152 , V_247 , V_248 , NULL , 0x0 ,
L_153 , V_243 }
} ,
{ & V_202 ,
{ L_154 , L_155 , V_246 , V_242 , NULL , 0x0 ,
L_147 , V_243 }
} ,
{ & V_203 ,
{ L_154 , L_156 , V_246 , V_242 , NULL , 0x0 ,
L_157 , V_243 }
} ,
{ & V_204 ,
{ L_158 , L_159 , V_253 , V_248 , NULL , 0x0 ,
L_160 , V_243 }
} ,
{ & V_228 ,
{ L_158 , L_161 , V_254 , V_248 , NULL , 0x0 ,
L_160 , V_243 }
} ,
#if 0
...
F_92 ( V_53 , V_240 , F_93 ( V_240 ) ) ;
F_94 ( V_255 , F_93 ( V_255 ) ) ;
V_5 = F_95 ( L_166 , L_167 , F_7 , F_8 , F_9 , NULL , NULL , NULL ) ;
V_239 = F_96 ( V_53 , V_256 ) ;
F_97 ( V_239 , L_168 , L_169 ,
L_170 , & V_257 ) ;
F_97 ( V_239 , L_171 ,
L_172 ,
L_173
...
void V_256 ( void )
{
static T_12 V_258 = FALSE ;
static T_28 V_259 ;
static T_12 V_260 = FALSE ;
if( ! V_258 ) {
V_259 = F_100 ( F_64 , V_158 ) ;
V_87 = F_18 ( L_165 ) ;
V_237 = F_101 ( L_179 ) ;
V_235 = F_102 ( L_180 , V_53 ) ;
V_238 = F_102 ( L_181 , V_53 ) ;
V_258 = TRUE ;
}
if( V_257 ) {
if( ! V_260 ) {
F_103 ( L_179 , L_182 , V_259 ) ;
V_260 = TRUE ;
}
} else {
if( V_260 ) {
F_104 ( L_179 , L_182 , V_259 ) ;
V_260 = FALSE ;
}
}
F_105 ( L_183 , F_10 , L_184 , L_185 , V_53 , V_261 ) ;
F_105 ( L_186 , F_13 , L_187 , L_188 , V_53 , V_261 ) ;
F_105 ( L_189 , F_15 , L_190 , L_191 , V_53 , V_261 ) ;
}
