...
if ( V_9 -> V_27 & V_28 ) V_9 -> V_13 = F_17 ( L_4 , V_9 -> V_12 ) ;
if ( V_9 -> V_27 & V_29 ) V_9 -> V_14 = F_17 ( L_5 , V_9 -> V_12 ) ;
if ( V_9 -> V_27 & V_30 ) V_9 -> V_15 = F_17 ( L_6 , V_9 -> V_12 ) ;
if ( V_9 -> V_27 & V_31 ) V_9 -> V_16 = F_17 ( L_7 , V_9 -> V_12 ) ;
if ( V_9 -> V_32 ) V_9 -> V_33 = F_18 ( V_9 -> V_32 , V_23 ) ;
}
}
void F_19 ( void )
{
...
V_34 = F_18 ( F_6 , V_23 ) ;
for ( V_9 = V_11 ; V_9 -> V_12 ; V_9 ++ ) {
if ( V_9 -> V_13 ) F_21 ( L_10 , V_9 -> V_13 , V_34 ) ;
if ( V_9 -> V_14 ) F_21 ( L_10 , V_9 -> V_14 , V_34 ) ;
if ( V_9 -> V_15 ) F_21 ( L_11 , V_9 -> V_15 , V_34 ) ;
if ( V_9 -> V_16 ) F_21 ( L_11 , V_9 -> V_16 , V_34 ) ;
if ( V_9 -> V_33 ) {
if ( V_9 -> V_13 ) F_21 ( L_12 , V_9 -> V_13 , V_9 -> V_33 ) ;
if ( V_9 -> V_14 ) F_21 ( L_12 , V_9 -> V_14 , V_9 -> V_33 ) ;
if ( V_9 -> V_15 ) F_21 ( L_13 , V_9 -> V_15 , V_9 -> V_33 ) ;
if ( V_9 -> V_16 ) F_21 ( L_13 , V_9 -> V_16 , V_9 -> V_33 ) ;
}
}
}
