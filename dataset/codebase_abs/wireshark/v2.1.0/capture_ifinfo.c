...
V_30 = F_16 ( V_29 [ 4 ] , L_8 , 0 ) ;
for ( V_25 = 0 ; V_30 [ V_25 ] != NULL ; V_25 ++ ) {
V_4 = F_19 ( T_3 , 1 ) ;
if ( F_20 ( V_30 [ V_25 ] , & V_4 -> V_16 . V_17 ) ) {
V_4 -> V_14 = V_15 ;
} else if ( F_21 ( V_30 [ V_25 ] , (struct V_35 * ) & V_4 -> V_16 . V_18 ) ) {
V_4 -> V_14 = V_36 ;
} else {
F_8 ( V_4 ) ;
V_4 = NULL ;
