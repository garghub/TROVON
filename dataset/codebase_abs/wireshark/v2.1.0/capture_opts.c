...
V_1 -> V_52 = TRUE ;
V_1 -> V_53 = F_13 ( V_75 , L_79 ) ;
} else if ( strcmp ( V_77 , L_74 ) == 0 ) {
V_1 -> V_59 = TRUE ;
V_1 -> V_60 = F_13 ( V_75 , L_80 ) ;
} else if ( strcmp ( V_77 , L_72 ) == 0 ) {
V_1 -> V_50 = TRUE ;
V_1 -> V_51 = F_13 ( V_75 , L_81 ) ;
}
* V_76 = ':' ;
return TRUE ;
}
...
if ( strcmp ( V_77 , L_82 ) == 0 ) {
if ( V_1 -> V_2 -> V_69 > 0 ) {
V_3 V_70 ;
V_70 = F_10 ( V_1 -> V_2 , V_3 , V_1 -> V_2 -> V_69 - 1 ) ;
V_1 -> V_2 = F_17 ( V_1 -> V_2 , V_1 -> V_2 -> V_69 - 1 ) ;
V_70 . V_37 = V_86 ;
V_70 . V_39 = F_13 ( V_75 , L_83 ) ;
F_19 ( V_1 -> V_2 , V_70 ) ;
} else {
V_1 -> V_7 . V_37 = V_86 ;
V_1 -> V_7 . V_39 = F_13 ( V_75 , L_83 ) ;
}
} else if ( strcmp ( V_77 , L_84 ) == 0 ) {
if ( V_1 -> V_2 -> V_69 > 0 ) {
V_3 V_70 ;
V_70 = F_10 ( V_1 -> V_2 , V_3 , V_1 -> V_2 -> V_69 - 1 ) ;
V_1 -> V_2 = F_17 ( V_1 -> V_2 , V_1 -> V_2 -> V_69 - 1 ) ;
V_70 . V_37 = V_87 ;
V_70 . V_39 = F_13 ( V_75 , L_85 ) ;
F_19 ( V_1 -> V_2 , V_70 ) ;
} else {
V_1 -> V_7 . V_37 = V_87 ;
V_1 -> V_7 . V_39 = F_13 ( V_75 , L_85 ) ;
}
}
* V_76 = ':' ;
return TRUE ;
...
V_1 -> V_7 . V_30 = V_73 ;
V_1 -> V_7 . V_32 = F_16 ( V_77 ) ;
V_1 -> V_7 . V_33 = F_16 ( V_75 ) ;
}
* V_76 = ':' ;
return TRUE ;
}
...
V_70 . V_28 = F_16 ( V_1 -> V_7 . V_28 ) ;
V_70 . V_29 = F_16 ( V_1 -> V_7 . V_29 ) ;
V_70 . V_30 = V_1 -> V_7 . V_30 ;
V_70 . V_32 = F_16 ( V_1 -> V_7 . V_32 ) ;
...
V_70 = F_10 ( V_1 -> V_2 , V_3 , V_1 -> V_2 -> V_69 - 1 ) ;
V_1 -> V_2 = F_17 ( V_1 -> V_2 , V_1 -> V_2 -> V_69 - 1 ) ;
V_70 . V_23 = F_13 ( V_88 , L_95 ) ;
F_19 ( V_1 -> V_2 , V_70 ) ;
} else {
V_1 -> V_7 . V_23 = F_13 ( V_88 , L_95 ) ;
}
break;
#endif
case 'c' :
V_1 -> V_57 = TRUE ;
V_1 -> V_58 = F_13 ( V_88 , L_96 ) ;
break;
case 'f' :
F_14 ( V_1 , V_88 ) ;
break;
...
printf ( L_103 , V_105 -> V_8 ) ;
if ( V_105 -> V_108 != NULL )
printf ( L_104 , V_105 -> V_108 ) ;
else
printf ( L_105 ) ;
printf ( L_106 ) ;
}
...
V_96 = F_29 ( V_96 ) ) {
V_91 = ( T_8 * ) V_96 -> V_83 ;
printf ( L_107 , V_68 ++ , V_91 -> V_8 ) ;
if ( V_91 -> V_95 != NULL ) {
printf ( L_104 , V_91 -> V_95 ) ;
} else {
if ( V_91 -> V_109 != NULL )
printf ( L_104 , V_91 -> V_109 ) ;
}
printf ( L_106 ) ;
}
}
...
static T_4
F_35 ( const char * V_41 , T_4 * V_119 )
{
int V_92 ;
* V_119 = FALSE ;
if ( V_41 != NULL ) {
if ( strcmp ( V_41 , L_112 ) == 0 ) {
* V_119 = TRUE ;
} else {
V_92 = F_43 ( V_41 ) ;
switch ( V_92 ) {
...
#endif
#ifdef F_4
V_70 . V_23 = V_122 . V_129 ;
#endif
#ifdef F_33
V_70 . V_25 = V_122 . V_130 ;
#endif
#ifdef F_5
V_70 . V_26 = V_72 ;
V_70 . V_28 = F_16 ( V_122 . V_131 . V_132 . V_28 ) ;
V_70 . V_29 = F_16 ( V_122 . V_131 . V_132 . V_29 ) ;
V_70 . V_30 = V_122 . V_131 . V_132 . V_30 ;
V_70 . V_32 = F_16 ( V_122 . V_131 . V_132 . V_32 ) ;
V_70 . V_33 = F_16 ( V_122 . V_131 . V_132 . V_33 ) ;
V_70 . V_34 = V_122 . V_131 . V_132 . V_34 ;
V_70 . V_35 = V_122 . V_131 . V_132 . V_35 ;
V_70 . V_36 = V_122 . V_131 . V_132 . V_36 ;
#endif
#ifdef F_6
V_70 . V_37 = V_122 . V_131 . V_37 ;
V_70 . V_39 = V_122 . V_131 . V_39 ;
#endif
F_19 ( V_1 -> V_2 , V_70 ) ;
} else {
continue;
...
F_55 ( V_122 -> V_137 ) ;
#ifdef F_5
F_18 ( V_122 -> V_131 . V_132 . V_28 ) ;
F_18 ( V_122 -> V_131 . V_132 . V_29 ) ;
F_18 ( V_122 -> V_131 . V_132 . V_32 ) ;
