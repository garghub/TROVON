...
int rhashtable_expand(struct rhashtable *ht, gfp_t flags)
{
	 ...
	 * for the ï¬?rst entry that hashes to the new bucket, and
	 ...
	 * the new table, but they will not beneï¬?t from any
	 * additional efï¬?ciency until later steps unzip the buckets.
	 */
...
int rhashtable_shrink(struct rhashtable *ht, gfp_t flags)
{
	...
	/* Link each bucket in the new table to the ï¬?rst bucket
